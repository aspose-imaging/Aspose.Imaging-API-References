...
description: Classe pour représenter limage raster Djvu où se trouve le résultat dune opération
type: docs
weight: 2460
url: /fr/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

Classe pour représenter l'image raster Djvu où se trouve le résultat d'une opération
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | Obtient le nombre de bits d'image par pixel. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | Obtient la hauteur. |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | Obtient la longueur. |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | Obtient la largeur. |
