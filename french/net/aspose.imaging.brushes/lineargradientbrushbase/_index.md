...
description: Représente unBrush../aspose.imaging/brush avec des capacités de dégradé et des propriétés appropriées.
type: docs
weight: 160
url: /fr/net/aspose.imaging.brushes/lineargradientbrushbase/
---
## LinearGradientBrushBase class

Représente un[`Brush`](../../aspose.imaging/brush) avec des capacités de dégradé et des propriétés appropriées.
...
| [IsAngleScalable](../../aspose.imaging.brushes/lineargradientbrushbase/isanglescalable) { get; set; } | Obtient ou définit une valeur indiquant si[`Angle`](./angle) est changé lors des transformations avec ceci[`LinearGradientBrushBase`](../lineargradientbrushbase) . |
