...
description: Représente unBrush../aspose.imaging/brush avec dégradé linéaire défini par plusieurs couleurs et positions appropriées. Cette classe ne peut pas être héritée.
type: docs
weight: 170
url: /fr/net/aspose.imaging.brushes/linearmulticolorgradientbrush/
---
## LinearMulticolorGradientBrush class

Représente un[`Brush`](../../aspose.imaging/brush) avec dégradé linéaire défini par plusieurs couleurs et positions appropriées. Cette classe ne peut pas être héritée.
...
| [InterpolationColors](../../aspose.imaging.brushes/linearmulticolorgradientbrush/interpolationcolors) { get; set; } | Obtient ou définit un[`ColorBlend`](../../aspose.imaging/colorblend) qui définit un dégradé linéaire multicolore. |
