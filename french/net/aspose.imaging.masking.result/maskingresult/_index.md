...
description: Classe abstraite de base qui peut fournir une image de résultat à partir du système de masquage dimage.
type: docs
weight: 10540
url: /fr/net/aspose.imaging.masking.result/maskingresult/
---
## MaskingResult class

Classe abstraite de base qui peut fournir une image de résultat à partir du système de masquage d'image.
...
| [Item](../../aspose.imaging.masking.result/maskingresult/item) { get; } | Obtient le[`IMaskingLayer`](../imaskinglayer) à l'index spécifié. |
| abstract [Layers](../../aspose.imaging.masking.result/maskingresult/layers) { get; } | Obtient les calques. |
| [Length](../../aspose.imaging.masking.result/maskingresult/length) { get; } | Obtient la longueur. |
...
| [GetEnumerator](../../aspose.imaging.masking.result/maskingresult/getenumerator)() | Obtient l'énumérateur. |

## Des champs

| Nom | La description |
| --- | --- |
| readonly [MaskingOptions](../../aspose.imaging.masking.result/maskingresult/maskingoptions) | Les options de masquage |
...
* espace de noms [Aspose.Imaging.Masking.Result](../../aspose.imaging.masking.result)
