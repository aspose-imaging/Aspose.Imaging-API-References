...
description: Une image jpeg.
type: docs
weight: 6770
url: /fr/net/aspose.imaging.fileformats.jpeg/jpegimage/
---
## JpegImage class
...
| Nom | La description |
| --- | --- |
| [JpegImage](jpegimage#constructor_1)(RasterImage) | Initialise une nouvelle instance du[`JpegImage`](../jpegimage) classe. |
| [JpegImage](jpegimage#constructor_3)(Stream) | Initialise une nouvelle instance du[`JpegImage`](../jpegimage) classe. |
| [JpegImage](jpegimage#constructor_4)(string) | Initialise une nouvelle instance du[`JpegImage`](../jpegimage) classe. |
| [JpegImage](jpegimage#constructor_2)(int, int) | Initialise une nouvelle instance du[`JpegImage`](../jpegimage) classe. |
| [JpegImage](jpegimage#constructor)(JpegOptions, int, int) | Initialise une nouvelle instance du[`JpegImage`](../jpegimage) classe. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg/jpegimage/bitsperpixel) { get; } | Obtient le nombre de bits d'image par pixel. |
...
| [CmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/cmykcolorprofile) { get; set; } | Le profil de couleur CMJN pour les images jpeg CMJN et YCCK. Doit être en paire avec RGBColorProfile pour une conversion de couleur correcte. |
| [Comment](../../aspose.imaging.fileformats.jpeg/jpegimage/comment) { get; set; } | Obtient ou définit le commentaire du fichier jpeg. |
...
| [DestinationCmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationcmykcolorprofile) { get; set; } | Le profil de couleur CMJN pour les images jpeg CMJN et YCCK, utilisé pour le processus d'enregistrement d'image. Doit être en paire avec RGBColorProfile pour une conversion de couleur correcte. |
| [DestinationRgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationrgbcolorprofile) { get; set; } | Le profil de couleur RVB pour les images jpeg CMJN et YCCK, utilisé pour le processus d'enregistrement d'image. Doit être en paire avec CMYKColorProfile pour une conversion correcte des couleurs. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Obtient une valeur indiquant si cette instance est supprimée. |
| [ExifData](../../aspose.imaging.fileformats.jpeg/jpegimage/exifdata) { get; set; } | Obtenir ou définir le conteneur de données exif |
| override [FileFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/fileformat) { get; } | Obtient une valeur de format de fichier |
...
| override [Height](../../aspose.imaging.fileformats.jpeg/jpegimage/height) { get; } | Obtient la hauteur de l'image. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/horizontalresolution) { get; set; } | Obtient ou définit la résolution horizontale, en pixels par pouce, de ce[`RasterImage`](../../aspose.imaging/rasterimage) . |
| [IgnoreEmbeddedColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/ignoreembeddedcolorprofile) { get; set; } | Obtient ou définit une valeur indiquant si le profil de couleur intégré est ignoré. Si le profil de couleur intégré est ignoré, le profil de couleur par défaut est utilisé. |
...
| [Jfif](../../aspose.imaging.fileformats.jpeg/jpegimage/jfif) { get; set; } | Obtient ou définit le jfif. |
| [JpegOptions](../../aspose.imaging.fileformats.jpeg/jpegimage/jpegoptions) { get; } | Obtient les options JPEG utilisées pour créer ou charger ce[`JpegImage`](../jpegimage) instance. |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/rawdataformat) { get; } | Obtient le format des données brutes. |
...
| [RgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/rgbcolorprofile) { get; set; } | Le profil de couleur RVB pour les images jpeg CMJN et YCCK. Doit être en paire avec CMYKColorProfile pour une conversion correcte des couleurs. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/verticalresolution) { get; set; } | Obtient ou définit la résolution verticale, en pixels par pouce, de ce[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.jpeg/jpegimage/width) { get; } | Obtient la largeur de l'image. |
| override [XmpData](../../aspose.imaging.fileformats.jpeg/jpegimage/xmpdata) { get; set; } | Obtient ou définit les métadonnées XMP. |
...
| [AutoRotate](../../aspose.imaging.fileformats.jpeg/jpegimage/autorotate)() | Effectuer une rotation automatique de l'image en fonction des données d'orientation fournies par Exif. |
...
| override [GetModifyDate](../../aspose.imaging.fileformats.jpeg/jpegimage/getmodifydate)(bool) | Obtient la date et l'heure de la dernière modification de l'image de ressource. |
...
| override [SetResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/setresolution)(double, double) | Définit la résolution pour ce[`RasterImage`](../../aspose.imaging/rasterimage) . |
