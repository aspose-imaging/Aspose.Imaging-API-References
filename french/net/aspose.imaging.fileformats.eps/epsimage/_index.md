...
description: Classe de base pour le format EPS
type: docs
weight: 6560
url: /fr/net/aspose.imaging.fileformats.eps/epsimage/
---
## EpsImage class
...
| abstract [EpsType](../../aspose.imaging.fileformats.eps/epsimage/epstype) { get; } | Obtient la valeur du sous-type EPS |
...
| abstract [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsimage/hasrasterpreview) { get; } | Obtient une valeur indiquant si cette instance a un aperçu raster spécifique au format |
...
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize#resize_1)(int, int, ImageResizeSettings) | Redimensionne l'image. |
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize#resize_2)(int, int, ResizeType) | Redimensionne l'image. |
