...
description: Classe pour le format déchange PostScript encapsulé
type: docs
weight: 6570
url: /fr/net/aspose.imaging.fileformats.eps/epsinterchangeimage/
---
## EpsInterchangeImage class

Classe pour le format d'échange PostScript encapsulé
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsinterchangeimage/epstype) { get; } | Obtient la valeur du sous-type EPS |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | Obtient une valeur indiquant si cette instance a un aperçu raster spécifique au format |
...
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | Obtient la hauteur de l'image d'aperçu |
| [PreviewWidth](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewwidth) { get; } | Obtient la largeur de l'image d'aperçu |
| [RasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/rasterpreview) { get; } | Obtient un aperçu raster n/b (si présent) ou null |
...
| [ConvertToBinary](../../aspose.imaging.fileformats.eps/epsinterchangeimage/converttobinary)() | Convertit cette instance en[`EpsBinaryImage`](../epsbinaryimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | Effectue une conversion explicite à partir[`EpsBinaryImage`](../epsbinaryimage) à[`EpsInterchangeImage`](../epsinterchangeimage) |
