...
type: docs
weight: 8010
url: /fr/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/
---
...
| Nom | La description |
| --- | --- |
| [TiffSRationalType](tiffsrationaltype#constructor)(TiffTags) | Initialise une nouvelle instance du[`TiffSRationalType`](../tiffsrationaltype) classe. |
| [TiffSRationalType](tiffsrationaltype#constructor_1)(ushort) | Initialise une nouvelle instance du[`TiffSRationalType`](../tiffsrationaltype) classe. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/elementsize) { get; } | Obtient la taille de l'élément en octets. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/tagtype) { get; } | Obtient le type de balise. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/value) { get; set; } | Obtient ou définit la valeur que ce type de données contient. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/values) { get; set; } | Obtient ou définit les valeurs. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/valuescontainer) { get; } | Obtient le conteneur de valeurs. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/writeadditionaldata)(TiffStreamWriter) | Écrit les données de variable supplémentaires. |
