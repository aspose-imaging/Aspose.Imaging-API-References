...
type: docs
weight: 7980
url: /fr/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/
---
...
| Nom | La description |
| --- | --- |
| [TiffRationalType](tiffrationaltype#constructor)(TiffTags) | Initialise une nouvelle instance du[`TiffRationalType`](../tiffrationaltype) classe. |
| [TiffRationalType](tiffrationaltype#constructor_1)(ushort) | Initialise une nouvelle instance du[`TiffRationalType`](../tiffrationaltype) classe. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/elementsize) { get; } | Obtient la taille de l'élément en octets. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/tagtype) { get; } | Obtient le type de balise. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/value) { get; set; } | Obtient ou définit la valeur que ce type de données contient. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/values) { get; set; } | Obtient ou définit les valeurs. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/valuescontainer) { get; } | Obtient le conteneur de valeurs. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/writeadditionaldata)(TiffStreamWriter) | Écrit les données de variable supplémentaires. |
