...
description: Le double type tiff.
type: docs
weight: 7940
url: /fr/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
| Nom | La description |
| --- | --- |
| [TiffDoubleType](tiffdoubletype#constructor)(TiffTags) | Initialise une nouvelle instance du[`TiffDoubleType`](../tiffdoubletype) classe. |
| [TiffDoubleType](tiffdoubletype#constructor_1)(ushort) | Initialise une nouvelle instance du[`TiffDoubleType`](../tiffdoubletype) classe. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/elementsize) { get; } | Obtient la taille de l'élément en octets. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/tagtype) { get; } | Obtient le type de balise. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/value) { get; set; } | Obtient ou définit la valeur que ce type de données contient. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/values) { get; set; } | Obtient ou définit les valeurs. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/valuescontainer) { get; } | Obtient le conteneur de valeurs. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/writeadditionaldata)(TiffStreamWriter) | Écrit les données de variable supplémentaires. |
