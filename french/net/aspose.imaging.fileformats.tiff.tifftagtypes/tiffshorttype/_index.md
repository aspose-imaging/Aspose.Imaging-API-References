...
type: docs
weight: 8030
url: /fr/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/
---
## TiffShortType class
...
| Nom | La description |
| --- | --- |
| [TiffShortType](tiffshorttype#constructor)(TiffTags) | Initialise une nouvelle instance du[`TiffShortType`](../tiffshorttype) classe. |
| [TiffShortType](tiffshorttype#constructor_1)(ushort) | Initialise une nouvelle instance du[`TiffShortType`](../tiffshorttype) classe. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/elementsize) { get; } | Obtient la taille de l'élément en octets. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/tagtype) { get; } | Obtient le type de balise. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/value) { get; set; } | Obtient ou définit la valeur que ce type de données contient. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/values) { get; set; } | Obtient ou définit les données. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/valuescontainer) { get; } | Obtient le conteneur de valeurs. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/writeadditionaldata)(TiffStreamWriter) | Écrit les données de variable supplémentaires. |
