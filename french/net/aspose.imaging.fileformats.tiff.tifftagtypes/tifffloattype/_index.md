...
type: docs
weight: 7950
url: /fr/net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/
---
## TiffFloatType class
...
| Nom | La description |
| --- | --- |
| [TiffFloatType](tifffloattype#constructor)(TiffTags) | Initialise une nouvelle instance du[`TiffFloatType`](../tifffloattype) classe. |
| [TiffFloatType](tifffloattype#constructor_1)(ushort) | Initialise une nouvelle instance du[`TiffFloatType`](../tifffloattype) classe. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/elementsize) { get; } | Obtient la taille de l'élément en octets. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/tagtype) { get; } | Obtient le type de balise. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/value) { get; set; } | Obtient ou définit la valeur que ce type de données contient. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/values) { get; set; } | Obtient ou définit les valeurs. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/valuescontainer) { get; } | Obtient le conteneur de valeurs. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/writeadditionaldata)(TiffStreamWriter) | Écrit les données de variable supplémentaires. |
