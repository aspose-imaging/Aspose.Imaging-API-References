...
type: docs
weight: 7870
url: /fr/net/aspose.imaging.fileformats.tiff/tiffframe/
---
## TiffFrame class
...
| Nom | La description |
| --- | --- |
| [TiffFrame](tiffframe#constructor_1)(RasterImage) | Initialise une nouvelle instance du[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_3)(Stream) | Initialise une nouvelle instance du[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_5)(string) | Initialise une nouvelle instance du[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_2)(RasterImage, TiffOptions) | Initialise une nouvelle instance du[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_4)(Stream, TiffOptions) | Initialise une nouvelle instance du[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_6)(string, TiffOptions) | Initialise une nouvelle instance du[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor)(TiffOptions, int, int) | Initialise une nouvelle instance du[`TiffFrame`](../tiffframe) classe. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.tiff/tiffframe/backgroundcolor) { get; set; } | Obtient ou définit une valeur pour la couleur d'arrière-plan. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.tiff/tiffframe/bitsperpixel) { get; } | Obtient le nombre de bits d'image par pixel. |
...
| [ExifData](../../aspose.imaging.fileformats.tiff/tiffframe/exifdata) { get; set; } | Obtient ou définit les données EXIF du cadre. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | Obtient une valeur de format de fichier |
| [FrameOptions](../../aspose.imaging.fileformats.tiff/tiffframe/frameoptions) { get; } | Obtient les options de création de cadre. |
| override [HasAlpha](../../aspose.imaging.fileformats.tiff/tiffframe/hasalpha) { get; } | Obtient une valeur indiquant si cette instance a alpha. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.tiff/tiffframe/hastransparentcolor) { get; set; } | Obtient une valeur indiquant si l'image a une couleur transparente. |
| override [Height](../../aspose.imaging.fileformats.tiff/tiffframe/height) { get; } | Obtient la hauteur de l'image. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/horizontalresolution) { get; set; } | Obtient ou définit la résolution horizontale, en pixels par pouce, de ce[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| [PathResources](../../aspose.imaging.fileformats.tiff/tiffframe/pathresources) { get; set; } | Obtient ou définit les ressources de chemin. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/verticalresolution) { get; set; } | Obtient ou définit la résolution verticale, en pixels par pouce, de ce[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.tiff/tiffframe/width) { get; } | Obtient la largeur de l'image. |
| override [XmpData](../../aspose.imaging.fileformats.tiff/tiffframe/xmpdata) { get; set; } | Obtient ou définit les données XMP du cadre. |

## Méthodes

| Nom | La description |
| --- | --- |
| static [CopyFrame](../../aspose.imaging.fileformats.tiff/tiffframe/copyframe)(TiffFrame) | Copie le cadre entier (doublons). |
| static [CreateFrameFrom](../../aspose.imaging.fileformats.tiff/tiffframe/createframefrom)(TiffFrame, TiffOptions) | Crée le cadre à partir de spécifié*tiffFrame* en utilisant le spécifié*options* . Les données de pixel sont conservées mais converties au format souhaité. |
...
| [AlignResolutions](../../aspose.imaging.fileformats.tiff/tiffframe/alignresolutions)() | Méthode d'assistance pour rendre les résolutions horizontales et verticales égales. |
...
| override [Crop](../../aspose.imaging.fileformats.tiff/tiffframe/crop#crop)(Rectangle) | Recadrage de l'image. |
...
| override [Resize](../../aspose.imaging.fileformats.tiff/tiffframe/resize#resize_2)(int, int, ResizeType) | Redimensionne l'image. |
...
| override [Rotate](../../aspose.imaging.fileformats.tiff/tiffframe/rotate#rotate_1)(float, bool, Color) | Faire pivoter l'image autour du centre. |
