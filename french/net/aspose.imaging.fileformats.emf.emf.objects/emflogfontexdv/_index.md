...
description: Lobjet LogFontExDv spécifie le vecteur de conception dune police logique étendue.
type: docs
weight: 3050
url: /fr/net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
## EmfLogFontExDv class

L'objet LogFontExDv spécifie le vecteur de conception d'une police logique étendue.
...
| Nom | La description |
| --- | --- |
| [EmfLogFontExDv](emflogfontexdv)(EmfLogFontEx) | Initialise une nouvelle instance du[`EmfLogFontExDv`](../emflogfontexdv) classe. |
...
| [DesignVector](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/designvector) { get; set; } | Obtient ou définit un objet DesignVector (section 2.2.3). Ce champ NE DOIT PAS dépasser 72 octets. |
...
| [FullName](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontex/fullname) { get; set; } | Obtient ou définit une chaîne de 64 caractères Unicode contenant le nom complet de la police. Si la longueur de cette chaîne est inférieure à 64 caractères, un NULL de fin DOIT être présent, après , le reste de ce champ DOIT être ignoré. |
...
| [Script](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontex/script) { get; set; } | Obtient ou définit une chaîne de 32 caractères Unicode qui définit le jeu de caractères de la police. Si la longueur de cette chaîne est inférieure à 32 caractères, un NULL de fin DOIT être présent, après quoi le reste de ce champ DOIT être ignoré. |
...
| [Style](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontex/style) { get; set; } | Obtient ou définit une chaîne de 32 caractères Unicode qui définit le style de la police. Si la longueur de cette chaîne est inférieure à 32 caractères, un NULL de fin DOIT être présent, après quoi le reste de ce champ DOIT être ignoré. |
