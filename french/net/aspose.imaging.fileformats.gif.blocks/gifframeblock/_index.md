...
description: Bloc de cadre Gif.
type: docs
weight: 6630
url: /fr/net/aspose.imaging.fileformats.gif.blocks/gifframeblock/
---
## GifFrameBlock class
...
| Nom | La description |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | Initialise une nouvelle instance du[`GifFrameBlock`](../gifframeblock) classe. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/backgroundcolor) { get; set; } | Obtient ou définit une valeur pour la couleur d'arrière-plan. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel) { get; } | Obtient le nombre de bits d'image par pixel. |
...
| [ControlBlock](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/controlblock) { get; } | Obtient le bloc de contrôle graphique associé à ce bloc. |
| [DataStreamContainer](../../aspose.imaging/datastreamsupporter/datastreamcontainer) { get; } | Obtient le flux de données de l'objet. |
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod) { get; } | Obtient la méthode d'élimination. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Obtient une valeur indiquant si cette instance est supprimée. |
| override [FileFormat](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/fileformat) { get; } | Obtient une valeur de format de fichier |
| [Flags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/flags) { get; set; } | Obtient ou définit les drapeaux. |
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft) { get; } | Obtient la gauche. |
| [FrameTime](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametime) { get; set; } | Obtient ou définit la durée. |
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop) { get; } | Convertit en p. |
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel) { get; set; } | Obtient ou définit les bits d'image GIF par pixel. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor) { get; set; } | Obtient une valeur indiquant si le bloc de trame a une couleur transparente. |
| override [Height](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/height) { get; } | Obtient la hauteur de l'image. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | Obtient ou définit une valeur indiquant si cette[`GifFrameBlock`](../gifframeblock) est entrelacé. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | Obtient une valeur indiquant si cette instance d'image est entrelacée. |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted) { get; set; } | Obtient ou définit une valeur indiquant si la palette de couleurs est triée. |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left) { get; set; } | Obtient ou définit l'emplacement de l'image de gauche. |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top) { get; set; } | Obtient ou définit l'emplacement supérieur de l'image. |
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor) { get; set; } | Obtient la couleur transparente du bloc de trame. |
...
| override [Width](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/width) { get; } | Obtient la largeur de l'image. |
...
| Nom | La description |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/adjustbrightness)(int) | Réglage d'une luminosité pour l'image. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getfullframe)() | Obtient l'image complète. |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor#replacecolor_1)(int, byte, int) | Remplace une couleur par une autre avec la différence autorisée et conserve la valeur alpha d'origine pour enregistrer des bords lisses. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors#replacenontransparentcolors_1)(int) | Remplace toutes les couleurs non transparentes par une nouvelle couleur et conserve la valeur alpha d'origine pour enregistrer des bords lisses. Remarque : si vous l'utilisez sur des images sans transparence, toutes les couleurs seront remplacées par une seule. |
...
| static [CreateFlags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/createflags)(IColorPalette, bool, bool) | Crée les drapeaux. |
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette)(IColorPalette, IColorPalette) | Obtient la palette de couleurs associée. |

## Des champs

| Nom | La description |
| --- | --- |
| const [ExtensionLabel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/extensionlabel) | Étiquette d'extension de bloc. |
| const [ImageDescriptorSize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/imagedescriptorsize) | La taille du descripteur d'image. |
