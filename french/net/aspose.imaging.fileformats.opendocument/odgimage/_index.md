...
description: Le graphique de document ouvert
type: docs
weight: 7390
url: /fr/net/aspose.imaging.fileformats.opendocument/odgimage/
---
## OdgImage class
...
| Nom | La description |
| --- | --- |
| [OdgImage](odgimage#constructor)(StreamContainer) | Initialise une nouvelle instance du[`OdgImage`](../odgimage) classe. |
| [OdgImage](odgimage#constructor_1)(StreamContainer, LoadOptions) | Initialise une nouvelle instance du[`OdgImage`](../odgimage) classe. |
...
| override [FileFormat](../../aspose.imaging.fileformats.opendocument/odgimage/fileformat) { get; } | Obtient une valeur de format de fichier |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.opendocument/odgimage/getdefaultoptions)(object[]) | Récupère les options par défaut. |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_1)(int, int, ImageResizeSettings) | Redimensionne l'image. |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_2)(int, int, ResizeType) | Redimensionne l'image. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.opendocument/odgimage/rotateflip)(RotateFlipType) | Fait pivoter, retourne ou fait pivoter et retourne l'image. |
