...
description: Dessine la chaîne de texte.
type: docs
weight: 80
url: /fr/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawstring/
---
...
| --- | --- | --- |
| font | Font | La police utilisée pour rendre le texte. |
| text | String | La chaîne de texte unicode. |
| origin | Point | Le coin supérieur gauche du texte s'exécute. |
| textColor | Color | La couleur du texte. |
