...
description: Remplit un arc représentant une portion dellipse spécifiée par une structure Rectangle.
type: docs
weight: 100
url: /fr/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/fillarc/
---
## SvgGraphics2D.FillArc method

Remplit un arc représentant une portion d'ellipse spécifiée par une structure Rectangle.
...
| brush | Brush | Le pinceau pour remplir l'intérieur de la figure. |
...
| arcAngle | Single | L'angle en degrés mesuré dans le sens des aiguilles d'une montre à partir du paramètre startAngle jusqu'au point de fin de l'arc. |
