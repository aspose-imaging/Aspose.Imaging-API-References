...
description: Dessine limage spécifiée à lemplacement spécifié.
type: docs
weight: 40
url: /fr/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawimage/
---
...
| --- | --- | --- |
| image | RasterImage | L'image dessinée. |
| origin | Point | L'emplacement de l'image dessinée. |
...
| image | RasterImage | L'image dessinée. |
| origin | Point | L'emplacement de l'image dessinée. |
| size | Size | La taille souhaitée de l'image dessinée. |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| srcRect | Rectangle | La partie de l'objet image à dessiner. |
| destRect | Rectangle | L'emplacement et la taille de l'image dessinée. L'image est mise à l'échelle pour s'adapter au rectangle. |
