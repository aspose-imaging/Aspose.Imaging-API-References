...
description: Dessine le cube de Bézier.
type: docs
weight: 30
url: /fr/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawcubicbezier/
---
## SvgGraphics2D.DrawCubicBezier method

Dessine le cube de Bézier.
...
| --- | --- | --- |
| pen | Pen | Le stylo qui détermine la couleur, la largeur et le style de la figure. |
| pt1 | PointF | Le point de départ de la courbe. |
| pt2 | PointF | Le premier point de contrôle de la courbe. |
| pt3 | PointF | Le deuxième point de contrôle de la courbe. |
| pt4 | PointF | Le point final de la courbe. |
