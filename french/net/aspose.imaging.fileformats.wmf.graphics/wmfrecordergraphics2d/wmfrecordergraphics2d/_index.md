...
description: Initialise une nouvelle instance duWmfRecorderGraphics2Daspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d classe.
type: docs
weight: 10
url: /fr/net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/wmfrecordergraphics2d/
---
## WmfRecorderGraphics2D constructor

Initialise une nouvelle instance du[`WmfRecorderGraphics2D`](../../wmfrecordergraphics2d) classe.
...
| --- | --- | --- |
| frame | Rectangle | Rectangle de destination, mesuré en twips, pour afficher le métafichier. |
| inch | Int32 | Le nombre de pixels par pouce. |
