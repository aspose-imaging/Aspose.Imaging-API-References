...
description: Obtient ou définit lID de limage.
type: docs
weight: 160
url: /fr/net/aspose.imaging.fileformats.tga/tgaimage/imageid/
---
## TgaImage.ImageId property

Obtient ou définit l'ID de l'image.

Ce champ facultatif contient des informations d'identification sur l'image. La longueur maximale pour ce champ est de 255 octets.
