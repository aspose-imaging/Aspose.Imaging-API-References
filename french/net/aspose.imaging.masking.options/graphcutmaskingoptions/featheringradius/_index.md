...
description: Obtient ou définit le rayon de contour progressif.
type: docs
weight: 20
url: /fr/net/aspose.imaging.masking.options/graphcutmaskingoptions/featheringradius/
---
## GraphCutMaskingOptions.FeatheringRadius property

Obtient ou définit le rayon de contour progressif.
...
Enregistrement du résultat du masquage de l'image Graph Cut avec l'adoucissement défini sur 3. Le masquage de l'image est effectué à l'aide du tableau de points spécifié.
