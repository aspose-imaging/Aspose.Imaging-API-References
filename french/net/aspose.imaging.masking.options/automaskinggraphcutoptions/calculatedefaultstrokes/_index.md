...
description: Obtient ou définit une valeur indiquant si les traits par défaut doivent être calculés.
type: docs
weight: 30
url: /fr/net/aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes/
---
## AutoMaskingGraphCutOptions.CalculateDefaultStrokes property

Obtient ou définit une valeur indiquant si les traits par défaut doivent être calculés.
