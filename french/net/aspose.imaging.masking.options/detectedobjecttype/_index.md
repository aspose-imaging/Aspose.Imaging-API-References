...
description: Lénumération des types dobjets détectés.
type: docs
weight: 10470
url: /fr/net/aspose.imaging.masking.options/detectedobjecttype/
---
...
| --- | --- | --- |
| Human | `0` | Le type d'objet humain. |
| Other | `1` | Autre type d'objet. |
