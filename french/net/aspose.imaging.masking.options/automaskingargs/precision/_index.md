...
description: Obtient ou définit la précision de la méthode de segmentation facultatif.
type: docs
weight: 70
url: /fr/net/aspose.imaging.masking.options/automaskingargs/precision/
---
## AutoMaskingArgs.Precision property

Obtient ou définit la précision de la méthode de segmentation (facultatif).
...
La précision de la méthode de segmentation (facultatif).
