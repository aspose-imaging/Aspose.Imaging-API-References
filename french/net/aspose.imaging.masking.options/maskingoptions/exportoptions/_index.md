...
description: Obtient ou définit les options dexportation dimage.
type: docs
weight: 50
url: /fr/net/aspose.imaging.masking.options/maskingoptions/exportoptions/
---
## MaskingOptions.ExportOptions property

Obtient ou définit les options d'exportation d'image.
...
Les options d'exportation d'image qui seront utilisées pour créer les images résultantes.
