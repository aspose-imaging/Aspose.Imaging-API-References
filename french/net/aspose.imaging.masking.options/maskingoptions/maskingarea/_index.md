...
description: Obtient ou définit la zone de masquage.
type: docs
weight: 60
url: /fr/net/aspose.imaging.masking.options/maskingoptions/maskingarea/
---
## MaskingOptions.MaskingArea property

Obtient ou définit la zone de masquage.
...
La zone de masquage qui est une zone partielle de l'image source. Rectangle.La valeur vide signifie une zone d'image source complète.
