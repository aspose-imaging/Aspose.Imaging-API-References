...
description: Obtient ou définit une valeur indiquant si inutile de séparer chaque forme du masque en tant quobjet individuel ou en tant quobjet uni du masque séparé de larrière-plan.
type: docs
weight: 40
url: /fr/net/aspose.imaging.masking.options/maskingoptions/decompose/
---
...
`vrai`si décomposer; Par ailleurs,`faux` .
