...
description: Obtient ou définit la couleur de remplacement de larrière-plan.
type: docs
weight: 30
url: /fr/net/aspose.imaging.masking.options/maskingoptions/backgroundreplacementcolor/
---
## MaskingOptions.BackgroundReplacementColor property

Obtient ou définit la couleur de remplacement de l'arrière-plan.
...
La couleur de remplacement de l'arrière-plan. Cette couleur sera utilisée comme couleur d'arrière-plan dans les images résultantes.
