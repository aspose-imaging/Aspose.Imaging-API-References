...
description: Initialise une nouvelle instance duAssumedObjectDataaspose.imaging.masking.options/assumedobjectdata classe.
type: docs
weight: 10
url: /fr/net/aspose.imaging.masking.options/assumedobjectdata/assumedobjectdata/
---
## AssumedObjectData() {#constructor}

Initialise une nouvelle instance du[`AssumedObjectData`](../../assumedobjectdata) classe.
...
| --- | --- | --- |
| type | DetectedObjectType | Le type de l'objet. |
| bounds | Rectangle | Les limites de l'objet. |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| type | String | Le type de l'objet. |
| bounds | Rectangle | Les limites de l'objet. |
