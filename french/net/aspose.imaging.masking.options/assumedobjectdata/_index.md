...
description: Les données de lobjet supposé. Inclut le type et la zone de lobjet.
type: docs
weight: 10440
url: /fr/net/aspose.imaging.masking.options/assumedobjectdata/
---
...
| Nom | La description |
| --- | --- |
| [AssumedObjectData](assumedobjectdata#constructor)() | Initialise une nouvelle instance du[`AssumedObjectData`](../assumedobjectdata) classe. |
| [AssumedObjectData](assumedobjectdata#constructor_1)(DetectedObjectType, Rectangle) | Initialise une nouvelle instance du[`AssumedObjectData`](../assumedobjectdata) classe. |
| [AssumedObjectData](assumedobjectdata#constructor_2)(string, Rectangle) | Initialise une nouvelle instance du[`AssumedObjectData`](../assumedobjectdata) classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [Bounds](../../aspose.imaging.masking.options/assumedobjectdata/bounds) { get; set; } | Obtient ou définit les limites de l'objet. |
| [Type](../../aspose.imaging.masking.options/assumedobjectdata/type) { get; set; } | Obtient ou définit le type de l'objet. |
