...
description: Les options de rastérisation Cdr
type: docs
weight: 9920
url: /fr/net/aspose.imaging.imageoptions/cdrrasterizationoptions/
---
## CdrRasterizationOptions class

Les options de rastérisation Cdr
...
| [ScaleX](../../aspose.imaging.imageoptions/cdrrasterizationoptions/scalex) { get; set; } | Obtient ou définit l'échelle x. |
| [ScaleY](../../aspose.imaging.imageoptions/cdrrasterizationoptions/scaley) { get; set; } | Obtient ou définit l'échelle y. |
