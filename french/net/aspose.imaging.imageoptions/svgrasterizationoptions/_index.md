...
description: Les options de pixellisation SVG.
type: docs
weight: 10200
url: /fr/net/aspose.imaging.imageoptions/svgrasterizationoptions/
---
## SvgRasterizationOptions class

Les options de pixellisation SVG.
...
| [ScaleX](../../aspose.imaging.imageoptions/svgrasterizationoptions/scalex) { get; set; } | Obtient ou définit l'échelle x. |
| [ScaleY](../../aspose.imaging.imageoptions/svgrasterizationoptions/scaley) { get; set; } | Obtient ou définit l'échelle y. |
