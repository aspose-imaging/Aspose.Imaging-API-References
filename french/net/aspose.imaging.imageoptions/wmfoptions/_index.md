...
description: Les options wmf.
type: docs
weight: 10290
url: /fr/net/aspose.imaging.imageoptions/wmfoptions/
---
## WmfOptions class
...
L'exemple suivant montre comment convertir une image vectorielle multipage au format WMF de manière générale sans faire référence à un type d'image particulier.
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    ...
    // Exporte uniquement les deux premières pages. En fait, une seule page sera convertie car WMF n'est pas un format multi-pages.
