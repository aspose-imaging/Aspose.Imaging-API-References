...
description: Les graphismes de lenregistreur Emf
type: docs
weight: 6490
url: /fr/net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/
---
## EmfRecorderGraphics2D class

Les graphismes de l'enregistreur Emf
...
| Nom | La description |
| --- | --- |
| [EmfRecorderGraphics2D](emfrecordergraphics2d)(Rectangle, Size, Size) | Initialise une nouvelle instance du[`EmfRecorderGraphics2D`](../emfrecordergraphics2d) classe. |
...
| [BackgroundMode](../../aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/backgroundmode) { get; set; } | Obtient ou définit le mode d'arrière-plan. |
...
| Nom | La description |
| --- | --- |
| static [FromEmfImage](../../aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/fromemfimage)(EmfImage) | Obtient une instance de[`EmfRecorderGraphics2D`](../emfrecordergraphics2d) contenant tous les enregistrements de l'image Emf. |
...
| [EndRecording](../../aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/endrecording)() | Termine l'enregistrement. |
