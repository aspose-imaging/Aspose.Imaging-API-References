...
description: Dessine un arc représentant une portion dellipse spécifiée par une structure Rectangle.
type: docs
weight: 50
url: /fr/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawarc/
---
## MetafileRecorderGraphics2D.DrawArc method

Dessine un arc représentant une portion d'ellipse spécifiée par une structure Rectangle.
...
| arcAngle | Single | Angle en degrés mesuré dans le sens des aiguilles d'une montre à partir du paramètre startAngle jusqu'au point de fin de l'arc. |
