...
description: Enregistrer létat de la session dans le flux spécifié.
type: docs
weight: 50
url: /fr/net/aspose.imaging.masking/imaskingsession/save/
---
## Save(Stream) {#save}

Enregistrer l'état de la session dans le flux spécifié.
