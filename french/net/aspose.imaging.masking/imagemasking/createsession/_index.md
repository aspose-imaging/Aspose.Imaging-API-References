...
description: Crée la session de masquage qui peut effectuer des opérations de décomposition de recyclage.
type: docs
weight: 20
url: /fr/net/aspose.imaging.masking/imagemasking/createsession/
---
## ImageMasking.CreateSession method

Crée la session de masquage qui peut effectuer des opérations de décomposition de recyclage.
...
| --- | --- | --- |
| options | MaskingOptions | Les options. |
