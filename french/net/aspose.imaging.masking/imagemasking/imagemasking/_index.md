...
description: Initialise une nouvelle instance duImageMaskingaspose.imaging.masking/imagemasking classe.
type: docs
weight: 10
url: /fr/net/aspose.imaging.masking/imagemasking/imagemasking/
---
## ImageMasking constructor

Initialise une nouvelle instance du[`ImageMasking`](../../imagemasking) classe.
...
| --- | --- | --- |
| sourceImage | RasterImage | L'image source. |

### Exceptions

| exception | condition |
| --- | --- |
| ArgumentNullException | l'image source est nulle. |
