...
description: Charger la session à partir du flux spécifié.
type: docs
weight: 50
url: /fr/net/aspose.imaging.masking/imagemasking/loadsession/
---
## LoadSession(Stream) {#loadsession}

Charger la session à partir du flux spécifié.
...
la session de masquage qui peut effectuer des opérations de décomposition de réapprentissage.
...
Charger la session à partir du fichier spécifié.
