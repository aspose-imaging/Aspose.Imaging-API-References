...
description: La nouvelle image png.
type: docs
weight: 7450
url: /fr/net/aspose.imaging.fileformats.png/pngimage/
---
## PngImage class

La nouvelle image png.
...
| Nom | La description |
| --- | --- |
| [PngImage](pngimage#constructor_1)(RasterImage) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
| [PngImage](pngimage#constructor_5)(Stream) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
| [PngImage](pngimage#constructor_6)(string) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
| [PngImage](pngimage#constructor_3)(int, int) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
| [PngImage](pngimage#constructor_2)(RasterImage, PngColorType) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
| [PngImage](pngimage#constructor_7)(string, PngColorType) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
| [PngImage](pngimage#constructor_4)(int, int, PngColorType) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
| [PngImage](pngimage#constructor)(PngOptions, int, int) | Initialise une nouvelle instance du[`PngImage`](../pngimage) classe. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.png/pngimage/backgroundcolor) { get; set; } | Obtient la couleur d'arrière-plan. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.png/pngimage/bitsperpixel) { get; } | Obtient les bits par pixel. |
...
| override [FileFormat](../../aspose.imaging.fileformats.png/pngimage/fileformat) { get; } | Obtient une valeur de format de fichier |
| override [HasAlpha](../../aspose.imaging.fileformats.png/pngimage/hasalpha) { get; } | Obtenir une valeur indiquant si cette instance a alpha. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.png/pngimage/hasbackgroundcolor) { get; set; } | Obtient une valeur indiquant s'il a une couleur d'arrière-plan. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.png/pngimage/hastransparentcolor) { get; set; } | Obtient une valeur indiquant si l'image a une couleur transparente. |
| override [Height](../../aspose.imaging.fileformats.png/pngimage/height) { get; } | Obtient la hauteur. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.png/pngimage/horizontalresolution) { get; set; } | Obtient ou définit la résolution horizontale. |
| virtual [ImageOpacity](../../aspose.imaging/rasterimage/imageopacity) { get; } | Obtient l'opacité de cette image. |
| [Interlaced](../../aspose.imaging.fileformats.png/pngimage/interlaced) { get; } | Obtient une valeur indiquant si cela[`PngImage`](../pngimage) est entrelacé. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.png/pngimage/isinterlaced) { get; } | Obtient une valeur indiquant si cette instance d'image est entrelacée. |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.png/pngimage/rawdataformat) { get; } | Obtient le format des données brutes. |
...
| override [TransparentColor](../../aspose.imaging.fileformats.png/pngimage/transparentcolor) { get; set; } | Obtient la couleur transparente. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.png/pngimage/verticalresolution) { get; set; } | Obtient ou définit la résolution verticale. |
| override [Width](../../aspose.imaging.fileformats.png/pngimage/width) { get; } | Obtient la largeur. |
| override [XmpData](../../aspose.imaging.fileformats.png/pngimage/xmpdata) { get; set; } | Obtient ou définit les métadonnées XMP. |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.png/pngimage/getdefaultoptions)(object[]) | Récupère les options par défaut. |
...
| override [GetModifyDate](../../aspose.imaging.fileformats.png/pngimage/getmodifydate)(bool) | Obtient la date et l'heure de la dernière modification de l'image de ressource. |
| override [GetOriginalOptions](../../aspose.imaging.fileformats.png/pngimage/getoriginaloptions)() | Obtient les options basées sur les paramètres du fichier d'origine. Cela peut être utile pour conserver la profondeur de bits et d'autres paramètres de l'image d'origine inchangés. Par exemple, si nous chargeons une image PNG noir-blanc avec 1 bit par pixel, puis enregistrez-le en utilisant the [`Save`](../../aspose.imaging/datastreamsupporter/save) , l'image PNG de sortie avec 8 bits par pixel sera produite. Pour l'éviter et enregistrer l'image PNG avec 1 bit par pixel, utilisez cette méthode pour obtenir les options d'enregistrement correspondantes et passez-les au[`Save`](../../aspose.imaging/image/save) méthode comme deuxième paramètre. |
