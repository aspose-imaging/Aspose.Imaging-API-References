...
description: Les types denregistrement de transformation spécifient les propriétés et les transformations sur les espaces de coordonnées.
type: docs
weight: 6450
url: /fr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplustransformrecordtype/
---
## EmfPlusTransformRecordType class

Les types d'enregistrement de transformation spécifient les propriétés et les transformations sur les espaces de coordonnées.
