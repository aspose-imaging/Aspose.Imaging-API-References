...
description: Les types denregistrements de découpage spécifient les régions et les opérations de découpage.
type: docs
weight: 5870
url: /fr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusclippingrecordtype/
---
## EmfPlusClippingRecordType class

Les types d'enregistrements de découpage spécifient les régions et les opérations de découpage.
