...
description: Les types denregistrement de contrôle spécifient les paramètres globaux pour le traitement du métafichier EMF.
type: docs
weight: 5890
url: /fr/net/aspose.imaging.fileformats.emf.emfplus.records/emfpluscontrolrecordtype/
---
## EmfPlusControlRecordType class

Les types d'enregistrement de contrôle spécifient les paramètres globaux pour le traitement du métafichier EMF+.
