...
description: Lenregistrement EmfPlusSetTextRenderingHint spécifie la qualité du rendu du texte y compris le type danticrénelage.
type: docs
weight: 6390
url: /fr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/
---
## EmfPlusSetTextRenderingHint class

L'enregistrement EmfPlusSetTextRenderingHint spécifie la qualité du rendu du texte, y compris le type d'anticrénelage.
...
| Nom | La description |
| --- | --- |
| [EmfPlusSetTextRenderingHint](emfplussettextrenderinghint)(EmfPlusRecord) | Initialise une nouvelle instance du[`EmfPlusSetTextRenderingHint`](../emfplussettextrenderinghint) classe. |
...
| [TextRenderingHint](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/textrenderinghint) { get; set; } | Obtient ou définit la valeur de l'indice de rendu de texte, à partir de l'énumération TextRenderingHint (section 2.1.1.32), qui spécifie la qualité à utiliser dans le rendu de texte ultérieur. |
