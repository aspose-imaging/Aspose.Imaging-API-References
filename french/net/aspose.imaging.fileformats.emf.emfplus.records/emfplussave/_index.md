...
description: Lenregistrement EmfPlusSave enregistre létat graphique identifié par un index spécifié sur une pile détats graphiques enregistrés.
type: docs
weight: 6250
url: /fr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussave/
---
## EmfPlusSave class

L'enregistrement EmfPlusSave enregistre l'état graphique, identifié par un index spécifié, sur une pile d'états graphiques enregistrés.
...
| Nom | La description |
| --- | --- |
| [EmfPlusSave](emfplussave)(EmfPlusRecord) | Initialise une nouvelle instance du[`EmfPlusSave`](../emfplussave) classe. |
...
| [StackIndex](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussave/stackindex) { get; set; } | Obtient ou définit un entier non signé 32 bits qui spécifie un niveau à associer à l'état graphique . La valeur de niveau peut être utilisée par une opération ultérieure d'enregistrement EmfPlusRestore (section 2.3.7.4) pour récupérer l'état graphique. |
