---
title: "TiffByteType Classe"
type: docs
weight: 20
url: /fr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffByteType(tag_id)](#TiffByteType_tag_id_1) | Initialise une nouvelle instance de la classe [TiffByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/). |
| [TiffByteType(tag_id)](#TiffByteType_tag_id_2) | Initialise une nouvelle instance de la classe [TiffByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/). |
## **Properties**
...
| values | System.Byte | r/w | Obtient ou définit les valeurs. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initialise une nouvelle instance de la classe [TiffByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/). |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initialise une nouvelle instance de la classe [TiffByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/). |
...
Initialise une nouvelle instance de la classe [TiffByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/).
