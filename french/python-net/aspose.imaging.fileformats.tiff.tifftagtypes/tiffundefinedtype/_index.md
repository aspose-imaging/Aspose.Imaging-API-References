---
title: "TiffUndefinedType Classe"
type: docs
weight: 170
url: /fr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_1) | Initialise une nouvelle instance de la classe [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_2) | Initialise une nouvelle instance de la classe [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| count | int | r | Obtient le nombre d'éléments. |
| données | System.Byte | r/w | Obtient ou définit les données. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initialise une nouvelle instance de la classe [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initialise une nouvelle instance de la classe [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
...
Initialise une nouvelle instance de la classe [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/).
