---
title: "TiffSShortType Classe"
type: docs
weight: 150
url: /fr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---

**Summary:** The tiff signed short type.

**Module:** [aspose.imaging.fileformats.tiff.tifftagtypes](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/)

**Full Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffSShortType
...
| **Name** | **Description** |
| :- | :- |
| [TiffSShortType(tag_id)](#TiffSShortType_tag_id_1) | Initialise une nouvelle instance de la classe [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/). |
| [TiffSShortType(tag_id)](#TiffSShortType_tag_id_2) | Initialise une nouvelle instance de la classe [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/). |
## **Properties**
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initialise une nouvelle instance de la classe [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/). |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initialise une nouvelle instance de la classe [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/). |
...
### Constructor: TiffSShortType(tag_id) {#TiffSShortType_tag_id_1}


```
 TiffSShortType(tag_id) 
```

Initialise une nouvelle instance de la classe [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/).
...
### Constructor: TiffSShortType(tag_id) {#TiffSShortType_tag_id_2}
