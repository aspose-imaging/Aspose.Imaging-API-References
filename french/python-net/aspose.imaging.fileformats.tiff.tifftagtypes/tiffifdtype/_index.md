---
title: "TiffIfdType Classe"
type: docs
weight: 70
url: /fr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/
---

**Summary:** Represents the TIFF Exif image file directory type class.

**Module:** [aspose.imaging.fileformats.tiff.tifftagtypes](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/)

**Full Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffIfdType
...
| **Name** | **Description** |
| :- | :- |
| [TiffIfdType(tag_id)](#TiffIfdType_tag_id_1) | Initialise une nouvelle instance de la [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) classe. |
| [TiffIfdType(tag_id)](#TiffIfdType_tag_id_2) | Initialise une nouvelle instance de la [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) classe. |
## **Properties**
...
| values | int[] | r/w | Obtient ou définit les valeurs. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initialise une nouvelle instance de la [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) classe. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initialise une nouvelle instance de la [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) classe. |
...
### Constructor: TiffIfdType(tag_id) {#TiffIfdType_tag_id_1}
...
Initialise une nouvelle instance de la [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) classe.
...
### Constructor: TiffIfdType(tag_id) {#TiffIfdType_tag_id_2}
...
| Type | Description |
| :- | :- |
| [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) |  |
