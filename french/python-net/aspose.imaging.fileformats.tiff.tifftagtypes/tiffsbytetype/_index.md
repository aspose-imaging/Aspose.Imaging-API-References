---
title: "TiffSByteType Classe"
type: docs
weight: 110
url: /fr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/
---

**Summary:** The tiff signed byte type.

**Module:** [aspose.imaging.fileformats.tiff.tifftagtypes](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/)

**Full Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffSByteType
...
| **Name** | **Description** |
| :- | :- |
| [TiffSByteType(tag_id)](#TiffSByteType_tag_id_1) | Initialise une nouvelle instance de la classe [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/). |
| [TiffSByteType(tag_id)](#TiffSByteType_tag_id_2) | Initialise une nouvelle instance de la classe [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/). |
## **Properties**
...
| values | System.SByte | r/w | Obtient ou définit les valeurs. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initialise une nouvelle instance de la classe [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/). |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initialise une nouvelle instance de la classe [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/). |
...
### Constructor: TiffSByteType(tag_id) {#TiffSByteType_tag_id_1}


```
 TiffSByteType(tag_id) 
```

Initialise une nouvelle instance de la classe [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/).
...
### Constructor: TiffSByteType(tag_id) {#TiffSByteType_tag_id_2}
...
| Type | Description |
| :- | :- |
| [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) |  |
