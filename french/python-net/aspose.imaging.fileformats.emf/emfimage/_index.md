---
title: "Classe EmfImage"
type: docs
weight: 680
url: /fr/python-net/aspose.imaging.fileformats.emf/emfimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfImage()](#EmfImage__1) | Commencez à travailler avec les images EMF en initialisant une nouvelle instance de la<br/>            [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) classe. Idéal pour incorporer rapidement des images EMF dans <br/>            vos projets avec aisance et efficacité. |
| [EmfImage(width, height)](#EmfImage_width_height_2) | Créez une nouvelle instance de la [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) classe en spécifiant les paramètres de largeur <br/>            et de hauteur. Ce constructeur simplifie le processus d'initialisation <br/>            des images EMF avec des dimensions spécifiques, améliorant l'efficacité de votre flux de travail de développement <br/>            workflow. |
## **Properties**
...
| bits_per_pixel | int | r | Récupérez le nombre de bits par pixel spécifique aux images raster, car ce paramètre <br/>            ne s'applique pas aux images vectorielles. Déterminez rapidement la profondeur de pixel des images raster pour une analyse et une manipulation précises, garantissant une gestion exacte<br/>            des données d'image. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Accédez à la valeur du format de fichier associée à l'objet. Déterminez facilement le <br/>            format du fichier lié à l'objet pour un traitement simplifié et <br/>            des vérifications de compatibilité. Simplifiez votre flux de travail en récupérant les informations de format de fichier <br/>            avec aisance. |
| has_background_color | bool | r/w | Obtient ou définit une valeur indiquant si l'image possède une couleur d'arrière-plan. |
| header | [EmfMetafileHeader](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheader/) | r/w | Récupérez ou modifiez l'enregistrement d'en-tête du métafichier EMF avec cette propriété. Idéal pour <br/>            gérer les données du métafichier efficacement au sein de votre application. Améliorez votre flux de travail <br/>            grâce à un accès simplifié aux informations d'en-tête du métafichier. |
| height | int | r | Obtient la hauteur de l'objet. |
| height_f | float | r | Récupérez la hauteur de l'image, facilitant un rendu précis et des ajustements de mise en page. <br/>            L'accès à la propriété de hauteur assure la compatibilité et une intégration fluide sur <br/>            différentes plateformes et applications. |
...
| is_cached | bool | r | Accédez à une valeur indiquant si les données de l'objet sont actuellement en cache, <br/>            éliminant le besoin de lectures de données supplémentaires. Améliorez l'efficacité en déterminant rapidement <br/>            si des données en cache sont disponibles pour un accès immédiat. Optimisez votre <br/>            flux de travail avec des processus de récupération de données simplifiés. |
...
| records | [MetaObjectList](/imaging/python-net/aspose.imaging.fileformats.emf/metaobjectlist/) | r/w | Récupérez ou modifiez les enregistrements associés à l'objet. Accédez efficacement et <br/>            gérez la collection d'enregistrements pour une manipulation et un traitement de données améliorés. <br/>            Optimisez votre flux de travail en interagissant de manière transparente avec les enregistrements de l'objet. |
...
| width_f | float | r | Accédez à la largeur de l'image, fournissant des informations essentielles pour un rendu <br/>            et un traitement précis. Récupérez rapidement la largeur de l'image pour assurer la compatibilité <br/>            et une mise en page correcte dans diverses applications et plateformes. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Obtient ou définit les données Xmp. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| cache_data() | Mettez en cache les données efficacement et évitez le chargement redondant depuis le <br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) sous-jacent avec cette méthode. Améliorez <br/>            les performances et simplifiez l'accès aux données dans votre application, optimisant l'utilisation des ressources <br/>            pour une meilleure réactivité. |
...
| [get_missed_fonts()](#get_missed_fonts__29) | Renvoie la liste des polices utilisées à l'intérieur du métafichier mais non trouvées. |
| [get_original_options()](#get_original_options__30) | Obtient les options d'image d'origine. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_31) | Obtient une hauteur proportionnelle. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_32) | Obtient une largeur proportionnelle. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_33) | Convertit en aps. |
| [get_used_fonts()](#get_used_fonts__34) | Récupérez la liste des polices utilisées dans le métafichier avec cette méthode. Obtenez <br/>            des informations sur l'utilisation des polices, facilitant une gestion efficace et l'optimisation des ressources de polices pour un rendu et une fidélité d'affichage améliorés. |
...
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_48) | Redimensionnez le canevas facilement en utilisant cette fonction. Parfait pour ajuster les <br/>            dimensions globales de l'image sans modifier son contenu. Améliorez la présentation et <br/>            préparez les images pour diverses tailles d'affichage sans effort. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_49) | Redimensionne la hauteur proportionnellement. Le défaut [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) est utilisé. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_50) | Redimensionne la hauteur proportionnellement. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_51) | Redimensionne la hauteur proportionnellement. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_52) | Redimensionne la hauteur proportionnellement. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_53) | Redimensionne la largeur proportionnellement. Le défaut [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) est utilisé. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_54) | Redimensionne la largeur proportionnellement. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_55) | Redimensionne la largeur proportionnellement. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_56) | Redimensionne la largeur proportionnellement. |
| [rotate(angle)](#rotate_angle_57) | Faire pivoter l'image autour du centre. |
...
| [save(file_path)](#save_file_path_59) | Enregistre l'image à l'emplacement de fichier spécifié. |
| [save(file_path, options)](#save_file_path_options_60) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_61) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
...
| [save(stream)](#save_stream_63) | Enregistre les données dans le _stream_ spécifié. |
| [save(stream, options_base)](#save_stream_options_base_64) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_65) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_to_stream(stream)](#save_to_stream_stream_66) | Enregistre les données de l'objet dans le flux spécifié. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_67) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_68) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_69) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_70) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_71) | Définit la palette d'image. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_72) | Essaie de définir une instance _metadata_, si cette instance [Image](/imaging/python-net/aspose.imaging/image/) prend en charge et implémente l'instance [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
...
Commencez à travailler avec les images EMF en initialisant une nouvelle instance de la<br/>            [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) classe. Idéal pour incorporer rapidement des images EMF dans <br/>            vos projets avec aisance et efficacité.
...
Créez une nouvelle instance de la [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) classe en spécifiant les paramètres de largeur <br/>            et de hauteur. Ce constructeur simplifie le processus d'initialisation <br/>            des images EMF avec des dimensions spécifiques, améliorant l'efficacité de votre flux de travail de développement <br/>            workflow.
...
Récupérez la liste des polices utilisées dans le métafichier avec cette méthode. Obtenez <br/>            des informations sur l'utilisation des polices, facilitant une gestion efficace et l'optimisation des ressources de polices pour un rendu et une fidélité d'affichage améliorés.
...
Redimensionnez le canevas facilement en utilisant cette fonction. Parfait pour ajuster les <br/>            dimensions globales de l'image sans modifier son contenu. Améliorez la présentation et <br/>            préparez les images pour diverses tailles d'affichage sans effort.
