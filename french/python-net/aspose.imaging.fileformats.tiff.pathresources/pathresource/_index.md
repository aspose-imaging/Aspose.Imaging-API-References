...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.fileformats.tiff.pathresources/pathresource/
---
...
| **Name** | **Description** |
| :- | :- |
| [PathResource()](#PathResource__1) | Initialise une nouvelle instance de la classe PathResource |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| block_id | int | r/w | Obtient ou définit l'identifiant du bloc. |
| nom | string | r/w | Obtient ou définit le nom. |
| enregistrements | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Core.VectorPaths.VectorPathRecord]] | r/w | Obtient ou définit les enregistrements. |
...
Initialise une nouvelle instance de la classe PathResource
