---
title: "EmfCommentMultiFormats Classe"
type: docs
weight: 210
url: /fr/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentmultiformats/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfCommentMultiFormats(source)](#EmfCommentMultiFormats_source_1) | Initialise une nouvelle instance de la classe [EmfCommentMultiFormats](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentmultiformats/) |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| a_formats | [EmfFormat[]](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfformat/) | r/w | Obtient ou définit un tableau de longueur CountFormats de formats graphiques, spécifié par <br/>            EmrFormat objects (section 2.2.4), dans l'ordre de préférence |
...
| format_data | System.Byte[] | r/w | Obtient ou définit un tableau de octets de longueur variable contenant les données d'image pour tous les formats graphiques <br/>            contenus dans cet enregistrement. <br/>            La taille des données pour chaque image est fournie par le champ DataSize dans l'objet EmrFormat correspondant <br/>. Ainsi, la taille totale de ce champ est la somme des valeurs DataSize de tous les objets EmrFormat. <br/>            Le format graphique des données pour chaque image est spécifié par le champ Signature dans l'objet EmrFormat correspondant. |
| output_rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r/w | Obtient ou définit un objet WMF RectL ([MS-WMF] section 2.2.2.19) qui spécifie le <br/>            rectangle de sortie, en coordonnées logiques. |
...
Initialise une nouvelle instance de la classe [EmfCommentMultiFormats](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentmultiformats/)
