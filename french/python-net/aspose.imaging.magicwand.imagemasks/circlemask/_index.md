...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.magicwand.imagemasks/circlemask/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircleMask(center, radius)](#CircleMask_center_radius_1) | Initialise une nouvelle instance de la classe [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) avec le point central et le rayon spécifiés. |
| [CircleMask(x, y, radius)](#CircleMask_x_y_radius_2) | Initialise une nouvelle instance de la classe [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) avec le point central et le rayon spécifiés. |
## **Properties**
...
| selection_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Obtient les limites, en pixels, de ce masque. |
...
Initialise une nouvelle instance de la classe [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) avec le point central et le rayon spécifiés.

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| center | [Point](/imaging/python-net/aspose.imaging/point/) | Le point central de la zone sélectionnée. |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Un CircleMask ou ImageBitMask recadré en tant qu'ImageMask.<br/>            Comme un ImageBitMask peut être retourné, un appel fluide est recommandé. |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Un CircleMask gonflé en tant qu'ImageMask. |
