---
title: "Classe RectangleMask"
type: docs
weight: 80
url: /fr/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/
---
...
| **Name** | **Description** |
| :- | :- |
| [RectangleMask(selected_area)](#RectangleMask_selected_area_1) | Initialise une nouvelle instance de la classe [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) avec le rectangle spécifié. |
| [RectangleMask(x, y, width, height)](#RectangleMask_x_y_width_height_2) | Initialise une nouvelle instance de la classe [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) avec le point en haut à gauche, la largeur et la hauteur spécifiés. |
## **Properties**
...
Initialise une nouvelle instance de la classe [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) avec le rectangle spécifié.

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| selected_area | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Zone sélectionnée spécifiée comme un rectangle. |
...
Initialise une nouvelle instance de la classe [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) avec le point en haut à gauche, la largeur et la hauteur spécifiés.

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| x | int | La coordonnée x du point en haut à gauche de la zone sélectionnée. |
| y | int | La coordonnée y du point en haut à gauche de la zone sélectionnée. |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Un RectangleMask recadré en tant qu'ImageMask. |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Un RectangleMask gonflé en tant qu'ImageMask. |
