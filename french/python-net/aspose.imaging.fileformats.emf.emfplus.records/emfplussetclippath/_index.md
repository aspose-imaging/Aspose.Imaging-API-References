...
type: docs
weight: 460
url: /fr/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetclippath/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfPlusSetClipPath(source)](#EmfPlusSetClipPath_source_1) | Initialise une nouvelle instance de la classe [EmfPlusSetClipPath](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetclippath/) |
## **Properties**
...
| object_id | System.Byte | r/w | Obtient ou définit l'index d'un objet EmfPlusPath (section 2.2.1.6) dans la table d'objets EMF+<br/>            . La valeur DOIT être comprise entre 0 et 63, inclusivement. |
...
Initialise une nouvelle instance de la classe [EmfPlusSetClipPath](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetclippath/)
