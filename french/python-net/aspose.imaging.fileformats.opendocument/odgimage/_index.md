...
type: docs
weight: 490
url: /fr/python-net/aspose.imaging.fileformats.opendocument/odgimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [OdgImage(stream_container)](#OdgImage_stream_container_1) | Conçu pour une intégration transparente dans les solutions logicielles, le constructeur [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) <br/>            initialise une nouvelle instance en utilisant un conteneur de flux. Cette méthode <br/>            assure une gestion efficace des données d'image ODG dans les environnements logiciels, optimisant <br/>            l'utilisation des ressources et facilitant des flux de travail de traitement d'image rationalisés. |
| [OdgImage(stream_container, options)](#OdgImage_stream_container_options_2) | Démarrez une nouvelle création de l'objet de classe [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) avec <br/>            l'initialisation d'une nouvelle instance. Exploitez le potentiel d'un conteneur de flux couplé <br/>            aux paramètres d'options de chargement, en conservant un constructeur polyvalent pour charger <br/>            les images de manière fluide. Ce constructeur permet une gestion efficace des images, offrant des configurations de chargement personnalisables <br/>            pour une adaptabilité et des performances accrues dans divers scénarios. |
## **Properties**
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | En récupérant la collection de pages, cette propriété permet d'accéder à l'ensemble <br/>            des pages associées à une image. En accédant à cette propriété, les développeurs peuvent <br/>            itérer à travers les pages individuelles, récupérer des pages spécifiques selon leur index, ou <br/>            effectuer des opérations par lots sur l'ensemble de la collection. |
...
| options | [LoadOptions](/imaging/python-net/aspose.imaging/loadoptions/) | Les options de chargement |
