...
type: docs
weight: 40
url: /fr/python-net/aspose.imaging.fileformats.svg/svgimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [SvgImage(path)](#SvgImage_path_1) | Instancie un nouvel objet de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) , en utilisant le <br/> chemin spécifié pour localiser et charger l'image. Ce constructeur facilite la <br/> création d'instances d'images SVG à partir de fichiers externes, permettant une intégration fluide <br/> dans les systèmes logiciels et les flux de travail. |
| [SvgImage(stream)](#SvgImage_stream_2) | Crée une nouvelle instance de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) , en chargeant l'image <br/> depuis le flux fourni. Ce constructeur permet le chargement direct d'images SVG <br/> depuis des flux, améliorant la flexibilité et l'efficacité dans la gestion des ressources d'image <br/> au sein des applications logicielles. |
| [SvgImage(svg_options, width, height)](#SvgImage_svg_options_width_height_3) | Crée une nouvelle instance de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) avec des options SVG spécifiées, la largeur et la hauteur de l'image. Ce constructeur permet <br/> aux développeurs d'initialiser des images SVG avec des options et des dimensions personnalisées, <br/> offrant une flexibilité dans la gestion du contenu et de la mise en page SVG. |
| [SvgImage(width, height)](#SvgImage_width_height_4) | Instancie un nouvel objet [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) avec la largeur et la hauteur spécifiées. Ce constructeur permet aux développeurs de créer des images SVG avec des dimensions prédéfinies, <br/> facilitant un contrôle précis de la taille de l'image lors de <br/> l'initialisation. |
## **Properties**
...
| bits_per_pixel | int | r | Récupère le nombre de bits par pixel de l'image. Il est important de noter que <br/> ce paramètre ne s'applique pas aux images vectorielles, car elles ne sont pas mesurées en <br/> pixels. Cette propriété fournit des informations cruciales sur la profondeur de couleur de l'image, <br/> aidant aux tâches de traitement et de manipulation. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Récupère le format de fichier de l'image, fournissant des métadonnées essentielles pour <br/> le traitement et les vérifications de compatibilité. Cette propriété est indispensable pour <br/> déterminer les stratégies de décodage et d'encodage appropriées afin de gérer les <br/> données d'image efficacement sur différents systèmes et applications. |
...
| is_cached | bool | r | Récupère une valeur booléenne indiquant si les données de l'objet sont actuellement <br/> en cache, éliminant ainsi le besoin d'opérations de lecture supplémentaires. Cette <br/> propriété donne un aperçu de l'état actuel du cache, optimisant la récupération et le traitement des données <br/> pour améliorer les performances et l'efficacité. |
...
| **Name** | **Description** |
| :- | :- |
| cache_data() | Mise en cache des données et garantie qu'aucun chargement supplémentaire de données ne proviendra <br/> du [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) sous-jacent. Cette <br/> optimisation améliore les performances en éliminant les opérations redondantes de récupération de données, <br/> particulièrement bénéfique dans les scénarios nécessitant un accès fréquent aux <br/> données d'image. |
...
| [create_from_stream(stream)](#create_from_stream_stream_20) | Initialise une nouvelle instance de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/). |
...
| [load(file_path)](#load_file_path_34) | Charge une nouvelle image depuis le chemin de fichier ou l'URL spécifié.<br/>            Si _filePath_ est un chemin de fichier, la méthode ouvre simplement le fichier.<br/>            Si _filePath_ est une URL, la méthode télécharge le fichier, le stocke temporairement, puis l'ouvre. |
| [load(file_path, load_options)](#load_file_path_load_options_35) | Charge une nouvelle image depuis le chemin de fichier ou l'URL spécifié.<br/>            Si _filePath_ est un chemin de fichier, la méthode ouvre simplement le fichier.<br/>            Si _filePath_ est une URL, la méthode télécharge le fichier, le stocke temporairement, puis l'ouvre. |
| [load(stream)](#load_stream_36) | Charge la section SVG. |
| [load(stream, load_options)](#load_stream_load_options_37) | Charge une nouvelle image depuis le flux spécifié. |
| [load_stream(stream)](#load_stream_stream_38) | Charge une nouvelle image depuis le flux spécifié. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_39) | Charge une nouvelle image depuis le flux spécifié. |
...
| [remove_background(settings)](#remove_background_settings_41) | Supprime l'arrière-plan. |
| remove_metadata() | Supprime les métadonnées. |
| [resize(new_width, new_height)](#resize_new_width_new_height_42) | Redimensionne l'image. Le paramètre par défaut [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) est utilisé. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_43) | Redimensionner l'image pour qu'elle corresponde aux dimensions spécifiées tout en préservant son aspect <br/>            ratio. Cette méthode offre un moyen pratique d'ajuster la taille de l'image <br/>            sans déformer ses proportions, garantissant un affichage ou un stockage optimal <br/>            selon les dimensions souhaitées. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_44) | Redimensionne l'image avec des options étendues. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_45) | Redimensionne l'image. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_46) | Redimensionne l'image. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_47) | Redimensionne la hauteur proportionnellement. Le défaut [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) est utilisé. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_48) | Redimensionne la hauteur proportionnellement. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_49) | Redimensionne la hauteur proportionnellement. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_50) | Redimensionne la hauteur proportionnellement. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_51) | Redimensionne la largeur proportionnellement. Le défaut [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) est utilisé. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_52) | Redimensionne la largeur proportionnellement. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_53) | Redimensionne la largeur proportionnellement. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_54) | Redimensionne la largeur proportionnellement. |
| [rotate(angle)](#rotate_angle_55) | Faire pivoter l'image autour du centre. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_56) | Fait pivoter, retourner, ou pivoter et retourner l'image. |
| save() | Enregistre les données de l'image dans le flux sous-jacent. |
| [save(file_path)](#save_file_path_57) | Enregistre l'image à l'emplacement de fichier spécifié. |
| [save(file_path, options)](#save_file_path_options_58) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_59) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save(file_path, over_write)](#save_file_path_over_write_60) | Enregistre les données de l'objet à l'emplacement de fichier spécifié. |
| [save(stream)](#save_stream_61) | Enregistre les données. |
| [save(stream, options_base)](#save_stream_options_base_62) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_63) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_to_stream(stream)](#save_to_stream_stream_64) | Enregistre les données de l'objet dans le flux spécifié. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_65) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_66) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | Applique une palette spécifiée à l'image, permettant la personnalisation des schémas de couleur <br/>            à des fins esthétiques ou fonctionnelles. Cette méthode offre une flexibilité <br/>            dans la gestion des palettes de couleurs pour répondre à diverses exigences de conception ou d'application. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | Essaie de définir une instance _metadata_, si cette instance [Image](/imaging/python-net/aspose.imaging/image/) prend en charge et implémente l'instance [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
...
Instancie un nouvel objet de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) , en utilisant le <br/> chemin spécifié pour localiser et charger l'image. Ce constructeur facilite la <br/> création d'instances d'images SVG à partir de fichiers externes, permettant une intégration fluide <br/> dans les systèmes logiciels et les flux de travail.
...
Crée une nouvelle instance de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) , en chargeant l'image <br/> depuis le flux fourni. Ce constructeur permet le chargement direct d'images SVG <br/> depuis des flux, améliorant la flexibilité et l'efficacité dans la gestion des ressources d'image <br/> au sein des applications logicielles.
...
Crée une nouvelle instance de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) avec des options SVG spécifiées, la largeur et la hauteur de l'image. Ce constructeur permet <br/> aux développeurs d'initialiser des images SVG avec des options et des dimensions personnalisées, <br/> offrant une flexibilité dans la gestion du contenu et de la mise en page SVG.

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| svg_options | [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/) | Les options SVG. |
...
Instancie un nouvel objet [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) avec la largeur et la hauteur spécifiées. Ce constructeur permet aux développeurs de créer des images SVG avec des dimensions prédéfinies, <br/> facilitant un contrôle précis de la taille de l'image lors de <br/> l'initialisation.
...
Initialise une nouvelle instance de la classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/).
...
Redimensionner l'image pour qu'elle corresponde aux dimensions spécifiées tout en préservant son aspect <br/>            ratio. Cette méthode offre un moyen pratique d'ajuster la taille de l'image <br/>            sans déformer ses proportions, garantissant un affichage ou un stockage optimal <br/>            selon les dimensions souhaitées.
...
Applique une palette spécifiée à l'image, permettant la personnalisation des schémas de couleur <br/>            à des fins esthétiques ou fonctionnelles. Cette méthode offre une flexibilité <br/>            dans la gestion des palettes de couleurs pour répondre à diverses exigences de conception ou d'application.
...
dir_: str = "c:\\temp"
# Chargez une image SVG à partir d'un flux de fichier.
