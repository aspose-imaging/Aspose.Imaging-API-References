...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.fileformats.dng/dngimage/
---
...
| bits_per_pixel | int | r | Découvrez le nombre de bits par pixel de l'image sans effort avec cette <br/>            propriété. Idéal pour comprendre rapidement et avec précision la profondeur de pixel de l'image. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Identifiez le format de fichier de votre image avec cette propriété. Parfait pour <br/>            comprendre le format - des détails simples. |
...
| height | int | r | Récupérez la hauteur de l'image avec cette propriété. Parfait pour déterminer la <br/>            taille verticale de l'image sans tracas. |
...
| img_data | [RawData](/imaging/python-net/aspose.imaging.fileformats.dng.decoder/rawdata/) | r/w | Gérez les données de l'image avec cette propriété. Que vous récupériez ou mettiez à jour, <br/>            cette propriété offre un accès fluide aux données de l'image pour une manipulation <br/>            efficace. |
...
| width | int | r | Accédez à la largeur de l'image avec cette propriété. Idéal pour obtenir la <br/>            taille horizontale de l'image rapidement et efficacement. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_63) | Charge partiellement des pixels ARGB 32 bits (par blocs). |
...
| [save(stream)](#save_stream_100) | Enregistre les données. |
