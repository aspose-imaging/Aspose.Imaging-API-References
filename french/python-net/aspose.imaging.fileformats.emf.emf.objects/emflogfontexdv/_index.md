---
title: "Classe EmfLogFontExDv"
type: docs
weight: 150
url: /fr/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfLogFontExDv(emf_log_font_ex)](#EmfLogFontExDv_emf_log_font_ex_1) | Initialise une nouvelle instance de la classe [EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/). |
## **Properties**
...
| design_vector | [EmfDesignVector](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfdesignvector/) | r/w | Obtient ou définit un objet DesignVector (section 2.2.3). Ce champ NE DOIT PAS dépasser 72 octets. |
...
Initialise une nouvelle instance de la classe [EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/).

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| emf_log_font_ex | [EmfLogFontEx](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontex/) | L’exemple de police de journal EMF. |
