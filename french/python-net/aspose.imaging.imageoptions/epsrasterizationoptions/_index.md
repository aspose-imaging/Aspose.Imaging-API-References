...
type: docs
weight: 110
url: /fr/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [EpsRasterizationOptions()](#EpsRasterizationOptions__1) | Initialise une nouvelle instance de la classe [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/). |
## **Properties**
...
| preview_to_export | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | r/w | Utilisez [EpsImage.get_preview_image(format)](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) pour l'exportation d'aperçu. |
...
Initialise une nouvelle instance de la classe [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/).
