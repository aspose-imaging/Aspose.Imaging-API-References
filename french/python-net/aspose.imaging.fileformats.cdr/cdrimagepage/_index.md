---
title: "Classe CdrImagePage"
type: docs
weight: 210
url: /fr/python-net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
...
**Inheritance:** IObjectWithBounds, IMetadataContainer, IHasExifData, IHasMetadata, IHasXmpData, IObjectWithSizeF, ICdrImage, VectorImage
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Obtient ou définit le document CDR. |
...
| is_cached | bool | r | Obtient une valeur indiquant si les données de l'objet sont actuellement en cache et qu'aucune lecture de données n'est requise. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Obtient les métadonnées de l’image. |
| page_number | int | r | Obtient le numéro de page. |
...
| parent_image | [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) | r | Obtient l'image parente. |
