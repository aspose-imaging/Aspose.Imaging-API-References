...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.xmp.schemas.pdf/pdfpackage/
---
...
| **Name** | **Description** |
| :- | :- |
| [PdfPackage()](#PdfPackage__1) | Initialise une nouvelle instance de la classe [PdfPackage](/imaging/python-net/aspose.imaging.xmp.schemas.pdf/pdfpackage/). |
## **Properties**
...
| [set_keywords(keywords)](#set_keywords_keywords_7) | Définit les mots‑clés. |
| [set_pdf_version(version)](#set_pdf_version_version_8) | Définit la version du PDF. |
| [set_producer(producer)](#set_producer_producer_9) | Définit le nom de l'outil qui a créé le Pdf. |
| [set_prop_value(key, value)](#set_prop_value_key_value_10) | Obtient ou définit l'objet avec la clé spécifiée. |
| [set_trapped(is_trapped)](#set_trapped_is_trapped_11) | Définit le trapped. |
| [set_value(key, value)](#set_value_key_value_12) | Définit la valeur. |
| [set_value(key, value)](#set_value_key_value_13) | Définit la valeur. |
| [set_xmp_type_value(key, value)](#set_xmp_type_value_key_value_14) | Définit la valeur du type XMP. |
| [try_get_value(key, value)](#try_get_value_key_value_15) | Obtient la valeur par la _key_. |
...
Initialise une nouvelle instance de la classe [PdfPackage](/imaging/python-net/aspose.imaging.xmp.schemas.pdf/pdfpackage/).
...
| Paramètre | Type | Description |
| :- | :- | :- |
| mots-clés | string | Les mots-clés. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| is_trapped | bool | si défini sur <c>true</c> le document a été piégé. |
