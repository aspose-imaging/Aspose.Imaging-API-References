...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [BigTiffImage(frame)](#BigTiffImage_frame_1) | Créez une nouvelle instance de la classe [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) en l'initialisant<br/>            avec un paramètre TiffFrame. Idéal pour les développeurs recherchant une méthode pratique<br/>            pour travailler avec les objets BigTiffImage, garantissant flexibilité et facilité d'intégration<br/>            dans leurs projets. |
| [BigTiffImage(frames)](#BigTiffImage_frames_2) | Commencez à utiliser la classe [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) de manière transparente en<br/>            initialisant une nouvelle instance avec une liste de paramètres TiffFrames.<br/>            Parfait pour les développeurs recherchant une méthode simple pour travailler avec<br/>            des objets BigTiffImage contenant plusieurs cadres, assurant l'efficacité de leurs projets. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Obtient le format de fichier de cette instance [Image](/imaging/python-net/aspose.imaging/image/). |
...
| [add_page(page)](#add_page_page_4) | Élargissez sans effort votre image BigTiff en ajoutant une nouvelle page avec cette méthode intuitive.<br/>            Parfait pour les développeurs souhaitant enrichir dynamiquement le contenu de leurs images multipages. |
...
| [create_with_frame(frame)](#create_with_frame_frame_34) | Initialise une nouvelle instance de la classe [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/). |
| [create_with_frames(frames)](#create_with_frames_frames_35) | Initialise une nouvelle instance de la classe [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/). |
...
Créez une nouvelle instance de la classe [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) en l'initialisant<br/>            avec un paramètre TiffFrame. Idéal pour les développeurs recherchant une méthode pratique<br/>            pour travailler avec les objets BigTiffImage, garantissant flexibilité et facilité d'intégration<br/>            dans leurs projets.
...
Commencez à utiliser la classe [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) de manière transparente en<br/>            initialisant une nouvelle instance avec une liste de paramètres TiffFrames.<br/>            Parfait pour les développeurs recherchant une méthode simple pour travailler avec<br/>            des objets BigTiffImage contenant plusieurs cadres, assurant l'efficacité de leurs projets.
...
Élargissez sans effort votre image BigTiff en ajoutant une nouvelle page avec cette méthode intuitive.<br/>            Parfait pour les développeurs souhaitant enrichir dynamiquement le contenu de leurs images multipages.
...
Initialise une nouvelle instance de la classe [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/).
...
| Type | Description |
| :- | :- |
| [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) | Une nouvelle image BigTiffImage qui inclut le cadre. |
