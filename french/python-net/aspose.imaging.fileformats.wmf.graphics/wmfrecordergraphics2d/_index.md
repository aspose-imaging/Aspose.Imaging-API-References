---
title: "Classe WmfRecorderGraphics2D"
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **Description** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | Initialise une nouvelle instance de la classe [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Obtient ou définit la couleur de l'arrière-plan. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | Obtient ou définit le mode d'arrière-plan. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | Obtient une instance de l'enregistreur Wmf pour l'image Wmf existante. |
...
Initialise une nouvelle instance de la classe [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/).

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Rectangle de destination, mesuré en twips, pour l'affichage du métafichier. |
...
| Type | Description |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | L'image résultante. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | L'image Wmf pour laquelle obtenir un recoreder. |

**Returns**

| Type | Description |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | Une instance de la classe [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
