...
type: docs
weight: 40
url: /fr/python-net/aspose.imaging.exif/jpegexifdata/
---
...
| **Name** | **Description** |
| :- | :- |
| [JpegExifData()](#JpegExifData__1) | Initialise une nouvelle instance de la classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/). |
| [JpegExifData(common_tags, exif_tags, gps_tags)](#JpegExifData_common_tags_exif_tags_gps_tags_2) | Initialise une nouvelle instance de la classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) avec des données provenant du tableau. |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_3) | Initialise une nouvelle instance de la classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) avec des données provenant du tableau. |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_4) | Initialise une nouvelle instance de la classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) avec des données provenant du tableau. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| MAX_EXIF_SEGMENT_SIZE [static] | int | r | La taille maximale du segment EXIF autorisée en octets. |
...
| compression | int | r/w | Obtient ou définit la compression. |
...
| maker_notes | [MakerNote[]](/imaging/python-net/aspose.imaging.exif/makernote/) | r | Obtient les notes du fabricant. |
...
| model | string | r/w | Obtient ou définit le modèle. |
...
| photometric_interpretation | int | r/w | Obtient ou définit l'interprétation photométrique. |
...
| planar_configuration | int | r/w | Obtient ou définit la configuration planaire. |
| primary_chromaticities | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Obtient ou définit la chromaticité des trois couleurs primaires de l'image. |
...
| reference_black_white | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Obtient ou définit le noir et blanc de référence. |
| related_sound_file | string | r/w | Obtient ou définit le fichier audio associé. |
| resolution_unit | [ExifUnit](/imaging/python-net/aspose.imaging.exif.enums/exifunit/) | r/w | Obtient ou définit l'unité de résolution. |
| samples_per_pixel | int | r/w | Obtient ou définit les échantillons par pixel. |
...
| software | string | r/w | Obtient ou définit le logiciel. |
...
| transfer_function | int[] | r/w | Obtient ou définit la fonction de transfert. |
...
| x_resolution | [TiffRational](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Obtient ou définit la résolution x. |
| y_cb_cr_coefficients | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Obtient ou définit les coefficients matriciels pour la transformation des données d'image de RGB à YCbCr. |
| y_cb_cr_positioning | [ExifYCbCrPositioning](/imaging/python-net/aspose.imaging.exif.enums/exifycbcrpositioning/) | r/w | Obtient ou définit la position des composants de chrominance par rapport au composant de luminance. |
| y_cb_cr_sub_sampling | int[] | r/w | Obtient ou définit le taux d'échantillonnage des composants de chrominance par rapport au composant de luminance. |
| y_resolution | [TiffRational](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Obtient ou définit la résolution y. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [serialize_exif_data()](#serialize_exif_data__6) | Sérialise les données EXIF. Écrit les valeurs et le contenu des balises. La balise de taille la plus influente est le contenu de la balise Miniature. |
...
Initialise une nouvelle instance de la classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/).
...
Initialise une nouvelle instance de la classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) avec des données provenant du tableau.
...
| Type | Description |
| :- | :- |
| System.Byte | Les données EXIF sérialisées. |
