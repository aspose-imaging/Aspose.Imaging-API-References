...
type: docs
weight: 50
url: /fr/python-net/aspose.imaging.brushes/pathgradientbrush/
---
...
| **Name** | **Description** |
| :- | :- |
| [PathGradientBrush(path)](#PathGradientBrush_path_1) | Initialise une nouvelle instance de la classe PathGradientBrush |
| [PathGradientBrush(path_points)](#PathGradientBrush_path_points_2) | Initialise une nouvelle instance de la classe PathGradientBrush |
| [PathGradientBrush(path_points)](#PathGradientBrush_path_points_3) | Initialise une nouvelle instance de la classe PathGradientBrush |
| [PathGradientBrush(path_points, wrap_mode)](#PathGradientBrush_path_points_wrap_mode_4) | Initialise une nouvelle instance de la classe PathGradientBrush |
| [PathGradientBrush(path_points, wrap_mode)](#PathGradientBrush_path_points_wrap_mode_5) | Initialise une nouvelle instance de la classe PathGradientBrush |
## **Properties**
...
| center_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Obtient ou définit la couleur au centre du dégradé de chemin. |
...
| surround_colors | [Color[]](/imaging/python-net/aspose.imaging/color/) | r/w | Obtient ou définit un tableau de couleurs qui correspondent aux points du chemin que ce [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) remplit. |
...
| **Name** | **Description** |
| :- | :- |
| [create_with_path(path)](#create_with_path_path_1) | Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec le chemin spécifié. |
| [create_with_points(path_points)](#create_with_points_path_points_2) | Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec les points spécifiés. |
| [create_with_points_f(path_points)](#create_with_points_f_path_points_3) | Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec les points spécifiés. |
| [create_with_points_f_wrap_mode(path_points, wrap_mode)](#create_with_points_f_wrap_mode_path_points_wrap_mode_4) | Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec les points spécifiés et le mode d'enroulement. |
| [create_with_points_wrap_mode(path_points, wrap_mode)](#create_with_points_wrap_mode_path_points_wrap_mode_5) | Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec les points spécifiés et le mode d'enroulement. |
...
| [set_blend_triangular_shape(focus)](#set_blend_triangular_shape_focus_13) | Crée un dégradé avec une couleur centrale et une décroissance linéaire vers une couleur environnante. |
| [set_blend_triangular_shape(focus, scale)](#set_blend_triangular_shape_focus_scale_14) | Crée un dégradé avec une couleur centrale et une décroissance linéaire vers chaque couleur environnante. |
| [set_sigma_bell_shape(focus)](#set_sigma_bell_shape_focus_15) | Crée un pinceau de dégradé qui change de couleur en partant du centre du chemin vers la frontière du chemin. La transition d'une couleur à l'autre est basée sur une courbe en forme de cloche. |
| [set_sigma_bell_shape(focus, scale)](#set_sigma_bell_shape_focus_scale_16) | Crée un pinceau de dégradé qui change de couleur en partant du centre du chemin vers la frontière du chemin. La transition d'une couleur à l'autre est basée sur une courbe en forme de cloche. |
| [translate_transform(dx, dy)](#translate_transform_dx_dy_17) | Transalte la transformation géométrique locale des dimensions spécifiées. Cette méthode préfixe la translation à la transformation. |
| [translate_transform(dx, dy, order)](#translate_transform_dx_dy_order_18) | Transalte la transformation géométrique locale des dimensions spécifiées dans l'ordre indiqué. |
...
Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec le chemin spécifié.

**Parameters:**

| Paramètre | Type | Description |
| :- | :- | :- |
| path | [GraphicsPath](/imaging/python-net/aspose.imaging/graphicspath/) | Le [GraphicsPath](/imaging/python-net/aspose.imaging/graphicspath/) qui définit la zone remplie par ce [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/). |
...
Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec les points spécifiés.
...
Initialise une nouvelle instance de la classe [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) avec les points spécifiés et le mode d'enroulement.
...
| :- | :- | :- |
| path_points | [PointF[]](/imaging/python-net/aspose.imaging/pointf/) | Un tableau de structures [PointF](/imaging/python-net/aspose.imaging/pointf/) qui représente les points constituant les sommets du chemin. |
| wrap_mode | [WrapMode](/imaging/python-net/aspose.imaging/wrapmode/) | Un [WrapMode](/imaging/python-net/aspose.imaging/wrapmode/) qui spécifie comment les remplissages dessinés avec ce [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sont disposés en mosaïque. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| focus | float | Une valeur de 0 à 1 qui indique où, le long de tout rayon du centre du chemin jusqu'à la bordure du chemin, la couleur centrale atteindra son intensité maximale. Une valeur de 1 (la valeur par défaut) place l'intensité maximale au centre du chemin. |
...
| :- | :- | :- |
| focus | float | Une valeur de 0 à 1 qui indique où, le long de tout rayon du centre du chemin jusqu'à la bordure du chemin, la couleur centrale atteindra son intensité maximale. Une valeur de 1 (la valeur par défaut) place l'intensité maximale au centre du chemin. |
| échelle | float | Une valeur de 0 à 1 qui spécifie l'intensité maximale de la couleur centrale qui se mélange avec la couleur de la bordure. Une valeur de 1 entraîne l'intensité la plus élevée possible de la couleur centrale, et c'est la valeur par défaut. |
