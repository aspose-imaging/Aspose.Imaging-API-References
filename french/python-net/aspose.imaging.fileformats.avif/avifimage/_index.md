...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.fileformats.avif/avifimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [AvifImage()](#AvifImage__1) | Initialise une nouvelle instance de la classe AvifImage |
## **Properties**
...
| bits_per_pixel | int | r | Obtient la valeur des bits par pixel. |
...
| height | int | r | Obtient la hauteur de l'image AVIF. |
...
| width | int | r | Obtient la largeur de l'image AVIF. |
...
Initialise une nouvelle instance de la classe AvifImage
