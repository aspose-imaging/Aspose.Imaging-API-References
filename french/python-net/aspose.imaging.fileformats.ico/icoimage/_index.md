...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.fileformats.ico/icoimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [IcoImage(image, ico_options)](#IcoImage_image_ico_options_1) | Conçu pour la simplicité et l'efficacité, la classe [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) vous permet <br/>            de créer des images ICO facilement. Ce constructeur initialise une nouvelle instance <br/>            de la classe, offrant une base solide pour vos besoins de manipulation d'images. <br/>            Que vous développiez des applications ou amélioriez les interfaces utilisateur, la <br/>            classe [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) simplifie la gestion des images ICO, vous permettant de vous concentrer <br/>            sur la livraison d'expériences exceptionnelles. |
| [IcoImage(width, height, options)](#IcoImage_width_height_options_2) | Commencez la création d'images ICO sans effort en utilisant la classe [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/). Ce <br/>            constructeur vous permet d'initialiser de nouvelles instances d'images ICO en spécifiant les paramètres de largeur, de hauteur et d'options de création. Avec ce constructeur simple <br/>            vous pouvez adapter les images ICO à vos spécifications exactes, garantissant <br/>            une compatibilité fluide et un attrait visuel sur différentes plateformes et appareils. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Récupérez le format de fichier sans effort avec cette propriété, permettant une intégration fluide <br/>            dans votre flux de travail. En utilisant cette propriété, vous accédez à des informations essentielles <br/>            sur le format de votre fichier, garantissant la compatibilité et un traitement efficace. |
| has_alpha | bool | r | Déterminez si un canal alpha est présent dans cette instance avec cette propriété. Elle <br/>            offre un moyen rapide de vérifier si l'image ou le document contient un canal alpha, <br/>            ce qui est crucial pour diverses tâches de traitement et de rendu d'images. Idéal pour <br/>            assurer la compatibilité et gérer les effets de transparence dans les images ou les documents. |
...
| page_count | int | r | Obtenez immédiatement un aperçu de la structure du document avec cette propriété simple <br/>            . En invoquant cette propriété, vous récupérez sans effort le nombre total de <br/>            pages contenues dans le fichier. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Récupérez des informations complètes sur les pages du document sans effort grâce à <br/>            cette propriété. En accédant à cette propriété, vous obtenez une collection ou un tableau <br/>            contenant toutes les pages présentes dans le document. |
...
| **Name** | **Description** |
| :- | :- |
| [add_page(page)](#add_page_page_1) | Étendez votre image ICO en ajoutant une entrée de page d'image, en tirant parti de <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Cette méthode intègre parfaitement les images raster dans <br/>            votre fichier ICO, les convertissant en un format PNG 32 bits de haute qualité. Idéal pour <br/>            améliorer vos fichiers ICO avec des images raster tout en assurant une compatibilité optimale <br/>            et une qualité de rendu. |
| [add_page(page)](#add_page_page_2) | Étendez votre image ICO en ajoutant une entrée de page d'image, en tirant parti de <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Cette méthode intègre parfaitement les images raster dans <br/>            votre fichier ICO, les convertissant en un format PNG 32 bits de haute qualité. Idéal pour <br/>            améliorer vos fichiers ICO avec des images raster tout en assurant une compatibilité optimale <br/>            et une qualité de rendu. |
| [add_page(page, ico_options)](#add_page_page_ico_options_3) | Diversifiez votre image ICO sans effort en intégrant une entrée d'image adaptée à <br/>            vos besoins avec les [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) spécifiés. Cette méthode intègre parfaitement l'image selon vos options personnalisées, garantissant flexibilité <br/>            et précision dans votre fichier ICO. |
| [add_raster_page(page)](#add_raster_page_page_4) | Ajoute une entrée d'image à l'image ICO selon les [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) par défaut en tant que PNG 32 bits. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | Ajustement d'une _luminosité_ pour l'image. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | [Image](/imaging/python-net/aspose.imaging/image/) contrastant |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | Correction gamma d'une image. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | Correction gamma d'une image. |
...
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | Binarisation d'une image avec un seuil prédéfini |
...
| [can_load(stream)](#can_load_stream_17) | Détermine si le flux fourni contient une image ICO. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | Recadrer l'image avec des déplacements. |
...
| [remove_page(index)](#remove_page_index_79) | Affinez votre image ICO en supprimant une entrée d'image spécifique située à l'<br/>            ***index*** désigné dans le fichier. Cette méthode offre un contrôle précis <br/>            sur la composition de votre image, vous permettant de peaufiner votre fichier ICO en toute simplicité. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_83) | Remplace toutes les couleurs non transparentes par une nouvelle couleur et préserve la valeur alpha originale pour conserver des bords lisses.<br/>                Note : si vous l'utilisez sur des images sans transparence, toutes les couleurs seront remplacées par une seule. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_84) | Remplace toutes les couleurs non transparentes par une nouvelle couleur et préserve la valeur alpha originale pour conserver des bords lisses.<br/>                Note : si vous l'utilisez sur des images sans transparence, toutes les couleurs seront remplacées par une seule. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_91) | Redimensionne la largeur proportionnellement. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) image autour du centre. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | Fait pivoter, retourner ou faire pivoter et retourner toutes les pages. |
...
| [save(file_path, options)](#save_file_path_options_103) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
...
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_109) | Enregistre les pixels ARGB 32 bits. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_110) | Enregistre les pixels. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_111) | Enregistre les pixels.<br/>            Cette méthode est obsolète. Veuillez utiliser de manière plus efficace la méthode [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_112) | Enregistre les pixels internes principaux. |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_113) | Enregistre les données brutes. |
| [save_to_stream(stream)](#save_to_stream_stream_114) | Enregistre les données de l'objet dans le flux spécifié. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_115) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_116) | Enregistre les données de l'image dans le flux spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_117) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_118) | Enregistre les données de l'objet à l'emplacement de fichier spécifié dans le format de fichier indiqué selon les options d'enregistrement. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_119) | Définit un pixel d'image 32 bits ARGB pour la position spécifiée. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_120) | Définit la palette d'image. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_121) | Définit un pixel d'image pour la position spécifiée. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_122) | Définit la résolution pour ce [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_123) | Essaie de définir une instance _metadata_, si cette instance [Image](/imaging/python-net/aspose.imaging/image/) prend en charge et implémente l'instance [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_124) | Écrit la ligne de numérisation complète à l'index de ligne de numérisation spécifié. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_125) | Écrit la ligne de numérisation complète à l'index de ligne de numérisation spécifié. |
...
| :- | :- | :- |
| image | [Image](/imaging/python-net/aspose.imaging/image/) | L'image. |
| ico_options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | Les options ICO. |
...
| options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | Les options de création ICO. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| page | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | L'image. |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| page | [Image](/imaging/python-net/aspose.imaging/image/) | L'image. |
...
Ajoute une entrée d'image à l'image ICO selon les [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) par défaut en tant que PNG 32 bits.
...
Ajustement d'une _luminosité_ pour l'image.
...
Détermine si le flux fourni contient une image ICO.
...
| Type | Description |
| :- | :- |
| bool | **True** si le flux contient une image ICO ; sinon **False** |
...
Affinez votre image ICO en supprimant une entrée d'image spécifique située à l'<br/>            ***index*** désigné dans le fichier. Cette méthode offre un contrôle précis <br/>            sur la composition de votre image, vous permettant de peaufiner votre fichier ICO en toute simplicité.
...
| :- | :- | :- |
| angle | float | L'angle de rotation en degrés. Les valeurs positives feront pivoter dans le sens horaire. |
| resize_proportionally | bool | si réglé sur <c>true</c> votre taille d'image sera modifiée<br/>                selon les projections du rectangle tourné (points d'angle) dans le cas contraire les dimensions restent inchangées et seuls le contenu __interne__ de l'image est tourné. |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | Couleur de l'arrière-plan. |
