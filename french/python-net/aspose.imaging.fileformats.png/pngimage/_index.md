...
type: docs
weight: 10
url: /fr/python-net/aspose.imaging.fileformats.png/pngimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [PngImage(path)](#PngImage_path_1) | Construit une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en utilisant le paramètre de chemin <br/>            pour spécifier l'emplacement du fichier image à charger. Ce constructeur <br/>            permet aux développeurs de créer facilement des images PNG en les chargeant depuis un fichier, <br/>            simplifiant le processus de travail avec les images PNG dans leurs applications. |
| [PngImage(path, color_type)](#PngImage_path_color_type_2) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en spécifiant le <br/>            chemin du fichier image et le type de couleur. Ce constructeur permet une création pratique <br/>            d'images PNG à partir de fichiers avec différents types de couleur, offrant <br/>            une flexibilité dans la gestion de divers formats d'image. |
| [PngImage(png_options, width, height)](#PngImage_png_options_width_height_3) | Initialisez une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en incorporant <br/>            des options PNG ainsi que les paramètres de largeur et de hauteur. Ce constructeur permet <br/>            aux développeurs de créer des images PNG avec des paramètres personnalisables et des dimensions, <br/>            offrant une flexibilité dans la génération d'images pour divers cas d'utilisation. |
| [PngImage(raster_image)](#PngImage_raster_image_4) | Crée une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en fournissant une image raster <br/>            comme paramètre. Ce constructeur permet aux développeurs d'initialiser directement un <br/>            objet image PNG en utilisant une image raster existante, simplifiant le processus de <br/>            travail avec les images PNG dans leurs applications. |
| [PngImage(raster_image, color_type)](#PngImage_raster_image_color_type_5) | Crée une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en spécifiant une <br/>            image raster et un type de couleur. Ce constructeur permet aux développeurs de convertir directement les images raster en format PNG tout en spécifiant le type de couleur souhaité, <br/>            offrant une flexibilité dans la représentation des couleurs. |
| [PngImage(stream)](#PngImage_stream_6) | Crée une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en l'initialisant <br/>            avec un flux. Ce constructeur permet aux développeurs de charger des images PNG directement <br/>            depuis un flux, offrant une flexibilité dans la récupération d'images à partir de différentes sources. |
| [PngImage(width, height)](#PngImage_width_height_7) | Initialisez un nouvel objet de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en fournissant les paramètres de <br/>            largeur et de hauteur. Ce constructeur simplifie la création d'images PNG <br/>            en permettant aux développeurs de spécifier directement les dimensions, facilitant <br/>            la gestion efficace des données d'image PNG au sein de leurs applications. |
| [PngImage(width, height, color_type)](#PngImage_width_height_color_type_8) | Instanciez une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en spécifiant <br/>            les paramètres de largeur, hauteur et type de couleur souhaités. Ce constructeur permet <br/>            une création rapide d'images PNG avec des dimensions et des configurations de couleur adaptées, <br/>            facilitant une génération d'images optimisée pour diverses applications et flux de travail. |
## **Properties**
...
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Récupère la couleur d'arrière-plan de l'image, si elle est spécifiée. Cette propriété <br/>            est utile pour les applications qui doivent identifier et éventuellement manipuler <br/>            la couleur d'arrière-plan d'une image. |
| bits_per_pixel | int | r | Récupère la valeur des bits par pixel de l'image. Cette propriété fournit des informations essentielles <br/>            concernant la profondeur de couleur de l'image, permettant aux développeurs de <br/>            comprendre le niveau de détail et la précision des couleurs présentes dans les données de l'image. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Récupère le format du fichier associé à l'instance d'image. Cette <br/>            propriété fournit des informations essentielles concernant le type de fichier, permettant <br/>            une gestion et un traitement efficaces en fonction des exigences spécifiques du format. |
| [has_alpha](#has_alpha1) | bool | r | Renvoie une valeur booléenne indiquant si l'image possède un canal alpha, <br/>            qui détermine sa transparence. Cette propriété est utile pour les applications <br/>            qui doivent gérer la transparence, permettant aux développeurs de déterminer si <br/>            un traitement supplémentaire est nécessaire pour gérer les zones transparentes de l'image. |
| has_background_color | bool | r/w | Récupère une valeur booléenne indiquant si l'image possède une couleur d'arrière-plan. <br/>            Cette propriété est utile pour les applications qui doivent déterminer si une image <br/>            inclut une couleur d'arrière-plan, ce qui peut être important pour diverses tâches de traitement <br/>            telles que le compositing, le rendu ou l'exportation. |
| has_transparent_color | bool | r/w | Fournit une valeur booléenne indiquant si l'image contient une couleur transparente <br/>            . Cette propriété est cruciale pour les applications qui doivent gérer <br/>            la transparence, permettant aux développeurs de déterminer si un traitement supplémentaire est <br/>            nécessaire pour gérer les zones transparentes de l'image. |
| height | int | r | Obtenez la hauteur de l'image. Cette propriété renvoie la dimension verticale de <br/>            l'image, permettant aux développeurs de déterminer sa taille en pixels le long de l'axe <br/>            vertical. |
| horizontal_resolution | float | r/w | Récupérez ou modifiez la résolution horizontale de l'image. Cette propriété <br/>            représente le nombre de pixels par pouce le long de l'axe horizontal de l'image. Ajuster cette résolution peut affecter la taille physique de l'image lors de son <br/>            impression ou affichage. |
| image_opacity | float | r | Obtient l'opacité de cette image. |
| interlaced | bool | r | Récupère une valeur booléenne indiquant si le [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) est <br/>            entrelacé, ce qui détermine si les données de l'image sont stockées de manière progressive <br/>            pour un chargement ou une transmission plus rapides. |
...
| is_interlaced | bool | r | Renvoie une valeur booléenne indiquant si l'instance d'image est entrelacée. Cette <br/>            propriété est cruciale pour optimiser les stratégies de chargement et garantir des performances efficaces <br/>            lors du traitement ou de l'affichage d'images. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Accède au format de données brutes de l'image. Cette propriété offre un aperçu de <br/>            la façon dont les données de l'image sont structurées en interne, ce qui peut être utile pour des tâches avancées <br/>            de traitement d'images ou de conversion de format. |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Récupère la couleur transparente de l'image, si elle existe. Cette propriété est <br/>            précieuse pour les applications nécessitant une gestion précise des zones transparentes <br/>            au sein des images, permettant aux développeurs d'accéder et de manipuler la couleur <br/>            transparente spécifique utilisée. |
...
| vertical_resolution | float | r/w | Fournit l'accès à la résolution verticale de l'image. Les développeurs peuvent utiliser <br/>            cette propriété pour récupérer ou modifier le paramètre de résolution, qui indique le <br/>            nombre de pixels par pouce (PPI) le long de l'axe vertical de l'image. |
| width | int | r | Permet de récupérer la largeur de l'image, fournissant des informations essentielles <br/>            sur ses dimensions. Cette propriété est fréquemment utilisée par les développeurs pour <br/>            déterminer la largeur de l'image, leur permettant d'effectuer diverses opérations basées <br/>            sur sa taille. |
...
| [create_from_file_with_color_type(path, color_type)](#create_from_file_with_color_type_path_color_type_26) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_29) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_from_image_with_color_type(raster_image, color_type)](#create_from_image_with_color_type_raster_image_color_type_30) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_34) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_color_type(width, height, color_type)](#create_with_width_height_color_type_width_height_color_type_35) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_options(png_options, width, height)](#create_with_width_height_options_png_options_width_height_36) | Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_54) | Récupère l'horodatage indiquant la modification la plus récente de l'image de la ressource <br/>            . Cette méthode donne accès à des métadonnées essentielles, permettant aux applications de <br/>            déterminer quand l'image a été modifiée pour la dernière fois, facilitant le suivi des versions et <br/>            la gestion du contenu. |
...
| [save(stream)](#save_stream_107) | Les données de sauvegarde. |
...
Construit une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en utilisant le paramètre de chemin <br/>            pour spécifier l'emplacement du fichier image à charger. Ce constructeur <br/>            permet aux développeurs de créer facilement des images PNG en les chargeant depuis un fichier, <br/>            simplifiant le processus de travail avec les images PNG dans leurs applications.
...
Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en spécifiant le <br/>            chemin du fichier image et le type de couleur. Ce constructeur permet une création pratique <br/>            d'images PNG à partir de fichiers avec différents types de couleur, offrant <br/>            une flexibilité dans la gestion de divers formats d'image.
...
| :- | :- | :- |
| chemin | string | Le chemin pour charger une image. |
| color_type | [PngColorType](/imaging/python-net/aspose.imaging.fileformats.png/pngcolortype/) | Le type de couleur. |
...
Initialisez une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en incorporant <br/>            des options PNG ainsi que les paramètres de largeur et de hauteur. Ce constructeur permet <br/>            aux développeurs de créer des images PNG avec des paramètres personnalisables et des dimensions, <br/>            offrant une flexibilité dans la génération d'images pour divers cas d'utilisation.
...
Crée une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en spécifiant une <br/>            image raster et un type de couleur. Ce constructeur permet aux développeurs de convertir directement les images raster en format PNG tout en spécifiant le type de couleur souhaité, <br/>            offrant une flexibilité dans la représentation des couleurs.
...
Crée une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en l'initialisant <br/>            avec un flux. Ce constructeur permet aux développeurs de charger des images PNG directement <br/>            depuis un flux, offrant une flexibilité dans la récupération d'images à partir de différentes sources.
...
Initialisez un nouvel objet de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en fournissant les paramètres de <br/>            largeur et de hauteur. Ce constructeur simplifie la création d'images PNG <br/>            en permettant aux développeurs de spécifier directement les dimensions, facilitant <br/>            la gestion efficace des données d'image PNG au sein de leurs applications.
...
Instanciez une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) en spécifiant <br/>            les paramètres de largeur, hauteur et type de couleur souhaités. Ce constructeur permet <br/>            une création rapide d'images PNG avec des dimensions et des configurations de couleur adaptées, <br/>            facilitant une génération d'images optimisée pour diverses applications et flux de travail.
...
Initialise une nouvelle instance de la classe [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/).
...
Récupère l'horodatage indiquant la modification la plus récente de l'image de la ressource <br/>            . Cette méthode donne accès à des métadonnées essentielles, permettant aux applications de <br/>            déterminer quand l'image a été modifiée pour la dernière fois, facilitant le suivi des versions et <br/>            la gestion du contenu.
...
dir_ = "c:\\temp"
# Charger une image PNG à partir d'un fichier.
# Notez que l'image colorée sera convertie en niveaux de gris automatiquement.
...
dir_: str = "c:\\temp"
# Charger une image PNG à partir d'un flux de fichier.
...
dir_: str = "c:\\temp"
# Charger une image PNG TrueColor à partir d'une image BMP.
# Tout d'abord, créez une image BMP temporaire qui servira de base pour créer une image PNG.
# Vous pouvez également charger une image BMP à partir d'un fichier ou utiliser une image d'un autre format raster.
with BmpImage(100, 100) as bmp_image:
	# Remplissez l'intégralité de l'image BMP en rouge.
...
dir_ = "c:\\temp"
# Charger une image PNG en niveaux de gris à partir d'une image BMP colorée.
# Tout d'abord, créez une image BMP temporaire qui servira de base pour créer une image PNG.
# Vous pouvez également charger une image BMP à partir d'un fichier ou utiliser une image d'un autre format raster.
with BmpImage(100, 100) as bmp_image:
	# Remplissez l'intégralité de l'image BMP en rouge.
	...
	brush = SolidBrush(Color.red)
	gr.fill_rectangle(brush, bmp_image.bounds)
	# Les couleurs des pixels de l'image seront converties en leurs équivalents en niveaux de gris.
...
dir_: str = "c:\\temp"
# Créer une image PNG en niveaux de gris de 100x100 px.
