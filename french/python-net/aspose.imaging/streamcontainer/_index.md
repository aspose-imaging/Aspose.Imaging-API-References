...
type: docs
weight: 7340
url: /fr/python-net/aspose.imaging/streamcontainer/
---
...
| **Name** | **Description** |
| :- | :- |
| [StreamContainer(stream)](#StreamContainer_stream_1) | Initialise une nouvelle instance de la classe [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/). |
| [StreamContainer(stream, dispose_stream)](#StreamContainer_stream_dispose_stream_2) | Initialise une nouvelle instance de la classe [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/). |
## **Properties**
...
| [read(buffer, offset, count)](#read_buffer_offset_count_1) | Lit une séquence d'octets du flux actuel et avance la position dans le flux du nombre d'octets lus. |
...
| [save(destination_stream)](#save_destination_stream_4) | Enregistre (copie) les données du flux vers le flux spécifié. Utilise la taille de tampon par défaut [StreamContainer.READ_WRITE_BYTES_COUNT](/imaging/python-net/aspose.imaging/streamcontainer/) et la valeur du flux [StreamContainer.length](/imaging/python-net/aspose.imaging/streamcontainer/). |
| [save(destination_stream, buffer_size)](#save_destination_stream_buffer_size_5) | Enregistre (copie) toutes les données du flux vers le flux spécifié. Utilise la valeur du flux [StreamContainer.length](/imaging/python-net/aspose.imaging/streamcontainer/). |
...
| [save(file_path)](#save_file_path_7) | Enregistre (copie) les données du flux vers le flux spécifié. Utilise la taille de tampon par défaut [StreamContainer.READ_WRITE_BYTES_COUNT](/imaging/python-net/aspose.imaging/streamcontainer/) et la valeur du flux [StreamContainer.length](/imaging/python-net/aspose.imaging/streamcontainer/). |
| [save(file_path, buffer_size)](#save_file_path_buffer_size_8) | Enregistre (copie) les données du flux vers le flux spécifié. Utilise la valeur du flux [StreamContainer.length](/imaging/python-net/aspose.imaging/streamcontainer/). |
...
| [save_to_stream_with_buf_size(destination_stream, buffer_size)](#save_to_stream_with_buf_size_destination_stream_buffer_size_11) | Enregistre (copie) toutes les données du flux vers le flux spécifié. Utilise la valeur du flux [StreamContainer.length](/imaging/python-net/aspose.imaging/streamcontainer/). |
| [save_to_stream_with_buf_size_and_len(destination_stream, buffer_size, length)](#save_to_stream_with_buf_size_and_len_destination_stream_buffer_size_length_12) | Enregistre (copie) les données du flux vers le flux spécifié. |
| [save_with_buf_size(file_path, buffer_size)](#save_with_buf_size_file_path_buffer_size_13) | Enregistre (copie) les données du flux vers le flux spécifié. Utilise la valeur du flux [StreamContainer.length](/imaging/python-net/aspose.imaging/streamcontainer/). |
| [save_with_buf_size_and_len(file_path, buffer_size, length)](#save_with_buf_size_and_len_file_path_buffer_size_length_14) | Enregistre (copie) les données du flux vers le flux spécifié. |
| [seek(offset, origin)](#seek_offset_origin_15) | Définit la position dans le flux actuel. |
...
| [to_bytes()](#to_bytes__16) | Convertit les données du flux en tableau d'entiers. |
| [to_bytes(position, bytes_count)](#to_bytes_position_bytes_count_17) | Convertit les données du flux en tableau d'entiers. |
| [write(buffer, offset, count)](#write_buffer_offset_count_18) | Écrit une séquence d'octets dans le flux actuel et avance la position actuelle dans ce flux du nombre d'octets écrits. |
| [write(bytes)](#write_bytes_19) | Écrit tous les octets spécifiés dans le flux. |
| [write_byte(value)](#write_byte_value_20) | Écrit un octet à la position actuelle du flux et avance la position dans le flux d'un octet. |
| [write_to(stream_container)](#write_to_stream_container_21) | Copie les données contenues vers un autre [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/). |
| [write_to(stream_container, length)](#write_to_stream_container_length_22) | Copie les données contenues vers un autre [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/). |
...
Initialise une nouvelle instance de la classe [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/).
