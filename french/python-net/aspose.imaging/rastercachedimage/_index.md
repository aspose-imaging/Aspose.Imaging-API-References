...
type: docs
weight: 7040
url: /fr/python-net/aspose.imaging/rastercachedimage/
---
...
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_82) | Redimensionne l'image. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_106) | Enregistre les pixels (méthode spécifique au format). |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_117) | Essaie de définir une instance _metadata_, si cette instance [Image](/imaging/python-net/aspose.imaging/image/) prend en charge et implémente l'instance [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
...
with Image.load(join_path(directory, "sample.png")) as image:
	...
	# La luminosité est une différence entre un pixel et la moyenne d'une fenêtre de s x s pixels centrée autour de ce pixel.
