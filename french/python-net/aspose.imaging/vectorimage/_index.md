...
type: docs
weight: 7880
url: /fr/python-net/aspose.imaging/vectorimage/
---
...
| [save(stream)](#save_stream_60) | Enregistre les données de l'objet dans le flux spécifié. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_69) | Essaie de définir une instance _metadata_, si cette instance [Image](/imaging/python-net/aspose.imaging/image/) prend en charge et implémente le type [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
