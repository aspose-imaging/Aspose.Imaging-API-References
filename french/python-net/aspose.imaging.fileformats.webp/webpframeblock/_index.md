...
type: docs
weight: 20
url: /fr/python-net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| **Name** | **Description** |
| :- | :- |
| [WebPFrameBlock(raster_image)](#WebPFrameBlock_raster_image_1) | <br/><br/>                    Initialise une nouvelle instance de la [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>classe.<br/> |
| [WebPFrameBlock(width, height)](#WebPFrameBlock_width_height_2) | Initialise une nouvelle instance de la classe [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/). |
## **Properties**
...
| disposal_method | [AnimationDisposalMethods](/imaging/python-net/aspose.imaging/animationdisposalmethods/) | r/w | Obtient ou définit la méthode de disposition. |
| libéré | bool | r | Obtient une valeur indiquant si cette instance est libérée. |
| duration | int | r/w | Obtient ou définit la durée de la trame. |
...
| frame_time | int | r | Obtient la durée de la trame. |
...
| gauche | int | r/w | Obtient ou définit la position gauche de la trame. |
...
| haut | int | r/w | Obtient ou définit la position supérieure de la trame. |
...
| use_alpha_blending | bool | r/w | Obtient ou définit la valeur indiquant si la trame actuelle est mélangée avec les valeurs alpha de la trame précédente. |
...
<br/><br/>                    Initialise une nouvelle instance de la [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>classe.<br/>
...
Initialise une nouvelle instance de la classe [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/).
