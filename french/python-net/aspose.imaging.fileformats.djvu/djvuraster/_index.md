...
type: docs
weight: 30
url: /fr/python-net/aspose.imaging.fileformats.djvu/djvuraster/
---
...
| length | int | r | Obtient la longueur. |
...
| raw_data_settings | [RawDataSettings](/imaging/python-net/aspose.imaging/rawdatasettings/) | r | Obtient les paramètres des données brutes. |
