...
type: docs
weight: 20
url: /fr/python-net/aspose.imaging.fileformats.djvu/djvupage/
---
...
| height | int | r | Obtient la hauteur de la page |
...
| image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r | Obtient l'image. |
...
| is_color | bool | r | Obtient une valeur indiquant si cette instance est en couleur. |
...
| parent_image | [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | r | Obtient l'image parente à laquelle la page appartient |
...
| thumbnail_image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r/w | Obtient ou définit l'image miniature de la page |
...
| width | int | r | Obtient la largeur de la page |
...
| [extract_thumbnail_image()](#extract_thumbnail_image__35) | Extrait l'image miniature de la page Djvu. |
| [filter(rectangle, options)](#filter_rectangle_options_36) | Filtre le rectangle spécifié. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_37) | Obtient un pixel ARGB 32 bits d'une image. |
| [get_background_image()](#get_background_image__38) | Obtient l'image d'arrière-plan. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_49) | Obtient l'image de premier plan de la page |
| [get_modify_date(use_default)](#get_modify_date_use_default_50) | Obtient la date et l'heure de la dernière modification de l'image ressource. |
...
| [get_pixel(x, y)](#get_pixel_x_y_52) | Obtient un pixel d'image. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_53) | Obtient une hauteur proportionnelle. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_54) | Obtient une largeur proportionnelle. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_55) | Convertit en aps. |
| [get_skew_angle()](#get_skew_angle__56) | Obtient l'angle d'inclinaison.<br/>            Cette méthode s'applique aux documents texte numérisés, pour déterminer l'angle d'inclinaison lors du scan. |
| [get_text_for_location(rect)](#get_text_for_location_rect_57) | Obtient le texte pour l'emplacement du rectangle |
| [get_text_image(subsample)](#get_text_image_subsample_58) | Obtient l'image texte. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | Redimensionne l'image de la page aux nouvelles dimensions |
...
| [save(stream)](#save_stream_105) | Enregistre les données. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_121) | Définit la résolution pour ce [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| Type | Description |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | L'image raster Djvu. |
...
| Type | Description |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Le bitmap |
...
Obtient l'image de premier plan de la page
...
| Type | Description |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Image bitmap |
...
| Paramètre | Type | Description |
| :- | :- | :- |
| rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Le rectangle de localisation. |

**Returns**

| Type | Description |
| :- | :- |
| string | Texte trouvé à l'emplacement |
...
Redimensionne l'image de la page aux nouvelles dimensions
