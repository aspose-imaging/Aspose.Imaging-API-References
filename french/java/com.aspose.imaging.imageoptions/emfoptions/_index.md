...
type: docs
weight: 19
url: /fr/java/com.aspose.imaging.imageoptions/emfoptions/
---
**Inheritance:**
...
| [EmfOptions(float dpiX, float dpiY)](#EmfOptions-float-float-) | Initialise une nouvelle instance de la classe `EmfOptions`. |
| [EmfOptions(float dpi)](#EmfOptions-float-) |  |
| [EmfOptions(EmfOptions emfOptions)](#EmfOptions-com.aspose.imaging.imageoptions.EmfOptions-) | Initialise une nouvelle instance de la classe `EmfOptions`. |
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Exportez uniquement les deux premières pages. En fait, seule une page sera convertie car le format EMF n'est pas multipage.
...
Initialise une nouvelle instance de la classe `EmfOptions`.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| emfOptions | [EmfOptions](../../com.aspose.imaging.imageoptions/emfoptions) | Les options EMF. |
