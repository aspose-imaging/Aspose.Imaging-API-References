...
type: docs
weight: 54
url: /fr/java/com.aspose.imaging.imageoptions/wmfoptions/
---
**Inheritance:**
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Exportez uniquement les deux premières pages. En fait, une seule page sera convertie car le WMF n'est pas un format multi-pages.
