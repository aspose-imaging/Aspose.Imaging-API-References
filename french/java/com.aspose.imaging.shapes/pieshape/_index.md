...
description: "Représente une forme de secteur."
type: docs
weight: 14
url: /fr/java/com.aspose.imaging.shapes/pieshape/
---
**Inheritance:**
...
Représente une forme de secteur.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [PieShape()](#PieShape--) | Initialise une nouvelle instance de la classe `PieShape`. |
| [PieShape(RectangleF rectangle, float startAngle, float sweepAngle)](#PieShape-com.aspose.imaging.RectangleF-float-float-) | Initialise une nouvelle instance de la classe `PieShape`. |
## Méthodes
...
| [getSweepAngle()](#getSweepAngle--) | Obtient ou définit l'angle d'arc. |
| [setSweepAngle(float value)](#setSweepAngle-float-) | Obtient ou définit l'angle d'arc. |
...
Initialise une nouvelle instance de la classe `PieShape`.
