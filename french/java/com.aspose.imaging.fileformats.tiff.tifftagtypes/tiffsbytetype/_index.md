...
description: "Le type octet signé tiff."
type: docs
weight: 20
url: /fr/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/
---
**Inheritance:**
...
Le type octet signé tiff.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [TiffSByteType(int tagId)](#TiffSByteType-int-) | Initialise une nouvelle instance de la classe `TiffSByteType`. |
## Méthodes
...
Initialise une nouvelle instance de la classe `TiffSByteType`.
