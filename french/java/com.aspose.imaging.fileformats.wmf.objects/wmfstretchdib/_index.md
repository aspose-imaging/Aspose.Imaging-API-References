...
description: "L'objet wmf Stretch DIB."
type: docs
weight: 94
url: /fr/java/com.aspose.imaging.fileformats.wmf.objects/wmfstretchdib/
---
**Inheritance:**
...
| --- | --- |
| [WmfStretchDib()](#WmfStretchDib--) | WMFs l'enregistrement. |
## Méthodes
...
Le champ Colors du DIB contient des valeurs RVB explicites ou des index dans une palette. Cette valeur DOIT être dans le `com.aspose.imaging.fileFormats.wmf.objects.wmfStretchDib.ColorUsage`

Énumération (section 2.1.1.6).
