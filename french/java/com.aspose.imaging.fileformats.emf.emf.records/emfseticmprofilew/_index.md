...
description: "L'enregistrement EMR_SETICMPROFILEW spécifie un profil couleur dans un fichier dont le nom est composé de caractères Unicode pour la sortie graphique."
type: docs
weight: 127
url: /fr/java/com.aspose.imaging.fileformats.emf.emf.records/emfseticmprofilew/
---
**Inheritance:**
...
L'enregistrement EMR\_SETICMPROFILEW spécifie un profil couleur dans un fichier dont le nom est composé de caractères Unicode, pour la sortie graphique.
## Constructeurs

| Constructeur | Description |
| --- | --- |
| [EmfSetIcmProfileW(EmfRecord source)](#EmfSetIcmProfileW-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | Initialise une nouvelle instance de la classe `EmfSetIcmProfileW`. |
## Méthodes
...
| [getCbData()](#getCbData--) | Obtient ou définit un entier non signé de 32 bits qui indique la taille des données du profil couleur, le cas échéant. |
| [setCbData(int value)](#setCbData-int-) | Obtient ou définit un entier non signé de 32 bits qui indique la taille des données du profil couleur, le cas échéant. |
...
Initialise une nouvelle instance de la classe `EmfSetIcmProfileW`.
...
Obtient ou définit un entier non signé de 32 bits qui indique la taille des données du profil couleur, le cas échéant.
