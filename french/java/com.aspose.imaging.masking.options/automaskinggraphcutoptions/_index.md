...
type: docs
weight: 12
url: /fr/java/com.aspose.imaging.masking.options/automaskinggraphcutoptions/
---
**Inheritance:**
...
| --- | --- |
| [AutoMaskingGraphCutOptions()](#AutoMaskingGraphCutOptions--) | Initialise une nouvelle instance de la classe [AutoMaskingGraphCutOptions](../../com.aspose.imaging.masking.options/automaskinggraphcutoptions). |
## Méthodes
...
| [getDefaultObjectsRectangles()](#getDefaultObjectsRectangles--) | Obtient les rectangles d'objets par défaut. |
| [getAssumedObjects()](#getAssumedObjects--) | Obtient les objets supposés. |
| [setAssumedObjects(List<AssumedObjectData> value)](#setAssumedObjects-java.util.List-com.aspose.imaging.masking.options.AssumedObjectData--) | Définit les objets supposés. |
...
| [setPrecalculationProgressEventHandler(ProgressEventHandler value)](#setPrecalculationProgressEventHandler-com.aspose.imaging.ProgressEventHandler-) | Définit le gestionnaire d'événement de progression du processus de pré-calcul des points par défaut. |
...
Initialise une nouvelle instance de la classe [AutoMaskingGraphCutOptions](../../com.aspose.imaging.masking.options/automaskinggraphcutoptions).
...
**Returns:**
com.aspose.imaging.Point[] - les traits de premier plan par défaut pré-calculés.
...
**Returns:**
com.aspose.imaging.Point[] - les traits d'arrière-plan par défaut.
...
Obtient les rectangles d'objets par défaut.

**Returns:**
com.aspose.imaging.Rectangle[] - les rectangles d'objets par défaut.
...
**Returns:**
java.util.List<com.aspose.imaging.masking.options.AssumedObjectData> - les objets supposés.
...
| --- | --- | --- |
| valeur | java.util.List<com.aspose.imaging.masking.options.AssumedObjectData> | les objets supposés. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | une valeur indiquant si les traits par défaut doivent être calculés. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [ProgressEventHandler](../../com.aspose.imaging/progresseventhandler) | le gestionnaire d'événement de progression du processus de pré-calcul des points par défaut. |
