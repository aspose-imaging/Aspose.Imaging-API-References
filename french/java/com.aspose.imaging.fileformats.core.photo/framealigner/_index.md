...
description: "Les cadres d'alignement."
type: docs
weight: 10
url: /fr/java/com.aspose.imaging.fileformats.core.photo/framealigner/
---
**Inheritance:**
java.lang.Object
```
...
Les cadres d'alignement.
## Méthodes

| Méthode | Description |
| --- | --- |
| [process(RasterImage[] images, FrameAlignerOptions options)](#process-com.aspose.imaging.RasterImage---com.aspose.imaging.fileformats.core.photo.FrameAlignerOptions-) | Traite les images spécifiées. |
...
| --- | --- | --- |
| images | [RasterImage\[\]](../../com.aspose.imaging/rasterimage) | Les images. |
| options | [FrameAlignerOptions](../../com.aspose.imaging.fileformats.core.photo/framealigneroptions) | Les options. |

**Returns:**
java.util.List<com.aspose.imaging.Point> - La liste des décalages par images
