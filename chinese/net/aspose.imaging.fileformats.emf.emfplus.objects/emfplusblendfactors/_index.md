...
| 姓名 | 描述 |
| --- | --- |
| [BlendFactors](../../aspose.imaging.fileformats.emf.emfplus.objects/emfplusblendfactors/blendfactors) { get; set; } | 获取或设置 PositionCount 32 位浮点值数组， 指定 BlendPositions 字段中定义的位置的颜色比例。 每个值必须是介于 0.0 和 1.0 之间的数字。 |
