...
type: docs
weight: 10310
url: /zh/net/aspose.imaging.imageoptions/wmfrasterizationoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [WmfRasterizationOptions](wmfrasterizationoptions)() | 默认构造函数。 |
...
| [RenderMode](../../aspose.imaging.imageoptions/wmfrasterizationoptions/rendermode) { get; set; } | 获取或设置 WMF 渲染模式。 |
