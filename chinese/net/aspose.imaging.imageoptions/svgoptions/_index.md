...
| [Compress](../../aspose.imaging.imageoptions/svgoptions/compress) { get; set; } | 获取或设置一个值，该值指示此ICompressedOptions是否被压缩。 |
...
以下示例显示如何在不参考特定图像类型的情况下以一般方式将多页矢量图像转换为 SVG 格式。
