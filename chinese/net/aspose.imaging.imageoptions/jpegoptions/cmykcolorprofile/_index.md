...
description: "JpegOptions 属性。CMYK jpeg 图像的目标 CMYK 色彩配置文件。用于保存图像。必须与 RGBColorProfile 配对，以实现正确的颜色转换。"
type: docs
weight: 30
url: /zh/net/aspose.imaging.imageoptions/jpegoptions/cmykcolorprofile/
---
