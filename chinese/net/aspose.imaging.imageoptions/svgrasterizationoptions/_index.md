...
type: docs
weight: 10210
url: /zh/net/aspose.imaging.imageoptions/svgrasterizationoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [SvgRasterizationOptions](svgrasterizationoptions)() | 默认构造函数。 |
...
| [CenterDrawing](../../aspose.imaging.imageoptions/vectorrasterizationoptions/centerdrawing) { get; set; } | 获取或设置是否居中绘制的值。 |
...
| [ScaleX](../../aspose.imaging.imageoptions/svgrasterizationoptions/scalex) { get; set; } | 获取或设置比例 x。 |
| [ScaleY](../../aspose.imaging.imageoptions/svgrasterizationoptions/scaley) { get; set; } | 获取或设置比例 y。 |
