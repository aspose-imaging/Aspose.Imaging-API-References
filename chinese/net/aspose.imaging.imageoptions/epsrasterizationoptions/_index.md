...
description: Eps 光栅化选项
type: docs
weight: 9990
url: /zh/net/aspose.imaging.imageoptions/epsrasterizationoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [EpsRasterizationOptions](epsrasterizationoptions)() | 默认构造函数。 |
...
| [PreviewToExport](../../aspose.imaging.imageoptions/epsrasterizationoptions/previewtoexport) { get; set; } | 获取或设置要导出的预览。 |
