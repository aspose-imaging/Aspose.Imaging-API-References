...
description: "Aspose.Imaging.Multithreading.InterruptMonitor 类。表示中断信息。"
type: docs
weight: 11170
...
| 名称 | 描述 |
| --- | --- |
| virtual [IsInterrupted](../../aspose.imaging.multithreading/interruptmonitor/isinterrupted/) { get; } | 获取指示是否应中断操作的值。 |
...
| 名称 | 描述 |
| --- | --- |
| virtual [Interrupt](../../aspose.imaging.multithreading/interruptmonitor/interrupt/)() | 发送请求以中断操作。 |
