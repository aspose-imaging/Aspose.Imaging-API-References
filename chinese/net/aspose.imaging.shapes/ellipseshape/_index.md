...
| 姓名 | 描述 |
| --- | --- |
| [EllipseShape](ellipseshape#constructor)() | 初始化[`EllipseShape`](../ellipseshape)类的新实例。 |
| [EllipseShape](ellipseshape#constructor_1)(RectangleF) | 初始化[`EllipseShape`](../ellipseshape)类的新实例。 |
...
| override [Segments](../../aspose.imaging.shapes/ellipseshape/segments) { get; } | 获取形状段。 |
...
此示例创建一个新图像并在图像表面上使用图形和 GraphicsPath 绘制各种形状
