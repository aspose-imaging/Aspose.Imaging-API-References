---
title: "类 EllipseShape"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.Shapes.EllipseShape 类。表示一个椭圆形状"
type: docs
weight: 11570
url: /zh/net/aspose.imaging.shapes/ellipseshape/
---
## EllipseShape class
...
| 名称 | 描述 |
| --- | --- |
| [EllipseShape](ellipseshape/#constructor)() | 初始化 `EllipseShape` 类的新实例。 |
| [EllipseShape](ellipseshape/#constructor_1)(RectangleF) | 初始化 `EllipseShape` 类的新实例。 |
...
| override [Segments](../../aspose.imaging.shapes/ellipseshape/segments/) { get; } | 获取形状的段。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| override [Equals](../../aspose.imaging.shapes/ellipseshape/equals/)(object) | 检查对象是否相等。 |
...
| override [GetHashCode](../../aspose.imaging.shapes/ellipseshape/gethashcode/)() | 获取当前对象的哈希码。 |
