...
description: "Aspose.Imaging.Shapes.RectangleShape 类。表示一个矩形形状"
type: docs
weight: 11610
url: /zh/net/aspose.imaging.shapes/rectangleshape/
---
...
| 名称 | 描述 |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | 初始化 `RectangleShape` 类的新实例。 |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | 初始化 `RectangleShape` 类的新实例。 |
...
| override [Segments](../../aspose.imaging.shapes/rectangleshape/segments/) { get; } | 获取形状的段。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| override [Equals](../../aspose.imaging.shapes/rectangleshape/equals/)(object) | 检查对象是否相等。 |
...
| override [GetHashCode](../../aspose.imaging.shapes/rectangleshape/gethashcode/)() | 获取当前对象的哈希码。 |
