...
description: "Aspose.Imaging.FileFormats.Emf.MetaImage 类。元对象类的基类"
type: docs
weight: 6630
...
| 名称 | 描述 |
| --- | --- |
| [MetaImage](metaimage/)() | 初始化 `MetaImage` 的新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| abstract [CacheData](../../aspose.imaging/datastreamsupporter/cachedata/)() | 缓存数据并确保不会从底层 [`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer/) 加载额外数据。 |
