...
description: "Aspose.Imaging.FileFormats.Dng.DngImage 类。用于处理 DNG（Digital Negative）图像文件格式的 API，满足数字摄影需求，提供对原始文件和元数据的全面支持。该 API 设计用于各种制造商的数码相机，使开发者能够操作诸如每像素位数、提取内部数据和高效调整图像平衡等方面。具备无缝更新和保存图像数据的能力，此 API 使开发者能够处理 DNG 文件，确保高质量结果和多功能的处理选项。"
type: docs
weight: 2610
...
用于处理 DNG（Digital Negative）图像文件格式的 API，满足数字摄影需求，提供对原始文件和元数据的全面支持。该 API 设计用于各厂商的数码相机，使开发者能够高效地操作位深、提取内部数据并调整图像平衡。具备无缝更新和保存图像数据的能力，此 API 使开发者能够处理 DNG 文件，确保高质量结果和多样化的处理选项。
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dng/dngimage/bitsperpixel/) { get; } | 使用此属性轻松获取图像的每像素位数。非常适合快速、准确地了解图像的像素深度。 |
...
| override [FileFormat](../../aspose.imaging.fileformats.dng/dngimage/fileformat/) { get; } | 使用此属性识别图像的文件格式。非常适合了解格式——简明直观的细节。 |
...
| override [Height](../../aspose.imaging.fileformats.dng/dngimage/height/) { get; } | 使用此属性检索图像的高度。非常适合轻松确定图像的垂直尺寸。 |
...
| [ImgData](../../aspose.imaging.fileformats.dng/dngimage/imgdata/) { get; set; } | 使用此属性管理图像数据。无论是检索还是更新，此属性都提供无缝访问图像数据，以实现高效操作。 |
...
| override [Width](../../aspose.imaging.fileformats.dng/dngimage/width/) { get; } | 使用此属性访问图像的宽度。是快速高效获取图像水平尺寸的理想选择。 |
...
本示例展示了如何从文件加载 DNG 图像、打印其属性并保存为 PNG。
