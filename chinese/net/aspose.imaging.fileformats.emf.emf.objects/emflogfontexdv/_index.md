---
title: "类 EmfLogFontExDv"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Emf.Emf.Objects.EmfLogFontExDv 类。LogFontExDv 对象指定扩展逻辑字体的设计向量"
type: docs
weight: 3140
url: /zh/net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
...
| 名称 | 描述 |
| --- | --- |
| [EmfLogFontExDv](emflogfontexdv/)(EmfLogFontEx) | 初始化 `EmfLogFontExDv` 类的新实例。 |
...
| [DesignVector](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/designvector/) { get; set; } | 获取或设置一个 DesignVector 对象（第 2.2.3 节）。该字段不得超过 72 字节。 |
...
| [FullName](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontex/fullname/) { get; set; } | 获取或设置一个包含 64 个 Unicode 字符的字符串，存放字体的完整名称。如果该字符串长度少于 64 个字符，必须包含一个终止的 NULL，之后的字段内容必须被忽略。 |
...
| [Script](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontex/script/) { get; set; } | 获取或设置一个由 32 个 Unicode 字符组成的字符串，定义字体的字符集。如果此字符串的长度少于 32 个字符，必须包含一个终止的 NULL，之后该字段的其余部分必须被忽略。 |
...
| [Style](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontex/style/) { get; set; } | 获取或设置一个由 32 个 Unicode 字符组成的字符串，定义字体的样式。如果此字符串的长度少于 32 个字符，必须包含一个终止的 NULL，之后该字段的其余部分必须被忽略。 |
