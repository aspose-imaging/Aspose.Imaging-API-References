...
description: 初始化Jpeg2000Imageaspose.imaging.fileformats.jpeg2000/jpeg2000image类的新实例
type: docs
weight: 10
...
初始化[`Jpeg2000Image`](../../jpeg2000image)类的新实例。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| path | String | 从加载图像和初始化像素和调色板数据的路径 |
| bitsPerPixel | Int32 | 每个像素的位数。 |
...
此示例说明如何创建 PNG 图像并将其保存为 JPEG2000 并使用所需的选项。
