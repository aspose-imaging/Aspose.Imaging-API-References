...
description: "Aspose.Imaging.FileFormats.Apng.ApngFrame 类。使用我们的 API 从单页光栅图像创建动画 PNG（APNG）图像帧。无缝设置动画和帧持续时间，编程帧数并调整伽马和对比度水平，确保生成引人入胜且可定制的动画，以符合您的愿景。"
type: docs
weight: 1340
...
使用我们的 API 从单页光栅图像制作动画 PNG（APNG）图像帧。可无缝设置动画和帧持续时间，编程帧数，并调整伽马和对比度水平，确保生成引人入胜且可定制的动画，以符合您的设想。
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.apng/apngframe/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| [DisposalMethod](../../aspose.imaging.fileformats.apng/apngframe/disposalmethod/) { get; } | 获取处理方法。 |
...
| [FrameTop](../../aspose.imaging.fileformats.apng/apngframe/frametop/) { get; } | 获取帧的顶部偏移量。 |
| override [HasAlpha](../../aspose.imaging.fileformats.apng/apngframe/hasalpha/) { get; } | 获取一个值，指示此实例是否具有 alpha 通道。 |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/hasbackgroundcolor/) { get; set; } | 获取一个值，指示是否具有背景颜色。 |
| override [HasTransparentColor](../../aspose.imaging.fileformats.apng/apngframe/hastransparentcolor/) { get; set; } | 获取一个值，指示图像是否具有透明颜色。 |
...
| override [TransparentColor](../../aspose.imaging.fileformats.apng/apngframe/transparentcolor/) { get; set; } | 获取透明颜色。 |
| virtual [UpdateXmpData](../../aspose.imaging/rasterimage/updatexmpdata/) { get; set; } | 获取或设置一个值，指示是否更新 XMP 元数据。 |
| [UseAlphaBlending](../../aspose.imaging.fileformats.apng/apngframe/usealphablending/) { get; } | 获取一个值，指示是否 [use alpha blending]。 |
...
| override [CacheData](../../aspose.imaging.fileformats.apng/apngframe/cachedata/)() | 缓存数据并确保不会从底层 [`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer/) 加载额外数据。 |
...
| [GetFullFrame](../../aspose.imaging.fileformats.apng/apngframe/getfullframe/)() | 获取完整帧。 |
