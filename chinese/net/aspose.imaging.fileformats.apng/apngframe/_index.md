...
| override [BitsPerPixel](../../aspose.imaging.fileformats.apng/apngframe/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| [FrameLeft](../../aspose.imaging.fileformats.apng/apngframe/frameleft) { get; } | 获取帧左偏移。 |
| [FrameTime](../../aspose.imaging.fileformats.apng/apngframe/frametime) { get; set; } | 获取或设置帧持续时间。 |
| [FrameTop](../../aspose.imaging.fileformats.apng/apngframe/frametop) { get; } | 获取帧顶部偏移量。 |
| override [HasAlpha](../../aspose.imaging.fileformats.apng/apngframe/hasalpha) { get; } | 获取一个值，表示这个实例是否有alpha。 |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/hasbackgroundcolor) { get; set; } | 获取是否有背景色的值。 |
| override [HasTransparentColor](../../aspose.imaging.fileformats.apng/apngframe/hastransparentcolor) { get; set; } | 获取图像是否具有透明色的值。 |
...
| override [CacheData](../../aspose.imaging.fileformats.apng/apngframe/cachedata)() | 缓存数据并确保不会从底层[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer)执行额外的数据加载。 |
...
以下示例显示如何创建来自另一个光栅单页图像的 APNG 图像。
