...
description: 获取最终的 Svg 图像其中包括通过SvgGraphics2Daspose.imaging.fileformats.svg.graphics/svggraphics2d对象执行的所有绘图命令
type: docs
weight: 90
...
获取最终的 Svg 图像，其中包括通过[`SvgGraphics2D`](../../svggraphics2d)对象执行的所有绘图命令。
