---
title: "类 VectorMultipageImage"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.VectorMultipageImage 类。矢量多页图像"
type: docs
weight: 11810
...
| override [BitsPerPixel](../../aspose.imaging/vectormultipageimage/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| override [IsCached](../../aspose.imaging/vectormultipageimage/iscached/) { get; } | 获取一个值，指示对象的数据当前是否已缓存且无需读取数据。 |
| override [Metadata](../../aspose.imaging/vectormultipageimage/metadata/) { get; } | 获取图像元数据。 |
| abstract [PageCount](../../aspose.imaging/vectormultipageimage/pagecount/) { get; } | 获取页面计数。 |
...
| 名称 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.imaging/vectormultipageimage/cachedata/)() | 缓存数据并确保不会从底层 [`DataStreamContainer`](../datastreamsupporter/datastreamcontainer/) 再进行额外的数据加载。 |
| [CanSave](../../aspose.imaging/image/cansave/)(ImageOptionsBase) | 确定图像是否可以保存为传入保存选项所表示的指定文件格式。 |
| override [Crop](../../aspose.imaging/vectormultipageimage/crop/#crop)(Rectangle) | 裁剪指定的矩形。 |
...
| override [RemoveBackground](../../aspose.imaging/vectormultipageimage/removebackground/#removebackground)() | 移除背景。 |
| override [RemoveBackground](../../aspose.imaging/vectormultipageimage/removebackground/#removebackground_1)(RemoveBackgroundSettings) | 移除背景。 |
