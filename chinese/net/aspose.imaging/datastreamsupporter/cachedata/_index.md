...
description: "DataStreamSupporter 方法。缓存数据并确保不会从底层的 DataStreamContainer 再次加载数据"
type: docs
weight: 30
url: /zh/net/aspose.imaging/datastreamsupporter/cachedata/
---
## DataStreamSupporter.CacheData method

缓存数据并确保不会从底层的 [`DataStreamContainer`](../datastreamcontainer/) 再次加载数据。
