...
description: 命名空间是嵌套命名空间的核心也是用于Aspose.Imaging处理的最基本的对象
type: docs
weight: 10
...
| [ShapeSegment](./shapesegment) | 表示一个形状段。线段是连接两点的直线或曲线。 |
| [Source](./source) | 源用于包含对象管道的所有相关信息。 |
| [SplitStreamContainer](./splitstreamcontainer) | 表示拆分流容器，它包含流并提供流处理例程。 |
| [StreamContainer](./streamcontainer) | 表示包含流并提供流处理例程的流容器。 |
...
| 枚举 | 描述 |
| --- | --- |
| [AnimationDisposalMethods](./animationdisposalmethods) | 表示图形显示后的处理方式。 |
...
| [WarpMode](./warpmode) | 指定应用的扭曲变换的类型。 |
