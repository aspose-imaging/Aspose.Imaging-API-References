...
description: "Aspose.Imaging.ImageOptionsBase 类。图像基础选项"
type: docs
weight: 10690
url: /zh/net/aspose.imaging/imageoptionsbase/
---
...
| [TrySetMetadata](../../aspose.imaging/imageoptionsbase/trysetmetadata/)(IImageMetadataFormat) | 尝试设置一个 *metadata* 实例，如果此 [`Image`](../image/) 实例支持并实现 [`IImageMetadataFormat`](../../aspose.imaging.metadata/iimagemetadataformat/) 实例。 |
