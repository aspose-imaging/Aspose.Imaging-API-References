...
绘制表示由[`RectangleF`](../../rectanglef)结构指定的椭圆的一部分的弧。
...
| sweepAngle | Int32 | 从*startAngle*参数到圆弧终点顺时针测量的角度。 |
...
绘制表示由[`Rectangle`](../../rectangle)结构指定的椭圆的一部分的弧。
