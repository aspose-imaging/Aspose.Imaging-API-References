...
description: 绘制由PointFaspose.imaging/pointf结构数组定义的多边形
type: docs
weight: 290
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen)确定颜色、宽度和样式多边形。 |
| points | PointF[] | [`PointF`](../../pointf)表示多边形顶点的结构的数组。 |
...
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen)确定颜色、宽度和样式多边形。 |
| points | Point[] | [`Point`](../../point)表示多边形顶点的结构的数组。 |
