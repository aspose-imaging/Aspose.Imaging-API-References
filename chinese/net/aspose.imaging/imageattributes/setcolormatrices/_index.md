...
| newColorMatrix | ColorMatrix | 颜色调整矩阵。 |
| grayMatrix | ColorMatrix | 灰度调整矩阵。 |
| flags | ColorMatrixFlag | 一个元素[`ColorMatrixFlag`](../../colormatrixflag)指定将受颜色调整和灰度调整矩阵影响的图像类型和颜色。 |
...
| newColorMatrix | ColorMatrix | 颜色调整矩阵。 |
| grayMatrix | ColorMatrix | 灰度调整矩阵。 |
| mode | ColorMatrixFlag | 一个元素[`ColorMatrixFlag`](../../colormatrixflag)指定将受颜色调整和灰度调整矩阵影响的图像类型和颜色。 |
| type | ColorAdjustType | 一个元素[`ColorAdjustType`](../../coloradjusttype)指定为其设置颜色调整和灰度调整矩阵的类别。 |
