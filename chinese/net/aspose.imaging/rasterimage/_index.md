...
| abstract [BitsPerPixel](../../aspose.imaging/image/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| abstract [IsCached](../../aspose.imaging/datastreamsupporter/iscached) { get; } | 获取对象的数据当前是否缓存，不需要读取数据。 |
...
| virtual [AdjustGamma](../../aspose.imaging/rasterimage/adjustgamma#adjustgamma)(float) | 图像的伽玛校正。 |
| virtual [AdjustGamma](../../aspose.imaging/rasterimage/adjustgamma#adjustgamma_1)(float, float, float) | 图像的伽玛校正。 |
...
| virtual [BinarizeFixed](../../aspose.imaging/rasterimage/binarizefixed)(byte) | 具有预定义阈值的图像的二值化 |
| virtual [BinarizeOtsu](../../aspose.imaging/rasterimage/binarizeotsu)() | 使用 Otsu 阈值对图像进行二值化 |
| abstract [CacheData](../../aspose.imaging/datastreamsupporter/cachedata)() | 缓存数据并确保不会从底层[`DataStreamContainer`](../datastreamsupporter/datastreamcontainer)执行额外的数据加载。 |
...
| virtual [Crop](../../aspose.imaging/rasterimage/crop#crop_1)(int, int, int, int) | 带班次裁剪图像。 |
...
| [NormalizeAngle](../../aspose.imaging/rasterimage/normalizeangle#normalizeangle)() | 标准化角度。 此方法适用于扫描的文本文档，以消除倾斜扫描。 此方法使用[`GetSkewAngle`](./getskewangle)和[`Rotate`](./rotate)方法。 |
| virtual [NormalizeAngle](../../aspose.imaging/rasterimage/normalizeangle#normalizeangle_1)(bool, Color) | 标准化角度。 此方法适用于扫描的文本文档，以消除倾斜扫描。 此方法使用[`GetSkewAngle`](./getskewangle)和[`Rotate`](./rotate)方法。 |
...
| [ReplaceNonTransparentColors](../../aspose.imaging/rasterimage/replacenontransparentcolors#replacenontransparentcolors)(Color) | 用新颜色替换所有非透明颜色并保留原始 alpha 值以保存平滑边缘。 注意:如果您在没有透明度的图像上使用它，所有颜色都将替换为一种颜色。 |
| virtual [ReplaceNonTransparentColors](../../aspose.imaging/rasterimage/replacenontransparentcolors#replacenontransparentcolors_1)(int) | 用新颜色替换所有非透明颜色并保留原始 alpha 值以保存平滑边缘。 注意:如果您在没有透明度的图像上使用它，所有颜色都将替换为一种颜色。 |
