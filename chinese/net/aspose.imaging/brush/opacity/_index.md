...
description: "Brush 属性。获取或设置画笔的不透明度。取值应在 0 到 1 之间。0 表示画笔完全可见，1 表示画笔完全不透明。"
type: docs
weight: 10
url: /zh/net/aspose.imaging/brush/opacity/
---
## Brush.Opacity property

获取或设置画笔的不透明度。该值应在 0 到 1 之间。0 表示画笔完全透明，1 表示画笔完全不透明。
