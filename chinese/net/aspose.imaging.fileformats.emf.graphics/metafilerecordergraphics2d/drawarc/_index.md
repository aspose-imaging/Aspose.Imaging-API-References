...
description: "MetafileRecorderGraphics2D 方法。绘制一个弧线，表示由 Rectangle 结构指定的椭圆的一部分。"
type: docs
weight: 50
url: /zh/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawarc/
---
## MetafileRecorderGraphics2D.DrawArc method

绘制由 Rectangle 结构指定的椭圆部分的弧。
...
| startAngle | 单精度 | 从 x 轴顺时针测量到弧线起始点的角度（度）。 |
| arcAngle | 单精度 | 以度为单位的角度，顺时针测量，从 startAngle 参数到弧的结束点。 |
