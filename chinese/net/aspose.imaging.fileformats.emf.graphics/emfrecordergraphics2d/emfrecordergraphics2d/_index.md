...
description: 初始化EmfRecorderGraphics2Daspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d类的新实例
type: docs
weight: 10
url: /zh/net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/emfrecordergraphics2d/
---
## EmfRecorderGraphics2D constructor

初始化[`EmfRecorderGraphics2D`](../../emfrecordergraphics2d)类的新实例。
...
| --- | --- | --- |
| frame | Rectangle | 帧。 |
| deviceSize | Size | 设备的大小。 |
| deviceSizeMm | Size | 设备尺寸 mm。 |
