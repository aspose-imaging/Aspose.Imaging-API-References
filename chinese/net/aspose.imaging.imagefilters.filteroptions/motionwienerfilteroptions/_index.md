...
description: "Aspose.Imaging.ImageFilters.FilterOptions.MotionWienerFilterOptions 类。运动去模糊滤镜选项"
type: docs
weight: 10080
...
| 名称 | 描述 |
| --- | --- |
| [Angle](../../aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/angle/) { get; set; } | 获取或设置角度（单位：度）。 |
...
| override [Kernel](../../aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/kernel/) { get; } | 获取核。 |
