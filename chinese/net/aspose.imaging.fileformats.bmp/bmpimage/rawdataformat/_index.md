...
description: "BmpImage 属性。使用此用户友好的函数，轻松获取原始数据的格式。非常适合希望快速访问数据格式关键信息的开发者。"
type: docs
weight: 90
url: /zh/net/aspose.imaging.fileformats.bmp/bmpimage/rawdataformat/
---
## BmpImage.RawDataFormat property

使用此友好函数轻松获取原始数据的格式。非常适合希望快速获取数据格式关键信息的开发人员。
