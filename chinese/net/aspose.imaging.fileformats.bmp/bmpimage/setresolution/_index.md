...
description: "BmpImage 方法。使用此用户友好的方法轻松调整 RasterImage 的分辨率。非常适合在应用程序中需要精确控制图像分辨率的开发者"
type: docs
weight: 140
...
使用此用户友好的方法轻松调整您的 [`RasterImage`](../../../aspose.imaging/rasterimage/) 的分辨率。非常适合在应用程序中需要精确控制图像分辨率的开发者。
