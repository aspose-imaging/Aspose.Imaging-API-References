...
description: "BmpImage 属性。使用此属性轻松检索图像的高度。对于需要快速获取图像尺寸信息的开发者而言，非常理想。"
type: docs
weight: 70
url: /zh/net/aspose.imaging.fileformats.bmp/bmpimage/height/
---
## BmpImage.Height property

使用此属性轻松获取图像的高度。非常适合需要快速获取图像尺寸信息的开发人员。
