...
description: "BmpImage 属性。使用此属性轻松获取图像使用的压缩类型。非常适合需要快速访问图像压缩信息的开发者。"
type: docs
weight: 40
url: /zh/net/aspose.imaging.fileformats.bmp/bmpimage/compression/
---
## BmpImage.Compression property

使用此属性轻松获取图像使用的压缩类型。非常适合需要快速获取图像压缩信息的开发人员。
