...
description: "BmpImage 属性。使用此简洁属性可快速获取每行原始数据的字节大小。非常适合需要高效处理原始图像数据的开发者。"
type: docs
weight: 100
url: /zh/net/aspose.imaging.fileformats.bmp/bmpimage/rawlinesize/
---
## BmpImage.RawLineSize property

使用此简洁属性快速获取每行原始数据的字节大小。非常适合需要高效处理原始图像数据的开发人员。
