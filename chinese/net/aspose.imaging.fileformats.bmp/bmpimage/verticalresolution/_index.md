...
description: "BmpImage 属性。使用此属性可以轻松获取或设置此 RasterImage 对象的垂直分辨率（每英寸像素数）。非常适合在应用程序中需要精确控制图像分辨率的开发者。"
type: docs
weight: 110
url: /zh/net/aspose.imaging.fileformats.bmp/bmpimage/verticalresolution/
---
## BmpImage.VerticalResolution property

使用此属性可以轻松获取或设置此 [`RasterImage`](../../../aspose.imaging/rasterimage/) 对象的垂直分辨率（每英寸像素数）。非常适合在应用程序中需要精确控制图像分辨率的开发者。
