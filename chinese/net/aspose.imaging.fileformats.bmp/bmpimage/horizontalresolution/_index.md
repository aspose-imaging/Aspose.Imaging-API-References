...
description: "BmpImage 属性。此属性允许您轻松获取或设置 RasterImage 对象的水平分辨率（以每英寸像素数计）。适用于需要对应用程序中图像分辨率进行精确控制的开发者。"
type: docs
weight: 80
url: /zh/net/aspose.imaging.fileformats.bmp/bmpimage/horizontalresolution/
---
## BmpImage.HorizontalResolution property

此属性允许您轻松获取或设置 [`RasterImage`](../../../aspose.imaging/rasterimage/) 对象的水平分辨率（以每英寸像素数计）。适用于需要对应用程序中图像分辨率进行精确控制的开发者。
