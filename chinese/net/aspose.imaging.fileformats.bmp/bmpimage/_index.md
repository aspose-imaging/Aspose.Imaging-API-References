...
description: bmp 图像支持 BMPDIB 格式
type: docs
weight: 1380
...
| 姓名 | 描述 |
| --- | --- |
| [BmpImage](bmpimage#constructor)(RasterImage) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_5)(Stream) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_7)(string) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_2)(int, int) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_3)(int, int, ushort, IColorPalette) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_1)(RasterImage, ushort, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_6)(Stream, ushort, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_8)(string, ushort, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
| [BmpImage](bmpimage#constructor_4)(int, int, ushort, IColorPalette, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.bmp/bmpimage/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| override [HorizontalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/horizontalresolution) { get; set; } | 获取或设置此[`RasterImage`](../../aspose.imaging/rasterimage)的水平分辨率，以每英寸像素为单位。 |
...
| override [RawLineSize](../../aspose.imaging.fileformats.bmp/bmpimage/rawlinesize) { get; } | 获取原始行大小（以字节为单位）。 |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/verticalresolution) { get; set; } | 获取或设置此[`RasterImage`](../../aspose.imaging/rasterimage)的垂直分辨率，以每英寸像素为单位。 |
...
| override [SetResolution](../../aspose.imaging.fileformats.bmp/bmpimage/setresolution)(double, double) | 设置分辨率[`RasterImage`](../../aspose.imaging/rasterimage)。 |
