...
description: 初始化BmpImageaspose.imaging.fileformats.bmp/bmpimage类的新实例
type: docs
weight: 10
...
| 例外 | （健康）状况 |
| --- | --- |
| ArgumentNullException | 光栅图像为空；rasterImage |
...
该示例展示了如何从具有指定位深度和分辨率的文件中加载 BmpImage。
...
该示例展示了如何从具有指定位深度和分辨率的文件流中加载 BmpImage。
...
该示例展示了如何从另一个 RasterImage 实例加载 BmpImage。
...
该示例展示了如何从另一个具有指定位深度和压缩率的 RasterImage 实例加载 BmpImage。
...
| 例外 | （健康）状况 |
| --- | --- |
| [BmpImageException](../../../aspose.imaging.coreexceptions.imageformats/bmpimageexception) | 高度应为正。 |
| ArgumentException | 应为每像素 8 位或更少的图像指定调色板。;调色板 |

### 例子

该示例展示了如何创建指定大小的 BmpImage。
