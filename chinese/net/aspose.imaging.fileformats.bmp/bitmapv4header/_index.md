---
title: "类 BitmapV4Header"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Bmp.BitmapV4Header 类。BitmapV4Header 结构是位图信息头文件。它是 BITMAPINFOHEADER 结构的扩展版本。BitmapV4Header 结构被扩展，以允许将 JPEG 或 PNG 图像作为源图像传递给 StretchDIBits。"
type: docs
weight: 1410
