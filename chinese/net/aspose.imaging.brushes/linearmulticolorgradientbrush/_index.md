...
description: "Aspose.Imaging.Brushes.LinearMulticolorGradientBrush 类。表示具有由多种颜色和相应位置定义的线性渐变的画笔。此类不可被继承"
type: docs
weight: 170
...
表示一个由多种颜色和相应位置定义的线性渐变的 [`Brush`](../../aspose.imaging/brush/) 。此类不可被继承。
...
| 名称 | 描述 |
| --- | --- |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor)() | 使用默认参数初始化 `LinearMulticolorGradientBrush` 类的新实例。起始颜色为黑色，结束颜色为白色，角度为 45 度，矩形位于 (0,0) 且大小为 (1,1)。 |
...
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_3)(Rectangle, float) | 基于矩形和方向角初始化 `LinearMulticolorGradientBrush` 类的新实例。 |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_5)(RectangleF, float) | 基于矩形和方向角初始化 `LinearMulticolorGradientBrush` 类的新实例。 |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_4)(Rectangle, float, bool) | 基于矩形和方向角初始化 `LinearMulticolorGradientBrush` 类的新实例。 |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush/#constructor_6)(RectangleF, float, bool) | 基于矩形和方向角初始化 `LinearMulticolorGradientBrush` 类的新实例。 |
...
| [InterpolationColors](../../aspose.imaging.brushes/linearmulticolorgradientbrush/interpolationcolors/) { get; set; } | 获取或设置一个定义多颜色线性渐变的 [`ColorBlend`](../../aspose.imaging/colorblend/)。 |
