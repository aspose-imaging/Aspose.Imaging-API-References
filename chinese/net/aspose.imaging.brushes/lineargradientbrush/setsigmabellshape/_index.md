...
type: docs
weight: 60
url: /zh/net/aspose.imaging.brushes/lineargradientbrush/setsigmabellshape/
---
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| focus | Single | 一个从 0 到 1 的值，指定渐变的中心（起始颜色和结束颜色混合的点一样）。 |
...
| scale | Single | 一个从 0 到 1 的值，指定颜色从*focus*衰减的速度。 |
