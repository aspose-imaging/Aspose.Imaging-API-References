...
| 姓名 | 描述 |
| --- | --- |
| [DjvuImage](djvuimage#constructor)(Stream) | 初始化[`DjvuImage`](../djvuimage)类的新实例。 |
| [DjvuImage](djvuimage#constructor_1)(Stream, LoadOptions) | 初始化[`DjvuImage`](../djvuimage)类的新实例。 |
...
| override [HasAlpha](../../aspose.imaging.fileformats.djvu/djvuimage/hasalpha) { get; } | 获取 Has alpha 通道。 |
...
| override [AdjustBrightness](../../aspose.imaging.fileformats.djvu/djvuimage/adjustbrightness)(int) | 调整图像的*brightness*。 |
| override [AdjustContrast](../../aspose.imaging.fileformats.djvu/djvuimage/adjustcontrast)(float) | [`Image`](../../aspose.imaging/image)对比 |
| override [AdjustGamma](../../aspose.imaging.fileformats.djvu/djvuimage/adjustgamma#adjustgamma)(float) | 图像的伽玛校正。 |
| override [AdjustGamma](../../aspose.imaging.fileformats.djvu/djvuimage/adjustgamma#adjustgamma_1)(float, float, float) | 图像的伽玛校正。 |
...
| override [BinarizeFixed](../../aspose.imaging.fileformats.djvu/djvuimage/binarizefixed)(byte) | 具有预定义阈值的图像的二值化 |
| override [BinarizeOtsu](../../aspose.imaging.fileformats.djvu/djvuimage/binarizeotsu)() | 使用 Otsu 阈值对图像进行二值化 |
| override [CacheData](../../aspose.imaging.fileformats.djvu/djvuimage/cachedata)() | 缓存数据私有。 |
...
| override [Crop](../../aspose.imaging.fileformats.djvu/djvuimage/crop#crop_1)(int, int, int, int) | 带班次裁剪图像。 |
...
| override [Rotate](../../aspose.imaging.fileformats.djvu/djvuimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate图像围绕中心。 |
