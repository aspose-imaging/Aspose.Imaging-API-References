...
description: 表示 Djvu 光栅图像的类该类位于某些操作的结果
type: docs
weight: 2460
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | 获取每像素的图像位数。 |
