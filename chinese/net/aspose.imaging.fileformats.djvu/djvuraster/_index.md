...
description: 表示 Djvu 光栅图像的类该类位于某些操作的结果位置
type: docs
weight: 2460
url: /zh/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

表示 Djvu 光栅图像的类，该类位于某些操作的结果位置
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | 获取高度。 |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | 获取长度。 |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | 获取宽度。 |
