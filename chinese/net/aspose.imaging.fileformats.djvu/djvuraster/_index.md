...
description: "Aspose.Imaging.FileFormats.Djvu.DjvuRaster 类。用于表示 Djvu 栅格图像的类，位于某些操作的结果所在位置。"
type: docs
weight: 2550
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
