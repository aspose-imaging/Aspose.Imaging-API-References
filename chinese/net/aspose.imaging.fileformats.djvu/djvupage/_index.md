...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvupage/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvupage/height) { get; } | 获取页面高度 |
...
| [IsColor](../../aspose.imaging.fileformats.djvu/djvupage/iscolor) { get; } | 获取一个值，该值指示此实例是否为彩色。 |
...
| [ParentImage](../../aspose.imaging.fileformats.djvu/djvupage/parentimage) { get; } | 获取页面所属的父图 |
...
| [ThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/thumbnailimage) { get; set; } | 获取或设置页面的缩略图 |
...
| [ExtractThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/extractthumbnailimage)() | 从 Djvu 页面中提取缩略图。 |
...
| [GetBackgroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getbackgroundimage)() | 获取背景图片。 |
