...
description: "Aspose.Imaging.FileFormats.Djvu.DjvuPage 类。Djvu 页面类"
type: docs
weight: 2540
url: /zh/net/aspose.imaging.fileformats.djvu/djvupage/
---
## DjvuPage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvupage/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvupage/height/) { get; } | 获取页面的高度 |
...
| [Image](../../aspose.imaging.fileformats.djvu/djvupage/image/) { get; } | 获取图像。 |
...
| [IsColor](../../aspose.imaging.fileformats.djvu/djvupage/iscolor/) { get; } | 获取指示此实例是否为彩色的值。 |
...
| [PageNumber](../../aspose.imaging.fileformats.djvu/djvupage/pagenumber/) { get; } | 获取页码。 |
| [Palette](../../aspose.imaging/image/palette/) { get; set; } | 获取或设置颜色调色板。当像素直接表示时，调色板不被使用。 |
| [ParentImage](../../aspose.imaging.fileformats.djvu/djvupage/parentimage/) { get; } | 获取页面所属的父图像 |
...
| [ThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/thumbnailimage/) { get; set; } | 获取或设置页面的缩略图图像 |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvupage/width/) { get; } | 获取页面的宽度 |
...
| [ExtractThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/extractthumbnailimage/)() | 从 Djvu 页面提取缩略图图像。 |
...
| [GetBackgroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getbackgroundimage/)() | 获取背景图像。 |
...
| [GetForegroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getforegroundimage/)(int) | 获取页面的前景图像 |
...
| [GetTextForLocation](../../aspose.imaging.fileformats.djvu/djvupage/gettextforlocation/)(Rectangle) | 获取矩形位置的文本 |
| [GetTextImage](../../aspose.imaging.fileformats.djvu/djvupage/gettextimage/)(int) | 获取文本图像。 |
...
| 名称 | 描述 |
| --- | --- |
| event [PropertyChanged](../../aspose.imaging.fileformats.djvu/djvupage/propertychanged/) | 当属性值更改时触发。 |
| static event [PageExportedAction](../../aspose.imaging.fileformats.djvu/djvupage/pageexportedaction/) | 当[page exported action]发生时触发。 |
