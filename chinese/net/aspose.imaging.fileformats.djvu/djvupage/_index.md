...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvupage/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| [IsColor](../../aspose.imaging.fileformats.djvu/djvupage/iscolor) { get; } | 获取表示此实例是否为彩色的值。 |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvupage/width) { get; } | 获取页面宽度 |
...
| [ExtractThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/extractthumbnailimage)() | 从 Djvu 页面提取缩略图。 |
