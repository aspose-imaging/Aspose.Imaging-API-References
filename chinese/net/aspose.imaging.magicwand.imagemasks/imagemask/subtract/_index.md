...
description: "ImageMask 方法。获取当前掩码减去提供的掩码的结果"
type: docs
weight: 190
url: /zh/net/aspose.imaging.magicwand.imagemasks/imagemask/subtract/
---
...
获取对提供的图像应用魔棒选择的结果，并从当前掩码中减去该结果。
