...
description: "Aspose.Imaging.FileFormats.Cdr.Objects.CdrPolygon 类。该 cdr 多边形"
type: docs
weight: 1760
url: /zh/net/aspose.imaging.fileformats.cdr.objects/cdrpolygon/
---
## CdrPolygon class
...
| [Points](../../aspose.imaging.fileformats.cdr.objects/cdrpolygon/points/) { get; set; } | 获取或设置点。 |
| [PointTypes](../../aspose.imaging.fileformats.cdr.objects/cdrpolygon/pointtypes/) { get; set; } | 获取或设置点类型。 |
