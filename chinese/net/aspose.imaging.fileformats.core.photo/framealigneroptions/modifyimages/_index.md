...
description: "FrameAlignerOptions 属性。获取或设置指示是否修改图像的值"
type: docs
weight: 30
url: /zh/net/aspose.imaging.fileformats.core.photo/framealigneroptions/modifyimages/
---
## FrameAlignerOptions.ModifyImages property

获取或设置指示是否 [modify image] 的值。
