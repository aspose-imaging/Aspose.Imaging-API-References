...
| 姓名 | 描述 |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | 初始化[`DicomPage`](../dicompage)类的新实例。 |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | 初始化[`DicomPage`](../dicompage)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel) { get; } | 获取每像素的图像位数。 |
