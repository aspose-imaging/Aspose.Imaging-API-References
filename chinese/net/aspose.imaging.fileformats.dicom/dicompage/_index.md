...
description: "Aspose.Imaging.FileFormats.Dicom.DicomPage 类。它是用于处理多帧类型 DICOM 文件的类"
type: docs
weight: 2520
...
| 名称 | 描述 |
| --- | --- |
| [DicomPage](dicompage/#constructor)(DicomImage, int) | 初始化 `DicomPage` 类的新实例。 |
| [DicomPage](dicompage/#constructor_1)(DicomImage, int, LoadOptions) | 初始化 `DicomPage` 类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| [Index](../../aspose.imaging.fileformats.dicom/dicompage/index/) { get; } | 获取当前页的索引。 |
