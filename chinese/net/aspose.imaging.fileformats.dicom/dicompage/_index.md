...
description: 它是用于处理多帧类型的 DICOM 文件的类
type: docs
weight: 2430
url: /zh/net/aspose.imaging.fileformats.dicom/dicompage/
---
## DicomPage class

它是用于处理多帧类型的 DICOM 文件的类
...
| 姓名 | 描述 |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | 初始化[`DicomPage`](../dicompage)类. |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | 初始化[`DicomPage`](../dicompage)类. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| override [FileFormat](../../aspose.imaging.fileformats.dicom/dicompage/fileformat) { get; } | 获取文件格式的值 |
...
| override [Height](../../aspose.imaging.fileformats.dicom/dicompage/height) { get; } | 获取图像高度。 |
...
| [Index](../../aspose.imaging.fileformats.dicom/dicompage/index) { get; } | 获取当前页面的索引。 |
...
| override [Width](../../aspose.imaging.fileformats.dicom/dicompage/width) { get; } | 获取图像宽度。 |
