...
| 姓名 | 描述 |
| --- | --- |
| [GifImage](gifimage#constructor)(GifFrameBlock) | 初始化[`GifImage`](../gifimage)类的新实例。 |
| [GifImage](gifimage#constructor_1)(GifFrameBlock, IColorPalette) | 初始化[`GifImage`](../gifimage)类的新实例。 |
| [GifImage](gifimage#constructor_2)(GifFrameBlock, IColorPalette, bool, byte, byte, byte, bool) | 初始化[`GifImage`](../gifimage)类的新实例。 |
...
| [BackgroundColorIndex](../../aspose.imaging.fileformats.gif/gifimage/backgroundcolorindex) { get; set; } | 获取或设置背景颜色索引。 |
...
| override [HasBackgroundColor](../../aspose.imaging.fileformats.gif/gifimage/hasbackgroundcolor) { get; } | 获取图像是否有背景色的值。 |
...
| override [ImageOpacity](../../aspose.imaging.fileformats.gif/gifimage/imageopacity) { get; } | 获取此图像（活动帧）的不透明度。 |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif/gifimage/isinterlaced) { get; } | 获取一个值，该值指示此图像实例是否是隔行扫描的。 |
...
| override [PageExportingAction](../../aspose.imaging.fileformats.gif/gifimage/pageexportingaction) { get; set; } | 获取或设置页面导出动作。 请注意，设置该方法执行后会自动释放页面资源。 它将在每个页面保存之前执行。 |
...
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif/gifimage/adjustbrightness)(int) | 调整图像的*brightness*。 |
| override [AdjustContrast](../../aspose.imaging.fileformats.gif/gifimage/adjustcontrast)(float) | 调整对比度。 |
| override [AdjustGamma](../../aspose.imaging.fileformats.gif/gifimage/adjustgamma#adjustgamma)(float) | 图像的伽玛校正。 |
| override [AdjustGamma](../../aspose.imaging.fileformats.gif/gifimage/adjustgamma#adjustgamma_1)(float, float, float) | 图像的伽玛校正。 |
...
| override [BinarizeFixed](../../aspose.imaging.fileformats.gif/gifimage/binarizefixed)(byte) | 具有预定义阈值的图像的二值化 |
...
| override [Crop](../../aspose.imaging/rastercachedmultipageimage/crop)(int, int, int, int) | 带班次裁剪图像。 |
...
| override [GetOriginalOptions](../../aspose.imaging.fileformats.gif/gifimage/getoriginaloptions)() | 获取基于原始文件设置的选项。 这有助于保持原始图像的位深度和其他参数不变。 例如，如果我们加载一个每像素 1 位的黑白 PNG 图像，然后使用 String)方法，将生成每像素 8 位的输出 PNG 图像。 为避免它并以每像素 1 位保存 PNG 图像，请使用此方法获取相应的保存选项并将它们传递 到ImageOptionsBase)方法作为第二个参数。 |
...
| [OrderBlocks](../../aspose.imaging.fileformats.gif/gifimage/orderblocks)() | 根据 GIF 规范对 GIF 块进行排序。一些[`GifGraphicsControlBlock`](../../aspose.imaging.fileformats.gif.blocks/gifgraphicscontrolblock)可能会被删除以进行正确的 GIF 布局。 |
...
| [ResizeFullFrame](../../aspose.imaging.fileformats.gif/gifimage/resizefullframe)(int, int, ResizeType) | 使用每个 GIF 页面的全帧调整图像大小。需要避免可能的伪影出现。 |
...
| [ResizeProportional](../../aspose.imaging.fileformats.gif/gifimage/resizeproportional)(int, int, ResizeType) | 对图像执行按比例调整大小。 比例调整大小将根据*newWidth*/width 和*newHeight*/height 的比例调整每一帧的大小。 |
...
| override [Rotate](../../aspose.imaging.fileformats.gif/gifimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate图像围绕中心。 |
