---
title: "类 EmfPlusComment"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Emf.EmfPlus.Records.EmfPlusComment 类。EmfPlusComment 记录指定任意私有数据。"
type: docs
weight: 6000
...
| 名称 | 描述 |
| --- | --- |
| [EmfPlusComment](emfpluscomment/)(EmfPlusRecord) | 初始化 `EmfPlusComment` 类的新实例。 |
...
| override [Flags](../../aspose.imaging.fileformats.emf.emfplus.records/emfpluscomment/flags/) { get; set; } | 获取或设置未使用的 16 位无符号整数。此字段应设置为零，且在接收时必须被忽略。 |
| [PrivateData](../../aspose.imaging.fileformats.emf.emfplus.records/emfpluscomment/privatedata/) { get; set; } | 获取或设置一个长度为 DataSize 的私有数据字节数组。后面跟随记录特定的数据字节。 |
