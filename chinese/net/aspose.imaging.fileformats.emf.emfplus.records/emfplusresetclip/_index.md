...
description: EmfPlusResetClip 记录将世界空间的当前剪切区域重置为无穷大
type: docs
weight: 6210
...
EmfPlusResetClip 记录将世界空间的当前剪切区域重置为无穷大。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfPlusResetClip](emfplusresetclip)(EmfPlusRecord) | 初始化[`EmfPlusResetClip`](../emfplusresetclip)类的新实例。 |
