---
title: "类 EmfPlusResetClip"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Emf.EmfPlus.Records.EmfPlusResetClip 类。EmfPlusResetClip 记录将世界空间的当前剪裁区域重置为无限。"
type: docs
weight: 6330
url: /zh/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/
---
## EmfPlusResetClip class

此 EmfPlusResetClip 记录将当前世界空间的剪裁区域重置为无限。
...
| 名称 | 描述 |
| --- | --- |
| [EmfPlusResetClip](emfplusresetclip/)(EmfPlusRecord) | 初始化 `EmfPlusResetClip` 类的新实例。 |
