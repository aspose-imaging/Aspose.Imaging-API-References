...
description: "EmfPlusMultiplyWorldTransform 属性。获取一个值，指示是否为后乘矩阵。如果设置，变换矩阵应后乘。如果清除，则应前乘。"
type: docs
weight: 30
...
获取一个值，指示 [post multiplied matrix]。如果设置，则变换矩阵应后乘。如果未设置，则应前乘。
...
`true` 表示 [post multiplied matrix]；否则为 `false`。
