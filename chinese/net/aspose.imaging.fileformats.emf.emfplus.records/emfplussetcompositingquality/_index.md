...
description: EmfPlusSetCompositingQuality 记录指定从多个对象创建 合成图像所需的质量级别
type: docs
weight: 6330
url: /zh/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/
---
## EmfPlusSetCompositingQuality class

EmfPlusSetCompositingQuality 记录指定从多个对象创建 合成图像所需的质量级别。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfPlusSetCompositingQuality](emfplussetcompositingquality)(EmfPlusRecord) | 初始化[`EmfPlusSetCompositingQuality`](../emfplussetcompositingquality)类的新实例。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [CompositingQuality](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/compositingquality) { get; set; } | 获取或设置合成质量。 |
