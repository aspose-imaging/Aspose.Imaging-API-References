---
title: "类 EmfPlusTerminalServerRecordType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Emf.EmfPlus.Records.EmfPlusTerminalServerRecordType 类。终端服务器记录类型指定在终端服务器上的图形处理。以下是 EMF 终端服务器记录类型。"
type: docs
weight: 6560
...
Terminal Server Record Types 指定终端服务器上的图形处理。以下是 EMF+ 终端服务器记录类型。
