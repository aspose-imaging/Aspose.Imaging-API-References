...
description: EmfPlusResetWorldTransform 记录将当前世界空间变换重置为识别矩阵
type: docs
weight: 6220
url: /zh/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/
---
## EmfPlusResetWorldTransform class

EmfPlusResetWorldTransform 记录将当前世界空间变换重置为识别矩阵。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfPlusResetWorldTransform](emfplusresetworldtransform)(EmfPlusRecord) | 初始化[`EmfPlusResetWorldTransform`](../emfplusresetworldtransform)类的新实例。 |
