---
title: "类 WebPFrameBlock"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Webp.WebPFrameBlock 类。表示 webp 块打开器注册表"
type: docs
weight: 8250
url: /zh/net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| 名称 | 描述 |
| --- | --- |
| [WebPFrameBlock](webpframeblock/#constructor)(RasterImage) | 初始化 `WebPFrameBlock` 的新实例 |
| [WebPFrameBlock](webpframeblock/#constructor_1)(int, int) | 初始化 `WebPFrameBlock` 类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod/) { get; set; } | 获取或设置处置方法。 |
| [Disposed](../../aspose.imaging/disposableobject/disposed/) { get; } | 获取一个值，指示此实例是否已释放。 |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration/) { get; set; } | 获取或设置帧持续时间。 |
...
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft/) { get; } | 获取帧左偏移量。 |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime/) { get; } | 获取帧持续时间。 |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop/) { get; } | 获取帧的顶部偏移量。 |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha/) { get; } | 获取一个值，指示此实例是否具有 alpha。 |
...
| override [Height](../../aspose.imaging.fileformats.webp/webpframeblock/height/) { get; } | 获取图像高度。 |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left/) { get; set; } | 获取或设置帧左侧位置。 |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top/) { get; set; } | 获取或设置帧顶部位置。 |
...
| [UseAlphaBlending](../../aspose.imaging.fileformats.webp/webpframeblock/usealphablending/) { get; set; } | 获取或设置指示当前帧是否与前一帧的 alpha 值混合的值。 |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width/) { get; } | 获取图像宽度。 |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe/)() | 获取完整帧。 |
