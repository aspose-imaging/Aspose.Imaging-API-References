...
| 姓名 | 描述 |
| --- | --- |
| [WebPFrameBlock](webpframeblock#constructor)(RasterImage) | 初始化[`WebPFrameBlock`](../webpframeblock) |
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | 初始化[`WebPFrameBlock`](../webpframeblock)类. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | 获取处置方法。 |
...
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | 获取框架顶部偏移量。 |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | 获取一个值，该值指示此实例是否具有 alpha。 |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | 获取或设置左边框位置。 |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | 获取或设置帧位置 top. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe)() | 获取全帧。 |
