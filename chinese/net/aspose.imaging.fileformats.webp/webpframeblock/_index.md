...
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | 初始化[`WebPFrameBlock`](../webpframeblock)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | 获取处理方法。 |
...
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft) { get; } | 获取帧左偏移。 |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime) { get; } | 获取帧持续时间。 |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | 获取帧顶部偏移量。 |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | 获取或设置左边的帧位置。 |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | 获取或设置帧位置顶部。 |
