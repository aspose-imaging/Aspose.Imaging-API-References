---
title: "类 WmfRecorderGraphics2D"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Wmf.Graphics.WmfRecorderGraphics2D 类。Wmf 记录器"
type: docs
weight: 8550
...
| 名称 | 描述 |
| --- | --- |
| [WmfRecorderGraphics2D](wmfrecordergraphics2d/)(Rectangle, int) | 初始化 `WmfRecorderGraphics2D` 类的新实例。 |
...
| [BackgroundMode](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/backgroundmode/) { get; set; } | 获取或设置背景模式。 |
