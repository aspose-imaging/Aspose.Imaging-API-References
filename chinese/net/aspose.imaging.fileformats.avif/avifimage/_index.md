...
description: "Aspose.Imaging.FileFormats.Avif.AvifImage 类。Avif 图像"
type: docs
weight: 1360
url: /zh/net/aspose.imaging.fileformats.avif/avifimage/
---
## AvifImage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.avif/avifimage/bitsperpixel/) { get; } | 获取每像素位数的值。 |
...
| override [FileFormat](../../aspose.imaging.fileformats.avif/avifimage/fileformat/) { get; } | 获取文件格式的值 |
...
| override [Height](../../aspose.imaging.fileformats.avif/avifimage/height/) { get; } | 获取 AVIF 图像的高度。 |
...
| override [Width](../../aspose.imaging.fileformats.avif/avifimage/width/) { get; } | 获取 AVIF 图像的宽度。 |
