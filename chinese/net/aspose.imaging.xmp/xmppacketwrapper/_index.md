...
| [Packages](../../aspose.imaging.xmp/xmppacketwrapper/packages) { get; } | 获取 XMP 中[`XmpPackage`](../xmppackage)的数组。 |
...
| [ClearPackages](../../aspose.imaging.xmp/xmppacketwrapper/clearpackages)() | 删除 XMP 内的所有[`XmpPackage`](../xmppackage)。 |
...
由一对 XML 处理指令 (PI) 组成的包装器可以放置在 rdf 周围:RDF 元素。
