...
用于带二进制头的封装 PostScript（Encapsulated PostScript）格式的类
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/hasrasterpreview) { get; } | 获取一个值，指示此实例是否具有特定格式的栅格预览 |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsbinaryimage/op_explicit) | 执行从 [`EpsInterchangeImage`](../epsinterchangeimage) 到 [`EpsBinaryImage`](../epsbinaryimage) 的显式转换 |
