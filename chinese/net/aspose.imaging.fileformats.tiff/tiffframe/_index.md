...
description: "Aspose.Imaging.FileFormats.Tiff.TiffFrame 类。tiff 帧"
type: docs
weight: 8020
...
| 名称 | 描述 |
| --- | --- |
| [TiffFrame](tiffframe/#constructor_1)(RasterImage) | 初始化 `TiffFrame` 类的新实例。 |
| [TiffFrame](tiffframe/#constructor_3)(Stream) | 初始化 `TiffFrame` 类的新实例。 |
| [TiffFrame](tiffframe/#constructor_5)(string) | 初始化 `TiffFrame` 类的新实例。 |
| [TiffFrame](tiffframe/#constructor_2)(RasterImage, TiffOptions) | 初始化 `TiffFrame` 类的新实例。 |
| [TiffFrame](tiffframe/#constructor_4)(Stream, TiffOptions) | 初始化 `TiffFrame` 类的新实例。 |
| [TiffFrame](tiffframe/#constructor_6)(string, TiffOptions) | 初始化 `TiffFrame` 类的新实例。 |
| [TiffFrame](tiffframe/#constructor)(TiffOptions, int, int) | 初始化 `TiffFrame` 类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.tiff/tiffframe/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| [FrameOptions](../../aspose.imaging.fileformats.tiff/tiffframe/frameoptions/) { get; } | 获取帧创建选项。 |
| override [HasAlpha](../../aspose.imaging.fileformats.tiff/tiffframe/hasalpha/) { get; } | 获取一个值，指示此实例是否具有 alpha。 |
...
| override [HorizontalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/horizontalresolution/) { get; set; } | 获取或设置此 [`RasterImage`](../../aspose.imaging/rasterimage/) 的水平分辨率（每英寸像素数）。 |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/verticalresolution/) { get; set; } | 获取或设置此 [`RasterImage`](../../aspose.imaging/rasterimage/) 的垂直分辨率（每英寸像素数）。 |
...
| 名称 | 描述 |
| --- | --- |
| static [CopyFrame](../../aspose.imaging.fileformats.tiff/tiffframe/copyframe/)(TiffFrame) | 复制整个帧（副本）。 |
| static [CreateFrameFrom](../../aspose.imaging.fileformats.tiff/tiffframe/createframefrom/)(TiffFrame, TiffOptions) | 使用指定的 *options* 从指定的 *tiffFrame* 创建帧。像素数据被保留，但会转换为所需的格式。 |
...
| [AlignResolutions](../../aspose.imaging.fileformats.tiff/tiffframe/alignresolutions/)() | 帮助方法，使水平和垂直分辨率相等。 |
...
| override [RemoveMetadata](../../aspose.imaging.fileformats.tiff/tiffframe/removemetadata/)() | 通过将此 [`XmpData`](../../aspose.imaging.xmp/ihasxmpdata/xmpdata/) 和 [`ExifData`](../../aspose.imaging.exif/ihasexifdata/exifdata/) 的值设为 `null` 来移除该图像实例的元数据。 |
...
| override [RotateFlip](../../aspose.imaging.fileformats.tiff/tiffframe/rotateflip/)(RotateFlipType) | 旋转、翻转或同时旋转和翻转图像。 |
