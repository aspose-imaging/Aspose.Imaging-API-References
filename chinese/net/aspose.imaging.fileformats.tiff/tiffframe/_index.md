...
| 姓名 | 描述 |
| --- | --- |
| [TiffFrame](tiffframe#constructor_1)(RasterImage) | 初始化[`TiffFrame`](../tiffframe)类的新实例。 |
| [TiffFrame](tiffframe#constructor_3)(Stream) | 初始化[`TiffFrame`](../tiffframe)类的新实例。 |
| [TiffFrame](tiffframe#constructor_5)(string) | 初始化[`TiffFrame`](../tiffframe)类的新实例。 |
| [TiffFrame](tiffframe#constructor_2)(RasterImage, TiffOptions) | 初始化[`TiffFrame`](../tiffframe)类的新实例。 |
| [TiffFrame](tiffframe#constructor_4)(Stream, TiffOptions) | 初始化[`TiffFrame`](../tiffframe)类的新实例。 |
| [TiffFrame](tiffframe#constructor_6)(string, TiffOptions) | 初始化[`TiffFrame`](../tiffframe)类的新实例。 |
| [TiffFrame](tiffframe#constructor)(TiffOptions, int, int) | 初始化[`TiffFrame`](../tiffframe)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.tiff/tiffframe/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.tiff/tiffframe/hastransparentcolor) { get; set; } | 获取图像是否具有透明色的值。 |
| override [Height](../../aspose.imaging.fileformats.tiff/tiffframe/height) { get; } | 获取图像高度。 |
| override [HorizontalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/horizontalresolution) { get; set; } | 获取或设置此[`RasterImage`](../../aspose.imaging/rasterimage)的水平分辨率，以每英寸像素为单位。 |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/verticalresolution) { get; set; } | 获取或设置此[`RasterImage`](../../aspose.imaging/rasterimage)的垂直分辨率，以每英寸像素为单位。 |
...
| static [CreateFrameFrom](../../aspose.imaging.fileformats.tiff/tiffframe/createframefrom)(TiffFrame, TiffOptions) | 从指定的*tiffFrame*使用指定的*options*创建框架。 像素数据被保留但转换为所需的格式。 |
...
| override [GetOriginalOptions](../../aspose.imaging.fileformats.tiff/tiffframe/getoriginaloptions)() | 获取基于原始文件设置的选项。 这有助于保持原始图像的位深度和其他参数不变。 例如，如果我们加载一个每像素 1 位的黑白 PNG 图像，然后使用 String)方法，将生成每像素 8 位的输出 PNG 图像。 为避免它并以每像素 1 位保存 PNG 图像，请使用此方法获取相应的保存选项并将它们传递 到ImageOptionsBase)方法作为第二个参数。 |
