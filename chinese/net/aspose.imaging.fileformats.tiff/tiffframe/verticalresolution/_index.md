...
description: "TiffFrame 属性。获取或设置此 RasterImage 的垂直分辨率（每英寸像素数）"
type: docs
weight: 110
url: /zh/net/aspose.imaging.fileformats.tiff/tiffframe/verticalresolution/
---
## TiffFrame.VerticalResolution property

获取或设置此 [`RasterImage`](../../../aspose.imaging/rasterimage/) 的垂直分辨率（每英寸像素数）。
