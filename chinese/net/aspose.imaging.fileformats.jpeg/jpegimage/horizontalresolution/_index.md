...
description: "JpegImage 属性。此属性让您访问 RasterImage 的水平分辨率，以每英寸像素数衡量。通过设置或获取此值，您可以精确控制图像的分辨率，确保其满足您对质量和清晰度的具体要求。"
type: docs
weight: 100
url: /zh/net/aspose.imaging.fileformats.jpeg/jpegimage/horizontalresolution/
---
## JpegImage.HorizontalResolution property

此属性让您访问 [`RasterImage`](../../../aspose.imaging/rasterimage/) 的水平分辨率，以每英寸像素数衡量。通过设置或获取此值，您可以精确控制图像的分辨率，确保其满足您对质量和清晰度的具体要求。
