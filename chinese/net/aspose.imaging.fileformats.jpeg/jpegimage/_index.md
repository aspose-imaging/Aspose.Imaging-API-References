...
| 姓名 | 描述 |
| --- | --- |
| [JpegImage](jpegimage#constructor_1)(RasterImage) | 初始化[`JpegImage`](../jpegimage)类的新实例。 |
| [JpegImage](jpegimage#constructor_3)(Stream) | 初始化[`JpegImage`](../jpegimage)类的新实例。 |
| [JpegImage](jpegimage#constructor_4)(string) | 初始化[`JpegImage`](../jpegimage)类的新实例。 |
| [JpegImage](jpegimage#constructor_2)(int, int) | 初始化[`JpegImage`](../jpegimage)类的新实例。 |
| [JpegImage](jpegimage#constructor)(JpegOptions, int, int) | 初始化[`JpegImage`](../jpegimage)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg/jpegimage/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| [Comment](../../aspose.imaging.fileformats.jpeg/jpegimage/comment) { get; set; } | 获取或设置 jpeg 文件注释。 |
...
| [ExifData](../../aspose.imaging.fileformats.jpeg/jpegimage/exifdata) { get; set; } | 获取或设置 exif 数据容器 |
...
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/horizontalresolution) { get; set; } | 获取或设置此[`RasterImage`](../../aspose.imaging/rasterimage)的水平分辨率，以每英寸像素为单位。 |
...
| [JpegOptions](../../aspose.imaging.fileformats.jpeg/jpegimage/jpegoptions) { get; } | 获取用于创建或加载此[`JpegImage`](../jpegimage)实例的 JPEG 选项。 |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/verticalresolution) { get; set; } | 获取或设置此[`RasterImage`](../../aspose.imaging/rasterimage)的垂直分辨率，以每英寸像素为单位。 |
...
| override [SetResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/setresolution)(double, double) | 设置分辨率[`RasterImage`](../../aspose.imaging/rasterimage)。 |
