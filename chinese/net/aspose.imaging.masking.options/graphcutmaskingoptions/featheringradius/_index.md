---
title: "GraphCutMaskingOptions.FeatheringRadius"
second_title: "Aspose.Imaging for .NET API 参考"
description: "GraphCutMaskingOptions 属性。获取或设置羽化半径"
type: docs
weight: 20
url: /zh/net/aspose.imaging.masking.options/graphcutmaskingoptions/featheringradius/
---
...
将 Graph Cut 图像遮罩结果保存，羽化设置为 3。图像遮罩使用指定的 Point 数组执行。
