...
description: "AutoMaskingGraphCutOptions 属性。获取或设置一个值，指示是否应计算默认笔画"
type: docs
weight: 30
url: /zh/net/aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes/
---
## AutoMaskingGraphCutOptions.CalculateDefaultStrokes property

获取或设置一个值，指示是否应计算默认笔画。
