...
| 姓名 | 描述 |
| --- | --- |
| [TgaImage](tgaimage#constructor)(RasterImage) | 初始化[`TgaImage`](../tgaimage)类的新实例。 |
| [TgaImage](tgaimage#constructor_1)(Stream) | 初始化[`TgaImage`](../tgaimage)类的新实例。 |
| [TgaImage](tgaimage#constructor_2)(string) | 初始化[`TgaImage`](../tgaimage)类的新实例。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AuthorComments](../../aspose.imaging.fileformats.tga/tgaimage/authorcomments) { get; set; } | 获取或设置作者评论。 这是一个 ASCII 字段，由 324 个字节组成，分为四行 80 个字符，每行后跟一个空终止符。 |
| [AuthorName](../../aspose.imaging.fileformats.tga/tgaimage/authorname) { get; set; } | 获取或设置作者姓名。 此字段是名称的 40 个 ASCII 字符。如果使用该字段， 它应该包含创建图像的人（作者）的姓名。 |
...
| [DateTimeStamp](../../aspose.imaging.fileformats.tga/tgaimage/datetimestamp) { get; set; } | 获取或设置日期/时间戳。 此字段定义图像保存的日期和时间值。 尽管操作系统通常是时间戳和日期戳文件，但提供此功能是 因为如果文件是:::47，操作系统可能会更改时间和日期戳:::复制。通过使用此区域，您可以保证在日期和时间 记录中使用未修改的区域。 |
...
| [GammaValueDenominator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluedenominator) { get; } | 获取 Gamma 值分母部分。 未校正的图像（没有伽马的图像）的结果应该是 1.0。 |
| [GammaValueNumerator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluenumerator) { get; } | 获取 Gamma 值分子部分。 未校正的图像（没有伽马的图像）的结果应该是 1.0。 |
| override [HasAlpha](../../aspose.imaging.fileformats.tga/tgaimage/hasalpha) { get; } | 获取一个值，该值指示此[`TgaImage`](../tgaimage)是否具有 alpha 通道。 |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.tga/tgaimage/hasbackgroundcolor) { get; set; } | 获取或设置一个值，该值指示图像是否具有背景色。 |
| [HasColorMap](../../aspose.imaging.fileformats.tga/tgaimage/hascolormap) { get; } | 获取一个值，该值指示此图像是否具有颜色图。 |
| override [HasTransparentColor](../../aspose.imaging.fileformats.tga/tgaimage/hastransparentcolor) { get; set; } | 获取或设置一个值，该值指示图像是否具有透明色。 |
...
| [IsGrayScale](../../aspose.imaging.fileformats.tga/tgaimage/isgrayscale) { get; } | 获取一个值，该值指示此[`TgaImage`](../tgaimage)是否为灰度。 |
...
| [XOrigin](../../aspose.imaging.fileformats.tga/tgaimage/xorigin) { get; set; } | 获取或设置图像左下角的绝对水平坐标 因为它位于原点位于下方的显示设备上 屏幕左侧（例如，TARGA 系列）。 |
| [YOrigin](../../aspose.imaging.fileformats.tga/tgaimage/yorigin) { get; set; } | 获取或设置图像左下角的绝对垂直坐标 因为它位于原点位于下方的显示设备上 屏幕左侧（例如，TARGA 系列）。 |
...
| override [Crop](../../aspose.imaging.fileformats.tga/tgaimage/crop#crop_1)(int, int, int, int) | 带班次裁剪图像。 |
...
| override [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals_1)(object) | 相等比较。 |
| [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals)(TgaImage) | 相等比较。 |
...
| override [GetHashCode](../../aspose.imaging.fileformats.tga/tgaimage/gethashcode)() | 获取此实例的哈希码。不适合用作键，因为[`TgaImage`](../tgaimage)不是不可变的。 |
...
| override [Rotate](../../aspose.imaging.fileformats.tga/tgaimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate图像围绕中心。 |
...
| [operator ==](../../aspose.imaging.fileformats.tga/tgaimage/op_equality) | 相等比较。 |
