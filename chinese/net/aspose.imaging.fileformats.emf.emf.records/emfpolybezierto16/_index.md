---
title: "类 EmfPolyBezierTo16"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Emf.Emf.Records.EmfPolyBezierTo16 类。EMR_POLYBEZIERTO16 记录指定基于当前位置信息的一个或多个贝塞尔曲线。"
type: docs
weight: 4090
url: /zh/net/aspose.imaging.fileformats.emf.emf.records/emfpolybezierto16/
---
## EmfPolyBezierTo16 class

EMR_POLYBEZIERTO16 记录指定基于当前位置信息的一个或多个贝塞尔曲线。
...
| 名称 | 描述 |
| --- | --- |
| [EmfPolyBezierTo16](emfpolybezierto16/#constructor)() | 初始化 `EmfPolyBezierTo16` 类的新实例。 |
| [EmfPolyBezierTo16](emfpolybezierto16/#constructor_1)(EmfRecord) | 初始化 `EmfPolyBezierTo16` 类的新实例。 |
