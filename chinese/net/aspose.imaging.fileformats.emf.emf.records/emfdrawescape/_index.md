...
description: EMR_DRAWESCAPE 记录将任意信息传递给打印机驱动程序目的是 信息将导致绘制完成
type: docs
weight: 3550
...
EMR_DRAWESCAPE 记录将任意信息传递给打印机驱动程序。目的是 信息将导致绘制完成。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfDrawEscape](emfdrawescape)(EmfRecord) | 初始化[`EmfDrawEscape`](../emfdrawescape)类的新实例。 |
