...
description: EMR_EXTESCAPE 记录将任意信息传递给打印机驱动程序目的是 信息不会导致绘制完成
type: docs
weight: 3640
...
EMR_EXTESCAPE 记录将任意信息传递给打印机驱动程序。目的是 信息不会导致绘制完成。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfExtEscape](emfextescape)(EmfRecord) | 初始化[`EmfExtEscape`](../emfextescape)类的新实例。 |
