---
title: "类 EmfPolyBezier16"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Emf.Emf.Records.EmfPolyBezier16 类。EMR_POLYBEZIER16 记录指定一个或多个贝塞尔曲线。曲线使用当前笔绘制。"
type: docs
weight: 4070
...
EMR_POLYBEZIER16 记录指定一个或多个贝塞尔曲线。曲线使用当前画笔绘制。
...
| 名称 | 描述 |
| --- | --- |
| [EmfPolyBezier16](emfpolybezier16/#constructor)() | 初始化 `EmfPolyBezier16` 类的新实例。 |
| [EmfPolyBezier16](emfpolybezier16/#constructor_1)(EmfRecord) | 初始化 `EmfPolyBezier16` 类的新实例。 |
