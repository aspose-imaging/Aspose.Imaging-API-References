...
description: "EmfColorMatchToTargetW 属性。获取或设置一个 32 位无符号整数，指定所需颜色配置文件的 Unicode UTF16LE 名称的字节数"
type: docs
weight: 30
url: /zh/net/aspose.imaging.fileformats.emf.emf.records/emfcolormatchtotargetw/cbname/
---
