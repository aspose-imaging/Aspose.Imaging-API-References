---
title: "类 TiffShortType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffShortType 类。The tiff short type"
type: docs
weight: 8210
...
| 名称 | 描述 |
| --- | --- |
| [TiffShortType](tiffshorttype/#constructor)(TiffTags) | 初始化 `TiffShortType` 类的新实例。 |
| [TiffShortType](tiffshorttype/#constructor_1)(ushort) | 初始化 `TiffShortType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/elementsize/) { get; } | 获取元素的字节大小。 |
