---
title: "类 TiffFloatType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffFloatType 类。tiff 浮点型"
type: docs
weight: 8100
url: /zh/net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/
---
## TiffFloatType class
...
| 名称 | 描述 |
| --- | --- |
| [TiffFloatType](tifffloattype/#constructor)(TiffTags) | 初始化 `TiffFloatType` 类的新实例。 |
| [TiffFloatType](tifffloattype/#constructor_1)(ushort) | 初始化 `TiffFloatType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/elementsize/) { get; } | 获取元素的字节大小。 |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/tagtype/) { get; } | 获取标签类型。 |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/value/) { get; set; } | 获取或设置此数据类型包含的值。 |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/values/) { get; set; } | 获取或设置这些值。 |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/valuescontainer/) { get; } | 获取值容器。 |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/writeadditionaldata/)(TiffStreamWriter) | 写入附加标签数据。 |
