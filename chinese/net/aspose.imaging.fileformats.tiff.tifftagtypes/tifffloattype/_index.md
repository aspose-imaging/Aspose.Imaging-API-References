...
| 姓名 | 描述 |
| --- | --- |
| [TiffFloatType](tifffloattype#constructor)(TiffTags) | 初始化[`TiffFloatType`](../tifffloattype)类的新实例。 |
| [TiffFloatType](tifffloattype#constructor_1)(ushort) | 初始化[`TiffFloatType`](../tifffloattype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/values) { get; set; } | 获取或设置值。 |
