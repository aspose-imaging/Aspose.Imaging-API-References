...
| 姓名 | 描述 |
| --- | --- |
| [TiffFloatType](tifffloattype#constructor)(TiffTags) | 初始化[`TiffFloatType`](../tifffloattype)类. |
| [TiffFloatType](tifffloattype#constructor_1)(ushort) | 初始化[`TiffFloatType`](../tifffloattype)类. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/elementsize) { get; } | 以字节为单位获取元素大小。 |
