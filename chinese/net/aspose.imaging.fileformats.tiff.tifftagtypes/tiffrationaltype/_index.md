...
| 姓名 | 描述 |
| --- | --- |
| [TiffRationalType](tiffrationaltype#constructor)(TiffTags) | 初始化[`TiffRationalType`](../tiffrationaltype)类的新实例。 |
| [TiffRationalType](tiffrationaltype#constructor_1)(ushort) | 初始化[`TiffRationalType`](../tiffrationaltype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/values) { get; set; } | 获取或设置值。 |
