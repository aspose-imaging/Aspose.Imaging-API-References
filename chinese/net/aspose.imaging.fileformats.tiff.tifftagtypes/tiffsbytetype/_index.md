---
title: "类 TiffSByteType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffSByteType 类。tiff 有符号字节型"
type: docs
weight: 8160
url: /zh/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/
---
## TiffSByteType class
...
| 名称 | 描述 |
| --- | --- |
| [TiffSByteType](tiffsbytetype/#constructor)(TiffTags) | 初始化 `TiffSByteType` 类的新实例。 |
| [TiffSByteType](tiffsbytetype/#constructor_1)(ushort) | 初始化 `TiffSByteType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/elementsize/) { get; } | 获取元素的字节大小。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/values/) { get; set; } | 获取或设置这些值。 |
