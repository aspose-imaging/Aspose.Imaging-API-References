...
| 姓名 | 描述 |
| --- | --- |
| [TiffSByteType](tiffsbytetype#constructor)(TiffTags) | 初始化[`TiffSByteType`](../tiffsbytetype)类的新实例。 |
| [TiffSByteType](tiffsbytetype#constructor_1)(ushort) | 初始化[`TiffSByteType`](../tiffsbytetype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
