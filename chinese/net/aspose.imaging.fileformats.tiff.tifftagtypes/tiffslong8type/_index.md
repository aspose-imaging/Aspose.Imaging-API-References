---
title: "类 TiffSLong8Type"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffSLong8Type 类。The Tiff unsigned 64bit type"
type: docs
weight: 8170
url: /zh/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/
---
...
| 名称 | 描述 |
| --- | --- |
| [TiffSLong8Type](tiffslong8type/#constructor)(TiffTags) | 初始化 `TiffSLong8Type` 类的新实例。 |
| [TiffSLong8Type](tiffslong8type/#constructor_1)(ushort) | 初始化 `TiffSLong8Type` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/elementsize/) { get; } | 获取元素的大小。 |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/tagtype/) { get; } | 获取标签类型。 |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/value/) { get; set; } | 获取或设置此数据类型包含的值。 |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/values/) { get; set; } | 获取或设置这些值。 |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/valuescontainer/) { get; } | 获取值容器。 |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/writeadditionaldata/)(TiffStreamWriter) | 写入附加标签数据。 |
