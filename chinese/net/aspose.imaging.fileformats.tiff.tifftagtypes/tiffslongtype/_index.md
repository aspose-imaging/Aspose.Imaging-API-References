---
title: "类 TiffSLongType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffSLongType 类。tiff 有符号长整型"
type: docs
weight: 8180
url: /zh/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
## TiffSLongType class
...
| 名称 | 描述 |
| --- | --- |
| [TiffSLongType](tiffslongtype/#constructor)(TiffTags) | 初始化 `TiffSLongType` 类的新实例。 |
| [TiffSLongType](tiffslongtype/#constructor_1)(ushort) | 初始化 `TiffSLongType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/elementsize/) { get; } | 获取元素的字节大小。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/values/) { get; set; } | 获取或设置这些值。 |
