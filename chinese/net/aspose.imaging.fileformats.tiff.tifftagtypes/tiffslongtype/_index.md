...
| 姓名 | 描述 |
| --- | --- |
| [TiffSLongType](tiffslongtype#constructor)(TiffTags) | 初始化[`TiffSLongType`](../tiffslongtype)类的新实例。 |
| [TiffSLongType](tiffslongtype#constructor_1)(ushort) | 初始化[`TiffSLongType`](../tiffslongtype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
