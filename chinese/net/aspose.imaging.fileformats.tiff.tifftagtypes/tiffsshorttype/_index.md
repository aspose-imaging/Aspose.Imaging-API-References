...
| 姓名 | 描述 |
| --- | --- |
| [TiffSShortType](tiffsshorttype#constructor)(TiffTags) | 初始化[`TiffSShortType`](../tiffsshorttype)类的新实例。 |
| [TiffSShortType](tiffsshorttype#constructor_1)(ushort) | 初始化[`TiffSShortType`](../tiffsshorttype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
