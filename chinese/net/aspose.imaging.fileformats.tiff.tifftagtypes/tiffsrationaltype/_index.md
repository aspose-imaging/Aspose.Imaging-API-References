...
| 姓名 | 描述 |
| --- | --- |
| [TiffSRationalType](tiffsrationaltype#constructor)(TiffTags) | 初始化[`TiffSRationalType`](../tiffsrationaltype)类的新实例。 |
| [TiffSRationalType](tiffsrationaltype#constructor_1)(ushort) | 初始化[`TiffSRationalType`](../tiffsrationaltype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/values) { get; set; } | 获取或设置值。 |
