---
title: "类 TiffSRationalType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffSRationalType 类。The tiff signed rational type"
type: docs
weight: 8190
url: /zh/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/
---
## TiffSRationalType class

tiff signed rational 类型。
...
| 名称 | 描述 |
| --- | --- |
| [TiffSRationalType](tiffsrationaltype/#constructor)(TiffTags) | 初始化 `TiffSRationalType` 类的新实例。 |
| [TiffSRationalType](tiffsrationaltype/#constructor_1)(ushort) | 初始化 `TiffSRationalType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/elementsize/) { get; } | 获取元素的字节大小。 |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/tagtype/) { get; } | 获取标签类型。 |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/value/) { get; set; } | 获取或设置此数据类型包含的值。 |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/values/) { get; set; } | 获取或设置这些值。 |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/valuescontainer/) { get; } | 获取值容器。 |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/writeadditionaldata/)(TiffStreamWriter) | 写入附加标签数据。 |
