...
| 姓名 | 描述 |
| --- | --- |
| [TiffSRationalType](tiffsrationaltype#constructor)(TiffTags) | 初始化[`TiffSRationalType`](../tiffsrationaltype)类. |
| [TiffSRationalType](tiffsrationaltype#constructor_1)(ushort) | 初始化[`TiffSRationalType`](../tiffsrationaltype)类. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/elementsize) { get; } | 以字节为单位获取元素大小。 |
