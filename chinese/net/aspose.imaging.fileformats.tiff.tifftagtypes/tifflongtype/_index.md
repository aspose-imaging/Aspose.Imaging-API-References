---
title: "类 TiffLongType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffLongType 类。tiff 长整型"
type: docs
weight: 8140
...
| 名称 | 描述 |
| --- | --- |
| [TiffLongType](tifflongtype/#constructor)(TiffTags) | 初始化 `TiffLongType` 类的新实例。 |
| [TiffLongType](tifflongtype/#constructor_1)(ushort) | 初始化 `TiffLongType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/elementsize/) { get; } | 获取元素的字节大小。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/values/) { get; set; } | 获取或设置这些值。 |
