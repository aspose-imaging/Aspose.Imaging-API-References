...
| 姓名 | 描述 |
| --- | --- |
| [TiffLongType](tifflongtype#constructor)(TiffTags) | 初始化[`TiffLongType`](../tifflongtype)类的新实例。 |
| [TiffLongType](tifflongtype#constructor_1)(ushort) | 初始化[`TiffLongType`](../tifflongtype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
