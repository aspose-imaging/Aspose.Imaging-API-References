...
| 姓名 | 描述 |
| --- | --- |
| [TiffDoubleType](tiffdoubletype#constructor)(TiffTags) | 初始化[`TiffDoubleType`](../tiffdoubletype)类的新实例。 |
| [TiffDoubleType](tiffdoubletype#constructor_1)(ushort) | 初始化[`TiffDoubleType`](../tiffdoubletype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
