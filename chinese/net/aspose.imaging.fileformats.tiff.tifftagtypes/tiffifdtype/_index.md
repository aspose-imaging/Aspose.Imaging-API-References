...
description: 代表TIFF Exif图像文件目录类型类
type: docs
weight: 7960
...
| 姓名 | 描述 |
| --- | --- |
| [TiffIfdType](tiffifdtype#constructor)(TiffTags) | 初始化[`TiffIfdType`](../tiffifdtype)类. |
| [TiffIfdType](tiffifdtype#constructor_1)(ushort) | 初始化[`TiffIfdType`](../tiffifdtype)类. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/elementsize) { get; } | 以字节为单位获取元素大小。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/values) { get; set; } | 获取或设置值。 |
