...
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffIfdType 类。表示 TIFF Exif 图像文件目录类型类"
type: docs
weight: 8120
url: /zh/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/
---
## TiffIfdType class

表示 TIFF Exif 图像文件目录类型类。
...
| 名称 | 描述 |
| --- | --- |
| [TiffIfdType](tiffifdtype/#constructor)(TiffTags) | 初始化 `TiffIfdType` 类的新实例。 |
| [TiffIfdType](tiffifdtype/#constructor_1)(ushort) | 初始化 `TiffIfdType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/elementsize/) { get; } | 获取元素的字节大小。 |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/tagtype/) { get; } | 获取标签类型。 |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/value/) { get; set; } | 获取或设置此数据类型包含的值。 |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/values/) { get; set; } | 获取或设置这些值。 |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/valuescontainer/) { get; } | 获取值容器。 |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/writeadditionaldata/)(TiffStreamWriter) | 写入附加标签数据。 |
