...
| 姓名 | 描述 |
| --- | --- |
| [TiffIfdType](tiffifdtype#constructor)(TiffTags) | 初始化[`TiffIfdType`](../tiffifdtype)类的新实例。 |
| [TiffIfdType](tiffifdtype#constructor_1)(ushort) | 初始化[`TiffIfdType`](../tiffifdtype)类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/elementsize) { get; } | 获取元素大小（以字节为单位）。 |
