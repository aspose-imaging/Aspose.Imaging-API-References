...
| 姓名 | 描述 |
| --- | --- |
| [TiffByteType](tiffbytetype#constructor)(TiffTags) | 初始化[`TiffByteType`](../tiffbytetype)类. |
| [TiffByteType](tiffbytetype#constructor_1)(ushort) | 初始化[`TiffByteType`](../tiffbytetype)类. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/elementsize) { get; } | 以字节为单位获取元素大小。 |
