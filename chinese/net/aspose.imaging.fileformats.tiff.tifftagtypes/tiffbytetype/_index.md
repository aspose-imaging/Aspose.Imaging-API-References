---
title: "类 TiffByteType"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffByteType 类。The tiff byte type"
type: docs
weight: 8070
...
| 名称 | 描述 |
| --- | --- |
| [TiffByteType](tiffbytetype/#constructor)(TiffTags) | 初始化 `TiffByteType` 类的新实例。 |
| [TiffByteType](tiffbytetype/#constructor_1)(ushort) | 初始化 `TiffByteType` 类的新实例。 |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/elementsize/) { get; } | 获取元素的字节大小。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/values/) { get; set; } | 获取或设置这些值。 |
