---
title: "类 TiffIfd8Type"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffIfd8Type 类。The Tiff unsigned 64bit Image File Directory type"
type: docs
weight: 8110
url: /zh/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifd8type/
---
## TiffIfd8Type class
...
| 名称 | 描述 |
| --- | --- |
| [TiffIfd8Type](tiffifd8type/#constructor)(TiffTags) | 初始化 `TiffIfd8Type` 类的新实例。 |
| [TiffIfd8Type](tiffifd8type/#constructor_1)(ushort) | 初始化 `TiffIfd8Type` 类的新实例。 |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifd8type/tagtype/) { get; } | 获取标签类型。 |
