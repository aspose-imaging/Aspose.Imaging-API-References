...
| 姓名 | 描述 |
| --- | --- |
| [CdrImage](cdrimage)(Stream, LoadOptions) | 初始化[`CdrImage`](../cdrimage)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimage/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimage/cdrdocument) { get; } | 获取或设置 CDR 文档。 |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimage/iscached) { get; } | 获取一个值，该值指示对象的数据当前是否被缓存，并且不需要读取数据。 |
| override [PageCount](../../aspose.imaging.fileformats.cdr/cdrimage/pagecount) { get; } | 获取或设置页数。 |
| override [PageExportingAction](../../aspose.imaging.fileformats.cdr/cdrimage/pageexportingaction) { get; set; } | 获取或设置页面导出动作。 请注意，设置该方法执行后会自动释放页面资源。 它将在每个页面保存之前执行。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimage/cachedata)() | 缓存数据并确保不会从底层 DataStreamSupporter执行额外的数据加载。数据流容器。 |
