...
| 姓名 | 描述 |
| --- | --- |
| [CmxImagePage](cmximagepage)(CmxPage) | 初始化[`CmxImagePage`](../cmximagepage)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cmx/cmximagepage/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| override [IsCached](../../aspose.imaging.fileformats.cmx/cmximagepage/iscached) { get; } | 获取对象的数据当前是否缓存，不需要读取数据。 |
