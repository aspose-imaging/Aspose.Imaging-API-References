---
title: "类 CmxImagePage"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Cmx.CmxImagePage 类。CMX 页面图像。"
type: docs
weight: 1960
...
| 名称 | 描述 |
| --- | --- |
| [CmxImagePage](cmximagepage/#constructor)(CmxPage) | 初始化 `CmxImagePage` 类的新实例。 |
| [CmxImagePage](cmximagepage/#constructor_1)(CmxPage, Image) | 初始化 `CmxImagePage` 类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cmx/cmximagepage/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| override [Height](../../aspose.imaging.fileformats.cmx/cmximagepage/height/) { get; } | 获取图像高度。 |
| override [HeightF](../../aspose.imaging.fileformats.cmx/cmximagepage/heightf/) { get; } | 获取对象的高度（英寸）。 |
| [InterruptMonitor](../../aspose.imaging/image/interruptmonitor/) { get; set; } | 获取或设置中断监视器。 |
| override [IsCached](../../aspose.imaging.fileformats.cmx/cmximagepage/iscached/) { get; } | 获取一个值，指示对象的数据当前是否已缓存且无需读取数据。 |
...
| override [Width](../../aspose.imaging.fileformats.cmx/cmximagepage/width/) { get; } | 获取图像宽度。 |
| override [WidthF](../../aspose.imaging.fileformats.cmx/cmximagepage/widthf/) { get; } | 获取对象的宽度（英寸）。 |
...
| 名称 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cmx/cmximagepage/cachedata/)() | 缓存不可用。 |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.cmx/cmximagepage/getdefaultoptions/)(object[]) | 获取默认选项。 |
