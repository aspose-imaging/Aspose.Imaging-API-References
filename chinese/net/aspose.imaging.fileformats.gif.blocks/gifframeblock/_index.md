---
title: "类 GifFrameBlock"
second_title: "Aspose.Imaging for .NET API 参考"
description: "Aspose.Imaging.FileFormats.Gif.Blocks.GifFrameBlock 类。GIF 帧类"
type: docs
weight: 6730
url: /zh/net/aspose.imaging.fileformats.gif.blocks/gifframeblock/
---
## GifFrameBlock class
...
| 名称 | 描述 |
| --- | --- |
| [GifFrameBlock](gifframeblock/#constructor)(RasterImage) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_3)(Stream) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_6)(string) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_9)(ushort, ushort) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_1)(RasterImage, ushort, ushort) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_4)(Stream, ushort, ushort) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_7)(string, ushort, ushort) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_10)(ushort, ushort, ushort, ushort) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_8)(string, ushort, ushort, bool, bool, byte) | 初始化 `GifFrameBlock` 类的新实例。 |
| [GifFrameBlock](gifframeblock/#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | 初始化 `GifFrameBlock` 类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel/) { get; } | 获取图像的每像素位数。 |
...
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod/) { get; } | 获取处理方法。 |
...
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft/) { get; } | 获取左侧。 |
...
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel/) { get; set; } | 获取或设置 GIF 帧的每像素位数。 |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor/) { get; set; } | 获取一个值，指示帧块是否具有透明颜色。 |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced/) { get; set; } | 获取或设置一个值，指示此 `GifFrameBlock` 是否为交错。 |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced/) { get; } | 获取一个值，指示此图像实例是否为隔行扫描。 |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted/) { get; set; } | 获取或设置一个值，指示颜色调色板是否已排序。 |
| [IsRawDataAvailable](../../aspose.imaging/rasterimage/israwdataavailable/) { get; } | 获取指示是否可进行原始数据加载的值。 |
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left/) { get; set; } | 获取或设置图像左侧位置。 |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top/) { get; set; } | 获取或设置图像顶部位置。 |
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor/) { get; set; } | 获取帧块的透明颜色。 |
| virtual [UpdateXmpData](../../aspose.imaging/rasterimage/updatexmpdata/) { get; set; } | 获取或设置一个值，指示是否更新 XMP 元数据。 |
| [UseAlphaBlending](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/usealphablending/) { get; } | 获取一个值，指示是否 [use alpha blending]。 |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor/#replacecolor_1)(int, byte, int) | 将一种颜色替换为另一种颜色，允许差异并保留原始 alpha 值以保持平滑边缘。 |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | 将所有非透明颜色替换为新颜色，并保留原始 alpha 值以保持平滑边缘。注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
| [Resize](../../aspose.imaging/image/resize/)(int, int) | 调整图像大小。默认使用 NearestNeighbourResample。 |
| override [Resize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/resize/#resize_1)(int, int, ImageResizeSettings) | 调整此[`RasterCachedImage`](../../aspose.imaging/rastercachedimage/)实例的大小。 |
...
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette/)(IColorPalette, IColorPalette) | 获取关联的颜色调色板。 |
