...
| 姓名 | 描述 |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | 初始化[`GifFrameBlock`](../gifframeblock)类的新实例。 |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel) { get; } | 获取每像素的图像位数。 |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor) { get; set; } | 获取一个值，该值指示帧块是否具有透明颜色。 |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | 获取或设置一个值，该值指示此[`GifFrameBlock`](../gifframeblock)是否是隔行扫描的。 |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | 获取一个值，该值指示此图像实例是否是隔行扫描的。 |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left) { get; set; } | 获取或设置左侧图像位置。 |
...
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor) { get; set; } | 获取框架块的透明色。 |
...
| override [GetOriginalOptions](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getoriginaloptions)() | 获取基于原始文件设置的选项。 这有助于保持原始图像的位深度和其他参数不变。 例如，如果我们加载一个每像素 1 位的黑白 PNG 图像，然后使用 String)方法，将生成每像素 8 位的输出 PNG 图像。 为避免它并以每像素 1 位保存 PNG 图像，请使用此方法获取相应的保存选项并将它们传递 到ImageOptionsBase)方法作为第二个参数。 |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors#replacenontransparentcolors_1)(int) | 用新颜色替换所有非透明颜色并保留原始 alpha 值以保存平滑边缘。 注意:如果您在没有透明度的图像上使用它，所有颜色都将替换为一种颜色。 |
