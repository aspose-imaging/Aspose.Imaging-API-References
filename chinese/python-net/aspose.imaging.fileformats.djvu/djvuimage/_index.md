...
type: docs
weight: 10
url: /zh/python-net/aspose.imaging.fileformats.djvu/djvuimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [DjvuImage(stream)](#DjvuImage_stream_1) | 通过使用 Stream 参数初始化一个新的实例来开始使用 DjVu 图像<br/>            [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) 类。非常适合<br/>            想要在项目中无缝集成 DjVu 图像处理的<br/>            开发者。 |
| [DjvuImage(stream, load_options)](#DjvuImage_stream_load_options_2) | 使用此构造函数即可无缝开始使用 DjVu 图像，它<br/>            使用 Stream 和 LoadOptions 参数初始化一个新的 [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) 类实例。非常适合希望对 DjVu 图像加载选项进行精确控制，同时保持简洁高效的<br/>            开发者。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| active_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r/w | 通过使用此属性访问或设置当前活动的<br/>            页面，浏览您的 DjVu 文档。无缝切换页面以聚焦特定<br/>            内容，提升文档查看体验。 |
...
| djvu_pages | [DjvuPage[]](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | 使用此属性快速检索 DjVu 文档中包含的所有页面。通过轻松访问和<br/>            管理 DjVu 文件中的各个页面，简化文档处理工作流。提升效率并<br/>            通过便捷的页面检索来简化任务。 |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | 获取或设置 Exif 实例。 |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | 获取与您的 DjVu 图像文件关联的文件格式信息。快速<br/>            确定文件格式，以便在工作流中无缝集成。 |
| first_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | 使用此属性访问 DjVu 文档的第一页。快速检索<br/>            初始页面，以高效开始查看或处理文档。 |
| has_alpha | bool | r | 快速判断您的 DjVu 图像文件是否包含 alpha 通道。<br/>            通过检查图像中是否存在透明度信息，简化工作流。 |
...
| last_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | 使用此属性检索 DjVu 文档的最后一页。快速访问<br/>            最终页面，以轻松进行查看或处理。 |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | 获取或设置来自帧的 XMP 数据。 |
| next_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | 通过使用此便捷属性访问下一页来浏览 DjVu 文档。快速在文档查看或<br/>            处理任务中前进。 |
| page_count | int | r | 使用此属性检索 DjVu 图像集合中的页面总数。<br/>            适用于快速评估以 DjVu 格式存储的文档或书籍的规模。<br/>            通过准确的页数信息提升工作流效率。 |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | 使用此属性访问 DjVu 图像集合中的各个页面。<br/>            通过直接访问每页，简化对以 DjVu 格式存储的文档或书籍的导航和操作。<br/>            通过轻松的页面检索提升工作流效率。 |
...
| previous_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | 通过使用此便捷属性访问上一页，快速在 DjVu 文档查看或处理任务中后退。<br/>            轻松高效地在文档中导航。 |
...
| **Name** | **描述** |
| :- | :- |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_1) | 使用指定参数调整图像的 _brightness_，<br/>            提供对亮度水平的控制，以获得最佳视觉清晰度。此方法可增强<br/>            或降低图像的整体亮度，允许进行细微调节以实现所需的光照效果。通过调节亮度，用户可以优化图像<br/>            可见性并提升细节再现，从而改善观看体验。 |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_2) | 使用此方法增强 [Image](/imaging/python-net/aspose.imaging/image/) 对比度，以提升视觉清晰度并<br/>            突出细节，该方法调整亮部和暗部之间的亮度差异。通过微调对比度水平，用户可以获得更鲜艳且<br/>            更有冲击力的图像，提升整体图像质量并最大化细节可见性。<br/>            此调整有助于展现颜色和纹理的细微差别，产生更具动感和视觉吸引力的图像。 |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_3) | 伽马校正，专门针对红、绿、蓝通道，涉及分别调整每个颜色分量的亮度。通过对 RGB 通道应用不同的伽马<br/>            系数，您可以微调图像的整体亮度和对比度。此技术确保颜色表现准确，并提升图像在不同显示设备上的<br/>            视觉质量。 |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_4) | 对图像进行伽马校正时，可为红、绿、蓝通道设置可自定义的参数，从而实现对色彩平衡和亮度的精确调节。此<br/>            方法通过微调颜色表现提升图像质量，确保在不同显示设备上的最佳渲染。对各通道的伽马值进行调节可改善色彩平衡和视觉吸引力。 |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_7) | 使用 Bradley 自适应阈值算法和积分图的二值化<br/>阈值化是一种基于局部邻域为每个像素计算局部阈值的方法。它能够适应图像中光照的变化，适用于光照不均的图像。通过使用积分图计算阈值，它能够高效处理大邻域，适用于实时应用。该技术常用于文档处理、OCR（光学字符识别）和图像分割任务，在后续分析中二值化的准确性至关重要。 |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_8) | 使用预定义阈值的二值化将复杂图像简化为二进制<br/>表示，像素根据其强度与指定阈值的比较被归类为黑或白。此技术常用于图像处理，以提升清晰度、简化分析，并为后续处理步骤（如光学字符识别（OCR））准备图像。通过应用固定阈值，您可以快速将灰度图像转换为二进制形式，使其更易于解释并提取有意义的信息。 |
| binarize_otsu() | 使用大津阈值的二值化是一种基于图像直方图自动计算最佳阈值的技术。它通过最小化类内方差将图像分为前景和背景。大津方法广泛用于将图像分割为二进制形式，尤其在像素强度分布呈双峰或多峰时。此方法对目标检测、图像分割和特征提取等任务有益，因为前景与背景之间的准确划分至关重要。 |
...
| cache_data() | 私有缓存数据以优化性能并减少对外部源重复检索数据的需求。此方法还能帮助节约资源，尤其在数据访问频繁或资源受限的场景中。 |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_30) | 带位移的裁剪允许您精确调整图像中裁剪区域的位置和尺寸。此功能对于优化构图、对齐元素以及突出视觉焦点非常宝贵。通过在裁剪过程中加入位移，您可以实现像素级的精确度，轻松微调图像的框架。 |
| [crop(rectangle)](#crop_rectangle_31) | "Crop" 将图像裁剪至关注的细节或去除不需要的元素，<br/>提升其构图和视觉冲击力。无论是为社交媒体调整照片、创建网站横幅，还是设计印刷材料，此工具都能帮助您以精确和清晰的方式优化图像。 |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_32) | 对当前图像执行抖动处理。 |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_33) | The "Dither" 功能对图像应用抖动效果，通过降低条带现象并改善颜色过渡来提升视觉质量。无论您从事数字艺术、摄影还是平面设计项目，此功能都能为图像增添专业感，使其看起来更平滑、更精致。 |
| [embed_digital_signature(password)](#embed_digital_signature_password_34) | 根据提供的密码将数字签名嵌入图像的每一页。 |
| [filter(rectangle, options)](#filter_rectangle_options_35) | 对图像中指定的矩形区域应用滤镜，以增强或修改其<br/>外观。通过针对特定区域进行操作，此方法允许进行精确的调整，例如模糊、锐化或应用艺术效果，以实现期望的视觉效果。对选定区域微调滤镜使用户能够自定义图像美感、提升清晰度，并创建符合个人偏好的艺术效果。 |
...
| grayscale() | 灰度转换将图像转换为黑白表示，每个像素的强度由单一数值在黑到白之间表示。此过程去除颜色信息，生成单色图像。灰度图像常用于颜色非必需或追求简洁的场景，如文档扫描、打印以及某些图像分析。 |
...
| [load(stream)](#load_stream_57) | 使用此方法加载您的 DjVu 文档。通过快速<br/>访问并导入 DjVu 文件到您的应用程序，简化工作流程。 |
| [load(stream, load_options)](#load_stream_load_options_58) | 使用此方法并结合 stream 和 loadOptions 参数导入您的 DjVu 文档。通过快速访问并导入 DjVu 文件到您的应用程序，提供灵活性和自定义选项以满足您的需求。 |
...
| [load_document(stream)](#load_document_stream_63) | 使用此方法加载您的 DjVu 文档。通过快速<br/>访问并导入 DjVu 文件到您的应用程序，简化工作流程。 |
| [load_document(stream, load_options)](#load_document_stream_load_options_64) | 使用此方法并结合 stream 和 loadOptions 参数导入您的 DjVu 文档。通过快速访问并导入 DjVu 文件到您的应用程序，提供灵活性和自定义选项以满足您的需求。 |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_74) | 归一化角度。<br/>            此方法适用于扫描的文本文档，以消除倾斜扫描。<br/>            此方法使用 [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) 和 [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) 方法。 |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_80) | 将所有非透明颜色替换为新颜色，并保留原始 alpha 值以保持平滑边缘。<br/>                注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_81) | 将所有非透明颜色替换为新颜色，并保留原始 alpha 值以保持平滑边缘。<br/>                注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_83) | 使用 `Resize` 方法调整图像大小，提供一种简单且有效的方式<br/>根据您的需求调整图像尺寸。此多功能功能使您能够轻松将图像缩放至所需大小，提升其在各种平台和应用中的可用性。 |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_84) | 将图像调整为指定的宽度和高度，并根据需要应用额外设置<br/>。此方法使用户能够在保持纵横比、图像质量和压缩设置等期望属性的同时，调整图像尺寸。通过提供灵活的缩放选项，用户可以根据特定需求定制图像，并优化其在各种应用和平台上的呈现。 |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_88) | `ResizeHeightProportionally` 方法允许您在保持纵横比的同时调整图像的高度。这确保图像保持比例，防止失真并保持视觉完整性。无论您是在为网页、移动应用或印刷媒体优化图像，此方法都能确保图像在不同平台和设备上呈现最佳效果。 |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_92) | `ResizeWidthProportionally` 方法提供了一种便捷的解决方案，以在保持纵横比的同时调整图像的宽度。通过按比例调整宽度，您可以确保图像在不同设备和屏幕尺寸上保持视觉吸引力和一致性，提升其在各种场景中的多样性和可用性。 |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_96) | 使用 RasterCachedMultipageImage 类的 Rotate 方法围绕中心旋转图像。此便捷功能让您轻松<br/>调整图像方向，同时保持中心位置，提升图像操作能力。 |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_97) | `RotateFlip` 方法为您的图像提供多样的操作选项，允许您独立地对活动帧进行旋转、翻转或两者同时操作。无论您是在编辑照片、创建图形还是提升数字艺术，此方法都能对图像的方向和构图提供精确控制，轻松高效地实现您的创意愿景。 |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_98) | 旋转并翻转全部。 |
| save() | 将图像数据保存到底层流中。 |
| [save(file_path)](#save_file_path_99) | 将图像保存到指定的文件位置。 |
| [save(file_path, options)](#save_file_path_options_100) | 根据保存选项，将对象的数据保存到指定文件位置的指定文件格式中。 |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_101) | 根据保存选项，将对象的数据保存到指定文件位置的指定文件格式中。 |
| [save(file_path, over_write)](#save_file_path_over_write_102) | 将对象的数据保存到指定的文件位置。 |
| [save(stream)](#save_stream_103) | 保存数据。 |
| [save(stream, options_base)](#save_stream_options_base_104) | 根据保存选项，将图像的数据保存到指定流中的指定文件格式。 |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_105) | 根据保存选项，将图像的数据保存到指定流中的指定文件格式。 |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_106) | 保存 32 位 ARGB 像素。 |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_107) | 保存像素。 |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_108) | 保存像素。<br/>此方法已弃用。请使用更有效的 [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) 方法。 |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_109) | 保存像素（特定格式方法）。 |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_110) | 保存原始数据。 |
| [save_to_stream(stream)](#save_to_stream_stream_111) | 将对象的数据保存到指定的流中。 |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_112) | 根据保存选项，将图像的数据保存到指定流中的指定文件格式。 |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_113) | 根据保存选项，将图像的数据保存到指定流中的指定文件格式。 |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_114) | 根据保存选项，将对象的数据保存到指定文件位置的指定文件格式中。 |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_115) | 根据保存选项，将对象的数据保存到指定文件位置的指定文件格式中。 |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_116) | 为指定位置设置图像的 32 位 ARGB 像素。 |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_117) | 设置图像调色板。 |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_118) | 为指定位置设置图像像素。 |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_119) | 为此 [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) 设置分辨率。 |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_120) | 尝试设置一个 _metadata_ 实例，前提是此 [Image](/imaging/python-net/aspose.imaging/image/) 实例支持并实现 [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) 实例。 |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_121) | 将整条扫描线写入指定的扫描线索引。 |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_122) | 将整条扫描线写入指定的扫描线索引。 |
...
通过使用 Stream 参数初始化一个新的实例来开始使用 DjVu 图像<br/>            [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) 类。非常适合<br/>            想要在项目中无缝集成 DjVu 图像处理的<br/>            开发者。
...
使用此构造函数即可无缝开始使用 DjVu 图像，它<br/>            使用 Stream 和 LoadOptions 参数初始化一个新的 [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) 类实例。非常适合希望对 DjVu 图像加载选项进行精确控制，同时保持简洁高效的<br/>            开发者。
...
使用此属性访问 DjVu 图像集合中的各个页面。<br/>            通过直接访问每页，简化对以 DjVu 格式存储的文档或书籍的导航和操作。<br/>            通过轻松的页面检索提升工作流效率。
...
使用指定参数调整图像的 _brightness_，<br/>            提供对亮度水平的控制，以获得最佳视觉清晰度。此方法可增强<br/>            或降低图像的整体亮度，允许进行细微调节以实现所需的光照效果。通过调节亮度，用户可以优化图像<br/>            可见性并提升细节再现，从而改善观看体验。
...
使用此方法增强 [Image](/imaging/python-net/aspose.imaging/image/) 对比度，以提升视觉清晰度并<br/>            突出细节，该方法调整亮部和暗部之间的亮度差异。通过微调对比度水平，用户可以获得更鲜艳且<br/>            更有冲击力的图像，提升整体图像质量并最大化细节可见性。<br/>            此调整有助于展现颜色和纹理的细微差别，产生更具动感和视觉吸引力的图像。
...
伽马校正，专门针对红、绿、蓝通道，涉及分别调整每个颜色分量的亮度。通过对 RGB 通道应用不同的伽马<br/>            系数，您可以微调图像的整体亮度和对比度。此技术确保颜色表现准确，并提升图像在不同显示设备上的<br/>            视觉质量。
...
对图像进行伽马校正时，可为红、绿、蓝通道设置可自定义的参数，从而实现对色彩平衡和亮度的精确调节。此<br/>            方法通过微调颜色表现提升图像质量，确保在不同显示设备上的最佳渲染。对各通道的伽马值进行调节可改善色彩平衡和视觉吸引力。
...
使用 Bradley 自适应阈值算法和积分图的二值化<br/>阈值化是一种基于局部邻域为每个像素计算局部阈值的方法。它能够适应图像中光照的变化，适用于光照不均的图像。通过使用积分图计算阈值，它能够高效处理大邻域，适用于实时应用。该技术常用于文档处理、OCR（光学字符识别）和图像分割任务，在后续分析中二值化的准确性至关重要。
...
使用预定义阈值的二值化将复杂图像简化为二进制<br/>表示，像素根据其强度与指定阈值的比较被归类为黑或白。此技术常用于图像处理，以提升清晰度、简化分析，并为后续处理步骤（如光学字符识别（OCR））准备图像。通过应用固定阈值，您可以快速将灰度图像转换为二进制形式，使其更易于解释并提取有意义的信息。
...
带位移的裁剪允许您精确调整图像中裁剪区域的位置和尺寸。此功能对于优化构图、对齐元素以及突出视觉焦点非常宝贵。通过在裁剪过程中加入位移，您可以实现像素级的精确度，轻松微调图像的框架。
...
"Crop" 将图像裁剪至关注的细节或去除不需要的元素，<br/>提升其构图和视觉冲击力。无论是为社交媒体调整照片、创建网站横幅，还是设计印刷材料，此工具都能帮助您以精确和清晰的方式优化图像。
...
The "Dither" 功能对图像应用抖动效果，通过降低条带现象并改善颜色过渡来提升视觉质量。无论您从事数字艺术、摄影还是平面设计项目，此功能都能为图像增添专业感，使其看起来更平滑、更精致。
...
对图像中指定的矩形区域应用滤镜，以增强或修改其<br/>外观。通过针对特定区域进行操作，此方法允许进行精确的调整，例如模糊、锐化或应用艺术效果，以实现期望的视觉效果。对选定区域微调滤镜使用户能够自定义图像美感、提升清晰度，并创建符合个人偏好的艺术效果。
...
使用此方法加载您的 DjVu 文档。通过快速<br/>访问并导入 DjVu 文件到您的应用程序，简化工作流程。
...
| Type | Description |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | 已加载的 djvu 文档 |
...
使用此方法并结合 stream 和 loadOptions 参数导入您的 DjVu 文档。通过快速访问并导入 DjVu 文件到您的应用程序，提供灵活性和自定义选项以满足您的需求。
...
| Type | Description |
| :- | :- |
| [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | 已加载的 djvu 文档 |
...
使用 `Resize` 方法调整图像大小，提供一种简单且有效的方式<br/>根据您的需求调整图像尺寸。此多功能功能使您能够轻松将图像缩放至所需大小，提升其在各种平台和应用中的可用性。
...
将图像调整为指定的宽度和高度，并根据需要应用额外设置<br/>。此方法使用户能够在保持纵横比、图像质量和压缩设置等期望属性的同时，调整图像尺寸。通过提供灵活的缩放选项，用户可以根据特定需求定制图像，并优化其在各种应用和平台上的呈现。
...
`ResizeHeightProportionally` 方法允许您在保持纵横比的同时调整图像的高度。这确保图像保持比例，防止失真并保持视觉完整性。无论您是在为网页、移动应用或印刷媒体优化图像，此方法都能确保图像在不同平台和设备上呈现最佳效果。
...
`ResizeWidthProportionally` 方法提供了一种便捷的解决方案，以在保持纵横比的同时调整图像的宽度。通过按比例调整宽度，您可以确保图像在不同设备和屏幕尺寸上保持视觉吸引力和一致性，提升其在各种场景中的多样性和可用性。
...
使用 RasterCachedMultipageImage 类的 Rotate 方法围绕中心旋转图像。此便捷功能让您轻松<br/>调整图像方向，同时保持中心位置，提升图像操作能力。
...
`RotateFlip` 方法为您的图像提供多样的操作选项，允许您独立地对活动帧进行旋转、翻转或两者同时操作。无论您是在编辑照片、创建图形还是提升数字艺术，此方法都能对图像的方向和构图提供精确控制，轻松高效地实现您的创意愿景。
