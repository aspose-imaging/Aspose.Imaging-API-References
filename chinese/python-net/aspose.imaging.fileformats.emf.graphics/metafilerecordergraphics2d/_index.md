---
title: "MetafileRecorderGraphics2D 类"
type: docs
weight: 20
url: /zh/python-net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/
---
...
| [exclude_clip(rect)](#exclude_clip_rect_21) | 更新此 Graphics 的裁剪区域，以排除由 Rectangle 结构指定的区域。 |
| [exclude_clip(region)](#exclude_clip_region_22) | 更新此 Graphics 的裁剪区域，以排除由 Region 指定的区域。 |
| [exclude_clip_rect(rect)](#exclude_clip_rect_rect_23) | 更新此 Graphics 的裁剪区域，以排除由 Rectangle 结构指定的区域。 |
| [exclude_clip_rgn(region)](#exclude_clip_rgn_region_24) | 更新此 Graphics 的裁剪区域，以排除由 Region 指定的区域。 |
| [fill_ellipse(brush, rect)](#fill_ellipse_brush_rect_25) | 填充椭圆。 |
| [fill_path(pen, brush, path)](#fill_path_pen_brush_path_26) | 填充路径。 |
| [fill_pie(brush, rect, start_angle, sweep_angle)](#fill_pie_brush_rect_start_angle_sweep_angle_27) | 填充饼形图。 |
| [fill_polygon(brush, points)](#fill_polygon_brush_points_28) | 填充多边形。 |
| [fill_polygon(brush, points, fill_mode)](#fill_polygon_brush_points_fill_mode_29) | 填充多边形。 |
| [fill_rectangle(brush, rectangle)](#fill_rectangle_brush_rectangle_30) | 填充矩形。 |
| [get_transform()](#get_transform__31) | 获取世界变换。 |
| [intersect_clip(rect)](#intersect_clip_rect_32) | 更新此 Graphics 的裁剪区域，使其为当前裁剪区域与指定 Rectangle 结构的交集。 |
| [intersect_clip(region)](#intersect_clip_region_33) | 更新此 Graphics 的裁剪区域，使其为当前裁剪区域与指定 Region 的交集。 |
| [intersect_clip_rect_f(rect)](#intersect_clip_rect_f_rect_34) | 更新此 Graphics 的裁剪区域，使其为当前裁剪区域与指定 Rectangle 结构的交集。 |
| [intersect_clip_rgn(region)](#intersect_clip_rgn_region_35) | 更新此 Graphics 的裁剪区域，使其为当前裁剪区域与指定 Region 的交集。 |
| [multiply_transform(matrix)](#multiply_transform_matrix_36) | 将此 Graphics 的世界变换与指定的 Matrix 相乘。 |
| [multiply_transform(matrix, order)](#multiply_transform_matrix_order_37) | 按指定顺序将此 Graphics 的世界变换与指定的 Matrix 相乘。 |
| reset_clip() | 重置剪裁。 |
| [rotate_transform(angle)](#rotate_transform_angle_38) | 将指定的旋转应用于此 Graphics 的变换矩阵。 |
| [rotate_transform(angle, center, order)](#rotate_transform_angle_center_order_39) | 按指定顺序将指定的旋转应用于此 Graphics 的变换矩阵。 |
| [scale_transform(sx, sy)](#scale_transform_sx_sy_40) | 通过将指定的缩放操作预先添加到对象的变换矩阵中，将其应用于此 Graphics 的变换矩阵。 |
| [scale_transform(sx, sy, order)](#scale_transform_sx_sy_order_41) | 按指定顺序将指定的缩放操作应用于此 Graphics 的变换矩阵。 |
| [set_transform(transform)](#set_transform_transform_42) | 设置变换。 |
| [translate_transform(x, y)](#translate_transform_x_y_43) | 通过将指定的平移预先添加到此 Graphics 的变换矩阵中，改变坐标系的原点。 |
| [translate_transform(x, y, order)](#translate_transform_x_y_order_44) | 按指定顺序将指定的平移应用于此 Graphics 的变换矩阵，改变坐标系的原点。 |
