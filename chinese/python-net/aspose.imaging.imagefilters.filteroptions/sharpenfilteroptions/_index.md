---
title: "SharpenFilterOptions 类"
type: docs
weight: 160
url: /zh/python-net/aspose.imaging.imagefilters.filteroptions/sharpenfilteroptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [SharpenFilterOptions()](#SharpenFilterOptions__1) | 初始化 [SharpenFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/sharpenfilteroptions/) 类的新实例。 |
| [SharpenFilterOptions(size, sigma)](#SharpenFilterOptions_size_sigma_2) | 初始化 [SharpenFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/sharpenfilteroptions/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| 偏置 | int | r/w | 获取或设置偏置。 |
...
初始化 [SharpenFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/sharpenfilteroptions/) 类的新实例。
