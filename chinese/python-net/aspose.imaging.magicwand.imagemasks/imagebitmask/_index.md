---
title: "ImageBitMask 类"
type: docs
weight: 50
url: /zh/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/
---
...
| **Name** | **描述** |
| :- | :- |
| [ImageBitMask(image)](#ImageBitMask_image_1) | 使用指定的现有 [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) 的尺寸，初始化 [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) 类的新实例。<br/>            指定的 [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) 将被存储为源图像。 |
| [ImageBitMask(width, height)](#ImageBitMask_width_height_2) | 使用指定的宽度和高度，初始化 [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| [get(x, y)](#get_x_y_9) | 获取指定像素在存储数组中的位置。 |
...
| [set_mask_pixel(x, y, value)](#set_mask_pixel_x_y_value_19) | 设置指定像素的不透明度。 |
| [subtract(image, settings)](#subtract_image_settings_20) | 获取将对提供的图像应用魔棒选择的结果从当前遮罩中减去后的结果。 |
| [subtract(mask)](#subtract_mask_21) | 获取当前遮罩减去提供的遮罩的结果。 |
| [subtract(settings)](#subtract_settings_22) | 获取将对当前遮罩源应用魔棒选择的结果从遮罩中减去后的结果。 |
| [union(image, settings)](#union_image_settings_23) | 获取当前遮罩与对提供的图像应用魔棒选择的结果的并集。 |
| [union(mask)](#union_mask_24) | 获取当前遮罩与提供的遮罩的并集。 |
| [union(settings)](#union_settings_25) | 获取当前遮罩与对遮罩源应用魔棒选择的结果的并集。 |
...
使用指定的现有 [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) 的尺寸，初始化 [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) 类的新实例。<br/>            指定的 [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) 将被存储为源图像。
...
使用指定的宽度和高度，初始化 [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) 类的新实例。
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | 裁剪后的 [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) 作为 [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/)。 |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | 膨胀的 [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) 作为 [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/)。 |
