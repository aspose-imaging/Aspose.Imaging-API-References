...
type: docs
weight: 10
url: /zh/python-net/aspose.imaging.magicwand.imagemasks/circlemask/
---
...
| **Name** | **描述** |
| :- | :- |
| [CircleMask(center, radius)](#CircleMask_center_radius_1) | 使用指定的中心点和半径初始化 [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) 类的新实例。 |
| [CircleMask(x, y, radius)](#CircleMask_x_y_radius_2) | 使用指定的中心点和半径初始化 [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | 获取此掩码的边界（以像素为单位）。 |
| height | int | r | 获取此掩码的高度（以像素为单位）。 |
| selection_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | 获取此掩码的边界（以像素为单位）。 |
...
使用指定的中心点和半径初始化 [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) 类的新实例。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| center | [Point](/imaging/python-net/aspose.imaging/point/) | 所选区域的中心点。 |
| 半径 | int | 所选区域的半径。 |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | 裁剪后的 CircleMask 或 ImageBitMask 作为 ImageMask。<br/>            由于可能返回 ImageBitMask，建议使用流式调用。 |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | 膨胀的 CircleMask 作为 ImageMask。 |
