---
title: "EmptyImageMask 类"
type: docs
weight: 20
url: /zh/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmptyImageMask(width, height)](#EmptyImageMask_width_height_1) | 使用指定的宽度和高度初始化 [EmptyImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
使用指定的宽度和高度初始化 [EmptyImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/) 类的新实例。
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | 裁剪后的 EmptyImageMask 作为 ImageMask。 |
...
| Type | Description |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | 膨胀的 EmptyImageMask 作为 ImageMask。 |
