...
type: docs
weight: 10
url: /zh/python-net/aspose.imaging.fileformats.ico/icoimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [IcoImage(image, ico_options)](#IcoImage_image_ico_options_1) | 为简洁和高效而打造，[IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) 类使您能够轻松创建 ICO 图像。此构造函数初始化类的新实例 <br/>            为您的图像处理需求提供坚实基础。 <br/>            无论您是开发应用程序还是提升用户界面， <br/>            [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) 类都简化了 ICO 图像管理，让您专注于提供卓越的体验。 |
| [IcoImage(width, height, options)](#IcoImage_width_height_options_2) | 使用 [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) 类轻松开始 ICO 图像创建。此 <br/>            构造函数允许您通过指定宽度、高度和创建选项参数来初始化 ICO 图像的新实例。凭借此简洁的 <br/>            构造函数，您可以根据精确规格定制 ICO 图像，确保在不同平台和设备之间实现无缝兼容和视觉吸引力。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | 使用此属性即可轻松检索文件格式，实现工作流的无缝 <br/>            集成。通过使用此属性，您可以获取有关文件格式的关键信息，确保兼容性和高效处理。 |
| has_alpha | bool | r | 使用此属性确定此实例是否存在 alpha 通道。它 <br/>            提供了一种快速检查图像或文档是否包含 alpha 通道的方法，<br/>            这对于各种图像处理和渲染任务至关重要。非常适合 <br/>            确保兼容性并处理图像或文档中的透明效果。 |
...
| page_count | int | r | 通过此简洁的 <br/>            属性，您可立即了解文档结构。调用此属性，您可以轻松检索文件中包含的总页数。 |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | 通过此属性轻松检索文档页面的完整信息。<br/>            通过访问此属性，您可以获得一个包含文档中所有页面的集合或数组<br/>            。 |
...
| **Name** | **描述** |
| :- | :- |
| [add_page(page)](#add_page_page_1) | 通过添加图像页面条目来扩展您的 ICO 图像，利用 <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/)。此方法可无缝地将栅格图像合并到 <br/>            您的 ICO 文件中，并将其转换为高质量的 32 位 PNG 格式。非常适合 <br/>            在确保最佳兼容性和渲染质量的同时，增强您的 ICO 文件的栅格图像。 |
| [add_page(page)](#add_page_page_2) | 通过添加图像页面条目来扩展您的 ICO 图像，利用 <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/)。此方法可无缝地将栅格图像合并到 <br/>            您的 ICO 文件中，并将其转换为高质量的 32 位 PNG 格式。非常适合 <br/>            在确保最佳兼容性和渲染质量的同时，增强您的 ICO 文件的栅格图像。 |
| [add_page(page, ico_options)](#add_page_page_ico_options_3) | 通过使用指定的 [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) 将符合您需求的图像条目集成到 ICO 图像中，轻松实现多样化。此方法可无缝 <br/>            地根据您的自定义选项合并图像，确保 ICO 文件的灵活性 <br/>            和精确性。 |
| [add_raster_page(page)](#add_raster_page_page_4) | 根据默认的 [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) 将图像条目添加到 ICO 图像中，使用 32 位 PNG 格式。 |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | 调整图像的 _brightness_。 |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | [Image](/imaging/python-net/aspose.imaging/image/) 对比 |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | 图像的伽马校正。 |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | 图像的伽马校正。 |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_11) | 使用 Bradley 的自适应阈值算法和积分图阈值进行图像二值化 |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | 使用预定义阈值对图像进行二值化 |
...
| [can_load(stream)](#can_load_stream_17) | 确定给定流是否包含 ICO 图像。 |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | 使用位移裁剪图像。 |
...
| [embed_digital_signature(password)](#embed_digital_signature_password_38) | 根据提供的密码将数字签名嵌入图像的每一页。 |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_76) | 归一化角度。<br/>            此方法适用于扫描的文本文档，以消除倾斜扫描。<br/>            此方法使用 [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) 和 [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) 方法。 |
...
| [remove_page(index)](#remove_page_index_79) | 通过删除文件中位于指定 ***index*** 的特定图像条目来微调您的 ICO 图像。此方法提供精确的 <br/>            图像组成控制，使您能够轻松优化 ICO 文件。 |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_83) | 将所有非透明颜色替换为新颜色，并保留原始 alpha 值以保持平滑边缘。<br/>                注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_84) | 将所有非透明颜色替换为新颜色，并保留原始 alpha 值以保持平滑边缘。<br/>                注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | 调整图像大小。使用默认的 [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/)。 |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) 围绕中心旋转图像。 |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | 旋转、翻转，或同时旋转和翻转所有页面。 |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_101) | 旋转并翻转全部。 |
| save() | 将图像数据保存到底层流中。 |
| [save(file_path)](#save_file_path_102) | 将图像保存到指定的文件位置。 |
| [save(file_path, options)](#save_file_path_options_103) | 根据保存选项，将对象的数据保存到指定文件位置的指定文件格式中。 |
...
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | 根据保存选项，将图像的数据保存到指定流中的指定文件格式。 |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_109) | 保存 32 位 ARGB 像素。 |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_110) | 保存像素。 |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_111) | 保存像素。<br/>此方法已弃用。请使用更有效的 [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) 方法。 |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_112) | 保存像素的内部主要内容。 |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_113) | 保存原始数据。 |
| [save_to_stream(stream)](#save_to_stream_stream_114) | 将对象的数据保存到指定的流中。 |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_115) | 根据保存选项，将图像的数据保存到指定流中的指定文件格式。 |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_116) | 根据保存选项，将图像的数据保存到指定流中的指定文件格式。 |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_117) | 根据保存选项，将对象的数据保存到指定文件位置的指定文件格式中。 |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_118) | 根据保存选项，将对象的数据保存到指定文件位置的指定文件格式中。 |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_119) | 为指定位置设置图像的 32 位 ARGB 像素。 |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_120) | 设置图像调色板。 |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_121) | 为指定位置设置图像像素。 |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_122) | 为此 [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) 设置分辨率。 |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_123) | 尝试设置一个 _metadata_ 实例，前提是此 [Image](/imaging/python-net/aspose.imaging/image/) 实例支持并实现 [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) 实例。 |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_124) | 将整条扫描线写入指定的扫描线索引。 |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_125) | 将整条扫描线写入指定的扫描线索引。 |
...
为简洁和高效而打造，[IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) 类使您能够轻松创建 ICO 图像。此构造函数初始化类的新实例 <br/>            为您的图像处理需求提供坚实基础。 <br/>            无论您是开发应用程序还是提升用户界面， <br/>            [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) 类都简化了 ICO 图像管理，让您专注于提供卓越的体验。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| image | [Image](/imaging/python-net/aspose.imaging/image/) | 图像。 |
| ico_options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | ICO 选项。 |
...
使用 [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) 类轻松开始 ICO 图像创建。此 <br/>            构造函数允许您通过指定宽度、高度和创建选项参数来初始化 ICO 图像的新实例。凭借此简洁的 <br/>            构造函数，您可以根据精确规格定制 ICO 图像，确保在不同平台和设备之间实现无缝兼容和视觉吸引力。
...
| width | int | 宽度。 |
| height | int | 高度。 |
| options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | ICO 创建选项。 |
...
通过添加图像页面条目来扩展您的 ICO 图像，利用 <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/)。此方法可无缝地将栅格图像合并到 <br/>            您的 ICO 文件中，并将其转换为高质量的 32 位 PNG 格式。非常适合 <br/>            在确保最佳兼容性和渲染质量的同时，增强您的 ICO 文件的栅格图像。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| page | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | 图像。 |
...
| 参数 | Type | Description |
| :- | :- | :- |
| page | [Image](/imaging/python-net/aspose.imaging/image/) | 图像。 |
...
通过使用指定的 [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) 将符合您需求的图像条目集成到 ICO 图像中，轻松实现多样化。此方法可无缝 <br/>            地根据您的自定义选项合并图像，确保 ICO 文件的灵活性 <br/>            和精确性。
...
根据默认的 [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) 将图像条目添加到 ICO 图像中，使用 32 位 PNG 格式。
...
通过删除文件中位于指定 ***index*** 的特定图像条目来微调您的 ICO 图像。此方法提供精确的 <br/>            图像组成控制，使您能够轻松优化 ICO 文件。
...
| :- | :- | :- |
| 角度 | float | 旋转角度（以度为单位）。正值将顺时针旋转。 |
| resize_proportionally | bool | 如果设置为 <c>true</c>，图像尺寸将根据旋转矩形（角点）投影进行更改<br/>                否则，尺寸保持不变，仅 __internal__ 图像内容被旋转。 |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | 背景颜色。 |
