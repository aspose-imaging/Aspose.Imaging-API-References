...
type: docs
weight: 50
url: /zh/python-net/aspose.imaging.shapes/pieshape/
---
...
| **Name** | **描述** |
| :- | :- |
| [PieShape()](#PieShape__1) | 初始化一个新的 [PieShape](/imaging/python-net/aspose.imaging.shapes/pieshape/) 类实例。 |
| [PieShape(rectangle, start_angle, sweep_angle)](#PieShape_rectangle_start_angle_sweep_angle_2) | 初始化一个新的 [PieShape](/imaging/python-net/aspose.imaging.shapes/pieshape/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [PieShape](/imaging/python-net/aspose.imaging.shapes/pieshape/) 类实例。
