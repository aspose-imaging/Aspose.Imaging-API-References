---
title: "TiffFloatType 类"
type: docs
weight: 50
url: /zh/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/
---
...
| **Name** | **描述** |
| :- | :- |
| [TiffFloatType(tag_id)](#TiffFloatType_tag_id_1) | 初始化 [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) 类的新实例。 |
| [TiffFloatType(tag_id)](#TiffFloatType_tag_id_2) | 初始化 [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| count | int | r | 获取元素的计数。 |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | 初始化 [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) 类的新实例。 |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | 初始化 [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) 类的新实例。 |
...
初始化 [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) 类的新实例。
