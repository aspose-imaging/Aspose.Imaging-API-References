---
title: "TiffSByteType 类"
type: docs
weight: 110
url: /zh/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/
---
...
| **Name** | **描述** |
| :- | :- |
| [TiffSByteType(tag_id)](#TiffSByteType_tag_id_1) | 初始化 [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) 类的新实例。 |
| [TiffSByteType(tag_id)](#TiffSByteType_tag_id_2) | 初始化 [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| count | int | r | 获取元素的计数。 |
...
| values | System.SByte | r/w | 获取或设置这些值。 |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | 初始化 [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) 类的新实例。 |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | 初始化 [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) 类的新实例。 |
...
初始化 [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) 类的新实例。
