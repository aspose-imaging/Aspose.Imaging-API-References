---
title: "TiffRationalType 类"
type: docs
weight: 100
url: /zh/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/
---
...
| **Name** | **描述** |
| :- | :- |
| [TiffRationalType(tag_id)](#TiffRationalType_tag_id_1) | 初始化 [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) 类的新实例。 |
| [TiffRationalType(tag_id)](#TiffRationalType_tag_id_2) | 初始化 [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| count | int | r | 获取元素的计数。 |
...
| values | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | 获取或设置这些值。 |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | 初始化 [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) 类的新实例。 |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | 初始化 [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) 类的新实例。 |
...
初始化 [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) 类的新实例。
