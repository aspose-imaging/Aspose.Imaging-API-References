---
title: "TiffSShortType 类"
type: docs
weight: 150
url: /zh/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
...
| **Name** | **描述** |
| :- | :- |
| [TiffSShortType(tag_id)](#TiffSShortType_tag_id_1) | 初始化 [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) 类的新实例。 |
| [TiffSShortType(tag_id)](#TiffSShortType_tag_id_2) | 初始化 [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| count | int | r | 获取元素的计数。 |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | 初始化 [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) 类的新实例。 |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | 初始化 [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) 类的新实例。 |
...
初始化 [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) 类的新实例。
