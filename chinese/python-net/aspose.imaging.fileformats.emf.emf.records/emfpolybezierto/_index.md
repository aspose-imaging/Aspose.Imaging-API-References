---
title: "EmfPolyBezierTo 类"
type: docs
weight: 780
url: /zh/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolybezierto/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPolyBezierTo()](#EmfPolyBezierTo__1) | 初始化一个新的 [EmfPolyBezierTo](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolybezierto/) 类的实例。 |
| [EmfPolyBezierTo(source)](#EmfPolyBezierTo_source_2) | 初始化一个新的 [EmfPolyBezierTo](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolybezierto/) 类的实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [EmfPolyBezierTo](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolybezierto/) 类的实例。
