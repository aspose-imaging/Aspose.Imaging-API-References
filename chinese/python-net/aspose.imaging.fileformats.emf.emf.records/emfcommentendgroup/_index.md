---
title: "EmfCommentEndGroup 类"
type: docs
weight: 200
url: /zh/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentendgroup/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfCommentEndGroup(source)](#EmfCommentEndGroup_source_1) | 初始化一个新的 [EmfCommentEndGroup](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentendgroup/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [EmfCommentEndGroup](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentendgroup/) 类实例。
