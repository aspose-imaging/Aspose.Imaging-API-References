---
title: "EmfExtTextOutW 类"
type: docs
weight: 480
url: /zh/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextoutw/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfExtTextOutW()](#EmfExtTextOutW__1) | 初始化一个新的 [EmfExtTextOutW](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextoutw/) 类实例。 |
| [EmfExtTextOutW(source)](#EmfExtTextOutW_source_2) | 初始化一个新的 [EmfExtTextOutW](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextoutw/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| w_emr_text | [EmfText](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emftext/) | r/w | 获取或设置一个 EmrText 对象（第 2.2.5 节），用于指定以 16 位 Unicode UTF16-LE 字符表示的输出字符串，并包含文本属性和间距值。 |
## **Methods**
| **Name** | **描述** |
| :- | :- |
...
初始化一个新的 [EmfExtTextOutW](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextoutw/) 类实例。
