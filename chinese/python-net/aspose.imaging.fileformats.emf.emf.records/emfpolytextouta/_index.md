---
title: "EmfPolyTextOutA 类"
type: docs
weight: 880
url: /zh/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolytextouta/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPolyTextOutA()](#EmfPolyTextOutA__1) | 初始化 [EmfPolyTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolytextouta/) 类的新实例。 |
| [EmfPolyTextOutA(source)](#EmfPolyTextOutA_source_2) | 初始化 [EmfPolyTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolytextouta/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| a_emr_text | [EmfText[]](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emftext/) | r/w | 获取或设置一个 EmrText 对象数组（第 2.2.5 节），用于指定以 8 位 ASCII 字符表示的输出 <br/> 字符串，包含文本属性和间距值。EmrText 对象的数量由 cStrings 指定。 |
...
初始化 [EmfPolyTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolytextouta/) 类的新实例。
