---
title: "EmfPolylineTo 类"
type: docs
weight: 940
url: /zh/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolylineto/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPolylineTo()](#EmfPolylineTo__1) | 初始化一个新的 [EmfPolylineTo](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolylineto/) 类实例。 |
| [EmfPolylineTo(source)](#EmfPolylineTo_source_2) | 初始化一个新的 [EmfPolylineTo](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolylineto/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [EmfPolylineTo](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfpolylineto/) 类实例。
