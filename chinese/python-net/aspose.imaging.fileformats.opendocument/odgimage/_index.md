...
type: docs
weight: 490
url: /zh/python-net/aspose.imaging.fileformats.opendocument/odgimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [OdgImage(stream_container)](#OdgImage_stream_container_1) | 为在软件解决方案中实现无缝集成而打造，[OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) 构造函数通过利用流容器初始化新实例。此方法 <br/>            确保在软件环境中高效处理 ODG 图像数据，优化 <br/>            资源利用并促进简化的图像处理工作流。 |
| [OdgImage(stream_container, options)](#OdgImage_stream_container_options_2) | 通过 <br/>            启动全新实例，开始创建 [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) 类对象。利用与加载选项参数相结合的流容器的潜力，保持多功能构造函数以无缝加载 <br/>            图像。此构造函数提升了高效的图像处理，提供可定制的 <br/>            加载配置，以在各种场景中实现更强的适应性和性能。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | 检索页面集合，此属性使能够访问与图像关联的全部 <br/>            页面。通过访问此属性，开发人员可以 <br/>            遍历各个页面，根据索引检索特定页面，或 <br/>            对整个集合执行批量操作。 |
...
为在软件解决方案中实现无缝集成而打造，[OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) 构造函数通过利用流容器初始化新实例。此方法 <br/>            确保在软件环境中高效处理 ODG 图像数据，优化 <br/>            资源利用并促进简化的图像处理工作流。
...
通过 <br/>            启动全新实例，开始创建 [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) 类对象。利用与加载选项参数相结合的流容器的潜力，保持多功能构造函数以无缝加载 <br/>            图像。此构造函数提升了高效的图像处理，提供可定制的 <br/>            加载配置，以在各种场景中实现更强的适应性和性能。
...
| options | [LoadOptions](/imaging/python-net/aspose.imaging/loadoptions/) | 加载选项 |
