...
type: docs
weight: 500
url: /zh/python-net/aspose.imaging.fileformats.opendocument/otgimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [OtgImage(stream_container)](#OtgImage_stream_container_1) | 通过提供流 <br/>            容器来创建 [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) 类的新对象。此构造函数使开发人员能够直接从 <br/>            流容器创建 OTG 图像，简化了处理 OTG 图像数据的过程。 |
| [OtgImage(stream_container, load_options)](#OtgImage_stream_container_load_options_2) | 通过提供流容器 <br/>            和加载选项来初始化新的 [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) 对象。此构造函数使开发人员能够高效地从流中加载 OTG <br/>            图像，并可指定自定义加载配置。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| bits_per_pixel | int | r | 检索图像的每像素位数。此属性提供对图像中细节级别和颜色深度的 <br/>            了解，有助于各种 <br/>            图像处理任务和优化。 |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | 检索与图像关联的默认页面，提供对图像集合中主页面的必要访问。此属性简化了图像数据的导航 <br/>            和操作，提升了软件开发 <br/>            工作流的效率。 |
| disposed | bool | r | 获取一个值，指示此实例是否已释放。 |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | 获取或设置 Exif 实例。 |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | 此属性提供对 OTG 文件格式的访问，提供有关图像文件中封装数据类型的关键洞察 <br/>            它作为软件开发人员的关键参考点，使他们能够在应用程序中有效处理 OTG <br/>            文件。通过使用此属性，您可以 <br/>            确定图像文件的具体格式，促进 OTG 文件在其软件系统中的无缝 <br/>            集成和操作。 |
...
| is_cached | bool | r | 获取一个布尔值，指示对象的数据是否当前已 <br/>            缓存，从而消除读取数据的需求。此属性充当优化指示器，通过最小化冗余数据访问 <br/>            操作来提升性能。 |
| metadata | [OdMetadata](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects/odmetadata/) | r | 检索特定于 OpenDocument 文件的元数据。此属性允许访问 <br/>            嵌入在 OD 文件中的关键信息，促进各种操作，如 <br/>            提取、修改或分析元数据。 |
| page_count | int | r | 检索图像中的总页数。此属性对管理多页图像的应用程序至关重要，使其能够准确确定可用于处理或显示的 <br/>            页数。 |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | 检索与图像关联的页面集合，使软件 <br/>            开发人员能够高效访问和操作每个单独的页面。此 <br/>            属性促进对页面的无缝遍历，以执行各种操作，<br/>            提升图像处理应用程序的功能性和多样性。 |
| palette | [IColorPalette](/imaging/python-net/aspose.imaging/icolorpalette/) | r/w | 获取或设置颜色调色板。当像素直接表示时，不使用颜色调色板。 |
| records | [OdObject[]](/imaging/python-net/aspose.imaging.fileformats.opendocument/odobject/) | r | 检索存储在图像中的 OpenDocument 记录。此属性授予 <br/>            对嵌入在 OpenDocument 文件中的特定结构化数据元素的访问，<br/>            促进相关信息的检索或操作，以便进一步处理 <br/>            或分析。 |
...
通过提供流 <br/>            容器来创建 [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) 类的新对象。此构造函数使开发人员能够直接从 <br/>            流容器创建 OTG 图像，简化了处理 OTG 图像数据的过程。
...
通过提供流容器 <br/>            和加载选项来初始化新的 [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) 对象。此构造函数使开发人员能够高效地从流中加载 OTG <br/>            图像，并可指定自定义加载配置。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| stream_container | [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/) | 该流。 |
