...
type: docs
weight: 80
url: /zh/python-net/aspose.imaging.brushes/solidbrush/
---
...
| **Name** | **描述** |
| :- | :- |
| [SolidBrush()](#SolidBrush__1) | 初始化 [SolidBrush](/imaging/python-net/aspose.imaging.brushes/solidbrush/) 类的新实例。 |
| [SolidBrush(color)](#SolidBrush_color_2) | 初始化 [SolidBrush](/imaging/python-net/aspose.imaging.brushes/solidbrush/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| [color](#color1) | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | 获取或设置画笔颜色。 |
...
初始化 [SolidBrush](/imaging/python-net/aspose.imaging.brushes/solidbrush/) 类的新实例。
...
| 参数 | Type | Description |
| :- | :- | :- |
| color | [Color](/imaging/python-net/aspose.imaging/color/) | 实心画笔的颜色。 |
