---
title: "EmfPlusComment 类"
type: docs
weight: 50
url: /zh/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfpluscomment/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPlusComment(source)](#EmfPlusComment_source_1) | 初始化一个新的 [EmfPlusComment](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfpluscomment/) 类的实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| private_data | System.Byte | r/w | 获取或设置一个长度为 DataSize 的私有数据字节数组。<br/>            随后记录特定数据的字节。 |
...
初始化一个新的 [EmfPlusComment](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfpluscomment/) 类的实例。
