---
title: "EmfPlusSetTextRenderingHint 类"
type: docs
weight: 560
url: /zh/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPlusSetTextRenderingHint(source)](#EmfPlusSetTextRenderingHint_source_1) | 初始化 [EmfPlusSetTextRenderingHint](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| text_rendering_hint | [EmfPlusTextRenderingHint](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.consts/emfplustextrenderinghint/) | r/w | 获取或设置文本渲染提示值，来源于<br/>            TextRenderingHint 枚举（第 2.1.1.32 节），该枚举指定后续文本渲染使用的质量。 |
...
初始化 [EmfPlusSetTextRenderingHint](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/) 类的新实例。
