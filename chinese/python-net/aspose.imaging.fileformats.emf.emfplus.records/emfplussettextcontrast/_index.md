---
title: "EmfPlusSetTextContrast 类"
type: docs
weight: 550
url: /zh/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextcontrast/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPlusSetTextContrast(source)](#EmfPlusSetTextContrast_source_1) | 初始化 [EmfPlusSetTextContrast](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextcontrast/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| text_contrast | int | r/w | 获取或设置伽马校正值（乘以 1000），该值将应用于<br/>            随后的文本渲染操作。允许范围为 1000 到 2200，<br/>            对应文本伽马值 1.0 到 2.2。 |
...
初始化 [EmfPlusSetTextContrast](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextcontrast/) 类的新实例。
