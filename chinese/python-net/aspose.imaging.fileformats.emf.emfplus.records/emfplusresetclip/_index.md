---
title: "EmfPlusResetClip 类"
type: docs
weight: 380
url: /zh/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPlusResetClip(source)](#EmfPlusResetClip_source_1) | 初始化一个新的 [EmfPlusResetClip](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/) 类的实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [EmfPlusResetClip](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/) 类的实例。
