---
title: "EmfPlusResetWorldTransform 类"
type: docs
weight: 390
url: /zh/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPlusResetWorldTransform(source)](#EmfPlusResetWorldTransform_source_1) | 初始化一个新的 [EmfPlusResetWorldTransform](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/) 类的实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [EmfPlusResetWorldTransform](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/) 类的实例。
