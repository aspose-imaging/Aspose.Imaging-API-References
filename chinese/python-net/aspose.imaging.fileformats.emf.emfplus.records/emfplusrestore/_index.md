---
title: "EmfPlusRestore 类"
type: docs
weight: 400
url: /zh/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusrestore/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPlusRestore(source)](#EmfPlusRestore_source_1) | 初始化 [EmfPlusRestore](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusrestore/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| stack_index | int | r/w | 获取或设置一个 32 位无符号整数，指定与图形状态关联的级别。<br/>            该级别值由先前的 EmfPlusSave 记录（第 2.3.7.5 节）分配给图形状态。 |
...
初始化 [EmfPlusRestore](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusrestore/) 类的新实例。
