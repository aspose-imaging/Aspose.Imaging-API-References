---
title: "EmfPlusGetDc 类"
type: docs
weight: 300
url: /zh/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusgetdc/
---
...
| **Name** | **描述** |
| :- | :- |
| [EmfPlusGetDc(source)](#EmfPlusGetDc_source_1) | 初始化一个新的 [EmfPlusGetDc](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusgetdc/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [EmfPlusGetDc](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusgetdc/) 类实例。
