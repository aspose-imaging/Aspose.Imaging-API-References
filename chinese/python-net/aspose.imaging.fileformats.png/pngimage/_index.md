...
type: docs
weight: 10
url: /zh/python-net/aspose.imaging.fileformats.png/pngimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [PngImage(path)](#PngImage_path_1) | 使用路径 <br/> 参数构造 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例，以指定要加载的图像文件位置。此构造函数 <br/> 使开发者能够方便地通过从文件加载来创建 PNG 图像，<br/> 简化了在其应用程序中使用 PNG 图像的过程。 |
| [PngImage(path, color_type)](#PngImage_path_color_type_2) | 通过指定 <br/> 路径到图像文件以及颜色类型，初始化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数允许方便地 <br/> 从不同颜色类型的文件创建 PNG 图像，提供 <br/> 在处理各种图像格式时的灵活性。 |
| [PngImage(png_options, width, height)](#PngImage_png_options_width_height_3) | 初始化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例，结合 <br/> PNG 选项以及宽度和高度参数。此构造函数使 <br/> 开发者能够创建具有可自定义设置和尺寸的 PNG 图像，<br/> 为多种使用场景的图像生成提供灵活性。 |
| [PngImage(raster_image)](#PngImage_raster_image_4) | 通过提供光栅 <br/> 图像作为参数，创建 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数允许开发者直接初始化一个 <br/> 使用现有光栅图像的 PNG 图像对象，简化了在其应用程序中使用 PNG 图像的过程。 |
| [PngImage(raster_image, color_type)](#PngImage_raster_image_color_type_5) | 通过指定 <br/> 光栅图像和颜色类型，创建 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数使开发者能够直接 <br/> 将光栅图像转换为 PNG 格式，同时指定所需的颜色类型，<br/> 提供颜色表示的灵活性。 |
| [PngImage(stream)](#PngImage_stream_6) | 通过使用流 <br/> 初始化，创建 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数允许开发者直接从流加载 PNG 图像，提供从不同来源检索图像的灵活性。 |
| [PngImage(width, height)](#PngImage_width_height_7) | 通过提供 <br/> 宽度和高度参数，初始化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新对象。此构造函数通过允许开发者直接指定尺寸，简化了 PNG <br/> 图像的创建，促进在其应用程序中高效管理 PNG 图像数据。 |
| [PngImage(width, height, color_type)](#PngImage_width_height_color_type_8) | 实例化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的全新实例，指定 <br/> 所需的宽度、高度和颜色类型参数。此构造函数实现了 <br/> 快速创建具有定制尺寸和颜色配置的 PNG 图像，促进各种应用和工作流的简化图像生成。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| auto_adjust_palette | bool | r/w | 获取或设置一个值，指示是否自动调整调色板。 |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | 检索图像的背景颜色（如果已指定）。此属性 <br/> 对于需要识别并可能操作图像背景颜色的应用程序非常有用。 |
| bits_per_pixel | int | r | 检索图像的每像素位数值。此属性提供有关图像颜色深度的关键 <br/> 信息，使开发者能够了解图像数据中细节和颜色精度的水平。 |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | 检索与图像实例关联的文件格式。此 <br/> 属性提供有关文件类型的基本信息，使得能够根据特定格式要求进行高效的处理和操作。 |
| [has_alpha](#has_alpha1) | bool | r | 返回一个布尔值，指示图像是否具有 alpha 通道，<br/> 这决定了其透明度。此属性对需要处理透明度的应用程序很有用，允许开发者判断是否需要 <br/> 进行额外处理以处理图像中的透明区域。 |
| has_background_color | bool | r/w | 检索一个布尔值，指示图像是否具有背景颜色。<br/> 此属性对需要确定图像是否包含背景颜色的应用程序有用，这在合成、渲染或导出等各种处理任务中可能很重要。 |
| has_transparent_color | bool | r/w | 提供一个布尔值，指示图像是否包含透明颜色。<br/> 此属性对需要处理透明度的应用程序至关重要，允许开发者判断是否需要 <br/> 进行额外处理以处理图像中的透明区域。 |
| height | int | r | 获取图像的高度。此属性返回图像的垂直尺寸，<br/> 允许开发者确定其在垂直轴上的像素大小。 |
| horizontal_resolution | float | r/w | 检索或修改图像的水平分辨率。此属性 <br/> 表示图像水平轴每英寸的像素数。调整此分辨率可能会影响图像在打印或显示时的实际尺寸。 |
| image_opacity | float | r | 获取此图像的不透明度。 |
| interlaced | bool | r | 检索一个布尔值，指示 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 是否 <br/> 为交错式，这决定了图像数据是否以渐进方式存储，以实现更快的加载或传输。 |
...
| is_interlaced | bool | r | 返回一个布尔值，指示图像实例是否为交错。此 <br/>            属性对于优化加载策略以及确保在图像处理或显示任务期间的高效 <br/>            性能至关重要。 |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | 访问图像的原始数据格式。此属性提供对图像数据内部结构的洞察，<br/>            对于高级图像处理任务或格式转换可能非常有用。 |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | 检索图像的透明颜色（如果存在）。此属性对于需要精确处理图像中透明区域的应用程序非常有价值，<br/>            允许开发者访问并操作所使用的特定透明颜色。 |
...
| vertical_resolution | float | r/w | 提供对图像垂直分辨率的访问。开发者可以使用此属性检索或修改分辨率设置，<br/>            该设置指示图像垂直轴每英寸的像素数（PPI）。 |
| width | int | r | 允许检索图像的宽度，提供关于其尺寸的关键信息。此属性经常被开发者用于<br/>            确定图像宽度，从而能够基于其大小执行各种操作。 |
...
| [create_from_file_with_color_type(path, color_type)](#create_from_file_with_color_type_path_color_type_26) | 初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。 |
| [create_from_files(files)](#create_from_files_files_27) | 创建包含指定文件的多页图像，将其作为延迟加载页面。 |
| [create_from_files(files, throw_exception_on_load_error)](#create_from_files_files_throw_exception_on_load_error_28) | 创建包含指定文件的多页图像，将其作为延迟加载页面。 |
| [create_from_image(raster_image)](#create_from_image_raster_image_29) | 初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。 |
| [create_from_image_with_color_type(raster_image, color_type)](#create_from_image_with_color_type_raster_image_color_type_30) | 初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。 |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | 初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。 |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_34) | 初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。 |
| [create_with_width_height_color_type(width, height, color_type)](#create_with_width_height_color_type_width_height_color_type_35) | 初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。 |
| [create_with_width_height_options(png_options, width, height)](#create_with_width_height_options_png_options_width_height_36) | 初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。 |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_54) | 检索指示资源图像最近一次修改的时间戳。此方法提供对关键元数据的访问，<br/>            使应用程序能够确定图像上次何时被更改，便于版本跟踪和内容管理。 |
...
| [save(stream)](#save_stream_107) | 保存的数据。 |
...
使用路径 <br/> 参数构造 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例，以指定要加载的图像文件位置。此构造函数 <br/> 使开发者能够方便地通过从文件加载来创建 PNG 图像，<br/> 简化了在其应用程序中使用 PNG 图像的过程。
...
通过指定 <br/> 路径到图像文件以及颜色类型，初始化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数允许方便地 <br/> 从不同颜色类型的文件创建 PNG 图像，提供 <br/> 在处理各种图像格式时的灵活性。
...
| :- | :- | :- |
| 路径 | string | 加载图像的路径。 |
| color_type | [PngColorType](/imaging/python-net/aspose.imaging.fileformats.png/pngcolortype/) | 颜色类型。 |
...
初始化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例，结合 <br/> PNG 选项以及宽度和高度参数。此构造函数使 <br/> 开发者能够创建具有可自定义设置和尺寸的 PNG 图像，<br/> 为多种使用场景的图像生成提供灵活性。
...
通过提供光栅 <br/> 图像作为参数，创建 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数允许开发者直接初始化一个 <br/> 使用现有光栅图像的 PNG 图像对象，简化了在其应用程序中使用 PNG 图像的过程。
...
通过指定 <br/> 光栅图像和颜色类型，创建 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数使开发者能够直接 <br/> 将光栅图像转换为 PNG 格式，同时指定所需的颜色类型，<br/> 提供颜色表示的灵活性。
...
通过使用流 <br/> 初始化，创建 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新实例。此构造函数允许开发者直接从流加载 PNG 图像，提供从不同来源检索图像的灵活性。
...
通过提供 <br/> 宽度和高度参数，初始化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的新对象。此构造函数通过允许开发者直接指定尺寸，简化了 PNG <br/> 图像的创建，促进在其应用程序中高效管理 PNG 图像数据。
...
实例化 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类的全新实例，指定 <br/> 所需的宽度、高度和颜色类型参数。此构造函数实现了 <br/> 快速创建具有定制尺寸和颜色配置的 PNG 图像，促进各种应用和工作流的简化图像生成。
...
返回一个布尔值，指示图像是否具有 alpha 通道，<br/> 这决定了其透明度。此属性对需要处理透明度的应用程序很有用，允许开发者判断是否需要 <br/> 进行额外处理以处理图像中的透明区域。
...
初始化一个新的 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 类实例。
...
检索指示资源图像最近一次修改的时间戳。此方法提供对关键元数据的访问，<br/>            使应用程序能够确定图像上次何时被更改，便于版本跟踪和内容管理。
...
# 一个 GrayscaleWithAlpha PNG 图像支持 alpha 通道
# 一个 TruecolorWithAlpha PNG 图像支持 alpha 通道
