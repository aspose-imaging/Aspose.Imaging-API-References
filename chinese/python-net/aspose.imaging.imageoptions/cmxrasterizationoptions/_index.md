...
type: docs
weight: 50
url: /zh/python-net/aspose.imaging.imageoptions/cmxrasterizationoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [CmxRasterizationOptions()](#CmxRasterizationOptions__1) | 初始化 [CmxRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/cmxrasterizationoptions/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化 [CmxRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/cmxrasterizationoptions/) 类的新实例。
