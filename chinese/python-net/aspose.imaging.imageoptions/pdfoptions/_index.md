...
type: docs
weight: 240
url: /zh/python-net/aspose.imaging.imageoptions/pdfoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [PdfOptions()](#PdfOptions__1) | 初始化一个新的 [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| page_size | [SizeF](/imaging/python-net/aspose.imaging/sizef/) | r/w | 获取或设置页面的大小。 |
| palette | [IColorPalette](/imaging/python-net/aspose.imaging/icolorpalette/) | r/w | 获取或设置颜色调色板。 |
| pdf_core_options | [PdfCoreOptions](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfcoreoptions/) | r/w | PDF 核心选项 |
| pdf_document_info | [PdfDocumentInfo](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfdocumentinfo/) | r/w | 获取或设置文档的元数据。 |
...
| use_original_image_resolution | bool | r/w | 获取或设置一个值，指示使用原始图像的 DPI 分辨率 |
...
初始化一个新的 [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/) 类实例。
