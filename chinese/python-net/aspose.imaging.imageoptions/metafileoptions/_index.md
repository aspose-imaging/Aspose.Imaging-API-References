---
title: "MetafileOptions 类"
type: docs
weight: 170
url: /zh/python-net/aspose.imaging.imageoptions/metafileoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [MetafileOptions()](#MetafileOptions__1) | 初始化一个新的 [MetafileOptions](/imaging/python-net/aspose.imaging.imageoptions/metafileoptions/) 类的实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| buffer_size_hint | int | r/w | 获取或设置缓冲区大小提示，该提示定义了所有内部缓冲区的最大允许大小。 |
| [compress](#compress1) | bool | r/w | 获取或设置一个值，指示此 [ICompressedOptions](/imaging/python-net/aspose.fileformats.core.imageoptions/icompressedoptions/) 是否已压缩。 |
...
初始化一个新的 [MetafileOptions](/imaging/python-net/aspose.imaging.imageoptions/metafileoptions/) 类的实例。

### Property: compress {#compress1}

获取或设置一个值，指示此 [ICompressedOptions](/imaging/python-net/aspose.fileformats.core.imageoptions/icompressedoptions/) 是否已压缩。
