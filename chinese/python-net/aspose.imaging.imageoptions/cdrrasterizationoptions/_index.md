---
title: "CdrRasterizationOptions 类"
type: docs
weight: 40
url: /zh/python-net/aspose.imaging.imageoptions/cdrrasterizationoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [CdrRasterizationOptions()](#CdrRasterizationOptions__1) | 初始化一个新的 [CdrRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/cdrrasterizationoptions/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [CdrRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/cdrrasterizationoptions/) 类实例。
