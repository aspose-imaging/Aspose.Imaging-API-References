---
title: "EpsRasterizationOptions 类"
type: docs
weight: 110
url: /zh/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [EpsRasterizationOptions()](#EpsRasterizationOptions__1) | 初始化 [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| preview_to_export | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | r/w | 使用 [EpsImage.get_preview_image(format)](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) 进行预览导出。 |
...
初始化 [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/) 类的新实例。
