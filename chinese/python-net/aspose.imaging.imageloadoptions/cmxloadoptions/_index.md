---
title: "CmxLoadOptions 类"
type: docs
weight: 20
url: /zh/python-net/aspose.imaging.imageloadoptions/cmxloadoptions/
---

**Summary:** The CMX load options

**Module:** [aspose.imaging.imageloadoptions](/imaging/python-net/aspose.imaging.imageloadoptions/)

**Full Name:** aspose.imaging.imageloadoptions.CmxLoadOptions
...
| **Name** | **描述** |
| :- | :- |
| [CmxLoadOptions()](#CmxLoadOptions__1) | 初始化 CmxLoadOptions 类的新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| optimal_memory_usage | bool | r/w | 获取或设置一个值，指示是否[optimal memory usage]。 |
| use_icc_profile_conversion | bool | r/w | 获取或设置一个值，指示是否应应用 ICC 配置文件转换。 |


### Constructor: CmxLoadOptions() {#CmxLoadOptions__1}
