...
type: docs
weight: 10
url: /zh/python-net/aspose.imaging.exif/exifdata/
---
...
| **Name** | **描述** |
| :- | :- |
| [ExifData()](#ExifData__1) | 初始化一个新的 [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) 类实例。 |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | 使用数组数据初始化一个新的 [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) 类实例。 |
| [ExifData(exifdata)](#ExifData_exifdata_3) | 使用数组数据初始化一个新的 [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) 类实例。 |
| [ExifData(exifdata)](#ExifData_exifdata_4) | 使用数组数据初始化一个新的 [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| [maker_notes](#maker_notes1) | [MakerNote[]](/imaging/python-net/aspose.imaging.exif/makernote/) | r | 获取制造商备注。 |
...
| x_resolution | int | r/w | 获取或设置 x 分辨率。 |
| y_resolution | int | r/w | 获取或设置 y 分辨率。 |
## **Methods**
| **Name** | **描述** |
| :- | :- |
...
初始化一个新的 [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) 类实例。
...
使用数组数据初始化一个新的 [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) 类实例。
