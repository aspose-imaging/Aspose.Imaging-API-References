...
type: docs
weight: 30
url: /zh/python-net/aspose.imaging.fileformats.eps/epsoptions/
---
...
| **Name** | **描述** |
| :- | :- |
| [EpsOptions()](#EpsOptions__1) | 初始化 EpsOptions 类的新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| sub_type | [EpsType](/imaging/python-net/aspose.imaging.fileformats.eps.consts/epstype/) | r/w | 获取或设置 EPS 格式的子类型。 |
