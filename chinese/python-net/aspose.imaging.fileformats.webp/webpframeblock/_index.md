---
title: "WebPFrameBlock 类"
type: docs
weight: 20
url: /zh/python-net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| **Name** | **描述** |
| :- | :- |
| [WebPFrameBlock(raster_image)](#WebPFrameBlock_raster_image_1) | <br/><br/>                    初始化一个新的 [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>类。<br/> |
| [WebPFrameBlock(width, height)](#WebPFrameBlock_width_height_2) | 初始化一个新的 [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/) 类。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| disposal_method | [AnimationDisposalMethods](/imaging/python-net/aspose.imaging/animationdisposalmethods/) | r/w | 获取或设置处理方法。 |
| disposed | bool | r | 获取一个值，指示此实例是否已释放。 |
| duration | int | r/w | 获取或设置帧持续时间。 |
...
| use_alpha_blending | bool | r/w | 获取或设置指示当前帧是否与前一帧的 alpha 值混合的值。 |
...
<br/><br/>                    初始化一个新的 [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>类。<br/>
...
初始化一个新的 [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/) 类。
