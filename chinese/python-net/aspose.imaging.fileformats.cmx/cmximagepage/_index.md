---
title: "CmxImagePage 类"
type: docs
weight: 110
url: /zh/python-net/aspose.imaging.fileformats.cmx/cmximagepage/
---
...
| **Name** | **描述** |
| :- | :- |
| [CmxImagePage(cmx_page)](#CmxImagePage_cmx_page_1) | 初始化 [CmxImagePage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximagepage/) 类的新实例。 |
| [CmxImagePage(cmx_page, container)](#CmxImagePage_cmx_page_container_2) | 初始化 [CmxImagePage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximagepage/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | r | 获取 CMX 页面。 |
...
| [get_default_options(args)](#get_default_options_args_22) | 获取默认选项。 |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_42) | 调整指定的新宽度。 |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_43) | 使用扩展选项调整图像大小。 |
...
初始化 [CmxImagePage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximagepage/) 类的新实例。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | CMX 页面。 |
...
| :- | :- | :- |
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | CMX 页面。 |
| container | [Image](/imaging/python-net/aspose.imaging/image/) | 容器。 |
