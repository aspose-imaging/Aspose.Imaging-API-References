---
title: "BigTiffImage 类"
type: docs
weight: 10
url: /zh/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [BigTiffImage(frame)](#BigTiffImage_frame_1) | 通过初始化<br/>            使用 TiffFrame 参数来创建 [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) 类的新实例。非常适合希望以便捷方式使用 BigTiffImage 对象的开发者，确保灵活性并易于将其集成<br/>            到项目中。 |
| [BigTiffImage(frames)](#BigTiffImage_frames_2) | 通过<br/>            使用 TiffFrames 列表参数初始化新实例，开始无缝使用 [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) 类。<br/>            非常适合希望以直接方式处理包含多个帧的<br/>            BigTiffImage 对象的开发者，确保项目的高效性。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | 获取此 [Image](/imaging/python-net/aspose.imaging/image/) 实例的文件格式。 |
...
| has_alpha | bool | r | 确定图像是否具有 alpha 通道，为渲染和合成操作提供关键信息<br/>            。将此功能集成到视觉处理工作流中，以优化<br/>            流程，确保对透明元素的准确<br/>            表现和操作。 |
...
| [add_page(page)](#add_page_page_4) | 通过此直观方法轻松为您的 BigTiff 图像添加新页面，<br/>            非常适合希望动态增强多页图像内容的开发者。 |
...
| [create_with_frame(frame)](#create_with_frame_frame_34) | 初始化 [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) 类的新实例。 |
| [create_with_frames(frames)](#create_with_frames_frames_35) | 初始化 [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) 类的新实例。 |
...
通过初始化<br/>            使用 TiffFrame 参数来创建 [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) 类的新实例。非常适合希望以便捷方式使用 BigTiffImage 对象的开发者，确保灵活性并易于将其集成<br/>            到项目中。
...
通过<br/>            使用 TiffFrames 列表参数初始化新实例，开始无缝使用 [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) 类。<br/>            非常适合希望以直接方式处理包含多个帧的<br/>            BigTiffImage 对象的开发者，确保项目的高效性。
...
通过此直观方法轻松为您的 BigTiff 图像添加新页面，<br/>            非常适合希望动态增强多页图像内容的开发者。
...
初始化 [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) 类的新实例。
...
| Type | Description |
| :- | :- |
| [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) | 包含该帧的新 BigTiffImage 图像。 |
