---
title: "TiffBigEndianStreamReader 类"
type: docs
weight: 50
url: /zh/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/
---
...
| **Name** | **描述** |
| :- | :- |
| [TiffBigEndianStreamReader(data)](#TiffBigEndianStreamReader_data_1) | 初始化一个新的 [TiffBigEndianStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/) 类实例。 |
| [TiffBigEndianStreamReader(data, start_index)](#TiffBigEndianStreamReader_data_start_index_2) | 初始化一个新的 [TiffBigEndianStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/) 类实例。 |
| [TiffBigEndianStreamReader(data, start_index, data_length)](#TiffBigEndianStreamReader_data_start_index_data_length_3) | 初始化一个新的 [TiffBigEndianStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/) 类实例。 |
| [TiffBigEndianStreamReader(stream_container)](#TiffBigEndianStreamReader_stream_container_4) | 初始化一个新的 [TiffBigEndianStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/) 类实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化一个新的 [TiffBigEndianStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/) 类实例。
