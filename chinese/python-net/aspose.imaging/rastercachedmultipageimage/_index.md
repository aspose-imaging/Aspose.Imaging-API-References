---
title: "RasterCachedMultipageImage 类"
type: docs
weight: 7050
url: /zh/python-net/aspose.imaging/rastercachedmultipageimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_1) | 调整图像的 _brightness_。 |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_2) | [Image](/imaging/python-net/aspose.imaging/image/) 对比 |
...
| [embed_digital_signature(password)](#embed_digital_signature_password_34) | 根据提供的密码将数字签名嵌入图像的每一页。 |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_72) | 归一化角度。<br/>            此方法适用于扫描的文本文档，以消除倾斜扫描。<br/>            此方法使用 [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) 和 [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) 方法。 |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_78) | 将所有非透明颜色替换为新颜色，并保留原始 alpha 值以保持平滑边缘。<br/>                注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_79) | 将所有非透明颜色替换为新颜色，并保留原始 alpha 值以保持平滑边缘。<br/>                注意：如果在没有透明度的图像上使用，它将把所有颜色替换为单一颜色。 |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_86) | 按比例调整宽度。 |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_94) | [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) 围绕中心旋转图像。 |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_95) | 旋转、翻转，或同时旋转和翻转所有页面。 |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_96) | 旋转并翻转全部。 |
| save() | 将图像数据保存到底层流中。 |
...
| [save(stream)](#save_stream_101) | 将对象的数据保存到指定的流中。 |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_107) | 保存像素的内部主要内容。 |
