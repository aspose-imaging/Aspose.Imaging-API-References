...
type: docs
weight: 30
url: /zh/python-net/aspose.imaging.fileformats.opendocument.objects.graphic/odcircle/
---
...
| **Name** | **描述** |
| :- | :- |
| [OdCircle(parent)](#OdCircle_parent_1) | 初始化 [OdCircle](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects.graphic/odcircle/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| absolute_coordinates | bool | r/w | 获取或设置指示是否使用 [absolute coordinates] 的值。 |
| closed | bool | r/w | 获取或设置一个值，指示此 [OdAngleEllipse](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects.graphic/odangleellipse/) 是否闭合。 |
| end_angle | float | r/w | 获取或设置结束角。 |
| 项 | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.OpenDocument.OdObject]] | r | 获取项目。 |
| kind | [OdObjectKind](/imaging/python-net/aspose.imaging.fileformats.opendocument.enums/odobjectkind/) | r/w | 获取或设置类型。 |
...
| style | [OdGraphicStyle](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects/odgraphicstyle/) | r/w | 获取或设置样式。 |
...
初始化 [OdCircle](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects.graphic/odcircle/) 类的新实例。
