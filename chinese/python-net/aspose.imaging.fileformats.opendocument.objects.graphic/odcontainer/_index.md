...
type: docs
weight: 60
url: /zh/python-net/aspose.imaging.fileformats.opendocument.objects.graphic/odcontainer/
---
...
| **Name** | **描述** |
| :- | :- |
| [OdContainer(parent)](#OdContainer_parent_1) | 初始化 [OdContainer](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects.graphic/odcontainer/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
初始化 [OdContainer](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects.graphic/odcontainer/) 类的新实例。
