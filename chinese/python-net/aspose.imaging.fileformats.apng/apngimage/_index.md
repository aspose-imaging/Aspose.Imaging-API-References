...
type: docs
weight: 20
url: /zh/python-net/aspose.imaging.fileformats.apng/apngimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [ApngImage(options, width, height)](#ApngImage_options_width_height_1) | 通过初始化<br/>            一个新实例，轻松开始使用 [ApngImage](/imaging/python-net/aspose.imaging.fileformats.apng/apngimage/) 类。非常适合希望在项目中快速高效地开始<br/>            使用 ApngImage 对象的开发者。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| default_frame_time | int | r/w | 轻松调整用于创建新帧的默认帧持续时间，使用<br/>            此灵活属性。非常适合在动画中高效自定义帧时间的开发者。 |
| disposed | bool | r | 获取一个值，指示此实例是否已释放。 |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | 获取或设置 Exif 实例。 |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | 使用此便捷属性快速访问文件格式信息。<br/>            非常适合需要轻松获取其 Apng 文件格式细节的开发者。 |
...
| interlaced | bool | r | 使用此便捷属性快速确定此 [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) 对象是否为隔行扫描<br/>            。非常适合需要轻松检查 PNG 图像隔行状态的开发者。 |
...
| num_plays | int | r/w | 使用此<br/>            多功能属性轻松控制动画循环的次数。非常适合希望对动画行为进行精确控制的开发者，且当值等于 0 时支持无限循环。 |
| page_count | int | r | 使用此属性轻松检索图像文件的总页数。<br/>            非常适合需要快速获取页数信息的开发者。 |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | 使用此便捷属性轻松访问图像的各页。<br/>            非常适合希望快速轻松获取单独页面进行操作的开发者。 |
...
| **Name** | **描述** |
| :- | :- |
| [add_frame()](#add_frame__1) | 使用此<br/>            简单方法轻松在帧集合末尾追加新帧。非常适合希望为多帧图像动画动态扩展帧集合的开发者。<br/>            新帧将根据当前图像的大小创建。 |
| [add_frame(frame_image)](#add_frame_frame_image_2) | 使用此直观方法在末尾添加新帧，轻松扩展帧集合。<br/>            非常适合希望动态增强多帧图像动画的开发者。<br/>            新帧的内容将从指定图像填充。 |
| [add_frame(frame_image, frame_time)](#add_frame_frame_image_frame_time_3) | 使用此直观方法无缝地在<br/>            末尾追加新帧，扩展帧集合。非常适合希望丰富多帧图像动画的开发者。<br/>            新帧的内容将从指定图像填充。 |
| [add_page(page)](#add_page_page_4) | 使用此直观方法轻松向图像添加新页。<br/>            非常适合希望动态扩展图像文件内容的开发者。 |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | 使用此直观方法轻松调整图像的 _brightness_，<br/>            使用指定的亮度参数。非常适合希望动态增强或降低图像整体亮度的开发者。 |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | 使用此直观方法提升 [Image](/imaging/python-net/aspose.imaging/image/) 的对比度，使细节更加突出。非常适合希望动态提升图像视觉清晰度和冲击力的开发者。 |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | 使用此直观方法，通过浮点系数对图像进行伽马校正。非常适合希望在图像中实现精确颜色控制的开发者。 |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | 使用此直观方法，对图像的红、绿、蓝通道分别使用单独系数进行伽马校正。非常适合希望微调色彩平衡并提升图像视觉质量的开发者。 |
...
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | 使用此<br/>            直观方法，利用预定义阈值轻松将图像二值化。非常适合希望将图像转换为二进制形式，以便进一步处理或分析的开发者。 |
| binarize_otsu() | 使用此直观方法，利用 Otsu 阈值对图像进行二值化。<br/>            非常适合希望自动确定将图像转换为二进制形式的最佳阈值，从而提升其清晰度并适合进一步分析的开发者。 |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | 使用此直观方法在调整位移的同时无缝裁剪图像。<br/>            适用于希望对裁剪过程进行精确控制的开发者<br/>            以聚焦其 Apng 图像的特定区域。 |
| [crop(rectangle)](#crop_rectangle_35) | 使用此直观方法轻松裁剪图像，以聚焦特定区域。<br/>            非常适合希望动态优化图像构图的开发者。 |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_36) | 对当前图像执行抖动处理。 |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_37) | 使用此直观方法轻松对当前图像应用抖动效果。<br/>            适用于希望为图像添加纹理或降低色带现象的开发者。 |
| [embed_digital_signature(password)](#embed_digital_signature_password_38) | 根据提供的密码将数字签名嵌入图像的每一页。 |
| [filter(rectangle, options)](#filter_rectangle_options_39) | 使用此直观方法轻松对图像的指定矩形区域应用滤镜。<br/>            非常适合希望增强或修改特定区域的开发者。 |
...
| [get_default_options(args)](#get_default_options_args_42) | 使用此简洁方法轻松获取默认选项。<br/>            适用于希望快速访问默认 Apng 图像设置的开发者。 |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_51) | 使用此用户友好方法快速获取资源图像上次修改的日期和时间。<br/>            适用于需要跟踪更改并有效管理资源的开发者。 |
| [get_original_options()](#get_original_options__52) | 使用此直观方法轻松检索基于原始文件设置的选项。<br/>            完美适用于希望访问并利用与原始文件特性相匹配的设置的开发者。<br/>            这有助于保持原始图像的位深度和其他参数不变。<br/>            例如，如果我们加载一个每像素 1 位的黑白 PNG 图像，然后使用<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/) 方法，则会生成每像素 8 位的输出 PNG 图像。<br/>            为避免这种情况并以每像素 1 位保存 PNG 图像，请使用此方法获取相应的保存选项并将其<br/>            传递给 [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) 方法作为第二个参数。 |
...
| grayscale() | 使用此直观方法轻松将图像转换为灰度表示。<br/>            适用于希望将彩色图像转换为灰度，以简化其可视化或分析过程的开发者。 |
| [insert_frame(index)](#insert_frame_index_58) | 使用此直观方法轻松在指定的<br/>            位置插入新帧到您的帧集合中。适用于希望对多帧图像动画中帧的排列进行精确控制的开发者。<br/>            将根据当前图像的尺寸创建新帧。 |
| [insert_frame(index, frame_image)](#insert_frame_index_frame_image_59) | 在指定索引处向自身帧集合插入新帧。<br/>            新帧的内容将从指定的图像中填充。 |
| [insert_frame(index, frame_image, frame_time)](#insert_frame_index_frame_image_frame_time_60) | 在指定索引处向自身帧集合插入新帧。<br/>            新帧的内容将从指定的图像中填充。 |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_79) | 归一化角度。<br/>            此方法适用于扫描的文本文档，以消除倾斜扫描。<br/>            此方法使用 [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) 和 [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) 方法。 |
| normalize_histogram() | 归一化图像直方图 — 调整像素值以使用全部可用范围。 |
| [pop_frame_at(index)](#pop_frame_at_index_80) | 使用此直观方法从您的帧集合中移除并检索指定索引的帧。<br/>            非常适合希望高效管理动画中帧的开发者。 |
...
| remove_all_frames() | 使用此直观方法通过移除所有帧来清空您的帧集合。<br/>            适用于希望重置或刷新其动画的开发者。 |
| [remove_frame_at(index)](#remove_frame_at_index_83) | 使用此方法无缝地从您的帧集合中移除指定索引的帧。<br/>            非常适合希望在多帧图像中实现简化帧管理的开发者。<br/>            被删除的帧将被释放。 |
...
| reset_default_image() | 使用此直观方法移除先前设置的默认图像。<br/>            适用于希望在动画中重置或清除默认图像的开发者。<br/>            此后，默认图像为自身帧集合中的第一帧<br/>            （无法使用此方法删除）。 |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_90) | 使用此直观方法无缝调整图像大小。非常适合希望动态调整图像尺寸的开发者。 |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_91) | 调整图像大小。 |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_95) | 使用此直观方法在保持比例的同时轻松调整图像高度。<br/>            非常适合希望在动态调整图像大小时保持宽高比的开发者。 |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_99) | 使用此直观方法轻松按比例调整图像宽度。<br/>            适用于希望在调整尺寸时保持图像宽高比的开发者。 |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_103) | 使用此直观方法轻松围绕中心旋转图像。<br/>            非常适合希望动态调整图像方向的开发者。 |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_104) | 使用此直观方法轻松通过旋转、翻转或两者共同操作活动帧。<br/>            适用于希望自定义图像帧方向的开发者。 |
...
| [set_default_image(image)](#set_default_image_image_124) | 设置在不支持 APNG 的解码器中显示的\"default image\"。<br/>            [ApngImage](/imaging/python-net/aspose.imaging.fileformats.apng/apngimage/) 类使用 [ApngImage.pages](/imaging/python-net/aspose.imaging.fileformats.apng/apngimage/) 的第一个元素作为默认（主）页面。 |
...
通过初始化<br/>            一个新实例，轻松开始使用 [ApngImage](/imaging/python-net/aspose.imaging.fileformats.apng/apngimage/) 类。非常适合希望在项目中快速高效地开始<br/>            使用 ApngImage 对象的开发者。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| options | [ApngOptions](/imaging/python-net/aspose.imaging.imageoptions/apngoptions/) | 选项。 |
| width | int | 宽度。 |
| height | int | 高度。 |
...
使用此<br/>            简单方法轻松在帧集合末尾追加新帧。非常适合希望为多帧图像动画动态扩展帧集合的开发者。<br/>            新帧将根据当前图像的大小创建。

**Returns**

| Type | Description |
| :- | :- |
| [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/) | 新创建的 APNG 帧。 |
...
使用此直观方法在末尾添加新帧，轻松扩展帧集合。<br/>            非常适合希望动态增强多帧图像动画的开发者。<br/>            新帧的内容将从指定图像填充。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| frame_image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | 帧图像。 |
...
使用此直观方法无缝地在<br/>            末尾追加新帧，扩展帧集合。非常适合希望丰富多帧图像动画的开发者。<br/>            新帧的内容将从指定图像填充。
...
使用此直观方法轻松向图像添加新页。<br/>            非常适合希望动态扩展图像文件内容的开发者。
...
使用此直观方法轻松调整图像的 _brightness_，<br/>            使用指定的亮度参数。非常适合希望动态增强或降低图像整体亮度的开发者。
...
使用此直观方法提升 [Image](/imaging/python-net/aspose.imaging/image/) 的对比度，使细节更加突出。非常适合希望动态提升图像视觉清晰度和冲击力的开发者。
...
使用此直观方法，通过浮点系数对图像进行伽马校正。非常适合希望在图像中实现精确颜色控制的开发者。
...
使用此直观方法，对图像的红、绿、蓝通道分别使用单独系数进行伽马校正。非常适合希望微调色彩平衡并提升图像视觉质量的开发者。
...
使用此<br/>            直观方法，利用预定义阈值轻松将图像二值化。非常适合希望将图像转换为二进制形式，以便进一步处理或分析的开发者。
...
使用此直观方法在调整位移的同时无缝裁剪图像。<br/>            适用于希望对裁剪过程进行精确控制的开发者<br/>            以聚焦其 Apng 图像的特定区域。
...
使用此直观方法轻松裁剪图像，以聚焦特定区域。<br/>            非常适合希望动态优化图像构图的开发者。
...
使用此直观方法轻松对当前图像应用抖动效果。<br/>            适用于希望为图像添加纹理或降低色带现象的开发者。
...
使用此直观方法轻松对图像的指定矩形区域应用滤镜。<br/>            非常适合希望增强或修改特定区域的开发者。
...
使用此简洁方法轻松获取默认选项。<br/>            适用于希望快速访问默认 Apng 图像设置的开发者。
...
使用此用户友好方法快速获取资源图像上次修改的日期和时间。<br/>            适用于需要跟踪更改并有效管理资源的开发者。
...
使用此直观方法轻松检索基于原始文件设置的选项。<br/>            完美适用于希望访问并利用与原始文件特性相匹配的设置的开发者。<br/>            这有助于保持原始图像的位深度和其他参数不变。<br/>            例如，如果我们加载一个每像素 1 位的黑白 PNG 图像，然后使用<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/) 方法，则会生成每像素 8 位的输出 PNG 图像。<br/>            为避免这种情况并以每像素 1 位保存 PNG 图像，请使用此方法获取相应的保存选项并将其<br/>            传递给 [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) 方法作为第二个参数。
...
使用此直观方法轻松在指定的<br/>            位置插入新帧到您的帧集合中。适用于希望对多帧图像动画中帧的排列进行精确控制的开发者。<br/>            将根据当前图像的尺寸创建新帧。
...
在指定索引处向自身帧集合插入新帧。<br/>            新帧的内容将从指定的图像中填充。
...
使用此直观方法从您的帧集合中移除并检索指定索引的帧。<br/>            非常适合希望高效管理动画中帧的开发者。
...
| Type | Description |
| :- | :- |
| [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/) | 已删除的 APNG 帧。 |
...
使用此方法无缝地从您的帧集合中移除指定索引的帧。<br/>            非常适合希望在多帧图像中实现简化帧管理的开发者。<br/>            被删除的帧将被释放。
...
使用此直观方法无缝调整图像大小。非常适合希望动态调整图像尺寸的开发者。
...
使用此直观方法在保持比例的同时轻松调整图像高度。<br/>            非常适合希望在动态调整图像大小时保持宽高比的开发者。
...
使用此直观方法轻松按比例调整图像宽度。<br/>            适用于希望在调整尺寸时保持图像宽高比的开发者。
...
使用此直观方法轻松围绕中心旋转图像。<br/>            非常适合希望动态调整图像方向的开发者。
...
使用此直观方法轻松通过旋转、翻转或两者共同操作活动帧。<br/>            适用于希望自定义图像帧方向的开发者。
...
设置在不支持 APNG 的解码器中显示的\"default image\"。<br/>            [ApngImage](/imaging/python-net/aspose.imaging.fileformats.apng/apngimage/) 类使用 [ApngImage.pages](/imaging/python-net/aspose.imaging.fileformats.apng/apngimage/) 的第一个元素作为默认（主）页面。
