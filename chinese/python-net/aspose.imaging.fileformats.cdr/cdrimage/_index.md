...
type: docs
weight: 190
url: /zh/python-net/aspose.imaging.fileformats.cdr/cdrimage/
---
...
| **Name** | **描述** |
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_1) | 通过以下方式轻松开始使用 [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) 类：<br/>            使用流和 loadOptions 参数初始化新实例。<br/>            适用于希望以便捷方式从各种数据源加载 CDR 图像并根据需要自定义加载过程的开发者。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| bits_per_pixel | int | r | 使用此用户友好的属性轻松获取图像的位深度。<br/>            适用于希望确定图像中细节级别或颜色深度的开发者，以确保准确的处理和操作。 |
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | 使用此直观属性轻松检索或更新 CDR 文档。<br/>            适用于希望访问或修改 CDR 文档的开发者，确保其应用程序的灵活性和效率。 |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | 使用此用户友好的属性轻松获取图像的默认页。<br/>            非常适合希望快速访问图像主页的开发者，确保高效的导航和管理。 |
| disposed | bool | r | 获取一个值，指示此实例是否已释放。 |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | 获取或设置 Exif 实例。 |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | 使用此直观属性轻松获取图像的文件格式。<br/>            适用于希望动态确定图像格式的开发者，确保其应用的兼容性和准确处理。 |
...
| is_cached | bool | r | 轻松确定对象的数据是否已缓存，<br/>            从而消除读取数据的需求。适用于希望通过高效利用缓存数据来优化性能的开发者，确保更快访问对象信息。 |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | 获取图像元数据。 |
| page_count | int | r | 使用此直观属性轻松检索或更新图像的总页数。<br/>            适用于希望动态管理多页图像的开发者，确保对图像内容的高效导航和操作。 |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | 使用此直观属性无缝检索图像的各页。<br/>            适用于希望访问和操作多页图像中各个页面的开发者，确保高效的导航和处理。 |
...
| **Name** | **描述** |
| :- | :- |
| cache_data() | 使用此用户友好的方法轻松缓存数据，以防止从底层来源额外加载。<br/>            适用于希望通过预加载数据来优化性能的开发者，确保其应用程序更快的访问和更流畅的运行。<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/)。 |
...
通过以下方式轻松开始使用 [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) 类：<br/>            使用流和 loadOptions 参数初始化新实例。<br/>            适用于希望以便捷方式从各种数据源加载 CDR 图像并根据需要自定义加载过程的开发者。
...
使用此直观属性无缝检索图像的各页。<br/>            适用于希望访问和操作多页图像中各个页面的开发者，确保高效的导航和处理。
