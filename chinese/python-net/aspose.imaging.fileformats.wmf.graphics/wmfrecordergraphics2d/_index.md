---
title: "WmfRecorderGraphics2D 类"
type: docs
weight: 10
url: /zh/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **描述** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | 初始化 [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) 类的新实例。 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | 获取或设置背景颜色。 |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | 获取或设置背景模式。 |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | 获取现有 Wmf 图像的 Wmf 记录器实例。 |
...
初始化 [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) 类的新实例。

**Parameters:**

| 参数 | Type | Description |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | 用于显示元文件的目标矩形（以 twips 为单位）。 |
| 英寸 | int | 每英寸的像素数。 |
...
| Type | Description |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | 结果图像。 |
...
| 参数 | Type | Description |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | 用于获取记录器的 Wmf 图像。 |

**Returns**

| Type | Description |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | 一个 [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) 类的实例。 |
