...
type: docs
weight: 50
url: /zh/python-net/aspose.imaging.fileformats.cdr.objects/cdrcurve/
---
...
| **Name** | **描述** |
| :- | :- |
| [CdrCurve()](#CdrCurve__1) | 初始化 CdrCurve 类的一个新实例 |
## **Properties**
| **Name** | **Type** | **Access** | **描述** |
| :- | :- | :- | :- |
...
| point_types | System.Byte | r/w | 获取或设置点类型。 |
| points | [PointD[]](/imaging/python-net/aspose.imaging.fileformats.cdr.types/pointd/) | r/w | 获取或设置点。 |
| width | float | r/w | 获取或设置 x。 |


### Constructor: CdrCurve() {#CdrCurve__1}
