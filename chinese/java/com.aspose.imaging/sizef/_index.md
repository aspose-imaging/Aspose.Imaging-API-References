...
| 方法 | 描述 |
| --- | --- |
| [getEmpty()](#getEmpty--) | 获取一个 `Aspose.Imaging.SizeF` 结构的新实例，其 `Aspose.Imaging.SizeF.Width` 和 `Aspose.Imaging.SizeF.Height` 值均为零。 |
...
| [toSize()](#toSize--) | 将 `Aspose.Imaging.SizeF` 转换为 `Aspose.Imaging.Size` 结构，截断尺寸值。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| width | float | 新 `Aspose.Imaging.SizeF` 的宽度分量。 |
| height | float | 新 `Aspose.Imaging.SizeF` 的高度分量。 |
...
获取一个 `Aspose.Imaging.SizeF` 结构的新实例，其 `Aspose.Imaging.SizeF.Width` 和 `Aspose.Imaging.SizeF.Height` 值均为零。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.imaging/sizef) | 要添加的第一个 `Aspose.Imaging.SizeF`。 |
| size2 | [SizeF](../../com.aspose.imaging/sizef) | 要添加的第二个 `Aspose.Imaging.SizeF`。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 在减法运算符左侧。 |
| size2 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 在减法运算符右侧。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 结构在等号运算符左侧。 |
| size2 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 结构在等号运算符右侧。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 结构在不等号运算符左侧。 |
| size2 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 结构在不等号运算符右侧。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| size1 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 结构在减法运算符左侧。 |
| size2 | [SizeF](../../com.aspose.imaging/sizef) | `Aspose.Imaging.SizeF` 结构在减法运算符右侧。 |
...
将 `Aspose.Imaging.SizeF` 转换为 `Aspose.Imaging.Size` 结构，截断尺寸值。
...
**Returns:**
boolean - 如果 `obj` 是 `Aspose.Imaging.SizeF` 并且其宽度和高度与此 `Aspose.Imaging.SizeF` 相同，则此方法返回 true；否则返回 false。
### hashCode() {#hashCode--}
```
public int hashCode()
```
