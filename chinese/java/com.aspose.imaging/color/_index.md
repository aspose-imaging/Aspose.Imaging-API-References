...
type: docs
weight: 20
url: /zh/java/com.aspose.imaging/color/
---
**Inheritance:**
...
| [getB()](#getB--) | 获取此 `com.aspose.imaging.Color` 结构的蓝色分量值。 |
| [getA()](#getA--) | 获取此 `com.aspose.imaging.Color` 结构的 alpha 分量值。 |
| [isKnownColor()](#isKnownColor--) | 获取一个值，指示此 `com.aspose.imaging.Color` 结构是否为预定义颜色。 |
| [isEmpty()](#isEmpty--) | 获取一个值，指示此 `com.aspose.imaging.Color` 结构是否未初始化。 |
| [isNamedColor()](#isNamedColor--) | 获取一个值，指示此 `com.aspose.imaging.Color` 结构是命名颜色还是 `Aspose.Imaging.KnownColor` 枚举的成员。 |
| [getName()](#getName--) | 获取此 `com.aspose.imaging.Color` 的名称。 |
| [getBrightness()](#getBrightness--) | 获取此 `com.aspose.imaging.Color` 结构的色相-饱和度-亮度 (HSB) 亮度值。 |
| [getHue()](#getHue--) | 获取此 `com.aspose.imaging.Color` 结构的色相-饱和度-亮度 (HSB) 色相值（以度为单位）。 |
| [getSaturation()](#getSaturation--) | 获取此 `com.aspose.imaging.Color` 结构的色相-饱和度-亮度 (HSB) 饱和度值。 |
| [toArgb()](#toArgb--) | 获取此 `com.aspose.imaging.Color` 结构的 32 位 ARGB 值。 |
| [toKnownColor()](#toKnownColor--) | 获取此 `com.aspose.imaging.Color` 结构的 `Aspose.Imaging.KnownColor` 值。 |
| [toString()](#toString--) | 将此 `com.aspose.imaging.Color` 结构转换为可读的字符串。 |
| [equals(Object obj)](#equals-java.lang.Object-) | 测试指定的对象是否为 `com.aspose.imaging.Color` 结构且等价于此 `com.aspose.imaging.Color` 结构。 |
| [hashCode()](#hashCode--) | 返回此 `com.aspose.imaging.Color` 结构的哈希码。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| left | [Color](../../com.aspose.imaging/color) | 等号运算符左侧的 `com.aspose.imaging.Color`。 |
| right | [Color](../../com.aspose.imaging/color) | 等号运算符右侧的 `com.aspose.imaging.Color`。 |
...
| baseColor | [Color](../../com.aspose.imaging/color) | 用于创建新 `com.aspose.imaging.Color` 的 `com.aspose.imaging.Color`。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pixels | [Color\[\]](../../com.aspose.imaging/color) | RGB 格式的 Color 类型像素。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| pixel | [Color](../../com.aspose.imaging/color) | RGB 格式的 Color 类型像素。 |
