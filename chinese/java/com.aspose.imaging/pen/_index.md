...
| [setWidth(float value)](#setWidth-float-) | 设置此 `Pen` 的宽度，单位为用于绘图的 Graphics 对象的单位。 |
| [getStartCap()](#getStartCap--) | 获取使用此 `Pen` 绘制的线条起始端使用的帽子样式。 |
| [setStartCap(int value)](#setStartCap-int-) | 设置使用此 `Pen` 绘制的线条起始端使用的帽子样式。 |
| [getEndCap()](#getEndCap--) | 获取使用此 `Pen` 绘制的线条结束端使用的帽子样式。 |
| [setEndCap(int value)](#setEndCap-int-) | 设置使用此 `Pen` 绘制的线条结束端使用的帽子样式。 |
| [getDashCap()](#getDashCap--) | 获取使用此 `Pen` 绘制的虚线中破折号结束端使用的帽子样式。 |
| [setDashCap(int value)](#setDashCap-int-) | 设置使用此 `Pen` 绘制的虚线中破折号结束端使用的帽子样式。 |
| [getLineJoin()](#getLineJoin--) | 获取使用此 `Pen` 绘制的两条连续线段端点的连接样式。 |
| [setLineJoin(int value)](#setLineJoin-int-) | 设置使用此 `Pen` 绘制的两条连续线段端点的连接样式。 |
| [getCustomStartCap()](#getCustomStartCap--) | 获取用于此 `Pen` 绘制的线条起始端的自定义帽子。 |
| [setCustomStartCap(CustomLineCap value)](#setCustomStartCap-com.aspose.imaging.CustomLineCap-) | 设置用于此 `Pen` 绘制的线条起始端的自定义帽子。 |
| [getCustomEndCap()](#getCustomEndCap--) | 获取用于此 `Pen` 绘制的线条结束端的自定义帽子。 |
| [setCustomEndCap(CustomLineCap value)](#setCustomEndCap-com.aspose.imaging.CustomLineCap-) | 设置用于此 `Pen` 绘制的线条结束端的自定义帽子。 |
| [getMiterLimit()](#getMiterLimit--) | 获取斜接角处连接的厚度限制。 |
| [setMiterLimit(float value)](#setMiterLimit-float-) | 设置斜接拐角处接合厚度的上限。 |
...
| [getDashOffset()](#getDashOffset--) | 获取从线条起点到虚线模式起始的距离。 |
| [setDashOffset(float value)](#setDashOffset-float-) | 设置从线条起点到虚线模式起始的距离。 |
| [getDashPattern()](#getDashPattern--) | 获取自定义虚线和间隔的数组。 |
| [setDashPattern(float[] value)](#setDashPattern-float---) | 设置自定义虚线和间隔的数组。 |
| [getCompoundArray()](#getCompoundArray--) | 获取指定复合笔的值数组。 |
| [setCompoundArray(float[] value)](#setCompoundArray-float---) | 设置指定复合笔的值数组。 |
| [setLineCap(int startCap, int endCap, int dashCap)](#setLineCap-int-int-int-) | 设置决定此 `Pen` 绘制的线条结束端帽样式的值。 |
...
| [multiplyTransform(Matrix matrix, int order)](#multiplyTransform-com.aspose.imaging.Matrix-int-) | 按指定顺序将此 `Pen` 的变换矩阵乘以指定的 `Matrix`。 |
| [translateTransform(float dx, float dy)](#translateTransform-float-float-) | 按指定的尺寸平移本地几何变换。 |
| [translateTransform(float dx, float dy, int order)](#translateTransform-float-float-int-) | 按指定顺序按指定的尺寸平移本地几何变换。 |
| [scaleTransform(float sx, float sy)](#scaleTransform-float-float-) | 按指定的因子缩放本地几何变换。 |
| [scaleTransform(float sx, float sy, int order)](#scaleTransform-float-float-int-) | 按指定顺序使用指定因子缩放局部几何变换。 |
| [rotateTransform(float angle)](#rotateTransform-float-) | 按指定角度旋转局部几何变换。 |
| [rotateTransform(float angle, int order)](#rotateTransform-float-int-) | 按指定顺序使用指定角度旋转局部几何变换。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| color | [Color](../../com.aspose.imaging/color) | 一个表示此 `Pen` 颜色的 `Color` 结构。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| brush | [Brush](../../com.aspose.imaging/brush) | 一个决定此 `Pen` 填充属性的 `Brush`。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| brush | [Brush](../../com.aspose.imaging/brush) | 一个决定此 `Pen` 特性的 `Brush`。 |
| 宽度 | float | 新 `Pen` 的宽度。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [CustomLineCap](../../com.aspose.imaging/customlinecap) | 一个 `CustomLineCap`，表示使用此 `Pen` 绘制的线段起始端的帽形。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [CustomLineCap](../../com.aspose.imaging/customlinecap) | 一个 `CustomLineCap`，表示使用此 `Pen` 绘制的线段结束端的帽形。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [Matrix](../../com.aspose.imaging/matrix) | 一个 `Matrix` 的副本，表示此 `Pen` 的几何变换。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [Color](../../com.aspose.imaging/color) | 一个 `Color` 结构，表示此 `Pen` 的颜色。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [Brush](../../com.aspose.imaging/brush) | 一个 `Brush`，决定此 `Pen` 的属性。 |
...
**Returns:**
float[] - 一个实数数组，指定虚线中交替的短划线和空格的长度。
...
**Returns:**
float[] - 一个实数数组，指定复合数组。数组中的元素必须递增，且不小于 0，且不大于 1。
