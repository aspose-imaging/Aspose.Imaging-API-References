...
type: docs
weight: 75
url: /zh/java/com.aspose.imaging/nongenericdictionary/
---
**Inheritance:**
...
| 方法 | 描述 |
| --- | --- |
| [getValuesTyped()](#getValuesTyped--) | 获取强类型值集合。 |
| [getKeysTyped()](#getKeysTyped--) | 获取强类型键集合。 |
### NonGenericDictionary() {#NonGenericDictionary--}
```
...
**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<V> - 强类型值集合。
...
**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericCollection<K> - 强类型键集合。
