...
description: "光栅图像 64 位 ARGB 像素加载器。"
type: docs
weight: 146
url: /zh/java/com.aspose.imaging/irasterimageargb64pixelloader/
---
...
光栅图像 64 位 ARGB 像素加载器。
## 方法

| 方法 | 描述 |
| --- | --- |
| [loadPartialArgb64Pixels(Rectangle rectangle, IPartialArgb64PixelLoader partialPixelLoader)](#loadPartialArgb64Pixels-com.aspose.imaging.Rectangle-com.aspose.imaging.IPartialArgb64PixelLoader-) | 部分加载 64 位 ARGB 像素（按块）。 |
...
| partialPixelLoader | [IPartialArgb64PixelLoader](../../com.aspose.imaging/ipartialargb64pixelloader) | 部分像素加载器。 |
