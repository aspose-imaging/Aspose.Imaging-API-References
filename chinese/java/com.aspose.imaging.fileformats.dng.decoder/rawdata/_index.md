...
type: docs
weight: 12
url: /zh/java/com.aspose.imaging.fileformats.dng.decoder/rawdata/
---
**Inheritance:**
java.lang.Object
```
...
| 构造函数 | 描述 |
| --- | --- |
| [RawData()](#RawData--) | 初始化 `RawData` 类的新实例。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [getImageDataParameters()](#getImageDataParameters--) | 获取或设置图像数据参数。 |
| [setImageDataParameters(ImageParameters value)](#setImageDataParameters-com.aspose.imaging.fileformats.dng.decoder.ImageParameters-) | 获取或设置图像数据参数。 |
| [getImageOtherParameters()](#getImageOtherParameters--) | 获取或设置其他图像参数。 |
| [setImageOtherParameters(ImageOtherParameters value)](#setImageOtherParameters-com.aspose.imaging.fileformats.dng.decoder.ImageOtherParameters-) | 获取或设置其他图像参数。 |
### RawData() {#RawData--}
```
public RawData()
```
