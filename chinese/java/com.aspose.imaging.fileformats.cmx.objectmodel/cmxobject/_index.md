...
type: docs
weight: 14
url: /zh/java/com.aspose.imaging.fileformats.cmx.objectmodel/cmxobject/
---
**Inheritance:**
java.lang.Object
...
| 方法 | 描述 |
| --- | --- |
| [getFillStyle()](#getFillStyle--) | 获取填充样式。 |
| [setFillStyle(CmxFillStyle value)](#setFillStyle-com.aspose.imaging.fileformats.cmx.objectmodel.styles.CmxFillStyle-) | 设置填充样式。 |
| [getOutline()](#getOutline--) | 获取轮廓样式。 |
| [setOutline(CmxOutline value)](#setOutline-com.aspose.imaging.fileformats.cmx.objectmodel.styles.CmxOutline-) | 设置轮廓样式。 |
| [getObjectSpec()](#getObjectSpec--) | 获取对象规范。 |
| [setObjectSpec(ICmxObjectSpec value)](#setObjectSpec-com.aspose.imaging.fileformats.cmx.objectmodel.specs.ICmxObjectSpec-) | 设置对象规范。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [CmxFillStyle](../../com.aspose.imaging.fileformats.cmx.objectmodel.styles/cmxfillstyle) | 填充样式。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [CmxOutline](../../com.aspose.imaging.fileformats.cmx.objectmodel.styles/cmxoutline) | 轮廓样式。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [ICmxObjectSpec](../../com.aspose.imaging.fileformats.cmx.objectmodel.specs/icmxobjectspec) | 对象规范。 |
