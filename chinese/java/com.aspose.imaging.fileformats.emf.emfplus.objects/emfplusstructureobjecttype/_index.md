...
description: "结构对象指定嵌入 EMF 元文件记录中的数据结构的容器。结构对象不同于图形对象，它们不会被显式创建，而是构成更复杂结构的组件。"
type: docs
weight: 76
url: /zh/java/com.aspose.imaging.fileformats.emf.emfplus.objects/emfplusstructureobjecttype/
---
**Inheritance:**
...
结构对象指定嵌入 EMF+ 元文件记录中的数据结构容器。结构对象不同于图形对象，不会被显式创建；它们是构成更复杂结构的组件
## 构造函数
