...
| [getExpandEdge()](#getExpandEdge--) | 获取或设置一个 32 位布尔值，指定位图是否按等于 BlurRadius 值的量扩展，以产生柔和的边缘。 |
| [setExpandEdge(boolean value)](#setExpandEdge-boolean-) | 获取或设置一个 32 位布尔值，指定位图是否按等于 BlurRadius 值的量扩展，以产生柔和的边缘。 |
### EmfPlusBlurEffect() {#EmfPlusBlurEffect--}
```
