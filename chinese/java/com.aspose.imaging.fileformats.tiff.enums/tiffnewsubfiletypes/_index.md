...
type: docs
weight: 18
url: /zh/java/com.aspose.imaging.fileformats.tiff.enums/tiffnewsubfiletypes/
---
**Inheritance:**
...
| 字段 | 描述 |
| --- | --- |
| [FileTypeDefault](#FileTypeDefault) | 默认文件类型。 |
| [FileTypeReducedImage](#FileTypeReducedImage) | 缩小图像文件类型。 |
| [FileTypePage](#FileTypePage) | 页面文件类型。 |
| [FileTypeMask](#FileTypeMask) | 掩码文件类型。 |
| [FileTypeLast](#FileTypeLast) | 最后的文件类型。 |
