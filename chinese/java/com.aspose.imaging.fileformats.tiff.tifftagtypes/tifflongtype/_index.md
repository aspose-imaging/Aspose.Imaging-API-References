...
type: docs
weight: 18
url: /zh/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [TiffLongType(int tagId)](#TiffLongType-int-) | 初始化 `TiffLongType` 类的新实例。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [getValues()](#getValues--) | 获取或设置值。 |
| [setValues(long[] value)](#setValues-long---) | 获取或设置值。 |
