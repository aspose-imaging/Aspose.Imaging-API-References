...
description: "该 tiff 有符号短整型。"
type: docs
weight: 24
url: /zh/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [TiffSShortType(int tagId)](#TiffSShortType-int-) | 初始化 `TiffSShortType` 类的新实例。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [getValues()](#getValues--) | 获取或设置值。 |
| [setValues(short[] value)](#setValues-short---) | 获取或设置值。 |
