...
type: docs
weight: 19
url: /zh/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [TiffRationalType(int tagId)](#TiffRationalType-int-) | 初始化 `TiffRationalType` 类的新实例。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [getValues()](#getValues--) | 获取或设置值。 |
| [setValues(TiffRational[] value)](#setValues-com.aspose.imaging.fileformats.tiff.TiffRational---) | 获取或设置值。 |
