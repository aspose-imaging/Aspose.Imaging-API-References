...
type: docs
weight: 14
url: /zh/java/com.aspose.imaging.coreexceptions.imageformats/gifimageexception/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [GifImageException(String message)](#GifImageException-java.lang.String-) | 初始化 `GifImageException` 类的新实例。 |
| [GifImageException(String message, Throwable innerException)](#GifImageException-java.lang.String-java.lang.Throwable-) | 初始化 `GifImageException` 类的新实例。 |
