...
type: docs
weight: 19
url: /zh/java/com.aspose.imaging.coreexceptions.imageformats/psdimageexception/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PsdImageException(String message)](#PsdImageException-java.lang.String-) | 初始化 `PsdImageException` 类的新实例。 |
| [PsdImageException(String message, Throwable innerException)](#PsdImageException-java.lang.String-java.lang.Throwable-) | 初始化 `PsdImageException` 类的新实例。 |
