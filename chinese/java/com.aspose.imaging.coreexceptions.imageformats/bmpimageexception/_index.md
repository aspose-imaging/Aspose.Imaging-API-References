...
type: docs
weight: 10
url: /zh/java/com.aspose.imaging.coreexceptions.imageformats/bmpimageexception/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [BmpImageException(String message)](#BmpImageException-java.lang.String-) | 初始化 `BmpImageException` 类的新实例。 |
| [BmpImageException(String message, Throwable innerException)](#BmpImageException-java.lang.String-java.lang.Throwable-) | 初始化 `BmpImageException` 类的新实例。 |
