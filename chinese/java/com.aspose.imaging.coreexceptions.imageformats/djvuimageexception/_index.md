...
type: docs
weight: 12
url: /zh/java/com.aspose.imaging.coreexceptions.imageformats/djvuimageexception/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [DjvuImageException(String message)](#DjvuImageException-java.lang.String-) | 初始化 `DjvuImageException` 类的新实例。 |
| [DjvuImageException(String message, Throwable innerException)](#DjvuImageException-java.lang.String-java.lang.Throwable-) | 初始化 `DjvuImageException` 类的新实例。 |
