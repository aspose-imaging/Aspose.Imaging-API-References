...
type: docs
weight: 20
url: /zh/java/com.aspose.imaging.coreexceptions.imageformats/svgimageexception/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [SvgImageException(String message)](#SvgImageException-java.lang.String-) | 初始化 `SvgImageException` 类的新实例。 |
| [SvgImageException(String message, Throwable innerException)](#SvgImageException-java.lang.String-java.lang.Throwable-) | 初始化 `SvgImageException` 类的新实例。 |
