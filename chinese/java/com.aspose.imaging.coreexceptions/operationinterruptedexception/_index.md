...
description: "当操作被中断时发生。"
type: docs
weight: 23
url: /zh/java/com.aspose.imaging.coreexceptions/operationinterruptedexception/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [OperationInterruptedException(String message)](#OperationInterruptedException-java.lang.String-) | 初始化 `OperationInterruptedException` 类的新实例。 |
| [OperationInterruptedException(String message, Throwable innerException)](#OperationInterruptedException-java.lang.String-java.lang.Throwable-) | 初始化 `OperationInterruptedException` 类的新实例。 |
...
### OperationInterruptedException(String message, Throwable innerException) {#OperationInterruptedException-java.lang.String-java.lang.Throwable-}
```
