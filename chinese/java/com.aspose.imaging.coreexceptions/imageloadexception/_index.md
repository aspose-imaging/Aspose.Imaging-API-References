...
type: docs
weight: 16
url: /zh/java/com.aspose.imaging.coreexceptions/imageloadexception/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [ImageLoadException(String message)](#ImageLoadException-java.lang.String-) | 初始化一个新的 `ImageLoadException` 类的实例。 |
| [ImageLoadException(String message, Throwable innerException)](#ImageLoadException-java.lang.String-java.lang.Throwable-) | 初始化一个新的 `ImageLoadException` 类的实例。 |
...
初始化一个新的 `ImageLoadException` 类的实例。
...
### ImageLoadException(String message, Throwable innerException) {#ImageLoadException-java.lang.String-java.lang.Throwable-}
```
