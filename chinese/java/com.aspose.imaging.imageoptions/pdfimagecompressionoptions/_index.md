...
| [None](#None) | 保存原始图像字节，导致 PDF 文件体积增大。 |
| [Rle](#Rle) | 行程长度压缩。 |
...
预测器选择被限制为 PNG Paeth 预测器，以加快处理速度。实际表现出乎意料地好。优于 [LzwOptimizedPredictor](../../com.aspose.imaging.imageoptions/pdfimagecompressionoptions\#LzwOptimizedPredictor)。
...
预测器选择更为复杂，应该能产生更小的图像尺寸，但需要更多时间。RFC 2083 表示这是最佳方案。但在测试数据中，基线预测器 [LzwBaselinePredictor](../../com.aspose.imaging.imageoptions/pdfimagecompressionoptions\#LzwBaselinePredictor) 表现出色，使优化预测器的压缩率提升落后了 25-40%。
