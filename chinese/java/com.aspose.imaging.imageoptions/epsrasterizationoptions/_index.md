...
type: docs
weight: 21
url: /zh/java/com.aspose.imaging.imageoptions/epsrasterizationoptions/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [EpsRasterizationOptions()](#EpsRasterizationOptions--) | 初始化该类的新实例。 |
...
| 方法 | 描述 |
| --- | --- |
| [getPreviewToExport()](#getPreviewToExport--) | 使用 [EpsImage.getPreviewImage(long)](../../com.aspose.imaging.fileformats.eps/epsimage\#getPreviewImage-long-) 进行预览导出。 |
| [setPreviewToExport(long value)](#setPreviewToExport-long-) | 使用 [EpsImage.getPreviewImage(long)](../../com.aspose.imaging.fileformats.eps/epsimage\#getPreviewImage-long-) 进行预览导出。 |
...
使用 [EpsImage.getPreviewImage(long)](../../com.aspose.imaging.fileformats.eps/epsimage\#getPreviewImage-long-) 进行预览导出。
