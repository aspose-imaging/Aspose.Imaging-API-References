...
description: "使用我们的 API 创建现代 WebP 栅格网络图像，提供对无损和有损压缩、以及 Alpha 通道和动画循环的强大支持。"
type: docs
weight: 53
...
使用我们的 API 创建现代 WebP 栅格网络图像，提供对无损和有损压缩、以及 Alpha 通道和动画循环的强大支持。通过动态视觉效果提升您的网页内容，同时优化文件大小以改善加载速度和用户体验。
## 构造函数
