...
type: docs
weight: 13
url: /zh/java/com.aspose.imaging.fileformats.cmx.objectmodel.styles/cmximagefill/
---
**Inheritance:**
java.lang.Object
```
...
| [getProcedure()](#getProcedure--) | 获取过程。 |
| [setProcedure(CmxProcedure value)](#setProcedure-com.aspose.imaging.fileformats.cmx.objectmodel.CmxProcedure-) | 设置过程。 |
| [getTileOffsetX()](#getTileOffsetX--) | 获取瓦片偏移 X。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [CmxProcedure](../../com.aspose.imaging.fileformats.cmx.objectmodel/cmxprocedure) | 过程。 |
