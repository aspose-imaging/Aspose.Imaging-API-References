...
type: docs
weight: 94
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.records/emfpolypolyline/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [EmfPolyPolyline(EmfRecord source)](#EmfPolyPolyline-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | 初始化 `EmfPolyPolyline` 类的新实例。 |
| [EmfPolyPolyline()](#EmfPolyPolyline--) | 初始化 `EmfPolyPolyline` 类的新实例。 |
