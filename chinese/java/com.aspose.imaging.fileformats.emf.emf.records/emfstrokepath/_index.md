...
type: docs
weight: 152
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.records/emfstrokepath/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [EmfStrokePath(EmfRecord record)](#EmfStrokePath-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | 初始化 `EmfStrokePath` 类的新实例。 |
| [EmfStrokePath()](#EmfStrokePath--) | 初始化 `EmfStrokePath` 类的新实例。 |
## 方法
