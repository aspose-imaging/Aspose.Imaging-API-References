...
type: docs
weight: 102
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.records/emfpolyline16/
---
**Inheritance:**
...
EMR\_POLYLINE16 记录通过连接指定数组中的点来指定一系列线段。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EmfPolyline16(EmfRecord source)](#EmfPolyline16-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | 初始化 `EmfPolyline16` 类的新实例。 |
| [EmfPolyline16()](#EmfPolyline16--) | 初始化 `EmfPolyline16` 类的新实例。 |
