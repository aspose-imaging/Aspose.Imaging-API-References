...
type: docs
weight: 133
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.records/emfsetmiterlimit/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [EmfSetMiterLimit(EmfRecord source)](#EmfSetMiterLimit-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | 初始化 `EmfSetMiterLimit` 类的新实例。 |
| [EmfSetMiterLimit()](#EmfSetMiterLimit--) | 初始化 `EmfSetMiterLimit` 类的新实例。 |
## 方法
