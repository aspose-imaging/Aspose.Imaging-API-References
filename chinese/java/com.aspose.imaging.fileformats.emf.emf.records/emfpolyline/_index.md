...
description: "EMR_POLYLINE 记录通过连接指定数组中的点来指定一系列线段。"
type: docs
weight: 101
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.records/emfpolyline/
---
**Inheritance:**
...
EMR\_POLYLINE 记录通过连接指定数组中的点来指定一系列线段。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EmfPolyline(EmfRecord source)](#EmfPolyline-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | 初始化 `EmfPolyline` 类的新实例。 |
| [EmfPolyline()](#EmfPolyline--) | 初始化 `EmfPolyline` 类的新实例。 |
