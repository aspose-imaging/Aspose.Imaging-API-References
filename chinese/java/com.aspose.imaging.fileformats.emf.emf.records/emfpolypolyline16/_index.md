...
description: "EMR_POLYPOLYLINE16 记录指定多个相连线段的系列。"
type: docs
weight: 95
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.records/emfpolypolyline16/
---
**Inheritance:**
...
EMR\_POLYPOLYLINE16 记录指定多个相连线段的系列。
...
| 构造函数 | 描述 |
| --- | --- |
| [EmfPolyPolyline16(EmfRecord source)](#EmfPolyPolyline16-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | 初始化 `EmfPolyPolyline16` 类的新实例。 |
| [EmfPolyPolyline16()](#EmfPolyPolyline16--) | 初始化 `EmfPolyPolyline16` 类的新实例。 |
