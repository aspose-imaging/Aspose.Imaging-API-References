...
type: docs
weight: 72
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [EmfMetafileHeaderExtension2(EmfMetafileHeaderExtension1 header)](#EmfMetafileHeaderExtension2-com.aspose.imaging.fileformats.emf.emf.records.EmfMetafileHeaderExtension1-) | 初始化 `EmfMetafileHeaderExtension2` 类的新实例。 |
| [EmfMetafileHeaderExtension2(EmfMetafileHeaderExtension2 header)](#EmfMetafileHeaderExtension2-com.aspose.imaging.fileformats.emf.emf.records.EmfMetafileHeaderExtension2-) | 初始化 `EmfMetafileHeaderExtension2` 类的新实例。 |
## 方法
...
初始化 `EmfMetafileHeaderExtension2` 类的新实例。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| header | [EmfMetafileHeaderExtension2](../../com.aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2) | 头部。 |
