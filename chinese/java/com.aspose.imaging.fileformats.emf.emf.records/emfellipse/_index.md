...
EMR\_ELLIPSE 记录指定一个椭圆。椭圆的中心是指定的边界矩形的中心。椭圆使用当前笔描边并使用当前画刷填充。
## 构造函数
...
| 方法 | 描述 |
| --- | --- |
| [getBox()](#getBox--) | 获取或设置一个 128 位 (WMF) RectL 对象，该对象在 [MS-WMF] 第 2.2.2.19 节中指定，用于指定包含-包含的边界矩形。 |
| [setBox(Rectangle value)](#setBox-com.aspose.imaging.Rectangle-) | 获取或设置一个 128 位 (WMF) RectL 对象，该对象在 [MS-WMF] 第 2.2.2.19 节中指定，用于指定包含-包含的边界矩形。 |
...
获取或设置一个 128 位 (WMF) RectL 对象，该对象在 [MS-WMF] 第 2.2.2.19 节中指定，用于指定包含-包含的边界矩形。
