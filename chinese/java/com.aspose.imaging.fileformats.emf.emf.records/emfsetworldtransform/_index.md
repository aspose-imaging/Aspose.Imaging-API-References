...
| 构造函数 | 描述 |
| --- | --- |
| [EmfSetWorldTransform(EmfRecord source)](#EmfSetWorldTransform-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | 初始化 `EmfSetWorldTransform` 类的新实例。 |
| [EmfSetWorldTransform()](#EmfSetWorldTransform--) | 初始化 `EmfSetWorldTransform` 类的新实例。 |
...
初始化 `EmfSetWorldTransform` 类的新实例。
