...
type: docs
weight: 24
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [EmfLogFontExDv(EmfLogFontEx emfLogFontEx)](#EmfLogFontExDv-com.aspose.imaging.fileformats.emf.emf.objects.EmfLogFontEx-) | 初始化 `EmfLogFontExDv` 类的新实例。 |
## 方法
