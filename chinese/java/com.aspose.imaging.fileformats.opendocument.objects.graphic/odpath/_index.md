...
type: docs
weight: 35
url: /zh/java/com.aspose.imaging.fileformats.opendocument.objects.graphic/odpath/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [OdPath(OdObject parent)](#OdPath-com.aspose.imaging.fileformats.opendocument.OdObject-) | 初始化 `OdPath` 类的新实例。 |
## 方法
...
| [getTextStyleName()](#getTextStyleName--) | 获取或设置文本样式的名称。 |
| [setTextStyleName(String value)](#setTextStyleName-java.lang.String-) | 获取或设置文本样式的名称。 |
| [getLayer()](#getLayer--) | 获取或设置图层。 |
| [setLayer(String value)](#setLayer-java.lang.String-) | 获取或设置图层。 |
| [getData()](#getData--) | 获取或设置数据。 |
| [setData(String value)](#setData-java.lang.String-) | 获取或设置数据。 |
