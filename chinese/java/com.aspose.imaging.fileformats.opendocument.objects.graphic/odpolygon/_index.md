...
type: docs
weight: 37
url: /zh/java/com.aspose.imaging.fileformats.opendocument.objects.graphic/odpolygon/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [OdPolygon(OdObject parent)](#OdPolygon-com.aspose.imaging.fileformats.opendocument.OdObject-) | 初始化 `OdPolygon` 类的新实例。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [getPoints()](#getPoints--) | 获取或设置点。 |
| [setPoints(PointF[] value)](#setPoints-com.aspose.imaging.PointF---) | 获取或设置点。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [PointF\[\]](../../com.aspose.imaging/pointf) | 这些点。 |
