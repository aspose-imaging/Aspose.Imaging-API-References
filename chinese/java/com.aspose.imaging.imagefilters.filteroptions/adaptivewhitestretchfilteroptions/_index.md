...
description: "提供用于配置自适应白色拉伸过滤器的选项。"
type: docs
weight: 10
...
| [getLowPercentile()](#getLowPercentile--) | 获取用于黑点计算的下限百分位。 |
| [getHighPercentile()](#getHighPercentile--) | 获取用于白点计算的上限百分位。 |
| [getTargetWhite()](#getTargetWhite--) | 获取拉伸旨在实现的目标白色值。 |
