...
description: "cdr 艺术文字"
type: docs
weight: 11
url: /zh/java/com.aspose.imaging.fileformats.cdr.objects/cdrartistictext/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [CdrArtisticText()](#CdrArtisticText--) |  |
## 方法

| 方法 | 描述 |
| --- | --- |
| [getOrigin()](#getOrigin--) | 获取原点。 |
| [setOrigin(PointD value)](#setOrigin-com.aspose.imaging.fileformats.cdr.types.PointD-) | 设置原点。 |
| [getTextIndex()](#getTextIndex--) | 获取文本的索引。 |
| [setTextIndex(int value)](#setTextIndex-int-) | 设置文本的索引。 |
### CdrArtisticText() {#CdrArtisticText--}
```
...
**Returns:**
[PointD](../../com.aspose.imaging.fileformats.cdr.types/pointd) - the origin.
### setOrigin(PointD value) {#setOrigin-com.aspose.imaging.fileformats.cdr.types.PointD-}
```
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [PointD](../../com.aspose.imaging.fileformats.cdr.types/pointd) | 原点。 |
