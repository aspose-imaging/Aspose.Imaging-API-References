...
description: "LineCapType 枚举定义了使用图形笔绘制的线段端点的线帽类型。"
type: docs
weight: 31
...
LineCapType 枚举定义了使用图形笔绘制的线段端点的线帽类型。

--------------------

图形线帽由 [EmfPlusPen](../../com.aspose.imaging.fileformats.emf.emfplus.objects/emfpluspen) 对象指定（第 2.2.1.7 节）。
## 字段

| 字段 | 描述 |
| --- | --- |
| [LineCapTypeFlat](#LineCapTypeFlat) | 指定方形线帽。 |
| [LineCapTypeSquare](#LineCapTypeSquare) | 指定方形线帽。 |
| [LineCapTypeRound](#LineCapTypeRound) | 指定圆形线帽。 |
| [LineCapTypeTriangle](#LineCapTypeTriangle) | 指定三角形线帽。 |
...
指定方形线帽。方形的中心必须位于线中的最后一点。方形的宽度即为线宽。
...
指定三角形线帽。三角形的底部必须位于线中的最后一点。三角形的底宽即为线宽。
...
指定线端使用方形线帽锚定。方形的中心必须位于线中的最后一点。方形的高和宽均为线宽。
...
指定线端使用圆形线帽锚定。圆心必须位于线中的最后一点。圆的宽度应大于线宽。
...
指定线端使用菱形线帽锚定，该线帽是旋转 45 度的方形。菱形的中心必须位于线中的最后一点。菱形的宽度应大于线宽。
...
指定线端以箭头形状锚定。箭头尖必须位于线的最后一点。箭头应比线宽。
