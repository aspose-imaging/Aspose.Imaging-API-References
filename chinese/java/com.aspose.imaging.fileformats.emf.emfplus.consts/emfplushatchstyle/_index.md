...
type: docs
weight: 25
url: /zh/java/com.aspose.imaging.fileformats.emf.emfplus.consts/emfplushatchstyle/
---
**Inheritance:**
...
HatchStyle 枚举定义了图形画刷使用的填充图案。填充图案由纯色背景和绘制在背景上的线条组成。
## 字段

| 字段 | 描述 |
| --- | --- |
| [HatchStyleHorizontal](#HatchStyleHorizontal) | 指定等间距的水平线。 |
| [HatchStyleVertical](#HatchStyleVertical) | 指定等间距的垂直线。 |
...
| [HatchStyleDarkUpwardDiagonal](#HatchStyleDarkUpwardDiagonal) | 指定从上到下向左倾斜的对角线，且不使用抗锯齿。 |
| [HatchStyleWideDownwardDiagonal](#HatchStyleWideDownwardDiagonal) | 指定从上到下向右倾斜的对角线，且不使用抗锯齿。 |
| [HatchStyleWideUpwardDiagonal](#HatchStyleWideUpwardDiagonal) | 指定从上到下向左倾斜的对角线，且不使用抗锯齿。 |
| [HatchStyleLightVertical](#HatchStyleLightVertical) | 指定垂直线，其间距比 HatchStyleVertical 图案中的线条紧密 50%。 |
| [HatchStyleLightHorizontal](#HatchStyleLightHorizontal) | 指定水平线，其间距比 HatchStyleHorizontal 图案中的线条紧密 50%。 |
| [HatchStyleNarrowVertical](#HatchStyleNarrowVertical) | 指定垂直线，其间距比 HatchStyleVertical 图案中的线条紧密 75%，或比 HatchStyleLightVertical 图案中的线条紧密 25%。 |
| [HatchStyleNarrowHorizontal](#HatchStyleNarrowHorizontal) | 指定水平线，其间距比 HatchStyleHorizontal 图案中的线条紧密 75%，或比 HatchStyleLightHorizontal 图案中的线条紧密 25%。 |
| [HatchStyleDarkVertical](#HatchStyleDarkVertical) | 指定线条，其间距比 HatchStyleVertical 图案中的线条紧密 50%。 |
| [HatchStyleDarkHorizontal](#HatchStyleDarkHorizontal) | 指定线条，其间距比 HatchStyleHorizontal 图案中的线条紧密 50%。 |
| [HatchStyleDashedDownwardDiagonal](#HatchStyleDashedDownwardDiagonal) | 指定从上到下向右倾斜的虚线对角线。 |
...
指定垂直线，其间距比 HatchStyleVertical 图案中的线条紧密 50%。
...
指定水平线，其间距比 HatchStyleHorizontal 图案中的线条紧密 50%。
...
指定垂直线，其间距比 HatchStyleVertical 图案中的线条紧密 75%，或比 HatchStyleLightVertical 图案中的线条紧密 25%。
...
指定水平线，其间距比 HatchStyleHorizontal 图案中的线条紧密 75%，或比 HatchStyleLightHorizontal 图案中的线条紧密 25%。
...
指定线条，其间距比 HatchStyleVertical 图案中的线条紧密 50%。
...
指定线条，其间距比 HatchStyleHorizontal 图案中的线条紧密 50%。
...
指定交叉的水平和垂直线条，其间距比 HatchStyleLargeGrid 小 50%。
