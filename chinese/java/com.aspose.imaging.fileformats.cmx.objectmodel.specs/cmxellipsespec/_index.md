...
| 方法 | 描述 |
| --- | --- |
| [getAngle1()](#getAngle1--) | 获取用于定义饼形扇区的第一个角度。 |
| [setAngle1(float value)](#setAngle1-float-) | 设置用于定义饼形扇区的第一个角度。 |
| [getAngle2()](#getAngle2--) | 获取用于定义饼形扇区的第二个角度。 |
| [setAngle2(float value)](#setAngle2-float-) | 设置用于定义饼形扇区的第二个角度。 |
| [getRotation()](#getRotation--) | 获取椭圆的旋转角度。 |
| [setRotation(float value)](#setRotation-float-) | 设置椭圆的旋转角度。 |
| [getPie()](#getPie--) | 获取一个值，指示此 [CmxEllipseSpec](../../com.aspose.imaging.fileformats.cmx.objectmodel.specs/cmxellipsespec) 是否为饼形。 |
| [setPie(boolean value)](#setPie-boolean-) | 设置一个值，指示此 [CmxEllipseSpec](../../com.aspose.imaging.fileformats.cmx.objectmodel.specs/cmxellipsespec) 是否为饼形。 |
...
| [setDiameterX(float value)](#setDiameterX-float-) | 设置矩形 X 维度的直径。 |
| [getDiameterY()](#getDiameterY--) | 获取矩形 Y 维度的直径。 |
| [setDiameterY(float value)](#setDiameterY-float-) | 设置矩形 Y 维度的直径。 |
...
获取一个值，指示此 [CmxEllipseSpec](../../com.aspose.imaging.fileformats.cmx.objectmodel.specs/cmxellipsespec) 是否为饼形。

**Returns:**
boolean - 表示此 [CmxEllipseSpec](../../com.aspose.imaging.fileformats.cmx.objectmodel.specs/cmxellipsespec) 是否为饼图的值。
...
设置一个值，指示此 [CmxEllipseSpec](../../com.aspose.imaging.fileformats.cmx.objectmodel.specs/cmxellipsespec) 是否为饼形。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 表示此 [CmxEllipseSpec](../../com.aspose.imaging.fileformats.cmx.objectmodel.specs/cmxellipsespec) 是否为饼图的值。 |
