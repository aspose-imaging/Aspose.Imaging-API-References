...
description: "MidLine 枚举定义了 PANOSE 系统中用于分类字体的特征之一的取值。"
type: docs
weight: 32
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.consts/emfmidline/
---
**Inheritance:**
...
MidLine 枚举定义了 PANOSE 系统中用于分类字体的特征之一的取值。
## 字段

| 字段 | 描述 |
| --- | --- |
| [PAN_ANY](#PAN-ANY) | 任意中线。 |
| [PAN_NO_FIT](#PAN-NO-FIT) | 不适配。 |
| [PAN_MIDLINE_STANDARD_TRIMMED](#PAN-MIDLINE-STANDARD-TRIMMED) | 标准 / 修剪。 |
| [PAN_MIDLINE_STANDARD_POINTED](#PAN-MIDLINE-STANDARD-POINTED) | 标准 / 尖端。 |
| [PAN_MIDLINE_STANDARD_SERIFED](#PAN-MIDLINE-STANDARD-SERIFED) | 标准 / 带衬线。 |
| [PAN_MIDLINE_HIGH_TRIMMED](#PAN-MIDLINE-HIGH-TRIMMED) | 高 / 修剪 |
| [PAN_MIDLINE_HIGH_POINTED](#PAN-MIDLINE-HIGH-POINTED) | 高 / 尖端。 |
| [PAN_MIDLINE_HIGH_SERIFED](#PAN-MIDLINE-HIGH-SERIFED) | 高 / 带衬线。 |
| [PAN_MIDLINE_CONSTANT_TRIMMED](#PAN-MIDLINE-CONSTANT-TRIMMED) | 常量 / 修剪。 |
| [PAN_MIDLINE_CONSTANT_POINTED](#PAN-MIDLINE-CONSTANT-POINTED) | 常量 / 尖端 |
| [PAN_MIDLINE_CONSTANT_SERIFED](#PAN-MIDLINE-CONSTANT-SERIFED) | 常量 / 带衬线 |
| [PAN_MIDLINE_LOW_TRIMMED](#PAN-MIDLINE-LOW-TRIMMED) | 低 / 修剪。 |
| [PAN_MIDLINE_LOW_POINTED](#PAN-MIDLINE-LOW-POINTED) | 低 / 尖端。 |
| [PAN_MIDLINE_LOW_SERIFED](#PAN-MIDLINE-LOW-SERIFED) | 低 / 带衬线。 |
### PAN_ANY {#PAN-ANY}
```
