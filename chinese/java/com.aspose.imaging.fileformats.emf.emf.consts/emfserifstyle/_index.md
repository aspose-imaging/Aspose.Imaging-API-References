...
type: docs
weight: 40
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.consts/emfserifstyle/
---
**Inheritance:**
...
SerifType 枚举定义了 PANOSE 系统中用于分类字体的特征之一的取值
## 字段
...
| [PAN_SERIF_NORMAL_SANS](#PAN-SERIF-NORMAL-SANS) | 普通无衬线样式。 |
| [PAN_SERIF_OBTUSE_SANS](#PAN-SERIF-OBTUSE-SANS) | 钝角无衬线样式。 |
| [PAN_SERIF_PERP_SANS](#PAN-SERIF-PERP-SANS) | 垂直无衬线样式。 |
| [PAN_SERIF_FLARED](#PAN-SERIF-FLARED) | 喇叭形样式。 |
| [PAN_SERIF_ROUNDED](#PAN-SERIF-ROUNDED) | 圆角样式。 |
### PAN_ANY {#PAN-ANY}
```
