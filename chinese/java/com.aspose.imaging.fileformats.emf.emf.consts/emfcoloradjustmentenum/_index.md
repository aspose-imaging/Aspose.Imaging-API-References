...
type: docs
weight: 13
url: /zh/java/com.aspose.imaging.fileformats.emf.emf.consts/emfcoloradjustmentenum/
---
**Inheritance:**
...
| 字段 | 描述 |
| --- | --- |
| [CA_NEGATIVE](#CA-NEGATIVE) | 指定应显示原始图像的负片。 |
| [CA_LOG_FILTER](#CA-LOG-FILTER) | 指定应对输出颜色的最终密度应用对数处理。 |
...
指定应对输出颜色的最终密度应用对数处理。这将在亮度低时提升颜色对比度。
