...
description: "该 wmf escape 对象。"
type: docs
weight: 33
url: /zh/java/com.aspose.imaging.fileformats.wmf.objects/wmfescape/
---
**Inheritance:**
...
| 方法 | 描述 |
| --- | --- |
| [getEscapeType()](#getEscapeType--) | 获取或设置转义的类型。 |
| [setEscapeType(int value)](#setEscapeType-int-) | 获取或设置转义的类型。 |
| [getEscapeRecord()](#getEscapeRecord--) | 获取或设置转义记录。 |
| [setEscapeRecord(WmfEscapeRecordBase value)](#setEscapeRecord-com.aspose.imaging.fileformats.wmf.objects.escaperecords.WmfEscapeRecordBase-) | 获取或设置转义记录。 |
### WmfEscape() {#WmfEscape--}
```
public WmfEscape()
```
