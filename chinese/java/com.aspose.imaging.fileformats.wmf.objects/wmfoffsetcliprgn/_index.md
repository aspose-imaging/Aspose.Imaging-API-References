...
description: "META_OFFSETCLIPRGN 记录通过指定的偏移量移动回放设备上下文中的裁剪区域。"
type: docs
weight: 48
url: /zh/java/com.aspose.imaging.fileformats.wmf.objects/wmfoffsetcliprgn/
---
**Inheritance:**
...
该 META\_OFFSETCLIPRGN 记录通过指定的偏移量移动回放设备上下文中的裁剪区域。
## 构造函数
