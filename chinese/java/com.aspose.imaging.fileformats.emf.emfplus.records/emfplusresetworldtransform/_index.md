...
type: docs
weight: 48
url: /zh/java/com.aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/
---
**Inheritance:**
...
EmfPlusResetWorldTransform 记录将当前世界空间变换重置为单位矩阵。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EmfPlusResetWorldTransform(EmfPlusRecord source)](#EmfPlusResetWorldTransform-com.aspose.imaging.fileformats.emf.emfplus.records.EmfPlusRecord-) | 初始化 `EmfPlusResetWorldTransform` 类的新实例。 |
...
初始化 `EmfPlusResetWorldTransform` 类的新实例。
