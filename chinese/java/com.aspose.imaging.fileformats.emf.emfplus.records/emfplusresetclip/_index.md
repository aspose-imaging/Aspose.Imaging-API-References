...
type: docs
weight: 47
url: /zh/java/com.aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/
---
**Inheritance:**
...
EmfPlusResetClip 记录将世界空间的当前裁剪区域重置为无限。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [EmfPlusResetClip(EmfPlusRecord source)](#EmfPlusResetClip-com.aspose.imaging.fileformats.emf.emfplus.records.EmfPlusRecord-) | 初始化 `EmfPlusResetClip` 类的新实例。 |
