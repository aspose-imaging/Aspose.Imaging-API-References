...
description: "定义在 ISO/IEC 14495-1 C.2.4.1.1 中的 JPEG-LS 预设编码参数。"
type: docs
weight: 16
...
定义在 ISO/IEC 14495-1, C.2.4.1.1 中的 JPEG-LS 预设编码参数。JPEG-LS 定义了一套默认参数，但可以使用自定义参数。使用时，这些参数会写入编码位流，以满足解码过程的需要。
## 构造函数
