...
type: docs
weight: 16
url: /zh/java/com.aspose.imaging.xmp.types.derived/xmpmimetype/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [XmpMimeType(String value)](#XmpMimeType-java.lang.String-) | 初始化 `XmpMimeType` 类的新实例。 |
