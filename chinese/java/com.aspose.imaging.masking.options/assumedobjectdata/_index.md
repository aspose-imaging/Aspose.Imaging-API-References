...
type: docs
weight: 10
url: /zh/java/com.aspose.imaging.masking.options/assumedobjectdata/
---
**Inheritance:**
java.lang.Object
```
...
| 方法 | 描述 |
| --- | --- |
| [getType()](#getType--) | 获取对象的类型。 |
| [setType(int value)](#setType-int-) | 设置对象的类型。 |
...
| --- | --- | --- |
| 类型 | int | 对象的类型。 |
| bounds | [Rectangle](../../com.aspose.imaging/rectangle) | 对象的边界。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | [Rectangle](../../com.aspose.imaging/rectangle) | 对象的边界。 |
