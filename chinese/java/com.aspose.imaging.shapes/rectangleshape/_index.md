...
type: docs
weight: 17
url: /zh/java/com.aspose.imaging.shapes/rectangleshape/
---
**Inheritance:**
...
| 构造函数 | 描述 |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | 初始化 `RectangleShape` 类的新实例。 |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.imaging.RectangleF-) | 初始化 `RectangleShape` 类的新实例。 |
## 方法
