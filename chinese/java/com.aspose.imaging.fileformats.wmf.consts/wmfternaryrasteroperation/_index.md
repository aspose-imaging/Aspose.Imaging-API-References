...
逆波兰 = 通用 = SDPSoox |
| [NOTSRCCOPY](#NOTSRCCOPY) | 将倒置的源矩形复制到目标。 |
|  | [SPDSAOX](#SPDSAOX) | -------------------- |
...
通用 = DPSnao |
| [MERGEPAINT](#MERGEPAINT) | 使用布尔 OR 运算符合并反转的源矩形的颜色与目标矩形的颜色。 |
|  | [SPDSANAX](#SPDSANAX) | -------------------- |
...
通用 = SDPxno |
| [SRCPAINT](#SRCPAINT) | 通过使用布尔 OR 运算符，将源矩形和目标矩形的颜色合并。 |
|  | [SDPNOO](#SDPNOO) | -------------------- |

通用 = SDPnoo |
| [PATCOPY](#PATCOPY) | 将当前在 hdcDest 中选中的画笔复制到目标位图中。 |
|  | [PDSONO](#PDSONO) | -------------------- |
