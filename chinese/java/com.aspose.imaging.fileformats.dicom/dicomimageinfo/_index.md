...
| 方法 | 描述 |
| --- | --- |
| [getDicomHeaderInfoByBytes()](#getDicomHeaderInfoByBytes--) | 按字节获取 DICOM 头信息。 |
...
| [getWindowWidth()](#getWindowWidth--) | 获取窗口的宽度。 |
...
| [isLittleEndian()](#isLittleEndian--) | 获取指示此实例是否为小端的值。 |
...
| [removeTagAt(int index)](#removeTagAt-int-) | 删除现有的标记。 |
| [tryRemoveTagAt(int index)](#tryRemoveTagAt-int-) | 删除现有的标记。 |
| [updateTagAt(int index, Object newValue)](#updateTagAt-int-java.lang.Object-) | 更新现有的标记。 |
| [tryUpdateTagAt(int index, Object newValue)](#tryUpdateTagAt-int-java.lang.Object-) | 更新现有的标记。 |
...
**Returns:**
java.util.List<java.lang.String> - DICOM 文件的标头信息。
...
//患者尺寸: 0
//患者体重: 0
//患者备注: 请参阅 www.medistim.com 上的案例报告
//Cine 速率: 1
//有效持续时间: 1
//设备序列号: 0
//软件版本: 3.3.0 RC0 构建于 02 / 23 / 12  09:50:45
//帧时间: 1000
//研究实例 UID: 2.16.840.1.114488.0.4.123489834087.1330071425.0
//系列实例 UID: 2.16.840.1.114488.0.4.123489834087.1330071425.1
//系列号: 1
//实例号: 1
//每像素样本数: 3
//光度解释: RGB
...
**Returns:**
java.lang.String - "PhotoInterpretation" 的值。
### getWidth() {#getWidth--}
```
public int getWidth()
```
...
| value | java.lang.Object | 标签值。不能为空。 |
