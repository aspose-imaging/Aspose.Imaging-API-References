...
type: docs
weight: 60
url: /com.aspose.imaging.fileformats.emf.emf.records/emfforceufimapping/
---
**Inheritance:**
...
| --- | --- |
| [EmfForceUfiMapping(EmfRecord source)](#EmfForceUfiMapping-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | Initializes a new instance of the `EmfForceUfiMapping` class. |
## Methods

| Method | Description |
| --- | --- |
| [getUfi()](#getUfi--) | Gets or sets the font id to use, specified as a UniversalFontId (section 2.2.27). |
| [setUfi(EmfUniversalFontId value)](#setUfi-com.aspose.imaging.fileformats.emf.emf.objects.EmfUniversalFontId-) | Gets or sets the font id to use, specified as a UniversalFontId (section 2.2.27). |
