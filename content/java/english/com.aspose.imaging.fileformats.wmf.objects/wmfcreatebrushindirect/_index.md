...
description: The Create brush in direct
type: docs
weight: 20
url: /com.aspose.imaging.fileformats.wmf.objects/wmfcreatebrushindirect/
---
**Inheritance:**
...
| --- | --- |
| [WmfCreateBrushInDirect()](#WmfCreateBrushInDirect--) | Initializes a new instance of the `WmfCreateBrushInDirect` class. |
## Methods

| Method | Description |
| --- | --- |
| [getLogBrush()](#getLogBrush--) | Gets or sets the log brush. |
| [setLogBrush(EmfLogBrushEx value)](#setLogBrush-com.aspose.imaging.fileformats.emf.emf.objects.EmfLogBrushEx-) | Gets or sets the log brush. |
