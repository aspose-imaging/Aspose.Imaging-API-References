...
description: The text span
type: docs
weight: 45
url: /com.aspose.imaging.fileformats.opendocument.objects.graphic/odtextspan/
---
**Inheritance:**
...
| --- | --- |
| [OdTextSpan(OdObject parent)](#OdTextSpan-com.aspose.imaging.fileformats.opendocument.OdObject-) | Initializes a new instance of the `OdTextSpan` class. |
## Methods
...
### OdTextSpan(OdObject parent) {#OdTextSpan-com.aspose.imaging.fileformats.opendocument.OdObject-}
```
