...
description: The EmfPlusBlendColors object specifies positions and colors for the blend pattern of a gradient brush.
type: docs
weight: 17
url: /com.aspose.imaging.fileformats.emf.emfplus.objects/emfplusblendcolors/
---
**Inheritance:**
...
| Method | Description |
| --- | --- |
| [getBlendArgb32Colors()](#getBlendArgb32Colors--) | Gets or sets an array of PositionCount EmfPlusARGB objects (section 2.2.2.1) that specify colors at the positions defined in the BlendPositions field. |
| [setBlendArgb32Colors(int[] value)](#setBlendArgb32Colors-int---) | Gets or sets an array of PositionCount EmfPlusARGB objects (section 2.2.2.1) that specify colors at the positions defined in the BlendPositions field. |
### EmfPlusBlendColors() {#EmfPlusBlendColors--}
```
...
### getBlendArgb32Colors() {#getBlendArgb32Colors--}
```
...
**Returns:**
int[]
### setBlendArgb32Colors(int[] value) {#setBlendArgb32Colors-int---}
```
