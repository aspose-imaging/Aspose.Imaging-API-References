...
description: The EmfPlusSolidBrushData object specifies a solid color for a graphics brush.
type: docs
weight: 73
url: /com.aspose.imaging.fileformats.emf.emfplus.objects/emfplussolidbrushdata/
---
**Inheritance:**
...
| Method | Description |
| --- | --- |
| [getSolidArgb32Color()](#getSolidArgb32Color--) | Gets or sets an EmfPlusARGB object (section 2.2.2.1) that specifies the color of the brush. |
| [setSolidArgb32Color(int value)](#setSolidArgb32Color-int-) | Gets or sets an EmfPlusARGB object (section 2.2.2.1) that specifies the color of the brush. |
### EmfPlusSolidBrushData() {#EmfPlusSolidBrushData--}
```
...
### getSolidArgb32Color() {#getSolidArgb32Color--}
```
...
**Returns:**
int
### setSolidArgb32Color(int value) {#setSolidArgb32Color-int-}
```
