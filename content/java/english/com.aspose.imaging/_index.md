...
| [DashCap](../com.aspose.imaging/dashcap) | Specifies the type of graphic shape to use on both ends of each dash in a dashed line. |
...
| [HatchStyle](../com.aspose.imaging/hatchstyle) | Specifies the different patterns available for `HatchBrush` objects. |
...
| [ImageAttributes](../com.aspose.imaging/imageattributes) | An `com.aspose.imaging.ImageAttributes` object contains information about how bitmap and metafile colors are manipulated during rendering. |
...
| [LineCap](../com.aspose.imaging/linecap) | Specifies the available cap styles with which a `Pen` object can end a line. |
| [LineJoin](../com.aspose.imaging/linejoin) | Specifies how to join consecutive line or curve segments in a figure (subpath) contained in a `GraphicsPath` object. |
...
| [Matrix](../com.aspose.imaging/matrix) | Replaces the GDI+ Matrix. |
...
| [PenAlignment](../com.aspose.imaging/penalignment) | Specifies the alignment of a `Pen` object in relation to the theoretical, zero-width line. |
| [PenType](../com.aspose.imaging/pentype) | Specifies the type of fill a `Pen` object uses to fill lines. |
...
| [SeekOrigin](../com.aspose.imaging/seekorigin) | Provides the fields that represent reference points in `StreamContainer` for seeking. |
...
| [StringAlignment](../com.aspose.imaging/stringalignment) | Specifies the alignment of a text string relative to its layout rectangle. |
...
| [IRasterImageArgb32PixelLoader](../com.aspose.imaging/irasterimageargb32pixelloader) | The raster image 32-bit ARGB pixel loader. |
