...
description: Ritar det angivnaImageaspose.imaging/graphics/image  med sin ursprungliga fysiska storlek på den angivna platsen.
type: docs
weight: 220
url: /sv/aspose.imaging/graphics/drawimage/
---
...
| point | PointF | [`PointF`](../../pointf) struktur som representerar det övre vänstra hörnet av den ritade bilden. |
...
| --- | --- | --- |
| sourceImage | Image | Bilden att rita med. |
| point | Point | [`Point`](../../point) struktur som representerar platsen för det övre vänstra hörnet av den ritade bilden. |
