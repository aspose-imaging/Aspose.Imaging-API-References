...
type: docs
weight: 1900
url: /ru/aspose.imaging.fileformats.cmx/cmximage/
---
## CmxImage class
...
| Имя | Описание |
| --- | --- |
| [CmxImage](cmximage)(StreamContainer, LoadOptions) | Инициализирует новый экземпляр[`CmxImage`](../cmximage) класс. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cmx/cmximage/setpalette)(IColorPalette, bool) | Задает палитру изображения. |
