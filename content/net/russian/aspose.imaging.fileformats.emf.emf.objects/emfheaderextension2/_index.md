...
description: Объект HeaderExtension2 определяет второе расширение заголовка метафайла EMF. Он добавляет возможность измерять поверхность устройства в микрометрах что повышает разрешение и масштабируемость метафайлов EMF.
type: docs
weight: 3000
url: /ru/aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/
---
