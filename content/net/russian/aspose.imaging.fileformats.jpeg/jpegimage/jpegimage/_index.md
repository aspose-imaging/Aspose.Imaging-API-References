...
description: Инициализирует новый экземплярJpegImageaspose.imaging.fileformats.jpeg/jpegimage класс.
type: docs
weight: 10
url: /ru/aspose.imaging.fileformats.jpeg/jpegimage/jpegimage/
---
## JpegImage(string) {#constructor_4}

Инициализирует новый экземпляр[`JpegImage`](../../jpegimage) класс.
