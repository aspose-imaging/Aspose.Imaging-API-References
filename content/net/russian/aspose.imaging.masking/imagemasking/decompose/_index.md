...
description: Выполняет операцию декомпозиции с использованием указанных параметров маскирования
type: docs
weight: 30
url: /ru/aspose.imaging.masking/imagemasking/decompose/
---
## ImageMasking.Decompose method

Выполняет операцию декомпозиции с использованием указанных параметров маскирования
