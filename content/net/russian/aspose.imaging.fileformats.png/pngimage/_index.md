...
type: docs
weight: 7450
url: /ru/aspose.imaging.fileformats.png/pngimage/
---
## PngImage class
...
| Имя | Описание |
| --- | --- |
| [PngImage](pngimage#constructor_1)(RasterImage) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
| [PngImage](pngimage#constructor_5)(Stream) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
| [PngImage](pngimage#constructor_6)(string) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
| [PngImage](pngimage#constructor_3)(int, int) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
| [PngImage](pngimage#constructor_2)(RasterImage, PngColorType) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
| [PngImage](pngimage#constructor_7)(string, PngColorType) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
| [PngImage](pngimage#constructor_4)(int, int, PngColorType) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
| [PngImage](pngimage#constructor)(PngOptions, int, int) | Инициализирует новый экземпляр[`PngImage`](../pngimage) класс. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.png/pngimage/bitsperpixel) { get; } | Получает количество бит на пиксель. |
...
| override [HasAlpha](../../aspose.imaging.fileformats.png/pngimage/hasalpha) { get; } | Получить значение, указывающее, есть ли у этого экземпляра альфа. |
...
| override [HorizontalResolution](../../aspose.imaging.fileformats.png/pngimage/horizontalresolution) { get; set; } | Получает или задает горизонтальное разрешение. |
| virtual [ImageOpacity](../../aspose.imaging/rasterimage/imageopacity) { get; } | Получает непрозрачность этого изображения. |
| [Interlaced](../../aspose.imaging.fileformats.png/pngimage/interlaced) { get; } | Получает значение, указывающее, является ли это[`PngImage`](../pngimage) чересстрочная развертка. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.png/pngimage/isinterlaced) { get; } | Получает значение, указывающее, является ли данный экземпляр изображения чересстрочным. |
