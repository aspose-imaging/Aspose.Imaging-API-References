...
type: docs
weight: 10110
url: /ru/aspose.imaging.imageoptions/pdfoptions/
---
## PdfOptions class
...
В следующем примере показано, как преобразовать многостраничное векторное изображение в формат PDF в общем виде без ссылки на конкретный тип изображения.
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    ...
    // Экспортировать только первые две страницы на соответствующие страницы выходного PDF-документа.
