...
type: docs
weight: 8000
url: /ru/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
## TiffSLongType class
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/elementsize) { get; } | Получает размер элемента в байтах. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/tagtype) { get; } | Получает тип тега. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/value) { get; set; } | Получает или задает значение, которое содержит этот тип данных. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/values) { get; set; } | Получает или задает значения. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/valuescontainer) { get; } | Получает контейнер значений. |
