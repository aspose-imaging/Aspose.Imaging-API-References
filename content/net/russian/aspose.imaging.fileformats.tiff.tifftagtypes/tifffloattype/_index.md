...
type: docs
weight: 7950
url: /ru/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/
---
## TiffFloatType class
...
| Имя | Описание |
| --- | --- |
| [TiffFloatType](tifffloattype#constructor)(TiffTags) | Инициализирует новый экземпляр[`TiffFloatType`](../tifffloattype) класс. |
| [TiffFloatType](tifffloattype#constructor_1)(ushort) | Инициализирует новый экземпляр[`TiffFloatType`](../tifffloattype) класс. |
