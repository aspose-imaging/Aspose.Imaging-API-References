...
type: docs
weight: 7870
url: /ru/aspose.imaging.fileformats.tiff/tiffframe/
---
## TiffFrame class
...
| Имя | Описание |
| --- | --- |
| [TiffFrame](tiffframe#constructor_1)(RasterImage) | Инициализирует новый экземпляр[`TiffFrame`](../tiffframe) класс. |
| [TiffFrame](tiffframe#constructor_3)(Stream) | Инициализирует новый экземпляр[`TiffFrame`](../tiffframe) класс. |
| [TiffFrame](tiffframe#constructor_5)(string) | Инициализирует новый экземпляр[`TiffFrame`](../tiffframe) класс. |
| [TiffFrame](tiffframe#constructor_2)(RasterImage, TiffOptions) | Инициализирует новый экземпляр[`TiffFrame`](../tiffframe) класс. |
| [TiffFrame](tiffframe#constructor_4)(Stream, TiffOptions) | Инициализирует новый экземпляр[`TiffFrame`](../tiffframe) класс. |
| [TiffFrame](tiffframe#constructor_6)(string, TiffOptions) | Инициализирует новый экземпляр[`TiffFrame`](../tiffframe) класс. |
| [TiffFrame](tiffframe#constructor)(TiffOptions, int, int) | Инициализирует новый экземпляр[`TiffFrame`](../tiffframe) класс. |
...
| override [HasAlpha](../../aspose.imaging.fileformats.tiff/tiffframe/hasalpha) { get; } | Получает значение, указывающее, есть ли у этого экземпляра альфа. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/verticalresolution) { get; set; } | Получает или задает разрешение по вертикали в пикселях на дюйм этого[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.tiff/tiffframe/width) { get; } | Получает ширину изображения. |
| override [XmpData](../../aspose.imaging.fileformats.tiff/tiffframe/xmpdata) { get; set; } | Получает или устанавливает данные XMP из кадра. |
...
| static [CreateFrameFrom](../../aspose.imaging.fileformats.tiff/tiffframe/createframefrom)(TiffFrame, TiffOptions) | Создает кадр из указанного*tiffFrame* используя указанный*options* . Данные пикселей сохраняются, но преобразуются в нужный формат. |
