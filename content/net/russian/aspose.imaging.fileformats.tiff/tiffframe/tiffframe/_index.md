...
description: Инициализирует новый экземплярTiffFrameaspose.imaging.fileformats.tiff/tiffframe класс.
type: docs
weight: 10
url: /ru/aspose.imaging.fileformats.tiff/tiffframe/tiffframe/
---
## TiffFrame(Stream) {#constructor_3}

Инициализирует новый экземпляр[`TiffFrame`](../../tiffframe) класс.
...
| --- | --- | --- |
| stream | Stream | Поток для загрузки изображения и инициализации пикселей кадра и данных палитры. |
| options | TiffOptions | Параметры, используемые для вновь созданного фрейма. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| options | TiffOptions | Варианты кадра. |
| width | Int32 | Ширина. |
| height | Int32 | Высота. |
...
| исключение | условие |
| --- | --- |
| ArgumentNullException | Параметр опций имеет значение null. |
