...
description: ПредставляетBrush../aspose.imaging/brush с возможностями градиента и соответствующими свойствами.
type: docs
weight: 160
url: /ru/aspose.imaging.brushes/lineargradientbrushbase/
---
...
| [IsAngleScalable](../../aspose.imaging.brushes/lineargradientbrushbase/isanglescalable) { get; set; } | Получает или задает значение, указывающее,[`Angle`](./angle) изменяется во время трансформаций с этим[`LinearGradientBrushBase`](../lineargradientbrushbase) . |
