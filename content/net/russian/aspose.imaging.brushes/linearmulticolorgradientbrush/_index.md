...
description: ПредставляетBrush../aspose.imaging/brush с линейным градиентом определяемым несколькими цветами и соответствующими позициями. Этот класс не может быть унаследован.
type: docs
weight: 170
url: /ru/aspose.imaging.brushes/linearmulticolorgradientbrush/
---
...
| Имя | Описание |
| --- | --- |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor)() | Инициализирует новый экземпляр[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) класс с параметрами по умолчанию. Начальный цвет черный, конечный цвет белый, угол 45 градусов и прямоугольник расположен в (0,0) с размером (1,1). |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_1)(Point, Point) | Инициализирует новый экземпляр[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) класс с указанными баллами. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_2)(PointF, PointF) | Инициализирует новый экземпляр[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) класс с указанными баллами. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_3)(Rectangle, float) | Инициализирует новый экземпляр[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) класс на основе прямоугольника и угла ориентации. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_5)(RectangleF, float) | Инициализирует новый экземпляр[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) класс на основе прямоугольника и угла ориентации. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_4)(Rectangle, float, bool) | Инициализирует новый экземпляр[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) класс на основе прямоугольника и угла ориентации. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_6)(RectangleF, float, bool) | Инициализирует новый экземпляр[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) класс на основе прямоугольника и угла ориентации. |
...
| [InterpolationColors](../../aspose.imaging.brushes/linearmulticolorgradientbrush/interpolationcolors) { get; set; } | Получает или задает[`ColorBlend`](../../aspose.imaging/colorblend) который определяет многоцветный линейный градиент. |
