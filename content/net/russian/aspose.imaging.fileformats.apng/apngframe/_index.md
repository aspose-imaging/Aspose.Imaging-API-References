...
description: Анимированное изображение PNG frame
type: docs
weight: 1310
url: /ru/aspose.imaging.fileformats.apng/apngframe/
---
## ApngFrame class

Анимированное изображение PNG frame
...
| override [HasAlpha](../../aspose.imaging.fileformats.apng/apngframe/hasalpha) { get; } | Получить значение, указывающее, есть ли у этого экземпляра альфа. |
