...
description: Инициализирует новый экземплярWmfRecorderGraphics2Daspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d класс.
type: docs
weight: 10
url: /ru/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/wmfrecordergraphics2d/
---
## WmfRecorderGraphics2D constructor

Инициализирует новый экземпляр[`WmfRecorderGraphics2D`](../../wmfrecordergraphics2d) класс.
...
| --- | --- | --- |
| frame | Rectangle | Целевой прямоугольник, измеренный в твипах, для отображения метафайла. |
