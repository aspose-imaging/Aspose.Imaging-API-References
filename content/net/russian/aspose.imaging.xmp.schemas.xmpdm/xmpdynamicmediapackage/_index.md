...
type: docs
weight: 11420
url: /ru/aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/
---
...
| Имя | Описание |
| --- | --- |
| [XmpDynamicMediaPackage](xmpdynamicmediapackage)() | Конструктор по умолчанию. |
...
| [SetArtist](../../aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/setartist)(string) | Устанавливает исполнителя. |
| [SetAudioChannelType](../../aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/setaudiochanneltype)(AudioChannelType) | Устанавливает тип аудиоканала. |
| [SetAudioSampleRate](../../aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/setaudiosamplerate)(int) | Устанавливает частоту дискретизации звука. |
| [SetAudioSampleType](../../aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/setaudiosampletype)(AudioSampleType) | Устанавливает тип аудиосемпла. |
| [SetCameraAngle](../../aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/setcameraangle)(string) | Устанавливает угол камеры. |
| [SetCameraLabel](../../aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/setcameralabel)(string) | Устанавливает метку камеры. |
| [SetCameraMove](../../aspose.imaging.xmp.schemas.xmpdm/xmpdynamicmediapackage/setcameramove)(string) | Устанавливает движение камеры. |
