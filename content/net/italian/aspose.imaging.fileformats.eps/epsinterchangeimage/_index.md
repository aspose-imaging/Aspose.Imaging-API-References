...
description: Classe per Encapsulated PostScript Interchange format
type: docs
weight: 6570
url: /it/aspose.imaging.fileformats.eps/epsinterchangeimage/
---
## EpsInterchangeImage class

Classe per Encapsulated PostScript Interchange format
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsinterchangeimage/epstype) { get; } | Ottiene il valore del sottotipo EPS |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | Ottiene un valore che indica se questa istanza ha un'anteprima raster specifica del formato |
...
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | Ottiene l'altezza dell'immagine di anteprima |
| [PreviewWidth](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewwidth) { get; } | Ottiene la larghezza dell'immagine di anteprima |
| [RasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/rasterpreview) { get; } | Ottiene l'anteprima raster b/n (se presente) o null |
...
| [ConvertToBinary](../../aspose.imaging.fileformats.eps/epsinterchangeimage/converttobinary)() | Converte questa istanza in[`EpsBinaryImage`](../epsbinaryimage) |
...
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ImageResizeSettings) | Ridimensiona l'immagine. |
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ResizeType) | Ridimensiona l'immagine. |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | Esegue una conversione esplicita da[`EpsBinaryImage`](../epsbinaryimage) a[`EpsInterchangeImage`](../epsinterchangeimage) |
