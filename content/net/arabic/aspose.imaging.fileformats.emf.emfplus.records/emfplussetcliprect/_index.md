...
description: يدمج سجل EmfPlusSetClipRect منطقة القطع الحالية مع مستطيل.
type: docs
weight: 6300
url: /ar/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/
---
## EmfPlusSetClipRect class

يدمج سجل EmfPlusSetClipRect منطقة القطع الحالية مع مستطيل.
...
| اسم | وصف |
| --- | --- |
| [EmfPlusSetClipRect](emfplussetcliprect)(EmfPlusRecord) | يقوم بتهيئة مثيل جديد لملف[`EmfPlusSetClipRect`](../emfplussetcliprect) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [ClipRect](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/cliprect) { get; set; } | الحصول على كائن EmfPlusRectF أو تعيينه (القسم 2.2.2.39) الذي يحدد المستطيل to استخدامه في عملية CombineMode. |
| [Cm](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/cm) { get; set; } | الحصول على CM (4 بت) أو تعيينه: يحدد العملية المنطقية لدمج منطقتين. راجع تعداد CombineMode (القسم 2.1.1.4) للتعرف على معاني القيم. |
