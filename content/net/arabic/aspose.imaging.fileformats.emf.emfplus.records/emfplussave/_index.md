...
description: يحفظ سجل EmfPlusSave حالة الرسومات  التي تم تحديدها بواسطة فهرس محدد  على مجموعة من حالات الرسومات المحفوظة.
type: docs
weight: 6250
url: /ar/aspose.imaging.fileformats.emf.emfplus.records/emfplussave/
---
## EmfPlusSave class

يحفظ سجل EmfPlusSave حالة الرسومات ، التي تم تحديدها بواسطة فهرس محدد ، على مجموعة من حالات الرسومات المحفوظة.
...
| اسم | وصف |
| --- | --- |
| [EmfPlusSave](emfplussave)(EmfPlusRecord) | يقوم بتهيئة مثيل جديد لملف[`EmfPlusSave`](../emfplussave) فئة . |
...
| [StackIndex](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussave/stackindex) { get; set; } | الحصول على أو تعيين عدد صحيح بدون إشارة 32 بت يحدد مستوى لربطه بحالة الرسومات. يمكن استخدام قيمة المستوى بواسطة عملية سجل EmfPlusRestore اللاحقة (section 2.3.7.4) لاسترداد حالة الرسومات. |
