...
description: يضاعف سجل EmfPlusMultiplyWorldTransform تحويل الفضاء العالمي الحالي بمصفوفة تحويل محددة.
type: docs
weight: 6150
url: /ar/aspose.imaging.fileformats.emf.emfplus.records/emfplusmultiplyworldtransform/
---
## EmfPlusMultiplyWorldTransform class

يضاعف سجل EmfPlusMultiplyWorldTransform تحويل الفضاء العالمي الحالي بمصفوفة تحويل محددة.
...
| اسم | وصف |
| --- | --- |
| [EmfPlusMultiplyWorldTransform](emfplusmultiplyworldtransform)(EmfPlusRecord) | يقوم بتهيئة مثيل جديد لملف[`EmfPlusMultiplyWorldTransform`](../emfplusmultiplyworldtransform) فئة . |
...
| [MatrixData](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusmultiplyworldtransform/matrixdata) { get; set; } | الحصول على أو تعيين كائن EmfPlusTransformMatrix (القسم 2.2.2.47) الذي يحدد مصفوفة الضرب. |
| [PostMultipliedMatrix](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusmultiplyworldtransform/postmultipliedmatrix) { get; } | يحصل على قيمة تشير إلى ما إذا كان [post المصفوفة المضاعفة] . إذا تم ضبطه ، يجب مضاعفة مصفوفة التحويل لاحقًا. إذا كان واضحًا ، فيجب أن يكون مضروبًا مسبقًا. |
