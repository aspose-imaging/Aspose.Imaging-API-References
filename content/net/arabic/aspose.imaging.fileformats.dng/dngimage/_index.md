...
description: فئة تمثيل صورة Dng
type: docs
weight: 2520
url: /ar/aspose.imaging.fileformats.dng/dngimage/
---
## DngImage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dng/dngimage/bitsperpixel) { get; } | الحصول على عدد بتات الصورة لكل بكسل . |
...
| override [FileFormat](../../aspose.imaging.fileformats.dng/dngimage/fileformat) { get; } | يحصل على قيمة تنسيق الملف |
...
| override [Height](../../aspose.imaging.fileformats.dng/dngimage/height) { get; } | الحصول على ارتفاع الصورة . |
...
| [ImgData](../../aspose.imaging.fileformats.dng/dngimage/imgdata) { get; set; } | الحصول على بيانات img أو تعيينها. |
...
| override [Width](../../aspose.imaging.fileformats.dng/dngimage/width) { get; } | الحصول على عرض الصورة . |
