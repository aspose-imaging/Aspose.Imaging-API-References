...
description: يمثل سجل الفتاحات لكتل الويب.
type: docs
weight: 8070
url: /ar/aspose.imaging.fileformats.webp/webpframeblock/
---
## WebPFrameBlock class

يمثل سجل الفتاحات لكتل الويب.
...
| اسم | وصف |
| --- | --- |
| [WebPFrameBlock](webpframeblock#constructor)(RasterImage) | يقوم بتهيئة مثيل جديد لملف[`WebPFrameBlock`](../webpframeblock) |
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | يقوم بتهيئة مثيل جديد لملف[`WebPFrameBlock`](../webpframeblock) فئة . |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | الحصول على عدد بتات الصورة لكل بكسل . |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | الحصول على طريقة التخلص . |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثيل قد تم التخلص منه. |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration) { get; set; } | الحصول على أو تحديد مدة الإطار . |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | يحصل على قيمة تنسيق الملف |
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft) { get; } | الحصول على إزاحة الإطار الأيسر . |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime) { get; } | الحصول على مدة الإطار . |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | يحصل على إزاحة أعلى الإطار . |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثيل يحتوي على alpha. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | الحصول على أو تحديد موضع الإطار لليسار . |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | الحصول على أو تحديد موضع الإطار العلوي . |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width) { get; } | الحصول على عرض الصورة . |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe)() | الحصول على الإطار الكامل . |
