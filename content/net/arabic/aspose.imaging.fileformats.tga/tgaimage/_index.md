...
description: صورة TGA .
type: docs
weight: 7580
url: /ar/aspose.imaging.fileformats.tga/tgaimage/
---
## TgaImage class
...
| اسم | وصف |
| --- | --- |
| [TgaImage](tgaimage#constructor)(RasterImage) | يقوم بتهيئة مثيل جديد لملف[`TgaImage`](../tgaimage) فئة . |
| [TgaImage](tgaimage#constructor_1)(Stream) | يقوم بتهيئة مثيل جديد لملف[`TgaImage`](../tgaimage) فئة . |
| [TgaImage](tgaimage#constructor_2)(string) | يقوم بتهيئة مثيل جديد لملف[`TgaImage`](../tgaimage) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [AuthorComments](../../aspose.imaging.fileformats.tga/tgaimage/authorcomments) { get; set; } | الحصول على تعليقات المؤلف أو تعيينها . هذا حقل ASCII يتكون من 324 بايت والتي تم تنظيمها على شكل أربعة أسطر من 80 حرفًا ، يتبع كل منها حرف إنهاء فارغ. |
| [AuthorName](../../aspose.imaging.fileformats.tga/tgaimage/authorname) { get; set; } | الحصول على اسم المؤلف أو تعيينه . هذا الحقل يبلغ إجمالي 40 حرفًا من أحرف ASCII للاسم. إذا تم استخدام الحقل ، يجب أن يحتوي الحقل على اسم الشخص الذي أنشأ الصورة (المؤلف) . |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.tga/tgaimage/backgroundcolor) { get; set; } | الحصول على لون الخلفية أو تعيينه. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.tga/tgaimage/bitsperpixel) { get; } | يحصل على بت لكل بكسل. |
...
| [BytesPerPixel](../../aspose.imaging.fileformats.tga/tgaimage/bytesperpixel) { get; } | يحصل على بايت لكل بكسل . |
...
| [DateTimeStamp](../../aspose.imaging.fileformats.tga/tgaimage/datetimestamp) { get; set; } | الحصول على طابع التاريخ / الوقت أو تعيينه . يحدد هذا الحقل قيمة التاريخ والوقت اللذين تم حفظ الصورة فيهما. على الرغم من أن أنظمة التشغيل عادةً ملفات طابع الوقت والتاريخ ، فإن هذه الميزة متوفرة لأن نظام التشغيل قد يغير طابع الوقت والتاريخ إذا تم نسخ الملف . باستخدام هذه المنطقة ، نضمن لك منطقة غير معدلة للتاريخ والوقت التسجيل . |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثيل قد تم التخلص منه. |
| override [FileFormat](../../aspose.imaging.fileformats.tga/tgaimage/fileformat) { get; } | يحصل على تنسيق الملف. |
| [GammaValueDenominator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluedenominator) { get; } | الحصول على جزء مقام قيمة جاما. يجب أن يكون للصورة غير المصححة (صورة بدون جاما) القيمة 1.0 كنتيجة . |
| [GammaValueNumerator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluenumerator) { get; } | الحصول على جزء البسط لقيمة جاما. يجب أن تحتوي الصورة غير المصححة (صورة بدون جاما) على القيمة 1.0 كنتيجة . |
| override [HasAlpha](../../aspose.imaging.fileformats.tga/tgaimage/hasalpha) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا[`TgaImage`](../tgaimage) لديه قناة ألفا. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.tga/tgaimage/hasbackgroundcolor) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كانت الصورة لها لون خلفية. |
| [HasColorMap](../../aspose.imaging.fileformats.tga/tgaimage/hascolormap) { get; } | يحصل على قيمة تشير إلى ما إذا كانت هذه الصورة تحتوي على خريطة ملونة. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.tga/tgaimage/hastransparentcolor) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كانت الصورة ذات لون شفاف. |
| override [Height](../../aspose.imaging.fileformats.tga/tgaimage/height) { get; } | الحصول على ارتفاع هذه الصورة . |
...
| [ImageId](../../aspose.imaging.fileformats.tga/tgaimage/imageid) { get; set; } | الحصول على معرف الصورة أو تعيينه. |
...
| [IsGrayScale](../../aspose.imaging.fileformats.tga/tgaimage/isgrayscale) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا[`TgaImage`](../tgaimage) مقياس رمادي . |
...
| [JobNameOrId](../../aspose.imaging.fileformats.tga/tgaimage/jobnameorid) { get; set; } | الحصول على أو تعيين اسم / معرف الوظيفة. |
| [JobTime](../../aspose.imaging.fileformats.tga/tgaimage/jobtime) { get; set; } | الحصول على وقت العمل أو تعيينه . |
...
| [PixelAspectRatioDenominator](../../aspose.imaging.fileformats.tga/tgaimage/pixelaspectratiodenominator) { get; } | يحصل على جزء مقام نسبة العرض إلى الارتفاع للبكسل. |
| [PixelAspectRatioNumerator](../../aspose.imaging.fileformats.tga/tgaimage/pixelaspectrationumerator) { get; } | يحصل على جزء البسط نسبة العرض إلى الارتفاع للبكسل. |
...
| [SoftwareId](../../aspose.imaging.fileformats.tga/tgaimage/softwareid) { get; set; } | الحصول على معرف البرنامج أو تعيينه . إجمالي 40 حرفًا من أحرف ASCII لمعرف البرنامج. |
| [SoftwareVersion](../../aspose.imaging.fileformats.tga/tgaimage/softwareversion) { get; set; } | الحصول على إصدار البرنامج أو تعيينه. طول سلسلة الإصدار المقبول هو 3-4 أحرف. |
| [SoftwareVersionLetter](../../aspose.imaging.fileformats.tga/tgaimage/softwareversionletter) { get; set; } | الحصول على جزء حرف إصدار البرنامج أو تعيينه. |
| [SoftwareVersionNumber](../../aspose.imaging.fileformats.tga/tgaimage/softwareversionnumber) { get; set; } | الحصول على جزء رقم إصدار البرنامج أو تعيينه. |
| override [TransparentColor](../../aspose.imaging.fileformats.tga/tgaimage/transparentcolor) { get; set; } | الحصول على لون المفتاح أو تعيينه . |
...
| override [Width](../../aspose.imaging.fileformats.tga/tgaimage/width) { get; } | الحصول على عرض الصورة هذا . |
| virtual [XmpData](../../aspose.imaging/rasterimage/xmpdata) { get; set; } | الحصول على بيانات تعريف XMP أو تعيينها. |
| [XOrigin](../../aspose.imaging.fileformats.tga/tgaimage/xorigin) { get; set; } | الحصول على أو تعيين إحداثيات أفقية مطلقة للزاوية اليسرى السفلية من image حيث يتم وضعها على جهاز عرض أصله في الجزء السفلي الأيسر من شاشة (على سبيل المثال ، سلسلة TARGA) . |
| [YOrigin](../../aspose.imaging.fileformats.tga/tgaimage/yorigin) { get; set; } | الحصول على أو تعيين إحداثيات رأسية مطلقة للزاوية اليسرى السفلية من image حيث يتم وضعها على جهاز عرض أصله في الجزء السفلي الأيسر من شاشة (على سبيل المثال ، سلسلة TARGA) . |
...
| [Clone](../../aspose.imaging.fileformats.tga/tgaimage/clone#clone)() | إنشاء كائن جديد يمثل نسخة من المثيل الحالي. |
| [Clone](../../aspose.imaging.fileformats.tga/tgaimage/clone#clone_1)(TgaImage) | استنساخ أخرى[`TgaImage`](../tgaimage) خصائص الكائن . |
| override [Crop](../../aspose.imaging.fileformats.tga/tgaimage/crop#crop)(Rectangle) | اقتصاص الصورة . |
| override [Crop](../../aspose.imaging.fileformats.tga/tgaimage/crop#crop_1)(int, int, int, int) | اقتصاص الصورة مع التحولات . |
...
| override [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals_1)(object) | مقارنة المساواة . |
| [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals)(TgaImage) | مقارنة المساواة . |
...
| override [GetHashCode](../../aspose.imaging.fileformats.tga/tgaimage/gethashcode)() | احصل على كود التجزئة لهذا المثال. غير مناسب لاستخدامه كمفتاح مثل[`TgaImage`](../tgaimage) غير ثابت. |
...
| override [Resize](../../aspose.imaging.fileformats.tga/tgaimage/resize#resize_1)(int, int, ImageResizeSettings) | يغير حجم الصورة. |
| override [Resize](../../aspose.imaging.fileformats.tga/tgaimage/resize#resize_2)(int, int, ResizeType) | يغير حجم الصورة. |
...
| override [Rotate](../../aspose.imaging.fileformats.tga/tgaimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate الصورة حول المركز . |
| override [RotateFlip](../../aspose.imaging.fileformats.tga/tgaimage/rotateflip)(RotateFlipType) | تدوير الوجه. |
...
| [operator ==](../../aspose.imaging.fileformats.tga/tgaimage/op_equality) | مقارنة المساواة . |
| [operator !=](../../aspose.imaging.fileformats.tga/tgaimage/op_inequality) | مقارنة عدم المساواة . |
...
* مساحة الاسم [Aspose.Imaging.FileFormats.Tga](../../aspose.imaging.fileformats.tga)
