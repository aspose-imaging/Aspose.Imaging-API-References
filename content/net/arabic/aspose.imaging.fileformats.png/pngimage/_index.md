...
description: صورة png الجديدة .
type: docs
weight: 7450
url: /ar/aspose.imaging.fileformats.png/pngimage/
---
## PngImage class
...
| اسم | وصف |
| --- | --- |
| [PngImage](pngimage#constructor_1)(RasterImage) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
| [PngImage](pngimage#constructor_5)(Stream) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
| [PngImage](pngimage#constructor_6)(string) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
| [PngImage](pngimage#constructor_3)(int, int) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
| [PngImage](pngimage#constructor_2)(RasterImage, PngColorType) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
| [PngImage](pngimage#constructor_7)(string, PngColorType) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
| [PngImage](pngimage#constructor_4)(int, int, PngColorType) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
| [PngImage](pngimage#constructor)(PngOptions, int, int) | يقوم بتهيئة مثيل جديد لملف[`PngImage`](../pngimage) فئة . |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.png/pngimage/backgroundcolor) { get; set; } | يحصل على لون الخلفية . |
| override [BitsPerPixel](../../aspose.imaging.fileformats.png/pngimage/bitsperpixel) { get; } | يحصل على وحدات البت لكل بكسل . |
...
| override [FileFormat](../../aspose.imaging.fileformats.png/pngimage/fileformat) { get; } | يحصل على قيمة تنسيق الملف |
| override [HasAlpha](../../aspose.imaging.fileformats.png/pngimage/hasalpha) { get; } | احصل على قيمة تشير إلى ما إذا كان هذا المثيل يحتوي على alpha . |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.png/pngimage/hasbackgroundcolor) { get; set; } | يحصل على قيمة تشير إلى ما إذا كان له لون خلفية. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.png/pngimage/hastransparentcolor) { get; set; } | يحصل على قيمة تشير إلى ما إذا كانت الصورة ذات لون شفاف. |
| override [Height](../../aspose.imaging.fileformats.png/pngimage/height) { get; } | الحصول على الارتفاع. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.png/pngimage/horizontalresolution) { get; set; } | الحصول على الدقة الأفقية أو تعيينها . |
| virtual [ImageOpacity](../../aspose.imaging/rasterimage/imageopacity) { get; } | يحصل على عتامة هذه الصورة . |
| [Interlaced](../../aspose.imaging.fileformats.png/pngimage/interlaced) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا[`PngImage`](../pngimage) متشابك. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.png/pngimage/isinterlaced) { get; } | يحصل على قيمة تشير إلى ما إذا كان مثيل الصورة هذا متشابكًا. |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.png/pngimage/rawdataformat) { get; } | يحصل على تنسيق البيانات الأولية. |
...
| override [TransparentColor](../../aspose.imaging.fileformats.png/pngimage/transparentcolor) { get; set; } | يحصل على اللون الشفاف . |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.png/pngimage/verticalresolution) { get; set; } | الحصول على الدقة الرأسية أو تعيينها . |
| override [Width](../../aspose.imaging.fileformats.png/pngimage/width) { get; } | الحصول على العرض . |
| override [XmpData](../../aspose.imaging.fileformats.png/pngimage/xmpdata) { get; set; } | الحصول على بيانات تعريف XMP أو تعيينها. |
