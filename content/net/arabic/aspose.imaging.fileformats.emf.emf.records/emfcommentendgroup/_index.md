...
description: يحدد سجل EMR_COMMENT_ENDGROUP نهاية مجموعة سجلات الرسم.
type: docs
weight: 3390
url: /ar/aspose.imaging.fileformats.emf.emf.records/emfcommentendgroup/
---
## EmfCommentEndGroup class

يحدد سجل EMR_COMMENT_ENDGROUP نهاية مجموعة سجلات الرسم.
...
| اسم | وصف |
| --- | --- |
| [EmfCommentEndGroup](emfcommentendgroup)(EmfRecord) | يقوم بتهيئة مثيل جديد لملف[`EmfCommentEndGroup`](../emfcommentendgroup) فئة . |
