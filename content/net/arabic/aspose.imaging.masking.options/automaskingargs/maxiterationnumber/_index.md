...
description: الحصول على أو تعيين الحد الأقصى لعدد التكرارات .
type: docs
weight: 20
url: /ar/aspose.imaging.masking.options/automaskingargs/maxiterationnumber/
---
## AutoMaskingArgs.MaxIterationNumber property

الحصول على أو تعيين الحد الأقصى لعدد التكرارات .
