...
description: الحصول على أو تعيين مستطيلات الكائنات التي تنتمي إلى كائنات منفصلة اختياري . يتم استخدام هذه المعلمة لزيادة دقة طريقة التجزئة.
type: docs
weight: 50
url: /ar/aspose.imaging.masking.options/automaskingargs/objectsrectangles/
---
## AutoMaskingArgs.ObjectsRectangles property

الحصول على أو تعيين مستطيلات الكائنات التي تنتمي إلى كائنات منفصلة (اختياري) . يتم استخدام هذه المعلمة لزيادة دقة طريقة التجزئة.
