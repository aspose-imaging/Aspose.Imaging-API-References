...
description: يمثل أBrush../aspose.imaging/brush مع التدرج الخطي المحدد بألوان متعددة والمواضع المناسبة. لا يمكن توريث هذه الفئة.
type: docs
weight: 170
url: /ar/aspose.imaging.brushes/linearmulticolorgradientbrush/
---
## LinearMulticolorGradientBrush class

يمثل أ[`Brush`](../../aspose.imaging/brush) مع التدرج الخطي المحدد بألوان متعددة والمواضع المناسبة. لا يمكن توريث هذه الفئة.
...
| اسم | وصف |
| --- | --- |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor)() | يقوم بتهيئة مثيل جديد لملف[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) فئة ذات معلمات افتراضية . لون البداية أسود ولون النهاية أبيض والزاوية 45 درجة والمستطيل يقع في (0،0) بحجم (1،1) . |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_1)(Point, Point) | يقوم بتهيئة مثيل جديد لملف[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) فئة بالنقاط المحددة. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_2)(PointF, PointF) | يقوم بتهيئة مثيل جديد لملف[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) فئة بالنقاط المحددة. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_3)(Rectangle, float) | يقوم بتهيئة مثيل جديد لملف[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) فئة تعتمد على مستطيل وزاوية اتجاه. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_5)(RectangleF, float) | يقوم بتهيئة مثيل جديد لملف[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) فئة تعتمد على مستطيل وزاوية اتجاه. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_4)(Rectangle, float, bool) | يقوم بتهيئة مثيل جديد لملف[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) فئة تعتمد على مستطيل وزاوية اتجاه. |
| [LinearMulticolorGradientBrush](linearmulticolorgradientbrush#constructor_6)(RectangleF, float, bool) | يقوم بتهيئة مثيل جديد لملف[`LinearMulticolorGradientBrush`](../linearmulticolorgradientbrush) فئة تعتمد على مستطيل وزاوية اتجاه. |
...
| [InterpolationColors](../../aspose.imaging.brushes/linearmulticolorgradientbrush/interpolationcolors) { get; set; } | يحصل أو يحدد أ[`ColorBlend`](../../aspose.imaging/colorblend) التي تحدد تدرج خطي متعدد الألوان. |
