...
description: يمثل أBrush../aspose.imaging/brush مع إمكانيات التدرج والخصائص المناسبة.
type: docs
weight: 160
url: /ar/aspose.imaging.brushes/lineargradientbrushbase/
---
## LinearGradientBrushBase class

يمثل أ[`Brush`](../../aspose.imaging/brush) مع إمكانيات التدرج والخصائص المناسبة.
...
| [IsAngleScalable](../../aspose.imaging.brushes/lineargradientbrushbase/isanglescalable) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان[`Angle`](./angle) تم تغييره أثناء التحويل مع هذا[`LinearGradientBrushBase`](../lineargradientbrushbase) . |
