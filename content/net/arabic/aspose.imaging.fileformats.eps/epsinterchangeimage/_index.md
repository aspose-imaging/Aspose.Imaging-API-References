...
description: فئة تنسيق Encapsulated PostScript Interchange
type: docs
weight: 6570
url: /ar/aspose.imaging.fileformats.eps/epsinterchangeimage/
---
## EpsInterchangeImage class

فئة تنسيق Encapsulated PostScript Interchange
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsinterchangeimage/epstype) { get; } | الحصول على قيمة النوع الفرعي EPS |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | الحصول على قيمة تشير إلى ما إذا كان هذا المثيل يحتوي على معاينة بيانات نقطية خاصة بالتنسيق |
...
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | الحصول على ارتفاع صورة المعاينة |
| [PreviewWidth](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewwidth) { get; } | يحصل على عرض معاينة الصورة |
| [RasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/rasterpreview) { get; } | الحصول على معاينة البيانات النقطية لـ b / w (إن وجدت) أو null |
...
| [ConvertToBinary](../../aspose.imaging.fileformats.eps/epsinterchangeimage/converttobinary)() | تحويل هذا المثيل إلى[`EpsBinaryImage`](../epsbinaryimage) |
...
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ImageResizeSettings) | يغير حجم الصورة. |
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ResizeType) | يغير حجم الصورة. |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | يقوم بإجراء تحويل صريح من[`EpsBinaryImage`](../epsbinaryimage) إلى[`EpsInterchangeImage`](../epsinterchangeimage) |
