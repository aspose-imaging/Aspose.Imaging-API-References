...
description: يمثل شكل قطع ناقص.
type: docs
weight: 10980
url: /ar/aspose.imaging.shapes/ellipseshape/
---
## EllipseShape class
...
| اسم | وصف |
| --- | --- |
| [EllipseShape](ellipseshape#constructor)() | يقوم بتهيئة مثيل جديد لملف[`EllipseShape`](../ellipseshape) فئة . |
| [EllipseShape](ellipseshape#constructor_1)(RectangleF) | يقوم بتهيئة مثيل جديد لملف[`EllipseShape`](../ellipseshape) فئة . |
...
| override [Segments](../../aspose.imaging.shapes/ellipseshape/segments) { get; } | الحصول على شرائح الشكل . |
