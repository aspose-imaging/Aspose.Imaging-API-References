...
description: الحصول على أو تحديد أقصى فرق بكسل مسموح به. إذا كانت القيمة أكبر من الصفر  فسيتم استخدام ضغط الفقد . القيمة الموصى بها للضغط الأمثل مع فقدان البيانات هي 80. 30 ضغط خفيف جدًا  و 200 ثقيل . يعمل بشكل أفضل عند تقديم خسارة قليلة فقط  وبسبب قيود خوارزمية الضغط مستويات الخسارة العالية جدًا لن تعطي قدرًا كبيرًا من المكاسب . نطاق القيم المسموح بها هو 0  1000 .
type: docs
weight: 110
url: /ar/aspose.imaging.imageoptions/gifoptions/maxdiff/
---
## GifOptions.MaxDiff property

الحصول على أو تحديد أقصى فرق بكسل مسموح به. إذا كانت القيمة أكبر من الصفر ، فسيتم استخدام ضغط الفقد . القيمة الموصى بها للضغط الأمثل مع فقدان البيانات هي 80. 30 ضغط خفيف جدًا ، و 200 ثقيل . يعمل بشكل أفضل عند تقديم خسارة قليلة فقط ، وبسبب قيود خوارزمية الضغط مستويات الخسارة العالية جدًا لن تعطي قدرًا كبيرًا من المكاسب . نطاق القيم المسموح بها هو [0 ، 1000] .
