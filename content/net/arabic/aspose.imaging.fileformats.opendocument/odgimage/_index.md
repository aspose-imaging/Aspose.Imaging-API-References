...
description: المستند المفتوح Graphic
type: docs
weight: 7390
url: /ar/aspose.imaging.fileformats.opendocument/odgimage/
---
## OdgImage class

المستند المفتوح Graphic
...
| اسم | وصف |
| --- | --- |
| [OdgImage](odgimage#constructor)(StreamContainer) | يقوم بتهيئة مثيل جديد لملف[`OdgImage`](../odgimage) فئة . |
| [OdgImage](odgimage#constructor_1)(StreamContainer, LoadOptions) | يقوم بتهيئة مثيل جديد لملف[`OdgImage`](../odgimage) فئة . |
...
| override [PageExportingAction](../../aspose.imaging.fileformats.opendocument/odgimage/pageexportingaction) { get; set; } | الحصول على إجراء تصدير الصفحة أو تعيينه . يرجى ملاحظة أن تعيين هذه الطريقة سيؤدي تلقائيًا إلى تحرير موارد الصفحة بعد تنفيذها. سيتم تنفيذها قبل حفظ كل صفحة مباشرةً. |
| override [Pages](../../aspose.imaging.fileformats.opendocument/odgimage/pages) { get; } | الحصول على الصفحات . |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.opendocument/odgimage/getdefaultoptions)(object[]) | يحصل على الخيارات الافتراضية . |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_1)(int, int, ImageResizeSettings) | يغير حجم الصورة. |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_2)(int, int, ResizeType) | يغير حجم الصورة. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.opendocument/odgimage/rotateflip)(RotateFlipType) | يقوم بتدوير الصورة أو قلبها أو تدويرها وقلبها. |
...
يقوم هذا المثال بتحميل صورة ODG متعددة الصفحات.
