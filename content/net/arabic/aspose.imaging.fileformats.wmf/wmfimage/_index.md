...
description: صورة Wmf
type: docs
weight: 9280
url: /ar/aspose.imaging.fileformats.wmf/wmfimage/
---
## WmfImage class
...
| اسم | وصف |
| --- | --- |
| [WmfImage](wmfimage#constructor)() | يقوم بتهيئة مثيل جديد لملف[`WmfImage`](../wmfimage) فئة . |
| [WmfImage](wmfimage#constructor_1)(int, int) | يقوم بتهيئة مثيل جديد لملف[`WmfImage`](../wmfimage) فئة . |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.wmf/wmfimage/bitsperpixel) { get; } | الحصول على عدد بتات الصورة لكل بكسل . |
...
| override [FileFormat](../../aspose.imaging.fileformats.wmf/wmfimage/fileformat) { get; } | يحصل على قيمة تنسيق الملف |
| [FrameBounds](../../aspose.imaging.fileformats.wmf/wmfimage/framebounds) { get; } | يحصل على حدود الإطار . |
...
| override [Height](../../aspose.imaging.fileformats.wmf/wmfimage/height) { get; } | الحصول على ارتفاع الصورة . |
| virtual [HeightF](../../aspose.imaging/vectorimage/heightf) { get; } | الحصول على ارتفاع الكائن بالبوصة . |
| [Inch](../../aspose.imaging.fileformats.wmf/wmfimage/inch) { get; set; } | الحصول على أو تعيين البوصة . |
| [InterruptMonitor](../../aspose.imaging/image/interruptmonitor) { get; set; } | الحصول على أو تعيين شاشة المقاطعة. |
| override [IsCached](../../aspose.imaging.fileformats.wmf/wmfimage/iscached) { get; } | يحصل على قيمة تشير إلى ما إذا كانت بيانات الكائن مخزنة مؤقتًا حاليًا ولا يلزم قراءة بيانات. |
...
| override [Width](../../aspose.imaging.fileformats.wmf/wmfimage/width) { get; } | الحصول على عرض الصورة . |
...
| اسم | وصف |
| --- | --- |
| [AddRecord](../../aspose.imaging.fileformats.wmf/wmfimage/addrecord)(WmfObject) | إضافة السجل . |
| override [CacheData](../../aspose.imaging.fileformats.wmf/wmfimage/cachedata)() | يخزن البيانات مؤقتًا ويضمن عدم إجراء تحميل بيانات إضافي من الملف الأساسي [`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [Crop](../../aspose.imaging.fileformats.wmf/wmfimage/crop#crop)(Rectangle) | يقطع المستطيل المحدد . |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.wmf/wmfimage/getdefaultoptions)(object[]) | يحصل على الخيارات الافتراضية . |
...
| [GetPostScript](../../aspose.imaging.fileformats.wmf/wmfimage/getpostscript)() | يحصل على نص المنشور. |
| override [GetUsedFonts](../../aspose.imaging.fileformats.wmf/wmfimage/getusedfonts)() | إرجاع قائمة الخطوط المستخدمة داخل ملف التعريف. |
| [Resize](../../aspose.imaging/image/resize)(int, int) | يغير حجم الصورة. الافتراضيNearestNeighbourResample يستخدم . |
| override [Resize](../../aspose.imaging.fileformats.wmf/wmfimage/resize#resize_1)(int, int, ImageResizeSettings) | يغير حجم الصورة. |
| override [Resize](../../aspose.imaging.fileformats.wmf/wmfimage/resize#resize_2)(int, int, ResizeType) | يغير حجم الصورة. |
| override [ResizeCanvas](../../aspose.imaging.fileformats.wmf/wmfimage/resizecanvas)(Rectangle) | يغير حجم اللوحة . |
...
| override [RotateFlip](../../aspose.imaging.fileformats.wmf/wmfimage/rotateflip)(RotateFlipType) | يقوم بتدوير الصورة أو قلبها أو تدويرها وقلبها. |
...
| override [SetPalette](../../aspose.imaging.fileformats.wmf/wmfimage/setpalette)(IColorPalette, bool) | يضبط لوحة الصور . |

### أمثلة

يوضح المثال التالي كيفية تحويل صور wmz إلى wmf fromat
