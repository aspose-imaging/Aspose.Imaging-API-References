...
type: docs
weight: 280
url: /ar/aspose.imaging.fileformats.djvu/djvuimage/resizewidthproportionally/
---
...
يقوم هذا المثال بتحميل صورة DJVU وتغيير حجمها بشكل متناسب باستخدام طرق تغيير الحجم المختلفة. يتم تحديد العرض فقط ، ويتم حساب الارتفاع تلقائيًا.
