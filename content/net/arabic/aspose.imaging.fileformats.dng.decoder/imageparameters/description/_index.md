...
description: الحصول على وصف الألوان RGBG أو RGBE أو GMCY أو GBTG .
type: docs
weight: 30
url: /ar/aspose.imaging.fileformats.dng.decoder/imageparameters/description/
---
## ImageParameters.Description property

الحصول على وصف الألوان (RGBG أو RGBE أو GMCY أو GBTG) .
