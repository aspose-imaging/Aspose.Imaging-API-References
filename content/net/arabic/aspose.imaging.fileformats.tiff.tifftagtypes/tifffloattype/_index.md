...
description: نوع تعويم tiff .
type: docs
weight: 7950
url: /ar/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/
---
## TiffFloatType class
...
| اسم | وصف |
| --- | --- |
| [TiffFloatType](tifffloattype#constructor)(TiffTags) | يقوم بتهيئة مثيل جديد لملف[`TiffFloatType`](../tifffloattype) فئة . |
| [TiffFloatType](tifffloattype#constructor_1)(ushort) | يقوم بتهيئة مثيل جديد لملف[`TiffFloatType`](../tifffloattype) فئة . |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/elementsize) { get; } | الحصول على حجم العنصر بالبايت. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/tagtype) { get; } | يحصل على نوع العلامة . |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/value) { get; set; } | الحصول على القيمة التي يحتوي عليها نوع البيانات هذا أو تعيينها. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/values) { get; set; } | الحصول على القيم أو تعيينها. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/writeadditionaldata)(TiffStreamWriter) | يكتب بيانات العلامة الإضافية . |
