...
type: docs
weight: 7980
url: /ar/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/
---
...
| اسم | وصف |
| --- | --- |
| [TiffRationalType](tiffrationaltype#constructor)(TiffTags) | يقوم بتهيئة مثيل جديد لملف[`TiffRationalType`](../tiffrationaltype) فئة . |
| [TiffRationalType](tiffrationaltype#constructor_1)(ushort) | يقوم بتهيئة مثيل جديد لملف[`TiffRationalType`](../tiffrationaltype) فئة . |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/elementsize) { get; } | الحصول على حجم العنصر بالبايت. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/tagtype) { get; } | يحصل على نوع العلامة . |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/value) { get; set; } | الحصول على القيمة التي يحتوي عليها نوع البيانات هذا أو تعيينها. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/values) { get; set; } | الحصول على القيم أو تعيينها. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/writeadditionaldata)(TiffStreamWriter) | يكتب بيانات العلامة الإضافية . |
