...
description: النوع العقلاني المُوقع لـ tiff .
type: docs
weight: 8010
url: /ar/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/
---
## TiffSRationalType class

النوع العقلاني المُوقع لـ tiff .
...
| اسم | وصف |
| --- | --- |
| [TiffSRationalType](tiffsrationaltype#constructor)(TiffTags) | يقوم بتهيئة مثيل جديد لملف[`TiffSRationalType`](../tiffsrationaltype) فئة . |
| [TiffSRationalType](tiffsrationaltype#constructor_1)(ushort) | يقوم بتهيئة مثيل جديد لملف[`TiffSRationalType`](../tiffsrationaltype) فئة . |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/elementsize) { get; } | الحصول على حجم العنصر بالبايت. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/tagtype) { get; } | يحصل على نوع العلامة . |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/value) { get; set; } | الحصول على القيمة التي يحتوي عليها نوع البيانات هذا أو تعيينها. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/values) { get; set; } | الحصول على القيم أو تعيينها. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/writeadditionaldata)(TiffStreamWriter) | يكتب بيانات العلامة الإضافية . |
