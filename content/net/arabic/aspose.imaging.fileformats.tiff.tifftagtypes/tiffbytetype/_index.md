...
description: نوع بايت tiff .
type: docs
weight: 7920
url: /ar/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/
---
## TiffByteType class
...
| اسم | وصف |
| --- | --- |
| [TiffByteType](tiffbytetype#constructor)(TiffTags) | يقوم بتهيئة مثيل جديد لملف[`TiffByteType`](../tiffbytetype) فئة . |
| [TiffByteType](tiffbytetype#constructor_1)(ushort) | يقوم بتهيئة مثيل جديد لملف[`TiffByteType`](../tiffbytetype) فئة . |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/elementsize) { get; } | الحصول على حجم العنصر بالبايت. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/tagtype) { get; } | يحصل على نوع العلامة . |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/value) { get; set; } | الحصول على القيمة التي يحتوي عليها نوع البيانات هذا أو تعيينها. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/values) { get; set; } | الحصول على القيم أو تعيينها. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/writeadditionaldata)(TiffStreamWriter) | يكتب بيانات العلامة الإضافية . |
