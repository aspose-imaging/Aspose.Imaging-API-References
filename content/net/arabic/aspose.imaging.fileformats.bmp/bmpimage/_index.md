...
description: صورة bmp تدعم تنسيقات BMP و DIB .
type: docs
weight: 1380
url: /ar/aspose.imaging.fileformats.bmp/bmpimage/
---
## BmpImage class

صورة bmp (تدعم تنسيقات BMP و DIB) .
...
| اسم | وصف |
| --- | --- |
| [BmpImage](bmpimage#constructor)(RasterImage) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_5)(Stream) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_7)(string) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_2)(int, int) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_3)(int, int, ushort, IColorPalette) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_1)(RasterImage, ushort, BitmapCompression, double, double) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_6)(Stream, ushort, BitmapCompression, double, double) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_8)(string, ushort, BitmapCompression, double, double) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
| [BmpImage](bmpimage#constructor_4)(int, int, ushort, IColorPalette, BitmapCompression, double, double) | يقوم بتهيئة مثيل جديد لملف[`BmpImage`](../bmpimage) فئة . |
...
| [BitmapInfoHeader](../../aspose.imaging.fileformats.bmp/bmpimage/bitmapinfoheader) { get; } | الحصول على رأس معلومات الصورة النقطية. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.bmp/bmpimage/bitsperpixel) { get; } | الحصول على عدد بتات الصورة لكل بكسل . |
...
| [Compression](../../aspose.imaging.fileformats.bmp/bmpimage/compression) { get; } | يحصل على ضغط الصورة . |
...
| override [FileFormat](../../aspose.imaging.fileformats.bmp/bmpimage/fileformat) { get; } | يحصل على قيمة تنسيق الملف |
...
| override [Height](../../aspose.imaging.fileformats.bmp/bmpimage/height) { get; } | الحصول على ارتفاع الصورة . |
| override [HorizontalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/horizontalresolution) { get; set; } | الحصول على أو تعيين الدقة الأفقية ، بالبكسل في البوصة ، لهذا[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.bmp/bmpimage/rawdataformat) { get; } | يحصل على تنسيق البيانات الأولية. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.bmp/bmpimage/rawlinesize) { get; } | الحصول على حجم الخط الخام بالبايت. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/verticalresolution) { get; set; } | الحصول على أو تحديد الدقة الرأسية ، بالبكسل في البوصة ، لهذا[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.bmp/bmpimage/width) { get; } | الحصول على عرض الصورة . |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.bmp/bmpimage/getdefaultoptions)(object[]) | يحصل على الخيارات الافتراضية . |
...
| override [SetResolution](../../aspose.imaging.fileformats.bmp/bmpimage/setresolution)(double, double) | يضبط الدقة لهذا الغرض[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [ToBitmap](../../aspose.imaging.fileformats.bmp/bmpimage/tobitmap)() | تحويل الصورة النقطية إلى الصورة النقطية. |
...
{
    // املأ الصورة بتدرج لوني أحمر-أسود خطي بسيط.
