...
description: الحصول على الدقة الرأسية  بالبكسل في البوصة  لهذاImageaspose.imaging/image .
type: docs
weight: 120
url: /ar/aspose.imaging.fileformats.tiff/tiffimage/verticalresolution/
---
## TiffImage.VerticalResolution property

الحصول على الدقة الرأسية ، بالبكسل في البوصة ، لهذا[`Image`](../../../aspose.imaging/image) .
