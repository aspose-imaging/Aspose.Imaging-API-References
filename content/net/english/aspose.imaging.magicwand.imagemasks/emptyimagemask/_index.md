...
| Name | Description |
| --- | --- |
| [EmptyImageMask](emptyimagemask)(int, int) | Initializes a new instance of the [`EmptyImageMask`](../emptyimagemask) class with the specified width and height. |
...
| override [Crop](../../aspose.imaging.magicwand.imagemasks/emptyimagemask/crop)(Rectangle) | Crops mask with the specified rectangle. |
