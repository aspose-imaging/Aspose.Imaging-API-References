...
| Name | Description |
| --- | --- |
| [CircleMask](circlemask)(Point, int) | Initializes a new instance of the [`CircleMask`](../circlemask) class with the specified center point and radius. |
| [CircleMask](circlemask)(int, int, int) | Initializes a new instance of the [`CircleMask`](../circlemask) class with the specified center point and radius. |
...
| override [Crop](../../aspose.imaging.magicwand.imagemasks/circlemask/crop)(Rectangle) | Crops mask with the specified rectangle. |
