...
type: docs
weight: 6070
url: /aspose.imaging.fileformats.emf.emfplus.records/emfplusfillclosedcurve/
---
...
| [Winding](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusfillclosedcurve/winding) { get; set; } | Gets or sets a value indicating whether this [`EmfPlusFillClosedCurve`](../emfplusfillclosedcurve) is winding. This bit indicates how to perform the fill operation. If set, the fill is a "winding" fill. If clear, the fill is an "alternate" fill. |
