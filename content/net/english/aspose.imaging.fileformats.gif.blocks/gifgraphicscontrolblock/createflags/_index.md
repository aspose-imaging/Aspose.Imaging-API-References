...
type: docs
weight: 120
url: /aspose.imaging.fileformats.gif.blocks/gifgraphicscontrolblock/createflags/
---
...
| --- | --- | --- |
| hasTransparentColor | Boolean | if set to `true` the [`GifGraphicsControlBlock`](../../gifgraphicscontrolblock) has valid transparent color index. |
