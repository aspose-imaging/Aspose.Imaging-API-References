...
description: 带有二进制标头的封装 PostScript 格式的类
type: docs
weight: 6550
url: /zh/aspose.imaging.fileformats.eps/epsbinaryimage/
---
## EpsBinaryImage class

带有二进制标头的封装 PostScript 格式的类
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsbinaryimage/op_explicit) | 执行显式转换[`EpsInterchangeImage`](../epsinterchangeimage)至[`EpsBinaryImage`](../epsbinaryimage) |
