...
description: EMR_COMMENT_ENDGROUP 记录指定一组绘图记录的结尾
type: docs
weight: 3390
url: /zh/aspose.imaging.fileformats.emf.emf.records/emfcommentendgroup/
---
## EmfCommentEndGroup class

EMR_COMMENT_ENDGROUP 记录指定一组绘图记录的结尾。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfCommentEndGroup](emfcommentendgroup)(EmfRecord) | 初始化[`EmfCommentEndGroup`](../emfcommentendgroup)类. |
