...
description: EmfMetafileHeaderExtension2 记录是在 EMF 元文件的第二个扩展中使用的标头记录在 EmfHeaderExtension2 字段之后其余字段是可选的 可以以任何顺序出现
type: docs
weight: 3830
url: /zh/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/
---
...
| 姓名 | 描述 |
| --- | --- |
| [EmfMetafileHeaderExtension2](emfmetafileheaderextension2#constructor)(EmfMetafileHeaderExtension1) | 初始化[`EmfMetafileHeaderExtension2`](../emfmetafileheaderextension2)类. |
| [EmfMetafileHeaderExtension2](emfmetafileheaderextension2#constructor_1)(EmfMetafileHeaderExtension2) | 初始化[`EmfMetafileHeaderExtension2`](../emfmetafileheaderextension2)类. |
...
| [EmfHeaderExtension1](../../aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension1/emfheaderextension1) { get; set; } | 获取或设置 HeaderExtension1 对象，该对象指定有关元文件中图像的附加信息。 |
| [EmfHeaderExtension2](../../aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/emfheaderextension2) { get; set; } | 获取或设置一个 HeaderExtension2 对象，该对象指定有关元文件中图像的附加信息 |
...
| [EmfPixelFormatBuffer](../../aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension1/emfpixelformatbuffer) { get; set; } | 获取或设置一个可选的字节数组，其中包含 EMF 像素格式描述符， 不需要与 EmfMetafileHeaderExtension1 记录的固定部分或 EMF 描述字符串连续。因此，此缓冲区中标记为“UndefinedSpace”的字段是 可选的，必须被忽略 |
