...
description: 一个 jpeg 图像
type: docs
weight: 6770
url: /zh/aspose.imaging.fileformats.jpeg/jpegimage/
---
## JpegImage class
...
| 姓名 | 描述 |
| --- | --- |
| [JpegImage](jpegimage#constructor_1)(RasterImage) | 初始化[`JpegImage`](../jpegimage)类. |
| [JpegImage](jpegimage#constructor_3)(Stream) | 初始化[`JpegImage`](../jpegimage)类. |
| [JpegImage](jpegimage#constructor_4)(string) | 初始化[`JpegImage`](../jpegimage)类. |
| [JpegImage](jpegimage#constructor_2)(int, int) | 初始化[`JpegImage`](../jpegimage)类. |
| [JpegImage](jpegimage#constructor)(JpegOptions, int, int) | 初始化[`JpegImage`](../jpegimage)类. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg/jpegimage/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| [CmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/cmykcolorprofile) { get; set; } | CMYK 和 YCCK jpeg 图像的 CMYK 颜色配置文件。必须与 RGBColorProfile 配对以进行正确的颜色转换。 |
| [Comment](../../aspose.imaging.fileformats.jpeg/jpegimage/comment) { get; set; } | 获取或设置jpeg文件注释。 |
...
| [DestinationCmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationcmykcolorprofile) { get; set; } | CMYK 和 YCCK jpeg 图像的 CMYK 颜色配置文件，用于图像保存过程。必须与 RGBColorProfile 配对以进行正确的颜色转换。 |
| [DestinationRgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationrgbcolorprofile) { get; set; } | CMYK 和 YCCK jpeg 图像的 RGB 颜色配置文件，用于图像保存过程。必须与 CMYKColorProfile 配对以进行正确的颜色转换。 |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | 获取一个值，该值指示此实例是否被释放。 |
| [ExifData](../../aspose.imaging.fileformats.jpeg/jpegimage/exifdata) { get; set; } | 获取或设置exif数据容器 |
| override [FileFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/fileformat) { get; } | 获取文件格式的值 |
...
| override [Height](../../aspose.imaging.fileformats.jpeg/jpegimage/height) { get; } | 获取图像高度。 |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/horizontalresolution) { get; set; } | 获取或设置此图像的水平分辨率，以每英寸像素为单位[`RasterImage`](../../aspose.imaging/rasterimage) . |
| [IgnoreEmbeddedColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/ignoreembeddedcolorprofile) { get; set; } | 获取或设置一个值，该值指示是否忽略嵌入的颜色配置文件。如果忽略嵌入的颜色配置文件，则使用默认颜色配置文件。 |
...
| [Jfif](../../aspose.imaging.fileformats.jpeg/jpegimage/jfif) { get; set; } | 获取或设置 jfif. |
| [JpegOptions](../../aspose.imaging.fileformats.jpeg/jpegimage/jpegoptions) { get; } | 获取用于创建或加载此文件的 JPEG 选项[`JpegImage`](../jpegimage)实例. |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/rawdataformat) { get; } | 获取原始数据格式。 |
...
| [RgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/rgbcolorprofile) { get; set; } | CMYK 和 YCCK jpeg 图像的 RGB 颜色配置文件。必须与 CMYKColorProfile 配对以进行正确的颜色转换。 |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/verticalresolution) { get; set; } | 获取或设置此对象的垂直分辨率，以每英寸像素为单位[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.jpeg/jpegimage/width) { get; } | 获取图像宽度。 |
| override [XmpData](../../aspose.imaging.fileformats.jpeg/jpegimage/xmpdata) { get; set; } | 获取或设置 XMP 元数据。 |
...
| [AutoRotate](../../aspose.imaging.fileformats.jpeg/jpegimage/autorotate)() | 根据 Exif 提供的方向数据执行图像的自动旋转。 |
...
| override [GetModifyDate](../../aspose.imaging.fileformats.jpeg/jpegimage/getmodifydate)(bool) | 获取上次修改资源图像的日期和时间。 |
...
| override [SetResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/setresolution)(double, double) | 为此设置分辨率[`RasterImage`](../../aspose.imaging/rasterimage) . |
