...
description: CMYK 和 YCCK jpeg 图像的 RGB 颜色配置文件必须与 CMYKColorProfile 配对以进行正确的颜色转换
type: docs
weight: 150
url: /zh/aspose.imaging.fileformats.jpeg/jpegimage/rgbcolorprofile/
---
## JpegImage.RgbColorProfile property

CMYK 和 YCCK jpeg 图像的 RGB 颜色配置文件。必须与 CMYKColorProfile 配对以进行正确的颜色转换。
