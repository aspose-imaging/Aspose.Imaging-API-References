...
description: 一张bmp图片支持BMPDIB格式
type: docs
weight: 1380
url: /zh/aspose.imaging.fileformats.bmp/bmpimage/
---
## BmpImage class
...
| 姓名 | 描述 |
| --- | --- |
| [BmpImage](bmpimage#constructor)(RasterImage) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_5)(Stream) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_7)(string) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_2)(int, int) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_3)(int, int, ushort, IColorPalette) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_1)(RasterImage, ushort, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_6)(Stream, ushort, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_8)(string, ushort, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类. |
| [BmpImage](bmpimage#constructor_4)(int, int, ushort, IColorPalette, BitmapCompression, double, double) | 初始化[`BmpImage`](../bmpimage)类. |
...
| [BitmapInfoHeader](../../aspose.imaging.fileformats.bmp/bmpimage/bitmapinfoheader) { get; } | 获取位图信息头 |
| override [BitsPerPixel](../../aspose.imaging.fileformats.bmp/bmpimage/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| [Compression](../../aspose.imaging.fileformats.bmp/bmpimage/compression) { get; } | 获取图像压缩。 |
...
| override [FileFormat](../../aspose.imaging.fileformats.bmp/bmpimage/fileformat) { get; } | 获取文件格式的值 |
...
| override [Height](../../aspose.imaging.fileformats.bmp/bmpimage/height) { get; } | 获取图像高度。 |
| override [HorizontalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/horizontalresolution) { get; set; } | 获取或设置此图像的水平分辨率，以每英寸像素为单位[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.bmp/bmpimage/rawdataformat) { get; } | 获取原始数据格式。 |
...
| override [RawLineSize](../../aspose.imaging.fileformats.bmp/bmpimage/rawlinesize) { get; } | 以字节为单位获取原始行大小。 |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/verticalresolution) { get; set; } | 获取或设置此对象的垂直分辨率，以每英寸像素为单位[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.bmp/bmpimage/width) { get; } | 获取图像宽度。 |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.bmp/bmpimage/getdefaultoptions)(object[]) | 获取默认选项。 |
...
| override [SetResolution](../../aspose.imaging.fileformats.bmp/bmpimage/setresolution)(double, double) | 为此设置分辨率[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [ToBitmap](../../aspose.imaging.fileformats.bmp/bmpimage/tobitmap)() | 将光栅图像转换为位图。 |
