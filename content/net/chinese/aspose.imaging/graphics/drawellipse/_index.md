...
description: 绘制由边界定义的椭圆RectangleFaspose.imaging/rectanglef .
type: docs
weight: 210
url: /zh/aspose.imaging/graphics/drawellipse/
---
## DrawEllipse(Pen, RectangleF) {#drawellipse_1}

绘制由边界定义的椭圆[`RectangleF`](../../rectanglef) .
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen)它决定了椭圆的颜色、宽度和样式。 |
...
绘制由边界指定的椭圆[`Rectangle`](../../rectangle)结构.
...
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen)它决定了椭圆的颜色、宽度和样式。 |
| rect | Rectangle | [`Rectangle`](../../rectangle)定义椭圆边界的结构。 |
