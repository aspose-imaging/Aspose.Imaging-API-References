...
type: docs
weight: 10800
url: /zh/aspose.imaging/rastercachedmultipageimage/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging/rastercachedmultipageimage/adjustbrightness)(int) | 调整一个*brightness*对于图像. |
| override [AdjustContrast](../../aspose.imaging/rastercachedmultipageimage/adjustcontrast)(float) | [`Image`](../image)对比 |
| override [AdjustGamma](../../aspose.imaging/rastercachedmultipageimage/adjustgamma#adjustgamma)(float) | 图像的 Gamma 校正。 |
| override [AdjustGamma](../../aspose.imaging/rastercachedmultipageimage/adjustgamma#adjustgamma_1)(float, float, float) | 图像的 Gamma 校正。 |
...
| override [Crop](../../aspose.imaging/rastercachedmultipageimage/crop#crop_1)(int, int, int, int) | 使用班次裁剪图像。 |
...
| override [NormalizeAngle](../../aspose.imaging/rastercachedmultipageimage/normalizeangle#normalizeangle_1)(bool, Color) | 角度归一化。 此方法适用于扫描的文本文档，以消除倾斜扫描。 此方法使用!:GetSkewAngle和[`Rotate`](./rotate)方法. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging/rastercachedmultipageimage/replacenontransparentcolors#replacenontransparentcolors_1)(int) | 将所有不透明的颜色替换为新颜色并保留原始 alpha 值以保存平滑的边缘。 注意：如果在不透明的图像上使用它，所有颜色都将替换为一个颜色。 |
...
| override [Rotate](../../aspose.imaging/rastercachedmultipageimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate中心周围的图像。 |
