...
description: 基础抽象类可以提供图像遮罩系统的结果图像
type: docs
weight: 10540
url: /zh/aspose.imaging.masking.result/maskingresult/
---
## MaskingResult class

基础抽象类，可以提供图像遮罩系统的结果图像。
...
| [Item](../../aspose.imaging.masking.result/maskingresult/item) { get; } | 获取[`IMaskingLayer`](../imaskinglayer)在指定的索引处。 |
...
| [GetEnumerator](../../aspose.imaging.masking.result/maskingresult/getenumerator)() | 获取枚举器。 |

## 字段

| 姓名 | 描述 |
| --- | --- |
| readonly [MaskingOptions](../../aspose.imaging.masking.result/maskingresult/maskingoptions) | 掩蔽选项 |
