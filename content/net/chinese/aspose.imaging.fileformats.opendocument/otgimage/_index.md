...
type: docs
weight: 7400
url: /zh/aspose.imaging.fileformats.opendocument/otgimage/
---
## OtgImage class
...
| 姓名 | 描述 |
| --- | --- |
| [OtgImage](otgimage#constructor)(StreamContainer) | 初始化[`OtgImage`](../otgimage)类. |
| [OtgImage](otgimage#constructor_1)(StreamContainer, LoadOptions) | 初始化[`OtgImage`](../otgimage)类. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.opendocument/odimage/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| override [FileFormat](../../aspose.imaging.fileformats.opendocument/otgimage/fileformat) { get; } | 获取文件格式的值 |
| virtual [HasBackgroundColor](../../aspose.imaging/image/hasbackgroundcolor) { get; set; } | 获取或设置图像是否有背景色的值。 |
| override [Height](../../aspose.imaging.fileformats.opendocument/odimage/height) { get; } | 获取图像高度。 |
...
| override [IsCached](../../aspose.imaging.fileformats.opendocument/odimage/iscached) { get; } | 获取一个值，表示对象的数据当前是否被缓存，不需要读取数据。 |
| [Metadata](../../aspose.imaging.fileformats.opendocument/odimage/metadata) { get; } | 获取元数据。 |
| override [PageCount](../../aspose.imaging.fileformats.opendocument/odimage/pagecount) { get; } | 获取页数。 |
| override [PageExportingAction](../../aspose.imaging.fileformats.opendocument/otgimage/pageexportingaction) { get; set; } | 获取或设置页面导出动作。 请注意，设置此方法执行后会自动释放页面资源。 会在每页保存前执行。 |
| override [Pages](../../aspose.imaging.fileformats.opendocument/otgimage/pages) { get; } | 获取页面。 |
| [Palette](../../aspose.imaging/image/palette) { get; set; } | 获取或设置调色板。直接表示像素时不使用调色板。 |
| [Records](../../aspose.imaging.fileformats.opendocument/odimage/records) { get; } | 获取记录。 |
...
| override [Width](../../aspose.imaging.fileformats.opendocument/odimage/width) { get; } | 获取图像宽度。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.imaging/vectormultipageimage/cachedata)() | 缓存数据并确保不会从底层执行额外的数据加载 [`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.opendocument/otgimage/getdefaultoptions)(object[]) | 获取默认选项。 |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize)(int, int, ImageResizeSettings) | 调整图像大小。 |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize)(int, int, ResizeType) | 调整图像大小。 |
...
| override [RotateFlip](../../aspose.imaging.fileformats.opendocument/odimage/rotateflip)(RotateFlipType) | 旋转、翻转或旋转和翻转图像。 |
