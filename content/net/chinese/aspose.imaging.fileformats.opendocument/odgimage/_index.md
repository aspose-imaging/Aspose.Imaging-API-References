...
type: docs
weight: 7390
url: /zh/aspose.imaging.fileformats.opendocument/odgimage/
---
## OdgImage class
...
| 姓名 | 描述 |
| --- | --- |
| [OdgImage](odgimage#constructor)(StreamContainer) | 初始化[`OdgImage`](../odgimage)类. |
| [OdgImage](odgimage#constructor_1)(StreamContainer, LoadOptions) | 初始化[`OdgImage`](../odgimage)类. |
...
| override [PageExportingAction](../../aspose.imaging.fileformats.opendocument/odgimage/pageexportingaction) { get; set; } | 获取或设置页面导出动作。 请注意，设置此方法执行后会自动释放页面资源。 会在每页保存前执行。 |
| override [Pages](../../aspose.imaging.fileformats.opendocument/odgimage/pages) { get; } | 获取页面。 |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.opendocument/odgimage/getdefaultoptions)(object[]) | 获取默认选项。 |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_1)(int, int, ImageResizeSettings) | 调整图像大小。 |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_2)(int, int, ResizeType) | 调整图像大小。 |
...
| override [RotateFlip](../../aspose.imaging.fileformats.opendocument/odgimage/rotateflip)(RotateFlipType) | 旋转、翻转或旋转和翻转图像。 |
...
以下示例显示如何将 FODG（平面 XML ODF 模板）图像导出为 PDF 格式。
