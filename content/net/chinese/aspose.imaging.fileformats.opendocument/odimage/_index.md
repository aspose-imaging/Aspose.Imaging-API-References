...
type: docs
weight: 7370
url: /zh/aspose.imaging.fileformats.opendocument/odimage/
---
## OdImage class
...
| 姓名 | 描述 |
| --- | --- |
| [OdImage](odimage#constructor)(StreamContainer) | 初始化[`OdImage`](../odimage)类. |
| [OdImage](odimage#constructor_1)(StreamContainer, LoadOptions) | 初始化[`OdImage`](../odimage)类. |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize#resize_1)(int, int, ImageResizeSettings) | 调整图像大小。 |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize#resize_2)(int, int, ResizeType) | 调整图像大小。 |
