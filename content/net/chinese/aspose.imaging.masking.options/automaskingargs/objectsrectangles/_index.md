...
description: 获取或设置属于分离对象的对象矩形可选 该参数用于提高分割方法的精度
type: docs
weight: 50
url: /zh/aspose.imaging.masking.options/automaskingargs/objectsrectangles/
---
## AutoMaskingArgs.ObjectsRectangles property

获取或设置属于分离对象的对象矩形（可选）。 该参数用于提高分割方法的精度。
