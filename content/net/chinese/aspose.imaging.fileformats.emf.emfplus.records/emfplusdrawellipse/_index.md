...
type: docs
weight: 5950
url: /zh/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawellipse/
---
...
| 姓名 | 描述 |
| --- | --- |
| [EmfPlusDrawEllipse](emfplusdrawellipse)(EmfPlusRecord) | 初始化[`EmfPlusDrawEllipse`](../emfplusdrawellipse)类. |
...
| [ObjectId](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawellipse/objectid) { get; set; } | 获取或设置对象标识符。 EmfPlusPen（第 2.2.1.7 节）对象在 EMF+ 对象表中的索引，用于绘制椭圆。该值必须是 0 到 63，包括在内。 |
| [RectData](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawellipse/rectdata) { get; set; } | 获取或设置矩形数据 定义椭圆边界框的 EmfPlusRect 或 EmfPlusRectF 对象。 |
