...
type: docs
weight: 6280
url: /zh/aspose.imaging.fileformats.emf.emfplus.records/emfplussetantialiasmode/
---
...
| 姓名 | 描述 |
| --- | --- |
| [EmfPlusSetAntiAliasMode](emfplussetantialiasmode)(EmfPlusRecord) | 初始化[`EmfPlusSetAntiAliasMode`](../emfplussetantialiasmode)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AntiAliasing](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetantialiasmode/antialiasing) { get; set; } | 获取或设置一个值，指示是否[抗锯齿]。 如果设置，则应执行抗锯齿。 如果清除，则不应执行抗锯齿。 |
