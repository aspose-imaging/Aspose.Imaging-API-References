...
description: EmfPlusMultiplyWorldTransform 记录将当前世界空间变换乘以一个 指定的变换矩阵
type: docs
weight: 6150
url: /zh/aspose.imaging.fileformats.emf.emfplus.records/emfplusmultiplyworldtransform/
---
## EmfPlusMultiplyWorldTransform class

EmfPlusMultiplyWorldTransform 记录将当前世界空间变换乘以一个 指定的变换矩阵。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfPlusMultiplyWorldTransform](emfplusmultiplyworldtransform)(EmfPlusRecord) | 初始化[`EmfPlusMultiplyWorldTransform`](../emfplusmultiplyworldtransform)类. |
...
| [MatrixData](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusmultiplyworldtransform/matrixdata) { get; set; } | 获取或设置定义乘法矩阵的 EmfPlusTransformMatrix 对象（第 2.2.2.47 节）。 |
| [PostMultipliedMatrix](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusmultiplyworldtransform/postmultipliedmatrix) { get; } | 获取一个值，该值指示是否[后乘矩阵]。 如果设置，则应对变换矩阵进行后乘。如果清楚，应该是预乘。 |
