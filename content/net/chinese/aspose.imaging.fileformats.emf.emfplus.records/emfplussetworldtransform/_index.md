...
description: EmfPlusSetWorldTransform 记录根据 a 指定变换矩阵中的值设置世界变换
type: docs
weight: 6420
url: /zh/aspose.imaging.fileformats.emf.emfplus.records/emfplussetworldtransform/
---
## EmfPlusSetWorldTransform class

EmfPlusSetWorldTransform 记录根据 a 指定变换矩阵中的值设置世界变换。
...
| 姓名 | 描述 |
| --- | --- |
| [EmfPlusSetWorldTransform](emfplussetworldtransform)(EmfPlusRecord) | 初始化[`EmfPlusSetWorldTransform`](../emfplussetworldtransform)类. |
...
| [MatrixData](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetworldtransform/matrixdata) { get; set; } | 获取或设置定义了 新的当前世界变换的 EmfPlusTransformMatrix 对象（第 2.2.2.47 节）。 |
