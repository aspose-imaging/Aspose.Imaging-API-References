...
type: docs
weight: 8370
url: /zh/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| 姓名 | 描述 |
| --- | --- |
| [WmfRecorderGraphics2D](wmfrecordergraphics2d)(Rectangle, int) | 初始化[`WmfRecorderGraphics2D`](../wmfrecordergraphics2d)类. |
...
| 姓名 | 描述 |
| --- | --- |
| static [FromWmfImage](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/fromwmfimage)(WmfImage) | 获取现有 Wmf 映像的 Wmf 记录器实例。 |
