...
type: docs
weight: 7940
url: /zh/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
| 姓名 | 描述 |
| --- | --- |
| [TiffDoubleType](tiffdoubletype#constructor)(TiffTags) | 初始化[`TiffDoubleType`](../tiffdoubletype)类. |
| [TiffDoubleType](tiffdoubletype#constructor_1)(ushort) | 初始化[`TiffDoubleType`](../tiffdoubletype)类. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/elementsize) { get; } | 以字节为单位获取元素大小。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/values) { get; set; } | 获取或设置值。 |
