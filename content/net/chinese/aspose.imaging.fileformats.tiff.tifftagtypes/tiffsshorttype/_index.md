...
description: tiff 签名短类型
type: docs
weight: 8020
url: /zh/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
...
| 姓名 | 描述 |
| --- | --- |
| [TiffSShortType](tiffsshorttype#constructor)(TiffTags) | 初始化[`TiffSShortType`](../tiffsshorttype)类. |
| [TiffSShortType](tiffsshorttype#constructor_1)(ushort) | 初始化[`TiffSShortType`](../tiffsshorttype)类. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/elementsize) { get; } | 以字节为单位获取元素大小。 |
...
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/values) { get; set; } | 获取或设置值。 |
