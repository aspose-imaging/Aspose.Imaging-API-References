...
description: 初始化TiffImageaspose.imaging.fileformats.tiff/tiffimage类.
type: docs
weight: 10
url: /zh/aspose.imaging.fileformats.tiff/tiffimage/tiffimage/
---
## TiffImage(TiffFrame) {#constructor}

初始化[`TiffImage`](../../tiffimage)类.
...
| 例外 | （健康）状况 |
| --- | --- |
| ArgumentNullException | Tiff 框架不能为空。;框架 |
