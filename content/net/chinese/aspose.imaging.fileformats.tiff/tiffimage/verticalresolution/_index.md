...
description: 获取垂直分辨率以每英寸像素为单位Imageaspose.imaging/image .
type: docs
weight: 120
url: /zh/aspose.imaging.fileformats.tiff/tiffimage/verticalresolution/
---
## TiffImage.VerticalResolution property

获取垂直分辨率（以每英寸像素为单位）[`Image`](../../../aspose.imaging/image) .
