...
type: docs
weight: 1430
url: /zh/aspose.imaging.fileformats.cdr/cdrimagepage/
---
## CdrImagePage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimagepage/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimagepage/cdrdocument) { get; } | 获取或设置话单文档。 |
...
| override [Height](../../aspose.imaging.fileformats.cdr/cdrimagepage/height) { get; } | 获取图像高度。 |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimagepage/iscached) { get; } | 获取一个值，该值指示对象的数据当前是否被缓存，不需要读取数据。 |
...
| override [Width](../../aspose.imaging.fileformats.cdr/cdrimagepage/width) { get; } | 获取图像宽度。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimagepage/cachedata)() | 缓存数据并确保不会从底层执行额外的数据加载[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_1)(int, int, ImageResizeSettings) | 调整图像大小。 |
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_2)(int, int, ResizeType) | 调整图像大小。 |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cdr/cdrimagepage/rotateflip)(RotateFlipType) | 旋转、翻转或旋转和翻转图像。 |
