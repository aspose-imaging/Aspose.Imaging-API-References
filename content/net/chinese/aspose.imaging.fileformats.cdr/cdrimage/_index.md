...
type: docs
weight: 1420
url: /zh/aspose.imaging.fileformats.cdr/cdrimage/
---
## CdrImage class
...
| 姓名 | 描述 |
| --- | --- |
| [CdrImage](cdrimage)(Stream, LoadOptions) | 初始化[`CdrImage`](../cdrimage)类. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimage/bitsperpixel) { get; } | 获取每像素计数的图像位数。 |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimage/cdrdocument) { get; } | 获取或设置话单文档。 |
...
| override [FileFormat](../../aspose.imaging.fileformats.cdr/cdrimage/fileformat) { get; } | 获取文件格式的值 |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimage/iscached) { get; } | 获取一个值，该值指示对象的数据当前是否被缓存，不需要读取数据。 |
| override [PageCount](../../aspose.imaging.fileformats.cdr/cdrimage/pagecount) { get; } | 获取或设置页数。 |
| override [PageExportingAction](../../aspose.imaging.fileformats.cdr/cdrimage/pageexportingaction) { get; set; } | 获取或设置页面导出动作。 请注意，设置此方法执行后会自动释放页面资源。 会在每页保存前执行。 |
| override [Pages](../../aspose.imaging.fileformats.cdr/cdrimage/pages) { get; } | 获取页面。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimage/cachedata)() | 缓存数据并确保不会从底层执行额外的数据加载 [`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.cdr/cdrimage/getdefaultoptions)(object[]) | 获取默认选项。 |
...
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimage/resize#resize_1)(int, int, ImageResizeSettings) | 调整图像大小。 |
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimage/resize#resize_2)(int, int, ResizeType) | 调整图像大小。 |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cdr/cdrimage/rotateflip)(RotateFlipType) | 旋转、翻转或旋转和翻转图像。 |
...
| override [SetPalette](../../aspose.imaging.fileformats.cdr/cdrimage/setpalette)(IColorPalette, bool) | 设置图像调色板。 |
