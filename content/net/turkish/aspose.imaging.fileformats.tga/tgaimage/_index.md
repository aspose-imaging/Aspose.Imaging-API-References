...
description: TGA görüntüsü.
type: docs
weight: 7580
url: /tr/aspose.imaging.fileformats.tga/tgaimage/
---
## TgaImage class
...
| İsim | Tanım |
| --- | --- |
| [TgaImage](tgaimage#constructor)(RasterImage) | Yeni bir örneğini başlatır[`TgaImage`](../tgaimage) sınıf. |
| [TgaImage](tgaimage#constructor_1)(Stream) | Yeni bir örneğini başlatır[`TgaImage`](../tgaimage) sınıf. |
| [TgaImage](tgaimage#constructor_2)(string) | Yeni bir örneğini başlatır[`TgaImage`](../tgaimage) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [AuthorComments](../../aspose.imaging.fileformats.tga/tgaimage/authorcomments) { get; set; } | Yazar Yorumlarını alır veya ayarlar. Bu, her biri bir boş sonlandırıcı tarafından takip edilen 80 karakterlik dört satır olarak düzenlenen 324 bayttan oluşan bir ASCII alanıdır. |
| [AuthorName](../../aspose.imaging.fileformats.tga/tgaimage/authorname) { get; set; } | Yazar Adını alır veya ayarlar. Bu alan ad için toplam 40 ASCII karakteridir. Alan kullanılıyorsa, resmi oluşturan kişinin (yazarın) adını içermelidir. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.tga/tgaimage/backgroundcolor) { get; set; } | Arka plan rengini alır veya ayarlar. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.tga/tgaimage/bitsperpixel) { get; } | Piksel başına bit alır. |
...
| [BytesPerPixel](../../aspose.imaging.fileformats.tga/tgaimage/bytesperpixel) { get; } | Piksel başına bayt alır. |
...
| [DateTimeStamp](../../aspose.imaging.fileformats.tga/tgaimage/datetimestamp) { get; set; } | Tarih/Saat Damgasını alır veya ayarlar. Bu alan görüntünün kaydedildiği tarih ve saatin değerini tanımlar. İşletim sistemleri genellikle zaman ve tarih damgası dosyaları olsa da, bu özellik 'dir, çünkü dosya kopyalanırsa işletim sistemi saat ve tarih damgasını değiştirebilir. Bu alanı kullanarak, tarih ve saat kaydı için değiştirilmemiş bir bölge garanti edilir. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Bu örneğin atılıp atılmadığını gösteren bir değer alır. |
| override [FileFormat](../../aspose.imaging.fileformats.tga/tgaimage/fileformat) { get; } | Dosya biçimini alır. |
| [GammaValueDenominator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluedenominator) { get; } | Gama Değer Paydasını Alır kısım. Düzeltilmemiş bir görüntü (gama içermeyen bir görüntü) sonuç olarak 1.0 değerine sahip olmalıdır. |
| [GammaValueNumerator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluenumerator) { get; } | Gama Değeri Payını Alır kısım. Düzeltilmemiş bir görüntü (gama içermeyen bir görüntü) sonuç olarak 1.0 değerine sahip olmalıdır. |
| override [HasAlpha](../../aspose.imaging.fileformats.tga/tgaimage/hasalpha) { get; } | Bunun olup olmadığını gösteren bir değer alır.[`TgaImage`](../tgaimage) bir alfa kanalı var. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.tga/tgaimage/hasbackgroundcolor) { get; set; } | Görüntünün arka plan rengine sahip olup olmadığını belirten bir değer alır veya ayarlar. |
| [HasColorMap](../../aspose.imaging.fileformats.tga/tgaimage/hascolormap) { get; } | Bu görüntünün renk haritasına sahip olup olmadığını gösteren bir değer alır. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.tga/tgaimage/hastransparentcolor) { get; set; } | Görüntünün saydam renge sahip olup olmadığını belirten bir değer alır veya ayarlar. |
| override [Height](../../aspose.imaging.fileformats.tga/tgaimage/height) { get; } | Bu resmin yüksekliğini alır. |
...
| [ImageId](../../aspose.imaging.fileformats.tga/tgaimage/imageid) { get; set; } | Görüntü Kimliğini alır veya ayarlar. |
...
| [IsGrayScale](../../aspose.imaging.fileformats.tga/tgaimage/isgrayscale) { get; } | Bunun olup olmadığını gösteren bir değer alır.[`TgaImage`](../tgaimage) gri ölçeklidir. |
...
| [JobNameOrId](../../aspose.imaging.fileformats.tga/tgaimage/jobnameorid) { get; set; } | İş Adı/Kimliğini alır veya ayarlar. |
| [JobTime](../../aspose.imaging.fileformats.tga/tgaimage/jobtime) { get; set; } | İş Süresini alır veya ayarlar. |
...
| [PixelAspectRatioDenominator](../../aspose.imaging.fileformats.tga/tgaimage/pixelaspectratiodenominator) { get; } | Piksel En Boy Oranı payda bölümünü alır. |
| [PixelAspectRatioNumerator](../../aspose.imaging.fileformats.tga/tgaimage/pixelaspectrationumerator) { get; } | Piksel En Boy Oranı pay bölümünü alır. |
...
| [SoftwareId](../../aspose.imaging.fileformats.tga/tgaimage/softwareid) { get; set; } | Yazılım Kimliğini alır veya ayarlar. Yazılım Kimliği için toplam 40 ASCII karakteri. |
| [SoftwareVersion](../../aspose.imaging.fileformats.tga/tgaimage/softwareversion) { get; set; } | Yazılım Sürümünü alır veya ayarlar. Kabul edilen sürüm dizesi uzunluğu 3-4 karakterdir. |
| [SoftwareVersionLetter](../../aspose.imaging.fileformats.tga/tgaimage/softwareversionletter) { get; set; } | Yazılım Sürümü harf bölümünü alır veya ayarlar. |
| [SoftwareVersionNumber](../../aspose.imaging.fileformats.tga/tgaimage/softwareversionnumber) { get; set; } | Yazılım Sürümü numarası bölümünü alır veya ayarlar. |
| override [TransparentColor](../../aspose.imaging.fileformats.tga/tgaimage/transparentcolor) { get; set; } | Anahtar Rengini alır veya ayarlar. |
...
| override [Width](../../aspose.imaging.fileformats.tga/tgaimage/width) { get; } | Bu görüntü genişliğini alır. |
| virtual [XmpData](../../aspose.imaging/rasterimage/xmpdata) { get; set; } | XMP meta verilerini alır veya ayarlar. |
| [XOrigin](../../aspose.imaging.fileformats.tga/tgaimage/xorigin) { get; set; } | ekranının sol alt tarafında bir orijine sahip bir görüntüleme aygıtında (örneğin, TARGA serisi) konumlandırıldığı için image resminin sol alt köşesi için mutlak yatay koordinatı alır veya ayarlar. |
| [YOrigin](../../aspose.imaging.fileformats.tga/tgaimage/yorigin) { get; set; } | ekranının sol alt tarafında bir orijine sahip bir görüntüleme cihazında (örneğin, TARGA serisi) konumlandırıldığı için image resminin sol alt köşesi için mutlak dikey koordinatı alır veya ayarlar. |
...
| [Clone](../../aspose.imaging.fileformats.tga/tgaimage/clone#clone)() | Geçerli örneğin bir kopyası olan yeni bir nesne oluşturur. |
| [Clone](../../aspose.imaging.fileformats.tga/tgaimage/clone#clone_1)(TgaImage) | Diğerini klonla[`TgaImage`](../tgaimage) nesnenin özellikleri. |
| override [Crop](../../aspose.imaging.fileformats.tga/tgaimage/crop#crop)(Rectangle) | Görüntü kırpılıyor. |
| override [Crop](../../aspose.imaging.fileformats.tga/tgaimage/crop#crop_1)(int, int, int, int) | Görüntüyü kaydırmalarla kırpın. |
...
| override [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals_1)(object) | Eşitlik karşılaştırması. |
| [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals)(TgaImage) | Eşitlik karşılaştırması. |
...
| override [GetHashCode](../../aspose.imaging.fileformats.tga/tgaimage/gethashcode)() | Bu örneğin karma kodunu alın. Anahtar olarak kullanılmaya uygun değildir.[`TgaImage`](../tgaimage) değişmez değil. |
...
| override [Resize](../../aspose.imaging.fileformats.tga/tgaimage/resize#resize_1)(int, int, ImageResizeSettings) | Resmi yeniden boyutlandırır. |
| override [Resize](../../aspose.imaging.fileformats.tga/tgaimage/resize#resize_2)(int, int, ResizeType) | Resmi yeniden boyutlandırır. |
...
| override [Rotate](../../aspose.imaging.fileformats.tga/tgaimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate merkezin etrafındaki görüntü. |
| override [RotateFlip](../../aspose.imaging.fileformats.tga/tgaimage/rotateflip)(RotateFlipType) | Döndürme çevirme. |
...
| [operator ==](../../aspose.imaging.fileformats.tga/tgaimage/op_equality) | Eşitlik karşılaştırması. |
| [operator !=](../../aspose.imaging.fileformats.tga/tgaimage/op_inequality) | Eşitsiz karşılaştırma. |
...
* ad alanı [Aspose.Imaging.FileFormats.Tga](../../aspose.imaging.fileformats.tga)
