...
description: Yeni bir örneğini başlatırDjvuMultiPageOptionsaspose.imaging.imageoptions/djvumultipageoptions sınıf.
type: docs
weight: 10
url: /tr/aspose.imaging.imageoptions/djvumultipageoptions/djvumultipageoptions/
---
## DjvuMultiPageOptions() {#constructor}

Yeni bir örneğini başlatır[`DjvuMultiPageOptions`](../../djvumultipageoptions) sınıf.
...
* ad alanı [Aspose.Imaging.ImageOptions](../../djvumultipageoptions)
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| pages | Int32[] | Sayfalar indekslenir. |
