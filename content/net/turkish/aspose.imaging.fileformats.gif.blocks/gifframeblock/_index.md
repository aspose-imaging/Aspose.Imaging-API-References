...
description: Gif çerçeve bloğu.
type: docs
weight: 6630
url: /tr/aspose.imaging.fileformats.gif.blocks/gifframeblock/
---
## GifFrameBlock class
...
| İsim | Tanım |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | Yeni bir örneğini başlatır[`GifFrameBlock`](../gifframeblock) sınıf. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/backgroundcolor) { get; set; } | Arka plan rengi için bir değer alır veya ayarlar. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| [ControlBlock](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/controlblock) { get; } | Bu blokla ilişkili grafik kontrol bloğunu alır. |
| [DataStreamContainer](../../aspose.imaging/datastreamsupporter/datastreamcontainer) { get; } | Nesnenin veri akışını alır. |
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod) { get; } | Elden çıkarma yöntemini alır. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Bu örneğin atılıp atılmadığını gösteren bir değer alır. |
| override [FileFormat](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/fileformat) { get; } | dosya formatının bir değerini alır |
| [Flags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/flags) { get; set; } | Bayrakları alır veya ayarlar. |
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft) { get; } | Sola döner. |
| [FrameTime](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametime) { get; set; } | Süreyi alır veya ayarlar. |
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop) { get; } | p. biçimine dönüştürür |
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel) { get; set; } | Piksel başına GIF çerçeve bitlerini alır veya ayarlar. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor) { get; set; } | Çerçeve bloğunun saydam renge sahip olup olmadığını gösteren bir değer alır. |
| override [Height](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/height) { get; } | Görüntü yüksekliğini alır. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`GifFrameBlock`](../gifframeblock) geçmeli. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | Bu görüntü örneğinin geçmeli olup olmadığını gösteren bir değer alır. |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted) { get; set; } | Renk paletinin sıralanıp sıralanmadığını belirten bir değer alır veya ayarlar. |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left) { get; set; } | Sol görüntü konumunu alır veya ayarlar. |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top) { get; set; } | En üstteki görüntü konumunu alır veya ayarlar. |
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor) { get; set; } | Çerçeve bloğunun saydam rengini alır. |
...
| override [Width](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/width) { get; } | Görüntü genişliğini alır. |
...
| İsim | Tanım |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/adjustbrightness)(int) | Görüntü için parlaklık ayarı. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getfullframe)() | Tam kareyi alır. |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor#replacecolor_1)(int, byte, int) | İzin verilen farkla bir rengi başka bir renkle değiştirir ve düzgün kenarları kaydetmek için orijinal alfa değerini korur. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors#replacenontransparentcolors_1)(int) | Tüm saydam olmayan renkleri yeni renklerle değiştirir ve düzgün kenarları korumak için orijinal alfa değerini korur. Not: Bunu saydam olmayan görüntülerde kullanırsanız, tüm renkler tek bir renkle değiştirilir. |
...
| static [CreateFlags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/createflags)(IColorPalette, bool, bool) | Bayrakları oluşturur. |
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette)(IColorPalette, IColorPalette) | İlişkili renk paletini alır. |

## Alanlar

| İsim | Tanım |
| --- | --- |
| const [ExtensionLabel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/extensionlabel) | Uzantı etiketini engelle. |
| const [ImageDescriptorSize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/imagedescriptorsize) | Resim tanımlayıcı boyutu. |
