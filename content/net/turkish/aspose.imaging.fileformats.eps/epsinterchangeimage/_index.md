...
description: Kapsüllenmiş PostScript Değişim formatı için sınıf
type: docs
weight: 6570
url: /tr/aspose.imaging.fileformats.eps/epsinterchangeimage/
---
## EpsInterchangeImage class

Kapsüllenmiş PostScript Değişim formatı için sınıf
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsinterchangeimage/epstype) { get; } | EPS alt türü değerini alır |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | Bu örneğin biçime özgü tarama önizlemesine sahip olup olmadığını gösteren bir değer alır |
...
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | Önizleme görüntüsünün yüksekliğini alır |
| [PreviewWidth](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewwidth) { get; } | Önizleme görüntüsünün genişliğini alır |
| [RasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/rasterpreview) { get; } | S/b tarama önizlemesini (varsa) veya null alır |
...
| [ConvertToBinary](../../aspose.imaging.fileformats.eps/epsinterchangeimage/converttobinary)() | Bu örneği şuna dönüştürür:[`EpsBinaryImage`](../epsbinaryimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | Şundan açık bir dönüştürme gerçekleştirir:[`EpsBinaryImage`](../epsbinaryimage) ile[`EpsInterchangeImage`](../epsinterchangeimage) |
