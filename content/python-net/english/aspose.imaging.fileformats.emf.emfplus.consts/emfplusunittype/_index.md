...
type: docs
weight: 440
url: /aspose.imaging.fileformats.emf.emfplus.consts/emfplusunittype/
---
...
| :- | :- |
| UNIT_TYPE_DISPLAY | Specifies a unit of distance based on the characteristics of the physical display.<br/>            For example, if the display device is a monitor, then the unit is 1 pixel. |
