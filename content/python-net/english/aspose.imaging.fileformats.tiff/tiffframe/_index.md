...
type: docs
weight: 170
url: /aspose.imaging.fileformats.tiff/tiffframe/
---
...
| [create_frame_from(tiff_frame, options)](#create_frame_from_tiff_frame_options_22) | Creates the frame from specified _tiffFrame_ using the specified _options_.<br/>            The pixel data is preserved but converted to the desired format. |
