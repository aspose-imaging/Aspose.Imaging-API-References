...
description: "تحدد علامات ClipPrecision دقة القص التي تحدد كيفية قص الأحرف التي تقع جزئياً خارج منطقة القص."
type: docs
weight: 14
...
تحدد علامات ClipPrecision دقة القص، التي تحدد كيفية قص الأحرف التي تقع جزئياً خارج منطقة القص. يمكن دمج هذه العلامات لتحديد خيارات متعددة.
## الحقول
...
| [Stroke](#Stroke) | قد تُرجع هذه القيمة عند تعداد الخطوط المرسومة، TrueType والخطوط المتجهة. |
| [LhAngles](#LhAngles) | تُستخدم هذه القيمة للتحكم في دوران الخط، كما يلي: - إذا تم تعيينها، يجب تحديد دوران جميع الخطوط بناءً على اتجاه نظام الإحداثيات؛ أي ما إذا كان الاتجاه يساريًا أم يمينيًا. |
...
قد تُرجع هذه القيمة عند تعداد الخطوط المرسومة، TrueType والخطوط المتجهة. [33] (Windows NT 3.1، Windows NT 3.5، Windows NT 3.51، Windows NT 4.0، Windows 2000، و Windows XP: تُرجع هذه القيمة دائمًا عند تعداد الخطوط.)
...
تُستخدم هذه القيمة للتحكم في دوران الخط، كما يلي: - إذا تم تعيينها، يجب تحديد دوران جميع الخطوط بناءً على اتجاه نظام الإحداثيات؛ أي ما إذا كان الاتجاه يساريًا أم يمينيًا. - إذا لم تُعيّن، يجب أن تدور خطوط الجهاز عكس اتجاه عقارب الساعة، لكن يجب تحديد دوران الخطوط الأخرى بناءً على اتجاه نظام الإحداثيات.
...
تحدد هذه القيمة أنه يجب إيقاف ربط الخطوط [35]. [35] هذه القيمة غير مدعومة في Windows 95، Windows 98، وإصدار Windows Millennium. يتم إيقاف ربط الخطوط في Windows 2000، Windows XP، و Windows Server 2003. تُهمل هذه القيمة في إصدارات Windows التالية: - Windows Vista - Windows Server 2008 - Windows 7 - Windows Server 2008 R2 - Windows 8 - Windows Server 2012 - Windows 8.1 - Windows Server 2012 R2
