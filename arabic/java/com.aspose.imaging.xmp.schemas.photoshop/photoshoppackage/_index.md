...
description: "يمثل مساحة اسم Adobe Photoshop."
type: docs
weight: 12
...
يمثل مساحة اسم Adobe Photoshop.
## المنشئات
...
| حقل | الوصف |
| --- | --- |
| [URGENCY_MAX](#URGENCY-MAX) | القيمة القصوى للإلحاح. |
| [URGENCY_MIN](#URGENCY-MIN) | القيمة الدنيا للإلحاح. |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [addValue(String key, String value)](#addValue-java.lang.String-java.lang.String-) | يضيف خاصية نصية. |
| [setAuthorsPosition(String authorsPosition)](#setAuthorsPosition-java.lang.String-) | يضبط موضع المؤلف. |
...
| [setUrgency(int urgency)](#setUrgency-int-) | يضبط الاستعجال. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| iccProfile | java.lang.String | ملف تعريف icc. |
...
يجب أن تكون العجلة في النطاق من 1 إلى 8. |
