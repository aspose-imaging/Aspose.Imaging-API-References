...
description: "الحزمة تحتوي على استثناءات تُطرح من أحد خوارزميات الضغط المدعومة."
type: docs
weight: 16
url: /ar/java/com.aspose.imaging.coreexceptions.compressors/
---

الحزمة تحتوي على استثناءات تُطرح من أحد خوارزميات الضغط المدعومة.
