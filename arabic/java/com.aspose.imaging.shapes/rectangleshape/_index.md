...
description: "يمثل شكلًا مستطيلاً."
type: docs
weight: 17
...
| المنشئ | الوصف |
| --- | --- |
| [RectangleShape()](#RectangleShape--) | ينشئ مثيلاً جديداً من الفئة `RectangleShape`. |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.imaging.RectangleF-) | ينشئ مثيلاً جديداً من الفئة `RectangleShape`. |
## الطرق
...
ينشئ مثيلاً جديداً من الفئة `RectangleShape`.
