...
| المنشئ | الوصف |
| --- | --- |
| [TiffSRationalType(int tagId)](#TiffSRationalType-int-) | ينشئ مثيلاً جديدًا من الفئة `TiffSRationalType`. |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [getValues()](#getValues--) | يحصل أو يعيّن القيم. |
| [setValues(TiffSRational[] value)](#setValues-com.aspose.imaging.fileformats.tiff.TiffSRational---) | يحصل أو يعيّن القيم. |
...
ينشئ مثيلاً جديدًا من الفئة `TiffSRationalType`.
