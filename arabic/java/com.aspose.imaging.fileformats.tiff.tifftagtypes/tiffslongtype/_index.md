...
description: "نوع tiff signed long."
type: docs
weight: 22
url: /ar/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
**Inheritance:**
...
| المنشئ | الوصف |
| --- | --- |
| [TiffSLongType(int tagId)](#TiffSLongType-int-) | يقوم بإنشاء نسخة جديدة من الفئة `TiffSLongType`. |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [getValues()](#getValues--) | يحصل أو يعيّن القيم. |
| [setValues(int[] value)](#setValues-int---) | يحصل أو يعيّن القيم. |
...
يقوم بإنشاء نسخة جديدة من الفئة `TiffSLongType`.
