...
description: "واجهة برمجة التطبيقات لمعالجة تنسيق ملف صورة DNG Digital Negative المستخدم لاحتياجات التصوير الرقمي من خلال توفير دعم شامل للملفات الخام والبيانات الوصفية."
type: docs
weight: 11
...
| المنشئ | الوصف |
| --- | --- |
| [DngImage()](#DngImage--) | قم بإنشاء نسخة جديدة من الفئة [DngImage](../../com.aspose.imaging.fileformats.dng/dngimage) بسهولة. |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [getBitsPerPixel()](#getBitsPerPixel--) | اكتشف عدد البتات لكل بكسل في الصورة بسهولة باستخدام هذه الخاصية. |
| [getHeight()](#getHeight--) | استرجع ارتفاع الصورة باستخدام هذه الخاصية. |
| [getWidth()](#getWidth--) | الوصول إلى عرض الصورة باستخدام هذه الخاصية. |
| [getFileFormat()](#getFileFormat--) | حدد تنسيق ملف الصورة الخاص بك باستخدام هذه الخاصية. |
...
قم بإنشاء نسخة جديدة من الفئة [DngImage](../../com.aspose.imaging.fileformats.dng/dngimage) بسهولة. مثالية للمطورين الذين يرغبون في بدء استخدام كائنات DngImage بسرعة وكفاءة في مشاريعهم.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [RawData](../../com.aspose.imaging.fileformats.dng.decoder/rawdata) | بيانات img. |
