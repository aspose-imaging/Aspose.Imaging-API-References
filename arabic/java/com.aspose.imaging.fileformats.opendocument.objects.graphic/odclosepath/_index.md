...
description: "المسار المغلق"
type: docs
weight: 13
url: /ar/java/com.aspose.imaging.fileformats.opendocument.objects.graphic/odclosepath/
---
**Inheritance:**
...
| المنشئ | الوصف |
| --- | --- |
| [OdClosePath(OdObject parent)](#OdClosePath-com.aspose.imaging.fileformats.opendocument.OdObject-) | ينشئ مثيلاً جديداً من الفئة `OdClosePath`. |
...
ينشئ مثيلاً جديداً من الفئة `OdClosePath`.
