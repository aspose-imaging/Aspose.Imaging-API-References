...
description: "يمثل Brush بتدرج خطي محدد بألوان متعددة ومواقع مناسبة."
type: docs
weight: 13
url: /ar/java/com.aspose.imaging.brushes/linearmulticolorgradientbrush/
---
**Inheritance:**
...
| المنشئ | الوصف |
| --- | --- |
| [LinearMulticolorGradientBrush()](#LinearMulticolorGradientBrush--) | ينشئ نسخة جديدة من الفئة `LinearMulticolorGradientBrush` باستخدام المعلمات الافتراضية. |
| [LinearMulticolorGradientBrush(Point point1, Point point2)](#LinearMulticolorGradientBrush-com.aspose.imaging.Point-com.aspose.imaging.Point-) | يُنشئ مثيلاً جديدًا من الفئة `LinearMulticolorGradientBrush` باستخدام النقاط المحددة. |
| [LinearMulticolorGradientBrush(PointF point1, PointF point2)](#LinearMulticolorGradientBrush-com.aspose.imaging.PointF-com.aspose.imaging.PointF-) | يُنشئ مثيلاً جديدًا من الفئة `LinearMulticolorGradientBrush` باستخدام النقاط المحددة. |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.imaging.Rectangle-float-) | يُنشئ مثيلاً جديدًا من الفئة `LinearMulticolorGradientBrush` استنادًا إلى مستطيل وزاوية توجيه. |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle)](#LinearMulticolorGradientBrush-com.aspose.imaging.RectangleF-float-) | يُنشئ مثيلاً جديدًا من الفئة `LinearMulticolorGradientBrush` استنادًا إلى مستطيل وزاوية توجيه. |
| [LinearMulticolorGradientBrush(Rectangle rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.imaging.Rectangle-float-boolean-) | يُنشئ مثيلاً جديدًا من الفئة `LinearMulticolorGradientBrush` استنادًا إلى مستطيل وزاوية توجيه. |
| [LinearMulticolorGradientBrush(RectangleF rect, float angle, boolean isAngleScalable)](#LinearMulticolorGradientBrush-com.aspose.imaging.RectangleF-float-boolean-) | يُنشئ مثيلاً جديدًا من الفئة `LinearMulticolorGradientBrush` استنادًا إلى مستطيل وزاوية توجيه. |
## الطرق
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| point1 | [Point](../../com.aspose.imaging/point) | بنية `Aspose.Imaging.Point` تمثل نقطة البدء للتدرج الخطي. |
| point2 | [Point](../../com.aspose.imaging/point) | بنية `Aspose.Imaging.Point` تمثل نقطة النهاية للتدرج الخطي. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| point1 | [PointF](../../com.aspose.imaging/pointf) | بنية `Aspose.Imaging.PointF` تمثل نقطة البدء للتدرج الخطي. |
| point2 | [PointF](../../com.aspose.imaging/pointf) | بنية `Aspose.Imaging.PointF` تمثل نقطة النهاية للتدرج الخطي. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| rect | [Rectangle](../../com.aspose.imaging/rectangle) | بنية `Aspose.Imaging.RectangleF` تحدد حدود التدرج الخطي. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| rect | [RectangleF](../../com.aspose.imaging/rectanglef) | بنية `Aspose.Imaging.RectangleF` تحدد حدود التدرج الخطي. |
| angle | float | الزاوية، مقاسة بالدرجات في اتجاه عقارب الساعة من محور x، لخط توجيه التدرج. |
