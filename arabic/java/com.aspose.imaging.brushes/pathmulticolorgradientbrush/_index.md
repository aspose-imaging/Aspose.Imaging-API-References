...
type: docs
weight: 16
url: /ar/java/com.aspose.imaging.brushes/pathmulticolorgradientbrush/
---
**Inheritance:**
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| path | [GraphicsPath](../../com.aspose.imaging/graphicspath) | `GraphicsPath` الذي يحدد المنطقة التي يملأها هذا `PathMulticolorGradientBrush`. |
