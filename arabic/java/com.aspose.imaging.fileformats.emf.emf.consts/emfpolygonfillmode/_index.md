...
description: "تحدد تعداد PolygonFillMode القيم التي تحدد كيفية حساب منطقة المضلع الذي سيتم ملؤه."
type: docs
weight: 36
url: /ar/java/com.aspose.imaging.fileformats.emf.emf.consts/emfpolygonfillmode/
---
**Inheritance:**
...
تحدد تعداد PolygonFillMode القيم التي تحدد كيفية حساب منطقة المضلع الذي سيتم ملؤه.
## الحقول
