...
| [MM_ISOTROPIC](#MM-ISOTROPIC) | الوحدات المنطقية تُطابق وحدات عشوائية مع محاور ذات مقياس متساوٍ؛ أي أن وحدة واحدة على محور x تساوي وحدة واحدة على محور y. |
| [MM_ANISOTROPIC](#MM-ANISOTROPIC) | الوحدات المنطقية تُطابق وحدات عشوائية مع محاور ذات مقياس عشوائي. |
### MM_TEXT {#MM-TEXT}
```
...
كل وحدة منطقية تُطابق 0.01 مليمتر. x الموجبة إلى اليمين؛ y الموجبة إلى الأعلى.
...
كل وحدة منطقية تُطابق 0.01 بوصة. x الموجبة إلى اليمين؛ y الموجبة إلى الأعلى
...
كل وحدة منطقية تُطابق 0.001 بوصة. x الموجبة إلى اليمين؛ y الموجبة إلى الأعلى.
...
كل وحدة منطقية تُطابق واحدًا من عشرين نقطة طابعة (1/1440 بوصة، وتُسمى أيضًا "twip"). x الموجبة إلى اليمين؛ y الموجبة إلى الأعلى.
...
الوحدات المنطقية تُطابق وحدات عشوائية مع محاور ذات مقياس متساوٍ؛ أي أن وحدة واحدة على محور x تساوي وحدة واحدة على محور y. يجب استخدام سجلات EMR\_SETWINDOWEXTEX و EMR\_SETVIEWPORTEXTEX لتحديد الوحدات واتجاه المحاور. يجب إجراء التعديلات حسب الضرورة لضمان بقاء وحدات x و y بنفس الحجم. على سبيل المثال، عندما يتم تعيين امتداد النافذة، يجب تعديل مساحة العرض للحفاظ على تماثل الوحدات.
...
الوحدات المنطقية تُطابق وحدات عشوائية مع محاور ذات مقياس عشوائي. يجب استخدام سجلات EMR\_SETWINDOWEXTEX و EMR\_SETVIEWPORTEXTEX لتحديد الوحدات والاتجاه والقياس.
