...
| [ETO_GLYPH_INDEX](#ETO-GLYPH-INDEX) | تشير هذه البتة إلى أن الرموز الخاصة بالأحرف في سلسلة نصية مُخرجة هي في الواقع فهارس لأشكال الأحرف في خط TrueType. |
...
| [ETO_IGNORELANGUAGE](#ETO-IGNORELANGUAGE) | تشير هذه البتة إلى أنه لا ينبغي تنفيذ أي معالجة خاصة من نظام التشغيل لتحديد موضع الرموز في السلاسل من اليمين إلى اليسار؛ أي أنه يجب أن يتم التعامل مع جميع مواضع الرموز من خلال سجلات الرسم والحالة في ملف الميتا. |
| [ETO_PDY](#ETO-PDY) | تشير هذه البتة إلى أنه يجب توفير قيم إزاحة الأحرف أفقياً وعمودياً. |
| [ETO_REVERSE_INDEX_MAP](#ETO-REVERSE-INDEX-MAP) | هذه البتة محجوزة ولا يجب استخدامها. |
