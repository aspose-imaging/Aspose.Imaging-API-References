...
description: "تحدد تعداد ModifyWorldTransformMode الأنماط لاستخدام بيانات التحويل المحددة لتعديل تحويل الفضاء العالمي إلى الفضاء الصفحي الذي يتم تعريفه حاليًا في سياق جهاز التشغيل."
type: docs
weight: 33
...
تحدد تعداد ModifyWorldTransformMode الأنماط لاستخدام بيانات التحويل المحددة لتعديل تحويل الفضاء العالمي إلى الفضاء الصفحي الذي يتم تعريفه حاليًا في سياق جهاز التشغيل.
## الحقول
...
ضرب التحويل الحالي. في هذا الوضع، تكون بيانات التحويل المحددة هي المضاعف الأيسر، والتحويل المعرفة حالياً في سياق جهاز التشغيل هو المضاعف الأيمن.
...
ضرب التحويل الحالي. في هذا الوضع، تكون بيانات التحويل المحددة هي المضاعف الأيمن، والتحويل المعرفة حالياً في سياق جهاز التشغيل هو المضاعف الأيسر.
