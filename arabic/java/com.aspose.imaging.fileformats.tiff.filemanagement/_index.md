...
description: "الحزمة تحتوي على فئات معالجة تدفق تنسيق ملف Tiff."
type: docs
weight: 79
url: /ar/java/com.aspose.imaging.fileformats.tiff.filemanagement/
---

الحزمة تحتوي على فئات معالجة تدفق تنسيق ملف Tiff.
