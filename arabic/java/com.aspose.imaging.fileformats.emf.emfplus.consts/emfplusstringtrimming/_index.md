...
description: "تحدد تعداد StringTrimming كيفية قص الأحرف من سلسلة تكون أكبر من مستطيل تخطيط النص."
type: docs
weight: 51
url: /ar/java/com.aspose.imaging.fileformats.emf.emfplus.consts/emfplusstringtrimming/
---
**Inheritance:**
...
تحدد تعداد StringTrimming كيفية قص الأحرف من سلسلة تكون أكبر من مستطيل تخطيط النص.
## الحقول
...
يحدد إزالة الجزء الأوسط من السلسلة واستبداله بثلاث نقاط. يحافظ الخوارزم على أكبر قدر ممكن من الجزء الأخير من السلسلة.
