...
description: "تحدد علامات StringFormat خيارات تخطيط النص الرسومي بما في ذلك الاتجاه والقص والتعامل مع الخطوط."
type: docs
weight: 50
...
تحدد علامات StringFormat خيارات تخطيط النص الرسومي، بما في ذلك الاتجاه والقص والتعامل مع الخطوط. يمكن دمج هذه العلامات لتحديد خيارات متعددة.
## الحقول
...
| [StringFormatNoWrap](#StringFormatNoWrap) | إذا تم تعيينه، يجب عدم لف السلسلة التي تمتد خارج نهاية مستطيل تخطيط النص إلى السطر التالي. |
| [StringFormatLineLimit](#StringFormatLineLimit) | إذا تم تعيينه، يجب إخراج أسطر النص الكاملة ويجب عدم قصها بواسطة مستطيل تخطيط السلسلة. |
| [StringFormatNoClip](#StringFormatNoClip) | إذا تم تعيينه، يجب السماح للنص الممتد خارج مستطيل تخطيط السلسلة بالظهور. |
| [StringFormatBypassGdi](#StringFormatBypassGdi) | قد يُستخدم هذا العلم لتحديد عملية خاصة بالتنفيذ لتصيير النص. |
...
إذا تم تعيينه، يجب أن يكون ترتيب قراءة السلسلة من اليمين إلى اليسار. بالنسبة للنص الأفقي، يعني ذلك أن الأحرف تُقرأ من اليمين إلى اليسار. بالنسبة للنص العمودي، يعني ذلك أن الأعمدة تُقرأ من اليمين إلى اليسار. إذا لم يُحدد، يجب قراءة النص الأفقي أو العمودي من اليسار إلى اليمين.
...
إذا تم تعيينه، يجب رسم أسطر النص الفردية عموديًا على جهاز العرض. إذا لم يُحدد، يجب رسم أسطر النص الفردية أفقيًا، مع وضع كل سطر جديد أسفل السطر السابق.
...
إذا تم تعيينه، يجب السماح لأجزاء الأحرف بالتمدد خارج مستطيل تخطيط النص. إذا لم يُحدد، يجب إعادة تموضع الأحرف التي تتجاوز حدود مستطيل تخطيط النص لتجنب التمدد. الحرف المائل "f" مثال على حرف يمكن أن يحتوي على أجزاء متمددة.
...
إذا تم تعيينه، يجب استخدام خط بديل للأحرف التي لا يدعمها الخط المطلوب. إذا لم يُحدد، يجب أن يظهر الحرف المفقود من الخط المطلوب كحرف "font missing"، والذي قد يكون مربعًا مفتوحًا.
...
إذا تم التعيين، يجب تضمين المسافة في نهاية كل سطر في قياسات طول السلسلة. إذا لم يتم التعيين، يجب استبعاد المسافة في نهاية كل سطر من قياسات طول السلسلة.
...
إذا تم التعيين، يجب عدم لف السلسلة التي تمتد خارج نهاية مستطيل تخطيط النص إلى السطر التالي. إذا لم يتم التعيين، يجب قطع السلسلة التي تمتد خارج نهاية مستطيل تخطيط النص عند آخر حد كلمة داخل المستطيل المحدد، ويجب لف باقي السلسلة إلى السطر التالي.
...
إذا تم التعيين، يجب السماح بإظهار النص الذي يمتد خارج مستطيل تخطيط السلسلة. إذا لم يتم التعيين، يجب قص كل النص الذي يمتد خارج مستطيل التخطيط.
...
قد يُستخدم هذا العلم لتحديد عملية خاصة بالتنفيذ لتصيير النص.
