...
description: "أنواع سجلات الحالة تحدد العمليات على حالة سياق جهاز التشغيل."
type: docs
weight: 69
url: /ar/java/com.aspose.imaging.fileformats.emf.emfplus.records/emfplusstaterecordtype/
---
**Inheritance:**
...
يجب إضافة كل حاوية حالة رسومية إلى مصفوفة من حاويات الرسومات المحفوظة. لا يتم كتابة حاوية الحالة الرسومية إلى ملف EMF+ التعريفي، لذا يمكن تحديد تنسيقها بواسطة التنفيذ.
