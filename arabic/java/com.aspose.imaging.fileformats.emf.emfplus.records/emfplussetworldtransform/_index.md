...
description: "سجل EmfPlusSetWorldTransform يضبط تحويل العالم وفقًا للقيم في مصفوفة التحويل المحددة."
type: docs
weight: 68
url: /ar/java/com.aspose.imaging.fileformats.emf.emfplus.records/emfplussetworldtransform/
---
**Inheritance:**
...
سجل EmfPlusSetWorldTransform يضبط تحويل العالم وفقًا للقيم في مصفوفة التحويل المحددة.
## المنشئات
