...
| المنشئ | الوصف |
| --- | --- |
| [EmfPlusDrawLines(EmfPlusRecord source)](#EmfPlusDrawLines-com.aspose.imaging.fileformats.emf.emfplus.records.EmfPlusRecord-) | يُنشئ مثيلًا جديدًا للفئة `EmfPlusDrawLines`. |
## الطرق
...
| [getPointData()](#getPointData--) | يحصل أو يعيّن بيانات النقاط: مصفوفة من Count نقاط تحدد نقاط البداية والنهاية للخطوط التي سيتم رسمها. |
| [setPointData(PointF[] value)](#setPointData-com.aspose.imaging.PointF---) | يحصل أو يعيّن بيانات النقاط: مصفوفة من Count نقاط تحدد نقاط البداية والنهاية للخطوط التي سيتم رسمها. |
