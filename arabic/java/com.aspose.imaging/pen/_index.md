...
| المنشئ | الوصف |
| --- | --- |
| [Pen(Color color)](#Pen-com.aspose.imaging.Color-) | ينشئ نسخة جديدة من الفئة `Pen` باللون المحدد. |
| [Pen(Color color, float width)](#Pen-com.aspose.imaging.Color-float-) | ينشئ نسخة جديدة من الفئة `Pen` بالخصائص المحددة `Color` و `Pen.Width`. |
| [Pen(Brush brush)](#Pen-com.aspose.imaging.Brush-) | ينشئ نسخة جديدة من الفئة `Pen` بالـ `Brush` المحدد. |
| [Pen(Brush brush, float width)](#Pen-com.aspose.imaging.Brush-float-) | ينشئ نسخة جديدة من الفئة `Pen` بالـ `Brush` و `Pen.Width` المحددين. |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [getWidth()](#getWidth--) | يحصل على عرض هذا `Pen` بوحدات كائن Graphics المستخدم للرسم. |
| [setWidth(float value)](#setWidth-float-) | يضبط عرض هذا `Pen` بوحدات كائن Graphics المستخدم للرسم. |
...
| [getMiterLimit()](#getMiterLimit--) | يحصل على حد سمك الوصل عند الزاوية المثلثية. |
| [setMiterLimit(float value)](#setMiterLimit-float-) | يضبط حد سمك الوصلة في زاوية مائلة. |
...
| [getDashOffset()](#getDashOffset--) | يحصل على المسافة من بداية الخط إلى بداية نمط الشرط. |
...
| [getCompoundArray()](#getCompoundArray--) | يحصل على مصفوفة من القيم التي تحدد قلم مركب. |
| [setCompoundArray(float[] value)](#setCompoundArray-float---) | يضبط مصفوفة من القيم التي تحدد قلم مركب. |
...
| [rotateTransform(float angle, int order)](#rotateTransform-float-int-) | يدور التحويل الهندسي المحلي بالزاوية المحددة وفقًا للترتيب المحدد. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| color | [Color](../../com.aspose.imaging/color) | بنية `Color` التي تشير إلى لون هذا `Pen`. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| brush | [Brush](../../com.aspose.imaging/brush) | `Brush` التي تحدد خصائص التعبئة لهذا `Pen`. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| brush | [Brush](../../com.aspose.imaging/brush) | `Brush` التي تحدد خصائص هذا `Pen`. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [CustomLineCap](../../com.aspose.imaging/customlinecap) | `CustomLineCap` الذي يمثل القمة المستخدمة في بداية الخطوط المرسومة بهذه `Pen`. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [CustomLineCap](../../com.aspose.imaging/customlinecap) | `CustomLineCap` الذي يمثل القمة المستخدمة في نهاية الخطوط المرسومة بهذه `Pen`. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [Matrix](../../com.aspose.imaging/matrix) | نسخة من `Matrix` التي تمثل التحويل الهندسي لهذه `Pen`. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [Color](../../com.aspose.imaging/color) | `Color` التي تمثل لون هذه `Pen`. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | [Brush](../../com.aspose.imaging/brush) | `Brush` التي تحدد خصائص هذه `Pen`. |
...
**Returns:**
float[] - مصفوفة من الأعداد الحقيقية تحدد أطوال الشرط والمسافات المتناوبة في الخطوط المتقطعة.
...
**Returns:**
float[] - مصفوفة من الأعداد الحقيقية تحدد مصفوفة المركب. يجب أن تكون عناصر المصفوفة بترتيب تصاعدي، لا تقل عن 0 ولا تزيد عن 1.
