...
يعرّف مصفوفة 5 × 5 تحتوي على إحداثيات مساحة RGBA. عدة طرق من فئة [ImageAttributes](../../com.aspose.imaging/imageattributes) تعدّل ألوان الصورة باستخدام مصفوفة ألوان. لا يمكن وراثة هذه الفئة.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [ColorMatrix()](#ColorMatrix--) | ينشئ مثيلاً جديداً لفئة `Aspose.Imaging.ColorMatrix`. |
| [ColorMatrix(float[][] newColorMatrix)](#ColorMatrix-float-----) | ينشئ مثيلاً جديداً لفئة `Aspose.Imaging.ColorMatrix` باستخدام العناصر في المصفوفة المحددة `newColorMatrix`. |
## الحقول
...
| [MATRIX_TOTAL_ELEMENTS_COUNT](#MATRIX-TOTAL-ELEMENTS-COUNT) | الإجمالي الكلي لعدد العناصر في المصفوفة. |
## الطرق
...
| [setMatrix10(float value)](#setMatrix10-float-) | يضبط العنصر في الصف الأول والعمود 0 (صفر) من هذه `Aspose.Imaging.ColorMatrix`. |
| [getMatrix11()](#getMatrix11--) | يحصل على العنصر في الصف الأول والعمود الأول من هذه `Aspose.Imaging.ColorMatrix`. |
| [setMatrix11(float value)](#setMatrix11-float-) | يضبط العنصر في الصف الأول والعمود الأول من هذه `Aspose.Imaging.ColorMatrix`. |
| [getMatrix12()](#getMatrix12--) | يحصل على العنصر في الصف الأول والعمود الثاني من هذه `Aspose.Imaging.ColorMatrix`. |
| [setMatrix12(float value)](#setMatrix12-float-) | يضبط العنصر في الصف الأول والعمود الثاني من هذه `Aspose.Imaging.ColorMatrix`. |
| [getMatrix13()](#getMatrix13--) | يحصل على العنصر في الصف الأول والعمود الثالث من هذه `Aspose.Imaging.ColorMatrix`. |
| [setMatrix13(float value)](#setMatrix13-float-) | يضبط العنصر في الصف الأول والعمود الثالث من هذه `Aspose.Imaging.ColorMatrix`. |
| [getMatrix14()](#getMatrix14--) | يحصل على العنصر في الصف الأول والعمود الرابع من هذه `Aspose.Imaging.ColorMatrix`. |
...
| [get_Item(int row, int column)](#get-Item-int-int-) | يحصل على قيم المصفوفة. |
...
ينشئ مثيلاً جديداً لفئة `Aspose.Imaging.ColorMatrix`.
...
ينشئ مثيلاً جديداً لفئة `Aspose.Imaging.ColorMatrix` باستخدام العناصر في المصفوفة المحددة `newColorMatrix`.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| قِيَم العناصر للمصفوفة `Aspose.Imaging.ColorMatrix` الجديدة. | float - العنصر في الصف 0 والعمود 0 من هذا `Aspose.Imaging.ColorMatrix`. | العنصر في الصف 0 والعمود 0 من هذا `Aspose.Imaging.ColorMatrix`. |
...
يضبط العنصر في الصف الأول والعمود 0 (صفر) من هذه `Aspose.Imaging.ColorMatrix`.

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| القيمة | float | float - العنصر في الصف الأول والعمود الثاني من هذا `Aspose.Imaging.ColorMatrix`. |
...
يحصل على العنصر في الصف الأول والعمود الأول من هذه `Aspose.Imaging.ColorMatrix`.

**Returns:**
العنصر في الصف الأول والعمود الثاني من هذا `Aspose.Imaging.ColorMatrix`.
...
يضبط العنصر في الصف الأول والعمود الأول من هذه `Aspose.Imaging.ColorMatrix`.
...
يحصل على العنصر في الصف الأول والعمود الثاني من هذه `Aspose.Imaging.ColorMatrix`.
...
يضبط العنصر في الصف الأول والعمود الثاني من هذه `Aspose.Imaging.ColorMatrix`.
...
يحصل على العنصر في الصف الأول والعمود الثالث من هذه `Aspose.Imaging.ColorMatrix`.
...
يضبط العنصر في الصف الأول والعمود الثالث من هذه `Aspose.Imaging.ColorMatrix`.
...
يحصل على العنصر في الصف الأول والعمود الرابع من هذه `Aspose.Imaging.ColorMatrix`.
