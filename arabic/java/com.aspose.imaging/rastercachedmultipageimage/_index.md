...
| [adjustContrast(float contrast)](#adjustContrast-float-) | [Image](../../com.aspose.imaging/image) التباين |
...
يضبط الزاوية. هذه الطريقة قابلة للتطبيق على مستندات النص الممسوحة ضوئيًا للتخلص من التشويه. تستخدم هذه الطريقة [RasterImage.getSkewAngle](../../com.aspose.imaging/rasterimage\#getSkewAngle) و [RasterImage.rotate(float, boolean, Color)](../../com.aspose.imaging/rasterimage\#rotate-float--boolean--Color-).
