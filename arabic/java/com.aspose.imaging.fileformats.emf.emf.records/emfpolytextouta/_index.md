...
description: "يسجل EMR_POLYTEXTOUTA يرسم سلسلة نصية أو أكثر من ASCII باستخدام الخط الحالي وألوان النص."
type: docs
weight: 97
...
يتم تحديد الخط وألوان النص المستخدمة للإخراج عبر الخصائص في الحالة الحالية لسياق جهاز التشغيل. يجب محاكاة EMR\_POLYTEXTOUTA بسلسلة من سجلات EMR\_EXTTEXTOUTW (القسم 2.3.5.7)، سجل واحد لكل سلسلة. يتطلب ذلك تحويل سلسلة النص ASCII في كل كائن EmrText إلى ترميز Unicode UTF16-LE.
## المنشئات
...
| [getAEmrText()](#getAEmrText--) | يحصل أو يعيّن مصفوفة من كائنات EmrText (القسم 2.2.5) التي تحدد سلاسل الإخراج ب字符 ASCII 8‑بت، مع سمات النص وقيم التباعد. |
| [setAEmrText(EmfText[] value)](#setAEmrText-com.aspose.imaging.fileformats.emf.emf.objects.EmfText---) | يحصل أو يعيّن مصفوفة من كائنات EmrText (القسم 2.2.5) التي تحدد سلاسل الإخراج ب字符 ASCII 8‑بت، مع سمات النص وقيم التباعد. |
...
يحصل أو يعيّن مصفوفة من كائنات EmrText (القسم 2.2.5) التي تحدد سلاسل الإخراج ب字符 ASCII 8‑بت، مع سمات النص وقيم التباعد. يتم تحديد عدد كائنات EmrText بواسطة cStrings.
