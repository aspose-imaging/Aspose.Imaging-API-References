...
description: "سجل EMR_STRETCHBLT يحدد نقل كتلة من البكسلات من صورة المصدر إلى مستطيل الوجهة، اختياريًا مع نمط فرشاة وفق عملية نقطية محددة، مع تمديد أو ضغط الناتج ليتناسب مع أبعاد الوجهة إذا لزم الأمر."
type: docs
weight: 149
...
سجل EMR\_STRETCHBLT يحدد نقل كتلة من البكسلات من صورة مصدر إلى مستطيل هدف، اختياريًا مع نمط فرشاة، وفقًا لعملية نقطية محددة، مع تمديد أو ضغط الناتج ليتناسب مع أبعاد الهدف، إذا لزم الأمر.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [EmfStretchBlt(EmfRecord source)](#EmfStretchBlt-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | يقوم بتهيئة نسخة جديدة من الفئة `EmfStretchBlt`. |
| [EmfStretchBlt()](#EmfStretchBlt--) | يقوم بتهيئة نسخة جديدة من الفئة `EmfStretchBlt`. |
## الطرق
...
| [getSourceBitmap()](#getSourceBitmap--) | يحصل أو يضبط مخزنًا يحتوي على صورة المصدر، والذي لا يُشترط أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_STRETCHBLT. |
| [setSourceBitmap(WmfDeviceIndependentBitmap value)](#setSourceBitmap-com.aspose.imaging.fileformats.wmf.objects.WmfDeviceIndependentBitmap-) | يحصل أو يضبط مخزنًا يحتوي على صورة المصدر، والذي لا يُشترط أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_STRETCHBLT. |
| [getSrcRect()](#getSrcRect--) | يحصل أو يضبط مستطيل المصدر. |
| [setSrcRect(Rectangle value)](#setSrcRect-com.aspose.imaging.Rectangle-) | يحصل أو يضبط مستطيل المصدر. |
| [getDestRect()](#getDestRect--) | يحصل أو يضبط مستطيل الوجهة. |
| [setDestRect(Rectangle value)](#setDestRect-com.aspose.imaging.Rectangle-) | يحصل أو يضبط مستطيل الوجهة. |
...
يقوم بتهيئة نسخة جديدة من الفئة `EmfStretchBlt`.
...
يحصل أو يضبط عددًا صحيحًا غير موقعًا 32‑بت يحدد رمز عملية النقطية. يحدد هذا الرمز كيفية دمج بيانات اللون لمستطيل المصدر مع بيانات اللون لمستطيل الوجهة، وربما نمط فرشاة، للحصول على اللون النهائي.
...
يحصل أو يضبط مخزنًا يحتوي على صورة المصدر، والذي لا يُشترط أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_STRETCHBLT. بناءً على ذلك، الحقول في هذا المخزن التي تحمل تسمية \"UndefinedSpace\" هي اختيارية ويجب تجاهلها.
