...
description: "سجل EMR_STRETCHBLT يحدد نقلًا كتليًا للبكسلات من صورة المصدر إلى مستطيل الوجهة، اختياريًا مع نمط فرشاة وفقًا لعملية رستر محددة، مع تمديد أو ضغط الناتج ليتناسب مع أبعاد الوجهة إذا لزم الأمر."
type: docs
weight: 149
url: /ar/java/com.aspose.imaging.fileformats.emf.emf.records/emfstretchblt/
---
**Inheritance:**
...
سجل EMR\_STRETCHBLT يحدد نقل كتلة من البكسلات من صورة مصدر إلى مستطيل هدف، اختياريًا مع نمط فرشاة، وفقًا لعملية نقطية محددة، مع تمديد أو ضغط الإخراج ليتناسب مع أبعاد الهدف إذا لزم الأمر.
## المنشئات

| المنشئ | الوصف |
| --- | --- |
| [EmfStretchBlt(EmfRecord source)](#EmfStretchBlt-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | ينشئ مثيلًا جديدًا من الفئة `EmfStretchBlt` class. |
| [EmfStretchBlt()](#EmfStretchBlt--) | ينشئ مثيلًا جديدًا من الفئة `EmfStretchBlt` class. |
## الطرق
...
| [getSourceBitmap()](#getSourceBitmap--) | يحصل أو يعيّن مخزنًا يحتوي على صورة المصدر، والذي ليس من الضروري أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_STRETCHBLT. |
| [setSourceBitmap(WmfDeviceIndependentBitmap value)](#setSourceBitmap-com.aspose.imaging.fileformats.wmf.objects.WmfDeviceIndependentBitmap-) | يحصل أو يعيّن مخزنًا يحتوي على صورة المصدر، والذي ليس من الضروري أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_STRETCHBLT. |
| [getSrcRect()](#getSrcRect--) | يحصل أو يعيّن مستطيل المصدر. |
| [setSrcRect(Rectangle value)](#setSrcRect-com.aspose.imaging.Rectangle-) | يحصل أو يعيّن مستطيل المصدر. |
| [getDestRect()](#getDestRect--) | يحصل أو يعيّن مستطيل الوجهة. |
| [setDestRect(Rectangle value)](#setDestRect-com.aspose.imaging.Rectangle-) | يحصل أو يعيّن مستطيل الوجهة. |
...
ينشئ مثيلًا جديدًا من الفئة `EmfStretchBlt` class.
...
يحصل أو يضبط عددًا صحيحًا غير موقع 32-بت يحدد رمز عملية الرستر. يحدد هذا الرمز كيفية دمج بيانات اللون للمستطيل المصدر مع بيانات اللون للمستطيل الوجهة وربما نمط الفرشاة، لتحقيق اللون النهائي.
...
يحصل أو يضبط مخزنًا يحتوي على صورة البت المصدر، والتي لا يلزم أن تكون متجاورة مع الجزء الثابت من سجل EMR\\_STRETCHBLT. وبالتالي، الحقول في هذا المخزن التي تم تسمية "UndefinedSpace" اختيارية ويجب تجاهلها.
