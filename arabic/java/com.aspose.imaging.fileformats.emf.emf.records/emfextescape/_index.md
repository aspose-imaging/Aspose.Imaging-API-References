...
| المنشئ | الوصف |
| --- | --- |
| [EmfExtEscape(EmfRecord source)](#EmfExtEscape-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | ينشئ مثيلًا جديدًا للفئة `EmfExtEscape`. |
## الطرق
...
ينشئ مثيلًا جديدًا للفئة `EmfExtEscape`.
