...
| [getIhBrush()](#getIhBrush--) | يحصل أو يضبط عددًا صحيحًا غير موقع 32‑بت يحدد فهرس جدول كائنات EMF للفرشاة لملء المنطقة. |
| [setIhBrush(int value)](#setIhBrush-int-) | يحصل أو يضبط عددًا صحيحًا غير موقع 32‑بت يحدد فهرس جدول كائنات EMF للفرشاة لملء المنطقة. |
...
يحصل أو يضبط عددًا صحيحًا غير موقع 32‑بت يحدد فهرس جدول كائنات EMF للفرشاة لملء المنطقة.
