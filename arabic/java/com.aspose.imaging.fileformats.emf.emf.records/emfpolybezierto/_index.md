...
description: "سجل EMR_POLYBEZIERTO يحدد منحنى (أو أكثر) بيزيير استنادًا إلى الموضع الحالي."
type: docs
weight: 87
...
سجل EMR\_POLYBEZIERTO يحدد منحنيات بيزيه واحد أو أكثر بناءً على الموقع الحالي.
