...
description: "السجل EMR_POLYBEZIERTO16 يحدد منحنى (أو أكثر) بيزيير بناءً على الموضع الحالي."
type: docs
weight: 88
...
سجل EMR\_POLYBEZIERTO16 يحدد منحنيات بيزيه واحد أو أكثر بناءً على الموقع الحالي.
...
| المنشئ | الوصف |
| --- | --- |
| [EmfPolyBezierTo16(EmfRecord record)](#EmfPolyBezierTo16-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | يُنشئ نسخة جديدة من الفئة `EmfPolyBezierTo16`. |
| [EmfPolyBezierTo16()](#EmfPolyBezierTo16--) | يُنشئ نسخة جديدة من الفئة `EmfPolyBezierTo16`. |
...
يُنشئ نسخة جديدة من الفئة `EmfPolyBezierTo16`.
