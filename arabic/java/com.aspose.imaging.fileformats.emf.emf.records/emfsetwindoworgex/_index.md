...
| المنشئ | الوصف |
| --- | --- |
| [EmfSetWindowOrgEx(EmfRecord source)](#EmfSetWindowOrgEx-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | ينشئ مثيلًا جديدًا من الفئة `EmfSetWindowOrgEx`. |
| [EmfSetWindowOrgEx()](#EmfSetWindowOrgEx--) | ينشئ مثيلًا جديدًا من الفئة `EmfSetWindowOrgEx`. |
## الطرق
...
ينشئ مثيلًا جديدًا من الفئة `EmfSetWindowOrgEx`.
