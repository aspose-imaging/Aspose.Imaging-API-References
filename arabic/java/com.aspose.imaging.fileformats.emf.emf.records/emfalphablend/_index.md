...
description: "السجل EMR_ALPHABLEND يحدد نقلًا كتليًا للبكسلات من صورة نقطية مصدر إلى مستطيل هدف شامل بيانات شفافية ألفا وفق عملية دمج محددة."
type: docs
weight: 11
...
| المنشئ | الوصف |
| --- | --- |
| [EmfAlphaBlend(EmfRecord source)](#EmfAlphaBlend-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | يُهيئ مثيلاً جديدًا من الفئة `EmfAlphaBlend`. |
## الطرق
...
| [getBlendFunction()](#getBlendFunction--) | يحصل أو يعيّن بنية تحدد عمليات المزج للصور النقطية المصدر والوجهة |
| [setBlendFunction(EmfBlendFunction value)](#setBlendFunction-com.aspose.imaging.fileformats.emf.emf.records.EmfBlendFunction-) | يحصل أو يعيّن بنية تحدد عمليات المزج للصور النقطية المصدر والوجهة |
...
| [getSourceBitmap()](#getSourceBitmap--) | يحصل أو يعيّن مخزنًا يحتوي على الصورة النقطية المصدر، والذي لا يُشترط أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_ALPHABLEND. |
| [setSourceBitmap(WmfDeviceIndependentBitmap value)](#setSourceBitmap-com.aspose.imaging.fileformats.wmf.objects.WmfDeviceIndependentBitmap-) | يحصل أو يعيّن مخزنًا يحتوي على الصورة النقطية المصدر، والذي لا يُشترط أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_ALPHABLEND. |
...
يُهيئ مثيلاً جديدًا من الفئة `EmfAlphaBlend`.
...
يحصل أو يعيّن عددًا صحيحًا موقعًا 32 بتًا يحدد العرض المنطقي للمستطيل الوجهة. يجب أن تكون هذه القيمة أكبر من الصفر.
...
يحصل أو يعيّن عددًا صحيحًا موقعًا 32 بتًا يحدد الارتفاع المنطقي للمستطيل الوجهة. يجب أن تكون هذه القيمة أكبر من الصفر.
...
يحصل أو يعيّن بنية تحدد عمليات المزج للصور النقطية المصدر والوجهة
...
يحصل أو يعيّن عددًا صحيحًا موقعًا 32 بتًا يحدد العرض المنطقي للمستطيل المصدر. يجب أن تكون هذه القيمة أكبر من الصفر.
...
يحصل أو يعيّن عددًا صحيحًا موقعًا 32 بتًا يحدد الارتفاع المنطقي للمستطيل المصدر. يجب أن تكون هذه القيمة أكبر من الصفر.
...
يحصل أو يعيّن مخزنًا يحتوي على الصورة النقطية المصدر، والذي لا يُشترط أن يكون متجاورًا مع الجزء الثابت من سجل EMR\_ALPHABLEND. وبالتالي، الحقول في هذا المخزن التي تم تسمية "UndefinedSpace" اختيارية ويجب تجاهلها.
