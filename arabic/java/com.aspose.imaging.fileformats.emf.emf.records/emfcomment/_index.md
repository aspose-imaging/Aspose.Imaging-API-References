...
| المنشئ | الوصف |
| --- | --- |
| [EmfComment(EmfRecord source)](#EmfComment-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | ينشئ مثيلاً جديدًا من الفئة `EmfComment`. |
## الطرق
...
ينشئ مثيلاً جديدًا من الفئة `EmfComment`.
...
يحصل أو يعيّن مصفوفة اختيارية من البايتات تحدد البيانات الخاصة. يجب ألا تكون الكلمة المزدوجة DWORD الأولى من هذه البيانات واحدة من قيم معرف التعليق المحددة مسبقًا المذكورة في القسم 2.3.3. البيانات الخاصة غير معروفة لـ EMF؛ هي ذات معنى فقط للتطبيقات التي تعرف تنسيق البيانات وكيفية استخدامها. سجلات البيانات الخاصة بـ EMR\_COMMENT قد يتم تجاهلها.
