...
كائن PitchAndFamily يحدد خصائص العرض والعائلة لكائن Font (القسم 2.2.1.2). يشير العرض إلى عرض الأحرف، وتشير العائلة إلى المظهر العام للخط.
## المنشئات
...
يحصل على خاصية من الخط تصف درجة الصوت للأحرف. يجب أن تكون هذه قيمة في تعداد PitchFont.
