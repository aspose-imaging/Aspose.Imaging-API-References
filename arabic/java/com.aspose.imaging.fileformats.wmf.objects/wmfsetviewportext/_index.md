...
description: "السجل META_SETVIEWPORTEXT يحدد الامتدادات الأفقية والعمودية لواجهة العرض في سياق جهاز التشغيل."
type: docs
weight: 89
url: /ar/java/com.aspose.imaging.fileformats.wmf.objects/wmfsetviewportext/
---
**Inheritance:**
...
سجل META\_SETVIEWPORTEXT يحدد الامتدادات الأفقية والرأسية لمنطقة العرض في سياق جهاز التشغيل.
## المنشئات
