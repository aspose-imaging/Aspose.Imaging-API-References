...
description: "السجل META_SETTEXTCHAREXTRA يحدد التباعد بين الأحرف لتبرير النص في سياق جهاز التشغيل."
type: docs
weight: 86
...
السجل META\_SETTEXTCHAREXTRA يحدد التباعد بين الأحرف لتبرير النص في سياق جهاز التشغيل. يُضاف التباعد إلى المسافة البيضاء بين كل حرف، بما في ذلك الأحرف ``، عندما يتم إخراج سطر نص مبرر.
## المنشئات
...
| طريقة | الوصف |
| --- | --- |
| [getCharExtra()](#getCharExtra--) | يحصل أو يضبط المسافة الإضافية بين الأحرف. |
| [setCharExtra(int value)](#setCharExtra-int-) | يحصل أو يضبط المسافة الإضافية بين الأحرف. |
### WmfSetTextCharExtra() {#WmfSetTextCharExtra--}
```
...
يحصل أو يضبط المسافة الإضافية بين الأحرف.
