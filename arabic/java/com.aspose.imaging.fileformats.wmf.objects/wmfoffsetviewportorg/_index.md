...
description: "يسجل META_OFFSETVIEWPORTORG ينقل أصل منطقة العرض في سياق جهاز التشغيل بواسطة الإزاحات الأفقية والعمودية المحددة."
type: docs
weight: 49
url: /ar/java/com.aspose.imaging.fileformats.wmf.objects/wmfoffsetviewportorg/
---
**Inheritance:**
...
سجل META\_OFFSETVIEWPORTORG ينقل أصل مساحة العرض في سياق جهاز التشغيل بالإزاحات الأفقية والعمودية المحددة.
## المنشئات
