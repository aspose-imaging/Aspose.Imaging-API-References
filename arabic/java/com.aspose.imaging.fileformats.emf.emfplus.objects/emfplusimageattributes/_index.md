...
description: "كائن EmfPlusImageAttributes يحدد كيفية معالجة ألوان صورة البت ماب أثناء العرض."
type: docs
weight: 48
...
كائن EmfPlusImageAttributes يحدد كيفية معالجة ألوان صورة البت ماب أثناء العرض.
## المنشئات
...
| طريقة | الوصف |
| --- | --- |
| [getWrapMode()](#getWrapMode--) | يحصل أو يعيّن عددًا صحيحًا غير موقع 32-بت يحدد كيفية معالجة ظروف الحافة باستخدام قيمة من تعداد WrapMode (القسم 2.1.1.34). |
| [setWrapMode(int value)](#setWrapMode-int-) | يحصل أو يعيّن عددًا صحيحًا غير موقع 32-بت يحدد كيفية معالجة ظروف الحافة باستخدام قيمة من تعداد WrapMode (القسم 2.1.1.34). |
...
يحصل أو يعيّن عددًا صحيحًا غير موقع 32-بت يحدد كيفية معالجة ظروف الحافة باستخدام قيمة من تعداد WrapMode (القسم 2.1.1.34).
...
يحصل أو يعيّن كائن EmfPlusARGB (القسم 2.2.2.1) الذي يحدد لون الحافة لاستخدامه عندما تكون قيمة WrapMode هي WrapModeClamp. يكون هذا اللون مرئيًا عندما يكون المستطيل المصدر الذي تعالجه سجل EmfPlusDrawImage (القسم 2.3.4.8) أكبر من الصورة نفسها.
...
يحصل أو يعيّن عددًا صحيحًا موقعًا 32-بت يحدد سلوك تثبيت الكائن. لا يُستخدم إلا عندما يُطبق هذا الكائن على صورة يتم رسمها. يجب أن تكون هذه القيمة واحدة من القيم المحددة في الجدول التالي.
