...
description: "كائن EmfPlusBitmapData يحدد صورة بت ماب مع بيانات البكسل."
type: docs
weight: 15
...
كائن EmfPlusBitmapData يحدد صورة بت ماب مع بيانات البكسل.
## المنشئات
...
| طريقة | الوصف |
| --- | --- |
| [getColors()](#getColors--) | يحصل أو يضبط ألوان لوحة الألوان Colors (متغير): كائن اختياري `EmfPlusPalette` (القسم 2.2.2.28)، الذي يحدد لوحة الألوان المستخدمة في بيانات البكسل. |
| [setColors(EmfPlusPalette value)](#setColors-com.aspose.imaging.fileformats.emf.emfplus.objects.EmfPlusPalette-) | يحصل أو يضبط ألوان لوحة الألوان Colors (متغير): كائن اختياري `EmfPlusPalette` (القسم 2.2.2.28)، الذي يحدد لوحة الألوان المستخدمة في بيانات البكسل. |
...
يحصل أو يضبط ألوان لوحة الألوان Colors (متغير): كائن اختياري `EmfPlusPalette` (القسم 2.2.2.28)، الذي يحدد لوحة الألوان المستخدمة في بيانات البكسل. يجب أن يكون هذا الحقل موجودًا إذا تم تعيين علم I في حقل PixelFormat لكائن `EmfPlusBitmap`.
...
يحصل أو يضبط بيانات البكسل PixelData (متغير): مصفوفة من البايتات التي تحدد بيانات البكسل. يمكن حساب حجم وتنسيق هذه البيانات من الحقول في كائن EmfPlusBitmap، بما في ذلك تنسيق البكسل من تعداد `Consts.EmfPlusPixelFormat` (القسم 2.1.1.25).
