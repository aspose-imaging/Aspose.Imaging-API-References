...
description: "كائن EmfPlusBoundaryPointData يحدد حد منحنى كاردينال مغلق لفرشاة التدرج"
type: docs
weight: 22
url: /ar/java/com.aspose.imaging.fileformats.emf.emfplus.objects/emfplusboundarypointdata/
---
**Inheritance:**
...
كائن EmfPlusBoundaryPointData يحدد حد منحنى كاردينال مغلق لفرشاة التدرج
## المنشئات
...
| طريقة | الوصف |
| --- | --- |
| [getBoundaryPointData()](#getBoundaryPointData--) | يحصل أو يضبط مصفوفة من كائنات BoundaryPointCount EmfPlusPointF التي تحدد حدود الفرشاة. |
| [setBoundaryPointData(PointF[] value)](#setBoundaryPointData-com.aspose.imaging.PointF---) | يحصل أو يضبط مصفوفة من كائنات BoundaryPointCount EmfPlusPointF التي تحدد حدود الفرشاة. |
### EmfPlusBoundaryPointData() {#EmfPlusBoundaryPointData--}
```
...
### getBoundaryPointData() {#getBoundaryPointData--}
```
public PointF[] getBoundaryPointData()
```


يحصل أو يضبط مصفوفة من كائنات BoundaryPointCount EmfPlusPointF التي تحدد حدود الفرشاة.

**Returns:**
com.aspose.imaging.PointF[]
### setBoundaryPointData(PointF[] value) {#setBoundaryPointData-com.aspose.imaging.PointF---}
```
