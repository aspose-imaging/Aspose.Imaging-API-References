...
description: "كائن EmfPlusPalette يحدد الألوان التي تتكون منها لوحة الألوان."
type: docs
weight: 57
...
كائن EmfPlusPalette يحدد الألوان التي تتكون منها لوحة الألوان.
## المنشئات
...
| طريقة | الوصف |
| --- | --- |
| [getPaletteStyleFlags()](#getPaletteStyleFlags--) | يحصل أو يعيّن أعلام نمط اللوحة. |
| [setPaletteStyleFlags(int value)](#setPaletteStyleFlags-int-) | يحصل أو يعيّن أعلام نمط اللوحة. |
...
يحصل أو يعيّن أعلام نمط اللوحة.

القيمة: PaletteStyleFlags (4 بايت): عدد صحيح غير موقع بسعة 32 بت يحدد سمات البيانات في اللوحة. يجب أن تتكون هذه القيمة من أعلام `EmfPlusPaletteStyleFlags`.
...
القيمة: PaletteEntries (متغيّر): مصفوفة من كائنات ARGB بسعة 32 بت عددها PaletteCount تُحدد البيانات في اللوحة.
