...
type: docs
weight: 80
url: /ar/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [TiffStreamReader(data)](#TiffStreamReader_data_1) | ينشئ مثيلاً جديداً من الفئة [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
| [TiffStreamReader(data, start_index)](#TiffStreamReader_data_start_index_2) | ينشئ مثيلاً جديداً من الفئة [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
| [TiffStreamReader(data, start_index, data_length)](#TiffStreamReader_data_start_index_data_length_3) | ينشئ مثيلاً جديداً من الفئة [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
| [TiffStreamReader(stream_container)](#TiffStreamReader_stream_container_4) | ينشئ مثيلاً جديداً من الفئة [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
## **Properties**
...
ينشئ مثيلاً جديداً من الفئة [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/).
