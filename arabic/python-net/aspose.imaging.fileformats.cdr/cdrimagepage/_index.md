---
title: "فئة CdrImagePage"
type: docs
weight: 210
url: /ar/python-net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | يحصل أو يعيّن مستند CDR. |
...
| is_cached | bool | r | يحصل على قيمة تشير إلى ما إذا كانت بيانات الكائن مخزنة مؤقتًا حاليًا ولا يلزم قراءة البيانات. |
...
| parent_image | [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) | r | يحصل على الصورة الأصلية. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_42) | يعيد تحجيم العرض الجديد المحدد. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_43) | يعيد تحجيم الصورة باستخدام خيارات موسعة. |
