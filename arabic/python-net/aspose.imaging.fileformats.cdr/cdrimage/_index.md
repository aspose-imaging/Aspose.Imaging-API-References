...
type: docs
weight: 190
url: /ar/python-net/aspose.imaging.fileformats.cdr/cdrimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_1) | ابدأ العمل مع الفئة [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) بسهولة عن طريق<br/>إنشاء مثيل جديد باستخدام تدفق ومعلمات loadOptions.<br/>مثالي للمطورين الذين يبحثون عن طريقة مريحة لتحميل صور CDR من<br/>مصادر بيانات مختلفة مع تخصيص عملية التحميل حسب الحاجة. |
## **Properties**
...
| bits_per_pixel | int | r | استرجع عمق البت للصورة بسهولة باستخدام هذه الخاصية سهلة الاستخدام.<br/>مثالي للمطورين الذين يرغبون في تحديد مستوى التفاصيل أو عمق اللون الموجود<br/>في صورهم، مما يضمن معالجة دقيقة وتعديلًا فعالًا. |
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | استرجع أو حدّث مستند CDR بسهولة باستخدام هذه الخاصية البديهية.<br/>مثالي للمطورين الذين يرغبون في الوصول إلى مستند CDR أو تعديله، مما يضمن<br>المرونة والكفاءة في تطبيقاتهم. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | استرجع الصفحة الافتراضية للصورة بسهولة باستخدام هذه الخاصية سهلة الاستخدام.<br/>مثالي للمطورين الذين يبحثون عن وصول سريع إلى الصفحة الرئيسية لصورتهم،<br/>مما يضمن تنقلًا وإدارةً فعّالة. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | استرجع تنسيق ملف الصورة بسهولة باستخدام هذه الخاصية البديهية.<br/>مثالي للمطورين الذين يرغبون في تحديد تنسيق صورهم بشكل ديناميكي،<br/>مما يضمن التوافق ومعالجة دقيقة في تطبيقاتهم. |
...
| is_cached | bool | r | حدد بسهولة ما إذا كانت بيانات الكائن مخزنة مؤقتًا حاليًا،<br/>مما يلغي الحاجة إلى قراءة البيانات. مثالي للمطورين الذين يسعون<br/>إلى تحسين الأداء من خلال الاستفادة من البيانات المخزنة مؤقتًا بفعالية، مما يضمن<br>وصولًا أسرع إلى معلومات الكائن. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | يحصل على بيانات التعريف الخاصة بالصورة. |
| page_count | int | r | استرجع أو حدّث عدد الصفحات الإجمالي للصورة بسهولة باستخدام هذه<br/>الخاصية البديهية. مثالي للمطورين الذين يرغبون في إدارة الصور متعددة الصفحات<br/>بشكل ديناميكي، مما يضمن تنقلًا فعالًا وتعديلًا لمحتوى الصورة. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | استرجع صفحات الصورة بسلاسة باستخدام هذه الخاصية البديهية.<br/>مثالي للمطورين الذين يرغبون في الوصول إلى الصفحات الفردية داخل<br/>الصور متعددة الصفحات، مما يضمن تنقلًا فعالًا ومعالجةً دقيقة. |
...
| **Name** | **الوصف** |
| :- | :- |
| cache_data() | قم بتخزين البيانات مؤقتًا بسهولة لمنع التحميل الإضافي من المصدر الأساسي<br/>باستخدام هذه الطريقة سهلة الاستخدام. مثالي للمطورين الذين يسعون إلى تحسين الأداء<br/>من خلال تحميل البيانات مسبقًا، مما يضمن وصولًا أسرع وعملًا أكثر سلاسة في تطبيقاتهم.<br/>[DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
ابدأ العمل مع الفئة [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) بسهولة عن طريق<br/>إنشاء مثيل جديد باستخدام تدفق ومعلمات loadOptions.<br/>مثالي للمطورين الذين يبحثون عن طريقة مريحة لتحميل صور CDR من<br/>مصادر بيانات مختلفة مع تخصيص عملية التحميل حسب الحاجة.
...
استرجع صفحات الصورة بسلاسة باستخدام هذه الخاصية البديهية.<br/>مثالي للمطورين الذين يرغبون في الوصول إلى الصفحات الفردية داخل<br/>الصور متعددة الصفحات، مما يضمن تنقلًا فعالًا ومعالجةً دقيقة.
...
| update_colors | bool | إذا تم تعيينه إلى <c>true</c> سيتم تحديث الألوان وفقًا للوحة الجديدة؛ وإلا ستبقى فهارس الألوان دون تغيير. لاحظ أن الفهارس غير المتغيرة قد تتسبب في تعطل الصورة عند التحميل إذا لم يكن لبعض الفهارس مدخلات لوحة مقابلة. |
