...
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.dng/dngimage/
---
...
| bits_per_pixel | int | r | اكتشف عدد البتات لكل بكسل في الصورة بسهولة باستخدام هذه الخاصية <br/>            . مثالية لفهم عمق بكسل الصورة بسرعة ودقة. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | حدد تنسيق ملف الصورة باستخدام هذه الخاصية. مثالية لـ <br/>            فهم التنسيق - تفاصيل مباشرة فقط. |
...
| height | int | r | استرجع ارتفاع الصورة باستخدام هذه الخاصية. مثالية لتحديد <br/>            الحجم العمودي للصورة دون عناء. |
...
| img_data | [RawData](/imaging/python-net/aspose.imaging.fileformats.dng.decoder/rawdata/) | r/w | إدارة بيانات الصورة باستخدام هذه الخاصية. سواء كنت تسترجع أو تحدث، <br/>            توفر هذه الخاصية وصولًا سلسًا إلى بيانات الصورة لتعديل فعال <br/>            . |
...
| width | int | r | الوصول إلى عرض الصورة باستخدام هذه الخاصية. مثالية للحصول على <br/>            الحجم الأفقي للصورة بسرعة وكفاءة. |
