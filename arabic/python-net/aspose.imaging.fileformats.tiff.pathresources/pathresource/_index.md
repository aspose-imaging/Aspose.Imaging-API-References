---
title: "فئة PathResource"
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.tiff.pathresources/pathresource/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [PathResource()](#PathResource__1) | ينشئ مثيلاً جديداً من فئة PathResource |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| block_id | int | r/w | يحصل أو يعيّن معرف الكتلة. |
| الاسم | string | r/w | يحصل أو يعيّن الاسم. |
| السجلات | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Core.VectorPaths.VectorPathRecord]] | r/w | يحصل أو يعيّن السجلات. |
...
ينشئ مثيلاً جديداً من فئة PathResource
