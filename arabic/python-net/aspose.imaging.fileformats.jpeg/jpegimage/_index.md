...
type: docs
weight: 20
url: /ar/python-net/aspose.imaging.fileformats.jpeg/jpegimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [JpegImage(jpeg_options, width, height)](#JpegImage_jpeg_options_width_height_1) | إنشاء كائن [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) جديد مع خيارات JPEG المقدمة. <br/>            يتيح لك هذا المُنشئ تخصيص إعدادات مختلفة لصورة JPEG، مثل <br/>            مستوى الضغط، الجودة، ومعلمات إضافية، مما يمنحك سيطرة دقيقة <br/>            على تنسيق الصورة الناتج. |
| [JpegImage(path)](#JpegImage_path_2) | تبدأ فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) بسهولة عن طريق استدعاء <br/>            مُنشئها مع معامل المسار المحدد. يتيح هذا المُنشئ إنشاء صور JPEG بسلاسة، مما يضمن دمجًا سريعًا في مشاريعك بسهولة. |
| [JpegImage(raster_image)](#JpegImage_raster_image_3) | إنشاء نسخة جديدة من فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) باستخدام معامل صورة نقطية <br/>            . يوفّر هذا المُنشئ طريقة مريحة لإنشاء صور JPEG مباشرةً من الصور النقطية، مما يُبسّط سير العمل عند التعامل مع صور JPEG <br/>            في تطبيقاتك. |
| [JpegImage(stream)](#JpegImage_stream_4) | إنشاء كائن صورة JPEG باستخدام فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) مع معامل تدفق <br/>            . يُبسّط هذا المُنشئ عملية التعامل مع صور JPEG، موفرًا نهجًا مباشرًا لدمجها في مشاريعك بسهولة. |
| [JpegImage(width, height)](#JpegImage_width_height_5) | إنشاء نسخة جديدة من فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) باستخدام معلمات العرض <br/>            والارتفاع المحددة. يتيح لك هذا المُنشئ إنشاء صور JPEG بأبعاد مخصصة، مما يمنحك مرونة في إدارة أحجام الصور في تطبيقك. |
## **Properties**
...
| bits_per_pixel | int | r | استرجع عمق البكسل للصورة بسهولة باستخدام هذه الخاصية، مما يوفّر <br/>            رؤى حول غنى تمثيل اللون أو التدرج الرمادي. سواء كانت صورة فوتوغرافية حيوية أو توضيح أحادي اللون، تُقدّم هذه الخاصية معلومات حيوية <br/>            حول تعقيد الصورة البصري. |
...
| cmyk_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | ملف تعريف اللون CMYK المرتبط بصور JPEG بنوعي CMYK وYCCK يضمن تحويل لون دقيق وموثوقية. يعمل بالتنسيق مع RGBColorProfile لتأكيد تمثيل لون صحيح عبر مختلف الأجهزة والتطبيقات. هذا الزوج ضروري للحفاظ على اتساق عرض الألوان وتحقيق جودة صورة مثالية. |
| تعليق | string | r/w | إدارة تعليقات ملفات JPEG باستخدام هذه الخاصية، مما يتيح لك إضافة أو استرجاع <br/>            تعليقات وصفية مرتبطة بالصورة. سواء كان ذلك بوضع وسوم على الصور مع البيانات الوصفية أو إلحاق سياق إضافي، توفر هذه الخاصية مرونة في <br/>            تنظيم وتصنيف ملفات JPEG الخاصة بك. |
...
| destination_cmyk_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | ملف تعريف اللون CMYK ضروري للتحويل الدقيق للألوان في صور JPEG بنوعي CMYK وYCCK أثناء عملية الحفظ. يعمل بالتوازي مع RGBColorProfile لضمان تمثيل لون صحيح، محافظًا على الاتساق والجودة عبر مختلف الأجهزة والبرمجيات. هذه المزامنة أساسية لتحقيق عرض لون دقيق وموثوق في الصور المحفوظة نهائيًا. |
| destination_rgb_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | ملف تعريف اللون RGBColorProfile أساسي للتحويل الدقيق للألوان في صور JPEG بنوعي CMYK وYCCK أثناء عملية الحفظ. عند اقترانه بملف تعريف اللون CMYKColorProfile، يضمن أن الألوان تُعرض بشكل صحيح ويحافظ على الاتساق عبر مختلف الأجهزة والتطبيقات. هذا الجمع ضروري للحفاظ على تمثيل اللون المقصود وتحقيق مخرجات صورة عالية الجودة. |
| تم التخلص | bool | r | يحصل على قيمة تشير إلى ما إذا كانت هذه المثيلة تم التخلص منها. |
| exif_data | [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) | r/w | إدارة بيانات EXIF باستخدام هذه الخاصية، مما يتيح لك إضافة أو استرجاع البيانات الوصفية <br/>            المرتبطة بالصورة. سواء كان ذلك باستخراج معلومات حول إعدادات الكاميرا أو تعديل البيانات الوصفية الحالية، توفر هذه الخاصية مرونة في <br/>            إدارة حاوية بيانات EXIF. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | استرجع تنسيق الصورة بسهولة باستخدام هذه الخاصية. فهي توفر <br/>            نظرة قيمة على تنسيق الملف، مما يساعد في دمج سلس وفحوصات توافق عبر مختلف المنصات والتطبيقات. |
...
| height | int | r | استرجع ارتفاع الصورة بسهولة باستخدام هذه الخاصية. فهي توفر وصولًا سريعًا إلى البُعد العمودي للصورة، مما يتيح لك تحديد حجمها ونسبة أبعادها بكفاءة دون الحاجة إلى حسابات معقدة أو <br/>            طرق إضافية. |
| horizontal_resolution | float | r/w | هذه الخاصية تمنحك الوصول إلى الدقة الأفقية لـ<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/)، المقاسة بالبكسل لكل بوصة. عن طريق تعيين أو استرجاع <br/>            هذه القيمة، يمكنك التحكم بدقة في دقة الصورة، مما يضمن أنها <br/>            تلبي متطلباتك المحددة للجودة والوضوح. |
| ignore_embedded_color_profile | bool | r/w | يسترجع أو يعدل العلامة التي تشير إلى ما إذا كان ملف تعريف اللون المدمج <br/>            يتم تجاهله. عن طريق تعيين هذه العلامة، يمكن للمستخدمين تحديد ما إذا كان يجب استخدام ملف تعريف اللون الافتراضي <br/>            بدلاً من المدمج. يضمن هذا الخيار تحكمًا أكبر <br/>            في إدارة الألوان، مما يسهل التعديلات لتحقيق التناسق و <br/>            التوافق عبر مختلف المنصات والتطبيقات. |
...
| jfif | [JFIFData](/imaging/python-net/aspose.imaging.fileformats.jpeg/jfifdata/) | r/w | تتيح لك هذه الخاصية الوصول إلى بيانات JFIF (JPEG File Interchange <br/>            Format) المرتبطة بصورة JPEG أو تعديلها. JFIF هو تنسيق قياسي لـ <br/>            تبادل الصور المضغوطة بصيغة JPEG بين الحواسيب والأجهزة الأخرى. عن طريق استرجاع <br/>            أو تعيين هذه الخاصية، يمكنك التفاعل مع بيانات JFIF، والتي قد تشمل <br/>            معلومات مثل دقة الصورة، نسبة العرض إلى الارتفاع، والصورة المصغرة. |
| jpeg_options | [JpegOptions](/imaging/python-net/aspose.imaging.imageoptions/jpegoptions/) | r | احصل على الوصول إلى خيارات JPEG المستخدمة أثناء إنشاء أو تحميل هذه<br/>            [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) بسهولة. توفر هذه الخاصية تفاصيل قيمة <br/>            حول الإعدادات المحددة المستخدمة، مما يمكّن المستخدمين من فهم وتكرار <br/>            سير عمل معالجة الصور بفعالية. سواء كانت مستويات الضغط، إعدادات الجودة <br/>            أو معلمات أخرى، توفر هذه الخاصية رؤى أساسية لـ <br/>            تعديل الصور بسلاسة. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | تسترجع هذه الخاصية تنسيق البيانات الخام للصورة، والذي يوضح كيف يتم هيكلة البيانات <br/>            المشفرة للصورة. فهم تنسيق البيانات الخام أمر أساسي لمعالجة أو تعديل بيانات الصورة بفعالية. فهو يقدم <br/>            رؤى حول التمثيل الأساسي للصورة، مثل ما إذا كانت مضغوطة، مشفرة في مساحة ألوان معينة، أو مخزنة في تنسيق ملف <br/>            معين. يتيح الوصول إلى هذه الخاصية الحصول على معلومات قيمة حول <br/>            بنية بيانات الصورة، مما يمكنك من تنفيذ عمليات أو تحسينات مختلفة <br/>            مخصصة لتنسيقها المحدد. |
...
| rgb_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | ملف تعريف اللون RGB لصور JPEG بصيغة CMYK وYCCK يضمن تحويلًا دقيقًا للون <br/>            وتمثيله. يجب إقرانه بـ CMYKColorProfile للحفاظ على التناسق والدقة في عرض اللون. هذا الاقتران ضروري للتطبيقات التي تتطلب إدارة لون دقيقة وإعادة إنتاج الصور، <br/>            مما يضمن تفسير وعرض بيانات RGB بشكل صحيح. |
...
| vertical_resolution | float | r/w | تدير هذه الخاصية الدقة العمودية، المعبر عنها بالبكسل لكل بوصة، للـ <br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) المرتبطة. يؤثر تعديل هذه الدقة على <br/>            حجم وجودة الصورة عند طباعتها أو عرضها بحجم مادي ثابت. عن طريق تعيين هذه الخاصية، تتحكم في كثافة بكسلات الصورة عموديًا، مما يؤثر على حدة الصورة ووضوحها العام. |
| width | int | r | تسترجع هذه الخاصية عرض الصورة، معبرًا عنه بالبكسل. توفر <br/>            معلومات أساسية حول أبعاد الصورة، مما يتيح عرضًا دقيقًا، <br/>            تعديلًا أو عرضًا لبيانات الصورة. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_28) | يُنشئ مثيلًا جديدًا من الفئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/). |
| [create_from_images(images)](#create_from_images_images_29) | ينشئ صورة جديدة باستخدام الصور المحددة كصفحات |
| [create_from_images(images, dispose_images)](#create_from_images_images_dispose_images_30) | ينشئ صورة جديدة باستخدام الصور المحددة كصفحات. |
| [create_from_stream(stream)](#create_from_stream_stream_31) | يُنشئ مثيلًا جديدًا من الفئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/). |
...
| [crop(rectangle)](#crop_rectangle_33) | قص الصورة. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_34) | يُجري تمويهًا على الصورة الحالية. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_35) | يُجري تمويهًا على الصورة الحالية. |
| [embed_digital_signature(password)](#embed_digital_signature_password_36) | إدراج توقيع رقمي بناءً على كلمة المرور المقدمة في الصورة باستخدام التستغنوجرافيا. |
| [filter(rectangle, options)](#filter_rectangle_options_37) | يفلتر المستطيل المحدد. |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_49) | يسترجع التاريخ والوقت عندما خضعت صورة المورد لأحدث <br/>            تعديل. توفر هذه الطريقة بيانات وصفية قيمة، تمكّن المستخدمين من تتبع وإدارة <br/>            تحديثات ملف الصورة بفعالية. من خلال الوصول إلى هذه المعلومات، يمكن للمستخدمين <br/>            ضمان سلامة وحداثة أصولهم من الصور، مما يسهل اتخاذ قرارات مستنيرة بشأن <br/>            استخدام وصيانة الصور. |
| [get_original_options()](#get_original_options__50) | يحصل على خيارات الصورة الأصلية لهذا المثيل [Image](/imaging/python-net/aspose.imaging/image/). |
...
| [is_digital_signed(password, percentage_threshold)](#is_digital_signed_password_percentage_threshold_56) | يُجري فحصًا سريعًا لتحديد ما إذا كانت الصورة موقعة رقمياً، باستخدام كلمة المرور والعتبة المقدمة. |
| [load(file_path)](#load_file_path_57) | يحمّل صورة جديدة من مسار الملف أو عنوان URL المحدد.<br/>            إذا كان _filePath_ مسار ملف، فإن الطريقة تفتح الملف فقط.<br/>            إذا كان _filePath_ عنوان URL، فإن الطريقة تُنزّل الملف، تخزّنه مؤقتًا، وتفتحه. |
| [load(file_path, load_options)](#load_file_path_load_options_58) | يحمّل صورة جديدة من مسار الملف أو عنوان URL المحدد.<br/>            إذا كان _filePath_ مسار ملف، فإن الطريقة تفتح الملف فقط.<br/>            إذا كان _filePath_ عنوان URL، فإن الطريقة تُنزّل الملف، تخزّنه مؤقتًا، وتفتحه. |
| [load(stream)](#load_stream_59) | يحمّل صورة جديدة من الدفق المحدد. |
| [load(stream, load_options)](#load_stream_load_options_60) | يحمّل صورة جديدة من الدفق المحدد. |
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_61) | يحمّل بكسلات ARGB 32‑بت. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_62) | يحمّل بكسلات ARGB 64‑بت. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_63) | يحمّل بكسلات بتنسيق CMYK. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_64) | يحمّل بكسلات بتنسيق CMYK.<br/>            هذه الطريقة مهجورة. يرجى استخدام الطريقة الأكثر فاعلية [RasterImage.load_cmyk_32_pixels(rectangle)](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_74) | يضبط الزاوية.<br/>            هذه الطريقة قابلة للتطبيق على المستندات النصية الممسوحة ضوئيًا للتخلص من الانحراف في المسح.<br/>            تستخدم هذه الطريقة أساليب [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) و [RasterImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_80) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية للحفاظ على حواف ناعمة.<br/>            ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_81) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية للحفاظ على حواف ناعمة.<br/>            ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_83) | يقوم بتغيير حجم الصورة. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_84) | يقوم بتغيير حجم الصورة. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_88) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_92) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_96) | تدوير الصورة حول المركز. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_97) | يدور، يقلب، أو يدور ويقلب الصورة. |
| save() | يقوم بحفظ بيانات الصورة إلى الدفق الأساسي. |
| [save(file_path)](#save_file_path_98) | يقوم بحفظ الصورة إلى موقع الملف المحدد. |
| [save(file_path, options)](#save_file_path_options_99) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_100) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(file_path, over_write)](#save_file_path_over_write_101) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد. |
| [save(stream)](#save_stream_102) | يحفظ بيانات الكائن إلى الدفق المحدد. |
| [save(stream, options_base)](#save_stream_options_base_103) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_104) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_105) | يقوم بحفظ بكسلات ARGB 32‑بت. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_106) | يقوم بحفظ البكسلات. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_107) | يقوم بحفظ البكسلات.<br/>            هذه الطريقة مهجورة. يرجى استخدام الطريقة الأكثر فعالية [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_108) | يقوم بحفظ البكسلات (طريقة خاصة بالتنسيق). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_109) | يحفظ البيانات الخام. |
| [save_to_stream(stream)](#save_to_stream_stream_110) | يحفظ بيانات الكائن إلى الدفق المحدد. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_111) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_112) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_113) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_114) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_115) | يضبط بكسل صورة 32-بت ARGB للموقع المحدد. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_116) | يضبط لوحة ألوان الصورة. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_117) | يضبط بكسل صورة للموقع المحدد. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_118) | يحدد الدقة لـ [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) المحدد، مما يضمن <br/>            التحجيم والطباعة بدقة. تمكّن هذه الطريقة المستخدمين من تعديل <br/>            دقة الصورة لتناسب متطلباتهم الخاصة، سواء للعرض الرقمي <br/>            أو النسخ المادي. عن طريق تعيين الدقة، يمكن للمستخدمين تحسين <br/>            جودة الصورة وضمان التوافق مع مختلف أجهزة الإخراج والوسائط، <br/>            مما يعزز التجربة البصرية العامة وقابلية استخدام الصورة. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_119) | يحاول ضبط مثال _metadata_، إذا كان مثال هذا [Image](/imaging/python-net/aspose.imaging/image/) يدعم ويطبق مثال [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) . |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_120) | يكتب كامل سطر المسح إلى فهرس سطر المسح المحدد. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_121) | يكتب كامل سطر المسح إلى فهرس سطر المسح المحدد. |
...
إنشاء كائن [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) جديد مع خيارات JPEG المقدمة. <br/>            يتيح لك هذا المُنشئ تخصيص إعدادات مختلفة لصورة JPEG، مثل <br/>            مستوى الضغط، الجودة، ومعلمات إضافية، مما يمنحك سيطرة دقيقة <br/>            على تنسيق الصورة الناتج.
...
تبدأ فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) بسهولة عن طريق استدعاء <br/>            مُنشئها مع معامل المسار المحدد. يتيح هذا المُنشئ إنشاء صور JPEG بسلاسة، مما يضمن دمجًا سريعًا في مشاريعك بسهولة.
...
إنشاء نسخة جديدة من فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) باستخدام معامل صورة نقطية <br/>            . يوفّر هذا المُنشئ طريقة مريحة لإنشاء صور JPEG مباشرةً من الصور النقطية، مما يُبسّط سير العمل عند التعامل مع صور JPEG <br/>            في تطبيقاتك.
...
إنشاء كائن صورة JPEG باستخدام فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) مع معامل تدفق <br/>            . يُبسّط هذا المُنشئ عملية التعامل مع صور JPEG، موفرًا نهجًا مباشرًا لدمجها في مشاريعك بسهولة.
...
إنشاء نسخة جديدة من فئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) باستخدام معلمات العرض <br/>            والارتفاع المحددة. يتيح لك هذا المُنشئ إنشاء صور JPEG بأبعاد مخصصة، مما يمنحك مرونة في إدارة أحجام الصور في تطبيقك.
...
يُنشئ مثيلًا جديدًا من الفئة [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/).
...
يسترجع التاريخ والوقت عندما خضعت صورة المورد لأحدث <br/>            تعديل. توفر هذه الطريقة بيانات وصفية قيمة، تمكّن المستخدمين من تتبع وإدارة <br/>            تحديثات ملف الصورة بفعالية. من خلال الوصول إلى هذه المعلومات، يمكن للمستخدمين <br/>            ضمان سلامة وحداثة أصولهم من الصور، مما يسهل اتخاذ قرارات مستنيرة بشأن <br/>            استخدام وصيانة الصور.
...
يحصل على خيارات الصورة الأصلية لهذا المثيل [Image](/imaging/python-net/aspose.imaging/image/).

**Returns**

| نوع | الوصف |
| :- | :- |
| [ImageOptionsBase](/imaging/python-net/aspose.imaging/imageoptionsbase/) | نسخة مستنسخة من خيارات الصورة الأصلية. |
...
يحدد الدقة لـ [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) المحدد، مما يضمن <br/>            التحجيم والطباعة بدقة. تمكّن هذه الطريقة المستخدمين من تعديل <br/>            دقة الصورة لتناسب متطلباتهم الخاصة، سواء للعرض الرقمي <br/>            أو النسخ المادي. عن طريق تعيين الدقة، يمكن للمستخدمين تحسين <br/>            جودة الصورة وضمان التوافق مع مختلف أجهزة الإخراج والوسائط، <br/>            مما يعزز التجربة البصرية العامة وقابلية استخدام الصورة.
...
# أنشئ صورة JPEG بحجم 100×100 بكسل.
