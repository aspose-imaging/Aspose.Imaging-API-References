---
title: "TiffSLong8Type فئة"
type: docs
weight: 120
url: /ar/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_1) | ينشئ مثيلاً جديدًا لـ [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) فئة. |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_2) | ينشئ مثيلاً جديدًا لـ [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) فئة. |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| count | int | r | يحصل على عدد العناصر. |
| data_size | int | r | يحصل على حجم قيمة العلامة. |
| element_size | System.Byte | r | يحصل على حجم العنصر. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | ينشئ مثيلاً جديدًا لـ [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) فئة. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | ينشئ مثيلاً جديدًا لـ [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) فئة. |
...
ينشئ مثيلاً جديدًا لـ [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) فئة.
