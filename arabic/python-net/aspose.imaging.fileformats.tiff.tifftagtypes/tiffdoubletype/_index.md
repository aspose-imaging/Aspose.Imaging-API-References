---
title: "فئة TiffDoubleType"
type: docs
weight: 40
url: /ar/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [TiffDoubleType(tag_id)](#TiffDoubleType_tag_id_1) | ينشئ مثيلًا جديدًا للفئة [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
| [TiffDoubleType(tag_id)](#TiffDoubleType_tag_id_2) | ينشئ مثيلًا جديدًا للفئة [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
## **Properties**
...
| القيم | float[] | r/w | يحصل أو يضبط القيم. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | ينشئ مثيلًا جديدًا للفئة [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | ينشئ مثيلًا جديدًا للفئة [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
...
ينشئ مثيلًا جديدًا للفئة [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/).
