---
title: "TiffUndefinedType فئة"
type: docs
weight: 170
url: /ar/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_1) | ينشئ مثيلاً جديدًا لـ [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) فئة. |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_2) | ينشئ مثيلاً جديدًا لـ [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) فئة. |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| count | int | r | يحصل على عدد العناصر. |
| البيانات | System.Byte | r/w | يحصل أو يعيّن البيانات. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | ينشئ مثيلاً جديدًا لـ [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) فئة. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | ينشئ مثيلاً جديدًا لـ [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) فئة. |
...
ينشئ مثيلاً جديدًا لـ [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) فئة.
