...
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.avif/avifimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [AvifImage()](#AvifImage__1) | يقوم بتهيئة نسخة جديدة من الفئة AvifImage |
## **Properties**
...
| bits_per_pixel | int | r | يحصل على قيمة البتات لكل بكسل. |
...
| height | int | r | يحصل على ارتفاع صورة AVIF. |
...
| width | int | r | يحصل على عرض صورة AVIF. |
...
يقوم بتهيئة نسخة جديدة من الفئة AvifImage
