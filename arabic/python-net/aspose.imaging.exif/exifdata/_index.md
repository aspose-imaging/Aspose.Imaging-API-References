...
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.exif/exifdata/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [ExifData()](#ExifData__1) | يُنشئ نسخة جديدة من الفئة [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/). |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | يُنشئ نسخة جديدة من الفئة [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) باستخدام البيانات من المصفوفة. |
| [ExifData(exifdata)](#ExifData_exifdata_3) | يُنشئ نسخة جديدة من الفئة [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) باستخدام البيانات من المصفوفة. |
| [ExifData(exifdata)](#ExifData_exifdata_4) | يُنشئ نسخة جديدة من الفئة [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) باستخدام البيانات من المصفوفة. |
## **Properties**
...
| [maker_notes](#maker_notes1) | [MakerNote[]](/imaging/python-net/aspose.imaging.exif/makernote/) | r | يحصل على ملاحظات الصانع. |
...
| دقة_x | int | r/w | يحصل أو يضبط دقة x. |
| y_resolution | int | r/w | يحصل أو يضبط دقة y. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
...
يُنشئ نسخة جديدة من الفئة [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/).
...
يُنشئ نسخة جديدة من الفئة [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) باستخدام البيانات من المصفوفة.
