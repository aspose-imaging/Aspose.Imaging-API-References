...
type: docs
weight: 3140
url: /ar/python-net/aspose.imaging.fileformats.emf/metaimage/
---
...
| [get_used_fonts()](#get_used_fonts__34) | يعيد قائمة الخطوط المستخدمة داخل ملف الميتا. |
...
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_48) | يعيد تحجيم اللوحة. |
