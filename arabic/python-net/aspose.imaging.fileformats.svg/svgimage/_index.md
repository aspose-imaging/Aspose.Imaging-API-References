...
type: docs
weight: 40
url: /ar/python-net/aspose.imaging.fileformats.svg/svgimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [SvgImage(path)](#SvgImage_path_1) | ينشئ كائنًا جديدًا من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) ، باستخدام <br/> المسار المحدد لتحديد موقع الصورة وتحميلها. يسهّل هذا المُنشئ <br/> إنشاء نسخ من صور SVG من ملفات خارجية، مما يتيح دمجًا سلسًا <br/> في أنظمة البرمجيات وسير العمل. |
| [SvgImage(stream)](#SvgImage_stream_2) | ينشئ نسخة جديدة من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) ، تحميل الصورة <br/> من التدفق المقدم. يتيح هذا المُنشئ التحميل المباشر لصور SVG <br/> من التدفقات، مما يعزز المرونة والكفاءة في معالجة موارد الصور <br/> داخل تطبيقات البرمجيات. |
| [SvgImage(svg_options, width, height)](#SvgImage_svg_options_width_height_3) | ينشئ نسخة جديدة من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) مع خيارات SVG محددة <br/> وعرض الصورة وارتفاعها. يتيح هذا المُنشئ <br/> للمطورين تهيئة صور SVG بخيارات وأبعاد مخصصة، <br/> مما يوفر مرونة في إدارة محتوى SVG وتخطيطه. |
| [SvgImage(width, height)](#SvgImage_width_height_4) | ينشئ كائنًا جديدًا من [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) بالعرض والارتفاع المحددين. يتيح هذا المُنشئ للمطورين إنشاء صور SVG بأبعاد مسبقة التعريف <br/>، مما يسهل التحكم الدقيق في حجم الصورة أثناء <br/> التهيئة. |
## **Properties**
...
| bits_per_pixel | int | r | يسترجع عدد البتات لكل بكسل في الصورة. من المهم ملاحظة أن <br/> هذه المعلمة غير قابلة للتطبيق على الصور المتجهية، لأنها لا تُقاس بـ <br/> البكسل. توفر هذه الخاصية معلومات حيوية حول عمق ألوان الصورة <br/>، مما يساعد في مهام المعالجة والتلاعب. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | يسترجع تنسيق ملف الصورة، موفرًا بيانات تعريفية أساسية لـ <br/> المعالجة وفحوصات التوافق. تُعد هذه الخاصية أساسية في <br/> تحديد استراتيجيات الترميز وفك الترميز المناسبة للتعامل مع <br/> بيانات الصورة بفعالية عبر أنظمة وتطبيقات مختلفة. |
...
| is_cached | bool | r | يسترجع قيمة منطقية تشير إلى ما إذا كانت بيانات الكائن مخزنة مؤقتًا حاليًا <br/>، مما يلغي الحاجة إلى عمليات قراءة بيانات إضافية. توفر هذه <br/> الخاصية نظرة على حالة التخزين المؤقت الحالية، مما يُحسّن استرجاع البيانات <br/> وتدفقات معالجة العمل لأداء وكفاءة محسّنة. |
...
| **Name** | **الوصف** |
| :- | :- |
| cache_data() | قم بتخزين البيانات مؤقتًا وتأكد من عدم تحميل بيانات إضافية من <br/> [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). تُحسن هذه <br/> العملية الأداء عبر إلغاء عمليات استرجاع البيانات المتكررة <br/>، وهو مفيد بشكل خاص في السيناريوهات التي تتطلب وصولًا متكررًا إلى <br/> بيانات الصورة. |
...
| [create_from_stream(stream)](#create_from_stream_stream_20) | يُهيئ نسخة جديدة من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/). |
...
| [load(file_path)](#load_file_path_34) | يحمّل صورة جديدة من مسار الملف أو عنوان URL المحدد.<br/>            إذا كان _filePath_ مسار ملف، فإن الطريقة تفتح الملف فقط.<br/>            إذا كان _filePath_ عنوان URL، فإن الطريقة تُنزّل الملف، تخزّنه مؤقتًا، وتفتحه. |
| [load(file_path, load_options)](#load_file_path_load_options_35) | يحمّل صورة جديدة من مسار الملف أو عنوان URL المحدد.<br/>            إذا كان _filePath_ مسار ملف، فإن الطريقة تفتح الملف فقط.<br/>            إذا كان _filePath_ عنوان URL، فإن الطريقة تُنزّل الملف، تخزّنه مؤقتًا، وتفتحه. |
| [load(stream)](#load_stream_36) | يحمّل قسم SVG. |
| [load(stream, load_options)](#load_stream_load_options_37) | يحمّل صورة جديدة من الدفق المحدد. |
| [load_stream(stream)](#load_stream_stream_38) | يحمّل صورة جديدة من الدفق المحدد. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_39) | يحمّل صورة جديدة من الدفق المحدد. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_40) | يحمّل صورة جديدة من مسار الملف أو عنوان URL المحدد.<br/>            إذا كان _filePath_ مسار ملف، فإن الطريقة تفتح الملف فقط.<br/>            إذا كان _filePath_ عنوان URL، فإن الطريقة تُنزّل الملف، تخزّنه مؤقتًا، وتفتحه. |
| remove_background() | يزيل الخلفية. |
| [remove_background(settings)](#remove_background_settings_41) | يزيل الخلفية. |
| remove_metadata() | يزيل البيانات الوصفية. |
| [resize(new_width, new_height)](#resize_new_width_new_height_42) | يُعيد تحجيم الصورة. يتم استخدام القيمة الافتراضية [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_43) | قم بتغيير حجم الصورة لتتناسب مع الأبعاد المحددة مع الحفاظ على نسبة العرض إلى الارتفاع <br/>            . توفر هذه الطريقة طريقة مريحة لضبط حجم الصورة <br/>            دون تشويه نسبها، مما يضمن عرضًا أو تخزينًا مثاليًا <br/>            وفقًا للأبعاد المطلوبة. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_44) | يعيد تحجيم الصورة باستخدام خيارات موسعة. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_45) | يقوم بتغيير حجم الصورة. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_46) | يقوم بتغيير حجم الصورة. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_47) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. يتم استخدام [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) الافتراضي. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_48) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_49) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_50) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_51) | يقوم بتغيير عرض الصورة بنسبة متناسبة. يتم استخدام [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) الافتراضي. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_52) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_53) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_54) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [rotate(angle)](#rotate_angle_55) | تدوير الصورة حول المركز. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_56) | يدور، يقلب، أو يدور ويقلب الصورة. |
| save() | يقوم بحفظ بيانات الصورة إلى الدفق الأساسي. |
| [save(file_path)](#save_file_path_57) | يقوم بحفظ الصورة إلى موقع الملف المحدد. |
| [save(file_path, options)](#save_file_path_options_58) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_59) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(file_path, over_write)](#save_file_path_over_write_60) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد. |
| [save(stream)](#save_stream_61) | يقوم بحفظ البيانات. |
| [save(stream, options_base)](#save_stream_options_base_62) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_63) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_to_stream(stream)](#save_to_stream_stream_64) | يحفظ بيانات الكائن إلى الدفق المحدد. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_65) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_66) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | يطبق لوحة ألوان محددة على الصورة، مما يتيح تخصيص مخططات الألوان <br/>            لأغراض جمالية أو وظيفية. توفر هذه الطريقة مرونة <br/>            في إدارة لوحات الألوان لتلبية مختلف متطلبات التصميم أو التطبيق. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | يحاول ضبط مثال _metadata_، إذا كان مثال هذا [Image](/imaging/python-net/aspose.imaging/image/) يدعم ويطبق مثال [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) . |
...
ينشئ كائنًا جديدًا من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) ، باستخدام <br/> المسار المحدد لتحديد موقع الصورة وتحميلها. يسهّل هذا المُنشئ <br/> إنشاء نسخ من صور SVG من ملفات خارجية، مما يتيح دمجًا سلسًا <br/> في أنظمة البرمجيات وسير العمل.
...
ينشئ نسخة جديدة من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) ، تحميل الصورة <br/> من التدفق المقدم. يتيح هذا المُنشئ التحميل المباشر لصور SVG <br/> من التدفقات، مما يعزز المرونة والكفاءة في معالجة موارد الصور <br/> داخل تطبيقات البرمجيات.
...
ينشئ نسخة جديدة من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) مع خيارات SVG محددة <br/> وعرض الصورة وارتفاعها. يتيح هذا المُنشئ <br/> للمطورين تهيئة صور SVG بخيارات وأبعاد مخصصة، <br/> مما يوفر مرونة في إدارة محتوى SVG وتخطيطه.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| svg_options | [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/) | خيارات SVG. |
...
ينشئ كائنًا جديدًا من [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) بالعرض والارتفاع المحددين. يتيح هذا المُنشئ للمطورين إنشاء صور SVG بأبعاد مسبقة التعريف <br/>، مما يسهل التحكم الدقيق في حجم الصورة أثناء <br/> التهيئة.
...
يُهيئ نسخة جديدة من فئة [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/).
...
قم بتغيير حجم الصورة لتتناسب مع الأبعاد المحددة مع الحفاظ على نسبة العرض إلى الارتفاع <br/>            . توفر هذه الطريقة طريقة مريحة لضبط حجم الصورة <br/>            دون تشويه نسبها، مما يضمن عرضًا أو تخزينًا مثاليًا <br/>            وفقًا للأبعاد المطلوبة.
...
يطبق لوحة ألوان محددة على الصورة، مما يتيح تخصيص مخططات الألوان <br/>            لأغراض جمالية أو وظيفية. توفر هذه الطريقة مرونة <br/>            في إدارة لوحات الألوان لتلبية مختلف متطلبات التصميم أو التطبيق.
