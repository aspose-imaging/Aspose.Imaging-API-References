...
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.png/pngimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [PngImage(path)](#PngImage_path_1) | ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) باستخدام معامل المسار <br/>            لتحديد موقع ملف الصورة المراد تحميله. يتيح هذا المُنشئ <br/>            للمطورين إنشاء صور PNG بسهولة عن طريق تحميلها من ملف، <br/>            مما يبسط عملية التعامل مع صور PNG في تطبيقاتهم. |
| [PngImage(path, color_type)](#PngImage_path_color_type_2) | يُهيئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق تحديد <br/>            مسار ملف الصورة ونوع اللون. يتيح هذا المُنشئ إنشاء صور PNG بسهولة من ملفات بأنواع ألوان مختلفة، مما يوفر <br/>            مرونة في معالجة صيغ الصور المتنوعة. |
| [PngImage(png_options, width, height)](#PngImage_png_options_width_height_3) | قم بتهيئة مثيل جديد من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) مع دمج <br/>            خيارات PNG إلى جانب معلمات العرض والارتفاع. يتيح هذا المُنشئ للمطورين إنشاء صور PNG بإعدادات وأبعاد قابلة للتخصيص، <br/>            مما يوفر مرونة في توليد الصور لمختلف حالات الاستخدام. |
| [PngImage(raster_image)](#PngImage_raster_image_4) | ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق توفير صورة نقطية <br/>            كمعامل. يتيح هذا المُنشئ للمطورين تهيئة كائن صورة PNG مباشرةً باستخدام صورة نقطية موجودة، مما يُبسّط عملية <br/>            التعامل مع صور PNG في تطبيقاتهم. |
| [PngImage(raster_image, color_type)](#PngImage_raster_image_color_type_5) | ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق تحديد <br/>            صورة نقطية ونوع اللون. يتيح هذا المُنشئ للمطورين تحويل الصور النقطية مباشرةً إلى صيغة PNG مع تحديد نوع اللون المطلوب، <br/>            مما يوفر مرونة في تمثيل الألوان. |
| [PngImage(stream)](#PngImage_stream_6) | ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق تهيئته <br/>            باستخدام تدفق. يتيح هذا المُنشئ للمطورين تحميل صور PNG مباشرةً من تدفق، مما يوفر مرونة في استرجاع الصور من مصادر مختلفة. |
| [PngImage(width, height)](#PngImage_width_height_7) | قم بتهيئة كائن جديد من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق توفير معلمات العرض والارتفاع. يبسط هذا المُنشئ إنشاء صور PNG <br/>            من خلال السماح للمطورين بتحديد الأبعاد مباشرةً، مما يُسهل إدارة بيانات صور PNG بكفاءة داخل تطبيقاتهم. |
| [PngImage(width, height, color_type)](#PngImage_width_height_color_type_8) | أنشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) مع تحديد <br/>            عرض وارتفاع ونوع اللون المطلوبين. يتيح هذا المُنشئ إنشاء صور PNG بسرعة بأبعاد وتكوينات لون مخصصة، <br/>            مما يُسهل توليد الصور بشكل مبسط لمختلف التطبيقات وسير العمل. |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| auto_adjust_palette | bool | r/w | يحصل أو يضبط قيمة تشير إلى ما إذا كان سيتم تعديل لوحة الألوان تلقائيًا. |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | يسترجع لون الخلفية للصورة إذا تم تحديده. هذه الخاصية <br/>            مفيدة للتطبيقات التي تحتاج إلى تحديد وربما تعديل <br/>            لون خلفية الصورة. |
| bits_per_pixel | int | r | استرجع قيمة البتات لكل بكسل للصورة. توفر هذه الخاصية معلومات حيوية <br/>            حول عمق اللون في الصورة، مما يمكّن المطورين من <br/>            فهم مستوى التفاصيل ودقة الألوان الموجودة في بيانات الصورة. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | يسترجع تنسيق الملف المرتبط بمثيل الصورة. توفر هذه <br/>            الخاصية معلومات أساسية حول نوع الملف، مما يتيح <br/>            معالجة وإدارة فعّالة بناءً على متطلبات التنسيق المحددة. |
| [has_alpha](#has_alpha1) | bool | r | يعيد قيمة منطقية تشير إلى ما إذا كانت الصورة تحتوي على قناة ألفا، <br/>            التي تحدد شفافيتها. هذه الخاصية مفيدة للتطبيقات <br/>            التي تحتاج إلى التعامل مع الشفافية، مما يسمح للمطورين بتحديد ما إذا كان <br/>            هناك حاجة إلى معالجة إضافية للتعامل مع المناطق الشفافة في الصورة. |
| has_background_color | bool | r/w | يسترجع قيمة منطقية تشير إلى ما إذا كانت الصورة لديها لون خلفية. <br/>            هذه الخاصية مفيدة للتطبيقات التي تحتاج إلى تحديد ما إذا كانت الصورة <br/>            تتضمن لون خلفية، وهو ما قد يكون مهمًا لمهام معالجة مختلفة <br/>            مثل التركيب، أو العرض، أو التصدير. |
| has_transparent_color | bool | r/w | يوفر قيمة منطقية تشير إلى ما إذا كانت الصورة تحتوي على لون شفاف <br/>            هذه الخاصية حاسمة للتطبيقات التي تحتاج إلى التعامل مع <br/>            الشفافية، مما يسمح للمطورين بتحديد ما إذا كانت هناك حاجة إلى معالجة إضافية <br/>            للتعامل مع المناطق الشفافة في الصورة. |
| height | int | r | احصل على ارتفاع الصورة. تُعيد هذه الخاصية البُعد العمودي للصورة، مما يتيح للمطورين تحديد حجمها بالبكسل على طول المحور <br/>            العمودي. |
| horizontal_resolution | float | r/w | استرجع أو عدّل الدقة الأفقية للصورة. تمثل هذه الخاصية عدد البكسلات لكل بوصة على المحور الأفقي للصورة. يمكن أن يؤثر تعديل هذه الدقة على الحجم الفعلي للصورة عند <br/>            طباعتها أو عرضها. |
| image_opacity | float | r | يحصل على شفافية هذه الصورة. |
| interlaced | bool | r | يسترجع قيمة منطقية تشير إلى ما إذا كان [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) <br/>            متشابكًا، وهو ما يحدد ما إذا كانت بيانات الصورة مخزنة بطريقة تدريجية <br/>            لتحميل أو نقل أسرع. |
...
| is_interlaced | bool | r | يعيد قيمة منطقية تشير إلى ما إذا كانت نسخة الصورة متشابكة. هذه <br/>            الخاصية حاسمة لتحسين استراتيجيات التحميل وضمان أداء فعال <br/>            أثناء معالجة الصور أو مهام العرض. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | يصل إلى تنسيق البيانات الخام للصورة. هذه الخاصية توفر نظرة على <br/>            كيفية هيكلة بيانات الصورة داخليًا، مما يمكن أن يكون مفيدًا لمهام معالجة الصور المتقدمة <br/>            أو تحويل الصيغ. |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | يسترجع اللون الشفاف للصورة، إذا كان موجودًا. هذه الخاصية <br/>            ذات قيمة للتطبيقات التي تتطلب معالجة دقيقة للمناطق الشفافة <br/>            داخل الصور، مما يسمح للمطورين بالوصول إلى اللون الشفاف المحدد <br/>            والتعامل معه. |
...
| vertical_resolution | float | r/w | يوفر الوصول إلى الدقة الرأسية للصورة. يمكن للمطورين استخدام <br/>            هذه الخاصية لاسترجاع أو تعديل إعداد الدقة، والذي يشير إلى <br/>            عدد البكسلات لكل بوصة (PPI) على المحور الرأسي للصورة. |
| width | int | r | يسمح باسترجاع عرض الصورة، موفرًا معلومات أساسية <br/>            حول أبعادها. تُستخدم هذه الخاصية بشكل متكرر من قبل المطورين لتحديد <br/>            عرض الصورة، مما يمكنهم من تنفيذ عمليات مختلفة بناءً على <br/>            حجمها. |
...
| [create_from_file_with_color_type(path, color_type)](#create_from_file_with_color_type_path_color_type_26) | ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_29) | ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_from_image_with_color_type(raster_image, color_type)](#create_from_image_with_color_type_raster_image_color_type_30) | ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_34) | ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_color_type(width, height, color_type)](#create_with_width_height_color_type_width_height_color_type_35) | ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_options(png_options, width, height)](#create_with_width_height_options_png_options_width_height_36) | ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_37) | قص الصورة مع إزاحات. |
| [crop(rectangle)](#crop_rectangle_38) | قص الصورة. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_39) | يُجري تمويهًا على الصورة الحالية. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_40) | يُجري تمويهًا على الصورة الحالية. |
| [embed_digital_signature(password)](#embed_digital_signature_password_41) | إدراج توقيع رقمي بناءً على كلمة المرور المقدمة في الصورة باستخدام التستغنوجرافيا. |
| [filter(rectangle, options)](#filter_rectangle_options_42) | يفلتر المستطيل المحدد. |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_54) | يسترجع الطابع الزمني الذي يشير إلى أحدث تعديل لمورد <br/>            الصورة. هذه الطريقة توفر الوصول إلى بيانات وصفية حيوية، مما يمكّن التطبيقات من <br/>            معرفة متى تم تعديل الصورة آخر مرة، وتسهيل تتبع الإصدارات وإدارة <br/>            المحتوى. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_79) | يضبط الزاوية.<br/>            هذه الطريقة قابلة للتطبيق على المستندات النصية الممسوحة ضوئيًا للتخلص من الانحراف في المسح.<br/>            تستخدم هذه الطريقة أساليب [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) و [RasterImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_82) | يستبدل لونًا بآخر مع فرق مسموح به ويحافظ على قيمة ألفا الأصلية لحفظ الحواف السلسة. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_83) | يستبدل لونًا بآخر مع فرق مسموح به ويحافظ على قيمة ألفا الأصلية لحفظ الحواف السلسة. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_84) | يستبدل لونًا بآخر مع فرق مسموح به ويحافظ على قيمة ألفا الأصلية لحفظ الحواف السلسة. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_85) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية للحفاظ على حواف ناعمة.<br/>            ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_86) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية للحفاظ على حواف ناعمة.<br/>            ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
| [resize(new_width, new_height)](#resize_new_width_new_height_87) | يُعيد تحجيم الصورة. يتم استخدام القيمة الافتراضية [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_88) | يقوم بتغيير حجم الصورة. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_89) | يقوم بتغيير حجم الصورة. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_90) | يقوم بتغيير حجم الصورة. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_91) | يقوم بتغيير حجم الصورة. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_92) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. يتم استخدام [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) الافتراضي. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_93) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_94) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_95) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_96) | يقوم بتغيير عرض الصورة بنسبة متناسبة. يتم استخدام [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) الافتراضي. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_97) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_98) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_99) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [rotate(angle)](#rotate_angle_100) | تدوير الصورة حول المركز. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_101) | تدوير الصورة حول المركز. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_102) | يدور، يقلب، أو يدور ويقلب الصورة. |
...
| [save(stream)](#save_stream_107) | بيانات الحفظ. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_123) | يضبط الدقة لهذه [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) باستخدام معامل المسار <br/>            لتحديد موقع ملف الصورة المراد تحميله. يتيح هذا المُنشئ <br/>            للمطورين إنشاء صور PNG بسهولة عن طريق تحميلها من ملف، <br/>            مما يبسط عملية التعامل مع صور PNG في تطبيقاتهم.
...
يُهيئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق تحديد <br/>            مسار ملف الصورة ونوع اللون. يتيح هذا المُنشئ إنشاء صور PNG بسهولة من ملفات بأنواع ألوان مختلفة، مما يوفر <br/>            مرونة في معالجة صيغ الصور المتنوعة.
...
| :- | :- | :- |
| المسار | string | المسار لتحميل صورة. |
| color_type | [PngColorType](/imaging/python-net/aspose.imaging.fileformats.png/pngcolortype/) | نوع اللون. |
...
قم بتهيئة مثيل جديد من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) مع دمج <br/>            خيارات PNG إلى جانب معلمات العرض والارتفاع. يتيح هذا المُنشئ للمطورين إنشاء صور PNG بإعدادات وأبعاد قابلة للتخصيص، <br/>            مما يوفر مرونة في توليد الصور لمختلف حالات الاستخدام.
...
ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق توفير صورة نقطية <br/>            كمعامل. يتيح هذا المُنشئ للمطورين تهيئة كائن صورة PNG مباشرةً باستخدام صورة نقطية موجودة، مما يُبسّط عملية <br/>            التعامل مع صور PNG في تطبيقاتهم.
...
ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق تحديد <br/>            صورة نقطية ونوع اللون. يتيح هذا المُنشئ للمطورين تحويل الصور النقطية مباشرةً إلى صيغة PNG مع تحديد نوع اللون المطلوب، <br/>            مما يوفر مرونة في تمثيل الألوان.
...
ينشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق تهيئته <br/>            باستخدام تدفق. يتيح هذا المُنشئ للمطورين تحميل صور PNG مباشرةً من تدفق، مما يوفر مرونة في استرجاع الصور من مصادر مختلفة.
...
قم بتهيئة كائن جديد من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) عن طريق توفير معلمات العرض والارتفاع. يبسط هذا المُنشئ إنشاء صور PNG <br/>            من خلال السماح للمطورين بتحديد الأبعاد مباشرةً، مما يُسهل إدارة بيانات صور PNG بكفاءة داخل تطبيقاتهم.
...
أنشئ مثيلاً جديداً من فئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) مع تحديد <br/>            عرض وارتفاع ونوع اللون المطلوبين. يتيح هذا المُنشئ إنشاء صور PNG بسرعة بأبعاد وتكوينات لون مخصصة، <br/>            مما يُسهل توليد الصور بشكل مبسط لمختلف التطبيقات وسير العمل.
...
يعيد قيمة منطقية تشير إلى ما إذا كانت الصورة تحتوي على قناة ألفا، <br/>            التي تحدد شفافيتها. هذه الخاصية مفيدة للتطبيقات <br/>            التي تحتاج إلى التعامل مع الشفافية، مما يسمح للمطورين بتحديد ما إذا كان <br/>            هناك حاجة إلى معالجة إضافية للتعامل مع المناطق الشفافة في الصورة.
...
ينشئ نسخة جديدة من الفئة [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/).
...
يسترجع الطابع الزمني الذي يشير إلى أحدث تعديل لمورد <br/>            الصورة. هذه الطريقة توفر الوصول إلى بيانات وصفية حيوية، مما يمكّن التطبيقات من <br/>            معرفة متى تم تعديل الصورة آخر مرة، وتسهيل تتبع الإصدارات وإدارة <br/>            المحتوى.
...
dir_: str = "c:\\temp"
# تحميل صورة PNG ذات اللون الحقيقي من صورة BMP.
...
with BmpImage(100, 100) as bmp_image:
	...
	brush = SolidBrush(Color.red)
	gr.fill_rectangle(brush, bmp_image.bounds)
	# ستتحول ألوان بكسلات الصورة إلى نظيراتها بتدرج الرمادي.
...
dir_: str = "c:\\temp"
# إنشاء صورة PNG بتدرج الرمادي بحجم 100x100 بكسل.
# جميع الألوان سيتم تحويلها تلقائيًا إلى تنسيق تدرج الرمادي.
...
# صورة PNG ذات اللون الحقيقي لا تدعم قناة ألفا
# صورة PNG ذات اللون المفهرس لا تدعم قناة ألفا
# صورة PNG بنظام GrayscaleWithAlpha تدعم قناة ألفا
# صورة PNG بنظام TruecolorWithAlpha تدعم قناة ألفا
