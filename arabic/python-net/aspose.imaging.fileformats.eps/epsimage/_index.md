...
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.eps/epsimage/
---
...
| bits_per_pixel | int | r | الوصول إلى عمق البت الدقيق للصورة بسهولة باستخدام هذه الخاصية. استرجاع <br/>            عدد البتات لكل بكسل، مما يوفر رؤى حاسمة في عمق ألوان الصورة <br/>            ويساعد في تحسين مهام المعالجة. مثالي للتطبيقات التي تتطلب <br/>            تحكمًا دقيقًا في معالجة وتحليل الصورة. |
| bounding_box | [RectangleF](/imaging/python-net/aspose.imaging/rectanglef/) | r | الوصول إلى الصندوق المحيط الأصلي بنقاط مستقلة عن الجهاز، هذه الخاصية <br/>            توفر معلومات هندسية حاسمة حول أبعاد [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) . <br/>            من خلال استرجاع هذه البيانات، يمكن للمستخدمين تقييم حجم الصورة ونسبة أبعادها بدقة <br/>            مما يسهل تخطيطًا وتحديد موضع دقيق في تطبيقات مختلفة. |
| bounding_box_px | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | هذه الخاصية تُعيد الصندوق المحيط الأصلي لـ [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) <br/>            في البكسل، وتوفر بيانات هندسية أساسية للتصيير الدقيق و <br/>            المعالجة. باستخدام هذه المعلومات، يمكن للمستخدمين ضمان وضع وحجم دقيق /// لصور EPS في مشاريعهم، مما يعزز العرض البصري العام والجودة. |
...
| creation_date | System.DateTime | r | استرجاع تاريخ الإنشاء من تعليقات اتفاقيات هيكلة مستندات EPS (DSC) <br/>           ، توفر هذه الخاصية بيانات وصفية أساسية تشير إلى بداية ملف EPS. من خلال الوصول إلى هذه المعلومات، يحصل المستخدمون على رؤى حول أصل الملف وتاريخه، مما يعزز إدارة الملفات وتنظيمها. |
| creator | string | r | توفر هذه الخاصية إمكانية الوصول إلى معلومات المنشئ المستمدة من وثيقة EPS <br/>            Structuring Conventions (DSC) الموجودة داخل ملف EPS. يوفر فهم تفاصيل المنشئ رؤى حول البرنامج أو الأداة المستخدمة لإنشاء ملف EPS، مما يسهل تقييم التوافق عبر مختلف المنصات و<br/>            التطبيقات. |
...
| eps_type | [EpsType](/imaging/python-net/aspose.imaging.fileformats.eps.consts/epstype/) | r | الوصول إلى قيمة النوع الفرعي لصورة EPS الخاصة بك وتفسيرها، مما يبسط سير العمل <br/>            ويعزز التوافق عبر المنصات. مثالي لتحسين استرجاع النوع الفرعي لـ EPS في مشاريعك بدقة وكفاءة. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | يحصل أو يعيّن كائن Exif. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | الوصول إلى تنسيق ملف الصورة الخاصة بك باستخدام هذه الخاصية. استرجاع المعلومات الأساسية <br/>            حول تنسيق ملف الصورة، مما يسهل التوافق والمعالجة الفعّالة. مثالي لتحديد تنسيق ملفات الصور الخاصة بك للتكامل السلس في مشاريعك. |
| has_background_color | bool | r/w | يحصل أو يعيّن قيمة تشير إلى ما إذا كانت الصورة لديها لون خلفية. |
| has_raster_preview | bool | r | اكتشف وجود معاينة نقطية بسهولة باستخدام هذه الخاصية. الوصول <br/>            إلى القيمة المنطقية التي تشير إلى ما إذا كانت نسخة [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) تشمل معاينة نقطية، مما يعزز مهام معالجة الصور بالوضوح والكفاءة. <br/>            مثالي لتبسيط قرارات سير العمل بناءً على وجود أو عدم وجود معاينات نقطية في صور EPS. |
| height | int | r | يحصل على ارتفاع الصورة. |
| height_f | float | r | الوصول إلى ارتفاع الصورة باستخدام هذه الخاصية. الحصول على ارتفاع الصورة بسهولة <br/>            مما يتيح تعديل التخطيط بسلاسة، حساب نسب الأبعاد، وتقديم عرض دقيق عبر مختلف دقات الشاشات وبيئات العرض. |
...
| is_cached | bool | r | توفر هذه الخاصية طريقة مريحة للتحقق مما إذا كانت بيانات الكائن مخزنة مؤقتًا حاليًا، مما يلغي الحاجة إلى قراءة بيانات إضافية. <br/>            إنها تقدم طريقة سريعة وفعّالة لتحديد ما إذا كانت المعلومات المطلوبة متاحة فورًا، <br/>            مما يحسن الأداء ويقلل من استهلاك الموارد في العمليات المكثفة للبيانات. |
...
| post_script_version | string | r | تسترجع هذه الخاصية نسخة PostScript المرتبطة بنسخة <br/>            [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) . إنها توفر نظرة على نسخة لغة PostScript المحددة المستخدمة داخل ملف EPS، مما يساعد في تقييم التوافق وتسهيل التكامل السلس مع البيئات المتوافقة مع PostScript. |
| preview_image_count | int | r | الوصول إلى عدد صور المعاينة المتاحة بسهولة. تسمح لك هذه الخاصية <br/>            باسترجاع عدد صور المعاينة المرتبطة بملفك بسهولة، <br/>            مما يتيح إدارة وتصفح فعال لصور المعاينة الخاصة بك. مثالي لتحسين سير العمل وتنظيم أصول الصور بفعالية. |
| preview_images | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | استرجاع صور المعاينة المرتبطة بملفك. توفر هذه الخاصية وصولًا سلسًا إلى مجموعة صور المعاينة، <br/>            مما يتيح لك تصفحها وإدارتها بكفاءة حسب الحاجة. مثالي لمعاينة سريعة واختيار الصورة المناسبة لمشروعك. |
...
| العنوان | string | r | تسترجع هذه الخاصية العنوان المستخرج من تعليقات بنية وثائق EPS <br/>            Structuring Conventions (DSC) المدمجة داخل ملف EPS. إنها توفر بيانات وصفية قيمة حول محتوى ملف EPS، مما يساعد في تنظيم المستندات وتحديدها داخل التطبيقات البرمجية المتوافقة. |
| use_palette | bool | r | يحصل على قيمة تشير إلى ما إذا كانت لوحة ألوان الصورة مستخدمة. |
| width | int | r | يحصل على عرض الصورة. |
| width_f | float | r | استرجاع عرض الصورة باستخدام هذه الخاصية المريحة. احصل على عرض الصورة بسهولة <br/>            مما يسهل حسابات التخطيط الدقيقة، عمليات التحجيم، والمهام المتعلقة بالأبعاد داخل تطبيقك. مثالي لضمان عرض دقيق للصور عبر مختلف المنصات والأجهزة. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | يحصل أو يضبط بيانات Xmp. |
## **Methods**
| **Name** | **الوصف** |
| :- | :- |
| cache_data() | هذه الطريقة لا تفعل شيئًا لأن تنفيذ فئة [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) الحالي لا يتضمن تخزين البيانات مؤقتًا. <br/>            بينما قد لا تقوم بأي إجراء، فإن فهم هذا السلوك ضروري للمطورين الذين يعملون مع صور EPS، لضمان إدارة موارد فعّالة وأداء أمثل داخل تطبيقاتهم. |
...
| [get_original_options()](#get_original_options__29) | يحصل على الخيارات بناءً على إعدادات الملف الأصلي.<br/> يمكن أن يكون ذلك مفيدًا للحفاظ على عمق البت وغيرها من معلمات الصورة الأصلية دون تغيير.<br/> على سبيل المثال، إذا قمنا بتحميل صورة PNG بالأبيض والأسود بعمق 1 بت لكل بكسل ثم حفظناها باستخدام<br/> طريقة [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/)، سيتم إنتاج صورة PNG ناتجة بعمق 8 بت لكل بكسل.<br/> لتجنب ذلك وحفظ صورة PNG بعمق 1 بت لكل بكسل، استخدم هذه الطريقة للحصول على خيارات الحفظ المقابلة ومررها<br/> إلى طريقة [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) كمعامل ثانٍ. |
| [get_preview_image(format)](#get_preview_image_format_30) | يسترجع صورة المعاينة الموجودة بالتنسيق المحدد _format_ أو يرجع **None** إذا لم يتم العثور على أي منها. <br/>            توفر هذه الطريقة مرونة في الوصول إلى صور المعاينة المخصصة لتنسيقات معينة، <br/>            مما يحسن التوافق وإدارة الموارد داخل التطبيقات. |
| [get_preview_images()](#get_preview_images__31) | يصل إلى صور المعاينة المرتبطة بنسخة [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) ، مما يسمح باسترجاع سلس للتفتيش أو الاستخدام في التطبيقات. <br/>            توفر هذه الطريقة وصولًا مريحًا إلى صور المعاينة، مما يعزز تفاعل المستخدم مع بيانات الصورة. |
...
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_34) | يحوّل إلى aps. |
...
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_48) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. يتم استخدام [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) الافتراضي. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_49) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_50) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_51) | يقوم بتغيير ارتفاع الصورة بنسبة متناسبة. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_52) | يقوم بتغيير عرض الصورة بنسبة متناسبة. يتم استخدام [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) الافتراضي. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_53) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_54) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_55) | يقوم بتغيير عرض الصورة بنسبة متناسبة. |
| [rotate(angle)](#rotate_angle_56) | تدوير الصورة حول المركز. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_57) | يدور، يقلب، أو يدور ويقلب الصورة. |
| save() | يقوم بحفظ بيانات الصورة إلى الدفق الأساسي. |
| [save(file_path)](#save_file_path_58) | يقوم بحفظ الصورة إلى موقع الملف المحدد. |
| [save(file_path, options)](#save_file_path_options_59) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_60) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(file_path, over_write)](#save_file_path_over_write_61) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد. |
| [save(stream)](#save_stream_62) | يقوم بحفظ البيانات. |
| [save(stream, options_base)](#save_stream_options_base_63) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_64) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_to_stream(stream)](#save_to_stream_stream_65) | يحفظ بيانات الكائن إلى الدفق المحدد. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_66) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_67) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_68) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_69) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_70) | خصص لوحات ألوان الصورة لتحقيق أنماط ألوان فريدة وتعزيز الجاذبية البصرية. <br/>            صمم الألوان لتأثيرات محددة وحسّن جودة الصورة عبر مختلف المنصات والأجهزة بسهولة. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_71) | يحاول ضبط مثال _metadata_، إذا كان مثال هذا [Image](/imaging/python-net/aspose.imaging/image/) يدعم ويطبق مثال [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) . |
...
يسترجع صورة المعاينة الموجودة بالتنسيق المحدد _format_ أو يرجع **None** إذا لم يتم العثور على أي منها. <br/>            توفر هذه الطريقة مرونة في الوصول إلى صور المعاينة المخصصة لتنسيقات معينة، <br/>            مما يحسن التوافق وإدارة الموارد داخل التطبيقات.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| format | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | تنسيق صورة المعاينة EPS. |

**Returns**

| نوع | الوصف |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | صورة المعاينة الموجودة أو **None**. |
...
يصل إلى صور المعاينة المرتبطة بنسخة [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) ، مما يسمح باسترجاع سلس للتفتيش أو الاستخدام في التطبيقات. <br/>            توفر هذه الطريقة وصولًا مريحًا إلى صور المعاينة، مما يعزز تفاعل المستخدم مع بيانات الصورة.

**Returns**

| نوع | الوصف |
| :- | :- |
| System.Collections.Generic.IEnumerable`1[[Aspose.Imaging.Image]] | صور المعاينة. |
...
خصص لوحات ألوان الصورة لتحقيق أنماط ألوان فريدة وتعزيز الجاذبية البصرية. <br/>            صمم الألوان لتأثيرات محددة وحسّن جودة الصورة عبر مختلف المنصات والأجهزة بسهولة.
...
with aspycore.as_of(Image.load("Sample.eps"), EpsImage) as image:
	...
	# عرض صورة نقطية باستخدام PostScript
...
#تحميل صورة EPS
with Image.load("AstrixObelix.eps") as image:
	# تغيير حجم الصورة باستخدام إعدادات التحجيم المتقدمة
