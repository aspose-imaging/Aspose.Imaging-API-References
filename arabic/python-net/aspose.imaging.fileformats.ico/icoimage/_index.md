---
title: "الفئة IcoImage"
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.ico/icoimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [IcoImage(image, ico_options)](#IcoImage_image_ico_options_1) | مصمم للبساطة والكفاءة، تمكّن فئة [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) <br/>           ك من إنشاء صور ICO بسهولة. يقوم هذا المُنشئ بتهيئة نسخة جديدة <br/>           من الفئة، موفرًا أساسًا قويًا لاحتياجاتك في معالجة الصور. <br/>            سواءً كنت تطور تطبيقات أو تحسن واجهات المستخدم، فإن فئة <br/>            [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) تبسط إدارة صور ICO، مما يتيح لك التركيز <br/>           على تقديم تجارب استثنائية. |
| [IcoImage(width, height, options)](#IcoImage_width_height_options_2) | ابدأ إنشاء صورة ICO بسهولة باستخدام فئة [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/). هذا <br/>            المُنشئ يتيح لك تهيئة نسخ جديدة من صور ICO عن طريق تحديد <br/>            عرض، ارتفاع، ومعلمات خيارات الإنشاء. باستخدام هذا المُنشئ البسيط، يمكنك تخصيص صور ICO وفقًا لمواصفاتك الدقيقة، مما يضمن <br/>            توافقًا سلسًا وجاذبية بصرية عبر مختلف المنصات والأجهزة. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | استرجع تنسيق الملف بسهولة باستخدام هذه الخاصية، مما يتيح دمجًا سلسًا <br/>            في سير عملك. باستخدام هذه الخاصية، تحصل على وصول إلى معلومات حيوية <br/>            حول تنسيق ملفك، مما يضمن التوافق والمعالجة الفعّالة. |
| has_alpha | bool | r | حدد ما إذا كان قناة ألفا موجودة في هذه الحالة باستخدام هذه الخاصية. إنها <br/>            توفر طريقة سريعة للتحقق مما إذا كانت الصورة أو المستند يحتوي على قناة ألفا، <br/>            وهو أمر حاسم لمهام معالجة الصور وعرضها المتنوعة. مثالية <br/>            لضمان التوافق ومعالجة تأثيرات الشفافية في الصور أو المستندات. |
...
| page_count | int | r | احصل على نظرة فورية على بنية المستند باستخدام هذه الخاصية البسيطة <br/>            . من خلال استدعاء هذه الخاصية، تسترجع بسهولة العدد الإجمالي للصفحات <br/>            الموجودة في الملف. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | استرجع معلومات شاملة عن صفحات المستند بسهولة عبر <br/> هذه الخاصية. من خلال الوصول إلى هذه الخاصية، ستحصل على مجموعة أو مصفوفة <br/> تحتوي على جميع الصفحات الموجودة داخل المستند. |
...
| **Name** | **الوصف** |
| :- | :- |
| [add_page(page)](#add_page_page_1) | قم بتوسيع صورة ICO الخاصة بك بإضافة إدخال صفحة صورة، مستفيدًا من <br/> [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). هذه الطريقة تدمج صورًا نقطية بسلاسة في <br/> ملف ICO الخاص بك، وتحولها إلى تنسيق PNG عالي الجودة بعمق 32 بت. مثالية لـ <br/> تحسين ملفات ICO الخاصة بك باستخدام الصور النقطية مع ضمان التوافق الأمثل <br/> جودة العرض. |
| [add_page(page)](#add_page_page_2) | قم بتوسيع صورة ICO الخاصة بك بإضافة إدخال صفحة صورة، مستفيدًا من <br/> [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). هذه الطريقة تدمج صورًا نقطية بسلاسة في <br/> ملف ICO الخاص بك، وتحولها إلى تنسيق PNG عالي الجودة بعمق 32 بت. مثالية لـ <br/> تحسين ملفات ICO الخاصة بك باستخدام الصور النقطية مع ضمان التوافق الأمثل <br/> جودة العرض. |
| [add_page(page, ico_options)](#add_page_page_ico_options_3) | نوّع صورة ICO الخاصة بك بسهولة عن طريق دمج إدخال صورة مخصص وفقًا <br/> لاحتياجاتك باستخدام [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) المحدد. هذه الطريقة تدمج الصورة بسلاسة <br/> وفقًا للخيارات المخصصة الخاصة بك، مما يضمن المرونة <br/> والدقة في ملف ICO الخاص بك. |
| [add_raster_page(page)](#add_raster_page_page_4) | يضيف إدخال صورة إلى صورة ICO وفقًا لـ [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) الافتراضية كملف PNG بعمق 32 بت. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | ضبط _السطوع_ للصورة. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | [Image](/imaging/python-net/aspose.imaging/image/) متباين |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | تصحيح جاما لصورة. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | تصحيح جاما لصورة. |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_11) | تحويل الصورة إلى ثنائية باستخدام خوارزمية العتبة التكيفية لبرايدلي باستخدام عتبة الصورة المتكاملة |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | تحويل الصورة إلى ثنائية باستخدام عتبة محددة مسبقًا |
...
| [can_load(stream)](#can_load_stream_17) | يحدد ما إذا كان التدفق المعطى يحتوي على صورة ICO. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | قص الصورة مع إزاحات. |
...
| [embed_digital_signature(password)](#embed_digital_signature_password_38) | أدمج توقيعًا رقميًا يعتمد على كلمة المرور المقدمة في كل صفحة من الصورة. |
...
| [remove_page(index)](#remove_page_index_79) | قم بضبط صورة ICO الخاصة بك بدقة عن طريق إزالة إدخال صورة محدد يقع في <br/> ***index*** المحدد داخل الملف. هذه الطريقة توفر تحكمًا دقيقًا <br/> في تكوين الصورة، مما يتيح لك تحسين ملف ICO بسهولة. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_83) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية لحفظ الحواف السلسة.<br/>                ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_84) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية لحفظ الحواف السلسة.<br/>                ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) صورة حول المركز. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | يدور، يقلب، أو يدور ويقلب جميع الصفحات. |
...
| [save(file_path, options)](#save_file_path_options_103) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
...
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_109) | يقوم بحفظ بكسلات ARGB 32‑بت. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_110) | يقوم بحفظ البكسلات. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_111) | يقوم بحفظ البكسلات.<br/>            هذه الطريقة مهجورة. يرجى استخدام الطريقة الأكثر فعالية [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_112) | يحفظ البكسلات الداخلية الرئيسية. |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_113) | يحفظ البيانات الخام. |
| [save_to_stream(stream)](#save_to_stream_stream_114) | يحفظ بيانات الكائن إلى الدفق المحدد. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_115) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_116) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_117) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_118) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_119) | يضبط بكسل صورة 32-بت ARGB للموقع المحدد. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_120) | يضبط لوحة ألوان الصورة. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_121) | يضبط بكسل صورة للموقع المحدد. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_122) | يضبط الدقة لهذه [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_123) | يحاول ضبط مثال _metadata_، إذا كان مثال هذا [Image](/imaging/python-net/aspose.imaging/image/) يدعم ويطبق مثال [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) . |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_124) | يكتب كامل سطر المسح إلى فهرس سطر المسح المحدد. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_125) | يكتب كامل سطر المسح إلى فهرس سطر المسح المحدد. |
...
مصمم للبساطة والكفاءة، تمكّن فئة [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) <br/>           ك من إنشاء صور ICO بسهولة. يقوم هذا المُنشئ بتهيئة نسخة جديدة <br/>           من الفئة، موفرًا أساسًا قويًا لاحتياجاتك في معالجة الصور. <br/>            سواءً كنت تطور تطبيقات أو تحسن واجهات المستخدم، فإن فئة <br/>            [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) تبسط إدارة صور ICO، مما يتيح لك التركيز <br/>           على تقديم تجارب استثنائية.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| image | [Image](/imaging/python-net/aspose.imaging/image/) | الصورة. |
| ico_options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | خيارات ICO. |
...
| width | int | العرض. |
| height | int | الارتفاع. |
| options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | خيارات إنشاء ICO. |
...
قم بتوسيع صورة ICO الخاصة بك بإضافة إدخال صفحة صورة، مستفيدًا من <br/> [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). هذه الطريقة تدمج صورًا نقطية بسلاسة في <br/> ملف ICO الخاص بك، وتحولها إلى تنسيق PNG عالي الجودة بعمق 32 بت. مثالية لـ <br/> تحسين ملفات ICO الخاصة بك باستخدام الصور النقطية مع ضمان التوافق الأمثل <br/> جودة العرض.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| page | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | الصورة. |
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| page | [Image](/imaging/python-net/aspose.imaging/image/) | الصورة. |
...
نوّع صورة ICO الخاصة بك بسهولة عن طريق دمج إدخال صورة مخصص وفقًا <br/> لاحتياجاتك باستخدام [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) المحدد. هذه الطريقة تدمج الصورة بسلاسة <br/> وفقًا للخيارات المخصصة الخاصة بك، مما يضمن المرونة <br/> والدقة في ملف ICO الخاص بك.
...
يضيف إدخال صورة إلى صورة ICO وفقًا لـ [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) الافتراضية كملف PNG بعمق 32 بت.
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| الحدّ | System.Byte | قيمة العتبة. إذا كانت القيمة الرمادية المقابلة للبكسل أكبر من العتبة، سيتم تعيين القيمة<br/>                255 له، 0 خلاف ذلك. |
...
يحدد ما إذا كان التدفق المعطى يحتوي على صورة ICO.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| دفق | _io.BufferedRandom | تدفق الصورة. |

**Returns**

| نوع | الوصف |
| :- | :- |
| bool | **True** إذا كان التدفق يحتوي على صورة ICO؛ وإلا **False** |
...
قم بضبط صورة ICO الخاصة بك بدقة عن طريق إزالة إدخال صورة محدد يقع في <br/> ***index*** المحدد داخل الملف. هذه الطريقة توفر تحكمًا دقيقًا <br/> في تكوين الصورة، مما يتيح لك تحسين ملف ICO بسهولة.
...
| :- | :- | :- |
| angle | float | زاوية الدوران بالدرجات. القيم الموجبة ستدور باتجاه عقارب الساعة. |
| resize_proportionally | bool | إذا تم تعيينه إلى <c>true</c> سيتغير حجم صورتك<br/>                وفقًا لإسقاطات المستطيل المدور (نقاط الزوايا) في الحالة الأخرى التي تترك الأبعاد دون تغيير وتقوم فقط<br/>                __internal__ بتدوير محتويات الصورة. |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | لون الخلفية. |
