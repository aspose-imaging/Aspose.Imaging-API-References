---
title: "فئة DicomImage"
type: docs
weight: 20
url: /ar/python-net/aspose.imaging.fileformats.dicom/dicomimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [DicomImage(dicom_options, width, height)](#DicomImage_dicom_options_width_height_1) | قم بإنشاء مثيل جديد من فئة DicomImage بسهولة باستخدام هذا<br/>            المُنشئ، مع الاستفادة من معلمات dicomOptions. مثالي للمطورين الذين يتطلعون<br/>            إلى الغوص في كائنات [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) بسرعة وكفاءة في مشاريعهم. |
| [DicomImage(stream)](#DicomImage_stream_2) | أنشئ مثيلًا جديدًا من فئة DicomImage باستخدام معلمة تدفق<br/>            في هذا المُنشئ. مثالي للمطورين الذين يبحثون عن طريقة مبسطة لتهيئة كائنات [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) من تدفقات البيانات الموجودة في مشاريعهم. |
| [DicomImage(stream, load_options)](#DicomImage_stream_load_options_3) | ابدأ مثيلًا جديدًا من فئة DicomImage بسلاسة باستخدام تدفق و<br/>            معلمات loadOptions في هذا المُنشئ. مثالي للمطورين المتحمسين للبدء<br/>            في العمل مع كائنات [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) بسرعة وفعالية في مشاريعهم. |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| active_page | [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) | r/w | تحكم في الصفحة النشطة للصورة باستخدام هذه الخاصية البديهية. مثالي للمطورين<br/>            الذين يسعون للتبديل الديناميكي بين الصفحات داخل الصور متعددة الصفحات، مما يضمن تنقلًا ومعالجةً فعالين. |
| active_page_index | int | r | استرجع فهرس الصفحة النشطة بسهولة باستخدام هذه الخاصية البديهية.<br/>            مثالي للمطورين الذين يبحثون عن وصول سريع إلى فهرس الصفحة الحالية داخل الصور متعددة الصفحات، مما يضمن تنقلًا ومعالجةً فعالين. |
...
| dicom_pages | [DicomPage[]](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) | r | الوصول إلى صفحات الصورة باستخدام هذه الخاصية البديهية. مثالي للمطورين<br/>            الذين يسعون للتفاعل مع الصفحات الفردية داخل الصورة، مما يضمن تنقلاً سلساً<br/>            وتلاعباً. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | استرجع قيمة تنسيق الملف بسهولة باستخدام هذه الخاصية البديهية. مثالي للمطورين<br/>            الذين يبحثون عن وصول سريع إلى تنسيق ملف الصورة، مما يضمن معالجة فعّالة<br/>            ومعالجة بناءً على نوع الملف. |
| file_info | [DicomImageInfo](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimageinfo/) | r | استرجع معلومات الرأس القيمة من ملف DICOM بسهولة باستخدام هذه<br/>            الخاصية البديهية. مثالي للمطورين الذين يبحثون عن وصول سريع إلى التفاصيل الأساسية<br/>            المتضمنة داخل ملف DICOM، مما يضمن استخراج بيانات فعال وتحليل. |
| has_alpha | bool | r | استرجع ما إذا كانت الصورة تحتوي على قناة ألفا بسهولة باستخدام هذه الخاصية البديهية<br/>            . مثالي للمطورين الذين يسعون لتحديد ما إذا كانت الصورة تحتوي على معلومات شفافية<br/>            ، مما يضمن معالجة دقيقة لبيانات قناة ألفا في مهام معالجة الصور. |
...
| page_count | int | r | استرجع العدد الإجمالي للصفحات في الصورة باستخدام هذه الخاصية البديهية. مثالي للمطورين<br/>            الذين يبحثون عن وصول سريع إلى عدد الصفحات داخل الصورة، مما يضمن<br/>            تنقلاً وإدارة فعّالة. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | الوصول إلى صفحات الصورة باستخدام هذه الخاصية البديهية. مثالي للمطورين<br/>            الذين يسعون للتفاعل مع الصفحات الفردية داخل الصورة، مما يضمن تنقلاً سلساً<br/>            وتلاعباً. |
...
| **Name** | **الوصف** |
| :- | :- |
| [add_page()](#add_page__1) | أضف صفحة جديدة إلى نهاية قائمة صفحات الصورة باستخدام هذه الطريقة البسيطة.<br/>            مثالية للمطورين الذين يسعون لتوسيع الصور متعددة الصفحات ديناميكيًا، مع ضمان دمج سلس<br/>            وتنظيم محتوى الصورة. |
| [add_page(page)](#add_page_page_2) | قم بتوسيع مجموعة صورك بإضافة صفحة جديدة باستخدام هذه الطريقة البديهية.<br/>            مثالية للمطورين الذين يسعون لإضافة صفحات ديناميكيًا إلى الصور متعددة الصفحات،<br/>            مع ضمان توسيع سلس وتنظيم محتوى الصورة. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_3) | عزز إضاءة الصورة من خلال تعديل _السطوع_، وهو<br/>            طريقة معلمة تسمح للمطورين بضبط سطوع الصور بدقة.<br/>            هذه الدالة سهلة الاستخدام تمكّن المطورين من تعديل سطوع الصورة بسلاسة،<br/>            مقدمةً مرونة وتحكمًا في الجماليات البصرية. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_4) | عزّز تباين [Image](/imaging/python-net/aspose.imaging/image/) باستخدام هذه الطريقة السهلة للمستخدم،<br/>            التي تُعدِّل الفارق بين المناطق الفاتحة والداكنة. حسّن وضوح الصورة وتعريفها بسهولة، موفراً للمطورين تحكمًا بديهيًا في<br/>            تباين الصورة للحصول على عرض مثالي. |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_5) | عزّز جودة الصورة واضبطها باستخدام تصحيح جاما، وهي تقنية قوية<br/>            لضبط المظهر البصري بدقة. مثالية للمطورين الذين يهدفون إلى تحسين عرض الصورة،<br/>            وضبط توازن الألوان، وضمان عرض ثابت عبر أجهزة وبيئات مختلفة. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_6) | حقق ضبطًا دقيقًا للألوان بتطبيق تصحيح جاما بشكل مستقل<br/>            على مكونات الأحمر والأخضر والأزرق في الصورة. تضمن هذه الطريقة توازنًا دقيقًا للألوان<br/>            وإخراجًا بصريًا مثاليًا، موجهة للمطورين الباحثين عن تحكم دقيق في عرض الصورة ودقة الألوان. |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_9) | قم بتحويل الصور إلى صيغة ثنائية باستخدام خوارزمية العتبة التكيفية لبرايدلي، مستفيدًا من عتبة الصورة المتكاملة لتحسين الأداء. مثالي للمطورين الذين يرغبون في<br/>            تقسيم الصور تلقائيًا بناءً على التباينات المحلية في السطوع، مما يضمن<br/>            اكتشافًا دقيقًا للكائنات واستخراجها في ظروف إضاءة متغيرة. |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_10) | حوّل الصورة بسهولة إلى صيغة ثنائية باستخدام عتبة محددة مسبقًا<br/>            مع هذه الطريقة البسيطة. مثالي للمطورين الذين يرغبون في تبسيط مهام معالجة الصور عن طريق تقسيم الصورة إلى مكونات المقدمة والخلفية<br/>            بناءً على مستويات الشدة المحددة. |
| binarize_otsu() | طبق عتبة أوتسو لتحويل الصورة إلى ثنائية، مع تحديد القيمة المثلى للعتبة تلقائيًا<br/>            بناءً على هيستوجرام الصورة. مثالي للمطورين الباحثين عن طريقة موثوقة لتقسيم الصور إلى مناطق المقدمة والخلفية<br/>            مع الحد الأدنى من التدخل اليدوي. |
...
| cache_data() | تقوم هذه الطريقة بتخزين البيانات مؤقتًا بكفاءة، مما يحسن الأداء ويضمن وصولًا سريعًا<br/>            عند الحاجة. مثالية للمطورين الذين يسعون لتعزيز سرعة وكفاءة تطبيقاتهم من خلال إدارة موارد البيانات بذكاء. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_32) | قم بضبط منطقة القص للصورة عن طريق تطبيق الإزاحات باستخدام هذه الطريقة المتعددة الاستخدامات.<br/> مثالية للمطورين الذين يحتاجون إلى تحكم دقيق في عملية القص، مما يضمن<br/> الحفاظ على التفاصيل الهامة مع القضاء على العناصر غير الضرورية. |
| [crop(rectangle)](#crop_rectangle_33) | قم بقص الصورة لإزالة المناطق غير المرغوب فيها والتركيز على المحتوى الأساسي باستخدام هذه<br/> الطريقة البسيطة. مثالية للمطورين الذين يسعون لتخصيص التركيب البصري لل<br/> الصور، مما يضمن نقل الرسالة المطلوبة بفعالية. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_34) | يُجري تمويهًا على الصورة الحالية. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_35) | حسّن الصورة الحالية بتطبيق تأثيرات التمويه باستخدام هذه الطريقة المبسطة.<br/> مثالية للمطورين الذين يهدفون إلى إضافة نسيج وعمق للصور،<br/> مما يحسن جودتها البصرية وجاذبيتها العامة. |
...
| [filter(rectangle, options)](#filter_rectangle_options_37) | قم بتحسين مناطق محددة من صورتك بسهولة عن طريق تطبيق فلاتر على المستطيلات المعينة.<br/> توفر هذه الطريقة للمطورين تحكمًا دقيقًا في<br/> معالجة الصورة، مما يسمح بإجراء تعديلات مستهدفة لتحقيق التأثيرات البصرية المطلوبة بسهولة. |
...
| grayscale() | حوّل الصور بسهولة إلى تمثيلها بتدرج الرمادي، مما يبسط تحليل ومعالجة البصر.<br/>            مثالي للمطورين الذين يسعون لتعزيز وضوح الصورة،<br/>            تقليل التعقيد، وتسهيل الخوارزميات القائمة على التدرج الرمادي<br/>            لتطبيقات متنوعة. |
| [insert_page(page_index)](#insert_page_page_index_56) | أدرج صفحة جديدة في قائمة صفحات الصورة عند فهرس محدد باستخدام هذه الطريقة البديهية.<br/>            مثالية للمطورين الذين يرغبون في التحكم الدقيق في ترتيب الصفحات في<br/>            الصور متعددة الصفحات، مما يضمن تنظيمًا سلسًا وتخصيص محتوى الصورة. |
...
| [remove_page(page_index)](#remove_page_page_index_78) | أزل الصفحة عند الفهرس المحدد من قائمة الصفحات باستخدام هذه الطريقة المريحة.<br/>            مثالية للمطورين الذين يسعون للتحكم الدقيق في إدارة الصور متعددة الصفحات،<br/>            مما يضمن تنظيمًا سلسًا وتخصيص محتوى الصورة. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_85) | يُعيد تحجيم الصورة مع الحفاظ على نسبة العرض إلى الارتفاع باستخدام هذه الطريقة المريحة. مثالية<br/>            للمطورين الذين يرغبون في ضبط أبعاد الصورة بنسب متناسبة، مما يضمن<br/>            التناسق والحفاظ على نسب المحتوى الأصلي.<br/>            سيُعيد التحجيم النسبي كل إطار وفقًا لنسبة _newWidth_/العرض و _newHeight_/الارتفاع. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_86) | قم بضبط حجم صورتك باستخدام طريقة تغيير الحجم البسيطة هذه. سواء كنت بحاجة إلى<br/>            تقليص أو تكبير صورتك، تضمن هذه الدالة تلبية احتياجاتك في تغيير الحجم<br/>            بكفاءة ودقة، مما يجعلها مثالية للمطورين الذين يبحثون عن تعديل حجم الصورة بسرعة وسهولة. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_90) | قم بضبط ارتفاع الصورة مع الحفاظ على نسبة العرض إلى الارتفاع باستخدام هذه<br/>            الطريقة سهلة الاستخدام. مثالية للمطورين الذين يرغبون في تغيير حجم الصور ديناميكياً<br/>            مع الحفاظ على نسبها، مما يضمن عرضاً مثالياً وسهولة الاستخدام<br/>            في تطبيقاتهم. |
...
| [resize_proportional(new_width, new_height, resize_type)](#resize_proportional_new_width_new_height_resize_type_93) | يُعيد تحجيم الصورة مع الحفاظ على نسبة العرض إلى الارتفاع باستخدام هذه الطريقة المريحة. مثالية<br/>            للمطورين الذين يرغبون في ضبط أبعاد الصورة بنسب متناسبة، مما يضمن<br/>            التناسق والحفاظ على نسب المحتوى الأصلي.<br/>            سيُعيد التحجيم النسبي كل إطار وفقًا لنسبة _newWidth_/العرض و _newHeight_/الارتفاع. |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_95) | قم بضبط عرض الصورة مع الحفاظ على نسبة العرض إلى الارتفاع باستخدام هذه الطريقة<br/>            المريحة. مثالية للمطورين الذين يرغبون في تغيير حجم الصور بنسبة متناسبة، مما يضمن<br/>            نتائج متسقة وجذابة بصرياً عبر بيئات العرض المختلفة. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | قم بتدوير الصورة حول مركزها باستخدام هذه الطريقة المريحة. مثالية للمطورين<br/>            الذين يرغبون في تعديل اتجاه الصورة ديناميكياً، مما يضمن عرضاً مثالياً و<br/>            محاذاة داخل تطبيقاتهم. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | قم بسهولة بتعديل الإطار النشط عن طريق التدوير أو القلب، أو تنفيذ كلا الإجراءين<br/>            معاً باستخدام هذه الطريقة البسيطة. مثالية للمطورين الذين يحتاجون إلى<br/>            تعديل اتجاه إطارات محددة داخل تسلسلات الصور ديناميكياً،<br/>            مما يضمن عرضاً مثالياً ومحاذاة. |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_101) | يقوم بتدوير جميع القلب. |
| save() | يقوم بحفظ بيانات الصورة إلى الدفق الأساسي. |
| [save(file_path)](#save_file_path_102) | يقوم بحفظ الصورة إلى موقع الملف المحدد. |
| [save(file_path, options)](#save_file_path_options_103) | قم بالحفاظ على بيانات الكائن عن طريق حفظها إلى الملف المحدد (المؤشر + اسم الملف)<br/>            مع تنسيق الملف المحدد والخيارات. مثالية للمطورين الذين يرغبون في<br/>            تخزين البيانات بأمان في صيغ مختلفة مع الحفاظ على المرونة والتحكم في<br/>            معلمات الحفظ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_104) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(file_path, over_write)](#save_file_path_over_write_105) | يقوم بحفظ بيانات الكائن إلى موقع الملف المحدد. |
| [save(stream)](#save_stream_106) | يقوم بحفظ البيانات. |
| [save(stream, options_base)](#save_stream_options_base_107) | يقوم بحفظ بيانات الصورة إلى الدفق المحدد بالتنسيق المحدد وفقاً لخيارات الحفظ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | قم بسهولة بحفظ بيانات صورتك إلى دفق محدد بالتنسيق المطلوب<br/>            باستخدام هذه الطريقة المريحة. سواء كنت تعمل مع JPEG أو PNG أو أي تنسيق آخر،<br/>            تضمن هذه الدالة حفظ بيانات صورتك بكفاءة ودقة،<br/>            مما يجعلها مثالية للمطورين الذين يرغبون في تبسيط عمليات حفظ الملفات. |
| [save_all(file_path, options)](#save_all_file_path_options_109) | قم بالحفاظ على بيانات الكائن عن طريق حفظها إلى الملف المحدد (المؤشر + اسم الملف)<br/>            مع تنسيق الملف المحدد والخيارات. مثالية للمطورين الذين يرغبون في<br/>            تخزين البيانات بأمان في صيغ مختلفة مع الحفاظ على المرونة والتحكم في<br/>            معلمات الحفظ. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_113) | يقوم بحفظ البكسلات (طريقة خاصة بالتنسيق). |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_121) | يضبط لوحة ألوان الصورة. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_122) | يضبط بكسل صورة للموقع المحدد. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_123) | قم بضبط دقة هذا [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) بدقة باستخدام هذه<br/>            الطريقة البسيطة. مثالية للمطورين الذين يرغبون في تخصيص دقة الصورة لتلبية المتطلبات المحددة، مع ضمان جودة عرض مثالية وإدارة حجم الملف. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_124) | يحاول ضبط مثال _metadata_، إذا كان مثال هذا [Image](/imaging/python-net/aspose.imaging/image/) يدعم ويطبق مثال [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) . |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_125) | يكتب كامل سطر المسح إلى فهرس سطر المسح المحدد. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_126) | يكتب كامل سطر المسح إلى فهرس سطر المسح المحدد. |
...
قم بإنشاء مثيل جديد من فئة DicomImage بسهولة باستخدام هذا<br/>            المُنشئ، مع الاستفادة من معلمات dicomOptions. مثالي للمطورين الذين يتطلعون<br/>            إلى الغوص في كائنات [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) بسرعة وكفاءة في مشاريعهم.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| dicom_options | [DicomOptions](/imaging/python-net/aspose.imaging.imageoptions/dicomoptions/) | خيارات الـ dicom. |
| width | int | العرض. |
| height | int | الارتفاع. |
...
أنشئ مثيلًا جديدًا من فئة DicomImage باستخدام معلمة تدفق<br/>            في هذا المُنشئ. مثالي للمطورين الذين يبحثون عن طريقة مبسطة لتهيئة كائنات [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) من تدفقات البيانات الموجودة في مشاريعهم.
...
ابدأ مثيلًا جديدًا من فئة DicomImage بسلاسة باستخدام تدفق و<br/>            معلمات loadOptions في هذا المُنشئ. مثالي للمطورين المتحمسين للبدء<br/>            في العمل مع كائنات [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) بسرعة وفعالية في مشاريعهم.
...
أضف صفحة جديدة إلى نهاية قائمة صفحات الصورة باستخدام هذه الطريقة البسيطة.<br/>            مثالية للمطورين الذين يسعون لتوسيع الصور متعددة الصفحات ديناميكيًا، مع ضمان دمج سلس<br/>            وتنظيم محتوى الصورة.

**Returns**

| نوع | الوصف |
| :- | :- |
| [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) | الصفحة [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) التي تم إنشاؤها حديثًا. |
...
قم بتوسيع مجموعة صورك بإضافة صفحة جديدة باستخدام هذه الطريقة البديهية.<br/>            مثالية للمطورين الذين يسعون لإضافة صفحات ديناميكيًا إلى الصور متعددة الصفحات،<br/>            مع ضمان توسيع سلس وتنظيم محتوى الصورة.
...
عزز إضاءة الصورة من خلال تعديل _السطوع_، وهو<br/>            طريقة معلمة تسمح للمطورين بضبط سطوع الصور بدقة.<br/>            هذه الدالة سهلة الاستخدام تمكّن المطورين من تعديل سطوع الصورة بسلاسة،<br/>            مقدمةً مرونة وتحكمًا في الجماليات البصرية.
...
عزّز تباين [Image](/imaging/python-net/aspose.imaging/image/) باستخدام هذه الطريقة السهلة للمستخدم،<br/>            التي تُعدِّل الفارق بين المناطق الفاتحة والداكنة. حسّن وضوح الصورة وتعريفها بسهولة، موفراً للمطورين تحكمًا بديهيًا في<br/>            تباين الصورة للحصول على عرض مثالي.
...
عزّز جودة الصورة واضبطها باستخدام تصحيح جاما، وهي تقنية قوية<br/>            لضبط المظهر البصري بدقة. مثالية للمطورين الذين يهدفون إلى تحسين عرض الصورة،<br/>            وضبط توازن الألوان، وضمان عرض ثابت عبر أجهزة وبيئات مختلفة.
...
حقق ضبطًا دقيقًا للألوان بتطبيق تصحيح جاما بشكل مستقل<br/>            على مكونات الأحمر والأخضر والأزرق في الصورة. تضمن هذه الطريقة توازنًا دقيقًا للألوان<br/>            وإخراجًا بصريًا مثاليًا، موجهة للمطورين الباحثين عن تحكم دقيق في عرض الصورة ودقة الألوان.
...
قم بتحويل الصور إلى صيغة ثنائية باستخدام خوارزمية العتبة التكيفية لبرايدلي، مستفيدًا من عتبة الصورة المتكاملة لتحسين الأداء. مثالي للمطورين الذين يرغبون في<br/>            تقسيم الصور تلقائيًا بناءً على التباينات المحلية في السطوع، مما يضمن<br/>            اكتشافًا دقيقًا للكائنات واستخراجها في ظروف إضاءة متغيرة.
...
حوّل الصورة بسهولة إلى صيغة ثنائية باستخدام عتبة محددة مسبقًا<br/>            مع هذه الطريقة البسيطة. مثالي للمطورين الذين يرغبون في تبسيط مهام معالجة الصور عن طريق تقسيم الصورة إلى مكونات المقدمة والخلفية<br/>            بناءً على مستويات الشدة المحددة.
...
قم بضبط منطقة القص للصورة عن طريق تطبيق الإزاحات باستخدام هذه الطريقة المتعددة الاستخدامات.<br/> مثالية للمطورين الذين يحتاجون إلى تحكم دقيق في عملية القص، مما يضمن<br/> الحفاظ على التفاصيل الهامة مع القضاء على العناصر غير الضرورية.
...
قم بقص الصورة لإزالة المناطق غير المرغوب فيها والتركيز على المحتوى الأساسي باستخدام هذه<br/> الطريقة البسيطة. مثالية للمطورين الذين يسعون لتخصيص التركيب البصري لل<br/> الصور، مما يضمن نقل الرسالة المطلوبة بفعالية.
...
حسّن الصورة الحالية بتطبيق تأثيرات التمويه باستخدام هذه الطريقة المبسطة.<br/> مثالية للمطورين الذين يهدفون إلى إضافة نسيج وعمق للصور،<br/> مما يحسن جودتها البصرية وجاذبيتها العامة.
...
قم بتحسين مناطق محددة من صورتك بسهولة عن طريق تطبيق فلاتر على المستطيلات المعينة.<br/> توفر هذه الطريقة للمطورين تحكمًا دقيقًا في<br/> معالجة الصورة، مما يسمح بإجراء تعديلات مستهدفة لتحقيق التأثيرات البصرية المطلوبة بسهولة.
...
أدرج صفحة جديدة في قائمة صفحات الصورة عند فهرس محدد باستخدام هذه الطريقة البديهية.<br/>            مثالية للمطورين الذين يرغبون في التحكم الدقيق في ترتيب الصفحات في<br/>            الصور متعددة الصفحات، مما يضمن تنظيمًا سلسًا وتخصيص محتوى الصورة.
...
أزل الصفحة عند الفهرس المحدد من قائمة الصفحات باستخدام هذه الطريقة المريحة.<br/>            مثالية للمطورين الذين يسعون للتحكم الدقيق في إدارة الصور متعددة الصفحات،<br/>            مما يضمن تنظيمًا سلسًا وتخصيص محتوى الصورة.
...
يُعيد تحجيم الصورة مع الحفاظ على نسبة العرض إلى الارتفاع باستخدام هذه الطريقة المريحة. مثالية<br/>            للمطورين الذين يرغبون في ضبط أبعاد الصورة بنسب متناسبة، مما يضمن<br/>            التناسق والحفاظ على نسب المحتوى الأصلي.<br/>            سيُعيد التحجيم النسبي كل إطار وفقًا لنسبة _newWidth_/العرض و _newHeight_/الارتفاع.
...
قم بضبط حجم صورتك باستخدام طريقة تغيير الحجم البسيطة هذه. سواء كنت بحاجة إلى<br/>            تقليص أو تكبير صورتك، تضمن هذه الدالة تلبية احتياجاتك في تغيير الحجم<br/>            بكفاءة ودقة، مما يجعلها مثالية للمطورين الذين يبحثون عن تعديل حجم الصورة بسرعة وسهولة.
...
قم بضبط ارتفاع الصورة مع الحفاظ على نسبة العرض إلى الارتفاع باستخدام هذه<br/>            الطريقة سهلة الاستخدام. مثالية للمطورين الذين يرغبون في تغيير حجم الصور ديناميكياً<br/>            مع الحفاظ على نسبها، مما يضمن عرضاً مثالياً وسهولة الاستخدام<br/>            في تطبيقاتهم.
...
قم بضبط عرض الصورة مع الحفاظ على نسبة العرض إلى الارتفاع باستخدام هذه الطريقة<br/>            المريحة. مثالية للمطورين الذين يرغبون في تغيير حجم الصور بنسبة متناسبة، مما يضمن<br/>            نتائج متسقة وجذابة بصرياً عبر بيئات العرض المختلفة.
...
قم بتدوير الصورة حول مركزها باستخدام هذه الطريقة المريحة. مثالية للمطورين<br/>            الذين يرغبون في تعديل اتجاه الصورة ديناميكياً، مما يضمن عرضاً مثالياً و<br/>            محاذاة داخل تطبيقاتهم.
...
قم بسهولة بتعديل الإطار النشط عن طريق التدوير أو القلب، أو تنفيذ كلا الإجراءين<br/>            معاً باستخدام هذه الطريقة البسيطة. مثالية للمطورين الذين يحتاجون إلى<br/>            تعديل اتجاه إطارات محددة داخل تسلسلات الصور ديناميكياً،<br/>            مما يضمن عرضاً مثالياً ومحاذاة.
...
قم بالحفاظ على بيانات الكائن عن طريق حفظها إلى الملف المحدد (المؤشر + اسم الملف)<br/>            مع تنسيق الملف المحدد والخيارات. مثالية للمطورين الذين يرغبون في<br/>            تخزين البيانات بأمان في صيغ مختلفة مع الحفاظ على المرونة والتحكم في<br/>            معلمات الحفظ.
...
قم بسهولة بحفظ بيانات صورتك إلى دفق محدد بالتنسيق المطلوب<br/>            باستخدام هذه الطريقة المريحة. سواء كنت تعمل مع JPEG أو PNG أو أي تنسيق آخر،<br/>            تضمن هذه الدالة حفظ بيانات صورتك بكفاءة ودقة،<br/>            مما يجعلها مثالية للمطورين الذين يرغبون في تبسيط عمليات حفظ الملفات.
...
قم بضبط دقة هذا [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) بدقة باستخدام هذه<br/>            الطريقة البسيطة. مثالية للمطورين الذين يرغبون في تخصيص دقة الصورة لتلبية المتطلبات المحددة، مع ضمان جودة عرض مثالية وإدارة حجم الملف.
