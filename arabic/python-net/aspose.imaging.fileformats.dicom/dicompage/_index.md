...
type: docs
weight: 40
url: /ar/python-net/aspose.imaging.fileformats.dicom/dicompage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [DicomPage(image, index)](#DicomPage_image_index_1) | يُنشئ مثيلًا جديدًا للفئة [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/). |
| [DicomPage(image, index, load_options)](#DicomPage_image_index_load_options_2) | يُنشئ مثيلًا جديدًا للفئة [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/). |
## **Properties**
...
| index | int | r | يحصل على فهرس الصفحة الحالية. |
...
| [save(stream)](#save_stream_100) | يقوم بحفظ البيانات. |
...
يُنشئ مثيلًا جديدًا للفئة [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/).

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| image | [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) | الصورة. |
| index | int | الفهرس. |
