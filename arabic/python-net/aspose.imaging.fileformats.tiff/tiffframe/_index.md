...
type: docs
weight: 170
url: /ar/python-net/aspose.imaging.fileformats.tiff/tiffframe/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [TiffFrame(image)](#TiffFrame_image_1) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(image, options)](#TiffFrame_image_options_2) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(options, width, height)](#TiffFrame_options_width_height_3) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path)](#TiffFrame_path_4) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path, options)](#TiffFrame_path_options_5) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream)](#TiffFrame_stream_6) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream, options)](#TiffFrame_stream_options_7) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
## **Properties**
...
| frame_options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | r | يحصل على خيارات إنشاء الإطار. |
...
| [path_resources](#path_resources1) | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Tiff.PathResources.PathResource]] | r/w | يحصل أو يعيّن موارد المسار. |
...
| align_resolutions() | طريقة مساعدة لجعل الدقة الأفقية والعمودية متساوية. |
...
| [copy_frame(tiff_frame)](#copy_frame_tiff_frame_19) | ينسخ الإطار بالكامل (نسخ مكررة). |
| [create(files)](#create_files_20) | ينشئ صورة متعددة الصفحات تحتوي على الملفات المحددة. |
| [create(files, throw_exception_on_load_error)](#create_files_throw_exception_on_load_error_21) | ينشئ صورة متعددة الصفحات تحتوي على الملفات المحددة. |
| [create(image_options, width, height)](#create_image_options_width_height_22) | ينشئ صورة جديدة باستخدام خيارات الإنشاء المحددة. |
...
| [create(images)](#create_images_24) | ينشئ صورة جديدة باستخدام الصور المحددة كصفحات |
| [create(images, dispose_images)](#create_images_dispose_images_25) | ينشئ صورة جديدة باستخدام الصور المحددة كصفحات. |
| [create(multipage_create_options)](#create_multipage_create_options_26) | ينشئ خيارات الإنشاء المتعددة الصفحات المحددة. |
| [create_frame_from(tiff_frame, options)](#create_frame_from_tiff_frame_options_27) | ينشئ الإطار من _tiffFrame_ المحدد باستخدام _options_ المحدد.<br/>            يتم الحفاظ على بيانات البكسل ولكن يتم تحويلها إلى التنسيق المطلوب. |
| [create_from_file_with_options(path, options)](#create_from_file_with_options_path_options_28) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_image(image)](#create_from_image_image_31) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_image_with_options(image, options)](#create_from_image_with_options_image_options_32) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_35) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_stream_with_options(stream, options)](#create_from_stream_with_options_stream_options_36) | يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
يُنشئ مثيلاً جديدًا للفئة [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/).

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | الصورة لتهيئة بكسل الإطار وبيانات لوحة الألوان معها. |
...
| :- | :- | :- |
| image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | الصورة لتهيئة بكسل الإطار وبيانات لوحة الألوان معها. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | الخيارات لاستخدامها مع الإطار الذي تم إنشاؤه حديثًا. |
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | خيارات الإطار. |
| width | int | العرض. |
| height | int | الارتفاع. |
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| المسار | string | المسار لتحميل صورة منه وتهيئة بكسل الإطار وبيانات لوحة الألوان معه. |
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| دفق | _io.BufferedRandom | دفق البيانات لتحميل صورة منه وتهيئة بكسل الإطار وبيانات لوحة الألوان معه. |
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | إطار TIFF للنسخ. |

**Returns**

| نوع | الوصف |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | إطار TIFF المنسوخ حديثًا. |
...
ينشئ الإطار من _tiffFrame_ المحدد باستخدام _options_ المحدد.<br/>            يتم الحفاظ على بيانات البكسل ولكن يتم تحويلها إلى التنسيق المطلوب.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | إطار TIFF لإنشائه من. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | الخيارات الجديدة للاستخدام. |

**Returns**

| نوع | الوصف |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | الإطار الذي تم إنشاؤه حديثًا. |
