---
title: "فئة ImageBitMask"
type: docs
weight: 50
url: /ar/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [ImageBitMask(image)](#ImageBitMask_image_1) | يُنشئ مثلاً جديداً من الفئة [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) بالحجم المستند إلى [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) المحدد الموجود.<br/>            سيتم تخزين [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) المحدد كمصدر الصورة. |
| [ImageBitMask(width, height)](#ImageBitMask_width_height_2) | يُنشئ مثلاً جديداً من الفئة [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) بالعرض والارتفاع المحددين. |
## **Properties**
...
| [get(x, y)](#get_x_y_9) | يحصل على موضع البكسل المحدد في مصفوفة التخزين. |
...
| [set_mask_pixel(x, y, value)](#set_mask_pixel_x_y_value_19) | يضبط الشفافية للبكسل المحدد. |
| [subtract(image, settings)](#subtract_image_settings_20) | يحصل على نتيجة تحديد العصا السحرية المطبقة على الصورة المقدمة مطروحًا من القناع الحالي. |
| [subtract(mask)](#subtract_mask_21) | يحصل على طرح القناع المقدم من القناع الحالي. |
| [subtract(settings)](#subtract_settings_22) | يحصل على نتيجة تحديد العصا السحرية المطبقة على مصدر القناع الحالي مطروحًا من القناع. |
| [union(image, settings)](#union_image_settings_23) | يحصل على اتحاد القناع الحالي مع نتيجة تحديد العصا السحرية المطبقة على الصورة المقدمة. |
| [union(mask)](#union_mask_24) | يحصل على اتحاد القناع الحالي مع القناع المقدم. |
| [union(settings)](#union_settings_25) | يحصل على اتحاد القناع الحالي مع نتيجة تحديد العصا السحرية المطبقة على مصدر القناع. |
...
يُنشئ مثلاً جديداً من الفئة [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) بالحجم المستند إلى [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) المحدد الموجود.<br/>            سيتم تخزين [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) المحدد كمصدر الصورة.
...
يُنشئ مثلاً جديداً من الفئة [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) بالعرض والارتفاع المحددين.
...
| نوع | الوصف |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | قناع [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) مقصوص كـ [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
يحصل على موضع البكسل المحدد في مصفوفة التخزين.
...
| نوع | الوصف |
| :- | :- |
| bool | قيمة Int تمثل الموضع في التخزين. |
...
| نوع | الوصف |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | قناع [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) منتفخ كـ [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
| x | int | الإحداثي السيني للبكسل. |
| y | int | الإحداثي الصادي للبكسل. |
| القيمة | bool | صحيح إذا كان البكسل المحدد معتمًا؛ وإلا خاطئ. |
