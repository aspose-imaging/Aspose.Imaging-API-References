---
title: "فئة WmfRecorderGraphics2D"
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | يقوم بإنشاء نسخة جديدة من [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) فئة. |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | يحصل أو يعيّن لون الخلفية. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | يحصل أو يعيّن وضع الخلفية. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | يحصل على نسخة من مسجل Wmf لصورة Wmf الحالية. |
...
يقوم بإنشاء نسخة جديدة من [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) فئة.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | مستطيل الوجهة، مقاس بوحدات twips، لعرض ملف الميتا. |
...
| نوع | الوصف |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | صورة النتيجة. |
...
| معامل | نوع | الوصف |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | صورة Wmf للحصول على مسجل لها. |

**Returns**

| نوع | الوصف |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | مثال من الفئة [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
