---
title: "MetafileRecorderGraphics2D فئة"
type: docs
weight: 20
url: /ar/python-net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/
---
...
| [exclude_clip(rect)](#exclude_clip_rect_21) | يقوم بتحديث منطقة القص لهذه الرسومات لاستبعاد المنطقة المحددة بواسطة بنية المستطيل. |
| [exclude_clip(region)](#exclude_clip_region_22) | يقوم بتحديث منطقة القص لهذه الرسومات لاستبعاد المنطقة المحددة بواسطة المنطقة. |
| [exclude_clip_rect(rect)](#exclude_clip_rect_rect_23) | يقوم بتحديث منطقة القص لهذه الرسومات لاستبعاد المنطقة المحددة بواسطة بنية المستطيل. |
| [exclude_clip_rgn(region)](#exclude_clip_rgn_region_24) | يقوم بتحديث منطقة القص لهذه الرسومات لاستبعاد المنطقة المحددة بواسطة المنطقة. |
| [fill_ellipse(brush, rect)](#fill_ellipse_brush_rect_25) | يملأ القطع الناقص. |
| [fill_path(pen, brush, path)](#fill_path_pen_brush_path_26) | يملأ المسار. |
| [fill_pie(brush, rect, start_angle, sweep_angle)](#fill_pie_brush_rect_start_angle_sweep_angle_27) | يملأ الفطيرة. |
| [fill_polygon(brush, points)](#fill_polygon_brush_points_28) | يملأ المضلع. |
| [fill_polygon(brush, points, fill_mode)](#fill_polygon_brush_points_fill_mode_29) | يملأ المضلع. |
| [fill_rectangle(brush, rectangle)](#fill_rectangle_brush_rectangle_30) | يملأ المستطيل. |
| [get_transform()](#get_transform__31) | يحصل على تحويل العالم. |
| [intersect_clip(rect)](#intersect_clip_rect_32) | يقوم بتحديث منطقة القص لهذه الرسومات إلى تقاطع منطقة القص الحالية والبنية المحددة للمستطيل. |
| [intersect_clip(region)](#intersect_clip_region_33) | يقوم بتحديث منطقة القص لهذه الرسومات إلى تقاطع منطقة القص الحالية والمنطقة المحددة. |
| [intersect_clip_rect_f(rect)](#intersect_clip_rect_f_rect_34) | يقوم بتحديث منطقة القص لهذه الرسومات إلى تقاطع منطقة القص الحالية والبنية المحددة للمستطيل. |
| [intersect_clip_rgn(region)](#intersect_clip_rgn_region_35) | يقوم بتحديث منطقة القص لهذه الرسومات إلى تقاطع منطقة القص الحالية والمنطقة المحددة. |
| [multiply_transform(matrix)](#multiply_transform_matrix_36) | يضرب تحويل العالم لهذه الرسومات بالمصفوفة المحددة. |
| [multiply_transform(matrix, order)](#multiply_transform_matrix_order_37) | يضرب تحويل العالم لهذه الرسومات بالمصفوفة المحددة بالترتيب المحدد. |
| reset_clip() | يعيد ضبط القص. |
| [rotate_transform(angle)](#rotate_transform_angle_38) | يطبق الدوران المحدد على مصفوفة التحويل لهذا Graphics. |
| [rotate_transform(angle, center, order)](#rotate_transform_angle_center_order_39) | يطبق الدوران المحدد على مصفوفة التحويل لهذا Graphics بالترتيب المحدد. |
| [scale_transform(sx, sy)](#scale_transform_sx_sy_40) | يطبق عملية التحجيم المحددة على مصفوفة التحويل لهذا Graphics عن طريق إلحاقها في مقدمة مصفوفة التحويل الخاصة بالكائن. |
| [scale_transform(sx, sy, order)](#scale_transform_sx_sy_order_41) | يطبق عملية التحجيم المحددة على مصفوفة التحويل لهذا Graphics بالترتيب المحدد. |
| [set_transform(transform)](#set_transform_transform_42) | يضبط التحويل. |
| [translate_transform(x, y)](#translate_transform_x_y_43) | يغيّر أصل نظام الإحداثيات عن طريق إلحاق الترجمة المحددة في مقدمة مصفوفة التحويل لهذا Graphics. |
| [translate_transform(x, y, order)](#translate_transform_x_y_order_44) | يغيّر أصل نظام الإحداثيات عن طريق تطبيق الترجمة المحددة على مصفوفة التحويل لهذا Graphics بالترتيب المحدد. |
