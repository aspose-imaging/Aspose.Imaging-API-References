...
type: docs
weight: 10
url: /ar/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [BigTiffImage(frame)](#BigTiffImage_frame_1) | أنشئ مثلاً جديدًا من الفئة [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) عن طريق تهيئته<br/>            باستخدام معامل TiffFrame. مثالي للمطورين الذين يبحثون عن طريقة مريحة<br/>            للعمل مع كائنات BigTiffImage، مما يضمن المرونة وسهولة التكامل<br/>            في مشاريعهم. |
| [BigTiffImage(frames)](#BigTiffImage_frames_2) | ابدأ باستخدام الفئة [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) بسلاسة عن طريق<br/>            تهيئة مثلاً جديدًا مع قائمة من معاملات TiffFrames.<br/>            مثالي للمطورين الذين يبحثون عن طريقة مباشرة للعمل مع<br/>            كائنات BigTiffImage التي تحتوي على إطارات متعددة، مما يضمن كفاءة مشاريعهم. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | يحصل على تنسيق الملف لهذا المثيل من [Image](/imaging/python-net/aspose.imaging/image/) |
...
| has_alpha | bool | r | حدد ما إذا كانت الصورة تحتوي على قناة ألفا، مما يوفر معلومات حاسمة<br/>            للتصوير وعمليات التركيب. دمج هذه الميزة لتحسين سير عمل المعالجة البصرية، مما يضمن تمثيلًا دقيقًا وتلاعبًا بالعناصر الشفافة. |
...
| [add_page(page)](#add_page_page_4) | قم بتوسيع صورة BigTiff الخاصة بك بسهولة بإضافة صفحة جديدة باستخدام هذه الطريقة البديهية.<br/>            مثالي للمطورين الذين يسعون إلى تعزيز محتوى صورهم متعددة الصفحات ديناميكيًا. |
...
| [create_with_frame(frame)](#create_with_frame_frame_34) | ينشئ مثيلاً جديداً من الفئة [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/). |
| [create_with_frames(frames)](#create_with_frames_frames_35) | ينشئ مثيلاً جديداً من الفئة [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/). |
...
أنشئ مثلاً جديدًا من الفئة [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) عن طريق تهيئته<br/>            باستخدام معامل TiffFrame. مثالي للمطورين الذين يبحثون عن طريقة مريحة<br/>            للعمل مع كائنات BigTiffImage، مما يضمن المرونة وسهولة التكامل<br/>            في مشاريعهم.
...
ابدأ باستخدام الفئة [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) بسلاسة عن طريق<br/>            تهيئة مثلاً جديدًا مع قائمة من معاملات TiffFrames.<br/>            مثالي للمطورين الذين يبحثون عن طريقة مباشرة للعمل مع<br/>            كائنات BigTiffImage التي تحتوي على إطارات متعددة، مما يضمن كفاءة مشاريعهم.
...
قم بتوسيع صورة BigTiff الخاصة بك بسهولة بإضافة صفحة جديدة باستخدام هذه الطريقة البديهية.<br/>            مثالي للمطورين الذين يسعون إلى تعزيز محتوى صورهم متعددة الصفحات ديناميكيًا.
...
ينشئ مثيلاً جديداً من الفئة [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/).
...
| نوع | الوصف |
| :- | :- |
| [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) | صورة BigTiffImage جديدة تتضمن الإطار. |
