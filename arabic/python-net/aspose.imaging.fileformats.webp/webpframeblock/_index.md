---
title: "فئة WebPFrameBlock"
type: docs
weight: 20
url: /ar/python-net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [WebPFrameBlock(raster_image)](#WebPFrameBlock_raster_image_1) | <br/><br/>                    يُنشئ مثيلًا جديدًا من الفئة [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>فئة.<br/> |
| [WebPFrameBlock(width, height)](#WebPFrameBlock_width_height_2) | يُنشئ مثيلًا جديدًا من الفئة [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/) |
## **Properties**
...
| disposal_method | [AnimationDisposalMethods](/imaging/python-net/aspose.imaging/animationdisposalmethods/) | r/w | يحصل أو يعيّن طريقة التخلص. |
| تم التخلص | bool | r | يحصل على قيمة تشير إلى ما إذا كانت هذه المثيلة تم التخلص منها. |
| duration | int | r/w | يحصل أو يعيّن مدة الإطار. |
...
| اليسار | int | r/w | يحصل أو يعيّن موضع الإطار الأيسر. |
...
| الأعلى | int | r/w | يحصل أو يعيّن موضع الإطار العلوي. |
...
| use_alpha_blending | bool | r/w | يحصل أو يعيّن القيمة التي تشير إلى ما إذا كان الإطار الحالي يُدمج مع قيم ألفا للإطار السابق. |
...
<br/><br/>                    يُنشئ مثيلًا جديدًا من الفئة [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>فئة.<br/>
...
يُنشئ مثيلًا جديدًا من الفئة [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)
