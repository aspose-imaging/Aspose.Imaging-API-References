---
title: "فئة EpsRasterizationOptions"
type: docs
weight: 110
url: /ar/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [EpsRasterizationOptions()](#EpsRasterizationOptions__1) | ينشئ مثيلاً جديداً من الفئة [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/). |
## **Properties**
...
| preview_to_export | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | r/w | استخدم [EpsImage.get_preview_image(format)](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) لتصدير المعاينة. |
...
ينشئ مثيلاً جديداً من الفئة [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/).
