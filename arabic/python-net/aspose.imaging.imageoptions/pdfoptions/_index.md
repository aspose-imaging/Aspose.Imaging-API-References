...
type: docs
weight: 240
url: /ar/python-net/aspose.imaging.imageoptions/pdfoptions/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [PdfOptions()](#PdfOptions__1) | يقوم بإنشاء نسخة جديدة من الفئة [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/) . |
## **Properties**
...
| page_size | [SizeF](/imaging/python-net/aspose.imaging/sizef/) | r/w | يحصل أو يضبط حجم الصفحة. |
| palette | [IColorPalette](/imaging/python-net/aspose.imaging/icolorpalette/) | r/w | يحصل أو يضبط لوحة الألوان. |
| pdf_core_options | [PdfCoreOptions](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfcoreoptions/) | r/w | الخيارات الأساسية لـ PDF |
| pdf_document_info | [PdfDocumentInfo](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfdocumentinfo/) | r/w | يحصل أو يضبط بيانات التعريف للمستند. |
...
| use_original_image_resolution | bool | r/w | يحصل أو يضبط قيمة تشير إلى استخدام دقة DPI الأصلية للصورة. |
...
يقوم بإنشاء نسخة جديدة من الفئة [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/) .
