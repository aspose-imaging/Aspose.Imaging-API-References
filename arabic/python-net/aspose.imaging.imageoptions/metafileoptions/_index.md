---
title: "فئة MetafileOptions"
type: docs
weight: 170
url: /ar/python-net/aspose.imaging.imageoptions/metafileoptions/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [MetafileOptions()](#MetafileOptions__1) | ينشئ مثيلاً جديدًا للفئة [MetafileOptions](/imaging/python-net/aspose.imaging.imageoptions/metafileoptions/) |
## **Properties**
| **Name** | **Type** | **Access** | **الوصف** |
| :- | :- | :- | :- |
| buffer_size_hint | int | r/w | يحصل أو يعيّن تلميح حجم المخزن المؤقت الذي يُعرف كأقصى حجم مسموح به لجميع المخازن الداخلية. |
| [compress](#compress1) | bool | r/w | يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [ICompressedOptions](/imaging/python-net/aspose.fileformats.core.imageoptions/icompressedoptions/) مضغوطًا. |
...
ينشئ مثيلاً جديدًا للفئة [MetafileOptions](/imaging/python-net/aspose.imaging.imageoptions/metafileoptions/)

### Property: compress {#compress1}

يحصل أو يضبط قيمة تشير إلى ما إذا كان هذا [ICompressedOptions](/imaging/python-net/aspose.fileformats.core.imageoptions/icompressedoptions/) مضغوطًا.
