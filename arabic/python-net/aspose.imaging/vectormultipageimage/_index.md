---
title: "فئة VectorMultipageImage"
type: docs
weight: 7890
url: /ar/python-net/aspose.imaging/vectormultipageimage/
---
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | يحصل على الصفحة الافتراضية. |
...
| page_count | int | r | يحصل على عدد الصفحات. |
