---
title: "فئة RasterCachedImage"
type: docs
weight: 7040
url: /ar/python-net/aspose.imaging/rastercachedimage/
---
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_106) | يقوم بحفظ البكسلات (طريقة خاصة بالتنسيق). |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_117) | يحاول ضبط مثال _metadata_، إذا كان مثال هذا [Image](/imaging/python-net/aspose.imaging/image/) يدعم ويطبق مثال [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) . |
...
with Image.load(join_path(directory, "sample.png")) as image:
	...
	# ثنّ الصورة بفارق سطوع قدره 5.
	# السطوع هو الفرق بين بكسل ومتوسط نافذة بحجم s × s بكسل متمركزة حول هذا البكسل.
...
with Image.load(join_path(directory, "sample.png")) as image:
	rasterImage = as_of(image, RasterCachedImage)
	# ثنّ الصورة بفارق سطوع قدره 5.
	# السطوع هو الفرق بين بكسل ومتوسط نافذة بحجم 10 × 10 بكسل متمركزة حول هذا البكسل.
...
with Image.load(join_path(directory, "sample.png")) as image:
	...
	# احفظ كملف PNG باستخدام الخيارات الافتراضية.
