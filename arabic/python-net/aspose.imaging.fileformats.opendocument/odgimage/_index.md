...
type: docs
weight: 490
url: /ar/python-net/aspose.imaging.fileformats.opendocument/odgimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [OdgImage(stream_container)](#OdgImage_stream_container_1) | مصمم للتكامل السلس في حلول البرمجيات، يقوم مُنشئ [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) بتهيئة نسخة جديدة باستخدام حاوية تدفق. يضمن هذا الأسلوب <br/>            معالجة فعّالة لبيانات صور ODG داخل بيئات البرمجيات، محسّنًا <br/>            استهلاك الموارد ومُسَهِّلًا سير عمل معالجة الصور المتكامل. |
| [OdgImage(stream_container, options)](#OdgImage_stream_container_options_2) | ابدأ إنشاء جديد لكائن فئة [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) مع <br/>            بدء نسخة جديدة. استغل إمكانات حاوية التدفق المرفقة <br/>            بمعلمات خيارات التحميل، حافظ على مُنشئ متعدد الاستخدامات لتحميل الصور بسلاسة. يتيح هذا المُنشئ معالجة صور فعّالة، مقدمًا تكوينات تحميل قابلة للتخصيص <br/>            لتعزيز التكيف والأداء عبر سيناريوهات متنوعة. |
## **Properties**
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | عند استرجاع مجموعة الصفحات، تُتيح هذه الخاصية الوصول إلى كامل <br/>            الصفحات المرتبطة بصورة. من خلال الوصول إلى هذه الخاصية، يمكن للمطورين <br/>            التنقل عبر الصفحات الفردية، استرجاع صفحات محددة بناءً على فهرسها، أو <br/>            تنفيذ عمليات دفعية على المجموعة بأكملها. |
...
| options | [LoadOptions](/imaging/python-net/aspose.imaging/loadoptions/) | خيارات التحميل |
