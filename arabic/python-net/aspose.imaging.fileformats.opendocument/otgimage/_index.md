...
type: docs
weight: 500
url: /ar/python-net/aspose.imaging.fileformats.opendocument/otgimage/
---
...
| **Name** | **الوصف** |
| :- | :- |
| [OtgImage(stream_container)](#OtgImage_stream_container_1) | إنشاء كائن جديد من فئة [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) عن طريق توفير حاوية تدفق <br/>            . يتيح هذا المُنشئ للمطورين إنشاء صور OTG مباشرةً من <br/>            حاويات التدفق، مما يبسط عملية التعامل مع بيانات صور OTG. |
| [OtgImage(stream_container, load_options)](#OtgImage_stream_container_load_options_2) | تهيئة كائن جديد من [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) عن طريق توفير حاوية تدفق <br/>            وخيارات التحميل. يتيح هذا المُنشئ للمطورين تحميل صور OTG بكفاءة من التدفقات مع تحديد تكوينات تحميل مخصصة. |
## **Properties**
...
| bits_per_pixel | int | r | يسترجع عدد البتات لكل بكسل في الصورة. توفر هذه الخاصية نظرة <br/>            على مستوى التفاصيل وعمق الألوان الممثلة في الصورة، مما يساعد في مهام معالجة الصور المختلفة <br/>            والتحسينات. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | يسترجع الصفحة الافتراضية المرتبطة بالصورة، موفرًا وصولًا أساسيًا إلى <br/>            الصفحة الرئيسية ضمن مجموعة الصور. تُسهل هذه الخاصية التنقل <br/>            ومعالجة بيانات الصورة، مما يعزز كفاءة سير عمل تطوير البرمجيات. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | توفر هذه الخاصية وصولًا إلى تنسيق ملف OTG، مقدمةً رؤى هامة <br/>            حول نوع البيانات المضمنة داخل ملف الصورة. تُعد نقطة مرجعية محورية للمطورين، مما يتيح لهم التعامل بفعالية مع ملفات OTG <br/>            داخل تطبيقاتهم. باستخدام هذه الخاصية، يمكنك <br/>            تحديد التنسيق المحدد لملف الصورة، مما يسهل التكامل السلس <br/>            ومعالجة ملفات OTG في أنظمة البرمجيات الخاصة بهم. |
...
| is_cached | bool | r | يحصل على قيمة منطقية تشير إلى ما إذا كانت بيانات الكائن مخزنة مؤقتًا حاليًا <br/>            ، مما يلغي الحاجة إلى قراءة البيانات. تعمل هذه الخاصية كمؤشر تحسين، تعزز الأداء من خلال تقليل عمليات الوصول المتكررة للبيانات. |
| metadata | [OdMetadata](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects/odmetadata/) | r | يسترجع البيانات الوصفية الخاصة بملفات OpenDocument. تتيح هذه الخاصية الوصول إلى <br/>            المعلومات الأساسية المدمجة داخل ملفات OD، مما يسهل عمليات مختلفة مثل <br/>            الاستخراج أو التعديل أو تحليل البيانات الوصفية. |
| page_count | int | r | يسترجع العدد الكلي للصفحات داخل الصورة. هذه الخاصية أساسية للتطبيقات التي تدير صورًا متعددة الصفحات، مما يمكنها من تحديد عدد الصفحات المتاحة للمعالجة أو العرض بدقة. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | يسترجع مجموعة الصفحات المرتبطة بالصورة، مما يتيح للمطورين الوصول إلى كل صفحة على حدة ومعالجتها بكفاءة. تُسهل هذه الخاصية التنقل السلس عبر الصفحات للقيام بعمليات مختلفة، <br/>            مما يعزز وظائف وتنوع تطبيقات معالجة الصور. |
...
| records | [OdObject[]](/imaging/python-net/aspose.imaging.fileformats.opendocument/odobject/) | r | يسترجع سجلات OpenDocument المخزنة داخل الصورة. تمنح هذه الخاصية <br/>            وصولًا إلى عناصر بيانات منظمة محددة مدمجة داخل ملفات OpenDocument، <br/>            مما يسهل استرجاع أو معالجة المعلومات ذات الصلة لمزيد من المعالجة <br/>            أو التحليل. |
...
| **Name** | **الوصف** |
| :- | :- |
| cache_data() | يقوم بتخزين البيانات مؤقتًا ويضمن عدم تحميل بيانات إضافية من المصدر الأساسي<br/>                [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_68) | يضبط لوحة ألوان الصورة. |
...
إنشاء كائن جديد من فئة [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) عن طريق توفير حاوية تدفق <br/>            . يتيح هذا المُنشئ للمطورين إنشاء صور OTG مباشرةً من <br/>            حاويات التدفق، مما يبسط عملية التعامل مع بيانات صور OTG.
...
تهيئة كائن جديد من [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) عن طريق توفير حاوية تدفق <br/>            وخيارات التحميل. يتيح هذا المُنشئ للمطورين تحميل صور OTG بكفاءة من التدفقات مع تحديد تكوينات تحميل مخصصة.

**Parameters:**

| معامل | نوع | الوصف |
| :- | :- | :- |
| stream_container | [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/) | الدفق. |
