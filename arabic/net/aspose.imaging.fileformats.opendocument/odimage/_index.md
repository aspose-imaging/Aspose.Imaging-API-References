...
description: "الفئة Aspose.Imaging.FileFormats.OpenDocument.OdImage. المستند المفتوح"
type: docs
weight: 7480
...
| الاسم | الوصف |
| --- | --- |
| [OdImage](odimage/#constructor)(StreamContainer) | ينشئ نسخة جديدة من الفئة `OdImage`، صُممت خصيصًا للتهيئة باستخدام حاوية تدفق. يتيح هذا المُنشئ تكاملًا سلسًا مع مصادر البيانات القائمة على التدفق، مما يسهل معالجة مثيلات OdImage بكفاءة داخل أنظمة البرمجيات. |
| [OdImage](odimage/#constructor_1)(StreamContainer, LoadOptions) | قم بتهيئة كائن `OdImage` جديد عن طريق توفير حاوية تدفق مع خيارات التحميل، مما يسهل التكامل السلس في تطبيقات البرمجيات. يعالج هذا المُنشئ بيانات الصورة بكفاءة، مع توفير مرونة وتحكم في عملية التحميل. |
...
| abstract [Pages](../../aspose.imaging/vectormultipageimage/pages/) { get; } | يحصل على الصفحات. |
