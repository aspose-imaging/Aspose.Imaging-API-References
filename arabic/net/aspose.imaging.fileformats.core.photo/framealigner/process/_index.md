...
description: "طريقة FrameAligner. تعالج الصور المحددة"
type: docs
weight: 10
url: /ar/net/aspose.imaging.fileformats.core.photo/framealigner/process/
---
...
| الخيارات | FrameAlignerOptions | الخيارات. |

### قيمة الإرجاع

مصفوفة الإزاحات حسب الصور
