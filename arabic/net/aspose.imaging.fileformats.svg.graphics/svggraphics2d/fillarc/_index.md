...
description: يملأ قوسًا يمثل جزءًا من القطع الناقص المحدد بواسطة بنية مستطيل.
type: docs
weight: 100
url: /ar/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/fillarc/
---
## SvgGraphics2D.FillArc method

يملأ قوسًا يمثل جزءًا من القطع الناقص المحدد بواسطة بنية مستطيل.
...
| brush | Brush | الفرشاة لملء الجزء الداخلي من الشكل. |
| rect | Rectangle | حدود القطع الناقص. |
| startAngle | Single | يتم قياس الزاوية بالدرجات في اتجاه عقارب الساعة من المحور x إلى نقطة بداية القوس. |
