...
description: "طريقة SvgGraphics2D. تملأ قوسًا يمثل جزءًا من إهليلج محدد بواسطة بنية Rectangle"
type: docs
weight: 100
...
يملأ قوسًا يمثل جزءًا من قطع ناقص محدد بواسطة بنية Rectangle.
...
| فرشاة | فرشاة | الفرشاة لملء داخل الشكل. |
| rect | Rectangle | حدود القطع الناقص. |
| startAngle | فردي | الزاوية بالدرجات المقاسة باتجاه عقارب الساعة من محور x إلى نقطة بدء القوس. |
| arcAngle | فردي | الزاوية بالدرجات المقاسة باتجاه عقارب الساعة من معامل startAngle إلى نقطة انتهاء القوس. |
