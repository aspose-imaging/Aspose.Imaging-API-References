...
description: الحصول على صورة Svg النهائية التي تتضمن جميع أوامر الرسم المنفذة عبرSvgGraphics2Daspose.imaging.fileformats.svg.graphics/svggraphics2d الكائن .
type: docs
weight: 90
url: /ar/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/endrecording/
---
## SvgGraphics2D.EndRecording method

الحصول على صورة Svg النهائية التي تتضمن جميع أوامر الرسم المنفذة عبر[`SvgGraphics2D`](../../svggraphics2d) الكائن .
