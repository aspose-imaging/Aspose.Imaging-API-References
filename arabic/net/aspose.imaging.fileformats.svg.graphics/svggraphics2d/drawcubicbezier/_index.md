...
description: "طريقة SvgGraphics2D. ترسم المنحنى المكعب Bezier."
type: docs
weight: 30
url: /ar/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawcubicbezier/
---
## SvgGraphics2D.DrawCubicBezier method

يرسم المنحنى المكعب Bezier.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قلم | قلم | القلم الذي يحدد اللون والعرض والنمط للشكل. |
| pt1 | PointF | نقطة البداية للمنحنى. |
| pt2 | PointF | نقطة التحكم الأولى للمنحنى. |
| pt3 | PointF | نقطة التحكم الثانية للمنحنى. |
| pt4 | PointF | نقطة النهاية للمنحنى. |
