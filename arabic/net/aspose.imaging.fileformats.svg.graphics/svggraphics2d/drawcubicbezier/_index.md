...
description: رسم البيزير المكعب .
type: docs
weight: 30
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| pen | Pen | القلم الذي يحدد لون الشكل وعرضه ونمطه. |
| pt1 | PointF | نقطة انطلاق المنحنى. |
| pt2 | PointF | أول نقطة تحكم للمنحنى. |
| pt3 | PointF | نقطة التحكم الثانية للمنحنى. |
| pt4 | PointF | نقطة نهاية المنحنى. |
