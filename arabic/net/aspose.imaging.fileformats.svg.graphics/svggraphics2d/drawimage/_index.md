...
description: "طريقة SvgGraphics2D. ترسم الصورة المحددة في الموقع المحدد"
type: docs
weight: 40
...
| الأصل | Point | موقع الصورة المرسومة. |
...
| image | RasterImage | الصورة المرسومة. |
| الأصل | Point | موقع الصورة المرسومة. |
| الحجم | الحجم | الحجم المطلوب للصورة المرسومة. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| srcRect | Rectangle | الجزء من كائن الصورة الذي سيتم رسمه. |
| destRect | Rectangle | موقع وحجم الصورة المرسومة. يتم تحجيم الصورة لتناسب المستطيل. |
