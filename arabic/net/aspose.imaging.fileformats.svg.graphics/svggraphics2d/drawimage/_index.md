...
description: يرسم الصورة المحددة في المكان المحدد .
type: docs
weight: 40
url: /ar/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawimage/
---
## DrawImage(RasterImage, Point) {#drawimage}

يرسم الصورة المحددة في المكان المحدد .
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| image | RasterImage | الصورة المرسومة. |
| origin | Point | موقع الصورة المرسومة. |
...
| image | RasterImage | الصورة المرسومة. |
| origin | Point | موقع الصورة المرسومة. |
| size | Size | الحجم المطلوب للصورة المرسومة. |
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| srcRect | Rectangle | جزء كائن الصورة المراد رسمه. |
| destRect | Rectangle | موقع وحجم الصورة المرسومة. تم تحجيم الصورة لتناسب المستطيل. |
