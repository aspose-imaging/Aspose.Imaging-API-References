---
title: "الفئة RectangleMask"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.MagicWand.ImageMasks.RectangleMask. يصف قناعًا مستطيلاً"
type: docs
weight: 10900
url: /ar/net/aspose.imaging.magicwand.imagemasks/rectanglemask/
---
## RectangleMask class
...
| الاسم | الوصف |
| --- | --- |
| [RectangleMask](rectanglemask/#constructor)(Rectangle) | ينشئ مثيلًا جديدًا للفئة `RectangleMask` باستخدام المستطيل المحدد. |
| [RectangleMask](rectanglemask/#constructor_1)(int, int, int, int) | ينشئ مثيلًا جديدًا للفئة `RectangleMask` باستخدام النقطة اليسرى العليا المحددة، والعرض والارتفاع. |
...
| override [Item](../../aspose.imaging.magicwand.imagemasks/rectanglemask/item/) { get; } | يحصل على شفافية البكسل المحدد. |
| override [SelectionBounds](../../aspose.imaging.magicwand.imagemasks/rectanglemask/selectionbounds/) { get; } | يحصل على حدود الجزء المحدد من القناع، بوحدات البكسل. |
...
| override [Clone](../../aspose.imaging.magicwand.imagemasks/rectanglemask/clone/)() | ينشئ كائنًا جديدًا يكون نسخة من النسخة الحالية. |
| override [Crop](../../aspose.imaging.magicwand.imagemasks/rectanglemask/crop/#crop)(Rectangle) | يقص القناع بالمستطيل المحدد. |
...
| override [Inflate](../../aspose.imaging.magicwand.imagemasks/rectanglemask/inflate/)(int) | يوسع هذا القناع بالمقدار المحدد. |
