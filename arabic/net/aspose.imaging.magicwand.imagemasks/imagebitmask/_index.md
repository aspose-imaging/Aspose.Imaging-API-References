---
title: "الفئة ImageBitMask"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.MagicWand.ImageMasks.ImageBitMask. يصف قناع صورة ثنائي"
type: docs
weight: 10870
url: /ar/net/aspose.imaging.magicwand.imagemasks/imagebitmask/
---
## ImageBitMask class
...
| الاسم | الوصف |
| --- | --- |
| [ImageBitMask](imagebitmask/#constructor)(RasterImage) | ينشئ مثيلًا جديدًا للفئة `ImageBitMask` بالحجم المستند إلى [`RasterImage`](../../aspose.imaging/rasterimage/) الموجود المحدد. سيتم تخزين [`RasterImage`](../../aspose.imaging/rasterimage/) المحدد كصورة مصدر. |
| [ImageBitMask](imagebitmask/#constructor_1)(int, int) | ينشئ مثيلًا جديدًا للفئة `ImageBitMask` باستخدام العرض والارتفاع المحددين. |
...
| override [Item](../../aspose.imaging.magicwand.imagemasks/imagebitmask/item/) { get; } | يحصل على شفافية البكسل المحدد. |
| override [SelectionBounds](../../aspose.imaging.magicwand.imagemasks/imagebitmask/selectionbounds/) { get; } | يحصل على حدود الجزء المحدد من القناع، بوحدات البكسل. |
...
| override [Clone](../../aspose.imaging.magicwand.imagemasks/imagebitmask/clone/)() | ينشئ كائنًا جديدًا يكون نسخة من النسخة الحالية. |
| override [Crop](../../aspose.imaging.magicwand.imagemasks/imagebitmask/crop/#crop)(Rectangle) | يقص القناع بالمستطيل المحدد. |
...
| override [Inflate](../../aspose.imaging.magicwand.imagemasks/imagebitmask/inflate/)(int) | يوسع هذا القناع بالمقدار المحدد. |
...
| [SetMaskPixel](../../aspose.imaging.magicwand.imagemasks/imagebitmask/setmaskpixel/)(int, int, bool) | يضبط الشفافية للبكسل المحدد. |
...
| [operator +](../../aspose.imaging.magicwand.imagemasks/imagebitmask/op_addition/) | اتحاد قناعين. |
| [operator ^](../../aspose.imaging.magicwand.imagemasks/imagebitmask/op_exclusiveor/) | التفريق الحصري لقناعين. |
| [operator !](../../aspose.imaging.magicwand.imagemasks/imagebitmask/op_logicalnot/) | يعكس القناع. |
| [operator *](../../aspose.imaging.magicwand.imagemasks/imagebitmask/op_multiply/) | تقاطع قناعين. |
| [operator -](../../aspose.imaging.magicwand.imagemasks/imagebitmask/op_subtraction/) | اطرح القناع الثاني من الأول. |
