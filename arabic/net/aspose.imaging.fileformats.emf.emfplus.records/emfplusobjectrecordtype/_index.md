...
description: "Aspose.Imaging.FileFormats.Emf.EmfPlus.Records.EmfPlusObjectRecordType فئة. تحدد أنواع سجلات الكائنات كائنات رسومية قابلة لإعادة الاستخدام."
type: docs
weight: 6290
url: /ar/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusobjectrecordtype/
---
## EmfPlusObjectRecordType class

أنواع سجلات الكائن تُعرّف كائنات رسومية قابلة لإعادة الاستخدام.
