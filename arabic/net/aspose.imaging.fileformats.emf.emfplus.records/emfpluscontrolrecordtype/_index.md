...
description: "الفئة Aspose.Imaging.FileFormats.Emf.EmfPlus.Records.EmfPlusControlRecordType. أنواع سجلات التحكم تحدد المعلمات العامة لمعالجة ملف EMF."
type: docs
weight: 6010
url: /ar/net/aspose.imaging.fileformats.emf.emfplus.records/emfpluscontrolrecordtype/
---
## EmfPlusControlRecordType class

أنواع سجلات التحكم تحدد المعلمات العامة لمعالجة ملفات EMF+ الوصفية.
