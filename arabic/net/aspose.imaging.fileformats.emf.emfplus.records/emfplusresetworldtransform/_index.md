...
description: يقوم سجل EmfPlusResetWorldTransform بإعادة تعيين تحويل الفضاء العالمي الحالي إلى مصفوفة التعريف.
type: docs
weight: 6220
url: /ar/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/
---
## EmfPlusResetWorldTransform class

يقوم سجل EmfPlusResetWorldTransform بإعادة تعيين تحويل الفضاء العالمي الحالي إلى مصفوفة التعريف.
...
| اسم | وصف |
| --- | --- |
| [EmfPlusResetWorldTransform](emfplusresetworldtransform)(EmfPlusRecord) | يقوم بتهيئة مثيل جديد لملف[`EmfPlusResetWorldTransform`](../emfplusresetworldtransform) فئة . |
