...
description: يعيد سجل EmfPlusResetClip تعيين منطقة القطع الحالية لمساحة العالم إلى ما لا نهاية.
type: docs
weight: 6210
url: /ar/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/
---
## EmfPlusResetClip class

يعيد سجل EmfPlusResetClip تعيين منطقة القطع الحالية لمساحة العالم إلى ما لا نهاية.
...
| اسم | وصف |
| --- | --- |
| [EmfPlusResetClip](emfplusresetclip)(EmfPlusRecord) | يقوم بتهيئة مثيل جديد لملف[`EmfPlusResetClip`](../emfplusresetclip) فئة . |
