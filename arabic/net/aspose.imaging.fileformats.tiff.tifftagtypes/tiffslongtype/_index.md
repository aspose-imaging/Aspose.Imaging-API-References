...
description: النوع الطويل الموقّع من نوع tiff .
type: docs
weight: 8000
...
النوع الطويل الموقّع من نوع tiff .
...
| اسم | وصف |
| --- | --- |
| [TiffSLongType](tiffslongtype#constructor)(TiffTags) | يقوم بتهيئة مثيل جديد لملف[`TiffSLongType`](../tiffslongtype) فئة . |
| [TiffSLongType](tiffslongtype#constructor_1)(ushort) | يقوم بتهيئة مثيل جديد لملف[`TiffSLongType`](../tiffslongtype) فئة . |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/elementsize) { get; } | الحصول على حجم العنصر بالبايت. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/tagtype) { get; } | يحصل على نوع العلامة . |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/value) { get; set; } | الحصول على القيمة التي يحتوي عليها نوع البيانات هذا أو تعيينها. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/values) { get; set; } | الحصول على القيم أو تعيينها. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/writeadditionaldata)(TiffStreamWriter) | يكتب بيانات العلامة الإضافية . |
