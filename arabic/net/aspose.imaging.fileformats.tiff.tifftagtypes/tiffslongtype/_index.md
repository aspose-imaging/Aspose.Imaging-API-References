---
title: "الفئة TiffSLongType"
second_title: "Aspose.Imaging for .NET API Reference"
description: "Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffSLongType الفئة. نوع tiff الطويل الموقّع"
type: docs
weight: 8180
url: /ar/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
## TiffSLongType class

نوع tiff signed long.
...
| الاسم | الوصف |
| --- | --- |
| [TiffSLongType](tiffslongtype/#constructor)(TiffTags) | ينشئ مثيلاً جديداً من الفئة `TiffSLongType`. |
| [TiffSLongType](tiffslongtype/#constructor_1)(ushort) | ينشئ مثيلاً جديداً من الفئة `TiffSLongType`. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/elementsize/) { get; } | يحصل على حجم العنصر بالبايت. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/tagtype/) { get; } | يحصل على نوع الوسم. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/value/) { get; set; } | يحصل أو يعيّن القيمة التي يحتويها هذا النوع من البيانات. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/values/) { get; set; } | يحصل أو يعيّن القيم. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/valuescontainer/) { get; } | يحصل على حاوية القيم. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/writeadditionaldata/)(TiffStreamWriter) | يكتب بيانات الوسم الإضافية. |
