---
title: "الفئة TiffSLong8Type"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffSLong8Type. نوع Tiff غير موقع 64 بت"
type: docs
weight: 8170
url: /ar/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/
---
...
| الاسم | الوصف |
| --- | --- |
| [TiffSLong8Type](tiffslong8type/#constructor)(TiffTags) | يقوم بتهيئة نسخة جديدة من الفئة `TiffSLong8Type`. |
| [TiffSLong8Type](tiffslong8type/#constructor_1)(ushort) | يقوم بتهيئة نسخة جديدة من الفئة `TiffSLong8Type`. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/elementsize/) { get; } | يحصل على حجم العنصر. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/tagtype/) { get; } | يحصل على نوع الوسم. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/value/) { get; set; } | يحصل أو يعيّن القيمة التي يحتويها هذا النوع من البيانات. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/values/) { get; set; } | يحصل أو يعيّن القيم. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/valuescontainer/) { get; } | يحصل على حاوية القيم. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/writeadditionaldata/)(TiffStreamWriter) | يكتب بيانات الوسم الإضافية. |
