---
title: "الفئة TiffIfd8Type"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Tiff.TiffTagTypes.TiffIfd8Type. نوع دليل ملف الصورة (Image File Directory) غير موقع 64 بت من Tiff"
type: docs
weight: 8110
url: /ar/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifd8type/
---
## TiffIfd8Type class
...
| الاسم | الوصف |
| --- | --- |
| [TiffIfd8Type](tiffifd8type/#constructor)(TiffTags) | يقوم بتهيئة نسخة جديدة من الفئة `TiffIfd8Type`. |
| [TiffIfd8Type](tiffifd8type/#constructor_1)(ushort) | يقوم بتهيئة نسخة جديدة من الفئة `TiffIfd8Type`. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifd8type/tagtype/) { get; } | يحصل على نوع الوسم. |
