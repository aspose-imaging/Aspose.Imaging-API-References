...
description: "فئة Aspose.Imaging.FileFormats.Dicom.DicomPage. هي فئة للعمل مع ملفات DICOM من النوع متعدد الإطارات"
type: docs
weight: 2520
url: /ar/net/aspose.imaging.fileformats.dicom/dicompage/
---
## DicomPage class

إنها فئة للعمل مع ملفات DICOM من نوع متعدد الإطارات.
...
| الاسم | الوصف |
| --- | --- |
| [DicomPage](dicompage/#constructor)(DicomImage, int) | يُنشئ مثيلًا جديدًا من الفئة `DicomPage`. |
| [DicomPage](dicompage/#constructor_1)(DicomImage, int, LoadOptions) | يُنشئ مثيلًا جديدًا من الفئة `DicomPage`. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel/) { get; } | الحصول على عدد البتات لكل بكسل في الصورة. |
...
| override [FileFormat](../../aspose.imaging.fileformats.dicom/dicompage/fileformat/) { get; } | يحصل على قيمة تنسيق الملف |
...
| override [Height](../../aspose.imaging.fileformats.dicom/dicompage/height/) { get; } | الحصول على ارتفاع الصورة. |
...
| [Index](../../aspose.imaging.fileformats.dicom/dicompage/index/) { get; } | يحصل على فهرس الصفحة الحالية. |
...
| override [Width](../../aspose.imaging.fileformats.dicom/dicompage/width/) { get; } | يحصل على عرض الصورة. |
