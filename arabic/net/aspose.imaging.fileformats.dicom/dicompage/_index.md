...
description: إنها فئة للعمل مع ملفات DICOM من النوع multi frame
type: docs
weight: 2430
...
إنها فئة للعمل مع ملفات DICOM من النوع multi frame
...
| اسم | وصف |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | يقوم بتهيئة مثيل جديد لملف[`DicomPage`](../dicompage) فئة . |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | يقوم بتهيئة مثيل جديد لملف[`DicomPage`](../dicompage) فئة . |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel) { get; } | الحصول على عدد بتات الصورة لكل بكسل . |
...
| override [Width](../../aspose.imaging.fileformats.dicom/dicompage/width) { get; } | الحصول على عرض الصورة . |
