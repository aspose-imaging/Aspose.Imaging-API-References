...
description: "منشئ SolidBrush. يهيئ مثيلاً جديداً من الفئة SolidBrush"
type: docs
weight: 10
url: /ar/net/aspose.imaging.brushes/solidbrush/solidbrush/
---
## SolidBrush() {#constructor}

تهيئ مثيلاً جديداً من الفئة [`SolidBrush`](../).
...
* class [SolidBrush](../)
* namespace [Aspose.Imaging.Brushes](../../solidbrush/)
