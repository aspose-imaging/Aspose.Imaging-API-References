...
description: "الفئة Aspose.Imaging.Brushes.SolidBrush. الفرشاة الصلبة مخصصة للرسم المستمر بلون محدد. لا يمكن وراثة هذه الفئة"
type: docs
weight: 210
...
| الاسم | الوصف |
| --- | --- |
| [SolidBrush](solidbrush/#constructor)() | يُهيئ مثيلاً جديدًا من الفئة `SolidBrush`. |
| [SolidBrush](solidbrush/#constructor_1)(Color) | يُهيئ مثيلاً جديدًا من الفئة `SolidBrush`. |

## الخصائص

| الاسم | الوصف |
| --- | --- |
| [Color](../../aspose.imaging.brushes/solidbrush/color/) { get; set; } | يحصل أو يعيّن لون الفرشاة. |
