...
description: الفرشاة المصمتة مخصصة للرسم المستمر بلون معين. لا يمكن توريث هذه الفئة.
type: docs
weight: 210
url: /ar/net/aspose.imaging.brushes/solidbrush/
---
## SolidBrush class
...
| اسم | وصف |
| --- | --- |
| [SolidBrush](solidbrush#constructor)() | يقوم بتهيئة مثيل جديد لملف[`SolidBrush`](../solidbrush) فئة . |
| [SolidBrush](solidbrush#constructor_1)(Color) | يقوم بتهيئة مثيل جديد لملف[`SolidBrush`](../solidbrush) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Color](../../aspose.imaging.brushes/solidbrush/color) { get; set; } | الحصول على أو تعيين لون الفرشاة . |
