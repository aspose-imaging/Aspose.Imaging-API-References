...
description: "خاصية JpegImage. تمنحك هذه الخاصية الوصول إلى الدقة الأفقية لـ RasterImage المقاسة بالبكسل لكل بوصة. من خلال ضبط أو استرجاع هذه القيمة يمكنك التحكم بدقة في دقة الصورة لضمان تلبية متطلباتك الخاصة للجودة والوضوح."
type: docs
weight: 100
url: /ar/net/aspose.imaging.fileformats.jpeg/jpegimage/horizontalresolution/
---
## JpegImage.HorizontalResolution property

تمنحك هذه الخاصية الوصول إلى الدقة الأفقية للـ [`RasterImage`](../../../aspose.imaging/rasterimage/)، المقاسة بالبكسل لكل بوصة. من خلال ضبط أو استرجاع هذه القيمة، يمكنك التحكم بدقة في دقة الصورة، وضمان تلبية متطلباتك الخاصة للجودة والوضوح.
