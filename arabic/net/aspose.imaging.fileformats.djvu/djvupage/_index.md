...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvupage/bitsperpixel) { get; } | الحصول على عدد بتات الصورة لكل بكسل . |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvupage/height) { get; } | الحصول على ارتفاع الصفحة |
...
| [IsColor](../../aspose.imaging.fileformats.djvu/djvupage/iscolor) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثيل ملونًا. |
...
| [ParentImage](../../aspose.imaging.fileformats.djvu/djvupage/parentimage) { get; } | الحصول على الصورة الأصلية التي تنتمي إليها الصفحة |
...
| [ThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/thumbnailimage) { get; set; } | الحصول على أو تعيين الصورة المصغرة للصفحة |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvupage/width) { get; } | الحصول على عرض الصفحة |
...
| [ExtractThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/extractthumbnailimage)() | استخراج الصورة المصغرة من صفحة Djvu. |
...
| [GetBackgroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getbackgroundimage)() | الحصول على صورة الخلفية . |
...
| [GetForegroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getforegroundimage)(int) | الحصول على الصورة الأمامية للصفحة |
...
| [GetTextForLocation](../../aspose.imaging.fileformats.djvu/djvupage/gettextforlocation)(Rectangle) | يحصل على نص المستطيل location |
| [GetTextImage](../../aspose.imaging.fileformats.djvu/djvupage/gettextimage)(int) | يحصل على الصورة النصية . |
