---
title: "الفئة DjvuPage"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Djvu.DjvuPage. فئة صفحة Djvu"
type: docs
weight: 2540
url: /ar/net/aspose.imaging.fileformats.djvu/djvupage/
---
## DjvuPage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvupage/bitsperpixel/) { get; } | الحصول على عدد البتات لكل بكسل في الصورة. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvupage/height/) { get; } | يسترجع ارتفاع الصفحة |
...
| [Image](../../aspose.imaging.fileformats.djvu/djvupage/image/) { get; } | يحصل على الصورة. |
...
| [IsColor](../../aspose.imaging.fileformats.djvu/djvupage/iscolor/) { get; } | يسترجع قيمة تشير إلى ما إذا كانت هذه العينة ملونة. |
...
| [PageNumber](../../aspose.imaging.fileformats.djvu/djvupage/pagenumber/) { get; } | يحصل على رقم الصفحة. |
...
| [ParentImage](../../aspose.imaging.fileformats.djvu/djvupage/parentimage/) { get; } | يسترجع الصورة الأصلية التي تنتمي إليها الصفحة |
...
| [ThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/thumbnailimage/) { get; set; } | يسترجع أو يحدد صورة المصغرة للصفحة |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvupage/width/) { get; } | يسترجع عرض الصفحة |
...
| [ExtractThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/extractthumbnailimage/)() | يستخرج صورة المصغرة من صفحة Djvu. |
...
| [GetBackgroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getbackgroundimage/)() | يسترجع صورة الخلفية. |
...
| [GetForegroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getforegroundimage/)(int) | يحصل على صورة المقدمة للصفحة |
...
| [GetTextForLocation](../../aspose.imaging.fileformats.djvu/djvupage/gettextforlocation/)(Rectangle) | يحصل على النص لموقع المستطيل |
| [GetTextImage](../../aspose.imaging.fileformats.djvu/djvupage/gettextimage/)(int) | يحصل على صورة النص. |
...
| الاسم | الوصف |
| --- | --- |
| event [PropertyChanged](../../aspose.imaging.fileformats.djvu/djvupage/propertychanged/) | يحدث عندما يتغير قيمة الخاصية. |
| static event [PageExportedAction](../../aspose.imaging.fileformats.djvu/djvupage/pageexportedaction/) | يحدث عندما [page exported action]. |
