---
title: "الفئة WebPFrameBlock"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Webp.WebPFrameBlock. تمثل سجل فتح كتل webp"
type: docs
weight: 8250
url: /ar/net/aspose.imaging.fileformats.webp/webpframeblock/
---
## WebPFrameBlock class

يمثل سجل مُفتحات كتل WebP.
...
| الاسم | الوصف |
| --- | --- |
| [WebPFrameBlock](webpframeblock/#constructor)(RasterImage) | ينشئ مثيلًا جديدًا من `WebPFrameBlock` |
| [WebPFrameBlock](webpframeblock/#constructor_1)(int, int) | ينشئ مثيلًا جديدًا من الفئة `WebPFrameBlock`. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel/) { get; } | الحصول على عدد البتات لكل بكسل في الصورة. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod/) { get; set; } | يحصل أو يعيّن طريقة التخلص. |
| [Disposed](../../aspose.imaging/disposableobject/disposed/) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثال تم التخلص منه. |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration/) { get; set; } | يحصل أو يعيّن مدة الإطار. |
...
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft/) { get; } | يحصل على إزاحة الإطار اليسرى. |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime/) { get; } | يحصل على مدة الإطار. |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop/) { get; } | يسترجع إزاحة الجزء العلوي للإطار. |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha/) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا الكائن يحتوي على ألفا. |
...
| override [Height](../../aspose.imaging.fileformats.webp/webpframeblock/height/) { get; } | الحصول على ارتفاع الصورة. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left/) { get; set; } | يحصل أو يعيّن موضع الإطار من اليسار. |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top/) { get; set; } | يحصل أو يعيّن موضع الإطار من الأعلى. |
...
| [UseAlphaBlending](../../aspose.imaging.fileformats.webp/webpframeblock/usealphablending/) { get; set; } | يحصل أو يعيّن القيمة التي تشير إلى ما إذا كان الإطار الحالي يدمج مع قيم ألفا للإطار السابق. |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width/) { get; } | يحصل على عرض الصورة. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe/)() | يسترجع الإطار الكامل. |
