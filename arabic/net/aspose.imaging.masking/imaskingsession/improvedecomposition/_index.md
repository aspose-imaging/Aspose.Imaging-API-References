---
title: "IMatchingSession.ImproveDecomposition"
second_title: "Aspose.Imaging for .NET API Reference"
description: "طريقة IMatchingSession. تنفذ عملية تفكيك إعادة التدريب"
type: docs
weight: 30
url: /ar/net/aspose.imaging.masking/imaskingsession/improvedecomposition/
---
## IMaskingSession.ImproveDecomposition method

ينفّذ عملية تفكيك إعادة التدريب
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| maskingArguments | IMatchingArgs | معلمات الإخفاء. |
