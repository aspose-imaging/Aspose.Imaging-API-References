---
title: "ImageMasking.CreateSession"
second_title: "Aspose.Imaging for .NET API Reference"
description: "طريقة ImageMasking. تنشئ جلسة القناع التي يمكنها تنفيذ عمليات إعادة التدريب والتفكيك."
type: docs
weight: 20
url: /ar/net/aspose.imaging.masking/imagemasking/createsession/
---
## ImageMasking.CreateSession method

ينشئ جلسة الإخفاء التي يمكنها تنفيذ عمليات تفكيك إعادة التدريب.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الخيارات | MaskingOptions | الخيارات. |
