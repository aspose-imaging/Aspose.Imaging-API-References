...
description: ينشئ جلسة التقنيع التي يمكنها إجراء عمليات تحلل إعادة التدريب.
type: docs
weight: 20
...
ينشئ جلسة التقنيع التي يمكنها إجراء عمليات تحلل إعادة التدريب.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| options | MaskingOptions | الخيارات. |
