...
description: "طريقة ImageMasking. تُجري عملية التفكيك باستخدام خيارات القناع المحددة"
type: docs
weight: 30
url: /ar/net/aspose.imaging.masking/imagemasking/decompose/
---
## ImageMasking.Decompose method

ينفذ عملية التفكيك باستخدام خيارات الإخفاء المحددة
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الخيارات | MaskingOptions | خيارات القناع. |
