---
title: "ImageMasking.ImageMasking"
second_title: "Aspose.Imaging for .NET API Reference"
description: "منشئ ImageMasking. يهيئ نسخة جديدة من فئة ImageMasking"
type: docs
weight: 10
...
يهيئ نسخة جديدة من فئة [`ImageMasking`](../).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| sourceImage | RasterImage | الصورة المصدر. |

### الاستثناءات

| استثناء | شرط |
| --- | --- |
| ArgumentNullException | الصورة المصدر فارغة. |
