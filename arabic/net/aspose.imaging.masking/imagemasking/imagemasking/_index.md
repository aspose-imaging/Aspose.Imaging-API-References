...
description: يقوم بتهيئة مثيل جديد لملفImageMaskingaspose.imaging.masking/imagemasking فئة .
type: docs
weight: 10
url: /ar/net/aspose.imaging.masking/imagemasking/imagemasking/
---
## ImageMasking constructor

يقوم بتهيئة مثيل جديد لملف[`ImageMasking`](../../imagemasking) فئة .
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| sourceImage | RasterImage | مصدر الصورة. |

### استثناءات

| استثناء | حالة |
| --- | --- |
| ArgumentNullException | الصورة المصدر خالية. |
