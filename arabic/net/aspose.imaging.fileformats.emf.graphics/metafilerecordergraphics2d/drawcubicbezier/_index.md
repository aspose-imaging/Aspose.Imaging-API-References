...
type: docs
weight: 60
url: /ar/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawcubicbezier/
---
...
| pt1 | Point | نقطة انطلاق المنحنى. |
| pt2 | Point | أول نقطة تحكم للمنحنى. |
| pt3 | Point | نقطة التحكم الثانية للمنحنى. |
| pt4 | Point | نقطة نهاية المنحنى. |
