...
description: "خاصية BmpImage. استرجع أو اضبط بسهولة الدقة العمودية المقاسة بوحدات البكسل لكل بوصة لهذا الكائن RasterImage باستخدام هذه الخاصية. مثالية للمطورين الذين يحتاجون إلى تحكم دقيق في دقة الصورة في تطبيقاتهم."
type: docs
weight: 110
url: /ar/net/aspose.imaging.fileformats.bmp/bmpimage/verticalresolution/
---
## BmpImage.VerticalResolution property

استرجع أو اضبط بسهولة الدقة العمودية، المقاسة بوحدات البكسل لكل بوصة، لهذا الكائن [`RasterImage`](../../../aspose.imaging/rasterimage/) باستخدام هذه الخاصية. مثالية للمطورين الذين يحتاجون إلى تحكم دقيق في دقة الصورة في تطبيقاتهم.
