---
title: "BmpImage.Compression"
second_title: "Aspose.Imaging for .NET API Reference"
description: "خاصية BmpImage. استرجع نوع الضغط المستخدم للصورة بسهولة باستخدام هذه الخاصية. مثالية للمطورين الذين يحتاجون إلى الوصول السريع إلى معلومات حول ضغط الصورة."
type: docs
weight: 40
...
استرجع بسهولة نوع الضغط المستخدم في الصورة باستخدام هذه الخاصية. مثالي للمطورين الذين يحتاجون إلى الوصول السريع إلى معلومات حول ضغط الصورة
