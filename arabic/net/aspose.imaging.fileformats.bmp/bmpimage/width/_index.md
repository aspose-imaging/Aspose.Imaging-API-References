...
description: "خاصية BmpImage. احصل على عرض الصورة بسهولة باستخدام هذه الخاصية. مثالي للمطورين الذين يبحثون عن معلومات سريعة حول أبعاد الصورة."
type: docs
weight: 120
url: /ar/net/aspose.imaging.fileformats.bmp/bmpimage/width/
---
## BmpImage.Width property

احصل بسهولة على عرض الصورة باستخدام هذه الخاصية. مثالي للمطورين الذين يبحثون عن معلومات سريعة حول أبعاد الصورة
