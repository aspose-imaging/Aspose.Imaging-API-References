---
title: "BmpImage.BitsPerPixel"
second_title: "Aspose.Imaging for .NET API Reference"
description: "خاصية BmpImage. احصل بسهولة على عدد البتات لكل بكسل في الصورة باستخدام هذه الخاصية. مثالية للمطورين الذين يبحثون عن معلومات سريعة حول جودة الصورة وعمقها"
type: docs
weight: 30
url: /ar/net/aspose.imaging.fileformats.bmp/bmpimage/bitsperpixel/
---
## BmpImage.BitsPerPixel property

احصل بسهولة على عدد البتات لكل بكسل في الصورة باستخدام هذه الخاصية. مثالي للمطورين الذين يبحثون عن معلومات سريعة حول جودة وعمق الصورة
