...
description: "خاصية TiffOptions. تحصل أو تعين قيمة تشير إلى ترتيب بايتات TIFF"
type: docs
weight: 60
url: /ar/net/aspose.imaging.imageoptions/tiffoptions/byteorder/
---
## TiffOptions.ByteOrder property

يحصل أو يعيّن قيمة تشير إلى ترتيب بايتات TIFF.
