...
description: "خاصية JpegOptions. ملف تعريف اللون CMYK الوجهة لصور JPEG بنظام CMYK. يُستخدم لحفظ الصور. يجب أن يكون مقترنًا بـ RGBColorProfile للتحويل اللوني الصحيح"
type: docs
weight: 30
url: /ar/net/aspose.imaging.imageoptions/jpegoptions/cmykcolorprofile/
---
## JpegOptions.CmykColorProfile property

ملف تعريف اللون CMYK الوجهة لصور JPEG بنظام CMYK. يُستخدم لحفظ الصور. يجب أن يكون مقترنًا بملف تعريف اللون RGBColorProfile للتحويل اللوني الصحيح.
