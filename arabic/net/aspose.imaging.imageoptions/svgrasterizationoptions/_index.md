---
title: "الفئة SvgRasterizationOptions"
second_title: "Aspose.Imaging for .NET API Reference"
description: "Aspose.Imaging.ImageOptions.SvgRasterizationOptions الفئة. خيارات التحويل إلى نقطية SVG"
type: docs
weight: 10590
url: /ar/net/aspose.imaging.imageoptions/svgrasterizationoptions/
---
...
| الاسم | الوصف |
| --- | --- |
| [SvgRasterizationOptions](svgrasterizationoptions/)() | المنشئ الافتراضي. |
...
| [ScaleX](../../aspose.imaging.imageoptions/svgrasterizationoptions/scalex/) { get; set; } | الحصول أو تعيين مقياس x. |
| [ScaleY](../../aspose.imaging.imageoptions/svgrasterizationoptions/scaley/) { get; set; } | الحصول أو تعيين مقياس y. |
...
| override [CopyTo](../../aspose.imaging.imageoptions/svgrasterizationoptions/copyto/)(VectorRasterizationOptions) | ينسخ هذه الحالة إلى *vectorRasterizationOptions*. |
