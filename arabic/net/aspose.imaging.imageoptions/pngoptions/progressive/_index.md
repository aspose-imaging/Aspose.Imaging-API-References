...
description: الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذاPngOptionsaspose.imaging.imageoptions/pngoptions تقدمية.
type: docs
weight: 60
...
الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا[`PngOptions`](../../pngoptions) تقدمية.
...
`حقيقي` إذا كانت تقدمية خلاف ذلك،`خاطئة` .
