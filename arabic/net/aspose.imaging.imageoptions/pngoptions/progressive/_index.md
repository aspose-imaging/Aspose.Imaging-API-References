...
description: "خاصية PngOptions. يحصل أو يضبط قيمة تشير إلى ما إذا كان PngImage progressive"
type: docs
weight: 60
url: /ar/net/aspose.imaging.imageoptions/pngoptions/progressive/
---
## PngOptions.Progressive property

يحصل أو يضبط قيمة تشير إلى ما إذا كان [`PngImage`](../../../aspose.imaging.fileformats.png/pngimage/) progressive.
...
`true` إذا كان progressive؛ وإلا `false`.
