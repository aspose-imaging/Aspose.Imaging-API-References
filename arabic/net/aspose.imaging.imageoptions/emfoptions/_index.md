...
type: docs
weight: 9970
url: /ar/net/aspose.imaging.imageoptions/emfoptions/
---
## EmfOptions class
...
يوضح المثال التالي كيفية تحويل صورة متجهية متعددة الصفحات إلى تنسيق EMF بشكل عام دون الرجوع إلى نوع صورة معين.
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    ...
    // تصدير أول صفحتين فقط. في الواقع ، سيتم تحويل صفحة واحدة فقط لأن EMF ليس تنسيقًا متعدد الصفحات.
