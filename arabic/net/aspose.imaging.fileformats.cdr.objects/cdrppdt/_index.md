...
type: docs
weight: 1730
url: /ar/net/aspose.imaging.fileformats.cdr.objects/cdrppdt/
---
## CdrPpdt class
...
| [KnotVecor](../../aspose.imaging.fileformats.cdr.objects/cdrppdt/knotvecor) { get; set; } | الحصول على أو تعيين شكل العقدة . |
| [Parent](../../aspose.imaging.fileformats.cdr.objects/cdrobject/parent) { get; set; } | الحصول على أو تعيين الأصل. |
| [Points](../../aspose.imaging.fileformats.cdr.objects/cdrppdt/points) { get; set; } | الحصول على النقاط أو تحديدها . |
