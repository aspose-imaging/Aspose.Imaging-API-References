...
description: "الفئة Aspose.Imaging.FileFormats.Ico.IcoImage. قم بالتلاعب بملفات صور ICO بسهولة باستخدام واجهة برمجة التطبيقات الخاصة بنا التي تدعم صيغ ملفات مختلفة وأنواع الإطارات بما في ذلك PNG و BMP. خصّص إعدادات البتات لكل بكسل وقم بتحديث أبعاد الصورة بسلاسة لضمان تمثيل مثالي وتوافق أيقوناتك عبر مختلف المنصات."
type: docs
weight: 6830
url: /ar/net/aspose.imaging.fileformats.ico/icoimage/
---
## IcoImage class
...
| override [FileFormat](../../aspose.imaging.fileformats.ico/icoimage/fileformat/) { get; } | استرجع تنسيق الملف بسهولة باستخدام هذه الخاصية، مما يتيح دمجًا سلسًا في سير عملك. باستخدام هذه الخاصية، تحصل على معلومات حيوية حول تنسيق ملفك، مما يضمن التوافق والمعالجة الفعّالة. |
| override [HasAlpha](../../aspose.imaging.fileformats.ico/icoimage/hasalpha/) { get; } | حدّد ما إذا كان قناة ألفا موجودة في هذه الحالة باستخدام هذه الخاصية. توفر طريقة سريعة للتحقق مما إذا كانت الصورة أو المستند يحتوي على قناة ألفا، وهو أمر حاسم لمهام معالجة الصور وعرضها المتنوعة. مثالية لضمان التوافق ومعالجة تأثيرات الشفافية في الصور أو المستندات. |
...
| override [PageCount](../../aspose.imaging.fileformats.ico/icoimage/pagecount/) { get; } | احصل على نظرة فورية على بنية المستند باستخدام هذه الخاصية المبسطة. من خلال استدعاء هذه الخاصية، تسترجع بسهولة العدد الإجمالي للصفحات الموجودة في الملف. |
...
| override [Pages](../../aspose.imaging.fileformats.ico/icoimage/pages/) { get; } | استرجع معلومات شاملة حول صفحات المستند بسهولة عبر هذه الخاصية. من خلال الوصول إلى هذه الخاصية، تحصل على مجموعة أو مصفوفة تحتوي على جميع الصفحات الموجودة في المستند. |
...
| الاسم | الوصف |
| --- | --- |
| [AddPage](../../aspose.imaging.fileformats.ico/icoimage/addpage/#addpage)(Image) | قم بإثراء صورة ICO الخاصة بك بسهولة عن طريق إدراج صفحة صورة باستخدام الإعدادات الافتراضية من [`IcoOptions`](../../aspose.imaging.imageoptions/icooptions/). يقوم هذا الأسلوب بتحويل الصورة المُدخلة إلى صيغة PNG 32‑بت بسهولة، مما يضمن التوافق وجودة عرض عالية داخل صورة ICO. مثالي لدمج صور PNG بسلاسة في ملفات ICO بسهولة وكفاءة. |
| [AddPage](../../aspose.imaging.fileformats.ico/icoimage/addpage/#addpage_2)(RasterImage) | وسّع صورة ICO الخاصة بك بإضافة صفحة صورة، مستفيدًا من [`IcoOptions`](../../aspose.imaging.imageoptions/icooptions/). يدمج هذا الأسلوب صورًا نقطية في ملف ICO بسلاسة، محولًا إياها إلى صيغة PNG 32‑بت عالية الجودة. مثالي لتعزيز ملفات ICO بالصور النقطية مع ضمان التوافق الأمثل وجودة العرض. |
| [AddPage](../../aspose.imaging.fileformats.ico/icoimage/addpage/#addpage_1)(Image, IcoOptions) | نوّع صورة ICO الخاصة بك بسهولة عبر دمج إدخال صورة مخصص وفقًا لاحتياجاتك باستخدام [`IcoOptions`](../../aspose.imaging.imageoptions/icooptions/) المحددة. يدمج هذا الأسلوب الصورة وفقًا للخيارات المخصصة الخاصة بك، مما يضمن المرونة والدقة في ملف ICO. |
| override [AdjustBrightness](../../aspose.imaging/rastercachedmultipageimage/adjustbrightness/)(int) | ضبط *السطوع* للصورة. |
| override [AdjustContrast](../../aspose.imaging/rastercachedmultipageimage/adjustcontrast/)(float) | [`Image`](../../aspose.imaging/image/) متباين |
| override [AdjustGamma](../../aspose.imaging/rastercachedmultipageimage/adjustgamma/)(float) | تصحيح جاما للصورة. |
| override [AdjustGamma](../../aspose.imaging/rastercachedmultipageimage/adjustgamma/)(float, float, float) | تصحيح جاما للصورة. |
...
| override [Crop](../../aspose.imaging/rastercachedmultipageimage/crop/)(Rectangle) | قص الصورة. |
...
| override [Dither](../../aspose.imaging/rastercachedmultipageimage/dither/)(DitheringMethod, int, IColorPalette) | يقوم بأداء التمويه على الصورة الحالية. |
...
| [RemovePage](../../aspose.imaging.fileformats.ico/icoimage/removepage/)(int) | قم بضبط صورة ICO بدقة عن طريق إزالة إدخال صورة محدد يقع في [الفهرس](index) المحدد داخل الملف. يوفر هذا الأسلوب تحكمًا دقيقًا في تكوين الصورة، مما يتيح لك تحسين ملف ICO بسهولة. |
...
| override [Resize](../../aspose.imaging/rastercachedmultipageimage/resize/)(int, int, ImageResizeSettings) | تغيير حجم الصورة. |
| override [Resize](../../aspose.imaging/rastercachedmultipageimage/resize/)(int, int, ResizeType) | تغيير حجم الصورة. |
...
| override [Rotate](../../aspose.imaging/rastercachedmultipageimage/rotate/)(float, bool, Color) | [`Rotate`](../../aspose.imaging/rastercachedmultipageimage/rotate/) صورة حول المركز. |
