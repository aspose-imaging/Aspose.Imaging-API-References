---
title: "الفئة GifFrameBlock"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Gif.Blocks.GifFrameBlock. فئة إطار GIF"
type: docs
weight: 6730
url: /ar/net/aspose.imaging.fileformats.gif.blocks/gifframeblock/
---
## GifFrameBlock class
...
| الاسم | الوصف |
| --- | --- |
| [GifFrameBlock](gifframeblock/#constructor)(RasterImage) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_3)(Stream) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_6)(string) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_9)(ushort, ushort) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_1)(RasterImage, ushort, ushort) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_4)(Stream, ushort, ushort) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_7)(string, ushort, ushort) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_10)(ushort, ushort, ushort, ushort) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_8)(string, ushort, ushort, bool, bool, byte) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
| [GifFrameBlock](gifframeblock/#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | يُهيئ نسخة جديدة من الفئة `GifFrameBlock`. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/backgroundcolor/) { get; set; } | الحصول على أو تعيين قيمة للون الخلفية. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel/) { get; } | الحصول على عدد البتات لكل بكسل في الصورة. |
...
| [ControlBlock](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/controlblock/) { get; } | يحصل على كتلة التحكم الرسومية المرتبطة بهذه الكتلة. |
| [DataStreamContainer](../../aspose.imaging/datastreamsupporter/datastreamcontainer/) { get; } | الحصول على تدفق بيانات الكائن. |
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod/) { get; } | يحصل على طريقة التخلص. |
| [Disposed](../../aspose.imaging/disposableobject/disposed/) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثال تم التخلص منه. |
| [ExifData](../../aspose.imaging/image/exifdata/) { get; set; } | الحصول على أو تعيين بيانات Exif. |
| override [FileFormat](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/fileformat/) { get; } | يحصل على قيمة تنسيق الملف |
| [Flags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/flags/) { get; set; } | يحصل أو يعيّن العلامات. |
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft/) { get; } | يحصل على اليسار. |
| [FrameTime](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametime/) { get; set; } | يحصل أو يعيّن المدة. |
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop/) { get; } | يحوّل إلى p. |
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel/) { get; set; } | يحصل أو يعيّن عدد البت لكل بكسل في إطار GIF. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor/) { get; set; } | يحصل على قيمة تشير إلى ما إذا كانت كتلة الإطار تحتوي على لون شفاف. |
| override [Height](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/height/) { get; } | الحصول على ارتفاع الصورة. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced/) { get; set; } | يحصل أو يعيّن قيمة تشير إلى ما إذا كانت هذه `GifFrameBlock` متشابكة. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced/) { get; } | يحصل على قيمة تشير إلى ما إذا كانت نسخة الصورة هذه متشابكة. |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted/) { get; set; } | يحصل أو يضبط قيمة تشير إلى ما إذا كانت لوحة الألوان مرتبة. |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left/) { get; set; } | يحصل أو يضبط موقع الصورة الأيسر. |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top/) { get; set; } | يحصل أو يضبط موقع الصورة العلوي. |
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor/) { get; set; } | يحصل على اللون الشفاف لكتلة الإطار. |
...
| [UseAlphaBlending](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/usealphablending/) { get; } | يسترجع قيمة تشير إلى ما إذا كان [use alpha blending]. |
...
| override [Width](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/width/) { get; } | يحصل على عرض الصورة. |
...
| الاسم | الوصف |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/adjustbrightness/)(int) | ضبط السطوع للصورة. |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor/#replacecolor_1)(int, byte, int) | يستبدل لونًا بآخر مع فرق مسموح ويحافظ على قيمة ألفا الأصلية لحفظ الحواف السلسة. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors/#replacenontransparentcolors_1)(int) | يستبدل جميع الألوان غير الشفافة بلون جديد ويحافظ على قيمة ألفا الأصلية لحفظ الحواف السلسة. ملاحظة: إذا استخدمتها على صور بدون شفافية، سيتم استبدال جميع الألوان بلون واحد. |
| [Resize](../../aspose.imaging/image/resize/)(int, int) | يُعيد تحجيم الصورة. يتم استخدام NearestNeighbourResample الافتراضي. |
| override [Resize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/resize/#resize_1)(int, int, ImageResizeSettings) | يعيد تحجيم نسخة [`RasterCachedImage`](../../aspose.imaging/rastercachedimage/) هذه. |
...
| static [CreateFlags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/createflags/)(IColorPalette, bool, bool) | ينشئ العلامات. |
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette/)(IColorPalette, IColorPalette) | يحصل على لوحة الألوان المرتبطة. |

## الحقول

| الاسم | الوصف |
| --- | --- |
| const [ExtensionLabel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/extensionlabel/) | تسمية امتداد الكتلة. |
| const [ImageDescriptorSize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/imagedescriptorsize/) | حجم موصّف الصورة. |
