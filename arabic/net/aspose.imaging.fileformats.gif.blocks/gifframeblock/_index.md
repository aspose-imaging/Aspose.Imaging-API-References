...
| اسم | وصف |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | يقوم بتهيئة مثيل جديد لملف[`GifFrameBlock`](../gifframeblock) فئة . |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel) { get; } | الحصول على عدد بتات الصورة لكل بكسل . |
...
| [ControlBlock](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/controlblock) { get; } | يحصل على كتلة التحكم في الرسومات المرتبطة بهذه الكتلة. |
| [DataStreamContainer](../../aspose.imaging/datastreamsupporter/datastreamcontainer) { get; } | يحصل على دفق بيانات الكائن. |
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod) { get; } | الحصول على طريقة التخلص . |
...
| [Flags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/flags) { get; set; } | الحصول على العلامات أو تعيينها . |
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft) { get; } | يحصل على اليسار. |
| [FrameTime](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametime) { get; set; } | الحصول على المدة أو تحديدها . |
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop) { get; } | تحويل إلى p. |
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel) { get; set; } | الحصول على أو تعيين بتات إطار GIF لكل بكسل. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor) { get; set; } | يحصل على قيمة تشير إلى ما إذا كانت كتلة الإطار لها لون شفاف. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان هذا[`GifFrameBlock`](../gifframeblock) متشابك. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | يحصل على قيمة تشير إلى ما إذا كان مثيل الصورة هذا متشابكًا. |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كانت لوحة الألوان مرتبة أم لا. |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left) { get; set; } | الحصول على أو تحديد موقع الصورة الأيسر . |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top) { get; set; } | الحصول على أو تحديد موقع الصورة العلوي. |
...
| override [Width](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/width) { get; } | الحصول على عرض الصورة . |
...
| اسم | وصف |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/adjustbrightness)(int) | ضبط سطوع الصورة . |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor#replacecolor_1)(int, byte, int) | يستبدل لونًا بآخر بالاختلاف المسموح به ويحتفظ بقيمة ألفا الأصلية لحفظ الحواف المتجانسة. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors#replacenontransparentcolors_1)(int) | يستبدل كل الألوان غير الشفافة بلون جديد ويحتفظ بقيمة ألفا الأصلية لحفظ الحواف الناعمة . ملاحظة: إذا كنت تستخدمها على صور بدون شفافية ، فسيتم استبدال كل الألوان بواحد. |
...
| static [CreateFlags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/createflags)(IColorPalette, bool, bool) | ينشئ الإشارات . |
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette)(IColorPalette, IColorPalette) | الحصول على لوحة الألوان المرتبطة . |

## مجالات

| اسم | وصف |
| --- | --- |
| const [ExtensionLabel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/extensionlabel) | تسمية ملحق الحظر . |
| const [ImageDescriptorSize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/imagedescriptorsize) | حجم واصف الصورة . |
