...
description: "منشئ AssumedObjectData. يهيء مثالًا جديدًا من الفئة AssumedObjectData"
type: docs
weight: 10
...
يهيء مثالًا جديدًا من الفئة [`AssumedObjectData`](../).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| نوع | DetectedObjectType | نوع الكائن. |
| الحدود | Rectangle | حدود الكائن. |
