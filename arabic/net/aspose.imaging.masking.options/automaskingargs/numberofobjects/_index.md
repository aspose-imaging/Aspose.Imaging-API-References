...
description: "خاصية AutoMaskingArgs. تحصل أو تعيين عدد الكائنات لفصل الصورة الأولية (اختياري). القيمة الافتراضية هي كائنان وخلفية"
type: docs
weight: 30
...
يحصل أو يعيّن عدد الكائنات التي سيتم فصل الصورة الأولية إليها (اختياري)، القيمة الافتراضية هي 2 (كائن وخلفية).
