...
description: "خاصية AutoMaskingGraphCutOptions. تحصل على ضربات الخلفية الافتراضية"
type: docs
weight: 40
url: /ar/net/aspose.imaging.masking.options/automaskinggraphcutoptions/defaultbackgroundstrokes/
---
## AutoMaskingGraphCutOptions.DefaultBackgroundStrokes property

يحصل على الضربات الخلفية الافتراضية.
