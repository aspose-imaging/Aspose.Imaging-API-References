...
description: يمثل خيارات إخفاء الصورة الشائعة.
type: docs
weight: 10510
...
يمثل خيارات إخفاء الصورة الشائعة.
...
| اسم | وصف |
| --- | --- |
| const [BackgroundObjectNumber](../../aspose.imaging.masking.options/maskingoptions/backgroundobjectnumber) | رقم كائن الخلفية |
