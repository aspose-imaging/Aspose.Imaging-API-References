---
title: "MaskingOptions.BackgroundReplacementColor"
second_title: "Aspose.Imaging for .NET API Reference"
description: "خاصية MaskingOptions. تحصل أو تعين لون استبدال الخلفية"
type: docs
weight: 30
url: /ar/net/aspose.imaging.masking.options/maskingoptions/backgroundreplacementcolor/
---
## MaskingOptions.BackgroundReplacementColor property

يحصل أو يضبط لون استبدال الخلفية.
...
لون استبدال الخلفية. سيُستخدم هذا اللون كلون خلفية في الصور الناتجة.
