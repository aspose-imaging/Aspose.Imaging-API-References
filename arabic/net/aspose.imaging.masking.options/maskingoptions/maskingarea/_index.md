...
description: "خاصية MaskingOptions. تحصل أو تعين منطقة القناع"
type: docs
weight: 60
url: /ar/net/aspose.imaging.masking.options/maskingoptions/maskingarea/
---
## MaskingOptions.MaskingArea property

يحصل أو يضبط منطقة القناع.
...
منطقة القناع التي هي جزء من الصورة الأصلية. قيمة Rectangle.Empty تعني مساحة الصورة الأصلية بالكامل.
