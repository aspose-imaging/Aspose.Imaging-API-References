---
title: "MaskingOptions.ExportOptions"
second_title: "Aspose.Imaging for .NET API Reference"
description: "خاصية MaskingOptions. تحصل أو تعين خيارات تصدير الصورة"
type: docs
weight: 50
url: /ar/net/aspose.imaging.masking.options/maskingoptions/exportoptions/
---
## MaskingOptions.ExportOptions property

يحصل أو يضبط خيارات تصدير الصورة.
...
خيارات تصدير الصورة التي ستُستخدم لإنشاء الصور الناتجة.
