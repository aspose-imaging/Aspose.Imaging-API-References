...
description: "الفئة Aspose.Imaging.Shapes.PieShape. تمثّل شكل فطيرة."
type: docs
weight: 11580
url: /ar/net/aspose.imaging.shapes/pieshape/
---
## PieShape class
...
| الاسم | الوصف |
| --- | --- |
| [PieShape](pieshape/#constructor)() | ينشئ مثيلاً جديدًا للفئة `PieShape`. |
| [PieShape](pieshape/#constructor_1)(RectangleF, float, float) | ينشئ مثيلاً جديدًا للفئة `PieShape`. |
...
| override [Segments](../../aspose.imaging.shapes/pieshape/segments/) { get; } | يحصل على قطاعات الشكل. |
...
| الاسم | الوصف |
| --- | --- |
| override [Equals](../../aspose.imaging.shapes/pieshape/equals/)(object) | تحقق مما إذا كانت الكائنات متساوية. |
...
| override [GetHashCode](../../aspose.imaging.shapes/pieshape/gethashcode/)() | احصل على قيمة التجزئة للكائن الحالي. |
