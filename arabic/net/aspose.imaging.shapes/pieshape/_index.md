...
| اسم | وصف |
| --- | --- |
| [PieShape](pieshape#constructor)() | يقوم بتهيئة مثيل جديد لملف[`PieShape`](../pieshape) فئة . |
| [PieShape](pieshape#constructor_1)(RectangleF, float, float) | يقوم بتهيئة مثيل جديد لملف[`PieShape`](../pieshape) فئة . |
...
| override [Segments](../../aspose.imaging.shapes/pieshape/segments) { get; } | الحصول على شرائح الشكل . |
