...
| اسم | وصف |
| --- | --- |
| [RectangleShape](rectangleshape#constructor)() | يقوم بتهيئة مثيل جديد لملف[`RectangleShape`](../rectangleshape) فئة . |
| [RectangleShape](rectangleshape#constructor_1)(RectangleF) | يقوم بتهيئة مثيل جديد لملف[`RectangleShape`](../rectangleshape) فئة . |
...
| override [Segments](../../aspose.imaging.shapes/rectangleshape/segments) { get; } | الحصول على شرائح الشكل . |
