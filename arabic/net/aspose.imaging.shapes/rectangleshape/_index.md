...
description: "Aspose.Imaging.Shapes.RectangleShape الفئة. تمثل شكلاً مستطيلاً"
type: docs
weight: 11610
url: /ar/net/aspose.imaging.shapes/rectangleshape/
---
...
| الاسم | الوصف |
| --- | --- |
| [RectangleShape](rectangleshape/#constructor)() | ينشئ نسخة جديدة من الفئة `RectangleShape`. |
| [RectangleShape](rectangleshape/#constructor_1)(RectangleF) | ينشئ نسخة جديدة من الفئة `RectangleShape`. |
...
| override [Segments](../../aspose.imaging.shapes/rectangleshape/segments/) { get; } | يحصل على قطاعات الشكل. |

## الطرق

| الاسم | الوصف |
| --- | --- |
| override [Equals](../../aspose.imaging.shapes/rectangleshape/equals/)(object) | تحقق مما إذا كانت الكائنات متساوية. |
...
| override [GetHashCode](../../aspose.imaging.shapes/rectangleshape/gethashcode/)() | احصل على قيمة التجزئة للكائن الحالي. |
