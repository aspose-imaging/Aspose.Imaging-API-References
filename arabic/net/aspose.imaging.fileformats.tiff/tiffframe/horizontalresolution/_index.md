...
description: "خاصية TiffFrame. يحصل أو يضبط الدقة الأفقية بوحدات البكسل لكل بوصة لهذا RasterImage"
type: docs
weight: 90
...
يحصل أو يضبط الدقة الأفقية، بوحدات البكسل لكل بوصة، لهذا [`RasterImage`](../../../aspose.imaging/rasterimage/).
