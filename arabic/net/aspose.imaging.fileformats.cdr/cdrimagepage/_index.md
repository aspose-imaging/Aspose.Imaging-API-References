---
title: "الفئة CdrImagePage"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Cdr.CdrImagePage. صفحة صورة Cdr"
type: docs
weight: 1480
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimagepage/bitsperpixel/) { get; } | الحصول على عدد البتات لكل بكسل في الصورة. |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimagepage/cdrdocument/) { get; } | يحصل أو يحدد مستند CDR. |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimagepage/iscached/) { get; } | يحصل على قيمة تشير إلى ما إذا كانت بيانات الكائن مخزنة مؤقتاً حالياً ولا يلزم قراءة البيانات. |
...
| [ParentImage](../../aspose.imaging.fileformats.cdr/cdrimagepage/parentimage/) { get; } | يحصل على الصورة الأصلية. |
...
| الاسم | الوصف |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimagepage/cachedata/)() | يقوم بتخزين البيانات مؤقتًا ويضمن عدم تحميل بيانات إضافية من [`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer/) الأساسي. |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.cdr/cdrimagepage/getdefaultoptions/)(object[]) | يحصل على الخيارات الافتراضية. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cdr/cdrimagepage/setpalette/)(IColorPalette, bool) | يضبط لوحة ألوان الصورة. |
