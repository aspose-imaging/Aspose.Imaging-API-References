...
description: "منشئ EmfDeleteObject. يُنشئ مثيلًا جديدًا للفئة EmfDeleteObject"
type: docs
weight: 10
url: /ar/net/aspose.imaging.fileformats.emf.emf.records/emfdeleteobject/emfdeleteobject/
---
## EmfDeleteObject(EmfRecord) {#constructor_1}

يُنشئ مثيلًا جديدًا للفئة [`EmfDeleteObject`](../).
