...
description: "منشئ EmfCreateBrushIndirect. يهيئ نسخة جديدة من الفئة EmfCreateBrushIndirect."
type: docs
weight: 10
url: /ar/net/aspose.imaging.fileformats.emf.emf.records/emfcreatebrushindirect/emfcreatebrushindirect/
---
## EmfCreateBrushIndirect(EmfRecord) {#constructor_1}

يهيئ نسخة جديدة من الفئة [`EmfCreateBrushIndirect`](../).
