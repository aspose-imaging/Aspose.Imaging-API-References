---
title: "الفئة EmfPolyBezier16"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Emf.Emf.Records.EmfPolyBezier16. السجل EMR_POLYBEZIER16 يحدد منحنى بيزيه واحد أو أكثر. تُرسم المنحنيات باستخدام القلم الحالي"
type: docs
weight: 4070
...
سجل EMR_POLYBEZIER16 يحدد منحنى بيزيه واحد أو أكثر. تُرسم المنحنيات باستخدام القلم الحالي.
...
| الاسم | الوصف |
| --- | --- |
| [EmfPolyBezier16](emfpolybezier16/#constructor)() | ينشئ مثيلًا جديدًا للفئة `EmfPolyBezier16`. |
| [EmfPolyBezier16](emfpolybezier16/#constructor_1)(EmfRecord) | ينشئ مثيلًا جديدًا للفئة `EmfPolyBezier16`. |
