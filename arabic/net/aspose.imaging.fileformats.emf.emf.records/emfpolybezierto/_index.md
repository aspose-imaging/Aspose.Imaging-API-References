---
title: "الفئة EmfPolyBezierTo"
second_title: "Aspose.Imaging for .NET API Reference"
description: "الفئة Aspose.Imaging.FileFormats.Emf.Emf.Records.EmfPolyBezierTo. سجل EMR_POLYBEZIERTO يحدد منحنى (أو أكثر) بيزيير استنادًا إلى الموضع الحالي."
type: docs
weight: 4080
url: /ar/net/aspose.imaging.fileformats.emf.emf.records/emfpolybezierto/
---
## EmfPolyBezierTo class

سجل EMR_POLYBEZIERTO يحدد منحنى بيزيه واحد أو أكثر بناءً على الموضع الحالي.
...
| الاسم | الوصف |
| --- | --- |
| [EmfPolyBezierTo](emfpolybezierto/#constructor)() | يُهيئ نسخة جديدة من الفئة `EmfPolyBezierTo`. |
| [EmfPolyBezierTo](emfpolybezierto/#constructor_1)(EmfRecord) | يُهيئ نسخة جديدة من الفئة `EmfPolyBezierTo`. |
