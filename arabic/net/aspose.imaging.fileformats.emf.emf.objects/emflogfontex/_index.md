...
description: يحدد كائن LogFontEx السمات الموسعة للخط المنطقي.
type: docs
weight: 3040
...
يحدد كائن LogFontEx السمات الموسعة للخط المنطقي.
...
| اسم | وصف |
| --- | --- |
| [EmfLogFontEx](emflogfontex)(EmfLogFont) | يقوم بتهيئة مثيل جديد لملف[`EmfLogFontEx`](../emflogfontex) فئة . |
