...
type: docs
weight: 6590
url: /ar/net/aspose.imaging.fileformats.eps/epsoptions/
---
## EpsOptions class

خيارات EPS (غير مستخدمة حاليًا)
...
| [SubType](../../aspose.imaging.fileformats.eps/epsoptions/subtype) { get; set; } | الحصول على النوع الفرعي لتنسيق EPS أو تحديده. |
