...
type: docs
weight: 6580
url: /ar/net/aspose.imaging.fileformats.eps/epsinterchangeimage/
---
## EpsInterchangeImage class

فئة لتنسيق Encapsulated PostScript Interchange
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.eps/epsimage/bitsperpixel) { get; } | الحصول على عدد البتات لكل بكسل في الصورة. |
| [BoundingBoxBottomLeft](../../aspose.imaging.fileformats.eps/epsimage/boundingboxbottomleft) { get; } | يحصل على موضع الزاوية السفلية اليسرى لمربع الحدود |
| [BoundingBoxString](../../aspose.imaging.fileformats.eps/epsimage/boundingboxstring) { get; } | يحصل على قيمة سلسلة BoundingBox |
| [BoundingBoxTopRight](../../aspose.imaging.fileformats.eps/epsimage/boundingboxtopright) { get; } | يحصل على موضع الزاوية العليا اليمنى لمربع الحدود |
...
| [Container](../../aspose.imaging/image/container) { get; } | يحصل على حاوية [`Image`](../../aspose.imaging/image). |
| [CreationDate](../../aspose.imaging.fileformats.eps/epsimage/creationdate) { get; } | يحصل على حقل CreationDate |
| [CreationDateString](../../aspose.imaging.fileformats.eps/epsimage/creationdatestring) { get; } | يحصل على قيمة سلسلة حقل CreationDate |
| [Creator](../../aspose.imaging.fileformats.eps/epsimage/creator) { get; } | يحصل على حقل Creator |
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsinterchangeimage/epstype) { get; } | يحصل على قيمة نوع EPS الفرعي |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | يحصل على قيمة تشير إلى ما إذا كانت هذه النسخة تحتوي على معاينة نقطية خاصة بالتنسيق |
...
| [PagesCount](../../aspose.imaging.fileformats.eps/epsimage/pagescount) { get; } | يحصل على عدد الصفحات |
...
| [PhotoshopThumbnail](../../aspose.imaging.fileformats.eps/epsimage/photoshopthumbnail) { get; } | يحصل على صورة مصغرة لمعاينة Photoshop (إذا كانت موجودة في بيانات EPS الأولية) |
| [PostScriptVersion](../../aspose.imaging.fileformats.eps/epsimage/postscriptversion) { get; } | يحصل على حقل نسخة PostScript |
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | يحصل على ارتفاع صورة المعاينة |
| [PreviewWidth](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewwidth) { get; } | يحصل على عرض صورة المعاينة |
| [RasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/rasterpreview) { get; } | يحصل على معاينة نقطية بالأبيض والأسود (إن وجدت) أو null |
...
| override [Width](../../aspose.imaging.fileformats.eps/epsimage/width) { get; } | يحصل على عرض الصورة. |
...
| الاسم | الوصف |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.eps/epsimage/cachedata)() | لا يمكن استخدام الذاكرة المؤقتة. |
...
| [ConvertToBinary](../../aspose.imaging.fileformats.eps/epsinterchangeimage/converttobinary)() | يحوّل هذا الكائن إلى [`EpsBinaryImage`](../epsbinaryimage) |
...
| virtual [GetOriginalOptions](../../aspose.imaging/image/getoriginaloptions)() | يحصل على الخيارات بناءً على إعدادات الملف الأصلي. يمكن أن يكون هذا مفيدًا للحفاظ على عمق البت وغيرها من معلمات الصورة الأصلية دون تغيير. على سبيل المثال، إذا قمنا بتحميل صورة PNG بالأبيض والأسود بدقة 1 بت لكل بكسل ثم حفظناها باستخدام طريقة [`Save`](../../aspose.imaging/datastreamsupporter/save)، سيتم إنتاج صورة PNG الناتجة بدقة 8 بت لكل بكسل. لتجنب ذلك وحفظ صورة PNG بدقة 1 بت لكل بكسل، استخدم هذه الطريقة للحصول على خيارات الحفظ المقابلة ومرّرها إلى طريقة [`Save`](../../aspose.imaging/image/save) كمعامل ثاني. |
| [Resize](../../aspose.imaging/image/resize)(int, int) | يُعيد تحجيم الصورة. يتم استخدام NearestNeighbourResample الافتراضي. |
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ImageResizeSettings) | تغيير حجم الصورة. |
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ResizeType) | تغيير حجم الصورة. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.eps/epsimage/rotateflip)(RotateFlipType) | يدور أو يقلب أو يدور ويقلب الصورة. |
...
| override [SetPalette](../../aspose.imaging.fileformats.eps/epsimage/setpalette)(IColorPalette, bool) | يضبط لوحة ألوان الصورة. |
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | يُجري تحويلًا صريحًا من [`EpsBinaryImage`](../epsbinaryimage) إلى [`EpsInterchangeImage`](../epsinterchangeimage) |
