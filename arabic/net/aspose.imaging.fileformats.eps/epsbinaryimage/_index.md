...
description: فئة تنسيق Encapsulated PostScript برأس ثنائي
type: docs
weight: 6550
url: /ar/net/aspose.imaging.fileformats.eps/epsbinaryimage/
---
## EpsBinaryImage class

فئة تنسيق Encapsulated PostScript برأس ثنائي
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsbinaryimage/epstype) { get; } | الحصول على قيمة النوع الفرعي EPS |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/hasrasterpreview) { get; } | الحصول على قيمة تشير إلى ما إذا كان هذا المثيل يحتوي على معاينة بيانات نقطية خاصة بالتنسيق |
...
| [TiffPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/tiffpreview) { get; } | الحصول على معاينة TIFF . |
...
| [WmfPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/wmfpreview) { get; } | يحصل على معاينة WMF . |
...
| [ConvertToInterchange](../../aspose.imaging.fileformats.eps/epsbinaryimage/converttointerchange)() | تحويل هذا المثيل إلى[`EpsInterchangeImage`](../epsinterchangeimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsbinaryimage/op_explicit) | يقوم بإجراء تحويل صريح من[`EpsInterchangeImage`](../epsinterchangeimage) إلى[`EpsBinaryImage`](../epsbinaryimage) |
