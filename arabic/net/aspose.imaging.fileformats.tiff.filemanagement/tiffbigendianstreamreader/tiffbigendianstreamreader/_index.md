---
title: "TiffBigEndianStreamReader.TiffBigEndianStreamReader"
second_title: "Aspose.Imaging for .NET API Reference"
description: "منشئ TiffBigEndianStreamReader. يهيئ مثيلاً جديداً لفئة TiffBigEndianStreamReader"
type: docs
weight: 10
url: /ar/net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/tiffbigendianstreamreader/
---
## TiffBigEndianStreamReader(byte[]) {#constructor_1}

يهيئ مثيلاً جديداً للفئة [`TiffBigEndianStreamReader`](../).
...
| --- | --- | --- |
| بيانات | Byte[] | بيانات مصفوفة البايت. |
| startIndex | Int32 | فهرس البداية في *data*. |
