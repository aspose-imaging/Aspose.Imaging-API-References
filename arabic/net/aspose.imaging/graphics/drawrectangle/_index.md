...
description: "طريقة Graphics. ترسم مستطيلًا محددًا بواسطة بنية RectangleF"
type: docs
weight: 310
url: /ar/net/aspose.imaging/graphics/drawrectangle/
---
## DrawRectangle(Pen, RectangleF) {#drawrectangle_1}

ترسم مستطيلًا محددًا بواسطة بنية [`RectangleF`](../../rectanglef/) .
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| pen | Pen | قلم [`Pen`](../../pen/) يحدد اللون والعرض والنمط للمستطيل. |
| rect | RectangleF | بنية [`RectangleF`](../../rectanglef/) تمثل المستطيل المراد رسمه. |
...
ترسم مستطيلًا محددًا بواسطة بنية [`Rectangle`](../../rectangle/) .
...
| --- | --- | --- |
| pen | Pen | قلم [`Pen`](../../pen/) يحدد اللون والعرض والنمط للمستطيل. |
| rect | Rectangle | بنية [`Rectangle`](../../rectangle/) تمثل المستطيل المراد رسمه. |
...
| --- | --- | --- |
| pen | Pen | قلم [`Pen`](../../pen/) يحدد اللون والعرض والنمط للمستطيل. |
| x | فردي | الإحداثي السيني للزاوية العلوية اليسرى للمستطيل المراد رسمه. |
| y | فردي | الإحداثي الصادي للزاوية العلوية اليسرى للمستطيل المراد رسمه. |
| العرض | فردي | عرض المستطيل المراد رسمه. |
| الارتفاع | فردي | ارتفاع المستطيل المراد رسمه. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen/) يحدد اللون والعرض والنمط للمستطيل. |
