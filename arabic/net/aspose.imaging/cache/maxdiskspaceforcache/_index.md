...
description: "خاصية Cache. تحصل أو تُعيّن الحد الأقصى المتاح لمساحة القرص للذاكرة المؤقتة. القيمة المحددة هي عدد الميجابايت."
type: docs
weight: 60
url: /ar/net/aspose.imaging/cache/maxdiskspaceforcache/
---
...
الحد الأقصى المتاح لمساحة القرص للذاكرة المؤقتة.
