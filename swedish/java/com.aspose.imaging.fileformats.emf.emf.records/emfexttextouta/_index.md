...
description: "EMR_EXTTEXTOUTA-posten ritar en ASCII-textsträng med det aktuella teckensnittet och textfärgerna."
type: docs
weight: 56
url: /sv/java/com.aspose.imaging.fileformats.emf.emf.records/emfexttextouta/
---
**Inheritance:**
...
Den EMR_EXTTEXTOUTA-posten ritar en ASCII-textsträng med det aktuella teckensnittet och textfärgerna.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [EmfExtTextOutA(EmfRecord source)](#EmfExtTextOutA-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | Initierar en ny instans av klassen `EmfExtTextOutA`. |
| [EmfExtTextOutA()](#EmfExtTextOutA--) | Initierar en ny instans av klassen [EmfExtTextOutA](../../com.aspose.imaging.fileformats.emf.emf.records/emfexttextouta). |
## Metoder
...
| [getAEmrText()](#getAEmrText--) | Hämtar eller anger ett EmrText-objekt (avsnitt 2.2.5) som specificerar utdatasträngen i 8‑bitars ASCII‑tecken, textattribut och avståndsvärden. |
| [setAEmrText(EmfText value)](#setAEmrText-com.aspose.imaging.fileformats.emf.emf.objects.EmfText-) | Hämtar eller anger ett EmrText-objekt (avsnitt 2.2.5) som specificerar utdatasträngen i 8‑bitars ASCII‑tecken, textattribut och avståndsvärden. |
...
Initierar en ny instans av klassen `EmfExtTextOutA`.
...
Initierar en ny instans av klassen [EmfExtTextOutA](../../com.aspose.imaging.fileformats.emf.emf.records/emfexttextouta).
...
Hämtar eller anger ett EmrText-objekt (avsnitt 2.2.5) som specificerar utdatasträngen i 8‑bitars ASCII‑tecken, textattribut och avståndsvärden.
