...
description: "Representerar TIFF Exif image file directory-typklassen."
type: docs
weight: 16
url: /sv/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/
---
**Inheritance:**
...
Representerar TIFF Exif image file directory-typklassen.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [TiffIfdType(int tagId)](#TiffIfdType-int-) | Initierar en ny instans av klassen `TiffIfdType`. |
## Metoder
...
Initierar en ny instans av klassen `TiffIfdType`.
