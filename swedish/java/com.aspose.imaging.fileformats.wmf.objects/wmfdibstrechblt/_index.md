...
description: "META_DIBSTRETCHBLT-posten specificerar överföringen av ett block av pixlar i enhetsoberoende format enligt en rasteroperation med möjlig expansion eller kontraktion."
type: docs
weight: 30
url: /sv/java/com.aspose.imaging.fileformats.wmf.objects/wmfdibstrechblt/
---
**Inheritance:**
...
META\_DIBSTRETCHBLT-posten specificerar överföringen av ett block pixlar i enhetsoberoende format enligt en rasteroperation, med möjlig expansion eller sammandragning.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [WmfDibStrechBlt()](#WmfDibStrechBlt--) | WMFs-posten. |
## Metoder
