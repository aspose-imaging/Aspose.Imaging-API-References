...
description: "Basabstrakt klass som kan tillhandahålla resultatbild från bildmaskeringssystemet."
type: docs
weight: 10
url: /sv/java/com.aspose.imaging.masking.result/maskingresult/
---
**Inheritance:**
...
Basabstrakt klass som kan tillhandahålla resultatbild från bildmaskeringssystemet.
## Fält
...
| Metod | Beskrivning |
| --- | --- |
| [getLayers()](#getLayers--) | Hämtar lagren. |
| [getLength()](#getLength--) | Hämtar längden. |
| [get_Item(int index)](#get-Item-int-) | Hämtar [IMaskingLayer](../../com.aspose.imaging.masking.result/imaskinglayer) på det angivna indexet. |
| [iterator()](#iterator--) | Hämtar enumeratorn. |
...
**Returns:**
com.aspose.imaging.masking.result.IMaskingLayer[] - lagren.
### getLength() {#getLength--}
```
...
Hämtar [IMaskingLayer](../../com.aspose.imaging.masking.result/imaskinglayer) på det angivna indexet.

**Parameters:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Indexet. Värde: [IMaskingLayer](../../com.aspose.imaging.masking.result/imaskinglayer). |
...
**Returns:**
java.util.Iterator<com.aspose.imaging.masking.result.IMaskingLayer> - enumeratorn.
