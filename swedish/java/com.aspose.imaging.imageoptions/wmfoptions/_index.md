...
description: "Wmf-alternativ."
type: docs
weight: 54
url: /sv/java/com.aspose.imaging.imageoptions/wmfoptions/
---
**Inheritance:**
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Exportera endast de två första sidorna. Faktiskt kommer bara en sida att konverteras eftersom WMF inte är ett flersidigt format.
