...
description: Typen tiff float.
type: docs
weight: 7950
url: /sv/net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/
---
## TiffFloatType class
...
| namn | Beskrivning |
| --- | --- |
| [TiffFloatType](tifffloattype#constructor)(TiffTags) | Initierar en ny instans av[`TiffFloatType`](../tifffloattype) class. |
| [TiffFloatType](tifffloattype#constructor_1)(ushort) | Initierar en ny instans av[`TiffFloatType`](../tifffloattype) class. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/elementsize) { get; } | Hämtar elementstorleken i byte. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/tagtype) { get; } | Hämtar taggtypen. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/value) { get; set; } | Hämtar eller ställer in värdet som denna datatyp innehåller. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/values) { get; set; } | Hämtar eller ställer in värdena. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/valuescontainer) { get; } | Hämtar värdebehållaren. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/writeadditionaldata)(TiffStreamWriter) | Skriver ytterligare taggdata. |
