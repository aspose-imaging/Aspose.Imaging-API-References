...
type: docs
weight: 8020
url: /sv/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
...
| namn | Beskrivning |
| --- | --- |
| [TiffSShortType](tiffsshorttype#constructor)(TiffTags) | Initierar en ny instans av[`TiffSShortType`](../tiffsshorttype) class. |
| [TiffSShortType](tiffsshorttype#constructor_1)(ushort) | Initierar en ny instans av[`TiffSShortType`](../tiffsshorttype) class. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/elementsize) { get; } | Hämtar elementstorleken i byte. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/tagtype) { get; } | Hämtar taggtypen. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/value) { get; set; } | Hämtar eller ställer in värdet som denna datatyp innehåller. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/values) { get; set; } | Hämtar eller ställer in värdena. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/valuescontainer) { get; } | Hämtar värdebehållaren. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/writeadditionaldata)(TiffStreamWriter) | Skriver ytterligare taggdata. |
