...
description: Typen tiff-byte.
type: docs
weight: 7920
url: /sv/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/
---
## TiffByteType class
...
| namn | Beskrivning |
| --- | --- |
| [TiffByteType](tiffbytetype#constructor)(TiffTags) | Initierar en ny instans av[`TiffByteType`](../tiffbytetype) class. |
| [TiffByteType](tiffbytetype#constructor_1)(ushort) | Initierar en ny instans av[`TiffByteType`](../tiffbytetype) class. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/elementsize) { get; } | Hämtar elementstorleken i byte. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/tagtype) { get; } | Hämtar taggtypen. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/value) { get; set; } | Hämtar eller ställer in värdet som denna datatyp innehåller. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/values) { get; set; } | Hämtar eller ställer in värdena. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/valuescontainer) { get; } | Hämtar värdebehållaren. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/writeadditionaldata)(TiffStreamWriter) | Skriver ytterligare taggdata. |
