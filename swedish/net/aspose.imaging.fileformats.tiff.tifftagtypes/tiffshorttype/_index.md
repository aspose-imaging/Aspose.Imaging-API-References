...
type: docs
weight: 8030
url: /sv/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/
---
## TiffShortType class
...
| namn | Beskrivning |
| --- | --- |
| [TiffShortType](tiffshorttype#constructor)(TiffTags) | Initierar en ny instans av[`TiffShortType`](../tiffshorttype) class. |
| [TiffShortType](tiffshorttype#constructor_1)(ushort) | Initierar en ny instans av[`TiffShortType`](../tiffshorttype) class. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/elementsize) { get; } | Hämtar elementstorleken i byte. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/tagtype) { get; } | Hämtar taggtypen. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/value) { get; set; } | Hämtar eller ställer in värdet som denna datatyp innehåller. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/values) { get; set; } | Hämtar eller ställer in data. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/valuescontainer) { get; } | Hämtar värdebehållaren. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/writeadditionaldata)(TiffStreamWriter) | Skriver ytterligare taggdata. |
