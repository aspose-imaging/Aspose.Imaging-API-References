...
description: Den tiff långa typen.
type: docs
weight: 7970
url: /sv/net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
## TiffLongType class

Den tiff långa typen.
...
| namn | Beskrivning |
| --- | --- |
| [TiffLongType](tifflongtype#constructor)(TiffTags) | Initierar en ny instans av[`TiffLongType`](../tifflongtype) class. |
| [TiffLongType](tifflongtype#constructor_1)(ushort) | Initierar en ny instans av[`TiffLongType`](../tifflongtype) class. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/elementsize) { get; } | Hämtar elementstorleken i byte. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/tagtype) { get; } | Hämtar taggtypen. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/value) { get; set; } | Hämtar eller ställer in värdet som denna datatyp innehåller. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/values) { get; set; } | Hämtar eller ställer in värdena. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/valuescontainer) { get; } | Hämtar värdebehållaren. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/writeadditionaldata)(TiffStreamWriter) | Skriver ytterligare taggdata. |
