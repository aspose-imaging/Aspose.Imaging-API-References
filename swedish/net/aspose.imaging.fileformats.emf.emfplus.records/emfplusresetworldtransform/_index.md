...
description: EmfPlusResetWorldTransform-posten återställer den aktuella världsrymdtransformen till identifieringsmatrisen.
type: docs
weight: 6220
url: /sv/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/
---
## EmfPlusResetWorldTransform class

EmfPlusResetWorldTransform-posten återställer den aktuella världsrymdtransformen till identifieringsmatrisen.
...
| namn | Beskrivning |
| --- | --- |
| [EmfPlusResetWorldTransform](emfplusresetworldtransform)(EmfPlusRecord) | Initierar en ny instans av[`EmfPlusResetWorldTransform`](../emfplusresetworldtransform) class. |
