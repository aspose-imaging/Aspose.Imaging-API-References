...
description: EmfPlusSetCompositingMode-posten anger hur källfärger kombineras med bakgrundsfärger.
type: docs
weight: 6320
url: /sv/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingmode/
---
## EmfPlusSetCompositingMode class

EmfPlusSetCompositingMode-posten anger hur källfärger kombineras med bakgrundsfärger.
...
| namn | Beskrivning |
| --- | --- |
| [EmfPlusSetCompositingMode](emfplussetcompositingmode)(EmfPlusRecord) | Initierar en ny instans av[`EmfPlusSetCompositingMode`](../emfplussetcompositingmode) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [CompositingMode](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingmode/compositingmode) { get; set; } | Hämtar eller ställer in kompositlägesvärdet från CompositingMode uppräkningen (avsnitt 2.1.1.5). Sammansättning kan uttryckas som tillståndet för alpha blandning, som antingen kan vara på eller av. |
