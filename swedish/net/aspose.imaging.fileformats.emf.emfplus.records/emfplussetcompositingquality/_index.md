...
description: EmfPlusSetCompositingQuality-posten anger önskad kvalitetsnivå för att skapa sammansatta bilder från flera objekt.
type: docs
weight: 6330
url: /sv/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/
---
## EmfPlusSetCompositingQuality class

EmfPlusSetCompositingQuality-posten anger önskad kvalitetsnivå för att skapa sammansatta bilder från flera objekt.
...
| namn | Beskrivning |
| --- | --- |
| [EmfPlusSetCompositingQuality](emfplussetcompositingquality)(EmfPlusRecord) | Initierar en ny instans av[`EmfPlusSetCompositingQuality`](../emfplussetcompositingquality) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [CompositingQuality](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/compositingquality) { get; set; } | Hämtar eller ställer in kompositkvaliteten. |
