...
description: EmfPlusSetClipRect-posten kombinerar det aktuella klippområdet med en rektangel.
type: docs
weight: 6300
url: /sv/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/
---
## EmfPlusSetClipRect class

EmfPlusSetClipRect-posten kombinerar det aktuella klippområdet med en rektangel.
...
| namn | Beskrivning |
| --- | --- |
| [EmfPlusSetClipRect](emfplussetcliprect)(EmfPlusRecord) | Initierar en ny instans av[`EmfPlusSetClipRect`](../emfplussetcliprect) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [ClipRect](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/cliprect) { get; set; } | Hämtar eller ställer in ett EmfPlusRectF-objekt (avsnitt 2.2.2.39) som definierar rektangeln som används i CombineMode-operationen. |
| [Cm](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/cm) { get; set; } | Hämtar eller ställer in CM (4 bitar): Anger den logiska operationen för att kombinera två regioner. Se CombineMode-uppräkningen (avsnitt 2.1.1.4) för betydelsen av värdena. |
