...
type: docs
weight: 6630
url: /sv/net/aspose.imaging.fileformats.gif.blocks/gifframeblock/
---
## GifFrameBlock class
...
| namn | Beskrivning |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | Initierar en ny instans av[`GifFrameBlock`](../gifframeblock) class. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/backgroundcolor) { get; set; } | Hämtar eller ställer in ett värde för bakgrundsfärgen. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel) { get; } | Hämtar bildbitar per pixelantal. |
...
| [ControlBlock](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/controlblock) { get; } | Hämtar grafikkontrollblocket som är kopplat till detta block. |
| [DataStreamContainer](../../aspose.imaging/datastreamsupporter/datastreamcontainer) { get; } | Hämtar objektets dataström. |
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod) { get; } | Hämtar bortskaffningsmetoden. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Får ett värde som indikerar om denna instans är bortskaffad. |
| override [FileFormat](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/fileformat) { get; } | Får värdet filformat |
| [Flags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/flags) { get; set; } | Hämtar eller sätter flaggorna. |
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft) { get; } | Får vänster. |
| [FrameTime](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametime) { get; set; } | Hämtar eller ställer in varaktigheten. |
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop) { get; } | Konverterar till p. |
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel) { get; set; } | Hämtar eller ställer in GIF-bildbitarna per pixel. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor) { get; set; } | Får ett värde som indikerar om ramblocket har transparent färg. |
| override [Height](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/height) { get; } | Hämtar bildhöjden. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | Hämtar eller ställer in ett värde som indikerar om detta[`GifFrameBlock`](../gifframeblock) är sammanflätad. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | Får ett värde som indikerar om denna bildinstans är sammanflätad. |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted) { get; set; } | Hämtar eller ställer in ett värde som anger om färgpaletten är sorterad. |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left) { get; set; } | Hämtar eller ställer in den vänstra bildplatsen. |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top) { get; set; } | Hämtar eller ställer in den översta bildens plats. |
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor) { get; set; } | Får den genomskinliga färgen på ramblocket. |
...
| override [Width](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/width) { get; } | Hämtar bildens bredd. |
...
| namn | Beskrivning |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/adjustbrightness)(int) | Justera en ljusstyrka för bilden. |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor#replacecolor_1)(int, byte, int) | Ersätter en färg mot en annan med tillåten skillnad och bevarar det ursprungliga alfavärdet för att spara jämna kanter. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors#replacenontransparentcolors_1)(int) | Ersätter alla icke-transparenta färger med ny färg och bevarar det ursprungliga alfavärdet för att spara jämna kanter. Obs: om du använder det på bilder utan genomskinlighet kommer alla färger att ersättas med en enda. |
...
| static [CreateFlags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/createflags)(IColorPalette, bool, bool) | Skapar flaggorna. |
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette)(IColorPalette, IColorPalette) | Får tillhörande färgpalett. |
...
| const [ImageDescriptorSize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/imagedescriptorsize) | Bildbeskrivningens storlek. |
