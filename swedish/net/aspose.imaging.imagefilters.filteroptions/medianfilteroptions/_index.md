...
type: docs
weight: 9790
url: /sv/net/aspose.imaging.imagefilters.filteroptions/medianfilteroptions/
---
...
| namn | Beskrivning |
| --- | --- |
| [MedianFilterOptions](medianfilteroptions)(int) | Initierar en ny instans av[`MedianFilterOptions`](../medianfilteroptions) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Size](../../aspose.imaging.imagefilters.filteroptions/medianfilteroptions/size) { get; set; } | Hämtar eller ställer in storleken. |
