...
description: Utför den första grovsönderdelningsoperationen
type: docs
weight: 10
url: /sv/net/aspose.imaging.masking/imaskingsession/decompose/
---
## IMaskingSession.Decompose method

Utför den första grovsönderdelningsoperationen
