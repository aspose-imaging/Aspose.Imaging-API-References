...
description: Ladda sessionen från den angivna strömmen.
type: docs
weight: 50
url: /sv/net/aspose.imaging.masking/imagemasking/loadsession/
---
## LoadSession(Stream) {#loadsession}

Ladda sessionen från den angivna strömmen.
...
Ladda sessionen från den angivna filen.
