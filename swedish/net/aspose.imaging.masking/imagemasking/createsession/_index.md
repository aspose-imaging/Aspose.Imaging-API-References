...
description: Skapar maskeringssessionen som kan utföra omträningsoperationer.
type: docs
weight: 20
url: /sv/net/aspose.imaging.masking/imagemasking/createsession/
---
## ImageMasking.CreateSession method

Skapar maskeringssessionen som kan utföra omträningsoperationer.
...
| --- | --- | --- |
| options | MaskingOptions | Alternativen. |

### Returvärde

maskeringssessionen som kan utföra omskolningsoperationer.
