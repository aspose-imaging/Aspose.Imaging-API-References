...
description: Initierar en ny instans avImageMaskingaspose.imaging.masking/imagemasking class.
type: docs
weight: 10
url: /sv/net/aspose.imaging.masking/imagemasking/imagemasking/
---
## ImageMasking constructor

Initierar en ny instans av[`ImageMasking`](../../imagemasking) class.
...
| --- | --- | --- |
| sourceImage | RasterImage | Källbilden. |

### Undantag

| undantag | skick |
| --- | --- |
| ArgumentNullException | källbilden är null. |
