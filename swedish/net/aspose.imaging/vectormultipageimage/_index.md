...
description: Vector flersidig bild
type: docs
weight: 11220
url: /sv/net/aspose.imaging/vectormultipageimage/
---
## VectorMultipageImage class

Vector flersidig bild
...
| override [BitsPerPixel](../../aspose.imaging/vectormultipageimage/bitsperpixel) { get; } | Hämtar bildbitar per pixelantal. |
...
| override [IsCached](../../aspose.imaging/vectormultipageimage/iscached) { get; } | Får ett värde som indikerar om objektets data är cachad för närvarande och ingen dataläsning krävs. |
| abstract [PageCount](../../aspose.imaging/vectormultipageimage/pagecount) { get; } | Hämtar sidantal. |
...
| namn | Beskrivning |
| --- | --- |
| override [CacheData](../../aspose.imaging/vectormultipageimage/cachedata)() | Cachelagrar data och säkerställer att ingen ytterligare dataladdning kommer att utföras från den underliggande [`DataStreamContainer`](../datastreamsupporter/datastreamcontainer) . |
...
| override [Resize](../../aspose.imaging/vectormultipageimage/resize#resize_1)(int, int, ImageResizeSettings) | Ändrar storlek på bilden. |
| override [Resize](../../aspose.imaging/vectormultipageimage/resize#resize_2)(int, int, ResizeType) | Ändrar storlek på bilden. |
...
| override [RotateFlip](../../aspose.imaging/vectormultipageimage/rotateflip)(RotateFlipType) | Roterar, vänder eller roterar och vänder bilden. |
