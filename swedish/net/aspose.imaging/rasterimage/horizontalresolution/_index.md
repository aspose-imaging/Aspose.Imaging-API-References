...
type: docs
weight: 30
url: /sv/net/aspose.imaging/rasterimage/horizontalresolution/
---
## RasterImage.HorizontalResolution property

Hämtar eller ställer in den horisontella upplösningen, i pixlar per tum, för detta[`RasterImage`](../../rasterimage) .
