...
description: Hämtar eller ställer in borstens opacitet. Värdet ska vara mellan 0 och 1. Värdet 0 betyder att borsten är helt synlig värdet 1 betyder att borsten är helt ogenomskinlig.
type: docs
weight: 10
url: /sv/net/aspose.imaging/brush/opacity/
---
## Brush.Opacity property

Hämtar eller ställer in borstens opacitet. Värdet ska vara mellan 0 och 1. Värdet 0 betyder att borsten är helt synlig, värdet 1 betyder att borsten är helt ogenomskinlig.
