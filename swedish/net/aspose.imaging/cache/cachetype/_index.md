...
description: Hämtar eller ställer in cacheschemat som används.
type: docs
weight: 40
url: /sv/net/aspose.imaging/cache/cachetype/
---
## Cache.CacheType property

Hämtar eller ställer in cacheschemat som används.
