...
description: Hämtar eller ställer in maximalt tillgängligt minne för cache i minnet. Det angivna värdet är megabyte count.
type: docs
weight: 70
url: /sv/net/aspose.imaging/cache/maxmemoryforcache/
---
## Cache.MaxMemoryForCache property

Hämtar eller ställer in maximalt tillgängligt minne för cache i minnet. Det angivna värdet är megabyte count.
