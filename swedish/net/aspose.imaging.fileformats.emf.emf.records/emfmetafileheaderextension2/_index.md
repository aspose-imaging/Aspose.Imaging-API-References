...
description: EmfMetafileHeaderExtension2-posten är rubrikposten som används i det andra tillägget till EMF metafiler. Efter fältet EmfHeaderExtension2 är de återstående fälten valfria och kan finnas i valfri ordning.
type: docs
weight: 3830
url: /sv/net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/
---
## EmfMetafileHeaderExtension2 class

EmfMetafileHeaderExtension2-posten är rubrikposten som används i det andra tillägget till EMF metafiler. Efter fältet EmfHeaderExtension2 är de återstående fälten valfria och kan finnas i valfri ordning.
...
| namn | Beskrivning |
| --- | --- |
| [EmfMetafileHeaderExtension2](emfmetafileheaderextension2#constructor)(EmfMetafileHeaderExtension1) | Initierar en ny instans av[`EmfMetafileHeaderExtension2`](../emfmetafileheaderextension2) class. |
| [EmfMetafileHeaderExtension2](emfmetafileheaderextension2#constructor_1)(EmfMetafileHeaderExtension2) | Initierar en ny instans av[`EmfMetafileHeaderExtension2`](../emfmetafileheaderextension2) class. |
...
| [EmfHeaderExtension2](../../aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/emfheaderextension2) { get; set; } | Hämtar eller ställer in ett HeaderExtension2-objekt, som anger ytterligare information om bilden i metafilen |
