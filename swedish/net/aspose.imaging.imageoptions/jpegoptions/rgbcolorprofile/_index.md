...
description: Mål RGB-färgprofilen för CMYK jpeg-bilder. Använd för att spara bilder. Måste vara i par med CMYKColorProfile för korrekt färgkonvertering.
type: docs
weight: 170
url: /sv/net/aspose.imaging.imageoptions/jpegoptions/rgbcolorprofile/
---
## JpegOptions.RgbColorProfile property

Mål RGB-färgprofilen för CMYK jpeg-bilder. Använd för att spara bilder. Måste vara i par med CMYKColorProfile för korrekt färgkonvertering.
