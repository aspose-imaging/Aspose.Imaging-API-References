...
description: Hämtar eller ställer in ett värde som indikerar om dettaPngOptionsaspose.imaging.imageoptions/pngoptions är progressiv.
type: docs
weight: 60
url: /sv/net/aspose.imaging.imageoptions/pngoptions/progressive/
---
## PngOptions.Progressive property

Hämtar eller ställer in ett värde som indikerar om detta[`PngOptions`](../../pngoptions) är progressiv.
...
`Sann` om progressiv; annat,`falsk` .
