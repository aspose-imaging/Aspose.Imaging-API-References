...
description: Wmf-alternativen.
type: docs
weight: 10290
url: /sv/net/aspose.imaging.imageoptions/wmfoptions/
---
## WmfOptions class
...
Följande exempel visar hur man konverterar en flersidig vektorbild till WMF-format på ett allmänt sätt utan att referera till en viss bildtyp.
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    ...
    // Exportera endast de två första sidorna. Faktum är att bara en sida kommer att konverteras eftersom WMF inte är ett flersidigt format.
