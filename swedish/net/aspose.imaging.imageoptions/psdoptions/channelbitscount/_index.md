...
description: Hämtar eller ställer in antalet bitar per färgkanal.
type: docs
weight: 20
url: /sv/net/aspose.imaging.imageoptions/psdoptions/channelbitscount/
---
## PsdOptions.ChannelBitsCount property

Hämtar eller ställer in antalet bitar per färgkanal.
