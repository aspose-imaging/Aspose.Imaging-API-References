...
description: Representerar enBrush../aspose.imaging/brush med gradientfunktioner och lämpliga egenskaper.
type: docs
weight: 160
url: /sv/net/aspose.imaging.brushes/lineargradientbrushbase/
---
## LinearGradientBrushBase class

Representerar en[`Brush`](../../aspose.imaging/brush) med gradientfunktioner och lämpliga egenskaper.
...
| [IsAngleScalable](../../aspose.imaging.brushes/lineargradientbrushbase/isanglescalable) { get; set; } | Hämtar eller ställer in ett värde som anger om[`Angle`](./angle) ändras vid omvandlingar med detta[`LinearGradientBrushBase`](../lineargradientbrushbase) . |
