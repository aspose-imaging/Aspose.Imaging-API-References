...
description: Bilden av CMX page
type: docs
weight: 1910
url: /sv/net/aspose.imaging.fileformats.cmx/cmximagepage/
---
## CmxImagePage class
...
| namn | Beskrivning |
| --- | --- |
| [CmxImagePage](cmximagepage)(CmxPage) | Initierar en ny instans av[`CmxImagePage`](../cmximagepage) class. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cmx/cmximagepage/bitsperpixel) { get; } | Hämtar bildbitar per pixelantal. |
...
| [CmxPage](../../aspose.imaging.fileformats.cmx/cmximagepage/cmxpage) { get; } | Hämtar CMX-sidan. |
...
| override [FileFormat](../../aspose.imaging.fileformats.cmx/cmximagepage/fileformat) { get; } | Får värdet filformat |
...
| override [HeightF](../../aspose.imaging.fileformats.cmx/cmximagepage/heightf) { get; } | Hämtar objektets höjd, i tum. |
| [InterruptMonitor](../../aspose.imaging/image/interruptmonitor) { get; set; } | Hämtar eller ställer in avbrottsmonitorn. |
| override [IsCached](../../aspose.imaging.fileformats.cmx/cmximagepage/iscached) { get; } | Får ett värde som indikerar om objektets data är cachad för närvarande och ingen dataläsning krävs. |
...
| override [WidthF](../../aspose.imaging.fileformats.cmx/cmximagepage/widthf) { get; } | Hämtar objektets bredd, i tum. |

## Metoder

| namn | Beskrivning |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cmx/cmximagepage/cachedata)() | Cache kan inte användas. |
...
| override [Resize](../../aspose.imaging.fileformats.cmx/cmximagepage/resize#resize_1)(int, int, ImageResizeSettings) | Ändrar storlek på bilden. |
| override [Resize](../../aspose.imaging.fileformats.cmx/cmximagepage/resize#resize_2)(int, int, ResizeType) | Ändrar storlek på bilden. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cmx/cmximagepage/rotateflip)(RotateFlipType) | Roterar, vänder eller roterar och vänder bilden. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cmx/cmximagepage/setpalette)(IColorPalette, bool) | Ställer in bildpaletten. |
