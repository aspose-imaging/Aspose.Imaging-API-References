...
description: Uppräkning av de upptäckta objekttyperna.
type: docs
weight: 10470
url: /sv/net/aspose.imaging.masking.options/detectedobjecttype/
---
## DetectedObjectType enumeration

Uppräkning av de upptäckta objekttyperna.
...
| --- | --- | --- |
| Human | `0` | Den mänskliga objekttypen. |
| Other | `1` | Annan objekttyp. |
