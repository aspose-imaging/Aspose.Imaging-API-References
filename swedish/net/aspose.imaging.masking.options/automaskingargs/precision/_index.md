...
description: Hämtar eller ställer in precisionen för segmenteringsmetoden valfritt.
type: docs
weight: 70
url: /sv/net/aspose.imaging.masking.options/automaskingargs/precision/
---
## AutoMaskingArgs.Precision property

Hämtar eller ställer in precisionen för segmenteringsmetoden (valfritt).
...
Precisionsmetoden för segmentering (valfritt).
