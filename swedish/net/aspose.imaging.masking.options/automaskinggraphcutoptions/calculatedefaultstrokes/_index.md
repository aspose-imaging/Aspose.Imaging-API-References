...
description: Hämtar eller ställer in ett värde som indikerar om standardlinjer ska beräknas.
type: docs
weight: 30
url: /sv/net/aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes/
---
## AutoMaskingGraphCutOptions.CalculateDefaultStrokes property

Hämtar eller ställer in ett värde som indikerar om standardlinjer ska beräknas.
