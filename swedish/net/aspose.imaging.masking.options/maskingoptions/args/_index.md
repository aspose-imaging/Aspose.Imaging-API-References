...
description: Hämtar eller ställer in argumenten för segmenteringsalgoritmen.
type: docs
weight: 20
url: /sv/net/aspose.imaging.masking.options/maskingoptions/args/
---
## MaskingOptions.Args property

Hämtar eller ställer in argumenten för segmenteringsalgoritmen.
...
Argumenten för segmenteringsalgoritm.
