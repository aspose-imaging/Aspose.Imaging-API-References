...
description: Hämtar eller ställer in alternativ för bildexport.
type: docs
weight: 50
url: /sv/net/aspose.imaging.masking.options/maskingoptions/exportoptions/
---
## MaskingOptions.ExportOptions property

Hämtar eller ställer in alternativ för bildexport.
...
Bildexportalternativen som kommer att användas för att skapa de resulterande bilderna.
