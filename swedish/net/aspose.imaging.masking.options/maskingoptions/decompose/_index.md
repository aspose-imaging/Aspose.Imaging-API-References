...
description: Hämtar eller ställer in ett värde som indikerar om onödigt att separera varje Shape från mask som individuellt objekt eller som förenat objekt från mask separerat från bakgrund.
type: docs
weight: 40
url: /sv/net/aspose.imaging.masking.options/maskingoptions/decompose/
---
...
`Sann`om sönderdelas; annat,`falsk` .
