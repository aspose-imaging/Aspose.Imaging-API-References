...
description: Hämtar eller ställer in maskeringsområdet.
type: docs
weight: 60
url: /sv/net/aspose.imaging.masking.options/maskingoptions/maskingarea/
---
## MaskingOptions.MaskingArea property

Hämtar eller ställer in maskeringsområdet.
...
Maskeringsområdet som är ett delområde av källbilden. Rectangle.Empty värde betyder fullständigt källbildsområde.
