...
description: Initierar en ny instans avAssumedObjectDataaspose.imaging.masking.options/assumedobjectdata class.
type: docs
weight: 10
url: /sv/net/aspose.imaging.masking.options/assumedobjectdata/assumedobjectdata/
---
## AssumedObjectData() {#constructor}

Initierar en ny instans av[`AssumedObjectData`](../../assumedobjectdata) class.
...
| --- | --- | --- |
| type | DetectedObjectType | Objektets typ. |
| bounds | Rectangle | Objektets gränser. |
