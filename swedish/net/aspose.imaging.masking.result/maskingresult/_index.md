...
description: Bas abstrakt klass som kan ge resultatbild från bildmaskeringssystem.
type: docs
weight: 10540
url: /sv/net/aspose.imaging.masking.result/maskingresult/
---
## MaskingResult class

Bas abstrakt klass som kan ge resultatbild från bildmaskeringssystem.
...
| [Item](../../aspose.imaging.masking.result/maskingresult/item) { get; } | Får[`IMaskingLayer`](../imaskinglayer) vid angivet index. |
| abstract [Layers](../../aspose.imaging.masking.result/maskingresult/layers) { get; } | Hämtar lagren. |
| [Length](../../aspose.imaging.masking.result/maskingresult/length) { get; } | Får längden. |
...
| [GetEnumerator](../../aspose.imaging.masking.result/maskingresult/getenumerator)() | Hämtar enumeratorn. |

## Fält

| namn | Beskrivning |
| --- | --- |
| readonly [MaskingOptions](../../aspose.imaging.masking.result/maskingresult/maskingoptions) | Maskeringsalternativen |
...
* namnutrymme [Aspose.Imaging.Masking.Result](../../aspose.imaging.masking.result)
