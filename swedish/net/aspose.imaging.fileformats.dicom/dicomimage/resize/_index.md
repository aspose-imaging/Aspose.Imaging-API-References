...
type: docs
weight: 260
url: /sv/net/aspose.imaging.fileformats.dicom/dicomimage/resize/
---
...
Det här exemplet läser in en DICOM-bild och ändrar storlek på den med olika storleksändringsmetoder.
...
Det här exemplet läser in en DICOM-bild och ändrar storlek på den med hjälp av olika storleksinställningar.
