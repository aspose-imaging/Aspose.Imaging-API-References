...
description: Klass för att representera Djvu-rasterbild där lokaliserad resultat av någon operation
type: docs
weight: 2460
url: /sv/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

Klass för att representera Djvu-rasterbild där lokaliserad resultat av någon operation
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | Hämtar bildbitar per pixelantal. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | Får höjden. |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | Får längden. |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | Hämtar bredden. |
