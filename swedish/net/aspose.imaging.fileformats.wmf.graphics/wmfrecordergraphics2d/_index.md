...
type: docs
weight: 8370
url: /sv/net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| namn | Beskrivning |
| --- | --- |
| [WmfRecorderGraphics2D](wmfrecordergraphics2d)(Rectangle, int) | Initierar en ny instans av[`WmfRecorderGraphics2D`](../wmfrecordergraphics2d) class. |
...
| [BackgroundMode](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/backgroundmode) { get; set; } | Hämtar eller ställer in bakgrundsläget. |
...
| namn | Beskrivning |
| --- | --- |
| static [FromWmfImage](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/fromwmfimage)(WmfImage) | Hämtar en instans av Wmf-inspelaren för den befintliga Wmf-bilden. |
...
| [EndRecording](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/endrecording)() | Avslutar inspelningen. |
...
* namnutrymme [Aspose.Imaging.FileFormats.Wmf.Graphics](../../aspose.imaging.fileformats.wmf.graphics)
