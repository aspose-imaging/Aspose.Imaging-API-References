...
description: Representerar registret för webp-blocköppnare.
type: docs
weight: 8070
url: /sv/net/aspose.imaging.fileformats.webp/webpframeblock/
---
## WebPFrameBlock class

Representerar registret för webp-blocköppnare.
...
| namn | Beskrivning |
| --- | --- |
| [WebPFrameBlock](webpframeblock#constructor)(RasterImage) | Initierar en ny instans av[`WebPFrameBlock`](../webpframeblock) |
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | Initierar en ny instans av[`WebPFrameBlock`](../webpframeblock) class. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | Hämtar bildbitar per pixelantal. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | Hämtar bortskaffningsmetoden. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Får ett värde som indikerar om denna instans är bortskaffad. |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration) { get; set; } | Hämtar eller ställer in bildrutelängden. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | Får värdet filformat |
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft) { get; } | Får ramen vänster offset. |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime) { get; } | Hämtar bildlängden. |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | Får ramens toppförskjutning. |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | Får ett värde som indikerar om denna instans har alpha. |
...
| override [Height](../../aspose.imaging.fileformats.webp/webpframeblock/height) { get; } | Hämtar bildhöjden. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | Hämtar eller ställer in rampositionen till vänster. |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | Får eller ställer in rampositionen överst. |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width) { get; } | Hämtar bildens bredd. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe)() | Får hela bilden. |
