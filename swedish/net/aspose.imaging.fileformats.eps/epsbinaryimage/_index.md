...
description: Klass för Encapsulated PostScript-format med binär header
type: docs
weight: 6550
url: /sv/net/aspose.imaging.fileformats.eps/epsbinaryimage/
---
## EpsBinaryImage class

Klass för Encapsulated PostScript-format med binär header
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsbinaryimage/epstype) { get; } | Får EPS subtyp value |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/hasrasterpreview) { get; } | Får ett värde som indikerar om denna instans har formatspecifik raster preview |
...
| [TiffPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/tiffpreview) { get; } | Hämtar TIFF-förhandsgranskningen. |
...
| [WmfPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/wmfpreview) { get; } | Hämtar WMF-förhandsvisningen. |
...
| [ConvertToInterchange](../../aspose.imaging.fileformats.eps/epsbinaryimage/converttointerchange)() | Konverterar denna instans till[`EpsInterchangeImage`](../epsinterchangeimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsbinaryimage/op_explicit) | Utför en explicit konvertering från[`EpsInterchangeImage`](../epsinterchangeimage) till[`EpsBinaryImage`](../epsbinaryimage) |
