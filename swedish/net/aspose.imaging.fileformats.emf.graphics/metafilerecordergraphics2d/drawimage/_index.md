...
type: docs
weight: 80
url: /sv/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawimage/
---
...
| location | Point | Platsen för det övre vänstra hörnet av den ritade bilden. |
...
| srcUnit | GraphicsUnit | Måttenheterna som används av parametern srcRect. |

### Undantag

| undantag | skick |
| --- | --- |
| ArgumentOutOfRangeException | srcUnit;Stöd endast Pixel-enhet |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| imageBytes | Byte[] | Bildbytes. |
| destRect | Rectangle | Den dest rect. |
| srcUnit | GraphicsUnit | Källenheten. |
