...
description: Ritar strängen.
type: docs
weight: 160
url: /sv/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawstring/
---
...
| font | Font | Teckensnitt som definierar strängens textformat. |
| color | Color | Textfärgen. |
| x | Int32 | X-koordinaten för det övre vänstra hörnet av den ritade texten. |
| y | Int32 | Y-koordinaten för det övre vänstra hörnet av den ritade texten. |
...
| x | Int32 | X-koordinaten för det övre vänstra hörnet av den ritade texten. |
| y | Int32 | Y-koordinaten för det övre vänstra hörnet av den ritade texten. |
| angle | Single | Vinkeln i grader mellan escapementvektorn och enhetens x-axel. Escapement-vektorn är parallell med baslinjen i en textrad. |
