...
description: Ritar den angivna bilden på den angivna platsen.
type: docs
weight: 40
url: /sv/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawimage/
---
...
| --- | --- | --- |
| image | RasterImage | Den ritade bilden. |
| origin | Point | Platsen för den ritade bilden. |
...
Ritar den angivna bilden av den angivna storleken på den angivna platsen.
...
| image | RasterImage | Den ritade bilden. |
| origin | Point | Platsen för den ritade bilden. |
| size | Size | Önskad storlek på den ritade bilden. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| srcRect | Rectangle | Den del av bildobjektet som ska ritas. |
| destRect | Rectangle | Platsen och storleken på den ritade bilden. Bilden skalas för att passa rektangeln. |
| image | RasterImage | Bilden att rita. |
