...
description: Ritar den kubiska beziern.
type: docs
weight: 30
url: /sv/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawcubicbezier/
---
## SvgGraphics2D.DrawCubicBezier method

Ritar den kubiska beziern.
...
| --- | --- | --- |
| pen | Pen | Pennan som avgör figurens färg, bredd och stil. |
| pt1 | PointF | Kurvans startpunkt. |
| pt2 | PointF | Den första kontrollpunkten för kurvan. |
| pt3 | PointF | Den andra kontrollpunkten för kurvan. |
| pt4 | PointF | Kurvans slutpunkt. |
