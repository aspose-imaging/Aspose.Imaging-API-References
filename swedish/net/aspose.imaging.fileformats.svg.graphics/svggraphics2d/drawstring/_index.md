...
description: Ritar textsträngen.
type: docs
weight: 80
url: /sv/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawstring/
---
...
| --- | --- | --- |
| font | Font | Teckensnittet som används för att återge text. |
| text | String | Unicode-textsträngen. |
| origin | Point | Det övre vänstra hörnet av textkörningen. |
| textColor | Color | Textfärgen. |
