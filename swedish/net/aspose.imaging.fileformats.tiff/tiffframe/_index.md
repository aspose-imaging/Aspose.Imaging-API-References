...
type: docs
weight: 7870
url: /sv/net/aspose.imaging.fileformats.tiff/tiffframe/
---
## TiffFrame class
...
| namn | Beskrivning |
| --- | --- |
| [TiffFrame](tiffframe#constructor_1)(RasterImage) | Initierar en ny instans av[`TiffFrame`](../tiffframe) class. |
| [TiffFrame](tiffframe#constructor_3)(Stream) | Initierar en ny instans av[`TiffFrame`](../tiffframe) class. |
| [TiffFrame](tiffframe#constructor_5)(string) | Initierar en ny instans av[`TiffFrame`](../tiffframe) class. |
| [TiffFrame](tiffframe#constructor_2)(RasterImage, TiffOptions) | Initierar en ny instans av[`TiffFrame`](../tiffframe) class. |
| [TiffFrame](tiffframe#constructor_4)(Stream, TiffOptions) | Initierar en ny instans av[`TiffFrame`](../tiffframe) class. |
| [TiffFrame](tiffframe#constructor_6)(string, TiffOptions) | Initierar en ny instans av[`TiffFrame`](../tiffframe) class. |
| [TiffFrame](tiffframe#constructor)(TiffOptions, int, int) | Initierar en ny instans av[`TiffFrame`](../tiffframe) class. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.tiff/tiffframe/backgroundcolor) { get; set; } | Hämtar eller ställer in ett värde för bakgrundsfärgen. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.tiff/tiffframe/bitsperpixel) { get; } | Hämtar bildbitar per pixelantal. |
...
| [ExifData](../../aspose.imaging.fileformats.tiff/tiffframe/exifdata) { get; set; } | Hämtar eller ställer in EXIF-data från frame. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | Får värdet filformat |
| [FrameOptions](../../aspose.imaging.fileformats.tiff/tiffframe/frameoptions) { get; } | Får fram alternativen för att skapa ramar. |
| override [HasAlpha](../../aspose.imaging.fileformats.tiff/tiffframe/hasalpha) { get; } | Får ett värde som indikerar om denna instans har alpha. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.tiff/tiffframe/hastransparentcolor) { get; set; } | Får ett värde som indikerar om bilden har transparent färg. |
| override [Height](../../aspose.imaging.fileformats.tiff/tiffframe/height) { get; } | Hämtar bildhöjden. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/horizontalresolution) { get; set; } | Hämtar eller ställer in den horisontella upplösningen, i pixlar per tum, för detta[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| [PathResources](../../aspose.imaging.fileformats.tiff/tiffframe/pathresources) { get; set; } | Hämtar eller ställer in sökvägsresurserna. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/verticalresolution) { get; set; } | Hämtar eller ställer in den vertikala upplösningen, i pixlar per tum, för detta[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.tiff/tiffframe/width) { get; } | Hämtar bildens bredd. |
| override [XmpData](../../aspose.imaging.fileformats.tiff/tiffframe/xmpdata) { get; set; } | Hämtar eller ställer in XMP-data från frame. |

## Metoder

| namn | Beskrivning |
| --- | --- |
| static [CopyFrame](../../aspose.imaging.fileformats.tiff/tiffframe/copyframe)(TiffFrame) | Kopierar hela ramen (dubbletter). |
| static [CreateFrameFrom](../../aspose.imaging.fileformats.tiff/tiffframe/createframefrom)(TiffFrame, TiffOptions) | Skapar ramen från specificerad*tiffFrame* använder det angivna*options* . Pixeldata bevaras men konverteras till önskat format. |
...
| [AlignResolutions](../../aspose.imaging.fileformats.tiff/tiffframe/alignresolutions)() | Hjälpmetod för att göra horisontella och vertikala upplösningar lika. |
...
| override [Crop](../../aspose.imaging.fileformats.tiff/tiffframe/crop#crop)(Rectangle) | Beskär bilden. |
...
| override [GetOriginalOptions](../../aspose.imaging.fileformats.tiff/tiffframe/getoriginaloptions)() | Hämtar alternativen baserat på de ursprungliga filinställningarna. Detta kan vara till hjälp för att behålla bitdjupet och andra parametrar i originalbilden oförändrade. Om vi till exempel laddar en svartvit PNG-bild med 1 bit per pixel och sedan spara den med hjälp av [`Save`](../../aspose.imaging/datastreamsupporter/save) metod, kommer den utgående PNG-bilden med 8-bitar per pixel att produceras. För att undvika det och spara PNG-bild med 1-bit per pixel, använd den här metoden för att få motsvarande sparalternativ och skicka dem till[`Save`](../../aspose.imaging/image/save) metod som den andra parametern. |
...
| override [Resize](../../aspose.imaging.fileformats.tiff/tiffframe/resize#resize_2)(int, int, ResizeType) | Ändrar storlek på bilden. |
...
| override [Rotate](../../aspose.imaging.fileformats.tiff/tiffframe/rotate#rotate_1)(float, bool, Color) | Rotera bilden runt mitten. |
