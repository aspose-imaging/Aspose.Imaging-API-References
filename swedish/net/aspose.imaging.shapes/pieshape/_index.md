...
type: docs
weight: 10990
url: /sv/net/aspose.imaging.shapes/pieshape/
---
## PieShape class
...
| namn | Beskrivning |
| --- | --- |
| [PieShape](pieshape#constructor)() | Initierar en ny instans av[`PieShape`](../pieshape) class. |
| [PieShape](pieshape#constructor_1)(RectangleF, float, float) | Initierar en ny instans av[`PieShape`](../pieshape) class. |
...
| override [Segments](../../aspose.imaging.shapes/pieshape/segments) { get; } | Hämtar formsegmenten. |
...
| namn | Beskrivning |
| --- | --- |
| override [GetBounds](../../aspose.imaging.shapes/rectangleprojectedshape/getbounds)(Matrix) | Hämtar objektets gränser. |
| override [GetBounds](../../aspose.imaging.shapes/rectangleprojectedshape/getbounds)(Matrix, Pen) | Hämtar objektets gränser. |
