...
description: Hämtar datumet för fotograferingen.
type: docs
weight: 90
url: /sv/net/aspose.imaging.fileformats.dng.decoder/imageotherparameters/timestamp/
---
## ImageOtherParameters.Timestamp property

Hämtar datumet för fotograferingen.
