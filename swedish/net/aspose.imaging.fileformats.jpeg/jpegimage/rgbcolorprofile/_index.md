...
description: RGB-färgprofilen för CMYK- och YCCK-jpeg-bilder. Måste vara i par med CMYKColorProfile för korrekt färgkonvertering.
type: docs
weight: 150
url: /sv/net/aspose.imaging.fileformats.jpeg/jpegimage/rgbcolorprofile/
---
## JpegImage.RgbColorProfile property

RGB-färgprofilen för CMYK- och YCCK-jpeg-bilder. Måste vara i par med CMYKColorProfile för korrekt färgkonvertering.
