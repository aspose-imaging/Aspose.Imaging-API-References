---
title: "DicomPage‑klass"
type: docs
weight: 40
url: /sv/python-net/aspose.imaging.fileformats.dicom/dicompage/
---
...
| **Name** | **Description** |
| :- | :- |
| [DicomPage(image, index)](#DicomPage_image_index_1) | Initierar en ny instans av klassen [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/). |
| [DicomPage(image, index, load_options)](#DicomPage_image_index_load_options_2) | Initierar en ny instans av klassen [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/). |
## **Properties**
...
| index | int | r | Hämtar indexet för den aktuella sidan. |
...
Initierar en ny instans av klassen [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/).

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| image | [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) | Bilden. |
| index | int | Indexet. |
