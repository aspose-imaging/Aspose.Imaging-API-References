---
title: "SvgImage klass"
type: docs
weight: 40
url: /sv/python-net/aspose.imaging.fileformats.svg/svgimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [SvgImage(path)](#SvgImage_path_1) | Instansierar ett nytt objekt av klassen [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), med hjälp av den <br/>            angivna sökvägen för att hitta och läsa in bilden. Denna konstruktor underlättar <br/>            skapandet av SVG-bildinstanser från externa filer, vilket möjliggör sömlös <br/>            integration i mjukvarusystem och arbetsflöden. |
| [SvgImage(stream)](#SvgImage_stream_2) | Skapar en ny instans av klassen [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), som läser in bilden <br/>            från den angivna strömmen. Denna konstruktor möjliggör direkt inläsning av SVG-<br/>            bilder från strömmar, vilket ökar flexibiliteten och effektiviteten vid hantering av bild-<br/>            resurser i mjukvaruapplikationer. |
| [SvgImage(svg_options, width, height)](#SvgImage_svg_options_width_height_3) | Skapar en ny instans av klassen [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) med angivna SVG-<br/>            alternativ, bildens bredd- och höjdpunktsparametrar. Denna konstruktor möjliggör <br/>            för utvecklare att initiera SVG-bilder med anpassade alternativ och dimensioner, <br/>            vilket ger flexibilitet i hantering av SVG-innehåll och layout. |
| [SvgImage(width, height)](#SvgImage_width_height_4) | Instansierar ett nytt [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/)-objekt med angiven bredd och <br/>            höjd. Denna konstruktor låter utvecklare skapa SVG-bilder med fördefinierade <br/>            dimensioner, vilket underlättar exakt kontroll över bildens storlek under <br/>            initiering. |
## **Properties**
...
| bits_per_pixel | int | r | Hämtar antalet bitar per pixel för bilden. Det är viktigt att notera att <br/>            denna parameter inte gäller för vektorbilder, eftersom de inte mäts i <br/>            pixlar. Denna egenskap ger viktig information om bildens färgdjup, <br/>            vilket underlättar bearbetnings- och manipuleringsuppgifter. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Hämtar bildens filformat och tillhandahåller väsentlig metadata för <br/>            bearbetning och kompatibilitetskontroller. Denna egenskap är avgörande för <br/>            att bestämma lämpliga avkodnings- och kodningsstrategier för att hantera <br/>            bilddata effektivt över olika system och applikationer. |
...
| is_cached | bool | r | Hämtar ett booleskt värde som indikerar om objektets data för närvarande <br/>            är cachad, vilket eliminerar behovet av ytterligare läsoperationer. Denna <br/>            egenskap ger insikt i den aktuella cachestatusen och optimerar <br/>            datahämtning och bearbetningsflöden för förbättrad prestanda och effektivitet. |
...
| **Name** | **Description** |
| :- | :- |
| cache_data() | Cacha data och garantera att ingen ytterligare data laddas från <br/>            den underliggande [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). Denna <br/>            optimering förbättrar prestanda genom att eliminera redundanta datahämtningar, <br/>            särskilt fördelaktigt i scenarier som kräver frekvent åtkomst till <br/>            bilddata. |
...
| [create_from_stream(stream)](#create_from_stream_stream_20) | Initierar en ny instans av klassen [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/). |
...
| [load(file_path)](#load_file_path_34) | Läser in en ny bild från den angivna filsökvägen eller URL:en.<br/>            Om _filePath_ är en filsökväg öppnar metoden bara filen.<br/>            Om _filePath_ är en URL laddar metoden ner filen, sparar den som en temporär och öppnar den. |
| [load(file_path, load_options)](#load_file_path_load_options_35) | Läser in en ny bild från den angivna filsökvägen eller URL:en.<br/>            Om _filePath_ är en filsökväg öppnar metoden bara filen.<br/>            Om _filePath_ är en URL laddar metoden ner filen, sparar den som en temporär och öppnar den. |
| [load(stream)](#load_stream_36) | Läser in SVG-sektionen. |
| [load(stream, load_options)](#load_stream_load_options_37) | Läser in en ny bild från den angivna strömmen. |
| [load_stream(stream)](#load_stream_stream_38) | Läser in en ny bild från den angivna strömmen. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_39) | Läser in en ny bild från den angivna strömmen. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_40) | Läser in en ny bild från den angivna filsökvägen eller URL:en.<br/>            Om _filePath_ är en filsökväg öppnar metoden bara filen.<br/>            Om _filePath_ är en URL laddar metoden ner filen, sparar den som en temporär och öppnar den. |
| remove_background() | Tar bort bakgrunden. |
| [remove_background(settings)](#remove_background_settings_41) | Tar bort bakgrunden. |
| remove_metadata() | Tar bort metadata. |
| [resize(new_width, new_height)](#resize_new_width_new_height_42) | Ändrar bildens storlek. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_43) | Ändra storleken på bilden så att den passar de angivna dimensionerna samtidigt som bildförhållandet <br/>            bevaras. Denna metod erbjuder ett bekvämt sätt att justera bildens storlek <br/>            utan att förvränga dess proportioner, vilket säkerställer optimal visning eller lagring <br/>            enligt de önskade dimensionerna. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_44) | Ändrar bildens storlek med utökade alternativ. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_45) | Ändrar storlek på bilden. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_46) | Ändrar storlek på bilden. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_47) | Ändrar höjden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_48) | Ändrar höjden proportionellt. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_49) | Ändrar höjden proportionellt. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_50) | Ändrar höjden proportionellt. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_51) | Ändrar bredden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_52) | Ändrar bredden proportionellt. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_53) | Ändrar bredden proportionellt. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_54) | Ändrar bredden proportionellt. |
| [rotate(angle)](#rotate_angle_55) | Rotera bilden kring centrum. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_56) | Rotera, vänd eller rotera och vänd bilden. |
| save() | Sparar bilddata till den underliggande strömmen. |
| [save(file_path)](#save_file_path_57) | Sparar bilden till den angivna filsökvägen. |
| [save(file_path, options)](#save_file_path_options_58) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_59) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, over_write)](#save_file_path_over_write_60) | Sparar objektets data till den angivna filsökvägen. |
| [save(stream)](#save_stream_61) | Sparar data. |
| [save(stream, options_base)](#save_stream_options_base_62) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_63) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream(stream)](#save_to_stream_stream_64) | Sparar objektets data till den angivna strömmen. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_65) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_66) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | Applicerar en specificerad palett på bilden, vilket möjliggör anpassning av färg <br/>            scheman för estetiska eller funktionella ändamål. Denna metod ger flexibilitet <br/>            i hanteringen av färgpaletter för att passa olika design- eller applikationskrav. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | Försöker sätta en _metadata_-instans, om detta [Image](/imaging/python-net/aspose.imaging/image/)-instans stödjer och implementerar [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)-instansen. |
...
Instansierar ett nytt objekt av klassen [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), med hjälp av den <br/>            angivna sökvägen för att hitta och läsa in bilden. Denna konstruktor underlättar <br/>            skapandet av SVG-bildinstanser från externa filer, vilket möjliggör sömlös <br/>            integration i mjukvarusystem och arbetsflöden.
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| svg_options | [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/) | SVG-alternativen. |
| width | int | Bildbredd. |
| height | int | Bildhöjd. |
...
Instansierar ett nytt [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/)-objekt med angiven bredd och <br/>            höjd. Denna konstruktor låter utvecklare skapa SVG-bilder med fördefinierade <br/>            dimensioner, vilket underlättar exakt kontroll över bildens storlek under <br/>            initiering.
...
Initierar en ny instans av klassen [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/).
...
Ändra storleken på bilden så att den passar de angivna dimensionerna samtidigt som bildförhållandet <br/>            bevaras. Denna metod erbjuder ett bekvämt sätt att justera bildens storlek <br/>            utan att förvränga dess proportioner, vilket säkerställer optimal visning eller lagring <br/>            enligt de önskade dimensionerna.
...
Applicerar en specificerad palett på bilden, vilket möjliggör anpassning av färg <br/>            scheman för estetiska eller funktionella ändamål. Denna metod ger flexibilitet <br/>            i hanteringen av färgpaletter för att passa olika design- eller applikationskrav.
