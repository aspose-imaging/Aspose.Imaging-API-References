...
type: docs
weight: 10
url: /sv/python-net/aspose.imaging.apsbuilder.dib/dibbitcount/
---

BitCount‑enumerationen specificerar antalet bitar som definierar varje pixel och<br/>                det maximala antalet färger i en enhetsoberoende bitmap (DIB).
