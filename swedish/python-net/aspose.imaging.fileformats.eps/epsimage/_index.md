---
title: "EpsImage-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.imaging.fileformats.eps/epsimage/
---
...
| bits_per_pixel | int | r | Få åtkomst till bildens exakta bitdjup enkelt med denna egenskap. Hämta <br/>            antalet bitar per pixel, vilket ger viktig insikt i bildens färgdjup <br/>            och hjälper till att optimera bearbetningsuppgifter. Idealiskt för applikationer som kräver <br/>            finjusterad kontroll över bildmanipulation och analys. |
| bounding_box | [RectangleF](/imaging/python-net/aspose.imaging/rectanglef/) | r | Genom att komma åt den ursprungliga omgivningsrutan i enhetsoberoende punkter, ger denna egenskap <br/>            viktig geometrisk information om dimensionerna för [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/). <br/>            Genom att hämta dessa data kan användare exakt bedöma bildens storlek och bildförhållande <br/>            vilket underlättar exakt layout och positionering i olika applikationer. |
| bounding_box_px | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Denna egenskap returnerar den ursprungliga omgivningsrutan för [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) <br/>            instansen i pixlar, vilket ger väsentlig geometrisk data för exakt rendering och <br/>            manipulation. Med denna information kan användare säkerställa exakt placering och storlek /// av EPS‑bilder i sina projekt, vilket förbättrar den övergripande visuella presentationen och kvaliteten. |
...
| creation_date | System.DateTime | r | Hämtar skapelsedatumet från EPS Document Structuring Conventions (DSC)-kommentarer <br/>            ger denna egenskap väsentlig metadata som indikerar EPS-filens <br/>            ursprung. Genom att få åtkomst till denna information får användare insikt i filens <br/>            härkomst och kronologi, vilket förbättrar filhantering och organisation. |
| creator | string | r | Denna egenskap ger åtkomst till skaparinformation hämtad från EPS-dokumentets <br/>            struktureringskonventioner (DSC)-kommentarer som finns i EPS-filen. Att förstå <br/>            skapardetaljerna ger insikter i vilken programvara eller verktyg som användes för att generera <br/>            EPS-filen, vilket underlättar bedömning av kompatibilitet över olika plattformar och <br/>            applikationer. |
...
| eps_type | [EpsType](/imaging/python-net/aspose.imaging.fileformats.eps.consts/epstype/) | r | Få åtkomst till och tolka undergruppsvärdet för din EPS-bild, vilket förenklar ditt <br/>            arbetsflöde och förbättrar kompatibilitet över plattformar. Idealiskt för att optimera EPS-<br/>            undergruppshämtning i dina projekt med precision och effektivitet. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Hämtar eller anger Exif-instans. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Få åtkomst till bildens filformat med denna egenskap. Hämta viktig <br/>            information om formatet för din bildfil, vilket underlättar kompatibilitet och <br/>            effektiv bearbetning. Idealiskt för att identifiera formatet på dina bildfiler för <br/>            sömlös integration i dina projekt. |
| has_background_color | bool | r/w | Hämtar eller anger ett värde som indikerar om bilden har bakgrundsfärg. |
| has_raster_preview | bool | r | Upptäck närvaron av en rasterförhandsgranskning enkelt med denna egenskap. Få <br/>            det booleska värdet som indikerar om [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑instansen innehåller en <br/>            rasterförhandsgranskning, vilket ger dina bildbehandlingsuppgifter klarhet och effektivitet. <br/>            Idealiskt för att förenkla arbetsflödesbeslut baserat på närvaro eller frånvaro av <br/>            rasterförhandsgranskningar i EPS-bilder. |
| height | int | r | Hämtar bildens höjd. |
| height_f | float | r | Få åtkomst till bildens höjd med denna egenskap. Hämta bildens höjd enkelt, vilket möjliggör sömlösa layoutjusteringar, beräkning av bildförhållanden och exakt <br/> rendering över olika skärmupplösningar och displaymiljöer. |
...
| is_cached | bool | r | Denna egenskap ger ett bekvämt sätt att kontrollera om objektets data för närvarande är <br/>            cachad, vilket eliminerar behovet av ytterligare dataläsning. Den erbjuder en snabb och <br/>            effektiv metod för att avgöra om den nödvändiga informationen redan är tillgänglig, <br/>            vilket optimerar prestanda och minskar resursbelastning i dataintensiva operationer. |
...
| post_script_version | string | r | Denna egenskap hämtar PostScript-versionen som är associerad med <br/>            [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑instansen. Den ger insikt i den specifika PostScript-<br/>            språkversionen som används i EPS-filen, vilket hjälper till med kompatibilitetsbedömning <br/>            och underlättar sömlös integration med PostScript‑kompatibla miljöer. |
| preview_image_count | int | r | Få åtkomst till antalet förhandsgranskningsbilder som finns tillgängliga enkelt. Denna egenskap låter dig <br/>            enkelt hämta antalet förhandsgranskningsbilder som är kopplade till din fil, <br/>            vilket möjliggör effektiv hantering och navigering av dina bildförhandsgranskningar. Idealiskt för <br/>            att optimera ditt arbetsflöde och organisera dina bildresurser effektivt. |
| preview_images | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Hämta förhandsgranskningsbilderna som är associerade med din fil. Denna egenskap ger <br/>            sömlös åtkomst till samlingen av förhandsgranskningsbilder, så att du effektivt kan <br/>            bläddra och hantera dem efter behov. Idealiskt för snabb förhandsgranskning och val av <br/>            rätt bild för ditt projekt. |
...
| titel | string | r | Denna egenskap hämtar titeln som extraherats från EPS-dokumentets struktureringskonventioner (DSC)-kommentarer som är inbäddade i EPS-filen. Den ger värdefull <br/>            metadata om innehållet i EPS-filen, vilket underlättar dokumentorganisation och <br/>            identifiering i kompatibla programvaruapplikationer. |
| use_palette | bool | r | Hämtar ett värde som indikerar om bildpaletten används. |
| width | int | r | Hämtar bildens bredd. |
| width_f | float | r | Hämta bildens bredd med denna praktiska egenskap. Få bildens bredd enkelt, vilket underlättar precisa layoutberäkningar, skalningsoperationer, <br/>            och dimension‑relaterade uppgifter i din applikation. Idealiskt för att säkerställa korrekt <br/>            rendering och visning av bilder över olika plattformar och enheter. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Hämtar eller anger Xmp-data. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| cache_data() | Denna metod gör ingenting eftersom den aktuella implementeringen av <br/>            [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑klassen inte involverar cachning av data. Även om den kanske inte <br/>            utför någon åtgärd, är förståelsen av detta beteende avgörande för utvecklare som arbetar <br/>            med EPS‑bilder, för att säkerställa effektiv resurshantering och optimal prestanda <br/>            i deras applikationer. |
...
| [get_original_options()](#get_original_options__29) | Hämtar alternativen baserat på de ursprungliga filinställningarna.<br/>            Detta kan vara användbart för att behålla bitdjup och andra parametrar i den ursprungliga bilden oförändrade.<br/>            Till exempel, om vi laddar en svart‑vit PNG‑bild med 1 bit per pixel och sedan sparar den med hjälp av<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/) metoden, kommer en PNG‑bild med 8‑bit per pixel att genereras.<br/>            För att undvika detta och spara PNG‑bilden med 1‑bit per pixel, använd denna metod för att hämta motsvarande sparalternativ och skicka dem<br/>            till [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) metoden som den andra parametern. |
| [get_preview_image(format)](#get_preview_image_format_30) | Hämtar den befintliga förhandsgranskningsbilden i det angivna _formatet_ eller <br/>            returnerar **None** om ingen hittas. Denna metod erbjuder flexibilitet i <br/>            åtkomst till förhandsgranskningsbilder anpassade för specifika format, vilket optimerar kompatibilitet och <br/>            resurshantering i applikationer. |
| [get_preview_images()](#get_preview_images__31) | Kommer åt förhandsgranskningsbilderna som är länkade till [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑instansen, vilket möjliggör <br/>            sömlös hämtning för inspektion eller användning i applikationer. Denna metod <br/>            ger bekväm åtkomst till förhandsgranskningsbilder, vilket förbättrar användarinteraktionen med <br/>            bilddata. |
...
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_34) | Konverterar till aps. |
...
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_48) | Ändrar höjden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_49) | Ändrar höjden proportionellt. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_50) | Ändrar höjden proportionellt. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_51) | Ändrar höjden proportionellt. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_52) | Ändrar bredden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_53) | Ändrar bredden proportionellt. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_54) | Ändrar bredden proportionellt. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_55) | Ändrar bredden proportionellt. |
| [rotate(angle)](#rotate_angle_56) | Rotera bilden kring centrum. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_57) | Rotera, vänd eller rotera och vänd bilden. |
| save() | Sparar bilddata till den underliggande strömmen. |
| [save(file_path)](#save_file_path_58) | Sparar bilden till den angivna filsökvägen. |
| [save(file_path, options)](#save_file_path_options_59) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_60) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, over_write)](#save_file_path_over_write_61) | Sparar objektets data till den angivna filsökvägen. |
| [save(stream)](#save_stream_62) | Sparar data. |
| [save(stream, options_base)](#save_stream_options_base_63) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_64) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream(stream)](#save_to_stream_stream_65) | Sparar objektets data till den angivna strömmen. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_66) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_67) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_68) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_69) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_70) | Anpassa bildpaletter för att uppnå unika färgscheman och förbättra den visuella attraktionskraften. <br/>            Skräddarsy färger för specifika effekter och optimera bildkvaliteten över olika <br/>            plattformar och enheter med lätthet. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_71) | Försöker sätta en _metadata_-instans, om detta [Image](/imaging/python-net/aspose.imaging/image/)-instans stödjer och implementerar [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)-instansen. |
...
Hämtar den befintliga förhandsgranskningsbilden i det angivna _formatet_ eller <br/>            returnerar **None** om ingen hittas. Denna metod erbjuder flexibilitet i <br/>            åtkomst till förhandsgranskningsbilder anpassade för specifika format, vilket optimerar kompatibilitet och <br/>            resurshantering i applikationer.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| format | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | EPS‑förhandsgranskningsbildformatet. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | Den befintliga förhandsgranskningsbilden eller **None**. |
...
| Typ | Beskrivning |
| :- | :- |
| System.Collections.Generic.IEnumerable`1[[Aspose.Imaging.Image]] | Förhandsgranskningsbilderna. |
...
Anpassa bildpaletter för att uppnå unika färgscheman och förbättra den visuella attraktionskraften. <br/>            Skräddarsy färger för specifika effekter och optimera bildkvaliteten över olika <br/>            plattformar och enheter med lätthet.
...
with aspycore.as_of(Image.load("Sample.eps"), EpsImage) as image:
	...
	# Rendera rasterbild med PostScript
...
#Läs in EPS‑bild
with Image.load("AstrixObelix.eps") as image:
	# Ändra storlek på bilden med avancerade storleksinställningar
