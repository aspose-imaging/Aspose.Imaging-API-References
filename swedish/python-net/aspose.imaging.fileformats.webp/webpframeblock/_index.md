---
title: "WebPFrameBlock klass"
type: docs
weight: 20
url: /sv/python-net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| **Name** | **Description** |
| :- | :- |
| [WebPFrameBlock(raster_image)](#WebPFrameBlock_raster_image_1) | <br/><br/>                    Initierar en ny instans av [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>klass.<br/> |
| [WebPFrameBlock(width, height)](#WebPFrameBlock_width_height_2) | Initierar en ny instans av [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/) klass. |
## **Properties**
...
| disposal_method | [AnimationDisposalMethods](/imaging/python-net/aspose.imaging/animationdisposalmethods/) | r/w | Hämtar eller anger borttagningsmetoden. |
| disposed | bool | r | Hämtar ett värde som indikerar om den här instansen är frigjord. |
| duration | int | r/w | Hämtar eller anger ramens varaktighet. |
...
| frame_time | int | r | Hämtar ramens varaktighet. |
| frame_top | int | r | Hämtar ramens övre offset. |
| [has_alpha](#has_alpha1) | bool | r | Hämtar ett värde som indikerar om denna instans har alfa. |
...
| vänster | int | r/w | Hämtar eller anger ramens vänstra position. |
...
| överkant | int | r/w | Hämtar eller anger ramens övre position. |
...
| use_alpha_blending | bool | r/w | Hämtar eller anger värdet som indikerar om den aktuella ramen blandas med föregående rams alfavärden. |
...
<br/><br/>                    Initierar en ny instans av [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>klass.<br/>
...
Initierar en ny instans av [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/) klass.
