---
title: "EmfStretchBlt klass"
type: docs
weight: 1400
url: /sv/python-net/aspose.imaging.fileformats.emf.emf.records/emfstretchblt/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfStretchBlt()](#EmfStretchBlt__1) | Initialiserar en ny instans av klassen [EmfStretchBlt](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfstretchblt/) klass. |
| [EmfStretchBlt(source)](#EmfStretchBlt_source_2) | Initialiserar en ny instans av klassen [EmfStretchBlt](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfstretchblt/) klass. |
## **Properties**
...
| bit_blt_raster_operation | [WmfTernaryRasterOperation](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfternaryrasteroperation/) | r/w | Hämtar eller anger ett 32-bitars osignerat heltal som specificerar rasteroperationskoden <br/>            Denna kod definierar hur färgdata för källrektangeln ska kombineras med <br/>            färgdata för destinationsrektangeln och eventuellt ett penselmönster, för att uppnå den slutgiltiga färgen. |
...
| dest_rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r/w | Hämtar eller anger destinationsrektangeln. |
| storlek | int | r/w | Hämtar eller anger storleken på posten |
| source_bitmap | [WmfDeviceIndependentBitmap](/imaging/python-net/aspose.imaging.fileformats.wmf.objects/wmfdeviceindependentbitmap/) | r/w | Hämtar eller anger en buffert som innehåller källbitmapen, vilken inte behöver vara <br/>            sammanhängande med den fasta delen av EMR_STRETCHBLT-posten. Följaktligen är fält i denna <br/>            buffert som är märkta "UndefinedSpace" valfria och MÅSTE ignoreras. |
| src_rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r/w | Hämtar eller anger källrektangeln. |
...
Initialiserar en ny instans av klassen [EmfStretchBlt](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfstretchblt/) klass.
