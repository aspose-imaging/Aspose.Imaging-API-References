---
title: "CdrImagePage-klass"
type: docs
weight: 210
url: /sv/python-net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
...
| is_cached | bool | r | Hämtar ett värde som indikerar om objektets data för närvarande är cachad och ingen dataavläsning krävs. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Hämtar bildens metadata. |
| page_number | int | r | Hämtar sidnumret. |
...
| parent_image | [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) | r | Hämtar föräldrabilden. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_42) | Ändrar storleken på den angivna nya bredden. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_43) | Ändrar bildens storlek med utökade alternativ. |
