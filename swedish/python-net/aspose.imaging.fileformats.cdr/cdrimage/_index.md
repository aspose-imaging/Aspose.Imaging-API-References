---
title: "CdrImage-klass"
type: docs
weight: 190
url: /sv/python-net/aspose.imaging.fileformats.cdr/cdrimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_1) | Börja arbeta med [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) klassen utan ansträngning genom<br/>            att initiera en ny instans med en ström och loadOptions-parametrar.<br/>            Perfekt för utvecklare som söker ett bekvämt sätt att läsa in CDR-bilder från<br/>            olika datakällor samtidigt som de anpassar inläsningsprocessen efter behov. |
## **Properties**
...
| bits_per_pixel | int | r | Hämta bildens bitdjup utan ansträngning med denna användarvänliga egenskap.<br/>            Perfekt för utvecklare som vill fastställa detaljnivån eller färgdjupet i sina bilder,<br/>            vilket säkerställer korrekt bearbetning och manipulation. |
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Hämta eller uppdatera CDR-dokumentet utan ansträngning med denna intuitiva egenskap.<br/>            Perfekt för utvecklare som vill komma åt eller ändra CDR-dokumentet, vilket ger<br/>            flexibilitet och effektivitet i deras applikationer. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Hämta bildens standardsida enkelt med denna användarvänliga egenskap.<br/>            Perfekt för utvecklare som vill ha snabb åtkomst till bildens huvudsida,<br/>            vilket säkerställer effektiv navigering och hantering. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Hämta bildens filformat utan ansträngning med denna intuitiva egenskap.<br/>            Perfekt för utvecklare som vill fastställa formatet på sina bilder dynamiskt,<br/>            vilket säkerställer kompatibilitet och korrekt bearbetning i deras applikationer. |
...
| is_cached | bool | r | Bestäm utan ansträngning om objektets data för närvarande är cachad,<br/>            vilket eliminerar behovet av dataavläsning. Perfekt för utvecklare som vill<br/>            optimera prestanda genom att effektivt utnyttja cachad data, vilket ger<br/>            snabbare åtkomst till objektinformation. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Hämtar bildens metadata. |
| page_count | int | r | Hämta eller uppdatera det totala sidantalet för bilden utan ansträngning med denna<br/>            intuitiva egenskap. Perfekt för utvecklare som vill hantera flersidiga bilder<br/>            dynamiskt, vilket säkerställer effektiv navigering och manipulation av bildinnehållet. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Hämta bildens sidor sömlöst med denna intuitiva egenskap.<br/>            Perfekt för utvecklare som vill komma åt och manipulera enskilda sidor i<br/>            flersidiga bilder, vilket säkerställer effektiv navigering och bearbetning. |
...
| **Name** | **Description** |
| :- | :- |
| cache_data() | Cacha data utan ansträngning för att förhindra ytterligare laddning från den underliggande källan<br/>            med denna användarvänliga metod. Perfekt för utvecklare som vill optimera prestanda<br/>            genom att förladda data, vilket ger snabbare åtkomst och smidigare drift i deras applikationer.<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
Hämta bildens sidor sömlöst med denna intuitiva egenskap.<br/>            Perfekt för utvecklare som vill komma åt och manipulera enskilda sidor i<br/>            flersidiga bilder, vilket säkerställer effektiv navigering och bearbetning.
...
| update_colors | bool | Om den är inställd på <c>true</c> uppdateras färgerna enligt den nya paletten; annars förblir färg<br/>            indexen oförändrade. Observera att oförändrade index kan krascha bilden vid inläsning om vissa index saknar<br/>            motsvarande palettposter. |
