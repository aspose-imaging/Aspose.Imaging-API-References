---
title: "EmfPlusSetTextRenderingHint-klass"
type: docs
weight: 560
url: /sv/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfPlusSetTextRenderingHint(source)](#EmfPlusSetTextRenderingHint_source_1) | Initierar en ny instans av klassen [EmfPlusSetTextRenderingHint](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/). |
## **Properties**
...
| text_rendering_hint | [EmfPlusTextRenderingHint](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.consts/emfplustextrenderinghint/) | r/w | Hämtar eller anger värdet för textrenderingstips, från<br/>            TextRenderingHint‑enumerationen (avsnitt 2.1.1.32), som specificerar kvaliteten för<br/>            efterföljande textrendering. |
...
Initierar en ny instans av klassen [EmfPlusSetTextRenderingHint](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/).
