---
title: "TiffFrame klass"
type: docs
weight: 170
url: /sv/python-net/aspose.imaging.fileformats.tiff/tiffframe/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffFrame(image)](#TiffFrame_image_1) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(image, options)](#TiffFrame_image_options_2) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(options, width, height)](#TiffFrame_options_width_height_3) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path)](#TiffFrame_path_4) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path, options)](#TiffFrame_path_options_5) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream)](#TiffFrame_stream_6) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream, options)](#TiffFrame_stream_options_7) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
## **Properties**
...
| frame_options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | r | Hämtar alternativ för att skapa ramen. |
...
| [path_resources](#path_resources1) | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Tiff.PathResources.PathResource]] | r/w | Hämtar eller anger sökvägsresurserna. |
...
| align_resolutions() | Hjälpmetod för att göra horisontella och vertikala upplösningar lika. |
...
| [copy_frame(tiff_frame)](#copy_frame_tiff_frame_19) | Kopierar hela ramen (duplicerar). |
| [create(files)](#create_files_20) | Skapar flersidig bild som innehåller de angivna filerna. |
| [create(files, throw_exception_on_load_error)](#create_files_throw_exception_on_load_error_21) | Skapar flersidig bild som innehåller de angivna filerna. |
| [create(image_options, width, height)](#create_image_options_width_height_22) | Skapar en ny bild med de angivna skapandealternativen. |
...
| [create(images)](#create_images_24) | Skapar en ny bild med de angivna bilderna som sidor |
| [create(images, dispose_images)](#create_images_dispose_images_25) | Skapar en ny bild från de angivna bilderna som sidor. |
| [create(multipage_create_options)](#create_multipage_create_options_26) | Skapar de angivna flersidiga skapalternativen. |
| [create_frame_from(tiff_frame, options)](#create_frame_from_tiff_frame_options_27) | Skapar ramen från angivet _tiffFrame_ med de angivna _options_.<br/>            Pixeldatan bevaras men konverteras till önskat format. |
| [create_from_file_with_options(path, options)](#create_from_file_with_options_path_options_28) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_image(image)](#create_from_image_image_31) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_image_with_options(image, options)](#create_from_image_with_options_image_options_32) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_35) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_stream_with_options(stream, options)](#create_from_stream_with_options_stream_options_36) | Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
Initierar en ny instans av klassen [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/).
...
| :- | :- | :- |
| image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Bilden som ska användas för att initiera ramens pixel- och palettdata med. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Alternativen att använda för den nyss skapade ramen. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Rammealternativen. |
| width | int | Bredden. |
| height | int | Höjden. |
...
Hämtar eller anger sökvägsresurserna.
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Tiff-ramen att kopiera. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Den nykopierade tiff-ramen. |
...
Skapar ramen från angivet _tiffFrame_ med de angivna _options_.<br/>            Pixeldatan bevaras men konverteras till önskat format.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Tiff-ramen att skapa från. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | De nya alternativen att använda. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Den nyss skapade ramen. |
