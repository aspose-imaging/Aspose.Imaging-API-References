---
title: "TiffImage klass"
type: docs
weight: 200
url: /sv/python-net/aspose.imaging.fileformats.tiff/tiffimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffImage(frame)](#TiffImage_frame_1) | Initiera ett nytt objekt av klassen [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/), ange <br/>            ramparametern. Denna konstruktor underlättar skapandet av en TiffImage <br/>            instans, vilket gör det möjligt för utvecklare att ange ramen som ska laddas eller bearbetas, <br/>            och effektiviserar hanteringen av Tiff-bilduppgifter i deras applikationer. |
| [TiffImage(frames)](#TiffImage_frames_2) | Skapa en ny instans av klassen [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/), med en lista av <br/>            ramar som parameter. Denna konstruktor möjliggör initieringen av ett TiffImage <br/>            objekt med flera ramar, vilket underlättar effektiv hantering och bearbetning av <br/>            TIFF-bildsekvenser i mjukvaruapplikationer. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Hämta filformatvärdet som är associerat med bilden. Denna egenskap fungerar som <br/>            en kritisk aspekt av hämtning av bildmetadata, vilket möjliggör för mjukvaruapplikationer att <br/>            identifiera och tolka formatet på bilddata effektivt. |
...
| [has_alpha](#has_alpha1) | bool | r | Bestäm om bilden har en alfakanal, vilket ger viktig information <br/>            för renderings- och sammansättningsoperationer. Integrera denna funktion för att optimera <br/>            visuella bearbetningsarbetsflöden, vilket säkerställer korrekt representation och manipulation av <br/>            transparenta element. |
...
| [add_page(page)](#add_page_page_4) | Inkludera en ny sida i den befintliga bilden sömlöst, vilket utökar dess innehåll <br/>            och mångsidighet. Använd denna metod för att förbättra dokumentkomposition och <br/>            hantering, vilket möjliggör effektiv hantering av flersidiga bilder i din applikation. |
...
| [create_with_frame(frame)](#create_with_frame_frame_34) | Initierar en ny instans av klassen [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/). |
| [create_with_frames(frames)](#create_with_frames_frames_35) | Initierar en ny instans av klassen [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/). |
...
Bestäm om bilden har en alfakanal, vilket ger viktig information <br/>            för renderings- och sammansättningsoperationer. Integrera denna funktion för att optimera <br/>            visuella bearbetningsarbetsflöden, vilket säkerställer korrekt representation och manipulation av <br/>            transparenta element.
...
Inkludera en ny sida i den befintliga bilden sömlöst, vilket utökar dess innehåll <br/>            och mångsidighet. Använd denna metod för att förbättra dokumentkomposition och <br/>            hantering, vilket möjliggör effektiv hantering av flersidiga bilder i din applikation.
...
Initierar en ny instans av klassen [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/).
