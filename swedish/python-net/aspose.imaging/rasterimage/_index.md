...
type: docs
weight: 7060
url: /sv/python-net/aspose.imaging/rasterimage/
---
...
| [premultiply_components](#premultiply_components2) | bool | r/w | Hämtar eller anger ett värde som indikerar om bildkomponenterna måste förmultipliceras. |
...
| [raw_data_format](#raw_data_format3) | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Hämtar det råa dataformatet. |
...
| [crop(rectangle)](#crop_rectangle_31) | Beskär den angivna rektangeln. |
...
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_82) | Ändrar bildens storlek med utökade alternativ. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_106) | Sparar pixlarna. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_117) | Försöker sätta en _metadata_-instans, om denna [Image](/imaging/python-net/aspose.imaging/image/) instans stöder och implementerar typen [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
