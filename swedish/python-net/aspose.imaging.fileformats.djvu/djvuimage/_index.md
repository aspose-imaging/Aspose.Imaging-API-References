...
type: docs
weight: 10
url: /sv/python-net/aspose.imaging.fileformats.djvu/djvuimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [DjvuImage(stream)](#DjvuImage_stream_1) | Börja arbeta med DjVu-bilder genom att initiera en ny instans av<br/>            [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) klassen med en Stream-parameter. Perfekt för<br/>            utvecklare som vill ha sömlös integration av DjVu-bildbehandling i<br/>            sina projekt. |
| [DjvuImage(stream, load_options)](#DjvuImage_stream_load_options_2) | Börja arbeta med DjVu-bilder sömlöst med denna konstruktor, som<br/>            initierar en ny [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) klassinstans med en Stream- och<br/>            LoadOptions-parameter. Perfekt för utvecklare som vill ha exakt kontroll över<br/>            DjVu-bildladdningsalternativ samtidigt som de behåller enkelhet och effektivitet. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| active_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r/w | Navigera genom ditt DjVu-dokument genom att komma åt eller ställa in den för närvarande aktiva<br/>            sidan med denna egenskap. Byt sömlöst mellan sidor för att fokusera på specifikt<br/>            innehåll och förbättra din dokumentvisningsupplevelse. |
...
| djvu_pages | [DjvuPage[]](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Hämta snabbt alla sidor som finns i ditt DjVu-dokument med hjälp av denna<br/>            egenskap. Förenkla ditt dokumentbehandlingsflöde genom att enkelt komma åt och<br/>            hantera enskilda sidor i dina DjVu-filer. Förbättra effektiviteten och<br/>            strömlinjeforma dina uppgifter med bekväm sidhämtning. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Hämtar eller anger Exif-instans. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Få filformatinformationen som är kopplad till din DjVu-bildfil. Bestäm snabbt<br/>            formatet på din fil för sömlös integration i ditt arbetsflöde. |
| first_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Kom åt den första sidan i ditt DjVu-dokument med denna egenskap. Hämta snabbt<br/>            den inledande sidan för att börja visa eller bearbeta ditt dokument effektivt. |
| has_alpha | bool | r | Bestäm snabbt om din DjVu-bildfil innehåller en alfakanal.<br/>            Förenkla ditt arbetsflöde genom att kontrollera förekomsten av transparensinformation<br/>            i dina bilder. |
...
| identifierare | int | r | Hämtar det unika identifieraren för dokumentet |
...
| last_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Hämta den sista sidan i ditt DjVu-dokument med denna egenskap. Få snabbt<br/>            åt den sista sidan för visning eller bearbetning med lätthet. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Hämtar eller anger XMP-data från ramen. |
| next_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Navigera genom ditt DjVu-dokument genom att komma åt nästa sida med denna<br/>            praktiska egenskap. Gå snabbt framåt i ditt dokumentvisnings- eller<br/>            bearbetningsarbete. |
| page_count | int | r | Hämta det totala antalet sidor i din DjVu-bildsamling med denna egenskap.<br/>            Perfekt för att snabbt bedöma omfattningen av ditt dokument eller bok lagrad i DjVu-format.<br/>            Förbättra ditt arbetsflödes effektivitet med exakt sidantalinformation. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Kom åt de enskilda sidorna i din DjVu-bildsamling med denna egenskap.<br/>            Förenkla navigering och manipulation av ditt dokument eller bok lagrad i DjVu-format<br/>            genom att direkt komma åt varje sida. Förbättra ditt arbetsflödes effektivitet med enkel<br/>            sidhämtning. |
...
| previous_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Gå snabbt bakåt i ditt DjVu-dokumentvisnings- eller bearbetningsarbete genom<br/>            att komma åt föregående sida med denna praktiska egenskap. Navigera effektivt<br/>            genom ditt dokument med lätthet. |
...
| **Name** | **Description** |
| :- | :- |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_1) | Justera _brightness_ för en bild med en specificerad parameter, <br/>            som ger kontroll över luminansnivåer för optimal visuell klarhet. Denna metod förstärker <br/>            eller minskar den övergripande ljusstyrkan i bilden, vilket möjliggör finjusteringar för <br/>            att uppnå önskade ljuseffekter. Genom att modulera ljusstyrkan kan användare optimera bildens <br/>            synlighet och förbättra detaljåtergivning för en förbättrad visningsupplevelse. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_2) | Förbättra [Image](/imaging/python-net/aspose.imaging/image/) kontrast för att förbättra visuell klarhet och <br/>            framhäva detaljer med denna metod, som justerar skillnaden i ljusstyrka mellan <br/>            ljusa och mörka områden. Genom finjustering av kontrastnivåer kan användare uppnå mer levande och <br/>            slagkraftiga bilder, förbättra den övergripande bildkvaliteten och maximera detaljsynlighet. <br/>            Denna justering hjälper till att framhäva subtila nyanser i färg och textur, vilket resulterar i <br/>            mer dynamiska och visuellt tilltalande bilder. |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_3) | Gamma-korrigering, specifikt för de röda, gröna och blå kanalerna, innebär att justera <br/>            ljusstyrkan för varje färgkomponent separat. Genom att applicera olika gamma-<br/>            koefficienter på RGB-kanalerna kan du finjustera den övergripande ljusstyrkan och kontrasten <br/>            i en bild. Denna teknik säkerställer korrekt färgåtergivning och förbättrar den <br/>            visuella kvaliteten på bilden på olika displayenheter. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_4) | Gamma-korrigering appliceras på en bild med anpassningsbara parametrar för de röda, gröna <br/>            och blå kanalerna, vilket möjliggör exakt justering av färgbalans och ljusstyrka. Denna <br/>            metod förbättrar bildkvaliteten genom finjustering av färgåtergivning, vilket säkerställer optimal <br/>            återgivning på olika displayenheter. Justering av gamma-värden för enskilda <br/>            kanaler förbättrar färgbalansen och den visuella attraktionskraften. |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_7) | Binarisering med Bradleys adaptiva tröskelalgoritm med integralbild<br/>            tröskling är en metod som beräknar ett lokalt tröskelvärde för varje pixel baserat på en <br/>            lokal grannskap. Den anpassar sig till variationer i belysning över bilden, vilket gör den <br/>            lämplig för bilder med ojämna ljusförhållanden. Genom att beräkna tröskeln med <br/>            integralbilder hanteras stora grannskap effektivt, vilket gör den tillämpbar på <br/>            realtidsapplikationer. Denna teknik används ofta i dokumentbehandling, OCR <br/>            (Optical Character Recognition), och bildsegmenteringsuppgifter där exakt <br/>            binarisering är avgörande för efterföljande analys. |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_8) | Binarisering med ett fördefinierat tröskelvärde förenklar komplexa bilder till binära<br/>            representationer, där pixlar kategoriseras som antingen svarta eller vita baserat på deras <br/>            intensitet jämfört med ett angivet tröskelvärde. Denna teknik används ofta i <br/>            bildbehandling för att förbättra tydlighet, förenkla analys och förbereda bilder för vidare <br/>            bearbetningssteg såsom optisk teckenigenkänning (OCR). Genom att tillämpa ett fast <br/>            tröskelvärde kan du snabbt omvandla gråskalebilder till binär form, vilket gör dem <br/>            lättare att tolka och extrahera meningsfull information från. |
| binarize_otsu() | Binarisering med Otsu-tröskling är en teknik som automatiskt beräknar ett<br/>            optimalt tröskelvärde baserat på bildens histogram. Den separerar bilden i <br/>            förgrund och bakgrund genom att minimera intra-klassvariansen. Otsus metod är <br/>            allmänt använd för att segmentera bilder till binär form, särskilt när fördelningen <br/>            av pixelintensiteter är bimodal eller multimodal. Detta tillvägagångssätt är fördelaktigt för uppgifter <br/>            såsom objektdetektion, bildsegmentering och funktionsextraktion, där exakt <br/>            avgränsning mellan förgrund och bakgrund är kritisk. |
...
| cache_data() | Cacha data privat för att optimera prestanda och minska behovet av upprepad data <br/>            hämtning från externa källor. Detta tillvägagångssätt hjälper också till att spara resurser, <br/>            särskilt i scenarier där dataåtkomst är frekvent eller resurser är begränsade. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_30) | Beskärning med förskjutningar låter dig exakt justera positionen och dimensionerna för det<br/>            beskurna området inom en bild. Denna funktion är ovärderlig för att förfina kompositioner,<br/>            alignera element och framhäva fokuspunkter i dina visuella verk. Genom att införliva förskjutningar<br/>            i beskärningsprocessen kan du uppnå pixelperfekt precision och finjustera <br/>            inramningen av dina bilder med lätthet. |
| [crop(rectangle)](#crop_rectangle_31) | "Crop" beskär din bild för att fokusera på specifika detaljer eller ta bort oönskade element,<br/>            vilket förbättrar dess komposition och visuella intryck. Oavsett om du justerar foton för sociala<br/>            medier, skapar webbplatsbanner eller designar tryckt material, hjälper detta verktyg dig<br/>            att förfina dina bilder med precision och klarhet. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_32) | Utför dithering på den aktuella bilden. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_33) | Funktionen "Dither" applicerar en dithereffekt på din bild, vilket förbättrar dess visuella<br/>            kvalitet genom att minska bandning och förbättra färgövergångar. Oavsett om du arbetar<br/>            med digital konst, fotografi eller grafisk design, lägger denna funktion till ett<br/>            professionellt inslag i dina bilder, så att de framstår som mjukare och mer förfinade. |
| [embed_digital_signature(password)](#embed_digital_signature_password_34) | Bädda in digital signatur baserad på angivet lösenord i varje sida av bilden. |
| [filter(rectangle, options)](#filter_rectangle_options_35) | Applicera filter på ett specificerat rektangulärt område inom bilden för att förbättra eller modifiera dess <br/>            utseende. Genom att rikta in sig på specifika regioner möjliggör denna metod precisa justeringar, <br/>            såsom oskärpa, skärpning eller applicering av konstnärliga effekter, för att uppnå önskade visuella <br/>            resultat. Finjustering av filter på valda områden ger användare möjlighet att anpassa bildens <br/>            estetik, förbättra klarhet och skapa konstnärliga effekter skräddarsydda efter deras preferenser. |
...
| grayscale() | Gråskalatransformation konverterar en bild till en svartvit representation, där <br/>            varje pixels intensitet representeras av ett enda värde som sträcker sig från svart till vitt. <br/>            Denna process tar bort färginformation, vilket resulterar i en monokrom bild. Gråskalebilder <br/>            används ofta i applikationer där färg är onödig eller där enkelhet föredras, såsom dokumentskanning, utskrift och vissa typer av bildanalys. |
...
| [load(stream)](#load_stream_57) | Läs in ditt DjVu-dokument med denna metod. Effektivisera din process genom att snabbt<br/>            få åtkomst till och importera dina DjVu-filer i din applikation. |
| [load(stream, load_options)](#load_stream_load_options_58) | Importera ditt DjVu-dokument genom att använda denna metod med stream- och loadOptions<br/>            parametrar. Effektivisera din process genom att snabbt få åtkomst till och importera DjVu-filer<br/>            i din applikation, vilket ger flexibilitet och anpassningsalternativ för att möta<br/>            dina behov. |
...
| [load_document(stream)](#load_document_stream_63) | Läs in ditt DjVu-dokument med denna metod. Effektivisera din process genom att snabbt<br/>            få åtkomst till och importera dina DjVu-filer i din applikation. |
| [load_document(stream, load_options)](#load_document_stream_load_options_64) | Importera ditt DjVu-dokument genom att använda denna metod med stream- och loadOptions<br/>            parametrar. Effektivisera din process genom att snabbt få åtkomst till och importera DjVu-filer<br/>            i din applikation, vilket ger flexibilitet och anpassningsalternativ för att möta<br/>            dina behov. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_65) | Läser in 32-bitars ARGB‑pixlar delvis (i block). |
| [load_partial_argb_64_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_66) | Läser in 64-bitars ARGB‑pixlar delvis i paket. |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_67) | Läser in pixlar delvis i paket. |
| [load_pixels(rectangle)](#load_pixels_rectangle_68) | Läser in pixlar. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_69) | Läser in rådata. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_70) | Läser in rådata. |
| [load_stream(stream)](#load_stream_stream_71) | Läser in en ny bild från den angivna strömmen. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_72) | Läser in en ny bild från den angivna strömmen. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_73) | Läser in en ny bild från den angivna filsökvägen eller URL:en.<br/>            Om _filePath_ är en filsökväg öppnar metoden bara filen.<br/>            Om _filePath_ är en URL laddar metoden ner filen, sparar den som en temporär och öppnar den. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_74) | Normaliserar vinkeln.<br/>            Denna metod är tillämplig på skannade textdokument för att bli av med snedvriden skanning.<br/>            Metoden använder [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) och [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) metoder. |
| normalize_histogram() | Normaliserar bildens histogram — justera pixelvärden för att använda hela tillgängliga intervallet. |
| [read_argb_32_scan_line(scan_line_index)](#read_argb_32_scan_line_scan_line_index_75) | Läser hela skanningsraden enligt det angivna skanningsradindexet. |
| [read_scan_line(scan_line_index)](#read_scan_line_scan_line_index_76) | Läser hela skanningsraden enligt det angivna skanningsradindexet. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_77) | Ersätter en färg med en annan med tillåten skillnad och bevarar det ursprungliga alfa‑värdet för att spara mjuka kanter. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_78) | Ersätter en färg med en annan med tillåten skillnad och bevarar det ursprungliga alfa‑värdet för att spara mjuka kanter. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_79) | Ersätter en färg med en annan med tillåten skillnad och bevarar det ursprungliga alfa‑värdet för att spara mjuka kanter. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_80) | Ersätter alla icke‑transparenta färger med en ny färg och bevarar det ursprungliga alfa‑värdet för att spara mjuka kanter.<br/>                Obs: om du använder den på bilder utan transparens, kommer alla färger att ersättas med en enda. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_81) | Ersätter alla icke‑transparenta färger med en ny färg och bevarar det ursprungliga alfa‑värdet för att spara mjuka kanter.<br/>                Obs: om du använder den på bilder utan transparens, kommer alla färger att ersättas med en enda. |
| [resize(new_width, new_height)](#resize_new_width_new_height_82) | Ändrar bildens storlek. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_83) | Ändra storlek på bilden med `Resize`-metoden, vilket ger ett enkelt och effektivt sätt<br/>            att justera dimensionerna på dina bilder enligt dina krav. Denna<br/>            mångsidiga funktionalitet gör att du enkelt kan skala bilder till önskad storlek,<br/>            vilket förbättrar deras användbarhet på olika plattformar och i applikationer. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_84) | Ändra storlek på bilden till den angivna bredden och höjden samtidigt som du tillämpar ytterligare inställningar <br/>            vid behov. Denna metod gör det möjligt för användare att justera bildens dimensioner samtidigt som <br/>            önskade attribut som bildförhållande, bildkvalitet och komprimeringsinställningar bevaras. Genom att erbjuda flexibilitet i storleksändringsalternativ kan användare anpassa bilden för <br/>            att passa specifika krav och optimera dess utseende för olika applikationer och <br/>            plattformar. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_85) | Ändrar storlek på bilden. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_86) | Ändrar storlek på bilden. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_87) | Ändrar höjden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_88) | Metoden `ResizeHeightProportionally` låter dig justera bildens höjd samtidigt som du bevarar bildförhållandet. Detta säkerställer att din bild behåller sina proportioner, förhindrar förvrängning och bevarar dess visuella integritet.<br/>            Oavsett om du optimerar bilder för webbsidor, mobilappar eller tryckt media, garanterar denna<br/>            metod att dina bilder ser bäst ut på olika plattformar och enheter. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_89) | Ändrar höjden proportionellt. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_90) | Ändrar höjden proportionellt. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_91) | Ändrar bredden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_92) | Metoden `ResizeWidthProportionally` erbjuder en bekväm lösning för att justera bildens<br/>            bredd samtidigt som bildförhållandet bibehålls. Genom att proportionellt ändra bredden kan du säkerställa att dina bilder förblir visuellt tilltalande och<br/>            konsekventa på olika enheter och skärmstorlekar, vilket ökar deras mångsidighet<br/>            och användbarhet i olika sammanhang. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_93) | Ändrar bredden proportionellt. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_94) | Ändrar bredden proportionellt. |
| [rotate(angle)](#rotate_angle_95) | Rotera bilden kring centrum. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_96) | Rotera bilden kring dess centrum med Rotate-metoden i<br/>            RasterCachedMultipageImage-klassen. Denna praktiska funktion låter dig enkelt<br/>            justera bildens orientering samtidigt som dess centrumposition bibehålls,<br/>            vilket förbättrar dina möjligheter att manipulera bilder. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_97) | `RotateFlip`-metoden erbjuder mångsidiga manipuleringsalternativ för din bild, vilket låter dig<br/>            rotera, vända eller utföra båda operationerna på den aktiva ramen oberoende.<br/>            Oavsett om du redigerar foton, skapar grafik eller förbättrar digital konst, ger denna<br/>            metod exakt kontroll över orienteringen och kompositionen av dina bilder,<br/>            så att de uppfyller din kreativa vision med lätthet och effektivitet. |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_98) | Roterar alla flip. |
| save() | Sparar bilddata till den underliggande strömmen. |
| [save(file_path)](#save_file_path_99) | Sparar bilden till den angivna filsökvägen. |
| [save(file_path, options)](#save_file_path_options_100) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_101) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, over_write)](#save_file_path_over_write_102) | Sparar objektets data till den angivna filsökvägen. |
| [save(stream)](#save_stream_103) | Sparar data. |
| [save(stream, options_base)](#save_stream_options_base_104) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_105) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_106) | Sparar de 32‑bitars ARGB‑pixlarna. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_107) | Sparar pixlarna. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_108) | Sparar pixlarna.<br/>            Denna metod är föråldrad. Använd den mer effektiva [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) metoden. |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_109) | Sparar pixlar (formatspecifik metod). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_110) | Sparar rådata. |
| [save_to_stream(stream)](#save_to_stream_stream_111) | Sparar objektets data till den angivna strömmen. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_112) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_113) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_114) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_115) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_116) | Ställer in en bildpixel i 32-bit ARGB för den angivna positionen. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_117) | Ställer in bildpaletten. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_118) | Ställer in en bildpixel för den angivna positionen. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_119) | Ställer in upplösningen för denna [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_120) | Försöker sätta en _metadata_-instans, om detta [Image](/imaging/python-net/aspose.imaging/image/)-instans stödjer och implementerar [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)-instansen. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_121) | Skriver hela skanningsraden till det angivna skanningsradindexet. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_122) | Skriver hela skanningsraden till det angivna skanningsradindexet. |
...
Börja arbeta med DjVu-bilder genom att initiera en ny instans av<br/>            [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) klassen med en Stream-parameter. Perfekt för<br/>            utvecklare som vill ha sömlös integration av DjVu-bildbehandling i<br/>            sina projekt.
...
Kom åt de enskilda sidorna i din DjVu-bildsamling med denna egenskap.<br/>            Förenkla navigering och manipulation av ditt dokument eller bok lagrad i DjVu-format<br/>            genom att direkt komma åt varje sida. Förbättra ditt arbetsflödes effektivitet med enkel<br/>            sidhämtning.
...
Gamma-korrigering, specifikt för de röda, gröna och blå kanalerna, innebär att justera <br/>            ljusstyrkan för varje färgkomponent separat. Genom att applicera olika gamma-<br/>            koefficienter på RGB-kanalerna kan du finjustera den övergripande ljusstyrkan och kontrasten <br/>            i en bild. Denna teknik säkerställer korrekt färgåtergivning och förbättrar den <br/>            visuella kvaliteten på bilden på olika displayenheter.
...
Beskärning med förskjutningar låter dig exakt justera positionen och dimensionerna för det<br/>            beskurna området inom en bild. Denna funktion är ovärderlig för att förfina kompositioner,<br/>            alignera element och framhäva fokuspunkter i dina visuella verk. Genom att införliva förskjutningar<br/>            i beskärningsprocessen kan du uppnå pixelperfekt precision och finjustera <br/>            inramningen av dina bilder med lätthet.
...
"Crop" beskär din bild för att fokusera på specifika detaljer eller ta bort oönskade element,<br/>            vilket förbättrar dess komposition och visuella intryck. Oavsett om du justerar foton för sociala<br/>            medier, skapar webbplatsbanner eller designar tryckt material, hjälper detta verktyg dig<br/>            att förfina dina bilder med precision och klarhet.
...
Applicera filter på ett specificerat rektangulärt område inom bilden för att förbättra eller modifiera dess <br/>            utseende. Genom att rikta in sig på specifika regioner möjliggör denna metod precisa justeringar, <br/>            såsom oskärpa, skärpning eller applicering av konstnärliga effekter, för att uppnå önskade visuella <br/>            resultat. Finjustering av filter på valda områden ger användare möjlighet att anpassa bildens <br/>            estetik, förbättra klarhet och skapa konstnärliga effekter skräddarsydda efter deras preferenser.
...
Läs in ditt DjVu-dokument med denna metod. Effektivisera din process genom att snabbt<br/>            få åtkomst till och importera dina DjVu-filer i din applikation.
...
| Typ | Beskrivning |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | Laddat djvu-dokument |
...
Importera ditt DjVu-dokument genom att använda denna metod med stream- och loadOptions<br/>            parametrar. Effektivisera din process genom att snabbt få åtkomst till och importera DjVu-filer<br/>            i din applikation, vilket ger flexibilitet och anpassningsalternativ för att möta<br/>            dina behov.
...
| Typ | Beskrivning |
| :- | :- |
| [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | Laddat djvu-dokument |
...
Ändra storlek på bilden till den angivna bredden och höjden samtidigt som du tillämpar ytterligare inställningar <br/>            vid behov. Denna metod gör det möjligt för användare att justera bildens dimensioner samtidigt som <br/>            önskade attribut som bildförhållande, bildkvalitet och komprimeringsinställningar bevaras. Genom att erbjuda flexibilitet i storleksändringsalternativ kan användare anpassa bilden för <br/>            att passa specifika krav och optimera dess utseende för olika applikationer och <br/>            plattformar.
...
Metoden `ResizeWidthProportionally` erbjuder en bekväm lösning för att justera bildens<br/>            bredd samtidigt som bildförhållandet bibehålls. Genom att proportionellt ändra bredden kan du säkerställa att dina bilder förblir visuellt tilltalande och<br/>            konsekventa på olika enheter och skärmstorlekar, vilket ökar deras mångsidighet<br/>            och användbarhet i olika sammanhang.
...
Rotera bilden kring dess centrum med Rotate-metoden i<br/>            RasterCachedMultipageImage-klassen. Denna praktiska funktion låter dig enkelt<br/>            justera bildens orientering samtidigt som dess centrumposition bibehålls,<br/>            vilket förbättrar dina möjligheter att manipulera bilder.
...
`RotateFlip`-metoden erbjuder mångsidiga manipuleringsalternativ för din bild, vilket låter dig<br/>            rotera, vända eller utföra båda operationerna på den aktiva ramen oberoende.<br/>            Oavsett om du redigerar foton, skapar grafik eller förbättrar digital konst, ger denna<br/>            metod exakt kontroll över orienteringen och kompositionen av dina bilder,<br/>            så att de uppfyller din kreativa vision med lätthet och effektivitet.
...
dir_: str = "c:\\temp"
# Läs in en DJVU-bild från en filström.
...
# Läs in en DJVU-bild från en filström.
with open(join(dir_, "sample.djvu"), "rb") as stream:
	# Den maximalt tillåtna storleken för alla interna buffertar är 1 MB.
