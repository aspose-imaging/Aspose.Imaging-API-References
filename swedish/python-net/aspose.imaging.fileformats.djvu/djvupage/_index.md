---
title: "DjvuPage klass"
type: docs
weight: 20
url: /sv/python-net/aspose.imaging.fileformats.djvu/djvupage/
---
...
| height | int | r | Hämtar höjden på sidan |
...
| image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r | Hämtar bilden. |
...
| is_color | bool | r | Hämtar ett värde som indikerar om detta objekt är färg. |
...
| parent_image | [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | r | Hämtar föräldrabilden som sidan tillhör |
...
| thumbnail_image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r/w | Hämtar eller anger miniatyrbilden för sidan |
...
| width | int | r | Hämtar bredden på sidan |
...
| [extract_thumbnail_image()](#extract_thumbnail_image__35) | Extraherar miniatyrbilden från Djvu-sidan. |
| [filter(rectangle, options)](#filter_rectangle_options_36) | Filtrerar den angivna rektangeln. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_37) | Hämtar en bildpixel i 32-bitars ARGB. |
| [get_background_image()](#get_background_image__38) | Hämtar bakgrundsbilden. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_49) | Hämtar förgrundsbilden för sidan |
| [get_modify_date(use_default)](#get_modify_date_use_default_50) | Hämtar datum och tid då resursbilden senast ändrades. |
...
| [get_pixel(x, y)](#get_pixel_x_y_52) | Hämtar en bildpixel. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_53) | Hämtar en proportionell höjd. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_54) | Hämtar en proportionell bredd. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_55) | Konverterar till aps. |
| [get_skew_angle()](#get_skew_angle__56) | Hämtar snedvinkeln.<br/>            Denna metod är tillämplig på skannade textdokument för att bestämma snedvinkeln vid skanning. |
| [get_text_for_location(rect)](#get_text_for_location_rect_57) | Hämtar texten för rektangelns position |
| [get_text_image(subsample)](#get_text_image_subsample_58) | Hämtar textbilden. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | Ändrar storlek på sidans bild till de nya dimensionerna |
...
| [save(stream)](#save_stream_105) | Sparar data. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_121) | Ställer in upplösningen för denna [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| Typ | Beskrivning |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Djvu rasterbilden. |
...
Ändrar storlek på sidans bild till de nya dimensionerna
