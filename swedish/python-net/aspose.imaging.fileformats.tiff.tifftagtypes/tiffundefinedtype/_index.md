---
title: "TiffUndefinedType klass"
type: docs
weight: 170
url: /sv/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_1) | Initierar en ny instans av [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) klass. |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_2) | Initierar en ny instans av [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) klass. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| count | int | r | Hämtar antalet element. |
| data | System.Byte | r/w | Hämtar eller anger data. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initierar en ny instans av [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) klass. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initierar en ny instans av [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) klass. |
...
Initierar en ny instans av [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) klass.
