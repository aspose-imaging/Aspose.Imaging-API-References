---
title: "TiffSLong8Type klass"
type: docs
weight: 120
url: /sv/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_1) | Initierar en ny instans av [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) klass. |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_2) | Initierar en ny instans av [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) klass. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| count | int | r | Hämtar antalet element. |
| data_size | int | r | Hämtar storleken på taggvärdet. |
| element_size | System.Byte | r | Hämtar storlek på elementet. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initierar en ny instans av [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) klass. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initierar en ny instans av [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) klass. |
...
Initierar en ny instans av [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) klass.
