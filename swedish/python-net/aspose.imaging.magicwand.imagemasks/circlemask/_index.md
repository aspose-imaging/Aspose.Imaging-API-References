---
title: "CircleMask-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.imaging.magicwand.imagemasks/circlemask/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircleMask(center, radius)](#CircleMask_center_radius_1) | Initierar en ny instans av klassen [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) med den angivna mittpunkten och radien. |
| [CircleMask(x, y, radius)](#CircleMask_x_y_radius_2) | Initierar en ny instans av klassen [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) med den angivna mittpunkten och radien. |
## **Properties**
...
| selection_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Hämtar gränserna, i pixlar, för den här masken. |
...
Initierar en ny instans av klassen [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) med den angivna mittpunkten och radien.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| center | [Point](/imaging/python-net/aspose.imaging/point/) | Mittpunkten för det markerade området. |
| radie | int | Radien för det markerade området. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| x | int | x‑koordinaten för mittpunkten i det markerade området. |
| y | int | y‑koordinaten för mittpunkten i det markerade området. |
| radie | int | Radien för det markerade området. |
...
| Typ | Beskrivning |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | En beskuren CircleMask eller ImageBitMask som ImageMask.<br/>            Eftersom ImageBitMask kan returneras rekommenderas ett fluent‑anrop. |
...
| Typ | Beskrivning |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | En uppblåst CircleMask som ImageMask. |
