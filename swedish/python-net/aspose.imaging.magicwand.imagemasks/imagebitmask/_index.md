---
title: "ImageBitMask klass"
type: docs
weight: 50
url: /sv/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/
---
...
| **Name** | **Description** |
| :- | :- |
| [ImageBitMask(image)](#ImageBitMask_image_1) | Initierar en ny instans av klassen [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) med storleken på den angivna befintliga [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/).<br/>            Angiven [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) kommer att lagras som källbild. |
| [ImageBitMask(width, height)](#ImageBitMask_width_height_2) | Initierar en ny instans av klassen [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) med den angivna bredden och höjden. |
## **Properties**
...
| [get(x, y)](#get_x_y_9) | Hämtar positionen i lagringsarrayen för den angivna pixeln. |
...
| [set_mask_pixel(x, y, value)](#set_mask_pixel_x_y_value_19) | Anger opaciteten för den angivna pixeln. |
| [subtract(image, settings)](#subtract_image_settings_20) | Hämtar resultatet av magic wand‑urval som tillämpats på den angivna bilden, subtraherat från den aktuella masken. |
| [subtract(mask)](#subtract_mask_21) | Hämtar subtraktionen av den angivna masken från den aktuella. |
| [subtract(settings)](#subtract_settings_22) | Hämtar resultatet av magic wand‑urval som tillämpats på källan till den aktuella masken, subtraherat från masken. |
| [union(image, settings)](#union_image_settings_23) | Hämtar unionen av den aktuella masken med resultatet av magic wand‑urval som tillämpats på den angivna bilden. |
| [union(mask)](#union_mask_24) | Hämtar unionen av den aktuella masken med den angivna. |
| [union(settings)](#union_settings_25) | Hämtar unionen av den aktuella masken med resultatet av magic wand‑urval som tillämpats på maskens källa. |
...
Initierar en ny instans av klassen [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) med den angivna bredden och höjden.
...
| Typ | Beskrivning |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | En beskuren [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) som [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
Hämtar positionen i lagringsarrayen för den angivna pixeln.
...
| Typ | Beskrivning |
| :- | :- |
| bool | Int-värde som representerar positionen i lagringen. |
...
| Typ | Beskrivning |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | En uppblåst [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) som [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
| x | int | X-koordinaten för pixeln. |
| y | int | Y-koordinaten för pixeln. |
| värde | bool | Sant om den angivna pixeln är ogenomskinlig; annars falskt. |
