---
title: "RectangleMask-klass"
type: docs
weight: 80
url: /sv/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/
---
...
| **Name** | **Description** |
| :- | :- |
| [RectangleMask(selected_area)](#RectangleMask_selected_area_1) | Initierar en ny instans av klassen [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) med den angivna rektangeln. |
| [RectangleMask(x, y, width, height)](#RectangleMask_x_y_width_height_2) | Initierar en ny instans av klassen [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) med den angivna vänster-övre punkten, bredd och höjd. |
## **Properties**
...
Initierar en ny instans av klassen [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) med den angivna rektangeln.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| selected_area | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Markerat område specificerat som en rektangel. |
...
Initierar en ny instans av klassen [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) med den angivna vänster-övre punkten, bredd och höjd.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| x | int | X-koordinaten för den vänster-övre punkten i det markerade området. |
| y | int | Y-koordinaten för den vänster-övre punkten i det markerade området. |
| width | int | Bredden på det markerade området. |
| height | int | Höjden på det markerade området. |
...
| Typ | Beskrivning |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | En beskuren RectangleMask som ImageMask. |
...
| Typ | Beskrivning |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | En uppblåst RectangleMask som ImageMask. |
