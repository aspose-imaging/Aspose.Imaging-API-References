---
title: "WmfRecorderGraphics2D-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **Description** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | Initierar en ny instans av klassen [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Hämtar eller anger bakgrundens färg. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | Hämtar eller anger bakgrundsläget. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | Hämtar en instans av Wmf-inspelaren för den befintliga Wmf-bilden. |
...
Initierar en ny instans av klassen [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/).

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Destinationsrektangel, mätt i twips, för att visa metafilen. |
...
| Typ | Beskrivning |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Resultatbilden. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Wmf-bilden för att få en inspelare. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | En instans av klassen [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
