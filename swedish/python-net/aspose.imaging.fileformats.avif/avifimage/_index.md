---
title: "AvifImage-klass"
type: docs
weight: 10
url: /sv/python-net/aspose.imaging.fileformats.avif/avifimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [AvifImage()](#AvifImage__1) | Initierar en ny instans av klassen AvifImage |
## **Properties**
...
| bits_per_pixel | int | r | Hämtar värdet för bitar per pixel |
...
| height | int | r | Hämtar AVIF-bildens höjd |
...
| width | int | r | Hämtar AVIF-bildens bredd |
...
Initierar en ny instans av klassen AvifImage
