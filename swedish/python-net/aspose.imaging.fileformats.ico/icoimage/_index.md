---
title: "IcoImage‑klass"
type: docs
weight: 10
url: /sv/python-net/aspose.imaging.fileformats.ico/icoimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [IcoImage(image, ico_options)](#IcoImage_image_ico_options_1) | Skapad för enkelhet och effektivitet, klassen [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) ger dig möjlighet att enkelt skapa ICO‑bilder. Denna konstruktor initierar en ny instans <br/>            av klassen, vilket ger en solid grund för dina bildmanipuleringsbehov. <br/>            Oavsett om du utvecklar applikationer eller förbättrar användargränssnitt, förenklar [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) klassen ICO‑bild‑hantering, så att du kan fokusera <br/>            på att leverera exceptionella upplevelser. |
| [IcoImage(width, height, options)](#IcoImage_width_height_options_2) | Börja skapa ICO‑bilder utan ansträngning med klassen [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/). Denna <br/>            konstruktor låter dig initiera nya instanser av ICO‑bilder genom att ange <br/>            bredd, höjd och parametrar för skapandealternativ. Med denna enkla <br/>            konstruktor kan du anpassa ICO‑bilder efter dina exakta specifikationer, vilket säkerställer <br/>            sömlös kompatibilitet och visuell attraktivitet på olika plattformar och enheter. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Hämta filformatet utan ansträngning med denna egenskap, vilket möjliggör sömlös <br/>            integration i ditt arbetsflöde. Genom att använda denna egenskap får du tillgång till viktig <br/>            information om ditt fils format, vilket säkerställer kompatibilitet och effektiv bearbetning. |
| has_alpha | bool | r | Bestäm om en alfakanal finns i detta objekt med denna egenskap. Den <br/>            ger ett snabbt sätt att kontrollera om bilden eller dokumentet innehåller en alfakanal, <br/>            vilket är avgörande för olika bildbehandlings- och renderingsuppgifter. Idealisk för <br/>            att säkerställa kompatibilitet och hantera transparenseffekter i bilder eller dokument. |
...
| page_count | int | r | Få omedelbar insikt i dokumentstrukturen med denna enkla <br/>            egenskap. Genom att anropa denna egenskap hämtar du utan ansträngning det totala antalet <br/>            sidor som finns i filen. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Hämta omfattande information om dokumentets sidor utan ansträngning via <br/>            denna egenskap. Genom att komma åt denna egenskap får du tillgång till en samling eller array <br/>            som innehåller alla sidor som finns i dokumentet. |
...
| **Name** | **Description** |
| :- | :- |
| [add_page(page)](#add_page_page_1) | Expandera din ICO-bild genom att lägga till en bildsidpost, med hjälp av <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Denna metod integrerar sömlöst rasterbilder i <br/>            din ICO-fil och konverterar dem till ett högkvalitativt 32-bitars PNG-format. Perfekt för <br/>            att förbättra dina ICO-filer med rasterbilder samtidigt som optimal kompatibilitet <br/>            och renderingskvalitet säkerställs. |
| [add_page(page)](#add_page_page_2) | Expandera din ICO-bild genom att lägga till en bildsidpost, med hjälp av <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Denna metod integrerar sömlöst rasterbilder i <br/>            din ICO-fil och konverterar dem till ett högkvalitativt 32-bitars PNG-format. Perfekt för <br/>            att förbättra dina ICO-filer med rasterbilder samtidigt som optimal kompatibilitet <br/>            och renderingskvalitet säkerställs. |
| [add_page(page, ico_options)](#add_page_page_ico_options_3) | Diversifiera din ICO-bild utan ansträngning genom att integrera en bildpost anpassad efter <br/>            dina behov med de angivna [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Denna metod integrerar sömlöst bilden enligt dina anpassade alternativ, vilket säkerställer flexibilitet <br/>            och precision i din ICO-fil. |
| [add_raster_page(page)](#add_raster_page_page_4) | Lägger till en bildpost i ICO-bilden enligt standard [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) som 32-bit PNG. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | Justering av en _brightness_ för bild. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | [Image](/imaging/python-net/aspose.imaging/image/) kontrasterande |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | Gammakorrigering av en bild. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | Gammakorrigering av en bild. |
...
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | Binärisering av en bild med fördefinierad tröskel |
...
| [can_load(stream)](#can_load_stream_17) | Avgör om den angivna strömmen innehåller en ICO-bild. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | Beskär bild med förskjutningar. |
...
| [remove_page(index)](#remove_page_index_79) | Finjustera din ICO-bild genom att ta bort en specifik bildpost placerad på den <br/>            angivna ***index*** i filen. Denna metod ger exakt <br/>            kontroll över din bildkomposition, vilket låter dig förfina din ICO-fil med lätthet. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) bild runt centrum. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | Roterar, vänder eller roterar och vänder alla sidor. |
...
| [save(file_path, options)](#save_file_path_options_103) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
...
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_109) | Sparar de 32‑bitars ARGB‑pixlarna. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_110) | Sparar pixlarna. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_111) | Sparar pixlarna.<br/>            Denna metod är föråldrad. Använd den mer effektiva [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) metoden. |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_112) | Sparar pixlarna internt. |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_113) | Sparar rådata. |
| [save_to_stream(stream)](#save_to_stream_stream_114) | Sparar objektets data till den angivna strömmen. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_115) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_116) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_117) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_118) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_119) | Ställer in en bildpixel i 32-bit ARGB för den angivna positionen. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_120) | Ställer in bildpaletten. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_121) | Ställer in en bildpixel för den angivna positionen. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_122) | Ställer in upplösningen för denna [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_123) | Försöker sätta en _metadata_-instans, om detta [Image](/imaging/python-net/aspose.imaging/image/)-instans stödjer och implementerar [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)-instansen. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_124) | Skriver hela skanningsraden till det angivna skanningsradindexet. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_125) | Skriver hela skanningsraden till det angivna skanningsradindexet. |
...
Skapad för enkelhet och effektivitet, klassen [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) ger dig möjlighet att enkelt skapa ICO‑bilder. Denna konstruktor initierar en ny instans <br/>            av klassen, vilket ger en solid grund för dina bildmanipuleringsbehov. <br/>            Oavsett om du utvecklar applikationer eller förbättrar användargränssnitt, förenklar [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) klassen ICO‑bild‑hantering, så att du kan fokusera <br/>            på att leverera exceptionella upplevelser.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| image | [Image](/imaging/python-net/aspose.imaging/image/) | Bilden. |
| ico_options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | ICO-alternativen. |
...
| width | int | Bredden. |
| height | int | Höjden. |
| options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | ICO-skapandealternativen. |
...
Expandera din ICO-bild genom att lägga till en bildsidpost, med hjälp av <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Denna metod integrerar sömlöst rasterbilder i <br/>            din ICO-fil och konverterar dem till ett högkvalitativt 32-bitars PNG-format. Perfekt för <br/>            att förbättra dina ICO-filer med rasterbilder samtidigt som optimal kompatibilitet <br/>            och renderingskvalitet säkerställs.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| page | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Bilden. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| page | [Image](/imaging/python-net/aspose.imaging/image/) | Bilden. |
...
Diversifiera din ICO-bild utan ansträngning genom att integrera en bildpost anpassad efter <br/>            dina behov med de angivna [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Denna metod integrerar sömlöst bilden enligt dina anpassade alternativ, vilket säkerställer flexibilitet <br/>            och precision i din ICO-fil.
...
Lägger till en bildpost i ICO-bilden enligt standard [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) som 32-bit PNG.
...
Justering av en _brightness_ för bild.
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| tröskelvärde | System.Byte | Tröskelvärde. Om motsvarande gråvärde för en pixel är större än tröskeln, tilldelas den ett värde på<br/>                255, annars 0. |
...
Avgör om den angivna strömmen innehåller en ICO-bild.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| ström | _io.BufferedRandom | Bildströmmen. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| bool | **True** om strömmen innehåller en ICO-bild; annars **False** |
...
Finjustera din ICO-bild genom att ta bort en specifik bildpost placerad på den <br/>            angivna ***index*** i filen. Denna metod ger exakt <br/>            kontroll över din bildkomposition, vilket låter dig förfina din ICO-fil med lätthet.
...
| :- | :- | :- |
| vinkel | float | Rotationsvinkeln i grader. Positiva värden roterar medurs. |
| resize_proportionally | bool | om inställt på <c>true</c> kommer din bildstorlek att ändras<br/>                enligt roterad rektangel (hörnpunkter) projektioner i annat<br/>                fall som lämnar dimensionerna orörda och endast<br/>                __internal__ bildinnehåll roteras. |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | Bakgrundens färg. |
