---
title: "WebPOptions-klass"
type: docs
weight: 360
url: /sv/python-net/aspose.imaging.imageoptions/webpoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [WebPOptions()](#WebPOptions__1) | Initierar en ny instans av klassen [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| anim_background_color | int | r/w | Hämtar eller anger färgen på animeringsbakgrunden. |
| anim_loop_count | int | r/w | Hämtar eller anger antalet animeringsloopar. |
...
| lossless | bool | r/w | Hämtar eller anger ett värde som indikerar om denna [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/) är förlustfri. |
...
| quality | float | r/w | Hämtar eller anger kvaliteten. |
...
Initierar en ny instans av klassen [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/).
