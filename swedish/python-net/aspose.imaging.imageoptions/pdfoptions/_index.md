...
type: docs
weight: 240
url: /sv/python-net/aspose.imaging.imageoptions/pdfoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [PdfOptions()](#PdfOptions__1) | Initierar en ny instans av klassen [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/). |
## **Properties**
...
| page_size | [SizeF](/imaging/python-net/aspose.imaging/sizef/) | r/w | Hämtar eller anger storleken på sidan. |
| palette | [IColorPalette](/imaging/python-net/aspose.imaging/icolorpalette/) | r/w | Hämtar eller anger färgpaletten. |
| pdf_core_options | [PdfCoreOptions](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfcoreoptions/) | r/w | PDF:s kärnalternativ |
| pdf_document_info | [PdfDocumentInfo](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfdocumentinfo/) | r/w | Hämtar eller anger metadata för dokumentet. |
...
| use_original_image_resolution | bool | r/w | Hämtar eller anger ett värde som indikerar att den ursprungliga bildens DPI-upplösning ska användas. |
...
Initierar en ny instans av klassen [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/).
