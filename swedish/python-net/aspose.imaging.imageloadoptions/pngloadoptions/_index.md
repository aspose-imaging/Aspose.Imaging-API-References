---
title: "PngLoadOptions klass"
type: docs
weight: 70
url: /sv/python-net/aspose.imaging.imageloadoptions/pngloadoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [PngLoadOptions()](#PngLoadOptions__1) | Initierar en ny instans av klassen [PngLoadOptions](/imaging/python-net/aspose.imaging.imageloadoptions/pngloadoptions/). |
## **Properties**
...
| [strict_mode](#strict_mode1) | bool | r/w | Hämtar eller anger ett värde som indikerar om [strict mode]. |
...
Initierar en ny instans av klassen [PngLoadOptions](/imaging/python-net/aspose.imaging.imageloadoptions/pngloadoptions/).
...
# Standardläge (icke-strikt) - lyckad läsning.
with Image.load(input_file_name) as image:
	image.save(output_file_name, PngOptions())

# Strikt läge - ImageLoadException : Oväntat filslut.
