---
title: "WatermarkRemover klass"
type: docs
weight: 40
url: /sv/python-net/aspose.imaging.watermark/watermarkremover/
---
...
| **Name** | **Description** |
| :- | :- |
| [paint_over(source, options)](#paint_over_source_options_1) | Ta bort vattenstämpeln från rasterbilden. |
...
| :- | :- | :- |
| source | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Den ursprungliga rasterbilden. |
| options | [WatermarkOptions](/imaging/python-net/aspose.imaging.watermark.options/watermarkoptions/) | Vattenstämpelalternativen. |

**Returns**

| Typ | Beskrivning |
| :- | :- |
| [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Den resulterande bilden. |
