---
title: "OtgImage klass"
type: docs
weight: 500
url: /sv/python-net/aspose.imaging.fileformats.opendocument/otgimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [OtgImage(stream_container)](#OtgImage_stream_container_1) | Skapa ett nytt objekt av klassen [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) genom att tillhandahålla en ström <br/> container. Denna konstruktor möjliggör för utvecklare att skapa OTG‑bilder direkt från <br/> strömbärare, vilket effektiviserar processen att arbeta med OTG‑bilddata. |
| [OtgImage(stream_container, load_options)](#OtgImage_stream_container_load_options_2) | Initiera ett nytt [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) objekt genom att tillhandahålla en strömbärare <br/> och laddningsalternativ. Denna konstruktor ger utvecklare möjlighet att effektivt ladda OTG <br/> bilder från strömmar samtidigt som anpassade laddningskonfigurationer specificeras. |
## **Properties**
...
| bits_per_pixel | int | r | Hämtar antalet bitar per pixel för bilden. Denna egenskap ger insikt <br/> i detaljnivån och färgdjupet som representeras i bilden, vilket hjälper vid olika <br/> bildbehandlingsuppgifter och optimeringar. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Hämtar standardsidan som är associerad med bilden och ger nödvändig åtkomst till <br/> huvud­sidan i bildsamlingen. Denna egenskap förenklar navigering <br/> och manipulation av bilddata, vilket förbättrar effektiviteten i mjukvaruutvecklings‑<br/> arbetsflöden. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Denna egenskap ger åtkomst till OTG‑filformatet och erbjuder viktig insikt <br/> i vilken typ av data som kapslas in i bildfilen. Den fungerar som en central <br/> referenspunkt för mjukvaruutvecklare, så att de effektivt kan hantera OTG‑filer i sina applikationer. Genom att använda denna egenskap kan du <br/> fastställa det specifika formatet för bildfilen, vilket underlättar sömlös <br/> integration och manipulation av OTG‑filer i deras mjukvarusystem. |
...
| is_cached | bool | r | Hämtar ett booleskt värde som indikerar om objektets data för närvarande är <br/> cachad, vilket eliminerar behovet av dataläsning. Denna egenskap fungerar som en <br/> optimeringsindikator och förbättrar prestanda genom att minimera redundanta data‑ åtkomstoperationer. |
| metadata | [OdMetadata](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects/odmetadata/) | r | Hämtar metadata specifik för OpenDocument‑filer. Denna egenskap möjliggör åtkomst till <br/> viktig information som är inbäddad i OD‑filer, vilket underlättar olika operationer som <br/> extraktion, modifiering eller analys av metadata. |
| page_count | int | r | Hämtar det totala antalet sidor i bilden. Denna egenskap är viktig för <br/> applikationer som hanterar flersidiga bilder, så att de exakt kan bestämma <br/> antalet sidor som är tillgängliga för bearbetning eller visning. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Hämtar samlingen av sidor som är associerade med bilden, vilket gör det möjligt för mjukvaru‑utvecklare att åtkomma och manipulera varje enskild sida effektivt. Denna <br/> egenskap underlättar sömlös iteration genom sidorna för olika operationer, <br/> vilket förbättrar funktionaliteten och mångsidigheten i bildbehandlingsapplikationer. |
...
| records | [OdObject[]](/imaging/python-net/aspose.imaging.fileformats.opendocument/odobject/) | r | Hämtar OpenDocument‑poster som lagras i bilden. Denna egenskap ger <br/> åtkomst till specifika strukturerade dataelement som är inbäddade i OpenDocument‑filer, <br/> vilket underlättar hämtning eller manipulation av relevant information för vidare bearbetning <br/> eller analys. |
...
| **Name** | **Description** |
| :- | :- |
| cache_data() | Cachar data och säkerställer att ingen ytterligare dataladdning kommer att utföras från den underliggande<br/>                [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_68) | Ställer in bildpaletten. |
...
| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| stream_container | [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/) | Strömmen. |
