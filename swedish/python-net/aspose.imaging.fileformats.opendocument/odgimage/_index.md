---
title: "OdgImage‑klass"
type: docs
weight: 490
url: /sv/python-net/aspose.imaging.fileformats.opendocument/odgimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [OdgImage(stream_container)](#OdgImage_stream_container_1) | Skapad för sömlös integration i mjukvarulösningar, [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) <br/> konstruktor initierar en ny instans genom att utnyttja en strömbärare. Denna metod <br/> säkerställer effektiv hantering av ODG‑bilddata i mjukvarumiljöer, optimerar <br/> resursanvändning och underlättar förenklade arbetsflöden för bildbehandling. |
| [OdgImage(stream_container, options)](#OdgImage_stream_container_options_2) | Starta en ny skapelse av [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) klassobjekt med <br/> initieringen av en ny instans. Utnyttja potentialen i en strömbärare kombinerad <br/> med laddningsalternativ, behåll en mångsidig konstruktor för att sömlöst ladda <br/> bilder. Denna konstruktor möjliggör effektiv bildhantering och erbjuder anpassningsbara <br/> laddningskonfigurationer för förbättrad anpassningsförmåga och prestanda i olika scenarier. |
## **Properties**
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Vid hämtning av sidssamlingen ger denna egenskap möjlighet att komma åt hela <br/> samlingen av sidor som är associerade med en bild. Genom att använda denna egenskap kan utvecklare <br/> iterera genom enskilda sidor, hämta specifika sidor baserat på deras index, eller <br/> utföra batch‑operationer på hela samlingen. |
...
| options | [LoadOptions](/imaging/python-net/aspose.imaging/loadoptions/) | Laddningsalternativen |
