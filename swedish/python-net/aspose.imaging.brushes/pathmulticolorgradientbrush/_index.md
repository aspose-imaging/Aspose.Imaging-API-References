...
type: docs
weight: 70
url: /sv/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/
---
...
| **Name** | **Description** |
| :- | :- |
| [PathMulticolorGradientBrush(path)](#PathMulticolorGradientBrush_path_1) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna. |
| [PathMulticolorGradientBrush(path_points)](#PathMulticolorGradientBrush_path_points_2) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna. |
| [PathMulticolorGradientBrush(path_points)](#PathMulticolorGradientBrush_path_points_3) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna. |
| [PathMulticolorGradientBrush(path_points, wrap_mode)](#PathMulticolorGradientBrush_path_points_wrap_mode_4) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna och omslagsläget. |
| [PathMulticolorGradientBrush(path_points, wrap_mode)](#PathMulticolorGradientBrush_path_points_wrap_mode_5) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna och omslagsläget. |
## **Properties**
...
| **Name** | **Description** |
| :- | :- |
| [create_with_path(path)](#create_with_path_path_1) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med den angivna banan. |
| [create_with_points(path_points)](#create_with_points_path_points_2) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna. |
| [create_with_points_f(path_points)](#create_with_points_f_path_points_3) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna. |
| [create_with_points_f_wrap_mode(path_points, wrap_mode)](#create_with_points_f_wrap_mode_path_points_wrap_mode_4) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna och omslagsläget. |
| [create_with_points_wrap_mode(path_points, wrap_mode)](#create_with_points_wrap_mode_path_points_wrap_mode_5) | Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna och omslagsläget. |
...
| [translate_transform(dx, dy)](#translate_transform_dx_dy_13) | Översätter den lokala geometriska transformen med de angivna dimensionerna. Denna metod lägger till översättningen i början av transformen. |
| [translate_transform(dx, dy, order)](#translate_transform_dx_dy_order_14) | Översätter den lokala geometriska transformen med de angivna dimensionerna i den angivna ordningen. |
...
Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna.
...
Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med de angivna punkterna och omslagsläget.
...
| :- | :- | :- |
| path_points | [PointF[]](/imaging/python-net/aspose.imaging/pointf/) | En array av [PointF](/imaging/python-net/aspose.imaging/pointf/) strukturer som representerar de punkter som bildar banans hörn. |
| wrap_mode | [WrapMode](/imaging/python-net/aspose.imaging/wrapmode/) | En [WrapMode](/imaging/python-net/aspose.imaging/wrapmode/) som specificerar hur fyllningar som ritas med denna [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) upprepas. |
...
Initierar en ny instans av klassen [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/) med den angivna banan.

**Parameters:**

| Parameter | Typ | Beskrivning |
| :- | :- | :- |
| path | [GraphicsPath](/imaging/python-net/aspose.imaging/graphicspath/) | Den [GraphicsPath](/imaging/python-net/aspose.imaging/graphicspath/) som definierar området som fylls av denna [PathMulticolorGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathmulticolorgradientbrush/). |
