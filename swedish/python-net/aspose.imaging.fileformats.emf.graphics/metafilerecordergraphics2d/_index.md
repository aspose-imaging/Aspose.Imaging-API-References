---
title: "MetafileRecorderGraphics2D-klass"
type: docs
weight: 20
url: /sv/python-net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/
---
...
| [exclude_clip(rect)](#exclude_clip_rect_21) | Uppdaterar klippområdet för denna Graphics för att utesluta området som anges av en rektangelstruktur. |
| [exclude_clip(region)](#exclude_clip_region_22) | Uppdaterar klippområdet för denna Graphics för att utesluta området som anges av en region. |
| [exclude_clip_rect(rect)](#exclude_clip_rect_rect_23) | Uppdaterar klippområdet för denna Graphics för att utesluta området som anges av en rektangelstruktur. |
| [exclude_clip_rgn(region)](#exclude_clip_rgn_region_24) | Uppdaterar klippområdet för denna Graphics för att utesluta området som anges av en region. |
| [fill_ellipse(brush, rect)](#fill_ellipse_brush_rect_25) | Fyller ellipsen. |
| [fill_path(pen, brush, path)](#fill_path_pen_brush_path_26) | Fyller sökvägen. |
| [fill_pie(brush, rect, start_angle, sweep_angle)](#fill_pie_brush_rect_start_angle_sweep_angle_27) | Fyller pajen. |
| [fill_polygon(brush, points)](#fill_polygon_brush_points_28) | Fyller polygonen. |
| [fill_polygon(brush, points, fill_mode)](#fill_polygon_brush_points_fill_mode_29) | Fyller polygonen. |
| [fill_rectangle(brush, rectangle)](#fill_rectangle_brush_rectangle_30) | Fyller rektangeln. |
| [get_transform()](#get_transform__31) | Hämtar världstransformationen. |
| [intersect_clip(rect)](#intersect_clip_rect_32) | Uppdaterar klippområdet för denna Graphics till skärningspunkten mellan det aktuella klippområdet och den angivna rektangelstrukturen. |
| [intersect_clip(region)](#intersect_clip_region_33) | Uppdaterar klippområdet för denna Graphics till skärningspunkten mellan det aktuella klippområdet och den angivna regionen. |
| [intersect_clip_rect_f(rect)](#intersect_clip_rect_f_rect_34) | Uppdaterar klippområdet för denna Graphics till skärningspunkten mellan det aktuella klippområdet och den angivna rektangelstrukturen. |
| [intersect_clip_rgn(region)](#intersect_clip_rgn_region_35) | Uppdaterar klippområdet för denna Graphics till skärningspunkten mellan det aktuella klippområdet och den angivna regionen. |
| [multiply_transform(matrix)](#multiply_transform_matrix_36) | Multiplicerar världstransformationen för denna Graphics med den angivna matrisen. |
| [multiply_transform(matrix, order)](#multiply_transform_matrix_order_37) | Multiplicerar världstransformationen för denna Graphics med den angivna matrisen i angiven ordning. |
| reset_clip() | Återställer klippet. |
| [rotate_transform(angle)](#rotate_transform_angle_38) | Tillämpar den angivna rotationen på transformationsmatrisen för denna Graphics. |
| [rotate_transform(angle, center, order)](#rotate_transform_angle_center_order_39) | Tillämpar den angivna rotationen på transformationsmatrisen för denna Graphics i den angivna ordningen. |
| [scale_transform(sx, sy)](#scale_transform_sx_sy_40) | Tillämpar den angivna skalningsoperationen på transformationsmatrisen för denna Graphics genom att föra in den i början av objektets transformationsmatris. |
| [scale_transform(sx, sy, order)](#scale_transform_sx_sy_order_41) | Tillämpar den angivna skalningsoperationen på transformationsmatrisen för denna Graphics i den angivna ordningen. |
| [set_transform(transform)](#set_transform_transform_42) | Ställer in transformen. |
| [translate_transform(x, y)](#translate_transform_x_y_43) | Ändrar ursprunget för koordinatsystemet genom att föra in den angivna translationen i början av transformationsmatrisen för denna Graphics. |
| [translate_transform(x, y, order)](#translate_transform_x_y_order_44) | Ändrar ursprunget för koordinatsystemet genom att tillämpa den angivna translationen på transformationsmatrisen för denna Graphics i den angivna ordningen. |
