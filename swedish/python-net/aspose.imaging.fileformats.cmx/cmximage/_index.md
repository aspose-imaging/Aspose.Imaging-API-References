---
title: "CmxImage-klass"
type: docs
weight: 90
url: /sv/python-net/aspose.imaging.fileformats.cmx/cmximage/
---
...
| **Name** | **Description** |
| :- | :- |
| [CmxImage(stream_container, load_options)](#CmxImage_stream_container_load_options_1) | Börja arbeta med klassen [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) sömlöst genom att initiera<br/>            en ny instans med parametrarna streamContainer och loadOptions. Idealiskt för utvecklare<br/>            som söker ett bekvämt sätt att läsa in CMX-bilder från olika datakällor samtidigt som<br/>            de anpassar inläsningsprocessen efter behov. |
## **Properties**
...
| bits_per_pixel | int | r | Hämta bildens bitdjup enkelt med denna användarvänliga egenskap.<br/>            Idealiskt för utvecklare som vill fastställa detaljnivån eller färgdjupet<br/>            i sina bilder, vilket säkerställer korrekt bearbetning och manipulation. |
...
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | r | Hämta enkelt CMX-sidan för bilden med denna intuitiva egenskap.<br/>            Idealiskt för utvecklare som söker snabb åtkomst till enskilda sidor i CMX-bilder,<br/>            vilket säkerställer effektiv navigering och hantering. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Hämta enkelt standard sidan för bilden med denna intuitiva egenskap.<br/>            Idealiskt för utvecklare som söker snabb åtkomst till bildens huvudsida,<br/>            vilket säkerställer effektiv navigering och hantering. |
| disposed | bool | r | Hämtar ett värde som indikerar om den här instansen är frigjord. |
| document | [CmxDocument](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxdocument/) | r | Hämta CMX-dokumentet enkelt med denna intuitiva egenskap. Idealiskt för<br/>            utvecklare som vill komma åt eller modifiera CMX-bilder, vilket säkerställer flexibilitet och<br/>            effektivitet i deras applikationer. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Hämtar eller anger Exif-instans. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Hämta bildens filformat enkelt med denna användarvänliga egenskap.<br/>            Idealiskt för utvecklare som vill bestämma formatet på sina bilder dynamiskt,<br/>            vilket säkerställer kompatibilitet och korrekt bearbetning i deras applikationer. |
...
| height_f | float | r | Få enkelt objektets höjd, mätt i tum, med denna<br/>            användarvänliga egenskap. Idealiskt för utvecklare som söker exakt dimensionell information<br/>            för effektiv layout och presentation i sina applikationer. |
...
| is_cached | bool | r | Bestäm om objektets data för närvarande är cachade, vilket eliminerar behovet<br/>            av dataläsning. Idealiskt för utvecklare som vill optimera prestanda genom<br/>            att effektivt utnyttja cachade data, vilket säkerställer snabbare åtkomst till objektinformation. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Hämtar bildens metadata. |
| page_count | int | r | Hämta det totala antalet sidor i bilden med denna intuitiva egenskap.<br/>            Idealiskt för utvecklare som vill hantera flersidiga bilder dynamiskt,<br/>            vilket säkerställer effektiv navigering och manipulation av bildinnehållet. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Hämta bildens sidor sömlöst med denna intuitiva egenskap.<br/>            Idealiskt för utvecklare som vill komma åt och manipulera enskilda sidor<br/>            i flersidiga bilder, vilket säkerställer effektiv navigering och bearbetning. |
...
| width_f | float | r | Hämta objektets bredd i tum med denna intuitiva egenskap.<br/>            Idealiskt för utvecklare som söker precisa mått på objekt i sina applikationer,<br/>            vilket säkerställer korrekt layout och presentation. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Hämtar eller anger Xmp-data. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| cache_data() | Cacha data för att förhindra ytterligare inläsning från den underliggande källan<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/)<br/>            med denna praktiska metod. Idealiskt för utvecklare som vill optimera prestanda<br/>            genom att förladda data, vilket säkerställer snabbare åtkomst och smidigare drift i deras applikationer. |
...
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_32) | Konverterar till aps. |
| [load(file_path)](#load_file_path_33) | Läser in en ny bild från den angivna filsökvägen eller URL:en.<br/>            Om _filePath_ är en filsökväg öppnar metoden bara filen.<br/>            Om _filePath_ är en URL laddar metoden ner filen, sparar den som en temporär och öppnar den. |
| [load(file_path, load_options)](#load_file_path_load_options_34) | Läser in en ny bild från den angivna filsökvägen eller URL:en.<br/>            Om _filePath_ är en filsökväg öppnar metoden bara filen.<br/>            Om _filePath_ är en URL laddar metoden ner filen, sparar den som en temporär och öppnar den. |
| [load(stream)](#load_stream_35) | Läser in en ny bild från den angivna strömmen. |
| [load(stream, load_options)](#load_stream_load_options_36) | Läser in en ny bild från den angivna strömmen. |
| [load_stream(stream)](#load_stream_stream_37) | Läser in en ny bild från den angivna strömmen. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_38) | Läser in en ny bild från den angivna strömmen. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_39) | Läser in en ny bild från den angivna filsökvägen eller URL:en.<br/>            Om _filePath_ är en filsökväg öppnar metoden bara filen.<br/>            Om _filePath_ är en URL laddar metoden ner filen, sparar den som en temporär och öppnar den. |
| remove_background() | Tar bort bakgrunden. |
| [remove_background(settings)](#remove_background_settings_40) | Tar bort bakgrunden. |
| remove_metadata() | Tar bort metadata. |
| [resize(new_width, new_height)](#resize_new_width_new_height_41) | Ändrar bildens storlek. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_42) | Ändrar storlek på bilden. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_43) | Ändrar storlek på bilden. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_44) | Ändrar storlek på bilden. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_45) | Ändrar storlek på bilden. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_46) | Ändrar höjden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_47) | Ändrar höjden proportionellt. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_48) | Ändrar höjden proportionellt. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_49) | Ändrar höjden proportionellt. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_50) | Ändrar bredden proportionellt. Standardvärdet [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) används. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_51) | Ändrar bredden proportionellt. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_52) | Ändrar bredden proportionellt. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_53) | Ändrar bredden proportionellt. |
| [rotate(angle)](#rotate_angle_54) | Rotera bilden kring centrum. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_55) | Rotera, vänd eller rotera och vänd bilden. |
| save() | Sparar bilddata till den underliggande strömmen. |
| [save(file_path)](#save_file_path_56) | Sparar bilden till den angivna filsökvägen. |
| [save(file_path, options)](#save_file_path_options_57) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_58) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save(file_path, over_write)](#save_file_path_over_write_59) | Sparar objektets data till den angivna filsökvägen. |
| [save(stream)](#save_stream_60) | Sparar data. |
| [save(stream, options_base)](#save_stream_options_base_61) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_62) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream(stream)](#save_to_stream_stream_63) | Sparar objektets data till den angivna strömmen. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_64) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_65) | Sparar bildens data till den angivna strömmen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_66) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_67) | Sparar objektets data till den angivna filsökvägen i det specificerade filformatet enligt sparalternativ. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_68) | Anpassa bildens färgpalett med denna intuitiva metod. Perfekt för<br/>            utvecklare som vill tillämpa specifika färgscheman eller justeringar dynamiskt,<br/>            vilket ger exakt kontroll över bildens visuella utseende. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_69) | Försöker sätta en _metadata_-instans, om detta [Image](/imaging/python-net/aspose.imaging/image/)-instans stödjer och implementerar [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)-instansen. |
...
Börja arbeta med klassen [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) sömlöst genom att initiera<br/>            en ny instans med parametrarna streamContainer och loadOptions. Idealiskt för utvecklare<br/>            som söker ett bekvämt sätt att läsa in CMX-bilder från olika datakällor samtidigt som<br/>            de anpassar inläsningsprocessen efter behov.
...
Hämta bildens sidor sömlöst med denna intuitiva egenskap.<br/>            Idealiskt för utvecklare som vill komma åt och manipulera enskilda sidor<br/>            i flersidiga bilder, vilket säkerställer effektiv navigering och bearbetning.
...
Anpassa bildens färgpalett med denna intuitiva metod. Perfekt för<br/>            utvecklare som vill tillämpa specifika färgscheman eller justeringar dynamiskt,<br/>            vilket ger exakt kontroll över bildens visuella utseende.
...
with aspycore.as_of(Image.load(join(dir_, "sample.cmx")), CmxImage) as image:
	...
	image.cache_data()
	# Cacha alla sidor så att ingen ytterligare dataladdning utförs från den underliggande datastreamen.
