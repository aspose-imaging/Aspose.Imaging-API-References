---
title: "EmfImage-klass"
type: docs
weight: 680
url: /sv/python-net/aspose.imaging.fileformats.emf/emfimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfImage()](#EmfImage__1) | Börja arbeta med EMF-bilder genom att initiera en ny instans av<br/>            [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) klassen. Perfekt för att snabbt integrera EMF-bilder i<br/>            dina projekt med enkelhet och effektivitet. |
| [EmfImage(width, height)](#EmfImage_width_height_2) | Skapa en ny instans av [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) klassen genom att ange bredd <br/>            och höjdparametrar. Denna konstruktor förenklar processen att initiera <br/>            EMF-bilder med specifika dimensioner, vilket förbättrar effektiviteten i ditt utvecklingsarbetsflöde. |
## **Properties**
...
| bits_per_pixel | int | r | Hämta bit-per-pixel‑antalet som är specifikt för rasterbilder, eftersom denna parameter <br/>            inte gäller för vektorbilder. Snabbt fastställ pixeldjupet för raster <br/>            bilder för exakt analys och manipulation, vilket säkerställer korrekt hantering<br/>            av bilddata. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Åtkomst till filformatvärdet som är associerat med objektet. Bestäm enkelt <br/>            formatet för filen som är kopplad till objektet för förenklad bearbetning och <br/>            kompatibilitetskontroller. Förenkla ditt arbetsflöde genom att hämta filformatinformationen <br/>            med lätthet. |
| has_background_color | bool | r/w | Hämtar eller anger ett värde som indikerar om bilden har bakgrundsfärg. |
| header | [EmfMetafileHeader](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheader/) | r/w | Hämta eller ändra EMF-metafilens huvudpost med denna egenskap. Idealisk för <br/>            att hantera metafildata effektivt i din applikation. Förbättra ditt arbetsflöde <br/>            med förenklad åtkomst till metafilens huvudinformation. |
| height | int | r | Hämtar objektets höjd. |
| height_f | float | r | Hämta bildens höjd, vilket underlättar exakt rendering och layoutjusteringar. <br/>            Åtkomst till höjd‑egenskapen säkerställer kompatibilitet och sömlös integration över <br/>            olika plattformar och applikationer. |
...
| is_cached | bool | r | Åtkomst till ett värde som indikerar om objektets data för närvarande är cachad, <br/>            vilket eliminerar behovet av ytterligare dataläsning. Förbättra effektiviteten genom att snabbt <br/>            avgöra om cachad data är tillgänglig för omedelbar åtkomst. Optimera ditt <br/>            arbetsflöde med förenklade datahämtningsprocesser. |
...
| records | [MetaObjectList](/imaging/python-net/aspose.imaging.fileformats.emf/metaobjectlist/) | r/w | Hämta eller ändra posterna som är associerade med objektet. Åtkomst och <br/>            hantera samlingen av poster effektivt för förbättrad datamanipulation och bearbetning. <br/>            Optimera ditt arbetsflöde genom att sömlöst interagera med objektets poster. |
...
| width_f | float | r | Åtkomst till bildens bredd, vilket ger viktig information för exakt <br/>            rendering och bearbetning. Hämta snabbt bildens bredd för att säkerställa kompatibilitet <br/>            och korrekt layout i olika applikationer och plattformar. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Hämtar eller anger Xmp-data. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| cache_data() | Cacha data effektivt och förhindra redundant laddning från den underliggande<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) med denna metod. Förbättra <br/>            prestanda och förenkla dataåtkomst i din applikation, optimera resursutnyttjandet <br/>            för förbättrad svarstid. |
...
| [get_original_options()](#get_original_options__30) | Hämtar de ursprungliga bildalternativen. |
...
| [get_used_fonts()](#get_used_fonts__34) | Hämta listan över teckensnitt som används i metafilen med denna metod. Få <br/>            insikt i teckensnittsanvändning, vilket underlättar effektiv hantering och optimering av teckensnitt <br/>            resurser för förbättrad rendering och bildkvalitet. |
...
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_48) | Ändra storlek på duken enkelt med denna funktion. Perfekt för att justera bildens totala <br/>            dimensioner utan att ändra dess innehåll. Förbättra presentationen och <br/>            förbered bilder för olika skärmstorlekar utan ansträngning. |
...
Börja arbeta med EMF-bilder genom att initiera en ny instans av<br/>            [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) klassen. Perfekt för att snabbt integrera EMF-bilder i<br/>            dina projekt med enkelhet och effektivitet.
...
Skapa en ny instans av [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) klassen genom att ange bredd <br/>            och höjdparametrar. Denna konstruktor förenklar processen att initiera <br/>            EMF-bilder med specifika dimensioner, vilket förbättrar effektiviteten i ditt utvecklingsarbetsflöde.
...
Hämta listan över teckensnitt som används i metafilen med denna metod. Få <br/>            insikt i teckensnittsanvändning, vilket underlättar effektiv hantering och optimering av teckensnitt <br/>            resurser för förbättrad rendering och bildkvalitet.
...
Ändra storlek på duken enkelt med denna funktion. Perfekt för att justera bildens totala <br/>            dimensioner utan att ändra dess innehåll. Förbättra presentationen och <br/>            förbered bilder för olika skärmstorlekar utan ansträngning.
