...
description: Inicializa una nueva instancia delImageMaskingaspose.imaging.masking/imagemasking clase.
type: docs
weight: 10
url: /es/net/aspose.imaging.masking/imagemasking/imagemasking/
---
## ImageMasking constructor

Inicializa una nueva instancia del[`ImageMasking`](../../imagemasking) clase.
...
| --- | --- | --- |
| sourceImage | RasterImage | La imagen de origen. |

### Excepciones

| excepción | condición |
| --- | --- |
| ArgumentNullException | la imagen de origen es nula. |
