...
description: Crea la sesión de enmascaramiento que puede realizar operaciones de descomposición de reentrenamiento.
type: docs
weight: 20
url: /es/net/aspose.imaging.masking/imagemasking/createsession/
---
## ImageMasking.CreateSession method

Crea la sesión de enmascaramiento que puede realizar operaciones de descomposición de reentrenamiento.
...
| --- | --- | --- |
| options | MaskingOptions | Las opciones. |
