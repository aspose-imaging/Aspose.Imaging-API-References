...
description: Aplica la máscara a la imagen de origen especificada.
type: docs
weight: 60
url: /es/net/aspose.imaging.masking/imagemasking/applymask/
---
## ImageMasking.ApplyMask method

Aplica la máscara a la imagen de origen especificada.
...
| --- | --- | --- |
| targetImage | RasterImage | La imagen de destino. |
| mask | RasterImage | La imagen de la máscara a aplicar. |
| maskingOptions | MaskingOptions | Las opciones de enmascaramiento. |
