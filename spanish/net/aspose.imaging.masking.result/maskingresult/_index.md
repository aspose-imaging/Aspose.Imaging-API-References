...
description: Clase abstracta base que puede proporcionar una imagen de resultado del sistema de enmascaramiento de imágenes.
type: docs
weight: 10540
url: /es/net/aspose.imaging.masking.result/maskingresult/
---
## MaskingResult class

Clase abstracta base que puede proporcionar una imagen de resultado del sistema de enmascaramiento de imágenes.
...
| [Item](../../aspose.imaging.masking.result/maskingresult/item) { get; } | Obtiene el[`IMaskingLayer`](../imaskinglayer) en el índice especificado. |
| abstract [Layers](../../aspose.imaging.masking.result/maskingresult/layers) { get; } | Obtiene las capas. |
| [Length](../../aspose.imaging.masking.result/maskingresult/length) { get; } | Obtiene la longitud. |
...
| [GetEnumerator](../../aspose.imaging.masking.result/maskingresult/getenumerator)() | Obtiene el enumerador. |

## Campos

| Nombre | Descripción |
| --- | --- |
| readonly [MaskingOptions](../../aspose.imaging.masking.result/maskingresult/maskingoptions) | Las opciones de enmascaramiento |
...
* espacio de nombres [Aspose.Imaging.Masking.Result](../../aspose.imaging.masking.result)
