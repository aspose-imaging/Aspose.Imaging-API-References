...
description: Dibuja el bezier cúbico.
type: docs
weight: 30
url: /es/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawcubicbezier/
---
...
| --- | --- | --- |
| pen | Pen | El bolígrafo que determina el color, el ancho y el estilo de la figura. |
| pt1 | PointF | El punto de partida de la curva. |
| pt2 | PointF | El primer punto de control de la curva. |
| pt3 | PointF | El segundo punto de control de la curva. |
| pt4 | PointF | El punto final de la curva. |
