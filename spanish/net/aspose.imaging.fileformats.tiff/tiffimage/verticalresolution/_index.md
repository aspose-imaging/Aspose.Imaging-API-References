...
description: Obtiene la resolución vertical en píxeles por pulgada de esteImageaspose.imaging/image .
type: docs
weight: 120
url: /es/net/aspose.imaging.fileformats.tiff/tiffimage/verticalresolution/
---
## TiffImage.VerticalResolution property

Obtiene la resolución vertical, en píxeles por pulgada, de este[`Image`](../../../aspose.imaging/image) .
