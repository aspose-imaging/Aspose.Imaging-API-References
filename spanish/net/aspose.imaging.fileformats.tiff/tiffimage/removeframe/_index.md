...
description: Elimina el marco por su índice.
type: docs
weight: 310
url: /es/net/aspose.imaging.fileformats.tiff/tiffimage/removeframe/
---
## RemoveFrame(int) {#removeframe}

Elimina el marco por su índice.
...
| --- | --- | --- |
| index | Int32 | Índice del fotograma que se va a eliminar. |
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| frame | TiffFrame | El marco para quitar. |
