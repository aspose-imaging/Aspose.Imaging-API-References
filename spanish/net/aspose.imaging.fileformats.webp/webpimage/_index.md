...
description: Una imagen webp.
type: docs
weight: 8080
url: /es/net/aspose.imaging.fileformats.webp/webpimage/
---
## WebPImage class
...
| Nombre | Descripción |
| --- | --- |
| [WebPImage](webpimage#constructor)(RasterImage) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) clase de rasterImage. |
| [WebPImage](webpimage#constructor_4)(Stream) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) class de stream. |
| [WebPImage](webpimage#constructor_6)(string) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) clase del archivo. |
| [WebPImage](webpimage#constructor_1)(RasterImage, LoadOptions) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) clase de rasterImage. |
| [WebPImage](webpimage#constructor_5)(Stream, LoadOptions) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) clase de stream. |
| [WebPImage](webpimage#constructor_7)(string, LoadOptions) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) clase del archivo. |
| [WebPImage](webpimage#constructor_2)(int, int, WebPOptions) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) clase con imagen vacía. |
| [WebPImage](webpimage#constructor_3)(int, int, WebPOptions, LoadOptions) | Inicializa una nueva instancia del[`WebPImage`](../webpimage) clase con imagen vacía. |
...
| override [FileFormat](../../aspose.imaging.fileformats.webp/webpimage/fileformat) { get; } | Obtiene un valor de formato de archivo |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpimage/hasalpha) { get; } | Obtiene el canal Tiene alfa. |
...
| [Options](../../aspose.imaging.fileformats.webp/webpimage/options) { get; } | Obtiene o establece las opciones. |
| override [PageCount](../../aspose.imaging.fileformats.webp/webpimage/pagecount) { get; } | Obtiene el número de páginas. |
| override [PageExportingAction](../../aspose.imaging.fileformats.webp/webpimage/pageexportingaction) { get; set; } | Obtiene o establece la acción de exportación de la página. Tenga en cuenta que configurar este método liberará automáticamente los recursos de la página después de ejecutarlo. Se ejecutará justo antes de que se guarde cada página. |
| override [Pages](../../aspose.imaging.fileformats.webp/webpimage/pages) { get; } | Obtiene los bloques. |
...
| Nombre | Descripción |
| --- | --- |
| [AddBlock](../../aspose.imaging.fileformats.webp/webpimage/addblock)(IFrame) | Agrega un nuevo bloque Webp. |
| [AddPage](../../aspose.imaging.fileformats.webp/webpimage/addpage)(RasterImage) | Agrega página a la imagen. |
| override [AdjustBrightness](../../aspose.imaging.fileformats.webp/webpimage/adjustbrightness)(int) | Ajuste de un*brightness* para imagen. |
| override [AdjustContrast](../../aspose.imaging.fileformats.webp/webpimage/adjustcontrast)(float) | [`Image`](../../aspose.imaging/image) contrastando |
| override [AdjustGamma](../../aspose.imaging.fileformats.webp/webpimage/adjustgamma#adjustgamma)(float) | Corrección gamma de una imagen. |
| override [AdjustGamma](../../aspose.imaging.fileformats.webp/webpimage/adjustgamma#adjustgamma_1)(float, float, float) | Corrección gamma de una imagen. |
...
| override [BinarizeBradley](../../aspose.imaging.fileformats.webp/webpimage/binarizebradley#binarizebradley_1)(double, int) | Binarización de una imagen usando el algoritmo de umbral adaptativo de Bradley usando el umbral de imagen integral |
| override [BinarizeFixed](../../aspose.imaging.fileformats.webp/webpimage/binarizefixed)(byte) | Binarización de una imagen con umbral predefinido |
| override [BinarizeOtsu](../../aspose.imaging.fileformats.webp/webpimage/binarizeotsu)() | Binarización de una imagen con umbral Otsu |
...
| [ClearBlocks](../../aspose.imaging.fileformats.webp/webpimage/clearblocks)() | Borra todos los bloques Webp. |
| override [Crop](../../aspose.imaging.fileformats.webp/webpimage/crop#crop)(Rectangle) | Recortando la imagen. |
| override [Crop](../../aspose.imaging.fileformats.webp/webpimage/crop#crop_1)(int, int, int, int) | Recortar imagen con turnos. |
...
| override [Dither](../../aspose.imaging.fileformats.webp/webpimage/dither#dither_1)(DitheringMethod, int, IColorPalette) | Realiza tramado en la imagen actual. |
| override [Filter](../../aspose.imaging.fileformats.webp/webpimage/filter)(Rectangle, FilterOptionsBase) | Filtra el rectángulo especificado. |
...
| override [Grayscale](../../aspose.imaging.fileformats.webp/webpimage/grayscale)() | Transformación de una imagen a su representación en escala de grises |
| [InsertBlock](../../aspose.imaging.fileformats.webp/webpimage/insertblock)(int, IFrame) | Agrega un nuevo bloque Webp. |
...
| [RemoveBlock](../../aspose.imaging.fileformats.webp/webpimage/removeblock)(IFrame) | Elimina el bloque Webp. |
...
| override [Resize](../../aspose.imaging.fileformats.webp/webpimage/resize#resize_1)(int, int, ImageResizeSettings) | Cambia el tamaño de la imagen. |
| override [Resize](../../aspose.imaging.fileformats.webp/webpimage/resize#resize_2)(int, int, ResizeType) | Cambia el tamaño de la imagen. |
...
| override [ResizeHeightProportionally](../../aspose.imaging.fileformats.webp/webpimage/resizeheightproportionally#resizeheightproportionally_2)(int, ResizeType) | Cambia el tamaño del ancho proporcionalmente. |
...
| override [ResizeWidthProportionally](../../aspose.imaging.fileformats.webp/webpimage/resizewidthproportionally#resizewidthproportionally_2)(int, ResizeType) | Cambia el tamaño del ancho proporcionalmente. |
| virtual [Rotate](../../aspose.imaging/rasterimage/rotate)(float) | Rotar imagen alrededor del centro. |
| override [Rotate](../../aspose.imaging.fileformats.webp/webpimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate imagen alrededor del centro. |
| override [RotateFlip](../../aspose.imaging.fileformats.webp/webpimage/rotateflip)(RotateFlipType) | Gira, voltea o gira y voltea solo el marco activo. |
