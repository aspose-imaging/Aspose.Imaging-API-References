...
type: docs
weight: 8070
url: /es/net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| Nombre | Descripción |
| --- | --- |
| [WebPFrameBlock](webpframeblock#constructor)(RasterImage) | Inicializa una nueva instancia del[`WebPFrameBlock`](../webpframeblock) |
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | Inicializa una nueva instancia del[`WebPFrameBlock`](../webpframeblock) clase. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | Obtiene el método de eliminación. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Obtiene un valor que indica si esta instancia se desecha. |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration) { get; set; } | Obtiene o establece la duración del marco. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | Obtiene un valor de formato de archivo |
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft) { get; } | Obtiene el desplazamiento a la izquierda del fotograma. |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime) { get; } | Obtiene la duración del cuadro. |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | Obtiene el desplazamiento superior del marco. |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | Obtiene un valor que indica si esta instancia tiene alfa. |
...
| override [Height](../../aspose.imaging.fileformats.webp/webpframeblock/height) { get; } | Obtiene la altura de la imagen. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | Obtiene o establece la posición del fotograma a la izquierda. |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | Obtiene o establece la posición superior del marco. |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width) { get; } | Obtiene el ancho de la imagen. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe)() | Obtiene el fotograma completo. |
