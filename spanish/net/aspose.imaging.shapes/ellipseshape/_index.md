...
type: docs
weight: 10980
url: /es/net/aspose.imaging.shapes/ellipseshape/
---
## EllipseShape class
...
| Nombre | Descripción |
| --- | --- |
| [EllipseShape](ellipseshape#constructor)() | Inicializa una nueva instancia del[`EllipseShape`](../ellipseshape) clase. |
| [EllipseShape](ellipseshape#constructor_1)(RectangleF) | Inicializa una nueva instancia del[`EllipseShape`](../ellipseshape) clase. |
...
| override [Segments](../../aspose.imaging.shapes/ellipseshape/segments) { get; } | Obtiene los segmentos de forma. |
