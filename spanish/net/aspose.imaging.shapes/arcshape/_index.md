...
type: docs
weight: 10950
url: /es/net/aspose.imaging.shapes/arcshape/
---
## ArcShape class
...
| Nombre | Descripción |
| --- | --- |
| [ArcShape](arcshape#constructor)() | Inicializa una nueva instancia del[`ArcShape`](../arcshape) clase. |
| [ArcShape](arcshape#constructor_1)(RectangleF, float, float) | Inicializa una nueva instancia del[`ArcShape`](../arcshape) clase. |
| [ArcShape](arcshape#constructor_2)(RectangleF, float, float, bool) | Inicializa una nueva instancia del[`ArcShape`](../arcshape) clase. |
...
| [EndPoint](../../aspose.imaging.shapes/arcshape/endpoint) { get; } | Obtiene el punto de forma final. |
...
| [IsClosed](../../aspose.imaging.shapes/arcshape/isclosed) { get; set; } | Obtiene o establece un valor que indica si la forma ordenada está cerrada. Cuando se procesa una forma ordenada cerrada, los puntos inicial y final no tienen significado. |
...
| override [Segments](../../aspose.imaging.shapes/arcshape/segments) { get; } | Obtiene los segmentos de forma. |
| [StartAngle](../../aspose.imaging.shapes/pieshape/startangle) { get; set; } | Obtiene o establece el ángulo de inicio. |
| [StartPoint](../../aspose.imaging.shapes/arcshape/startpoint) { get; } | Obtiene el punto de forma inicial. |
| [SweepAngle](../../aspose.imaging.shapes/pieshape/sweepangle) { get; set; } | Obtiene o establece el ángulo de barrido. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| override [GetBounds](../../aspose.imaging.shapes/arcshape/getbounds#getbounds)(Matrix) | Obtiene los límites del objeto. |
| override [GetBounds](../../aspose.imaging.shapes/arcshape/getbounds#getbounds_1)(Matrix, Pen) | Obtiene los límites del objeto. |
| [Reverse](../../aspose.imaging.shapes/arcshape/reverse)() | Invierte el orden de los puntos de esta forma. |
