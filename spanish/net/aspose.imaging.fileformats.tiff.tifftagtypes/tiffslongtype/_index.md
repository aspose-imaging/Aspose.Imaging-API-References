...
description: El tiff firmó tipo largo.
type: docs
weight: 8000
url: /es/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
## TiffSLongType class

El tiff firmó tipo largo.
...
| Nombre | Descripción |
| --- | --- |
| [TiffSLongType](tiffslongtype#constructor)(TiffTags) | Inicializa una nueva instancia del[`TiffSLongType`](../tiffslongtype) clase. |
| [TiffSLongType](tiffslongtype#constructor_1)(ushort) | Inicializa una nueva instancia del[`TiffSLongType`](../tiffslongtype) clase. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/elementsize) { get; } | Obtiene el tamaño del elemento en bytes. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/tagtype) { get; } | Obtiene el tipo de etiqueta. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/value) { get; set; } | Obtiene o establece el valor que contiene este tipo de datos. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/values) { get; set; } | Obtiene o establece los valores. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/valuescontainer) { get; } | Obtiene el contenedor de valores. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/writeadditionaldata)(TiffStreamWriter) | Escribe los datos adicionales de la etiqueta. |
