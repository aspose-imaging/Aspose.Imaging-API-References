...
description: El tipo de byte con firma tiff.
type: docs
weight: 7990
url: /es/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/
---
## TiffSByteType class

El tipo de byte con firma tiff.
...
| Nombre | Descripción |
| --- | --- |
| [TiffSByteType](tiffsbytetype#constructor)(TiffTags) | Inicializa una nueva instancia del[`TiffSByteType`](../tiffsbytetype) clase. |
| [TiffSByteType](tiffsbytetype#constructor_1)(ushort) | Inicializa una nueva instancia del[`TiffSByteType`](../tiffsbytetype) clase. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/elementsize) { get; } | Obtiene el tamaño del elemento en bytes. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/tagtype) { get; } | Obtiene el tipo de etiqueta. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/value) { get; set; } | Obtiene o establece el valor que contiene este tipo de datos. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/values) { get; set; } | Obtiene o establece los valores. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/valuescontainer) { get; } | Obtiene el contenedor de valores. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/writeadditionaldata)(TiffStreamWriter) | Escribe los datos adicionales de la etiqueta. |
