...
description: El tipo tiff doble.
type: docs
weight: 7940
url: /es/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
| Nombre | Descripción |
| --- | --- |
| [TiffDoubleType](tiffdoubletype#constructor)(TiffTags) | Inicializa una nueva instancia del[`TiffDoubleType`](../tiffdoubletype) clase. |
| [TiffDoubleType](tiffdoubletype#constructor_1)(ushort) | Inicializa una nueva instancia del[`TiffDoubleType`](../tiffdoubletype) clase. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/elementsize) { get; } | Obtiene el tamaño del elemento en bytes. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/tagtype) { get; } | Obtiene el tipo de etiqueta. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/value) { get; set; } | Obtiene o establece el valor que contiene este tipo de datos. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/values) { get; set; } | Obtiene o establece los valores. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/valuescontainer) { get; } | Obtiene el contenedor de valores. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/writeadditionaldata)(TiffStreamWriter) | Escribe los datos adicionales de la etiqueta. |
