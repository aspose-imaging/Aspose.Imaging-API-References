...
description: El tipo tiff corto.
type: docs
weight: 8030
url: /es/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/
---
## TiffShortType class
...
| Nombre | Descripción |
| --- | --- |
| [TiffShortType](tiffshorttype#constructor)(TiffTags) | Inicializa una nueva instancia del[`TiffShortType`](../tiffshorttype) clase. |
| [TiffShortType](tiffshorttype#constructor_1)(ushort) | Inicializa una nueva instancia del[`TiffShortType`](../tiffshorttype) clase. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/elementsize) { get; } | Obtiene el tamaño del elemento en bytes. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/tagtype) { get; } | Obtiene el tipo de etiqueta. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/value) { get; set; } | Obtiene o establece el valor que contiene este tipo de datos. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/values) { get; set; } | Obtiene o establece los datos. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/valuescontainer) { get; } | Obtiene el contenedor de valores. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/writeadditionaldata)(TiffStreamWriter) | Escribe los datos adicionales de la etiqueta. |
