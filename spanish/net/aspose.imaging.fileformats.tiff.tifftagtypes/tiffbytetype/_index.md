...
description: El tipo de byte tiff.
type: docs
weight: 7920
url: /es/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/
---
## TiffByteType class

El tipo de byte tiff.
...
| Nombre | Descripción |
| --- | --- |
| [TiffByteType](tiffbytetype#constructor)(TiffTags) | Inicializa una nueva instancia del[`TiffByteType`](../tiffbytetype) clase. |
| [TiffByteType](tiffbytetype#constructor_1)(ushort) | Inicializa una nueva instancia del[`TiffByteType`](../tiffbytetype) clase. |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/elementsize) { get; } | Obtiene el tamaño del elemento en bytes. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/tagtype) { get; } | Obtiene el tipo de etiqueta. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/value) { get; set; } | Obtiene o establece el valor que contiene este tipo de datos. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/values) { get; set; } | Obtiene o establece los valores. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/valuescontainer) { get; } | Obtiene el contenedor de valores. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/writeadditionaldata)(TiffStreamWriter) | Escribe los datos adicionales de la etiqueta. |
