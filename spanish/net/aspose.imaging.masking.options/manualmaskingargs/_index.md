...
description: Representa los argumentos que se especifican para el método de enmascaramiento manual
type: docs
weight: 10500
url: /es/net/aspose.imaging.masking.options/manualmaskingargs/
---
## ManualMaskingArgs class

Representa los argumentos que se especifican para el método de enmascaramiento manual
...
| Nombre | Descripción |
| --- | --- |
| [ManualMaskingArgs](manualmaskingargs)() | Constructor predeterminado |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Mask](../../aspose.imaging.masking.options/manualmaskingargs/mask) { get; set; } | Obtiene o establece el conjunto de formas gráficas que forman mask. |
