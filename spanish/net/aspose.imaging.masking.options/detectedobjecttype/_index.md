...
description: La enumeración de tipos de objetos detectados.
type: docs
weight: 10470
url: /es/net/aspose.imaging.masking.options/detectedobjecttype/
---
## DetectedObjectType enumeration

La enumeración de tipos de objetos detectados.
...
| --- | --- | --- |
| Human | `0` | El tipo de objeto humano. |
| Other | `1` | Otro tipo de objeto. |
