...
description: Representa las opciones comunes de enmascaramiento de imágenes.
type: docs
weight: 10510
url: /es/net/aspose.imaging.masking.options/maskingoptions/
---
## MaskingOptions class

Representa las opciones comunes de enmascaramiento de imágenes.
...
| Nombre | Descripción |
| --- | --- |
| [MaskingOptions](maskingoptions)() | Constructor predeterminado |
...
| Nombre | Descripción |
| --- | --- |
| const [BackgroundObjectNumber](../../aspose.imaging.masking.options/maskingoptions/backgroundobjectnumber) | El número de objeto de fondo |
