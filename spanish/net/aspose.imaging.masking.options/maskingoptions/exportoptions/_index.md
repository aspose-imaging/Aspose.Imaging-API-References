...
description: Obtiene o establece las opciones de exportación de imágenes.
type: docs
weight: 50
url: /es/net/aspose.imaging.masking.options/maskingoptions/exportoptions/
---
## MaskingOptions.ExportOptions property

Obtiene o establece las opciones de exportación de imágenes.
...
Las opciones de exportación de imágenes que se utilizarán para crear las imágenes resultantes.
