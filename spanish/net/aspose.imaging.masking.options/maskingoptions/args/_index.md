...
description: Obtiene o establece los argumentos para el algoritmo de segmentación.
type: docs
weight: 20
url: /es/net/aspose.imaging.masking.options/maskingoptions/args/
---
## MaskingOptions.Args property

Obtiene o establece los argumentos para el algoritmo de segmentación.
...
Los argumentos para el algoritmo de segmentación.
