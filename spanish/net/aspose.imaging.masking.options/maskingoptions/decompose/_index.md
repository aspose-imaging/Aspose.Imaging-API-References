...
description: Obtiene o establece un valor que indica si es necesario separar cada Forma de la máscara como objeto individual o como objeto unido de la máscara separada del fondo.
type: docs
weight: 40
url: /es/net/aspose.imaging.masking.options/maskingoptions/decompose/
---
## MaskingOptions.Decompose property

Obtiene o establece un valor que indica si es necesario separar cada Forma de la máscara como objeto individual o como objeto unido de la máscara separada del fondo.
...
`verdadero`si se descompone; de lo contrario,`falso` .
