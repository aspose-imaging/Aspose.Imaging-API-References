...
description: Obtiene o establece el color de reemplazo de fondo.
type: docs
weight: 30
url: /es/net/aspose.imaging.masking.options/maskingoptions/backgroundreplacementcolor/
---
## MaskingOptions.BackgroundReplacementColor property

Obtiene o establece el color de reemplazo de fondo.
...
El color de reemplazo de fondo. Este color se utilizará como color de fondo en las imágenes resultantes.
