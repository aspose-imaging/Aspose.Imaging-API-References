...
description: Obtiene o establece el número máximo de iteraciones.
type: docs
weight: 20
url: /es/net/aspose.imaging.masking.options/automaskingargs/maxiterationnumber/
---
## AutoMaskingArgs.MaxIterationNumber property

Obtiene o establece el número máximo de iteraciones.
...
El número máximo máximo de iteraciones.
