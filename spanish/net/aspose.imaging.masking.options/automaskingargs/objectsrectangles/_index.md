...
description: Obtiene o establece los rectángulos de objetos que pertenecen a objetos separados opcional. Este parámetro se utiliza para aumentar la precisión del método de segmentación.
type: docs
weight: 50
url: /es/net/aspose.imaging.masking.options/automaskingargs/objectsrectangles/
---
## AutoMaskingArgs.ObjectsRectangles property

Obtiene o establece los rectángulos de objetos que pertenecen a objetos separados (opcional). Este parámetro se utiliza para aumentar la precisión del método de segmentación.
