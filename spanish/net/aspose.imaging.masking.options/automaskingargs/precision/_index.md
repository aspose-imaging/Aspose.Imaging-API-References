...
description: Obtiene o establece la precisión del método de segmentación opcional.
type: docs
weight: 70
url: /es/net/aspose.imaging.masking.options/automaskingargs/precision/
---
## AutoMaskingArgs.Precision property

Obtiene o establece la precisión del método de segmentación (opcional).
...
La precisión del método de segmentación (opcional).
