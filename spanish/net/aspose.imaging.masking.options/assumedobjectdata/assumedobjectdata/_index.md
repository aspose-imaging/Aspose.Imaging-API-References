...
description: Inicializa una nueva instancia delAssumedObjectDataaspose.imaging.masking.options/assumedobjectdata clase.
type: docs
weight: 10
url: /es/net/aspose.imaging.masking.options/assumedobjectdata/assumedobjectdata/
---
## AssumedObjectData() {#constructor}

Inicializa una nueva instancia del[`AssumedObjectData`](../../assumedobjectdata) clase.
...
| --- | --- | --- |
| type | DetectedObjectType | El tipo de objeto. |
| bounds | Rectangle | Los límites del objeto. |
