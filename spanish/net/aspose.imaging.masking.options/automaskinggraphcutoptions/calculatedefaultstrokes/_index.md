...
description: Obtiene o establece un valor que indica si se deben calcular los trazos predeterminados.
type: docs
weight: 30
url: /es/net/aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes/
---
## AutoMaskingGraphCutOptions.CalculateDefaultStrokes property

Obtiene o establece un valor que indica si se deben calcular los trazos predeterminados.
