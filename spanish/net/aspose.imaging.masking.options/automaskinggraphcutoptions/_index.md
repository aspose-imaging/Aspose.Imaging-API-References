...
type: docs
weight: 10460
url: /es/net/aspose.imaging.masking.options/automaskinggraphcutoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [AutoMaskingGraphCutOptions](automaskinggraphcutoptions)() | Constructor predeterminado |
...
| [AssumedObjects](../../aspose.imaging.masking.options/automaskinggraphcutoptions/assumedobjects) { get; set; } | Obtiene o establece los objetos supuestos. |
...
| [CalculateDefaultStrokes](../../aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes) { get; set; } | Obtiene o establece un valor que indica si se deben calcular los trazos predeterminados. |
...
| [DefaultBackgroundStrokes](../../aspose.imaging.masking.options/automaskinggraphcutoptions/defaultbackgroundstrokes) { get; } | Obtiene los trazos de fondo predeterminados. |
| [DefaultForegroundStrokes](../../aspose.imaging.masking.options/automaskinggraphcutoptions/defaultforegroundstrokes) { get; } | Obtiene los trazos de primer plano predeterminados precalculados. |
| [DefaultObjectsRectangles](../../aspose.imaging.masking.options/automaskinggraphcutoptions/defaultobjectsrectangles) { get; } | Obtiene los objetos predeterminados rectángulos. |
...
| [PrecalculationProgressEventHandler](../../aspose.imaging.masking.options/automaskinggraphcutoptions/precalculationprogresseventhandler) { get; set; } | Obtiene o establece el controlador de eventos de progreso del proceso de cálculo previo de puntos predeterminado. |
