...
description: Obtiene la máscara de bits que describe el orden de los píxeles de color en la matriz.
type: docs
weight: 50
url: /es/net/aspose.imaging.fileformats.dng.decoder/imageparameters/filters/
---
