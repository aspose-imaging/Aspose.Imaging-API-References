...
description: Clase para formato PostScript encapsulado con encabezado binario
type: docs
weight: 6550
url: /es/net/aspose.imaging.fileformats.eps/epsbinaryimage/
---
## EpsBinaryImage class

Clase para formato PostScript encapsulado con encabezado binario
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsbinaryimage/epstype) { get; } | Obtiene el valor del subtipo EPS |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/hasrasterpreview) { get; } | Obtiene un valor que indica si esta instancia tiene una vista previa de ráster específica del formato |
...
| [TiffPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/tiffpreview) { get; } | Obtiene la vista previa TIFF. |
...
| [WmfPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/wmfpreview) { get; } | Obtiene la vista previa de WMF. |
...
| [ConvertToInterchange](../../aspose.imaging.fileformats.eps/epsbinaryimage/converttointerchange)() | Convierte esta instancia en[`EpsInterchangeImage`](../epsinterchangeimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsbinaryimage/op_explicit) | Realiza una conversión explícita de[`EpsInterchangeImage`](../epsinterchangeimage) a[`EpsBinaryImage`](../epsbinaryimage) |
