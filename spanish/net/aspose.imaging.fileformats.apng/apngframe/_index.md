...
description: La imagen PNG animada frame
type: docs
weight: 1310
url: /es/net/aspose.imaging.fileformats.apng/apngframe/
---
## ApngFrame class

La imagen PNG animada frame
...
| override [BackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/backgroundcolor) { get; set; } | Obtiene el color de fondo. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.apng/apngframe/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.apng/apngframe/disposalmethod) { get; } | Obtiene el método de eliminación. |
...
| [FrameLeft](../../aspose.imaging.fileformats.apng/apngframe/frameleft) { get; } | Obtiene el desplazamiento a la izquierda del fotograma. |
| [FrameTime](../../aspose.imaging.fileformats.apng/apngframe/frametime) { get; set; } | Obtiene o establece la duración del marco. |
| [FrameTop](../../aspose.imaging.fileformats.apng/apngframe/frametop) { get; } | Obtiene el desplazamiento superior del marco. |
| override [HasAlpha](../../aspose.imaging.fileformats.apng/apngframe/hasalpha) { get; } | Obtiene un valor que indica si esta instancia tiene alfa. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/hasbackgroundcolor) { get; set; } | Obtiene un valor que indica si tiene color de fondo. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.apng/apngframe/hastransparentcolor) { get; set; } | Obtiene un valor que indica si la imagen tiene color transparente. |
| override [Height](../../aspose.imaging.fileformats.apng/apngframe/height) { get; } | Obtiene la altura de la imagen. |
...
| override [TransparentColor](../../aspose.imaging.fileformats.apng/apngframe/transparentcolor) { get; set; } | Obtiene el color transparente. |
...
| override [Width](../../aspose.imaging.fileformats.apng/apngframe/width) { get; } | Obtiene el ancho de la imagen. |
...
| override [CacheData](../../aspose.imaging.fileformats.apng/apngframe/cachedata)() | Almacena en caché los datos y garantiza que no se realizará ninguna carga de datos adicional desde el servidor subyacente.[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| [GetFullFrame](../../aspose.imaging.fileformats.apng/apngframe/getfullframe)() | Obtiene el fotograma completo. |
