...
description: El perfil de color RGB para imágenes jpeg CMYK e YCCK. Debe estar en pareja con CMYKColorProfile para una conversión de color correcta.
type: docs
weight: 150
url: /es/net/aspose.imaging.fileformats.jpeg/jpegimage/rgbcolorprofile/
---
## JpegImage.RgbColorProfile property

El perfil de color RGB para imágenes jpeg CMYK e YCCK. Debe estar en pareja con CMYKColorProfile para una conversión de color correcta.
