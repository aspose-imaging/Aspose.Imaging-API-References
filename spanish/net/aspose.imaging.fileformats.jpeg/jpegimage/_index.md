...
description: Una imagen jpeg.
type: docs
weight: 6770
url: /es/net/aspose.imaging.fileformats.jpeg/jpegimage/
---
## JpegImage class
...
| Nombre | Descripción |
| --- | --- |
| [JpegImage](jpegimage#constructor_1)(RasterImage) | Inicializa una nueva instancia del[`JpegImage`](../jpegimage) clase. |
| [JpegImage](jpegimage#constructor_3)(Stream) | Inicializa una nueva instancia del[`JpegImage`](../jpegimage) clase. |
| [JpegImage](jpegimage#constructor_4)(string) | Inicializa una nueva instancia del[`JpegImage`](../jpegimage) clase. |
| [JpegImage](jpegimage#constructor_2)(int, int) | Inicializa una nueva instancia del[`JpegImage`](../jpegimage) clase. |
| [JpegImage](jpegimage#constructor)(JpegOptions, int, int) | Inicializa una nueva instancia del[`JpegImage`](../jpegimage) clase. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg/jpegimage/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| [CmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/cmykcolorprofile) { get; set; } | El perfil de color CMYK para imágenes jpeg CMYK e YCCK. Debe estar en pareja con RGBColorProfile para una conversión de color correcta. |
| [Comment](../../aspose.imaging.fileformats.jpeg/jpegimage/comment) { get; set; } | Obtiene o establece el comentario del archivo jpeg. |
...
| [DestinationCmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationcmykcolorprofile) { get; set; } | El perfil de color CMYK para imágenes jpeg CMYK e YCCK, utilizado para el proceso de guardado de imágenes. Debe estar en pareja con RGBColorProfile para una conversión de color correcta. |
| [DestinationRgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationrgbcolorprofile) { get; set; } | El perfil de color RGB para imágenes jpeg CMYK e YCCK, utilizado para el proceso de guardado de imágenes. Debe estar en pareja con CMYKColorProfile para una conversión de color correcta. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Obtiene un valor que indica si esta instancia se desecha. |
| [ExifData](../../aspose.imaging.fileformats.jpeg/jpegimage/exifdata) { get; set; } | Obtener o configurar el contenedor de datos exif |
| override [FileFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/fileformat) { get; } | Obtiene un valor de formato de archivo |
...
| override [Height](../../aspose.imaging.fileformats.jpeg/jpegimage/height) { get; } | Obtiene la altura de la imagen. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/horizontalresolution) { get; set; } | Obtiene o establece la resolución horizontal, en píxeles por pulgada, de este[`RasterImage`](../../aspose.imaging/rasterimage) . |
| [IgnoreEmbeddedColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/ignoreembeddedcolorprofile) { get; set; } | Obtiene o establece un valor que indica si se ignora el perfil de color incrustado. Si se ignora el perfil de color incrustado, se utiliza el perfil de color predeterminado. |
...
| [Jfif](../../aspose.imaging.fileformats.jpeg/jpegimage/jfif) { get; set; } | Obtiene o establece el jfif. |
| [JpegOptions](../../aspose.imaging.fileformats.jpeg/jpegimage/jpegoptions) { get; } | Obtiene las opciones de JPEG utilizadas para crear o cargar este[`JpegImage`](../jpegimage) instancia. |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/rawdataformat) { get; } | Obtiene el formato de datos sin procesar. |
...
| [RgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/rgbcolorprofile) { get; set; } | El perfil de color RGB para imágenes jpeg CMYK e YCCK. Debe estar en pareja con CMYKColorProfile para una conversión de color correcta. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/verticalresolution) { get; set; } | Obtiene o establece la resolución vertical, en píxeles por pulgada, de este[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.jpeg/jpegimage/width) { get; } | Obtiene el ancho de la imagen. |
| override [XmpData](../../aspose.imaging.fileformats.jpeg/jpegimage/xmpdata) { get; set; } | Obtiene o establece los metadatos XMP. |
...
| [AutoRotate](../../aspose.imaging.fileformats.jpeg/jpegimage/autorotate)() | Realiza la rotación automática de la imagen según los datos de orientación proporcionados por Exif. |
...
| override [GetModifyDate](../../aspose.imaging.fileformats.jpeg/jpegimage/getmodifydate)(bool) | Obtiene la fecha y la hora en que se modificó por última vez la imagen del recurso. |
...
| override [SetResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/setresolution)(double, double) | Establece la resolución para este[`RasterImage`](../../aspose.imaging/rasterimage) . |
