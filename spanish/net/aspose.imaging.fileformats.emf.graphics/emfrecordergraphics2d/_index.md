...
description: Los gráficos de la grabadora Emf
type: docs
weight: 6490
url: /es/net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/
---
## EmfRecorderGraphics2D class

Los gráficos de la grabadora Emf
...
| Nombre | Descripción |
| --- | --- |
| [EmfRecorderGraphics2D](emfrecordergraphics2d)(Rectangle, Size, Size) | Inicializa una nueva instancia del[`EmfRecorderGraphics2D`](../emfrecordergraphics2d) clase. |
...
| [BackgroundMode](../../aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/backgroundmode) { get; set; } | Obtiene o establece el modo de fondo. |
...
| Nombre | Descripción |
| --- | --- |
| static [FromEmfImage](../../aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/fromemfimage)(EmfImage) | Obtiene una instancia del[`EmfRecorderGraphics2D`](../emfrecordergraphics2d) que contiene todos los registros de la imagen Emf. |
...
| [EndRecording](../../aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/endrecording)() | Finaliza la grabación. |
