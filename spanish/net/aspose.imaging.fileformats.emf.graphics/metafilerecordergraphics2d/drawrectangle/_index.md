...
description: Dibuja el rectángulo.
type: docs
weight: 150
url: /es/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawrectangle/
---
...
| width | Int32 | El ancho del rectángulo a dibujar. |
| height | Int32 | La altura del rectángulo a dibujar. |
...
| --- | --- | --- |
| pen | Pen | Bolígrafo que determina el color, ancho y estilo de la figura. |
| rectangle | Rectangle | El rectángulo a dibujar. |
