...
description: Dibuja un arco que representa una parte de una elipse especificada por una estructura Rectangle.
type: docs
weight: 50
url: /es/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawarc/
---
## MetafileRecorderGraphics2D.DrawArc method

Dibuja un arco que representa una parte de una elipse especificada por una estructura Rectangle.
...
| arcAngle | Single | Ángulo en grados medido en el sentido de las agujas del reloj desde el parámetro startAngle hasta el punto final del arco. |
