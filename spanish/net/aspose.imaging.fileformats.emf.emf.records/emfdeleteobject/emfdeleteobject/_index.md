...
description: Inicializa una nueva instancia delEmfDeleteObjectaspose.imaging.fileformats.emf.emf.records/emfdeleteobject clase.
type: docs
weight: 10
url: /es/net/aspose.imaging.fileformats.emf.emf.records/emfdeleteobject/emfdeleteobject/
---
## EmfDeleteObject(EmfRecord) {#constructor_1}

Inicializa una nueva instancia del[`EmfDeleteObject`](../../emfdeleteobject) clase.
