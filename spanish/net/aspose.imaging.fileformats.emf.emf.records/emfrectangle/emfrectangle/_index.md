...
description: Inicializa una nueva instancia delEmfRectangleaspose.imaging.fileformats.emf.emf.records/emfrectangle clase.
type: docs
weight: 10
url: /es/net/aspose.imaging.fileformats.emf.emf.records/emfrectangle/emfrectangle/
---
## EmfRectangle(EmfRecord) {#constructor_1}

Inicializa una nueva instancia del[`EmfRectangle`](../../emfrectangle) clase.
