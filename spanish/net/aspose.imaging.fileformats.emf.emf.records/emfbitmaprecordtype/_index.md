...
description: Los tipos de registro de mapa de bits realizan transferencias en bloque de imágenes de mapa de bits.
type: docs
weight: 3260
url: /es/net/aspose.imaging.fileformats.emf.emf.records/emfbitmaprecordtype/
---
## EmfBitmapRecordType class

Los tipos de registro de mapa de bits realizan transferencias en bloque de imágenes de mapa de bits.
