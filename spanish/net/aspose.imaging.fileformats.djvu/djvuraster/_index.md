...
description: Clase para representar la imagen ráster de Djvu donde se encuentra el resultado de alguna operación
type: docs
weight: 2460
url: /es/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

Clase para representar la imagen ráster de Djvu donde se encuentra el resultado de alguna operación
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | Obtiene la altura. |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | Obtiene la longitud. |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | Obtiene el ancho. |
