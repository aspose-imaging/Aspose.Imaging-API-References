...
description: Las opciones de rasterización Od
type: docs
weight: 10070
url: /es/net/aspose.imaging.imageoptions/odrasterizationoptions/
---
## OdRasterizationOptions class

Las opciones de rasterización Od
...
| Nombre | Descripción |
| --- | --- |
| [OdRasterizationOptions](odrasterizationoptions)() | Constructor predeterminado |
