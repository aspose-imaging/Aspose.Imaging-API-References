...
description: El nivel de compresión de la imagen png en el rango de 0-9 donde 9 es la compresión máxima y 0 es el modo de almacenamiento.
type: docs
weight: 40
url: /es/net/aspose.imaging.imageoptions/pngoptions/compressionlevel/
---
## PngOptions.CompressionLevel property

El nivel de compresión de la imagen png en el rango de 0-9, donde 9 es la compresión máxima y 0 es el modo de almacenamiento.
