...
type: docs
weight: 1910
url: /es/net/aspose.imaging.fileformats.cmx/cmximagepage/
---
## CmxImagePage class
...
| Nombre | Descripción |
| --- | --- |
| [CmxImagePage](cmximagepage)(CmxPage) | Inicializa una nueva instancia del[`CmxImagePage`](../cmximagepage) clase. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cmx/cmximagepage/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| [CmxPage](../../aspose.imaging.fileformats.cmx/cmximagepage/cmxpage) { get; } | Obtiene la página CMX. |
...
| override [FileFormat](../../aspose.imaging.fileformats.cmx/cmximagepage/fileformat) { get; } | Obtiene un valor de formato de archivo |
...
| override [HeightF](../../aspose.imaging.fileformats.cmx/cmximagepage/heightf) { get; } | Obtiene la altura del objeto, en pulgadas. |
| [InterruptMonitor](../../aspose.imaging/image/interruptmonitor) { get; set; } | Obtiene o establece el monitor de interrupción. |
| override [IsCached](../../aspose.imaging.fileformats.cmx/cmximagepage/iscached) { get; } | Obtiene un valor que indica si los datos del objeto se almacenan en caché actualmente y no se requiere lectura de datos. |
...
| override [WidthF](../../aspose.imaging.fileformats.cmx/cmximagepage/widthf) { get; } | Obtiene el ancho del objeto, en pulgadas. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cmx/cmximagepage/cachedata)() | No se puede usar el caché. |
...
| override [Resize](../../aspose.imaging.fileformats.cmx/cmximagepage/resize#resize_1)(int, int, ImageResizeSettings) | Cambia el tamaño de la imagen. |
| override [Resize](../../aspose.imaging.fileformats.cmx/cmximagepage/resize#resize_2)(int, int, ResizeType) | Cambia el tamaño de la imagen. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cmx/cmximagepage/rotateflip)(RotateFlipType) | Gira, voltea o gira y voltea la imagen. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cmx/cmximagepage/setpalette)(IColorPalette, bool) | Establece la paleta de la imagen. |
