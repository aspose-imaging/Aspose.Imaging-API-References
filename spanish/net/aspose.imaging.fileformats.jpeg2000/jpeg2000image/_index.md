...
description: Clase principal de la biblioteca JPEG2000
type: docs
weight: 6830
url: /es/net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/
---
## Jpeg2000Image class

Clase principal de la biblioteca JPEG2000
...
| Nombre | Descripción |
| --- | --- |
| [Jpeg2000Image](jpeg2000image#constructor)(RasterImage) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_5)(Stream) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_7)(string) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_2)(int, int) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_1)(RasterImage, int) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_6)(Stream, int) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_8)(string, int) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_4)(int, int, int) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
| [Jpeg2000Image](jpeg2000image#constructor_3)(int, int, Jpeg2000Options) | Inicializa una nueva instancia del[`Jpeg2000Image`](../jpeg2000image) clase. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/bitsperpixel) { get; } | Obtiene la profundidad de la imagen (bits por píxel) |
...
| [Codec](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/codec) { get; } | Obtiene el códec. |
| [Comments](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/comments) { get; set; } | Obtiene o establece los comentarios. |
...
| override [FileFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/fileformat) { get; } | Obtiene un valor de formato de archivo |
...
| override [Height](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/height) { get; } | Obtiene la altura de la imagen |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/horizontalresolution) { get; set; } | Obtiene o establece la resolución horizontal, en píxeles por pulgada, de este[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawdataformat) { get; } | Obtiene el formato de datos sin procesar. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawlinesize) { get; } | Obtiene el tamaño de línea sin formato en bytes. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/verticalresolution) { get; set; } | Obtiene o establece la resolución vertical, en píxeles por pulgada, de este[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/width) { get; } | Obtiene el ancho de la imagen |
| override [XmpData](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/xmpdata) { get; set; } | Obtiene o establece los metadatos XMP. |
...
| override [GetOriginalOptions](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/getoriginaloptions)() | Obtiene las opciones basadas en la configuración del archivo original. Esto puede ser útil para mantener sin cambios la profundidad de bits y otros parámetros de la imagen original. Por ejemplo, si cargamos una imagen PNG en blanco y negro con 1 bit por píxel y luego guardarlo usando the [`Save`](../../aspose.imaging/datastreamsupporter/save) se producirá la imagen PNG de salida con 8 bits por píxel.[`Save`](../../aspose.imaging/image/save) método como el segundo parámetro. |
