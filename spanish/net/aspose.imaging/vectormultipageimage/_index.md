...
description: La imagen vectorial multipágina
type: docs
weight: 11220
url: /es/net/aspose.imaging/vectormultipageimage/
---
## VectorMultipageImage class

La imagen vectorial multipágina
...
| override [BitsPerPixel](../../aspose.imaging/vectormultipageimage/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| override [IsCached](../../aspose.imaging/vectormultipageimage/iscached) { get; } | Obtiene un valor que indica si los datos del objeto se almacenan en caché actualmente y no se requiere lectura de datos. |
| abstract [PageCount](../../aspose.imaging/vectormultipageimage/pagecount) { get; } | Obtiene el número de páginas. |
...
| abstract [Pages](../../aspose.imaging/vectormultipageimage/pages) { get; } | Obtiene las páginas. |
...
| Nombre | Descripción |
| --- | --- |
| override [CacheData](../../aspose.imaging/vectormultipageimage/cachedata)() | Almacena en caché los datos y garantiza que no se realizará ninguna carga de datos adicional desde el subyacente [`DataStreamContainer`](../datastreamsupporter/datastreamcontainer) . |
...
| override [Resize](../../aspose.imaging/vectormultipageimage/resize#resize_1)(int, int, ImageResizeSettings) | Cambia el tamaño de la imagen. |
| override [Resize](../../aspose.imaging/vectormultipageimage/resize#resize_2)(int, int, ResizeType) | Cambia el tamaño de la imagen. |
...
| override [RotateFlip](../../aspose.imaging/vectormultipageimage/rotateflip)(RotateFlipType) | Gira, voltea o gira y voltea la imagen. |
