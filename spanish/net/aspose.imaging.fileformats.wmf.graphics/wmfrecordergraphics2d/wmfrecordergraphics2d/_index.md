...
description: Inicializa una nueva instancia delWmfRecorderGraphics2Daspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d clase.
type: docs
weight: 10
url: /es/net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/wmfrecordergraphics2d/
---
## WmfRecorderGraphics2D constructor

Inicializa una nueva instancia del[`WmfRecorderGraphics2D`](../../wmfrecordergraphics2d) clase.
...
| --- | --- | --- |
| frame | Rectangle | Rectángulo de destino, medido en twips, para mostrar el metarchivo. |
| inch | Int32 | El número de píxeles por pulgada. |
