...
description: Obtiene o establece el número de versión del software part.
type: docs
weight: 250
url: /es/net/aspose.imaging.fileformats.tga/tgaimage/softwareversionnumber/
---
## TgaImage.SoftwareVersionNumber property

Obtiene o establece el número de versión del software part.
