...
type: docs
weight: 6120
url: /es/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusfillregion/
---
...
| Nombre | Descripción |
| --- | --- |
| [EmfPlusFillRegion](emfplusfillregion)(EmfPlusRecord) | Inicializa una nueva instancia del[`EmfPlusFillRegion`](../emfplusfillregion) clase. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [BrushId](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusfillregion/brushid) { get; set; } | Obtiene o establece el identificador del pincel Un entero sin signo de 32 bits que define el pincel, cuyo contenido está determinado por el bit S en el campo Indicadores. |
...
| [IsColor](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusfillregion/iscolor) { get; set; } | Obtiene o establece un valor que indica si esta instancia es color. Si se establece, BrushId especifica un color como un objeto EmfPlusARGB (sección 2.2.2.1). Si está claro, BrushId contiene el índice de un objeto EmfPlusBrush (sección 2.2.1.1) en la tabla de objetos EMF+. |
| [ObjectId](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusfillregion/objectid) { get; set; } | Obtiene o establece el identificador del objeto. El índice del objeto EmfPlusRegion (sección 2.2.1.8) para completar, en la tabla de objetos EMF+. El valor DEBE ser cero a 63, inclusive. |
