...
description: Los tipos de registro de servidor de terminal especifican el procesamiento de gráficos en un servidor de terminal. Los siguientes son tipos de registro de servidor de terminal EMF.
type: docs
weight: 6440
url: /es/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusterminalserverrecordtype/
---
## EmfPlusTerminalServerRecordType class

Los tipos de registro de servidor de terminal especifican el procesamiento de gráficos en un servidor de terminal. Los siguientes son tipos de registro de servidor de terminal EMF+.
