...
description: La página de imagen de Cdr
type: docs
weight: 1430
url: /es/net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
## CdrImagePage class

La página de imagen de Cdr
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimagepage/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimagepage/cdrdocument) { get; } | Obtiene o establece el documento CDR. |
...
| override [FileFormat](../../aspose.imaging.fileformats.cdr/cdrimagepage/fileformat) { get; } | Obtiene un valor de formato de archivo |
...
| override [Height](../../aspose.imaging.fileformats.cdr/cdrimagepage/height) { get; } | Obtiene la altura de la imagen. |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimagepage/iscached) { get; } | Obtiene un valor que indica si los datos del objeto se almacenan en caché actualmente y no se requiere lectura de datos. |
| [PageNumber](../../aspose.imaging.fileformats.cdr/cdrimagepage/pagenumber) { get; } | Obtiene el número de página. |
...
| [ParentImage](../../aspose.imaging.fileformats.cdr/cdrimagepage/parentimage) { get; } | Obtiene la imagen principal. |
...
| override [Width](../../aspose.imaging.fileformats.cdr/cdrimagepage/width) { get; } | Obtiene el ancho de la imagen. |
...
| Nombre | Descripción |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimagepage/cachedata)() | Almacena en caché los datos y garantiza que no se realizará ninguna carga de datos adicional desde el servidor subyacente.[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_1)(int, int, ImageResizeSettings) | Cambia el tamaño de la imagen. |
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_2)(int, int, ResizeType) | Cambia el tamaño de la imagen. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cdr/cdrimagepage/rotateflip)(RotateFlipType) | Gira, voltea o gira y voltea la imagen. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cdr/cdrimagepage/setpalette)(IColorPalette, bool) | Establece la paleta de la imagen. |
