...
type: docs
weight: 7370
url: /es/net/aspose.imaging.fileformats.opendocument/odimage/
---
## OdImage class
...
| Nombre | Descripción |
| --- | --- |
| [OdImage](odimage#constructor)(StreamContainer) | Inicializa una nueva instancia del[`OdImage`](../odimage) clase. |
| [OdImage](odimage#constructor_1)(StreamContainer, LoadOptions) | Inicializa una nueva instancia del[`OdImage`](../odimage) clase. |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize#resize_1)(int, int, ImageResizeSettings) | Cambia el tamaño de la imagen. |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize#resize_2)(int, int, ResizeType) | Cambia el tamaño de la imagen. |
