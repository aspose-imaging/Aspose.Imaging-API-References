...
description: La imagen Otg
type: docs
weight: 7400
url: /es/net/aspose.imaging.fileformats.opendocument/otgimage/
---
## OtgImage class
...
| Nombre | Descripción |
| --- | --- |
| [OtgImage](otgimage#constructor)(StreamContainer) | Inicializa una nueva instancia del[`OtgImage`](../otgimage) clase. |
| [OtgImage](otgimage#constructor_1)(StreamContainer, LoadOptions) | Inicializa una nueva instancia del[`OtgImage`](../otgimage) clase. |
...
| override [FileFormat](../../aspose.imaging.fileformats.opendocument/otgimage/fileformat) { get; } | Obtiene un valor de formato de archivo |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.opendocument/otgimage/getdefaultoptions)(object[]) | Obtiene las opciones predeterminadas. |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize)(int, int, ImageResizeSettings) | Cambia el tamaño de la imagen. |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize)(int, int, ResizeType) | Cambia el tamaño de la imagen. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.opendocument/odimage/rotateflip)(RotateFlipType) | Gira, voltea o gira y voltea la imagen. |
