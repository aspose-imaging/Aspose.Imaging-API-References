...
description: Clase de representación de imagen Dng
type: docs
weight: 2520
url: /es/net/aspose.imaging.fileformats.dng/dngimage/
---
## DngImage class

Clase de representación de imagen Dng
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dng/dngimage/bitsperpixel) { get; } | Obtiene el recuento de bits por píxel de la imagen. |
...
| override [FileFormat](../../aspose.imaging.fileformats.dng/dngimage/fileformat) { get; } | Obtiene un valor de formato de archivo |
...
| override [Height](../../aspose.imaging.fileformats.dng/dngimage/height) { get; } | Obtiene la altura de la imagen. |
...
| [ImgData](../../aspose.imaging.fileformats.dng/dngimage/imgdata) { get; set; } | Obtiene o establece los datos img. |
...
| override [Width](../../aspose.imaging.fileformats.dng/dngimage/width) { get; } | Obtiene el ancho de la imagen. |
