---
title: "Clase EmfRecorderGraphics2D"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [EmfRecorderGraphics2D(frame, device_size, device_size_mm)](#EmfRecorderGraphics2D_frame_device_size_device_size_mm_1) | Inicializa una nueva instancia de la clase [EmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Obtiene o establece el color del fondo. |
| background_mode | [EmfBackgroundMode](/imaging/python-net/aspose.imaging.fileformats.emf.emf.consts/emfbackgroundmode/) | r/w | Obtiene o establece el modo de fondo. |
...
| [end_recording()](#end_recording__21) | Finaliza la grabación. |
| [exclude_clip(rect)](#exclude_clip_rect_22) | Actualiza la región de recorte de este Graphics para excluir el área especificada por una estructura Rectangle. |
| [exclude_clip(region)](#exclude_clip_region_23) | Actualiza la región de recorte de este Graphics para excluir el área especificada por una Región. |
| [exclude_clip_rect(rect)](#exclude_clip_rect_rect_24) | Actualiza la región de recorte de este Graphics para excluir el área especificada por una estructura Rectangle. |
| [exclude_clip_rgn(region)](#exclude_clip_rgn_region_25) | Actualiza la región de recorte de este Graphics para excluir el área especificada por una Región. |
| [fill_ellipse(brush, rect)](#fill_ellipse_brush_rect_26) | Rellena la elipse. |
| [fill_path(pen, brush, path)](#fill_path_pen_brush_path_27) | Rellena la ruta. |
| [fill_pie(brush, rect, start_angle, sweep_angle)](#fill_pie_brush_rect_start_angle_sweep_angle_28) | Rellena el sector. |
| [fill_polygon(brush, points)](#fill_polygon_brush_points_29) | Rellena el polígono. |
| [fill_polygon(brush, points, fill_mode)](#fill_polygon_brush_points_fill_mode_30) | Rellena el polígono. |
| [fill_rectangle(brush, rectangle)](#fill_rectangle_brush_rectangle_31) | Rellena el rectángulo. |
| [from_emf_image(emf_image)](#from_emf_image_emf_image_32) | Obtiene una instancia de la [EmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/) que contiene todos los registros de la imagen Emf. |
| [get_transform()](#get_transform__33) | Obtiene la transformación mundial. |
| [intersect_clip(rect)](#intersect_clip_rect_34) | Actualiza la región de recorte de este Graphics a la intersección de la región de recorte actual y la estructura Rectangle especificada. |
| [intersect_clip(region)](#intersect_clip_region_35) | Actualiza la región de recorte de este Graphics a la intersección de la región de recorte actual y la Región especificada. |
| [intersect_clip_rect_f(rect)](#intersect_clip_rect_f_rect_36) | Actualiza la región de recorte de este Graphics a la intersección de la región de recorte actual y la estructura Rectangle especificada. |
| [intersect_clip_rgn(region)](#intersect_clip_rgn_region_37) | Actualiza la región de recorte de este Graphics a la intersección de la región de recorte actual y la Región especificada. |
| [multiply_transform(matrix)](#multiply_transform_matrix_38) | Multiplica la transformación mundial de este Graphics por la Matriz especificada. |
| [multiply_transform(matrix, order)](#multiply_transform_matrix_order_39) | Multiplica la transformación mundial de este Graphics por la Matriz especificada en el orden especificado. |
| reset_clip() | Restablece el recorte. |
| [rotate_transform(angle)](#rotate_transform_angle_40) | Aplica la rotación especificada a la matriz de transformación de este Graphics. |
| [rotate_transform(angle, center, order)](#rotate_transform_angle_center_order_41) | Aplica la rotación especificada a la matriz de transformación de este Graphics en el orden especificado. |
| [scale_transform(sx, sy)](#scale_transform_sx_sy_42) | Aplica la operación de escalado especificada a la matriz de transformación de este Graphics anteponiéndola a la matriz de transformación del objeto. |
| [scale_transform(sx, sy, order)](#scale_transform_sx_sy_order_43) | Aplica la operación de escalado especificada a la matriz de transformación de este Graphics en el orden especificado. |
| [set_transform(transform)](#set_transform_transform_44) | Establece la transformación. |
| [translate_transform(x, y)](#translate_transform_x_y_45) | Cambia el origen del sistema de coordenadas anteponiendo la traslación especificada a la matriz de transformación de este Graphics. |
| [translate_transform(x, y, order)](#translate_transform_x_y_order_46) | Cambia el origen del sistema de coordenadas aplicando la traslación especificada a la matriz de transformación de este Graphics en el orden especificado. |
...
Inicializa una nueva instancia de la clase [EmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/).

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | El marco. |
| device_size | [Size](/imaging/python-net/aspose.imaging/size/) | Tamaño del dispositivo. |
| device_size_mm | [Size](/imaging/python-net/aspose.imaging/size/) | El tamaño del dispositivo en mm. |
...
| Tipo | Descripción |
| :- | :- |
| [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) | La imagen resultante. |
...
Obtiene una instancia de la [EmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/) que contiene todos los registros de la imagen Emf.

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| emf_image | [EmfImage](/imaging/python-net/aspose.imaging.fileformats.emf/emfimage/) | La imagen Emf de la que leer los registros. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [EmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/) | Una instancia de la [EmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/) |
