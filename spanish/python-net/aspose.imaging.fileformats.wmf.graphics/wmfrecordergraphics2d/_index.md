---
title: "Clase WmfRecorderGraphics2D"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | Inicializa una nueva instancia de la clase [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Obtiene o establece el color del fondo. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | Obtiene o establece el modo de fondo. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | Obtiene una instancia del grabador Wmf para la imagen Wmf existente. |
...
Inicializa una nueva instancia de la clase [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/).

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Rectángulo de destino, medido en twips, para mostrar el metafile. |
...
| Tipo | Descripción |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | La imagen resultante. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | La imagen Wmf para obtener un grabador. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | Una instancia de la clase [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
