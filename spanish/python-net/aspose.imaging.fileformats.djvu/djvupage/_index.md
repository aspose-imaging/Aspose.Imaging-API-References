---
title: "Clase DjvuPage"
type: docs
weight: 20
url: /es/python-net/aspose.imaging.fileformats.djvu/djvupage/
---
...
| height | int | r | Obtiene la altura de la página |
...
| image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r | Obtiene la imagen. |
...
| is_color | bool | r | Obtiene un valor que indica si esta instancia es a color. |
...
| page_number | int | r | Obtiene el número de página. |
...
| parent_image | [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | r | Obtiene la imagen padre a la que pertenece la página |
...
| thumbnail_image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r/w | Obtiene o establece la imagen en miniatura para la página |
...
| width | int | r | Obtiene el ancho de la página |
...
| [extract_thumbnail_image()](#extract_thumbnail_image__35) | Extrae la imagen en miniatura de la página Djvu. |
| [filter(rectangle, options)](#filter_rectangle_options_36) | Filtra el rectángulo especificado. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_37) | Obtiene un píxel ARGB de 32 bits de la imagen. |
| [get_background_image()](#get_background_image__38) | Obtiene la imagen de fondo. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_49) | Obtiene la imagen de primer plano para la página |
| [get_modify_date(use_default)](#get_modify_date_use_default_50) | Obtiene la fecha y hora en que la imagen del recurso fue modificada por última vez. |
...
| [get_pixel(x, y)](#get_pixel_x_y_52) | Obtiene un píxel de la imagen. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_53) | Obtiene una altura proporcional. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_54) | Obtiene un ancho proporcional. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_55) | Convierte a aps. |
| [get_skew_angle()](#get_skew_angle__56) | Obtiene el ángulo de sesgo.<br/>            Este método es aplicable a documentos de texto escaneados, para determinar el ángulo de sesgo al escanear. |
| [get_text_for_location(rect)](#get_text_for_location_rect_57) | Obtiene el texto para la ubicación del rectángulo |
| [get_text_image(subsample)](#get_text_image_subsample_58) | Obtiene la imagen de texto. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | Redimensiona la imagen de la página a las nuevas dimensiones |
...
| [save(stream)](#save_stream_105) | Guarda los datos. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_121) | Establece la resolución para este [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| Tipo | Descripción |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | La imagen raster Djvu. |
...
| Tipo | Descripción |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | El bitmap |
...
| Tipo | Descripción |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Imagen bitmap |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | El rectángulo de ubicación. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| string | Texto encontrado en la ubicación |
...
Redimensiona la imagen de la página a las nuevas dimensiones
