---
title: "CdrLoadOptions Clase"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.imageloadoptions/cdrloadoptions/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [CdrLoadOptions()](#CdrLoadOptions__1) | Inicializa una nueva instancia de la clase [CdrLoadOptions](/imaging/python-net/aspose.imaging.imageloadoptions/cdrloadoptions/). |
## **Properties**
...
| default_font | [Font](/imaging/python-net/aspose.imaging/font/) | r/w | Obtiene o establece la fuente predeterminada. |
| optimal_memory_usage | bool | r/w | Obtiene o establece un valor que indica si [optimal memory usage]. |
...
### Constructor: CdrLoadOptions() {#CdrLoadOptions__1}
...
Inicializa una nueva instancia de la clase [CdrLoadOptions](/imaging/python-net/aspose.imaging.imageloadoptions/cdrloadoptions/).
