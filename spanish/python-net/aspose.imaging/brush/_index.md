...
type: docs
weight: 340
url: /es/python-net/aspose.imaging/brush/
---
...
| [opacity](#opacity1) | float | r/w | Obtiene o establece la opacidad del pincel. El valor debe estar entre 0 y 1. Un valor de 0 significa que el pincel es totalmente visible, un valor de 1 significa que el pincel es totalmente opaco. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
