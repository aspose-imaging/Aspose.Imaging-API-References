...
type: docs
weight: 7880
url: /es/python-net/aspose.imaging/vectorimage/
---
...
| [save(stream)](#save_stream_60) | Guarda los datos del objeto en el flujo especificado. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_69) | Intenta establecer una instancia de _metadata_, si esta instancia de [Image](/imaging/python-net/aspose.imaging/image/) admite e implementa el tipo [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
