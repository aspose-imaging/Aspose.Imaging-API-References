---
title: "Clase EmfPlusSetInterpolationMode"
type: docs
weight: 510
url: /es/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetinterpolationmode/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [EmfPlusSetInterpolationMode(source)](#EmfPlusSetInterpolationMode_source_1) | Inicializa una nueva instancia de la clase [EmfPlusSetInterpolationMode](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetinterpolationmode/). |
## **Properties**
...
| interpolation_mode | [EmfPlusInterpolationMode](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.consts/emfplusinterpolationmode/) | r/w | Obtiene o establece el valor del modo de interpolación, de la enumeración InterpolationMode (sección 2.1.1.16). |
...
Inicializa una nueva instancia de la clase [EmfPlusSetInterpolationMode](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetinterpolationmode/).
