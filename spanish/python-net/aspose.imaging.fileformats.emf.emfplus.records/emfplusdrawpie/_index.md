---
title: "Clase EmfPlusDrawPie"
type: docs
weight: 170
url: /es/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawpie/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [EmfPlusDrawPie(source)](#EmfPlusDrawPie_source_1) | Inicializa una nueva instancia de la clase [EmfPlusDrawPie](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawpie/). |
## **Properties**
...
| object_id | System.Byte | r/w | Obtiene o establece el identificador del objeto.<br/> El índice de un objeto EmfPlusPen (sección 2.2.1.7) en la tabla de objetos EMF+<br/> para dibujar el pie. El valor DEBE estar entre 0 y 63, inclusive. |
...
Inicializa una nueva instancia de la clase [EmfPlusDrawPie](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawpie/).
