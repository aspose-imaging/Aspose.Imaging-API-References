---
title: "Clase RectangleMask"
type: docs
weight: 80
url: /es/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [RectangleMask(selected_area)](#RectangleMask_selected_area_1) | Inicializa una nueva instancia de la clase [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) con el rectángulo especificado. |
| [RectangleMask(x, y, width, height)](#RectangleMask_x_y_width_height_2) | Inicializa una nueva instancia de la clase [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) con el punto superior izquierdo especificado, ancho y alto. |
## **Properties**
...
Inicializa una nueva instancia de la clase [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) con el rectángulo especificado.

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| selected_area | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Área seleccionada especificada como un rectángulo. |
...
Inicializa una nueva instancia de la clase [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) con el punto superior izquierdo especificado, ancho y alto.
...
| Tipo | Descripción |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una RectangleMask recortada como ImageMask. |
...
| Tipo | Descripción |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una RectangleMask inflada como ImageMask. |
