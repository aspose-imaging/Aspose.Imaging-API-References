---
title: "Clase ImageBitMask"
type: docs
weight: 50
url: /es/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ImageBitMask(image)](#ImageBitMask_image_1) | Inicializa una nueva instancia de la clase [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con el tamaño del [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) existente especificado.<br/>            El [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) especificado se almacenará como imagen de origen. |
| [ImageBitMask(width, height)](#ImageBitMask_width_height_2) | Inicializa una nueva instancia de la clase [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con el ancho y la altura especificados. |
## **Properties**
...
| [get(x, y)](#get_x_y_9) | Obtiene la posición en la matriz de almacenamiento del píxel especificado. |
...
| [set_mask_pixel(x, y, value)](#set_mask_pixel_x_y_value_19) | Establece la opacidad del píxel especificado. |
| [subtract(image, settings)](#subtract_image_settings_20) | Obtiene el resultado de la selección con varita mágica aplicada a la imagen proporcionada restado de la máscara actual. |
| [subtract(mask)](#subtract_mask_21) | Obtiene la sustracción de la máscara proporcionada de la actual. |
| [subtract(settings)](#subtract_settings_22) | Obtiene el resultado de la selección con varita mágica aplicada al origen de la máscara actual restado de la máscara. |
| [union(image, settings)](#union_image_settings_23) | Obtiene la unión de la máscara actual con el resultado de la selección con varita mágica aplicada a la imagen proporcionada. |
| [union(mask)](#union_mask_24) | Obtiene la unión de la máscara actual con la proporcionada. |
| [union(settings)](#union_settings_25) | Obtiene la unión de la máscara actual con el resultado de la selección con varita mágica aplicada al origen de la máscara. |
...
Inicializa una nueva instancia de la clase [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con el tamaño del [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) existente especificado.<br/>            El [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) especificado se almacenará como imagen de origen.
...
Inicializa una nueva instancia de la clase [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con el ancho y la altura especificados.
...
| Tipo | Descripción |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) recortada como [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
Obtiene la posición en la matriz de almacenamiento del píxel especificado.
...
| Tipo | Descripción |
| :- | :- |
| bool | Valor entero, que representa la posición en el almacenamiento. |
...
| Tipo | Descripción |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) inflada como [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
| x | int | La coordenada x del píxel. |
| y | int | La coordenada y del píxel. |
| valor | bool | true si el píxel especificado es opaco; de lo contrario, false. |
