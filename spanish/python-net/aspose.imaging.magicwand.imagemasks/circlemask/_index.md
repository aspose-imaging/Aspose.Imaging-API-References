---
title: "Clase CircleMask"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.magicwand.imagemasks/circlemask/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [CircleMask(center, radius)](#CircleMask_center_radius_1) | Inicializa una nueva instancia de la clase [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) con el punto central y radio especificados. |
| [CircleMask(x, y, radius)](#CircleMask_x_y_radius_2) | Inicializa una nueva instancia de la clase [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) con el punto central y radio especificados. |
## **Properties**
...
| selection_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Obtiene los límites, en píxeles, de esta máscara. |
...
Inicializa una nueva instancia de la clase [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) con el punto central y radio especificados.

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| center | [Point](/imaging/python-net/aspose.imaging/point/) | El punto central del área seleccionada. |
| radio | int | Radio del área seleccionada. |
...
| Tipo | Descripción |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una CircleMask recortada o ImageBitMask como ImageMask.<br/>            Como puede devolverse ImageBitMask, se recomienda una llamada fluida. |
...
| Tipo | Descripción |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una CircleMask inflada como ImageMask. |
