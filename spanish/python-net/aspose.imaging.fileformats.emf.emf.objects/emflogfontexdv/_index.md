---
title: "Clase EmfLogFontExDv"
type: docs
weight: 150
url: /es/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [EmfLogFontExDv(emf_log_font_ex)](#EmfLogFontExDv_emf_log_font_ex_1) | Inicializa una nueva instancia de la clase [EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/). |
## **Properties**
...
| design_vector | [EmfDesignVector](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfdesignvector/) | r/w | Obtiene o establece un objeto DesignVector (sección 2.2.3). Este campo NO DEBE ser más largo que 72 bytes. |
...
| full_name | string | r/w | Obtiene o establece una cadena de 64 caracteres Unicode que contiene el nombre completo de la fuente. Si <br/>            la longitud de esta cadena es menor a 64 caracteres, debe estar presente un NULL terminador, después <br/>            del cual el resto de este campo DEBE ser ignorado. |
...
| script | string | r/w | Obtiene o establece una cadena de 32 caracteres Unicode que define el conjunto de caracteres de la fuente. <br/>            Si la longitud de esta cadena es inferior a 32 caracteres, DEBE estar presente un NULL terminador, <br/>            después del cual el resto de este campo DEBE ser ignorado. |
...
Inicializa una nueva instancia de la clase [EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/).

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| emf_log_font_ex | [EmfLogFontEx](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontex/) | El ejemplo de fuente de registro EMF. |
