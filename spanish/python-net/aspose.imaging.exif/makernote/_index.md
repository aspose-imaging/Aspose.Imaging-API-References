...
type: docs
weight: 50
url: /es/python-net/aspose.imaging.exif/makernote/
---
...
| :- | :- | :- | :- |
| nombre | string | r | Obtiene el nombre de la configuración. |
| valor | string | r | Obtiene el valor de la configuración. |
