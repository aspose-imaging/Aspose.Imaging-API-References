---
title: "Clase ExifData"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.exif/exifdata/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [ExifData()](#ExifData__1) | Inicializa una nueva instancia de la clase [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/). |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | Inicializa una nueva instancia de la clase [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) con datos del array. |
| [ExifData(exifdata)](#ExifData_exifdata_3) | Inicializa una nueva instancia de la clase [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) con datos del array. |
| [ExifData(exifdata)](#ExifData_exifdata_4) | Inicializa una nueva instancia de la clase [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) con datos del array. |
## **Properties**
...
| [maker_notes](#maker_notes1) | [MakerNote[]](/imaging/python-net/aspose.imaging.exif/makernote/) | r | Obtiene las notas del fabricante. |
...
| x_resolution | int | r/w | Obtiene o establece la resolución x. |
| y_resolution | int | r/w | Obtiene o establece la resolución y. |
## **Methods**
| **Name** | **Descripción** |
| :- | :- |
...
Inicializa una nueva instancia de la clase [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/).
...
Inicializa una nueva instancia de la clase [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) con datos del array.
