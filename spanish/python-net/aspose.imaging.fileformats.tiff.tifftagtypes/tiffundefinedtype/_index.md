---
title: "TiffUndefinedType Clase"
type: docs
weight: 170
url: /es/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_1) | Inicializa una nueva instancia de la clase [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_2) | Inicializa una nueva instancia de la clase [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| count | int | r | Obtiene el recuento de elementos. |
| datos | System.Byte | r/w | Obtiene o establece los datos. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Inicializa una nueva instancia de la clase [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Inicializa una nueva instancia de la clase [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/). |
...
Inicializa una nueva instancia de la clase [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/).
