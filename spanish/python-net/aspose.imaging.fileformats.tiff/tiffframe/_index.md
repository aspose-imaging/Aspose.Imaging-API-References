---
title: "Clase TiffFrame"
type: docs
weight: 170
url: /es/python-net/aspose.imaging.fileformats.tiff/tiffframe/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [TiffFrame(image)](#TiffFrame_image_1) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(image, options)](#TiffFrame_image_options_2) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(options, width, height)](#TiffFrame_options_width_height_3) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path)](#TiffFrame_path_4) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path, options)](#TiffFrame_path_options_5) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream)](#TiffFrame_stream_6) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream, options)](#TiffFrame_stream_options_7) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
## **Properties**
...
| frame_options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | r | Obtiene las opciones de creación del frame. |
...
| [path_resources](#path_resources1) | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Tiff.PathResources.PathResource]] | r/w | Obtiene o establece los recursos de ruta. |
...
| align_resolutions() | Método auxiliar para hacer iguales las resoluciones horizontal y vertical. |
...
| [copy_frame(tiff_frame)](#copy_frame_tiff_frame_19) | Copia todo el frame (duplicados). |
| [create(files)](#create_files_20) | Crea la imagen multipágina que contiene los archivos especificados. |
| [create(files, throw_exception_on_load_error)](#create_files_throw_exception_on_load_error_21) | Crea la imagen multipágina que contiene los archivos especificados. |
| [create(image_options, width, height)](#create_image_options_width_height_22) | Crea una nueva imagen usando las opciones de creación especificadas. |
...
| [create(images)](#create_images_24) | Crea una nueva imagen usando las imágenes especificadas como páginas |
| [create(images, dispose_images)](#create_images_dispose_images_25) | Crea una nueva imagen con las imágenes especificadas como páginas. |
| [create(multipage_create_options)](#create_multipage_create_options_26) | Crea las opciones de creación multipágina especificadas. |
| [create_frame_from(tiff_frame, options)](#create_frame_from_tiff_frame_options_27) | Crea el marco a partir del _tiffFrame_ especificado usando las _options_ especificadas.<br/>            Los datos de píxeles se conservan pero se convierten al formato deseado. |
| [create_from_file_with_options(path, options)](#create_from_file_with_options_path_options_28) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_image(image)](#create_from_image_image_31) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_image_with_options(image, options)](#create_from_image_with_options_image_options_32) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_35) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_stream_with_options(stream, options)](#create_from_stream_with_options_stream_options_36) | Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
Inicializa una nueva instancia de la clase [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/).
...
| :- | :- | :- |
| image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | La imagen con la que inicializar los píxeles del cuadro y los datos de la paleta. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Las opciones a usar para el marco recién creado. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Las opciones del marco. |
| width | int | El ancho. |
...
Obtiene o establece los recursos de ruta.
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | El marco tiff a copiar. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | El marco tiff recién copiado. |
...
Crea el marco a partir del _tiffFrame_ especificado usando las _options_ especificadas.<br/>            Los datos de píxeles se conservan pero se convierten al formato deseado.

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | El marco tiff a crear a partir de. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Las nuevas opciones a usar. |

**Returns**

| Tipo | Descripción |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | El marco recién creado. |
