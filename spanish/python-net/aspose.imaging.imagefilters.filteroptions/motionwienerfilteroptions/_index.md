---
title: "Clase MotionWienerFilterOptions"
type: docs
weight: 140
url: /es/python-net/aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [MotionWienerFilterOptions(size, sigma, angle)](#MotionWienerFilterOptions_size_sigma_angle_1) | Inicializa una nueva instancia de la clase [MotionWienerFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| angle | float | r/w | Obtiene o establece el ángulo en grados. |
...
Inicializa una nueva instancia de la clase [MotionWienerFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/).
...
| angle | float | El ángulo en grados. |
