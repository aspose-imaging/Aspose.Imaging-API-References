---
title: "Clase BigTiffImage"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [BigTiffImage(frame)](#BigTiffImage_frame_1) | Crea una nueva instancia de la clase [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) inicializando<br/>            con un parámetro TiffFrame. Ideal para desarrolladores que buscan una forma conveniente<br/>            de trabajar con objetos BigTiffImage, asegurando flexibilidad y facilidad de integración<br/>            en sus proyectos. |
| [BigTiffImage(frames)](#BigTiffImage_frames_2) | Comienza a utilizar la clase [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sin problemas al<br/>            inicializar una nueva instancia con una lista de parámetros TiffFrames.<br/>            Perfecto para desarrolladores que buscan un método sencillo para trabajar con<br/>            objetos BigTiffImage que contienen múltiples fotogramas, garantizando la eficiencia de sus proyectos. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Obtiene el formato de archivo de esta instancia de [Image](/imaging/python-net/aspose.imaging/image/). |
...
| [add_page(page)](#add_page_page_4) | Expande sin esfuerzo tu imagen BigTiff añadiendo una nueva página con este método intuitivo.<br/>            Perfecto para desarrolladores que buscan mejorar dinámicamente el contenido de sus imágenes multipágina. |
...
| [create_with_frame(frame)](#create_with_frame_frame_34) | Inicializa una nueva instancia de la clase [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/). |
| [create_with_frames(frames)](#create_with_frames_frames_35) | Inicializa una nueva instancia de la clase [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/). |
...
Crea una nueva instancia de la clase [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) inicializando<br/>            con un parámetro TiffFrame. Ideal para desarrolladores que buscan una forma conveniente<br/>            de trabajar con objetos BigTiffImage, asegurando flexibilidad y facilidad de integración<br/>            en sus proyectos.
...
Comienza a utilizar la clase [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sin problemas al<br/>            inicializar una nueva instancia con una lista de parámetros TiffFrames.<br/>            Perfecto para desarrolladores que buscan un método sencillo para trabajar con<br/>            objetos BigTiffImage que contienen múltiples fotogramas, garantizando la eficiencia de sus proyectos.
...
Expande sin esfuerzo tu imagen BigTiff añadiendo una nueva página con este método intuitivo.<br/>            Perfecto para desarrolladores que buscan mejorar dinámicamente el contenido de sus imágenes multipágina.
...
Inicializa una nueva instancia de la clase [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/).
...
| Tipo | Descripción |
| :- | :- |
| [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) | Una nueva imagen BigTiffImage que incluye el marco. |
