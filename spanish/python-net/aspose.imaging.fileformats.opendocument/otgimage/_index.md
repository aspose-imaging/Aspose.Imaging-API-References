---
title: "Clase OtgImage"
type: docs
weight: 500
url: /es/python-net/aspose.imaging.fileformats.opendocument/otgimage/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [OtgImage(stream_container)](#OtgImage_stream_container_1) | Cree un nuevo objeto de la clase [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) proporcionando un flujo <br/>            contenedor. Este constructor permite a los desarrolladores crear imágenes OTG directamente desde <br/>            contenedores de flujo, simplificando el proceso de trabajo con datos de imágenes OTG. |
| [OtgImage(stream_container, load_options)](#OtgImage_stream_container_load_options_2) | Inicialice un nuevo objeto de la clase [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) proporcionando un contenedor de flujo <br/>            y opciones de carga. Este constructor permite a los desarrolladores cargar eficientemente imágenes OTG <br/>            desde flujos mientras especifican configuraciones de carga personalizadas. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Esta propiedad brinda acceso al formato de archivo OTG, ofreciendo información crucial <br/>            sobre el tipo de datos encapsulados dentro del archivo de imagen. Sirve como un punto de referencia fundamental <br/>            para los desarrolladores de software, permitiéndoles manejar eficazmente archivos OTG <br/>            dentro de sus aplicaciones. Al utilizar esta propiedad, puede <br/>            determinar el formato específico del archivo de imagen, facilitando una integración fluida <br/>            y la manipulación de archivos OTG en sus sistemas de software. |
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Obtiene la colección de páginas asociadas a la imagen, permitiendo a los desarrolladores de software <br/>            acceder y manipular cada página individual de manera eficiente. Esta <br/>            propiedad facilita una iteración fluida a través de las páginas para diversas operaciones, <br/>            mejorando la funcionalidad y versatilidad de las aplicaciones de procesamiento de imágenes. |
...
Cree un nuevo objeto de la clase [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) proporcionando un flujo <br/>            contenedor. Este constructor permite a los desarrolladores crear imágenes OTG directamente desde <br/>            contenedores de flujo, simplificando el proceso de trabajo con datos de imágenes OTG.
