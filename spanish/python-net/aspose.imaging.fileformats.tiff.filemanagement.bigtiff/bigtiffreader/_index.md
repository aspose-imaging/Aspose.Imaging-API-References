---
title: "Clase BigTiffReader"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [BigTiffReader(data)](#BigTiffReader_data_1) | Inicializa una nueva instancia de la clase [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
| [BigTiffReader(data, start_index)](#BigTiffReader_data_start_index_2) | Inicializa una nueva instancia de la clase [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
| [BigTiffReader(data, start_index, data_length)](#BigTiffReader_data_start_index_data_length_3) | Inicializa una nueva instancia de la clase [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
| [BigTiffReader(stream_container)](#BigTiffReader_stream_container_4) | Inicializa una nueva instancia de la clase [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
## **Properties**
...
Inicializa una nueva instancia de la clase [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/).
