---
title: "Clase SvgImage"
type: docs
weight: 40
url: /es/python-net/aspose.imaging.fileformats.svg/svgimage/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [SvgImage(path)](#SvgImage_path_1) | Instancia un nuevo objeto de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), utilizando la <br/>            ruta especificada para localizar y cargar la imagen. Este constructor facilita la <br/>            creación de instancias de imágenes SVG a partir de archivos externos, permitiendo una integración fluida <br/>            en sistemas y flujos de trabajo de software. |
| [SvgImage(stream)](#SvgImage_stream_2) | Crea una nueva instancia de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), cargando la imagen <br/>            desde el flujo proporcionado. Este constructor permite la carga directa de imágenes SVG <br/>            desde flujos, mejorando la flexibilidad y eficiencia en el manejo de recursos de imagen <br/>            dentro de aplicaciones de software. |
| [SvgImage(svg_options, width, height)](#SvgImage_svg_options_width_height_3) | Crea una nueva instancia de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con opciones SVG especificadas, ancho y altura de la imagen. Este constructor permite <br/>            a los desarrolladores inicializar imágenes SVG con opciones y dimensiones personalizadas, <br/>            proporcionando flexibilidad en la gestión del contenido y diseño SVG. |
| [SvgImage(width, height)](#SvgImage_width_height_4) | Instancia un nuevo objeto [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con el ancho y <br/>            altura especificados. Este constructor permite a los desarrolladores crear imágenes SVG con dimensiones predefinidas, <br/>            facilitando un control preciso sobre el tamaño de la imagen durante <br/>            la inicialización. |
## **Properties**
...
| bits_per_pixel | int | r | Obtiene el recuento de bits por píxel de la imagen. Es importante notar que <br/>            este parámetro no se aplica a imágenes vectoriales, ya que no se miden en <br/>            píxeles. Esta propiedad proporciona información crucial sobre la profundidad de color <br/>            de la imagen, ayudando en tareas de procesamiento y manipulación. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Obtiene el formato de archivo de la imagen, proporcionando metadatos esenciales para <br/>            el procesamiento y la verificación de compatibilidad. Esta propiedad es fundamental para <br/>            determinar las estrategias de decodificación y codificación adecuadas para manejar los <br/>            datos de la imagen de manera eficaz en diferentes sistemas y aplicaciones. |
...
| is_cached | bool | r | Obtiene un valor booleano que indica si los datos del objeto están actualmente <br/>            en caché, eliminando la necesidad de operaciones adicionales de lectura de datos. Esta <br/>            propiedad brinda información sobre el estado actual de la caché, optimizando la recuperación <br/>            y los flujos de procesamiento de datos para mejorar el rendimiento y la eficiencia. |
...
| **Name** | **Descripción** |
| :- | :- |
| cache_data() | Ponga en caché los datos y garantice que no habrá más cargas de datos desde <br/>            el [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) subyacente. Esta <br/>            optimización mejora el rendimiento al eliminar operaciones redundantes de recuperación de datos, <br/>            especialmente útil en escenarios que requieren acceso frecuente a los <br/>            datos de la imagen. |
...
| [create_from_stream(stream)](#create_from_stream_stream_20) | Inicializa una nueva instancia de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/). |
...
| [load(file_path)](#load_file_path_34) | Carga una nueva imagen desde la ruta de archivo o URL especificada.<br/>            Si _filePath_ es una ruta de archivo, el método simplemente abre el archivo.<br/>            Si _filePath_ es una URL, el método descarga el archivo, lo almacena como uno temporal y lo abre. |
| [load(file_path, load_options)](#load_file_path_load_options_35) | Carga una nueva imagen desde la ruta de archivo o URL especificada.<br/>            Si _filePath_ es una ruta de archivo, el método simplemente abre el archivo.<br/>            Si _filePath_ es una URL, el método descarga el archivo, lo almacena como uno temporal y lo abre. |
| [load(stream)](#load_stream_36) | Carga la sección SVG. |
| [load(stream, load_options)](#load_stream_load_options_37) | Carga una nueva imagen desde el flujo especificado. |
| [load_stream(stream)](#load_stream_stream_38) | Carga una nueva imagen desde el flujo especificado. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_39) | Carga una nueva imagen desde el flujo especificado. |
...
| [remove_background(settings)](#remove_background_settings_41) | Elimina el fondo. |
| remove_metadata() | Elimina los metadatos. |
| [resize(new_width, new_height)](#resize_new_width_new_height_42) | Redimensiona la imagen. Se utiliza el valor predeterminado [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_43) | Redimensiona la imagen para que se ajuste a las dimensiones especificadas mientras preserva su relación de aspecto <br/>            ratio. Este método proporciona una forma conveniente de ajustar el tamaño de la imagen <br/>            sin distorsionar sus proporciones, garantizando una visualización o almacenamiento óptimo <br/>            según las dimensiones deseadas. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_44) | Redimensiona la imagen con opciones extendidas. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_45) | Redimensiona la imagen. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_46) | Redimensiona la imagen. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_47) | Redimensiona la altura proporcionalmente. Se utiliza el valor predeterminado [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_48) | Redimensiona la altura proporcionalmente. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_49) | Redimensiona la altura proporcionalmente. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_50) | Redimensiona la altura proporcionalmente. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_51) | Redimensiona el ancho proporcionalmente. Se utiliza el valor predeterminado [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_52) | Redimensiona el ancho proporcionalmente. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_53) | Redimensiona el ancho proporcionalmente. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_54) | Redimensiona el ancho proporcionalmente. |
| [rotate(angle)](#rotate_angle_55) | Rotar la imagen alrededor del centro. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_56) | Rota, voltea o rota y voltea la imagen. |
| save() | Guarda los datos de la imagen en el flujo subyacente. |
| [save(file_path)](#save_file_path_57) | Guarda la imagen en la ubicación de archivo especificada. |
| [save(file_path, options)](#save_file_path_options_58) | Guarda los datos del objeto en la ubicación de archivo especificada en el formato de archivo indicado según las opciones de guardado. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_59) | Guarda los datos del objeto en la ubicación de archivo especificada en el formato de archivo indicado según las opciones de guardado. |
| [save(file_path, over_write)](#save_file_path_over_write_60) | Guarda los datos del objeto en la ubicación de archivo especificada. |
| [save(stream)](#save_stream_61) | Guarda los datos. |
| [save(stream, options_base)](#save_stream_options_base_62) | Guarda los datos de la imagen en el flujo especificado en el formato de archivo indicado según las opciones de guardado. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_63) | Guarda los datos de la imagen en el flujo especificado en el formato de archivo indicado según las opciones de guardado. |
| [save_to_stream(stream)](#save_to_stream_stream_64) | Guarda los datos del objeto en el flujo especificado. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_65) | Guarda los datos de la imagen en el flujo especificado en el formato de archivo indicado según las opciones de guardado. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_66) | Guarda los datos de la imagen en el flujo especificado en el formato de archivo indicado según las opciones de guardado. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | Guarda los datos del objeto en la ubicación de archivo especificada en el formato de archivo indicado según las opciones de guardado. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | Guarda los datos del objeto en la ubicación de archivo especificada en el formato de archivo indicado según las opciones de guardado. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | Aplica una paleta especificada a la imagen, permitiendo la personalización de esquemas de color <br/>            para propósitos estéticos o funcionales. Este método brinda flexibilidad <br/>            en la gestión de paletas de colores para adaptarse a diversos requisitos de diseño o aplicación. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | Intenta establecer una instancia de _metadata_, si esta instancia de [Image](/imaging/python-net/aspose.imaging/image/) admite e implementa la instancia [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
...
Instancia un nuevo objeto de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), utilizando la <br/>            ruta especificada para localizar y cargar la imagen. Este constructor facilita la <br/>            creación de instancias de imágenes SVG a partir de archivos externos, permitiendo una integración fluida <br/>            en sistemas y flujos de trabajo de software.
...
Crea una nueva instancia de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), cargando la imagen <br/>            desde el flujo proporcionado. Este constructor permite la carga directa de imágenes SVG <br/>            desde flujos, mejorando la flexibilidad y eficiencia en el manejo de recursos de imagen <br/>            dentro de aplicaciones de software.
...
Crea una nueva instancia de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con opciones SVG especificadas, ancho y altura de la imagen. Este constructor permite <br/>            a los desarrolladores inicializar imágenes SVG con opciones y dimensiones personalizadas, <br/>            proporcionando flexibilidad en la gestión del contenido y diseño SVG.

**Parameters:**

| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| svg_options | [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/) | Las opciones SVG. |
...
Instancia un nuevo objeto [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con el ancho y <br/>            altura especificados. Este constructor permite a los desarrolladores crear imágenes SVG con dimensiones predefinidas, <br/>            facilitando un control preciso sobre el tamaño de la imagen durante <br/>            la inicialización.
...
Inicializa una nueva instancia de la clase [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/).
...
Redimensiona la imagen para que se ajuste a las dimensiones especificadas mientras preserva su relación de aspecto <br/>            ratio. Este método proporciona una forma conveniente de ajustar el tamaño de la imagen <br/>            sin distorsionar sus proporciones, garantizando una visualización o almacenamiento óptimo <br/>            según las dimensiones deseadas.
...
Aplica una paleta especificada a la imagen, permitiendo la personalización de esquemas de color <br/>            para propósitos estéticos o funcionales. Este método brinda flexibilidad <br/>            en la gestión de paletas de colores para adaptarse a diversos requisitos de diseño o aplicación.
...
dir_: str = "c:\\temp"
# Carga una imagen SVG desde un flujo de archivo.
