---
title: "Clase DngImage"
type: docs
weight: 10
url: /es/python-net/aspose.imaging.fileformats.dng/dngimage/
---
...
| bits_per_pixel | int | r | Descubra el número de bits por píxel en la imagen sin esfuerzo con esta <br/>            propiedad. Ideal para comprender rápidamente y con precisión la profundidad de píxeles de la imagen. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Identifique el formato de archivo de su imagen con esta propiedad. Perfecto para <br/>            comprender el formato, solo detalles directos. |
...
| height | int | r | Recupere la altura de la imagen con esta propiedad. Perfecto para determinar el <br/>            tamaño vertical de la imagen sin complicaciones. |
...
| img_data | [RawData](/imaging/python-net/aspose.imaging.fileformats.dng.decoder/rawdata/) | r/w | Gestione los datos de la imagen con esta propiedad. Ya sea que esté recuperando o actualizando, <br/>            esta propiedad brinda acceso sin problemas a los datos de la imagen para una manipulación <br/>            eficiente. |
...
| width | int | r | Acceda al ancho de la imagen con esta propiedad. Ideal para obtener el <br/>            tamaño horizontal de la imagen de forma rápida y eficiente. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_63) | Carga parcialmente píxeles ARGB de 32 bits (por bloques). |
...
| [save(stream)](#save_stream_100) | Guarda los datos. |
