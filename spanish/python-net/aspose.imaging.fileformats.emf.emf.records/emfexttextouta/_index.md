---
title: "EmfExtTextOutA Clase"
type: docs
weight: 470
url: /es/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [EmfExtTextOutA()](#EmfExtTextOutA__1) | Inicializa una nueva instancia de la clase [EmfExtTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/). |
| [EmfExtTextOutA(source)](#EmfExtTextOutA_source_2) | Inicializa una nueva instancia de la clase [EmfExtTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descripción** |
| :- | :- | :- | :- |
| a_emr_text | [EmfText](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emftext/) | r/w | Obtiene o establece un objeto EmrText (sección 2.2.5) que especifica la cadena de salida en caracteres ASCII de 8 bits <br/>            , atributos de texto y valores de espaciado. |
...
Inicializa una nueva instancia de la clase [EmfExtTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/).
