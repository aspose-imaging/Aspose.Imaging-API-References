...
type: docs
weight: 630
url: /es/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/
---
...
| **Name** | **Descripción** |
| :- | :- |
| [EmfMetafileHeaderExtension2(header)](#EmfMetafileHeaderExtension2_header_1) | Inicializa una nueva instancia de la clase [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [EmfMetafileHeaderExtension2(header)](#EmfMetafileHeaderExtension2_header_2) | Inicializa una nueva instancia de la clase [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
## **Properties**
...
| emf_header_extension2 | [EmfHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/) | r/w | Obtiene o establece un objeto HeaderExtension2, que especifica información adicional sobre la imagen en el metafile |
...
| **Name** | **Descripción** |
| :- | :- |
| [create_from_header(header)](#create_from_header_header_1) | Inicializa una nueva instancia de la clase [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [create_from_header_extension1(header)](#create_from_header_extension1_header_2) | Inicializa una nueva instancia de la clase [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [create_from_header_extension2(header)](#create_from_header_extension2_header_3) | Inicializa una nueva instancia de la clase [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [create_from_record(record)](#create_from_record_record_4) | Inicializa una nueva instancia de la clase [EmfMetafileHeader](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheader/). |
| [create_from_type(type)](#create_from_type_type_5) | Inicializa una nueva instancia de la clase [EmfRecord](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfrecord/). |
...
Inicializa una nueva instancia de la clase [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/).
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| header | [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) | El encabezado. |
