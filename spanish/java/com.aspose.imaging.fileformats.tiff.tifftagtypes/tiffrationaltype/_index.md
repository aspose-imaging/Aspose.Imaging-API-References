...
type: docs
weight: 19
url: /es/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/
---
**Inheritance:**
...
| --- | --- |
| [TiffRationalType(int tagId)](#TiffRationalType-int-) | Inicializa una nueva instancia de la clase `TiffRationalType`. |
## Métodos

| Método | Descripción |
| --- | --- |
| [getValues()](#getValues--) | Obtiene o establece los valores. |
| [setValues(TiffRational[] value)](#setValues-com.aspose.imaging.fileformats.tiff.TiffRational---) | Obtiene o establece los valores. |
...
Inicializa una nueva instancia de la clase `TiffRationalType`.
