...
description: "El tipo corto con signo tiff."
type: docs
weight: 24
url: /es/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
**Inheritance:**
...
El tipo corto con signo tiff.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [TiffSShortType(int tagId)](#TiffSShortType-int-) | Inicializa una nueva instancia de la clase `TiffSShortType`. |
## Métodos

| Método | Descripción |
| --- | --- |
| [getValues()](#getValues--) | Obtiene o establece los valores. |
| [setValues(short[] value)](#setValues-short---) | Obtiene o establece los valores. |
...
Inicializa una nueva instancia de la clase `TiffSShortType`.
