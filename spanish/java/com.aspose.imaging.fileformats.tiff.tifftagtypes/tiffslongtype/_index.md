...
description: "El tipo long con signo tiff."
type: docs
weight: 22
url: /es/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
**Inheritance:**
...
El tipo long con signo tiff.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [TiffSLongType(int tagId)](#TiffSLongType-int-) | Inicializa una nueva instancia de la clase `TiffSLongType`. |
## Métodos

| Método | Descripción |
| --- | --- |
| [getValues()](#getValues--) | Obtiene o establece los valores. |
| [setValues(int[] value)](#setValues-int---) | Obtiene o establece los valores. |
...
Inicializa una nueva instancia de la clase `TiffSLongType`.
