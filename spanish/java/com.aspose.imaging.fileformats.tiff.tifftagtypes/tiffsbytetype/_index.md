...
description: "El tipo byte con signo tiff."
type: docs
weight: 20
url: /es/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/
---
**Inheritance:**
...
El tipo byte con signo tiff.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [TiffSByteType(int tagId)](#TiffSByteType-int-) | Inicializa una nueva instancia de la clase `TiffSByteType`. |
## Métodos
...
Inicializa una nueva instancia de la clase `TiffSByteType`.
