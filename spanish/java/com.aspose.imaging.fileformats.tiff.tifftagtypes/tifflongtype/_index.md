...
description: "El tipo long tiff."
type: docs
weight: 18
url: /es/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
**Inheritance:**
...
| --- | --- |
| [TiffLongType(int tagId)](#TiffLongType-int-) | Inicializa una nueva instancia de la clase `TiffLongType`. |
## Métodos
...
Inicializa una nueva instancia de la clase `TiffLongType`.
