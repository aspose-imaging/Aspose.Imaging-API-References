...
description: "Los marcos de alineación"
type: docs
weight: 10
url: /es/java/com.aspose.imaging.fileformats.core.photo/framealigner/
---
**Inheritance:**
java.lang.Object
```
...
Los marcos de alineación
## Métodos

| Método | Descripción |
| --- | --- |
| [process(RasterImage[] images, FrameAlignerOptions options)](#process-com.aspose.imaging.RasterImage---com.aspose.imaging.fileformats.core.photo.FrameAlignerOptions-) | Procesa las imágenes especificadas. |
...
Procesa las imágenes especificadas.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| images | [RasterImage\[\]](../../com.aspose.imaging/rasterimage) | Las imágenes. |
| options | [FrameAlignerOptions](../../com.aspose.imaging.fileformats.core.photo/framealigneroptions) | Las opciones. |

**Returns:**
java.util.List<com.aspose.imaging.Point> - La lista de desplazamientos por imágenes
