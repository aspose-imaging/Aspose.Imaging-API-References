...
description: "El registro EMR_POLYBEZIERTO16 especifica una o más curvas Bézier basadas en la posición actual."
type: docs
weight: 88
url: /es/java/com.aspose.imaging.fileformats.emf.emf.records/emfpolybezierto16/
---
**Inheritance:**
...
El registro EMR\_POLYBEZIERTO16 especifica una o más curvas de Bézier basadas en la posición actual.
...
| --- | --- |
| [EmfPolyBezierTo16(EmfRecord record)](#EmfPolyBezierTo16-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | Inicializa una nueva instancia de la clase `EmfPolyBezierTo16`. |
| [EmfPolyBezierTo16()](#EmfPolyBezierTo16--) | Inicializa una nueva instancia de la clase `EmfPolyBezierTo16`. |
...
Inicializa una nueva instancia de la clase `EmfPolyBezierTo16`.
