...
description: "El registro EMR_DRAWESCAPE pasa información arbitraria a un controlador de impresora."
type: docs
weight: 44
url: /es/java/com.aspose.imaging.fileformats.emf.emf.records/emfdrawescape/
---
**Inheritance:**
...
El registro EMR\_DRAWESCAPE pasa información arbitraria a un controlador de impresora. La intención es que la información resulte en la realización del dibujo.
## Constructores

| Constructor | Descripción |
| --- | --- |
| [EmfDrawEscape(EmfRecord source)](#EmfDrawEscape-com.aspose.imaging.fileformats.emf.emf.records.EmfRecord-) | Inicializa una nueva instancia de la clase `EmfDrawEscape`. |
## Métodos
...
Inicializa una nueva instancia de la clase `EmfDrawEscape`.
