...
description: "Las opciones wmf."
type: docs
weight: 54
url: /es/java/com.aspose.imaging.imageoptions/wmfoptions/
---
**Inheritance:**
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Exporta solo las dos primeras páginas. De hecho, solo se convertirá una página porque WMF no es un formato multipágina.
