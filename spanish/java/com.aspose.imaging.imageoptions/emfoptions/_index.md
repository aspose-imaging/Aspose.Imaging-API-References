...
description: "Las opciones Emf."
type: docs
weight: 19
url: /es/java/com.aspose.imaging.imageoptions/emfoptions/
---
**Inheritance:**
...
| [EmfOptions(float dpiX, float dpiY)](#EmfOptions-float-float-) | Inicializa una nueva instancia de la clase `EmfOptions`. |
| [EmfOptions(float dpi)](#EmfOptions-float-) |  |
| [EmfOptions(EmfOptions emfOptions)](#EmfOptions-com.aspose.imaging.imageoptions.EmfOptions-) | Inicializa una nueva instancia de la clase `EmfOptions`. |
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Exporta solo las dos primeras páginas. De hecho, solo se convertirá una página porque EMF no es un formato multipágina.
...
Inicializa una nueva instancia de la clase `EmfOptions`.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| emfOptions | [EmfOptions](../../com.aspose.imaging.imageoptions/emfoptions) | Las opciones de EMF. |
