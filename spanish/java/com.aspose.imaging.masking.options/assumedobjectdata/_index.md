...
description: "Los datos de los objetos asumidos."
type: docs
weight: 10
url: /es/java/com.aspose.imaging.masking.options/assumedobjectdata/
---
**Inheritance:**
java.lang.Object
```
...
| --- | --- |
| [AssumedObjectData()](#AssumedObjectData--) | Inicializa una nueva instancia de la clase [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata). |
| [AssumedObjectData(int type, Rectangle bounds)](#AssumedObjectData-int-com.aspose.imaging.Rectangle-) | Inicializa una nueva instancia de la clase [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata). |
| [AssumedObjectData(String type, Rectangle bounds)](#AssumedObjectData-java.lang.String-com.aspose.imaging.Rectangle-) | Inicializa una nueva instancia de la clase [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata). |
## Métodos

| Método | Descripción |
| --- | --- |
| [getType()](#getType--) | Obtiene el tipo del objeto. |
| [setType(int value)](#setType-int-) | Establece el tipo del objeto. |
| [getBounds()](#getBounds--) | Obtiene los límites del objeto. |
| [setBounds(Rectangle value)](#setBounds-com.aspose.imaging.Rectangle-) | Establece los límites del objeto. |
...
Inicializa una nueva instancia de la clase [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata).
...
| --- | --- | --- |
| tipo | int | El tipo del objeto. |
| bounds | [Rectangle](../../com.aspose.imaging/rectangle) | Los límites del objeto. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| tipo | java.lang.String | El tipo del objeto. |
| bounds | [Rectangle](../../com.aspose.imaging/rectangle) | Los límites del objeto. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | [Rectangle](../../com.aspose.imaging/rectangle) | los límites del objeto. |
