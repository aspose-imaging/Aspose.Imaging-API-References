...
|**Name**|**Description**|
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_0) | Initializes a new instance of the [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) class. |
## **Properties**
...
| page_count | int | r | Gets or sets the page count. |
...
### CdrImage(stream, load_options) {#CdrImage_stream_load_options_0}
...
Initializes a new instance of the [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) class.
