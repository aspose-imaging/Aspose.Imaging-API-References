...
type: docs
weight: 30
url: /python-net/api-reference/aspose.imaging.brushes/lineargradientbrushbase/
---

Represents a [Brush](/imaging/python-net/api-reference/aspose.imaging/brush/) with gradient capabilities and appropriate properties.
