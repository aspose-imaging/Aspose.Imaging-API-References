...
type: docs
weight: 80
url: /python-net/api-reference/aspose.imaging.brushes/solidbrush/
---
...
|**Name**|**Description**|
| :- | :- |
|SolidBrush()|Initializes a new instance of the [SolidBrush](/imaging/python-net/api-reference/aspose.imaging.brushes/solidbrush/) class.|
