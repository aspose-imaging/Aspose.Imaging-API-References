...
|**Name**|**Description**|
| :- | :- |
| [PathGradientBrush(path_points)](#PathGradientBrush_path_points_0) | Initializes a new instance of the PathGradientBrush class |
| [PathGradientBrush(path_points, wrap_mode)](#PathGradientBrush_path_points_wrap_mode_1) | Initializes a new instance of the PathGradientBrush class |
| [PathGradientBrush(path_points)](#PathGradientBrush_path_points_2) | Initializes a new instance of the PathGradientBrush class |
| [PathGradientBrush(path_points, wrap_mode)](#PathGradientBrush_path_points_wrap_mode_3) | Initializes a new instance of the PathGradientBrush class |
| [PathGradientBrush(path)](#PathGradientBrush_path_4) | Initializes a new instance of the PathGradientBrush class |
## **Properties**
...
| [set_sigma_bell_shape(focus)](#set_sigma_bell_shape_focus_13) | Creates a gradient brush that changes color starting from the center of the path outward to the path's boundary. The transition from one color to another is based on a bell-shaped curve. |
| [set_sigma_bell_shape(focus, scale)](#set_sigma_bell_shape_focus_scale_14) | Creates a gradient brush that changes color starting from the center of the path outward to the path's boundary. The transition from one color to another is based on a bell-shaped curve. |
| [set_blend_triangular_shape(focus)](#set_blend_triangular_shape_focus_15) | Creates a gradient with a center color and a linear falloff to one surrounding color. |
| [set_blend_triangular_shape(focus, scale)](#set_blend_triangular_shape_focus_scale_16) | Creates a gradient with a center color and a linear falloff to each surrounding color. |
| [deep_clone()](#deep_clone__17) | Creates a new deep clone of the current [Brush](/imaging/python-net/aspose.imaging/brush/). |
| reset_transform() | Resets the [transform](/imaging/python-net/aspose.imaging.brushes/transformbrush/) property to identity. |
| [create_with_points_f(path_points)](#create_with_points_f_path_points_18) | Initializes a new instance of the [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) class with the specified points. |
| [create_with_points_f_wrap_mode(path_points, wrap_mode)](#create_with_points_f_wrap_mode_path_points_wrap_mode_19) | Initializes a new instance of the [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) class with the specified points and wrap mode. |
| [create_with_points(path_points)](#create_with_points_path_points_20) | Initializes a new instance of the [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) class with the specified points. |
| [create_with_points_wrap_mode(path_points, wrap_mode)](#create_with_points_wrap_mode_path_points_wrap_mode_21) | Initializes a new instance of the [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) class with the specified points and wrap mode. |
| [create_with_path(path)](#create_with_path_path_22) | Initializes a new instance of the [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) class with the specified path. |

### PathGradientBrush(path_points) {#PathGradientBrush_path_points_0}
...
### PathGradientBrush(path_points, wrap_mode) {#PathGradientBrush_path_points_wrap_mode_1}
...
### PathGradientBrush(path_points) {#PathGradientBrush_path_points_2}
...
### PathGradientBrush(path_points, wrap_mode) {#PathGradientBrush_path_points_wrap_mode_3}
...
### PathGradientBrush(path) {#PathGradientBrush_path_4}
...
### set_sigma_bell_shape(focus) {#set_sigma_bell_shape_focus_13}
...
### set_sigma_bell_shape(focus, scale) {#set_sigma_bell_shape_focus_scale_14}
...
### set_blend_triangular_shape(focus) {#set_blend_triangular_shape_focus_15}
...
### set_blend_triangular_shape(focus, scale) {#set_blend_triangular_shape_focus_scale_16}
...
### create_with_points_f(path_points)  [static] {#create_with_points_f_path_points_18}
...
### create_with_points_f_wrap_mode(path_points, wrap_mode)  [static] {#create_with_points_f_wrap_mode_path_points_wrap_mode_19}
...
### create_with_points(path_points)  [static] {#create_with_points_path_points_20}
...
### create_with_points_wrap_mode(path_points, wrap_mode)  [static] {#create_with_points_wrap_mode_path_points_wrap_mode_21}
...
### create_with_path(path)  [static] {#create_with_path_path_22}
