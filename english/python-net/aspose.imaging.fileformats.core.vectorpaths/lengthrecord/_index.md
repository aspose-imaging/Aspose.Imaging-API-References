...
|**Name**|**Description**|
| :- | :- |
| [LengthRecord(data)](#LengthRecord_data_0) | Initializes a new instance of the [LengthRecord](/imaging/python-net/aspose.imaging.fileformats.core.vectorpaths/lengthrecord/) class. |
...
### LengthRecord(data) {#LengthRecord_data_0}
