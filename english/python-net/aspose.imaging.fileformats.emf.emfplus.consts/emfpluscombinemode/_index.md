---
title: EmfPlusCombineMode Enumeration
type: docs
weight: 50
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emfplus.consts/emfpluscombinemode/
---

The CombineMode enumeration defines modes for combining two graphics regions. <br/>            In the following descriptions, the regions to be combined are referred to as the "existing" and "new" regions.
