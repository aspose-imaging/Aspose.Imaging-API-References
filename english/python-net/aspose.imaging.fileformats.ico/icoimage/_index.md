...
|can_load(file_path)|Determines whether given stream contains an ICO image.|
|can_load(file_path, load_options)|Determines whether given stream contains an ICO image.|
|can_load(stream)|Determines whether given stream contains an ICO image.|
|can_load(stream, load_options)|Determines whether given stream contains an ICO image.|
...
|resize(new_width, new_height, resize_type)|Mains the image resize only.|
|resize(new_width, new_height, settings)|Resizes the image.|
|resize(new_width, new_height)|Mains the image resize only.|
...
|rotate_flip(rotate_flip_type)|Rotates, flips, or rotates and flips all pages.|
