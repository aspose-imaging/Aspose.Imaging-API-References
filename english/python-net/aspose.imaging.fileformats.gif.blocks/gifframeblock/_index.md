...
|**Name**|**Description**|
| :- | :- |
|GifFrameBlock(width, height)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(left, top, width, height)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(left, top, width, height, color_palette, is_palette_sorted, is_gif_frame_interlaced, bits_per_pixel)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(image)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(image, left, top)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(image, left, top, is_palette_sorted, is_gif_frame_interlaced, lzw_code_size)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(stream)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(stream, left, top)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(stream, left, top, is_palette_sorted, is_gif_frame_interlaced, lzw_code_size)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(path)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(path, left, top)|Initializes a new instance of the GifFrameBlock class|
|GifFrameBlock(path, left, top, is_palette_sorted, is_gif_frame_interlaced, lzw_code_size)|Initializes a new instance of the GifFrameBlock class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|vertical_resolution|  |
|has_transparent_color|Gets a value indicating whether frame block has transparent color.|
|has_alpha|  |
...
|left|Gets or sets the left image location.|
|top|Gets or sets the top image location.|
|frame_top|Converts to p.|
|frame_left|Gets the left.|
|disposal_method|Gets the disposal method.|
|flags|Gets or sets the flags.|
|control_block|Gets the graphics control block associated with this block.|
|EXTENSION_LABEL|Block extension label.|
|IMAGE_DESCRIPTOR_SIZE|The image descriptor size.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
|save(stream, options_base, bounds_rectangle)|Saves the block to the specified stream.|
|save()|Saves the GIF frame header.|
|save(file_path)|Saves the block to the specified stream.|
|save(file_path, options)|Saves the block to the specified stream.|
|save(file_path, options, bounds_rectangle)|Saves the block to the specified stream.|
|save(stream, options_base)|Saves the block to the specified stream.|
|save(stream)|Saves the object's data to the specified stream.|
|save(file_path, over_write)|Saves the block to the specified stream.|
|can_load(file_path)|  |
...
|resize(new_width, new_height, resize_type)|Resize current frame using full frame approach.|
|resize(new_width, new_height, settings)|Resize current frame using full frame approach.|
|resize(new_width, new_height)|Resize current frame using full frame approach.|
