...
|**Name**|**Description**|
| :- | :- |
| [EmfPlusDrawRects(source)](#EmfPlusDrawRects_source_0) | Initializes a new instance of the [EmfPlusDrawRects](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawrects/) class. |
## **Properties**
...
| object_id | byte | r/w | Gets or sets the object identifier.<br/>            The index of an EmfPlusPen object (section 2.2.1.7) in the EMF+<br/>            Object Table to draw the rectangles. The value MUST be zero to 63, inclusive. |
...
### EmfPlusDrawRects(source) {#EmfPlusDrawRects_source_0}
