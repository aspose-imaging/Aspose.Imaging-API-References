...
type: docs
weight: 280
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emfplus.records/emfplusfillrects/
---
...
|compressed|Gets or sets a value indicating whether this [EmfPlusFillRects](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emfplus.records/emfplusfillrects/) is compressed.<br/>            If set, RectData contains an EmfPlusRect object (section 2.2.2.38). If clear, RectData<br/>             contains an EmfPlusRectF object (section 2.2.2.39) object|
