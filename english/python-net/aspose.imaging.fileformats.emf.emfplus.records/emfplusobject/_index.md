...
|**Name**|**Description**|
| :- | :- |
| [EmfPlusObject(source)](#EmfPlusObject_source_0) | Initializes a new instance of the [EmfPlusObject](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusobject/) class. |
## **Properties**
...
| object_id | byte | r/w | Gets or sets the object identifier.<br/>            The index in the EMF+ Object Table to associate with the object<br/>            created by this record. The value MUST be zero to 63, inclusive. |
...
### EmfPlusObject(source) {#EmfPlusObject_source_0}
