---
title: EmfPlusPropertyRecordType Class
type: docs
weight: 360
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emfplus.records/emfpluspropertyrecordtype/
---
...
**Full Class Name:** aspose.imaging.fileformats.emf.emfplus.records.EmfPlusPropertyRecordType

**Assembly:**  Aspose.Imaging Version: 23.3.0

The EmfPlusPropertyRecordType type exposes the following members:
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|Gets a 16-bit unsigned integer that identifies the record type.|
|flags|Gets or sets a 16-bit unsigned integer that contains information for some records on how<br/>            the operation is to be performed and on the structure of the record.|
