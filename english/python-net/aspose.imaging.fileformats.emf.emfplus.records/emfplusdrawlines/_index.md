...
|**Name**|**Description**|
| :- | :- |
| [EmfPlusDrawLines(source)](#EmfPlusDrawLines_source_0) | Initializes a new instance of the [EmfPlusDrawLines](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawlines/) class. |
## **Properties**
...
| object_id | byte | r/w | Gets or sets the object identifier.<br/>            The index of an EmfPlusPen object (section 2.2.1.7) in the EMF+<br/>            Object Table to draw the lines. The value MUST be zero to 63, inclusive. |
...
### EmfPlusDrawLines(source) {#EmfPlusDrawLines_source_0}
