...
|**Name**|**Description**|
| :- | :- |
|EmfPlusOffsetClip(source)|Initializes a new instance of the EmfPlusOffsetClip class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
...
|size|  |
|data_size|  |
|dx|Gets or sets a 32-bit floating-point value that specifies the horizontal offset for the translation.|
|dy|Gets or sets a 32-bit floating-point value that specifies the vertical offset for the translation.|
