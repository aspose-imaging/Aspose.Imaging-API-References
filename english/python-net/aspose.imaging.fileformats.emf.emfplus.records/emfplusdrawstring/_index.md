...
|**Name**|**Description**|
| :- | :- |
| [EmfPlusDrawString(source)](#EmfPlusDrawString_source_0) | Initializes a new instance of the [EmfPlusDrawString](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawstring/) class. |
## **Properties**
...
| object_id | byte | r/w | Gets or sets the object identifier.<br/>            The index of an EmfPlusFont object (section 2.2.1.3) in the EMF+<br/>            Object Table to render the text. The value MUST be zero to 63, inclusive. |
...
### EmfPlusDrawString(source) {#EmfPlusDrawString_source_0}
