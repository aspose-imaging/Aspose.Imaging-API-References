...
|**Name**|**Description**|
| :- | :- |
|EmfPlusSetPageTransform(source)|Initializes a new instance of the EmfPlusSetPageTransform class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
...
|size|  |
|data_size|  |
|page_unit|Gets the unit of measure for page space coordinates, from the UnitType<br/>            enumeration (section 2.1.1.33). This value SHOULD NOT be UnitTypeDisplay or UnitTypeWorld.|
|page_scale|Gets or sets a 32-bit floating-point value that specifies the scale factor for converting<br/>            page space coordinates to device space coordinates.|
