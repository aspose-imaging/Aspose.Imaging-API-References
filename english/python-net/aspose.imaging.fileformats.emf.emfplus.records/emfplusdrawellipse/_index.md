...
|**Name**|**Description**|
| :- | :- |
| [EmfPlusDrawEllipse(source)](#EmfPlusDrawEllipse_source_0) | Initializes a new instance of the [EmfPlusDrawEllipse](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawellipse/) class. |
## **Properties**
...
| object_id | byte | r/w | Gets or sets the object identifier.<br/>            The index of an EmfPlusPen (section 2.2.1.7) object in the EMF+<br/>            Object Table to draw the ellipse. The value MUST be zero to 63, inclusive. |
...
### EmfPlusDrawEllipse(source) {#EmfPlusDrawEllipse_source_0}
