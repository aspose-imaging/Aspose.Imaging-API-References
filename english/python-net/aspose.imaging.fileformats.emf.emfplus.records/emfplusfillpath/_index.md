...
|**Name**|**Description**|
| :- | :- |
| [EmfPlusFillPath(source)](#EmfPlusFillPath_source_0) | Initializes a new instance of the [EmfPlusFillPath](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusfillpath/) class. |
## **Properties**
...
| object_id | byte | r/w | Gets or sets the object identifier.<br/>            The index of the EmfPlusPath object (section 2.2.1.6) to fill, in the<br/>            EMF+ Object Table. The value MUST be zero to 63, inclusive. |
...
### EmfPlusFillPath(source) {#EmfPlusFillPath_source_0}
