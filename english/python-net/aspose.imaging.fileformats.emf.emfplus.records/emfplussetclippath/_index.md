...
|**Name**|**Description**|
| :- | :- |
|EmfPlusSetClipPath(source)|Initializes a new instance of the EmfPlusSetClipPath class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
...
|object_id|Gets or sets the index of an EmfPlusPath object (section 2.2.1.6) in the EMF+<br/>            Object Table. The value MUST be zero to 63, inclusive.|
