...
type: docs
weight: 10
url: /python-net/api-reference/aspose.imaging.fileformats.dng/dngimage/
---

Dng image representation class

**Namespace:** [aspose.imaging.fileformats.dng](/imaging/python-net/api-reference/aspose.imaging.fileformats.dng/)

**Full Class Name:** aspose.imaging.fileformats.dng.DngImage

**Assembly:**  Aspose.Imaging Version: 23.3.0

The DngImage type exposes the following members:
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|transparent_color|  |
|image_opacity|  |
|img_data|Gets or sets the img data.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
