...
type: docs
weight: 80
url: /python-net/api-reference/aspose.imaging.fileformats.cdr.objects/cdrdocument/
---
...
|texts|Gets the texts.|
|clip_ids|Gets or sets the clip ids.|
|last_text_index|Gets the text indexes.|
