...
| [extract_thumbnail_image()](#extract_thumbnail_image__25) | Extracts the thumbnail image from the Djvu page. |
| [filter(rectangle, options)](#filter_rectangle_options_26) | Filters the specified rectangle. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_27) | Gets an image 32-bit ARGB pixel. |
| [get_background_image()](#get_background_image__28) | Gets the background image. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_29) | Gets the default 32-bit ARGB pixels array. |
| [get_default_options(args)](#get_default_options_args_30) | Gets the default options. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_31) | Gets the default pixels array using partial pixel loader. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_32) | Gets the default raw data array using partial pixel loader. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_33) | Gets the default raw data array. |
| [get_file_format(file_path)](#get_file_format_file_path_34) | Gets the file format. |
| [get_file_format(stream)](#get_file_format_stream_35) | Gets the file format. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_36) | Gets the file format. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_37) | Gets rectangle which fits the current image. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_38) | Gets rectangle which fits the current image. |
| [get_foreground_image(subsample)](#get_foreground_image_subsample_39) | Gets the foreground image for the page |
| [get_modify_date(use_default)](#get_modify_date_use_default_40) | Gets the date and time the resource image was last modified. |
| [get_original_options()](#get_original_options__41) | Gets the options based on the original file settings.<br/>            This can be helpful to keep bit-depth and other parameters of the original image unchanged.<br/>            For example, if we load a black-white PNG image with 1 bit per pixel and then save it using the<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/) method, the output PNG image with 8-bit per pixel will be produced.<br/>            To avoid it and save PNG image with 1-bit per pixel, use this method to get corresponding saving options and pass them<br/>            to the [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) method as the second parameter. |
| [get_pixel(x, y)](#get_pixel_x_y_42) | Gets an image pixel. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_43) | Gets a proportional height. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_44) | Gets a proportional width. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_45) | Converts to aps. |
| [get_skew_angle()](#get_skew_angle__46) | Gets the skew angle.<br/>            This method is applicable to scanned text documents, to determine the skew angle when scanning. |
| [get_text_for_location(rect)](#get_text_for_location_rect_47) | Gets the text for the rectangle location |
| [get_text_image(subsample)](#get_text_image_subsample_48) | Gets the text image. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_74) | Resizes the pages image to the new dimensions |
...
| [save(stream)](#save_stream_94) | Saves the data. |
...
### Method: extract_thumbnail_image() {#extract_thumbnail_image__25}
...
### Method: filter(rectangle, options) {#filter_rectangle_options_26}
...
### Method: get_argb_32_pixel(x, y) {#get_argb_32_pixel_x_y_27}
...
### Method: get_background_image() {#get_background_image__28}
...
### Method: get_default_argb_32_pixels(rectangle) {#get_default_argb_32_pixels_rectangle_29}
...
### Method: get_default_options(args) {#get_default_options_args_30}
...
### Method: get_default_pixels(rectangle, partial_pixel_loader) {#get_default_pixels_rectangle_partial_pixel_loader_31}
...
### Method: get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings) {#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_32}
...
### Method: get_default_raw_data(rectangle, raw_data_settings) {#get_default_raw_data_rectangle_raw_data_settings_33}
...
### Method: get_file_format(file_path)  [static] {#get_file_format_file_path_34}
...
### Method: get_file_format(stream)  [static] {#get_file_format_stream_35}
...
### Method: get_file_format_of_stream(stream)  [static] {#get_file_format_of_stream_stream_36}
...
### Method: get_fitting_rectangle(rectangle, pixels, width, height)  [static] {#get_fitting_rectangle_rectangle_pixels_width_height_37}
...
### Method: get_fitting_rectangle(rectangle, width, height)  [static] {#get_fitting_rectangle_rectangle_width_height_38}
...
### Method: get_foreground_image(subsample) {#get_foreground_image_subsample_39}
...
### Method: get_modify_date(use_default) {#get_modify_date_use_default_40}
...
### Method: get_original_options() {#get_original_options__41}
...
### Method: get_pixel(x, y) {#get_pixel_x_y_42}
...
### Method: get_proportional_height(width, height, new_width)  [static] {#get_proportional_height_width_height_new_width_43}
...
### Method: get_proportional_width(width, height, new_height)  [static] {#get_proportional_width_width_height_new_height_44}
...
### Method: get_serialized_stream(image_options, clipping_rectangle, page_number) {#get_serialized_stream_image_options_clipping_rectangle_page_number_45}
...
### Method: get_skew_angle() {#get_skew_angle__46}
...
### Method: get_text_for_location(rect) {#get_text_for_location_rect_47}
...
### Method: get_text_image(subsample) {#get_text_image_subsample_48}
