...
| [extract_thumbnail_image()](#extract_thumbnail_image__37) | Extracts the thumbnail image from the Djvu page. |
...
| [get_background_image()](#get_background_image__40) | Gets the background image. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_51) | Gets the foreground image for the page |
| [get_modify_date(use_default)](#get_modify_date_use_default_52) | Gets the datetime value the image was last modified. |
...
| [get_text_for_location(rect)](#get_text_for_location_rect_59) | Gets the text for the rectangle location |
| [get_text_image(subsample)](#get_text_image_subsample_60) | Gets the text image. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_87) | Resizes the pages image to the new dimensions |
...
| [save(stream)](#save_stream_107) | Saves the data. |
...
### Method: extract_thumbnail_image() {#extract_thumbnail_image__37}
...
### Method: get_background_image() {#get_background_image__40}
...
### Method: get_foreground_image(subsample) {#get_foreground_image_subsample_51}
...
### Method: get_text_for_location(rect) {#get_text_for_location_rect_59}
...
### Method: get_text_image(subsample) {#get_text_image_subsample_60}
