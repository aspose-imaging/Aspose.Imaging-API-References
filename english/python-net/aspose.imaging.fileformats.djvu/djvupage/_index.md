...
type: docs
weight: 20
url: /python-net/api-reference/aspose.imaging.fileformats.djvu/djvupage/
---
...
**Full Class Name:** aspose.imaging.fileformats.djvu.DjvuPage
...
|transparent_color|  |
|image_opacity|  |
|parent_image|Gets the parent image the page belongs to|
|image|Gets the image.|
|thumbnail_image|Gets or sets the thumbnail image for the page|
|page_number|Gets the page number.|
|is_color|Gets a value indicating whether this instance is color.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
...
|resize(new_width, new_height)|Resizes the pages image to the new dimensions|
...
|get_text_for_location(rect)|Gets the text for the rectangle location|
|get_foreground_image(subsample)|Gets the foreground image for the page|
|get_text_image(subsample)|Gets the text image.|
|get_background_image()|Gets the background image.|
|extract_thumbnail_image()|Extracts the thumbnail image from the Djvu page.|
