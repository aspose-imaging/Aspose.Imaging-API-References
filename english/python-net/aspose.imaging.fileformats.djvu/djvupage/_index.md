...
| [extract_thumbnail_image()](#extract_thumbnail_image__28) | Extracts the thumbnail image from the Djvu page. |
...
| [get_background_image()](#get_background_image__31) | Gets the background image. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_42) | Gets the foreground image for the page |
...
| [get_text_for_location(rect)](#get_text_for_location_rect_50) | Gets the text for the rectangle location |
| [get_text_image(subsample)](#get_text_image_subsample_51) | Gets the text image. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_77) | Resizes the pages image to the new dimensions |
...
### Method: extract_thumbnail_image() {#extract_thumbnail_image__28}
...
### Method: get_background_image() {#get_background_image__31}
...
### Method: get_foreground_image(subsample) {#get_foreground_image_subsample_42}
...
### Method: get_modify_date(use_default) {#get_modify_date_use_default_43}
...
### Method: get_original_options() {#get_original_options__44}
...
### Method: get_pixel(x, y) {#get_pixel_x_y_45}
...
### Method: get_proportional_height(width, height, new_width)  [static] {#get_proportional_height_width_height_new_width_46}
...
### Method: get_proportional_width(width, height, new_height)  [static] {#get_proportional_width_width_height_new_height_47}
...
### Method: get_text_for_location(rect) {#get_text_for_location_rect_50}
...
### Method: get_text_image(subsample) {#get_text_image_subsample_51}
