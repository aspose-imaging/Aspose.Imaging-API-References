...
| [extract_thumbnail_image()](#extract_thumbnail_image__34) | Extracts the thumbnail image from the Djvu page. |
...
| [get_background_image()](#get_background_image__37) | Gets the background image. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_48) | Gets the foreground image for the page |
...
| [get_text_for_location(rect)](#get_text_for_location_rect_56) | Gets the text for the rectangle location |
| [get_text_image(subsample)](#get_text_image_subsample_57) | Gets the text image. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_84) | Resizes the pages image to the new dimensions |
...
| [save(stream)](#save_stream_104) | Saves the data. |
...
### Method: extract_thumbnail_image() {#extract_thumbnail_image__34}
...
### Method: get_background_image() {#get_background_image__37}
...
### Method: get_foreground_image(subsample) {#get_foreground_image_subsample_48}
...
### Method: get_text_for_location(rect) {#get_text_for_location_rect_56}
...
### Method: get_text_image(subsample) {#get_text_image_subsample_57}
