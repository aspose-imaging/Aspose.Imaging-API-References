...
|**Name**|**Description**|
| :- | :- |
| [DjvuImage(stream)](#DjvuImage_stream_0) | Initializes a new instance of the [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) class. |
| [DjvuImage(stream, load_options)](#DjvuImage_stream_load_options_1) | Initializes a new instance of the [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) class. |
## **Properties**
...
| [load(stream, load_options)](#load_stream_load_options_22) | Loads the document. |
| [load(stream)](#load_stream_23) | Loads the document. |
...
| [load_document(stream)](#load_document_stream_52) | Loads the document. |
| [load_document(stream, load_options)](#load_document_stream_load_options_53) | Loads the document. |
...
### DjvuImage(stream) {#DjvuImage_stream_0}
...
### DjvuImage(stream, load_options) {#DjvuImage_stream_load_options_1}
...
### load_document(stream)  [static] {#load_document_stream_52}
...
### load_document(stream, load_options)  [static] {#load_document_stream_load_options_53}
