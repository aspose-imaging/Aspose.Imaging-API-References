...
|**Name**|**Description**|
| :- | :- |
|DjvuImage(stream)|Initializes a new instance of the DjvuImage class|
|DjvuImage(stream, load_options)|Initializes a new instance of the DjvuImage class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|first_page|Gets the first page of the document|
|last_page|Gets the last page of the document|
|next_page|Gets the next page of the document|
|previous_page|Gets the previous page of the document|
## **Methods**
|**Name**|**Description**|
| :- | :- |
...
|load(stream, load_options)|Loads the document.|
|load(stream)|Loads the document.|
...
|load_document(stream)|Loads the document.|
|load_document(stream, load_options)|Loads the document.|
