...
|date_time|Gets or sets the date time.|
...
|photometric_interpretation|Gets or sets the photometric interpretation.|
|planar_configuration|Gets or sets the planar configuration.|
|primary_chromaticities|Gets or sets the chromaticity of the three primary colors of the image.|
|reference_black_white|Gets or sets the reference black white.|
|resolution_unit|Gets or sets the resolution unit.|
|samples_per_pixel|Gets or sets the samples per pixel.|
|software|Gets or sets the software.|
|thumbnail|Gets or sets the thumbnail image.|
|transfer_function|Gets or sets the transfer function.|
|x_resolution|Gets or sets the x resolution.|
|y_cb_cr_coefficients|Gets or sets the matrix coefficients for transformation from RGB to YCbCr image data.|
|y_cb_cr_positioning|Gets or sets the position of chrominance components in relation to the luminance component.|
|y_cb_cr_sub_sampling|Gets or sets the sampling ratio of chrominance components in relation to the luminance component.|
|y_resolution|Gets or sets the y resolution.|
