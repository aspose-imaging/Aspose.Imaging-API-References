...
|**Name**|**Description**|
| :- | :- |
| [TgaImage(path)](#TgaImage_path_0) | Initializes a new instance of the [TgaImage](/imaging/python-net/aspose.imaging.fileformats.tga/tgaimage/) class. |
| [TgaImage(raster_image)](#TgaImage_raster_image_1) | Initializes a new instance of the TgaImage class |
| [TgaImage(stream)](#TgaImage_stream_2) | Initializes a new instance of the TgaImage class |
## **Properties**
...
| [save(stream)](#save_stream_8) | The save data. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_26) | Resizes the image. |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_29) | Resizes the width proportionally. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_32) | Resizes the height proportionally. |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_42) | Binarization of an image using Bradley's adaptive thresholding algorithm using the integral image thresholding |
| [binarize_bradley(brightness_difference)](#binarize_bradley_brightness_difference_43) | Binarization of an image using Bradley's adaptive thresholding algorithm using the integral image thresholding |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_44) | Gamma-correction of an image. |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_45) | Gamma-correction of an image. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_48) | Normalizes the angle.<br/>            This method is applicable to scanned text documents to get rid of the skewed scan.<br/>            This method uses [None](/imaging/python-net/aspose.imaging/rasterimage/) and <see cref="M:Aspose.Imaging.RasterImage.Rotate(float,System.Boolean,Aspose.Imaging.Color)" /> methods. |
...
| [clone()](#clone__52) | Creates a new object that is a copy of the current instance. |
| [clone(tga_image)](#clone_tga_image_53) | Clone other [TgaImage](/imaging/python-net/aspose.imaging.fileformats.tga/tgaimage/) object's properties. |
...
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_69) | The rotate flip. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_109) | Initializes a new instance of the [TgaImage](/imaging/python-net/aspose.imaging.fileformats.tga/tgaimage/) class. |
| [create_from_stream(stream)](#create_from_stream_stream_110) | Initializes a new instance of the [TgaImage](/imaging/python-net/aspose.imaging.fileformats.tga/tgaimage/) class. |

### TgaImage(path) {#TgaImage_path_0}
...
### TgaImage(raster_image) {#TgaImage_raster_image_1}
...
### TgaImage(stream) {#TgaImage_stream_2}
...
### resize(new_width, new_height, resize_type) {#resize_new_width_new_height_resize_type_26}
...
### resize_width_proportionally(new_width, resize_type) {#resize_width_proportionally_new_width_resize_type_29}
...
### resize_height_proportionally(new_height, resize_type) {#resize_height_proportionally_new_height_resize_type_32}
...
### binarize_bradley(brightness_difference, window_size) {#binarize_bradley_brightness_difference_window_size_42}
...
### binarize_bradley(brightness_difference) {#binarize_bradley_brightness_difference_43}
...
### adjust_gamma(gamma_red, gamma_green, gamma_blue) {#adjust_gamma_gamma_red_gamma_green_gamma_blue_44}
...
### adjust_gamma(gamma) {#adjust_gamma_gamma_45}
...
### clone(tga_image) {#clone_tga_image_53}
...
### create_from_image(raster_image)  [static] {#create_from_image_raster_image_109}
...
### create_from_stream(stream)  [static] {#create_from_stream_stream_110}
