...
|**Name**|**Description**|
| :- | :- |
|region_data_header|Gets or sets a 256-bit RegionDataHeader object that describes the following data.|
|data|Gets or sets an array of WMF RectL objects ([MS-WMF] section 2.2.2.19); the objects are <br/>            merged to create the region|
