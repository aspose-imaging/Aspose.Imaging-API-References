...
|**Name**|**Description**|
| :- | :- |
| [EmfLogFontPanose(emf_log_font)](#EmfLogFontPanose_emf_log_font_0) | Initializes a new instance of the [EmfLogFontPanose](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontpanose/) class. |
## **Properties**
...
| padding | short | r/w | Gets or sets a field that exists only to ensure 32-bit alignment of this structure. It MUST be ignored |

### EmfLogFontPanose(emf_log_font) {#EmfLogFontPanose_emf_log_font_0}
