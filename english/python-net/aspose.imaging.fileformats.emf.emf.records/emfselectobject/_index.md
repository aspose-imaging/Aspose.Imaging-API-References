...
type: docs
weight: 1040
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfselectobject/
---
...
|EmfSelectObject()|Initializes a new instance of the [EmfSelectObject](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfselectobject/) class.|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|Gets or sets the type.|
|size|Gets or sets the size of the record|
|object_handle|Gets or sets 32-bit unsigned integer that specifies either the index of a graphics object <br/>            in the EMF Object Table or the index of a stock object from the [EmfStockObject](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emf.consts/emfstockobject/) enumeration.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
