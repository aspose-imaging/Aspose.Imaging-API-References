...
type: docs
weight: 60
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfbeginpath/
---
...
|**Name**|**Description**|
| :- | :- |
|EmfBeginPath()|Initializes a new instance of the [EmfBeginPath](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfbeginpath/) class.|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
