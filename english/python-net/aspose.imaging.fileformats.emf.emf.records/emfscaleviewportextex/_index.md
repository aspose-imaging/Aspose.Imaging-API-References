...
|type|  |
|size|  |
|x_num|Gets or sets a 32-bit signed integer that specifies the horizontal multiplicand. Cannot be zero.|
|x_denom|Gets or sets a 32-bit signed integer that specifies the horizontal divisor. Cannot be zero.|
|y_num|Gets or sets a 32-bit signed integer that specifies the vertical multiplicand. Cannot be zero.|
|y_denom|Gets or sets a 32-bit signed integer that specifies the vertical divisor. Cannot be zero.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
