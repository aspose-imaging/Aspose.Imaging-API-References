...
type: docs
weight: 1000
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfsavedc/
---
...
|EmfSaveDc()|Initializes a new instance of the [EmfSaveDc](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfsavedc/) class.|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
