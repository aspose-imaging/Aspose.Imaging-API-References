...
type: docs
weight: 120
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfclosefigure/
---
...
|**Name**|**Description**|
| :- | :- |
|EmfCloseFigure()|Initializes a new instance of the [EmfCloseFigure](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfclosefigure/) class.|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
