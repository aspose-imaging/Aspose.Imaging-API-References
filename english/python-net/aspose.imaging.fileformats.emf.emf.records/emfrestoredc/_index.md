...
type: docs
weight: 970
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfrestoredc/
---
...
|EmfRestoreDc()|Initializes a new instance of the [EmfRestoreDc](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfrestoredc/) class.|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
