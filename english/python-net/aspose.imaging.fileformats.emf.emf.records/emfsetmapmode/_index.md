...
|**Name**|**Description**|
| :- | :- |
|EmfSetMapMode()|Initializes a new instance of the [EmfSetMapMode](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfsetmapmode/) class.|
|EmfSetMapMode(record)|Initializes a new instance of the EmfSetMapMode class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
