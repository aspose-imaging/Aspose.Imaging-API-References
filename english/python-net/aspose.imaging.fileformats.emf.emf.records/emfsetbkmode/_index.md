...
|type|  |
|size|  |
|background_mode|Gets or sets a 32-bit unsigned integer that specifies the background mode<br/>            and MUST be in the BackgroundMode (section 2.1.4) enumeration.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
