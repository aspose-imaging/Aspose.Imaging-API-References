...
type: docs
weight: 510
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfforceufimapping/
---
...
|type|  |
|size|  |
|ufi|Gets or sets the font id to use, specified as a UniversalFontId (section 2.2.27).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
