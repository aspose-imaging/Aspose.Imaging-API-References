...
|type|  |
|size|  |
|ih_pen|Gets or sets a 32-bit unsigned integer that specifies the index of the logical pen object in<br/>            the EMF Object Table (section 3.1.1.1). This index MUST be saved so that this object can be<br/>            reused or modified.|
|log_pen|Gets or sets a LogPen object (section 2.2.19) that specifies the style, width, and color<br/>            of the logical pen.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
