...
|type|  |
|size|  |
|x_num|Gets or sets a 32-bit signed integer that specifies the horizontal multiplicand. MUST NOT be zero.|
|x_denom|Gets or sets a 32-bit signed integer that specifies the horizontal divisor. MUST NOT be zero.|
|y_num|Gets or sets a 32-bit signed integer that specifies the vertical multiplicand. MUST NOT be zero.|
|y_denom|Gets or sets a 32-bit signed integer that specifies the vertical divisor. MUST NOT be zero.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
