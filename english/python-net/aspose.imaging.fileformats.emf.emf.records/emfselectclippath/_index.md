...
|type|  |
|size|  |
|region_mode|Gets or sets a 32-bit unsigned integer that specifies the way to use the path. The <br/>            value MUST be in the RegionMode enumeration (section 2.1.29).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
