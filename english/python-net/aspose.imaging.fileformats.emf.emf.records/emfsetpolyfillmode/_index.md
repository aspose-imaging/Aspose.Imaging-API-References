...
|type|  |
|size|  |
|polygon_fill_mode|Gets or sets a 32-bit unsigned integer that specifies the polygon fill mode and<br/>            MUST be in the PolygonFillMode (section 2.1.27) enumeration.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
