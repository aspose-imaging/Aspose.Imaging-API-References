...
|**Name**|**Description**|
| :- | :- |
| [EmfMetafileHeader(record)](#EmfMetafileHeader_record_0) | Initializes a new instance of the EmfMetafileHeader class |
...
| [EmfMetafileHeader(header)](#EmfMetafileHeader_header_2) | Initializes a new instance of the EmfMetafileHeader class |
## **Properties**
...
| [create_from_header(header)](#create_from_header_header_5) | Initializes a new instance of the [EmfMetafileHeader](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheader/) class. |

### EmfMetafileHeader(record) {#EmfMetafileHeader_record_0}
...
| :- | :- | :- |
| record | [EmfRecord](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfrecord) |  |

### EmfMetafileHeader() {#EmfMetafileHeader__1}
...
### EmfMetafileHeader(header) {#EmfMetafileHeader_header_2}
...
### create_from_record(record)  [static] {#create_from_record_record_3}
...
### create_from_header(header)  [static] {#create_from_header_header_5}
