...
|**Name**|**Description**|
| :- | :- |
|EmfSetLayout(source)|Initializes a new instance of the EmfSetLayout class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
|size|  |
|layout_mode|Gets or sets a 32-bit unsigned integer that specifies the layout mode|
## **Methods**
|**Name**|**Description**|
| :- | :- |
