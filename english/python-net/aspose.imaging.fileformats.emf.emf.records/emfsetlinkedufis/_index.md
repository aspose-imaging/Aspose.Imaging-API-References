...
|**Name**|**Description**|
| :- | :- |
|EmfSetLinkedUfis(source)|Initializes a new instance of the EmfSetLinkedUfis class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
|size|  |
|ufis|Gets or sets an array of uNumLinkedUFI elements of type UniversalFontId, which specifies<br/>            the identifiers of the linked fonts.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
