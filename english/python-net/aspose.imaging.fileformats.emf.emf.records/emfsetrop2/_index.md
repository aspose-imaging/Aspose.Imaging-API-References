...
|type|  |
|size|  |
|rop_2_mode|Gets or sets a 32-bit unsigned integer that specifies the raster operation mode and<br/>            MUST be in the WMF Binary Raster Op enumeration ([MS-WMF] section 2.1.1.2).|
## **Methods**
|**Name**|**Description**|
| :- | :- |
