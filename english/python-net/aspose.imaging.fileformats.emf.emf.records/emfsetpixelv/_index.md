...
|type|  |
|size|  |
|pixel|Gets or sets a 64-bit WMF PointL object ([MS-WMF] section 2.2.2.15) that specifies the<br/>            logical coordinates for the pixel.|
|argb_32_color|Gets or sets a 32-bit WMF ColorRef object ([MS-WMF] section 2.2.2.8) that specifies the pixel color.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
