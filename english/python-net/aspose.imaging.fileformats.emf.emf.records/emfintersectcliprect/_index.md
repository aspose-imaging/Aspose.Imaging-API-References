...
|**Name**|**Description**|
| :- | :- |
|EmfIntersectClipRect(source)|Initializes a new instance of the EmfIntersectClipRect class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|type|  |
|size|  |
|clip|Gets or sets a WMF RectL object ([MS-WMF] section 2.2.2.19) that specifies the rectangle in logical units.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
