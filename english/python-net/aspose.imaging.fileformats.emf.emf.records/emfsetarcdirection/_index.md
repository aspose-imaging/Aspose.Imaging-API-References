...
|type|  |
|size|  |
|arc_direction|Gets or sets a 32-bit unsigned integer that specifies the arc direction. The value<br/>            MUST be in the ArcDirection enumeration (section 2.1.2).<br/>            The default direction is counterclockwise.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
