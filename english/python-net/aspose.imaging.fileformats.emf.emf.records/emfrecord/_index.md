...
type: docs
weight: 940
url: /python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfrecord/
---
...
|**Name**|**Description**|
| :- | :- |
|EmfRecord()|Initializes a new instance of the [EmfRecord](/imaging/python-net/api-reference/aspose.imaging.fileformats.emf.emf.records/emfrecord/) class.|
