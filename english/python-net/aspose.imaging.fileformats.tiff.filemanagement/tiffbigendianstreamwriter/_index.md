...
|**Name**|**Description**|
| :- | :- |
| [TiffBigEndianStreamWriter(writer)](#TiffBigEndianStreamWriter_writer_0) | Initializes a new instance of the [TiffBigEndianStreamWriter](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamwriter/) class. |
## **Properties**
...
| [write(data)](#write_data_2) | Writes the specified data. |
| [write(data)](#write_data_3) | Writes the specified data. |
| [write(data)](#write_data_4) | Writes the specified data. |
| [write(data)](#write_data_5) | Writes the specified data. |
| [write(data)](#write_data_6) | Writes the specified data. |
| [write(data)](#write_data_7) | Writes the specified data. |
| [write(data)](#write_data_8) | Writes the specified data. |
| [write(data)](#write_data_9) | Writes the specified data. |
| [write(data)](#write_data_10) | Writes the specified data. |
| [write(data)](#write_data_11) | Writes the specified data. |
| [write(data)](#write_data_12) | Writes the specified data. |
| [write(data)](#write_data_13) | Writes the specified data. |
| [write(data)](#write_data_14) | Writes the specified data. |
| [write(data)](#write_data_15) | Writes the specified data. |
| [write(data)](#write_data_16) | Writes the specified data. |
| [write(data)](#write_data_17) | Writes the specified data. |
| [write(data)](#write_data_18) | Writes the specified data. |
| [write(data)](#write_data_19) | Writes the specified data. |
| [write(data)](#write_data_20) | Writes the specified data. |
| [write(data)](#write_data_21) | Writes the specified data. |
| [write(data)](#write_data_22) | Writes the specified data. |
| [write(data)](#write_data_23) | Writes the specified data. |
| [write(data)](#write_data_24) | Writes the specified data. |
| [write(data)](#write_data_25) | Writes the specified data. |
...
### TiffBigEndianStreamWriter(writer) {#TiffBigEndianStreamWriter_writer_0}
...
Initializes a new instance of the [TiffBigEndianStreamWriter](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamwriter/) class.
