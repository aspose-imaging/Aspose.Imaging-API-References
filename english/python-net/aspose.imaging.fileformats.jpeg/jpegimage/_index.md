...
| **Name** | **Description** |
| :- | :- |
| [JpegImage(jpeg_options, width, height)](#JpegImage_jpeg_options_width_height_1) | Initializes a new instance of the [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) class. |
| [JpegImage(path)](#JpegImage_path_2) | Initializes a new instance of the [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) class. |
| [JpegImage(raster_image)](#JpegImage_raster_image_3) | Initializes a new instance of the [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) class. |
| [JpegImage(stream)](#JpegImage_stream_4) | Initializes a new instance of the [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) class. |
| [JpegImage(width, height)](#JpegImage_width_height_5) | Initializes a new instance of the [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) class. |
## **Properties**
...
| ignore_embedded_color_profile | bool | r/w | Gets or sets a value indicating whether embedded color profile is ignored. If embedded color profile is ignored, default color profile is used. |
...
| [load(file_path)](#load_file_path_45) | Loads a new image from the specified file. |
| [load(file_path, load_options)](#load_file_path_load_options_46) | Loads a new image from the specified file. |
...
### Method: to_bitmap() {#to_bitmap__107}
