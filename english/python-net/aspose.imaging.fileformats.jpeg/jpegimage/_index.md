...
| [horizontal_resolution](#horizontal_resolution1) | float | r/w | This property grants you access to the horizontal resolution of the<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), measured in pixels per inch. By setting or retrieving <br/>            this value, you can precisely control the resolution of the image, ensuring it <br/>            meets your specific requirements for quality and clarity. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_30) | Initializes a new instance of the [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) class. |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | Initializes a new instance of the [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) class. |
...
| [get_original_options()](#get_original_options__52) | Gets the original image options of this [Image](/imaging/python-net/aspose.imaging/image/) instance. |
...
**[Example # 1](#example_107)**: The example shows how to load a JpegImage from a file.
...
**[Example # 1](#example_108)**: The example shows how to load a JpegImage from another RasterImage.
...
**[Example # 1](#example_109)**: The following example shows how to create JPEG image of the specified size.


### Property: horizontal_resolution {#horizontal_resolution1}

This property grants you access to the horizontal resolution of the<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), measured in pixels per inch. By setting or retrieving <br/>            this value, you can precisely control the resolution of the image, ensuring it <br/>            meets your specific requirements for quality and clarity.

**See also:**

**[Example # 1](#example_110)**: The following example shows how to set horizontal/vertical resolution of a JP...


### Property: vertical_resolution {#vertical_resolution2}

This property manages the vertical resolution, expressed in pixels per inch, for <br/>            the associated  [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). Adjusting this resolution impacts the <br/>            size and quality of the image when printed or displayed at a fixed physical size. <br/>            By setting this property, you control how densely the image's pixels are packed <br/>            vertically, affecting its overall sharpness and clarity.
...
## **Examples**
### The example shows how to load a JpegImage from a file. {#example_107}
``` python
...
### The example shows how to load a JpegImage from another RasterImage. {#example_108}
``` python
...
### The following example shows how to create JPEG image of the specified size. {#example_109}
``` python
...
### The following example shows how to set horizontal/vertical resolution of a JPEG image. {#example_110}
``` python
...
with Image.load(path_join(dir_, "sample.jp2")) as image:
	jpeg_image = aspycore.as_of(image, JpegImage)
	# Get horizontal and vertical resolution of the JpegImage.
	horizontal_resolution = jpeg_image.horizontal_resolution
	vertical_resolution = jpeg_image.vertical_resolution
	...
	if horizontal_resolution != 96.0 or vertical_resolution != 96.0:
		...
		jpeg_image.set_resolution(96.0, 96.0)
		print("The horizontal resolution, in pixels per inch:", jpeg_image.horizontal_resolution)
		print("The vertical resolution, in pixels per inch:", jpeg_image.vertical_resolution)
