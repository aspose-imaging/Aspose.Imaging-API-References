...
**Namespace:** [aspose.imaging.fileformats.bigtiff](/imaging/python-net/aspose.imaging.fileformats.bigtiff/)
...
|**Name**|**Description**|
| :- | :- |
|BigTiffImage(frame)|Initializes a new instance of the BigTiffImage class|
|BigTiffImage(frames)|Initializes a new instance of the BigTiffImage class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|exif_data|Gets or sets EXIF data for the active frame.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
...
|remove_frame(frame)|Removes the specified frame.|
|cache_data()|  |
...
|create_with_frame(frame)|Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class.|
|create_with_frames(frames)|Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class.|
...
|add(image)|Adds page to the image.|
|add_frames(frames)|Adds the frames array to image|
|insert_frame(index, frame_to_insert)|The insert frame.|
|replace_frame(index, frame_to_replace)|Replaces the frame at the specified position.|
