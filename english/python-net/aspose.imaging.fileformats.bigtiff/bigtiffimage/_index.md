...
The [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class.
...
|**Name**|**Description**|
| :- | :- |
| [BigTiffImage(frame)](#BigTiffImage_frame_0) | Initializes a new instance of the BigTiffImage class |
| [BigTiffImage(frames)](#BigTiffImage_frames_1) | Initializes a new instance of the BigTiffImage class |
## **Properties**
...
| [save(stream)](#save_stream_7) | Saves the object's data to the specified stream. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_24) | Performs proportional resize on the image.<br/>            The proportional resize will resize each frame according to the ratio of <paramref name="newWidth" />/width and <paramref name="newHeight" />/height. |
...
| [adjust_gamma(gamma)](#adjust_gamma_gamma_43) | Gamma-correction of an image. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_47) | Normalizes the angle.<br/>            This method is applicable to scanned text documents to get rid of the skewed scan.<br/>            This method uses [None](/imaging/python-net/aspose.imaging/rasterimage/) and <see cref="M:Aspose.Imaging.FileFormats.Tiff.TiffImage.Rotate(float,System.Boolean,Aspose.Imaging.Color)" /> methods. |
...
| [remove_frame(index)](#remove_frame_index_52) | Removes the frame by its index. |
| [remove_frame(frame)](#remove_frame_frame_53) | Removes the specified frame. |
| cache_data() | Caches the data private. |
| [save_to_stream(stream)](#save_to_stream_stream_54) | Saves image to stream |
...
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_69) | Rotates, flips, or rotates and flips the Active frame only. |
...
| [adjust_brightness(brightness)](#adjust_brightness_brightness_104) | Adjust of a <paramref name="brightness" /> for image. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_105) | [Image](/imaging/python-net/aspose.imaging/image/) contrasting |
...
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_109) | Rotates the flip all. |
| [create_with_frame(frame)](#create_with_frame_frame_110) | Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class. |
| [create_with_frames(frames)](#create_with_frames_frames_111) | Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class. |
| [add_page(page)](#add_page_page_112) | Adds page to the image. |
| align_resolutions() | Helper method to make horizontal and vertical resolutions equal. |
| [add_frame(frame)](#add_frame_frame_113) | Adds the frame to image |
| [add(image)](#add_image_114) | Adds the specified image's frames to current frame. |
| [add_frames(frames)](#add_frames_frames_115) | Adds the frames array to image |
| [insert_frame(index, frame_to_insert)](#insert_frame_index_frame_to_insert_116) | The insert frame. |
| [replace_frame(index, frame_to_replace)](#replace_frame_index_frame_to_replace_117) | Replaces the frame at the specified position. |
| [remove_frame_by_index(index)](#remove_frame_by_index_index_118) | Removes the frame by its index. |
| [resize_proportional(new_width, new_height, resize_type)](#resize_proportional_new_width_new_height_resize_type_119) | Performs proportional resize on the image.<br/>            The proportional resize will resize each frame according to the ratio of <paramref name="newWidth" />/width and <paramref name="newHeight" />/height. |

### BigTiffImage(frame) {#BigTiffImage_frame_0}
...
Initializes a new instance of the BigTiffImage class
...
### BigTiffImage(frames) {#BigTiffImage_frames_1}
...
### adjust_gamma(gamma) {#adjust_gamma_gamma_43}
...
Normalizes the angle.<br/>            This method is applicable to scanned text documents to get rid of the skewed scan.<br/>            This method uses [None](/imaging/python-net/aspose.imaging/rasterimage/) and <see cref="M:Aspose.Imaging.FileFormats.Tiff.TiffImage.Rotate(float,System.Boolean,Aspose.Imaging.Color)" /> methods.
...
### remove_frame(index) {#remove_frame_index_52}
...
### remove_frame(frame) {#remove_frame_frame_53}
...
### rotate_flip_all(rotate_flip) {#rotate_flip_all_rotate_flip_109}
...
### create_with_frame(frame)  [static] {#create_with_frame_frame_110}
...
### create_with_frames(frames)  [static] {#create_with_frames_frames_111}
...
### add_page(page) {#add_page_page_112}
...
### add_frame(frame) {#add_frame_frame_113}
...
### add_frames(frames) {#add_frames_frames_115}
...
### insert_frame(index, frame_to_insert) {#insert_frame_index_frame_to_insert_116}
...
### replace_frame(index, frame_to_replace) {#replace_frame_index_frame_to_replace_117}
...
### remove_frame_by_index(index) {#remove_frame_by_index_index_118}
...
### resize_proportional(new_width, new_height, resize_type) {#resize_proportional_new_width_new_height_resize_type_119}
