...
**Summary:** The [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class.
...
| **Name** | **Description** |
| :- | :- |
| [BigTiffImage(frame)](#BigTiffImage_frame_1) | Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class. |
| [BigTiffImage(frames)](#BigTiffImage_frames_2) | Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class. |
## **Properties**
...
| [create_with_frame(frame)](#create_with_frame_frame_25) | Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class. |
| [create_with_frames(frames)](#create_with_frames_frames_26) | Initializes a new instance of the [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) class. |
...
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_35) | Gets the default pixels array using partial pixel loader. |
...
| [get_file_format(file_path)](#get_file_format_file_path_38) | Gets the file format. |
| [get_file_format(stream)](#get_file_format_stream_39) | Gets the file format. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_40) | Gets the file format. |
...
| [to_bitmap()](#to_bitmap__118) | Converts raster image to the bitmap. |
...
### Method: create_with_frame(frame)  [static] {#create_with_frame_frame_25}
...
### Method: create_with_frames(frames)  [static] {#create_with_frames_frames_26}
...
| Type | Description |
| :- | :- |
| [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage) | A new BigTiffImage image that includes the frames. |


### Method: crop(left_shift, right_shift, top_shift, bottom_shift) {#crop_left_shift_right_shift_top_shift_bottom_shift_27}
...
### Method: crop(rectangle) {#crop_rectangle_28}
...
### Method: dither(dithering_method, bits_count) {#dither_dithering_method_bits_count_29}
...
### Method: dither(dithering_method, bits_count, custom_palette) {#dither_dithering_method_bits_count_custom_palette_30}
...
### Method: filter(rectangle, options) {#filter_rectangle_options_31}
...
### Method: get_argb_32_pixel(x, y) {#get_argb_32_pixel_x_y_32}
...
### Method: get_default_argb_32_pixels(rectangle) {#get_default_argb_32_pixels_rectangle_33}
...
### Method: get_default_options(args) {#get_default_options_args_34}
...
### Method: get_default_pixels(rectangle, partial_pixel_loader) {#get_default_pixels_rectangle_partial_pixel_loader_35}
...
### Method: get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings) {#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_36}
...
### Method: get_default_raw_data(rectangle, raw_data_settings) {#get_default_raw_data_rectangle_raw_data_settings_37}
...
### Method: get_file_format(file_path)  [static] {#get_file_format_file_path_38}
...
### Method: get_file_format(stream)  [static] {#get_file_format_stream_39}
...
### Method: get_file_format_of_stream(stream)  [static] {#get_file_format_of_stream_stream_40}
...
### Method: get_fitting_rectangle(rectangle, pixels, width, height)  [static] {#get_fitting_rectangle_rectangle_pixels_width_height_41}
...
### Method: get_fitting_rectangle(rectangle, width, height)  [static] {#get_fitting_rectangle_rectangle_width_height_42}
...
### Method: to_bitmap() {#to_bitmap__118}
