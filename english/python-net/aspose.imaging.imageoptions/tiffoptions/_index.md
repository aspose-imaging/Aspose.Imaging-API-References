...
|**Name**|**Description**|
| :- | :- |
| [TiffOptions(expected_format, byte_order)](#TiffOptions_expected_format_byte_order_0) | Initializes a new instance of the [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) class. |
| [TiffOptions(expected_format)](#TiffOptions_expected_format_1) | Initializes a new instance of the TiffOptions class |
| [TiffOptions(options)](#TiffOptions_options_2) | Initializes a new instance of the TiffOptions class |
| [TiffOptions(tags)](#TiffOptions_tags_3) | Initializes a new instance of the TiffOptions class |
## **Properties**
...
| [create_with_format(expected_format)](#create_with_format_expected_format_5) | Initializes a new instance of the [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) class. By default little endian convention is used. |
| [create_with_options(options)](#create_with_options_options_6) | Initializes a new instance of the [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) class. |
| [create_with_tags(tags)](#create_with_tags_tags_7) | Initializes a new instance of the [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) class. |
...
### TiffOptions(expected_format, byte_order) {#TiffOptions_expected_format_byte_order_0}
...
### TiffOptions(expected_format) {#TiffOptions_expected_format_1}
...
### TiffOptions(options) {#TiffOptions_options_2}
...
### TiffOptions(tags) {#TiffOptions_tags_3}
