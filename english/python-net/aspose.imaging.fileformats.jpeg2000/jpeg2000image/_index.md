...
| [horizontal_resolution](#horizontal_resolution1) | float | r/w | This property allows you to retrieve or modify the horizontal resolution of the<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), measured in pixels per inch (PPI). Adjusting this <br/>            resolution can impact the size and quality of the image when printed or displayed. <br/>            By setting the horizontal resolution, users can optimize the image for specific <br/>            output devices or applications, ensuring the best possible visual results. |
...
| [vertical_resolution](#vertical_resolution2) | float | r/w | This property provides access to the vertical resolution of the<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), measured in pixels per inch (PPI). Modifying this <br/>            resolution can affect the quality and size of the image when printed or displayed. <br/>            By adjusting the vertical resolution, users can optimize the image for different <br/>            output devices or applications, ensuring optimal visual rendering. |
...
| [create(width, height)](#create_width_height_26) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
| [create(width, height, argb_32_pixels)](#create_width_height_argb_32_pixels_27) | Creates a new raster image stored in memory. |
| [create_from_file_with_bpp(path, bits_per_pixel)](#create_from_file_with_bpp_path_bits_per_pixel_28) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
...
| [create_from_image(image)](#create_from_image_image_31) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
| [create_from_image_with_bpp(raster_image, bits_per_pixel)](#create_from_image_with_bpp_raster_image_bits_per_pixel_32) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
...
| [create_from_stream(stream)](#create_from_stream_stream_35) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
| [create_from_stream_with_bpp(stream, bits_per_pixel)](#create_from_stream_with_bpp_stream_bits_per_pixel_36) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_37) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
| [create_with_width_height_bitscount(width, height, bits_count)](#create_with_width_height_bitscount_width_height_bits_count_38) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
| [create_with_width_height_options(width, height, options)](#create_with_width_height_options_width_height_options_39) | Initializes a new instance of the [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) class. |
...
| [crop(rectangle)](#crop_rectangle_41) | Cropping the image. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_42) | Performs dithering on the current image. |
...
| [embed_digital_signature(password)](#embed_digital_signature_password_44) | Embed digital sign based on provided password into the image using steganography. |
| [filter(rectangle, options)](#filter_rectangle_options_45) | Filters the specified rectangle. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_46) | Gets an image 32-bit ARGB pixel. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_47) | Gets the default 32-bit ARGB pixels array. |
| [get_default_options(args)](#get_default_options_args_48) | Gets the default options. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_49) | Gets the default pixels array using partial pixel loader. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_50) | Gets the default raw data array using partial pixel loader. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_51) | Gets the default raw data array. |
| [get_file_format(file_path)](#get_file_format_file_path_52) | Gets the file format. |
| [get_file_format(stream)](#get_file_format_stream_53) | Gets the file format. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_54) | Gets the file format. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_55) | Gets rectangle which fits the current image. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_56) | Gets rectangle which fits the current image. |
| [get_modify_date(use_default)](#get_modify_date_use_default_57) | Gets the datetime value the image was last modified. |
| [get_original_options()](#get_original_options__58) | Retrieve the image options based on the original file settings. This method is <br/>            beneficial for maintaining the bit-depth and other parameters of the original <br/>            image, ensuring consistency and preserving the integrity of the image data. <br/>            Accessing these options facilitates seamless handling and processing of the image <br/>            while retaining its original characteristics.<br/>            For example, if we load a black-white PNG image with 1 bit per pixel and then save it using the<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/) method, the output PNG image with 8-bit per pixel will be produced.<br/>            To avoid it and save PNG image with 1-bit per pixel, use this method to get corresponding saving options and pass them<br/>            to the [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) method as the second parameter. |
| [get_pixel(x, y)](#get_pixel_x_y_59) | Gets an image pixel. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_60) | Gets a proportional height. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_61) | Gets a proportional width. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_62) | Converts to aps. |
| [get_skew_angle()](#get_skew_angle__63) | Gets the skew angle.<br/>            This method is applicable to scanned text documents, to determine the skew angle when scanning. |
...
| [load(stream, load_options)](#load_stream_load_options_68) | Loads a new image from the specified stream. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_91) | Resizes the image. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_92) | Resizes the image. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_96) | Resizes the height proportionally. |
...
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_99) | Resizes the width proportionally. The default [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) is used. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_100) | Resizes the width proportionally. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_101) | Resizes the width proportionally. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_102) | Resizes the width proportionally. |
| [rotate(angle)](#rotate_angle_103) | Rotate image around the center. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_104) | Rotate image around the center. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_105) | Rotates, flips, or rotates and flips the image. |
...
| [save(stream)](#save_stream_110) | Saves the object's data to the specified stream |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_116) | Saves pixels (format specific method). |
...
**[Example # 1](#example_166)**: This example shows how to load a JPEG2000 image from a file and save it to PNG.
...
**[Example # 1](#example_167)**: This example shows how to load a JPEG2000 image from a file stream and save i...
...
**[Example # 1](#example_168)**: This example shows how to create a JPEG2000 image and save it to a file.
...
### Property: horizontal_resolution {#horizontal_resolution1}

This property allows you to retrieve or modify the horizontal resolution of the<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), measured in pixels per inch (PPI). Adjusting this <br/>            resolution can impact the size and quality of the image when printed or displayed. <br/>            By setting the horizontal resolution, users can optimize the image for specific <br/>            output devices or applications, ensuring the best possible visual results.

**See also:**

**[Example # 1](#example_172)**: The following example shows how to set horizontal/vertical resolution of a JP...


### Property: vertical_resolution {#vertical_resolution2}

This property provides access to the vertical resolution of the<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), measured in pixels per inch (PPI). Modifying this <br/>            resolution can affect the quality and size of the image when printed or displayed. <br/>            By adjusting the vertical resolution, users can optimize the image for different <br/>            output devices or applications, ensuring optimal visual rendering.
...
### Method: create_from_file_with_bpp(path, bits_per_pixel)  [static] {#create_from_file_with_bpp_path_bits_per_pixel_28}
...
### Method: create_from_image_with_bpp(raster_image, bits_per_pixel)  [static] {#create_from_image_with_bpp_raster_image_bits_per_pixel_32}
...
### Method: create_from_stream_with_bpp(stream, bits_per_pixel)  [static] {#create_from_stream_with_bpp_stream_bits_per_pixel_36}
...
### Method: create_with_width_height(width, height)  [static] {#create_with_width_height_width_height_37}
...
### Method: create_with_width_height_bitscount(width, height, bits_count)  [static] {#create_with_width_height_bitscount_width_height_bits_count_38}
...
### Method: create_with_width_height_options(width, height, options)  [static] {#create_with_width_height_options_width_height_options_39}
...
### Method: crop(left_shift, right_shift, top_shift, bottom_shift) {#crop_left_shift_right_shift_top_shift_bottom_shift_40}
...
### Method: crop(rectangle) {#crop_rectangle_41}
...
### Method: dither(dithering_method, bits_count) {#dither_dithering_method_bits_count_42}
...
### Method: dither(dithering_method, bits_count, custom_palette) {#dither_dithering_method_bits_count_custom_palette_43}
...
### Method: embed_digital_signature(password) {#embed_digital_signature_password_44}
...
### Method: filter(rectangle, options) {#filter_rectangle_options_45}
...
### Method: get_argb_32_pixel(x, y) {#get_argb_32_pixel_x_y_46}
...
### Method: get_modify_date(use_default) {#get_modify_date_use_default_57}
...
### Method: get_original_options() {#get_original_options__58}
...
### Method: get_pixel(x, y) {#get_pixel_x_y_59}
...
### Method: get_proportional_height(width, height, new_width)  [static] {#get_proportional_height_width_height_new_width_60}
...
### Method: get_proportional_width(width, height, new_height)  [static] {#get_proportional_width_width_height_new_height_61}
...
### Method: get_serialized_stream(image_options, clipping_rectangle, page_number) {#get_serialized_stream_image_options_clipping_rectangle_page_number_62}
...
### Method: get_skew_angle() {#get_skew_angle__63}
...
### Method: resize_width_proportionally(new_width) {#resize_width_proportionally_new_width_99}
...
### Method: resize_width_proportionally(new_width, resize_type) {#resize_width_proportionally_new_width_resize_type_100}
...
### Method: resize_width_proportionally(new_width, settings) {#resize_width_proportionally_new_width_settings_101}
...
### Method: resize_width_proportionally_settings(new_width, settings) {#resize_width_proportionally_settings_new_width_settings_102}
...
### Method: rotate(angle) {#rotate_angle_103}
...
### Method: rotate(angle, resize_proportionally, background_color) {#rotate_angle_resize_proportionally_background_color_104}
...
### Method: rotate_flip(rotate_flip_type) {#rotate_flip_rotate_flip_type_105}
...
## **Examples**
### This example shows how to load a JPEG2000 image from a file and save it to PNG. {#example_166}
``` python
...
### This example shows how to load a JPEG2000 image from a file stream and save it to PNG. {#example_167}
``` python
import aspose.pycore as aspycore
from aspose.imaging.fileformats.jpeg2000 import Jpeg2000Image
from aspose.imaging.imageoptions import PngOptions
...
### This example shows how to create a JPEG2000 image and save it to a file. {#example_168}
``` python
...
### The following example shows how to set horizontal/vertical resolution of a JPEG2000 image. {#example_172}
``` python
import aspose.pycore as aspycore
from os.path import join as path_join
...
dir_: str = "c:\\temp"
with Image.load(path_join(dir_, "sample.jp2")) as image:
	jpeg2000_image = aspycore.as_of(image, Jpeg2000Image)
	# Get horizontal and vertical resolution of the Jpeg2000Image.
	horizontal_resolution = jpeg2000_image.horizontal_resolution
	vertical_resolution = jpeg2000_image.vertical_resolution
	...
	if horizontal_resolution != 96.0 or vertical_resolution != 96.0:
		...
		jpeg2000_image.set_resolution(96.0, 96.0)
		print("The horizontal resolution, in pixels per inch:", jpeg2000_image.horizontal_resolution)
		print("The vertical resolution, in pixels per inch:", jpeg2000_image.vertical_resolution)
