...
|**Name**|**Description**|
| :- | :- |
|BmpImage(path)|Initializes a new instance of the BmpImage class|
|BmpImage(path, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)|Initializes a new instance of the BmpImage class|
|BmpImage(stream)|Initializes a new instance of the BmpImage class|
|BmpImage(stream, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)|Initializes a new instance of the BmpImage class|
|BmpImage(raster_image)|Initializes a new instance of the BmpImage class|
|BmpImage(raster_image, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)|Initializes a new instance of the BmpImage class|
|BmpImage(width, height)|Initializes a new instance of the BmpImage class|
|BmpImage(width, height, bits_per_pixel, palette)|Initializes a new instance of the BmpImage class|
|BmpImage(width, height, bits_per_pixel, palette, compression, horizontal_resolution, vertical_resolution)|Initializes a new instance of the BmpImage class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|transparent_color|  |
|image_opacity|  |
|bitmap_info_header|Gets the bitmap information header.|
|compression|Gets the image compression.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
|save(stream, options_base, bounds_rectangle)|  |
|save()|Saves the image into BMP file format.|
|save(file_path)|  |
