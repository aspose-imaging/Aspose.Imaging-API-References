...
|**Name**|**Description**|
| :- | :- |
|PngImage(width, height)|Initializes a new instance of the PngImage class|
|PngImage(path)|Initializes a new instance of the PngImage class|
|PngImage(raster_image)|Initializes a new instance of the PngImage class|
|PngImage(path, color_type)|Initializes a new instance of the PngImage class|
|PngImage(raster_image, color_type)|Initializes a new instance of the PngImage class|
|PngImage(stream)|Initializes a new instance of the PngImage class|
|PngImage(width, height, color_type)|Initializes a new instance of the PngImage class|
|PngImage(png_options, width, height)|Initializes a new instance of the PngImage class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
