...
| [horizontal_resolution](#horizontal_resolution2) | float | r/w | Retrieve or modify the horizontal resolution of the image. This property <br/>            represents the number of pixels per inch along the horizontal axis of the <br/>            image. Adjusting this resolution can affect the physical size of the image when <br/>            printed or displayed. |
...
| [vertical_resolution](#vertical_resolution3) | float | r/w | Provides access to the vertical resolution of the image. Developers can use <br/>            this property to retrieve or modify the resolution setting, which indicates the <br/>            number of pixels per inch (PPI) along the vertical axis of the image. |
...
| [create(width, height)](#create_width_height_26) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
| [create(width, height, argb_32_pixels)](#create_width_height_argb_32_pixels_27) | Creates a new raster image stored in memory. |
| [create_from_file_with_color_type(path, color_type)](#create_from_file_with_color_type_path_color_type_28) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_31) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
| [create_from_image_with_color_type(raster_image, color_type)](#create_from_image_with_color_type_raster_image_color_type_32) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
...
| [create_from_stream(stream)](#create_from_stream_stream_35) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_36) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
| [create_with_width_height_color_type(width, height, color_type)](#create_with_width_height_color_type_width_height_color_type_37) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
| [create_with_width_height_options(png_options, width, height)](#create_with_width_height_options_png_options_width_height_38) | Initializes a new instance of the [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) class. |
...
| [save(stream)](#save_stream_109) | The save data. |
...
**[Example # 1](#example_111)**: This example shows how to load a PNG image from a file.
...
**[Example # 1](#example_112)**: This example shows how to load a PNG image from a file with the specified col...
...
**[Example # 1](#example_114)**: This example shows how to load PNG image from a BMP image.
...
**[Example # 1](#example_115)**: This example shows how to load PNG image from a BMP image with the specified ...
...
**[Example # 1](#example_113)**: This example shows how to load a PNG image from a file or a file stream.
...
**[Example # 1](#example_116)**: This example shows how to create a PNG image of the specified size, fill it w...
...
**[Example # 1](#example_117)**: This example shows how to create a PNG image of the specified size with the s...
...
**[Example # 1](#example_118)**: The following example shows how to check if a PNG image supports alpha-channel.


### Property: horizontal_resolution {#horizontal_resolution2}

Retrieve or modify the horizontal resolution of the image. This property <br/>            represents the number of pixels per inch along the horizontal axis of the <br/>            image. Adjusting this resolution can affect the physical size of the image when <br/>            printed or displayed.

**See also:**

**[Example # 1](#example_119)**: The following example shows how to set horizontal/vertical resolution of a PN...


### Property: vertical_resolution {#vertical_resolution3}

Provides access to the vertical resolution of the image. Developers can use <br/>            this property to retrieve or modify the resolution setting, which indicates the <br/>            number of pixels per inch (PPI) along the vertical axis of the image.
...
### Method: create_from_file_with_color_type(path, color_type)  [static] {#create_from_file_with_color_type_path_color_type_28}
...
### Method: create_from_image_with_color_type(raster_image, color_type)  [static] {#create_from_image_with_color_type_raster_image_color_type_32}
...
### Method: create_with_width_height(width, height)  [static] {#create_with_width_height_width_height_36}
...
### Method: create_with_width_height_color_type(width, height, color_type)  [static] {#create_with_width_height_color_type_width_height_color_type_37}
...
### Method: create_with_width_height_options(png_options, width, height)  [static] {#create_with_width_height_options_png_options_width_height_38}
...
| Parameter | Type | Description |
| :- | :- | :- |
| use_default | bool | If value is to **True**, it uses the information from . <br/>            Otherwise, it tries to extract it from internal PNG settings or [Image.xmp_data](/imaging/python-net/aspose.imaging/image/). |

**Returns**

| Type | Description |
| :- | :- |
| System.DateTime | datetime or min date value in case of exception while retrieving the value. |
...
## **Examples**
### This example shows how to load a PNG image from a file. {#example_111}
``` python
...
### This example shows how to load a PNG image from a file with the specified color type. {#example_112}
``` python
...
### This example shows how to load a PNG image from a file or a file stream. {#example_113}
``` python
import aspose.pycore as aspycore
from aspose.imaging import Image
from aspose.imaging.fileformats.png import PngImage
...
### This example shows how to load PNG image from a BMP image. {#example_114}
``` python
...
### This example shows how to load PNG image from a BMP image with the specified color type. {#example_115}
``` python
...
### This example shows how to create a PNG image of the specified size with the specified color type, fill it with a solid color and save it to a file. {#example_117}
``` python
from aspose.imaging.fileformats.png import PngImage, PngColorType
from aspose.imaging import Graphics, Color
from aspose.imaging.brushes import SolidBrush
...
### The following example shows how to check if a PNG image supports alpha-channel. {#example_118}
``` python
...
### The following example shows how to set horizontal/vertical resolution of a PNG image. {#example_119}
``` python
from os.path import join as path_join
import aspose.pycore as aspycore
from aspose.imaging import Image
...
dir_: str = "c:\\temp"
with Image.load(path_join(dir_, "sample.png")) as image:
	png_image = aspycore.as_of(image, PngImage)
	# Get horizontal and vertical resolution of the PngImage.
	horizontal_resolution = png_image.horizontal_resolution
	vertical_resolution = png_image.vertical_resolution
	...
	if horizontal_resolution != 96.0 or vertical_resolution != 96.0:
		# Use the SetResolution method for updating both resolution values in a single call.
		print("Set resolution values to 96 dpi")
		png_image.set_resolution(96.0, 96.0)
		print("The horizontal resolution, in pixels per inch:", png_image.horizontal_resolution)
		print("The vertical resolution, in pixels per inch:", png_image.vertical_resolution)


```

### The example shows how to remove any object from the image using Graphics Path with Content Aware fill algorithm. {#example_241}
``` python
...
### The example shows how to remove any object from the image using Graphics Path with Telea algorithm. {#example_242}
``` python
from aspose.imaging import Image, Figure, GraphicsPath, RectangleF
from aspose.imaging.shapes import EllipseShape
from aspose.imaging.watermark import WatermarkRemover
