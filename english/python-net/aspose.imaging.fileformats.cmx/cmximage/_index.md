...
type: docs
weight: 10
url: /python-net/api-reference/aspose.imaging.fileformats.cmx/cmximage/
---
...
**Full Class Name:** aspose.imaging.fileformats.cmx.CmxImage
...
|**Name**|**Description**|
| :- | :- |
|CmxImage(stream_container, load_options)|Initializes a new instance of the CmxImage class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|document|Gets the CMX document.|
