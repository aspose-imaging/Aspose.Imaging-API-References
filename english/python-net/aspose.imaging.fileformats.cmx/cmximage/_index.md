...
type: docs
weight: 90
url: /python-net/aspose.imaging.fileformats.cmx/cmximage/
---
...
The CmxImage type exposes the following members:
## **Constructors**
|**Name**|**Description**|
| :- | :- |
| [CmxImage(stream_container, load_options)](#CmxImage_stream_container_load_options_0) | Initializes a new instance of the [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) class. |
## **Properties**
...
| document | [CmxDocument](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxdocument/) | r | Gets the CMX document. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_30) | Resizes the height proportionally. |
...
| [save_to_stream(stream)](#save_to_stream_stream_32) | Saves the object's data to the specified stream. |
| [can_load_with_options(file_path, load_options)](#can_load_with_options_file_path_load_options_33) | Determines whether image can be loaded from the specified file path and optionally using the specified open options. |
| [can_load_stream(stream)](#can_load_stream_stream_34) | Determines whether image can be loaded from the specified stream. |
| [can_load_stream_with_options(stream, load_options)](#can_load_stream_with_options_stream_load_options_35) | Determines whether image can be loaded from the specified stream and optionally using the specified <paramref name="loadOptions" />. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_36) | Gets the file format. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_37) | Loads a new image from the specified file. |
...
| [can_save(options)](#can_save_options_40) | Determines whether image can be saved to the specified file format represented by the passed save options. |
...
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_45) | Resizes the width proportionally. |
...
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_47) | Rotates, flips, or rotates and flips the image. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_48) | Saves the object's data to the specified file location in the specified file format according to save options. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_49) | Saves the object's data to the specified file location in the specified file format according to save options. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_50) | Saves the image's data to the specified stream in the specified file format according to save options. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_51) | Saves the image's data to the specified stream in the specified file format according to save options. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_52) | Sets the image palette. |
...
| [get_embedded_images()](#get_embedded_images__55) | Gets the embedded images. |

### CmxImage(stream_container, load_options) {#CmxImage_stream_container_load_options_0}
...
Initializes a new instance of the [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) class.
...
### save_to_stream(stream) {#save_to_stream_stream_32}
...
### can_load_with_options(file_path, load_options)  [static] {#can_load_with_options_file_path_load_options_33}
...
### can_load_stream(stream)  [static] {#can_load_stream_stream_34}
...
### can_load_stream_with_options(stream, load_options)  [static] {#can_load_stream_with_options_stream_load_options_35}
...
### get_file_format_of_stream(stream)  [static] {#get_file_format_of_stream_stream_36}
...
### load_with_options(file_path, load_options)  [static] {#load_with_options_file_path_load_options_37}
...
### load_stream_with_options(stream, load_options)  [static] {#load_stream_with_options_stream_load_options_38}
...
### load_stream(stream)  [static] {#load_stream_stream_39}
...
### can_save(options) {#can_save_options_40}
...
### resize_by_type(new_width, new_height, resize_type) {#resize_by_type_new_width_new_height_resize_type_41}
...
### resize_by_settings(new_width, new_height, settings) {#resize_by_settings_new_width_new_height_settings_42}
...
### get_default_options(args) {#get_default_options_args_43}
...
### get_original_options() {#get_original_options__44}
...
### resize_width_proportionally_settings(new_width, settings) {#resize_width_proportionally_settings_new_width_settings_45}
...
### resize_height_proportionally_settings(new_height, settings) {#resize_height_proportionally_settings_new_height_settings_46}
...
### rotate_flip(rotate_flip_type) {#rotate_flip_rotate_flip_type_47}
...
### save_with_options(file_path, options) {#save_with_options_file_path_options_48}
...
### save_with_options_rect(file_path, options, bounds_rectangle) {#save_with_options_rect_file_path_options_bounds_rectangle_49}
...
### save_to_stream_with_options(stream, options_base) {#save_to_stream_with_options_stream_options_base_50}
...
### save_to_stream_with_options_rect(stream, options_base, bounds_rectangle) {#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_51}
...
### set_palette(palette, update_colors) {#set_palette_palette_update_colors_52}
...
### get_proportional_width(width, height, new_height)  [static] {#get_proportional_width_width_height_new_height_53}
...
### get_proportional_height(width, height, new_width)  [static] {#get_proportional_height_width_height_new_width_54}
...
### get_embedded_images() {#get_embedded_images__55}
