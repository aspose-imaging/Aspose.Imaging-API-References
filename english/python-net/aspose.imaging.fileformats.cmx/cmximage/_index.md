...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | Customize the color palette of the image with this intuitive method. Ideal for<br/>            developers seeking to apply specific color schemes or adjustments dynamically,<br/>            ensuring precise control over the visual appearance of their images. |
...
**[Example # 1](#example_188)**: The following example shows how to cache all pages of a CMX image.
...
## **Examples**
### The following example shows how to cache all pages of a CMX image. {#example_188}
``` python
