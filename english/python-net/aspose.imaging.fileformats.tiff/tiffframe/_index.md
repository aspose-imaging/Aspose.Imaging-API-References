...
| [create(files)](#create_files_19) | Creates the specified files. |
| [create(files, throw_exception_on_load_error)](#create_files_throw_exception_on_load_error_20) | Creates the specified files. |
...
| [create_from_image(image)](#create_from_image_image_27) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
| [create_from_image_with_options(image, options)](#create_from_image_with_options_image_options_28) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
| [create_from_stream(stream)](#create_from_stream_stream_29) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
| [create_from_stream_with_options(stream, options)](#create_from_stream_with_options_stream_options_30) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
...
### Method: create_from_image_with_options(image, options)  [static] {#create_from_image_with_options_image_options_28}
...
### Method: create_from_stream_with_options(stream, options)  [static] {#create_from_stream_with_options_stream_options_30}
