...
| [create_frame_from(tiff_frame, options)](#create_frame_from_tiff_frame_options_26) | Creates the frame from specified _tiffFrame_ using the specified _options_.<br/>            The pixel data is preserved but converted to the desired format. |
| [create_from_file_with_options(path, options)](#create_from_file_with_options_path_options_27) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
...
| [create_from_image(image)](#create_from_image_image_30) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
| [create_from_image_with_options(image, options)](#create_from_image_with_options_image_options_31) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
...
| [create_from_stream(stream)](#create_from_stream_stream_34) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
| [create_from_stream_with_options(stream, options)](#create_from_stream_with_options_stream_options_35) | Initializes a new instance of the [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) class. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_87) | Resizes the image. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_88) | Resizes the image. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_100) | Rotate image around the center. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_101) | Rotates, flips, or rotates and flips the image. |
...
| [save(stream)](#save_stream_106) | Saves the object's data to the specified stream. |
...
### Method: create_frame_from(tiff_frame, options)  [static] {#create_frame_from_tiff_frame_options_26}
...
### Method: create_from_file_with_options(path, options)  [static] {#create_from_file_with_options_path_options_27}
...
### Method: create_from_image_with_options(image, options)  [static] {#create_from_image_with_options_image_options_31}
...
### Method: create_from_stream_with_options(stream, options)  [static] {#create_from_stream_with_options_stream_options_35}
