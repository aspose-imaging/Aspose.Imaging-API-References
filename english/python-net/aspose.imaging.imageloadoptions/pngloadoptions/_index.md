...
type: docs
weight: 50
url: /python-net/api-reference/aspose.imaging.imageloadoptions/pngloadoptions/
---
...
|**Name**|**Description**|
| :- | :- |
|PngLoadOptions()|Initializes a new instance of the [PngLoadOptions](/imaging/python-net/api-reference/aspose.imaging.imageloadoptions/pngloadoptions/) class.|
## **Properties**
|**Name**|**Description**|
| :- | :- |
