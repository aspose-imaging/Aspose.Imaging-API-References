...
type: docs
weight: 10
url: /python-net/api-reference/aspose.imaging.imageloadoptions/cdrloadoptions/
---
...
|**Name**|**Description**|
| :- | :- |
|CdrLoadOptions()|Initializes a new instance of the [CdrLoadOptions](/imaging/python-net/api-reference/aspose.imaging.imageloadoptions/cdrloadoptions/) class.|
## **Properties**
|**Name**|**Description**|
| :- | :- |
