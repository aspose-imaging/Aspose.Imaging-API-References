...
| **Name** | **Description** |
| :- | :- |
| [TiffLong8Type(tag_id)](#TiffLong8Type_tag_id_1) | Initializes a new instance of the [TiffLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/) class. |
| [TiffLong8Type(tag_id)](#TiffLong8Type_tag_id_2) | Initializes a new instance of the [TiffLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/) class. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| count | int | r | Gets the count of elements. |
| data_size | int | r | Gets the tag value size. |
| element_size | System.Byte | r | Gets size of element. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initializes a new instance of the [TiffLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/) class. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initializes a new instance of the [TiffLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/) class. |
