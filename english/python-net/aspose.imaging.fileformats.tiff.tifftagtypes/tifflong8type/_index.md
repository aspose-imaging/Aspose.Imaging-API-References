---
title: TiffLong8Type Class
type: docs
weight: 80
url: /python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/
---
...
The TiffLong8Type type exposes the following members:
## **Constructors**
|**Name**|**Description**|
| :- | :- |
| [TiffLong8Type(tag_id)](#TiffLong8Type_tag_id_0) | Initializes a new instance of the TiffLong8Type class |
| [TiffLong8Type(tag_id)](#TiffLong8Type_tag_id_1) | Initializes a new instance of the TiffLong8Type class |
## **Properties**
...
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_9) | Initializes a new instance of the [TiffLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/) class. |
| [create_with_tag(tag_id)](#create_with_tag_tag_id_10) | Initializes a new instance of the [TiffLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/) class. |

### TiffLong8Type(tag_id) {#TiffLong8Type_tag_id_0}
...
### TiffLong8Type(tag_id) {#TiffLong8Type_tag_id_1}
...
### create_with_tag_id(tag_id)  [static] {#create_with_tag_id_tag_id_9}
...
Initializes a new instance of the [TiffLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflong8type/) class.
...
### create_with_tag(tag_id)  [static] {#create_with_tag_tag_id_10}
