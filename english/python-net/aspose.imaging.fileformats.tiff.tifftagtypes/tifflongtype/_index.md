...
type: docs
weight: 70
url: /python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
...
**Full Class Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffLongType
...
|**Name**|**Description**|
| :- | :- |
|TiffLongType(tag_id)|Initializes a new instance of the TiffLongType class|
|TiffLongType(tag_id)|Initializes a new instance of the TiffLongType class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
...
|create_with_tag(tag_id)|Initializes a new instance of the [TiffLongType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/) class.|
|create_with_tag_id(tag_id)|Initializes a new instance of the [TiffLongType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/) class.|
