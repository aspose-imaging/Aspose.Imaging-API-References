...
type: docs
weight: 120
url: /python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
...
**Full Class Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffSShortType
...
|**Name**|**Description**|
| :- | :- |
|TiffSShortType(tag_id)|Initializes a new instance of the TiffSShortType class|
|TiffSShortType(tag_id)|Initializes a new instance of the TiffSShortType class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
...
|create_with_tag(tag_id)|Initializes a new instance of the [TiffSShortType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) class.|
|create_with_tag_id(tag_id)|Initializes a new instance of the [TiffSShortType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) class.|
