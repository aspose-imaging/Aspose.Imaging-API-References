...
type: docs
weight: 100
url: /python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
...
**Full Class Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffSLongType
...
|**Name**|**Description**|
| :- | :- |
|TiffSLongType(tag_id)|Initializes a new instance of the TiffSLongType class|
|TiffSLongType(tag_id)|Initializes a new instance of the TiffSLongType class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
...
|create_with_tag(tag_id)|Initializes a new instance of the [TiffSLongType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/) class.|
|create_with_tag_id(tag_id)|Initializes a new instance of the [TiffSLongType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/) class.|
