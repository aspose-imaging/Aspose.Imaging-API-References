...
|**Name**|**Description**|
| :- | :- |
|TiffByteType(tag_id)|Initializes a new instance of the TiffByteType class|
|TiffByteType(tag_id)|Initializes a new instance of the TiffByteType class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
...
|create_with_tag(tag_id)|Initializes a new instance of the [TiffByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/) class.|
|create_with_tag_id(tag_id)|Initializes a new instance of the [TiffByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/) class.|
