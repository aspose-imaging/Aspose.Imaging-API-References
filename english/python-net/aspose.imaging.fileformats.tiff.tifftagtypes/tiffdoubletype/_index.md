...
type: docs
weight: 40
url: /python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
**Full Class Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffDoubleType
...
|**Name**|**Description**|
| :- | :- |
|TiffDoubleType(tag_id)|Initializes a new instance of the TiffDoubleType class|
|TiffDoubleType(tag_id)|Initializes a new instance of the TiffDoubleType class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
...
|create_with_tag(tag_id)|Initializes a new instance of the [TiffDoubleType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/) class.|
|create_with_tag_id(tag_id)|Initializes a new instance of the [TiffDoubleType](/imaging/python-net/api-reference/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/) class.|
