...
| [create(files)](#create_files_19) | Creates the instance of the [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/). |
...
| [get_full_frame()](#get_full_frame__49) | Gets the full frame. |
| [get_modify_date(use_default)](#get_modify_date_use_default_50) | Gets the datetime value the image was last modified. |
...
| [save(stream)](#save_stream_103) | Saves the data. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_120) | Tries to set a _metadata_ instance, if this [Image](/imaging/python-net/aspose.imaging/image/) instance supports and implements [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) instance. |
...
### Method: get_full_frame() {#get_full_frame__49}
