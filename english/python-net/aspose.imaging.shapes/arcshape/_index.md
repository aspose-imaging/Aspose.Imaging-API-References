...
type: docs
weight: 10
url: /python-net/api-reference/aspose.imaging.shapes/arcshape/
---
...
|**Name**|**Description**|
| :- | :- |
|ArcShape()|Initializes a new instance of the [ArcShape](/imaging/python-net/api-reference/aspose.imaging.shapes/arcshape/) class.|
