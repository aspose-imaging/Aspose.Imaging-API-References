...
type: docs
weight: 20
url: /python-net/api-reference/aspose.imaging.fileformats.webp/webpframeblock/
---
...
|**Name**|**Description**|
| :- | :- |
|WebPFrameBlock(raster_image)|Initializes a new instance of the WebPFrameBlock class|
|WebPFrameBlock(width, height)|Initializes a new instance of the WebPFrameBlock class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|use_alpha_blending|Gets or sets the value indicating whether current frame gets blended with the previous frame alpha values.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
