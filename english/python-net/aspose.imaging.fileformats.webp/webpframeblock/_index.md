...
| **Name** | **Description** |
| :- | :- |
| [WebPFrameBlock(raster_image)](#WebPFrameBlock_raster_image_1) | <para><br/>                    Initializes a new instance of the [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)</para><br/>        <para>class.</para> |
