...
| [create(width, height)](#create_width_height_28) | Creates a new raster image stored in memory. |
| [create(width, height, argb_32_pixels)](#create_width_height_argb_32_pixels_29) | Creates a new raster image stored in memory. |
| [create_from_file_with_options(path, load_options)](#create_from_file_with_options_path_load_options_30) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from file. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_33) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from rasterImage. |
| [create_from_image_with_options(raster_image, load_options)](#create_from_image_with_options_raster_image_load_options_34) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from rasterImage. |
...
| [create_from_stream(stream)](#create_from_stream_stream_37) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class<br/>                from stream. |
| [create_from_stream_with_options(stream, load_options)](#create_from_stream_with_options_stream_load_options_38) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from stream. |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_39) | Crop the image by applying left, right, top, and bottom shifts, effectively <br/>            selecting a region of interest within the image. Utilize this method to <br/>            dynamically extract desired portions of the image while adjusting its composition <br/>            and focus according to your application's requirements. |
| [crop(rectangle)](#crop_rectangle_40) | Crop the image using a specified rectangle region, removing unwanted portions <br/>            while retaining the desired content. Integrate this method into your image <br/>            processing workflow to precisely extract and focus on specific areas of interest <br/>            within the image, enhancing clarity and composition for various applications. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_41) | Performs dithering on the current image. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_42) | Perform dithering on the current image to reduce color banding and enhance visual <br/>            quality. Integrate this method into your image processing workflow to achieve <br/>            smoother transitions between colors and improve the overall appearance of the <br/>            image within your application. |
| [embed_digital_signature(password)](#embed_digital_signature_password_43) | Embed digital sign based on provided password into each page of the image. |
| [filter(rectangle, options)](#filter_rectangle_options_44) | Filter the content within the specified rectangle, applying a designated image <br/>            processing filter to enhance or modify the selected region. Integrate this method <br/>            into your image manipulation workflow to achieve targeted enhancements or <br/>            transformations within your application. |
...
| [insert_block(index, block)](#insert_block_index_block_63) | Insert a new WebP block at the specified index within the image, enabling precise <br/>            control over the block sequence. Integrate this method to seamlessly incorporate <br/>            additional WebP blocks into the image data structure, facilitating advanced image <br/>            processing and optimization within your application. |
| [is_digital_signed(password, percentage_threshold)](#is_digital_signed_password_percentage_threshold_64) | Performs a fast check to determine if the image is digitally signed, using the provided password and threshold. |
| [load(file_path)](#load_file_path_65) | Loads a new image from the specified file path or URL.<br/>            If _filePath_ is a file path the method just opens the file.<br/>            If _filePath_ is an URL, the method downloads the file, stores it as a temporary one, and opens it. |
| [load(file_path, load_options)](#load_file_path_load_options_66) | Loads a new image from the specified file path or URL.<br/>            If _filePath_ is a file path the method just opens the file.<br/>            If _filePath_ is an URL, the method downloads the file, stores it as a temporary one, and opens it. |
| [load(stream)](#load_stream_67) | Loads a new image from the specified stream. |
| [load(stream, load_options)](#load_stream_load_options_68) | Loads the data from stream. |
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_69) | Loads 32-bit ARGB pixels. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_70) | Loads 64-bit ARGB pixels. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_71) | Loads pixels in CMYK format. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_72) | Loads pixels in CMYK format.<br/>            This method is deprecated. Please use more effective the [RasterImage.load_cmyk_32_pixels(rectangle)](/imaging/python-net/aspose.imaging/rasterimage/) method. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_73) | Loads 32-bit ARGB pixels partially (by blocks). |
| [load_partial_argb_64_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_74) | Loads 64-bit ARGB pixels partially by packs. |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_75) | Loads pixels partially by packs. |
| [load_pixels(rectangle)](#load_pixels_rectangle_76) | Loads pixels. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_77) | Loads raw data. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_78) | Loads raw data. |
| [load_stream(stream)](#load_stream_stream_79) | Loads a new image from the specified stream. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_80) | Loads a new image from the specified stream. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_81) | Loads a new image from the specified file path or URL.<br/>            If _filePath_ is a file path the method just opens the file.<br/>            If _filePath_ is an URL, the method downloads the file, stores it as a temporary one, and opens it. |
...
| [remove_block(block)](#remove_block_block_85) | Remove the specified WebP block from the image, facilitating efficient management <br/>            of image data structure. Utilize this method to streamline image processing <br/>            workflows by eliminating unnecessary blocks or components within your application. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_86) | Replaces one color to another with allowed difference and preserves original alpha value to save smooth edges. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_87) | Replaces one color to another with allowed difference and preserves original alpha value to save smooth edges. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_88) | Replaces one color to another with allowed difference and preserves original alpha value to save smooth edges. |
...
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_93) | Resize the image according to specified settings, enabling precise control over <br/>            dimensions, aspect ratio, and scaling behavior. Integrate this method into your <br/>            image processing workflow to achieve customized resizing operations tailored to <br/>            the specific requirements of your application. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_105) | Rotate the image around its center by a specified angle, while proportionally <br/>            resizing it and applying specified background color parameters. Incorporate this <br/>            method into your image processing workflow to achieve precise transformations with <br/>            customizable background colors, ensuring optimal visual presentation within your <br/>            application. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_106) | Apply rotation, flipping, or both operations exclusively to the active frame <br/>            within the image. Integrate this method into your image processing workflow to <br/>            achieve precise manipulation of individual frames, enhancing flexibility and <br/>            control over frame transformations within your application. |
...
| [save(stream)](#save_stream_112) | Saves the data. |
...
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_117) | Saves the pixels.<br/>            This method is deprecated. Please use more effective the [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) method. |
...
| [save_to_stream(stream)](#save_to_stream_stream_120) | Saves the object's data to the specified stream. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_128) | Sets the resolution for this [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_129) | Tries to set a _metadata_ instance, if this [Image](/imaging/python-net/aspose.imaging/image/) instance supports and implements [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) instance. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_130) | Writes the whole scan line to the specified scan line index. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_131) | Writes the whole scan line to the specified scan line index. |
...
**[Example # 1](#example_173)**: This example shows how to load a WebP image from a file and save it to PNG.
...
**[Example # 1](#example_175)**: This example shows how to create a WebP image from another raster image.
...
**[Example # 1](#example_174)**: This example shows how to load a WebP image from a file stream and save it to...
...
**[Example # 1](#example_176)**: This example shows how to create a WebP image with the specified options from...
...
**[Example # 1](#example_177)**: The following example loads a WEBP image and prints information about raw dat...
...
### Method: create(width, height)  [static] {#create_width_height_28}
...
### Method: create(width, height, argb_32_pixels)  [static] {#create_width_height_argb_32_pixels_29}
...
### Method: create_from_file_with_options(path, load_options)  [static] {#create_from_file_with_options_path_load_options_30}
...
### Method: create_from_image(raster_image)  [static] {#create_from_image_raster_image_33}
...
### Method: create_from_image_with_options(raster_image, load_options)  [static] {#create_from_image_with_options_raster_image_load_options_34}
...
### Method: create_from_stream_with_options(stream, load_options)  [static] {#create_from_stream_with_options_stream_load_options_38}
...
### Method: insert_block(index, block) {#insert_block_index_block_63}
...
### Method: is_digital_signed(password, percentage_threshold) {#is_digital_signed_password_percentage_threshold_64}
...
### Method: load(file_path)  [static] {#load_file_path_65}
...
### Method: load(file_path, load_options)  [static] {#load_file_path_load_options_66}
...
### Method: load(stream)  [static] {#load_stream_67}
...
### Method: load(stream, load_options)  [static] {#load_stream_load_options_68}
...
### Method: load_argb_32_pixels(rectangle) {#load_argb_32_pixels_rectangle_69}
...
### Method: load_argb_64_pixels(rectangle) {#load_argb_64_pixels_rectangle_70}
...
### Method: load_cmyk_32_pixels(rectangle) {#load_cmyk_32_pixels_rectangle_71}
...
### Method: load_cmyk_pixels(rectangle) {#load_cmyk_pixels_rectangle_72}
...
### Method: load_partial_argb_32_pixels(rectangle, partial_pixel_loader) {#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_73}
...
### Method: load_partial_argb_64_pixels(rectangle, partial_pixel_loader) {#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_74}
...
### Method: load_partial_pixels(desired_rectangle, pixel_loader) {#load_partial_pixels_desired_rectangle_pixel_loader_75}
...
### Method: load_pixels(rectangle) {#load_pixels_rectangle_76}
...
### Method: load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader) {#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_77}
...
### Method: load_raw_data(rectangle, raw_data_settings, raw_data_loader) {#load_raw_data_rectangle_raw_data_settings_raw_data_loader_78}
...
### Method: load_stream(stream)  [static] {#load_stream_stream_79}
...
### Method: load_stream_with_options(stream, load_options)  [static] {#load_stream_with_options_stream_load_options_80}
...
### Method: load_with_options(file_path, load_options)  [static] {#load_with_options_file_path_load_options_81}
...
### Method: normalize_angle(resize_proportionally, background_color) {#normalize_angle_resize_proportionally_background_color_82}
...
### Method: read_argb_32_scan_line(scan_line_index) {#read_argb_32_scan_line_scan_line_index_83}
...
### Method: read_scan_line(scan_line_index) {#read_scan_line_scan_line_index_84}
...
### Method: remove_block(block) {#remove_block_block_85}
...
### Method: try_set_metadata(metadata) {#try_set_metadata_metadata_129}
...
### Method: write_argb_32_scan_line(scan_line_index, argb_32_pixels) {#write_argb_32_scan_line_scan_line_index_argb_32_pixels_130}
...
### Method: write_scan_line(scan_line_index, pixels) {#write_scan_line_scan_line_index_pixels_131}
...
## **Examples**
### This example shows how to load a WebP image from a file and save it to PNG. {#example_173}
``` python
...
### This example shows how to load a WebP image from a file stream and save it to PNG. {#example_174}
``` python
...
### This example shows how to create a WebP image from another raster image. {#example_175}
``` python
from os.path import join
...
### This example shows how to create a WebP image with the specified options from scratch. {#example_176}
``` python
from aspose.imaging.fileformats.webp import WebPImage
from aspose.imaging import Graphics, Color
from aspose.imaging.brushes import SolidBrush
...
### The following example loads a WEBP image and prints information about raw data format and alpha channel. {#example_177}
``` python
