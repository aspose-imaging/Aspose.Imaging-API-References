...
| **Name** | **Description** |
| :- | :- |
| [add_block(block)](#add_block_block_1) | Adds a new Webp block. |
...
| [insert_block(index, block)](#insert_block_index_block_50) | Adds a new Webp block. |
...
| [load(stream, load_options)](#load_stream_load_options_54) | Loads the data from stream. |
...
| [to_bitmap()](#to_bitmap__115) | Converts raster image to the bitmap. |
...
### Method: insert_block(index, block) {#insert_block_index_block_50}
...
### Method: remove_block(block) {#remove_block_block_71}
...
### Method: to_bitmap() {#to_bitmap__115}
