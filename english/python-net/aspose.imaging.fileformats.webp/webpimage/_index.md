...
|**Name**|**Description**|
| :- | :- |
| [WebPImage(stream)](#WebPImage_stream_0) | Initializes a new instance of the WebPImage class |
| [WebPImage(stream, load_options)](#WebPImage_stream_load_options_1) | Initializes a new instance of the WebPImage class |
| [WebPImage(path)](#WebPImage_path_2) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from file. |
| [WebPImage(path, load_options)](#WebPImage_path_load_options_3) | Initializes a new instance of the WebPImage class |
| [WebPImage(raster_image)](#WebPImage_raster_image_4) | Initializes a new instance of the WebPImage class |
| [WebPImage(raster_image, load_options)](#WebPImage_raster_image_load_options_5) | Initializes a new instance of the WebPImage class |
| [WebPImage(width, height, options)](#WebPImage_width_height_options_6) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class with empty image. |
| [WebPImage(width, height, options, load_options)](#WebPImage_width_height_options_load_options_7) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class with empty image. |
## **Properties**
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image) | r | <para>Gets the blocks.</para><br/>        <para>Gets the Webp blocks.</para> |
| options | [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/) | r | Gets or sets the options. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
| [save(stream)](#save_stream_13) | Saves the data. |
...
| [load(stream, load_options)](#load_stream_load_options_28) | Loads the data from stream. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_36) | Resizes the width proportionally. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_51) | <see cref="!:RasterCahcedMultipageImage.Rotate" /> image around the center. |
| [rotate(angle)](#rotate_angle_52) | Rotate image around the center. |
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_53) | Normalizes the angle.<br/>            This method is applicable to scanned text documents to get rid of the skewed scan.<br/>            This method uses GetSkewAngle and <see cref="M:Aspose.Imaging.RasterCachedMultipageImage.Rotate(float,System.Boolean,Aspose.Imaging.Color)" /> methods. |
...
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_54) | Replaces one color to another with allowed difference and preserves original alpha value to save smooth edges. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_57) | Replaces all non-transparent colors with new color and preserves original alpha value to save smooth edges.<br/>                Note: if you use it on images without transparency, all colors will be replaced with a single one. |
...
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_73) | Rotates, flips, or rotates and flips the Active frame only. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_102) | Saves the pixels. |
...
| [adjust_brightness(brightness)](#adjust_brightness_brightness_108) | Adjust of a <paramref name="brightness" /> for image. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_109) | [Image](/imaging/python-net/aspose.imaging/image/) contrasting |
...
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_113) | Rotates the flip all. |
| [create_from_stream(stream)](#create_from_stream_stream_114) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class<br/>                from stream. |
| [create_from_stream_with_options(stream, load_options)](#create_from_stream_with_options_stream_load_options_115) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from stream. |
| [create_from_file_with_options(path, load_options)](#create_from_file_with_options_path_load_options_116) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from file. |
| [create_from_image(raster_image)](#create_from_image_raster_image_117) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from rasterImage. |
| [create_from_image_with_options(raster_image, load_options)](#create_from_image_with_options_raster_image_load_options_118) | Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class from rasterImage. |
| [add_page(page)](#add_page_page_119) | Adds page to the image. |
| [add_block(block)](#add_block_block_120) | Adds a new Webp block. |
| clear_blocks() | Clears all the Webp blocks. |
| [insert_block(index, block)](#insert_block_index_block_121) | Adds a new Webp block. |
| [remove_block(block)](#remove_block_block_122) | Removes the Webp block. |

### WebPImage(stream) {#WebPImage_stream_0}
...
### WebPImage(stream, load_options) {#WebPImage_stream_load_options_1}
...
### WebPImage(path) {#WebPImage_path_2}
...
### WebPImage(path, load_options) {#WebPImage_path_load_options_3}
...
### WebPImage(raster_image) {#WebPImage_raster_image_4}
...
### WebPImage(raster_image, load_options) {#WebPImage_raster_image_load_options_5}
...
### WebPImage(width, height, options) {#WebPImage_width_height_options_6}
...
Initializes a new instance of the [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) class with empty image.
...
### WebPImage(width, height, options, load_options) {#WebPImage_width_height_options_load_options_7}
...
### replace_color(old_color_argb, old_color_diff, new_color_argb) {#replace_color_old_color_argb_old_color_diff_new_color_argb_54}
...
### replace_non_transparent_colors(new_color) {#replace_non_transparent_colors_new_color_57}
...
### rotate_flip_all(rotate_flip) {#rotate_flip_all_rotate_flip_113}
...
### create_from_stream_with_options(stream, load_options)  [static] {#create_from_stream_with_options_stream_load_options_115}
...
### create_from_file_with_options(path, load_options)  [static] {#create_from_file_with_options_path_load_options_116}
...
### create_from_image(raster_image)  [static] {#create_from_image_raster_image_117}
...
### create_from_image_with_options(raster_image, load_options)  [static] {#create_from_image_with_options_raster_image_load_options_118}
...
### add_page(page) {#add_page_page_119}
...
### add_block(block) {#add_block_block_120}
...
### insert_block(index, block) {#insert_block_index_block_121}
...
| Parameter | Type | Description |
| :- | :- | :- |
| index | int | The zero-based element, at which <paramref name="block" /> will be<br/>                inserted. |
| block | [IFrame](/imaging/python-net/aspose.imaging.fileformats.webp/iframe) | The Webp block to add. |

### remove_block(block) {#remove_block_block_122}
