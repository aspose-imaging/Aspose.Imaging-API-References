...
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_47) | This versatile method apply various transformations to images, including <br/>            rotation and flipping, to achieve desired orientations and visual effects. With <br/>            intuitive parameters, you can specify the degree of rotation and the type of <br/>            flipping (horizontal, vertical, or both) to precisely manipulate the image as needed. |
...
This versatile method apply various transformations to images, including <br/>            rotation and flipping, to achieve desired orientations and visual effects. With <br/>            intuitive parameters, you can specify the degree of rotation and the type of <br/>            flipping (horizontal, vertical, or both) to precisely manipulate the image as needed.
