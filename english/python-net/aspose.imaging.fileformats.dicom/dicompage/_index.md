---
title: DicomPage Class
type: docs
weight: 40
url: /python-net/aspose.imaging.fileformats.dicom/dicompage/
---

**Summary:** It is class for work with DICOM files of the type multi frame

**Module:** [aspose.imaging.fileformats.dicom](/imaging/python-net/aspose.imaging.fileformats.dicom/)

**Full Name:** aspose.imaging.fileformats.dicom.DicomPage
...
| **Name** | **Description** |
| :- | :- |
| [DicomPage(image, index)](#DicomPage_image_index_1) | Initializes a new instance of the [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) class. |
| [DicomPage(image, index, load_options)](#DicomPage_image_index_load_options_2) | Initializes a new instance of the [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) class. |
## **Properties**
...
| index | int | r | Gets the index of the current page. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_51) | Loads 32-bit ARGB pixels partially (by blocks). |
...
| [save(stream)](#save_stream_88) | Saves the data. |
...
### Constructor: DicomPage(image, index) {#DicomPage_image_index_1}


```
 DicomPage(image, index) 
```

Initializes a new instance of the [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) class.

**Parameters:**

| Parameter | Type | Description |
| :- | :- | :- |
| image | [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage) | The image. |
| index | int | The index. |

### Constructor: DicomPage(image, index, load_options) {#DicomPage_image_index_load_options_2}


```
 DicomPage(image, index, load_options) 
```
