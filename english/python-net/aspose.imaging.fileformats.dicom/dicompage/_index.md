...
|**Name**|**Description**|
| :- | :- |
| [DicomPage(image, index)](#DicomPage_image_index_0) | Initializes a new instance of the [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) class. |
| [DicomPage(image, index, load_options)](#DicomPage_image_index_load_options_1) | Initializes a new instance of the [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) class. |
## **Properties**
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_24) | Resizes the image. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_31) | Resizes the height proportionally. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_45) | Rotate image around the center. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_49) | Replaces all non-transparent colors with new color and preserves original alpha value to save smooth edges.<br/>            Note: if you use it on images without transparency, all colors will be replaced with a single one. |
...
| [save_to_stream(stream)](#save_to_stream_stream_51) | Saves the object's data to the specified stream. |
| [can_load_with_options(file_path, load_options)](#can_load_with_options_file_path_load_options_52) | Determines whether image can be loaded from the specified file path and optionally using the specified open options. |
| [can_load_stream(stream)](#can_load_stream_stream_53) | Determines whether image can be loaded from the specified stream. |
| [can_load_stream_with_options(stream, load_options)](#can_load_stream_with_options_stream_load_options_54) | Determines whether image can be loaded from the specified stream and optionally using the specified <paramref name="loadOptions" />. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_55) | Gets the file format. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_56) | Loads a new image from the specified file. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_57) | Loads a new image from the specified stream. |
| [load_stream(stream)](#load_stream_stream_58) | Loads a new image from the specified stream. |
| [can_save(options)](#can_save_options_59) | Determines whether image can be saved to the specified file format represented by the passed save options. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_60) | Resizes the image. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_61) | Resizes the image. |
| [get_default_options(args)](#get_default_options_args_62) | Gets the default options. |
| [get_original_options()](#get_original_options__63) | Gets the options based on the original file settings.<br/>            This can be helpful to keep bit-depth and other parameters of the original image unchanged.<br/>            For example, if we load a black-white PNG image with 1 bit per pixel and then save it using the<br/>            <see cref="M:Aspose.Imaging.DataStreamSupporter.Save(System.String)" /> method, the output PNG image with 8-bit per pixel will be produced.<br/>            To avoid it and save PNG image with 1-bit per pixel, use this method to get corresponding saving options and pass them<br/>            to the <see cref="M:Aspose.Imaging.Image.Save(System.String,Aspose.Imaging.ImageOptionsBase)" /> method as the second parameter. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_64) | Resizes the width proportionally. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_65) | Resizes the height proportionally. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_66) | Rotates, flips, or rotates and flips the image. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | Saves the object's data to the specified file location in the specified file format according to save options. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | Saves the object's data to the specified file location in the specified file format according to save options. |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_71) | Sets the image palette. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_72) | Gets a proportional width. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_73) | Gets a proportional height. |
| [get_modify_date(use_default)](#get_modify_date_use_default_74) | Gets the date and time the resource image was last modified. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_75) | Gets the default pixels array using partial pixel loader. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_76) | Gets the default 32-bit ARGB pixels array. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_77) | Gets an image 32-bit ARGB pixel. |
| [get_pixel(x, y)](#get_pixel_x_y_78) | Gets an image pixel. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_79) | Sets an image 32-bit ARGB pixel for the specified position. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_80) | Sets an image pixel for the specified position. |
...
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_83) | Writes the whole scan line to the specified scan line index. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_84) | Writes the whole scan line to the specified scan line index. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_85) | Loads 32-bit ARGB pixels partially (by blocks). |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_86) | Loads pixels partially by packs. |
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_87) | Loads 32-bit ARGB pixels. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_88) | Loads 64-bit ARGB pixels. |
| [load_partial_argb_64_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_89) | Loads 64-bit ARGB pixels partially by packs. |
| [load_pixels(rectangle)](#load_pixels_rectangle_90) | Loads pixels. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_91) | Loads pixels in CMYK format.<br/>            This method is deprecated. Please use more effective the <see cref="M:Aspose.Imaging.RasterImage.LoadCmyk32Pixels(Aspose.Imaging.Rectangle)" /> method. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_92) | Loads pixels in CMYK format. |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_93) | Saves the raw data. |
...
| [to_bitmap()](#to_bitmap__96) | Converts raster image to the bitmap. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_97) | Saves the pixels.<br/>            This method is deprecated. Please use more effective the <see cref="M:Aspose.Imaging.RasterImage.SaveCmyk32Pixels(Aspose.Imaging.Rectangle,int[])" /> method. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_98) | Saves the pixels. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_99) | Sets the resolution for this [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_100) | Binarization of an image with predefined threshold |
| binarize_otsu() | Binarization of an image with Otsu thresholding |
| grayscale() | Transformation of an image to its grayscale representation |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_101) | Adjust of a brightness for image. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_102) | Image contrasting |
| [get_skew_angle()](#get_skew_angle__103) | Gets the skew angle.<br/>            This method is applicable to scanned text documents, to determine the skew angle when scanning. |
| [filter(rectangle, options)](#filter_rectangle_options_104) | Filters the specified rectangle. |
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_105) | Replaces one color to another with allowed difference and preserves original alpha value to save smooth edges. |

### DicomPage(image, index) {#DicomPage_image_index_0}
...
### DicomPage(image, index, load_options) {#DicomPage_image_index_load_options_1}
...
### replace_non_transparent_colors(new_color) {#replace_non_transparent_colors_new_color_49}
...
### save_to_stream(stream) {#save_to_stream_stream_51}
...
### can_load_with_options(file_path, load_options)  [static] {#can_load_with_options_file_path_load_options_52}
...
### can_load_stream(stream)  [static] {#can_load_stream_stream_53}
...
### can_load_stream_with_options(stream, load_options)  [static] {#can_load_stream_with_options_stream_load_options_54}
...
### get_file_format_of_stream(stream)  [static] {#get_file_format_of_stream_stream_55}
...
### load_with_options(file_path, load_options)  [static] {#load_with_options_file_path_load_options_56}
...
### load_stream_with_options(stream, load_options)  [static] {#load_stream_with_options_stream_load_options_57}
...
### load_stream(stream)  [static] {#load_stream_stream_58}
...
### can_save(options) {#can_save_options_59}
...
### resize_by_type(new_width, new_height, resize_type) {#resize_by_type_new_width_new_height_resize_type_60}
...
### resize_by_settings(new_width, new_height, settings) {#resize_by_settings_new_width_new_height_settings_61}
...
### get_default_options(args) {#get_default_options_args_62}
...
### get_original_options() {#get_original_options__63}
...
### resize_width_proportionally_settings(new_width, settings) {#resize_width_proportionally_settings_new_width_settings_64}
...
### resize_height_proportionally_settings(new_height, settings) {#resize_height_proportionally_settings_new_height_settings_65}
...
### rotate_flip(rotate_flip_type) {#rotate_flip_rotate_flip_type_66}
...
### save_with_options(file_path, options) {#save_with_options_file_path_options_67}
...
### save_with_options_rect(file_path, options, bounds_rectangle) {#save_with_options_rect_file_path_options_bounds_rectangle_68}
...
### save_to_stream_with_options(stream, options_base) {#save_to_stream_with_options_stream_options_base_69}
...
### save_to_stream_with_options_rect(stream, options_base, bounds_rectangle) {#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_70}
...
### set_palette(palette, update_colors) {#set_palette_palette_update_colors_71}
...
### get_proportional_width(width, height, new_height)  [static] {#get_proportional_width_width_height_new_height_72}
...
### get_proportional_height(width, height, new_width)  [static] {#get_proportional_height_width_height_new_width_73}
...
### get_modify_date(use_default) {#get_modify_date_use_default_74}
...
### get_default_pixels(rectangle, partial_pixel_loader) {#get_default_pixels_rectangle_partial_pixel_loader_75}
...
### get_default_argb_32_pixels(rectangle) {#get_default_argb_32_pixels_rectangle_76}
...
### get_argb_32_pixel(x, y) {#get_argb_32_pixel_x_y_77}
...
### get_pixel(x, y) {#get_pixel_x_y_78}
...
### set_argb_32_pixel(x, y, argb_32_color) {#set_argb_32_pixel_x_y_argb_32_color_79}
...
### set_pixel(x, y, color) {#set_pixel_x_y_color_80}
...
### read_scan_line(scan_line_index) {#read_scan_line_scan_line_index_81}
...
### read_argb_32_scan_line(scan_line_index) {#read_argb_32_scan_line_scan_line_index_82}
...
### write_scan_line(scan_line_index, pixels) {#write_scan_line_scan_line_index_pixels_83}
...
### write_argb_32_scan_line(scan_line_index, argb_32_pixels) {#write_argb_32_scan_line_scan_line_index_argb_32_pixels_84}
...
### load_partial_argb_32_pixels(rectangle, partial_pixel_loader) {#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_85}
...
### load_partial_pixels(desired_rectangle, pixel_loader) {#load_partial_pixels_desired_rectangle_pixel_loader_86}
...
### load_argb_32_pixels(rectangle) {#load_argb_32_pixels_rectangle_87}
...
### load_argb_64_pixels(rectangle) {#load_argb_64_pixels_rectangle_88}
...
### load_partial_argb_64_pixels(rectangle, partial_pixel_loader) {#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_89}
...
### load_pixels(rectangle) {#load_pixels_rectangle_90}
...
### load_cmyk_pixels(rectangle) {#load_cmyk_pixels_rectangle_91}
...
### load_cmyk_32_pixels(rectangle) {#load_cmyk_32_pixels_rectangle_92}
...
### save_raw_data(data, data_offset, rectangle, raw_data_settings) {#save_raw_data_data_data_offset_rectangle_raw_data_settings_93}
...
### save_argb_32_pixels(rectangle, pixels) {#save_argb_32_pixels_rectangle_pixels_94}
...
### save_pixels(rectangle, pixels) {#save_pixels_rectangle_pixels_95}
...
### save_cmyk_pixels(rectangle, pixels) {#save_cmyk_pixels_rectangle_pixels_97}
...
### save_cmyk_32_pixels(rectangle, pixels) {#save_cmyk_32_pixels_rectangle_pixels_98}
...
### set_resolution(dpi_x, dpi_y) {#set_resolution_dpi_x_dpi_y_99}
...
### binarize_fixed(threshold) {#binarize_fixed_threshold_100}
...
### adjust_brightness(brightness) {#adjust_brightness_brightness_101}
...
### adjust_contrast(contrast) {#adjust_contrast_contrast_102}
...
### get_skew_angle() {#get_skew_angle__103}
...
### filter(rectangle, options) {#filter_rectangle_options_104}
...
### replace_argb(old_color_argb, old_color_diff, new_color_argb) {#replace_argb_old_color_argb_old_color_diff_new_color_argb_105}
