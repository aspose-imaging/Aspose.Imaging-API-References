...
type: docs
weight: 40
url: /python-net/api-reference/aspose.imaging.fileformats.dicom/dicompage/
---
...
|**Name**|**Description**|
| :- | :- |
|DicomPage(image, index)|Initializes a new instance of the DicomPage class|
|DicomPage(image, index, load_options)|Initializes a new instance of the DicomPage class|
## **Properties**
|**Name**|**Description**|
| :- | :- |
|disposed|  |
...
|transparent_color|  |
|image_opacity|  |
|index|Gets the index of the current page.|
## **Methods**
|**Name**|**Description**|
| :- | :- |
...
|create(image_options, width, height)|Creates the specified image.|
|create(images)|Creates the specified image.|
|create(images, dispose_images)|Creates the specified image.|
