...
|**Name**|**Description**|
| :- | :- |
| [DicomImage(dicom_options, width, height)](#DicomImage_dicom_options_width_height_0) | Initializes a new instance of the [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) class. |
| [DicomImage(stream, load_options)](#DicomImage_stream_load_options_1) | Initializes a new instance of the [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) class. |
...
| [save(file_path, options)](#save_file_path_options_5) | Saves the object's data to the specified file (indexer + filename) location in the specified file format according to save options.. |
...
| [save(stream)](#save_stream_8) | Saves the data. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_25) | Performs proportional resize on the image.<br/>            The proportional resize will resize each frame according to the ratio of <paramref name="newWidth" />/width and <paramref name="newHeight" />/height. |
...
| [add_page(page)](#add_page_page_53) | Adds page to the image. |
| [add_page()](#add_page__54) | Adds a new page to the end of the page list. |
...
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_70) | Rotates, flips, or rotates and flips the Active frame only. |
...
| [save_all(file_path, options)](#save_all_file_path_options_111) | Saves the object's data to the specified file (indexer + filename) location in the specified file format according to save options.. |
| [resize_proportional(new_width, new_height, resize_type)](#resize_proportional_new_width_new_height_resize_type_112) | Performs proportional resize on the image.<br/>            The proportional resize will resize each frame according to the ratio of <paramref name="newWidth" />/width and <paramref name="newHeight" />/height. |
| [insert_page(page_index)](#insert_page_page_index_113) | Inserts a new page into the page list at the specified index. |
| [remove_page(page_index)](#remove_page_page_index_114) | Removes the page at the specified index of the page list. |

### DicomImage(dicom_options, width, height) {#DicomImage_dicom_options_width_height_0}
...
### DicomImage(stream, load_options) {#DicomImage_stream_load_options_1}
...
### DicomImage(stream) {#DicomImage_stream_2}
...
### resize_proportional(new_width, new_height, resize_type) {#resize_proportional_new_width_new_height_resize_type_112}
...
### insert_page(page_index) {#insert_page_page_index_113}
...
### remove_page(page_index) {#remove_page_page_index_114}
