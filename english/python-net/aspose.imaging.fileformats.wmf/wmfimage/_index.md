...
type: docs
weight: 10
url: /python-net/api-reference/aspose.imaging.fileformats.wmf/wmfimage/
---
...
|**Name**|**Description**|
| :- | :- |
|WmfImage()|Initializes a new instance of the [WmfImage](/imaging/python-net/api-reference/aspose.imaging.fileformats.wmf/wmfimage/) class.|
