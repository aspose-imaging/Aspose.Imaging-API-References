...
| [create(width, height, graphics_unit)](#create_width_height_graphics_unit_17) | Creates a new instance of a vector image with the specified dimensions and graphics unit. |
| [create_from_files(files)](#create_from_files_files_18) | Creates the multipage image containing the specified files as lazy loading pages. |
| [create_from_files(files, throw_exception_on_load_error)](#create_from_files_files_throw_exception_on_load_error_19) | Creates the multipage image containing the specified files as lazy loading pages. |
| [create_from_images(images)](#create_from_images_images_20) | Creates a new image using the specified images as pages |
| [create_from_images(images, dispose_images)](#create_from_images_images_dispose_images_21) | Creates a new image the specified images as pages. |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_22) | Crop image with shifts. |
| [crop(rectangle)](#crop_rectangle_23) | Crops the specified rectangle. |
| [get_default_options(args)](#get_default_options_args_24) | Gets the default image options. |
| [get_embedded_images()](#get_embedded_images__25) | Gets the embedded images. |
...
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_28) | Gets the file format. |
...
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_30) | Gets rectangle which fits the current image. |
| [get_missed_fonts()](#get_missed_fonts__31) | Returns the list of fonts which used inside metafile but not found. |
| [get_original_options()](#get_original_options__32) | Gets the original image options. |
| [get_post_script()](#get_post_script__33) | Access the PostScript data associated with the image, providing detailed <br/>            information about its structure or content. Utilize this method to retrieve <br/>            PostScript data for further analysis or processing within your application, <br/>            enabling advanced functionality related to PostScript rendering or manipulation. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_34) | Gets a proportional height. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_35) | Gets a proportional width. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_36) | Converts to aps. |
| [get_used_fonts()](#get_used_fonts__37) | Retrieve the list of fonts used within the metafile, providing insight into the <br/>            font resources utilized in the image. Utilize this method to analyze font usage <br/>            and ensure font availability for rendering or further processing within your application. |
| [load(file_path)](#load_file_path_38) | Loads a new image from the specified file path or URL.<br/>            If _filePath_ is a file path the method just opens the file.<br/>            If _filePath_ is an URL, the method downloads the file, stores it as a temporary one, and opens it. |
| [load(file_path, load_options)](#load_file_path_load_options_39) | Loads a new image from the specified file path or URL.<br/>            If _filePath_ is a file path the method just opens the file.<br/>            If _filePath_ is an URL, the method downloads the file, stores it as a temporary one, and opens it. |
| [load(stream)](#load_stream_40) | Loads a new image from the specified stream. |
| [load(stream, load_options)](#load_stream_load_options_41) | Loads a new image from the specified stream. |
| [load_stream(stream)](#load_stream_stream_42) | Loads a new image from the specified stream. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_43) | Loads a new image from the specified stream. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_44) | Loads a new image from the specified file path or URL.<br/>            If _filePath_ is a file path the method just opens the file.<br/>            If _filePath_ is an URL, the method downloads the file, stores it as a temporary one, and opens it. |
| remove_background() | Removes the background. |
| [remove_background(settings)](#remove_background_settings_45) | Removes the background. |
| remove_metadata() | Removes the metadata from [Image.metadata](/imaging/python-net/aspose.imaging/image/) property. |
| [resize(new_width, new_height)](#resize_new_width_new_height_46) | Resizes the image. The default [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) is used. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_47) | Resizes the specified new width. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_48) | Resizes the image with extended options. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_49) | Resizes the image. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_50) | Resizes the image. |
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_51) | Resize the canvas of the image, adjusting its dimensions while retaining the image <br/>            content. Utilize this method to modify the size of the canvas without altering the <br/>            content, facilitating layout adjustments and composition changes within your <br/>            application. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_52) | Resizes the height proportionally. The default [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) is used. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_53) | Resizes the height proportionally. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_54) | Resizes the height proportionally. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_55) | Resizes the height proportionally. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_56) | Resizes the width proportionally. The default [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) is used. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_57) | Resizes the width proportionally. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_58) | Resizes the width proportionally. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_59) | Resizes the width proportionally. |
| [rotate(angle)](#rotate_angle_60) | Rotate image around the center. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_61) | Rotates, flips, or rotates and flips the image. |
| save() | Saves the image data to the underlying stream. |
| [save(file_path)](#save_file_path_62) | Saves the image to the specified file location. |
...
| [save(stream)](#save_stream_66) | Saves the data to specified _stream_. |
...
| [save_to_stream(stream)](#save_to_stream_stream_69) | Saves the object's data to the specified stream. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_70) | Saves the image's data to the specified stream in the specified file format according to save options. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_71) | Saves the image's data to the specified stream in the specified file format according to save options. |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_74) | Apply a specified palette to the image, enabling customization of color <br/>            representation. Utilize this method to enhance visual rendering and achieve <br/>            specific color effects within your application. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_75) | Tries to set a _metadata_ instance, if this [Image](/imaging/python-net/aspose.imaging/image/) instance supports and implements [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) instance. |
...
### Method: create(width, height, graphics_unit)  [static] {#create_width_height_graphics_unit_17}


```
 create(width, height, graphics_unit) 
```
...
| graphics_unit | [GraphicsUnit](/imaging/python-net/aspose.imaging/graphicsunit/) | The unit of measurement for the width and height. The default is [GraphicsUnit.PIXEL](/imaging/python-net/aspose.imaging/graphicsunit/). |

**Returns**

| Type | Description |
| :- | :- |
| [VectorImage](/imaging/python-net/aspose.imaging/vectorimage/) | A new [VectorImage](/imaging/python-net/aspose.imaging/vectorimage/) instance with the specified dimensions and graphics unit. |


### Method: create_from_files(files)  [static] {#create_from_files_files_18}
...
### Method: create_from_files(files, throw_exception_on_load_error)  [static] {#create_from_files_files_throw_exception_on_load_error_19}
...
### Method: create_from_images(images)  [static] {#create_from_images_images_20}
...
### Method: create_from_images(images, dispose_images)  [static] {#create_from_images_images_dispose_images_21}
...
### Method: crop(left_shift, right_shift, top_shift, bottom_shift) {#crop_left_shift_right_shift_top_shift_bottom_shift_22}
...
### Method: crop(rectangle) {#crop_rectangle_23}
...
### Method: get_default_options(args) {#get_default_options_args_24}
...
### Method: get_embedded_images() {#get_embedded_images__25}
...
### Method: get_file_format(file_path)  [static] {#get_file_format_file_path_26}
...
### Method: get_file_format(stream)  [static] {#get_file_format_stream_27}
...
### Method: get_file_format_of_stream(stream)  [static] {#get_file_format_of_stream_stream_28}
...
### Method: get_fitting_rectangle(rectangle, pixels, width, height)  [static] {#get_fitting_rectangle_rectangle_pixels_width_height_29}
...
### Method: get_fitting_rectangle(rectangle, width, height)  [static] {#get_fitting_rectangle_rectangle_width_height_30}
...
### Method: get_missed_fonts() {#get_missed_fonts__31}
...
### Method: get_original_options() {#get_original_options__32}
...
### Method: get_post_script() {#get_post_script__33}
...
### Method: get_proportional_height(width, height, new_width)  [static] {#get_proportional_height_width_height_new_width_34}
...
### Method: get_proportional_width(width, height, new_height)  [static] {#get_proportional_width_width_height_new_height_35}
...
### Method: get_serialized_stream(image_options, clipping_rectangle, page_number) {#get_serialized_stream_image_options_clipping_rectangle_page_number_36}
...
### Method: get_used_fonts() {#get_used_fonts__37}
...
### Method: load(file_path)  [static] {#load_file_path_38}
...
### Method: load(file_path, load_options)  [static] {#load_file_path_load_options_39}
...
### Method: load(stream)  [static] {#load_stream_40}
...
### Method: load(stream, load_options)  [static] {#load_stream_load_options_41}
...
### Method: load_stream(stream)  [static] {#load_stream_stream_42}
...
### Method: load_stream_with_options(stream, load_options)  [static] {#load_stream_with_options_stream_load_options_43}
...
### Method: load_with_options(file_path, load_options)  [static] {#load_with_options_file_path_load_options_44}
...
### Method: remove_background(settings) {#remove_background_settings_45}
...
### Method: resize(new_width, new_height) {#resize_new_width_new_height_46}
...
### Method: resize(new_width, new_height, resize_type) {#resize_new_width_new_height_resize_type_47}
...
### Method: resize(new_width, new_height, settings) {#resize_new_width_new_height_settings_48}
...
### Method: resize_by_settings(new_width, new_height, settings) {#resize_by_settings_new_width_new_height_settings_49}
...
### Method: resize_by_type(new_width, new_height, resize_type) {#resize_by_type_new_width_new_height_resize_type_50}
...
### Method: resize_canvas(new_rectangle) {#resize_canvas_new_rectangle_51}
...
### Method: resize_height_proportionally(new_height) {#resize_height_proportionally_new_height_52}
...
### Method: resize_height_proportionally(new_height, resize_type) {#resize_height_proportionally_new_height_resize_type_53}
...
### Method: resize_height_proportionally(new_height, settings) {#resize_height_proportionally_new_height_settings_54}
...
### Method: resize_height_proportionally_settings(new_height, settings) {#resize_height_proportionally_settings_new_height_settings_55}
...
### Method: resize_width_proportionally(new_width) {#resize_width_proportionally_new_width_56}
...
### Method: resize_width_proportionally(new_width, resize_type) {#resize_width_proportionally_new_width_resize_type_57}
...
### Method: resize_width_proportionally(new_width, settings) {#resize_width_proportionally_new_width_settings_58}
...
### Method: resize_width_proportionally_settings(new_width, settings) {#resize_width_proportionally_settings_new_width_settings_59}
...
### Method: rotate(angle) {#rotate_angle_60}
...
### Method: save_to_stream(stream) {#save_to_stream_stream_69}
...
### Method: save_to_stream_with_options(stream, options_base) {#save_to_stream_with_options_stream_options_base_70}
...
### Method: save_to_stream_with_options_rect(stream, options_base, bounds_rectangle) {#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_71}
...
### Method: save_with_options(file_path, options) {#save_with_options_file_path_options_72}
...
### Method: save_with_options_rect(file_path, options, bounds_rectangle) {#save_with_options_rect_file_path_options_bounds_rectangle_73}
...
### Method: set_palette(palette, update_colors) {#set_palette_palette_update_colors_74}
...
### Method: try_set_metadata(metadata) {#try_set_metadata_metadata_75}
