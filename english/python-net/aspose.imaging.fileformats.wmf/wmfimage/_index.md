...
|**Name**|**Description**|
| :- | :- |
| [WmfImage()](#WmfImage__0) | Initializes a new instance of the [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) class. |
| [WmfImage(width, height)](#WmfImage_width_height_1) | Initializes a new instance of the [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) class. |
## **Properties**
...
| [get_used_fonts()](#get_used_fonts__59) | Returns the list of font which used inside metafile. |
| [get_missed_fonts()](#get_missed_fonts__60) | Returns the list of fonts which used inside metafile but not found. |
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_61) | Resizes the canvas. |
| [add_record(record)](#add_record_record_62) | Adds the record. |
| [get_post_script()](#get_post_script__63) | Gets the post script. |

### WmfImage() {#WmfImage__0}
...
### WmfImage(width, height) {#WmfImage_width_height_1}
...
### crop(rectangle) {#crop_rectangle_33}
...
### crop(left_shift, right_shift, top_shift, bottom_shift) {#crop_left_shift_right_shift_top_shift_bottom_shift_34}
...
### get_used_fonts() {#get_used_fonts__59}
...
### get_missed_fonts() {#get_missed_fonts__60}
...
### resize_canvas(new_rectangle) {#resize_canvas_new_rectangle_61}
...
### add_record(record) {#add_record_record_62}
...
### get_post_script() {#get_post_script__63}
