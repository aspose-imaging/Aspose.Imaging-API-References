...
| [crop(rectangle)](#crop_rectangle_16) | Crops the specified rectangle. |
| [get_default_options(args)](#get_default_options_args_17) | Gets the default options. |
...
| [get_used_fonts()](#get_used_fonts__29) | Returns the list of font which used inside metafile. |
...
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_43) | Resizes the canvas. |
...
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_52) | Rotates, flips, or rotates and flips the image. |
...
| [save(stream)](#save_stream_57) | Saves the object's data to the specified stream. |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_65) | Sets the image palette. |
