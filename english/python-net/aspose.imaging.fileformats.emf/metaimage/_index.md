...
| [resize(new_width, new_height)](#resize_new_width_new_height_22) | Resizes the image. The default [NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) is used. |
...
| [crop(rectangle)](#crop_rectangle_32) | Crops the specified rectangle. |
...
| [get_used_fonts()](#get_used_fonts__57) | Returns the list of font which used inside metafile. |
| [get_missed_fonts()](#get_missed_fonts__58) | Returns the list of fonts which used inside metafile but not found. |
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_59) | Resizes the canvas. |
...
### resize(new_width, new_height) {#resize_new_width_new_height_22}
...
### crop(left_shift, right_shift, top_shift, bottom_shift) {#crop_left_shift_right_shift_top_shift_bottom_shift_31}
...
### crop(rectangle) {#crop_rectangle_32}
...
### get_used_fonts() {#get_used_fonts__57}
...
### get_missed_fonts() {#get_missed_fonts__58}
...
### resize_canvas(new_rectangle) {#resize_canvas_new_rectangle_59}
