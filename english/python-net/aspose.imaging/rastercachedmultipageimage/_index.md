...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_93) | Aspose.Imaging.RasterCachedMultipageImage.Rotate(float,bool,Aspose.Imaging.Color) image around the center. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_94) | Rotates, flips, or rotates and flips all pages. |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_95) | Rotates the flip all. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_106) | Saves the pixels internal main. |
...
### Method: rotate_flip_all(rotate_flip) {#rotate_flip_all_rotate_flip_95}
