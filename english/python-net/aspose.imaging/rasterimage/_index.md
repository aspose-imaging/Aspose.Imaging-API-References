...
| auto_brightness_contrast() | Automatic adaptive brightness and contrast normalization for the entire image. |
...
| [crop(rectangle)](#crop_rectangle_33) | Crops the specified rectangle. |
...
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_84) | Resizes the image with extended options. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_108) | Saves the pixels. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_119) | Tries to set a _metadata_ instance, if this [Image](/imaging/python-net/aspose.imaging/image/) instance supports and implements [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) type. |
...
**[Example # 1](#example_195)**: Skew is an artifact that might appear during document scanning process when t...
