...
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_23) | Resizes the image with extended options. |
...
| [crop(rectangle)](#crop_rectangle_37) | Crops the specified rectangle. |
...
| [binarize_bradley(brightness_difference)](#binarize_bradley_brightness_difference_39) | Binarization of an image using Bradley's adaptive thresholding algorithm using the integral image thresholding |
...
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_59) | Resizes the image with extended options. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_83) | Loads 32-bit ARGB pixels partially by packs. |
...
### dither(dithering_method, bits_count) {#dither_dithering_method_bits_count_31}
...
### binarize_bradley(brightness_difference) {#binarize_bradley_brightness_difference_39}
