...
| length | int | The stream data length to copy. By default the length is set to [SplitStreamContainer.length](/imaging/python-net/aspose.imaging/splitstreamcontainer/) value. |
