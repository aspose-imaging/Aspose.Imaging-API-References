...
| [save(stream)](#save_stream_61) | Saves the object's data to the specified stream. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | Tries to set a _metadata_ instance, if this [Image](/imaging/python-net/aspose.imaging/image/) instance supports and implements [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) type. |
...
**[Example # 1](#example_238)**: Support extracting embedded raster images from a vector image
...
## **Examples**
### Support extracting embedded raster images from a vector image {#example_238}
``` python
