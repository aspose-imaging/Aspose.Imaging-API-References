---
title: EmfBitBlt.SourceBitmap
second_title: Aspose.Imaging for .NET API Reference
description: EmfBitBlt property. Gets or sets a buffer containing the source bitmap which is not required to be contiguous with the fixed portion of the EMR_BITBLT record. Accordingly fields in this buffer that are labeled UndefinedSpace are optional and MUST be ignored
type: docs
weight: 70
