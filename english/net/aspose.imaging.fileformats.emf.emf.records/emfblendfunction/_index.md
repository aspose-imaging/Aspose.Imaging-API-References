...
| Name | Description |
| --- | --- |
| [EmfBlendFunction](emfblendfunction)(int) | Initializes a new instance of the [`EmfBlendFunction`](../emfblendfunction) class. |

## Properties

| Name | Description |
| --- | --- |
| [AlphaFormat](alphaformat) { get; } | Gets a structure that specifies how source and destination pixels are interpreted with respect to alpha transparency. |
| [BlendFlags](blendflags) { get; } | Gets the blend flags. This value MUST be 0x00 and MUST be ignored. |
...
| Name | Description |
| --- | --- |
| enum [AlphaFormatEnum](emfblendfunction.alphaformatenum) | A structure that specifies how source and destination pixels are interpreted with respect to alpha transparency. |
