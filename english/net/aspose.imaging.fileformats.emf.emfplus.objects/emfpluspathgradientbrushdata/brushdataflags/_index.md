---
title: EmfPlusPathGradientBrushData.BrushDataFlags
second_title: Aspose.Imaging for .NET API Reference
description: EmfPlusPathGradientBrushData property. Gets or sets 32bit unsigned integer that specifies the data in the OptionalData field. This value MUST be composed of BrushData flags section 2.1.2.1. The following flags are relevant to a path gradient brush
type: docs
weight: 30
