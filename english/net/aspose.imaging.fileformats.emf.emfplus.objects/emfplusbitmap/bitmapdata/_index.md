---
title: EmfPlusBitmap.BitmapData
second_title: Aspose.Imaging for .NET API Reference
description: EmfPlusBitmap property. Gets or sets bitmap data BitmapData variable Variablelength data that defines the bitmap data object specified in the Type field. The content and format of the data can be different for every bitmap type
type: docs
weight: 20
