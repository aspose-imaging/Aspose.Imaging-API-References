...
| Name | Description |
| --- | --- |
| [WebPFrameBlock](webpframeblock/#constructor)(RasterImage) | Initializes a new instance of the `WebPFrameBlock` |
| [WebPFrameBlock](webpframeblock/#constructor_1)(int, int) | Initializes a new instance of the `WebPFrameBlock` class. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel/) { get; } | Gets the image bits per pixel count. |
...
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft/) { get; } | Gets the frame left offset. |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime/) { get; } | Gets the frame duration. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left/) { get; set; } | Gets or sets the frame position left. |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width/) { get; } | Gets the image width. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe/)() | Gets the full frame. |
