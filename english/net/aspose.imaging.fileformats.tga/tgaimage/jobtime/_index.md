...
description: TgaImage property. Retrieves or sets the timestamp indicating the job time associated with the image. This property allows developers to access or modify the time metadata related to the specific job or project associated with the image
type: docs
weight: 190
url: /net/aspose.imaging.fileformats.tga/tgaimage/jobtime/
---
