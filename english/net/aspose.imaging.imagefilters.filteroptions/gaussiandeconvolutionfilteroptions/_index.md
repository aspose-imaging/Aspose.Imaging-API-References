...
| Name | Description |
| --- | --- |
| [GaussianDeconvolutionFilterOptions](gaussiandeconvolutionfilteroptions)(int, double) | Initializes a new instance of the [`GaussianDeconvolutionFilterOptions`](../gaussiandeconvolutionfilteroptions) class. |
