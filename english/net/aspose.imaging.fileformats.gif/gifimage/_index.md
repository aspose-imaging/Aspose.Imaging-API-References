...
| override [Resize](../../aspose.imaging.fileformats.gif/gifimage/resize/#resize_1)(int, int, ImageResizeSettings) | Resize the width and height of the image while maintaining its aspect ratio and applying additional settings as specified. This method ensures that the image dimensions are adjusted proportionally, preserving the overall visual quality and appearance according to the provided settings. |
