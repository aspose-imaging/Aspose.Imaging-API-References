...
| exception | condition |
| --- | --- |
| ArgumentOutOfRangeException | In case if this [`ExifData`](../../../aspose.imaging.exif/ihasexifdata/exifdata/) instance has invalid [`Orientation`](../../../aspose.imaging.exif/exifdata/orientation/) value. |
