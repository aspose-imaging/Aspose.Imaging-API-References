...
```csharp
public class TiffIfd8Type : TiffLong8Type
```
...
| Name | Description |
| --- | --- |
| [TiffIfd8Type](tiffifd8type/#constructor)(TiffTags) | Initializes a new instance of the `TiffIfd8Type` class. |
| [TiffIfd8Type](tiffifd8type/#constructor_1)(ushort) | Initializes a new instance of the `TiffIfd8Type` class. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifd8type/tagtype/) { get; } | Gets the tag type. |
