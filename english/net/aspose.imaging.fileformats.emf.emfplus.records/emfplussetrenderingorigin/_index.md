---
title: Class EmfPlusSetRenderingOrigin
...
| Name | Description |
| --- | --- |
| [EmfPlusSetRenderingOrigin](emfplussetrenderingorigin/)(EmfPlusRecord) | Initializes a new instance of the `EmfPlusSetRenderingOrigin` class. |
...
| [X](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/x/) { get; set; } | Gets or sets a 32-bit unsigned integer that defines the horizontal coordinate value of the rendering origin. |
| [Y](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/y/) { get; set; } | Gets or sets a 32-bit unsigned integer that defines the vertical coordinate value of the rendering origin. |
