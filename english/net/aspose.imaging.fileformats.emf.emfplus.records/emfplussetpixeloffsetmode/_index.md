---
title: Class EmfPlusSetPixelOffsetMode
...
| Name | Description |
| --- | --- |
| [EmfPlusSetPixelOffsetMode](emfplussetpixeloffsetmode/)(EmfPlusRecord) | Initializes a new instance of the `EmfPlusSetPixelOffsetMode` class. |
...
| [PixelOffsetMode](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetpixeloffsetmode/pixeloffsetmode/) { get; set; } | Gets or sets the pixel offset mode value, from the PixelOffsetMode enumeration (section 2.1.1.26). |
