...
| Name | Description |
| --- | --- |
| [EmfPlusClear](emfplusclear/)(EmfPlusRecord) | Initializes a new instance of the `EmfPlusClear` class. |

## Properties

| Name | Description |
| --- | --- |
| [Argb32Color](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusclear/argb32color/) { get; set; } | Gets or sets the color. An EmfPlusARGB object (section 2.2.2.1) that defines the color to paint the screen. All colors are specified in [IEC-RGB], unless otherwise noted. |
