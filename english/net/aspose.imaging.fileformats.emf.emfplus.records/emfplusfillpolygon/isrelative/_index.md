---
title: EmfPlusFillPolygon.IsRelative
second_title: Aspose.Imaging for .NET API Reference
description: EmfPlusFillPolygon property. Gets or sets a value indicating whether this instance is relative. If set each element in PointData specifies a location in the coordinate space that is relative to the location specified by the previous element in the array. In the case of the first element in PointData a previous location at coordinates 00 is assumed. If clear PointData specifies absolute locations according to the C flag
type: docs
weight: 50
