---
title: EmfLogBrushEx.BrushStyle
second_title: Aspose.Imaging for .NET API Reference
description: EmfLogBrushEx property. Gets or sets a 32bit unsigned integer that specifies the brush style. The value MUST be an enumeration from WMF BrushStyle enumeration MSWMF section 2.1.1.4. The style values that are supported in this structure are listed later in this section. The BS_NULL style SHOULD be used to specify a brush that has no effect
type: docs
weight: 40
