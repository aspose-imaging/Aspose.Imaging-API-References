...
description: EmfRecorderGraphics2D constructor. Initializes a new instance of the EmfRecorderGraphics2D class
type: docs
weight: 10
url: /net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/emfrecordergraphics2d/
---
...
| --- | --- | --- |
| frame | Rectangle | The frame. |
| deviceSize | Size | Size of the device. |
| deviceSizeMm | Size | The device size mm. |
