...
description: MetafileRecorderGraphics2D method. Draws the specified Image using its original physical size at the specified location
type: docs
weight: 80
...
| srcUnit | GraphicsUnit | The units of measure used by the srcRect parameter. |

### Exceptions

| exception | condition |
| --- | --- |
| ArgumentOutOfRangeException | srcUnit;Support only Pixel unit |
