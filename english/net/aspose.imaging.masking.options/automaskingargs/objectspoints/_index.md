...
description: AutoMaskingArgs property. Gets or sets the points that belong to separated objects optional NumberOfObjects coordinates that belong to NumberOfObjects objects of initial image. This parameter is used to increase segmentation method precision
type: docs
weight: 40
