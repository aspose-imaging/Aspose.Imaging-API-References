...
| Name | Description |
| --- | --- |
| [OdLineTo](odlineto/)(OdObject) | Initializes a new instance of the `OdLineTo` class. |
...
| [Horizontal](../../aspose.imaging.fileformats.opendocument.objects.graphic/odlineto/horizontal/) { get; set; } | Gets or sets a value indicating whether this `OdLineTo` is vertical. |
...
| [Vertical](../../aspose.imaging.fileformats.opendocument.objects.graphic/odlineto/vertical/) { get; set; } | Gets or sets a value indicating whether this `OdLineTo` is vertical. |
