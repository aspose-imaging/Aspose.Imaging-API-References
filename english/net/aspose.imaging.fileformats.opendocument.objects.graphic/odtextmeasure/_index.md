...
| Name | Description |
| --- | --- |
| [OdTextMeasure](odtextmeasure/)(OdObject) | Initializes a new instance of the `OdTextMeasure` class. |
...
| [Kind](../../aspose.imaging.fileformats.opendocument.objects.graphic/odtextmeasure/kind/) { get; set; } | Gets or sets the kind. |
...
| [Text](../../aspose.imaging.fileformats.opendocument.objects.graphic/odtextmeasure/text/) { get; set; } | Gets or sets the value. |
