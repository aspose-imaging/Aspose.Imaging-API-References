...
| [KnotVecor](../../aspose.imaging.fileformats.cdr.objects/cdrppdt/knotvecor/) { get; set; } | Gets or sets the knot vecors. |
| [Parent](../../aspose.imaging.fileformats.cdr.objects/cdrobject/parent/) { get; set; } | Gets or sets the parent. |
| [Points](../../aspose.imaging.fileformats.cdr.objects/cdrppdt/points/) { get; set; } | Gets or sets the points. |
