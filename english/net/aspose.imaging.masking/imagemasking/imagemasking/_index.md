...
description: ImageMasking constructor. Initializes a new instance of the ImageMasking class
type: docs
weight: 10
url: /net/aspose.imaging.masking/imagemasking/imagemasking/
---
...
| --- | --- | --- |
| sourceImage | RasterImage | The source image. |

### Exceptions

| exception | condition |
| --- | --- |
| ArgumentNullException | source image is null. |
