...
description: The META_RECTANGLE record paints a rectangle.
type: docs
weight: 61
url: /java/com.aspose.imaging.fileformats.wmf.objects/wmfrectangle/
---
**Inheritance:**
...
The META\_RECTANGLE record paints a rectangle. The rectangle is outlined by using the pen and filled by using the brush that are defined in the playback device context.
## Constructors
