...
description: The create pen in direct
type: docs
weight: 24
url: /java/com.aspose.imaging.fileformats.wmf.objects/wmfcreatepenindirect/
---
**Inheritance:**
...
| --- | --- |
| [WmfCreatePenInDirect()](#WmfCreatePenInDirect--) | WMFs the record. |
## Methods

| Method | Description |
| --- | --- |
| [getLogPen()](#getLogPen--) | Gets or sets the log pen. |
| [setLogPen(EmfLogPen value)](#setLogPen-com.aspose.imaging.fileformats.emf.emf.objects.EmfLogPen-) | Gets or sets the log pen. |
