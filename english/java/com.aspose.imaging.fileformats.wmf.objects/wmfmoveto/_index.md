...
description: The META_MOVETO record sets the output position in the playback device     context to a specified point.
type: docs
weight: 46
url: /java/com.aspose.imaging.fileformats.wmf.objects/wmfmoveto/
---
**Inheritance:**
...
The META\_MOVETO record sets the output position in the playback device context to a specified point.
## Constructors
