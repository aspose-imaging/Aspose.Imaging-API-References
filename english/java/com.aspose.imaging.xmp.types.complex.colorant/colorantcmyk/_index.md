...
type: docs
weight: 13
url: /java/com.aspose.imaging.xmp.types.complex.colorant/colorantcmyk/
---
**Inheritance:**
...
| Field | Description |
| --- | --- |
| [COLOR_VALUE_MAX](#COLOR-VALUE-MAX) | Color max value in CMYK colorant. |
| [COLOR_VALUE_MIN](#COLOR-VALUE-MIN) | Color min value in CMYK colorant. |
## Methods
