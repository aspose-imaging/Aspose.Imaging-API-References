...
description: The EmfPlusCustomStartCapData object specifies a custom line cap for the start of a line.
type: docs
weight: 38
url: /java/com.aspose.imaging.fileformats.emf.emfplus.objects/emfpluscustomstartcapdata/
---
**Inheritance:**
...
| Method | Description |
| --- | --- |
| [getCustomStartCap()](#getCustomStartCap--) | Gets or sets custom line cap that defines the shape to draw at the end of a line. |
| [setCustomStartCap(EmfPlusCustomLineCap value)](#setCustomStartCap-com.aspose.imaging.fileformats.emf.emfplus.objects.EmfPlusCustomLineCap-) | Gets or sets custom line cap that defines the shape to draw at the end of a line. |
### EmfPlusCustomStartCapData() {#EmfPlusCustomStartCapData--}
```
...
### setCustomStartCap(EmfPlusCustomLineCap value) {#setCustomStartCap-com.aspose.imaging.fileformats.emf.emfplus.objects.EmfPlusCustomLineCap-}
```
