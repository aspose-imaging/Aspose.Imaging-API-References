...
description: The Transform Record Types specify properties and transforms on coordinate spaces.
type: docs
weight: 71
url: /java/com.aspose.imaging.fileformats.emf.emfplus.records/emfplustransformrecordtype/
---
**Inheritance:**
...
```
public abstract class EmfPlusTransformRecordType extends EmfPlusRecord
```
