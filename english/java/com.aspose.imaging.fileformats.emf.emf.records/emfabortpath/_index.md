...
description: This record aborts a path bracket or discards the path from a closed path bracket.
type: docs
weight: 10
url: /java/com.aspose.imaging.fileformats.emf.emf.records/emfabortpath/
---
**Inheritance:**
...
| --- | --- |
| [EmfAbortPath()](#EmfAbortPath--) | Initializes a new instance of the `EmfAbortPath` class. |
...
Initializes a new instance of the `EmfAbortPath` class.
