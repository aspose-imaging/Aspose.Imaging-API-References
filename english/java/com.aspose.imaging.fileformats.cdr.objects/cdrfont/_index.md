...
description: the cdr Font
type: docs
weight: 22
url: /java/com.aspose.imaging.fileformats.cdr.objects/cdrfont/
---
**Inheritance:**
...
| [setEncoding(short value)](#setEncoding-short-) | Sets the encoding. |
### CdrFont() {#CdrFont--}
```
public CdrFont()
```
...
**Returns:**
short - the encoding.
### setEncoding(short value) {#setEncoding-short-}
```
