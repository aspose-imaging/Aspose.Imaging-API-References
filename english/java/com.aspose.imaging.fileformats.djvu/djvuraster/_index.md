...
description: Class for representing Djvu raster image where located result of some operation
type: docs
weight: 12
url: /java/com.aspose.imaging.fileformats.djvu/djvuraster/
---
**Inheritance:**
...
| --- | --- |
| [DjvuRaster(int width, int height, IRasterImageArgb32PixelLoader loader)](#DjvuRaster-int-int-com.aspose.imaging.IRasterImageArgb32PixelLoader-) | Initializes a new instance of the `DjvuRaster` class. |
## Methods
...
| loader | [IRasterImageArgb32PixelLoader](../../com.aspose.imaging/irasterimageargb32pixelloader) | The loader. |
