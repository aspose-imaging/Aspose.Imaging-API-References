...
description: Exception for Emf classes
type: docs
weight: 13
url: /java/com.aspose.imaging.coreexceptions.imageformats/emfexception/
---
**Inheritance:**
...
| --- | --- |
| [EmfException(String message)](#EmfException-java.lang.String-) | Initializes a new instance of the `EmfException` class. |
### EmfException(String message) {#EmfException-java.lang.String-}
```
