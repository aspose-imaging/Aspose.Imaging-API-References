---
title: "PngImage‑Klasse"
type: docs
weight: 10
url: /de/python-net/aspose.imaging.fileformats.png/pngimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [PngImage(path)](#PngImage_path_1) | Konstruiert eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse unter Verwendung des Pfad <br/>            Parameters, um den Speicherort der zu ladenden Bilddatei anzugeben. Dieser Konstruktor <br/>            ermöglicht Entwicklern, PNG‑Bilder bequem zu erstellen, indem sie sie aus einer Datei laden, <br/>            und vereinfacht den Prozess der Arbeit mit PNG‑Bildern in ihren Anwendungen. |
| [PngImage(path, color_type)](#PngImage_path_color_type_2) | Initialisiert eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem der <br/>            Pfad zur Bilddatei und der Farbtyp angegeben werden. Dieser Konstruktor ermöglicht die bequeme <br/>            Erstellung von PNG‑Bildern aus Dateien mit unterschiedlichen Farbtypen und bietet <br/>            Flexibilität beim Umgang mit verschiedenen Bildformaten. |
| [PngImage(png_options, width, height)](#PngImage_png_options_width_height_3) | Initialisiert eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse und integriert <br/>            PNG‑Optionen zusammen mit Breiten‑ und Höhenparametern. Dieser Konstruktor befähigt <br/>            Entwickler, PNG‑Bilder mit anpassbaren Einstellungen und Abmessungen zu erstellen, <br/>            und bietet Flexibilität bei der Bildgenerierung für verschiedene Anwendungsfälle. |
| [PngImage(raster_image)](#PngImage_raster_image_4) | Erstellt eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem ein Raster‑<br/>            Bild als Parameter übergeben wird. Dieser Konstruktor ermöglicht Entwicklern, ein <br/>            PNG‑Bildobjekt direkt mit einem vorhandenen Rasterbild zu initialisieren und vereinfacht den <br/>            Prozess der Arbeit mit PNG‑Bildern in ihren Anwendungen. |
| [PngImage(raster_image, color_type)](#PngImage_raster_image_color_type_5) | Erstellt eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem ein Raster‑<br/>            Bild und ein Farbtyp angegeben werden. Dieser Konstruktor ermöglicht Entwicklern, Rasterbilder direkt in das PNG‑Format zu konvertieren, wobei der gewünschte Farbtyp festgelegt wird, und bietet Flexibilität bei der Farbdarstellung. |
| [PngImage(stream)](#PngImage_stream_6) | Erstellt eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem sie <br/>            mit einem Stream initialisiert wird. Dieser Konstruktor ermöglicht Entwicklern, PNG‑Bilder direkt <br/>            aus einem Stream zu laden und bietet Flexibilität beim Abrufen von Bildern aus verschiedenen Quellen. |
| [PngImage(width, height)](#PngImage_width_height_7) | Initialisiert ein neues Objekt der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem die <br/>            Breiten‑ und Höhenparameter bereitgestellt werden. Dieser Konstruktor vereinfacht die Erstellung von PNG‑<br/>            Bildern, indem er Entwicklern erlaubt, die Abmessungen direkt anzugeben, und erleichtert die effiziente Verwaltung von PNG‑Bilddaten in ihren Anwendungen. |
| [PngImage(width, height, color_type)](#PngImage_width_height_color_type_8) | Instanziiert eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem die gewünschten Breiten‑, Höhen‑ und Farbtyp‑Parameter angegeben werden. Dieser Konstruktor ermöglicht <br/>            die schnelle Erstellung von PNG‑Bildern mit maßgeschneiderten Abmessungen und Farbkombinationen, <br/>            und erleichtert die optimierte Bildgenerierung für verschiedene Anwendungen und Workflows. |
## **Properties**
...
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Ruft die Hintergrundfarbe des Bildes ab, falls angegeben. Diese Eigenschaft <br/>            ist nützlich für Anwendungen, die die Hintergrundfarbe eines Bildes identifizieren und ggf. manipulieren müssen. |
| bits_per_pixel | int | r | Ruft den Bits‑pro‑Pixel‑Wert des Bildes ab. Diese Eigenschaft liefert wichtige <br/>            Informationen zur Farbtiefe des Bildes und ermöglicht Entwicklern, <br/>            das Detail- und Farbgenauigkeitsniveau der Bilddaten zu verstehen. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Ruft das Format der mit der Bildinstanz verknüpften Datei ab. Diese <br/>            Eigenschaft liefert wesentliche Informationen zum Dateityp und ermöglicht <br/>            eine effiziente Handhabung und Verarbeitung basierend auf den jeweiligen Formatvorgaben. |
| [has_alpha](#has_alpha1) | bool | r | Gibt einen booleschen Wert zurück, der angibt, ob das Bild einen Alpha‑Kanal besitzt, <br/>            der dessen Transparenz bestimmt. Diese Eigenschaft ist nützlich für Anwendungen, <br/>            die Transparenz verarbeiten müssen, und ermöglicht Entwicklern zu bestimmen, ob <br/>            zusätzliche Verarbeitung erforderlich ist, um transparente Bereiche im Bild zu handhaben. |
| has_background_color | bool | r/w | Ruft einen booleschen Wert ab, der angibt, ob das Bild eine Hintergrundfarbe besitzt. <br/>            Diese Eigenschaft ist nützlich für Anwendungen, die feststellen müssen, ob ein Bild <br/>            eine Hintergrundfarbe enthält, was für verschiedene Verarbeitungsaufgaben wie <br/>            Komposition, Rendering oder Export wichtig sein kann. |
| has_transparent_color | bool | r/w | Stellt einen booleschen Wert bereit, der angibt, ob das Bild eine transparente <br/>            Farbe enthält. Diese Eigenschaft ist entscheidend für Anwendungen, die Transparenz verarbeiten müssen, und ermöglicht Entwicklern zu bestimmen, ob zusätzliche Verarbeitung <br/>            erforderlich ist, um transparente Bereiche im Bild zu handhaben. |
| height | int | r | Ermittelt die Höhe des Bildes. Diese Eigenschaft gibt die vertikale Dimension des <br/>            Bildes zurück und ermöglicht Entwicklern, seine Größe in Pixeln entlang der <br/>            Vertikalachse zu bestimmen. |
| horizontal_resolution | float | r/w | Ruft die horizontale Auflösung des Bildes ab oder ändert sie. Diese Eigenschaft <br/>            gibt die Anzahl der Pixel pro Zoll entlang der Horizontalachse des <br/>            Bildes an. Das Anpassen dieser Auflösung kann die physische Größe des Bildes beim <br/>            Druck oder der Anzeige beeinflussen. |
| image_opacity | float | r | Liest die Opazität dieses Bildes. |
| interlaced | bool | r | Ruft einen booleschen Wert ab, der angibt, ob die [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) <br/>            interlaced ist, was bestimmt, ob die Bilddaten progressiv gespeichert werden, <br/>            um schnelleres Laden oder Übertragen zu ermöglichen. |
...
| is_interlaced | bool | r | Gibt einen booleschen Wert zurück, der angibt, ob die Bildinstanz interlaced ist. Diese <br/>            Eigenschaft ist entscheidend für die Optimierung von Ladestrategien und die Gewährleistung einer effizienten <br/>            Leistung während der Bildverarbeitung oder Anzeigeaufgaben. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Greift auf das Rohdatenformat des Bildes zu. Diese Eigenschaft liefert Einblick in <br/>            wie die Bilddaten intern strukturiert sind, was für fortgeschrittene <br/>            Bildverarbeitungsaufgaben oder Formatkonvertierung nützlich sein kann. |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Ruft die transparente Farbe des Bildes ab, falls vorhanden. Diese Eigenschaft ist <br/>            wertvoll für Anwendungen, die eine präzise Handhabung transparenter Bereiche <br/>            innerhalb von Bildern erfordern, und ermöglicht Entwicklern den Zugriff auf und die Manipulation der verwendeten <br/>            transparenten Farbe. |
...
| vertical_resolution | float | r/w | Bietet Zugriff auf die vertikale Auflösung des Bildes. Entwickler können <br/>            diese Eigenschaft nutzen, um die Auflösungseinstellung abzurufen oder zu ändern, die die <br/>            Anzahl der Pixel pro Zoll (PPI) entlang der vertikalen Achse des Bildes angibt. |
| width | int | r | Ermöglicht das Abrufen der Breite des Bildes und liefert wesentliche Informationen <br/>            über seine Abmessungen. Diese Eigenschaft wird von Entwicklern häufig verwendet, um <br/>            die Bildbreite zu bestimmen, sodass sie verschiedene Operationen basierend <br/>            auf seiner Größe ausführen können. |
...
| [create_from_file_with_color_type(path, color_type)](#create_from_file_with_color_type_path_color_type_26) | Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_29) | Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_from_image_with_color_type(raster_image, color_type)](#create_from_image_with_color_type_raster_image_color_type_30) | Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_34) | Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_color_type(width, height, color_type)](#create_with_width_height_color_type_width_height_color_type_35) | Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_options(png_options, width, height)](#create_with_width_height_options_png_options_width_height_36) | Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_54) | Ruft den Zeitstempel ab, der die letzte Änderung der Ressourcen‑<br/>            Bildes angibt. Diese Methode bietet Zugriff auf wichtige Metadaten, sodass Anwendungen <br/>            feststellen können, wann das Bild zuletzt geändert wurde, was die Versionsverfolgung und <br/>            das Content‑Management erleichtert. |
...
| [save(stream)](#save_stream_107) | Die gespeicherten Daten. |
...
| :- | :- | :- |
| Pfad | string | Der Pfad zum Laden eines Bildes. |
| color_type | [PngColorType](/imaging/python-net/aspose.imaging.fileformats.png/pngcolortype/) | Der Farbtyp. |
...
Initialisiert ein neues Objekt der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem die <br/>            Breiten‑ und Höhenparameter bereitgestellt werden. Dieser Konstruktor vereinfacht die Erstellung von PNG‑<br/>            Bildern, indem er Entwicklern erlaubt, die Abmessungen direkt anzugeben, und erleichtert die effiziente Verwaltung von PNG‑Bilddaten in ihren Anwendungen.
...
Instanziiert eine neue Instanz der [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/)‑Klasse, indem die gewünschten Breiten‑, Höhen‑ und Farbtyp‑Parameter angegeben werden. Dieser Konstruktor ermöglicht <br/>            die schnelle Erstellung von PNG‑Bildern mit maßgeschneiderten Abmessungen und Farbkombinationen, <br/>            und erleichtert die optimierte Bildgenerierung für verschiedene Anwendungen und Workflows.
...
Gibt einen booleschen Wert zurück, der angibt, ob das Bild einen Alpha‑Kanal besitzt, <br/>            der dessen Transparenz bestimmt. Diese Eigenschaft ist nützlich für Anwendungen, <br/>            die Transparenz verarbeiten müssen, und ermöglicht Entwicklern zu bestimmen, ob <br/>            zusätzliche Verarbeitung erforderlich ist, um transparente Bereiche im Bild zu handhaben.
...
Initialisiert eine neue Instanz der Klasse [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/).
...
Ruft den Zeitstempel ab, der die letzte Änderung der Ressourcen‑<br/>            Bildes angibt. Diese Methode bietet Zugriff auf wichtige Metadaten, sodass Anwendungen <br/>            feststellen können, wann das Bild zuletzt geändert wurde, was die Versionsverfolgung und <br/>            das Content‑Management erleichtert.
...
with as_of(Image.load("sample.png"), PngImage) as pngImage:
	# Transformiere das Bild in eine Graustufen‑Darstellung
	pngImage.grayscale()
...
dir_ = "c:\\temp"
# Lade ein PNG‑Bild aus einer Datei.
# Beachte, dass das farbige Bild automatisch in Graustufen konvertiert wird.
...
dir_: str = "c:\\temp"
# Lade ein PNG‑Bild aus einem Dateistream.
...
dir_: str = "c:\\temp"
# Lade ein TrueColor‑PNG‑Bild aus einem BMP‑Bild.
# Erstelle zunächst ein temporäres BMP‑Bild, das die Grundlage für die Erstellung eines PNG‑Bildes bildet.
# Du kannst ein BMP‑Bild auch aus einer Datei laden oder ein Bild eines anderen Rasterformats verwenden.
with BmpImage(100, 100) as bmp_image:
	# Fülle das gesamte BMP‑Bild mit Rot.
...
dir_ = "c:\\temp"
# Lade ein Graustufen‑PNG‑Bild aus einem farbigen BMP‑Bild.
# Erstelle zunächst ein temporäres BMP‑Bild, das die Grundlage für die Erstellung eines PNG‑Bildes bildet.
# Du kannst ein BMP‑Bild auch aus einer Datei laden oder ein Bild eines anderen Rasterformats verwenden.
with BmpImage(100, 100) as bmp_image:
	# Fülle das gesamte BMP‑Bild mit Rot.
	...
	brush = SolidBrush(Color.red)
	gr.fill_rectangle(brush, bmp_image.bounds)
	# Die Farben der Bildpixel werden in ihre Graustufen‑Entsprechungen konvertiert.
...
dir_: str = "c:\\temp"
# Erstelle ein Graustufen‑PNG‑Bild mit 100 × 100 px.
...
# Rufe alle unterstützten PNG‑Farbtypen ab.
...
# Ein TruecolorWithAlpha PNG-Bild unterstützt den Alphakanal
