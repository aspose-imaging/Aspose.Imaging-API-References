---
title: "MetaImage Klasse"
type: docs
weight: 3140
url: /de/python-net/aspose.imaging.fileformats.emf/metaimage/
---
...
| records | [MetaObjectList](/imaging/python-net/aspose.imaging.fileformats.emf/metaobjectlist/) | r/w | Liest oder setzt die Datensätze. |
...
| [get_original_options()](#get_original_options__30) | Liefert die Optionen basierend auf den ursprünglichen Dateieinstellungen.<br/>            Dies kann hilfreich sein, um die Bit‑Tiefe und andere Parameter des Originalbildes unverändert zu lassen.<br/>            Zum Beispiel, wenn wir ein schwarz‑weißes PNG‑Bild mit 1 Bit pro Pixel laden und es anschließend mit der<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/)‑Methode speichern, wird ein PNG‑Ausgabebild mit 8 Bit pro Pixel erzeugt.<br/>            Um dies zu vermeiden und ein PNG‑Bild mit 1 Bit pro Pixel zu speichern, verwenden Sie diese Methode, um die entsprechenden Speicheroptionen zu erhalten und übergeben Sie sie<br/>            an die [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/)‑Methode als zweiten Parameter. |
...
| [get_used_fonts()](#get_used_fonts__34) | Gibt die Liste der im Metafile verwendeten Schriftarten zurück. |
...
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_48) | Ändert die Größe der Leinwand. |
...
Gibt die Liste der im Metafile verwendeten Schriftarten zurück.
