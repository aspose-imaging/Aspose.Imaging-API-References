---
title: "EmfMetafileHeaderExtension2 Klasse"
type: docs
weight: 630
url: /de/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [EmfMetafileHeaderExtension2(header)](#EmfMetafileHeaderExtension2_header_1) | Initialisiert eine neue Instanz der [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) Klasse. |
| [EmfMetafileHeaderExtension2(header)](#EmfMetafileHeaderExtension2_header_2) | Initialisiert eine neue Instanz der [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) Klasse. |
## **Properties**
...
| emf_header_extension2 | [EmfHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/) | r/w | Liest oder setzt ein HeaderExtension2‑Objekt, das zusätzliche Informationen über das Bild in der Metadatei angibt |
...
| **Name** | **Beschreibung** |
| :- | :- |
| [create_from_header(header)](#create_from_header_header_1) | Initialisiert eine neue Instanz der [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) Klasse. |
| [create_from_header_extension1(header)](#create_from_header_extension1_header_2) | Initialisiert eine neue Instanz der [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) Klasse. |
| [create_from_header_extension2(header)](#create_from_header_extension2_header_3) | Initialisiert eine neue Instanz der [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) Klasse. |
| [create_from_record(record)](#create_from_record_record_4) | Initialisiert eine neue Instanz der Klasse [EmfMetafileHeader](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheader/). |
| [create_from_type(type)](#create_from_type_type_5) | Initialisiert eine neue Instanz der [EmfRecord](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfrecord/) Klasse. |
...
Initialisiert eine neue Instanz der [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) Klasse.
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| header | [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) | Der Header. |
