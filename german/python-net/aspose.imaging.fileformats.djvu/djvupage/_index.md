---
title: "DjvuPage Klasse"
type: docs
weight: 20
url: /de/python-net/aspose.imaging.fileformats.djvu/djvupage/
---
...
| height | int | r | Ermittelt die Höhe der Seite |
...
| image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r | Liest das Bild. |
...
| is_color | bool | r | Ermittelt einen Wert, der angibt, ob diese Instanz farbig ist. |
...
| page_number | int | r | Liefert die Seitennummer. |
...
| parent_image | [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | r | Ermittelt das übergeordnete Bild, zu dem die Seite gehört |
...
| thumbnail_image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r/w | Liest oder setzt das Miniaturbild für die Seite |
...
| width | int | r | Ermittelt die Breite der Seite |
...
| [extract_thumbnail_image()](#extract_thumbnail_image__35) | Extrahiert das Miniaturbild aus der Djvu‑Seite. |
| [filter(rectangle, options)](#filter_rectangle_options_36) | Filtert das angegebene Rechteck. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_37) | Liefert ein 32‑Bit‑ARGB‑Pixel‑Bild. |
| [get_background_image()](#get_background_image__38) | Ermittelt das Hintergrundbild. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_49) | Ermittelt das Vordergrundbild für die Seite |
| [get_modify_date(use_default)](#get_modify_date_use_default_50) | Liefert Datum und Uhrzeit, zu der das Ressourcen‑Bild zuletzt geändert wurde. |
...
| [get_pixel(x, y)](#get_pixel_x_y_52) | Liefert ein Bild‑Pixel. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_53) | Liefert eine proportionale Höhe. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_54) | Liefert eine proportionale Breite. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_55) | Konvertiert zu aps. |
| [get_skew_angle()](#get_skew_angle__56) | Liefert den Schrägungswinkel.<br/>            Diese Methode ist auf gescannte Textdokumente anwendbar, um den Schrägungswinkel beim Scannen zu bestimmen. |
| [get_text_for_location(rect)](#get_text_for_location_rect_57) | Ermittelt den Text für die Rechteckposition |
| [get_text_image(subsample)](#get_text_image_subsample_58) | Ermittelt das Textbild. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | Ändert die Größe des Seitenbildes auf die neuen Abmessungen |
...
| [save(stream)](#save_stream_105) | Speichert die Daten. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_121) | Setzt die Auflösung für dieses [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| Typ | Beschreibung |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Das Djvu‑Rasterbild. |
...
| Typ | Beschreibung |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Das Bitmap |
...
Ermittelt das Vordergrundbild für die Seite

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| Unterabtastung | int | Die Unterabtastung. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Bitmap-Bild |
...
Ermittelt den Text für die Rechteckposition

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Das Positionsrechteck. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| string | Text, der an der Position gefunden wurde |
...
Ändert die Größe des Seitenbildes auf die neuen Abmessungen
