---
title: "DjvuImage-Klasse"
type: docs
weight: 10
url: /de/python-net/aspose.imaging.fileformats.djvu/djvuimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [DjvuImage(stream)](#DjvuImage_stream_1) | Beginnen Sie mit der Arbeit an DjVu-Bildern, indem Sie eine neue Instanz der<br/>            [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) Klasse mit einem Stream-Parameter erstellen. Perfekt für<br/>            Entwickler, die eine nahtlose Integration der DjVu-Bildverarbeitung in<br/>            ihre Projekte wünschen. |
| [DjvuImage(stream, load_options)](#DjvuImage_stream_load_options_2) | Beginnen Sie nahtlos mit DjVu-Bildern mit diesem Konstruktor, der<br/>            eine neue Instanz der [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) Klasse mithilfe eines Stream- und<br/>            LoadOptions-Parameters initialisiert. Perfekt für Entwickler, die eine präzise Kontrolle über<br/>            DjVu-Bildladeoptionen bei gleichzeitig einfacher Handhabung und Effizienz wünschen. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| active_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r/w | Navigieren Sie durch Ihr DjVu-Dokument, indem Sie über diese Eigenschaft die aktuell aktive<br/>            Seite abrufen oder festlegen. Wechseln Sie nahtlos zwischen Seiten, um sich auf bestimmte<br/>            Inhalte zu konzentrieren und Ihr Dokumentanzeigeerlebnis zu verbessern. |
...
| djvu_pages | [DjvuPage[]](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Rufen Sie schnell alle Seiten ab, die in Ihrem DjVu-Dokument enthalten sind, über diese<br/>            Eigenschaft. Vereinfachen Sie Ihren Dokumentverarbeitungsablauf, indem Sie einzelne Seiten in Ihren DjVu-Dateien leicht zugreifen und verwalten. Steigern Sie die Effizienz und<br/>            optimieren Sie Ihre Aufgaben mit einer bequemen Seitenermittlung. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Liest oder setzt die Exif‑Instanz. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Erhalten Sie die Dateiformatinformationen zu Ihrer DjVu-Bilddatei. Bestimmen Sie schnell<br/>            das Format Ihrer Datei für eine nahtlose Integration in Ihren Arbeitsablauf. |
| first_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Greifen Sie über diese Eigenschaft auf die erste Seite Ihres DjVu-Dokuments zu. Rufen Sie schnell<br/>            die Anfangsseite ab, um Ihr Dokument effizient anzusehen oder zu verarbeiten. |
| has_alpha | bool | r | Bestimmen Sie schnell, ob Ihre DjVu-Bilddatei einen Alpha-Kanal enthält.<br/>            Vereinfachen Sie Ihren Arbeitsablauf, indem Sie das Vorhandensein von Transparenzinformationen<br/>            in Ihren Bildern prüfen. |
...
| Bezeichner | int | r | Ermittelt den eindeutigen Bezeichner für das Dokument |
...
| last_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Rufen Sie die letzte Seite Ihres DjVu-Dokuments über diese Eigenschaft ab. Greifen Sie schnell<br/>            auf die Endseite zu, um sie bequem anzusehen oder zu verarbeiten. |
...
| next_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Navigieren Sie durch Ihr DjVu-Dokument, indem Sie mit dieser<br/>            praktischen Eigenschaft die nächste Seite aufrufen. Bewegen Sie sich schnell vorwärts beim Ansehen oder<br/>            Verarbeiten Ihres Dokuments. |
| page_count | int | r | Ermitteln Sie die Gesamtzahl der Seiten in Ihrer DjVu-Bildsammlung über diese Eigenschaft.<br/>            Ideal, um schnell das Ausmaß Ihres Dokuments oder Buches im DjVu-Format zu beurteilen.<br/>            Steigern Sie die Effizienz Ihres Arbeitsablaufs mit genauen Seitenzahlinformationen. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Greifen Sie über diese Eigenschaft auf die einzelnen Seiten Ihrer DjVu-Bildsammlung zu.<br/>            Vereinfachen Sie die Navigation und Manipulation Ihres Dokuments oder Buches im DjVu-Format,<br/>            indem Sie jede Seite direkt aufrufen. Steigern Sie die Effizienz Ihres Arbeitsablaufs mit einfacher<br/>            Seitenermittlung. |
...
| previous_page | [DjvuPage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvupage/) | r | Bewegen Sie sich schnell rückwärts in Ihren DjVu-Dokumentanzeige- oder Verarbeitungsaufgaben, indem Sie<br/>            die vorherige Seite über diese praktische Eigenschaft aufrufen. Navigieren Sie effizient<br/>            durch Ihr Dokument mit Leichtigkeit. |
...
| **Name** | **Beschreibung** |
| :- | :- |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_1) | Stellen Sie die _Helligkeit_ eines Bildes mit einem angegebenen Parameter ein, <br/>            um die Luminanzwerte für optimale visuelle Klarheit zu steuern. Diese Methode erhöht <br/>            oder verringert die Gesamthelligkeit des Bildes und ermöglicht feine Anpassungen, um <br/>            gewünschte Lichteffekte zu erzielen. Durch die Modulation der Helligkeit können Benutzer die Bild<br/>            Sichtbarkeit optimieren und die Detailwiedergabe für ein verbessertes Anzeigeerlebnis steigern. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_2) | Verbessern Sie den Kontrast von [Image](/imaging/python-net/aspose.imaging/image/), um die visuelle Klarheit zu erhöhen und <br/>            Details mit dieser Methode hervorzuheben, die den Helligkeitsunterschied zwischen <br/>            hellen und dunklen Bereichen anpasst. Durch feine Einstellung der Kontrastwerte können Benutzer lebendigere und <br/>            eindrucksvollere Bilder erzielen, die Gesamtbildqualität verbessern und die Detailsichtbarkeit maximieren. <br/>            Diese Anpassung bringt subtile Nuancen in Farbe und Textur zum Vorschein, was zu <br/>            dynamischeren und optisch ansprechenderen Bildern führt. |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_3) | Die Gammakorrektur, speziell für die Rot-, Grün- und Blaukanäle, beinhaltet die separate Anpassung <br/>            der Helligkeit jeder Farbkomponente. Durch Anwenden unterschiedlicher Gamma-<br/>            Koeffizienten auf die RGB-Kanäle können Sie die Gesamthelligkeit und den Kontrast <br/>            eines Bildes feinjustieren. Diese Technik gewährleistet eine genaue Farbdarstellung und verbessert die <br/>            visuelle Qualität des Bildes auf verschiedenen Anzeigegeräten. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_4) | Die Gammakorrektur wird auf ein Bild mit anpassbaren Parametern für die Rot-, Grün- <br/>            und Blaukanäle angewendet, wodurch eine präzise Einstellung von Farbbalance und Helligkeit möglich ist. Diese <br/>            Methode verbessert die Bildqualität durch Feinabstimmung der Farbdarstellung und sorgt für optimale <br/>            Darstellung auf verschiedenen Anzeigegeräten. Das Anpassen der Gamma-Werte einzelner <br/>            Kanäle verbessert die Farbbalance und die visuelle Attraktivität. |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_7) | Binarisierung mit Bradleys adaptivem Schwellenwertalgorithmus und Integralbild<br/>            Schwellenwertbestimmung ist ein Verfahren, das für jedes Pixel einen lokalen Schwellenwert basierend auf einem <br/>            lokalen Nachbarschaftsbereich berechnet. Es passt sich an Beleuchtungsvariationen im Bild an, wodurch es <br/>            für Bilder mit ungleichmäßigen Lichtverhältnissen geeignet ist. Durch die Berechnung des Schwellenwerts mittels <br/>            Integralbildern wird effizient mit großen Nachbarschaften umgegangen, was es für <br/>            Echtzeitanwendungen anwendbar macht. Diese Technik wird häufig in der Dokumentenverarbeitung, OCR <br/>            (Optische Zeichenerkennung) und Bildsegmentierungsaufgaben eingesetzt, bei denen eine genaue <br/>            Binarisierung für die nachfolgende Analyse entscheidend ist. |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_8) | Binarisierung mit einem vordefinierten Schwellenwert vereinfacht komplexe Bilder zu binären<br/>            Darstellungen, wobei Pixel entweder als schwarz oder weiß klassifiziert werden, basierend auf ihrer <br/>            Intensität im Vergleich zu einem festgelegten Schwellenwert. Diese Technik wird häufig in <br/>            der Bildverarbeitung eingesetzt, um die Klarheit zu erhöhen, Analysen zu vereinfachen und Bilder für weitere <br/>            Verarbeitungsschritte wie die optische Zeichenerkennung (OCR) vorzubereiten. Durch die Anwendung eines festen <br/>            Schwellenwerts können Graustufenbilder schnell in binäre Form umgewandelt werden, wodurch sie <br/>            leichter zu interpretieren und bedeutungsvolle Informationen zu extrahieren sind. |
| binarize_otsu() | Binarisierung mittels Otsu‑Schwellenwertverfahren ist eine Technik, die automatisch einen<br/>            optimalen Schwellenwert basierend auf dem Histogramm des Bildes berechnet. Sie trennt das Bild in <br/>            Vordergrund und Hintergrund, indem sie die Intra‑Klassen‑Varianz minimiert. Die Otsu‑Methode wird <br/>            häufig zum Segmentieren von Bildern in binäre Form verwendet, insbesondere wenn die Verteilung <br/>            der Pixelintensitäten bimodal oder multimodal ist. Dieser Ansatz ist vorteilhaft für Aufgaben <br/>            wie Objekterkennung, Bildsegmentierung und Merkmalsextraktion, bei denen eine genaue <br/>            Abgrenzung zwischen Vordergrund und Hintergrund entscheidend ist. |
...
| cache_data() | Cache die Daten privat, um die Leistung zu optimieren und den Bedarf an wiederholten Daten <br/>            Abrufen aus externen Quellen zu reduzieren. Dieser Ansatz hilft zudem, Ressourcen zu schonen, <br/>            insbesondere in Szenarien, in denen der Datenzugriff häufig oder Ressourcen begrenzt sind. |
...
| [create_from_files(files)](#create_from_files_files_26) | Erstellt das Mehrseiten‑Bild, das die angegebenen Dateien als Lazy‑Loading‑Seiten enthält. |
| [create_from_files(files, throw_exception_on_load_error)](#create_from_files_files_throw_exception_on_load_error_27) | Erstellt das Mehrseiten‑Bild, das die angegebenen Dateien als Lazy‑Loading‑Seiten enthält. |
| [create_from_images(images)](#create_from_images_images_28) | Erstellt ein neues Bild, das die angegebenen Bilder als Seiten verwendet |
| [create_from_images(images, dispose_images)](#create_from_images_images_dispose_images_29) | Erstellt ein neues Bild, wobei die angegebenen Bilder als Seiten verwendet werden. |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_30) | Crop with shifts ermöglicht es dir, die Position und Abmessungen des<br/>            beschnittenen Bereichs innerhalb eines Bildes präzise anzupassen. Diese Funktion ist unverzichtbar, um Kompositionen zu verfeinern,<br/>            Elemente auszurichten und Fokuspunkte in deinen Visuals zu betonen. Durch das Einbeziehen von Verschiebungen<br/>            in den Zuschneidevorgang kannst du pixelgenaue Präzision erreichen und den<br/>            Bildausschnitt mühelos feinjustieren. |
| [crop(rectangle)](#crop_rectangle_31) | "Crop" schneidet dein Bild zu, um spezifische Details hervorzuheben oder unerwünschte Elemente zu entfernen,<br/>            wodurch die Komposition und visuelle Wirkung verbessert wird. Egal, ob du Fotos für soziale<br/>            Medien anpasst, Website‑Banner erstellst oder Druckmaterialien gestaltest, dieses Werkzeug hilft dir<br/>            dabei, deine Bilder mit Präzision und Klarheit zu verfeinern. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_32) | Führt Dithering auf dem aktuellen Bild aus. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_33) | Die "Dither"‑Funktion wendet einen Dithering‑Effekt auf dein Bild an und verbessert dessen visuelle<br/>            Qualität, indem Banding reduziert und Farbübergänge verbessert werden. Egal, ob du an digitaler Kunst, Fotografie oder Grafikdesignprojekten arbeitest, fügt dieses Feature deinen Bildern einen<br/>            professionellen Touch hinzu, sodass sie glatter und raffinierter wirken. |
| [embed_digital_signature(password)](#embed_digital_signature_password_34) | Betten Sie eine digitale Signatur, basierend auf dem angegebenen Passwort, in jede Seite des Bildes ein. |
| [filter(rectangle, options)](#filter_rectangle_options_35) | Wende Filter auf einen angegebenen rechteckigen Bereich innerhalb des Bildes an, um dessen <br/>            Aussehen zu verbessern oder zu verändern. Durch das gezielte Ansteuern bestimmter Regionen ermöglicht diese Methode präzise Anpassungen, <br/>            wie das Weichzeichnen, Schärfen oder Anwenden künstlerischer Effekte, um gewünschte visuelle <br/>            Ergebnisse zu erzielen. Das Feinabstimmen von Filtern in ausgewählten Bereichen befähigt Benutzer, die Bildästhetik zu personalisieren, <br/>            die Klarheit zu verbessern und künstlerische Effekte nach ihren Vorlieben zu gestalten. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_36) | Liefert ein 32‑Bit‑ARGB‑Pixel‑Bild. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_37) | Liefert das Standard‑32‑Bit‑ARGB‑Pixel‑Array. |
| [get_default_options(args)](#get_default_options_args_38) | Liefert die Standardoptionen. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_39) | Liefert das Standard‑Pixel‑Array mittels teilweisem Pixel‑Lader. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_40) | Liefert das Standard‑Rohdaten‑Array mittels teilweisem Pixel‑Lader. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_41) | Liefert das Standard‑Rohdaten‑Array. |
| [get_file_format(file_path)](#get_file_format_file_path_42) | Liefert das Dateiformat. |
| [get_file_format(stream)](#get_file_format_stream_43) | Liefert das Dateiformat. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_44) | Liefert das Dateiformat. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_45) | Liefert das Rechteck, das zum aktuellen Bild passt. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_46) | Liefert das Rechteck, das zum aktuellen Bild passt. |
| [get_modify_date(use_default)](#get_modify_date_use_default_47) | Liefert Datum und Uhrzeit, zu der das Ressourcen‑Bild zuletzt geändert wurde. |
...
| [get_pixel(x, y)](#get_pixel_x_y_49) | Liefert ein Bild‑Pixel. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_50) | Liefert eine proportionale Höhe. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_51) | Liefert eine proportionale Breite. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_52) | Konvertiert zu aps. |
| [get_skew_angle()](#get_skew_angle__53) | Liefert den Schrägungswinkel.<br/>            Diese Methode ist auf gescannte Textdokumente anwendbar, um den Schrägungswinkel beim Scannen zu bestimmen. |
| grayscale() | Die Graustufen‑Transformation wandelt ein Bild in eine Schwarz‑Weiß‑Darstellung um, wobei <br/>            jeder Pixelwert durch einen einzelnen Wert von Schwarz bis Weiß repräsentiert wird. <br/>            Dieser Vorgang entfernt Farbinformationen und erzeugt ein monochromes Bild. Graustufen‑Bilder werden häufig in Anwendungen eingesetzt, bei denen Farbe unnötig ist oder Einfachheit <br/>            bevorzugt wird, wie beim Dokumentenscannen, Drucken und bestimmten Arten der Bildanalyse. |
| [is_digital_signed(password, percentage_threshold)](#is_digital_signed_password_percentage_threshold_54) | Führt eine schnelle Prüfung durch, um festzustellen, ob das Bild digital signiert ist, wobei das bereitgestellte Passwort und der Schwellenwert verwendet werden. |
| [load(file_path)](#load_file_path_55) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
| [load(file_path, load_options)](#load_file_path_load_options_56) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
| [load(stream)](#load_stream_57) | Lade dein DjVu‑Dokument mit dieser Methode. Beschleunige deinen Prozess, indem du schnell<br/>            auf deine DjVu‑Dateien zugreifst und sie in deine Anwendung importierst. |
| [load(stream, load_options)](#load_stream_load_options_58) | Importiere dein DjVu‑Dokument, indem du diese Methode mit den Parametern stream und loadOptions<br/>            nutzt. Beschleunige deinen Prozess, indem du schnell auf DjVu‑Dateien zugreifst und sie<br/>            in deine Anwendung importierst, wobei du Flexibilität und Anpassungsoptionen erhältst, um deine<br/>            Bedürfnisse zu erfüllen. |
...
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_62) | Lädt Pixel im CMYK‑Format.<br/>            Diese Methode ist veraltet. Bitte verwenden Sie die effektivere Methode [RasterImage.load_cmyk_32_pixels(rectangle)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [load_document(stream)](#load_document_stream_63) | Lade dein DjVu‑Dokument mit dieser Methode. Beschleunige deinen Prozess, indem du schnell<br/>            auf deine DjVu‑Dateien zugreifst und sie in deine Anwendung importierst. |
| [load_document(stream, load_options)](#load_document_stream_load_options_64) | Importiere dein DjVu‑Dokument, indem du diese Methode mit den Parametern stream und loadOptions<br/>            nutzt. Beschleunige deinen Prozess, indem du schnell auf DjVu‑Dateien zugreifst und sie<br/>            in deine Anwendung importierst, wobei du Flexibilität und Anpassungsoptionen erhältst, um deine<br/>            Bedürfnisse zu erfüllen. |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_65) | Lädt 32‑Bit‑ARGB‑Pixel teilweise (nach Blöcken). |
| [load_partial_argb_64_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_66) | Lädt 64‑Bit‑ARGB‑Pixel teilweise nach Paketen. |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_67) | Lädt Pixel teilweise nach Paketen. |
| [load_pixels(rectangle)](#load_pixels_rectangle_68) | Lädt Pixel. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_69) | Lädt Rohdaten. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_70) | Lädt Rohdaten. |
| [load_stream(stream)](#load_stream_stream_71) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_72) | Lädt ein neues Bild aus dem angegebenen Stream. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_74) | Normalisiert den Winkel.<br/>            Diese Methode ist auf gescannte Textdokumente anwendbar, um die schiefe Aufnahme zu korrigieren.<br/>            Diese Methode verwendet die Methoden [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) und [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/). |
...
| [read_argb_32_scan_line(scan_line_index)](#read_argb_32_scan_line_scan_line_index_75) | Liest die gesamte Scanzeile anhand des angegebenen Scanzeilen‑Index. |
| [read_scan_line(scan_line_index)](#read_scan_line_scan_line_index_76) | Liest die gesamte Scanzeile anhand des angegebenen Scanzeilen‑Index. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_77) | Ersetzt eine Farbe durch eine andere mit zulässiger Differenz und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_78) | Ersetzt eine Farbe durch eine andere mit zulässiger Differenz und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_79) | Ersetzt eine Farbe durch eine andere mit zulässiger Differenz und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_80) | Ersetzt alle nicht‑transparenten Farben durch eine neue Farbe und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten.<br/>                Hinweis: Wenn Sie dies bei Bildern ohne Transparenz verwenden, werden alle Farben durch eine einzige ersetzt. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_81) | Ersetzt alle nicht‑transparenten Farben durch eine neue Farbe und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten.<br/>                Hinweis: Wenn Sie dies bei Bildern ohne Transparenz verwenden, werden alle Farben durch eine einzige ersetzt. |
| [resize(new_width, new_height)](#resize_new_width_new_height_82) | Skaliert das Bild. Der Standardwert [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_83) | Skaliere das Bild mit der `Resize`‑Methode, die eine einfache und effektive Möglichkeit bietet<br/>            die Abmessungen deiner Bilder nach deinen Anforderungen anzupassen. Diese<br/>            vielseitige Funktion ermöglicht es dir, Bilder mühelos auf die gewünschte Größe zu skalieren,<br/>            wodurch ihre Nutzbarkeit über verschiedene Plattformen und Anwendungen hinweg verbessert wird. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_84) | Skaliere das Bild auf die angegebene Breite und Höhe, während bei Bedarf zusätzliche Einstellungen <br/>            angewendet werden. Diese Methode ermöglicht es Benutzern, die Bildabmessungen anzupassen, während <br/>            gewünschte Attribute wie Seitenverhältnis, Bildqualität und Kompressionseinstellungen beibehalten werden. Durch die Bereitstellung von Flexibilität bei den Skalierungsoptionen können Benutzer das Bild <br/>            an spezifische Anforderungen anpassen und sein Erscheinungsbild für verschiedene Anwendungen und <br/>            Plattformen optimieren. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_85) | Skaliert das Bild. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_86) | Skaliert das Bild. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_87) | Skaliert die Höhe proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_88) | Die `ResizeHeightProportionally`‑Methode erlaubt es dir, die Höhe deines<br/>            Bildes anzupassen und dabei das Seitenverhältnis beizubehalten. Dadurch bleibt dein Bild<br/>            proportional, verhindert Verzerrungen und bewahrt seine visuelle Integrität.<br/>            Egal, ob du Bilder für Webseiten, mobile Apps oder Printmedien optimierst, stellt diese<br/>            Methode sicher, dass deine Bilder auf verschiedenen Plattformen und Geräten optimal aussehen. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_89) | Skaliert die Höhe proportional. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_90) | Skaliert die Höhe proportional. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_91) | Skaliert die Breite proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_92) | Die `ResizeWidthProportionally`‑Methode bietet eine praktische Lösung, um die<br/>            Breite deines Bildes anzupassen und dabei das Seitenverhältnis beizubehalten. Durch das proportionale Ändern<br/>            der Breite kannst du sicherstellen, dass deine Bilder visuell ansprechend bleiben und<br/>            konsistent über verschiedene Geräte und Bildschirmgrößen hinweg, was ihre Vielseitigkeit<br/>            und Nutzbarkeit in unterschiedlichen Kontexten erhöht. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_93) | Skaliert die Breite proportional. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_94) | Skaliert die Breite proportional. |
| [rotate(angle)](#rotate_angle_95) | Bild um das Zentrum drehen. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_96) | Drehe das Bild um sein Zentrum mit der Rotate‑Methode der<br/>            RasterCachedMultipageImage‑Klasse. Diese praktische Funktion ermöglicht es dir, die Ausrichtung von Bildern einfach<br/>            anzupassen, während du ihre zentrale Position beibehältst,<br/>            und erweitert deine Bildbearbeitungsfähigkeiten. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_97) | Die `RotateFlip`‑Methode bietet vielseitige Manipulationsoptionen für dein Bild und ermöglicht<br/>            das Drehen, Spiegeln oder die Kombination beider Vorgänge auf dem aktiven Frame unabhängig voneinander.<br/>            Egal, ob du Fotos bearbeitest, Grafiken erstellst oder digitale Kunst verbesserst, diese<br/>            Methode liefert präzise Kontrolle über die Ausrichtung und Komposition deiner Bilder,<br/>            sodass sie deiner kreativen Vision mühelos und effizient entsprechen. |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_98) | Dreht das gesamte Flip. |
| save() | Speichert die Bilddaten in den zugrunde liegenden Stream. |
| [save(file_path)](#save_file_path_99) | Speichert das Bild am angegebenen Dateipfad. |
| [save(file_path, options)](#save_file_path_options_100) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_101) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, over_write)](#save_file_path_over_write_102) | Speichert die Daten des Objekts am angegebenen Speicherort. |
| [save(stream)](#save_stream_103) | Speichert die Daten. |
| [save(stream, options_base)](#save_stream_options_base_104) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_105) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_106) | Speichert die 32‑Bit‑ARGB‑Pixel. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_107) | Speichert die Pixel. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_108) | Speichert die Pixel.<br/>            Diese Methode ist veraltet. Bitte verwenden Sie die effektivere [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) Methode. |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_109) | Speichert Pixel (formatspezifische Methode). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_110) | Speichert die Rohdaten. |
| [save_to_stream(stream)](#save_to_stream_stream_111) | Speichert die Daten des Objekts in den angegebenen Stream. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_112) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_113) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_114) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_115) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_116) | Setzt ein 32‑Bit‑ARGB‑Pixel des Bildes für die angegebene Position. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_117) | Setzt die Bildpalette. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_118) | Setzt ein Bildpixel für die angegebene Position. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_119) | Setzt die Auflösung für dieses [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_120) | Versucht, eine _metadata_-Instanz zu setzen, falls diese [Image](/imaging/python-net/aspose.imaging/image/)‑Instanz unterstützt und eine [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)‑Instanz implementiert. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_121) | Schreibt die gesamte Scanzeile in den angegebenen Scanzeilen‑Index. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_122) | Schreibt die gesamte Scanzeile in den angegebenen Scanzeilen‑Index. |
...
Beginnen Sie mit der Arbeit an DjVu-Bildern, indem Sie eine neue Instanz der<br/>            [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) Klasse mit einem Stream-Parameter erstellen. Perfekt für<br/>            Entwickler, die eine nahtlose Integration der DjVu-Bildverarbeitung in<br/>            ihre Projekte wünschen.
...
Greifen Sie über diese Eigenschaft auf die einzelnen Seiten Ihrer DjVu-Bildsammlung zu.<br/>            Vereinfachen Sie die Navigation und Manipulation Ihres Dokuments oder Buches im DjVu-Format,<br/>            indem Sie jede Seite direkt aufrufen. Steigern Sie die Effizienz Ihres Arbeitsablaufs mit einfacher<br/>            Seitenermittlung.
...
Die Gammakorrektur, speziell für die Rot-, Grün- und Blaukanäle, beinhaltet die separate Anpassung <br/>            der Helligkeit jeder Farbkomponente. Durch Anwenden unterschiedlicher Gamma-<br/>            Koeffizienten auf die RGB-Kanäle können Sie die Gesamthelligkeit und den Kontrast <br/>            eines Bildes feinjustieren. Diese Technik gewährleistet eine genaue Farbdarstellung und verbessert die <br/>            visuelle Qualität des Bildes auf verschiedenen Anzeigegeräten.
...
Die Gammakorrektur wird auf ein Bild mit anpassbaren Parametern für die Rot-, Grün- <br/>            und Blaukanäle angewendet, wodurch eine präzise Einstellung von Farbbalance und Helligkeit möglich ist. Diese <br/>            Methode verbessert die Bildqualität durch Feinabstimmung der Farbdarstellung und sorgt für optimale <br/>            Darstellung auf verschiedenen Anzeigegeräten. Das Anpassen der Gamma-Werte einzelner <br/>            Kanäle verbessert die Farbbalance und die visuelle Attraktivität.
...
Binarisierung mit einem vordefinierten Schwellenwert vereinfacht komplexe Bilder zu binären<br/>            Darstellungen, wobei Pixel entweder als schwarz oder weiß klassifiziert werden, basierend auf ihrer <br/>            Intensität im Vergleich zu einem festgelegten Schwellenwert. Diese Technik wird häufig in <br/>            der Bildverarbeitung eingesetzt, um die Klarheit zu erhöhen, Analysen zu vereinfachen und Bilder für weitere <br/>            Verarbeitungsschritte wie die optische Zeichenerkennung (OCR) vorzubereiten. Durch die Anwendung eines festen <br/>            Schwellenwerts können Graustufenbilder schnell in binäre Form umgewandelt werden, wodurch sie <br/>            leichter zu interpretieren und bedeutungsvolle Informationen zu extrahieren sind.
...
"Crop" schneidet dein Bild zu, um spezifische Details hervorzuheben oder unerwünschte Elemente zu entfernen,<br/>            wodurch die Komposition und visuelle Wirkung verbessert wird. Egal, ob du Fotos für soziale<br/>            Medien anpasst, Website‑Banner erstellst oder Druckmaterialien gestaltest, dieses Werkzeug hilft dir<br/>            dabei, deine Bilder mit Präzision und Klarheit zu verfeinern.
...
Wende Filter auf einen angegebenen rechteckigen Bereich innerhalb des Bildes an, um dessen <br/>            Aussehen zu verbessern oder zu verändern. Durch das gezielte Ansteuern bestimmter Regionen ermöglicht diese Methode präzise Anpassungen, <br/>            wie das Weichzeichnen, Schärfen oder Anwenden künstlerischer Effekte, um gewünschte visuelle <br/>            Ergebnisse zu erzielen. Das Feinabstimmen von Filtern in ausgewählten Bereichen befähigt Benutzer, die Bildästhetik zu personalisieren, <br/>            die Klarheit zu verbessern und künstlerische Effekte nach ihren Vorlieben zu gestalten.
...
Lade dein DjVu‑Dokument mit dieser Methode. Beschleunige deinen Prozess, indem du schnell<br/>            auf deine DjVu‑Dateien zugreifst und sie in deine Anwendung importierst.
...
| Typ | Beschreibung |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | Geladenes Djvu‑Dokument |
...
| Typ | Beschreibung |
| :- | :- |
| [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | Geladenes Djvu‑Dokument |
...
Skaliere das Bild auf die angegebene Breite und Höhe, während bei Bedarf zusätzliche Einstellungen <br/>            angewendet werden. Diese Methode ermöglicht es Benutzern, die Bildabmessungen anzupassen, während <br/>            gewünschte Attribute wie Seitenverhältnis, Bildqualität und Kompressionseinstellungen beibehalten werden. Durch die Bereitstellung von Flexibilität bei den Skalierungsoptionen können Benutzer das Bild <br/>            an spezifische Anforderungen anpassen und sein Erscheinungsbild für verschiedene Anwendungen und <br/>            Plattformen optimieren.
...
Drehe das Bild um sein Zentrum mit der Rotate‑Methode der<br/>            RasterCachedMultipageImage‑Klasse. Diese praktische Funktion ermöglicht es dir, die Ausrichtung von Bildern einfach<br/>            anzupassen, während du ihre zentrale Position beibehältst,<br/>            und erweitert deine Bildbearbeitungsfähigkeiten.
...
Die `RotateFlip`‑Methode bietet vielseitige Manipulationsoptionen für dein Bild und ermöglicht<br/>            das Drehen, Spiegeln oder die Kombination beider Vorgänge auf dem aktiven Frame unabhängig voneinander.<br/>            Egal, ob du Fotos bearbeitest, Grafiken erstellst oder digitale Kunst verbesserst, diese<br/>            Methode liefert präzise Kontrolle über die Ausrichtung und Komposition deiner Bilder,<br/>            sodass sie deiner kreativen Vision mühelos und effizient entsprechen.
...
with open(join(dir_, "sample.djvu"), "rb") as stream:
	with DjvuImage(stream) as djvu_image:
		...
		for djvu_page in djvu_image.pages:
			# Erstelle einen Dateinamen basierend auf der Seitenzahl.
