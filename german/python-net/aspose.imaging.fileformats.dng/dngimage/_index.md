---
title: "DngImage Klasse"
type: docs
weight: 10
url: /de/python-net/aspose.imaging.fileformats.dng/dngimage/
---
...
| bits_per_pixel | int | r | Entdecken Sie die Anzahl der Bits pro Pixel im Bild mühelos mit dieser <br/>            Eigenschaft. Ideal, um die Pixeltiefe des Bildes schnell und genau zu verstehen. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Identifizieren Sie das Dateiformat Ihres Bildes mit dieser Eigenschaft. Perfekt für <br/>            das Verständnis des Formats – nur klare Details. |
...
| height | int | r | Rufen Sie die Höhe des Bildes mit dieser Eigenschaft ab. Perfekt, um die <br/>            vertikale Größe des Bildes ohne Aufwand zu bestimmen. |
...
| img_data | [RawData](/imaging/python-net/aspose.imaging.fileformats.dng.decoder/rawdata/) | r/w | Verwalten Sie die Bilddaten mit dieser Eigenschaft. Egal, ob Sie sie abrufen oder aktualisieren, <br/>            bietet diese Eigenschaft nahtlosen Zugriff auf die Bilddaten für effiziente <br/>            Manipulation. |
...
| width | int | r | Greifen Sie mit dieser Eigenschaft auf die Breite des Bildes zu. Ideal, um die <br/>            horizontale Größe des Bildes schnell und effizient zu erhalten. |
...
| [save(stream)](#save_stream_100) | Speichert die Daten. |
