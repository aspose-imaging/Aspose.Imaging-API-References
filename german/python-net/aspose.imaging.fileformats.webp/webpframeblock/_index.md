---
title: "WebPFrameBlock Klasse"
type: docs
weight: 20
url: /de/python-net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [WebPFrameBlock(raster_image)](#WebPFrameBlock_raster_image_1) | <br/><br/>                    Initialisiert eine neue Instanz von [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>Klasse.<br/> |
| [WebPFrameBlock(width, height)](#WebPFrameBlock_width_height_2) | Initialisiert eine neue Instanz der Klasse [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/). |
## **Properties**
...
| disposal_method | [AnimationDisposalMethods](/imaging/python-net/aspose.imaging/animationdisposalmethods/) | r/w | Ermittelt oder setzt die Entsorgungsmethode. |
| freigegeben | bool | r | Liest einen Wert, der angibt, ob diese Instanz freigegeben ist. |
| duration | int | r/w | Ermittelt oder setzt die Frame-Dauer. |
...
| frame_time | int | r | Liest die Frame-Dauer aus. |
| frame_top | int | r | Liest den oberen Frame-Offset aus. |
| [has_alpha](#has_alpha1) | bool | r | Gibt einen Wert zurück, der angibt, ob diese Instanz Alpha enthält. |
...
| links | int | r/w | Ermittelt oder setzt die linke Frame-Position. |
...
| oben | int | r/w | Ermittelt oder setzt die obere Frame-Position. |
...
| use_alpha_blending | bool | r/w | Ermittelt oder setzt den Wert, der angibt, ob der aktuelle Frame mit den Alpha-Werten des vorherigen Frames gemischt wird. |
...
<br/><br/>                    Initialisiert eine neue Instanz von [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>Klasse.<br/>
...
Initialisiert eine neue Instanz der Klasse [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/).
