---
title: "TiffImage Klasse"
type: docs
weight: 200
url: /de/python-net/aspose.imaging.fileformats.tiff/tiffimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [TiffImage(frame)](#TiffImage_frame_1) | Initialisiert ein neues Objekt der Klasse [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/), wobei der <br/>            Frame-Parameter angegeben wird. Dieser Konstruktor erleichtert die Erstellung einer TiffImage <br/>            Instanz und ermöglicht Entwicklern, den zu ladenden oder zu verarbeitenden Frame anzugeben, <br/>            wodurch Aufgaben der Tiff-Bildverarbeitung in ihren Anwendungen optimiert werden. |
| [TiffImage(frames)](#TiffImage_frames_2) | Erstellt eine neue Instanz der Klasse [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/), wobei eine Liste von <br/>            Frames als Parameter übergeben wird. Dieser Konstruktor ermöglicht die Initialisierung eines TiffImage <br/>            Objekts mit mehreren Frames und erleichtert die effiziente Handhabung und Verarbeitung von <br/>            TIFF-Bildsequenzen in Softwareanwendungen. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Ruft den Dateiformatwert ab, der dem Bild zugeordnet ist. Diese Eigenschaft dient als <br/>            ein kritischer Aspekt der Metadatenabfrage für Bilder und ermöglicht es Softwareanwendungen, <br/>            das Format der Bilddaten effizient zu erkennen und zu interpretieren. |
...
| [add_page(page)](#add_page_page_4) | Integriert nahtlos eine neue Seite in das bestehende Bild und erweitert dessen Inhalt <br/>            und Vielseitigkeit. Verwenden Sie diese Methode, um die Dokumentenkomposition und <br/>            -verwaltung zu verbessern, wodurch die effiziente Handhabung von mehrseitigen Bildern in Ihrer Anwendung ermöglicht wird. |
...
| [create_with_frame(frame)](#create_with_frame_frame_34) | Initialisiert eine neue Instanz der Klasse [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/). |
| [create_with_frames(frames)](#create_with_frames_frames_35) | Initialisiert eine neue Instanz der Klasse [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/). |
...
Bestimmen Sie, ob das Bild einen Alpha-Kanal besitzt, und liefern damit entscheidende Informationen <br/>            für Rendering- und Compositing‑Operationen. Integrieren Sie diese Funktion, um visuelle Verarbeitungs‑Workflows zu optimieren, und gewährleisten Sie eine genaue Darstellung sowie Manipulation transparenter Elemente.
...
Integriert nahtlos eine neue Seite in das bestehende Bild und erweitert dessen Inhalt <br/>            und Vielseitigkeit. Verwenden Sie diese Methode, um die Dokumentenkomposition und <br/>            -verwaltung zu verbessern, wodurch die effiziente Handhabung von mehrseitigen Bildern in Ihrer Anwendung ermöglicht wird.
...
Initialisiert eine neue Instanz der Klasse [TiffImage](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffimage/).
