---
title: "Os22XBitmapHeader Klasse"
type: docs
weight: 80
url: /de/python-net/aspose.imaging.fileformats.bmp/os22xbitmapheader/
---
...
| color_encoding | int | r | Liefert die Farbkodierung. |
...
| Bezeichner | int | r | Liefert den Bezeichner. |
| Aufnahme | int | r | Liefert die Aufnahme. |
| Rendering | int | r | Liefert das Rendering. |
| reserviert | int | r | Liefert das Reservierte. |
| size1 | int | r | Ruft die Größe1 ab. |
| size2 | int | r | Ruft die Größe2 ab. |
| Einheiten | int | r | Ruft die Einheiten ab. |
