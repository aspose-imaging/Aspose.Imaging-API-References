---
title: "TiffUnknownType Klasse"
type: docs
weight: 180
url: /de/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [TiffUnknownType(stream, tag_type, tag_id, count, offset_or_value)](#TiffUnknownType_stream_tag_type_tag_id_count_offset_or_value_1) | Initialisiert eine neue Instanz der [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/) Klasse. |
## **Properties**
...
| offset_or_value | int | r | Ruft den Offsetwert für zusätzliche Daten oder den Wert selbst ab, falls die Anzahl 1 ist. |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | r | Ruft den Stream ab, aus dem zusätzliche Daten gelesen werden. |
...
Initialisiert eine neue Instanz der [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/) Klasse.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | Der Stream, aus dem gelesen wird. |
| tag_type | int | Typ des Tags. |
| tag_id | int | Die Tag‑ID. |
| count | int | Der Zählwert. |
| offset_or_value | int | Der Offset oder Wert. |
