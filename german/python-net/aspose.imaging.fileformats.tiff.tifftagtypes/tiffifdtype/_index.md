---
title: "TiffIfdType Klasse"
type: docs
weight: 70
url: /de/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [TiffIfdType(tag_id)](#TiffIfdType_tag_id_1) | Initialisiert eine neue Instanz der [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) Klasse. |
| [TiffIfdType(tag_id)](#TiffIfdType_tag_id_2) | Initialisiert eine neue Instanz der [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) Klasse. |
## **Properties**
...
| values | int[] | r/w | Ermittelt oder setzt die Werte. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initialisiert eine neue Instanz der [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) Klasse. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initialisiert eine neue Instanz der [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) Klasse. |
...
Initialisiert eine neue Instanz der [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) Klasse.
