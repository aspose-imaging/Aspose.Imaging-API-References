---
title: "TiffUndefinedType Klasse"
type: docs
weight: 170
url: /de/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_1) | Initialisiert eine neue Instanz der [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) Klasse. |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_2) | Initialisiert eine neue Instanz der [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) Klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| count | int | r | Ermittelt die Anzahl der Elemente. |
| Daten | System.Byte | r/w | Liest oder setzt die Daten. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Initialisiert eine neue Instanz der [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) Klasse. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Initialisiert eine neue Instanz der [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) Klasse. |
...
Initialisiert eine neue Instanz der [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) Klasse.
