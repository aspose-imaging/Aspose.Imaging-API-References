---
title: "SvgImage Klasse"
type: docs
weight: 40
url: /de/python-net/aspose.imaging.fileformats.svg/svgimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [SvgImage(path)](#SvgImage_path_1) | Instanziiert ein neues Objekt der [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Klasse, wobei der <br/>            angegebene Pfad verwendet wird, um das Bild zu finden und zu laden. Dieser Konstruktor erleichtert die <br/>            Erstellung von SVG-Bildinstanzen aus externen Dateien und ermöglicht eine nahtlose <br/>            Integration in Softwaresysteme und Arbeitsabläufe. |
| [SvgImage(stream)](#SvgImage_stream_2) | Erstellt eine neue Instanz der [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Klasse, die das Bild <br/>            aus dem bereitgestellten Stream lädt. Dieser Konstruktor ermöglicht das direkte Laden von SVG <br/>            Bildern aus Streams, erhöht die Flexibilität und Effizienz beim Umgang mit Bild‑<br/>            Ressourcen in Softwareanwendungen. |
| [SvgImage(svg_options, width, height)](#SvgImage_svg_options_width_height_3) | Erstellt eine neue Instanz der [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Klasse mit angegebenen SVG <br/>            Optionen, Bildbreite und -höhe. Dieser Konstruktor ermöglicht <br/>            Entwicklern, SVG-Bilder mit benutzerdefinierten Optionen und Abmessungen zu initialisieren, <br/>            was Flexibilität bei der Verwaltung von SVG-Inhalten und Layout bietet. |
| [SvgImage(width, height)](#SvgImage_width_height_4) | Instanziiert ein neues [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Objekt mit der angegebenen Breite und <br/>            Höhe. Dieser Konstruktor ermöglicht Entwicklern, SVG-Bilder mit vordefinierten <br/>            Abmessungen zu erstellen, wodurch eine präzise Kontrolle über die Bildgröße während <br/>            der Initialisierung ermöglicht wird. |
## **Properties**
...
| bits_per_pixel | int | r | Ruft die Bits‑pro‑Pixel‑Anzahl des Bildes ab. Es ist wichtig zu beachten, dass <br/>            dieser Parameter nicht für Vektorbilder gilt, da sie nicht in <br/>            Pixeln gemessen werden. Diese Eigenschaft liefert wichtige Informationen über die Farbtiefe des Bildes, <br/>            was bei Verarbeitungs‑ und Manipulationsaufgaben hilft. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Ruft das Dateiformat des Bildes ab und liefert wesentliche Metadaten für <br/>            Verarbeitung und Kompatibilitätsprüfungen. Diese Eigenschaft ist entscheidend für <br/>            die Bestimmung geeigneter Dekodierungs‑ und Kodierungsstrategien, um Bilddaten effektiv über verschiedene Systeme und Anwendungen hinweg zu handhaben. |
...
| is_cached | bool | r | Ruft einen booleschen Wert ab, der angibt, ob die Daten des Objekts derzeit <br/>            zwischengespeichert sind, wodurch zusätzliche Lesevorgänge entfallen. Diese <br/>            Eigenschaft gibt Aufschluss über den aktuellen Cache‑Status und optimiert die Daten‑<br/>            abruf‑ und Verarbeitungsabläufe für verbesserte Leistung und Effizienz. |
...
| **Name** | **Beschreibung** |
| :- | :- |
| cache_data() | Cache die Daten und stelle sicher, dass keine weiteren Daten aus dem zugrunde liegenden [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) geladen werden. Diese <br/>            Optimierung verbessert die Leistung, indem redundante Datenabruf‑<br/>            Vorgänge eliminiert werden, insbesondere in Szenarien, die häufigen Zugriff auf die <br/>            Bilddaten erfordern. |
...
| [create_from_stream(stream)](#create_from_stream_stream_20) | Initialisiert eine neue Instanz der [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Klasse. |
...
| [load(file_path)](#load_file_path_34) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
| [load(file_path, load_options)](#load_file_path_load_options_35) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
| [load(stream)](#load_stream_36) | Lädt den SVG-Abschnitt. |
| [load(stream, load_options)](#load_stream_load_options_37) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_stream(stream)](#load_stream_stream_38) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_39) | Lädt ein neues Bild aus dem angegebenen Stream. |
...
| [remove_background(settings)](#remove_background_settings_41) | Entfernt den Hintergrund. |
| remove_metadata() | Entfernt Metadaten. |
| [resize(new_width, new_height)](#resize_new_width_new_height_42) | Skaliert das Bild. Der Standardwert [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_43) | Skaliere das Bild, um die angegebenen Abmessungen zu erfüllen, während das Seitenverhältnis <br/>            beibehalten wird. Diese Methode bietet eine bequeme Möglichkeit, die Größe des Bildes <br/>            anzupassen, ohne seine Proportionen zu verzerren, und sorgt für eine optimale Anzeige oder Speicherung <br/>            gemäß den gewünschten Abmessungen. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_44) | Skaliert das Bild mit erweiterten Optionen. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_45) | Skaliert das Bild. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_46) | Skaliert das Bild. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_47) | Skaliert die Höhe proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_48) | Skaliert die Höhe proportional. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_49) | Skaliert die Höhe proportional. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_50) | Skaliert die Höhe proportional. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_51) | Skaliert die Breite proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_52) | Skaliert die Breite proportional. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_53) | Skaliert die Breite proportional. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_54) | Skaliert die Breite proportional. |
| [rotate(angle)](#rotate_angle_55) | Bild um das Zentrum drehen. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_56) | Dreht, spiegelt oder dreht und spiegelt das Bild. |
| save() | Speichert die Bilddaten in den zugrunde liegenden Stream. |
| [save(file_path)](#save_file_path_57) | Speichert das Bild am angegebenen Dateipfad. |
| [save(file_path, options)](#save_file_path_options_58) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_59) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, over_write)](#save_file_path_over_write_60) | Speichert die Daten des Objekts am angegebenen Speicherort. |
| [save(stream)](#save_stream_61) | Speichert die Daten. |
| [save(stream, options_base)](#save_stream_options_base_62) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_63) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream(stream)](#save_to_stream_stream_64) | Speichert die Daten des Objekts in den angegebenen Stream. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_65) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_66) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | Wendet eine angegebene Palette auf das Bild an und ermöglicht die Anpassung von Farbschemata <br/>            für ästhetische oder funktionale Zwecke. Diese Methode bietet Flexibilität <br/>            bei der Verwaltung von Farbpaletten, um verschiedenen Design- oder Anwendungsanforderungen gerecht zu werden. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | Versucht, eine _metadata_-Instanz zu setzen, falls diese [Image](/imaging/python-net/aspose.imaging/image/)‑Instanz unterstützt und eine [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)‑Instanz implementiert. |
...
Instanziiert ein neues Objekt der [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Klasse, wobei der <br/>            angegebene Pfad verwendet wird, um das Bild zu finden und zu laden. Dieser Konstruktor erleichtert die <br/>            Erstellung von SVG-Bildinstanzen aus externen Dateien und ermöglicht eine nahtlose <br/>            Integration in Softwaresysteme und Arbeitsabläufe.
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| svg_options | [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/) | Die SVG-Optionen. |
...
Instanziiert ein neues [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Objekt mit der angegebenen Breite und <br/>            Höhe. Dieser Konstruktor ermöglicht Entwicklern, SVG-Bilder mit vordefinierten <br/>            Abmessungen zu erstellen, wodurch eine präzise Kontrolle über die Bildgröße während <br/>            der Initialisierung ermöglicht wird.
...
Initialisiert eine neue Instanz der [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) Klasse.
...
Skaliere das Bild, um die angegebenen Abmessungen zu erfüllen, während das Seitenverhältnis <br/>            beibehalten wird. Diese Methode bietet eine bequeme Möglichkeit, die Größe des Bildes <br/>            anzupassen, ohne seine Proportionen zu verzerren, und sorgt für eine optimale Anzeige oder Speicherung <br/>            gemäß den gewünschten Abmessungen.
...
Wendet eine angegebene Palette auf das Bild an und ermöglicht die Anpassung von Farbschemata <br/>            für ästhetische oder funktionale Zwecke. Diese Methode bietet Flexibilität <br/>            bei der Verwaltung von Farbpaletten, um verschiedenen Design- oder Anwendungsanforderungen gerecht zu werden.
