---
title: "EmfPlusClear Klasse"
type: docs
weight: 30
url: /de/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusclear/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [EmfPlusClear(source)](#EmfPlusClear_source_1) | Initialisiert eine neue Instanz der [EmfPlusClear](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusclear/) Klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| argb_32_color | int | r/w | Liest oder setzt die Farbe.<br/>            Ein EmfPlusARGB-Objekt (Abschnitt 2.2.2.1), das die zu malenden Bildschirmfarbe definiert. Alle Farben werden in [IEC-RGB] angegeben, sofern nicht anders angegeben. |
...
Initialisiert eine neue Instanz der [EmfPlusClear](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusclear/) Klasse.
