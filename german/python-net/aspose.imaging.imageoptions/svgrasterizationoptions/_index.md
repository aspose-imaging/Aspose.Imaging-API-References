---
title: "SvgRasterizationOptions Klasse"
type: docs
weight: 310
url: /de/python-net/aspose.imaging.imageoptions/svgrasterizationoptions/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [SvgRasterizationOptions()](#SvgRasterizationOptions__1) | Initialisiert eine neue Instanz der [SvgRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/svgrasterizationoptions/) Klasse. |
## **Properties**
...
| scale_x | float | r/w | Liest oder setzt die Skalierung x. |
| scale_y | float | r/w | Liest oder setzt die Skalierung y. |
...
| [copy_to(vector_rasterization_options)](#copy_to_vector_rasterization_options_2) | Kopiert diese Instanz zu _vectorRasterizationOptions_. |
...
Initialisiert eine neue Instanz der [SvgRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/svgrasterizationoptions/) Klasse.
...
Kopiert diese Instanz zu _vectorRasterizationOptions_.
