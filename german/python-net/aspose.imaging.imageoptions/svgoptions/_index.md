---
title: "SvgOptions Klasse"
type: docs
weight: 300
url: /de/python-net/aspose.imaging.imageoptions/svgoptions/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [SvgOptions()](#SvgOptions__1) | Initialisiert eine neue Instanz von [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/). |
## **Properties**
...
| callback | [ISvgResourceKeeperCallback](/imaging/python-net/aspose.imaging.fileformats.svg/isvgresourcekeepercallback/) | r/w | Liest oder schreibt die Speicherstrategie für eingebettete Ressourcen von [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), wie Schriftarten, verschachtelte Raster. |
| color_type | [SvgColorMode](/imaging/python-net/aspose.imaging.fileformats.svg/svgcolormode/) | r/w | Liest oder schreibt den Farbtyp für SVG-Bilder. |
| [compress](#compress1) | bool | r/w | Liest oder schreibt einen Wert, der angibt, ob das Ausgabebild komprimiert werden muss. |
...
| [text_as_shapes](#text_as_shapes2) | bool | r/w | Liest oder schreibt einen Wert, der angibt, ob Text als Formen gerendert werden muss. |
...
Initialisiert eine neue Instanz von [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/).

### Property: compress {#compress1}

Liest oder schreibt einen Wert, der angibt, ob das Ausgabebild komprimiert werden muss.
...
Liest oder schreibt einen Wert, der angibt, ob Text als Formen gerendert werden muss.
