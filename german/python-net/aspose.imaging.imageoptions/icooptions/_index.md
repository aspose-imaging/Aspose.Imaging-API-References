---
title: "IcoOptions Klasse"
type: docs
weight: 140
url: /de/python-net/aspose.imaging.imageoptions/icooptions/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [IcoOptions()](#IcoOptions__1) | Initialisiert eine neue Instanz der [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) Klasse mit dem ICO‑Frame‑Format gleich Png und<br/>            bitsPerPixel gleich 32. |
| [IcoOptions(format, bits_per_pixel)](#IcoOptions_format_bits_per_pixel_2) | Initialisiert eine neue Instanz der [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) Klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| bits_per_pixel | int | r/w | Liest oder setzt den Bits‑pro‑Pixel‑Wert. |
...
| format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r/w | Liest oder setzt das ICO‑Frame‑Format. |
...
Initialisiert eine neue Instanz der [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) Klasse mit dem ICO‑Frame‑Format gleich Png und<br/>            bitsPerPixel gleich 32.
...
Initialisiert eine neue Instanz der [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) Klasse.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | Das ICO‑Frame‑Format.<br/>            Hinweis: Das ICO‑Bild unterstützt nur [FileFormat.PNG](/imaging/python-net/aspose.imaging/fileformat/) und [FileFormat.BMP](/imaging/python-net/aspose.imaging/fileformat/) Bilder als Einträge. |
| bits_per_pixel | int | Der Bits‑pro‑Pixel‑Wert. |
