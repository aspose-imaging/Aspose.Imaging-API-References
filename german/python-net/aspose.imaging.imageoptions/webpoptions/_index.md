---
title: "WebPOptions Klasse"
type: docs
weight: 360
url: /de/python-net/aspose.imaging.imageoptions/webpoptions/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [WebPOptions()](#WebPOptions__1) | Initialisiert eine neue Instanz der [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/) Klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| anim_background_color | int | r/w | Liest oder schreibt die Farbe des Animationshintergrunds. |
| anim_loop_count | int | r/w | Liest oder schreibt die Anzahl der Animationsschleifen. |
...
| lossless | bool | r/w | Liest oder schreibt einen Wert, der angibt, ob diese [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/) verlustfrei ist. |
...
| quality | float | r/w | Liest oder schreibt die Qualität. |
...
Initialisiert eine neue Instanz der [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/) Klasse.
