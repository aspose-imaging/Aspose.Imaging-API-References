...
type: docs
weight: 7040
url: /de/python-net/aspose.imaging/rastercachedimage/
---
...
**Full Name:** aspose.imaging.RasterCachedImage

**Inheritance:** IObjectWithBounds, IMetadataContainer, IHasExifData, IHasMetadata, IHasXmpData, IRasterImageArgb32PixelLoader, IRasterImageRawDataLoader, RasterImage
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_30) | Bild mit Verschiebungen zuschneiden. |
| [crop(rectangle)](#crop_rectangle_31) | Zuschneiden des Bildes. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_32) | Führt Dithering auf dem aktuellen Bild aus. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_33) | Führt Dithering auf dem aktuellen Bild aus. |
| [embed_digital_signature(password)](#embed_digital_signature_password_34) | Digitales Siegel basierend auf dem bereitgestellten Passwort in das Bild einbetten mittels Steganographie. |
| [filter(rectangle, options)](#filter_rectangle_options_35) | Filtert das angegebene Rechteck. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_63) | Lädt 32‑Bit‑ARGB‑Pixel teilweise in Paketen. |
| [load_partial_argb_64_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_64) | Lädt 64‑Bit‑ARGB‑Pixel teilweise nach Paketen. |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_65) | Lädt Pixel teilweise nach Paketen. |
| [load_pixels(rectangle)](#load_pixels_rectangle_66) | Lädt Pixel. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_67) | Lädt Rohdaten. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_68) | Lädt Rohdaten. |
| [load_stream(stream)](#load_stream_stream_69) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_70) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_71) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_72) | Normalisiert den Winkel.<br/>            Diese Methode ist auf gescannte Textdokumente anwendbar, um die verzerrte Aufnahme zu korrigieren.<br/>            Diese Methode verwendet die Methoden [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) und [RasterImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| [read_argb_32_scan_line(scan_line_index)](#read_argb_32_scan_line_scan_line_index_73) | Liest die gesamte Scanzeile anhand des angegebenen Scanzeilen‑Index. |
| [read_scan_line(scan_line_index)](#read_scan_line_scan_line_index_74) | Liest die gesamte Scanzeile anhand des angegebenen Scanzeilen‑Index. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_75) | Ersetzt eine Farbe durch eine andere mit zulässiger Differenz und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_76) | Ersetzt eine Farbe durch eine andere mit zulässiger Differenz und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_77) | Ersetzt eine Farbe durch eine andere mit zulässiger Differenz und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten. |
...
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_79) | Ersetzt alle nicht-transparenten Farben durch eine neue Farbe und bewahrt den ursprünglichen Alphawert, um glatte Kanten zu erhalten.<br/>            Hinweis: Wenn Sie es bei Bildern ohne Transparenz verwenden, werden alle Farben durch eine einzige ersetzt. |
| [resize(new_width, new_height)](#resize_new_width_new_height_80) | Skaliert das Bild. Der Standardwert [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_81) | Skaliert das Bild. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_82) | Skaliert das Bild. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_83) | Skaliert das Bild. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_84) | Skaliert das Bild. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_85) | Skaliert die Höhe proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_86) | Skaliert die Höhe proportional. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_87) | Skaliert die Höhe proportional. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_88) | Skaliert die Höhe proportional. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_89) | Skaliert die Breite proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_90) | Skaliert die Breite proportional. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_91) | Skaliert die Breite proportional. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_92) | Skaliert die Breite proportional. |
| [rotate(angle)](#rotate_angle_93) | Bild um das Zentrum drehen. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_94) | Bild um das Zentrum drehen. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_95) | Dreht, spiegelt oder dreht und spiegelt das Bild. |
| save() | Speichert die Bilddaten in den zugrunde liegenden Stream. |
| [save(file_path)](#save_file_path_96) | Speichert das Bild am angegebenen Dateipfad. |
| [save(file_path, options)](#save_file_path_options_97) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_98) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, over_write)](#save_file_path_over_write_99) | Speichert die Daten des Objekts am angegebenen Speicherort. |
| [save(stream)](#save_stream_100) | Speichert die Daten des Objekts in den angegebenen Stream. |
| [save(stream, options_base)](#save_stream_options_base_101) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_102) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_103) | Speichert die 32‑Bit‑ARGB‑Pixel. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_104) | Speichert die Pixel. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_105) | Speichert die Pixel.<br/>            Diese Methode ist veraltet. Bitte verwenden Sie die effektivere [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) Methode. |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_106) | Speichert Pixel (formatspezifische Methode). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_107) | Speichert die Rohdaten. |
| [save_to_stream(stream)](#save_to_stream_stream_108) | Speichert die Daten des Objekts in den angegebenen Stream. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_109) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_110) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_111) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_112) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_113) | Setzt ein 32‑Bit‑ARGB‑Pixel des Bildes für die angegebene Position. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_114) | Setzt die Bildpalette. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_115) | Setzt ein Bildpixel für die angegebene Position. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_116) | Setzt die Auflösung für dieses [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_117) | Versucht, eine _metadata_-Instanz zu setzen, falls diese [Image](/imaging/python-net/aspose.imaging/image/)‑Instanz unterstützt und eine [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)‑Instanz implementiert. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_118) | Schreibt die gesamte Scanzeile in den angegebenen Scanzeilen‑Index. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_119) | Schreibt die gesamte Scanzeile in den angegebenen Scanzeilen‑Index. |
...
**[Example # 1](#example_74)**: The following example performs brightness correction of a raster cached image.
...
**[Example # 1](#example_75)**: The following example performs contrast correction of a raster cached image.
...
**[Example # 1](#example_72)**: The following example performs gamma-correction of a raster cached image.
...
**[Example # 1](#example_73)**: The following example performs gamma-correction of a raster cached image appl...
...
**[Example # 1](#example_64)**: The following example binarizes a raster cached image with Bradley's adaptive...
...
**[Example # 1](#example_65)**: The following example binarizes a raster cached image with Bradley's adaptive...
...
**[Example # 1](#example_70)**: The following example binarizes a raster cached image with the predefined thr...
...
**[Example # 1](#example_69)**: The following example crops a raster cached image. The cropping area is be sp...
...
| partial_pixel_loader | [IPartialArgb32PixelLoader](/imaging/python-net/aspose.imaging/ipartialargb32pixelloader/) | Der 32‑Bit‑ARGB‑Pixel‑Lader. |
...
**[Example # 1](#example_66)**: This example loads a raster cached image and resizes it using various resizin...
...
**[Example # 1](#example_76)**: This example loads a raster cached image and resizes it using various resizin...
...
**[Example # 1](#example_67)**: This example loads a raster cached image, rotates it by 90 degrees clockwise ...
...
## **Examples**
### The following example binarizes a raster cached image with Bradley's adaptive thresholding algorithm. Binarized images contain only 2 colors - black and white. {#example_64}
``` python
from aspose.pycore import as_of
from aspose.imaging import Image, RasterCachedImage
from os.path import join as join_path

directory = r"c:\temp"

with Image.load(join_path(directory, "sample.png")) as image:
	rasterImage = as_of(image, RasterCachedImage)
	# Binarisiert das Bild mit einem Helligkeitsunterschied von 5.
	# Die Helligkeit ist die Differenz zwischen einem Pixel und dem Durchschnitt eines s × s‑Fensters von Pixeln, das um diesen Pixel zentriert ist.
	# Die Größe des Fensters wird automatisch kalibriert.
	rasterImage.binarize_bradley(5.0)
	rasterImage.save(join_path(directory, "sample.BinarizeBradley5.png"))


```

### The following example binarizes a raster cached image with Bradley's adaptive thresholding algorithm with the specified window size. Binarized images contain only 2 colors - black and white. {#example_65}
``` python
from aspose.pycore import as_of
from aspose.imaging import Image, RasterCachedImage
from os.path import join as join_path
...
with Image.load(join_path(directory, "sample.png")) as image:
	rasterImage = as_of(image, RasterCachedImage)
	# Binarisiert das Bild mit einem Helligkeitsunterschied von 5.
	# Die Helligkeit ist die Differenz zwischen einem Pixel und dem Durchschnitt eines 10 × 10‑Fensters von Pixeln, das um diesen Pixel zentriert ist.
	rasterImage.binarize_bradley(5.0, 10)
	rasterImage.save(join_path(directory, "sample.BinarizeBradley5_10x10.png"))


```

### This example loads a raster cached image and resizes it using various resizing methods. {#example_66}
``` python
from aspose.pycore import as_of
from aspose.imaging import Image, RasterCachedImage, ResizeType
...
with Image.load(join_path(directory, "sample.png")) as image:
	raster_image = as_of(image, RasterCachedImage)
	# Vergrößert das Bild um das 2‑fache mittels Nearest‑Neighbour‑Neuberechnung.
	raster_image.resize(image.width * 2, image.height * 2, ResizeType.NEAREST_NEIGHBOUR_RESAMPLE)
	# Speichert als PNG mit Standardoptionen.
	raster_image.save(join_path(directory, "upsample.nearestneighbour.png"), PngOptions())
...
with Image.load(join_path(directory, "sample.png")) as image:
	...
	raster_image.resize(image.width // 2, image.height // 2, ResizeType.NEAREST_NEIGHBOUR_RESAMPLE)
	# Speichert als PNG mit Standardoptionen.
	raster_image.save(join_path(directory, "downsample.nearestneighbour.png"), PngOptions())

with Image.load(join_path(directory, "sample.png")) as image:
	raster_image = as_of(image, RasterCachedImage)
	# Vergrößert das Bild um das 2‑fache mittels bilinearer Neuberechnung.
	raster_image.resize(image.width * 2, image.height * 2, ResizeType.BILINEAR_RESAMPLE)
	# Speichert als PNG mit Standardoptionen.
	raster_image.save(join_path(directory, "upsample.bilinear.png"), PngOptions())
...
with Image.load(join_path(directory, "sample.png")) as image:
	...
	raster_image.resize(image.width // 2, image.height // 2, ResizeType.BILINEAR_RESAMPLE)
	# Speichert als PNG mit Standardoptionen.
	raster_image.save(join_path(directory, "downsample.bilinear.png"), PngOptions())


```

### This example loads a raster cached image, rotates it by 90 degrees clockwise and optionally flips the image horizontally and(or) vertically. {#example_67}
``` python
from aspose.imaging import RotateFlipType, RasterCachedImage, Image
from aspose.pycore import as_of
...
rotateFlipTypes = {
	RotateFlipType.ROTATE_90_FLIP_NONE,
	RotateFlipType.ROTATE_90_FLIP_X,
	RotateFlipType.ROTATE_90_FLIP_XY,
	RotateFlipType.ROTATE_90_FLIP_Y
}

for rotate_flip_type in rotateFlipTypes:
	# Drehen, spiegeln und in die Ausgabedatei speichern.
	with as_of(Image.load(join(directory, "sample.bmp")), RasterCachedImage) as image:
		image.rotate_flip(rotate_flip_type)
		image.save(join(directory, f"sample.{rotate_flip_type.name}.bmp"))


```

### The following example crops a raster cached image. The cropping area is be specified via aspose.imaging.Rectangle. {#example_69}
``` python
from aspose.imaging import Rectangle, RasterCachedImage, Image
from aspose.pycore import as_of
from os.path import join

directory = "c:\\temp\\"

with Image.load(join(directory, "sample.png")) as image:
	raster_image = as_of(image, RasterCachedImage)

	# Beschneiden Sie das Bild. Der Beschneidungsbereich ist der rechteckige zentrale Bereich des Bildes.
	area = Rectangle(raster_image.width // 4, raster_image.height // 4,
					 raster_image.width // 2, raster_image.height // 2)
	raster_image.crop(area)

	# Speichern Sie das beschnittene Bild als PNG
	raster_image.save(join(directory, "sample.Crop.png"))
	

```

### The following example binarizes a raster cached image with the predefined threshold. Binarized images contain only 2 colors - black and white. {#example_70}
``` python
...
with Image.load(join(directory, "sample.png")) as image:
	...
	raster_image.binarize_fixed(127)
	raster_image.save(join(directory, "sample.BinarizeFixed.png"))


```

### The following example transforms a colored raster cached image to its grayscale representation. Grayscale images are composed exclusively of shades of gray and carry only intensity information. {#example_71}
``` python
from aspose.imaging import RasterCachedImage, Image
from aspose.pycore import as_of
from os.path import join
...
with Image.load(join(directory, "sample.png")) as image:
	...
	raster_image.save(join(directory, "sample.Grayscale.png"))


```

### The following example performs gamma-correction of a raster cached image. {#example_72}
``` python
from aspose.imaging import RasterCachedImage, Image
from aspose.pycore import as_of
from os.path import join
...
with Image.load(join(directory, "sample.png")) as image:
	...
	raster_image.adjust_gamma(2.5)
	raster_image.save(join(directory, "sample.AdjustGamma.png"))
}

```

### The following example performs gamma-correction of a raster cached image applying different coefficients for color components. {#example_73}
``` python
from aspose.imaging import RasterCachedImage, Image
from aspose.pycore import as_of
from os.path import join
...
with Image.load(join(directory, "sample.png")) as image:
	...
	raster_image.adjust_gamma(1.5, 2.5, 3.5)
	raster_image.save(join(directory, "sample.AdjustGamma.png"))


```

### The following example performs brightness correction of a raster cached image. {#example_74}
``` python
from aspose.imaging import RasterCachedImage, Image
from aspose.pycore import as_of
from os.path import join
...
with Image.load(join(directory, "sample.png")) as image:
	...
	raster_image.adjust_brightness(50)
	raster_image.save(join(directory, "sample.AdjustBrightness.png"))


```

### The following example performs contrast correction of a raster cached image. {#example_75}
``` python
from aspose.imaging import RasterCachedImage, Image
from aspose.pycore import as_of
from os.path import join
...
with Image.load(join(directory, "sample.png")) as image:
	...
	raster_image.adjust_contrast(50)
	raster_image.save(join(directory, "sample.AdjustContrast.png"))


```

### This example loads a raster cached image and resizes it using various resizing settings. {#example_76}
``` python
from aspose.imaging import RasterCachedImage, Image, ImageResizeSettings, ResizeType, ImageFilterType,\
	ColorQuantizationMethod, ColorCompareMethod
from aspose.pycore import as_of
from os.path import join
...
with as_of(Image.load(join(directory, "sample.png")), RasterCachedImage) as image:
