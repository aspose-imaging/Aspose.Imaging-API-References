---
title: "OtgImage Klasse"
type: docs
weight: 500
url: /de/python-net/aspose.imaging.fileformats.opendocument/otgimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [OtgImage(stream_container)](#OtgImage_stream_container_1) | Erstellen Sie ein neues Objekt der [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) Klasse, indem Sie einen Stream <br/>            Container bereitstellen. Dieser Konstruktor ermöglicht Entwicklern, OTG-Bilder direkt aus <br/>            Stream-Containern zu erstellen und vereinfacht den Umgang mit OTG-Bilddaten. |
| [OtgImage(stream_container, load_options)](#OtgImage_stream_container_load_options_2) | Initialisieren Sie ein neues [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) Objekt, indem Sie einen Stream-Container <br/>            und Ladeoptionen bereitstellen. Dieser Konstruktor befähigt Entwickler, OTG-<br/>            Bilder effizient aus Streams zu laden, während benutzerdefinierte Ladekonfigurationen angegeben werden. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Diese Eigenschaft bietet Zugriff auf das OTG-Dateiformat und liefert wichtige Einblicke <br/>            in die Art der Daten, die in der Bilddatei gekapselt sind. Sie dient als zentraler <br/>            Referenzpunkt für Softwareentwickler, sodass sie OTG-Dateien in ihren Anwendungen effektiv handhaben können. Durch die Nutzung dieser Eigenschaft können Sie <br/>            das spezifische Format der Bilddatei ermitteln, was eine nahtlose <br/>            Integration und Manipulation von OTG-Dateien in ihren Softwaresystemen ermöglicht. |
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Gibt die Sammlung von Seiten zurück, die dem Bild zugeordnet sind, und ermöglicht Software-<br/>            Entwicklern, jede einzelne Seite effizient zuzugreifen und zu manipulieren. Diese <br/>            Eigenschaft erleichtert das nahtlose Durchlaufen der Seiten für verschiedene Vorgänge und <br/>            steigert die Funktionalität und Vielseitigkeit von Bildverarbeitungsanwendungen. |
...
Erstellen Sie ein neues Objekt der [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) Klasse, indem Sie einen Stream <br/>            Container bereitstellen. Dieser Konstruktor ermöglicht Entwicklern, OTG-Bilder direkt aus <br/>            Stream-Containern zu erstellen und vereinfacht den Umgang mit OTG-Bilddaten.
