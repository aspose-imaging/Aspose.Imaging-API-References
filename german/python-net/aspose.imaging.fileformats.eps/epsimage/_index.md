---
title: "EpsImage Klasse"
type: docs
weight: 10
url: /de/python-net/aspose.imaging.fileformats.eps/epsimage/
---
...
| bits_per_pixel | int | r | Greifen Sie mühelos auf die genaue Bit‑Tiefe des Bildes zu mit dieser Eigenschaft. Rufen Sie <br/>            die Bit‑pro‑Pixel‑Anzahl ab, die entscheidende Einblicke in die Farbtiefe des Bildes liefert <br/>            und bei der Optimierung von Verarbeitungsaufgaben hilft. Ideal für Anwendungen, die <br/>            eine feinkörnige Kontrolle über Bildmanipulation und Analyse erfordern. |
| bounding_box | [RectangleF](/imaging/python-net/aspose.imaging/rectanglef/) | r | Durch den Zugriff auf die ursprüngliche Begrenzungsbox in geräteunabhängigen Punkten liefert diese Eigenschaft <br/>            entscheidende geometrische Informationen über die Abmessungen des [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/). <br/>            Durch das Abrufen dieser Daten können Benutzer die Größe und das Seitenverhältnis des Bildes genau beurteilen, <br/>            was ein präzises Layout und eine genaue Positionierung in verschiedenen Anwendungen ermöglicht. |
| bounding_box_px | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Diese Eigenschaft gibt die ursprüngliche Begrenzungsbox der [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) <br/>            Instanz in Pixeln zurück und liefert wesentliche geometrische Daten für ein genaues Rendering und <br/>            die Manipulation. Mit diesen Informationen können Benutzer die präzise Platzierung und Größenbestimmung /// von EPS‑Bildern in ihren Projekten sicherstellen und so die gesamte visuelle Darstellung und Qualität verbessern. |
...
| creation_date | System.DateTime | r | Beim Abrufen des Erstellungsdatums aus den EPS Document Structuring Conventions (DSC) <br/>            Kommentaren liefert diese Eigenschaft wesentliche Metadaten, die den Beginn der EPS‑Datei anzeigen. Durch den Zugriff auf diese Informationen erhalten Benutzer Einblicke in die Herkunft und Chronologie der Datei, was das Dateimanagement und die Organisation verbessert. |
| creator | string | r | Diese Eigenschaft bietet Zugriff auf die Erstellerinformationen, die aus den EPS Document <br/> Structuring Conventions (DSC)-Kommentaren im EPS‑Datei stammen. Das Verstehen der <br/> Erstellerdetails liefert Einblicke in die Software oder das Werkzeug, das zum Erzeugen der <br/> EPS‑Datei verwendet wurde, und erleichtert die Bewertung der Kompatibilität über verschiedene Plattformen und <br/> Anwendungen. |
...
| eps_type | [EpsType](/imaging/python-net/aspose.imaging.fileformats.eps.consts/epstype/) | r | Greifen Sie auf den Subtypwert Ihres EPS‑Bildes zu und interpretieren Sie ihn, wodurch Ihr <br/> Arbeitsablauf optimiert und die Kompatibilität über Plattformen hinweg verbessert wird. Ideal zur präzisen und effizienten Optimierung der EPS‑Subtyp‑Abrufung in Ihren Projekten. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Liest oder setzt die Exif‑Instanz. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Greifen Sie mit dieser Eigenschaft auf das Dateiformat Ihres Bildes zu. Rufen Sie wesentliche <br/> Informationen über das Format Ihrer Bilddatei ab, um Kompatibilität und <br/> effiziente Verarbeitung zu ermöglichen. Ideal, um das Format Ihrer Bilddateien für eine nahtlose Integration in Ihre Projekte zu identifizieren. |
| has_background_color | bool | r/w | Liest oder setzt einen Wert, der angibt, ob das Bild eine Hintergrundfarbe hat. |
| has_raster_preview | bool | r | Entdecken Sie mühelos das Vorhandensein einer Rastervorschau mit dieser Eigenschaft. Greifen Sie auf den booleschen Wert zu, der angibt, ob die [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑Instanz eine <br/> Rastervorschau enthält, und stärken Sie Ihre Bildverarbeitungsaufgaben mit Klarheit und Effizienz. <br/> Ideal, um Workflow‑Entscheidungen basierend auf dem Vorhandensein oder Fehlen von <br/> Rastervorschauen in EPS‑Bildern zu optimieren. |
| height | int | r | Liest die Bildhöhe. |
| height_f | float | r | Greifen Sie mit dieser Eigenschaft auf die Höhe des Bildes zu. Ermitteln Sie die Bildhöhe <br/> mühelos, um nahtlose Layout‑Anpassungen, Seitenverhältnis‑Berechnungen und präzises <br/> Rendering über verschiedene Bildschirmauflösungen und Anzeigeumgebungen hinweg zu ermöglichen. |
...
| is_cached | bool | r | Diese Eigenschaft bietet eine bequeme Möglichkeit zu prüfen, ob die Daten des Objekts derzeit <br/> zwischengespeichert sind, wodurch zusätzliches Datenlesen entfällt. Sie bietet eine schnelle und <br/> effiziente Methode, um festzustellen, ob die benötigten Informationen sofort verfügbar sind, <br/> optimiert die Leistung und reduziert den Ressourcenaufwand bei datenintensiven Vorgängen. |
...
| post_script_version | string | r | Diese Eigenschaft ruft die PostScript‑Version ab, die mit der<br/> [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑Instanz verknüpft ist. Sie liefert Einblick in die spezifische PostScript-<br/> Sprachversion, die in der EPS‑Datei verwendet wird, unterstützt die Bewertung der Kompatibilität <br/> und erleichtert die nahtlose Integration in PostScript‑kompatible Umgebungen. |
| preview_image_count | int | r | Greifen Sie mühelos auf die Anzahl der verfügbaren Vorschaubilder zu. Diese Eigenschaft ermöglicht es Ihnen, <br/> die Anzahl der mit Ihrer Datei verknüpften Vorschaubilder mühelos abzurufen, <br/> um eine effiziente Verwaltung und Navigation Ihrer Bildvorschauen zu gewährleisten. Ideal, um <br/> Ihren Workflow zu optimieren und Ihre Bildressourcen effektiv zu organisieren. |
| preview_images | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Rufen Sie die mit Ihrer Datei verknüpften Vorschaubilder ab. Diese Eigenschaft bietet <br/> nahtlosen Zugriff auf die Sammlung von Vorschaubildern, sodass Sie sie bei Bedarf effizient <br/> durchsuchen und verwalten können. Ideal, um schnell eine Vorschau zu erhalten und das <br/> passende Bild für Ihr Projekt auszuwählen. |
...
| Titel | string | r | Diese Eigenschaft ruft den Titel ab, der aus den EPS Document Structuring <br/> Conventions (DSC)-Kommentaren extrahiert wurde, die in der EPS‑Datei eingebettet sind. Sie liefert wertvolle <br/> Metadaten über den Inhalt der EPS‑Datei, unterstützt die Dokumentenorganisation und <br/> die Identifizierung in kompatiblen Softwareanwendungen. |
| use_palette | bool | r | Liest einen Wert, der angibt, ob die Bildpalette verwendet wird. |
| width | int | r | Liest die Bildbreite. |
| width_f | float | r | Rufen Sie mit dieser praktischen Eigenschaft die Breite des Bildes ab. Ermitteln Sie die Bildbreite <br/> mühelos, um präzise Layout‑Berechnungen, Skalierungs‑Operationen und dimensionale Aufgaben in Ihrer Anwendung zu ermöglichen. Ideal, um ein genaues <br/> Rendering und die Anzeige von Bildern über verschiedene Plattformen und Geräte hinweg sicherzustellen. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Liest oder setzt XMP-Daten. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
| cache_data() | Diese Methode tut nichts, da die aktuelle Implementierung der<br/> [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑Klasse kein Caching von Daten beinhaltet. Obwohl sie keine Aktion ausführt, ist das Verständnis dieses Verhaltens für Entwickler, die mit EPS‑Bildern arbeiten, entscheidend, um eine effiziente Ressourcenverwaltung und optimale Leistung <br/> in ihren Anwendungen sicherzustellen. |
...
| [get_preview_image(format)](#get_preview_image_format_30) | Ruft das vorhandene Vorschaubild im angegebenen _format_ ab oder <br/> gibt **None** zurück, wenn keines gefunden wird. Diese Methode bietet Flexibilität beim <br/> Zugriff auf Vorschaubilder, die auf bestimmte Formate zugeschnitten sind, und optimiert die Kompatibilität sowie <br/> das Ressourcenmanagement in Anwendungen. |
| [get_preview_images()](#get_preview_images__31) | Greift auf die mit der [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/)‑Instanz verknüpften Vorschaubilder zu und ermöglicht <br/> ein nahtloses Abrufen zur Inspektion oder Nutzung in Anwendungen. Diese Methode <br/> bietet bequemen Zugriff auf Vorschaubilder und verbessert die Benutzerinteraktion mit den <br/> Bilddaten. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_32) | Liefert eine proportionale Höhe. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_33) | Liefert eine proportionale Breite. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_34) | Konvertiert zu aps. |
...
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_48) | Skaliert die Höhe proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_49) | Skaliert die Höhe proportional. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_50) | Skaliert die Höhe proportional. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_51) | Skaliert die Höhe proportional. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_52) | Skaliert die Breite proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_53) | Skaliert die Breite proportional. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_54) | Skaliert die Breite proportional. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_55) | Skaliert die Breite proportional. |
| [rotate(angle)](#rotate_angle_56) | Bild um das Zentrum drehen. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_57) | Dreht, spiegelt oder dreht und spiegelt das Bild. |
| save() | Speichert die Bilddaten in den zugrunde liegenden Stream. |
| [save(file_path)](#save_file_path_58) | Speichert das Bild am angegebenen Dateipfad. |
| [save(file_path, options)](#save_file_path_options_59) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_60) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, over_write)](#save_file_path_over_write_61) | Speichert die Daten des Objekts am angegebenen Speicherort. |
| [save(stream)](#save_stream_62) | Speichert die Daten. |
| [save(stream, options_base)](#save_stream_options_base_63) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_64) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream(stream)](#save_to_stream_stream_65) | Speichert die Daten des Objekts in den angegebenen Stream. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_66) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_67) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_68) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_69) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_70) | Passen Sie Bildpaletten an, um einzigartige Farbschemata zu erzielen und die visuelle Attraktivität zu steigern. <br/> Stimmen Sie Farben für spezifische Effekte ab und optimieren Sie die Bildqualität mühelos über verschiedene <br/> Plattformen und Geräte hinweg. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_71) | Versucht, eine _metadata_-Instanz zu setzen, falls diese [Image](/imaging/python-net/aspose.imaging/image/)‑Instanz unterstützt und eine [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)‑Instanz implementiert. |
...
Ruft das vorhandene Vorschaubild im angegebenen _format_ ab oder <br/> gibt **None** zurück, wenn keines gefunden wird. Diese Methode bietet Flexibilität beim <br/> Zugriff auf Vorschaubilder, die auf bestimmte Formate zugeschnitten sind, und optimiert die Kompatibilität sowie <br/> das Ressourcenmanagement in Anwendungen.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| format | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | Das EPS‑Vorschaubildformat. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | Das vorhandene Vorschaubild oder **None**. |
...
| Typ | Beschreibung |
| :- | :- |
| System.Collections.Generic.IEnumerable`1[[Aspose.Imaging.Image]] | Die Vorschaubilder. |
...
Passen Sie Bildpaletten an, um einzigartige Farbschemata zu erzielen und die visuelle Attraktivität zu steigern. <br/> Stimmen Sie Farben für spezifische Effekte ab und optimieren Sie die Bildqualität mühelos über verschiedene <br/> Plattformen und Geräte hinweg.
...
with aspycore.as_of(Image.load("Sample.eps"), EpsImage) as image:
	...
	# Rasterbild mit PostScript rendern
...
with Image.load("AstrixObelix.eps") as image:
	# Bild mit der Mitchell‑Kubik‑Interpolationsmethode skalieren
	image.resize(400, 400, ResizeType.MITCHELL)

	# Bild in PNG‑Format exportieren
...
#EPS‑Bild laden
with Image.load("AstrixObelix.eps") as image:
	# Bild mit erweiterten Skalierungseinstellungen skalieren
