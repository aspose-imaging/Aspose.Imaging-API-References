---
title: "RectangleMask Klasse"
type: docs
weight: 80
url: /de/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [RectangleMask(selected_area)](#RectangleMask_selected_area_1) | Initialisiert eine neue Instanz der [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) Klasse mit dem angegebenen Rechteck. |
| [RectangleMask(x, y, width, height)](#RectangleMask_x_y_width_height_2) | Initialisiert eine neue Instanz der [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) Klasse mit dem angegebenen linken oberen Punkt, Breite und Höhe. |
## **Properties**
...
Initialisiert eine neue Instanz der [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) Klasse mit dem angegebenen Rechteck.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| selected_area | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Ausgewählter Bereich als Rechteck angegeben. |
...
Initialisiert eine neue Instanz der [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) Klasse mit dem angegebenen linken oberen Punkt, Breite und Höhe.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| x | int | Die x-Koordinate des linken oberen Punktes des ausgewählten Bereichs. |
| y | int | Die y-Koordinate des linken oberen Punktes des ausgewählten Bereichs. |
| width | int | Breite des ausgewählten Bereichs. |
| height | int | Höhe des ausgewählten Bereichs. |
...
| Typ | Beschreibung |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Eine beschnittene RectangleMask als ImageMask. |
...
| Typ | Beschreibung |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Eine aufgeblähte RectangleMask als ImageMask. |
