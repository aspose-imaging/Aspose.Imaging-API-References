---
title: "BigTiffWriter Klasse"
type: docs
weight: 30
url: /de/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffwriter/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [BigTiffWriter(writer)](#BigTiffWriter_writer_1) | Initialisiert eine neue Instanz der [TiffStreamWriter](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamwriter/) Klasse. |
## **Properties**
...
| **Name** | **Beschreibung** |
| :- | :- |
| [write(data)](#write_data_1) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_2) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_3) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_4) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_5) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_6) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_7) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_8) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_9) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_10) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_11) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_12) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_13) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_14) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_15) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_16) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_17) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_18) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_19) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_20) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_21) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_22) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_23) | Schreibt den BigTiff-Offset. |
| [write(data)](#write_data_24) | Schreibt den BigTiff-Offset. |
...
Initialisiert eine neue Instanz der [TiffStreamWriter](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamwriter/) Klasse.
...
Schreibt den BigTiff-Offset.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| Daten | System.Byte | Die Stream-Position. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| Daten | float | Die Stream-Position. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| data | [TiffRational](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | Die Stream-Position. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| data | [TiffSRational](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffsrational/) | Die Stream-Position. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| Daten | System.SByte | Die Stream-Position. |
