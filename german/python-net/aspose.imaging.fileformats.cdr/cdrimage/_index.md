---
title: "CdrImage Klasse"
type: docs
weight: 190
url: /de/python-net/aspose.imaging.fileformats.cdr/cdrimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_1) | Beginnen Sie mühelos mit der [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) Klasse zu arbeiten, indem Sie<br/>            eine neue Instanz mit einem Stream und den loadOptions-Parametern initialisieren.<br/>            Ideal für Entwickler, die eine bequeme Möglichkeit suchen, CDR-Bilder aus<br/>            verschiedenen Datenquellen zu laden und den Ladevorgang bei Bedarf anzupassen. |
## **Properties**
...
| bits_per_pixel | int | r | Rufen Sie die Bit‑Tiefe des Bildes mühelos über diese benutzerfreundliche Eigenschaft ab.<br/>            Ideal für Entwickler, die das Detailniveau oder die Farbtiefe ihrer Bilder bestimmen möchten,<br/>            um eine genaue Verarbeitung und Manipulation sicherzustellen. |
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Rufen Sie das CDR-Dokument mühelos ab oder aktualisieren Sie es über diese intuitive Eigenschaft.<br/>            Ideal für Entwickler, die auf das CDR-Dokument zugreifen oder es ändern möchten, um<br/>            Flexibilität und Effizienz in ihren Anwendungen zu gewährleisten. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Rufen Sie die Standardseite des Bildes einfach über diese benutzerfreundliche Eigenschaft ab.<br/>            Perfekt für Entwickler, die schnellen Zugriff auf die Hauptseite ihres Bildes benötigen,<br/>            um eine effiziente Navigation und Verwaltung zu gewährleisten. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Ermitteln Sie das Dateiformat des Bildes mühelos über diese intuitive Eigenschaft.<br/>            Ideal für Entwickler, die das Format ihrer Bilder dynamisch bestimmen möchten,<br/>            um Kompatibilität und eine genaue Verarbeitung in ihren Anwendungen sicherzustellen. |
...
| is_cached | bool | r | Bestimmen Sie mühelos, ob die Daten des Objekts derzeit im Cache sind,<br/>            wodurch ein erneutes Lesen der Daten entfällt. Ideal für Entwickler, die<br/>            die Leistung optimieren möchten, indem sie zwischengespeicherte Daten effizient nutzen, um<br/>            einen schnelleren Zugriff auf Objektinformationen zu gewährleisten. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Gibt die Metadaten des Bildes zurück. |
| page_count | int | r | Rufen Sie die Gesamtseitenzahl des Bildes mühelos ab oder aktualisieren Sie sie über diese<br/>            intuitive Eigenschaft. Ideal für Entwickler, die mehrseitige Bilder<br/>            dynamisch verwalten möchten, um eine effiziente Navigation und Manipulation des Bildinhalts zu gewährleisten. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Rufen Sie die Seiten des Bildes nahtlos über diese intuitive Eigenschaft ab.<br/>            Ideal für Entwickler, die auf einzelne Seiten innerhalb<br/>            mehrseitiger Bilder zugreifen und diese manipulieren möchten, um eine effiziente Navigation und Verarbeitung zu gewährleisten. |
...
| **Name** | **Beschreibung** |
| :- | :- |
| cache_data() | Zwischenspeichern Sie die Daten mühelos, um zusätzliches Laden aus der zugrunde liegenden Quelle zu verhindern<br/>            mit dieser benutzerfreundlichen Methode. Ideal für Entwickler, die die Leistung optimieren möchten,<br/>            indem sie Daten vorab laden, um einen schnelleren Zugriff und einen reibungsloseren Betrieb in ihren Anwendungen zu gewährleisten.<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
Rufen Sie die Seiten des Bildes nahtlos über diese intuitive Eigenschaft ab.<br/>            Ideal für Entwickler, die auf einzelne Seiten innerhalb<br/>            mehrseitiger Bilder zugreifen und diese manipulieren möchten, um eine effiziente Navigation und Verarbeitung zu gewährleisten.
...
| update_colors | bool | Wenn auf <c>true</c> gesetzt, werden die Farben gemäß der neuen Palette aktualisiert; andernfalls bleiben Farb‑Indexes unverändert.<br/>            Hinweis: Unveränderte Indexe können das Bild beim Laden zum Absturz bringen, wenn einige Indexe keinen entsprechenden Paletteneintrag haben. |
