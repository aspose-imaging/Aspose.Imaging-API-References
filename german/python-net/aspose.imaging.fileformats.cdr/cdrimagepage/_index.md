---
title: "CdrImagePage Klasse"
type: docs
weight: 210
url: /de/python-net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Liest oder setzt das CDR-Dokument. |
...
| is_cached | bool | r | Liefert einen Wert, der angibt, ob die Daten des Objekts derzeit im Cache sind und kein erneutes Lesen der Daten erforderlich ist. |
...
| parent_image | [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) | r | Liefert das übergeordnete Bild. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_42) | Ändert die Größe auf die angegebene neue Breite. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_43) | Skaliert das Bild mit erweiterten Optionen. |
