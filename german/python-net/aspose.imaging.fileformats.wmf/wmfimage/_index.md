---
title: "WmfImage Klasse"
type: docs
weight: 350
url: /de/python-net/aspose.imaging.fileformats.wmf/wmfimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [WmfImage()](#WmfImage__1) | Erstelle eine neue Instanz der Klasse [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/), die für <br/>            weitere Manipulation und Verarbeitung von Windows Metafile (WMF)-Bilddaten initialisiert wird. Dieser <br/>            Konstruktor stellt ein grundlegendes Objekt für die Arbeit mit WMF‑Bildern bereit und ermöglicht <br/>            die nahtlose Integration von WMF‑Bildverarbeitungsfunktionen in die Funktionalität Ihrer Anwendung. |
| [WmfImage(width, height)](#WmfImage_width_height_2) | Instanziiere eine neue Instanz der Klasse [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) mit anpassbaren <br/>            Breiten‑ und Höhenparametern, um leere WMF‑Bilder zu erstellen, die auf bestimmte Abmessungen zugeschnitten sind. Nutzen Sie diesen Konstruktor, um WMF‑Bilder mit präzisen Abmessungen dynamisch zu erzeugen, was flexible Bildgenerierung und -manipulation in Ihrer Anwendung ermöglicht. |
## **Properties**
...
| bits_per_pixel | int | r | Rufe die Anzahl der Bits pro Pixel des Bildes ab, was den Grad der Farbtiefe oder Granularität angibt. <br/>            Nutzen Sie diese Eigenschaft, um die Farbdarstellung und Präzision des Bildes zu bestimmen, was Kompatibilitätsprüfungen und farbbezogene Verarbeitung in Ihrer Anwendung erleichtert. |
...
| frame_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Greife auf die Begrenzungen des Frames zu, die seine Position und Abmessungen innerhalb des Bildes anzeigen. <br/>            Nutzen Sie diese Eigenschaft, um detaillierte Informationen über den räumlichen Standort des Frames abzurufen, was präzise Manipulation und Rendering in Ihrer Anwendung ermöglicht. |
...
| height_f | float | r | Greife auf die Höhe des Bildes zu, die die Anzahl der Pixel entlang seiner vertikalen Achse darstellt. <br/>            Nutzen Sie diese Eigenschaft, um die räumlichen Abmessungen und das Seitenverhältnis des Bildes zu ermitteln, was genaue Layout‑ und Rendering‑Anpassungen in Ihrer Anwendung ermöglicht. |
| Zoll | int | r/w | Greife auf die Inch‑Eigenschaft zu oder ändere sie, die eine üblicherweise zur Angabe physischer Abmessungen im Druck‑ oder Anzeige‑Kontext verwendete Maßeinheit darstellt. <br/>            Nutzen Sie diese Eigenschaft, um Inch‑Werte, die mit dem Bild verknüpft sind, festzulegen oder abzurufen, was eine genaue Darstellung physischer Abmessungen in Ihrer Anwendung ermöglicht. |
...
| is_cached | bool | r | Rufe einen booleschen Wert ab, der angibt, ob die Daten des Objekts derzeit im Cache gespeichert sind, <br/>            wodurch zusätzliche Lesevorgänge entfallen. Nutzen Sie diese Eigenschaft, um die Leistung zu optimieren, indem Sie feststellen, ob die Daten des Objekts sofort verfügbar sind, ohne kostspielige Datenabrufprozesse in Ihrer Anwendung. |
...
| width_f | float | r | Greife auf die Breite des Bildes zu, die die Anzahl der Pixel entlang seiner horizontalen Achse angibt. <br/>            Nutzen Sie diese Eigenschaft, um die räumlichen Abmessungen und das Seitenverhältnis des Bildes zu bestimmen, was präzise Layout‑ und Rendering‑Anpassungen in Ihrer Anwendung ermöglicht. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Liest oder setzt XMP-Daten. |
## **Methods**
| **Name** | **Beschreibung** |
| :- | :- |
| [add_record(record)](#add_record_record_1) | Integriere das angegebene Record‑Objekt in das Bild und erweitere dessen Inhalt um zusätzliche Daten oder Metadaten. <br/>            Verwenden Sie diese Methode, um Record‑Objekte nahtlos in das Bild einzufügen, was eine umfassende Datenspeicherung und -organisation in Ihrer Anwendung ermöglicht. |
| cache_data() | Cache die Daten effizient, um das zusätzliche Laden aus dem zugrunde liegenden [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) zu vermeiden. <br/>            Nutzen Sie diese Methode, um die Leistung zu optimieren und den Ressourcenverbrauch in Ihrer Anwendung zu minimieren, indem Sie lokale Daten im Cache speichern und darauf zugreifen. |
...
| [can_load(stream, load_options)](#can_load_stream_load_options_5) | Bestimmt, ob das Bild vom angegebenen Stream geladen werden kann und optional die angegebenen _loadOptions_ verwendet. |
| [can_load_stream(stream)](#can_load_stream_stream_6) | Bestimmt, ob das Bild vom angegebenen Stream geladen werden kann. |
| [can_load_stream_with_options(stream, load_options)](#can_load_stream_with_options_stream_load_options_7) | Bestimmt, ob das Bild vom angegebenen Stream geladen werden kann und optional die angegebenen _loadOptions_ verwendet. |
| [can_load_with_options(file_path, load_options)](#can_load_with_options_file_path_load_options_8) | Bestimmt, ob das Bild vom angegebenen Dateipfad geladen werden kann und optional die angegebenen Öffnungsoptionen verwendet. |
| [can_save(options)](#can_save_options_9) | Bestimmt, ob das Bild im angegebenen Dateiformat, das durch die übergebenen Speicheroptionen repräsentiert wird, gespeichert werden kann. |
| [create(files)](#create_files_10) | Erstellt das mehrseitige Bild, das die angegebenen Dateien enthält. |
| [create(files, throw_exception_on_load_error)](#create_files_throw_exception_on_load_error_11) | Erstellt das mehrseitige Bild, das die angegebenen Dateien enthält. |
| [create(image_options, width, height)](#create_image_options_width_height_12) | Erstellt ein neues Bild mit den angegebenen Erstellungsoptionen. |
...
| [create(images)](#create_images_14) | Erstellt ein neues Bild, das die angegebenen Bilder als Seiten verwendet |
| [create(images, dispose_images)](#create_images_dispose_images_15) | Erstellt ein neues Bild, wobei die angegebenen Bilder als Seiten verwendet werden. |
| [create(multipage_create_options)](#create_multipage_create_options_16) | Erstellt die angegebenen Mehrseiten‑Erstellungsoptionen. |
| [create_from_files(files)](#create_from_files_files_17) | Erstellt das Mehrseiten‑Bild, das die angegebenen Dateien als Lazy‑Loading‑Seiten enthält. |
| [create_from_files(files, throw_exception_on_load_error)](#create_from_files_files_throw_exception_on_load_error_18) | Erstellt das Mehrseiten‑Bild, das die angegebenen Dateien als Lazy‑Loading‑Seiten enthält. |
| [create_from_images(images)](#create_from_images_images_19) | Erstellt ein neues Bild, das die angegebenen Bilder als Seiten verwendet |
| [create_from_images(images, dispose_images)](#create_from_images_images_dispose_images_20) | Erstellt ein neues Bild, wobei die angegebenen Bilder als Seiten verwendet werden. |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_21) | Bild mit Verschiebungen zuschneiden. |
| [crop(rectangle)](#crop_rectangle_22) | Schneidet das angegebene Rechteck zu. |
| [get_default_options(args)](#get_default_options_args_23) | Liefert die Standard-Bildeinstellungen. |
| [get_embedded_images()](#get_embedded_images__24) | Liefert die eingebetteten Bilder. |
| [get_file_format(file_path)](#get_file_format_file_path_25) | Liefert das Dateiformat. |
| [get_file_format(stream)](#get_file_format_stream_26) | Liefert das Dateiformat. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_27) | Liefert das Dateiformat. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_28) | Liefert das Rechteck, das zum aktuellen Bild passt. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_29) | Liefert das Rechteck, das zum aktuellen Bild passt. |
| [get_missed_fonts()](#get_missed_fonts__30) | Gibt die Liste der Schriftarten zurück, die innerhalb der Metadatei verwendet wurden, aber nicht gefunden wurden. |
| [get_original_options()](#get_original_options__31) | Ermittelt die ursprünglichen Bildoptionen. |
| [get_post_script()](#get_post_script__32) | Greifen Sie auf die mit dem Bild verbundenen PostScript-Daten zu und erhalten detaillierte <br/>            Informationen über deren Struktur oder Inhalt. Verwenden Sie diese Methode, um <br/>            PostScript-Daten für weitere Analysen oder Verarbeitungen in Ihrer Anwendung abzurufen, <br/>            wodurch erweiterte Funktionen im Zusammenhang mit PostScript‑Rendering oder -Manipulation ermöglicht werden. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_33) | Liefert eine proportionale Höhe. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_34) | Liefert eine proportionale Breite. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_35) | Konvertiert zu aps. |
| [get_used_fonts()](#get_used_fonts__36) | Rufen Sie die Liste der im Metafile verwendeten Schriftarten ab, um Einblick in die <br/>            im Bild genutzten Schriftressourcen zu erhalten. Nutzen Sie diese Methode, um die Schriftartverwendung zu analysieren <br/>            und die Verfügbarkeit von Schriftarten für das Rendering oder weitere Verarbeitungen in Ihrer Anwendung sicherzustellen. |
| [load(file_path)](#load_file_path_37) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
| [load(file_path, load_options)](#load_file_path_load_options_38) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
| [load(stream)](#load_stream_39) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load(stream, load_options)](#load_stream_load_options_40) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_stream(stream)](#load_stream_stream_41) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_42) | Lädt ein neues Bild aus dem angegebenen Stream. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_43) | Lädt ein neues Bild vom angegebenen Dateipfad oder URL.<br/>            Wenn _filePath_ ein Dateipfad ist, öffnet die Methode einfach die Datei.<br/>            Wenn _filePath_ eine URL ist, lädt die Methode die Datei herunter, speichert sie temporär und öffnet sie. |
| remove_background() | Entfernt den Hintergrund. |
| [remove_background(settings)](#remove_background_settings_44) | Entfernt den Hintergrund. |
| remove_metadata() | Entfernt Metadaten. |
| [resize(new_width, new_height)](#resize_new_width_new_height_45) | Skaliert das Bild. Der Standardwert [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_46) | Ändert die Größe auf die angegebene neue Breite. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_47) | Skaliert das Bild mit erweiterten Optionen. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_48) | Skaliert das Bild. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_49) | Skaliert das Bild. |
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_50) | Ändern Sie die Größe der Leinwand des Bildes, indem Sie seine Abmessungen anpassen und dabei den Bild <br/>            Inhalt beibehalten. Verwenden Sie diese Methode, um die Größe der Leinwand zu ändern, ohne den <br/>            Inhalt zu verändern, und erleichtern Sie Layout‑Anpassungen sowie Kompositionsänderungen in Ihrer <br/>            Anwendung. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_51) | Skaliert die Höhe proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_52) | Skaliert die Höhe proportional. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_53) | Skaliert die Höhe proportional. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_54) | Skaliert die Höhe proportional. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_55) | Skaliert die Breite proportional. Der Standard [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) wird verwendet. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_56) | Skaliert die Breite proportional. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_57) | Skaliert die Breite proportional. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_58) | Skaliert die Breite proportional. |
| [rotate(angle)](#rotate_angle_59) | Bild um das Zentrum drehen. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_60) | Dreht, spiegelt oder dreht und spiegelt das Bild. |
| save() | Speichert die Bilddaten in den zugrunde liegenden Stream. |
| [save(file_path)](#save_file_path_61) | Speichert das Bild am angegebenen Dateipfad. |
| [save(file_path, options)](#save_file_path_options_62) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_63) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(file_path, over_write)](#save_file_path_over_write_64) | Speichert die Daten des Objekts am angegebenen Speicherort. |
| [save(stream)](#save_stream_65) | Speichert die Daten in den angegebenen _stream_. |
| [save(stream, options_base)](#save_stream_options_base_66) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_67) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream(stream)](#save_to_stream_stream_68) | Speichert die Daten des Objekts in den angegebenen Stream. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_69) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_70) | Speichert die Bilddaten in den angegebenen Stream im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_71) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_72) | Speichert die Daten des Objekts am angegebenen Speicherort im angegebenen Dateiformat gemäß den Speicheroptionen. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_73) | Wenden Sie eine angegebene Palette auf das Bild an, um die Farbdarstellung <br/>            anzupassen. Nutzen Sie diese Methode, um das visuelle Rendering zu verbessern und <br/>            spezifische Farbeffekte in Ihrer Anwendung zu erzielen. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_74) | Versucht, eine _metadata_-Instanz zu setzen, falls diese [Image](/imaging/python-net/aspose.imaging/image/)‑Instanz unterstützt und eine [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/)‑Instanz implementiert. |
...
Instanziiere eine neue Instanz der Klasse [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) mit anpassbaren <br/>            Breiten‑ und Höhenparametern, um leere WMF‑Bilder zu erstellen, die auf bestimmte Abmessungen zugeschnitten sind. Nutzen Sie diesen Konstruktor, um WMF‑Bilder mit präzisen Abmessungen dynamisch zu erzeugen, was flexible Bildgenerierung und -manipulation in Ihrer Anwendung ermöglicht.
...
Integriere das angegebene Record‑Objekt in das Bild und erweitere dessen Inhalt um zusätzliche Daten oder Metadaten. <br/>            Verwenden Sie diese Methode, um Record‑Objekte nahtlos in das Bild einzufügen, was eine umfassende Datenspeicherung und -organisation in Ihrer Anwendung ermöglicht.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| record | [WmfObject](/imaging/python-net/aspose.imaging.fileformats.wmf.objects/wmfobject/) | Der Datensatz. |
...
Greifen Sie auf die mit dem Bild verbundenen PostScript-Daten zu und erhalten detaillierte <br/>            Informationen über deren Struktur oder Inhalt. Verwenden Sie diese Methode, um <br/>            PostScript-Daten für weitere Analysen oder Verarbeitungen in Ihrer Anwendung abzurufen, <br/>            wodurch erweiterte Funktionen im Zusammenhang mit PostScript‑Rendering oder -Manipulation ermöglicht werden.

**Returns**

| Typ | Beschreibung |
| :- | :- |
| string | Das PostScript |
...
Rufen Sie die Liste der im Metafile verwendeten Schriftarten ab, um Einblick in die <br/>            im Bild genutzten Schriftressourcen zu erhalten. Nutzen Sie diese Methode, um die Schriftartverwendung zu analysieren <br/>            und die Verfügbarkeit von Schriftarten für das Rendering oder weitere Verarbeitungen in Ihrer Anwendung sicherzustellen.
...
Wenden Sie eine angegebene Palette auf das Bild an, um die Farbdarstellung <br/>            anzupassen. Nutzen Sie diese Methode, um das visuelle Rendering zu verbessern und <br/>            spezifische Farbeffekte in Ihrer Anwendung zu erzielen.
