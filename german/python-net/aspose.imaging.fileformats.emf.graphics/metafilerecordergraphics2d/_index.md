---
title: "MetafileRecorderGraphics2D Klasse"
type: docs
weight: 20
url: /de/python-net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/
---
...
| [exclude_clip(rect)](#exclude_clip_rect_21) | Aktualisiert den Clip-Bereich dieses Graphics, um den durch eine Rectangle-Struktur angegebenen Bereich auszuschließen. |
| [exclude_clip(region)](#exclude_clip_region_22) | Aktualisiert den Clip-Bereich dieses Graphics, um den durch eine Region angegebenen Bereich auszuschließen. |
| [exclude_clip_rect(rect)](#exclude_clip_rect_rect_23) | Aktualisiert den Clip-Bereich dieses Graphics, um den durch eine Rectangle-Struktur angegebenen Bereich auszuschließen. |
| [exclude_clip_rgn(region)](#exclude_clip_rgn_region_24) | Aktualisiert den Clip-Bereich dieses Graphics, um den durch eine Region angegebenen Bereich auszuschließen. |
| [fill_ellipse(brush, rect)](#fill_ellipse_brush_rect_25) | Füllt die Ellipse. |
| [fill_path(pen, brush, path)](#fill_path_pen_brush_path_26) | Füllt den Pfad. |
| [fill_pie(brush, rect, start_angle, sweep_angle)](#fill_pie_brush_rect_start_angle_sweep_angle_27) | Füllt das Kuchenstück. |
| [fill_polygon(brush, points)](#fill_polygon_brush_points_28) | Füllt das Polygon. |
| [fill_polygon(brush, points, fill_mode)](#fill_polygon_brush_points_fill_mode_29) | Füllt das Polygon. |
| [fill_rectangle(brush, rectangle)](#fill_rectangle_brush_rectangle_30) | Füllt das Rechteck. |
| [get_transform()](#get_transform__31) | Erhält die Welt-Transformation. |
| [intersect_clip(rect)](#intersect_clip_rect_32) | Aktualisiert den Clip-Bereich dieses Graphics zur Schnittmenge des aktuellen Clip-Bereichs und der angegebenen Rectangle-Struktur. |
| [intersect_clip(region)](#intersect_clip_region_33) | Aktualisiert den Clip-Bereich dieses Graphics zur Schnittmenge des aktuellen Clip-Bereichs und der angegebenen Region. |
| [intersect_clip_rect_f(rect)](#intersect_clip_rect_f_rect_34) | Aktualisiert den Clip-Bereich dieses Graphics zur Schnittmenge des aktuellen Clip-Bereichs und der angegebenen Rectangle-Struktur. |
| [intersect_clip_rgn(region)](#intersect_clip_rgn_region_35) | Aktualisiert den Clip-Bereich dieses Graphics zur Schnittmenge des aktuellen Clip-Bereichs und der angegebenen Region. |
| [multiply_transform(matrix)](#multiply_transform_matrix_36) | Multipliziert die Welt-Transformation dieses Graphics mit der angegebenen Matrix. |
| [multiply_transform(matrix, order)](#multiply_transform_matrix_order_37) | Multipliziert die Welt-Transformation dieses Graphics mit der angegebenen Matrix in der angegebenen Reihenfolge. |
| reset_clip() | Setzt den Clip zurück. |
| [rotate_transform(angle)](#rotate_transform_angle_38) | Wendet die angegebene Drehung auf die Transformationsmatrix dieses Graphics an. |
| [rotate_transform(angle, center, order)](#rotate_transform_angle_center_order_39) | Wendet die angegebene Drehung in der angegebenen Reihenfolge auf die Transformationsmatrix dieses Graphics an. |
| [scale_transform(sx, sy)](#scale_transform_sx_sy_40) | Wendet die angegebene Skalierungsoperation auf die Transformationsmatrix dieses Graphics an, indem sie dieser Transformationsmatrix vorangestellt wird. |
| [scale_transform(sx, sy, order)](#scale_transform_sx_sy_order_41) | Wendet die angegebene Skalierungsoperation in der angegebenen Reihenfolge auf die Transformationsmatrix dieses Graphics an. |
| [set_transform(transform)](#set_transform_transform_42) | Setzt die Transformation. |
| [translate_transform(x, y)](#translate_transform_x_y_43) | Ändert den Ursprung des Koordinatensystems, indem die angegebene Verschiebung der Transformationsmatrix dieses Graphics vorangestellt wird. |
| [translate_transform(x, y, order)](#translate_transform_x_y_order_44) | Ändert den Ursprung des Koordinatensystems, indem die angegebene Verschiebung in der angegebenen Reihenfolge auf die Transformationsmatrix dieses Graphics angewendet wird. |
