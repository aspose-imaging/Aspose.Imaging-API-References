---
title: "WmfRecorderGraphics2D Klasse"
type: docs
weight: 10
url: /de/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | Initialisiert eine neue Instanz der [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) Klasse. |
## **Properties**
| **Name** | **Type** | **Access** | **Beschreibung** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Liest oder legt die Hintergrundfarbe fest. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | Liest oder legt den Hintergrundmodus fest. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | Erhält eine Instanz des Wmf-Recorders für das vorhandene Wmf-Image. |
...
Initialisiert eine neue Instanz der [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) Klasse.

**Parameters:**

| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Zielrechteck, gemessen in Twips, zum Anzeigen der Metadatei. |
...
| Typ | Beschreibung |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Das Ergebnisbild. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Das WMF-Bild, für das ein Rekorder erhalten werden soll. |

**Returns**

| Typ | Beschreibung |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | Eine Instanz der Klasse [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
