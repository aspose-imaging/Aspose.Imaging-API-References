---
title: "AvifImage Klasse"
type: docs
weight: 10
url: /de/python-net/aspose.imaging.fileformats.avif/avifimage/
---
...
| **Name** | **Beschreibung** |
| :- | :- |
| [AvifImage()](#AvifImage__1) | Initialisiert eine neue Instanz der AvifImage‑Klasse |
## **Properties**
...
| bits_per_pixel | int | r | Ruft den Bits‑pro‑Pixel‑Wert ab. |
...
| height | int | r | Ruft die Höhe des AVIF‑Bildes ab. |
...
| width | int | r | Ruft die Breite des AVIF‑Bildes ab. |
...
Initialisiert eine neue Instanz der AvifImage‑Klasse
