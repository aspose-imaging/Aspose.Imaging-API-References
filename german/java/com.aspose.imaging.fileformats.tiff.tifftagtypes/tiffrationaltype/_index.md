...
type: docs
weight: 19
url: /de/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/
---
**Inheritance:**
...
| --- | --- |
| [TiffRationalType(int tagId)](#TiffRationalType-int-) | Initialisiert eine neue Instanz der `TiffRationalType`-Klasse. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getValues()](#getValues--) | Liest oder setzt die Werte. |
| [setValues(TiffRational[] value)](#setValues-com.aspose.imaging.fileformats.tiff.TiffRational---) | Liest oder setzt die Werte. |
...
Initialisiert eine neue Instanz der `TiffRationalType`-Klasse.
