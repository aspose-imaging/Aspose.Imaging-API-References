...
description: "Stellt die TIFF Exif Image File Directory‑Typklasse dar."
type: docs
weight: 16
url: /de/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/
---
**Inheritance:**
...
Stellt die TIFF Exif Image File Directory‑Typklasse dar.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [TiffIfdType(int tagId)](#TiffIfdType-int-) | Initialisiert eine neue Instanz der `TiffIfdType`-Klasse. |
## Methoden
...
Initialisiert eine neue Instanz der `TiffIfdType`-Klasse.
