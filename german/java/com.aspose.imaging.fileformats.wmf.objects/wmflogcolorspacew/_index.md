...
description: "Das LogColorSpaceW-Objekt gibt einen logischen Farbraum an, der durch eine Farbprofildatei definiert werden kann, deren Name aus Unicode‑16‑Bit‑Zeichen besteht."
type: docs
weight: 45
url: /de/java/com.aspose.imaging.fileformats.wmf.objects/wmflogcolorspacew/
---
**Inheritance:**
...
Das LogColorSpaceW-Objekt gibt einen logischen Farbraum an, der durch eine Farbprofildatei definiert werden kann, deren Name aus Unicode‑16‑Bit‑Zeichen besteht.

Siehe das `WmfLogColorSpace`-Objekt (Abschnitt 2.2.2.11) für weitere Details zur Interpretation der Feldwerte dieses Objekts.
## Konstruktoren
...
| [getFilename()](#getFilename--) | Liest oder schreibt eine optionale, nullterminierte Unicode‑UTF16‑LE‑Zeichenkette, die den Namen einer Datei angibt, die ein Farbprofil enthält. |
| [setFilename(String value)](#setFilename-java.lang.String-) | Liest oder schreibt eine optionale, nullterminierte Unicode‑UTF16‑LE‑Zeichenkette, die den Namen einer Datei angibt, die ein Farbprofil enthält. |
### WmfLogColorSpaceW() {#WmfLogColorSpaceW--}
```
...
Liest oder schreibt eine optionale, nullterminierte Unicode‑UTF16‑LE‑Zeichenkette, die den Namen einer Datei angibt, die ein Farbprofil enthält. Wenn ein Dateiname angegeben ist und das Feld `ColorSpaceType` auf LCS\_CALIBRATED\_RGB gesetzt ist, SOLLTEN die anderen Felder dieser Struktur ignoriert werden.
