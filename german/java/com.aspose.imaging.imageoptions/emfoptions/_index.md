...
type: docs
weight: 19
url: /de/java/com.aspose.imaging.imageoptions/emfoptions/
---
**Inheritance:**
...
| [EmfOptions(float dpiX, float dpiY)](#EmfOptions-float-float-) | Initialisiert eine neue Instanz der `EmfOptions` Klasse. |
| [EmfOptions(float dpi)](#EmfOptions-float-) |  |
| [EmfOptions(EmfOptions emfOptions)](#EmfOptions-com.aspose.imaging.imageoptions.EmfOptions-) | Initialisiert eine neue Instanz der `EmfOptions` Klasse. |
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Exportieren Sie nur die ersten beiden Seiten. Tatsächlich wird nur eine Seite konvertiert, weil EMF kein mehrseitiges Format ist.
...
Initialisiert eine neue Instanz der `EmfOptions` Klasse.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| emfOptions | [EmfOptions](../../com.aspose.imaging.imageoptions/emfoptions) | Die EMF‑Optionen. |
