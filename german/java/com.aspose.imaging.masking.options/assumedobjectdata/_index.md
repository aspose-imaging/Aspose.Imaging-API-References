...
description: "Die angenommenen Objektdaten."
type: docs
weight: 10
url: /de/java/com.aspose.imaging.masking.options/assumedobjectdata/
---
**Inheritance:**
java.lang.Object
```
...
Die Daten des angenommenen Objekts. Enthält den Objekttyp und die Fläche.
## Konstruktoren

| Konstruktor | Beschreibung |
| --- | --- |
| [AssumedObjectData()](#AssumedObjectData--) | Initialisiert eine neue Instanz der Klasse [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata). |
| [AssumedObjectData(int type, Rectangle bounds)](#AssumedObjectData-int-com.aspose.imaging.Rectangle-) | Initialisiert eine neue Instanz der Klasse [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata). |
| [AssumedObjectData(String type, Rectangle bounds)](#AssumedObjectData-java.lang.String-com.aspose.imaging.Rectangle-) | Initialisiert eine neue Instanz der Klasse [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata). |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getType()](#getType--) | Ruft den Objekttyp ab. |
| [setType(int value)](#setType-int-) | Legt den Objekttyp fest. |
| [getBounds()](#getBounds--) | Ruft die Begrenzungen des Objekts ab. |
| [setBounds(Rectangle value)](#setBounds-com.aspose.imaging.Rectangle-) | Legt die Begrenzungen des Objekts fest. |
...
Initialisiert eine neue Instanz der Klasse [AssumedObjectData](../../com.aspose.imaging.masking.options/assumedobjectdata).
...
| --- | --- | --- |
| Typ | int | Der Objekttyp. |
| bounds | [Rectangle](../../com.aspose.imaging/rectangle) | Die Begrenzungen des Objekts. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Typ | java.lang.String | Der Objekttyp. |
| bounds | [Rectangle](../../com.aspose.imaging/rectangle) | Die Begrenzungen des Objekts. |
...
Legt den Objekttyp fest.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int | der Objekttyp. |
...
Legt die Begrenzungen des Objekts fest.

**Parameters:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | [Rectangle](../../com.aspose.imaging/rectangle) | die Begrenzungen des Objekts. |
