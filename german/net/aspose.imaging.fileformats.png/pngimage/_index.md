...
description: Das neue PNG-Bild.
type: docs
weight: 7450
url: /de/net/aspose.imaging.fileformats.png/pngimage/
---
## PngImage class
...
| Name | Beschreibung |
| --- | --- |
| [PngImage](pngimage#constructor_1)(RasterImage) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
| [PngImage](pngimage#constructor_5)(Stream) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
| [PngImage](pngimage#constructor_6)(string) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
| [PngImage](pngimage#constructor_3)(int, int) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
| [PngImage](pngimage#constructor_2)(RasterImage, PngColorType) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
| [PngImage](pngimage#constructor_7)(string, PngColorType) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
| [PngImage](pngimage#constructor_4)(int, int, PngColorType) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
| [PngImage](pngimage#constructor)(PngOptions, int, int) | Initialisiert eine neue Instanz von[`PngImage`](../pngimage) Klasse. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.png/pngimage/backgroundcolor) { get; set; } | Ruft die Hintergrundfarbe ab. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.png/pngimage/bitsperpixel) { get; } | Ruft die Bits pro Pixel ab. |
...
| override [FileFormat](../../aspose.imaging.fileformats.png/pngimage/fileformat) { get; } | Ruft einen Wert von Dateiformat ab |
| override [HasAlpha](../../aspose.imaging.fileformats.png/pngimage/hasalpha) { get; } | Ruft einen Wert ab, der angibt, ob diese Instanz alpha hat. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.png/pngimage/hasbackgroundcolor) { get; set; } | Ruft einen Wert ab, der angibt, ob eine Hintergrundfarbe vorhanden ist. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.png/pngimage/hastransparentcolor) { get; set; } | Ruft einen Wert ab, der angibt, ob das Bild eine transparente Farbe hat. |
| override [Height](../../aspose.imaging.fileformats.png/pngimage/height) { get; } | Ruft die Höhe ab. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.png/pngimage/horizontalresolution) { get; set; } | Ruft die horizontale Auflösung ab oder legt sie fest. |
| virtual [ImageOpacity](../../aspose.imaging/rasterimage/imageopacity) { get; } | Ruft die Deckkraft dieses Bildes ab. |
| [Interlaced](../../aspose.imaging.fileformats.png/pngimage/interlaced) { get; } | Ruft einen Wert ab, der angibt, ob dies[`PngImage`](../pngimage) ist interlaced. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.png/pngimage/isinterlaced) { get; } | Ruft einen Wert ab, der angibt, ob diese Bildinstanz interlaced ist. |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.png/pngimage/rawdataformat) { get; } | Ruft das Rohdatenformat ab. |
...
| override [TransparentColor](../../aspose.imaging.fileformats.png/pngimage/transparentcolor) { get; set; } | Ruft die transparente Farbe ab. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.png/pngimage/verticalresolution) { get; set; } | Ruft die vertikale Auflösung ab oder legt sie fest. |
| override [Width](../../aspose.imaging.fileformats.png/pngimage/width) { get; } | Ruft die Breite ab. |
| override [XmpData](../../aspose.imaging.fileformats.png/pngimage/xmpdata) { get; set; } | Ruft die XMP-Metadaten ab oder legt sie fest. |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.png/pngimage/getdefaultoptions)(object[]) | Ruft die Standardoptionen ab. |
...
| override [GetModifyDate](../../aspose.imaging.fileformats.png/pngimage/getmodifydate)(bool) | Ruft das Datum und die Uhrzeit ab, zu der das Ressourcenbild zuletzt geändert wurde. |
| override [GetOriginalOptions](../../aspose.imaging.fileformats.png/pngimage/getoriginaloptions)() | Ruft die Optionen basierend auf den ursprünglichen Dateieinstellungen ab. Dies kann hilfreich sein, um die Bittiefe und andere Parameter des Originalbildes unverändert zu lassen. Zum Beispiel, wenn wir ein schwarz-weißes PNG-Bild mit 1 Bit pro Pixel laden und dann Speichern Sie es mit the [`Save`](../../aspose.imaging/datastreamsupporter/save) -Methode wird das ausgegebene PNG-Bild mit 8 Bit pro Pixel erzeugt. Um dies zu vermeiden und das PNG-Bild mit 1 Bit pro Pixel zu speichern, verwenden Sie diese Methode, um entsprechende Speicheroptionen zu erhalten, und übergeben Sie sie an die[`Save`](../../aspose.imaging/image/save) Methode als zweiten Parameter. |
