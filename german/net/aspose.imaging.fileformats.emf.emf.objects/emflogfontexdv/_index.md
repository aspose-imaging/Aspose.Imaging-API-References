...
description: Das LogFontExDv-Objekt gibt den Designvektor für eine erweiterte logische Schriftart an.
type: docs
weight: 3050
url: /de/net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
## EmfLogFontExDv class

Das LogFontExDv-Objekt gibt den Designvektor für eine erweiterte logische Schriftart an.
...
| Name | Beschreibung |
| --- | --- |
| [EmfLogFontExDv](emflogfontexdv)(EmfLogFontEx) | Initialisiert eine neue Instanz von[`EmfLogFontExDv`](../emflogfontexdv) Klasse. |
...
| [DesignVector](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/designvector) { get; set; } | Holt oder setzt ein DesignVector-Objekt (Abschnitt 2.2.3). Dieses Feld DARF NICHT länger als 72 Bytes sein. |
