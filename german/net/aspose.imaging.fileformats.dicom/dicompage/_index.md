...
description: Es ist Klasse für die Arbeit mit DICOM-Dateien des Typs Multiframe
type: docs
weight: 2430
url: /de/net/aspose.imaging.fileformats.dicom/dicompage/
---
## DicomPage class

Es ist Klasse für die Arbeit mit DICOM-Dateien des Typs Multiframe
...
| Name | Beschreibung |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | Initialisiert eine neue Instanz von[`DicomPage`](../dicompage) Klasse. |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | Initialisiert eine neue Instanz von[`DicomPage`](../dicompage) Klasse. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel) { get; } | Ruft die Anzahl der Bildbits pro Pixel ab. |
...
| override [FileFormat](../../aspose.imaging.fileformats.dicom/dicompage/fileformat) { get; } | Ruft einen Wert von Dateiformat ab |
...
| override [Height](../../aspose.imaging.fileformats.dicom/dicompage/height) { get; } | Ruft die Bildhöhe ab. |
...
| [Index](../../aspose.imaging.fileformats.dicom/dicompage/index) { get; } | Ruft den Index der aktuellen Seite ab. |
...
| override [Width](../../aspose.imaging.fileformats.dicom/dicompage/width) { get; } | Ruft die Bildbreite ab. |
