...
description: Fügt den Rahmen zu image hinzu
type: docs
weight: 140
url: /de/net/aspose.imaging.fileformats.tiff/tiffimage/addframe/
---
## TiffImage.AddFrame method

Fügt den Rahmen zu image hinzu
...
| --- | --- | --- |
| frame | TiffFrame | Der hinzuzufügende Rahmen. |
