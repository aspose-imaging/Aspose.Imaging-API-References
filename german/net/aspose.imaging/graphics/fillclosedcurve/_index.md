...
description: Füllt das Innere einer geschlossenen kardinalen Spline-Kurve die durch ein Array von definiert istPointFaspose.imaging/pointf Strukturen. Diese Methode verwendet eine Standardspannung von 05 undAlternate Füllmodus.
type: docs
weight: 340
url: /de/net/aspose.imaging/graphics/fillclosedcurve/
---
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| brush | Brush | EIN[`Brush`](../../brush) die die Eigenschaften der Füllung bestimmt. |
| points | PointF[] | Anordnung von[`PointF`](../../pointf) Strukturen, die den Spline definieren. |
| fillmode | FillMode | Mitglied von[`FillMode`](../../fillmode) Enumeration, die bestimmt, wie die Kurve gefüllt wird. |
