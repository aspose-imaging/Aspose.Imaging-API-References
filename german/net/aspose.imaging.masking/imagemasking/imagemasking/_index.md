...
description: Initialisiert eine neue Instanz vonImageMaskingaspose.imaging.masking/imagemasking Klasse.
type: docs
weight: 10
url: /de/net/aspose.imaging.masking/imagemasking/imagemasking/
---
## ImageMasking constructor

Initialisiert eine neue Instanz von[`ImageMasking`](../../imagemasking) Klasse.
...
| --- | --- | --- |
| sourceImage | RasterImage | Das Quellbild. |

### Ausnahmen

| Ausnahme | Bedingung |
| --- | --- |
| ArgumentNullException | Quellbild ist null. |
