...
description: Erstellt die Maskierungssitzung die Retraining-Zerlegungsvorgänge ausführen kann.
type: docs
weight: 20
url: /de/net/aspose.imaging.masking/imagemasking/createsession/
---
## ImageMasking.CreateSession method

Erstellt die Maskierungssitzung, die Retraining-Zerlegungsvorgänge ausführen kann.
...
| --- | --- | --- |
| options | MaskingOptions | Die Optionen. |

### Rückgabewert

die Maskierungssitzung, die Retraining-Zerlegungsoperationen durchführen kann.
