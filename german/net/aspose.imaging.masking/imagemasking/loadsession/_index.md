...
description: Laden Sie die Sitzung aus dem angegebenen Stream.
type: docs
weight: 50
url: /de/net/aspose.imaging.masking/imagemasking/loadsession/
---
## LoadSession(Stream) {#loadsession}

Laden Sie die Sitzung aus dem angegebenen Stream.
