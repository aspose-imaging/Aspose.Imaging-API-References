...
description: Der animierte PNG-Bildrahmen
type: docs
weight: 1310
url: /de/net/aspose.imaging.fileformats.apng/apngframe/
---
## ApngFrame class

Der animierte PNG-Bildrahmen
...
| override [BackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/backgroundcolor) { get; set; } | Ruft die Hintergrundfarbe ab. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.apng/apngframe/bitsperpixel) { get; } | Ruft die Anzahl der Bildbits pro Pixel ab. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.apng/apngframe/disposalmethod) { get; } | Ruft die Entsorgungsmethode ab. |
...
| [FrameLeft](../../aspose.imaging.fileformats.apng/apngframe/frameleft) { get; } | Ruft den linken Versatz des Rahmens ab. |
| [FrameTime](../../aspose.imaging.fileformats.apng/apngframe/frametime) { get; set; } | Ruft die Frame-Dauer ab oder legt sie fest. |
| [FrameTop](../../aspose.imaging.fileformats.apng/apngframe/frametop) { get; } | Ruft den oberen Versatz des Rahmens ab. |
| override [HasAlpha](../../aspose.imaging.fileformats.apng/apngframe/hasalpha) { get; } | Ruft einen Wert ab, der angibt, ob diese Instanz alpha hat. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/hasbackgroundcolor) { get; set; } | Ruft einen Wert ab, der angibt, ob eine Hintergrundfarbe vorhanden ist. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.apng/apngframe/hastransparentcolor) { get; set; } | Ruft einen Wert ab, der angibt, ob das Bild eine transparente Farbe hat. |
| override [Height](../../aspose.imaging.fileformats.apng/apngframe/height) { get; } | Ruft die Bildhöhe ab. |
...
| override [TransparentColor](../../aspose.imaging.fileformats.apng/apngframe/transparentcolor) { get; set; } | Ruft die transparente Farbe ab. |
...
| override [Width](../../aspose.imaging.fileformats.apng/apngframe/width) { get; } | Ruft die Bildbreite ab. |
...
| override [CacheData](../../aspose.imaging.fileformats.apng/apngframe/cachedata)() | Zwischenspeichert die Daten und stellt sicher, dass kein zusätzliches Laden von Daten aus der zugrunde liegenden Datei durchgeführt wird[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| [GetFullFrame](../../aspose.imaging.fileformats.apng/apngframe/getfullframe)() | Ruft das Vollbild ab. |
