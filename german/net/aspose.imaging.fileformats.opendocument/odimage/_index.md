...
description: Das geöffnete Dokument
type: docs
weight: 7370
url: /de/net/aspose.imaging.fileformats.opendocument/odimage/
---
## OdImage class
...
| Name | Beschreibung |
| --- | --- |
| [OdImage](odimage#constructor)(StreamContainer) | Initialisiert eine neue Instanz von[`OdImage`](../odimage) Klasse. |
| [OdImage](odimage#constructor_1)(StreamContainer, LoadOptions) | Initialisiert eine neue Instanz von[`OdImage`](../odimage) Klasse. |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize#resize_1)(int, int, ImageResizeSettings) | Ändert die Bildgröße. |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odimage/resize#resize_2)(int, int, ResizeType) | Ändert die Bildgröße. |
