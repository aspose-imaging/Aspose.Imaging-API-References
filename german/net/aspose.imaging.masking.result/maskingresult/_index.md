...
description: Abstrakte Basisklasse die Ergebnisbilder aus dem Bildmaskierungssystem bereitstellen kann.
type: docs
weight: 10540
url: /de/net/aspose.imaging.masking.result/maskingresult/
---
## MaskingResult class

Abstrakte Basisklasse, die Ergebnisbilder aus dem Bildmaskierungssystem bereitstellen kann.
...
| [Item](../../aspose.imaging.masking.result/maskingresult/item) { get; } | Ruft die ab[`IMaskingLayer`](../imaskinglayer) am angegebenen Index. |
| abstract [Layers](../../aspose.imaging.masking.result/maskingresult/layers) { get; } | Ruft die Ebenen ab. |
| [Length](../../aspose.imaging.masking.result/maskingresult/length) { get; } | Ruft die Länge ab. |
...
| [GetEnumerator](../../aspose.imaging.masking.result/maskingresult/getenumerator)() | Ruft den Enumerator ab. |

## Felder

| Name | Beschreibung |
| --- | --- |
| readonly [MaskingOptions](../../aspose.imaging.masking.result/maskingresult/maskingoptions) | Die Maskierungsoptionen |
...
* namensraum [Aspose.Imaging.Masking.Result](../../aspose.imaging.masking.result)
