...
description: Hauptklasse der JPEG2000-Bibliothek
type: docs
weight: 6830
url: /de/net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/
---
## Jpeg2000Image class

Hauptklasse der JPEG2000-Bibliothek
...
| Name | Beschreibung |
| --- | --- |
| [Jpeg2000Image](jpeg2000image#constructor)(RasterImage) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_5)(Stream) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_7)(string) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_2)(int, int) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_1)(RasterImage, int) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_6)(Stream, int) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_8)(string, int) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_4)(int, int, int) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
| [Jpeg2000Image](jpeg2000image#constructor_3)(int, int, Jpeg2000Options) | Initialisiert eine neue Instanz von[`Jpeg2000Image`](../jpeg2000image) Klasse. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/bitsperpixel) { get; } | Ermittelt die Bildtiefe (Bits pro Pixel) |
...
| [Codec](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/codec) { get; } | Ruft den Codec ab. |
| [Comments](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/comments) { get; set; } | Ruft die Kommentare ab oder legt sie fest. |
...
| override [FileFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/fileformat) { get; } | Ruft einen Wert von Dateiformat ab |
...
| override [Height](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/height) { get; } | Ruft die Bildhöhe ab |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/horizontalresolution) { get; set; } | Ermittelt oder setzt die horizontale Auflösung davon in Pixel pro Zoll[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawdataformat) { get; } | Ruft das Rohdatenformat ab. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawlinesize) { get; } | Ruft die rohe Zeilengröße in Bytes ab. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/verticalresolution) { get; set; } | Ermittelt oder setzt die vertikale Auflösung davon in Pixel pro Zoll[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/width) { get; } | Ruft die Bildbreite ab |
| override [XmpData](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/xmpdata) { get; set; } | Ruft die XMP-Metadaten ab oder legt sie fest. |
...
| override [GetOriginalOptions](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/getoriginaloptions)() | Ruft die Optionen basierend auf den ursprünglichen Dateieinstellungen ab. Dies kann hilfreich sein, um die Bittiefe und andere Parameter des Originalbildes unverändert zu lassen. Zum Beispiel, wenn wir ein schwarz-weißes PNG-Bild mit 1 Bit pro Pixel laden und dann Speichern Sie es mit the [`Save`](../../aspose.imaging/datastreamsupporter/save) -Methode wird das ausgegebene PNG-Bild mit 8 Bit pro Pixel erzeugt. Um dies zu vermeiden und das PNG-Bild mit 1 Bit pro Pixel zu speichern, verwenden Sie diese Methode, um entsprechende Speicheroptionen zu erhalten, und übergeben Sie sie an die[`Save`](../../aspose.imaging/image/save) Methode als zweiten Parameter. |
