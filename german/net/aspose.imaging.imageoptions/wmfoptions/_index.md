...
description: Die wmf Optionen.
type: docs
weight: 10290
url: /de/net/aspose.imaging.imageoptions/wmfoptions/
---
## WmfOptions class
...
Das folgende Beispiel zeigt, wie Sie ein mehrseitiges Vektorbild auf allgemeine Weise in das WMF-Format konvertieren, ohne auf einen bestimmten Bildtyp zu verweisen.
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    ...
    // Nur die ersten beiden Seiten exportieren. Tatsächlich wird nur eine Seite konvertiert, da WMF kein mehrseitiges Format ist.
