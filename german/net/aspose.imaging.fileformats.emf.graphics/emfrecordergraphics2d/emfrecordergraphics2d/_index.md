...
description: Initialisiert eine neue Instanz vonEmfRecorderGraphics2Daspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d Klasse.
type: docs
weight: 10
url: /de/net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/emfrecordergraphics2d/
---
## EmfRecorderGraphics2D constructor

Initialisiert eine neue Instanz von[`EmfRecorderGraphics2D`](../../emfrecordergraphics2d) Klasse.
...
| --- | --- | --- |
| frame | Rectangle | Der Rahmen. |
| deviceSize | Size | Größe des Geräts. |
| deviceSizeMm | Size | Die Gerätegröße mm. |
