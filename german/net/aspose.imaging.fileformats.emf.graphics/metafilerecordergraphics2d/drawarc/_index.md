...
description: Zeichnet einen Bogen der einen Teil einer Ellipse darstellt die durch eine Rectangle-Struktur angegeben wird.
type: docs
weight: 50
url: /de/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawarc/
---
## MetafileRecorderGraphics2D.DrawArc method

Zeichnet einen Bogen, der einen Teil einer Ellipse darstellt, die durch eine Rectangle-Struktur angegeben wird.
...
| arcAngle | Single | Winkel in Grad, gemessen im Uhrzeigersinn vom startAngle-Parameter bis zum Endpunkt des Bogens. |
