...
description: Zeichnet die Schnur.
type: docs
weight: 160
url: /de/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawstring/
---
...
| font | Font | Schriftart, die das Textformat der Zeichenfolge definiert. |
| color | Color | Die Textfarbe. |
| x | Int32 | Die x-Koordinate der oberen linken Ecke des gezeichneten Textes. |
| y | Int32 | Die y-Koordinate der oberen linken Ecke des gezeichneten Textes. |
...
| x | Int32 | Die x-Koordinate der oberen linken Ecke des gezeichneten Textes. |
| y | Int32 | Die y-Koordinate der oberen linken Ecke des gezeichneten Textes. |
| angle | Single | Der Winkel in Grad zwischen dem Hemmungsvektor und der x-Achse des Geräts. Der Escape-Vektor verläuft parallel zur Grundlinie einer Textzeile. |
