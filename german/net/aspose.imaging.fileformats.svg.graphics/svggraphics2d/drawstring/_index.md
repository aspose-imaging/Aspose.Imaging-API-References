...
description: Zeichnet die Textzeichenfolge.
type: docs
weight: 80
url: /de/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawstring/
---
...
| --- | --- | --- |
| font | Font | Die zum Rendern von Text verwendete Schriftart. |
| text | String | Die Unicode-Textzeichenfolge. |
| origin | Point | Die obere linke Ecke des Textverlaufs. |
