...
description: Entfaltungsfilteroptionen Bewegungsunschärfe
type: docs
weight: 9800
url: /de/net/aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/
---
## MotionWienerFilterOptions class

Entfaltungsfilteroptionen Bewegungsunschärfe
...
| Name | Beschreibung |
| --- | --- |
| [MotionWienerFilterOptions](motionwienerfilteroptions)(int, double, double) | Initialisiert eine neue Instanz von[`MotionWienerFilterOptions`](../motionwienerfilteroptions) Klasse. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [Angle](../../aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/angle) { get; set; } | Liest oder setzt den Winkel in Grad. |
...
| [Length](../../aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/length) { get; set; } | Ruft die Länge ab oder legt sie fest. |
| [Smooth](../../aspose.imaging.imagefilters.filteroptions/motionwienerfilteroptions/smooth) { get; set; } | Ruft die Glättung ab oder legt sie fest. |
