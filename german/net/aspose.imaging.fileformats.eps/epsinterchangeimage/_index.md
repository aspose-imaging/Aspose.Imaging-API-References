...
description: Klasse für Encapsulated PostScript Interchange format
type: docs
weight: 6570
url: /de/net/aspose.imaging.fileformats.eps/epsinterchangeimage/
---
## EpsInterchangeImage class

Klasse für Encapsulated PostScript Interchange format
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsinterchangeimage/epstype) { get; } | Ruft den Wert des EPS-Subtyps ab |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | Ruft einen Wert ab, der angibt, ob diese Instanz eine formatspezifische Rastervorschau hat |
...
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | Ermittelt die Höhe des Vorschaubildes |
| [PreviewWidth](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewwidth) { get; } | Ermittelt die Breite des Vorschaubildes |
| [RasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/rasterpreview) { get; } | Ruft eine s/w-Rastervorschau ab (falls vorhanden) oder null |
...
| [ConvertToBinary](../../aspose.imaging.fileformats.eps/epsinterchangeimage/converttobinary)() | Konvertiert diese Instanz in[`EpsBinaryImage`](../epsbinaryimage) |
...
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ImageResizeSettings) | Ändert die Bildgröße. |
| override [Resize](../../aspose.imaging.fileformats.eps/epsimage/resize)(int, int, ResizeType) | Ändert die Bildgröße. |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | Führt eine explizite Konvertierung von aus[`EpsBinaryImage`](../epsbinaryimage) zu[`EpsInterchangeImage`](../epsinterchangeimage) |
