...
description: Klasse für Encapsulated PostScript-Format mit binärem Header
type: docs
weight: 6550
url: /de/net/aspose.imaging.fileformats.eps/epsbinaryimage/
---
## EpsBinaryImage class

Klasse für Encapsulated PostScript-Format mit binärem Header
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsbinaryimage/epstype) { get; } | Ruft den Wert des EPS-Subtyps ab |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/hasrasterpreview) { get; } | Ruft einen Wert ab, der angibt, ob diese Instanz eine formatspezifische Rastervorschau hat |
...
| [TiffPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/tiffpreview) { get; } | Ruft die TIFF-Vorschau ab. |
...
| [WmfPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/wmfpreview) { get; } | Ruft die WMF-Vorschau ab. |
...
| [ConvertToInterchange](../../aspose.imaging.fileformats.eps/epsbinaryimage/converttointerchange)() | Konvertiert diese Instanz in[`EpsInterchangeImage`](../epsinterchangeimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsbinaryimage/op_explicit) | Führt eine explizite Konvertierung von aus[`EpsInterchangeImage`](../epsinterchangeimage) zu[`EpsBinaryImage`](../epsbinaryimage) |
