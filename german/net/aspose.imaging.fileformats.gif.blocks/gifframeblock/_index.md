...
description: GIF-Rahmenblock.
type: docs
weight: 6630
url: /de/net/aspose.imaging.fileformats.gif.blocks/gifframeblock/
---
## GifFrameBlock class
...
| Name | Beschreibung |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | Initialisiert eine neue Instanz von[`GifFrameBlock`](../gifframeblock) Klasse. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/backgroundcolor) { get; set; } | Ruft einen Wert für die Hintergrundfarbe ab oder legt ihn fest. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel) { get; } | Ruft die Anzahl der Bildbits pro Pixel ab. |
...
| [ControlBlock](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/controlblock) { get; } | Ruft den diesem Block zugeordneten Grafiksteuerblock ab. |
| [DataStreamContainer](../../aspose.imaging/datastreamsupporter/datastreamcontainer) { get; } | Ruft den Datenstrom des Objekts ab. |
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod) { get; } | Ruft die Entsorgungsmethode ab. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Ruft einen Wert ab, der angibt, ob diese Instanz verworfen wird. |
| override [FileFormat](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/fileformat) { get; } | Ruft einen Wert von Dateiformat ab |
| [Flags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/flags) { get; set; } | Ruft die Flags ab oder setzt sie. |
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft) { get; } | fährt nach links. |
| [FrameTime](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametime) { get; set; } | Ruft die Dauer ab oder legt sie fest. |
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop) { get; } | Konvertiert in p. |
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel) { get; set; } | Ruft die GIF-Frame-Bits pro Pixel ab oder legt sie fest. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor) { get; set; } | Ruft einen Wert ab, der angibt, ob der Rahmenblock eine transparente Farbe hat. |
| override [Height](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/height) { get; } | Ruft die Bildhöhe ab. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob dies der Fall ist[`GifFrameBlock`](../gifframeblock) ist interlaced. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | Ruft einen Wert ab, der angibt, ob diese Bildinstanz interlaced ist. |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob die Farbpalette sortiert ist. |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left) { get; set; } | Ruft die linke Bildposition ab oder legt sie fest. |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top) { get; set; } | Ruft die oberste Bildposition ab oder legt sie fest. |
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor) { get; set; } | Ruft die transparente Farbe des Rahmenblocks ab. |
...
| override [Width](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/width) { get; } | Ruft die Bildbreite ab. |
...
| Name | Beschreibung |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/adjustbrightness)(int) | Anpassen einer Helligkeit für das Bild. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getfullframe)() | Ruft das Vollbild ab. |
...
| override [GetOriginalOptions](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getoriginaloptions)() | Ruft die Optionen basierend auf den ursprünglichen Dateieinstellungen ab. Dies kann hilfreich sein, um die Bittiefe und andere Parameter des Originalbildes unverändert zu lassen. Zum Beispiel, wenn wir ein schwarz-weißes PNG-Bild mit 1 Bit pro Pixel laden und dann Speichern Sie es mit the [`Save`](../../aspose.imaging/datastreamsupporter/save) -Methode wird das ausgegebene PNG-Bild mit 8 Bit pro Pixel erzeugt. Um dies zu vermeiden und das PNG-Bild mit 1 Bit pro Pixel zu speichern, verwenden Sie diese Methode, um entsprechende Speicheroptionen zu erhalten, und übergeben Sie sie an die[`Save`](../../aspose.imaging/image/save) Methode als zweiten Parameter. |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor#replacecolor_1)(int, byte, int) | Ersetzt eine Farbe durch eine andere mit zulässigem Unterschied und behält den ursprünglichen Alpha-Wert bei, um glatte Kanten zu erhalten. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors#replacenontransparentcolors_1)(int) | Ersetzt alle nicht transparenten Farben durch neue Farben und behält den ursprünglichen Alpha-Wert bei, um glatte Kanten zu erhalten. Hinweis: Wenn Sie es auf Bildern ohne Transparenz verwenden, werden alle Farben durch eine einzige ersetzt. |
...
| static [CreateFlags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/createflags)(IColorPalette, bool, bool) | Erstellt die Flags. |
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette)(IColorPalette, IColorPalette) | Ruft die zugehörige Farbpalette ab. |

## Felder

| Name | Beschreibung |
| --- | --- |
| const [ExtensionLabel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/extensionlabel) | Erweiterungslabel blockieren. |
| const [ImageDescriptorSize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/imagedescriptorsize) | Die Größe des Bilddeskriptors. |
