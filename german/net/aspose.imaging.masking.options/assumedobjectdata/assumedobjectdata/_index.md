...
description: Initialisiert eine neue Instanz vonAssumedObjectDataaspose.imaging.masking.options/assumedobjectdata Klasse.
type: docs
weight: 10
url: /de/net/aspose.imaging.masking.options/assumedobjectdata/assumedobjectdata/
---
## AssumedObjectData() {#constructor}

Initialisiert eine neue Instanz von[`AssumedObjectData`](../../assumedobjectdata) Klasse.
...
| --- | --- | --- |
| type | DetectedObjectType | Der Typ des Objekts. |
| bounds | Rectangle | Die Grenzen des Objekts. |
