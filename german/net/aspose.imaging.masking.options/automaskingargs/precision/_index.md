...
description: Ruft die Genauigkeit der Segmentierungsmethode ab oder legt sie fest optional.
type: docs
weight: 70
url: /de/net/aspose.imaging.masking.options/automaskingargs/precision/
---
## AutoMaskingArgs.Precision property

Ruft die Genauigkeit der Segmentierungsmethode ab oder legt sie fest (optional).
...
Die Genauigkeit der Segmentierungsmethode (optional).
