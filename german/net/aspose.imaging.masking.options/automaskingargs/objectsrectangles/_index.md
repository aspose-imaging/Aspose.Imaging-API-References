...
description: Ruft die Objektrechtecke ab oder legt sie fest die zu getrennten Objekten gehören optional. Dieser Parameter wird verwendet um die Genauigkeit der Segmentierungsmethoden zu erhöhen.
type: docs
weight: 50
url: /de/net/aspose.imaging.masking.options/automaskingargs/objectsrectangles/
---
## AutoMaskingArgs.ObjectsRectangles property

Ruft die Objektrechtecke ab oder legt sie fest, die zu getrennten Objekten gehören (optional). Dieser Parameter wird verwendet, um die Genauigkeit der Segmentierungsmethoden zu erhöhen.
