...
description: Der EmfPlusResetClip-Datensatz setzt den aktuellen Clipping-Bereich für den Weltraum auf unendlich zurück.
type: docs
weight: 6210
url: /de/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/
---
## EmfPlusResetClip class

Der EmfPlusResetClip-Datensatz setzt den aktuellen Clipping-Bereich für den Weltraum auf unendlich zurück.
...
| Name | Beschreibung |
| --- | --- |
| [EmfPlusResetClip](emfplusresetclip)(EmfPlusRecord) | Initialisiert eine neue Instanz von[`EmfPlusResetClip`](../emfplusresetclip) Klasse. |
