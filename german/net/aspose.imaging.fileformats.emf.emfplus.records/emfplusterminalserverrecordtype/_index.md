...
description: Die Terminalserver-Datensatztypen geben die Grafikverarbeitung auf einem Terminalserver an. Die folgenden sind EMF Terminalserver-Datensatztypen.
type: docs
weight: 6440
url: /de/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusterminalserverrecordtype/
---
## EmfPlusTerminalServerRecordType class

Die Terminalserver-Datensatztypen geben die Grafikverarbeitung auf einem Terminalserver an. Die folgenden sind EMF+ Terminalserver-Datensatztypen.
