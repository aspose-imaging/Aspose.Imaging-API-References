...
description: Der EmfPlusSetTextRenderingHint-Datensatz gibt die Qualität der Textwiedergabe an einschließlich des Anti-Aliasing-Typs.
type: docs
weight: 6390
url: /de/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/
---
## EmfPlusSetTextRenderingHint class

Der EmfPlusSetTextRenderingHint-Datensatz gibt die Qualität der Textwiedergabe an, einschließlich des Anti-Aliasing-Typs.
...
| Name | Beschreibung |
| --- | --- |
| [EmfPlusSetTextRenderingHint](emfplussettextrenderinghint)(EmfPlusRecord) | Initialisiert eine neue Instanz von[`EmfPlusSetTextRenderingHint`](../emfplussettextrenderinghint) Klasse. |
...
| [TextRenderingHint](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/textrenderinghint) { get; set; } | Ruft den Hinweiswert für die Textwiedergabe aus der Aufzählung TextRenderingHint (Abschnitt 2.1.1.32) ab oder legt ihn fest, der die Qualität angibt, die bei der nachfolgenden Textwiedergabe verwendet werden soll. |
