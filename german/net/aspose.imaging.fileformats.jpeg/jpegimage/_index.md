...
description: Ein JPEG-Bild.
type: docs
weight: 6770
url: /de/net/aspose.imaging.fileformats.jpeg/jpegimage/
---
## JpegImage class
...
| Name | Beschreibung |
| --- | --- |
| [JpegImage](jpegimage#constructor_1)(RasterImage) | Initialisiert eine neue Instanz von[`JpegImage`](../jpegimage) Klasse. |
| [JpegImage](jpegimage#constructor_3)(Stream) | Initialisiert eine neue Instanz von[`JpegImage`](../jpegimage) Klasse. |
| [JpegImage](jpegimage#constructor_4)(string) | Initialisiert eine neue Instanz von[`JpegImage`](../jpegimage) Klasse. |
| [JpegImage](jpegimage#constructor_2)(int, int) | Initialisiert eine neue Instanz von[`JpegImage`](../jpegimage) Klasse. |
| [JpegImage](jpegimage#constructor)(JpegOptions, int, int) | Initialisiert eine neue Instanz von[`JpegImage`](../jpegimage) Klasse. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg/jpegimage/bitsperpixel) { get; } | Ruft die Anzahl der Bildbits pro Pixel ab. |
...
| [CmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/cmykcolorprofile) { get; set; } | Das CMYK-Farbprofil für CMYK- und YCCK-JPEG-Bilder. Muss für eine korrekte Farbkonvertierung mit RGBColorProfile gekoppelt sein. |
| [Comment](../../aspose.imaging.fileformats.jpeg/jpegimage/comment) { get; set; } | Ruft den JPEG-Dateikommentar ab oder legt ihn fest. |
...
| [DestinationCmykColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationcmykcolorprofile) { get; set; } | Das CMYK-Farbprofil für CMYK- und YCCK-jpeg-Bilder, das zum Speichern von Bildern verwendet wird. Muss für eine korrekte Farbkonvertierung mit RGBColorProfile gekoppelt sein. |
| [DestinationRgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/destinationrgbcolorprofile) { get; set; } | Das RGB-Farbprofil für CMYK- und YCCK-jpeg-Bilder, das zum Speichern von Bildern verwendet wird. Muss für eine korrekte Farbkonvertierung mit CMYKColorProfile gepaart sein. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Ruft einen Wert ab, der angibt, ob diese Instanz verworfen wird. |
| [ExifData](../../aspose.imaging.fileformats.jpeg/jpegimage/exifdata) { get; set; } | Exif-Datencontainer abrufen oder setzen |
| override [FileFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/fileformat) { get; } | Ruft einen Wert von Dateiformat ab |
...
| override [Height](../../aspose.imaging.fileformats.jpeg/jpegimage/height) { get; } | Ruft die Bildhöhe ab. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/horizontalresolution) { get; set; } | Ermittelt oder setzt die horizontale Auflösung davon in Pixel pro Zoll[`RasterImage`](../../aspose.imaging/rasterimage) . |
| [IgnoreEmbeddedColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/ignoreembeddedcolorprofile) { get; set; } | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob das eingebettete Farbprofil ignoriert wird. Wenn das eingebettete Farbprofil ignoriert wird, wird das standardmäßige Farbprofil verwendet. |
...
| [Jfif](../../aspose.imaging.fileformats.jpeg/jpegimage/jfif) { get; set; } | Holt oder setzt jfif. |
| [JpegOptions](../../aspose.imaging.fileformats.jpeg/jpegimage/jpegoptions) { get; } | Ruft die JPEG-Optionen ab, die verwendet werden, um dies zu erstellen oder zu laden[`JpegImage`](../jpegimage) Instanz. |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg/jpegimage/rawdataformat) { get; } | Ruft das Rohdatenformat ab. |
...
| [RgbColorProfile](../../aspose.imaging.fileformats.jpeg/jpegimage/rgbcolorprofile) { get; set; } | Das RGB-Farbprofil für CMYK- und YCCK-JPEG-Bilder. Muss für eine korrekte Farbkonvertierung mit CMYKColorProfile gepaart sein. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/verticalresolution) { get; set; } | Ermittelt oder setzt die vertikale Auflösung davon in Pixel pro Zoll[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.jpeg/jpegimage/width) { get; } | Ruft die Bildbreite ab. |
| override [XmpData](../../aspose.imaging.fileformats.jpeg/jpegimage/xmpdata) { get; set; } | Ruft die XMP-Metadaten ab oder legt sie fest. |
...
| [AutoRotate](../../aspose.imaging.fileformats.jpeg/jpegimage/autorotate)() | Führt eine automatische Bilddrehung in Abhängigkeit von den von Exif bereitgestellten Orientierungsdaten durch. |
...
| override [GetModifyDate](../../aspose.imaging.fileformats.jpeg/jpegimage/getmodifydate)(bool) | Ruft das Datum und die Uhrzeit ab, zu der das Ressourcenbild zuletzt geändert wurde. |
...
| override [SetResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/setresolution)(double, double) | Legt die Auflösung dafür fest[`RasterImage`](../../aspose.imaging/rasterimage) . |
