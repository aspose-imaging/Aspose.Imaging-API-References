...
description: Klasse zur Darstellung des Djvu-Rasterbildes in dem sich das Ergebnis einer Operation befindet
type: docs
weight: 2460
url: /de/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

Klasse zur Darstellung des Djvu-Rasterbildes, in dem sich das Ergebnis einer Operation befindet
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | Ruft die Anzahl der Bildbits pro Pixel ab. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | Ruft die Höhe ab. |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | Ruft die Länge ab. |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | Ruft die Breite ab. |
