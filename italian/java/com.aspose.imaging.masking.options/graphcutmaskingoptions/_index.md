...
type: docs
weight: 14
url: /it/java/com.aspose.imaging.masking.options/graphcutmaskingoptions/
---
**Inheritance:**
...
| Metodo | Descrizione |
| --- | --- |
| [getFeatheringRadius()](#getFeatheringRadius--) | Ottiene il raggio del feathering. |
| [setFeatheringRadius(int value)](#setFeatheringRadius-int-) | Imposta il raggio del feathering. |
...
Salvataggio del risultato della mascheratura dell'immagine Graph Cut con feathering impostato a 3. La mascheratura dell'immagine viene eseguita utilizzando l'array Point specificato.
``` java
MaskingResult[] results;
try (RasterImage image = (RasterImage)Image.load("input.jpg"))
{
...
Ottiene il raggio del feathering.

**Returns:**
int - il raggio del feathering.
...
Imposta il raggio del feathering.
