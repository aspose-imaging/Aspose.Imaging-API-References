...
description: "Il tipo TIFF signed long."
type: docs
weight: 22
url: /it/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
**Inheritance:**
...
Il tipo TIFF signed long.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [TiffSLongType(int tagId)](#TiffSLongType-int-) | Inizializza una nuova istanza della classe `TiffSLongType`. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getValues()](#getValues--) | Ottiene o imposta i valori. |
| [setValues(int[] value)](#setValues-int---) | Ottiene o imposta i valori. |
...
Inizializza una nuova istanza della classe `TiffSLongType`.
