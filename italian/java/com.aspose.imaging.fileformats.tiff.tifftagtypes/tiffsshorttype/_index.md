...
description: "Il tipo tiff signed short."
type: docs
weight: 24
url: /it/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
**Inheritance:**
...
Il tipo tiff signed short.
## Costruttori

| Costruttore | Descrizione |
| --- | --- |
| [TiffSShortType(int tagId)](#TiffSShortType-int-) | Inizializza una nuova istanza della classe `TiffSShortType`. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getValues()](#getValues--) | Ottiene o imposta i valori. |
| [setValues(short[] value)](#setValues-short---) | Ottiene o imposta i valori. |
...
Inizializza una nuova istanza della classe `TiffSShortType`.
