...
description: "Il tipo TIFF long."
type: docs
weight: 18
url: /it/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
**Inheritance:**
...
| --- | --- |
| [TiffLongType(int tagId)](#TiffLongType-int-) | Inizializza una nuova istanza della classe `TiffLongType`. |
## Metodi
...
Inizializza una nuova istanza della classe `TiffLongType`.
