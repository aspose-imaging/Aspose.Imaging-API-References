...
type: docs
weight: 13
url: /it/java/com.aspose.imaging.shapes/ellipseshape/
---
**Inheritance:**
...
| --- | --- |
| [EllipseShape()](#EllipseShape--) | Inizializza una nuova istanza della classe `EllipseShape`. |
| [EllipseShape(RectangleF rectangle)](#EllipseShape-com.aspose.imaging.RectangleF-) | Inizializza una nuova istanza della classe `EllipseShape`. |
## Metodi
...
Inizializza una nuova istanza della classe `EllipseShape`.
