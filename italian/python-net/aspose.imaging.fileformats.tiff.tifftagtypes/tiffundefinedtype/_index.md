...
type: docs
weight: 170
url: /it/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_1) | Inizializza una nuova istanza di [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) classe. |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_2) | Inizializza una nuova istanza di [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) classe. |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| count | int | r | Restituisce il conteggio degli elementi. |
| dati | System.Byte | r/w | Ottiene o imposta i dati. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Inizializza una nuova istanza di [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) classe. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Inizializza una nuova istanza di [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) classe. |
...
Inizializza una nuova istanza di [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) classe.
