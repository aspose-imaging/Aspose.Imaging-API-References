---
title: "TiffASCIIType Classe"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffasciitype/
---

**Summary:** The tiff ascii type.

**Module:** [aspose.imaging.fileformats.tiff.tifftagtypes](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/)

**Full Name:** aspose.imaging.fileformats.tiff.tifftagtypes.TiffASCIIType
...
| **Name** | **Descrizione** |
| :- | :- |
| [TiffASCIIType(tag_id)](#TiffASCIIType_tag_id_1) | Inizializza una nuova istanza di [TiffASCIIType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffasciitype/) classe. |
| [TiffASCIIType(tag_id)](#TiffASCIIType_tag_id_2) | Inizializza una nuova istanza di [TiffASCIIType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffasciitype/) classe. |
## **Properties**
...
| text | string | r/w | Ottiene o imposta il testo. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Inizializza una nuova istanza di [TiffASCIIType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffasciitype/) classe. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Inizializza una nuova istanza di [TiffASCIIType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffasciitype/) classe. |
...
### Constructor: TiffASCIIType(tag_id) {#TiffASCIIType_tag_id_1}
...
Inizializza una nuova istanza di [TiffASCIIType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffasciitype/) classe.
...
| Tipo | Descrizione |
| :- | :- |
| [TiffASCIIType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffasciitype/) |  |
