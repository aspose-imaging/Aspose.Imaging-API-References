...
type: docs
weight: 120
url: /it/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_1) | Inizializza una nuova istanza di [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) classe. |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_2) | Inizializza una nuova istanza di [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) classe. |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| count | int | r | Restituisce il conteggio degli elementi. |
| data_size | int | r | Restituisce la dimensione del valore del tag. |
| element_size | System.Byte | r | Ottiene la dimensione dell'elemento. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Inizializza una nuova istanza di [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) classe. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Inizializza una nuova istanza di [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) classe. |
...
Inizializza una nuova istanza di [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) classe.
