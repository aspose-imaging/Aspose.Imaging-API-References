...
type: docs
weight: 180
url: /it/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [TiffUnknownType(stream, tag_type, tag_id, count, offset_or_value)](#TiffUnknownType_stream_tag_type_tag_id_count_offset_or_value_1) | Inizializza una nuova istanza della classe [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/). |
## **Properties**
...
| offset_or_value | int | r | Restituisce il valore di offset per un dato aggiuntivo o per il valore stesso nel caso in cui il conteggio sia 1. |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | r | Restituisce lo stream da cui leggere i dati aggiuntivi. |
...
| [get_additional_data_size(size_of_tag_value)](#get_additional_data_size_size_of_tag_value_3) | Ottiene la dimensione aggiuntiva del valore del tag in byte (nel caso in cui il tag non possa contenere l'intero valore del tag). |
| [get_aligned_data_size(size_of_tag_value)](#get_aligned_data_size_size_of_tag_value_4) | Ottiene la dimensione dei dati allineata a un confine di 4 byte (int) o 8 byte (long). |
| [read_tag(data_stream, position)](#read_tag_data_stream_position_5) | Legge i dati del tag. |
| [write_additional_data(data_stream)](#write_additional_data_data_stream_6) | Scrive i dati aggiuntivi del tag. |
| [write_tag(data_stream, additional_data_offset)](#write_tag_data_stream_additional_data_offset_7) | Scrive il valore del tag o l'offset aggiuntivo. |
...
Inizializza una nuova istanza della classe [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/).

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | Lo stream da cui leggere. |
| tag_type | int | Tipo del tag. |
| tag_id | int | L'ID del tag. |
| count | int | Il valore del conteggio. |
| offset_or_value | int | L'offset o il valore. |
