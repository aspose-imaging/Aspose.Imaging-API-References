---
title: "WmfRecorderGraphics2D Classe"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | Inizializza una nuova istanza della classe [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Ottiene o imposta il colore dello sfondo. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | Ottiene o imposta la modalità di sfondo. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | Ottiene un'istanza del registratore Wmf per l'immagine Wmf esistente. |
...
Inizializza una nuova istanza della classe [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/).

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Rettangolo di destinazione, misurato in twip, per la visualizzazione del metafile. |
...
| Tipo | Descrizione |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | L'immagine risultante. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | L'immagine Wmf per cui ottenere un registratore. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | Un'istanza della classe [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
