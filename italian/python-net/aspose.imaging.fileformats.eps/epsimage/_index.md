...
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.eps/epsimage/
---
...
| bits_per_pixel | int | r | Accedi facilmente alla profondità di bit precisa dell'immagine con questa proprietà. Recupera <br/>            il conteggio dei bit per pixel, fornendo informazioni cruciali sulla profondità di colore dell'immagine <br/>            e contribuendo a ottimizzare le attività di elaborazione. Ideale per applicazioni che richiedono <br/>            un controllo dettagliato sulla manipolazione e l'analisi delle immagini. |
| bounding_box | [RectangleF](/imaging/python-net/aspose.imaging/rectanglef/) | r | Accedendo al riquadro di delimitazione originale in punti indipendenti dal dispositivo, questa proprietà <br/>            fornisce informazioni geometriche cruciali sulle dimensioni del [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/). <br/>            Recuperando questi dati, gli utenti possono valutare con precisione le dimensioni e il rapporto d'aspetto dell'immagine <br/>            facilitando layout e posizionamento precisi in varie applicazioni. |
| bounding_box_px | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Questa proprietà restituisce il riquadro di delimitazione originale dell'[EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) <br/>            istanza in pixel, fornendo dati geometrici essenziali per un rendering e una manipolazione accurati. Con queste informazioni, gli utenti possono garantire un posizionamento e una dimensione precisi /// delle immagini EPS nei loro progetti, migliorando la presentazione visiva complessiva e la qualità. |
...
| creation_date | System.DateTime | r | Recuperando la data di creazione dai commenti delle EPS Document Structuring Conventions (DSC) <br/>            questa proprietà fornisce metadati essenziali che indicano l'origine del file EPS <br/>            . Accedendo a queste informazioni, gli utenti ottengono approfondimenti sull'origine e la cronologia del file, migliorando la gestione e l'organizzazione dei file. |
| creator | string | r | Questa proprietà offre l'accesso alle informazioni sul creatore provenienti dai commenti delle EPS Document <br/>            Structuring Conventions (DSC) trovati all'interno del file EPS. Comprendere i dettagli del creatore fornisce indicazioni sul software o sullo strumento utilizzato per generare il <br/>            file EPS, facilitando la valutazione della compatibilità su varie piattaforme e <br/>            applicazioni. |
...
| eps_type | [EpsType](/imaging/python-net/aspose.imaging.fileformats.eps.consts/epstype/) | r | Accedi e interpreta il valore del sottotipo della tua immagine EPS, semplificando il tuo <br/>            flusso di lavoro e migliorando la compatibilità su tutte le piattaforme. Ideale per ottimizzare il recupero del sottotipo EPS nei tuoi progetti con precisione ed efficienza. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Ottiene o imposta l'istanza Exif. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Accedi al formato file della tua immagine con questa proprietà. Recupera le informazioni essenziali <br/>            sul formato del file immagine, facilitando la compatibilità e l'elaborazione efficiente. Ideale per identificare il formato dei tuoi file immagine per <br/>            un'integrazione fluida nei tuoi progetti. |
| has_background_color | bool | r/w | Ottiene o imposta un valore che indica se l'immagine ha un colore di sfondo. |
| has_raster_preview | bool | r | Scopri la presenza di un'anteprima raster senza sforzo con questa proprietà. Accedi <br/>            al valore booleano che indica se l'istanza [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) include un <br/>            anteprima raster, potenziando le tue attività di elaborazione delle immagini con chiarezza ed efficienza. <br/>            Ideale per semplificare le decisioni di flusso di lavoro basate sulla presenza o assenza di <br/>            anteprime raster nelle immagini EPS. |
| height | int | r | Ottiene l'altezza dell'immagine. |
| height_f | float | r | Accedi all'altezza dell'immagine usando questa proprietà. Ottieni l'altezza dell'immagine con <br/>            facilità, consentendo regolazioni di layout fluide, calcoli del rapporto d'aspetto e rendering preciso <br/>            su diverse risoluzioni dello schermo e ambienti di visualizzazione. |
...
| is_cached | bool | r | Questa proprietà fornisce un modo comodo per verificare se i dati dell'oggetto sono attualmente <br/>            memorizzati nella cache, eliminando la necessità di letture aggiuntive. Offre un metodo rapido ed <br/>            efficiente per determinare se le informazioni richieste sono prontamente disponibili, <br/>            ottimizzando le prestazioni e riducendo il consumo di risorse in operazioni ad alta intensità di dati. |
...
| post_script_version | string | r | Questa proprietà recupera la versione PostScript associata all'<br/>            istanza [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/). Fornisce informazioni sulla specifica versione del linguaggio PostScript <br/>            utilizzata nel file EPS, aiutando nella valutazione della compatibilità <br/>            e facilitando l'integrazione fluida con ambienti compatibili con PostScript. |
| preview_image_count | int | r | Accedi al numero di anteprime disponibili con facilità. Questa proprietà ti consente <br/>            di recuperare senza sforzo il conteggio delle anteprime associate al tuo file, <br/>            permettendo una gestione efficiente e una navigazione delle anteprime delle immagini. Ideale per <br/>            ottimizzare il tuo flusso di lavoro e organizzare efficacemente le risorse immagine. |
| preview_images | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Recupera le anteprime associate al tuo file. Questa proprietà fornisce <br/>            un accesso fluido alla collezione di anteprime, consentendoti di navigare e gestirle in modo efficiente <br/>            secondo le necessità. Ideale per visualizzare rapidamente e selezionare l'immagine <br/>            giusta per il tuo progetto. |
...
| titolo | string | r | Questa proprietà recupera il titolo estratto dai commenti delle EPS Document Structuring <br/>            Conventions (DSC) incorporati nel file EPS. Fornisce metadati preziosi sul contenuto del file EPS, aiutando nell'organizzazione dei documenti e <br/>            nell'identificazione all'interno di applicazioni software compatibili. |
...
| width_f | float | r | Recupera la larghezza dell'immagine con questa pratica proprietà. Ottieni la larghezza dell'immagine <br/>            senza sforzo, facilitando calcoli di layout precisi, operazioni di ridimensionamento e <br/>            compiti relativi alle dimensioni nella tua applicazione. Ideale per garantire un rendering accurato <br/>            e una visualizzazione delle immagini su varie piattaforme e dispositivi. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Ottiene o imposta i dati Xmp. |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
| cache_data() | Questo metodo non fa nulla poiché l'attuale implementazione della classe<br/>            [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) non prevede la memorizzazione nella cache dei dati. Sebbene non <br/>            esegua alcuna azione, comprendere questo comportamento è fondamentale per gli sviluppatori che lavorano <br/>            con immagini EPS, garantendo una gestione efficiente delle risorse e prestazioni ottimali <br/>            nelle loro applicazioni. |
...
| [get_preview_image(format)](#get_preview_image_format_30) | Recupera l'anteprima esistente nel _format_ specificato o <br/>            restituisce **None** se non ne viene trovata alcuna. Questo metodo offre flessibilità nell'<br/>            accesso alle anteprime adattate a formati specifici, ottimizzando la compatibilità e la <br/>            gestione delle risorse nelle applicazioni. |
| [get_preview_images()](#get_preview_images__31) | Accede alle anteprime collegate all'istanza [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/), consentendo <br/>            un recupero fluido per l'ispezione o l'utilizzo nelle applicazioni. Questo metodo <br/>            fornisce un accesso comodo alle anteprime, migliorando l'interazione dell'utente con i <br/>            dati dell'immagine. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_32) | Ottiene un'altezza proporzionale. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_33) | Ottiene una larghezza proporzionale. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_34) | Converte in aps. |
...
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_48) | Ridimensiona l'altezza proporzionalmente. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_49) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_50) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_51) | Ridimensiona l'altezza proporzionalmente. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_52) | Ridimensiona la larghezza proporzionalmente. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_53) | Ridimensiona la larghezza proporzionalmente. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_54) | Ridimensiona la larghezza proporzionalmente. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_55) | Ridimensiona la larghezza proporzionalmente. |
| [rotate(angle)](#rotate_angle_56) | Ruota l'immagine attorno al centro. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_57) | Ruota, capovolge o ruota e capovolge l'immagine. |
| save() | Salva i dati dell'immagine nello stream sottostante. |
| [save(file_path)](#save_file_path_58) | Salva l'immagine nella posizione file specificata. |
| [save(file_path, options)](#save_file_path_options_59) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_60) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save(file_path, over_write)](#save_file_path_over_write_61) | Salva i dati dell'oggetto nella posizione file specificata. |
| [save(stream)](#save_stream_62) | Salva i dati. |
| [save(stream, options_base)](#save_stream_options_base_63) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_64) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_to_stream(stream)](#save_to_stream_stream_65) | Salva i dati dell'oggetto nello stream specificato. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_66) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_67) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_68) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_69) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_70) | Personalizza le palette di immagine per ottenere schemi di colore unici e migliorare l'appeal visivo. <br/>            Adatta i colori per effetti specifici e ottimizza la qualità dell'immagine su diverse <br/>            piattaforme e dispositivi con facilità. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_71) | Cerca di impostare un'istanza _metadata_, se questa istanza di [Image](/imaging/python-net/aspose.imaging/image/) supporta e implementa l'istanza [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
...
Recupera l'anteprima esistente nel _format_ specificato o <br/>            restituisce **None** se non ne viene trovata alcuna. Questo metodo offre flessibilità nell'<br/>            accesso alle anteprime adattate a formati specifici, ottimizzando la compatibilità e la <br/>            gestione delle risorse nelle applicazioni.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| format | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | Il formato dell'anteprima EPS. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | L'anteprima esistente o **None**. |
...
Accede alle anteprime collegate all'istanza [EpsImage](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/), consentendo <br/>            un recupero fluido per l'ispezione o l'utilizzo nelle applicazioni. Questo metodo <br/>            fornisce un accesso comodo alle anteprime, migliorando l'interazione dell'utente con i <br/>            dati dell'immagine.

**Returns**

| Tipo | Descrizione |
| :- | :- |
| System.Collections.Generic.IEnumerable`1[[Aspose.Imaging.Image]] | Le anteprime. |
...
Personalizza le palette di immagine per ottenere schemi di colore unici e migliorare l'appeal visivo. <br/>            Adatta i colori per effetti specifici e ottimizza la qualità dell'immagine su diverse <br/>            piattaforme e dispositivi con facilità.
...
with aspycore.as_of(Image.load("Sample.eps"), EpsImage) as image:
	...
	# Renderizza l'immagine raster utilizzando il PostScript
