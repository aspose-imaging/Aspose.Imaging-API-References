...
type: docs
weight: 40
url: /it/python-net/aspose.imaging.watermark/watermarkremover/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [paint_over(source, options)](#paint_over_source_options_1) | Rimuovi la filigrana dall'immagine raster. |
...
Rimuovi la filigrana dall'immagine raster.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| source | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | L'immagine raster di origine. |
| options | [WatermarkOptions](/imaging/python-net/aspose.imaging.watermark.options/watermarkoptions/) | Le opzioni della filigrana. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | L'immagine risultante. |
