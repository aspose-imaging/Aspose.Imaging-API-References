---
title: "Classe Html5CanvasOptions"
type: docs
weight: 130
url: /it/python-net/aspose.imaging.imageoptions/html5canvasoptions/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [Html5CanvasOptions()](#Html5CanvasOptions__1) | Inizializza una nuova istanza della classe [Html5CanvasOptions](/imaging/python-net/aspose.imaging.imageoptions/html5canvasoptions/). |
## **Properties**
...
| canvas_tag_id | string | r/w | Ottiene o imposta l'identificatore del tag canvas. |
| eliminato | bool | r | Ottiene un valore che indica se questa istanza è stata eliminata. |
| encoding | string | r/w | Ottiene o imposta la codifica. |
...
| full_html_page | bool | r/w | Ottiene o imposta un valore che indica se la pagina HTML completa deve essere generata. |
...
Inizializza una nuova istanza della classe [Html5CanvasOptions](/imaging/python-net/aspose.imaging.imageoptions/html5canvasoptions/).
