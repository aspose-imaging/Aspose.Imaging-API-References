...
type: docs
weight: 40
url: /it/python-net/aspose.imaging.exif/jpegexifdata/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [JpegExifData()](#JpegExifData__1) | Inizializza una nuova istanza della classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/). |
| [JpegExifData(common_tags, exif_tags, gps_tags)](#JpegExifData_common_tags_exif_tags_gps_tags_2) | Inizializza una nuova istanza della classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) con dati provenienti dall'array. |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_3) | Inizializza una nuova istanza della classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) con dati provenienti dall'array. |
| [JpegExifData(exifdata)](#JpegExifData_exifdata_4) | Inizializza una nuova istanza della classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) con dati provenienti dall'array. |
## **Properties**
...
| compressione | int | r/w | Ottiene o imposta la compressione. |
...
| data_ora | string | r/w | Ottiene o imposta la data e ora. |
...
| maker_notes | [MakerNote[]](/imaging/python-net/aspose.imaging.exif/makernote/) | r | Ottiene le note del produttore. |
...
| modello | string | r/w | Ottiene o imposta il modello. |
...
| interpretazione_fotometrica | int | r/w | Ottiene o imposta l'interpretazione fotometrica. |
...
| configurazione_planare | int | r/w | Ottiene o imposta la configurazione planare. |
| primary_chromaticities | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Ottiene o imposta la cromaticità dei tre colori primari dell'immagine. |
...
| reference_black_white | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Ottiene o imposta il riferimento bianco e nero. |
| related_sound_file | string | r/w | Ottiene o imposta il file audio correlato. |
| resolution_unit | [ExifUnit](/imaging/python-net/aspose.imaging.exif.enums/exifunit/) | r/w | Ottiene o imposta l'unità di risoluzione. |
| campioni_per_pixel | int | r/w | Ottiene o imposta i campioni per pixel. |
...
| transfer_function | int[] | r/w | Ottiene o imposta la funzione di trasferimento. |
...
| x_resolution | [TiffRational](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Ottiene o imposta la risoluzione x. |
| y_cb_cr_coefficients | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Ottiene o imposta i coefficienti della matrice per la trasformazione da dati immagine RGB a YCbCr. |
| y_cb_cr_positioning | [ExifYCbCrPositioning](/imaging/python-net/aspose.imaging.exif.enums/exifycbcrpositioning/) | r/w | Ottiene o imposta la posizione dei componenti di crominanza rispetto al componente di luminanza. |
| y_cb_cr_sub_sampling | int[] | r/w | Ottiene o imposta il rapporto di campionamento dei componenti di crominanza rispetto al componente di luminanza. |
| y_resolution | [TiffRational](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Ottiene o imposta la risoluzione y. |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
...
| [serialize_exif_data()](#serialize_exif_data__6) | Serializza i dati EXIF. Scrive i valori e i contenuti dei tag. Il tag di dimensione più influente è il contenuto del tag Thumbnail. |
...
Inizializza una nuova istanza della classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/).
...
Inizializza una nuova istanza della classe [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) con dati provenienti dall'array.
...
| Tipo | Descrizione |
| :- | :- |
| System.Byte | I dati EXIF serializzati. |
