---
title: "Classe AvifImage"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.avif/avifimage/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [AvifImage()](#AvifImage__1) | Inizializza una nuova istanza della classe AvifImage |
## **Properties**
...
| bits_per_pixel | int | r | Restituisce il valore dei bit per pixel. |
...
| height | int | r | Restituisce l'altezza dell'immagine AVIF. |
...
| width | int | r | Restituisce la larghezza dell'immagine AVIF. |
...
Inizializza una nuova istanza della classe AvifImage
