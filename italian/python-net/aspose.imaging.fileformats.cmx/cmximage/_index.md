...
type: docs
weight: 90
url: /it/python-net/aspose.imaging.fileformats.cmx/cmximage/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [CmxImage(stream_container, load_options)](#CmxImage_stream_container_load_options_1) | Inizia a lavorare con la classe [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) in modo fluido inizializzando<br/>            una nuova istanza con i parametri streamContainer e loadOptions. Ideale per gli sviluppatori<br/>            che cercano un modo comodo per caricare immagini CMX da varie fonti di dati mentre<br/>            personalizzano il processo di caricamento secondo le necessità. |
## **Properties**
...
| bits_per_pixel | int | r | Recupera facilmente la profondità di bit dell'immagine con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano determinare il livello di dettaglio o la profondità di colore<br/>            presente nelle loro immagini, garantendo una elaborazione e manipolazione precise. |
...
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | r | Recupera facilmente la pagina CMX dell'immagine con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che cercano un accesso rapido alle singole pagine all'interno delle immagini CMX,<br/>            garantendo una navigazione e gestione efficienti. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Recupera facilmente la pagina predefinita dell'immagine con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che cercano un accesso rapido alla pagina principale della loro immagine,<br/>            garantendo una navigazione e gestione efficienti. |
| eliminato | bool | r | Ottiene un valore che indica se questa istanza è stata eliminata. |
| document | [CmxDocument](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxdocument/) | r | Recupera facilmente il documento CMX con questa proprietà intuitiva. Ideale per<br/>            gli sviluppatori che desiderano accedere o modificare immagini CMX, garantendo flessibilità e<br/>            efficienza nelle loro applicazioni. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Ottiene o imposta l'istanza Exif. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Recupera facilmente il formato file dell'immagine con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano determinare dinamicamente il formato delle loro immagini,<br/>            garantendo compatibilità e una corretta elaborazione nelle loro applicazioni. |
...
| height_f | float | r | Ottieni facilmente l'altezza dell'oggetto, misurata in pollici, con questa<br/>            proprietà intuitiva. Ideale per gli sviluppatori che cercano informazioni dimensionali precise<br/>            per una disposizione e presentazione efficaci nelle loro applicazioni. |
...
| is_cached | bool | r | Determina se i dati dell'oggetto sono attualmente nella cache, eliminando la necessità<br/>            di leggere i dati. Ideale per gli sviluppatori che desiderano ottimizzare le prestazioni sfruttando<br/>            i dati memorizzati nella cache in modo efficiente, garantendo un accesso più rapido alle informazioni dell'oggetto. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Ottiene i metadati dell'immagine. |
| page_count | int | r | Recupera il conteggio totale delle pagine dell'immagine con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano gestire dinamicamente immagini multipagina,<br/>            garantendo una navigazione e manipolazione efficienti del contenuto dell'immagine. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Recupera le pagine dell'immagine in modo fluido con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano accedere e manipolare singole pagine<br/>            all'interno di immagini multipagina, garantendo una navigazione e un'elaborazione efficienti. |
...
| width_f | float | r | Recupera la larghezza dell'oggetto in pollici con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che cercano misurazioni precise degli oggetti nelle loro applicazioni,<br/>            garantendo una disposizione e presentazione accurate. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Ottiene o imposta i dati Xmp. |
## **Methods**
| **Name** | **Descrizione** |
| :- | :- |
| cache_data() | Metti nella cache i dati per evitare ulteriori caricamenti dalla fonte sottostante<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/)<br/>            con questo metodo comodo. Ideale per gli sviluppatori che desiderano ottimizzare le prestazioni<br/>            pre-caricando i dati, garantendo un accesso più rapido e un funzionamento più fluido nelle loro applicazioni. |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_68) | Personalizza la tavolozza dei colori dell'immagine con questo metodo intuitivo. Ideale per<br/>            gli sviluppatori che desiderano applicare schemi di colore o regolazioni specifiche in modo dinamico,<br/>            garantendo un controllo preciso sull'aspetto visivo delle loro immagini. |
...
Inizia a lavorare con la classe [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) in modo fluido inizializzando<br/>            una nuova istanza con i parametri streamContainer e loadOptions. Ideale per gli sviluppatori<br/>            che cercano un modo comodo per caricare immagini CMX da varie fonti di dati mentre<br/>            personalizzano il processo di caricamento secondo le necessità.
...
Recupera le pagine dell'immagine in modo fluido con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano accedere e manipolare singole pagine<br/>            all'interno di immagini multipagina, garantendo una navigazione e un'elaborazione efficienti.
...
Personalizza la tavolozza dei colori dell'immagine con questo metodo intuitivo. Ideale per<br/>            gli sviluppatori che desiderano applicare schemi di colore o regolazioni specifiche in modo dinamico,<br/>            garantendo un controllo preciso sull'aspetto visivo delle loro immagini.
...
with aspycore.as_of(Image.load(join(dir_, "sample.cmx")), CmxImage) as image:
	...
	image.cache_data()
	# Memorizza nella cache tutte le pagine in modo che non vengano effettuati ulteriori caricamenti di dati dal flusso di dati sottostante.
