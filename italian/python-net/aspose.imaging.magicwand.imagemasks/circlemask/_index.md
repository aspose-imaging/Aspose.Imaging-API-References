---
title: "Classe CircleMask"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.magicwand.imagemasks/circlemask/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [CircleMask(center, radius)](#CircleMask_center_radius_1) | Inizializza una nuova istanza della classe [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) con il punto centrale e il raggio specificati. |
| [CircleMask(x, y, radius)](#CircleMask_x_y_radius_2) | Inizializza una nuova istanza della classe [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) con il punto centrale e il raggio specificati. |
## **Properties**
...
| selection_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Restituisce i limiti, in pixel, di questa maschera. |
...
Inizializza una nuova istanza della classe [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) con il punto centrale e il raggio specificati.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| center | [Point](/imaging/python-net/aspose.imaging/point/) | Il punto centrale dell'area selezionata. |
| raggio | int | Raggio dell'area selezionata. |
...
| Tipo | Descrizione |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una CircleMask o ImageBitMask ritagliata come ImageMask.<br/>            Poiché può essere restituita una ImageBitMask, si consiglia una chiamata fluente. |
...
| Tipo | Descrizione |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una CircleMask gonfiata come ImageMask. |
