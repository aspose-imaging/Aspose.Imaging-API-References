...
type: docs
weight: 50
url: /it/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [ImageBitMask(image)](#ImageBitMask_image_1) | Inizializza una nuova istanza della classe [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con le dimensioni della [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) esistente specificata.<br/>            La [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) specificata verrà memorizzata come immagine sorgente. |
| [ImageBitMask(width, height)](#ImageBitMask_width_height_2) | Inizializza una nuova istanza della classe [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con la larghezza e l'altezza specificate. |
## **Properties**
...
| [get(x, y)](#get_x_y_9) | Ottiene la posizione nell'array di memorizzazione del pixel specificato. |
...
| [set_mask_pixel(x, y, value)](#set_mask_pixel_x_y_value_19) | Imposta l'opacità del pixel specificato. |
| [subtract(image, settings)](#subtract_image_settings_20) | Restituisce il risultato della selezione bacchetta magica applicata all'immagine fornita sottratto dalla maschera corrente. |
| [subtract(mask)](#subtract_mask_21) | Restituisce la sottrazione della maschera fornita dalla corrente. |
| [subtract(settings)](#subtract_settings_22) | Restituisce il risultato della selezione bacchetta magica applicata alla sorgente della maschera corrente sottratto dalla maschera. |
| [union(image, settings)](#union_image_settings_23) | Restituisce l'unione della maschera corrente con il risultato della selezione bacchetta magica applicata all'immagine fornita. |
| [union(mask)](#union_mask_24) | Restituisce l'unione della maschera corrente con quella fornita. |
| [union(settings)](#union_settings_25) | Restituisce l'unione della maschera corrente con il risultato della selezione bacchetta magica applicata alla sorgente della maschera. |
...
Inizializza una nuova istanza della classe [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con le dimensioni della [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) esistente specificata.<br/>            La [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) specificata verrà memorizzata come immagine sorgente.
...
Inizializza una nuova istanza della classe [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) con la larghezza e l'altezza specificate.
...
| Tipo | Descrizione |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) ritagliata come [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
Ottiene la posizione nell'array di memorizzazione del pixel specificato.
...
| Tipo | Descrizione |
| :- | :- |
| bool | Valore int, che rappresenta la posizione nella memorizzazione. |
...
| Tipo | Descrizione |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Una [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) gonfiata come [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
| x | int | La coordinata x del pixel. |
| y | int | La coordinata y del pixel. |
| valore | bool | true se il pixel specificato è opaco; altrimenti, false. |
