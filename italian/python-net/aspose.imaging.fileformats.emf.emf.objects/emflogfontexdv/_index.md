...
type: docs
weight: 150
url: /it/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [EmfLogFontExDv(emf_log_font_ex)](#EmfLogFontExDv_emf_log_font_ex_1) | Inizializza una nuova istanza della classe [EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/). |
## **Properties**
...
| design_vector | [EmfDesignVector](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfdesignvector/) | r/w | Ottiene o imposta un oggetto DesignVector (sezione 2.2.3). Questo campo NON DEVE superare i 72 byte. |
...
Inizializza una nuova istanza della classe [EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/).

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| emf_log_font_ex | [EmfLogFontEx](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontex/) | L'esempio di log font EMF. |
