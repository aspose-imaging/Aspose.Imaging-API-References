...
type: docs
weight: 100
url: /it/python-net/aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [EmfHeaderExtension2()](#EmfHeaderExtension2__1) | Inizializza una nuova istanza della classe EmfHeaderExtension2 |
## **Properties**
...
| micrometers_x | int | r/w | Ottiene o imposta la dimensione orizzontale a 32 bit del dispositivo di visualizzazione per il quale è stata generata l'immagine del metafile, in micrometri |
| micrometers_y | int | r/w | Ottiene o imposta la dimensione verticale a 32 bit del dispositivo di visualizzazione per il quale è stata generata l'immagine del metafile, in micrometri. |
...
Inizializza una nuova istanza della classe EmfHeaderExtension2
