---
title: "Classe PathResource"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.tiff.pathresources/pathresource/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [PathResource()](#PathResource__1) | Inizializza una nuova istanza della classe PathResource |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| block_id | int | r/w | Ottiene o imposta l'identificatore del blocco. |
| nome | string | r/w | Ottiene o imposta il nome. |
| record | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Core.VectorPaths.VectorPathRecord]] | r/w | Ottiene o imposta i record. |
...
Inizializza una nuova istanza della classe PathResource
