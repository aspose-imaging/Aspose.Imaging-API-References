...
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [BigTiffReader(data)](#BigTiffReader_data_1) | Inizializza una nuova istanza della classe [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
| [BigTiffReader(data, start_index)](#BigTiffReader_data_start_index_2) | Inizializza una nuova istanza della classe [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
| [BigTiffReader(data, start_index, data_length)](#BigTiffReader_data_start_index_data_length_3) | Inizializza una nuova istanza della classe [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
| [BigTiffReader(stream_container)](#BigTiffReader_stream_container_4) | Inizializza una nuova istanza della classe [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/). |
## **Properties**
...
Inizializza una nuova istanza della classe [BigTiffReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement.bigtiff/bigtiffreader/).
