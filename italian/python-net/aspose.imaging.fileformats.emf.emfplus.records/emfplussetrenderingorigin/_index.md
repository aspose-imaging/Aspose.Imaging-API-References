---
title: "Classe EmfPlusSetRenderingOrigin"
type: docs
weight: 540
url: /it/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [EmfPlusSetRenderingOrigin(source)](#EmfPlusSetRenderingOrigin_source_1) | Inizializza una nuova istanza della classe [EmfPlusSetRenderingOrigin](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/). |
## **Properties**
...
| x | int | r/w | Ottiene o imposta un intero senza segno a 32 bit che definisce il valore della coordinata orizzontale dell'origine di rendering. |
| y | int | r/w | Ottiene o imposta un intero senza segno a 32 bit che definisce il valore della coordinata verticale dell'origine di rendering. |
...
Inizializza una nuova istanza della classe [EmfPlusSetRenderingOrigin](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/).
