...
type: docs
weight: 80
url: /it/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [TiffStreamReader(data)](#TiffStreamReader_data_1) | Inizializza una nuova istanza della classe [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
| [TiffStreamReader(data, start_index)](#TiffStreamReader_data_start_index_2) | Inizializza una nuova istanza della classe [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
| [TiffStreamReader(data, start_index, data_length)](#TiffStreamReader_data_start_index_data_length_3) | Inizializza una nuova istanza della classe [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
| [TiffStreamReader(stream_container)](#TiffStreamReader_stream_container_4) | Inizializza una nuova istanza della classe [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/). |
## **Properties**
...
Inizializza una nuova istanza della classe [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/).
