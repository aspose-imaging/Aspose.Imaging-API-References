---
title: "Classe DjvuPage"
type: docs
weight: 20
url: /it/python-net/aspose.imaging.fileformats.djvu/djvupage/
---
...
| height | int | r | Restituisce l'altezza della pagina |
...
| image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r | Ottiene l'immagine. |
...
| is_color | bool | r | Restituisce un valore che indica se questa istanza è a colori. |
...
| page_number | int | r | Restituisce il numero di pagina. |
...
| parent_image | [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | r | Restituisce l'immagine padre a cui appartiene la pagina |
...
| thumbnail_image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r/w | Restituisce o imposta l'immagine miniatura per la pagina |
...
| width | int | r | Restituisce la larghezza della pagina |
...
| [extract_thumbnail_image()](#extract_thumbnail_image__35) | Estrae l'immagine miniatura dalla pagina Djvu. |
| [filter(rectangle, options)](#filter_rectangle_options_36) | Filtra il rettangolo specificato. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_37) | Ottiene un pixel ARGB a 32 bit dell'immagine. |
| [get_background_image()](#get_background_image__38) | Restituisce l'immagine di sfondo. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_49) | Restituisce l'immagine di primo piano per la pagina |
| [get_modify_date(use_default)](#get_modify_date_use_default_50) | Ottiene la data e l'ora dell'ultima modifica dell'immagine di risorsa. |
...
| [get_pixel(x, y)](#get_pixel_x_y_52) | Ottiene un pixel dell'immagine. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_53) | Ottiene un'altezza proporzionale. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_54) | Ottiene una larghezza proporzionale. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_55) | Converte in aps. |
| [get_skew_angle()](#get_skew_angle__56) | Ottiene l'angolo di inclinazione.<br/>            Questo metodo è applicabile ai documenti di testo scansionati, per determinare l'angolo di inclinazione durante la scansione. |
| [get_text_for_location(rect)](#get_text_for_location_rect_57) | Restituisce il testo per la posizione del rettangolo |
| [get_text_image(subsample)](#get_text_image_subsample_58) | Restituisce l'immagine del testo. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | Ridimensiona l'immagine della pagina alle nuove dimensioni |
...
| [save(stream)](#save_stream_105) | Salva i dati. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_121) | Imposta la risoluzione per questo [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| Tipo | Descrizione |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | L'immagine raster Djvu. |
...
Restituisce l'immagine di sfondo.

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Il bitmap |
...
Restituisce l'immagine di primo piano per la pagina
...
| Tipo | Descrizione |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Immagine bitmap |
...
Restituisce il testo per la posizione del rettangolo

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Il rettangolo di posizione. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| string | Testo trovato nella posizione |
...
Restituisce l'immagine del testo.
...
Ridimensiona l'immagine della pagina alle nuove dimensioni
