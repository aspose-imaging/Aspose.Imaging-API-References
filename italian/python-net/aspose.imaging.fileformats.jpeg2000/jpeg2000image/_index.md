---
title: "Jpeg2000Image Classe"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [Jpeg2000Image(image)](#Jpeg2000Image_image_1) | Istanzia una nuova classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) con un'immagine raster. Questo <br/> costruttore facilita la creazione di un'immagine JPEG2000 da un'immagine raster esistente, offrendo un'integrazione fluida e la conversione tra diversi formati di immagine. |
| [Jpeg2000Image(path)](#Jpeg2000Image_path_2) | Inizia a lavorare con la classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) inizializzando una nuova <br/> istanza con il percorso dell'immagine che desideri caricare. Questo costruttore consente un facile <br/> accesso alle immagini JPEG2000, semplificando il processo di caricamento e gestione dei file <br/> immagine. Fornendo il percorso del file, puoi rapidamente iniziare a elaborare e <br/> manipolare le immagini JPEG2000 nella tua applicazione. |
| [Jpeg2000Image(path, bits_per_pixel)](#Jpeg2000Image_path_bits_per_pixel_3) | Inizia facilmente con la classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) creando una nuova <br/> istanza con sia il percorso del file sia il parametro dei bit per pixel desiderato. Questo <br/> costruttore consente di affinare il processo di caricamento dell'immagine, garantendo <br/> la compatibilità con vari formati di immagine e impostazioni di qualità. Con questa <br/> flessibilità, puoi gestire ed elaborare efficientemente le immagini JPEG2000 secondo <br/> i tuoi requisiti specifici. |
| [Jpeg2000Image(raster_image, bits_per_pixel)](#Jpeg2000Image_raster_image_bits_per_pixel_4) | Inizializza una nuova istanza di [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) con un'immagine raster e <br/> parametri dei bit per pixel. Questo costruttore consente un controllo preciso sulla <br/> qualità e le dimensioni dell'immagine JPEG2000 risultante, rendendola ideale per scenari <br/> in cui la personalizzazione è fondamentale. |
| [Jpeg2000Image(stream)](#Jpeg2000Image_stream_5) | Inizializza facilmente una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) fornendo un oggetto stream. Questo costruttore semplifica il processo di caricamento <br/> delle immagini JPEG2000 direttamente da stream, offrendo flessibilità e praticità per <br/> la gestione dei dati immagine provenienti da varie fonti. |
| [Jpeg2000Image(stream, bits_per_pixel)](#Jpeg2000Image_stream_bits_per_pixel_6) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) con uno stream per <br/> caricare l'immagine, insieme ai parametri dei bit per pixel. Questo costruttore offre <br/> flessibilità consentendo di specificare sia la sorgente dei dati immagine sia i <br/> bit per pixel desiderati, fornendo un controllo più fine sul processo di caricamento dell'immagine. |
| [Jpeg2000Image(width, height)](#Jpeg2000Image_width_height_7) | Crea una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) specificando i parametri di <br/> larghezza e altezza. Questo costruttore consente di inizializzare un'immagine JPEG2000 <br/> con dimensioni specifiche, utile per scenari in cui è necessario <br/> creare programmaticamente un'immagine di una certa dimensione. |
| [Jpeg2000Image(width, height, bits_count)](#Jpeg2000Image_width_height_bits_count_8) | Crea una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) con parametri per <br/> larghezza, altezza e conteggio dei bit. Questo costruttore consente la creazione di immagini JPEG2000 <br/> con dimensioni e profondità di bit specifiche, offrendo flessibilità per varie <br/> esigenze di imaging. |
| [Jpeg2000Image(width, height, options)](#Jpeg2000Image_width_height_options_9) | Istanzia un nuovo oggetto [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) fornendo i parametri di larghezza, altezza, <br/> e opzioni immagine. Questo costruttore consente la creazione di immagini JPEG2000 <br/> con dimensioni specifiche e opzioni aggiuntive, offrendo flessibilità nella <br/> generazione dell'immagine. |
## **Properties**
...
| bits_per_pixel | int | r | Questa proprietà restituisce la profondità dell'immagine, misurata in bit per pixel (bpp). Indica <br/> la quantità di informazioni di colore memorizzate in ciascun pixel dell'immagine. <br/> Comprendere la profondità dell'immagine è fondamentale per determinare la fedeltà del colore e <br/> la qualità dell'immagine. Con queste informazioni, gli utenti possono valutare il livello di dettaglio <br/> e la ricchezza dei colori presenti nell'immagine. |
...
| codec | [Jpeg2000Codec](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000codec/) | r | Questa proprietà recupera il codec JPEG2000 associato all'immagine. Il codec JPEG2000 <br/> è responsabile della codifica e decodifica dei dati dell'immagine nel formato JPEG2000, <br/> fornendo una compressione efficiente mantenendo alta la qualità dell'immagine. <br/> Accedere a questo codec può essere utile per eseguire operazioni avanzate di elaborazione <br/> delle immagini o ottimizzare le impostazioni di compressione dell'immagine su misura per requisiti specifici. |
| commenti | string[] | r/w | Questa proprietà consente di recuperare o aggiornare i commenti associati all'immagine. I commenti forniscono informazioni aggiuntive sul contenuto dell'immagine, come <br/> annotazioni, descrizioni o metadati. Modificare questi commenti può essere utile per <br/> organizzare e categorizzare le immagini, nonché per trasmettere dettagli importanti a <br/> spettatori o utenti. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Recupera il formato del file immagine. Questa proprietà fornisce informazioni sul <br/> formato del file dell'immagine. Utilizza questa proprietà per determinare programmaticamente il formato del <br/> file immagine, facilitando una gestione e un'elaborazione appropriate in base al <br/> formato del file. |
...
| height | int | r | Questa proprietà recupera l'altezza dell'immagine in pixel. Fornisce informazioni essenziali <br/> per comprendere le dimensioni verticali dell'immagine, aiutando in varie <br/> operazioni di manipolazione dell'immagine come ridimensionamento, ritaglio e rendering. Accedendo a questa <br/> proprietà gli utenti possono determinare la dimensione verticale dell'immagine, consentendo layout e visualizzazione precisi nelle applicazioni. |
| horizontal_resolution | float | r/w | Questa proprietà consente di recuperare o modificare la risoluzione orizzontale del<br/> [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) misurata in pixel per pollice (PPI). Regolare questa <br/> risoluzione può influire sulla dimensione e sulla qualità dell'immagine quando stampata o visualizzata. <br/> Impostando la risoluzione orizzontale, gli utenti possono ottimizzare l'immagine per dispositivi di <br/> output specifici o applicazioni, garantendo i migliori risultati visivi possibili. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Questa proprietà recupera il formato dei dati grezzi dell'immagine. Fornisce informazioni <br/> su come i dati dei pixel sono memorizzati in memoria. Usa questa proprietà per comprendere il <br/> formato dei dati sottostante dell'immagine, che può essere cruciale per varie operazioni di <br/> elaborazione delle immagini come conversione del colore, compressione o decompressione. |
...
| raw_line_size | int | r | Questa proprietà recupera la dimensione di una singola riga di dati grezzi dell'immagine in byte. Indica <br/> la quantità di memoria occupata da una singola riga di pixel nel formato dei dati grezzi dell'immagine. Comprendere la dimensione della riga grezza è essenziale per attività come <br/> l'allocazione della memoria, la manipolazione dei dati e gli algoritmi di elaborazione delle immagini che operano <br/> su singole righe dell'immagine. |
...
| vertical_resolution | float | r/w | Questa proprietà fornisce l'accesso alla risoluzione verticale del<br/> [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) misurata in pixel per pollice (PPI). Modificare questa <br/> risoluzione può influire sulla qualità e sulla dimensione dell'immagine quando stampata o visualizzata. <br/> Regolando la risoluzione verticale, gli utenti possono ottimizzare l'immagine per diversi <br/> dispositivi di output o applicazioni, garantendo una resa visiva ottimale. |
| width | int | r | Questa proprietà restituisce la larghezza dell'immagine in pixel. Fornisce una informazione fondamentale <br/> sulle dimensioni dell'immagine, cruciale per varie attività di elaborazione delle immagini, <br/> inclusi ridimensionamento, ritaglio e rendering. |
...
| [create_from_file_with_bpp(path, bits_per_pixel)](#create_from_file_with_bpp_path_bits_per_pixel_26) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
...
| [create_from_image(image)](#create_from_image_image_29) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_from_image_with_bpp(raster_image, bits_per_pixel)](#create_from_image_with_bpp_raster_image_bits_per_pixel_30) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_from_stream_with_bpp(stream, bits_per_pixel)](#create_from_stream_with_bpp_stream_bits_per_pixel_34) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_35) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_with_width_height_bitscount(width, height, bits_count)](#create_with_width_height_bitscount_width_height_bits_count_36) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_with_width_height_options(width, height, options)](#create_with_width_height_options_width_height_options_37) | Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_38) | Ritaglia l'immagine con spostamenti. |
| [crop(rectangle)](#crop_rectangle_39) | Ritaglio dell'immagine. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_40) | Esegue il dithering sull'immagine corrente. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_41) | Esegue il dithering sull'immagine corrente. |
| [embed_digital_signature(password)](#embed_digital_signature_password_42) | Incorpora una firma digitale basata sulla password fornita nell'immagine usando la steganografia. |
| [filter(rectangle, options)](#filter_rectangle_options_43) | Filtra il rettangolo specificato. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_44) | Ottiene un pixel ARGB a 32 bit dell'immagine. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_45) | Ottiene l'array predefinito di pixel ARGB a 32 bit. |
| [get_default_options(args)](#get_default_options_args_46) | Ottiene le opzioni predefinite. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_47) | Ottiene l'array predefinito di pixel usando il caricatore di pixel parziale. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_48) | Ottiene l'array predefinito di dati grezzi usando il caricatore di pixel parziale. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_49) | Ottiene l'array predefinito di dati grezzi. |
| [get_file_format(file_path)](#get_file_format_file_path_50) | Ottiene il formato del file. |
| [get_file_format(stream)](#get_file_format_stream_51) | Ottiene il formato del file. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_52) | Ottiene il formato del file. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_53) | Ottiene il rettangolo che si adatta all'immagine corrente. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_54) | Ottiene il rettangolo che si adatta all'immagine corrente. |
| [get_modify_date(use_default)](#get_modify_date_use_default_55) | Ottiene la data e l'ora dell'ultima modifica dell'immagine di risorsa. |
| [get_original_options()](#get_original_options__56) | Recupera le opzioni dell'immagine basate sulle impostazioni del file originale. Questo metodo è <br/> utile per mantenere la profondità di bit e altri parametri dell'immagine originale, garantendo coerenza e preservando l'integrità dei dati dell'immagine. <br/> Accedere a queste opzioni facilita una gestione e un'elaborazione fluide dell'immagine <br/> mantenendo le sue caratteristiche originali.<br/> Ad esempio, se carichiamo un'immagine PNG in bianco e nero con 1 bit per pixel e poi la salviamo usando il<br/> metodo [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/), verrà prodotto un PNG di output con 8 bit per pixel.<br/> Per evitarlo e salvare l'immagine PNG con 1 bit per pixel, utilizza questo metodo per ottenere le opzioni di salvataggio corrispondenti e passale<br/> al metodo [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) come secondo parametro. |
| [get_pixel(x, y)](#get_pixel_x_y_57) | Ottiene un pixel dell'immagine. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_58) | Ottiene un'altezza proporzionale. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_59) | Ottiene una larghezza proporzionale. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_60) | Converte in aps. |
| [get_skew_angle()](#get_skew_angle__61) | Ottiene l'angolo di inclinazione.<br/>            Questo metodo è applicabile ai documenti di testo scansionati, per determinare l'angolo di inclinazione durante la scansione. |
...
| [load(stream, load_options)](#load_stream_load_options_66) | Carica una nuova immagine dallo stream specificato. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_80) | Normalizza l'angolo.<br/>            Questo metodo è applicabile ai documenti di testo scansionati per eliminare la scansione inclinata.<br/>            Questo metodo utilizza i metodi [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) e [RasterImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_83) | Sostituisce un colore con un altro con differenza consentita e preserva il valore alfa originale per mantenere bordi lisci. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_84) | Sostituisce un colore con un altro con differenza consentita e preserva il valore alfa originale per mantenere bordi lisci. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_85) | Sostituisce un colore con un altro con differenza consentita e preserva il valore alfa originale per mantenere bordi lisci. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_86) | Sostituisce tutti i colori non trasparenti con un nuovo colore e preserva il valore alfa originale per mantenere bordi lisci.<br/>            Nota: se lo utilizzi su immagini senza trasparenza, tutti i colori saranno sostituiti con un unico colore. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_87) | Sostituisce tutti i colori non trasparenti con un nuovo colore e preserva il valore alfa originale per mantenere bordi lisci.<br/>            Nota: se lo utilizzi su immagini senza trasparenza, tutti i colori saranno sostituiti con un unico colore. |
| [resize(new_width, new_height)](#resize_new_width_new_height_88) | Ridimensiona l'immagine. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_89) | Ridimensiona l'immagine. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_90) | Ridimensiona l'immagine. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_91) | Ridimensiona l'immagine. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_92) | Ridimensiona l'immagine. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_93) | Ridimensiona l'altezza proporzionalmente. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_94) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_95) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_96) | Ridimensiona l'altezza proporzionalmente. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_97) | Ridimensiona la larghezza proporzionalmente. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_98) | Ridimensiona la larghezza proporzionalmente. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_99) | Ridimensiona la larghezza proporzionalmente. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_100) | Ridimensiona la larghezza proporzionalmente. |
| [rotate(angle)](#rotate_angle_101) | Ruota l'immagine attorno al centro. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_102) | Ruota l'immagine attorno al centro. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_103) | Ruota, capovolge o ruota e capovolge l'immagine. |
| save() | Salva i dati dell'immagine nello stream sottostante. |
| [save(file_path)](#save_file_path_104) | Salva l'immagine nella posizione file specificata. |
| [save(file_path, options)](#save_file_path_options_105) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_106) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save(file_path, over_write)](#save_file_path_over_write_107) | Salva i dati dell'oggetto nella posizione file specificata. |
| [save(stream)](#save_stream_108) | Salva i dati dell'oggetto nello stream specificato |
| [save(stream, options_base)](#save_stream_options_base_109) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_110) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_111) | Salva i pixel ARGB a 32 bit. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_112) | Salva i pixel. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_113) | Salva i pixel.<br/>            Questo metodo è deprecato. Si prega di utilizzare in modo più efficace il metodo [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_114) | Salva i pixel (metodo specifico del formato). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_115) | Salva i dati grezzi. |
| [save_to_stream(stream)](#save_to_stream_stream_116) | Salva i dati dell'oggetto nello stream specificato. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_117) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_118) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_119) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_120) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_121) | Imposta un pixel immagine a 32 bit ARGB per la posizione specificata. |
...
Inizia facilmente con la classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) creando una nuova <br/> istanza con sia il percorso del file sia il parametro dei bit per pixel desiderato. Questo <br/> costruttore consente di affinare il processo di caricamento dell'immagine, garantendo <br/> la compatibilità con vari formati di immagine e impostazioni di qualità. Con questa <br/> flessibilità, puoi gestire ed elaborare efficientemente le immagini JPEG2000 secondo <br/> i tuoi requisiti specifici.
...
Inizializza una nuova istanza di [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) con un'immagine raster e <br/> parametri dei bit per pixel. Questo costruttore consente un controllo preciso sulla <br/> qualità e le dimensioni dell'immagine JPEG2000 risultante, rendendola ideale per scenari <br/> in cui la personalizzazione è fondamentale.
...
Inizializza facilmente una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) fornendo un oggetto stream. Questo costruttore semplifica il processo di caricamento <br/> delle immagini JPEG2000 direttamente da stream, offrendo flessibilità e praticità per <br/> la gestione dei dati immagine provenienti da varie fonti.
...
Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) con uno stream per <br/> caricare l'immagine, insieme ai parametri dei bit per pixel. Questo costruttore offre <br/> flessibilità consentendo di specificare sia la sorgente dei dati immagine sia i <br/> bit per pixel desiderati, fornendo un controllo più fine sul processo di caricamento dell'immagine.
...
Crea una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) specificando i parametri di <br/> larghezza e altezza. Questo costruttore consente di inizializzare un'immagine JPEG2000 <br/> con dimensioni specifiche, utile per scenari in cui è necessario <br/> creare programmaticamente un'immagine di una certa dimensione.
...
| width | int | La larghezza dell'immagine |
| height | int | L'altezza dell'immagine |
| bits_count | int | Il conteggio dei bit. |
...
Istanzia un nuovo oggetto [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) fornendo i parametri di larghezza, altezza, <br/> e opzioni immagine. Questo costruttore consente la creazione di immagini JPEG2000 <br/> con dimensioni specifiche e opzioni aggiuntive, offrendo flessibilità nella <br/> generazione dell'immagine.
...
| width | int | La larghezza dell'immagine |
| height | int | L'altezza dell'immagine |
| options | [Jpeg2000Options](/imaging/python-net/aspose.imaging.imageoptions/jpeg2000options/) | Le opzioni. |
...
Inizializza una nuova istanza della classe [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/).
