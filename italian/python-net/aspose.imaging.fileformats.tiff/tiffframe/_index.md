...
type: docs
weight: 170
url: /it/python-net/aspose.imaging.fileformats.tiff/tiffframe/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [TiffFrame(image)](#TiffFrame_image_1) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(image, options)](#TiffFrame_image_options_2) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(options, width, height)](#TiffFrame_options_width_height_3) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path)](#TiffFrame_path_4) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(path, options)](#TiffFrame_path_options_5) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream)](#TiffFrame_stream_6) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [TiffFrame(stream, options)](#TiffFrame_stream_options_7) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
## **Properties**
...
| frame_options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | r | Ottiene le opzioni di creazione del frame. |
...
| [path_resources](#path_resources1) | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Tiff.PathResources.PathResource]] | r/w | Ottiene o imposta le risorse del percorso. |
...
| align_resolutions() | Metodo di supporto per rendere uguali le risoluzioni orizzontale e verticale. |
...
| [copy_frame(tiff_frame)](#copy_frame_tiff_frame_19) | Copia l'intero frame (duplicati). |
| [create(files)](#create_files_20) | Crea l'immagine multipagina contenente i file specificati. |
| [create(files, throw_exception_on_load_error)](#create_files_throw_exception_on_load_error_21) | Crea l'immagine multipagina contenente i file specificati. |
| [create(image_options, width, height)](#create_image_options_width_height_22) | Crea una nuova immagine utilizzando le opzioni di creazione specificate. |
...
| [create(images)](#create_images_24) | Crea una nuova immagine utilizzando le immagini specificate come pagine |
| [create(images, dispose_images)](#create_images_dispose_images_25) | Crea una nuova immagine dalle immagini specificate come pagine. |
| [create(multipage_create_options)](#create_multipage_create_options_26) | Crea le opzioni di creazione multipagina specificate. |
| [create_frame_from(tiff_frame, options)](#create_frame_from_tiff_frame_options_27) | Crea il frame dal _tiffFrame_ specificato utilizzando le _options_ specificate.<br/>            I dati dei pixel sono conservati ma convertiti nel formato desiderato. |
| [create_from_file_with_options(path, options)](#create_from_file_with_options_path_options_28) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_image(image)](#create_from_image_image_31) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_image_with_options(image, options)](#create_from_image_with_options_image_options_32) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_35) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
| [create_from_stream_with_options(stream, options)](#create_from_stream_with_options_stream_options_36) | Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/). |
...
Inizializza una nuova istanza della classe [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/).
...
| :- | :- | :- |
| image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | L'immagine con cui inizializzare i pixel del fotogramma e i dati della tavolozza. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Le opzioni da utilizzare per il frame appena creato. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Le opzioni del frame. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Il frame TIFF da copiare. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Il frame TIFF appena copiato. |
...
Crea il frame dal _tiffFrame_ specificato utilizzando le _options_ specificate.<br/>            I dati dei pixel sono conservati ma convertiti nel formato desiderato.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Il frame TIFF da cui creare. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Le nuove opzioni da utilizzare. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Il frame appena creato. |
