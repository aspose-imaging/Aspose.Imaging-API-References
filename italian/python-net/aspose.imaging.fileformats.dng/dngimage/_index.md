---
title: "Classe DngImage"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.dng/dngimage/
---
...
| bits_per_pixel | int | r | Scopri il numero di bit per pixel nell'immagine senza sforzo con questa <br/>            proprietà. Ideale per comprendere rapidamente e con precisione la profondità dei pixel dell'immagine. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Identifica il formato file della tua immagine con questa proprietà. Perfetto per <br/>            comprendere il formato - semplici dettagli. |
...
| height | int | r | Recupera l'altezza dell'immagine con questa proprietà. Perfetto per determinare la <br/>            dimensione verticale dell'immagine senza problemi. |
...
| img_data | [RawData](/imaging/python-net/aspose.imaging.fileformats.dng.decoder/rawdata/) | r/w | Gestisci i dati dell'immagine con questa proprietà. Che tu stia recuperando o aggiornando, <br/>            questa proprietà fornisce un accesso senza interruzioni ai dati dell'immagine per una manipolazione <br/>            efficiente. |
...
| width | int | r | Accedi alla larghezza dell'immagine con questa proprietà. Ideale per ottenere la <br/>            dimensione orizzontale dell'immagine rapidamente ed efficientemente. |
...
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_63) | Carica parzialmente pixel ARGB a 32 bit (per blocchi). |
...
| [save(stream)](#save_stream_100) | Salva i dati. |
