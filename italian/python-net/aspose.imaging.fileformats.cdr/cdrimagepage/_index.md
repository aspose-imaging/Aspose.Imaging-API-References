...
type: docs
weight: 210
url: /it/python-net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Ottiene o imposta il documento CDR. |
...
| is_cached | bool | r | Restituisce un valore che indica se i dati dell'oggetto sono attualmente nella cache e non è necessaria alcuna lettura dei dati. |
...
| parent_image | [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) | r | Restituisce l'immagine padre. |
