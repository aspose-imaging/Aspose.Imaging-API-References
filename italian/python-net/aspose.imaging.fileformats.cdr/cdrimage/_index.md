...
type: docs
weight: 190
url: /it/python-net/aspose.imaging.fileformats.cdr/cdrimage/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_1) | Inizia a lavorare con la classe [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) senza sforzo <br/>            inizializzando una nuova istanza con un flusso e i parametri loadOptions.<br/>            Ideale per gli sviluppatori che cercano un modo conveniente per caricare immagini CDR da<br/>            varie fonti di dati personalizzando il processo di caricamento secondo le necessità. |
## **Properties**
...
| bits_per_pixel | int | r | Recupera la profondità di bit dell'immagine senza sforzo con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano determinare il livello di dettaglio o la profondità di colore presente<br/>            nelle loro immagini, garantendo una elaborazione e manipolazione accurate. |
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Recupera o aggiorna il documento CDR senza sforzo usando questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano accedere o modificare il documento CDR, garantendo<br/>            flessibilità ed efficienza nelle loro applicazioni. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Recupera la pagina predefinita dell'immagine con facilità usando questa proprietà intuitiva.<br/>            Perfetto per gli sviluppatori che cercano un accesso rapido alla pagina principale della loro immagine,<br/>            garantendo una navigazione e gestione efficienti. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Recupera il formato file dell'immagine senza sforzo con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano determinare dinamicamente il formato delle loro immagini,<br/>            garantendo compatibilità e una elaborazione accurata nelle loro applicazioni. |
...
| is_cached | bool | r | Determina senza sforzo se i dati dell'oggetto sono attualmente nella cache,<br/>            eliminando la necessità di leggere i dati. Ideale per gli sviluppatori che cercano<br/>            di ottimizzare le prestazioni sfruttando i dati nella cache in modo efficiente, garantendo<br/>            un accesso più rapido alle informazioni dell'oggetto. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Ottiene i metadati dell'immagine. |
| page_count | int | r | Recupera o aggiorna senza sforzo il conteggio totale delle pagine dell'immagine con questa<br/>            proprietà intuitiva. Ideale per gli sviluppatori che desiderano gestire immagini multi-pagina<br/>            in modo dinamico, garantendo una navigazione e manipolazione efficienti del contenuto dell'immagine. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Recupera le pagine dell'immagine senza soluzione di continuità con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano accedere e manipolare pagine individuali all'interno di<br/>            immagini multi-pagina, garantendo una navigazione e un'elaborazione efficienti. |
...
| **Name** | **Descrizione** |
| :- | :- |
| cache_data() | Metti nella cache i dati senza sforzo per evitare ulteriori caricamenti dalla sorgente sottostante<br/>            con questo metodo intuitivo. Ideale per gli sviluppatori che cercano di ottimizzare le prestazioni<br/>            precaricando i dati, garantendo un accesso più rapido e un funzionamento più fluido nelle loro applicazioni.<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
Recupera le pagine dell'immagine senza soluzione di continuità con questa proprietà intuitiva.<br/>            Ideale per gli sviluppatori che desiderano accedere e manipolare pagine individuali all'interno di<br/>            immagini multi-pagina, garantendo una navigazione e un'elaborazione efficienti.
...
| update_colors | bool | se impostato su <c>true</c> i colori verranno aggiornati secondo la nuova tavolozza; altrimenti gli indici di colore rimarranno invariati. Nota che gli indici non modificati potrebbero causare il crash dell'immagine al caricamento se alcuni indici non hanno<br/>            voci corrispondenti nella tavolozza. |
