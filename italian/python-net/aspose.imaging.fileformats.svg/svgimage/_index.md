---
title: "Classe SvgImage"
type: docs
weight: 40
url: /it/python-net/aspose.imaging.fileformats.svg/svgimage/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [SvgImage(path)](#SvgImage_path_1) | Instanzia un nuovo oggetto della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), utilizzando il <br/> percorso specificato per individuare e caricare l'immagine. Questo costruttore facilita la <br/> creazione di istanze di immagini SVG da file esterni, consentendo un'integrazione fluida <br/> nei sistemi software e nei flussi di lavoro. |
| [SvgImage(stream)](#SvgImage_stream_2) | Crea una nuova istanza della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), caricando l'immagine <br/> dal flusso fornito. Questo costruttore consente il caricamento diretto di immagini SVG <br/> da stream, migliorando flessibilità ed efficienza nella gestione delle risorse immagine <br/> all'interno delle applicazioni software. |
| [SvgImage(svg_options, width, height)](#SvgImage_svg_options_width_height_3) | Crea una nuova istanza della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con le opzioni SVG <br/> specificate, larghezza e altezza dell'immagine. Questo costruttore consente <br/> agli sviluppatori di inizializzare immagini SVG con opzioni e dimensioni personalizzate, <br/> offrendo flessibilità nella gestione del contenuto e del layout SVG. |
| [SvgImage(width, height)](#SvgImage_width_height_4) | Instanzia un nuovo oggetto [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con la larghezza e <br/> altezza specificate. Questo costruttore permette agli sviluppatori di creare immagini SVG con dimensioni predefinite <br/> facilitando un controllo preciso sulla dimensione dell'immagine durante <br/> l'inizializzazione. |
## **Properties**
...
| bits_per_pixel | int | r | Restituisce il conteggio dei bit per pixel dell'immagine. È importante notare che <br/> questo parametro non è applicabile alle immagini vettoriali, poiché non sono misurate in <br/> pixel. Questa proprietà fornisce informazioni cruciali sulla profondità di colore <br/> dell'immagine, aiutando nelle attività di elaborazione e manipolazione. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Restituisce il formato file dell'immagine, fornendo metadati essenziali per <br/> l'elaborazione e i controlli di compatibilità. Questa proprietà è fondamentale per <br/> determinare le strategie di decodifica e codifica appropriate per gestire i <br/> dati dell'immagine in modo efficace su diversi sistemi e applicazioni. |
...
| is_cached | bool | r | Restituisce un valore booleano che indica se i dati dell'oggetto sono attualmente <br/> memorizzati nella cache, eliminando la necessità di ulteriori operazioni di lettura dei dati. Questa <br/> proprietà fornisce una visione dello stato attuale della cache, ottimizzando il recupero dei dati <br/> e i flussi di lavoro di elaborazione per prestazioni ed efficienza migliorate. |
...
| **Name** | **Descrizione** |
| :- | :- |
| cache_data() | Memorizza i dati nella cache e garantisce che non avvenga ulteriori caricamenti di dati dal <br/> sottostante [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). Questa <br/> ottimizzazione migliora le prestazioni eliminando operazioni ridondanti di recupero dei dati <br/>, particolarmente vantaggiosa in scenari che richiedono accessi frequenti ai <br/> dati dell'immagine. |
...
| [create_from_stream(stream)](#create_from_stream_stream_20) | Inizializza una nuova istanza della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/). |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_21) | Ritaglia l'immagine con spostamenti. |
| [crop(rectangle)](#crop_rectangle_22) | Ritaglia il rettangolo specificato. |
| [get_default_options(args)](#get_default_options_args_23) | Ottiene le opzioni immagine predefinite. |
| [get_embedded_images()](#get_embedded_images__24) | Ottiene le immagini incorporate. |
| [get_file_format(file_path)](#get_file_format_file_path_25) | Ottiene il formato del file. |
| [get_file_format(stream)](#get_file_format_stream_26) | Ottiene il formato del file. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_27) | Ottiene il formato del file. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_28) | Ottiene il rettangolo che si adatta all'immagine corrente. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_29) | Ottiene il rettangolo che si adatta all'immagine corrente. |
...
| [load(file_path)](#load_file_path_34) | Carica una nuova immagine dal percorso file o URL specificato.<br/>            Se _filePath_ è un percorso file, il metodo apre semplicemente il file.<br/>            Se _filePath_ è un URL, il metodo scarica il file, lo memorizza temporaneamente e lo apre. |
| [load(file_path, load_options)](#load_file_path_load_options_35) | Carica una nuova immagine dal percorso file o URL specificato.<br/>            Se _filePath_ è un percorso file, il metodo apre semplicemente il file.<br/>            Se _filePath_ è un URL, il metodo scarica il file, lo memorizza temporaneamente e lo apre. |
| [load(stream)](#load_stream_36) | Carica la sezione SVG. |
| [load(stream, load_options)](#load_stream_load_options_37) | Carica una nuova immagine dallo stream specificato. |
| [load_stream(stream)](#load_stream_stream_38) | Carica una nuova immagine dallo stream specificato. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_39) | Carica una nuova immagine dallo stream specificato. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_40) | Carica una nuova immagine dal percorso file o URL specificato.<br/>            Se _filePath_ è un percorso file, il metodo apre semplicemente il file.<br/>            Se _filePath_ è un URL, il metodo scarica il file, lo memorizza temporaneamente e lo apre. |
| remove_background() | Rimuove lo sfondo. |
| [remove_background(settings)](#remove_background_settings_41) | Rimuove lo sfondo. |
| remove_metadata() | Rimuove i metadati. |
| [resize(new_width, new_height)](#resize_new_width_new_height_42) | Ridimensiona l'immagine. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_43) | Ridimensiona l'immagine per adattarla alle dimensioni specificate mantenendo il suo rapporto d'aspetto <br/>            rapporto. Questo metodo offre un modo conveniente per regolare le dimensioni dell'immagine <br/>            senza distorcere le proporzioni, garantendo una visualizzazione o archiviazione <br/>            secondo le dimensioni desiderate. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_44) | Ridimensiona l'immagine con opzioni estese. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_45) | Ridimensiona l'immagine. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_46) | Ridimensiona l'immagine. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_47) | Ridimensiona l'altezza proporzionalmente. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_48) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_49) | Ridimensiona l'altezza proporzionalmente. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_50) | Ridimensiona l'altezza proporzionalmente. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_51) | Ridimensiona la larghezza proporzionalmente. Viene utilizzato il valore predefinito [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_52) | Ridimensiona la larghezza proporzionalmente. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_53) | Ridimensiona la larghezza proporzionalmente. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_54) | Ridimensiona la larghezza proporzionalmente. |
| [rotate(angle)](#rotate_angle_55) | Ruota l'immagine attorno al centro. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_56) | Ruota, capovolge o ruota e capovolge l'immagine. |
| save() | Salva i dati dell'immagine nello stream sottostante. |
| [save(file_path)](#save_file_path_57) | Salva l'immagine nella posizione file specificata. |
| [save(file_path, options)](#save_file_path_options_58) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_59) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save(file_path, over_write)](#save_file_path_over_write_60) | Salva i dati dell'oggetto nella posizione file specificata. |
| [save(stream)](#save_stream_61) | Salva i dati. |
| [save(stream, options_base)](#save_stream_options_base_62) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_63) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_to_stream(stream)](#save_to_stream_stream_64) | Salva i dati dell'oggetto nello stream specificato. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_65) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_66) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | Applica una tavolozza specificata all'immagine, consentendo la personalizzazione del colore <br/>            schemi per scopi estetici o funzionali. Questo metodo offre flessibilità <br/>            nella gestione delle tavolozze di colore per soddisfare varie esigenze di progettazione o applicazione. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | Cerca di impostare un'istanza _metadata_, se questa istanza di [Image](/imaging/python-net/aspose.imaging/image/) supporta e implementa l'istanza [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
...
Instanzia un nuovo oggetto della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), utilizzando il <br/> percorso specificato per individuare e caricare l'immagine. Questo costruttore facilita la <br/> creazione di istanze di immagini SVG da file esterni, consentendo un'integrazione fluida <br/> nei sistemi software e nei flussi di lavoro.
...
Crea una nuova istanza della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), caricando l'immagine <br/> dal flusso fornito. Questo costruttore consente il caricamento diretto di immagini SVG <br/> da stream, migliorando flessibilità ed efficienza nella gestione delle risorse immagine <br/> all'interno delle applicazioni software.
...
Crea una nuova istanza della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con le opzioni SVG <br/> specificate, larghezza e altezza dell'immagine. Questo costruttore consente <br/> agli sviluppatori di inizializzare immagini SVG con opzioni e dimensioni personalizzate, <br/> offrendo flessibilità nella gestione del contenuto e del layout SVG.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| svg_options | [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/) | Le opzioni SVG. |
...
Instanzia un nuovo oggetto [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) con la larghezza e <br/> altezza specificate. Questo costruttore permette agli sviluppatori di creare immagini SVG con dimensioni predefinite <br/> facilitando un controllo preciso sulla dimensione dell'immagine durante <br/> l'inizializzazione.
...
Inizializza una nuova istanza della classe [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/).
...
Applica una tavolozza specificata all'immagine, consentendo la personalizzazione del colore <br/>            schemi per scopi estetici o funzionali. Questo metodo offre flessibilità <br/>            nella gestione delle tavolozze di colore per soddisfare varie esigenze di progettazione o applicazione.
