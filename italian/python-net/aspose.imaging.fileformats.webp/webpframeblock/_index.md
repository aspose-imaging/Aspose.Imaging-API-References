---
title: "Classe WebPFrameBlock"
type: docs
weight: 20
url: /it/python-net/aspose.imaging.fileformats.webp/webpframeblock/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [WebPFrameBlock(raster_image)](#WebPFrameBlock_raster_image_1) | <br/><br/>                    Inizializza una nuova istanza di [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>classe.<br/> |
| [WebPFrameBlock(width, height)](#WebPFrameBlock_width_height_2) | Inizializza una nuova istanza della classe [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/). |
## **Properties**
...
| disposal_method | [AnimationDisposalMethods](/imaging/python-net/aspose.imaging/animationdisposalmethods/) | r/w | Ottiene o imposta il metodo di smaltimento. |
| eliminato | bool | r | Ottiene un valore che indica se questa istanza è stata eliminata. |
| duration | int | r/w | Ottiene o imposta la durata del fotogramma. |
...
| [has_alpha](#has_alpha1) | bool | r | Ottiene un valore che indica se questa istanza ha alfa. |
...
| sinistra | int | r/w | Ottiene o imposta la posizione sinistra del fotogramma. |
...
| alto | int | r/w | Ottiene o imposta la posizione superiore del fotogramma. |
...
| use_alpha_blending | bool | r/w | Ottiene o imposta il valore che indica se il fotogramma corrente viene mescolato con i valori alfa del fotogramma precedente. |
...
<br/><br/>                    Inizializza una nuova istanza di [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/)<br/><br/>        <br/>classe.<br/>
...
Inizializza una nuova istanza della classe [WebPFrameBlock](/imaging/python-net/aspose.imaging.fileformats.webp/webpframeblock/).
