---
title: "OtgImage Classe"
type: docs
weight: 500
url: /it/python-net/aspose.imaging.fileformats.opendocument/otgimage/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [OtgImage(stream_container)](#OtgImage_stream_container_1) | Crea un nuovo oggetto della classe [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) fornendo un contenitore di stream <br/>            . Questo costruttore consente agli sviluppatori di creare immagini OTG direttamente da <br/>            contenitori di stream, semplificando il processo di lavoro con i dati delle immagini OTG. |
| [OtgImage(stream_container, load_options)](#OtgImage_stream_container_load_options_2) | Inizializza un nuovo oggetto [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) fornendo un contenitore di stream <br/>            e opzioni di caricamento. Questo costruttore consente agli sviluppatori di caricare efficientemente immagini OTG <br/>            da stream specificando configurazioni di caricamento personalizzate. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Questa proprietà fornisce l'accesso al formato file OTG, offrendo informazioni cruciali <br/>            sul tipo di dati contenuti nel file immagine. Funziona come punto di riferimento fondamentale <br/>            per gli sviluppatori software, consentendo loro di gestire efficacemente i file OTG <br/>            nelle proprie applicazioni. Utilizzando questa proprietà, è possibile <br/>            determinare il formato specifico del file immagine, facilitando un'integrazione fluida <br/>            e la manipolazione dei file OTG nei loro sistemi software. |
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Recupera la collezione di pagine associate all'immagine, consentendo agli sviluppatori software di accedere e manipolare ogni singola pagina in modo efficiente. Questa <br/>            proprietà facilita l'iterazione fluida attraverso le pagine per varie operazioni, <br/>            migliorando la funzionalità e la versatilità delle applicazioni di elaborazione delle immagini. |
...
Crea un nuovo oggetto della classe [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) fornendo un contenitore di stream <br/>            . Questo costruttore consente agli sviluppatori di creare immagini OTG direttamente da <br/>            contenitori di stream, semplificando il processo di lavoro con i dati delle immagini OTG.
