---
title: "Classe IcoImage"
type: docs
weight: 10
url: /it/python-net/aspose.imaging.fileformats.ico/icoimage/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [IcoImage(image, ico_options)](#IcoImage_image_ico_options_1) | Progettata per semplicità ed efficienza, la classe [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) ti consente di creare immagini ICO con facilità. <br/>            Questo costruttore inizializza una nuova istanza <br/>            della classe, fornendo una solida base per le tue esigenze di manipolazione delle immagini. <br/>            Che tu stia sviluppando applicazioni o migliorando interfacce utente, la <br/>            classe [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) semplifica la gestione delle immagini ICO, permettendoti di concentrarti <br/>            sulla fornitura di esperienze eccezionali. |
| [IcoImage(width, height, options)](#IcoImage_width_height_options_2) | Inizia la creazione di immagini ICO senza sforzo utilizzando la classe [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/). Questo <br/>            costruttore ti consente di inizializzare nuove istanze di immagini ICO specificando i parametri di larghezza, altezza e opzioni di creazione. Con questo costruttore semplice, puoi personalizzare le immagini ICO secondo le tue specifiche esatte, garantendo <br/>            compatibilità senza interruzioni e un aspetto visivo accattivante su diverse piattaforme e dispositivi. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Recupera il formato del file senza sforzo con questa proprietà, consentendo un'integrazione fluida <br/> nel tuo flusso di lavoro. Utilizzando questa proprietà, ottieni l'accesso a informazioni critiche <br/> sul formato del tuo file, garantendo compatibilità ed elaborazione efficiente. |
| has_alpha | bool | r | Determina se il canale alfa è presente in questa istanza con questa proprietà. Essa <br/> offre un modo rapido per verificare se l'immagine o il documento contiene un canale alfa, <br/> il che è fondamentale per varie operazioni di elaborazione e rendering delle immagini. Ideale per <br/> garantire la compatibilità e gestire gli effetti di trasparenza nelle immagini o nei documenti. |
...
| page_count | int | r | Ottieni immediatamente una visione della struttura del documento con questa semplice <br/> proprietà. Invocando questa proprietà, recuperi senza sforzo il numero totale di <br/> pagine contenute nel file. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Recupera informazioni complete sulle pagine del documento senza sforzo tramite <br/>            questa proprietà. Accedendo a questa proprietà, ottieni una collezione o un array <br/>            contenente tutte le pagine presenti nel documento. |
...
| **Name** | **Descrizione** |
| :- | :- |
| [add_page(page)](#add_page_page_1) | Espandi la tua immagine ICO aggiungendo una voce di pagina immagine, sfruttando il <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Questo metodo incorpora senza soluzione di continuità immagini raster nel <br/>            tuo file ICO, convertendole in un formato PNG a 32 bit di alta qualità. Perfetto per <br/>            migliorare i tuoi file ICO con immagini raster garantendo al contempo la massima compatibilità <br/>            e qualità di rendering. |
| [add_page(page)](#add_page_page_2) | Espandi la tua immagine ICO aggiungendo una voce di pagina immagine, sfruttando il <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Questo metodo incorpora senza soluzione di continuità immagini raster nel <br/>            tuo file ICO, convertendole in un formato PNG a 32 bit di alta qualità. Perfetto per <br/>            migliorare i tuoi file ICO con immagini raster garantendo al contempo la massima compatibilità <br/>            e qualità di rendering. |
| [add_page(page, ico_options)](#add_page_page_ico_options_3) | Diversifica la tua immagine ICO senza sforzo integrando una voce immagine su misura per <br/>            le tue esigenze con le [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) specificate. Questo metodo incorpora senza soluzione di continuità l'immagine secondo le tue opzioni personalizzate, garantendo flessibilità <br/>            e precisione nel tuo file ICO. |
| [add_raster_page(page)](#add_raster_page_page_4) | Aggiunge una voce immagine all'immagine ICO secondo le [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) predefinite come PNG a 32 bit. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | Regola della _luminosità_ per l'immagine. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | [Image](/imaging/python-net/aspose.imaging/image/) contrastante |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | Correzione gamma di un'immagine. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | Correzione gamma di un'immagine. |
...
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | Binarizzazione di un'immagine con soglia predefinita |
...
| [can_load(stream)](#can_load_stream_17) | Determina se il flusso fornito contiene un'immagine ICO. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | Ritaglia l'immagine con spostamenti. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_76) | Normalizza l'angolo.<br/>            Questo metodo è applicabile ai documenti di testo scansionati per eliminare la scansione inclinata.<br/>            Questo metodo utilizza i metodi [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) e [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/). |
...
| [remove_page(index)](#remove_page_index_79) | Affina la tua immagine ICO rimuovendo una voce immagine specifica situata al <br/>            ***index*** designato all'interno del file. Questo metodo fornisce un controllo preciso <br/>            sulla composizione dell'immagine, consentendoti di perfezionare il tuo file ICO con facilità. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | Ruota l'immagine [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) attorno al centro. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | Ruota, capovolge o ruota e capovolge tutte le pagine. |
...
| [save(file_path, options)](#save_file_path_options_103) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
...
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_109) | Salva i pixel ARGB a 32 bit. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_110) | Salva i pixel. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_111) | Salva i pixel.<br/>            Questo metodo è deprecato. Si prega di utilizzare in modo più efficace il metodo [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_112) | Salva i pixel interni principali. |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_113) | Salva i dati grezzi. |
| [save_to_stream(stream)](#save_to_stream_stream_114) | Salva i dati dell'oggetto nello stream specificato. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_115) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_116) | Salva i dati dell'immagine nello stream specificato nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_117) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_118) | Salva i dati dell'oggetto nella posizione file specificata nel formato file indicato secondo le opzioni di salvataggio. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_119) | Imposta un pixel immagine a 32 bit ARGB per la posizione specificata. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_120) | Imposta la tavolozza dell'immagine. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_121) | Imposta un pixel dell'immagine per la posizione specificata. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_122) | Imposta la risoluzione per questo [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_123) | Cerca di impostare un'istanza _metadata_, se questa istanza di [Image](/imaging/python-net/aspose.imaging/image/) supporta e implementa l'istanza [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_124) | Scrive l'intera riga di scansione all'indice di riga di scansione specificato. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_125) | Scrive l'intera riga di scansione all'indice di riga di scansione specificato. |
...
| :- | :- | :- |
| image | [Image](/imaging/python-net/aspose.imaging/image/) | L'immagine. |
| ico_options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | Le opzioni ICO. |
...
| options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | Le opzioni di creazione ICO. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| page | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | L'immagine. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| page | [Image](/imaging/python-net/aspose.imaging/image/) | L'immagine. |
...
Diversifica la tua immagine ICO senza sforzo integrando una voce immagine su misura per <br/>            le tue esigenze con le [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) specificate. Questo metodo incorpora senza soluzione di continuità l'immagine secondo le tue opzioni personalizzate, garantendo flessibilità <br/>            e precisione nel tuo file ICO.
...
Aggiunge una voce immagine all'immagine ICO secondo le [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) predefinite come PNG a 32 bit.
...
Regola della _luminosità_ per l'immagine.
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| soglia | System.Byte | Valore di soglia. Se il valore grigio corrispondente di un pixel è maggiore della soglia, verrà assegnato un valore di<br/>                255, altrimenti 0. |
...
Determina se il flusso fornito contiene un'immagine ICO.

**Parameters:**

| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| stream | _io.BufferedRandom | Il flusso immagine. |

**Returns**

| Tipo | Descrizione |
| :- | :- |
| bool | **True** se il flusso contiene un'immagine ICO; altrimenti **False** |
...
Affina la tua immagine ICO rimuovendo una voce immagine specifica situata al <br/>            ***index*** designato all'interno del file. Questo metodo fornisce un controllo preciso <br/>            sulla composizione dell'immagine, consentendoti di perfezionare il tuo file ICO con facilità.
...
| :- | :- | :- |
| angle | float | L'angolo di rotazione in gradi. I valori positivi ruoteranno in senso orario. |
| resize_proportionally | bool | se impostato a <c>true</c> la dimensione della tua immagine verrà modificata<br/>                in base alle proiezioni del rettangolo ruotato (punti d'angolo) in caso contrario le dimensioni rimarranno inalterate e solo<br/>                i contenuti __internal__ dell'immagine saranno ruotati. |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | Colore dello sfondo. |
