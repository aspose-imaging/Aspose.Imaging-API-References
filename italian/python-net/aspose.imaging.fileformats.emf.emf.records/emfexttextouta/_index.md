---
title: "Classe EmfExtTextOutA"
type: docs
weight: 470
url: /it/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [EmfExtTextOutA()](#EmfExtTextOutA__1) | Inizializza una nuova istanza della classe [EmfExtTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/). |
| [EmfExtTextOutA(source)](#EmfExtTextOutA_source_2) | Inizializza una nuova istanza della classe [EmfExtTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/). |
## **Properties**
| **Name** | **Type** | **Access** | **Descrizione** |
| :- | :- | :- | :- |
| a_emr_text | [EmfText](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emftext/) | r/w | Ottiene o imposta un oggetto EmrText (sezione 2.2.5) che specifica la stringa di output in caratteri ASCII a 8 bit <br/>            , attributi di testo e valori di spaziatura. |
...
Inizializza una nuova istanza della classe [EmfExtTextOutA](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfexttextouta/).
