---
title: "EmfMetafileHeaderExtension2 Classe"
type: docs
weight: 630
url: /it/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/
---
...
| **Name** | **Descrizione** |
| :- | :- |
| [EmfMetafileHeaderExtension2(header)](#EmfMetafileHeaderExtension2_header_1) | Inizializza una nuova istanza della classe [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [EmfMetafileHeaderExtension2(header)](#EmfMetafileHeaderExtension2_header_2) | Inizializza una nuova istanza della classe [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
## **Properties**
...
| emf_header_extension2 | [EmfHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/) | r/w | Ottiene o imposta un oggetto HeaderExtension2, che specifica informazioni aggiuntive sull'immagine nel metafile |
...
| **Name** | **Descrizione** |
| :- | :- |
| [create_from_header(header)](#create_from_header_header_1) | Inizializza una nuova istanza della classe [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [create_from_header_extension1(header)](#create_from_header_extension1_header_2) | Inizializza una nuova istanza della classe [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [create_from_header_extension2(header)](#create_from_header_extension2_header_3) | Inizializza una nuova istanza della classe [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/). |
| [create_from_record(record)](#create_from_record_record_4) | Inizializza una nuova istanza della classe [EmfMetafileHeader](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheader/). |
| [create_from_type(type)](#create_from_type_type_5) | Inizializza una nuova istanza della classe [EmfRecord](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfrecord/). |
...
Inizializza una nuova istanza della classe [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/).
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| header | [EmfMetafileHeaderExtension2](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfmetafileheaderextension2/) | L'intestazione. |
