---
title: "Classe RasterCachedMultipageImage"
type: docs
weight: 7050
url: /it/python-net/aspose.imaging/rastercachedmultipageimage/
---
...
| page_count | int | r | Ottiene il conteggio delle pagine. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Ottiene le pagine. |
...
| **Name** | **Descrizione** |
| :- | :- |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_1) | Regola della _luminosità_ per l'immagine. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_2) | [Image](/imaging/python-net/aspose.imaging/image/) contrastante |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_72) | Normalizza l'angolo.<br/>            Questo metodo è applicabile ai documenti di testo scansionati per eliminare la scansione inclinata.<br/>            Questo metodo utilizza i metodi [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) e [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/). |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_86) | Ridimensiona la larghezza proporzionalmente. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_94) | Ruota l'immagine [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) attorno al centro. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_95) | Ruota, capovolge o ruota e capovolge tutte le pagine. |
| [rotate_flip_all(rotate_flip)](#rotate_flip_all_rotate_flip_96) | Ruota il flip completo. |
...
| [save(stream)](#save_stream_101) | Salva i dati dell'oggetto nello stream specificato. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_107) | Salva i pixel interni principali. |
