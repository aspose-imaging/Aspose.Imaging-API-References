...
type: docs
weight: 7060
url: /it/python-net/aspose.imaging/rasterimage/
---
...
| [premultiply_components](#premultiply_components2) | bool | r/w | Ottiene o imposta un valore che indica se i componenti dell'immagine devono essere premoltiplicati. |
...
| [raw_data_format](#raw_data_format3) | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Ottiene il formato dei dati grezzi. |
...
| [crop(rectangle)](#crop_rectangle_31) | Ritaglia il rettangolo specificato. |
...
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_82) | Ridimensiona l'immagine con opzioni estese. |
...
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_106) | Salva i pixel. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_117) | Prova a impostare un'istanza _metadata_, se questa istanza di [Image](/imaging/python-net/aspose.imaging/image/) supporta e implementa il tipo [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
