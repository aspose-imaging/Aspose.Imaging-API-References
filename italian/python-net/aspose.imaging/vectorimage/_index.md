...
type: docs
weight: 7880
url: /it/python-net/aspose.imaging/vectorimage/
---
...
| [save(stream)](#save_stream_60) | Salva i dati dell'oggetto nello stream specificato. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_69) | Prova a impostare un'istanza _metadata_, se questa istanza di [Image](/imaging/python-net/aspose.imaging/image/) supporta e implementa il tipo [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
