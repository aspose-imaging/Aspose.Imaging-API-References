...
description: Classe per rappresentare limmagine raster Djvu dove si trova il risultato di alcune operazioni
type: docs
weight: 2460
url: /it/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

Classe per rappresentare l'immagine raster Djvu dove si trova il risultato di alcune operazioni
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | Ottiene l'altezza. |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | Ottiene la lunghezza. |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | Ottiene la larghezza. |
