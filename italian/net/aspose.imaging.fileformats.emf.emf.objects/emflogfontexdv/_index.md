...
description: Loggetto LogFontExDv specifica il vettore di disegno per un carattere logico esteso.
type: docs
weight: 3050
url: /it/net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
...
| Nome | Descrizione |
| --- | --- |
| [EmfLogFontExDv](emflogfontexdv)(EmfLogFontEx) | Inizializza una nuova istanza di[`EmfLogFontExDv`](../emflogfontexdv) classe. |
...
| [DesignVector](../../aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/designvector) { get; set; } | Ottiene o imposta un oggetto DesignVector (sezione 2.2.3). Questo campo NON DEVE essere più lungo di 72 byte. |
