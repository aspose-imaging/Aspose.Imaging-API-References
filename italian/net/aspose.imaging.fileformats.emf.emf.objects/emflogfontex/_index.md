...
description: Loggetto LogFontEx specifica gli attributi estesi di un carattere logico.
type: docs
weight: 3040
url: /it/net/aspose.imaging.fileformats.emf.emf.objects/emflogfontex/
---
## EmfLogFontEx class

L'oggetto LogFontEx specifica gli attributi estesi di un carattere logico.
...
| Nome | Descrizione |
| --- | --- |
| [EmfLogFontEx](emflogfontex)(EmfLogFont) | Inizializza una nuova istanza di[`EmfLogFontEx`](../emflogfontex) classe. |
