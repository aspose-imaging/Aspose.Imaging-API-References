...
type: docs
weight: 3960
url: /it/net/aspose.imaging.fileformats.emf.emf.records/emfpolybezier/
---
## EmfPolyBezier class

Il record EMR_POLYBEZIER specifica una o più curve di Bézier.
...
| Nome | Descrizione |
| --- | --- |
| [EmfPolyBezier](emfpolybezier#constructor)() | Inizializza una nuova istanza di[`EmfPolyBezier`](../emfpolybezier) classe. |
| [EmfPolyBezier](emfpolybezier#constructor_1)(EmfRecord) | Inizializza una nuova istanza di[`EmfPolyBezier`](../emfpolybezier) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [APoints](../../aspose.imaging.fileformats.emf.emf.records/emfpolybezier/apoints) { get; set; } | Ottiene o imposta una matrice Count length di oggetti WMF PointL ([MS-WMF] sezione 2.2.2.15) che specifica i punti finali e i punti di controllo delle curve di Bezier, in unità logiche. |
| [Bounds](../../aspose.imaging.fileformats.emf.emf.records/emfpolybezier/bounds) { get; set; } | Ottiene o imposta un oggetto RectL WMF a 128 bit ([MS-WMF] sezione 2.2.2.19) che specifica il rettangolo di delimitazione in unità di dispositivo. |
