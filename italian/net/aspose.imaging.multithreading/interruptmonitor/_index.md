...
type: docs
weight: 10600
url: /it/net/aspose.imaging.multithreading/interruptmonitor/
---
...
| Nome | Descrizione |
| --- | --- |
| virtual [IsInterrupted](../../aspose.imaging.multithreading/interruptmonitor/isinterrupted) { get; } | Ottiene il valore che indica se le operazioni devono essere interrotte. |
| static [ThreadLocalInstance](../../aspose.imaging.multithreading/interruptmonitor/threadlocalinstance) { get; set; } | Ottiene o imposta l'istanza di IInterruptMonitor che è univoca per ogni thread. |

## Metodi

| Nome | Descrizione |
| --- | --- |
| virtual [Interrupt](../../aspose.imaging.multithreading/interruptmonitor/interrupt)() | Invia una richiesta di interruzione delle operazioni. |
