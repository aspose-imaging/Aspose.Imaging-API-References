...
description: Il record META_RECTANGLE dipinge un rettangolo. Il rettangolo viene delineato utilizzando la penna e riempito utilizzando il pennello definito nel contesto del dispositivo di riproduzione .
type: docs
weight: 8920
url: /it/net/aspose.imaging.fileformats.wmf.objects/wmfrectangle/
---
## WmfRectangle class

Il record META_RECTANGLE dipinge un rettangolo. Il rettangolo viene delineato utilizzando la penna e riempito utilizzando il pennello definito nel contesto del dispositivo di riproduzione .
...
| Nome | Descrizione |
| --- | --- |
| [WmfRectangle](wmfrectangle)() | Default_Costruttore |
