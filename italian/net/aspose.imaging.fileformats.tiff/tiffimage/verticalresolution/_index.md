...
description: Ottiene la risoluzione verticale in pixel per pollice di questoImageaspose.imaging/image .
type: docs
weight: 120
url: /it/net/aspose.imaging.fileformats.tiff/tiffimage/verticalresolution/
---
## TiffImage.VerticalResolution property

Ottiene la risoluzione verticale, in pixel per pollice, di questo[`Image`](../../../aspose.imaging/image) .
