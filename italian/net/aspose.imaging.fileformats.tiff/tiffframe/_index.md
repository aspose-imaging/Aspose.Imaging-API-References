...
description: La cornice tiff.
type: docs
weight: 7870
url: /it/net/aspose.imaging.fileformats.tiff/tiffframe/
---
## TiffFrame class
...
| Nome | Descrizione |
| --- | --- |
| [TiffFrame](tiffframe#constructor_1)(RasterImage) | Inizializza una nuova istanza di[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_3)(Stream) | Inizializza una nuova istanza di[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_5)(string) | Inizializza una nuova istanza di[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_2)(RasterImage, TiffOptions) | Inizializza una nuova istanza di[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_4)(Stream, TiffOptions) | Inizializza una nuova istanza di[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor_6)(string, TiffOptions) | Inizializza una nuova istanza di[`TiffFrame`](../tiffframe) classe. |
| [TiffFrame](tiffframe#constructor)(TiffOptions, int, int) | Inizializza una nuova istanza di[`TiffFrame`](../tiffframe) classe. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.tiff/tiffframe/backgroundcolor) { get; set; } | Ottiene o imposta un valore per il colore di sfondo. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.tiff/tiffframe/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| [ExifData](../../aspose.imaging.fileformats.tiff/tiffframe/exifdata) { get; set; } | Ottiene o imposta i dati EXIF dal frame. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | Ottiene un valore di formato file |
| [FrameOptions](../../aspose.imaging.fileformats.tiff/tiffframe/frameoptions) { get; } | Ottiene le opzioni di creazione del frame. |
| override [HasAlpha](../../aspose.imaging.fileformats.tiff/tiffframe/hasalpha) { get; } | Ottiene un valore che indica se questa istanza ha alpha. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.tiff/tiffframe/hastransparentcolor) { get; set; } | Ottiene un valore che indica se l'immagine ha un colore trasparente. |
| override [Height](../../aspose.imaging.fileformats.tiff/tiffframe/height) { get; } | Ottiene l'altezza dell'immagine. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/horizontalresolution) { get; set; } | Ottiene o imposta la risoluzione orizzontale, in pixel per pollice, di questo[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| [PathResources](../../aspose.imaging.fileformats.tiff/tiffframe/pathresources) { get; set; } | Ottiene o imposta le risorse del percorso. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/verticalresolution) { get; set; } | Ottiene o imposta la risoluzione verticale, in pixel per pollice, di questo[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.tiff/tiffframe/width) { get; } | Ottiene la larghezza dell'immagine. |
| override [XmpData](../../aspose.imaging.fileformats.tiff/tiffframe/xmpdata) { get; set; } | Ottiene o imposta i dati XMP dal frame. |

## Metodi

| Nome | Descrizione |
| --- | --- |
| static [CopyFrame](../../aspose.imaging.fileformats.tiff/tiffframe/copyframe)(TiffFrame) | Copia l'intero frame (duplica). |
| static [CreateFrameFrom](../../aspose.imaging.fileformats.tiff/tiffframe/createframefrom)(TiffFrame, TiffOptions) | Crea il frame da specificato*tiffFrame* utilizzando il specificato*options* . I dati dei pixel vengono conservati ma convertiti nel formato desiderato. |
...
| [AlignResolutions](../../aspose.imaging.fileformats.tiff/tiffframe/alignresolutions)() | Metodo di supporto per rendere uguali le risoluzioni orizzontali e verticali. |
...
| override [Crop](../../aspose.imaging.fileformats.tiff/tiffframe/crop#crop)(Rectangle) | Ritaglio dell'immagine. |
...
| override [Resize](../../aspose.imaging.fileformats.tiff/tiffframe/resize#resize_2)(int, int, ResizeType) | Ridimensiona l'immagine. |
...
| override [Rotate](../../aspose.imaging.fileformats.tiff/tiffframe/rotate#rotate_1)(float, bool, Color) | Ruota l'immagine attorno al centro. |
