...
description: Le opzioni wmf.
type: docs
weight: 10290
url: /it/net/aspose.imaging.imageoptions/wmfoptions/
---
## WmfOptions class
...
| Nome | Descrizione |
| --- | --- |
| [WmfOptions](wmfoptions)() | Default_Costruttore |
...
L'esempio seguente mostra come convertire un'immagine vettoriale multipagina in formato WMF in generale senza fare riferimento a un particolare tipo di immagine.
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    ...
    // Esporta solo le prime due pagine. In effetti, verrà convertita solo una pagina perché WMF non è un formato multipagina.
