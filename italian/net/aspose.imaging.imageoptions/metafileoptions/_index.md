...
description: Le opzioni di base dei metafile.
type: docs
weight: 10040
url: /it/net/aspose.imaging.imageoptions/metafileoptions/
---
## MetafileOptions class

Le opzioni di base dei metafile.
...
| Nome | Descrizione |
| --- | --- |
| [MetafileOptions](metafileoptions)() | Default_Costruttore |
