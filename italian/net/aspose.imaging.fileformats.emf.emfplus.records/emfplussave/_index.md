...
type: docs
weight: 6250
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussave/
---
## EmfPlusSave class
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusSave](emfplussave)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusSave`](../emfplussave) classe. |
...
| [StackIndex](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussave/stackindex) { get; set; } | Ottiene o imposta un intero senza segno a 32 bit che specifica un livello da associare allo stato grafico . Il valore del livello può essere utilizzato da un'operazione successiva del record EmfPlusRestore (sezione 2.3.7.4) per recuperare lo stato grafico. |
