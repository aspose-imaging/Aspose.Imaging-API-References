...
type: docs
weight: 6380
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextcontrast/
---
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusSetTextContrast](emfplussettextcontrast)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusSetTextContrast`](../emfplussettextcontrast) classe. |
...
| [TextContrast](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussettextcontrast/textcontrast) { get; set; } | Ottiene o imposta il valore di correzione gamma X 1000, che verrà applicato a successive operazioni di rendering del testo. L'intervallo consentito è compreso tra 1000 e 2200, che rappresenta valori gamma di testo da 1,0 a 2,2. |
