...
description: Il record EmfPlusSetTextRenderingHint specifica la qualità del rendering del testo incluso il tipo di anti-aliasing.
type: docs
weight: 6390
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/
---
## EmfPlusSetTextRenderingHint class

Il record EmfPlusSetTextRenderingHint specifica la qualità del rendering del testo, incluso il tipo di anti-aliasing.
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusSetTextRenderingHint](emfplussettextrenderinghint)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusSetTextRenderingHint`](../emfplussettextrenderinghint) classe. |
...
| [TextRenderingHint](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussettextrenderinghint/textrenderinghint) { get; set; } | Ottiene o imposta il valore del suggerimento per il rendering del testo, dall'enumerazione TextRenderingHint (sezione 2.1.1.32), che specifica la qualità da da utilizzare nel rendering del testo successivo. |
