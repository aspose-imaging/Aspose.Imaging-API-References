...
description: Il record EmfPlusSetPixelOffsetMode specifica come i pixel sono centrati rispetto alle coordinate della superficie di disegno.
type: docs
weight: 6360
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetpixeloffsetmode/
---
## EmfPlusSetPixelOffsetMode class

Il record EmfPlusSetPixelOffsetMode specifica come i pixel sono centrati rispetto alle coordinate della superficie di disegno.
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusSetPixelOffsetMode](emfplussetpixeloffsetmode)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusSetPixelOffsetMode`](../emfplussetpixeloffsetmode) classe. |
...
| [PixelOffsetMode](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetpixeloffsetmode/pixeloffsetmode) { get; set; } | Ottiene o imposta il valore della modalità di offset dei pixel, dall'enumerazione PixelOffsetMode (sezione 2.1.1.26). |
