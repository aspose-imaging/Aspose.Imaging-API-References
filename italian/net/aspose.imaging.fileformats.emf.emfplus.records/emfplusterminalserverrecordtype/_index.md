...
description: I tipi di record del server terminal specificano lelaborazione grafica su un server terminal. I seguenti sono tipi di record del server terminal EMF.
type: docs
weight: 6440
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusterminalserverrecordtype/
---
## EmfPlusTerminalServerRecordType class

I tipi di record del server terminal specificano l'elaborazione grafica su un server terminal. I seguenti sono tipi di record del server terminal EMF+.
