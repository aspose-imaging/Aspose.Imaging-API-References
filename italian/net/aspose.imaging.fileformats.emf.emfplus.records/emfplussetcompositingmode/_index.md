...
type: docs
weight: 6320
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingmode/
---
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusSetCompositingMode](emfplussetcompositingmode)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusSetCompositingMode`](../emfplussetcompositingmode) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [CompositingMode](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingmode/compositingmode) { get; set; } | Ottiene o imposta il valore della modalità di composizione, dall'enumerazione CompositingMode (sezione 2.1.1.5). La composizione può essere espressa come lo stato della fusione alpha , che può essere attivata o disattivata. |
