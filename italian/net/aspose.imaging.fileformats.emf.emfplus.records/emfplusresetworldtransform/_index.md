...
description: Il record EmfPlusResetWorldTransform reimposta la trasformazione dello spazio mondiale corrente sulla matrice di identificazione.
type: docs
weight: 6220
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/
---
## EmfPlusResetWorldTransform class

Il record EmfPlusResetWorldTransform reimposta la trasformazione dello spazio mondiale corrente sulla matrice di identificazione.
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusResetWorldTransform](emfplusresetworldtransform)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusResetWorldTransform`](../emfplusresetworldtransform) classe. |
