...
description: Il record EmfPlusSetCompositingQuality specifica il livello di qualità desiderato per la creazione di immagini composite da più oggetti.
type: docs
weight: 6330
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/
---
## EmfPlusSetCompositingQuality class

Il record EmfPlusSetCompositingQuality specifica il livello di qualità desiderato per la creazione di immagini composite da più oggetti.
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusSetCompositingQuality](emfplussetcompositingquality)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusSetCompositingQuality`](../emfplussetcompositingquality) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [CompositingQuality](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/compositingquality) { get; set; } | Ottiene o imposta la qualità della composizione. |
