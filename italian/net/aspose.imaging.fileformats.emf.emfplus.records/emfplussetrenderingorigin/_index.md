...
description: Il record EmfPlusSetRenderingOrigin specifica lorigine del rendering per loutput grafico.
type: docs
weight: 6370
url: /it/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/
---
## EmfPlusSetRenderingOrigin class

Il record EmfPlusSetRenderingOrigin specifica l'origine del rendering per l'output grafico.
...
| Nome | Descrizione |
| --- | --- |
| [EmfPlusSetRenderingOrigin](emfplussetrenderingorigin)(EmfPlusRecord) | Inizializza una nuova istanza di[`EmfPlusSetRenderingOrigin`](../emfplussetrenderingorigin) classe. |
...
| [X](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/x) { get; set; } | Ottiene o imposta un intero senza segno a 32 bit che definisce il valore della coordinata orizzontale dell'origine del rendering. |
| [Y](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetrenderingorigin/y) { get; set; } | Ottiene o imposta un intero senza segno a 32 bit che definisce il valore della coordinata verticale dell'origine del rendering. |
