...
description: Inizializza una nuova istanza diEmfRecorderGraphics2Daspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d classe.
type: docs
weight: 10
url: /it/net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/emfrecordergraphics2d/
---
## EmfRecorderGraphics2D constructor

Inizializza una nuova istanza di[`EmfRecorderGraphics2D`](../../emfrecordergraphics2d) classe.
...
| --- | --- | --- |
| frame | Rectangle | La cornice. |
| deviceSize | Size | Dimensioni del dispositivo. |
| deviceSizeMm | Size | La dimensione del dispositivo mm. |
