...
type: docs
weight: 60
url: /it/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawcubicbezier/
---
...
| pt1 | Point | Il punto di partenza della curva. |
| pt2 | Point | Il primo punto di controllo per la curva. |
| pt3 | Point | Il secondo punto di controllo per la curva. |
| pt4 | Point | Il punto finale della curva. |
