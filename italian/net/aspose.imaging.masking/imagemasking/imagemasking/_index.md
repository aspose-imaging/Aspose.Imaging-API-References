...
description: Inizializza una nuova istanza diImageMaskingaspose.imaging.masking/imagemasking classe.
type: docs
weight: 10
url: /it/net/aspose.imaging.masking/imagemasking/imagemasking/
---
## ImageMasking constructor

Inizializza una nuova istanza di[`ImageMasking`](../../imagemasking) classe.
...
| --- | --- | --- |
| sourceImage | RasterImage | L'immagine di origine. |

### Eccezioni

| eccezione | condizione |
| --- | --- |
| ArgumentNullException | l'immagine di origine è nulla. |
