...
description: Crea la sessione di mascheratura che può eseguire operazioni di scomposizione di riaddestramento.
type: docs
weight: 20
url: /it/net/aspose.imaging.masking/imagemasking/createsession/
---
## ImageMasking.CreateSession method

Crea la sessione di mascheratura che può eseguire operazioni di scomposizione di riaddestramento.
...
| --- | --- | --- |
| options | MaskingOptions | Le opzioni. |

### Valore di ritorno

la sessione di mascheramento che può eseguire operazioni di scomposizione di riqualificazione.
