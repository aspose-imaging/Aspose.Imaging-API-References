...
description: Salva lo stato della sessione nel flusso specificato.
type: docs
weight: 50
url: /it/net/aspose.imaging.masking/imaskingsession/save/
---
## Save(Stream) {#save}

Salva lo stato della sessione nel flusso specificato.
