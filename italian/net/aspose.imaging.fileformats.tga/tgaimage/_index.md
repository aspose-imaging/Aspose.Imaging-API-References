...
description: Limmagine TGA.
type: docs
weight: 7580
url: /it/net/aspose.imaging.fileformats.tga/tgaimage/
---
## TgaImage class
...
| Nome | Descrizione |
| --- | --- |
| [TgaImage](tgaimage#constructor)(RasterImage) | Inizializza una nuova istanza di[`TgaImage`](../tgaimage) classe. |
| [TgaImage](tgaimage#constructor_1)(Stream) | Inizializza una nuova istanza di[`TgaImage`](../tgaimage) classe. |
| [TgaImage](tgaimage#constructor_2)(string) | Inizializza una nuova istanza di[`TgaImage`](../tgaimage) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [AuthorComments](../../aspose.imaging.fileformats.tga/tgaimage/authorcomments) { get; set; } | Ottiene o imposta i commenti dell'autore. Questo è un campo ASCII composto da 324 byte che sono organizzati come quattro righe di 80 caratteri, ciascuna seguita da un terminatore nullo. |
| [AuthorName](../../aspose.imaging.fileformats.tga/tgaimage/authorname) { get; set; } | Ottiene o imposta il nome dell'autore. Questo campo contiene un totale di 40 caratteri ASCII per il nome. Se il campo è utilizzato, deve contenere il nome della persona che ha creato l'immagine (autore). |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.tga/tgaimage/backgroundcolor) { get; set; } | Ottiene o imposta il colore di sfondo. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.tga/tgaimage/bitsperpixel) { get; } | Ottiene bit per pixel. |
...
| [BytesPerPixel](../../aspose.imaging.fileformats.tga/tgaimage/bytesperpixel) { get; } | Ottiene byte per pixel. |
...
| [DateTimeStamp](../../aspose.imaging.fileformats.tga/tgaimage/datetimestamp) { get; set; } | Ottiene o imposta Data/ora. Questo campo definisce il valore per la data e l'ora in cui l'immagine è stata salvata. Anche se i sistemi operativi in genere contengono file di data e ora, questa funzione è fornita perché il sistema operativo può modificare la data e l'ora se il file viene copiato. Utilizzando quest'area, ti viene garantita una regione non modificata per la registrazione di data e ora . |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Ottiene un valore che indica se questa istanza è stata eliminata. |
| override [FileFormat](../../aspose.imaging.fileformats.tga/tgaimage/fileformat) { get; } | Ottiene il formato del file. |
| [GammaValueDenominator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluedenominator) { get; } | Ottiene la parte Gamma Value Denominator. Un'immagine non corretta (un'immagine senza gamma) dovrebbe avere il valore 1.0 come risultato. |
| [GammaValueNumerator](../../aspose.imaging.fileformats.tga/tgaimage/gammavaluenumerator) { get; } | Ottiene il valore Gamma Numerator part. Un'immagine non corretta (un'immagine senza gamma) dovrebbe avere il valore 1.0 come risultato. |
| override [HasAlpha](../../aspose.imaging.fileformats.tga/tgaimage/hasalpha) { get; } | Ottiene un valore che indica se questo[`TgaImage`](../tgaimage) ha un canale alfa. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.tga/tgaimage/hasbackgroundcolor) { get; set; } | Ottiene o imposta un valore che indica se l'immagine ha il colore di sfondo. |
| [HasColorMap](../../aspose.imaging.fileformats.tga/tgaimage/hascolormap) { get; } | Ottiene un valore che indica se questa immagine ha una mappa dei colori. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.tga/tgaimage/hastransparentcolor) { get; set; } | Ottiene o imposta un valore che indica se l'immagine ha un colore trasparente. |
| override [Height](../../aspose.imaging.fileformats.tga/tgaimage/height) { get; } | Ottiene questa altezza dell'immagine. |
...
| [ImageId](../../aspose.imaging.fileformats.tga/tgaimage/imageid) { get; set; } | Ottiene o imposta l'ID immagine. |
...
| [IsGrayScale](../../aspose.imaging.fileformats.tga/tgaimage/isgrayscale) { get; } | Ottiene un valore che indica se questo[`TgaImage`](../tgaimage) è in scala di grigi. |
...
| [JobNameOrId](../../aspose.imaging.fileformats.tga/tgaimage/jobnameorid) { get; set; } | Ottiene o imposta Nome/ID lavoro. |
| [JobTime](../../aspose.imaging.fileformats.tga/tgaimage/jobtime) { get; set; } | Ottiene o imposta l'ora del lavoro. |
...
| [PixelAspectRatioDenominator](../../aspose.imaging.fileformats.tga/tgaimage/pixelaspectratiodenominator) { get; } | Ottiene la parte del denominatore Pixel Aspect Ratio. |
| [PixelAspectRatioNumerator](../../aspose.imaging.fileformats.tga/tgaimage/pixelaspectrationumerator) { get; } | Ottiene la parte del numeratore Pixel Aspect Ratio. |
...
| [SoftwareId](../../aspose.imaging.fileformats.tga/tgaimage/softwareid) { get; set; } | Ottiene o imposta l'ID software. Un totale di 40 caratteri ASCII per l'ID software. |
| [SoftwareVersion](../../aspose.imaging.fileformats.tga/tgaimage/softwareversion) { get; set; } | Ottiene o imposta la versione del software. La lunghezza della stringa della versione accettata è di 3-4 caratteri. |
| [SoftwareVersionLetter](../../aspose.imaging.fileformats.tga/tgaimage/softwareversionletter) { get; set; } | Ottiene o imposta la lettera della versione del software part. |
| [SoftwareVersionNumber](../../aspose.imaging.fileformats.tga/tgaimage/softwareversionnumber) { get; set; } | Ottiene o imposta il numero di versione del software part. |
| override [TransparentColor](../../aspose.imaging.fileformats.tga/tgaimage/transparentcolor) { get; set; } | Ottiene o imposta il colore della chiave. |
...
| override [Width](../../aspose.imaging.fileformats.tga/tgaimage/width) { get; } | Ottiene questa larghezza dell'immagine. |
| virtual [XmpData](../../aspose.imaging/rasterimage/xmpdata) { get; set; } | Ottiene o imposta i metadati XMP. |
| [XOrigin](../../aspose.imaging.fileformats.tga/tgaimage/xorigin) { get; set; } | Ottiene o imposta la coordinata orizzontale assoluta per l'angolo inferiore sinistro dell'immagine poiché è posizionato su un dispositivo di visualizzazione avente un'origine nella parte inferiore sinistra dello schermo (ad esempio, la serie TARGA). |
| [YOrigin](../../aspose.imaging.fileformats.tga/tgaimage/yorigin) { get; set; } | Ottiene o imposta la coordinata verticale assoluta per l'angolo inferiore sinistro dell'immagine poiché è posizionato su un dispositivo di visualizzazione avente un'origine nella parte inferiore sinistra dello schermo (ad esempio, la serie TARGA). |
...
| [Clone](../../aspose.imaging.fileformats.tga/tgaimage/clone#clone)() | Crea un nuovo oggetto che è una copia dell'istanza corrente. |
| [Clone](../../aspose.imaging.fileformats.tga/tgaimage/clone#clone_1)(TgaImage) | Clona altro[`TgaImage`](../tgaimage) proprietà dell'oggetto. |
| override [Crop](../../aspose.imaging.fileformats.tga/tgaimage/crop#crop)(Rectangle) | Ritaglio dell'immagine. |
| override [Crop](../../aspose.imaging.fileformats.tga/tgaimage/crop#crop_1)(int, int, int, int) | Ritaglia immagine con spostamenti. |
...
| override [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals_1)(object) | Confronto uguaglianza. |
| [Equals](../../aspose.imaging.fileformats.tga/tgaimage/equals#equals)(TgaImage) | Confronto uguaglianza. |
...
| override [GetHashCode](../../aspose.imaging.fileformats.tga/tgaimage/gethashcode)() | Ottieni il codice hash di questa istanza. Non adatto per essere usato come chiave come[`TgaImage`](../tgaimage) non è immutabile. |
...
| override [Resize](../../aspose.imaging.fileformats.tga/tgaimage/resize#resize_1)(int, int, ImageResizeSettings) | Ridimensiona l'immagine. |
| override [Resize](../../aspose.imaging.fileformats.tga/tgaimage/resize#resize_2)(int, int, ResizeType) | Ridimensiona l'immagine. |
...
| override [Rotate](../../aspose.imaging.fileformats.tga/tgaimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotate immagine intorno al centro. |
| override [RotateFlip](../../aspose.imaging.fileformats.tga/tgaimage/rotateflip)(RotateFlipType) | Il capovolgimento ruotato. |
...
| [operator ==](../../aspose.imaging.fileformats.tga/tgaimage/op_equality) | Confronto uguaglianza. |
| [operator !=](../../aspose.imaging.fileformats.tga/tgaimage/op_inequality) | Confronto di non uguaglianza. |
...
* spazio dei nomi [Aspose.Imaging.FileFormats.Tga](../../aspose.imaging.fileformats.tga)
