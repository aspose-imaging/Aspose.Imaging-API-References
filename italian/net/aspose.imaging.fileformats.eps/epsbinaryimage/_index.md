...
description: Classe per il formato PostScript incapsulato con intestazione binaria
type: docs
weight: 6550
url: /it/net/aspose.imaging.fileformats.eps/epsbinaryimage/
---
## EpsBinaryImage class

Classe per il formato PostScript incapsulato con intestazione binaria
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsbinaryimage/epstype) { get; } | Ottiene il valore del sottotipo EPS |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/hasrasterpreview) { get; } | Ottiene un valore che indica se questa istanza ha un'anteprima raster specifica del formato |
...
| [TiffPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/tiffpreview) { get; } | Ottiene l'anteprima TIFF. |
...
| [WmfPreview](../../aspose.imaging.fileformats.eps/epsbinaryimage/wmfpreview) { get; } | Ottiene l'anteprima WMF. |
...
| [ConvertToInterchange](../../aspose.imaging.fileformats.eps/epsbinaryimage/converttointerchange)() | Converte questa istanza in[`EpsInterchangeImage`](../epsinterchangeimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsbinaryimage/op_explicit) | Esegue una conversione esplicita da[`EpsInterchangeImage`](../epsinterchangeimage) a[`EpsBinaryImage`](../epsbinaryimage) |
