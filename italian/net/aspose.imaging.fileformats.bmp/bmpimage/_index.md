...
description: Unimmagine bmp supporta i formati BMP DIB.
type: docs
weight: 1380
url: /it/net/aspose.imaging.fileformats.bmp/bmpimage/
---
## BmpImage class

Un'immagine bmp (supporta i formati BMP, DIB).
...
| Nome | Descrizione |
| --- | --- |
| [BmpImage](bmpimage#constructor)(RasterImage) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_5)(Stream) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_7)(string) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_2)(int, int) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_3)(int, int, ushort, IColorPalette) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_1)(RasterImage, ushort, BitmapCompression, double, double) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_6)(Stream, ushort, BitmapCompression, double, double) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_8)(string, ushort, BitmapCompression, double, double) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
| [BmpImage](bmpimage#constructor_4)(int, int, ushort, IColorPalette, BitmapCompression, double, double) | Inizializza una nuova istanza di[`BmpImage`](../bmpimage) classe. |
...
| [BitmapInfoHeader](../../aspose.imaging.fileformats.bmp/bmpimage/bitmapinfoheader) { get; } | Ottiene l'intestazione delle informazioni bitmap. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.bmp/bmpimage/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| [Compression](../../aspose.imaging.fileformats.bmp/bmpimage/compression) { get; } | Ottiene la compressione dell'immagine. |
...
| override [FileFormat](../../aspose.imaging.fileformats.bmp/bmpimage/fileformat) { get; } | Ottiene un valore di formato file |
...
| override [Height](../../aspose.imaging.fileformats.bmp/bmpimage/height) { get; } | Ottiene l'altezza dell'immagine. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/horizontalresolution) { get; set; } | Ottiene o imposta la risoluzione orizzontale, in pixel per pollice, di questo[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.bmp/bmpimage/rawdataformat) { get; } | Ottiene il formato dei dati grezzi. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.bmp/bmpimage/rawlinesize) { get; } | Ottiene la dimensione della riga grezza in byte. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/verticalresolution) { get; set; } | Ottiene o imposta la risoluzione verticale, in pixel per pollice, di questo[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.bmp/bmpimage/width) { get; } | Ottiene la larghezza dell'immagine. |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.bmp/bmpimage/getdefaultoptions)(object[]) | Ottiene le opzioni predefinite. |
...
| override [SetResolution](../../aspose.imaging.fileformats.bmp/bmpimage/setresolution)(double, double) | Imposta la risoluzione per questo[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [ToBitmap](../../aspose.imaging.fileformats.bmp/bmpimage/tobitmap)() | Converte l'immagine raster in bitmap. |
...
L'esempio seguente mostra come creare un'immagine BMP della dimensione specificata.
...
{
    // Riempi l'immagine con un semplice gradiente rosso-nero lineare.
