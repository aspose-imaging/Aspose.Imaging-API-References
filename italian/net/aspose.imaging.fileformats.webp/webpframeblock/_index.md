...
description: Rappresenta il registro degli apri blocchi webp.
type: docs
weight: 8070
url: /it/net/aspose.imaging.fileformats.webp/webpframeblock/
---
## WebPFrameBlock class

Rappresenta il registro degli apri blocchi webp.
...
| Nome | Descrizione |
| --- | --- |
| [WebPFrameBlock](webpframeblock#constructor)(RasterImage) | Inizializza una nuova istanza di[`WebPFrameBlock`](../webpframeblock) |
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | Inizializza una nuova istanza di[`WebPFrameBlock`](../webpframeblock) classe. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | Ottiene il metodo di smaltimento. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Ottiene un valore che indica se questa istanza è stata eliminata. |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration) { get; set; } | Ottiene o imposta la durata del frame. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | Ottiene un valore di formato file |
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft) { get; } | Ottiene l'offset sinistro del fotogramma. |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime) { get; } | Ottiene la durata del frame. |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | Ottiene l'offset superiore del frame. |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | Ottiene un valore che indica se questa istanza ha alpha. |
...
| override [Height](../../aspose.imaging.fileformats.webp/webpframeblock/height) { get; } | Ottiene l'altezza dell'immagine. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | Ottiene o imposta la posizione del frame a sinistra. |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | Ottiene o imposta la posizione del frame in alto. |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width) { get; } | Ottiene la larghezza dell'immagine. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe)() | Ottiene il fotogramma intero. |
