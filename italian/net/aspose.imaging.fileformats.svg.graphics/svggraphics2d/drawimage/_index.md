...
description: Disegna limmagine specificata nella posizione specificata.
type: docs
weight: 40
url: /it/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawimage/
---
...
| --- | --- | --- |
| image | RasterImage | L'immagine disegnata. |
| origin | Point | La posizione dell'immagine disegnata. |
...
| image | RasterImage | L'immagine disegnata. |
| origin | Point | La posizione dell'immagine disegnata. |
| size | Size | La dimensione desiderata dell'immagine disegnata. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| srcRect | Rectangle | La parte dell'oggetto immagine da disegnare. |
| destRect | Rectangle | La posizione e le dimensioni dell'immagine disegnata. L'immagine viene ridimensionata per adattarsi al rettangolo. |
