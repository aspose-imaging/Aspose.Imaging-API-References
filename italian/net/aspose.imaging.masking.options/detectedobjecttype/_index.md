...
description: Enumerazione dei tipi di oggetto rilevati.
type: docs
weight: 10470
url: /it/net/aspose.imaging.masking.options/detectedobjecttype/
---
## DetectedObjectType enumeration

Enumerazione dei tipi di oggetto rilevati.
...
| --- | --- | --- |
| Human | `0` | Il tipo di oggetto umano. |
| Other | `1` | Altro tipo di oggetto. |
