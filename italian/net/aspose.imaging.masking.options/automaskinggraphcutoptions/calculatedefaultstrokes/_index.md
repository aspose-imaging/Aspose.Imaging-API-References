---
title: CalculateDefaultStrokes
second_title: Riferimento all'API di Aspose.Imaging per .NET
description: Ottiene o imposta un valore che indica se devono essere calcolati i tratti predefiniti.
type: docs
weight: 30
url: /it/net/aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes/
---
## AutoMaskingGraphCutOptions.CalculateDefaultStrokes property

Ottiene o imposta un valore che indica se devono essere calcolati i tratti predefiniti.
