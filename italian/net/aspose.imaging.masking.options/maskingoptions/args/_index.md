...
description: Ottiene o imposta gli argomenti per lalgoritmo di segmentazione.
type: docs
weight: 20
url: /it/net/aspose.imaging.masking.options/maskingoptions/args/
---
## MaskingOptions.Args property

Ottiene o imposta gli argomenti per l'algoritmo di segmentazione.
...
Gli argomenti per l'algoritmo di segmentazione.
