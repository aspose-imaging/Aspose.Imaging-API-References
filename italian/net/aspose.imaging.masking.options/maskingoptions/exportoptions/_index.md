...
description: Ottiene o imposta le opzioni di esportazione dellimmagine.
type: docs
weight: 50
url: /it/net/aspose.imaging.masking.options/maskingoptions/exportoptions/
---
## MaskingOptions.ExportOptions property

Ottiene o imposta le opzioni di esportazione dell'immagine.
...
Le opzioni di esportazione delle immagini che verranno utilizzate per creare le immagini risultanti.
