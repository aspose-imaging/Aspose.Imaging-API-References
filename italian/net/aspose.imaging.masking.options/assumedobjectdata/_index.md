...
description: I dati delloggetto presunto. Include il tipo e larea delloggetto.
type: docs
weight: 10440
url: /it/net/aspose.imaging.masking.options/assumedobjectdata/
---
...
| Nome | Descrizione |
| --- | --- |
| [AssumedObjectData](assumedobjectdata#constructor)() | Inizializza una nuova istanza di[`AssumedObjectData`](../assumedobjectdata) classe. |
| [AssumedObjectData](assumedobjectdata#constructor_1)(DetectedObjectType, Rectangle) | Inizializza una nuova istanza di[`AssumedObjectData`](../assumedobjectdata) classe. |
| [AssumedObjectData](assumedobjectdata#constructor_2)(string, Rectangle) | Inizializza una nuova istanza di[`AssumedObjectData`](../assumedobjectdata) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Bounds](../../aspose.imaging.masking.options/assumedobjectdata/bounds) { get; set; } | Ottiene o imposta i limiti dell'oggetto. |
| [Type](../../aspose.imaging.masking.options/assumedobjectdata/type) { get; set; } | Ottiene o imposta il tipo dell'oggetto. |
