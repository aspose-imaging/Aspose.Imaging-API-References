...
description: Ottiene o imposta il numero di oggetti su cui separare limmagine iniziale opzionale il valore predefinito è 2 oggetto e sfondo.
type: docs
weight: 30
url: /it/net/aspose.imaging.masking.options/automaskingargs/numberofobjects/
---
## AutoMaskingArgs.NumberOfObjects property

Ottiene o imposta il numero di oggetti su cui separare l'immagine iniziale (opzionale), il valore predefinito è 2 (oggetto e sfondo).
