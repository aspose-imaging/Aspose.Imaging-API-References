...
description: Rappresenta gli argomenti specificati per i metodi di mascheramento automatizzati
type: docs
weight: 10450
url: /it/net/aspose.imaging.masking.options/automaskingargs/
---
## AutoMaskingArgs class

Rappresenta gli argomenti specificati per i metodi di mascheramento automatizzati
...
| Nome | Descrizione |
| --- | --- |
| [AutoMaskingArgs](automaskingargs)() | Default_Costruttore |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [MaxIterationNumber](../../aspose.imaging.masking.options/automaskingargs/maxiterationnumber) { get; set; } | Ottiene o imposta il numero massimo di iterazioni. |
| [NumberOfObjects](../../aspose.imaging.masking.options/automaskingargs/numberofobjects) { get; set; } | Ottiene o imposta il numero di oggetti su cui separare l'immagine iniziale (opzionale), il valore predefinito è 2 (oggetto e sfondo). |
| [ObjectsPoints](../../aspose.imaging.masking.options/automaskingargs/objectspoints) { get; set; } | Ottiene o imposta i punti che appartengono a oggetti separati (opzionale) Coordinate NumberOfObjects che appartengono agli oggetti NumberOfObjects dell'immagine iniziale. Questo parametro viene utilizzato per aumentare la precisione del metodo di segmentazione. |
| [ObjectsRectangles](../../aspose.imaging.masking.options/automaskingargs/objectsrectangles) { get; set; } | Ottiene o imposta i rettangoli degli oggetti che appartengono a oggetti separati (opzionale). Questo parametro viene utilizzato per aumentare la precisione del metodo di segmentazione. |
| [OrphanedPoints](../../aspose.imaging.masking.options/automaskingargs/orphanedpoints) { get; set; } | Ottiene o imposta i punti che non appartengono più ad alcun oggetto (opzionale). Questo parametro viene utilizzato solo in caso di risegmentazione. |
| [Precision](../../aspose.imaging.masking.options/automaskingargs/precision) { get; set; } | Ottiene o imposta la precisione del metodo di segmentazione (opzionale). |
