...
description: Limmagine Cdr.
type: docs
weight: 1420
url: /it/net/aspose.imaging.fileformats.cdr/cdrimage/
---
## CdrImage class
...
| Nome | Descrizione |
| --- | --- |
| [CdrImage](cdrimage)(Stream, LoadOptions) | Inizializza una nuova istanza di[`CdrImage`](../cdrimage) classe. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimage/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimage/cdrdocument) { get; } | Ottiene o imposta il documento CDR. |
...
| override [FileFormat](../../aspose.imaging.fileformats.cdr/cdrimage/fileformat) { get; } | Ottiene un valore di formato file |
...
| override [Height](../../aspose.imaging.fileformats.cdr/cdrimage/height) { get; } | Ottiene l'altezza dell'immagine. |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimage/iscached) { get; } | Ottiene un valore che indica se i dati dell'oggetto sono attualmente memorizzati nella cache e non è richiesta alcuna lettura dei dati. |
| override [PageCount](../../aspose.imaging.fileformats.cdr/cdrimage/pagecount) { get; } | Ottiene o imposta il conteggio delle pagine. |
| override [PageExportingAction](../../aspose.imaging.fileformats.cdr/cdrimage/pageexportingaction) { get; set; } | Ottiene o imposta l'azione di esportazione della pagina. Tieni presente che l'impostazione di questo metodo rilascerà automaticamente le risorse della pagina dopo l'esecuzione. Verrà eseguito appena prima del salvataggio di ogni pagina. |
| override [Pages](../../aspose.imaging.fileformats.cdr/cdrimage/pages) { get; } | Ottiene le pagine. |
...
| override [Width](../../aspose.imaging.fileformats.cdr/cdrimage/width) { get; } | Ottiene la larghezza dell'immagine. |
...
| Nome | Descrizione |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimage/cachedata)() | Memorizza i dati nella cache e garantisce che nessun ulteriore caricamento dei dati venga eseguito dal sottostante [`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.cdr/cdrimage/getdefaultoptions)(object[]) | Ottiene le opzioni predefinite. |
...
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimage/resize#resize_1)(int, int, ImageResizeSettings) | Ridimensiona l'immagine. |
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimage/resize#resize_2)(int, int, ResizeType) | Ridimensiona l'immagine. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cdr/cdrimage/rotateflip)(RotateFlipType) | Ruota, capovolge o ruota e capovolge l'immagine. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cdr/cdrimage/setpalette)(IColorPalette, bool) | Imposta la tavolozza dell'immagine. |
