...
description: La pagina dellimmagine del Cdr
type: docs
weight: 1430
url: /it/net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
## CdrImagePage class

La pagina dell'immagine del Cdr
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimagepage/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimagepage/cdrdocument) { get; } | Ottiene o imposta il documento CDR. |
...
| override [FileFormat](../../aspose.imaging.fileformats.cdr/cdrimagepage/fileformat) { get; } | Ottiene un valore di formato file |
...
| override [Height](../../aspose.imaging.fileformats.cdr/cdrimagepage/height) { get; } | Ottiene l'altezza dell'immagine. |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimagepage/iscached) { get; } | Ottiene un valore che indica se i dati dell'oggetto sono attualmente memorizzati nella cache e non è richiesta alcuna lettura dei dati. |
| [PageNumber](../../aspose.imaging.fileformats.cdr/cdrimagepage/pagenumber) { get; } | Ottiene il numero di pagina. |
...
| [ParentImage](../../aspose.imaging.fileformats.cdr/cdrimagepage/parentimage) { get; } | Ottiene l'immagine principale. |
...
| override [Width](../../aspose.imaging.fileformats.cdr/cdrimagepage/width) { get; } | Ottiene la larghezza dell'immagine. |
...
| Nome | Descrizione |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimagepage/cachedata)() | Memorizza i dati nella cache e garantisce che nessun ulteriore caricamento dei dati venga eseguito dal sottostante[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_1)(int, int, ImageResizeSettings) | Ridimensiona l'immagine. |
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_2)(int, int, ResizeType) | Ridimensiona l'immagine. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cdr/cdrimagepage/rotateflip)(RotateFlipType) | Ruota, capovolge o ruota e capovolge l'immagine. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cdr/cdrimagepage/setpalette)(IColorPalette, bool) | Imposta la tavolozza dell'immagine. |
