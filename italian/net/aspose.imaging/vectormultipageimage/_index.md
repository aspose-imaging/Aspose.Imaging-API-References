...
description: Limmagine multipagina Vector
type: docs
weight: 11220
url: /it/net/aspose.imaging/vectormultipageimage/
---
...
| override [BitsPerPixel](../../aspose.imaging/vectormultipageimage/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| override [IsCached](../../aspose.imaging/vectormultipageimage/iscached) { get; } | Ottiene un valore che indica se i dati dell'oggetto sono attualmente memorizzati nella cache e non è richiesta la lettura dei dati. |
| abstract [PageCount](../../aspose.imaging/vectormultipageimage/pagecount) { get; } | Ottiene il conteggio delle pagine. |
...
| Nome | Descrizione |
| --- | --- |
| override [CacheData](../../aspose.imaging/vectormultipageimage/cachedata)() | Memorizza i dati nella cache e garantisce che nessun ulteriore caricamento dei dati venga eseguito dal sottostante [`DataStreamContainer`](../datastreamsupporter/datastreamcontainer) . |
...
| override [Resize](../../aspose.imaging/vectormultipageimage/resize#resize_1)(int, int, ImageResizeSettings) | Ridimensiona l'immagine. |
| override [Resize](../../aspose.imaging/vectormultipageimage/resize#resize_2)(int, int, ResizeType) | Ridimensiona l'immagine. |
...
| override [RotateFlip](../../aspose.imaging/vectormultipageimage/rotateflip)(RotateFlipType) | Ruota, capovolge o ruota e capovolge l'immagine. |
