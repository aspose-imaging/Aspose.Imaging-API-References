...
description: È una classe per lavorare con file DICOM del tipo multi frame
type: docs
weight: 2430
url: /it/net/aspose.imaging.fileformats.dicom/dicompage/
---
## DicomPage class

È una classe per lavorare con file DICOM del tipo multi frame
...
| Nome | Descrizione |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | Inizializza una nuova istanza di[`DicomPage`](../dicompage) classe. |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | Inizializza una nuova istanza di[`DicomPage`](../dicompage) classe. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel) { get; } | Ottiene il numero di bit dell'immagine per pixel. |
...
| override [FileFormat](../../aspose.imaging.fileformats.dicom/dicompage/fileformat) { get; } | Ottiene un valore di formato file |
...
| override [Height](../../aspose.imaging.fileformats.dicom/dicompage/height) { get; } | Ottiene l'altezza dell'immagine. |
...
| [Index](../../aspose.imaging.fileformats.dicom/dicompage/index) { get; } | Ottiene l'indice della pagina corrente. |
...
| override [Width](../../aspose.imaging.fileformats.dicom/dicompage/width) { get; } | Ottiene la larghezza dell'immagine. |
