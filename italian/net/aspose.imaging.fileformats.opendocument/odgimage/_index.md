...
description: La grafica del documento aperto
type: docs
weight: 7390
url: /it/net/aspose.imaging.fileformats.opendocument/odgimage/
---
## OdgImage class
...
| Nome | Descrizione |
| --- | --- |
| [OdgImage](odgimage#constructor)(StreamContainer) | Inizializza una nuova istanza di[`OdgImage`](../odgimage) classe. |
| [OdgImage](odgimage#constructor_1)(StreamContainer, LoadOptions) | Inizializza una nuova istanza di[`OdgImage`](../odgimage) classe. |
...
| override [FileFormat](../../aspose.imaging.fileformats.opendocument/odgimage/fileformat) { get; } | Ottiene un valore di formato file |
...
| override [PageExportingAction](../../aspose.imaging.fileformats.opendocument/odgimage/pageexportingaction) { get; set; } | Ottiene o imposta l'azione di esportazione della pagina. Tieni presente che l'impostazione di questo metodo rilascerà automaticamente le risorse della pagina dopo l'esecuzione. Verrà eseguito appena prima del salvataggio di ogni pagina. |
| override [Pages](../../aspose.imaging.fileformats.opendocument/odgimage/pages) { get; } | Ottiene le pagine. |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.opendocument/odgimage/getdefaultoptions)(object[]) | Ottiene le opzioni predefinite. |
...
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_1)(int, int, ImageResizeSettings) | Ridimensiona l'immagine. |
| override [Resize](../../aspose.imaging.fileformats.opendocument/odgimage/resize#resize_2)(int, int, ResizeType) | Ridimensiona l'immagine. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.opendocument/odgimage/rotateflip)(RotateFlipType) | Ruota, capovolge o ruota e capovolge l'immagine. |
