...
type: docs
weight: 14
url: /tr/java/com.aspose.imaging.masking.options/graphcutmaskingoptions/
---
**Inheritance:**
...
Tüylenme 3 olarak ayarlanmış Graph Cut görüntü maskeleme sonucu kaydediliyor. Görüntü maskelemesi belirtilen Point dizisi kullanılarak gerçekleştirilir.
``` java
MaskingResult[] results;
try (RasterImage image = (RasterImage)Image.load("input.jpg"))
{
