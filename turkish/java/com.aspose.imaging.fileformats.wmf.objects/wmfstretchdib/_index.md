...
type: docs
weight: 94
url: /tr/java/com.aspose.imaging.fileformats.wmf.objects/wmfstretchdib/
---
**Inheritance:**
...
| Yapıcı | Açıklama |
| --- | --- |
| [WmfStretchDib()](#WmfStretchDib--) | WMFs kaydı. |
## Yöntemler
...
DIB'nin Colors alanı açık RGB değerleri veya bir palete indeksler içerir. Bu değer `com.aspose.imaging.fileFormats.wmf.objects.wmfStretchDib.ColorUsage` içinde olmalıdır.

Sınıflandırma (bölüm 2.1.1.6).
