...
description: "tiff işaretli long türü."
type: docs
weight: 22
url: /tr/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffslongtype/
---
**Inheritance:**
...
tiff işaretli long türü.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [TiffSLongType(int tagId)](#TiffSLongType-int-) | Yeni bir `TiffSLongType` sınıfının örneğini başlatır. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getValues()](#getValues--) | Değerleri alır veya ayarlar. |
| [setValues(int[] value)](#setValues-int---) | Değerleri alır veya ayarlar. |
...
Yeni bir `TiffSLongType` sınıfının örneğini başlatır.
