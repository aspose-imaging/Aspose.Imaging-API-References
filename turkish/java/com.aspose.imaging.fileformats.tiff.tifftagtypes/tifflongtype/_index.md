...
description: "tiff long türü."
type: docs
weight: 18
url: /tr/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
**Inheritance:**
...
| Yapıcı | Açıklama |
| --- | --- |
| [TiffLongType(int tagId)](#TiffLongType-int-) | Yeni bir `TiffLongType` sınıfının örneğini başlatır. |
## Yöntemler
...
Yeni bir `TiffLongType` sınıfının örneğini başlatır.
