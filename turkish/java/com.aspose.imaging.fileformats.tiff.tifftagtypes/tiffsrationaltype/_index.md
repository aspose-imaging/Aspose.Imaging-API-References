...
description: "Tiff işaretli rasyonel tür."
type: docs
weight: 23
url: /tr/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/
---
**Inheritance:**
...
Tiff işaretli rasyonel tür.
## Yapıcılar

| Yapıcı | Açıklama |
| --- | --- |
| [TiffSRationalType(int tagId)](#TiffSRationalType-int-) | Yeni bir `TiffSRationalType` sınıfının örneğini başlatır. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getValues()](#getValues--) | Değerleri alır veya ayarlar. |
| [setValues(TiffSRational[] value)](#setValues-com.aspose.imaging.fileformats.tiff.TiffSRational---) | Değerleri alır veya ayarlar. |
...
Yeni bir `TiffSRationalType` sınıfının örneğini başlatır.
