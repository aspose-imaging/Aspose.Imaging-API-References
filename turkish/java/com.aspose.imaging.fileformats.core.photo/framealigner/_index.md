...
description: "Çerçeve hizalama"
type: docs
weight: 10
url: /tr/java/com.aspose.imaging.fileformats.core.photo/framealigner/
---
**Inheritance:**
java.lang.Object
```
...
| Yöntem | Açıklama |
| --- | --- |
| [process(RasterImage[] images, FrameAlignerOptions options)](#process-com.aspose.imaging.RasterImage---com.aspose.imaging.fileformats.core.photo.FrameAlignerOptions-) | Belirtilen görüntüleri işler. |
...
| options | [FrameAlignerOptions](../../com.aspose.imaging.fileformats.core.photo/framealigneroptions) | Seçenekler. |

**Returns:**
java.util.List<com.aspose.imaging.Point> - Görüntüler tarafından ofsetlerin listesi
