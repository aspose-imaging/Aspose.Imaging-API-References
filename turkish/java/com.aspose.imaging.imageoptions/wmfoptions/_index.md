...
type: docs
weight: 54
url: /tr/java/com.aspose.imaging.imageoptions/wmfoptions/
---
**Inheritance:**
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Yalnızca ilk iki sayfayı dışa aktar. Aslında, WMF çok sayfalı bir format olmadığından yalnızca bir sayfa dönüştürülecek.
