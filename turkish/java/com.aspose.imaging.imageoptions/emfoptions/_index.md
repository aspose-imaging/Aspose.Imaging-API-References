...
type: docs
weight: 19
url: /tr/java/com.aspose.imaging.imageoptions/emfoptions/
---
**Inheritance:**
...
| [EmfOptions(float dpiX, float dpiY)](#EmfOptions-float-float-) | Yeni bir `EmfOptions` sınıfı örneği başlatır. |
| [EmfOptions(float dpi)](#EmfOptions-float-) |  |
| [EmfOptions(EmfOptions emfOptions)](#EmfOptions-com.aspose.imaging.imageoptions.EmfOptions-) | Yeni bir `EmfOptions` sınıfı örneği başlatır. |
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Yalnızca ilk iki sayfayı dışa aktar. Aslında, EMF çok sayfalı bir format olmadığı için sadece bir sayfa dönüştürülecek.
...
Yeni bir `EmfOptions` sınıfı örneği başlatır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| emfOptions | [EmfOptions](../../com.aspose.imaging.imageoptions/emfoptions) | EMF seçenekleri. |
