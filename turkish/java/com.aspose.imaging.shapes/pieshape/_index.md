...
type: docs
weight: 14
url: /tr/java/com.aspose.imaging.shapes/pieshape/
---
**Inheritance:**
...
| Yapıcı | Açıklama |
| --- | --- |
| [PieShape()](#PieShape--) | Yeni bir `PieShape` sınıfı örneğini başlatır. |
| [PieShape(RectangleF rectangle, float startAngle, float sweepAngle)](#PieShape-com.aspose.imaging.RectangleF-float-float-) | Yeni bir `PieShape` sınıfı örneğini başlatır. |
## Yöntemler
...
Yeni bir `PieShape` sınıfı örneğini başlatır.
