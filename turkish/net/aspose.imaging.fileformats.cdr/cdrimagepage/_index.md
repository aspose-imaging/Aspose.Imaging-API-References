...
description: Cdr resmi sayfası
type: docs
weight: 1430
url: /tr/net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
## CdrImagePage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.cdr/cdrimagepage/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| [CdrDocument](../../aspose.imaging.fileformats.cdr/cdrimagepage/cdrdocument) { get; } | CDR belgesini alır veya ayarlar. |
...
| override [FileFormat](../../aspose.imaging.fileformats.cdr/cdrimagepage/fileformat) { get; } | dosya formatının bir değerini alır |
...
| override [Height](../../aspose.imaging.fileformats.cdr/cdrimagepage/height) { get; } | Görüntü yüksekliğini alır. |
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimagepage/iscached) { get; } | Nesnenin verilerinin şu anda önbelleğe alınıp alınmadığını ve veri okuması gerekip gerekmediğini gösteren bir değer alır. |
| [PageNumber](../../aspose.imaging.fileformats.cdr/cdrimagepage/pagenumber) { get; } | Sayfa numarasını alır. |
...
| [ParentImage](../../aspose.imaging.fileformats.cdr/cdrimagepage/parentimage) { get; } | Üst resmi alır. |
...
| override [Width](../../aspose.imaging.fileformats.cdr/cdrimagepage/width) { get; } | Görüntü genişliğini alır. |
...
| İsim | Tanım |
| --- | --- |
| override [CacheData](../../aspose.imaging.fileformats.cdr/cdrimagepage/cachedata)() | Verileri önbelleğe alır ve temel alınandan ek veri yüklemesi yapılmamasını sağlar[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_1)(int, int, ImageResizeSettings) | Resmi yeniden boyutlandırır. |
| override [Resize](../../aspose.imaging.fileformats.cdr/cdrimagepage/resize#resize_2)(int, int, ResizeType) | Resmi yeniden boyutlandırır. |
...
| override [RotateFlip](../../aspose.imaging.fileformats.cdr/cdrimagepage/rotateflip)(RotateFlipType) | Görüntüyü döndürür, çevirir veya döndürür ve döndürür. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cdr/cdrimagepage/setpalette)(IColorPalette, bool) | Görüntü paletini ayarlar. |
