...
description: Bazı işlemlerin sonucunun bulunduğu Djvu raster görüntüsünü temsil eden sınıf
type: docs
weight: 2460
url: /tr/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

Bazı işlemlerin sonucunun bulunduğu Djvu raster görüntüsünü temsil eden sınıf
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | Yüksekliği alır. |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | Uzunluğu alır. |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | Genişliği alır. |
