...
type: docs
weight: 270
url: /tr/net/aspose.imaging.fileformats.djvu/djvuimage/resizeheightproportionally/
---
...
Bu örnek, bir DJVU görüntüsünü yükler ve çeşitli yeniden boyutlandırma yöntemlerini kullanarak orantılı olarak yeniden boyutlandırır. Yalnızca yükseklik belirtilir, genişlik otomatik olarak hesaplanır.
