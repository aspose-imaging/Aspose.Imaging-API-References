...
description: Djvu sayfası class
type: docs
weight: 2450
url: /tr/net/aspose.imaging.fileformats.djvu/djvupage/
---
## DjvuPage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvupage/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvupage/height) { get; } | Sayfanın yüksekliğini alır |
...
| [Image](../../aspose.imaging.fileformats.djvu/djvupage/image) { get; } | Resmi alır. |
...
| [IsColor](../../aspose.imaging.fileformats.djvu/djvupage/iscolor) { get; } | Bu örneğin renkli olup olmadığını gösteren bir değer alır. |
...
| [PageNumber](../../aspose.imaging.fileformats.djvu/djvupage/pagenumber) { get; } | Sayfa numarasını alır. |
...
| [ParentImage](../../aspose.imaging.fileformats.djvu/djvupage/parentimage) { get; } | Sayfanın ait olduğu üst resmi alır |
...
| [ThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/thumbnailimage) { get; set; } | page sayfasının küçük resmini alır veya ayarlar |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvupage/width) { get; } | Sayfanın genişliğini alır |
...
| [ExtractThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/extractthumbnailimage)() | Djvu sayfasından küçük resim görüntüsünü alır. |
...
| [GetBackgroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getbackgroundimage)() | Arka plan resmini alır. |
...
| [GetForegroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getforegroundimage)(int) | page için ön plan resmini alır |
...
| [GetTextForLocation](../../aspose.imaging.fileformats.djvu/djvupage/gettextforlocation)(Rectangle) | dikdörtgen konumu için metni alır |
| [GetTextImage](../../aspose.imaging.fileformats.djvu/djvupage/gettextimage)(int) | Metin görüntüsünü alır. |
