...
description: Belirtilen Resmi orijinal fiziksel boyutunu kullanarak belirtilen konumda çizer.
type: docs
weight: 80
url: /tr/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawimage/
---
## DrawImage(RasterImage, Point) {#drawimage}

Belirtilen Resmi orijinal fiziksel boyutunu kullanarak belirtilen konumda çizer.
...
| location | Point | Çizilen görüntünün sol üst köşesinin konumu. |
...
| --- | --- | --- |
| image | RasterImage | Çizilecek görüntü. |
| destRect | Rectangle | Çizilen görüntünün konumunu ve boyutunu belirten dikdörtgen yapı. Görüntü dikdörtgene sığacak şekilde ölçeklenir. |
| srcRect | Rectangle | Resim nesnesinin çizilecek bölümünü belirten dikdörtgen yapı. |
| srcUnit | GraphicsUnit | srcRect parametresi tarafından kullanılan ölçü birimleri. |

### istisnalar

| istisna | şart |
| --- | --- |
| ArgumentOutOfRangeException | srcUnit;Yalnızca Pixel birimini destekler |
...
| destRect | Rectangle | Yol tarifi. |
| srcUnit | GraphicsUnit | Kaynak birimi. |
