...
description: Yeni bir örneğini başlatırEmfRecorderGraphics2Daspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/emfrecordergraphics2d/
---
## EmfRecorderGraphics2D constructor

Yeni bir örneğini başlatır[`EmfRecorderGraphics2D`](../../emfrecordergraphics2d) sınıf.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| frame | Rectangle | Çerçeve. |
| deviceSize | Size | Cihazın boyutu. |
| deviceSizeMm | Size | Cihaz boyutu mm. |
