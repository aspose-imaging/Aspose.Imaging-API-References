...
description: Karma çerçeve.
type: docs
weight: 7870
url: /tr/net/aspose.imaging.fileformats.tiff/tiffframe/
---
## TiffFrame class
...
| İsim | Tanım |
| --- | --- |
| [TiffFrame](tiffframe#constructor_1)(RasterImage) | Yeni bir örneğini başlatır[`TiffFrame`](../tiffframe) sınıf. |
| [TiffFrame](tiffframe#constructor_3)(Stream) | Yeni bir örneğini başlatır[`TiffFrame`](../tiffframe) sınıf. |
| [TiffFrame](tiffframe#constructor_5)(string) | Yeni bir örneğini başlatır[`TiffFrame`](../tiffframe) sınıf. |
| [TiffFrame](tiffframe#constructor_2)(RasterImage, TiffOptions) | Yeni bir örneğini başlatır[`TiffFrame`](../tiffframe) sınıf. |
| [TiffFrame](tiffframe#constructor_4)(Stream, TiffOptions) | Yeni bir örneğini başlatır[`TiffFrame`](../tiffframe) sınıf. |
| [TiffFrame](tiffframe#constructor_6)(string, TiffOptions) | Yeni bir örneğini başlatır[`TiffFrame`](../tiffframe) sınıf. |
| [TiffFrame](tiffframe#constructor)(TiffOptions, int, int) | Yeni bir örneğini başlatır[`TiffFrame`](../tiffframe) sınıf. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.tiff/tiffframe/backgroundcolor) { get; set; } | Arka plan rengi için bir değer alır veya ayarlar. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.tiff/tiffframe/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| [ExifData](../../aspose.imaging.fileformats.tiff/tiffframe/exifdata) { get; set; } | Çerçeveden EXIF verilerini alır veya ayarlar. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | dosya formatının bir değerini alır |
| [FrameOptions](../../aspose.imaging.fileformats.tiff/tiffframe/frameoptions) { get; } | Çerçeve oluşturma seçeneklerini alır. |
| override [HasAlpha](../../aspose.imaging.fileformats.tiff/tiffframe/hasalpha) { get; } | Bu örneğin alfa olup olmadığını gösteren bir değer alır. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.tiff/tiffframe/hastransparentcolor) { get; set; } | Resmin saydam renge sahip olup olmadığını gösteren bir değer alır. |
| override [Height](../../aspose.imaging.fileformats.tiff/tiffframe/height) { get; } | Görüntü yüksekliğini alır. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/horizontalresolution) { get; set; } | Bunun yatay çözünürlüğünü inç başına piksel cinsinden alır veya ayarlar.[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| [PathResources](../../aspose.imaging.fileformats.tiff/tiffframe/pathresources) { get; set; } | Yol kaynaklarını alır veya ayarlar. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.tiff/tiffframe/verticalresolution) { get; set; } | Bunun dikey çözünürlüğünü inç başına piksel cinsinden alır veya ayarlar.[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.tiff/tiffframe/width) { get; } | Görüntü genişliğini alır. |
| override [XmpData](../../aspose.imaging.fileformats.tiff/tiffframe/xmpdata) { get; set; } | Çerçeveden XMP verilerini alır veya ayarlar. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| static [CopyFrame](../../aspose.imaging.fileformats.tiff/tiffframe/copyframe)(TiffFrame) | Tüm çerçeveyi kopyalar (yineler). |
| static [CreateFrameFrom](../../aspose.imaging.fileformats.tiff/tiffframe/createframefrom)(TiffFrame, TiffOptions) | Belirtilen çerçeveden çerçeveyi oluşturur*tiffFrame* belirtilenleri kullanarak*options* . Piksel verileri korunur ancak istenen biçime dönüştürülür. |
...
| [AlignResolutions](../../aspose.imaging.fileformats.tiff/tiffframe/alignresolutions)() | Yatay ve dikey çözünürlükleri eşit yapmak için yardımcı yöntem. |
...
| override [Crop](../../aspose.imaging.fileformats.tiff/tiffframe/crop#crop)(Rectangle) | Görüntü kırpılıyor. |
...
| override [Resize](../../aspose.imaging.fileformats.tiff/tiffframe/resize#resize_2)(int, int, ResizeType) | Resmi yeniden boyutlandırır. |
...
| override [Rotate](../../aspose.imaging.fileformats.tiff/tiffframe/rotate#rotate_1)(float, bool, Color) | Resmi merkez çevresinde döndürün. |
