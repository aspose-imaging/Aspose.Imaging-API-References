...
description: Multi frame türündeki DICOM dosyalarıyla çalışmak için bir sınıftır.
type: docs
weight: 2430
url: /tr/net/aspose.imaging.fileformats.dicom/dicompage/
---
## DicomPage class

Multi frame türündeki DICOM dosyalarıyla çalışmak için bir sınıftır.
...
| İsim | Tanım |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | Yeni bir örneğini başlatır[`DicomPage`](../dicompage) sınıf. |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | Yeni bir örneğini başlatır[`DicomPage`](../dicompage) sınıf. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| override [FileFormat](../../aspose.imaging.fileformats.dicom/dicompage/fileformat) { get; } | dosya formatının bir değerini alır |
...
| override [Height](../../aspose.imaging.fileformats.dicom/dicompage/height) { get; } | Görüntü yüksekliğini alır. |
...
| [Index](../../aspose.imaging.fileformats.dicom/dicompage/index) { get; } | Geçerli sayfanın dizinini alır. |
...
| override [Width](../../aspose.imaging.fileformats.dicom/dicompage/width) { get; } | Görüntü genişliğini alır. |
