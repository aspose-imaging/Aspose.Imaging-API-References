...
description: Önbellek için maksimum kullanılabilir disk alanını alır veya ayarlar. Belirtilen değer megabayt sayısıdır.
type: docs
weight: 60
url: /tr/net/aspose.imaging/cache/maxdiskspaceforcache/
---
## Cache.MaxDiskSpaceForCache property

Önbellek için maksimum kullanılabilir disk alanını alır veya ayarlar. Belirtilen değer megabayt sayısıdır.
