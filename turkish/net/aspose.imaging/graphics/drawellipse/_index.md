...
description: Bir sınırlayıcı tarafından tanımlanan bir elips çizerRectangleFaspose.imaging/rectanglef .
type: docs
weight: 210
url: /tr/net/aspose.imaging/graphics/drawellipse/
---
## DrawEllipse(Pen, RectangleF) {#drawellipse_1}

Bir sınırlayıcı tarafından tanımlanan bir elips çizer[`RectangleF`](../../rectanglef) .
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen) elipsin rengini, genişliğini ve stilini belirler. |
...
Bir sınırlayıcı tarafından belirtilen bir elips çizer[`Rectangle`](../../rectangle) yapı.
...
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen) elipsin rengini, genişliğini ve stilini belirler. |
| rect | Rectangle | [`Rectangle`](../../rectangle) elipsin sınırlarını tanımlayan yapı. |
