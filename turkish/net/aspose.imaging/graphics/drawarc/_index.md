...
description: Bir çift koordinat genişlik ve yükseklik ile belirtilen bir elipsin bir bölümünü temsil eden bir yay çizer.
type: docs
weight: 160
url: /tr/net/aspose.imaging/graphics/drawarc/
---
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen) Bu, yayın rengini, genişliğini ve stilini belirler. |
...
| sweepAngle | Single | Saat yönünde ölçülen derece cinsinden açı*startAngle* arkın bitiş noktasının parametresi. |
...
tarafından belirtilen bir elipsin bir bölümünü temsil eden bir yay çizer.[`RectangleF`](../../rectanglef) yapı.
...
| startAngle | Int32 | X ekseninden yayın başlangıç noktasına kadar saat yönünde ölçülen derece cinsinden açı. |
| sweepAngle | Int32 | Saat yönünde ölçülen derece cinsinden açı*startAngle* arkın bitiş noktasının parametresi. |
...
tarafından belirtilen bir elipsin bir bölümünü temsil eden bir yay çizer.[`Rectangle`](../../rectangle) yapı.
