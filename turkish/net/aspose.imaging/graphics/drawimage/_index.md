...
description: Belirtilen çizerImageaspose.imaging/graphics/image  belirtilen konumda orijinal fiziksel boyutunu kullanarak.
type: docs
weight: 220
url: /tr/net/aspose.imaging/graphics/drawimage/
---
## DrawImage(Image, PointF) {#drawimage_1}

Belirtilen çizer[`Image`](../image) , belirtilen konumda orijinal fiziksel boyutunu kullanarak.
...
| --- | --- | --- |
| sourceImage | Image | Çizilecek görüntü. |
| x | Single | Çizilen görüntünün sol üst köşesinin x koordinatı. |
| y | Single | Çizilen görüntünün sol üst köşesinin y koordinatı. |
...
Belirtilen çizer[`Image`](../image) belirtilen konumda ve belirtilen boyutta.
...
| --- | --- | --- |
| sourceImage | Image | Çizilecek görüntü. |
| rectDestination | RectangleF | Çizilecek hedef dikdörtgen. |
| graphicsUnit | GraphicsUnit | Grafik birimi. |
| imageAttributes | ImageAttributes | Görüntü öznitelikleri. |
...
| --- | --- | --- |
| sourceImage | Image | Çizilecek görüntü. |
| rectSource | Rectangle | Doğru kaynak. |
| rectDestination | Rectangle | Doğru hedef. |
| graphicsUnit | GraphicsUnit | Grafik birimi. |
...
| --- | --- | --- |
| sourceImage | Image | Çizilecek görüntü. |
| rectSource | RectangleF | Doğru kaynak. |
| rectDestination | RectangleF | Doğru hedef. |
| graphicsUnit | GraphicsUnit | Grafik birimi. |
...
Belirtilenin belirtilen kısmını çizer*image* belirtilen konumda ve belirtilen boyutta.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| image | Image | Çizilecek görüntü. |
| destPoints | Point[] | Bir paralelkenarı tanımlayan üç PointF yapısı dizisi. |
...
| --- | --- | --- |
| image | Image | Çizilecek görüntü. |
| destPoints | PointF[] | Bir paralelkenarı tanımlayan üç PointF yapısı dizisi. |

### istisnalar

| istisna | şart |
| --- | --- |
| ArgumentNullException | resim |
...
| --- | --- | --- |
| sourceImage | Image | Çizilecek görüntü. |
| point | Point | [`Point`](../../point) çizilen görüntünün sol üst köşesinin konumunu temsil eden yapı. |
...
| --- | --- | --- |
| sourceImage | Image | Çizilecek görüntü. |
| rect | Rectangle | [`Rectangle`](../../rectangle) çizilen görüntünün konumunu ve boyutunu belirten yapı. |
