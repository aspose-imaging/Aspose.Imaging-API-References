...
description: Bir dizi tarafından tanımlanan bir çokgen çizerPointFaspose.imaging/pointf yapılar.
type: docs
weight: 290
url: /tr/net/aspose.imaging/graphics/drawpolygon/
---
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| pen | Pen | [`Pen`](../../pen) poligonun rengini, genişliğini ve stilini belirler. |
