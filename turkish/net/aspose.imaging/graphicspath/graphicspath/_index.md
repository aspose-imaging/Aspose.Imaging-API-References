...
description: Yeni bir örneğini başlatırGraphicsPathaspose.imaging/graphicspath sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging/graphicspath/graphicspath/
---
## GraphicsPath() {#constructor}

Yeni bir örneğini başlatır[`GraphicsPath`](../../graphicspath) sınıf.
