...
description: Fırça opaklığını alır veya ayarlar. Değer 0 ile 1 arasında olmalıdır. 0 değeri fırçanın tamamen görünür olduğu 1 değeri fırçanın tamamen opak olduğu anlamına gelir.
type: docs
weight: 10
url: /tr/net/aspose.imaging/brush/opacity/
---
## Brush.Opacity property

Fırça opaklığını alır veya ayarlar. Değer 0 ile 1 arasında olmalıdır. 0 değeri fırçanın tamamen görünür olduğu, 1 değeri fırçanın tamamen opak olduğu anlamına gelir.
