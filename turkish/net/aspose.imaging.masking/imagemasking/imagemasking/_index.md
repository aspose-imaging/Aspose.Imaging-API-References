...
description: Yeni bir örneğini başlatırImageMaskingaspose.imaging.masking/imagemasking sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.masking/imagemasking/imagemasking/
---
## ImageMasking constructor

Yeni bir örneğini başlatır[`ImageMasking`](../../imagemasking) sınıf.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| sourceImage | RasterImage | Kaynak görüntü. |

### istisnalar

| istisna | şart |
| --- | --- |
| ArgumentNullException | kaynak görüntü boş. |
