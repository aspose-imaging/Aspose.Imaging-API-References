...
description: Dng görüntü temsili class
type: docs
weight: 2520
url: /tr/net/aspose.imaging.fileformats.dng/dngimage/
---
## DngImage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dng/dngimage/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| override [FileFormat](../../aspose.imaging.fileformats.dng/dngimage/fileformat) { get; } | dosya formatının bir değerini alır |
...
| override [Height](../../aspose.imaging.fileformats.dng/dngimage/height) { get; } | Görüntü yüksekliğini alır. |
...
| [ImgData](../../aspose.imaging.fileformats.dng/dngimage/imgdata) { get; set; } | İmg verilerini alır veya ayarlar. |
...
| override [Width](../../aspose.imaging.fileformats.dng/dngimage/width) { get; } | Görüntü genişliğini alır. |
