...
description: Bir bmp görüntüsü BMP DIB formatlarını destekler.
type: docs
weight: 1380
url: /tr/net/aspose.imaging.fileformats.bmp/bmpimage/
---
## BmpImage class
...
| İsim | Tanım |
| --- | --- |
| [BmpImage](bmpimage#constructor)(RasterImage) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_5)(Stream) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_7)(string) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_2)(int, int) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_3)(int, int, ushort, IColorPalette) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_1)(RasterImage, ushort, BitmapCompression, double, double) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_6)(Stream, ushort, BitmapCompression, double, double) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_8)(string, ushort, BitmapCompression, double, double) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
| [BmpImage](bmpimage#constructor_4)(int, int, ushort, IColorPalette, BitmapCompression, double, double) | Yeni bir örneğini başlatır[`BmpImage`](../bmpimage) sınıf. |
...
| [BitmapInfoHeader](../../aspose.imaging.fileformats.bmp/bmpimage/bitmapinfoheader) { get; } | Bitmap bilgi başlığını alır. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.bmp/bmpimage/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| [Compression](../../aspose.imaging.fileformats.bmp/bmpimage/compression) { get; } | Görüntü sıkıştırmasını alır. |
...
| override [FileFormat](../../aspose.imaging.fileformats.bmp/bmpimage/fileformat) { get; } | dosya formatının bir değerini alır |
...
| override [Height](../../aspose.imaging.fileformats.bmp/bmpimage/height) { get; } | Görüntü yüksekliğini alır. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/horizontalresolution) { get; set; } | Bunun yatay çözünürlüğünü inç başına piksel cinsinden alır veya ayarlar.[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.bmp/bmpimage/rawdataformat) { get; } | Ham veri biçimini alır. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.bmp/bmpimage/rawlinesize) { get; } | Bayt cinsinden ham satır boyutunu alır. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/verticalresolution) { get; set; } | Bunun dikey çözünürlüğünü inç başına piksel cinsinden alır veya ayarlar.[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.bmp/bmpimage/width) { get; } | Görüntü genişliğini alır. |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.bmp/bmpimage/getdefaultoptions)(object[]) | Varsayılan seçenekleri alır. |
...
| override [SetResolution](../../aspose.imaging.fileformats.bmp/bmpimage/setresolution)(double, double) | Bunun için çözünürlüğü ayarlar[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [ToBitmap](../../aspose.imaging.fileformats.bmp/bmpimage/tobitmap)() | Raster görüntüyü bitmap'e dönüştürür. |
