...
description: EmfPlusSetCompositingQuality kaydı birden çok nesneden bileşik görüntüler oluşturmak için istenen kalite düzeyini belirtir.
type: docs
weight: 6330
url: /tr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/
---
## EmfPlusSetCompositingQuality class

EmfPlusSetCompositingQuality kaydı, birden çok nesneden bileşik görüntüler oluşturmak için istenen kalite düzeyini belirtir.
...
| İsim | Tanım |
| --- | --- |
| [EmfPlusSetCompositingQuality](emfplussetcompositingquality)(EmfPlusRecord) | Yeni bir örneğini başlatır[`EmfPlusSetCompositingQuality`](../emfplussetcompositingquality) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [CompositingQuality](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingquality/compositingquality) { get; set; } | Birleştirme kalitesini alır veya ayarlar. |
