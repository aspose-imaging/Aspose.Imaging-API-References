...
description: EmfPlusSetWorldTransform kaydı dünya dönüşümünü a belirtilen dönüşüm matrisindeki değerlere göre ayarlar.
type: docs
weight: 6420
url: /tr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetworldtransform/
---
## EmfPlusSetWorldTransform class

EmfPlusSetWorldTransform kaydı, dünya dönüşümünü a belirtilen dönüşüm matrisindeki değerlere göre ayarlar.
...
| İsim | Tanım |
| --- | --- |
| [EmfPlusSetWorldTransform](emfplussetworldtransform)(EmfPlusRecord) | Yeni bir örneğini başlatır[`EmfPlusSetWorldTransform`](../emfplussetworldtransform) sınıf. |
...
| [MatrixData](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetworldtransform/matrixdata) { get; set; } | Yeni mevcut dünya dönüşümünü tanımlayan bir EmfPlusTransformMatrix nesnesi (bölüm 2.2.2.47) alır veya ayarlar. |
