...
type: docs
weight: 6200
url: /tr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusrecord/
---
## EmfPlusRecord class
...
| İsim | Tanım |
| --- | --- |
| [EmfPlusRecord](emfplusrecord#constructor)() | Yeni bir örneğini başlatır[`EmfPlusRecord`](../emfplusrecord) sınıf. |
| [EmfPlusRecord](emfplusrecord#constructor_1)(EmfPlusRecord) | Yeni bir örneğini başlatır[`EmfPlusRecord`](../emfplusrecord) sınıf. |
