...
description: EmfPlusSetClipRegion kaydı geçerli kırpma bölgesini başka bir grafik bölgesiyle birleştirir. Yeni geçerli kırpma bölgesi önceki geçerli kırpma bölgesi ve belirtilen EmfPlusRegion nesnesi üzerinde CombineMode işleminin gerçekleştirilmesinin sonucuna ayarlanır.
type: docs
weight: 6310
url: /tr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetclipregion/
---
...
| İsim | Tanım |
| --- | --- |
| [EmfPlusSetClipRegion](emfplussetclipregion)(EmfPlusRecord) | Yeni bir örneğini başlatır[`EmfPlusSetClipRegion`](../emfplussetclipregion) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [Cm](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetclipregion/cm) { get; set; } | CM'yi (4 bit) alır veya ayarlar: İki bölgeyi birleştirmek için mantıksal işlemi belirtir. Değerlerin anlamları için bkz. CombineMode numaralandırması (bölüm 2.1.1.4). |
...
| [ObjectId](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetclipregion/objectid) { get; set; } | EMF+ Nesne Tablosundaki bir EmfPlusRegion nesnesinin (bölüm 2.2.1.8) dizinini alır veya ayarlar.Değer sıfırdan 63'e (dahil) ZORUNLUDUR. |
