...
description: EmfPlusClear kaydı çıktı koordinat alanını temizler ve onu bir arka plan rengi ve şeffaflıkla başlatır
type: docs
weight: 5860
url: /tr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusclear/
---
## EmfPlusClear class

EmfPlusClear kaydı, çıktı koordinat alanını temizler ve onu bir arka plan rengi ve şeffaflıkla başlatır
...
| İsim | Tanım |
| --- | --- |
| [EmfPlusClear](emfplusclear)(EmfPlusRecord) | Yeni bir örneğini başlatır[`EmfPlusClear`](../emfplusclear) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [Argb32Color](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusclear/argb32color) { get; set; } | Rengi alır veya ayarlar. Ekranı boyamak için rengi tanımlayan bir EmfPlusARGB nesnesi (bölüm 2.2.2.1). Aksi belirtilmedikçe tüm renkler [IEC-RGB]'de belirtilmiştir. |
