...
description: EmfPlusResetClip kaydı dünya alanı için geçerli kırpma bölgesini sonsuza sıfırlar.
type: docs
weight: 6210
url: /tr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/
---
## EmfPlusResetClip class

EmfPlusResetClip kaydı, dünya alanı için geçerli kırpma bölgesini sonsuza sıfırlar.
...
| İsim | Tanım |
| --- | --- |
| [EmfPlusResetClip](emfplusresetclip)(EmfPlusRecord) | Yeni bir örneğini başlatır[`EmfPlusResetClip`](../emfplusresetclip) sınıf. |
