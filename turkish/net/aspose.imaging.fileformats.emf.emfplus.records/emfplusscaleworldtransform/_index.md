...
description: EmfPlusScaleWorldTransform kaydı mevcut dünya uzay dönüşümü üzerinde bir ölçeklendirme gerçekleştirir.
type: docs
weight: 6260
url: /tr/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusscaleworldtransform/
---
...
| İsim | Tanım |
| --- | --- |
| [EmfPlusScaleWorldTransform](emfplusscaleworldtransform)(EmfPlusRecord) | Yeni bir örneğini başlatır[`EmfPlusScaleWorldTransform`](../emfplusscaleworldtransform) sınıf. |
...
| [PostMultipliedMatrix](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusscaleworldtransform/postmultipliedmatrix) { get; } | [son çarpılmış matris] olup olmadığını gösteren bir değer alır. Ayarlanırsa, dönüştürme matrisi sonradan çarpılmalıdır. Açıksa, önceden çarpılmalıdır. |
...
| [Sx](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusscaleworldtransform/sx) { get; set; } | Yatay ölçek faktörünü tanımlayan 32 bitlik bir kayan nokta değeri alır veya ayarlar. scaling , aşağıdaki tabloda gösterildiği gibi Sx ve Sy alan değerlerinden yeni bir dönüşüm matrisi oluşturularak gerçekleştirilir. ----------------- &#x7C; Sx &#x7C; 0 &#x7C; 0 &#x7C; &#x7C; 0 &#x7C; Sx &#x7C; 0 &#x7C; ----------------- Şekil 3: Ölçek Dönüşüm Matrisi |
| [Sy](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusscaleworldtransform/sy) { get; set; } | Dikey ölçek faktörünü tanımlayan 32 bitlik bir kayan nokta değeri alır veya ayarlar. |
