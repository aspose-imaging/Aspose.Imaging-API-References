...
description: Yeni bir örneğini başlatırPieShapeaspose.imaging.shapes/pieshape sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.shapes/pieshape/pieshape/
---
## PieShape() {#constructor}

Yeni bir örneğini başlatır[`PieShape`](../../pieshape) sınıf.
