...
description: Yeni bir örneğini başlatırRectangleShapeaspose.imaging.shapes/rectangleshape sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.shapes/rectangleshape/rectangleshape/
---
## RectangleShape() {#constructor}

Yeni bir örneğini başlatır[`RectangleShape`](../../rectangleshape) sınıf.
