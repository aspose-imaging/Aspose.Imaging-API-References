...
description: Yeni bir örneğini başlatırArcShapeaspose.imaging.shapes/arcshape sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.shapes/arcshape/arcshape/
---
## ArcShape() {#constructor}

Yeni bir örneğini başlatır[`ArcShape`](../../arcshape) sınıf.
...
| startAngle | Single | Başlangıç açısı. |
| sweepAngle | Single | Süpürme açısı. |
| isClosed | Boolean | olarak ayarlanırsa`doğru` ark kapalı. Kapalı yay aslında bir elipse dönüşüyor. |
