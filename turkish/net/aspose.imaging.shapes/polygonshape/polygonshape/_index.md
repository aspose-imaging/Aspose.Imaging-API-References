...
description: Yeni bir örneğini başlatırPolygonShapeaspose.imaging.shapes/polygonshape sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.shapes/polygonshape/polygonshape/
---
## PolygonShape() {#constructor}

Yeni bir örneğini başlatır[`PolygonShape`](../../polygonshape) sınıf.
...
| --- | --- | --- |
| points | PointF[] | Puan dizisi. |
| isClosed | Boolean | olarak ayarlanırsa`doğru` çokgen kapalı. |
