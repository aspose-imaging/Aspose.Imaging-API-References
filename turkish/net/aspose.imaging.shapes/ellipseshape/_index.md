...
description: Bir elips şeklini temsil eder.
type: docs
weight: 10980
url: /tr/net/aspose.imaging.shapes/ellipseshape/
---
## EllipseShape class

Bir elips şeklini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [EllipseShape](ellipseshape#constructor)() | Yeni bir örneğini başlatır[`EllipseShape`](../ellipseshape) sınıf. |
| [EllipseShape](ellipseshape#constructor_1)(RectangleF) | Yeni bir örneğini başlatır[`EllipseShape`](../ellipseshape) sınıf. |
...
| override [Segments](../../aspose.imaging.shapes/ellipseshape/segments) { get; } | Şekil parçalarını alır. |
