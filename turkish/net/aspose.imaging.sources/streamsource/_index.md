...
type: docs
weight: 11110
url: /tr/net/aspose.imaging.sources/streamsource/
---
## StreamSource class
...
| İsim | Tanım |
| --- | --- |
| [StreamSource](streamsource#constructor)(Stream) | Yeni bir örneğini başlatır[`StreamSource`](../streamsource) sınıf. |
| [StreamSource](streamsource#constructor_1)(Stream, bool) | Yeni bir örneğini başlatır[`StreamSource`](../streamsource) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [DisposeStream](../../aspose.imaging.sources/streamsource/disposestream) { get; } | Kapsayıcı atıldığında akışın atılması gerekip gerekmediğini gösteren bir değer alır. |
| [Stream](../../aspose.imaging.sources/streamsource/stream) { get; } | Akışı alır. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| override [GetStreamContainer](../../aspose.imaging.sources/streamsource/getstreamcontainer)() | Akış kapsayıcısını alır. |
