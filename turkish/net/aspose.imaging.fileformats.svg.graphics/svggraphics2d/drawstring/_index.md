...
description: Metin dizesini çizer.
type: docs
weight: 80
url: /tr/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawstring/
---
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| font | Font | Metni işlemek için kullanılan yazı tipi. |
| text | String | Unicode metin dizesi. |
| origin | Point | Metnin sol üst köşesi çalıştırılır. |
