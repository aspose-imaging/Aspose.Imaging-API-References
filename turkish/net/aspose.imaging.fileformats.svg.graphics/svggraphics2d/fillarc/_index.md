...
description: Bir Dikdörtgen yapısı tarafından belirtilen bir elipsin bir bölümünü temsil eden bir yayı doldurur.
type: docs
weight: 100
url: /tr/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/fillarc/
---
## SvgGraphics2D.FillArc method

Bir Dikdörtgen yapısı tarafından belirtilen bir elipsin bir bölümünü temsil eden bir yayı doldurur.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| pen | Pen | Şeklin ana hatlarını çizmek için kalem. |
| brush | Brush | Şeklin içini doldurmak için fırça. |
| rect | Rectangle | Elipsin sınırları. |
| startAngle | Single | Derece cinsinden açı, x ekseninden yayın başlangıç noktasına kadar saat yönünde ölçülür. |
| arcAngle | Single | BaşlangıçAngle parametresinden yayın bitiş noktasına kadar saat yönünde ölçülen derece cinsinden açı. |
