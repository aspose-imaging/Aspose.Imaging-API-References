...
description: Yeni bir örneğini başlatırWmfRecorderGraphics2Daspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/wmfrecordergraphics2d/
---
## WmfRecorderGraphics2D constructor

Yeni bir örneğini başlatır[`WmfRecorderGraphics2D`](../../wmfrecordergraphics2d) sınıf.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| frame | Rectangle | Meta dosyasını görüntülemek için twip cinsinden ölçülen hedef dikdörtgen. |
| inch | Int32 | İnç başına piksel sayısı. |
