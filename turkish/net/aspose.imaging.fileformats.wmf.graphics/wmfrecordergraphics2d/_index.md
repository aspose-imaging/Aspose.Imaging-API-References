...
description: Wmf kaydedici.
type: docs
weight: 8370
url: /tr/net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| İsim | Tanım |
| --- | --- |
| [WmfRecorderGraphics2D](wmfrecordergraphics2d)(Rectangle, int) | Yeni bir örneğini başlatır[`WmfRecorderGraphics2D`](../wmfrecordergraphics2d) sınıf. |
...
| [BackgroundMode](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/backgroundmode) { get; set; } | Arka plan modunu alır veya ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| static [FromWmfImage](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/fromwmfimage)(WmfImage) | Mevcut Wmf görüntüsü için Wmf kaydedicinin bir örneğini alır. |
...
| [EndRecording](../../aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/endrecording)() | Kaydı sonlandırır. |
...
* ad alanı [Aspose.Imaging.FileFormats.Wmf.Graphics](../../aspose.imaging.fileformats.wmf.graphics)
