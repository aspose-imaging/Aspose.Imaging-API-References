...
description: Yeni bir örneğini başlatırEmfSelectObjectaspose.imaging.fileformats.emf.emf.records/emfselectobject sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.fileformats.emf.emf.records/emfselectobject/emfselectobject/
---
## EmfSelectObject(EmfRecord) {#constructor_1}

Yeni bir örneğini başlatır[`EmfSelectObject`](../../emfselectobject) sınıf.
