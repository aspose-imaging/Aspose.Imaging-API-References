...
description: Yeni bir örneğini başlatırEmfCreateBrushIndirectaspose.imaging.fileformats.emf.emf.records/emfcreatebrushindirect sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.fileformats.emf.emf.records/emfcreatebrushindirect/emfcreatebrushindirect/
---
## EmfCreateBrushIndirect(EmfRecord) {#constructor_1}

Yeni bir örneğini başlatır[`EmfCreateBrushIndirect`](../../emfcreatebrushindirect) sınıf.
