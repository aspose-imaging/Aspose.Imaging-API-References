...
description: Yeni bir örneğini başlatırEmfRectangleaspose.imaging.fileformats.emf.emf.records/emfrectangle sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.fileformats.emf.emf.records/emfrectangle/emfrectangle/
---
## EmfRectangle(EmfRecord) {#constructor_1}

Yeni bir örneğini başlatır[`EmfRectangle`](../../emfrectangle) sınıf.
