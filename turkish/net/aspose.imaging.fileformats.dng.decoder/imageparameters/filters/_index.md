...
description: Matristeki renk piksellerinin sırasını açıklayan Bit maskesini alır.
type: docs
weight: 50
url: /tr/net/aspose.imaging.fileformats.dng.decoder/imageparameters/filters/
---
## ImageParameters.Filters property

Matristeki renk piksellerinin sırasını açıklayan Bit maskesini alır.
