...
description: Dosyadaki RAW görüntü sayısını alır 0 dosyanın tanınmadığı anlamına gelir.
type: docs
weight: 80
url: /tr/net/aspose.imaging.fileformats.dng.decoder/imageparameters/rawcount/
---
## ImageParameters.RawCount property

Dosyadaki RAW görüntü sayısını alır (0, dosyanın tanınmadığı anlamına gelir).
