...
description: Jpeg2000 kitaplığı ana sınıfı
type: docs
weight: 6830
url: /tr/net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/
---
## Jpeg2000Image class

Jpeg2000 kitaplığı ana sınıfı
...
| İsim | Tanım |
| --- | --- |
| [Jpeg2000Image](jpeg2000image#constructor)(RasterImage) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_5)(Stream) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_7)(string) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_2)(int, int) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_1)(RasterImage, int) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_6)(Stream, int) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_8)(string, int) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_4)(int, int, int) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
| [Jpeg2000Image](jpeg2000image#constructor_3)(int, int, Jpeg2000Options) | Yeni bir örneğini başlatır[`Jpeg2000Image`](../jpeg2000image) sınıf. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/bitsperpixel) { get; } | Görüntü derinliğini alır (piksel başına bit) |
...
| [Codec](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/codec) { get; } | Codec'i alır. |
| [Comments](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/comments) { get; set; } | Yorumları alır veya ayarlar. |
...
| override [FileFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/fileformat) { get; } | dosya formatının bir değerini alır |
...
| override [Height](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/height) { get; } | Görüntünün yüksekliğini alır |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/horizontalresolution) { get; set; } | Bunun yatay çözünürlüğünü inç başına piksel cinsinden alır veya ayarlar.[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawdataformat) { get; } | Ham veri biçimini alır. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawlinesize) { get; } | Bayt cinsinden ham satır boyutunu alır. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/verticalresolution) { get; set; } | Bunun dikey çözünürlüğünü inç başına piksel cinsinden alır veya ayarlar.[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/width) { get; } | Görüntünün genişliğini alır |
| override [XmpData](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/xmpdata) { get; set; } | XMP meta verilerini alır veya ayarlar. |
