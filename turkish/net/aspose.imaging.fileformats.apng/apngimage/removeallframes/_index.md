...
description: Kendi çerçeve koleksiyonundan tüm çerçeveleri kaldırır.
type: docs
weight: 270
url: /tr/net/aspose.imaging.fileformats.apng/apngimage/removeallframes/
---
## ApngImage.RemoveAllFrames method

Kendi çerçeve koleksiyonundan tüm çerçeveleri kaldırır.
