...
description: Animasyonlu PNG resim çerçevesi
type: docs
weight: 1310
url: /tr/net/aspose.imaging.fileformats.apng/apngframe/
---
## ApngFrame class

Animasyonlu PNG resim çerçevesi
...
| override [BackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/backgroundcolor) { get; set; } | Arka plan rengini alır. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.apng/apngframe/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.apng/apngframe/disposalmethod) { get; } | Elden çıkarma yöntemini alır. |
...
| [FrameLeft](../../aspose.imaging.fileformats.apng/apngframe/frameleft) { get; } | Çerçevenin sol ofsetini alır. |
| [FrameTime](../../aspose.imaging.fileformats.apng/apngframe/frametime) { get; set; } | Çerçeve süresini alır veya ayarlar. |
| [FrameTop](../../aspose.imaging.fileformats.apng/apngframe/frametop) { get; } | Çerçeve üst ofsetini alır. |
| override [HasAlpha](../../aspose.imaging.fileformats.apng/apngframe/hasalpha) { get; } | Bu örneğin alfa olup olmadığını gösteren bir değer alın. |
| override [HasBackgroundColor](../../aspose.imaging.fileformats.apng/apngframe/hasbackgroundcolor) { get; set; } | Arka plan renginin olup olmadığını gösteren bir değer alır. |
| override [HasTransparentColor](../../aspose.imaging.fileformats.apng/apngframe/hastransparentcolor) { get; set; } | Resmin saydam renge sahip olup olmadığını gösteren bir değer alır. |
| override [Height](../../aspose.imaging.fileformats.apng/apngframe/height) { get; } | Görüntü yüksekliğini alır. |
...
| override [TransparentColor](../../aspose.imaging.fileformats.apng/apngframe/transparentcolor) { get; set; } | Saydam rengi alır. |
...
| override [Width](../../aspose.imaging.fileformats.apng/apngframe/width) { get; } | Görüntü genişliğini alır. |
...
| override [CacheData](../../aspose.imaging.fileformats.apng/apngframe/cachedata)() | Verileri önbelleğe alır ve temel alınandan ek veri yüklemesi yapılmamasını sağlar[`DataStreamContainer`](../../aspose.imaging/datastreamsupporter/datastreamcontainer) . |
...
| [GetFullFrame](../../aspose.imaging.fileformats.apng/apngframe/getfullframe)() | Tam kareyi alır. |
