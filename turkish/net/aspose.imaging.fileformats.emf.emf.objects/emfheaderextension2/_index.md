...
description: HeaderExtension2 nesnesi EMF meta dosyası başlığının ikinci uzantısını tanımlar. EMF meta dosyalarının çözünürlüğünü ve ölçeklenebilirliğini artıran cihaz yüzeylerini mikrometre cinsinden ölçme yeteneğini ekler.
type: docs
weight: 3000
url: /tr/net/aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/
---
## EmfHeaderExtension2 class

HeaderExtension2 nesnesi, EMF meta dosyası başlığının ikinci uzantısını tanımlar. EMF meta dosyalarının çözünürlüğünü ve ölçeklenebilirliğini artıran, cihaz yüzeylerini mikrometre cinsinden ölçme yeteneğini ekler.
...
| [MicrometersX](../../aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/micrometersx) { get; set; } | Meta dosya görüntüsünün oluşturulduğu görüntüleme aygıtının 32 bit yatay boyutunu mikrometre cinsinden alır veya ayarlar |
| [MicrometersY](../../aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/micrometersy) { get; set; } | Meta dosyası görüntüsünün oluşturulduğu görüntüleme aygıtının 32 bit dikey boyutunu mikrometre cinsinden alır veya ayarlar. |
