...
description: LogFontEx nesnesi bir mantıksal yazı tipinin genişletilmiş özniteliklerini belirtir.
type: docs
weight: 3040
url: /tr/net/aspose.imaging.fileformats.emf.emf.objects/emflogfontex/
---
## EmfLogFontEx class

LogFontEx nesnesi, bir mantıksal yazı tipinin genişletilmiş özniteliklerini belirtir.
...
| İsim | Tanım |
| --- | --- |
| [EmfLogFontEx](emflogfontex)(EmfLogFont) | Yeni bir örneğini başlatır[`EmfLogFontEx`](../emflogfontex) sınıf. |
