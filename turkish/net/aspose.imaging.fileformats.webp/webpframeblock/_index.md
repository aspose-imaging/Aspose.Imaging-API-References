...
description: Webp blok açma kayıt defterini temsil eder.
type: docs
weight: 8070
url: /tr/net/aspose.imaging.fileformats.webp/webpframeblock/
---
## WebPFrameBlock class

Webp blok açma kayıt defterini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [WebPFrameBlock](webpframeblock#constructor)(RasterImage) | Yeni bir örneğini başlatır[`WebPFrameBlock`](../webpframeblock) |
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | Yeni bir örneğini başlatır[`WebPFrameBlock`](../webpframeblock) sınıf. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | Piksel sayısı başına görüntü bitlerini alır. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | Elden çıkarma yöntemini alır. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Bu örneğin atılıp atılmadığını gösteren bir değer alır. |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration) { get; set; } | Çerçeve süresini alır veya ayarlar. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | dosya formatının bir değerini alır |
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft) { get; } | Çerçevenin sol ofsetini alır. |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime) { get; } | Çerçeve süresini alır. |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | Çerçeve üst ofsetini alır. |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | Bu örneğin alfa olup olmadığını gösteren bir değer alır. |
...
| override [Height](../../aspose.imaging.fileformats.webp/webpframeblock/height) { get; } | Görüntü yüksekliğini alır. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | Sola çerçeve konumunu alır veya ayarlar. |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | Üst çerçeve konumunu alır veya ayarlar. |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width) { get; } | Görüntü genişliğini alır. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe)() | Tam kareyi alır. |
