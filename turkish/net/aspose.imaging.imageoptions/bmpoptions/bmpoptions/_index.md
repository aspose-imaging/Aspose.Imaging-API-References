...
description: Yeni bir örneğini başlatırBmpOptionsaspose.imaging.imageoptions/bmpoptions sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.imageoptions/bmpoptions/bmpoptions/
---
## BmpOptions() {#constructor}

Yeni bir örneğini başlatır[`BmpOptions`](../../bmpoptions) sınıf.
