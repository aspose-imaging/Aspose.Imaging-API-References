...
description: Yeni bir örneğini başlatırMultiPageOptionsaspose.imaging.imageoptions/multipageoptions sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.imageoptions/multipageoptions/multipageoptions/
---
## MultiPageOptions() {#constructor}

Yeni bir örneğini başlatır[`MultiPageOptions`](../../multipageoptions) sınıf.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| pages | Int32[] | Sayfa dizisi. |
| exportArea | Rectangle | İhracat alanı. |
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| pageTitles | String[] | Sayfa başlıkları. |
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| ranges | IntRange[] | bu[`IntRange`](../../../aspose.imaging/intrange). |
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| range | IntRange | bu[`IntRange`](../../../aspose.imaging/intrange). |
