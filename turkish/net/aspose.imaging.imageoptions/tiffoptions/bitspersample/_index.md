...
type: docs
weight: 50
url: /tr/net/aspose.imaging.imageoptions/tiffoptions/bitspersample/
---
...
Örnek değeri başına bit sayısı.

### Notlar

Bu değeri ayarlarken, SamplesPerPixel değerini de dizi uzunluğuna ayarlayacağını unutmayın. Bu 2 özellik çok sıkı bir şekilde bağlanmıştır, bu nedenle yalnızca birlikte ayarlanabilir.
