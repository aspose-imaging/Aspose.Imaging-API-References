...
description: Bunun olup olmadığını gösteren bir değer alır veya ayarlar.WebPOptionsaspose.imaging.imageoptions/webpoptions kayıpsızdır.
type: docs
weight: 40
url: /tr/net/aspose.imaging.imageoptions/webpoptions/lossless/
---
## WebPOptions.Lossless property

Bunun olup olmadığını gösteren bir değer alır veya ayarlar.[`WebPOptions`](../../webpoptions) kayıpsızdır.
...
`doğru` kayıpsız ise; aksi halde,`yanlış` .
