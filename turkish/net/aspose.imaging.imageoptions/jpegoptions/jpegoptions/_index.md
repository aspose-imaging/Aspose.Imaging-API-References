...
description: Yeni bir örneğini başlatırJpegOptionsaspose.imaging.imageoptions/jpegoptions sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.imageoptions/jpegoptions/jpegoptions/
---
## JpegOptions() {#constructor}

Yeni bir örneğini başlatır[`JpegOptions`](../../jpegoptions) sınıf.
