...
description: 9un maksimum sıkıştırma ve 0ın depolama modu olduğu 0-9 aralığında png görüntü sıkıştırma düzeyi.
type: docs
weight: 40
url: /tr/net/aspose.imaging.imageoptions/pngoptions/compressionlevel/
---
## PngOptions.CompressionLevel property

9'un maksimum sıkıştırma ve 0'ın depolama modu olduğu 0-9 aralığında png görüntü sıkıştırma düzeyi.
