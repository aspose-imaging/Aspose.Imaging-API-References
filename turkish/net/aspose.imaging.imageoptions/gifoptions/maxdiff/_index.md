...
description: İzin verilen maksimum piksel farkını alır veya ayarlar. Sıfırdan büyükse kayıplı sıkıştırma kullanılacaktır. Optimum kayıplı sıkıştırma için önerilen değer 80dir. 30 çok hafif sıkıştırma 200 ağırdır. Sıkıştırma algoritmasının sınırlandırılması nedeniyle en iyi sonucu verir. çok yüksek kayıp seviyeleri o kadar kazanç sağlamaz. İzin verilen değerler aralığı 0 1000dir.
type: docs
weight: 110
url: /tr/net/aspose.imaging.imageoptions/gifoptions/maxdiff/
---
