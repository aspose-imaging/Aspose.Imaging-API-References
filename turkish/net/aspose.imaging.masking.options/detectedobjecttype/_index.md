...
description: Algılanan nesne türleri numaralandırması.
type: docs
weight: 10470
url: /tr/net/aspose.imaging.masking.options/detectedobjecttype/
---
## DetectedObjectType enumeration

Algılanan nesne türleri numaralandırması.
...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Human | `0` | İnsan nesne türü. |
| Other | `1` | Diğer nesne türü. |
