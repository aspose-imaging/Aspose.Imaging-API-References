...
description: Segmentasyon yönteminin kesinliğini alır veya ayarlar isteğe bağlı.
type: docs
weight: 70
url: /tr/net/aspose.imaging.masking.options/automaskingargs/precision/
---
## AutoMaskingArgs.Precision property

Segmentasyon yönteminin kesinliğini alır veya ayarlar (isteğe bağlı).
...
Segmentasyon yönteminin kesinliği (isteğe bağlı).
