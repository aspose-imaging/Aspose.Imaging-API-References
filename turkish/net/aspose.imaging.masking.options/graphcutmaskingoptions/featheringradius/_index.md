...
description: Geçiş yumuşatma yarıçapını alır veya ayarlar.
type: docs
weight: 20
url: /tr/net/aspose.imaging.masking.options/graphcutmaskingoptions/featheringradius/
---
## GraphCutMaskingOptions.FeatheringRadius property

Geçiş yumuşatma yarıçapını alır veya ayarlar.
