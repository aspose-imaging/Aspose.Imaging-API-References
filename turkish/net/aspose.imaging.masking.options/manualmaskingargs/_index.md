...
description: El ile maskeleme yöntemi için belirtilen bağımsız değişkenleri temsil eder
type: docs
weight: 10500
url: /tr/net/aspose.imaging.masking.options/manualmaskingargs/
---
## ManualMaskingArgs class

El ile maskeleme yöntemi için belirtilen bağımsız değişkenleri temsil eder
...
| İsim | Tanım |
| --- | --- |
| [Mask](../../aspose.imaging.masking.options/manualmaskingargs/mask) { get; set; } | Maske oluşturan grafik şekilleri kümesini alır veya ayarlar. |
