...
description: Varsayılan nesnenin verileri. Nesnenin türünü ve alanını içerir.
type: docs
weight: 10440
url: /tr/net/aspose.imaging.masking.options/assumedobjectdata/
---
...
| İsim | Tanım |
| --- | --- |
| [AssumedObjectData](assumedobjectdata#constructor)() | Yeni bir örneğini başlatır[`AssumedObjectData`](../assumedobjectdata) sınıf. |
| [AssumedObjectData](assumedobjectdata#constructor_1)(DetectedObjectType, Rectangle) | Yeni bir örneğini başlatır[`AssumedObjectData`](../assumedobjectdata) sınıf. |
| [AssumedObjectData](assumedobjectdata#constructor_2)(string, Rectangle) | Yeni bir örneğini başlatır[`AssumedObjectData`](../assumedobjectdata) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [Bounds](../../aspose.imaging.masking.options/assumedobjectdata/bounds) { get; set; } | Nesnenin sınırlarını alır veya ayarlar. |
| [Type](../../aspose.imaging.masking.options/assumedobjectdata/type) { get; set; } | Nesnenin türünü alır veya ayarlar. |
