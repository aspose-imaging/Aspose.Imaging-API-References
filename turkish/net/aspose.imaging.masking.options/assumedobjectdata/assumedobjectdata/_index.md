...
description: Yeni bir örneğini başlatırAssumedObjectDataaspose.imaging.masking.options/assumedobjectdata sınıf.
type: docs
weight: 10
url: /tr/net/aspose.imaging.masking.options/assumedobjectdata/assumedobjectdata/
---
## AssumedObjectData() {#constructor}

Yeni bir örneğini başlatır[`AssumedObjectData`](../../assumedobjectdata) sınıf.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| type | DetectedObjectType | Nesnenin türü. |
| bounds | Rectangle | Nesnenin sınırları. |
