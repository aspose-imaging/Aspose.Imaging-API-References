...
description: Arka plan değiştirme rengini alır veya ayarlar.
type: docs
weight: 30
url: /tr/net/aspose.imaging.masking.options/maskingoptions/backgroundreplacementcolor/
---
## MaskingOptions.BackgroundReplacementColor property

Arka plan değiştirme rengini alır veya ayarlar.
...
Arka plan değiştirme rengi. Bu renk, ortaya çıkan resimlerde arka plan rengi olarak kullanılacaktır.
