...
description: Görüntü dışa aktarma seçeneklerini alır veya ayarlar.
type: docs
weight: 50
url: /tr/net/aspose.imaging.masking.options/maskingoptions/exportoptions/
---
## MaskingOptions.ExportOptions property

Görüntü dışa aktarma seçeneklerini alır veya ayarlar.
...
Ortaya çıkan görüntüleri oluşturmak için kullanılacak görüntü dışa aktarma seçenekleri.
