...
description: Genel görüntü maskeleme seçeneklerini temsil eder.
type: docs
weight: 10510
url: /tr/net/aspose.imaging.masking.options/maskingoptions/
---
## MaskingOptions class

Genel görüntü maskeleme seçeneklerini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| const [BackgroundObjectNumber](../../aspose.imaging.masking.options/maskingoptions/backgroundobjectnumber) | Arka plan nesne numarası |
