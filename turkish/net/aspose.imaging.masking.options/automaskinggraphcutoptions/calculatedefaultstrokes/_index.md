...
description: Varsayılan vuruşların hesaplanması gerekip gerekmediğini belirten bir değer alır veya ayarlar.
type: docs
weight: 30
url: /tr/net/aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes/
---
## AutoMaskingGraphCutOptions.CalculateDefaultStrokes property

Varsayılan vuruşların hesaplanması gerekip gerekmediğini belirten bir değer alır veya ayarlar.
