...
description: Varsayılan arka plan vuruşlarını alır.
type: docs
weight: 40
url: /tr/net/aspose.imaging.masking.options/automaskinggraphcutoptions/defaultbackgroundstrokes/
---
## AutoMaskingGraphCutOptions.DefaultBackgroundStrokes property

Varsayılan arka plan vuruşlarını alır.
