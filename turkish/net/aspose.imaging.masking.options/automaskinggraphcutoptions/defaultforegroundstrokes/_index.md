...
description: Önceden hesaplanmış varsayılan ön plan vuruşlarını alır.
type: docs
weight: 50
url: /tr/net/aspose.imaging.masking.options/automaskinggraphcutoptions/defaultforegroundstrokes/
---
## AutoMaskingGraphCutOptions.DefaultForegroundStrokes property

Önceden hesaplanmış varsayılan ön plan vuruşlarını alır.
