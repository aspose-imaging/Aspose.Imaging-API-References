...
description: Maskeleme katmanı
type: docs
weight: 10530
url: /tr/net/aspose.imaging.masking.result/imaskinglayer/
---
...
| İsim | Tanım |
| --- | --- |
| [ObjectNumber](../../aspose.imaging.masking.result/imaskinglayer/objectnumber) { get; } | Nesne numarasını alır. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| [GetImage](../../aspose.imaging.masking.result/imaskinglayer/getimage)() | Sonuç görüntüsünü sağlar. |
| [GetMask](../../aspose.imaging.masking.result/imaskinglayer/getmask)() | Görüntü maskesini alır. |
