...
type: docs
weight: 10540
url: /tr/net/aspose.imaging.masking.result/maskingresult/
---
## MaskingResult class
...
| [Item](../../aspose.imaging.masking.result/maskingresult/item) { get; } | [`IMaskingLayer`](../imaskinglayer) belirtilen dizinde. |
| abstract [Layers](../../aspose.imaging.masking.result/maskingresult/layers) { get; } | Katmanları alır. |
| [Length](../../aspose.imaging.masking.result/maskingresult/length) { get; } | Uzunluğu alır. |
...
| [GetEnumerator](../../aspose.imaging.masking.result/maskingresult/getenumerator)() | Numaralandırıcıyı alır. |

## Alanlar

| İsim | Tanım |
| --- | --- |
| readonly [MaskingOptions](../../aspose.imaging.masking.result/maskingresult/maskingoptions) | Maskeleme seçenekleri |
...
* ad alanı [Aspose.Imaging.Masking.Result](../../aspose.imaging.masking.result)
