---
title: "WatermarkRemover Sınıfı"
type: docs
weight: 40
url: /tr/python-net/aspose.imaging.watermark/watermarkremover/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [paint_over(source, options)](#paint_over_source_options_1) | Filigranı raster görüntüden kaldır. |
...
| :- | :- | :- |
| source | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Kaynak raster görüntü. |
| options | [WatermarkOptions](/imaging/python-net/aspose.imaging.watermark.options/watermarkoptions/) | Filigran seçenekleri. |

**Returns**

| Tür | Açıklama |
| :- | :- |
| [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Ortaya çıkan görüntü. |
