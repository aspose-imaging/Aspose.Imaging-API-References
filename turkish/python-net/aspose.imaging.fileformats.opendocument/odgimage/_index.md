---
title: "OdgImage Sınıfı"
type: docs
weight: 490
url: /tr/python-net/aspose.imaging.fileformats.opendocument/odgimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [OdgImage(stream_container)](#OdgImage_stream_container_1) | Yazılım çözümlerine sorunsuz entegrasyon için tasarlanmış [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) <br/>            yapıcı, bir akış konteyneri kullanarak yeni bir örnek başlatır. Bu yöntem, yazılım ortamlarında ODG görüntü verilerinin verimli bir şekilde işlenmesini sağlar, kaynak kullanımını optimize eder ve sorunsuz görüntü işleme iş akışlarını kolaylaştırır. |
| [OdgImage(stream_container, options)](#OdgImage_stream_container_options_2) | Yeni bir örnek başlatılarak [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) sınıf nesnesinin yeni bir oluşturulmasına başlayın. Bir akış konteyneri ile yükleme seçenekleri parametrelerini birleştirerek, görüntüleri sorunsuz bir şekilde yükleyen çok yönlü bir yapıcıyı sürdürün. Bu yapıcı, verimli görüntü işleme yeteneği sağlar ve çeşitli senaryolarda artırılmış uyarlanabilirlik ve performans için özelleştirilebilir <br/>            yükleme yapılandırmaları sunar. |
## **Properties**
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Sayfa koleksiyonunu alırken, bu özellik bir görüntüyle ilişkili tüm sayfalara erişim sağlar. Bu özelliğe erişerek, geliştiriciler <br/>            bireysel sayfalar arasında iterasyon yapabilir, indekslerine göre belirli sayfaları alabilir veya <br/>            tüm koleksiyon üzerinde toplu işlemler gerçekleştirebilir. |
...
| options | [LoadOptions](/imaging/python-net/aspose.imaging/loadoptions/) | Yükleme seçenekleri |
