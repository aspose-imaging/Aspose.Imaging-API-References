---
title: "OtgImage Sınıfı"
type: docs
weight: 500
url: /tr/python-net/aspose.imaging.fileformats.opendocument/otgimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [OtgImage(stream_container)](#OtgImage_stream_container_1) | Bir akış <br/>            konteyneri sağlayarak [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) sınıfının yeni bir nesnesini oluşturun. Bu yapıcı, geliştiricilerin OTG görüntülerini doğrudan <br/>            akış konteynerlerinden oluşturmasını sağlar ve OTG görüntü verileriyle çalışmayı kolaylaştırır. |
| [OtgImage(stream_container, load_options)](#OtgImage_stream_container_load_options_2) | Bir akış konteyneri <br/>            ve yükleme seçenekleri sağlayarak yeni bir [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) nesnesini başlatın. Bu yapıcı, geliştiricilerin OTG <br/>            görüntülerini akışlardan verimli bir şekilde yüklemelerini ve özel yükleme yapılandırmalarını belirtmelerini sağlar. |
## **Properties**
...
| bits_per_pixel | int | r | Görüntünün piksel başına bit sayısını alır. Bu özellik, görüntüde temsil edilen detay seviyesi ve renk derinliği hakkında <br/>            bilgi sağlar, çeşitli <br/>            görüntü işleme görevleri ve iyileştirmelerine yardımcı olur. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Görüntüyle ilişkili varsayılan sayfayı alır, görüntü koleksiyonundaki birincil sayfaya temel erişim sağlar. Bu özellik, görüntü verilerinin gezinmesini ve manipülasyonunu kolaylaştırarak yazılım geliştirme <br/>            iş akışlarının verimliliğini artırır. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Bu özellik, OTG dosya formatına erişim sağlar ve görüntü dosyasında kapsüllenmiş veri türü hakkında kritik bilgiler <br/>            sunar. Yazılım geliştiricileri için temel bir referans noktası olarak hizmet eder, uygulamalarında OTG <br/>            dosyalarını etkili bir şekilde yönetmelerine olanak tanır. Bu özelliği kullanarak görüntü dosyasının belirli formatını belirleyebilir, OTG dosyalarının yazılım sistemlerine sorunsuz <br/>            entegrasyonunu ve manipülasyonunu kolaylaştırabilirsiniz. |
...
| is_cached | bool | r | Nesnenin verisinin şu anda <br/>            önbelleğe alınıp alınmadığını gösteren bir boolean değer elde eder, böylece veri okuma ihtiyacını ortadan kaldırır. Bu özellik, gereksiz veri erişim işlemlerini azaltarak performansı artıran bir <br/>            optimizasyon göstergesi olarak hizmet eder. |
| metadata | [OdMetadata](/imaging/python-net/aspose.imaging.fileformats.opendocument.objects/odmetadata/) | r | OpenDocument dosyalarına özgü meta verileri alır. Bu özellik, OD dosyalarına gömülü temel bilgilere erişim sağlar ve meta verilerin çıkarılması, değiştirilmesi veya analizi gibi çeşitli işlemleri kolaylaştırır. |
| page_count | int | r | Görüntü içindeki toplam sayfa sayısını alır. Bu özellik, çok sayfalı görüntüleri yöneten uygulamalar için önemlidir ve işleme veya gösterim için mevcut sayfa sayısını doğru bir şekilde belirlemelerini sağlar. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Görüntüyle ilişkili sayfa koleksiyonunu alır, yazılım geliştiricilerin her bir sayfaya verimli bir şekilde erişmesini ve manipüle etmesini sağlar. Bu <br/>            özellik, çeşitli işlemler için sayfalar arasında sorunsuz bir iterasyonu mümkün kılar ve görüntü işleme uygulamalarının işlevselliğini ve çok yönlülüğünü artırır. |
...
| records | [OdObject[]](/imaging/python-net/aspose.imaging.fileformats.opendocument/odobject/) | r | Görüntü içinde depolanan OpenDocument kayıtlarını alır. Bu özellik, OpenDocument dosyalarına gömülü belirli yapılandırılmış veri öğelerine erişim sağlar ve ilgili bilgilerin daha ileri işleme <br/>            veya analiz için alınmasını veya manipüle edilmesini kolaylaştırır. |
...
| **Name** | **Açıklama** |
| :- | :- |
| cache_data() | Verileri önbelleğe alır ve temel<br/>                [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) üzerinden ek veri yüklemesinin yapılmayacağını garanti eder. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_42) | Görüntüyü yeniden boyutlandırır. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_43) | Görüntüyü yeniden boyutlandırır. |
...
Bir akış <br/>            konteyneri sağlayarak [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) sınıfının yeni bir nesnesini oluşturun. Bu yapıcı, geliştiricilerin OTG görüntülerini doğrudan <br/>            akış konteynerlerinden oluşturmasını sağlar ve OTG görüntü verileriyle çalışmayı kolaylaştırır.
...
Bir akış konteyneri <br/>            ve yükleme seçenekleri sağlayarak yeni bir [OtgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/otgimage/) nesnesini başlatın. Bu yapıcı, geliştiricilerin OTG <br/>            görüntülerini akışlardan verimli bir şekilde yüklemelerini ve özel yükleme yapılandırmalarını belirtmelerini sağlar.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| stream_container | [StreamContainer](/imaging/python-net/aspose.imaging/streamcontainer/) | Akış. |
