---
title: "DicomPage Sınıfı"
type: docs
weight: 40
url: /tr/python-net/aspose.imaging.fileformats.dicom/dicompage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [DicomPage(image, index)](#DicomPage_image_index_1) | Yeni bir [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) sınıfı örneği başlatır. |
| [DicomPage(image, index, load_options)](#DicomPage_image_index_load_options_2) | Yeni bir [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) sınıfı örneği başlatır. |
## **Properties**
...
| index | int | r | Geçerli sayfanın indeksini alır. |
...
Yeni bir [DicomPage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicompage/) sınıfı örneği başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| image | [DicomImage](/imaging/python-net/aspose.imaging.fileformats.dicom/dicomimage/) | Görüntü. |
| index | int | İndeks. |
