---
title: "EmfPlusResetWorldTransform Sınıfı"
type: docs
weight: 390
url: /tr/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfPlusResetWorldTransform(source)](#EmfPlusResetWorldTransform_source_1) | Yeni bir [EmfPlusResetWorldTransform](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/) sınıfının örneğini başlatır. |
## **Properties**
...
Yeni bir [EmfPlusResetWorldTransform](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetworldtransform/) sınıfının örneğini başlatır.
