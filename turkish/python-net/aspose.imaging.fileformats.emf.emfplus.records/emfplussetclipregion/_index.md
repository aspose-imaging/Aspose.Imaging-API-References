---
title: "EmfPlusSetClipRegion Sınıfı"
type: docs
weight: 480
url: /tr/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetclipregion/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfPlusSetClipRegion(source)](#EmfPlusSetClipRegion_source_1) | Yeni bir [EmfPlusSetClipRegion](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetclipregion/) sınıfının örneğini başlatır. |
## **Properties**
...
| object_id | System.Byte | r/w | EMF+<br/>            Nesne Tablosunda bir EmfPlusRegion nesnesinin (bölüm 2.2.1.8) dizinini alır veya ayarlar. Değer 0 ile 63 arasında, dahil olmak üzere olmalıdır. |
...
Yeni bir [EmfPlusSetClipRegion](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetclipregion/) sınıfının örneğini başlatır.
