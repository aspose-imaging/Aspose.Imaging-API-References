---
title: "EmfPlusBeginContainerNoParams Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusbegincontainernoparams/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfPlusBeginContainerNoParams(source)](#EmfPlusBeginContainerNoParams_source_1) | Yeni bir [EmfPlusBeginContainerNoParams](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusbegincontainernoparams/) sınıfı örneği başlatır. |
## **Properties**
...
Yeni bir [EmfPlusBeginContainerNoParams](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplusbegincontainernoparams/) sınıfı örneği başlatır.
