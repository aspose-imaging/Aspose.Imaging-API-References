---
title: "EmfPlusSetCompositingMode Sınıfı"
type: docs
weight: 490
url: /tr/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingmode/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfPlusSetCompositingMode(source)](#EmfPlusSetCompositingMode_source_1) | Yeni bir [EmfPlusSetCompositingMode](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingmode/) sınıfının örneğini başlatır. |
## **Properties**
| **Name** | **Type** | **Access** | **Açıklama** |
| :- | :- | :- | :- |
| compositing_mode | [EmfPlusCompositingMode](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.consts/emfpluscompositingmode/) | r/w | CompositingMode<br/>            enumarasyonundan (bölüm 2.1.1.5) birleştirme modu değerini alır veya ayarlar. Birleştirme, alfa karıştırma durumuyla ifade edilebilir; bu durum açık veya kapalı olabilir. |
...
Yeni bir [EmfPlusSetCompositingMode](/imaging/python-net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcompositingmode/) sınıfının örneğini başlatır.
