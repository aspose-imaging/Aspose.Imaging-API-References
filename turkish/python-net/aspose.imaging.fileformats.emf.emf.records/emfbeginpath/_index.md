---
title: "EmfBeginPath Sınıfı"
type: docs
weight: 60
url: /tr/python-net/aspose.imaging.fileformats.emf.emf.records/emfbeginpath/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfBeginPath()](#EmfBeginPath__1) | Yeni bir [EmfBeginPath](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfbeginpath/) sınıfının örneğini başlatır. |
## **Properties**
...
Yeni bir [EmfBeginPath](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfbeginpath/) sınıfının örneğini başlatır.
