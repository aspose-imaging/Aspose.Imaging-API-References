---
title: "EmfCommentBeginGroup Sınıfı"
type: docs
weight: 170
url: /tr/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentbegingroup/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfCommentBeginGroup(source)](#EmfCommentBeginGroup_source_1) | Yeni bir [EmfCommentBeginGroup](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentbegingroup/) sınıfı örneği başlatır. |
## **Properties**
...
| açıklama | string | r/w | Bu kayıt grubunu tanımlayan isteğe bağlı, null ile sonlandırılmış bir Unicode dizesi alır veya ayarlar. |
| n_description | int | r/w | Sonraki isteğe bağlı açıklama dizesindeki Unicode karakter sayısını alır veya ayarlar. |
...
| rectangle | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r/w | Bir WMF RectL nesnesi ([MS-WMF] bölüm 2.2.2.19) alır veya ayarlar; bu nesne mantıksal koordinatlarda <br/>            çıktı dikdörtgenini belirler. |
...
Yeni bir [EmfCommentBeginGroup](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfcommentbegingroup/) sınıfı örneği başlatır.
