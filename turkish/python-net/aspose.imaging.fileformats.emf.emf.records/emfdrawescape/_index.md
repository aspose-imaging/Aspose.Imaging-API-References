---
title: "EmfDrawEscape Sınıfı"
type: docs
weight: 350
url: /tr/python-net/aspose.imaging.fileformats.emf.emf.records/emfdrawescape/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfDrawEscape(source)](#EmfDrawEscape_source_1) | Yeni bir [EmfDrawEscape](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfdrawescape/) sınıfı örneği başlatır. |
## **Properties**
...
Yeni bir [EmfDrawEscape](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfdrawescape/) sınıfı örneği başlatır.
