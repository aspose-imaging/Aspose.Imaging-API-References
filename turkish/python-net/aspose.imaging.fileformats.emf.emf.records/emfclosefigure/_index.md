---
title: "EmfCloseFigure Sınıfı"
type: docs
weight: 130
url: /tr/python-net/aspose.imaging.fileformats.emf.emf.records/emfclosefigure/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfCloseFigure()](#EmfCloseFigure__1) | Yeni bir [EmfCloseFigure](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfclosefigure/) sınıfı örneği başlatır. |
## **Properties**
...
Yeni bir [EmfCloseFigure](/imaging/python-net/aspose.imaging.fileformats.emf.emf.records/emfclosefigure/) sınıfı örneği başlatır.
