---
title: "EmfLogFontExDv Sınıfı"
type: docs
weight: 150
url: /tr/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmfLogFontExDv(emf_log_font_ex)](#EmfLogFontExDv_emf_log_font_ex_1) | [EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/) sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| design_vector | [EmfDesignVector](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emfdesignvector/) | r/w | DesignVector nesnesini alır veya ayarlar (bölüm 2.2.3). Bu alan 72 bayttan uzun OLAMAZ. |
...
[EmfLogFontExDv](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontexdv/) sınıfının yeni bir örneğini başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| emf_log_font_ex | [EmfLogFontEx](/imaging/python-net/aspose.imaging.fileformats.emf.emf.objects/emflogfontex/) | EMF günlük yazı tipi örneği. |
