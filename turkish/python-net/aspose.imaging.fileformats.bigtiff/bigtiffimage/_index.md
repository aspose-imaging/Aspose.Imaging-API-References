---
title: "BigTiffImage Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [BigTiffImage(frame)](#BigTiffImage_frame_1) | Yeni bir [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sınıf örneği, bir TiffFrame parametresiyle başlatarak oluşturun<br/>            Bu, BigTiffImage nesneleriyle çalışmak isteyen geliştiriciler için uygun bir yol sunar, esneklik ve entegrasyon kolaylığı sağlar<br/>            projelerine. |
| [BigTiffImage(frames)](#BigTiffImage_frames_2) | Başlayın [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sınıfını sorunsuz bir şekilde kullanmaya<br/>            bir TiffFrames listesi parametresiyle yeni bir örnek başlatarak.<br/>            Bu, birden çok çerçeve içeren BigTiffImage nesneleriyle çalışmak isteyen geliştiriciler için doğrudan bir yöntem sunar, projelerinin verimliliğini sağlar. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Bu [Image](/imaging/python-net/aspose.imaging/image/) örneğinin dosya formatını alır. |
...
| [add_page(page)](#add_page_page_4) | Bu sezgisel yöntemle yeni bir sayfa ekleyerek BigTiff görüntünüzü zahmetsizce genişletin.<br/>            Çok sayfalı görüntülerinin içeriğini dinamik olarak artırmak isteyen geliştiriciler için mükemmeldir. |
...
| [create_with_frame(frame)](#create_with_frame_frame_34) | [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sınıfının yeni bir örneğini başlatır. |
| [create_with_frames(frames)](#create_with_frames_frames_35) | [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sınıfının yeni bir örneğini başlatır. |
...
Yeni bir [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sınıf örneği, bir TiffFrame parametresiyle başlatarak oluşturun<br/>            Bu, BigTiffImage nesneleriyle çalışmak isteyen geliştiriciler için uygun bir yol sunar, esneklik ve entegrasyon kolaylığı sağlar<br/>            projelerine.
...
Başlayın [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sınıfını sorunsuz bir şekilde kullanmaya<br/>            bir TiffFrames listesi parametresiyle yeni bir örnek başlatarak.<br/>            Bu, birden çok çerçeve içeren BigTiffImage nesneleriyle çalışmak isteyen geliştiriciler için doğrudan bir yöntem sunar, projelerinin verimliliğini sağlar.
...
Bu sezgisel yöntemle yeni bir sayfa ekleyerek BigTiff görüntünüzü zahmetsizce genişletin.<br/>            Çok sayfalı görüntülerinin içeriğini dinamik olarak artırmak isteyen geliştiriciler için mükemmeldir.
...
[BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) sınıfının yeni bir örneğini başlatır.
...
| Tür | Açıklama |
| :- | :- |
| [BigTiffImage](/imaging/python-net/aspose.imaging.fileformats.bigtiff/bigtiffimage/) | Yeni bir BigTiffImage görüntüsü, çerçeveyi içerir. |
