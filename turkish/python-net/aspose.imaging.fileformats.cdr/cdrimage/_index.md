---
title: "CdrImage Sınıfı"
type: docs
weight: 190
url: /tr/python-net/aspose.imaging.fileformats.cdr/cdrimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_1) | Yeni bir akış ve loadOptions parametreleriyle yeni bir örnek başlatarak [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) sınıfı ile sorunsuzca çalışmaya başlayın.<br/>            Bu, CDR görüntülerini çeşitli veri kaynaklarından yüklemek ve yükleme sürecini gerektiği gibi özelleştirmek isteyen geliştiriciler için idealdir. |
## **Properties**
...
| bits_per_pixel | int | r | Bu kullanıcı dostu özellik sayesinde görüntünün bit derinliğini sorunsuzca alın.<br/>            Görüntülerindeki detay seviyesini veya renk derinliğini belirlemek isteyen geliştiriciler için idealdir,<br/>            doğru işleme ve manipülasyonu sağlar. |
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Bu sezgisel özellik ile CDR belgesini sorunsuzca alın veya güncelleyin.<br/>            CDR belgesine erişmek veya onu değiştirmek isteyen geliştiriciler için idealdir,<br/>            uygulamalarında esneklik ve verimlilik sağlar. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Bu kullanıcı dostu özellik sayesinde görüntünün varsayılan sayfasını kolayca alın.<br/>            Görüntülerinin birincil sayfasına hızlı erişim isteyen geliştiriciler için mükemmeldir,<br/>            verimli gezinme ve yönetim sağlar. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Bu sezgisel özellik ile görüntünün dosya biçimini sorunsuzca alın.<br/>            Görüntülerinin biçimini dinamik olarak belirlemek isteyen geliştiriciler için idealdir,<br/>            uyumluluk ve doğru işleme sağlar. |
...
| is_cached | bool | r | Nesnenin verisinin şu anda önbelleğe alınıp alınmadığını sorunsuzca belirleyin,<br/>            veri okuma ihtiyacını ortadan kaldırır. Verileri verimli bir şekilde önbellekten kullanarak performansı artırmak isteyen geliştiriciler için idealdir,<br/>            nesne bilgisine daha hızlı erişim sağlar. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Görüntünün meta verilerini alır. |
| page_count | int | r | Bu sezgisel özellik ile görüntünün toplam sayfa sayısını sorunsuzca alın veya güncelleyin.<br/>            Çok sayfalı görüntüleri dinamik olarak yönetmek isteyen geliştiriciler için idealdir,<br/>            görüntü içeriğinin verimli gezinmesi ve manipülasyonunu sağlar. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Bu sezgisel özellik sayesinde görüntünün sayfalarını sorunsuzca alın.<br/>            Çok sayfalı görüntülerdeki bireysel sayfalara erişmek ve bunları manipüle etmek isteyen geliştiriciler için idealdir,<br/>            verimli gezinme ve işleme sağlar. |
...
| **Name** | **Açıklama** |
| :- | :- |
| cache_data() | Bu kullanıcı dostu yöntemle veriyi sorunsuzca önbelleğe alarak temel kaynaktan ek yüklemeyi önleyin.<br/>            Veriyi önceden yükleyerek performansı artırmak isteyen geliştiriciler için idealdir,<br/>            uygulamalarında daha hızlı erişim ve daha sorunsuz çalışma sağlar.<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
Bu sezgisel özellik sayesinde görüntünün sayfalarını sorunsuzca alın.<br/>            Çok sayfalı görüntülerdeki bireysel sayfalara erişmek ve bunları manipüle etmek isteyen geliştiriciler için idealdir,<br/>            verimli gezinme ve işleme sağlar.
...
| update_colors | bool | Eğer <c>true</c> olarak ayarlanırsa renkler yeni palete göre güncellenir; aksi takdirde renk<br/>            indeksleri değişmeden kalır. Değişmeyen indekslerin, bazı indekslerin karşılık gelen palet girdisi yoksa, görüntünün yüklenirken çökmesine neden olabileceğini unutmayın. |
