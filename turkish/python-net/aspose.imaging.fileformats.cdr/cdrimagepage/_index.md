---
title: "CdrImagePage Sınıfı"
type: docs
weight: 210
url: /tr/python-net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | CDR belgesini alır veya ayarlar. |
...
| is_cached | bool | r | Nesnenin verisinin şu anda önbelleğe alınıp alınmadığını ve veri okumanın gerekli olup olmadığını gösteren bir değeri alır. |
...
| parent_image | [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) | r | Üst görüntüyü alır. |
