---
title: "WmfRecorderGraphics2D Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | Yeni bir [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) sınıfı örneği başlatır. |
## **Properties**
| **Name** | **Type** | **Access** | **Açıklama** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Arka plan rengini alır veya ayarlar. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | Arka plan modunu alır veya ayarlar. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | Mevcut Wmf görüntüsü için bir Wmf kaydedici örneği alır. |
...
Yeni bir [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) sınıfı örneği başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Metafile'i görüntülemek için twip cinsinden ölçülen hedef dikdörtgen. |
...
| Tür | Açıklama |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Sonuç görüntüsü. |
...
Mevcut Wmf görüntüsü için bir Wmf kaydedici örneği alır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Kayıt cihazı alınacak Wmf görüntüsü. |

**Returns**

| Tür | Açıklama |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | Bir [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) sınıfı örneği. |
