---
title: "MetafileRecorderGraphics2D Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/
---
...
| [exclude_clip(rect)](#exclude_clip_rect_21) | Bu Graphics nesnesinin kırpma bölgesini, bir Rectangle yapısı tarafından belirtilen alanı hariç tutacak şekilde günceller. |
| [exclude_clip(region)](#exclude_clip_region_22) | Bu Graphics nesnesinin kırpma bölgesini, bir Region tarafından belirtilen alanı hariç tutacak şekilde günceller. |
| [exclude_clip_rect(rect)](#exclude_clip_rect_rect_23) | Bu Graphics nesnesinin kırpma bölgesini, bir Rectangle yapısı tarafından belirtilen alanı hariç tutacak şekilde günceller. |
| [exclude_clip_rgn(region)](#exclude_clip_rgn_region_24) | Bu Graphics nesnesinin kırpma bölgesini, bir Region tarafından belirtilen alanı hariç tutacak şekilde günceller. |
| [fill_ellipse(brush, rect)](#fill_ellipse_brush_rect_25) | Elipsi doldurur. |
| [fill_path(pen, brush, path)](#fill_path_pen_brush_path_26) | Yolu doldurur. |
| [fill_pie(brush, rect, start_angle, sweep_angle)](#fill_pie_brush_rect_start_angle_sweep_angle_27) | Pasta dilimini doldurur. |
| [fill_polygon(brush, points)](#fill_polygon_brush_points_28) | Poligonu doldurur. |
| [fill_polygon(brush, points, fill_mode)](#fill_polygon_brush_points_fill_mode_29) | Poligonu doldurur. |
| [fill_rectangle(brush, rectangle)](#fill_rectangle_brush_rectangle_30) | Dikdörtgeni doldurur. |
| [get_transform()](#get_transform__31) | Dünya dönüşümünü alır. |
| [intersect_clip(rect)](#intersect_clip_rect_32) | Bu Graphics nesnesinin kırpma bölgesini, mevcut kırpma bölgesi ile belirtilen Rectangle yapısının kesişimi olarak günceller. |
| [intersect_clip(region)](#intersect_clip_region_33) | Bu Graphics nesnesinin kırpma bölgesini, mevcut kırpma bölgesi ile belirtilen Region'un kesişimi olarak günceller. |
| [intersect_clip_rect_f(rect)](#intersect_clip_rect_f_rect_34) | Bu Graphics nesnesinin kırpma bölgesini, mevcut kırpma bölgesi ile belirtilen Rectangle yapısının kesişimi olarak günceller. |
| [intersect_clip_rgn(region)](#intersect_clip_rgn_region_35) | Bu Graphics nesnesinin kırpma bölgesini, mevcut kırpma bölgesi ile belirtilen Region'un kesişimi olarak günceller. |
| [multiply_transform(matrix)](#multiply_transform_matrix_36) | Bu Graphics nesnesinin dünya dönüşümünü belirtilen Matris ile çarpar. |
| [multiply_transform(matrix, order)](#multiply_transform_matrix_order_37) | Bu Graphics nesnesinin dünya dönüşümünü belirtilen Matris ile belirtilen sırada çarpar. |
| reset_clip() | Klip'i sıfırlar. |
| [rotate_transform(angle)](#rotate_transform_angle_38) | Bu Graphics nesnesinin dönüşüm matrisine belirtilen dönüşü uygular. |
| [rotate_transform(angle, center, order)](#rotate_transform_angle_center_order_39) | Bu Graphics nesnesinin dönüşüm matrisine belirtilen dönüşü belirtilen sırada uygular. |
| [scale_transform(sx, sy)](#scale_transform_sx_sy_40) | Bu Graphics nesnesinin dönüşüm matrisine belirtilen ölçekleme işlemini nesnenin dönüşüm matrisine ön ekleyerek uygular. |
| [scale_transform(sx, sy, order)](#scale_transform_sx_sy_order_41) | Bu Graphics nesnesinin dönüşüm matrisine belirtilen ölçekleme işlemini belirtilen sırada uygular. |
| [set_transform(transform)](#set_transform_transform_42) | Dönüşümü ayarlar. |
| [translate_transform(x, y)](#translate_transform_x_y_43) | Bu Graphics nesnesinin dönüşüm matrisine belirtilen çeviriyi ön ekleyerek koordinat sisteminin orijini değiştirir. |
| [translate_transform(x, y, order)](#translate_transform_x_y_order_44) | Bu Graphics nesnesinin dönüşüm matrisine belirtilen çeviriyi belirtilen sırada uygulayarak koordinat sisteminin orijini değiştirir. |
