---
title: "AvifImage Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.fileformats.avif/avifimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [AvifImage()](#AvifImage__1) | AvifImage sınıfının yeni bir örneğini başlatır |
## **Properties**
...
| bits_per_pixel | int | r | Piksel başına bit değerini alır. |
...
| height | int | r | AVIF görüntü yüksekliğini alır. |
...
| width | int | r | AVIF görüntü genişliğini alır. |
...
AvifImage sınıfının yeni bir örneğini başlatır
