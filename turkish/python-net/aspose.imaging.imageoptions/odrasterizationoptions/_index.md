---
title: "OdRasterizationOptions Sınıfı"
type: docs
weight: 210
url: /tr/python-net/aspose.imaging.imageoptions/odrasterizationoptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [OdRasterizationOptions()](#OdRasterizationOptions__1) | OdRasterizationOptions sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
OdRasterizationOptions sınıfının yeni bir örneğini başlatır.
