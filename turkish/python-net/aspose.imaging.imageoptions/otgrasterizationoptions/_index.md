---
title: "OtgRasterizationOptions Sınıfı"
type: docs
weight: 230
url: /tr/python-net/aspose.imaging.imageoptions/otgrasterizationoptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [OtgRasterizationOptions()](#OtgRasterizationOptions__1) | OtgRasterizationOptions sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
OtgRasterizationOptions sınıfının yeni bir örneğini başlatır.
