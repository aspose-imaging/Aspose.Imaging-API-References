---
title: "DicomOptions Sınıfı"
type: docs
weight: 60
url: /tr/python-net/aspose.imaging.imageoptions/dicomoptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [DicomOptions()](#DicomOptions__1) | Yeni bir [DicomOptions](/imaging/python-net/aspose.imaging.imageoptions/dicomoptions/) sınıfı örneği başlatır. |
## **Properties**
...
| [color_type](#color_type1) | [ColorType](/imaging/python-net/aspose.imaging.fileformats.dicom/colortype/) | r/w | Renk tipini alır veya ayarlar. |
| [compression](#compression2) | [Compression](/imaging/python-net/aspose.imaging.fileformats.dicom/compression/) | r/w | Sıkıştırmayı alır veya ayarlar. |
...
Yeni bir [DicomOptions](/imaging/python-net/aspose.imaging.imageoptions/dicomoptions/) sınıfı örneği başlatır.
