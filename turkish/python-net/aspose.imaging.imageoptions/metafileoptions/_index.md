---
title: "MetafileOptions Sınıfı"
type: docs
weight: 170
url: /tr/python-net/aspose.imaging.imageoptions/metafileoptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [MetafileOptions()](#MetafileOptions__1) | Yeni bir [MetafileOptions](/imaging/python-net/aspose.imaging.imageoptions/metafileoptions/) sınıfı örneği başlatır. |
## **Properties**
...
| [compress](#compress1) | bool | r/w | Bu [ICompressedOptions](/imaging/python-net/aspose.fileformats.core.imageoptions/icompressedoptions/) sıkıştırılmış mı olduğunu belirten bir değeri alır veya ayarlar. |
...
Yeni bir [MetafileOptions](/imaging/python-net/aspose.imaging.imageoptions/metafileoptions/) sınıfı örneği başlatır.

### Property: compress {#compress1}

Bu [ICompressedOptions](/imaging/python-net/aspose.fileformats.core.imageoptions/icompressedoptions/) sıkıştırılmış mı olduğunu belirten bir değeri alır veya ayarlar.
