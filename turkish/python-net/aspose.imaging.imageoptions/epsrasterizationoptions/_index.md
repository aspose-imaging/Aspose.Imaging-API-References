---
title: "EpsRasterizationOptions Sınıfı"
type: docs
weight: 110
url: /tr/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EpsRasterizationOptions()](#EpsRasterizationOptions__1) | Yeni bir [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/) sınıfının örneğini başlatır. |
## **Properties**
...
| preview_to_export | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | r/w | Ön izleme dışa aktarma için [EpsImage.get_preview_image(format)](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) kullanın. |
...
Yeni bir [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/) sınıfının örneğini başlatır.
