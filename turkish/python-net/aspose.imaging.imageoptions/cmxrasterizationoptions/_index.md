...
type: docs
weight: 50
url: /tr/python-net/aspose.imaging.imageoptions/cmxrasterizationoptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [CmxRasterizationOptions()](#CmxRasterizationOptions__1) | Yeni bir [CmxRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/cmxrasterizationoptions/) sınıfı örneği başlatır. |
## **Properties**
...
Yeni bir [CmxRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/cmxrasterizationoptions/) sınıfı örneği başlatır.
