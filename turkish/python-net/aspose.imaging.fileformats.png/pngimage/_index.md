---
title: "PngImage Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.fileformats.png/pngimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [PngImage(path)](#PngImage_path_1) | Yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfı örneği, yolu <br/>            parametresiyle yüklemek için görüntü dosyasının konumunu belirterek oluşturur. Bu yapıcı <br/>            geliştiricilerin PNG görüntülerini bir dosyadan yükleyerek kolayca oluşturmalarını sağlar, <br/>            uygulamalarında PNG görüntüleriyle çalışmayı basitleştirir. |
| [PngImage(path, color_type)](#PngImage_path_color_type_2) | Yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini, görüntü dosyasının yolunu ve renk tipini belirterek başlatır. Bu yapıcı <br/>            farklı renk tiplerine sahip dosyalardan PNG görüntüleri oluşturmayı kolaylaştırır, <br/>            çeşitli görüntü formatlarını işleme esnekliği sağlar. |
| [PngImage(png_options, width, height)](#PngImage_png_options_width_height_3) | Yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini, genişlik ve yükseklik parametreleriyle birlikte PNG seçeneklerini dahil ederek başlatır. Bu yapıcı, geliştiricilerin özelleştirilebilir ayarlar ve boyutlarla PNG görüntüleri oluşturmasını sağlar, çeşitli kullanım senaryoları için görüntü üretiminde esneklik sunar. |
| [PngImage(raster_image)](#PngImage_raster_image_4) | Bir raster <br/>            görüntüyü parametre olarak sağlayarak yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini oluşturur. Bu yapıcı, geliştiricilerin mevcut bir raster görüntüyü kullanarak doğrudan bir PNG görüntü nesnesi başlatmasına izin verir, uygulamalarında PNG görüntüleriyle çalışmayı kolaylaştırır. |
| [PngImage(raster_image, color_type)](#PngImage_raster_image_color_type_5) | Bir raster görüntü ve renk tipi belirterek yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini oluşturur. Bu yapıcı, geliştiricilerin raster görüntüleri istenen renk tipini belirterek doğrudan PNG formatına dönüştürmesini sağlar, renk temsili konusunda esneklik sunar. |
| [PngImage(stream)](#PngImage_stream_6) | Bir akış ile başlatarak yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini oluşturur. Bu yapıcı, geliştiricilerin PNG görüntülerini doğrudan bir akıştan yüklemesine izin verir, farklı kaynaklardan görüntü alımında esneklik sağlar. |
| [PngImage(width, height)](#PngImage_width_height_7) | Genişlik ve yükseklik parametrelerini sağlayarak yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfı nesnesini başlatır. Bu yapıcı, geliştiricilerin boyutları doğrudan belirlemesine izin vererek PNG <br/>            görüntü oluşturmayı basitleştirir, uygulamalarında PNG görüntü verilerinin verimli yönetimini kolaylaştırır. |
| [PngImage(width, height, color_type)](#PngImage_width_height_color_type_8) | İstenen genişlik, yükseklik ve renk tipi parametrelerini belirterek yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının taze bir örneğini oluşturur. Bu yapıcı, özelleştirilmiş boyutlar ve renk yapılandırmalarıyla PNG görüntülerinin hızlı bir şekilde oluşturulmasını sağlar, çeşitli uygulama ve iş akışları için sorunsuz görüntü üretimini kolaylaştırır. |
## **Properties**
| **Name** | **Type** | **Access** | **Açıklama** |
| :- | :- | :- | :- |
| auto_adjust_palette | bool | r/w | Otomatik palet ayarlamasını gösteren bir değeri alır veya ayarlar. |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Görselin arka plan rengini, belirtilmişse geri alır. Bu özellik <br/>            bir görüntünün arka plan rengini tanımlaması ve gerekirse değiştirmesi gereken uygulamalar için faydalıdır. |
| bits_per_pixel | int | r | Görselin piksel başına bit değerini alır. Bu özellik, görüntünün renk derinliğiyle ilgili kritik <br/>            bilgi sağlar, geliştiricilerin görüntü verilerindeki detay ve renk doğruluğu seviyesini anlamasını mümkün kılar. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Görsel örneğiyle ilişkili dosyanın formatını alır. Bu <br/>            özellik, dosya türüyle ilgili temel bilgi sağlar, belirli format gereksinimlerine göre verimli işleme ve yönetim imkanı sunar. |
| [has_alpha](#has_alpha1) | bool | r | Görselin alfa kanalı olup olmadığını belirten bir boolean değer döndürür, <br/>            bu da şeffaflığını belirler. Bu özellik, şeffaflığı yönetmesi gereken uygulamalar için faydalıdır, geliştiricilerin görüntüdeki şeffaf alanları işlemek için ek işlem gerekip gerekmediğini belirlemesini sağlar. |
| has_background_color | bool | r/w | Görselin arka plan rengine sahip olup olmadığını gösteren bir boolean değer alır. <br/>            Bu özellik, bir görüntünün arka plan rengi içerip içermediğini belirlemesi gereken uygulamalar için faydalıdır; bu, birleştirme, renderleme veya dışa aktarma gibi çeşitli işleme görevleri için önemli olabilir. |
| has_transparent_color | bool | r/w | Görselin şeffaf bir renk içerip içermediğini gösteren bir boolean değer sağlar. Bu özellik, şeffaflığı yönetmesi gereken uygulamalar için kritik öneme sahiptir, geliştiricilerin görüntüdeki şeffaf bölgeleri işlemek için ek işlem gerekip gerekmediğini belirlemesini sağlar. |
| height | int | r | Görselin yüksekliğini alır. Bu özellik, görüntünün dikey boyutunu <br/>            döndürür, geliştiricilerin dikey eksen boyunca piksel cinsinden boyutunu belirlemesini sağlar. |
| horizontal_resolution | float | r/w | Görselin yatay çözünürlüğünü alır veya değiştirir. Bu özellik, görüntünün yatay eksenindeki inç başına piksel sayısını temsil eder. Bu çözünürlüğün ayarlanması, görüntünün yazdırıldığında veya gösterildiğinde fiziksel boyutunu etkileyebilir. |
| image_opacity | float | r | Bu görüntünün opaklığını alır. |
| interlaced | bool | r | Bir boolean değer alır ve [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının <br/>            satır aralıklı (interlaced) olup olmadığını gösterir; bu, görüntü verisinin daha hızlı yükleme veya iletim için ilerleyici bir şekilde depolanıp depolanmadığını belirler. |
...
| is_interlaced | bool | r | Görüntü örneğinin taramalı olup olmadığını belirten bir boolean değer döndürür. Bu <br/>            özellik, yükleme stratejilerini optimize etmek ve görüntü işleme veya gösterim görevleri sırasında verimli <br/>            performansı sağlamak için kritiktir. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Görüntünün ham veri formatına erişir. Bu özellik, görüntü verisinin dahili olarak nasıl yapılandırıldığını gösterir ve gelişmiş <br/>            görüntü işleme görevleri veya format dönüşümü için faydalı olabilir. |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Görüntünün, varsa, şeffaf rengini alır. Bu özellik, görüntülerdeki şeffaf alanların hassas bir şekilde işlenmesini gerektiren uygulamalar için değerlidir ve geliştiricilerin kullanılan belirli şeffaf rengi erişip manipüle etmelerini sağlar. |
...
| vertical_resolution | float | r/w | Görüntünün dikey çözünürlüğüne erişim sağlar. Geliştiriciler bu özelliği çözünürlük ayarını almak veya değiştirmek için kullanabilir; bu ayar, görüntünün dikey eksenindeki inç başına piksel (PPI) sayısını gösterir. |
| width | int | r | Görüntünün genişliğini almayı sağlar ve boyutları hakkında temel bilgi sunar. Bu özellik, geliştiriciler tarafından görüntünün genişliğini belirlemek ve boyutuna göre çeşitli işlemler gerçekleştirmek için sıkça kullanılır. |
...
| [create_from_file_with_color_type(path, color_type)](#create_from_file_with_color_type_path_color_type_26) | [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_29) | [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır. |
| [create_from_image_with_color_type(raster_image, color_type)](#create_from_image_with_color_type_raster_image_color_type_30) | [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır. |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır. |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_34) | [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır. |
| [create_with_width_height_color_type(width, height, color_type)](#create_with_width_height_color_type_width_height_color_type_35) | [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır. |
| [create_with_width_height_options(png_options, width, height)](#create_with_width_height_options_png_options_width_height_36) | [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır. |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_37) | Kaydırmalarla görüntüyü kırp. |
| [crop(rectangle)](#crop_rectangle_38) | Görüntüyü kırpma. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_39) | Mevcut görüntüde dithering uygular. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_40) | Mevcut görüntüde dithering uygular. |
| [embed_digital_signature(password)](#embed_digital_signature_password_41) | Sağlanan şifreye dayalı dijital imzayı steganografi kullanarak görüntüye göm. |
| [filter(rectangle, options)](#filter_rectangle_options_42) | Belirtilen dikdörtgeni filtreler. |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_54) | Kaynak görüntünün en son değiştirildiğini gösteren zaman damgasını alır. Bu yöntem, uygulamaların görüntünün ne zaman son kez değiştirildiğini belirlemelerini sağlayan önemli meta verilere erişim sunar ve sürüm takibi ile içerik yönetimini kolaylaştırır. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_79) | Açıyı normalleştirir.<br/>            Bu yöntem, taranmış metin belgelerinde eğik taramayı gidermek için uygulanabilir.<br/>            Bu yöntem, [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) ve [RasterImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rasterimage/) metodlarını kullanır. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_82) | İzin verilen farkla bir rengi başka bir renkle değiştirir ve orijinal alfa değerini koruyarak pürüzsüz kenarları korur. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_83) | İzin verilen farkla bir rengi başka bir renkle değiştirir ve orijinal alfa değerini koruyarak pürüzsüz kenarları korur. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_84) | İzin verilen farkla bir rengi başka bir renkle değiştirir ve orijinal alfa değerini koruyarak pürüzsüz kenarları korur. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_85) | Tüm şeffaf olmayan renkleri yeni renk ile değiştirir ve orijinal alfa değerini koruyarak yumuşak kenarları korur.<br/>            Not: şeffaflık içermeyen görüntülerde kullanırsanız, tüm renkler tek bir renk ile değiştirilecektir. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_86) | Tüm şeffaf olmayan renkleri yeni renk ile değiştirir ve orijinal alfa değerini koruyarak yumuşak kenarları korur.<br/>            Not: şeffaflık içermeyen görüntülerde kullanırsanız, tüm renkler tek bir renk ile değiştirilecektir. |
| [resize(new_width, new_height)](#resize_new_width_new_height_87) | Görüntüyü yeniden boyutlandırır. Varsayılan olarak [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) kullanılır. |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_88) | Görüntüyü yeniden boyutlandırır. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_89) | Görüntüyü yeniden boyutlandırır. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_90) | Görüntüyü yeniden boyutlandırır. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_91) | Görüntüyü yeniden boyutlandırır. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_92) | Yüksekliği orantılı olarak yeniden boyutlandırır. Varsayılan [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) kullanılır. |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_93) | Yüksekliği orantılı olarak yeniden boyutlandırır. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_94) | Yüksekliği orantılı olarak yeniden boyutlandırır. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_95) | Yüksekliği orantılı olarak yeniden boyutlandırır. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_96) | Genişliği orantılı olarak yeniden boyutlandırır. Varsayılan [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/) kullanılır. |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_97) | Genişliği orantılı olarak yeniden boyutlandırır. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_98) | Genişliği orantılı olarak yeniden boyutlandırır. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_99) | Genişliği orantılı olarak yeniden boyutlandırır. |
| [rotate(angle)](#rotate_angle_100) | Görüntüyü merkezin etrafında döndür. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_101) | Görüntüyü merkezin etrafında döndür. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_102) | Görüntüyü döndürür, çevirir veya döndürüp çevirir. |
...
| [save(stream)](#save_stream_107) | Kaydetme verileri. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_123) | Bu [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) için çözünürlüğü ayarlar. |
...
Yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfı örneği, yolu <br/>            parametresiyle yüklemek için görüntü dosyasının konumunu belirterek oluşturur. Bu yapıcı <br/>            geliştiricilerin PNG görüntülerini bir dosyadan yükleyerek kolayca oluşturmalarını sağlar, <br/>            uygulamalarında PNG görüntüleriyle çalışmayı basitleştirir.
...
Yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini, görüntü dosyasının yolunu ve renk tipini belirterek başlatır. Bu yapıcı <br/>            farklı renk tiplerine sahip dosyalardan PNG görüntüleri oluşturmayı kolaylaştırır, <br/>            çeşitli görüntü formatlarını işleme esnekliği sağlar.
...
| :- | :- | :- |
| yol | string | Bir görüntüyü yüklemek için yol. |
| color_type | [PngColorType](/imaging/python-net/aspose.imaging.fileformats.png/pngcolortype/) | Renk türü. |
...
Yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini, genişlik ve yükseklik parametreleriyle birlikte PNG seçeneklerini dahil ederek başlatır. Bu yapıcı, geliştiricilerin özelleştirilebilir ayarlar ve boyutlarla PNG görüntüleri oluşturmasını sağlar, çeşitli kullanım senaryoları için görüntü üretiminde esneklik sunar.
...
Bir raster görüntü ve renk tipi belirterek yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini oluşturur. Bu yapıcı, geliştiricilerin raster görüntüleri istenen renk tipini belirterek doğrudan PNG formatına dönüştürmesini sağlar, renk temsili konusunda esneklik sunar.
...
Bir akış ile başlatarak yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının örneğini oluşturur. Bu yapıcı, geliştiricilerin PNG görüntülerini doğrudan bir akıştan yüklemesine izin verir, farklı kaynaklardan görüntü alımında esneklik sağlar.
...
Genişlik ve yükseklik parametrelerini sağlayarak yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfı nesnesini başlatır. Bu yapıcı, geliştiricilerin boyutları doğrudan belirlemesine izin vererek PNG <br/>            görüntü oluşturmayı basitleştirir, uygulamalarında PNG görüntü verilerinin verimli yönetimini kolaylaştırır.
...
İstenen genişlik, yükseklik ve renk tipi parametrelerini belirterek yeni bir [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının taze bir örneğini oluşturur. Bu yapıcı, özelleştirilmiş boyutlar ve renk yapılandırmalarıyla PNG görüntülerinin hızlı bir şekilde oluşturulmasını sağlar, çeşitli uygulama ve iş akışları için sorunsuz görüntü üretimini kolaylaştırır.
...
Görselin alfa kanalı olup olmadığını belirten bir boolean değer döndürür, <br/>            bu da şeffaflığını belirler. Bu özellik, şeffaflığı yönetmesi gereken uygulamalar için faydalıdır, geliştiricilerin görüntüdeki şeffaf alanları işlemek için ek işlem gerekip gerekmediğini belirlemesini sağlar.
...
[PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) sınıfının yeni bir örneğini başlatır.
...
Kaynak görüntünün en son değiştirildiğini gösteren zaman damgasını alır. Bu yöntem, uygulamaların görüntünün ne zaman son kez değiştirildiğini belirlemelerini sağlayan önemli meta verilere erişim sunar ve sürüm takibi ile içerik yönetimini kolaylaştırır.
...
dir_: str = "c:\\temp"
# Bir dosya akışından PNG görüntüsü yükle.
...
dir_: str = "c:\\temp"
# Bir BMP görüntüsünden TrueColor PNG görüntüsü yükle.
# İlk olarak, PNG görüntüsü oluşturmak için temel olacak geçici bir BMP görüntüsü oluşturun.
# BMP görüntüsünü bir dosyadan yükleyebilir veya herhangi başka bir raster formatındaki görüntüyü kullanabilirsiniz.
with BmpImage(100, 100) as bmp_image:
	# Tüm BMP görüntüsünü kırmızıyla doldurun.
...
dir_ = "c:\\temp"
# Renkli bir BMP görüntüsünden gri tonlamalı PNG görüntüsü yükle.
# İlk olarak, PNG görüntüsü oluşturmak için temel olacak geçici bir BMP görüntüsü oluşturun.
# BMP görüntüsünü bir dosyadan yükleyebilir veya herhangi başka bir raster formatındaki görüntüyü kullanabilirsiniz.
with BmpImage(100, 100) as bmp_image:
	# Tüm BMP görüntüsünü kırmızıyla doldurun.
	...
	brush = SolidBrush(Color.red)
	gr.fill_rectangle(brush, bmp_image.bounds)
	# Görüntü piksellerinin renkleri gri tonlamalı karşılıklarına dönüştürülecek.
...
dir_: str = "c:\\temp"
# 100x100 piksel boyutunda gri tonlamalı PNG görüntüsü oluştur.
# Tüm renkler otomatik olarak gri tonlamalı formata dönüştürülecek.
...
# Desteklenen tüm PNG renk türlerini al.
...
# Gri tonlamalı PNG görüntüsü alfa kanalını desteklemez
# Truecolor PNG görüntüsü alfa kanalını desteklemez
# IndexedColor PNG görüntüsü alfa kanalını desteklemez
# Bir GrayscaleWithAlpha PNG görüntüsü alfa kanalını destekler
# Bir TruecolorWithAlpha PNG görüntüsü alfa kanalını destekler
