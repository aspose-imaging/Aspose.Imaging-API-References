...
type: docs
weight: 80
url: /tr/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffStreamReader(data)](#TiffStreamReader_data_1) | Yeni bir [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) sınıfı örneği başlatır. |
| [TiffStreamReader(data, start_index)](#TiffStreamReader_data_start_index_2) | Yeni bir [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) sınıfı örneği başlatır. |
| [TiffStreamReader(data, start_index, data_length)](#TiffStreamReader_data_start_index_data_length_3) | Yeni bir [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) sınıfı örneği başlatır. |
| [TiffStreamReader(stream_container)](#TiffStreamReader_stream_container_4) | Yeni bir [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) sınıfı örneği başlatır. |
## **Properties**
...
Yeni bir [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) sınıfı örneği başlatır.
