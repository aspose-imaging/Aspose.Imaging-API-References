---
title: "TiffRationalType Sınıfı"
type: docs
weight: 100
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffRationalType(tag_id)](#TiffRationalType_tag_id_1) | Yeni bir [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) sınıfının bir örneğini başlatır. |
| [TiffRationalType(tag_id)](#TiffRationalType_tag_id_2) | Yeni bir [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| values | [TiffRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffrational/) | r/w | Değerleri alır veya ayarlar. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) sınıfının bir örneğini başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) sınıfının bir örneğini başlatır. |
...
Yeni bir [TiffRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffrationaltype/) sınıfının bir örneğini başlatır.
