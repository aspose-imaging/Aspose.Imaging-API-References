---
title: "TiffIfdType Sınıfı"
type: docs
weight: 70
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffIfdType(tag_id)](#TiffIfdType_tag_id_1) | Yeni bir [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) sınıfının bir örneğini başlatır. |
| [TiffIfdType(tag_id)](#TiffIfdType_tag_id_2) | Yeni bir [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) sınıfının bir örneğini başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) sınıfının bir örneğini başlatır. |
...
Yeni bir [TiffIfdType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/) sınıfının bir örneğini başlatır.
