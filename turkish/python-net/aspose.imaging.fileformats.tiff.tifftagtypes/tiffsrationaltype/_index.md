---
title: "TiffSRationalType Sınıf"
type: docs
weight: 140
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffSRationalType(tag_id)](#TiffSRationalType_tag_id_1) | Yeni bir [TiffSRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/) sınıfının bir örneğini başlatır. |
| [TiffSRationalType(tag_id)](#TiffSRationalType_tag_id_2) | Yeni bir [TiffSRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| values | [TiffSRational[]](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffsrational/) | r/w | Değerleri alır veya ayarlar. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffSRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/) sınıfının bir örneğini başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffSRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/) sınıfının bir örneğini başlatır. |
...
Yeni bir [TiffSRationalType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsrationaltype/) sınıfının bir örneğini başlatır.
