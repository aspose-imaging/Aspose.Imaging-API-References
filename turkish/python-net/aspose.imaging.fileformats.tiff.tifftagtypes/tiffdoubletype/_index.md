---
title: "TiffDoubleType Sınıfı"
type: docs
weight: 40
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffDoubleType(tag_id)](#TiffDoubleType_tag_id_1) | Yeni bir [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/) sınıfı örneği başlatır. |
| [TiffDoubleType(tag_id)](#TiffDoubleType_tag_id_2) | Yeni bir [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/) sınıfı örneği başlatır. |
## **Properties**
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/) sınıfı örneği başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/) sınıfı örneği başlatır. |
...
Yeni bir [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/) sınıfı örneği başlatır.
