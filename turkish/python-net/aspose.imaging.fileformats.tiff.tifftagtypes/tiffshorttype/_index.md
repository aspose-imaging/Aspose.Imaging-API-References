---
title: "TiffShortType Sınıf"
type: docs
weight: 160
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffShortType(tag_id)](#TiffShortType_tag_id_1) | Yeni bir [TiffShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/) sınıfının bir örneğini başlatır. |
| [TiffShortType(tag_id)](#TiffShortType_tag_id_2) | Yeni bir [TiffShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| values | int[] | r/w | Veriyi alır veya ayarlar. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/) sınıfının bir örneğini başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/) sınıfının bir örneğini başlatır. |
...
Yeni bir [TiffShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffshorttype/) sınıfının bir örneğini başlatır.
