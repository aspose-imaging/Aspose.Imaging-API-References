---
title: "TiffFloatType Sınıf"
type: docs
weight: 50
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffFloatType(tag_id)](#TiffFloatType_tag_id_1) | Yeni bir [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) sınıfının bir örneğini başlatır. |
| [TiffFloatType(tag_id)](#TiffFloatType_tag_id_2) | Yeni bir [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| values | float[] | r/w | Değerleri alır veya ayarlar. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) sınıfının bir örneğini başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) sınıfının bir örneğini başlatır. |
...
Yeni bir [TiffFloatType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tifffloattype/) sınıfının bir örneğini başlatır.
