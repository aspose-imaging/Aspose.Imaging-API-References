---
title: "TiffSShortType Sınıf"
type: docs
weight: 150
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffSShortType(tag_id)](#TiffSShortType_tag_id_1) | Yeni bir [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) sınıfının bir örneğini başlatır. |
| [TiffSShortType(tag_id)](#TiffSShortType_tag_id_2) | Yeni bir [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) sınıfının bir örneğini başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) sınıfının bir örneğini başlatır. |
...
Yeni bir [TiffSShortType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsshorttype/) sınıfının bir örneğini başlatır.
