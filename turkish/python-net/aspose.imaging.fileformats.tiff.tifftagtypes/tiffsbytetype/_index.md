---
title: "TiffSByteType Sınıf"
type: docs
weight: 110
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffSByteType(tag_id)](#TiffSByteType_tag_id_1) | Yeni bir [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) sınıfının bir örneğini başlatır. |
| [TiffSByteType(tag_id)](#TiffSByteType_tag_id_2) | Yeni bir [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| values | System.SByte | r/w | Değerleri alır veya ayarlar. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Yeni bir [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) sınıfının bir örneğini başlatır. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Yeni bir [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) sınıfının bir örneğini başlatır. |
...
Yeni bir [TiffSByteType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffsbytetype/) sınıfının bir örneğini başlatır.
