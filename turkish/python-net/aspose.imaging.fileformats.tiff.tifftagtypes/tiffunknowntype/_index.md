---
title: "TiffUnknownType Sınıfı"
type: docs
weight: 180
url: /tr/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffUnknownType(stream, tag_type, tag_id, count, offset_or_value)](#TiffUnknownType_stream_tag_type_tag_id_count_offset_or_value_1) | Yeni bir [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| offset_or_value | int | r | Sayım 1 olduğunda ek veri için offset değerini veya değerin kendisini alır. |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | r | Ek veriyi okumak için akışı alır. |
...
| [write_tag(data_stream, additional_data_offset)](#write_tag_data_stream_additional_data_offset_7) | Etiket değerini veya ek ofseti yazar. |
...
Yeni bir [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/) sınıfının bir örneğini başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | Okunacak akış. |
| tag_type | int | Etiketin türü. |
| tag_id | int | Etiket kimliği. |
| count | int | Sayım değeri. |
| offset_or_value | int | Offset veya değer. |
