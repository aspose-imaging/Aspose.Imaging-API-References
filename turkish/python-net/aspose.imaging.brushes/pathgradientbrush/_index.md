...
type: docs
weight: 50
url: /tr/python-net/aspose.imaging.brushes/pathgradientbrush/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [PathGradientBrush(path)](#PathGradientBrush_path_1) | PathGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathGradientBrush(path_points)](#PathGradientBrush_path_points_2) | PathGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathGradientBrush(path_points)](#PathGradientBrush_path_points_3) | PathGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathGradientBrush(path_points, wrap_mode)](#PathGradientBrush_path_points_wrap_mode_4) | PathGradientBrush sınıfının yeni bir örneğini başlatır. |
| [PathGradientBrush(path_points, wrap_mode)](#PathGradientBrush_path_points_wrap_mode_5) | PathGradientBrush sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| center_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Yol degrade'nin merkezindeki rengi alır veya ayarlar. |
...
| surround_colors | [Color[]](/imaging/python-net/aspose.imaging/color/) | r/w | Bu [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) tarafından doldurulan yoldaki noktalara karşılık gelen renk dizisini alır veya ayarlar. |
...
| **Name** | **Açıklama** |
| :- | :- |
| [create_with_path(path)](#create_with_path_path_1) | Belirtilen yol ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır. |
| [create_with_points(path_points)](#create_with_points_path_points_2) | Belirtilen noktalar ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır. |
| [create_with_points_f(path_points)](#create_with_points_f_path_points_3) | Belirtilen noktalar ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır. |
| [create_with_points_f_wrap_mode(path_points, wrap_mode)](#create_with_points_f_wrap_mode_path_points_wrap_mode_4) | Belirtilen noktalar ve sarma modu ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır. |
| [create_with_points_wrap_mode(path_points, wrap_mode)](#create_with_points_wrap_mode_path_points_wrap_mode_5) | Belirtilen noktalar ve sarma modu ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır. |
...
| [set_blend_triangular_shape(focus)](#set_blend_triangular_shape_focus_13) | Merkez rengi ve bir çevre rengine doğru lineer azalma ile bir degrade oluşturur. |
| [set_blend_triangular_shape(focus, scale)](#set_blend_triangular_shape_focus_scale_14) | Merkez rengi ve her çevre rengine doğru lineer azalma ile bir degrade oluşturur. |
| [set_sigma_bell_shape(focus)](#set_sigma_bell_shape_focus_15) | Yolun merkezinden başlayarak yolun sınırına doğru renk değiştiren bir degrade fırçası oluşturur. Bir renkten diğerine geçiş, çan şeklinde bir eğriye dayanır. |
| [set_sigma_bell_shape(focus, scale)](#set_sigma_bell_shape_focus_scale_16) | Yolun merkezinden başlayarak yolun sınırına doğru renk değiştiren bir degrade fırçası oluşturur. Bir renkten diğerine geçiş, çan şeklinde bir eğriye dayanır. |
| [translate_transform(dx, dy)](#translate_transform_dx_dy_17) | Yerel geometrik dönüşümü belirtilen boyutlarla çevirir. Bu yöntem çeviriyi dönüşüme ön ekler. |
| [translate_transform(dx, dy, order)](#translate_transform_dx_dy_order_18) | Yerel geometrik dönüşümü belirtilen boyutlarla, belirtilen sırada çevirir. |
...
Belirtilen yol ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| path | [GraphicsPath](/imaging/python-net/aspose.imaging/graphicspath/) | Bu [GraphicsPath](/imaging/python-net/aspose.imaging/graphicspath/) yolu, bu [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) tarafından doldurulan alanı tanımlar. |
...
Belirtilen noktalar ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır.
...
Belirtilen noktalar ve sarma modu ile [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) sınıfının yeni bir örneğini başlatır.
...
| :- | :- | :- |
| path_points | [PointF[]](/imaging/python-net/aspose.imaging/pointf/) | Yolun köşe noktalarını oluşturan noktaları temsil eden bir [PointF](/imaging/python-net/aspose.imaging/pointf/) yapıları dizisi. |
| wrap_mode | [WrapMode](/imaging/python-net/aspose.imaging/wrapmode/) | Bir [WrapMode](/imaging/python-net/aspose.imaging/wrapmode/) bu [PathGradientBrush](/imaging/python-net/aspose.imaging.brushes/pathgradientbrush/) ile çizilen doldurmaların nasıl döşeneceğini belirler. |
