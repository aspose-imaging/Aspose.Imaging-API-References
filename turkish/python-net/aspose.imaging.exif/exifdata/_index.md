...
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.exif/exifdata/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [ExifData()](#ExifData__1) | Yeni bir [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) sınıfının bir örneğini başlatır. |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | Diziden gelen veriyle yeni bir [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) sınıfının bir örneğini başlatır. |
| [ExifData(exifdata)](#ExifData_exifdata_3) | Diziden gelen veriyle yeni bir [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) sınıfının bir örneğini başlatır. |
| [ExifData(exifdata)](#ExifData_exifdata_4) | Diziden gelen veriyle yeni bir [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) sınıfının bir örneğini başlatır. |
## **Properties**
...
| [maker_notes](#maker_notes1) | [MakerNote[]](/imaging/python-net/aspose.imaging.exif/makernote/) | r | Üretici notlarını alır. |
...
| x_resolution | int | r/w | x çözünürlüğünü alır veya ayarlar. |
| y_resolution | int | r/w | y çözünürlüğünü alır veya ayarlar. |
## **Methods**
| **Name** | **Açıklama** |
| :- | :- |
...
Yeni bir [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) sınıfının bir örneğini başlatır.
...
Diziden gelen veriyle yeni bir [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) sınıfının bir örneğini başlatır.
