---
title: "IcoImage Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.fileformats.ico/icoimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [IcoImage(image, ico_options)](#IcoImage_image_ico_options_1) | Basitlik ve verimlilik için tasarlanmış olan [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) sınıfı, <br/>            size ICO görüntülerini kolayca oluşturma imkanı verir. Bu yapıcı, sınıfın yeni bir örneğini <br/>            başlatarak görüntü işleme ihtiyaçlarınız için sağlam bir temel sağlar. <br/>            İster uygulama geliştiriyor olun ister kullanıcı arayüzlerini iyileştiriyor olun, <br/>            [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) sınıfı ICO görüntü yönetimini basitleştirir, böylece <br/>            olağanüstü deneyimler sunmaya odaklanabilirsiniz. |
| [IcoImage(width, height, options)](#IcoImage_width_height_options_2) | [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) sınıfını kullanarak ICO görüntüsü oluşturmayı zahmetsizce başlatın. Bu <br/>            yapıcı, genişlik, yükseklik ve oluşturma seçenekleri parametrelerini belirterek ICO görüntülerinin yeni örneklerini başlatmanıza izin verir. Bu basit <br/>            yapıcı sayesinde ICO görüntülerini tam olarak istediğiniz gibi özelleştirebilir, farklı platform ve cihazlarda <br/>            sorunsuz uyumluluk ve görsel çekicilik sağlayabilirsiniz. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Bu özellik sayesinde dosya formatını zahmetsizce alın, iş akışınıza sorunsuz <br/>            entegrasyon sağlar. Bu özelliği kullanarak dosyanızın formatı hakkında kritik <br/>            bilgilere erişir, uyumluluğu ve verimli işleme garantilersiniz. |
| has_alpha | bool | r | Bu özellik ile bu örnekte alfa kanalının bulunup bulunmadığını belirleyin. <br/>            Görüntünün veya belgenin alfa kanalı içerip içermediğini hızlıca kontrol etmenizi sağlar, <br/>            bu çeşitli görüntü işleme ve renderleme görevleri için kritiktir. Görüntü ve belgelerde <br/>            uyumluluğu sağlamak ve şeffaflık etkilerini yönetmek için idealdir. |
...
| page_count | int | r | Bu basit <br/>            özellik sayesinde belge yapısı hakkında anında bilgi edinin. Bu özelliği çağırarak, dosyada bulunan <br/>            toplam sayfa sayısını zahmetsizce elde edersiniz. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Belgenin sayfalarıyla ilgili kapsamlı bilgileri zahmetsizce <br/>            bu özellik aracılığıyla alın. Bu özelliğe erişerek, belge içinde bulunan tüm sayfaları içeren bir koleksiyon veya diziye erişim elde edersiniz. |
...
| **Name** | **Açıklama** |
| :- | :- |
| [add_page(page)](#add_page_page_1) | ICO görüntünüzü bir görüntü sayfası girişi ekleyerek genişletin, <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Bu yöntem raster görüntüleri ICO dosyanıza sorunsuz bir şekilde ekler, yüksek kaliteli 32-bit PNG formatına dönüştürür. Raster görüntülerle ICO dosyalarınızı geliştirmek ve optimal uyumluluk <br/>            ve render kalitesi sağlamak için mükemmeldir. |
| [add_page(page)](#add_page_page_2) | ICO görüntünüzü bir görüntü sayfası girişi ekleyerek genişletin, <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Bu yöntem raster görüntüleri ICO dosyanıza sorunsuz bir şekilde ekler, yüksek kaliteli 32-bit PNG formatına dönüştürür. Raster görüntülerle ICO dosyalarınızı geliştirmek ve optimal uyumluluk <br/>            ve render kalitesi sağlamak için mükemmeldir. |
| [add_page(page, ico_options)](#add_page_page_ico_options_3) | ICO görüntünüzü zahmetsizce çeşitlendirin, belirttiğiniz [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) ile ihtiyaçlarınıza göre uyarlanmış bir görüntü girişi ekleyerek. Bu yöntem görüntüyü özelleştirilmiş seçeneklerinize göre sorunsuz bir şekilde <br/>            ekler, ICO dosyanızda esneklik <br/>            ve hassasiyet sağlar. |
| [add_raster_page(page)](#add_raster_page_page_4) | Varsayılan [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) kullanarak ICO görüntüsüne 32-bit PNG olarak bir görüntü girişi ekler. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | Görüntü için bir _parlaklık_ ayarı. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | [Image](/imaging/python-net/aspose.imaging/image/) kontrastı |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | Bir görüntünün gama düzeltmesi. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | Bir görüntünün gama düzeltmesi. |
...
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | Önceden tanımlı eşik ile bir görüntünün ikilileştirilmesi |
...
| [can_load(stream)](#can_load_stream_17) | Verilen akışın bir ICO görüntüsü içerip içermediğini belirler. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | Kaydırmalarla görüntüyü kırp. |
| [crop(rectangle)](#crop_rectangle_35) | Görüntüyü kırpma. |
...
| [remove_page(index)](#remove_page_index_79) | ICO görüntünüzü dosya içinde belirlenen ***index*** konumundaki belirli bir görüntü girişini kaldırarak ince ayar yapın. Bu yöntem görüntü bileşiminiz üzerinde hassas <br/>            kontrol sağlar, ICO dosyanızı kolayca iyileştirmenize olanak tanır. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_83) | Tüm şeffaf olmayan renkleri yeni renk ile değiştirir ve orijinal alfa değerini koruyarak pürüzsüz kenarları korur.<br/>                Not: Şeffaflığı olmayan görüntülerde kullanırsanız, tüm renkler tek bir renk ile değiştirilecektir. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_84) | Tüm şeffaf olmayan renkleri yeni renk ile değiştirir ve orijinal alfa değerini koruyarak pürüzsüz kenarları korur.<br/>                Not: Şeffaflığı olmayan görüntülerde kullanırsanız, tüm renkler tek bir renk ile değiştirilecektir. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) görüntüyü merkez etrafında döndürür. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | Tüm sayfaları döndürür, çevirir veya döndürüp çevirir. |
...
| [save(file_path, options)](#save_file_path_options_103) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya konumunda ve belirtilen dosya formatında kaydeder. |
...
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen akışa ve belirtilen dosya formatında kaydeder. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_109) | 32-bit ARGB piksellerini kaydeder. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_110) | Pikselleri kaydeder. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_111) | Pikselleri kaydeder.<br/>            Bu yöntem artık kullanılmamaktadır. Lütfen daha etkili olan [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) yöntemini kullanın. |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_112) | Piksel verilerini dahili olarak kaydeder. |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_113) | Ham veriyi kaydeder. |
| [save_to_stream(stream)](#save_to_stream_stream_114) | Nesnenin verisini belirtilen akışa kaydeder. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_115) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen akışa ve belirtilen dosya formatında kaydeder. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_116) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen akışa ve belirtilen dosya formatında kaydeder. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_117) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya konumunda ve belirtilen dosya formatında kaydeder. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_118) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya konumunda ve belirtilen dosya formatında kaydeder. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_119) | Belirtilen konum için bir görüntünün 32-bit ARGB pikselini ayarlar. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_120) | Görüntü paletini ayarlar. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_121) | Belirtilen konum için bir görüntü pikselini ayarlar. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_122) | Bu [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) için çözünürlüğü ayarlar. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_123) | Bu [Image](/imaging/python-net/aspose.imaging/image/) örneği destekliyor ve [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) örneğini uyguluyorsa, bir _metadata_ örneği ayarlamaya çalışır. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_124) | Tüm tarama satırını belirtilen tarama satırı indeksine yazar. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_125) | Tüm tarama satırını belirtilen tarama satırı indeksine yazar. |
...
Basitlik ve verimlilik için tasarlanmış olan [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) sınıfı, <br/>            size ICO görüntülerini kolayca oluşturma imkanı verir. Bu yapıcı, sınıfın yeni bir örneğini <br/>            başlatarak görüntü işleme ihtiyaçlarınız için sağlam bir temel sağlar. <br/>            İster uygulama geliştiriyor olun ister kullanıcı arayüzlerini iyileştiriyor olun, <br/>            [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) sınıfı ICO görüntü yönetimini basitleştirir, böylece <br/>            olağanüstü deneyimler sunmaya odaklanabilirsiniz.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| image | [Image](/imaging/python-net/aspose.imaging/image/) | Görüntü. |
| ico_options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | ICO seçenekleri. |
...
| options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | ICO oluşturma seçenekleri. |
...
ICO görüntünüzü bir görüntü sayfası girişi ekleyerek genişletin, <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Bu yöntem raster görüntüleri ICO dosyanıza sorunsuz bir şekilde ekler, yüksek kaliteli 32-bit PNG formatına dönüştürür. Raster görüntülerle ICO dosyalarınızı geliştirmek ve optimal uyumluluk <br/>            ve render kalitesi sağlamak için mükemmeldir.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| page | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Görüntü. |
...
| Parameter | Tür | Açıklama |
| :- | :- | :- |
| page | [Image](/imaging/python-net/aspose.imaging/image/) | Görüntü. |
...
Varsayılan [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) kullanarak ICO görüntüsüne 32-bit PNG olarak bir görüntü girişi ekler.
...
Görüntü için bir _parlaklık_ ayarı.
...
| Parameter | Tür | Açıklama |
| :- | :- | :- |
| eşik | System.Byte | Eşik değeri. Bir pikselin ilgili gri değeri eşikten büyükse, bir değer olan<br/>                255 atanır, aksi takdirde 0. |
...
Verilen akışın bir ICO görüntüsü içerip içermediğini belirler.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| akış | _io.BufferedRandom | Görüntü akışı. |

**Returns**

| Tür | Açıklama |
| :- | :- |
| bool | **True** akış bir ICO görüntüsü içeriyorsa; aksi takdirde **False** |
...
ICO görüntünüzü dosya içinde belirlenen ***index*** konumundaki belirli bir görüntü girişini kaldırarak ince ayar yapın. Bu yöntem görüntü bileşiminiz üzerinde hassas <br/>            kontrol sağlar, ICO dosyanızı kolayca iyileştirmenize olanak tanır.
...
| :- | :- | :- |
| angle | float | Derece cinsinden döndürme açısı. Pozitif değerler saat yönünde döndürür. |
| resize_proportionally | bool | eğer <c>true</c> olarak ayarlanırsa, görüntü boyutunuz döndürülmüş dikdörtgen (köşe noktaları) projeksiyonlarına göre değişir<br/>                diğer durumda boyutlar dokunulmaz kalır ve yalnızca<br/>                __internal__ görüntü içeriği döndürülür. |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | Arka plan rengi. |
