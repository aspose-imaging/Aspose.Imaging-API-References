---
title: "JpegImage Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.imaging.fileformats.jpeg/jpegimage/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [JpegImage(jpeg_options, width, height)](#JpegImage_jpeg_options_width_height_1) | Sağlanan JPEG seçenekleriyle yeni bir [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) nesnesi başlatın. <br/>            Bu yapıcı, JPEG görüntüsü için sıkıştırma seviyesi, kalite ve ek parametreler gibi çeşitli ayarları özelleştirmenizi sağlar, ortaya çıkan görüntü formatı üzerinde kesin kontrol sunar. |
| [JpegImage(path)](#JpegImage_path_2) | [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfı, belirtilen yol parametresiyle <br/>            yapıcısını çağırarak sorunsuz bir şekilde başlatılır. Bu yapıcı, JPEG görüntülerinin kesintisiz oluşturulmasını sağlar ve projelerinize hızlı entegrasyonu kolaylaştırır. |
| [JpegImage(raster_image)](#JpegImage_raster_image_3) | [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfının yeni bir örneğini raster görüntü <br/>            parametresiyle başlatın. Bu yapıcı, raster görüntülerden doğrudan JPEG görüntüleri oluşturmanın <br/>            pratik bir yolunu sunar, uygulamalarınızda JPEG görüntüleriyle çalışmayı kolaylaştırır. |
| [JpegImage(stream)](#JpegImage_stream_4) | [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfını kullanarak bir akış parametresiyle JPEG görüntü nesnesi başlatın. <br/>            Bu yapıcı, JPEG görüntüleriyle çalışmayı basitleştirir ve projelerinize sorunsuz bir şekilde entegre etmenin <br/>            doğrudan bir yolunu sunar. |
| [JpegImage(width, height)](#JpegImage_width_height_5) | Belirtilen genişlik ve yükseklik parametreleriyle [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfının yeni bir örneğini oluşturun. <br/>            Bu yapıcı, JPEG görüntülerini özel boyutlarla oluşturmanıza olanak tanır ve uygulamanızda görüntü boyutlarını yönetmede esneklik sağlar. |
## **Properties**
...
| bits_per_pixel | int | r | Bu özellik sayesinde görüntünün piksel derinliğini zahmetsizce alın, renk ya da gri tonlamanın zenginliği hakkında <br/>            bilgi sunar. İster canlı bir fotoğraf, ister tek renkli bir illüstrasyon olsun, bu özellik görüntünün görsel karmaşıklığı hakkında kritik <br/>            bilgiler sağlar. |
...
| cmyk_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | CMYK ve YCCK JPEG görüntüleriyle ilişkili CMYK renk profili, kesin renk dönüşümü ve sadakati sağlar. RGBColorProfile ile birlikte çalışarak çeşitli cihaz ve uygulamalarda doğru renk temsilini garanti eder. <br/>            Bu eşleşme, renk işleme tutarlılığını korumak ve optimum görüntü kalitesine ulaşmak için kritiktir. |
| yorum | string | r/w | Bu özellik ile JPEG dosya yorumlarını yönetin; görüntüyle ilişkili açıklayıcı notları ekleyebilir veya alabilirsiniz. Görüntülere meta veri eklemek ya da ek bağlam eklemek isterken, bu özellik JPEG dosyalarınızı düzenleme ve sınıflandırmada esneklik sağlar. |
...
| destination_cmyk_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | CMYK renk profili, kaydetme işlemi sırasında CMYK ve YCCK JPEG görüntülerinin doğru renk dönüşümü için hayati öneme sahiptir. RGBColorProfile ile birlikte çalışarak doğru renk temsilini sağlar, farklı cihaz ve yazılımlarda tutarlılık ve kaliteyi korur. Bu senkronizasyon, kaydedilen son görüntülerde doğru ve güvenilir renk işleme elde etmek için kritiktir. |
| destination_rgb_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | RGBColorProfile, kaydetme sürecinde CMYK ve YCCK JPEG görüntülerinin doğru renk dönüşümü için gereklidir. CMYKColorProfile ile eşleştirildiğinde, renklerin doğru işlenmesini sağlar ve farklı cihaz ve uygulamalarda tutarlılığı korur. Bu kombinasyon, istenen renk temsilini korumak ve yüksek kaliteli görüntü çıktısı elde etmek için kritiktir. |
| dağıtıldı | bool | r | Bu örneğin dağıtılıp dağıtılmadığını gösteren bir değer alır. |
| exif_data | [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) | r/w | Bu özellik ile EXIF verilerini yönetin; görüntüyle ilişkili meta verileri ekleyebilir veya alabilirsiniz. Kamera ayarlarıyla ilgili bilgileri çıkarmak ya da mevcut meta verileri değiştirmek isterken, bu özellik EXIF veri konteynerini yönetmede esneklik sağlar. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Bu özellik sayesinde görüntünün formatını zahmetsizce alın. Dosya formatı hakkında değerli bilgi sunar, çeşitli platform ve uygulamalarda sorunsuz entegrasyon ve uyumluluk kontrollerine yardımcı olur. |
...
| height | int | r | Bu özellik ile görüntünün yüksekliğini zahmetsizce alın. Görüntünün dikey boyutuna hızlı erişim sağlar, karmaşık hesaplamalar veya ek yöntemler gerektirmeden boyut ve en-boy oranını verimli bir şekilde belirlemenize olanak tanır. |
| horizontal_resolution | float | r/w | Bu özellik, yatay çözünürlüğe erişmenizi sağlar<br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), inç başına piksel olarak ölçülür. Bu değeri ayarlayarak veya alarak<br/>            görüntünün çözünürlüğünü hassas bir şekilde kontrol edebilir ve kalite ve netlik için belirli gereksinimlerinizi karşılamasını sağlayabilirsiniz. |
| ignore_embedded_color_profile | bool | r/w | Yerleşik renk profilinin göz ardı edilip edilmediğini belirten bayrağı alır veya değiştirir<br/>            Bu bayrağı ayarlayarak, kullanıcılar varsayılan renk profilinin yerleşik profilin yerine kullanılıp kullanılmayacağını belirtebilir. Bu seçenek, renk yönetimi üzerinde daha fazla kontrol sağlar ve çeşitli platformlar ve uygulamalar arasında tutarlılık ve uyumluluk için ayarlamaları kolaylaştırır. |
...
| jfif | [JFIFData](/imaging/python-net/aspose.imaging.fileformats.jpeg/jfifdata/) | r/w | Bu özellik, JPEG görüntüsüyle ilişkili JFIF (JPEG File Interchange <br/>            Format) verilerine erişmenizi veya bu verileri değiştirmenizi sağlar. JFIF, bilgisayarlar ve diğer cihazlar arasında JPEG sıkıştırmalı görüntülerin değiş tokuşu için standart bir formattır. Bu özelliği alarak veya ayarlayarak, görüntünün çözünürlüğü, en‑boy oranı ve küçük resim gibi bilgileri içerebilecek JFIF verileriyle etkileşimde bulunabilirsiniz. |
| jpeg_options | [JpegOptions](/imaging/python-net/aspose.imaging.imageoptions/jpegoptions/) | r | Bu [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) örneğinin oluşturulması veya yüklenmesi sırasında kullanılan JPEG seçeneklerine kolayca erişin. Bu özellik, kullanılan belirli ayarlar hakkında değerli ayrıntılar sunar ve kullanıcıların görüntü işleme iş akışlarını etkili bir şekilde anlamalarını ve yeniden üretmelerini sağlar. Sıkıştırma seviyeleri, kalite ayarları veya diğer parametreler olsun, bu özellik sorunsuz görüntü manipülasyonu için temel içgörüler sağlar. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Bu özellik, görüntünün ham veri formatını alır; bu format, görüntü verilerinin nasıl yapılandırıldığını ve kodlandığını gösterir. Ham veri formatını anlamak, görüntü verilerini etkili bir şekilde işlemek veya manipüle etmek için esastır. Bu, görüntünün sıkıştırılmış, belirli bir renk uzayında kodlanmış veya belirli bir dosya formatında depolanmış olup olmadığını gösteren temel bilgiler sağlar. Bu özelliğe erişerek, görüntünün veri yapısı hakkında değerli bilgiler elde eder ve belirli formatına uygun çeşitli işlemler veya optimizasyonlar gerçekleştirebilirsiniz. |
...
| rgb_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | CMYK ve YCCK JPEG görüntüleri için RGB renk profili, doğru renk dönüşümü ve temsili sağlar. Renk işleme tutarlılığı ve doğruluğunu korumak için CMYKColorProfile ile eşleştirilmelidir. Bu eşleşme, kesin renk yönetimi ve görüntü çoğaltması gerektiren uygulamalar için gereklidir ve RGB verilerinin doğru şekilde yorumlanıp görüntülenmesini sağlar. |
...
| vertical_resolution | float | r/w | Bu özellik, ilişkili [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) için inç başına piksel cinsinden ifade edilen dikey çözünürlüğü yönetir. Bu çözünürlüğü ayarlamak, görüntünün sabit fiziksel boyutta yazdırıldığında veya görüntülendiğinde boyut ve kalitesini etkiler. Bu özelliği ayarlayarak, görüntünün piksel yoğunluğunu dikey olarak ne kadar sık paketlediğini kontrol eder ve genel keskinlik ve netliği etkilersiniz. |
| width | int | r | Bu özellik, görüntünün genişliğini piksel cinsinden alır. Bu, görüntünün boyutları hakkında temel bilgi sağlar ve görüntü verisinin doğru şekilde render edilmesi, manipüle edilmesi veya görüntülenmesini mümkün kılar. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_28) | Yeni bir [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfının örneğini başlatır. |
| [create_from_images(images)](#create_from_images_images_29) | Belirtilen görüntüleri sayfa olarak kullanarak yeni bir görüntü oluşturur. |
| [create_from_images(images, dispose_images)](#create_from_images_images_dispose_images_30) | Belirtilen görüntüleri sayfa olarak kullanarak yeni bir görüntü oluşturur. |
| [create_from_stream(stream)](#create_from_stream_stream_31) | Yeni bir [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfının örneğini başlatır. |
...
| [crop(rectangle)](#crop_rectangle_33) | Görüntüyü kırpma. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_34) | Mevcut görüntüde dithering uygular. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_35) | Mevcut görüntüde dithering uygular. |
| [embed_digital_signature(password)](#embed_digital_signature_password_36) | Sağlanan şifreye dayalı dijital imzayı steganografi kullanarak görüntüye göm. |
| [filter(rectangle, options)](#filter_rectangle_options_37) | Belirtilen dikdörtgeni filtreler. |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_49) | Kaynak görüntünün en son değişikliğini yaptığı tarih ve saati alır<br/>            Bu yöntem, kullanıcıların görüntü dosyasındaki güncellemeleri etkili bir şekilde izlemelerini ve yönetmelerini sağlayan değerli meta veriler sunar. Bu bilgilere erişerek, kullanıcılar görüntü varlıklarının bütünlüğünü ve güncelliğini sağlayabilir ve görüntü kullanımı ve bakımıyla ilgili bilinçli kararlar alabilir. |
| [get_original_options()](#get_original_options__50) | Bu [Image](/imaging/python-net/aspose.imaging/image/) örneğinin orijinal görüntü seçeneklerini alır. |
...
| [is_digital_signed(password, percentage_threshold)](#is_digital_signed_password_percentage_threshold_56) | Sağlanan şifre ve eşik değeri kullanarak görüntünün dijital olarak imzalı olup olmadığını hızlı bir şekilde kontrol eder. |
| [load(file_path)](#load_file_path_57) | Belirtilen dosya yolu veya URL'den yeni bir görüntü yükler.<br/>            _filePath_ bir dosya yolu ise yöntem sadece dosyayı açar.<br/>            _filePath_ bir URL ise yöntem dosyayı indirir, geçici bir dosya olarak saklar ve açar. |
| [load(file_path, load_options)](#load_file_path_load_options_58) | Belirtilen dosya yolu veya URL'den yeni bir görüntü yükler.<br/>            _filePath_ bir dosya yolu ise yöntem sadece dosyayı açar.<br/>            _filePath_ bir URL ise yöntem dosyayı indirir, geçici bir dosya olarak saklar ve açar. |
| [load(stream)](#load_stream_59) | Belirtilen akıştan yeni bir görüntü yükler. |
| [load(stream, load_options)](#load_stream_load_options_60) | Belirtilen akıştan yeni bir görüntü yükler. |
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_61) | 32-bit ARGB piksellerini yükler. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_62) | 64-bit ARGB piksellerini yükler. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_63) | CMYK formatında pikselleri yükler. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_64) | CMYK formatında pikselleri yükler.<br/>            Bu yöntem kullanımdan kaldırılmıştır. Lütfen daha etkili olan [RasterImage.load_cmyk_32_pixels(rectangle)](/imaging/python-net/aspose.imaging/rasterimage/) yöntemini kullanın. |
...
| [normalize_angle(resize_proportionally, background_color)](#normalize_angle_resize_proportionally_background_color_74) | Açıyı normalleştirir.<br/>            Bu yöntem, taranmış metin belgelerinde eğik taramayı gidermek için uygulanabilir.<br/>            Bu yöntem, [RasterImage.get_skew_angle()](/imaging/python-net/aspose.imaging/rasterimage/) ve [RasterImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rasterimage/) metodlarını kullanır. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_80) | Tüm şeffaf olmayan renkleri yeni renk ile değiştirir ve orijinal alfa değerini koruyarak yumuşak kenarları korur.<br/>            Not: şeffaflık içermeyen görüntülerde kullanırsanız, tüm renkler tek bir renk ile değiştirilecektir. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_81) | Tüm şeffaf olmayan renkleri yeni renk ile değiştirir ve orijinal alfa değerini koruyarak yumuşak kenarları korur.<br/>            Not: şeffaflık içermeyen görüntülerde kullanırsanız, tüm renkler tek bir renk ile değiştirilecektir. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_83) | Görüntüyü yeniden boyutlandırır. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_84) | Görüntüyü yeniden boyutlandırır. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_88) | Yüksekliği orantılı olarak yeniden boyutlandırır. |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_92) | Genişliği orantılı olarak yeniden boyutlandırır. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_96) | Görüntüyü merkezin etrafında döndür. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_97) | Görüntüyü döndürür, çevirir veya döndürüp çevirir. |
| save() | Görüntü verilerini temel akıma kaydeder. |
| [save(file_path)](#save_file_path_98) | Görüntüyü belirtilen dosya konumuna kaydeder. |
| [save(file_path, options)](#save_file_path_options_99) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya konumunda ve belirtilen dosya formatında kaydeder. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_100) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya konumunda ve belirtilen dosya formatında kaydeder. |
| [save(file_path, over_write)](#save_file_path_over_write_101) | Nesnenin verilerini belirtilen dosya konumuna kaydeder. |
| [save(stream)](#save_stream_102) | Nesnenin verisini belirtilen akışa kaydeder. |
| [save(stream, options_base)](#save_stream_options_base_103) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen akışa ve belirtilen dosya formatında kaydeder. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_104) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen akışa ve belirtilen dosya formatında kaydeder. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_105) | 32-bit ARGB piksellerini kaydeder. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_106) | Pikselleri kaydeder. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_107) | Pikselleri kaydeder.<br/>            Bu yöntem artık kullanılmamaktadır. Lütfen daha etkili olan [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/) yöntemini kullanın. |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_108) | Pikselleri kaydeder (format özel yöntemi). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_109) | Ham veriyi kaydeder. |
| [save_to_stream(stream)](#save_to_stream_stream_110) | Nesnenin verisini belirtilen akışa kaydeder. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_111) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen akışa ve belirtilen dosya formatında kaydeder. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_112) | Görüntünün verilerini, kaydetme seçeneklerine göre belirtilen akışa ve belirtilen dosya formatında kaydeder. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_113) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya konumunda ve belirtilen dosya formatında kaydeder. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_114) | Nesnenin verilerini, kaydetme seçeneklerine göre belirtilen dosya konumunda ve belirtilen dosya formatında kaydeder. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_115) | Belirtilen konum için bir görüntünün 32-bit ARGB pikselini ayarlar. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_116) | Görüntü paletini ayarlar. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_117) | Belirtilen konum için bir görüntü pikselini ayarlar. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_118) | Belirtilen [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) için çözünürlüğü belirler, doğru ölçekleme ve baskı yeteneklerini sağlar. Bu yöntem, kullanıcıların görüntü çözünürlüğünü dijital gösterim ya da fiziksel çoğaltma gibi belirli gereksinimlerine göre uyarlamalarına olanak tanır. Çözünürlüğü ayarlayarak, kullanıcılar görüntü kalitesini optimize edebilir ve çeşitli çıkış cihazları ve ortamlarıyla uyumluluğu sağlayabilir, böylece görüntünün genel görsel deneyimini ve kullanılabilirliğini artırır. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_119) | Bu [Image](/imaging/python-net/aspose.imaging/image/) örneği destekliyor ve [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/) örneğini uyguluyorsa, bir _metadata_ örneği ayarlamaya çalışır. |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_120) | Tüm tarama satırını belirtilen tarama satırı indeksine yazar. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_121) | Tüm tarama satırını belirtilen tarama satırı indeksine yazar. |
...
Sağlanan JPEG seçenekleriyle yeni bir [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) nesnesi başlatın. <br/>            Bu yapıcı, JPEG görüntüsü için sıkıştırma seviyesi, kalite ve ek parametreler gibi çeşitli ayarları özelleştirmenizi sağlar, ortaya çıkan görüntü formatı üzerinde kesin kontrol sunar.
...
[JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfı, belirtilen yol parametresiyle <br/>            yapıcısını çağırarak sorunsuz bir şekilde başlatılır. Bu yapıcı, JPEG görüntülerinin kesintisiz oluşturulmasını sağlar ve projelerinize hızlı entegrasyonu kolaylaştırır.
...
[JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfının yeni bir örneğini raster görüntü <br/>            parametresiyle başlatın. Bu yapıcı, raster görüntülerden doğrudan JPEG görüntüleri oluşturmanın <br/>            pratik bir yolunu sunar, uygulamalarınızda JPEG görüntüleriyle çalışmayı kolaylaştırır.
...
[JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfını kullanarak bir akış parametresiyle JPEG görüntü nesnesi başlatın. <br/>            Bu yapıcı, JPEG görüntüleriyle çalışmayı basitleştirir ve projelerinize sorunsuz bir şekilde entegre etmenin <br/>            doğrudan bir yolunu sunar.
...
Yeni bir [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) sınıfının örneğini başlatır.
...
Kaynak görüntünün en son değişikliğini yaptığı tarih ve saati alır<br/>            Bu yöntem, kullanıcıların görüntü dosyasındaki güncellemeleri etkili bir şekilde izlemelerini ve yönetmelerini sağlayan değerli meta veriler sunar. Bu bilgilere erişerek, kullanıcılar görüntü varlıklarının bütünlüğünü ve güncelliğini sağlayabilir ve görüntü kullanımı ve bakımıyla ilgili bilinçli kararlar alabilir.
...
Bu [Image](/imaging/python-net/aspose.imaging/image/) örneğinin orijinal görüntü seçeneklerini alır.

**Returns**

| Tür | Açıklama |
| :- | :- |
| [ImageOptionsBase](/imaging/python-net/aspose.imaging/imageoptionsbase/) | Orijinal görüntü seçeneklerinin bir kopyası. |
...
Belirtilen [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) için çözünürlüğü belirler, doğru ölçekleme ve baskı yeteneklerini sağlar. Bu yöntem, kullanıcıların görüntü çözünürlüğünü dijital gösterim ya da fiziksel çoğaltma gibi belirli gereksinimlerine göre uyarlamalarına olanak tanır. Çözünürlüğü ayarlayarak, kullanıcılar görüntü kalitesini optimize edebilir ve çeşitli çıkış cihazları ve ortamlarıyla uyumluluğu sağlayabilir, böylece görüntünün genel görsel deneyimini ve kullanılabilirliğini artırır.
...
dir_ = "c:\\temp"
# Başka bir raster görüntüden JPEG resmi yükle.
# İlk olarak, JPEG resmi oluşturmak için temel olacak geçici bir PNG resmi oluştur.
# Ayrıca bir dosyadan PNG resmi yükleyebilir veya başka bir raster formatındaki resmi kullanabilirsiniz.
with PngOptions() as create_options:
	with aspycore.as_of(Image.create(create_options, 100, 100), RasterImage) as raster_image:
		...
		# PNG resmine dayanarak bir JPEG resmi oluştur.
		with JpegImage(raster_image) as jpeg_image:
			# Bir JPEG dosyasına kaydet
...
# 100x100 piksel boyutunda bir JPEG resmi oluştur.
