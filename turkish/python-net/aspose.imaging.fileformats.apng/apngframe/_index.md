---
title: "ApngFrame Sınıfı"
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.fileformats.apng/apngframe/
---
...
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Arka plan rengini alır. |
...
| frame_time | int | r/w | Kare süresini alır veya ayarlar. |
| frame_top | int | r | Kare üst ofsetini alır. |
| has_alpha | bool | r | Bu örneğin alfa içerip içermediğini gösteren bir değer al. |
| has_background_color | bool | r/w | Arka plan rengine sahip olup olmadığını gösteren bir değer alır. |
| has_transparent_color | bool | r/w | Görselin şeffaf renge sahip olup olmadığını gösteren bir değer alır. |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Şeffaf rengi alır. |
...
| [create(files)](#create_files_19) | Şu [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/) örneğini oluşturur. |
...
Şu [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/) örneğini oluşturur.
...
| Tür | Açıklama |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | Yeni oluşturulan [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/) |
