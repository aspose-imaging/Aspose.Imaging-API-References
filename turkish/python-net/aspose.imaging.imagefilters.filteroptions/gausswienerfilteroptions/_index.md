...
type: docs
weight: 90
url: /tr/python-net/aspose.imaging.imagefilters.filteroptions/gausswienerfilteroptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [GaussWienerFilterOptions()](#GaussWienerFilterOptions__1) | Yeni bir [GaussWienerFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/gausswienerfilteroptions/) sınıfının bir örneğini başlatır. |
| [GaussWienerFilterOptions(size, sigma)](#GaussWienerFilterOptions_size_sigma_2) | Yeni bir [GaussWienerFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/gausswienerfilteroptions/) sınıfının bir örneğini başlatır. |
## **Properties**
...
Yeni bir [GaussWienerFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/gausswienerfilteroptions/) sınıfının bir örneğini başlatır.
