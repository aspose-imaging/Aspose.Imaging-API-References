...
type: docs
weight: 130
url: /tr/python-net/aspose.imaging.imagefilters.filteroptions/medianfilteroptions/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [MedianFilterOptions(size)](#MedianFilterOptions_size_1) | [MedianFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/medianfilteroptions/) sınıfının yeni bir örneğini başlatır. |
## **Properties**
| **Name** | **Type** | **Access** | **Açıklama** |
| :- | :- | :- | :- |
| size | int | r/w | Boyutu alır veya ayarlar. |
...
[MedianFilterOptions](/imaging/python-net/aspose.imaging.imagefilters.filteroptions/medianfilteroptions/) sınıfının yeni bir örneğini başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| size | int | Filtre dikdörtgeninin boyutu. |
