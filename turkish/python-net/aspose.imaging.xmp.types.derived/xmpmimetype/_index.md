---
title: "XmpMimeType Sınıfı"
type: docs
weight: 60
url: /tr/python-net/aspose.imaging.xmp.types.derived/xmpmimetype/
---
...
**Full Name:** aspose.imaging.xmp.types.derived.XmpMimeType
...
| **Name** | **Açıklama** |
| :- | :- |
| [XmpMimeType(value)](#XmpMimeType_value_1) | Yeni bir [XmpMimeType](/imaging/python-net/aspose.imaging.xmp.types.derived/xmpmimetype/) sınıfı örneği başlatır. |
## **Properties**
...
Yeni bir [XmpMimeType](/imaging/python-net/aspose.imaging.xmp.types.derived/xmpmimetype/) sınıfı örneği başlatır.
