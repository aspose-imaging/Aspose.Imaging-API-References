---
title: "TiffFrame Sınıfı"
type: docs
weight: 170
url: /tr/python-net/aspose.imaging.fileformats.tiff/tiffframe/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [TiffFrame(image)](#TiffFrame_image_1) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [TiffFrame(image, options)](#TiffFrame_image_options_2) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [TiffFrame(options, width, height)](#TiffFrame_options_width_height_3) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [TiffFrame(path)](#TiffFrame_path_4) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [TiffFrame(path, options)](#TiffFrame_path_options_5) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [TiffFrame(stream)](#TiffFrame_stream_6) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [TiffFrame(stream, options)](#TiffFrame_stream_options_7) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
## **Properties**
...
| frame_options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | r | Çerçeve oluşturma seçeneklerini alır. |
...
| [path_resources](#path_resources1) | System.Collections.Generic.List`1[[Aspose.Imaging.FileFormats.Tiff.PathResources.PathResource]] | r/w | Yol kaynaklarını alır veya ayarlar. |
...
| align_resolutions() | Yatay ve dikey çözünürlükleri eşitlemek için yardımcı yöntem. |
...
| [copy_frame(tiff_frame)](#copy_frame_tiff_frame_19) | Tüm çerçeveyi kopyalar (çoğaltır). |
| [create(files)](#create_files_20) | Belirtilen dosyaları içeren çok sayfalı görüntüyü oluşturur. |
| [create(files, throw_exception_on_load_error)](#create_files_throw_exception_on_load_error_21) | Belirtilen dosyaları içeren çok sayfalı görüntüyü oluşturur. |
| [create(image_options, width, height)](#create_image_options_width_height_22) | Belirtilen oluşturma seçeneklerini kullanarak yeni bir görüntü oluşturur. |
...
| [create(images)](#create_images_24) | Belirtilen görüntüleri sayfa olarak kullanarak yeni bir görüntü oluşturur. |
| [create(images, dispose_images)](#create_images_dispose_images_25) | Belirtilen görüntüleri sayfa olarak kullanarak yeni bir görüntü oluşturur. |
| [create(multipage_create_options)](#create_multipage_create_options_26) | Belirtilen çok sayfalı oluşturma seçeneklerini oluşturur. |
| [create_frame_from(tiff_frame, options)](#create_frame_from_tiff_frame_options_27) | Belirtilen _tiffFrame_ kullanılarak belirtilen _options_ ile çerçeveyi oluşturur.<br/>            Piksel verileri korunur ancak istenen formata dönüştürülür. |
| [create_from_file_with_options(path, options)](#create_from_file_with_options_path_options_28) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
...
| [create_from_image(image)](#create_from_image_image_31) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [create_from_image_with_options(image, options)](#create_from_image_with_options_image_options_32) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
...
| [create_from_stream(stream)](#create_from_stream_stream_35) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
| [create_from_stream_with_options(stream, options)](#create_from_stream_with_options_stream_options_36) | Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını. |
...
Yeni bir örnek başlatır [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) sınıfını.
...
| :- | :- | :- |
| image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Çerçeve piksel ve palet verilerini başlatmak için kullanılan görüntü. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Yeni oluşturulan çerçeve için kullanılacak seçenekler. |
...
| Parameter | Tür | Açıklama |
| :- | :- | :- |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Çerçeve seçenekleri. |
| width | int | Genişlik. |
...
Tüm çerçeveyi kopyalar (çoğaltır).

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Kopyalanacak tiff çerçevesi. |

**Returns**

| Tür | Açıklama |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Yeni kopyalanan tiff çerçevesi. |
...
Belirtilen _tiffFrame_ kullanılarak belirtilen _options_ ile çerçeveyi oluşturur.<br/>            Piksel verileri korunur ancak istenen formata dönüştürülür.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| tiff_frame | [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Oluşturulacak tiff çerçevesi. |
| options | [TiffOptions](/imaging/python-net/aspose.imaging.imageoptions/tiffoptions/) | Kullanılacak yeni seçenekler. |

**Returns**

| Tür | Açıklama |
| :- | :- |
| [TiffFrame](/imaging/python-net/aspose.imaging.fileformats.tiff/tiffframe/) | Yeni oluşturulan çerçeve. |
