---
title: "DngImage Sınıf"
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.fileformats.dng/dngimage/
---
...
| bits_per_pixel | int | r | Bu <br/>            özelliği kullanarak görüntüdeki piksel başına bit sayısını zahmetsizce keşfedin. Görüntünün piksel derinliğini hızlı ve doğru bir şekilde anlamak için idealdir. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Bu özellik ile görüntünüzün dosya biçimini belirleyin. Biçimi anlamak için <br/>            mükemmeldir - sadece basit detaylar. |
...
| height | int | r | Bu özellik ile görüntünün yüksekliğini alın. Görüntünün dikey boyutunu zahmetsizce belirlemek için <br/>            mükemmeldir. |
...
| img_data | [RawData](/imaging/python-net/aspose.imaging.fileformats.dng.decoder/rawdata/) | r/w | Bu özellik ile görüntü verilerini yönetin. İster alıyor olun ister güncelliyor olun, <br/>            bu özellik verimli <br/>            manipülasyon için görüntü verilerine sorunsuz erişim sağlar. |
...
| width | int | r | Bu özellik ile görüntünün genişliğine erişin. Görüntünün yatay boyutunu hızlı ve verimli bir şekilde elde etmek için idealdir. |
...
| [save(stream)](#save_stream_100) | Verileri kaydeder. |
