---
title: "RectangleMask Sınıfı"
type: docs
weight: 80
url: /tr/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [RectangleMask(selected_area)](#RectangleMask_selected_area_1) | Belirtilen dikdörtgen ile yeni bir [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) sınıfı örneği başlatır. |
| [RectangleMask(x, y, width, height)](#RectangleMask_x_y_width_height_2) | Belirtilen sol-üst nokta, genişlik ve yükseklik ile yeni bir [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) sınıfı örneği başlatır. |
## **Properties**
...
Belirtilen dikdörtgen ile yeni bir [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) sınıfı örneği başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| selected_area | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Dikdörtgen olarak belirtilen seçili alan. |
...
Belirtilen sol-üst nokta, genişlik ve yükseklik ile yeni bir [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) sınıfı örneği başlatır.
...
| width | int | Seçili alanın genişliği. |
| height | int | Seçili alanın yüksekliği. |
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Kırpılmış bir RectangleMask, ImageMask olarak. |
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Şişirilmiş bir RectangleMask, ImageMask olarak. |
