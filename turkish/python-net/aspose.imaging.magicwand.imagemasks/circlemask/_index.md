...
type: docs
weight: 10
url: /tr/python-net/aspose.imaging.magicwand.imagemasks/circlemask/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [CircleMask(center, radius)](#CircleMask_center_radius_1) | Belirtilen merkez noktası ve yarıçap ile [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) sınıfının yeni bir örneğini başlatır. |
| [CircleMask(x, y, radius)](#CircleMask_x_y_radius_2) | Belirtilen merkez noktası ve yarıçap ile [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) sınıfının yeni bir örneğini başlatır. |
## **Properties**
...
| selection_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Bu maskenin piksel cinsinden sınırlarını alır. |
...
Belirtilen merkez noktası ve yarıçap ile [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) sınıfının yeni bir örneğini başlatır.

**Parameters:**

| Parameter | Tür | Açıklama |
| :- | :- | :- |
| center | [Point](/imaging/python-net/aspose.imaging/point/) | Seçilen alanın merkez noktası. |
| yarıçap | int | Seçilen alanın yarıçapı. |
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | ImageMask olarak kırpılmış bir CircleMask veya ImageBitMask.<br/>            ImageBitMask döndürülebileceği için, akıcı çağrı önerilir. |
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Şişirilmiş bir CircleMask, ImageMask olarak. |
