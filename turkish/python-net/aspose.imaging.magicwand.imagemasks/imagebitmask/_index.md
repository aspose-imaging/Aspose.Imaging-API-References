---
title: "ImageBitMask Sınıfı"
type: docs
weight: 50
url: /tr/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [ImageBitMask(image)](#ImageBitMask_image_1) | Belirtilen mevcut [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) boyutunda yeni bir [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) sınıfı örneği başlatır.<br/>            Belirtilen [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) kaynak görüntü olarak saklanacaktır. |
| [ImageBitMask(width, height)](#ImageBitMask_width_height_2) | Belirtilen genişlik ve yükseklik ile yeni bir [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) sınıfı örneği başlatır. |
## **Properties**
...
| [get(x, y)](#get_x_y_9) | Belirtilen pikselin depolama dizisindeki konumunu alır. |
...
| [set_mask_pixel(x, y, value)](#set_mask_pixel_x_y_value_19) | Belirtilen piksele opaklık ayarlar. |
| [subtract(image, settings)](#subtract_image_settings_20) | Sağlanan görüntüye uygulanan sihirli değnek seçiminin sonucunu mevcut maskeden çıkarır. |
| [subtract(mask)](#subtract_mask_21) | Sağlanan maskeyi mevcut maskeden çıkarır. |
| [subtract(settings)](#subtract_settings_22) | Mevcut maskenin kaynağına uygulanan sihirli değnek seçiminin sonucunu maskeden çıkarır. |
| [union(image, settings)](#union_image_settings_23) | Sağlanan görüntüye uygulanan sihirli değnek seçiminin sonucu ile mevcut maskenin birleşimini alır. |
| [union(mask)](#union_mask_24) | Mevcut maskenin sağlanan ile birleşimini alır. |
| [union(settings)](#union_settings_25) | Maskenin kaynağına uygulanan sihirli değnek seçiminin sonucu ile mevcut maskenin birleşimini alır. |
...
Belirtilen mevcut [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) boyutunda yeni bir [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) sınıfı örneği başlatır.<br/>            Belirtilen [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) kaynak görüntü olarak saklanacaktır.
...
Belirtilen genişlik ve yükseklik ile yeni bir [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) sınıfı örneği başlatır.
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Kırpılmış [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) olarak [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
Belirtilen pikselin depolama dizisindeki konumunu alır.
...
| Tür | Açıklama |
| :- | :- |
| bool | Depolamadaki konumu temsil eden int değeri. |
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Şişirilmiş [ImageBitMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagebitmask/) olarak [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/). |
...
Belirtilen piksele opaklık ayarlar.
...
| x | int | Pikselin x koordinatı. |
| y | int | Pikselin y koordinatı. |
| değer | bool | Belirtilen piksel opak ise true; aksi takdirde false. |
