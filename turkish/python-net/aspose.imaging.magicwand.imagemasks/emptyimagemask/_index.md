---
title: "EmptyImageMask Sınıfı"
type: docs
weight: 20
url: /tr/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/
---
...
| **Name** | **Açıklama** |
| :- | :- |
| [EmptyImageMask(width, height)](#EmptyImageMask_width_height_1) | Belirtilen genişlik ve yükseklik ile yeni bir [EmptyImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/) sınıfı örneği başlatır. |
## **Properties**
...
Belirtilen genişlik ve yükseklik ile yeni bir [EmptyImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/) sınıfı örneği başlatır.
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Kırpılmış EmptyImageMask, ImageMask olarak. |
...
| Tür | Açıklama |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Şişirilmiş EmptyImageMask, ImageMask olarak. |
