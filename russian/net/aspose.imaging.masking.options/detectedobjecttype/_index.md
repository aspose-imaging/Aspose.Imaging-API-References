...
description: Перечисление типов обнаруженных объектов.
type: docs
weight: 10480
url: /ru/net/aspose.imaging.masking.options/detectedobjecttype/
---
## DetectedObjectType enumeration

Перечисление типов обнаруженных объектов.
...
| --- | --- | --- |
| Human | `0` | Тип объекта "человек". |
| Other | `1` | Другой тип объекта. |
