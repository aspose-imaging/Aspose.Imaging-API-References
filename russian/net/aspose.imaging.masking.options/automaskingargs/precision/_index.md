...
description: Получает или задает точность метода сегментации необязательно.
type: docs
weight: 70
url: /ru/net/aspose.imaging.masking.options/automaskingargs/precision/
---
## AutoMaskingArgs.Precision property

Получает или задает точность метода сегментации (необязательно).
...
Точность метода сегментации (необязательно).
