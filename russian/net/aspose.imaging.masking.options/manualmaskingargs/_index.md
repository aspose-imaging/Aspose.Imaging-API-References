...
type: docs
weight: 10510
url: /ru/net/aspose.imaging.masking.options/manualmaskingargs/
---
...
| Имя | Описание |
| --- | --- |
| [ManualMaskingArgs](manualmaskingargs)() | Конструктор по умолчанию. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Mask](../../aspose.imaging.masking.options/manualmaskingargs/mask) { get; set; } | Получает или задает набор графических фигур, образующих маску. |
