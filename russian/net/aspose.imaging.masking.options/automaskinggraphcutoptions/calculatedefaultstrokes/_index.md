...
description: Получает или задает значение указывающее следует ли рассчитывать ходы по умолчанию.
type: docs
weight: 30
...
Получает или задает значение, указывающее, следует ли рассчитывать ходы по умолчанию.
