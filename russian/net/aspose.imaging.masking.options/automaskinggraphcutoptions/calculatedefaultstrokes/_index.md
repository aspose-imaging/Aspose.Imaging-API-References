...
description: Получает или задает значение указывающее следует ли рассчитывать штрихи по умолчанию.
type: docs
weight: 30
url: /ru/net/aspose.imaging.masking.options/automaskinggraphcutoptions/calculatedefaultstrokes/
---
## AutoMaskingGraphCutOptions.CalculateDefaultStrokes property

Получает или задает значение, указывающее, следует ли рассчитывать штрихи по умолчанию.
