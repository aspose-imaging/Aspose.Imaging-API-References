...
description: Получает предварительно рассчитанные по умолчанию штрихи переднего плана.
type: docs
weight: 50
url: /ru/net/aspose.imaging.masking.options/automaskinggraphcutoptions/defaultforegroundstrokes/
---
## AutoMaskingGraphCutOptions.DefaultForegroundStrokes property

Получает предварительно рассчитанные по умолчанию штрихи переднего плана.
