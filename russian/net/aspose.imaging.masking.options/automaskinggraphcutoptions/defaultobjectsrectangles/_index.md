...
description: Получает прямоугольники объектов по умолчанию.
type: docs
weight: 60
url: /ru/net/aspose.imaging.masking.options/automaskinggraphcutoptions/defaultobjectsrectangles/
---
## AutoMaskingGraphCutOptions.DefaultObjectsRectangles property

Получает прямоугольники объектов по умолчанию.
