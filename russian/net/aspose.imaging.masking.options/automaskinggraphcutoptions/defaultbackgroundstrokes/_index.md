...
description: Получает фоновые штрихи по умолчанию.
type: docs
weight: 40
url: /ru/net/aspose.imaging.masking.options/automaskinggraphcutoptions/defaultbackgroundstrokes/
---
## AutoMaskingGraphCutOptions.DefaultBackgroundStrokes property

Получает фоновые штрихи по умолчанию.
