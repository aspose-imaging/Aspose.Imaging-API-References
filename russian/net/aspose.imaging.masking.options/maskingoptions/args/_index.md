...
description: Получает или задает аргументы для алгоритма сегментации.
type: docs
weight: 20
url: /ru/net/aspose.imaging.masking.options/maskingoptions/args/
---
## MaskingOptions.Args property

Получает или задает аргументы для алгоритма сегментации.
...
Аргументы для алгоритма сегментации.
