...
description: Получает или задает параметры экспорта изображения.
type: docs
weight: 50
url: /ru/net/aspose.imaging.masking.options/maskingoptions/exportoptions/
---
## MaskingOptions.ExportOptions property

Получает или задает параметры экспорта изображения.
...
Параметры экспорта изображений, которые будут использоваться для создания результирующих изображений.
