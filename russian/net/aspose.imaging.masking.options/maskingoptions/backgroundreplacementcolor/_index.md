...
description: Получает или задает цвет замены фона.
type: docs
weight: 30
url: /ru/net/aspose.imaging.masking.options/maskingoptions/backgroundreplacementcolor/
---
## MaskingOptions.BackgroundReplacementColor property

Получает или задает цвет замены фона.
...
Цвет замены фона. Этот цвет будет использоваться в качестве цвета фона в результирующих изображениях.
