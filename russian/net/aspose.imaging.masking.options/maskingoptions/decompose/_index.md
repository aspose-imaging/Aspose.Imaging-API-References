...
description: Получает или задает значение указывающее нужно ли отделять каждую форму от маски как отдельный объект или как объединенный объект от маски отделенной от фона.
type: docs
weight: 40
url: /ru/net/aspose.imaging.masking.options/maskingoptions/decompose/
---
## MaskingOptions.Decompose property

Получает или задает значение, указывающее, нужно ли отделять каждую форму от маски как отдельный объект или как объединенный объект от маски, отделенной от фона.
...
` true` если разложить; в противном случае` false` .
