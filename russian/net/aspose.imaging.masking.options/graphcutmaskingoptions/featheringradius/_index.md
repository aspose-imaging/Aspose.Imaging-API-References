...
description: Получает или задает радиус размытия.
type: docs
weight: 20
...
Сохранение результата маскирования изображения Graph Cut с растушевкой, установленной на 3. Маскирование изображения выполняется с использованием указанного массива точек.
