...
type: docs
weight: 10490
url: /ru/net/aspose.imaging.masking.options/graphcutmaskingoptions/
---
...
| Имя | Описание |
| --- | --- |
| [GraphCutMaskingOptions](graphcutmaskingoptions)() | Конструктор по умолчанию. |
...
Сохранение графика Результат маскирования изображения вырезается с растушевкой, установленной на 3. Маскирование изображения выполняется с использованием указанного массива точек.
