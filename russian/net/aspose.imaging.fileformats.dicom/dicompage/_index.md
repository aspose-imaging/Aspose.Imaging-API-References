...
| Имя | Описание |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | Инициализирует новый экземпляр класса[`DicomPage`](../dicompage). |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | Инициализирует новый экземпляр класса[`DicomPage`](../dicompage). |
