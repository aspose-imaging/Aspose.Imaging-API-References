...
description: Класс для работы с файлами DICOM типа multiframe
type: docs
weight: 2430
url: /ru/net/aspose.imaging.fileformats.dicom/dicompage/
---
## DicomPage class

Класс для работы с файлами DICOM типа multiframe
...
| Имя | Описание |
| --- | --- |
| [DicomPage](dicompage#constructor)(DicomImage, int) | Инициализирует новый экземпляр[`DicomPage`](../dicompage) класс. |
| [DicomPage](dicompage#constructor_1)(DicomImage, int, LoadOptions) | Инициализирует новый экземпляр[`DicomPage`](../dicompage) класс. |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.dicom/dicompage/bitsperpixel) { get; } | Получает количество бит изображения на пиксель. |
...
| override [FileFormat](../../aspose.imaging.fileformats.dicom/dicompage/fileformat) { get; } | Получает значение формата файла |
...
| override [Height](../../aspose.imaging.fileformats.dicom/dicompage/height) { get; } | Получает высоту изображения. |
...
| [Index](../../aspose.imaging.fileformats.dicom/dicompage/index) { get; } | Получает индекс текущей страницы. |
...
| override [Width](../../aspose.imaging.fileformats.dicom/dicompage/width) { get; } | Получает ширину изображения. |
