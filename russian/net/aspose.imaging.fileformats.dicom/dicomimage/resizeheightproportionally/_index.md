...
type: docs
weight: 270
url: /ru/net/aspose.imaging.fileformats.dicom/dicomimage/resizeheightproportionally/
---
...
В этом примере загружается изображение DICOM и пропорционально изменяется его размер с использованием различных методов изменения размера. Задается только высота, ширина рассчитывается автоматически.
