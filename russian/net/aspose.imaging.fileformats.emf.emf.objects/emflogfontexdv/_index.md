...
description: Объект LogFontExDv определяет вектор дизайна для расширенного логического шрифта.
type: docs
weight: 3050
...
Объект LogFontExDv определяет вектор дизайна для расширенного логического шрифта.
...
| Имя | Описание |
| --- | --- |
| [EmfLogFontExDv](emflogfontexdv)(EmfLogFontEx) | Инициализирует новый экземпляр класса[`EmfLogFontExDv`](../emflogfontexdv). |
