...
description: Выполняет первую операцию грубой декомпозиции
type: docs
weight: 10
url: /ru/net/aspose.imaging.masking/imaskingsession/decompose/
---
## IMaskingSession.Decompose method

Выполняет первую операцию грубой декомпозиции
...
Результат операции маскирования в виде массива поставщики изображений сегментов.
