...
description: Инициализирует новый экземпляр классаImageMaskingaspose.imaging.masking/imagemasking.
type: docs
weight: 10
...
Инициализирует новый экземпляр класса[`ImageMasking`](../../imagemasking).
...
| исключение | условие |
| --- | --- |
| ArgumentNullException | Исходное изображение равно null. |

### Примеры

В этом примере показано, как разбить растровое изображение на несколько изображений, используя маскирование изображения и алгоритм сегментации K-средних. Маскирование изображения — это метод обработки изображения, который используется для отделения фона от объектов изображения переднего плана.
