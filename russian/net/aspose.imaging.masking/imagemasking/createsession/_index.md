...
type: docs
weight: 20
url: /ru/net/aspose.imaging.masking/imagemasking/createsession/
---
...
| --- | --- | --- |
| options | MaskingOptions | Опции. |

### Возвращаемое значение

сеанс маскирования, который может выполнять операции повторного обучения декомпозиции.
