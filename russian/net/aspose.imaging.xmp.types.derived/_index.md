...
description: Пространство имен содержит классы которые представляют значения производного типа свойств XMP.
type: docs
weight: 1080
url: /ru/net/aspose.imaging.xmp.types.derived/
---
Пространство имен содержит классы, которые представляют значения производного типа свойств XMP.
