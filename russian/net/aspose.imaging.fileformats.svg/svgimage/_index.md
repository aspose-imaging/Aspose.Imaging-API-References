...
description: Представляет класс изображений SVG.
type: docs
weight: 7550
...
Представляет класс изображений SVG.
...
| Имя | Описание |
| --- | --- |
| [SvgImage](svgimage#constructor_2)(Stream) | Инициализирует новый экземпляр класса[`SvgImage`](../svgimage). |
| [SvgImage](svgimage#constructor_3)(string) | Инициализирует новый экземпляр класса[`SvgImage`](../svgimage). |
| [SvgImage](svgimage#constructor_1)(int, int) | Инициализирует новый экземпляр класса[`SvgImage`](../svgimage). |
| [SvgImage](svgimage#constructor)(SvgOptions, int, int) | Инициализирует новый экземпляр класса[`SvgImage`](../svgimage). |
...
| override [SetPalette](../../aspose.imaging.fileformats.svg/svgimage/setpalette)(IColorPalette, bool) | Устанавливает палитру изображения. |

### Примеры

В следующем примере показано, как преобразовать изображения svgz в svg fromat
...
В следующем примере показано, как преобразовать сжатые изображения (*.emz,*.wmz, *.svgz) в растровые из at
