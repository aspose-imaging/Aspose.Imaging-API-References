...
description: Опции wmf.
type: docs
weight: 10300
url: /ru/net/aspose.imaging.imageoptions/wmfoptions/
---
## WmfOptions class
...
В следующем примере показано, как преобразовать изображения wmz в wmf fromat
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    exportOptions.MultiPageOptions = null;
     ...
     // Экспортировать только первые две страницы. На самом деле будет преобразована только одна страница, потому что WMF не является многостраничным форматом.
...
В следующем примере показано, как преобразовать изображения wmf в формат wmz fromat
...
В следующем примере показано, как преобразовать многостраничное векторное изображение в формат WMF в общем виде без ссылки к определенному типу изображения.
