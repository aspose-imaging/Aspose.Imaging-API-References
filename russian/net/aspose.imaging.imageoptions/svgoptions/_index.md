...
| [Compress](../../aspose.imaging.imageoptions/svgoptions/compress) { get; set; } | Получает или задает значение, указывающее, сжат ли этот файлICompressedOptions. |
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    exportOptions.MultiPageOptions = null;
     ...
     // Экспортировать только первые две страницы. На самом деле будет преобразована только одна страница, потому что SVG не является многостраничным форматом.
...
В следующем примере показано как преобразовать многостраничное векторное изображение в формат SVG в общем виде без привязки к конкретному типу изображения.
