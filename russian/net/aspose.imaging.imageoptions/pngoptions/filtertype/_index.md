...
description: Получает или задает тип фильтра используемый во время процесса сохранения png-файла.
type: docs
weight: 50
...
Получает или задает тип фильтра, используемый во время процесса сохранения png-файла.
