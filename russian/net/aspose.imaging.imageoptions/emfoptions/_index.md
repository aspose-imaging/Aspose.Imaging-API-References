...
description: Параметры ЭДС.
type: docs
weight: 9970
url: /ru/net/aspose.imaging.imageoptions/emfoptions/
---
## EmfOptions class
...
| Имя | Описание |
| --- | --- |
| [EmfOptions](emfoptions)() | Конструктор по умолчанию. |
...
using (Aspose.Imaging.Image image = Aspose.Imaging.Image.Load(inputFilePath))
{
    exportOptions.MultiPageOptions = null;
     ...
     // Экспортировать только первые две страницы. На самом деле конвертируется только одна страница, потому что EMF не является многостраничным форматом.
...
В следующем примере показано, как преобразовать изображения emf в формат emz fromat
...
В следующем примере показано, как преобразовать многостраничное векторное изображение в формат EMF в общем виде без ссылки к определенному типу изображения.
