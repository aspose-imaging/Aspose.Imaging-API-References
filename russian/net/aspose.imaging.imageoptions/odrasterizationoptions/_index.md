...
description: Параметры растеризации Od
type: docs
weight: 10070
url: /ru/net/aspose.imaging.imageoptions/odrasterizationoptions/
---
## OdRasterizationOptions class

Параметры растеризации Od
...
| Имя | Описание |
| --- | --- |
| [OdRasterizationOptions](odrasterizationoptions)() | Конструктор по умолчанию. |
