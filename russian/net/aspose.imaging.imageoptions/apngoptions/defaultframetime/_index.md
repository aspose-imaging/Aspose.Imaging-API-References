...
description: Получает или задает длительность кадра по умолчанию.
type: docs
weight: 20
url: /ru/net/aspose.imaging.imageoptions/apngoptions/defaultframetime/
---
## ApngOptions.DefaultFrameTime property

Получает или задает длительность кадра по умолчанию.
