...
description: Параметры растеризации Otg
type: docs
weight: 10100
url: /ru/net/aspose.imaging.imageoptions/otgrasterizationoptions/
---
## OtgRasterizationOptions class

Параметры растеризации Otg
...
| Имя | Описание |
| --- | --- |
| [OtgRasterizationOptions](otgrasterizationoptions)() | Конструктор по умолчанию. |
