...
description: Параметры растеризации Emf.
type: docs
weight: 9980
url: /ru/net/aspose.imaging.imageoptions/emfrasterizationoptions/
---
## EmfRasterizationOptions class

Параметры растеризации Emf.
...
| Имя | Описание |
| --- | --- |
| [EmfRasterizationOptions](emfrasterizationoptions)() | Конструктор по умолчанию. |
...
| [RenderMode](../../aspose.imaging.imageoptions/emfrasterizationoptions/rendermode) { get; set; } | Получает или задает режим рендеринга. |
