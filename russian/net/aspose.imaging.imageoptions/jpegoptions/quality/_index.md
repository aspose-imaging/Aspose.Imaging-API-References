...
description: Получает или задает качество изображения.
type: docs
weight: 140
url: /ru/net/aspose.imaging.imageoptions/jpegoptions/quality/
---
## JpegOptions.Quality property

Получает или задает качество изображения.
