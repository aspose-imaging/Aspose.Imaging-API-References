...
description: Параметры загрузки открытого документа
type: docs
weight: 9870
url: /ru/net/aspose.imaging.imageloadoptions/odloadoptions/
---
## OdLoadOptions class

Параметры загрузки открытого документа
...
| Имя | Описание |
| --- | --- |
| [OdLoadOptions](odloadoptions)() | Конструктор по умолчанию. |
...
| [Password](../../aspose.imaging.imageloadoptions/odloadoptions/password) { get; set; } | Получает или устанавливает пароль. |
