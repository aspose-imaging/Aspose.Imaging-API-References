...
В следующем примере выполняется бинаризация растрового изображения с предопределенным порогом. Бинаризованные изображения содержат только 2 цвета — черный и белый.
