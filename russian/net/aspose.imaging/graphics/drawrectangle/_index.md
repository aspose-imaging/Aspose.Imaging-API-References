...
description: Рисует прямоугольник заданный структуройRectangleFaspose.imaging/rectanglef.
type: docs
weight: 300
...
| --- | --- | --- |
| pen | Pen | A[`Pen`](../../pen)который определяет цвет, ширину и стиль прямоугольника. |
| rect | Rectangle | A[`Rectangle`](../../rectangle)структура, которая представляет прямоугольник для рисования. |
