...
type: docs
weight: 170
url: /ru/net/aspose.imaging/graphics/drawbezier/
---
...
Рисует сплайн Безье, определяемый четырьмя структурами[`Point`](../../point).
...
| pt3 | Point | [`Point`](../../point)структура, представляющая вторую контрольную точку для кривой. |
