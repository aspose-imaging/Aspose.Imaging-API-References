...
description: Рисует линию соединяющую две структурыPointaspose.imaging/point.
type: docs
weight: 250
url: /ru/net/aspose.imaging/graphics/drawline/
---
...
| point2 | Point | [`Point`](../../point)структура, представляющая вторую точку для подключения. |
...
| point2 | PointF | [`PointF`](../../pointf)структура, представляющая вторую точку для подключения. |
