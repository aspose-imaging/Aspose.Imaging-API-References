...
type: docs
weight: 450
url: /ru/net/aspose.imaging/graphics/rotatetransform/
---
...
| --- | --- | --- |
| angle | Single | Угол поворота. |
| order | MatrixOrder | A[`MatrixOrder`](../../matrixorder)который указывает, следует ли добавлять или добавлять перед матрицей поворота. |
