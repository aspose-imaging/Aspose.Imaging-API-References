...
description: Получает разрешение по вертикали в пикселях на дюйм этогоImageaspose.imaging/image .
type: docs
weight: 120
url: /ru/net/aspose.imaging.fileformats.tiff/tiffimage/verticalresolution/
---
## TiffImage.VerticalResolution property

Получает разрешение по вертикали в пикселях на дюйм этого[`Image`](../../../aspose.imaging/image) .
