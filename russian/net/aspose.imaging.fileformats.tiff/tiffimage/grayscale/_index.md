...
Следующий пример преобразует цветное изображение TIFF в его представление в градациях серого. Изображения в градациях серого состоят исключительно из оттенков серого и несут только информацию об интенсивности.
