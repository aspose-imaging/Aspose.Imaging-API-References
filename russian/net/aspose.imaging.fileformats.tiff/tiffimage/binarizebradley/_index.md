...
В следующем примере Изображение в формате TIFF с адаптивным алгоритмом пороговой обработки Брэдли с заданным размером окна. Бинаризованные изображения содержат только 2 цвета — черный и белый.
