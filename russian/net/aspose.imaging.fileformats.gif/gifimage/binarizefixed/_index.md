...
type: docs
weight: 270
url: /ru/net/aspose.imaging.fileformats.gif/gifimage/binarizefixed/
---
...
В следующем примере выполняется бинаризация изображения GIF с предопределенным пороговым значением. Бинаризованные изображения содержат только 2 цвета — черный и белый.
