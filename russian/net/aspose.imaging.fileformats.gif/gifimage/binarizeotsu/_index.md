...
В следующем примере выполняется бинаризация изображения GIF с пороговым значением Otsu. Бинаризованные изображения содержат только 2 цвета — черный и белый.
