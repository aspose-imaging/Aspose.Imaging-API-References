...
description: Цветовой профиль CMYK для изображений CMYK и YCCK jpeg. Должен быть в паре с RGBColorProfile для правильного преобразования цвета.
type: docs
weight: 30
url: /ru/net/aspose.imaging.fileformats.jpeg/jpegimage/cmykcolorprofile/
---
## JpegImage.CmykColorProfile property

Цветовой профиль CMYK для изображений CMYK и YCCK jpeg. Должен быть в паре с RGBColorProfile для правильного преобразования цвета.
