...
type: docs
weight: 70
url: /ru/net/aspose.imaging.fileformats.jpeg/jpegimage/exifdata/
---
...
В следующем примере показано, как извлечение тегов EXIF из изображения JPEG.
...
using (Aspose.Imaging.FileFormats.Jpeg.JpegImage image = (Aspose.Imaging.FileFormats.Jpeg.JpegImage)Image.Load(dir + "original.jpg"))
{
 ...
 //Яркость: 
 //Контрастность: Normal
 //Гамма:
 //Резкость: 0
 //Апертура: 4,64(4643856/1000000)
 //Режим экспозиции: Manual
 //Смещение экспозиции: 0,67(4/6)
 //Время экспозиции: 0,01(1/160)
 //Фокусное расстояние: 145,00(1450/10)
 //Единица разрешения фокальной плоскости: Cm
 //Модель объектива: 70.0 - 200.0 мм f/ 4.0
 //Выдержка: 7,32(7321928/1000000)
 //JPEG EXIF data
 //------------------------------------------------------------------------
