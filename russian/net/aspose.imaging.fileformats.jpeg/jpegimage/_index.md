...
| Имя | Описание |
| --- | --- |
| [JpegImage](jpegimage#constructor_1)(RasterImage) | Инициализирует новый экземпляр класса[`JpegImage`](../jpegimage). |
| [JpegImage](jpegimage#constructor_3)(Stream) | Инициализирует новый экземпляр класса[`JpegImage`](../jpegimage). |
| [JpegImage](jpegimage#constructor_4)(string) | Инициализирует новый экземпляр класса[`JpegImage`](../jpegimage). |
| [JpegImage](jpegimage#constructor_2)(int, int) | Инициализирует новый экземпляр класса[`JpegImage`](../jpegimage). |
| [JpegImage](jpegimage#constructor)(JpegOptions, int, int) | Инициализирует новый экземпляр класса[`JpegImage`](../jpegimage). |
...
| [JpegOptions](../../aspose.imaging.fileformats.jpeg/jpegimage/jpegoptions) { get; } | Получает параметры JPEG, используемые для создания или загрузки этого экземпляра[`JpegImage`](../jpegimage). |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg/jpegimage/verticalresolution) { get; set; } | Получает или задает вертикальное разрешение в пикселях на дюйм для этого[`RasterImage`](../../aspose.imaging/rasterimage). |
