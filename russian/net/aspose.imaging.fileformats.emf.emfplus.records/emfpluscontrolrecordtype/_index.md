...
description: Типы контрольных записей определяют глобальные параметры для обработки метафайлов EMF.
type: docs
weight: 5890
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfpluscontrolrecordtype/
---
## EmfPlusControlRecordType class

Типы контрольных записей определяют глобальные параметры для обработки метафайлов EMF+.
