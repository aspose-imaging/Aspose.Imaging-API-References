...
Каждый контейнер графического состояния ДОЛЖЕН быть добавлен в массив сохраненных графических контейнеров. Контейнер состояния графики не записывается в метафайл EMF+, поэтому его формат может определяться реализацией .
