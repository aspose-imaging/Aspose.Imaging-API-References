...
description: Типы записей преобразования определяют свойства и преобразования в координатных пространствах.
type: docs
weight: 6450
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfplustransformrecordtype/
---
## EmfPlusTransformRecordType class

Типы записей преобразования определяют свойства и преобразования в координатных пространствах.
