...
description: Запись EmfPlusGetDC указывает что последующие записи EMF обнаруженные в метафайле ДОЛЖНЫ быть обработаны.
type: docs
weight: 6130
...
Запись EmfPlusGetDC указывает, что последующие записи EMF, обнаруженные в метафайле, ДОЛЖНЫ быть обработаны.
...
| Имя | Описание |
| --- | --- |
| [EmfPlusGetDc](emfplusgetdc)(EmfPlusRecord) | Инициализирует новый экземпляр[`EmfPlusGetDc`](../emfplusgetdc) класс. |
