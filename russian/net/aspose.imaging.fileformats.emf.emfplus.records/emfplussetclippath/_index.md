...
| Имя | Описание |
| --- | --- |
| [EmfPlusSetClipPath](emfplussetclippath)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusSetClipPath`](../emfplussetclippath). |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Cm](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetclippath/cm) { get; set; } | Получает или устанавливает CM (4 бита):задает логическую операцию для объединения двух регионов. См. перечисление CombineMode (раздел 2.1.1.4) для значений значений. |
