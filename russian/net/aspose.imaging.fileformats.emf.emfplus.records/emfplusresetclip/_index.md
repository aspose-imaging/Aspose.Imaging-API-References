...
type: docs
weight: 6210
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusresetclip/
---
...
| Имя | Описание |
| --- | --- |
| [EmfPlusResetClip](emfplusresetclip)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusResetClip`](../emfplusresetclip). |
