...
| Имя | Описание |
| --- | --- |
| [EmfPlusRestore](emfplusrestore)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusRestore`](../emfplusrestore). |
...
| [StackIndex](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusrestore/stackindex) { get; set; } | Получает или задает 32-разрядное целое число без знака, указывающее уровень, связанный с состоянием графики . Значение уровня было присвоено графическому состоянию предыдущей записью EmfPlusSave (раздел 2.3.7.5). |
