...
| Имя | Описание |
| --- | --- |
| [EmfPlusSetInterpolationMode](emfplussetinterpolationmode)(EmfPlusRecord) | Инициализирует новый экземпляр[`EmfPlusSetInterpolationMode`](../emfplussetinterpolationmode) класс. |
