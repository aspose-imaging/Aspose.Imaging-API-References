...
type: docs
weight: 6200
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusrecord/
---
## EmfPlusRecord class
...
| Имя | Описание |
| --- | --- |
| [EmfPlusRecord](emfplusrecord#constructor)() | Инициализирует новый экземпляр класса[`EmfPlusRecord`](../emfplusrecord). |
| [EmfPlusRecord](emfplusrecord#constructor_1)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusRecord`](../emfplusrecord). |
