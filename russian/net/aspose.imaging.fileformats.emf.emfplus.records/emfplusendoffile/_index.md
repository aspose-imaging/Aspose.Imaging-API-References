...
type: docs
weight: 6050
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusendoffile/
---
...
| Имя | Описание |
| --- | --- |
| [EmfPlusEndOfFile](emfplusendoffile)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusEndOfFile`](../emfplusendoffile). |
