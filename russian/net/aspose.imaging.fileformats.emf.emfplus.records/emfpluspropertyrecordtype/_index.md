...
description: Типы записей свойств определяют свойства контекста устройства воспроизведения.
type: docs
weight: 6190
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfpluspropertyrecordtype/
---
## EmfPlusPropertyRecordType class

Типы записей свойств определяют свойства контекста устройства воспроизведения.
