...
description: Типы записей чертежей определяют вывод графики.
type: docs
weight: 6030
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawingrecordtype/
---
## EmfPlusDrawingRecordType class

Типы записей чертежей определяют вывод графики.
