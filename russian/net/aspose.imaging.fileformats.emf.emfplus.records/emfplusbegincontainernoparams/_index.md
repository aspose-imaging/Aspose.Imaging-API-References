...
type: docs
weight: 5850
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfplusbegincontainernoparams/
---
...
| Имя | Описание |
| --- | --- |
| [EmfPlusBeginContainerNoParams](emfplusbegincontainernoparams)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusBeginContainerNoParams`](../emfplusbegincontainernoparams). |
