...
type: docs
weight: 6300
url: /ru/net/aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/
---
...
| Имя | Описание |
| --- | --- |
| [EmfPlusSetClipRect](emfplussetcliprect)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusSetClipRect`](../emfplussetcliprect). |

## Характеристики

| Имя | Описание |
| --- | --- |
| [ClipRect](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/cliprect) { get; set; } | Получает или задает объект EmfPlusRectF (раздел 2.2.2.39), который определяет прямоугольник для использования в операции CombineMode. |
| [Cm](../../aspose.imaging.fileformats.emf.emfplus.records/emfplussetcliprect/cm) { get; set; } | Получает или устанавливает CM (4 бита):задает логическую операцию для объединения двух регионов. См. перечисление CombineMode (раздел 2.1.1.4) для значений значений. |
