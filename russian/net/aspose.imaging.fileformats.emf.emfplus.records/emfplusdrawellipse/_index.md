...
| Имя | Описание |
| --- | --- |
| [EmfPlusDrawEllipse](emfplusdrawellipse)(EmfPlusRecord) | Инициализирует новый экземпляр класса[`EmfPlusDrawEllipse`](../emfplusdrawellipse). |
...
| [RectData](../../aspose.imaging.fileformats.emf.emfplus.records/emfplusdrawellipse/rectdata) { get; set; } | Получает или задает данные прямоугольника Объект EmfPlusRect или EmfPlusRectF, определяющий ограничивающую рамку эллипса. |
