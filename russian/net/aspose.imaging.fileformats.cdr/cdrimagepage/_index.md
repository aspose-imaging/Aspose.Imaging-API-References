...
type: docs
weight: 1430
url: /ru/net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
## CdrImagePage class
...
| override [IsCached](../../aspose.imaging.fileformats.cdr/cdrimagepage/iscached) { get; } | Получает значение, указывающее, кэшируются ли в данный момент данные объекта и не требуется ли считывание данных. |
...
| override [SetPalette](../../aspose.imaging.fileformats.cdr/cdrimagepage/setpalette)(IColorPalette, bool) | Устанавливает палитру изображения. |
