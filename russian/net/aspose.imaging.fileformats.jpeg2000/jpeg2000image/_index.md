...
| Имя | Описание |
| --- | --- |
| [Jpeg2000Image](jpeg2000image#constructor)(RasterImage) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_5)(Stream) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_7)(string) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_2)(int, int) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_1)(RasterImage, int) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_6)(Stream, int) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_8)(string, int) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_4)(int, int, int) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
| [Jpeg2000Image](jpeg2000image#constructor_3)(int, int, Jpeg2000Options) | Инициализирует новый экземпляр[`Jpeg2000Image`](../jpeg2000image) класс. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawlinesize) { get; } | Получает исходный размер строки в байтах. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/verticalresolution) { get; set; } | Получает или задает разрешение по вертикали в пикселях на дюйм этого[`RasterImage`](../../aspose.imaging/rasterimage) . |
