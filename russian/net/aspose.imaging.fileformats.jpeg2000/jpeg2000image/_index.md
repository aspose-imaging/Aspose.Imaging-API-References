...
description: Основной класс библиотеки Jpeg2000
type: docs
weight: 6830
url: /ru/net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/
---
## Jpeg2000Image class

Основной класс библиотеки Jpeg2000
...
| Имя | Описание |
| --- | --- |
| [Jpeg2000Image](jpeg2000image#constructor)(RasterImage) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_5)(Stream) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_7)(string) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_2)(int, int) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_1)(RasterImage, int) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_6)(Stream, int) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_8)(string, int) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_4)(int, int, int) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
| [Jpeg2000Image](jpeg2000image#constructor_3)(int, int, Jpeg2000Options) | Инициализирует новый экземпляр класса[`Jpeg2000Image`](../jpeg2000image). |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/bitsperpixel) { get; } | Получает глубину изображения (бит на пиксель) |
...
| [Codec](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/codec) { get; } | Получает кодек. |
| [Comments](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/comments) { get; set; } | Получает или задает комментарии. |
...
| override [FileFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/fileformat) { get; } | Получает значение формата файла |
...
| override [Height](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/height) { get; } | Получает высоту изображения |
| override [HorizontalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/horizontalresolution) { get; set; } | Получает или задает горизонтальное разрешение в пикселях на дюйм для этого[`RasterImage`](../../aspose.imaging/rasterimage). |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawdataformat) { get; } | Получает формат необработанных данных. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/rawlinesize) { get; } | Получает необработанный размер строки в байтах. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/verticalresolution) { get; set; } | Получает или задает вертикальное разрешение в пикселях на дюйм для этого[`RasterImage`](../../aspose.imaging/rasterimage). |
| override [Width](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/width) { get; } | Получает ширину изображения |
| override [XmpData](../../aspose.imaging.fileformats.jpeg2000/jpeg2000image/xmpdata) { get; set; } | Получает или задает метаданные XMP. |
...
В этом примере показано, как загрузить JPEG2000 изображение из файла и сохраните его в формате PNG.
