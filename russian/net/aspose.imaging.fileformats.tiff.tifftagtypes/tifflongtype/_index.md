...
| Имя | Описание |
| --- | --- |
| [TiffLongType](tifflongtype#constructor)(TiffTags) | Инициализирует новый экземпляр[`TiffLongType`](../tifflongtype) класс. |
| [TiffLongType](tifflongtype#constructor_1)(ushort) | Инициализирует новый экземпляр[`TiffLongType`](../tifflongtype) класс. |
