...
description: Длинный тип tiff.
type: docs
weight: 7970
url: /ru/net/aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
## TiffLongType class
...
| Имя | Описание |
| --- | --- |
| [TiffLongType](tifflongtype#constructor)(TiffTags) | Инициализирует новый экземпляр класса[`TiffLongType`](../tifflongtype). |
| [TiffLongType](tifflongtype#constructor_1)(ushort) | Инициализирует новый экземпляр класса[`TiffLongType`](../tifflongtype). |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/elementsize) { get; } | Получает размер элемента в байтах. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/tagtype) { get; } | Получает тип тега. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/value) { get; set; } | Получает или задает значение, которое содержит этот тип данных. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/values) { get; set; } | Получает или задает значения. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/valuescontainer) { get; } | Получает контейнер значений. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/writeadditionaldata)(TiffStreamWriter) | Записывает дополнительные данные тега. |
