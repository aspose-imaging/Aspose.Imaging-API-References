...
description: Тип байта tiff.
type: docs
weight: 7920
url: /ru/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/
---
## TiffByteType class
...
| Имя | Описание |
| --- | --- |
| [TiffByteType](tiffbytetype#constructor)(TiffTags) | Инициализирует новый экземпляр класса[`TiffByteType`](../tiffbytetype). |
| [TiffByteType](tiffbytetype#constructor_1)(ushort) | Инициализирует новый экземпляр класса[`TiffByteType`](../tiffbytetype). |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/elementsize) { get; } | Получает размер элемента в байтах. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/tagtype) { get; } | Получает тип тега. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/value) { get; set; } | Получает или задает значение, которое содержит этот тип данных. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/values) { get; set; } | Получает или задает значения. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/valuescontainer) { get; } | Получает контейнер значений. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffbytetype/writeadditionaldata)(TiffStreamWriter) | Записывает дополнительные данные тега. |
