...
| Имя | Описание |
| --- | --- |
| [TiffByteType](tiffbytetype#constructor)(TiffTags) | Инициализирует новый экземпляр[`TiffByteType`](../tiffbytetype) класс. |
| [TiffByteType](tiffbytetype#constructor_1)(ushort) | Инициализирует новый экземпляр[`TiffByteType`](../tiffbytetype) класс. |
