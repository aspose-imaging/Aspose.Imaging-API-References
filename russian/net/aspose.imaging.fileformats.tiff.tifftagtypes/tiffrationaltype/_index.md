...
| Имя | Описание |
| --- | --- |
| [TiffRationalType](tiffrationaltype#constructor)(TiffTags) | Инициализирует новый экземпляр[`TiffRationalType`](../tiffrationaltype) класс. |
| [TiffRationalType](tiffrationaltype#constructor_1)(ushort) | Инициализирует новый экземпляр[`TiffRationalType`](../tiffrationaltype) класс. |
