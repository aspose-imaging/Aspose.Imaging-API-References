...
| Имя | Описание |
| --- | --- |
| [TiffIfdType](tiffifdtype#constructor)(TiffTags) | Инициализирует новый экземпляр[`TiffIfdType`](../tiffifdtype) класс. |
| [TiffIfdType](tiffifdtype#constructor_1)(ushort) | Инициализирует новый экземпляр[`TiffIfdType`](../tiffifdtype) класс. |
