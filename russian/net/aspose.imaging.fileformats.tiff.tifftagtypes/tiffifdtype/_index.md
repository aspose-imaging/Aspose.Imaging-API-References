...
description: Представляет класс типа каталога файлов изображений TIFF Exif.
type: docs
weight: 7960
url: /ru/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/
---
## TiffIfdType class

Представляет класс типа каталога файлов изображений TIFF Exif.
...
| Имя | Описание |
| --- | --- |
| [TiffIfdType](tiffifdtype#constructor)(TiffTags) | Инициализирует новый экземпляр класса[`TiffIfdType`](../tiffifdtype). |
| [TiffIfdType](tiffifdtype#constructor_1)(ushort) | Инициализирует новый экземпляр класса[`TiffIfdType`](../tiffifdtype). |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/elementsize) { get; } | Получает размер элемента в байтах. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/tagtype) { get; } | Получает тип тега. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/value) { get; set; } | Получает или задает значение, которое содержит этот тип данных. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/values) { get; set; } | Получает или задает значения. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/valuescontainer) { get; } | Получает контейнер значений. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffifdtype/writeadditionaldata)(TiffStreamWriter) | Записывает дополнительные данные тега. |
