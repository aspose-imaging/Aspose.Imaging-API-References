...
| Имя | Описание |
| --- | --- |
| [TiffSRationalType](tiffsrationaltype#constructor)(TiffTags) | Инициализирует новый экземпляр[`TiffSRationalType`](../tiffsrationaltype) класс. |
| [TiffSRationalType](tiffsrationaltype#constructor_1)(ushort) | Инициализирует новый экземпляр[`TiffSRationalType`](../tiffsrationaltype) класс. |
