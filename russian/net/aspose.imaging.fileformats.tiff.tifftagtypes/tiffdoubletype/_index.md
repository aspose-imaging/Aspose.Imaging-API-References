...
| Имя | Описание |
| --- | --- |
| [TiffDoubleType](tiffdoubletype#constructor)(TiffTags) | Инициализирует новый экземпляр[`TiffDoubleType`](../tiffdoubletype) класс. |
| [TiffDoubleType](tiffdoubletype#constructor_1)(ushort) | Инициализирует новый экземпляр[`TiffDoubleType`](../tiffdoubletype) класс. |
