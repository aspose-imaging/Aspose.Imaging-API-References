...
type: docs
weight: 7940
url: /ru/net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
| Имя | Описание |
| --- | --- |
| [TiffDoubleType](tiffdoubletype#constructor)(TiffTags) | Инициализирует новый экземпляр класса[`TiffDoubleType`](../tiffdoubletype). |
| [TiffDoubleType](tiffdoubletype#constructor_1)(ushort) | Инициализирует новый экземпляр класса[`TiffDoubleType`](../tiffdoubletype). |
...
| override [ElementSize](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/elementsize) { get; } | Получает размер элемента в байтах. |
...
| override [TagType](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/tagtype) { get; } | Получает тип тега. |
| override [Value](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/value) { get; set; } | Получает или задает значение, которое содержит этот тип данных. |
| [Values](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/values) { get; set; } | Получает или задает значения. |
| override [ValuesContainer](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/valuescontainer) { get; } | Получает контейнер значений. |
...
| override [WriteAdditionalData](../../aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/writeadditionaldata)(TiffStreamWriter) | Записывает дополнительные данные тега. |
