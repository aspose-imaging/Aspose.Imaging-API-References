...
description: Объект конфигурации cdr
type: docs
weight: 1630
url: /ru/net/aspose.imaging.fileformats.cdr.objects/cdrmcfg/
---
## CdrMcfg class

Объект конфигурации cdr
...
| Имя | Описание |
| --- | --- |
| [CdrMcfg](cdrmcfg)() | Конструктор по умолчанию. |
...
| [Height](../../aspose.imaging.fileformats.cdr.objects/cdrmcfg/height) { get; set; } | Получает или задает высоту. |
| [Parent](../../aspose.imaging.fileformats.cdr.objects/cdrobject/parent) { get; set; } | Получает или задает родителя. |
| [Width](../../aspose.imaging.fileformats.cdr.objects/cdrmcfg/width) { get; set; } | Получает или задает ширину. |
