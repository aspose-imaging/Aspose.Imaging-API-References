...
description: Поток tiff для обработки файлов формата tiff с обратным порядком байтов.
type: docs
weight: 7760
url: /ru/net/aspose.imaging.fileformats.tiff.filemanagement/tiffbigendianstreamreader/
---
## TiffBigEndianStreamReader class

Поток tiff для обработки файлов формата tiff с обратным порядком байтов.
...
| Имя | Описание |
| --- | --- |
| [TiffBigEndianStreamReader](tiffbigendianstreamreader#constructor_1)(byte[]) | Инициализирует новый экземпляр[`TiffBigEndianStreamReader`](../tiffbigendianstreamreader) класс. |
| [TiffBigEndianStreamReader](tiffbigendianstreamreader#constructor)(StreamContainer) | Инициализирует новый экземпляр[`TiffBigEndianStreamReader`](../tiffbigendianstreamreader) класс. |
| [TiffBigEndianStreamReader](tiffbigendianstreamreader#constructor_2)(byte[], int) | Инициализирует новый экземпляр[`TiffBigEndianStreamReader`](../tiffbigendianstreamreader) класс. |
| [TiffBigEndianStreamReader](tiffbigendianstreamreader#constructor_3)(byte[], int, int) | Инициализирует новый экземпляр[`TiffBigEndianStreamReader`](../tiffbigendianstreamreader) класс. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Length](../../aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/length) { get; } | Получает длину считывателя. |
| [ThrowExceptions](../../aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/throwexceptions) { get; set; } | Получает или задает значение, указывающее, генерируются ли исключения при неправильной обработке данных (чтение или запись в поток). |

## Методы

| Имя | Описание |
| --- | --- |
| [ReadBytes](../../aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/readbytes)(long, long) | Считывает из потока массив байтовых значений без знака. |
| [ReadBytes](../../aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/readbytes)(byte[], int, long, long) | Считывает массив байтовых значений из потока. |
