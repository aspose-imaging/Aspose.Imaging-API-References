...
type: docs
weight: 140
url: /ru/net/aspose.imaging.brushes/hatchbrush/
---
## HatchBrush class
...
| Имя | Описание |
| --- | --- |
| [BackgroundColor](../../aspose.imaging.brushes/hatchbrush/backgroundcolor) { get; set; } | Получает или задает цвет пробелов между линиями штриховки. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Получает значение, указывающее, удален ли этот экземпляр. |
| [ForegroundColor](../../aspose.imaging.brushes/hatchbrush/foregroundcolor) { get; set; } | Получает или задает цвет линий штриховки. |
| [HatchStyle](../../aspose.imaging.brushes/hatchbrush/hatchstyle) { get; set; } | Получает или задает стиль штриховки этой кисти. |
