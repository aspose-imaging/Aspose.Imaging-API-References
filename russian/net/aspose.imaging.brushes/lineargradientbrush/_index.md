...
description: ИнкапсулируетBrush../aspose.imaging/brushс линейным градиентом. Этот класс не может быть унаследован.
type: docs
weight: 150
url: /ru/net/aspose.imaging.brushes/lineargradientbrush/
---
...
| [Blend](../../aspose.imaging.brushes/lineargradientbrush/blend) { get; set; } | Получает или задает[`Blend`](../../aspose.imaging/blend), который указывает позиции и факторы, определяющие пользовательский спад для градиента. |
