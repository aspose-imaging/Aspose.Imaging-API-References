...
type: docs
weight: 80
url: /ru/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawimage/
---
...
| --- | --- | --- |
| image | RasterImage | Изображение для рисования. |
| location | Point | Расположение верхнего левого угла нарисованного изображения. |
...
| --- | --- | --- |
| image | RasterImage | Изображение для рисования. |
| destRect | Rectangle | Структура прямоугольника, определяющая положение и размер рисуемого изображения. Изображение масштабируется, чтобы соответствовать прямоугольнику. |
| srcRect | Rectangle | Структура прямоугольника, указывающая часть объекта изображения для рисования. |
...
| исключение | условие |
| --- | --- |
| ArgumentOutOfRangeException | srcUnit;Поддержка только единиц измерения пикселей |

### Примеры

В этом примере показано, как создать изображение WMF и нарисуйте несколько геометрических фигур с помощью WmfRecorderGraphics2D.
...
int deviceHeight = 400;
 ...
 // Размер изображения в миллимитрах
...
| destRect | Rectangle | Адрес назначения. |
| srcUnit | GraphicsUnit | Исходный блок. |
