...
type: docs
weight: 150
url: /ru/net/aspose.imaging.fileformats.emf.graphics/metafilerecordergraphics2d/drawrectangle/
---
...
| width | Int32 | Ширина рисуемого прямоугольника. |
...
| --- | --- | --- |
| pen | Pen | Перо, определяющее цвет, ширину и стиль фигуры. |
| rectangle | Rectangle | Прямоугольник для рисования. |
