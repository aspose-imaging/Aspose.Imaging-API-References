...
| Имя | Описание |
| --- | --- |
| [EmfRecorderGraphics2D](emfrecordergraphics2d)(Rectangle, Size, Size) | Инициализирует новый экземпляр класса[`EmfRecorderGraphics2D`](../emfrecordergraphics2d). |
...
| [BackgroundMode](../../aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/backgroundmode) { get; set; } | Получает или задает фоновый режим. |
