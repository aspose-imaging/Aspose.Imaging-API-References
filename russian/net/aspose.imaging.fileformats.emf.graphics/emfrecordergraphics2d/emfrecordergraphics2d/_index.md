...
description: Инициализирует новый экземпляр классаEmfRecorderGraphics2Daspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d.
type: docs
weight: 10
url: /ru/net/aspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d/emfrecordergraphics2d/
---
## EmfRecorderGraphics2D constructor

Инициализирует новый экземпляр класса[`EmfRecorderGraphics2D`](../../emfrecordergraphics2d).
...
| --- | --- | --- |
| frame | Rectangle | Кадр. |
| deviceSize | Size | Размер устройства. |
| deviceSizeMm | Size | Размер устройства мм. |
