...
description: Инициализирует новый экземплярEmfRecorderGraphics2Daspose.imaging.fileformats.emf.graphics/emfrecordergraphics2d класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`EmfRecorderGraphics2D`](../../emfrecordergraphics2d) класс.
