...
| Имя | Описание |
| --- | --- |
| [WebPImage](webpimage#constructor)(RasterImage) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage)из rasterImage. |
| [WebPImage](webpimage#constructor_4)(Stream) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage) из потока . |
| [WebPImage](webpimage#constructor_6)(string) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage)из файла. |
| [WebPImage](webpimage#constructor_1)(RasterImage, LoadOptions) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage)из rasterImage. |
| [WebPImage](webpimage#constructor_5)(Stream, LoadOptions) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage)из потока. |
| [WebPImage](webpimage#constructor_7)(string, LoadOptions) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage)из файла. |
| [WebPImage](webpimage#constructor_2)(int, int, WebPOptions) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage)с пустым изображением. |
| [WebPImage](webpimage#constructor_3)(int, int, WebPOptions, LoadOptions) | Инициализирует новый экземпляр класса[`WebPImage`](../webpimage)с пустым изображением. |
...
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpimage/hasalpha) { get; } | Получает альфа-канал Has. |
...
| override [AdjustBrightness](../../aspose.imaging.fileformats.webp/webpimage/adjustbrightness)(int) | Регулировка*яркости*для изображения. |
| override [AdjustContrast](../../aspose.imaging.fileformats.webp/webpimage/adjustcontrast)(float) | [`Image`](../../aspose.imaging/image)контраст |
...
| override [BinarizeBradley](../../aspose.imaging.fileformats.webp/webpimage/binarizebradley#binarizebradley_1)(double, int) | Бинаризация изображения с использованием алгоритма адаптивной пороговой обработки Брэдли с использованием интегральной пороговой обработки изображения |
...
| override [BinarizeOtsu](../../aspose.imaging.fileformats.webp/webpimage/binarizeotsu)() | Бинаризация изображения с порогом Оцу |
...
| override [ResizeHeightProportionally](../../aspose.imaging.fileformats.webp/webpimage/resizeheightproportionally#resizeheightproportionally_2)(int, ResizeType) | Пропорционально изменяет ширину. |
...
| override [ResizeWidthProportionally](../../aspose.imaging.fileformats.webp/webpimage/resizewidthproportionally#resizewidthproportionally_2)(int, ResizeType) | Пропорционально изменяет ширину. |
| virtual [Rotate](../../aspose.imaging/rasterimage/rotate)(float) | Повернуть изображение вокруг центра. |
| override [Rotate](../../aspose.imaging.fileformats.webp/webpimage/rotate#rotate_1)(float, bool, Color) | !:RasterCahcedMultipageImage.Rotateизображение вокруг центра. |
