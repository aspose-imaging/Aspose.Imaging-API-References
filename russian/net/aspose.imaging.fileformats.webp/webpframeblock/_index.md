...
description: Представляет реестр открывателей блоков webp.
type: docs
weight: 8070
url: /ru/net/aspose.imaging.fileformats.webp/webpframeblock/
---
## WebPFrameBlock class

Представляет реестр открывателей блоков webp.
...
| Имя | Описание |
| --- | --- |
| [WebPFrameBlock](webpframeblock#constructor)(RasterImage) | Инициализирует новый экземпляр[`WebPFrameBlock`](../webpframeblock) |
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | Инициализирует новый экземпляр класса[`WebPFrameBlock`](../webpframeblock). |
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.webp/webpframeblock/bitsperpixel) { get; } | Получает количество бит изображения на пиксель. |
...
| [DisposalMethod](../../aspose.imaging.fileformats.webp/webpframeblock/disposalmethod) { get; } | Получает метод удаления. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Получает значение, указывающее, удален ли этот экземпляр. |
| [Duration](../../aspose.imaging.fileformats.webp/webpframeblock/duration) { get; set; } | Получает или задает продолжительность кадра. |
| virtual [FileFormat](../../aspose.imaging/image/fileformat) { get; } | Получает значение формата файла |
| [FrameLeft](../../aspose.imaging.fileformats.webp/webpframeblock/frameleft) { get; } | Получает смещение кадра влево. |
| [FrameTime](../../aspose.imaging.fileformats.webp/webpframeblock/frametime) { get; } | Получает продолжительность кадра. |
| [FrameTop](../../aspose.imaging.fileformats.webp/webpframeblock/frametop) { get; } | Получает верхнее смещение кадра. |
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | Получает значение, указывающее, имеет ли этот экземпляр альфа-канал. |
...
| override [Height](../../aspose.imaging.fileformats.webp/webpframeblock/height) { get; } | Получает высоту изображения. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | Получает или задает позицию кадра слева. |
...
| [Top](../../aspose.imaging.fileformats.webp/webpframeblock/top) { get; set; } | Получает или задает верхнюю позицию кадра. |
...
| override [Width](../../aspose.imaging.fileformats.webp/webpframeblock/width) { get; } | Получает ширину изображения. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.webp/webpframeblock/getfullframe)() | Получает полный кадр. |
