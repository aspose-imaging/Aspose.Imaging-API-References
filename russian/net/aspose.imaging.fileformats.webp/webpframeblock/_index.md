...
| [WebPFrameBlock](webpframeblock#constructor_1)(int, int) | Инициализирует новый экземпляр[`WebPFrameBlock`](../webpframeblock) класс. |
...
| override [HasAlpha](../../aspose.imaging.fileformats.webp/webpframeblock/hasalpha) { get; } | Получает значение, указывающее, есть ли у этого экземпляра альфа. |
...
| [Left](../../aspose.imaging.fileformats.webp/webpframeblock/left) { get; set; } | Получает или задает положение кадра слева. |
