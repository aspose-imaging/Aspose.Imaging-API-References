...
description: Получает заголовок с информацией о растровом изображении.
type: docs
weight: 20
url: /ru/net/aspose.imaging.fileformats.bmp/bmpimage/bitmapinfoheader/
---
## BmpImage.BitmapInfoHeader property

Получает заголовок с информацией о растровом изображении.
...
Информационный заголовок растрового изображения.
