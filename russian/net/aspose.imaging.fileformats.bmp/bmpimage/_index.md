...
description: Изображение в формате bmp поддерживает форматы BMP DIB.
type: docs
weight: 1380
url: /ru/net/aspose.imaging.fileformats.bmp/bmpimage/
---
## BmpImage class

Изображение в формате bmp (поддерживает форматы BMP, DIB).
...
| Имя | Описание |
| --- | --- |
| [BmpImage](bmpimage#constructor)(RasterImage) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_5)(Stream) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_7)(string) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_2)(int, int) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_3)(int, int, ushort, IColorPalette) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_1)(RasterImage, ushort, BitmapCompression, double, double) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_6)(Stream, ushort, BitmapCompression, double, double) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_8)(string, ushort, BitmapCompression, double, double) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
| [BmpImage](bmpimage#constructor_4)(int, int, ushort, IColorPalette, BitmapCompression, double, double) | Инициализирует новый экземпляр[`BmpImage`](../bmpimage) класс. |
...
| [BitmapInfoHeader](../../aspose.imaging.fileformats.bmp/bmpimage/bitmapinfoheader) { get; } | Получает заголовок информации о растровом изображении. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.bmp/bmpimage/bitsperpixel) { get; } | Получает количество бит изображения на пиксель. |
...
| [Compression](../../aspose.imaging.fileformats.bmp/bmpimage/compression) { get; } | Получает сжатие изображения. |
...
| override [FileFormat](../../aspose.imaging.fileformats.bmp/bmpimage/fileformat) { get; } | Получает значение формата файла |
...
| override [Height](../../aspose.imaging.fileformats.bmp/bmpimage/height) { get; } | Получает высоту изображения. |
| override [HorizontalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/horizontalresolution) { get; set; } | Получает или задает горизонтальное разрешение в пикселях на дюйм для этого[`RasterImage`](../../aspose.imaging/rasterimage) . |
...
| override [RawDataFormat](../../aspose.imaging.fileformats.bmp/bmpimage/rawdataformat) { get; } | Получает формат необработанных данных. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.bmp/bmpimage/rawlinesize) { get; } | Получает исходный размер строки в байтах. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/verticalresolution) { get; set; } | Получает или задает разрешение по вертикали в пикселях на дюйм этого[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [Width](../../aspose.imaging.fileformats.bmp/bmpimage/width) { get; } | Получает ширину изображения. |
...
| override [GetDefaultOptions](../../aspose.imaging.fileformats.bmp/bmpimage/getdefaultoptions)(object[]) | Получает параметры по умолчанию. |
...
| override [SetResolution](../../aspose.imaging.fileformats.bmp/bmpimage/setresolution)(double, double) | Устанавливает разрешение для этого[`RasterImage`](../../aspose.imaging/rasterimage) . |
| override [ToBitmap](../../aspose.imaging.fileformats.bmp/bmpimage/tobitmap)() | Преобразует растровое изображение в растровое. |
...
В следующем примере показано, как создать изображение BMP указанного размера.
...
{
    // Заливаем изображение простым линейным красно-черным градиентом.
