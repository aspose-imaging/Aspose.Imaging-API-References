...
| Имя | Описание |
| --- | --- |
| [BmpImage](bmpimage#constructor)(RasterImage) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_5)(Stream) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_7)(string) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_2)(int, int) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_3)(int, int, ushort, IColorPalette) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_1)(RasterImage, ushort, BitmapCompression, double, double) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_6)(Stream, ushort, BitmapCompression, double, double) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_8)(string, ushort, BitmapCompression, double, double) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
| [BmpImage](bmpimage#constructor_4)(int, int, ushort, IColorPalette, BitmapCompression, double, double) | Инициализирует новый экземпляр класса[`BmpImage`](../bmpimage). |
...
| [BitmapInfoHeader](../../aspose.imaging.fileformats.bmp/bmpimage/bitmapinfoheader) { get; } | Получает заголовок с информацией о растровом изображении. |
...
| override [RawLineSize](../../aspose.imaging.fileformats.bmp/bmpimage/rawlinesize) { get; } | Получает необработанный размер строки в байтах. |
...
| override [VerticalResolution](../../aspose.imaging.fileformats.bmp/bmpimage/verticalresolution) { get; set; } | Получает или задает вертикальное разрешение в пикселях на дюйм для этого[`RasterImage`](../../aspose.imaging/rasterimage). |
