...
type: docs
weight: 11120
url: /ru/net/aspose.imaging.sources/streamsource/
---
## StreamSource class
...
| Имя | Описание |
| --- | --- |
| [DisposeStream](../../aspose.imaging.sources/streamsource/disposestream) { get; } | Получает значение, указывающее, следует ли удалять поток при удалении контейнера. |
| [Stream](../../aspose.imaging.sources/streamsource/stream) { get; } | Получает поток. |

## Методы

| Имя | Описание |
| --- | --- |
| override [GetStreamContainer](../../aspose.imaging.sources/streamsource/getstreamcontainer)() | Получает контейнер потока. |
