...
description: Получает битовую маску описывающую порядок цветных пикселей в матрице.
type: docs
weight: 50
url: /ru/net/aspose.imaging.fileformats.dng.decoder/imageparameters/filters/
---
## ImageParameters.Filters property

Получает битовую маску, описывающую порядок цветных пикселей в матрице.
