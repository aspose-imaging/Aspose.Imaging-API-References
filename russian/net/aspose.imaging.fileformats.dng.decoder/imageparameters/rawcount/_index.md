...
description: Получает количество изображений RAW в файле 0 означает что файл не был распознан.
type: docs
weight: 80
url: /ru/net/aspose.imaging.fileformats.dng.decoder/imageparameters/rawcount/
---
## ImageParameters.RawCount property

Получает количество изображений RAW в файле (0 означает, что файл не был распознан).
