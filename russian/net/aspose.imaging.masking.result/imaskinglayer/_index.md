...
description: Маскирующий слой
type: docs
weight: 10540
url: /ru/net/aspose.imaging.masking.result/imaskinglayer/
---
...
| Имя | Описание |
| --- | --- |
| [ObjectNumber](../../aspose.imaging.masking.result/imaskinglayer/objectnumber) { get; } | Получает номер объекта. |

## Методы

| Имя | Описание |
| --- | --- |
| [GetImage](../../aspose.imaging.masking.result/imaskinglayer/getimage)() | Предоставляет результирующее изображение. |
| [GetMask](../../aspose.imaging.masking.result/imaskinglayer/getmask)() | Получает маску изображения. |

### Примеры

В этом примере показано, как разбить растровое изображение на несколько изображений с использованием маскирования изображений и алгоритма сегментации K-средних. Маскирование изображения — это метод обработки изображения, который используется для отделения фона от объектов изображения переднего плана.
