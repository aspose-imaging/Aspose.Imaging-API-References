...
description: Получает окончательное изображение Svg которое включает в себя все команды рисования выполняемые через объектSvgGraphics2Daspose.imaging.fileformats.svg.graphics/svggraphics2d.
type: docs
weight: 90
...
Получает окончательное изображение Svg, которое включает в себя все команды рисования, выполняемые через объект[`SvgGraphics2D`](../../svggraphics2d).
