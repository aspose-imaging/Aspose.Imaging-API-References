...
description: Заполняет дугу представляющую часть эллипса заданного структурой Rectangle.
type: docs
weight: 100
url: /ru/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/fillarc/
---
## SvgGraphics2D.FillArc method

Заполняет дугу, представляющую часть эллипса, заданного структурой Rectangle.
