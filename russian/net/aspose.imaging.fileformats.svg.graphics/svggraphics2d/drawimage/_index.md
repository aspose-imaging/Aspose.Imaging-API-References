...
| origin | Point | Расположение нарисованного изображения. |
...
| destRect | Rectangle | Расположение и размер рисуемого изображения. Изображение масштабируется, чтобы соответствовать прямоугольнику. |
