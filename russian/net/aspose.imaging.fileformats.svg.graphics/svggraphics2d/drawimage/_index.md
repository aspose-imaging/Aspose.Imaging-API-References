...
description: Рисует указанное изображение в указанном месте.
type: docs
weight: 40
url: /ru/net/aspose.imaging.fileformats.svg.graphics/svggraphics2d/drawimage/
---
...
| --- | --- | --- |
| image | RasterImage | Нарисованное изображение. |
| origin | Point | Местоположение нарисованного изображения. |
...
Рисует указанное изображение указанного размера в указанном месте.
...
| image | RasterImage | Нарисованное изображение. |
| origin | Point | Местоположение нарисованного изображения. |
| size | Size | Желаемый размер рисуемого изображения. |
...
| destRect | Rectangle | Местоположение и размер рисуемого изображения. Изображение масштабируется, чтобы соответствовать прямоугольнику. |
