...
| Имя | Описание |
| --- | --- |
| [CmxImagePage](cmximagepage)(CmxPage) | Инициализирует новый экземпляр класса[`CmxImagePage`](../cmximagepage). |
...
| override [SetPalette](../../aspose.imaging.fileformats.cmx/cmximagepage/setpalette)(IColorPalette, bool) | Устанавливает палитру изображения. |
