...
| Имя | Описание |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | Инициализирует новый экземпляр класса[`GifFrameBlock`](../gifframeblock). |
...
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop) { get; } | Преобразует в стр. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | Получает или задает значение, указывающее, является ли этот файл[`GifFrameBlock`](../gifframeblock)чересстрочным. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | Получает значение, указывающее, является ли этот экземпляр изображения чересстрочным. |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor#replacecolor_1)(int, byte, int) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное значение альфа-канала для сохранения гладких краев. |
