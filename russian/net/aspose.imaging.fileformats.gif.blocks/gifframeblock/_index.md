...
type: docs
weight: 6630
url: /ru/net/aspose.imaging.fileformats.gif.blocks/gifframeblock/
---
## GifFrameBlock class
...
| Имя | Описание |
| --- | --- |
| [GifFrameBlock](gifframeblock#constructor)(RasterImage) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_3)(Stream) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_6)(string) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_9)(ushort, ushort) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_1)(RasterImage, ushort, ushort) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_4)(Stream, ushort, ushort) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_7)(string, ushort, ushort) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_10)(ushort, ushort, ushort, ushort) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_2)(RasterImage, ushort, ushort, bool, bool, byte) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_5)(Stream, ushort, ushort, bool, bool, byte) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_8)(string, ushort, ushort, bool, bool, byte) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
| [GifFrameBlock](gifframeblock#constructor_11)(ushort, ushort, ushort, ushort, IColorPalette, bool, bool, byte) | Инициализирует новый экземпляр[`GifFrameBlock`](../gifframeblock) класс. |
...
| override [BackgroundColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/backgroundcolor) { get; set; } | Получает или задает значение цвета фона. |
| override [BitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/bitsperpixel) { get; } | Получает количество бит изображения на пиксель. |
...
| [ControlBlock](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/controlblock) { get; } | Получает блок управления графикой, связанный с этим блоком. |
| [DataStreamContainer](../../aspose.imaging/datastreamsupporter/datastreamcontainer) { get; } | Получает поток данных объекта. |
| [DisposalMethod](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/disposalmethod) { get; } | Получает метод удаления. |
| [Disposed](../../aspose.imaging/disposableobject/disposed) { get; } | Получает значение, указывающее, удален ли этот экземпляр. |
| override [FileFormat](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/fileformat) { get; } | Получает значение формата файла |
| [Flags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/flags) { get; set; } | Получает или устанавливает флаги. |
| [FrameLeft](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frameleft) { get; } | Получает левый. |
| [FrameTime](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametime) { get; set; } | Получает или задает продолжительность. |
| [FrameTop](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/frametop) { get; } | Преобразуется в p. |
| [GifFrameBitsPerPixel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/gifframebitsperpixel) { get; set; } | Получает или задает количество бит кадра GIF на пиксель. |
...
| override [HasTransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/hastransparentcolor) { get; set; } | Получает значение, указывающее, имеет ли блок кадра прозрачный цвет. |
| override [Height](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/height) { get; } | Получает высоту изображения. |
...
| [Interlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/interlaced) { get; set; } | Получает или задает значение, указывающее, является ли это[`GifFrameBlock`](../gifframeblock) чересстрочная развертка. |
...
| [IsInterlaced](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/isinterlaced) { get; } | Получает значение, указывающее, является ли данный экземпляр изображения чересстрочным. |
| [IsPaletteSorted](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/ispalettesorted) { get; set; } | Получает или задает значение, указывающее, отсортирована ли цветовая палитра. |
...
| [Left](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/left) { get; set; } | Получает или задает расположение левого изображения. |
...
| [Top](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/top) { get; set; } | Получает или задает расположение верхнего изображения. |
| override [TransparentColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/transparentcolor) { get; set; } | Получает прозрачный цвет блока кадра. |
...
| override [Width](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/width) { get; } | Получает ширину изображения. |
...
| Имя | Описание |
| --- | --- |
| override [AdjustBrightness](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/adjustbrightness)(int) | Настройка яркости изображения. |
...
| [GetFullFrame](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getfullframe)() | Получает полный кадр. |
...
| override [ReplaceColor](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacecolor#replacecolor_1)(int, byte, int) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное значение альфа-канала для сохранения сглаженных краев. |
...
| override [ReplaceNonTransparentColors](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/replacenontransparentcolors#replacenontransparentcolors_1)(int) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа-канала для сохранения гладких краев. Примечание: если вы используете его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
...
| static [CreateFlags](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/createflags)(IColorPalette, bool, bool) | Создает флаги. |
| static [GetColorPalette](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/getcolorpalette)(IColorPalette, IColorPalette) | Получает связанную цветовую палитру. |

## Поля

| Имя | Описание |
| --- | --- |
| const [ExtensionLabel](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/extensionlabel) | Метка расширения блока. |
| const [ImageDescriptorSize](../../aspose.imaging.fileformats.gif.blocks/gifframeblock/imagedescriptorsize) | Размер дескриптора изображения. |
