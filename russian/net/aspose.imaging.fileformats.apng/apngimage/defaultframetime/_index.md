...
description: Получает или задает длительность кадра по умолчанию. Используется при создании новых кадров.
type: docs
weight: 20
url: /ru/net/aspose.imaging.fileformats.apng/apngimage/defaultframetime/
---
## ApngImage.DefaultFrameTime property

Получает или задает длительность кадра по умолчанию. Используется при создании новых кадров.
...
Длительность кадра по умолчанию в миллисекундах.
