...
type: docs
weight: 7140
url: /ru/net/aspose.imaging.fileformats.opendocument.objects.graphic/odlistitem/
---
## OdListItem class
...
| Имя | Описание |
| --- | --- |
| [OdListItem](odlistitem)(OdObject) | Инициализирует новый экземпляр класса[`OdListItem`](../odlistitem). |
