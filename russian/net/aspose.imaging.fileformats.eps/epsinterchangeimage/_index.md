...
description: Класс для формата Encapsulated PostScript Interchange
type: docs
weight: 6570
url: /ru/net/aspose.imaging.fileformats.eps/epsinterchangeimage/
---
## EpsInterchangeImage class

Класс для формата Encapsulated PostScript Interchange
...
| override [EpsType](../../aspose.imaging.fileformats.eps/epsinterchangeimage/epstype) { get; } | Получает значение подтипа EPS |
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | Получает значение, указывающее, имеет ли данный экземпляр предварительный просмотр растра для конкретного формата |
...
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | Получает высоту изображения для предварительного просмотра |
| [PreviewWidth](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewwidth) { get; } | Получает ширину изображения предварительного просмотра |
| [RasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/rasterpreview) { get; } | Получает предварительный просмотр черно-белого растра (если есть) или null |
...
| [ConvertToBinary](../../aspose.imaging.fileformats.eps/epsinterchangeimage/converttobinary)() | Преобразует этот экземпляр в[`EpsBinaryImage`](../epsbinaryimage) |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | Выполняет явное преобразование из[`EpsBinaryImage`](../epsbinaryimage)в[`EpsInterchangeImage`](../epsinterchangeimage) |
