...
description: Класс для инкапсулированного формата обмена PostScript
type: docs
weight: 6570
...
| override [HasRasterPreview](../../aspose.imaging.fileformats.eps/epsinterchangeimage/hasrasterpreview) { get; } | Получает значение, указывающее, имеет ли данный экземпляр растровый файл preview для определенного формата. |
...
| [PreviewHeight](../../aspose.imaging.fileformats.eps/epsinterchangeimage/previewheight) { get; } | Получает высоту изображения предварительного просмотра |
...
| [explicit operator](../../aspose.imaging.fileformats.eps/epsinterchangeimage/op_explicit) | Выполняет явное преобразование из[`EpsBinaryImage`](../epsbinaryimage) к[`EpsInterchangeImage`](../epsinterchangeimage) |
