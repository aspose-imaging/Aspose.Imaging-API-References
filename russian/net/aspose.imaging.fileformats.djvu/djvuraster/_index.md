...
description: Класс для представления растрового изображения Djvu в котором находится результат какой-либо операции
type: docs
weight: 2460
url: /ru/net/aspose.imaging.fileformats.djvu/djvuraster/
---
## DjvuRaster class

Класс для представления растрового изображения Djvu, в котором находится результат какой-либо операции
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvuraster/bitsperpixel) { get; } | Получает количество бит изображения на пиксель. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvuraster/height) { get; } | Получает высоту. |
...
| [Length](../../aspose.imaging.fileformats.djvu/djvuraster/length) { get; } | Получает длину. |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvuraster/width) { get; } | Получает ширину. |
