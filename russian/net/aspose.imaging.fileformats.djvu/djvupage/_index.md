...
description: Djvu-страница class
type: docs
weight: 2450
url: /ru/net/aspose.imaging.fileformats.djvu/djvupage/
---
## DjvuPage class
...
| override [BitsPerPixel](../../aspose.imaging.fileformats.djvu/djvupage/bitsperpixel) { get; } | Получает количество бит изображения на пиксель. |
...
| override [Height](../../aspose.imaging.fileformats.djvu/djvupage/height) { get; } | Получает высоту страницы |
...
| [Image](../../aspose.imaging.fileformats.djvu/djvupage/image) { get; } | Получает изображение. |
...
| [IsColor](../../aspose.imaging.fileformats.djvu/djvupage/iscolor) { get; } | Получает значение, указывающее, является ли данный экземпляр цветным. |
...
| [PageNumber](../../aspose.imaging.fileformats.djvu/djvupage/pagenumber) { get; } | Получает номер страницы. |
...
| [ParentImage](../../aspose.imaging.fileformats.djvu/djvupage/parentimage) { get; } | Получает родительское изображение, которому принадлежит страница |
...
| [ThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/thumbnailimage) { get; set; } | Получает или задает миниатюру для страницы |
...
| override [Width](../../aspose.imaging.fileformats.djvu/djvupage/width) { get; } | Получает ширину страницы |
...
| [ExtractThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/extractthumbnailimage)() | Извлекает эскиз изображения со страницы Djvu. |
...
| [GetBackgroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getbackgroundimage)() | Получает фоновое изображение. |
...
| [GetForegroundImage](../../aspose.imaging.fileformats.djvu/djvupage/getforegroundimage)(int) | Получает изображение переднего плана для страницы |
...
| [GetTextForLocation](../../aspose.imaging.fileformats.djvu/djvupage/gettextforlocation)(Rectangle) | Получает текст для прямоугольника location |
| [GetTextImage](../../aspose.imaging.fileformats.djvu/djvupage/gettextimage)(int) | Получает текстовое изображение. |
