...
| [ThumbnailImage](../../aspose.imaging.fileformats.djvu/djvupage/thumbnailimage) { get; set; } | Получает или задает эскиз изображения для страницы |
...
| [GetTextForLocation](../../aspose.imaging.fileformats.djvu/djvupage/gettextforlocation)(Rectangle) | Получает текст для местоположения прямоугольника |
