...
type: docs
weight: 260
url: /ru/net/aspose.imaging.fileformats.djvu/djvuimage/resize/
---
...
В этом примере загружается изображение DJVU и изменяется его размер с использованием различных методов изменения размера.
...
В этом примере загружается изображение DJVU и изменяется его размер с использованием различных параметров изменения размера.
