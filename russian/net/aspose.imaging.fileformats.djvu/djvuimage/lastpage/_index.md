...
description: Получает последнюю страницу документа
type: docs
weight: 90
url: /ru/net/aspose.imaging.fileformats.djvu/djvuimage/lastpage/
---
## DjvuImage.LastPage property

Получает последнюю страницу документа
...
| исключение | условие |
| --- | --- |
| [DjvuImageException](../../../aspose.imaging.coreexceptions.imageformats/djvuimageexception) | Последняя страница не может быть найдена |
