...
| Имя | Описание |
| --- | --- |
| [WmfImage](wmfimage#constructor)() | Инициализирует новый экземпляр класса[`WmfImage`](../wmfimage). |
| [WmfImage](wmfimage#constructor_1)(int, int) | Инициализирует новый экземпляр класса[`WmfImage`](../wmfimage). |
...
| [Inch](../../aspose.imaging.fileformats.wmf/wmfimage/inch) { get; set; } | Получает или устанавливает дюймы. |
| [InterruptMonitor](../../aspose.imaging/image/interruptmonitor) { get; set; } | Получает или устанавливает монитор прерываний. |
| override [IsCached](../../aspose.imaging.fileformats.wmf/wmfimage/iscached) { get; } | Получает значение, указывающее, кэшируются ли в данный момент данные объекта и не требуется ли считывание данных. |
...
| override [SetPalette](../../aspose.imaging.fileformats.wmf/wmfimage/setpalette)(IColorPalette, bool) | Устанавливает палитру изображения. |

### Примеры

В следующем примере показано, как преобразовать wmz изображения в wmf fromat
