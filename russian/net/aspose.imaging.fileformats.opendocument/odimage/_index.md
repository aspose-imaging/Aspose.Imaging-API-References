...
| Имя | Описание |
| --- | --- |
| [OdImage](odimage#constructor)(StreamContainer) | Инициализирует новый экземпляр[`OdImage`](../odimage) класс. |
| [OdImage](odimage#constructor_1)(StreamContainer, LoadOptions) | Инициализирует новый экземпляр[`OdImage`](../odimage) класс. |
