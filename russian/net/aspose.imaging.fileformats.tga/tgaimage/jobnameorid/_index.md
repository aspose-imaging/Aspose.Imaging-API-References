...
description: Получает или задает имя/идентификатор задания.
type: docs
weight: 180
url: /ru/net/aspose.imaging.fileformats.tga/tgaimage/jobnameorid/
---
## TgaImage.JobNameOrId property

Получает или задает имя/идентификатор задания.
