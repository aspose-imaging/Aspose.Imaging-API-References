...
type: docs
weight: 160
url: /ru/net/aspose.imaging.fileformats.tga/tgaimage/imageid/
---
## TgaImage.ImageId property

Получает или задает идентификатор изображения.

Это необязательное поле содержит идентифицирующую информацию об изображении. Максимальная длина для этого поля составляет 255 байт.
