...
description: Получает часть знаменателя значения гаммы. Неисправленное изображение изображение без гаммы в результате должно иметь значение 1.0.
type: docs
weight: 90
...
Получает часть знаменателя значения гаммы. Неисправленное изображение (изображение без гаммы) в результате должно иметь значение 1.0.
