...
description: Инициализирует новый экземпляр классаEmfRectangleaspose.imaging.fileformats.emf.emf.records/emfrectangle.
type: docs
weight: 10
...
Инициализирует новый экземпляр класса[`EmfRectangle`](../../emfrectangle).
