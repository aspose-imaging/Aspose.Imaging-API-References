...
description: Инициализирует новый экземплярEmfSelectObjectaspose.imaging.fileformats.emf.emf.records/emfselectobject класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`EmfSelectObject`](../../emfselectobject) класс.
