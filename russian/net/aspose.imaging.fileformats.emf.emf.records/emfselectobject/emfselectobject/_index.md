...
description: Инициализирует новый экземпляр классаEmfSelectObjectaspose.imaging.fileformats.emf.emf.records/emfselectobject.
type: docs
weight: 10
url: /ru/net/aspose.imaging.fileformats.emf.emf.records/emfselectobject/emfselectobject/
---
## EmfSelectObject(EmfRecord) {#constructor_1}

Инициализирует новый экземпляр класса[`EmfSelectObject`](../../emfselectobject).
