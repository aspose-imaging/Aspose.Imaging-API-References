...
description: Инициализирует новый экземпляр классаEmfCreateBrushIndirectaspose.imaging.fileformats.emf.emf.records/emfcreatebrushindirect.
type: docs
weight: 10
url: /ru/net/aspose.imaging.fileformats.emf.emf.records/emfcreatebrushindirect/emfcreatebrushindirect/
---
## EmfCreateBrushIndirect(EmfRecord) {#constructor_1}

Инициализирует новый экземпляр класса[`EmfCreateBrushIndirect`](../../emfcreatebrushindirect).
