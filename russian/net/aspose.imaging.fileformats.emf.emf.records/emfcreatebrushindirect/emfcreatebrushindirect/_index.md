...
description: Инициализирует новый экземплярEmfCreateBrushIndirectaspose.imaging.fileformats.emf.emf.records/emfcreatebrushindirect класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`EmfCreateBrushIndirect`](../../emfcreatebrushindirect) класс.
