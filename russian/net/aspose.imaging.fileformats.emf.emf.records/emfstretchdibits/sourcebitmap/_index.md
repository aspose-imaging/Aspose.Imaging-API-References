...
description: Получает или задает буфер содержащий исходное растровое изображение которое не обязательно должно быть непрерывным с фиксированной частью записи EMR_STRETCHDIBITS. Соответственно поля в этого буфера помеченные как UndefinedSpace являются необязательными и ДОЛЖНЫ игнорироваться.
type: docs
weight: 80
url: /ru/net/aspose.imaging.fileformats.emf.emf.records/emfstretchdibits/sourcebitmap/
---
