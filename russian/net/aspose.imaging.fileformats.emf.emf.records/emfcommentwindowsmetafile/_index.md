...
description: Запись EMR_COMMENT_WINDOWS_METAFILE определяет изображение во встроенном метафайле WMF.
type: docs
weight: 3440
...
Запись EMR_COMMENT_WINDOWS_METAFILE определяет изображение во встроенном метафайле WMF.
...
| Имя | Описание |
| --- | --- |
| [EmfCommentWindowsMetaFile](emfcommentwindowsmetafile)(EmfRecord) | Инициализирует новый экземпляр класса[`EmfCommentWindowsMetaFile`](../emfcommentwindowsmetafile). |
