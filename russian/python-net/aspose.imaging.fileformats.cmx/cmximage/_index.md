---
title: "Класс CmxImage"
type: docs
weight: 90
url: /ru/python-net/aspose.imaging.fileformats.cmx/cmximage/
---
...
| **Name** | **Description** |
| :- | :- |
| [CmxImage(stream_container, load_options)](#CmxImage_stream_container_load_options_1) | Начните работу с классом [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) без проблем, инициализируя<br/>            новый экземпляр с параметрами streamContainer и loadOptions. Идеально подходит для разработчиков<br/>            ищущих удобный способ загрузки CMX‑изображений из различных источников данных, при этом<br/>            настраивая процесс загрузки по мере необходимости. |
## **Properties**
...
| bits_per_pixel | int | r | Получите глубину цвета изображения без усилий с помощью этого удобного свойства.<br/>            Идеально подходит для разработчиков, желающих определить уровень детализации или глубину цвета<br/>            в своих изображениях, обеспечивая точную обработку и манипуляцию. |
...
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | r | Без труда получайте страницу CMX изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, которым нужен быстрый доступ к отдельным страницам в CMX‑изображениях,<br/>            обеспечивая эффективную навигацию и управление. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Без труда получайте основную страницу изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, которым нужен быстрый доступ к основной странице их изображения,<br/>            обеспечивая эффективную навигацию и управление. |
| disposed | bool | r | Получает значение, указывающее, удалён ли этот экземпляр. |
| document | [CmxDocument](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxdocument/) | r | Без труда получайте документ CMX с помощью этого интуитивного свойства. Идеально подходит для<br/>            разработчиков, желающих получить доступ к CMX‑изображениям или изменить их, обеспечивая гибкость и<br/>            эффективность в их приложениях. |
| exif_data | [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) | r/w | Получает или задаёт экземпляр Exif. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Без труда получайте формат файла изображения с помощью этого удобного свойства.<br/>            Идеально подходит для разработчиков, желающих динамически определять формат своих изображений,<br/>            обеспечивая совместимость и точную обработку в их приложениях. |
...
| height_f | float | r | Без труда получайте высоту объекта, измеренную в дюймах, с помощью этого<br/>            удобного свойства. Идеально подходит для разработчиков, которым нужна точная информация о размерах<br/>            для эффективного размещения и представления в их приложениях. |
...
| is_cached | bool | r | Определите, кэшированы ли данные объекта в данный момент, устраняя необходимость<br/>            чтения данных. Идеально подходит для разработчиков, стремящихся оптимизировать производительность за счёт<br/>            эффективного использования кэшированных данных, обеспечивая более быстрый доступ к информации об объекте. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Получает метаданные изображения. |
| page_count | int | r | Получайте общее количество страниц изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, которым необходимо динамически управлять многостраничными изображениями,<br/>            обеспечивая эффективную навигацию и манипуляцию содержимым изображения. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Бесшовно получайте страницы изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, которым нужен доступ и манипуляция отдельными страницами<br/>            в многостраничных изображениях, обеспечивая эффективную навигацию и обработку. |
...
| width_f | float | r | Получайте ширину объекта в дюймах с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, которым нужны точные измерения объектов в их приложениях,<br/>            обеспечивая точное размещение и представление. |
| xmp_data | [XmpPacketWrapper](/imaging/python-net/aspose.imaging.xmp/xmppacketwrapper/) | r/w | Получает или задает данные Xmp. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
| cache_data() | Кешируйте данные, чтобы предотвратить дополнительную загрузку из базового источника<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/)<br/>            с помощью этого удобного метода. Идеально подходит для разработчиков, стремящихся оптимизировать производительность<br/>            предзагружая данные, обеспечивая более быстрый доступ и более плавную работу в их приложениях. |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_68) | Настройте цветовую палитру изображения с помощью этого интуитивного метода. Идеально подходит для<br/>            разработчиков, желающих динамически применять определённые цветовые схемы или корректировки,<br/>            обеспечивая точный контроль над визуальным отображением их изображений. |
...
Начните работу с классом [CmxImage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximage/) без проблем, инициализируя<br/>            новый экземпляр с параметрами streamContainer и loadOptions. Идеально подходит для разработчиков<br/>            ищущих удобный способ загрузки CMX‑изображений из различных источников данных, при этом<br/>            настраивая процесс загрузки по мере необходимости.
...
Бесшовно получайте страницы изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, которым нужен доступ и манипуляция отдельными страницами<br/>            в многостраничных изображениях, обеспечивая эффективную навигацию и обработку.
...
Настройте цветовую палитру изображения с помощью этого интуитивного метода. Идеально подходит для<br/>            разработчиков, желающих динамически применять определённые цветовые схемы или корректировки,<br/>            обеспечивая точный контроль над визуальным отображением их изображений.
...
dir_: str = "c:\\temp"
# Загрузите изображение из файла CMX.
with aspycore.as_of(Image.load(join(dir_, "sample.cmx")), CmxImage) as image:
	# Этот вызов кэширует только страницу по умолчанию.
	image.cache_data()
	# Кэшируйте все страницы, чтобы не происходила дополнительная загрузка данных из базового потока данных.
