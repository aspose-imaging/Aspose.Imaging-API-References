---
title: "Класс CmxImagePage"
type: docs
weight: 110
url: /ru/python-net/aspose.imaging.fileformats.cmx/cmximagepage/
---
...
| **Name** | **Description** |
| :- | :- |
| [CmxImagePage(cmx_page)](#CmxImagePage_cmx_page_1) | Инициализирует новый экземпляр класса [CmxImagePage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximagepage/). |
| [CmxImagePage(cmx_page, container)](#CmxImagePage_cmx_page_container_2) | Инициализирует новый экземпляр класса [CmxImagePage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximagepage/). |
## **Properties**
...
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | r | Получает страницу CMX. |
...
| **Name** | **Description** |
| :- | :- |
| cache_data() | Кеш не может быть использован. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_42) | Изменяет размер до указанной новой ширины. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_43) | Изменяет размер изображения с расширенными параметрами. |
...
Инициализирует новый экземпляр класса [CmxImagePage](/imaging/python-net/aspose.imaging.fileformats.cmx/cmximagepage/).

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | Страница CMX. |
...
| :- | :- | :- |
| cmx_page | [CmxPage](/imaging/python-net/aspose.imaging.fileformats.cmx.objectmodel/cmxpage/) | Страница CMX. |
| container | [Image](/imaging/python-net/aspose.imaging/image/) | Контейнер. |
