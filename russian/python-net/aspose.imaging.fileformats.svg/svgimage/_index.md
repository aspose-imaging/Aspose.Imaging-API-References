---
title: "Класс SvgImage"
type: docs
weight: 40
url: /ru/python-net/aspose.imaging.fileformats.svg/svgimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [SvgImage(path)](#SvgImage_path_1) | Создает новый объект класса [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), используя <br/>            указанный путь для поиска и загрузки изображения. Этот конструктор облегчает <br/>            создание экземпляров изображений SVG из внешних файлов, обеспечивая бесшовную <br/>            интеграцию в программные системы и рабочие процессы. |
| [SvgImage(stream)](#SvgImage_stream_2) | Создает новый экземпляр класса [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), загружая изображение <br/>            из предоставленного потока. Этот конструктор позволяет напрямую загружать изображения SVG <br/>            из потоков, повышая гибкость и эффективность при работе с ресурсами изображений в <br/>            программных приложениях. |
| [SvgImage(svg_options, width, height)](#SvgImage_svg_options_width_height_3) | Создает новый экземпляр класса [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) с указанными параметрами SVG <br/>            опций, ширины и высоты изображения. Этот конструктор позволяет <br/>            разработчикам инициализировать изображения SVG с пользовательскими опциями и размерами, <br/>            обеспечивая гибкость при управлении содержимым и макетом SVG. |
| [SvgImage(width, height)](#SvgImage_width_height_4) | Создает новый объект [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) с указанными шириной и <br/>            высотой. Этот конструктор позволяет разработчикам создавать изображения SVG с предопределенными <br/>            размерами, облегчая точный контроль над размером изображения во время <br/>            инициализации. |
## **Properties**
...
| bits_per_pixel | int | r | Возвращает количество бит на пиксель изображения. Важно отметить, что <br/>            этот параметр не применяется к векторным изображениям, поскольку они не измеряются в <br/>            пикселях. Это свойство предоставляет важную информацию о глубине цвета изображения, <br/>            помогая в задачах обработки и манипуляции. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Возвращает формат файла изображения, предоставляя важные метаданные для <br/>            обработки и проверки совместимости. Это свойство играет ключевую роль в <br/>            определении подходящих стратегий декодирования и кодирования для эффективного <br/>            управления данными изображения в разных системах и приложениях. |
...
| is_cached | bool | r | Возвращает логическое значение, указывающее, кэшированы ли данные объекта в данный момент <br/>            , устраняя необходимость дополнительных операций чтения данных. Это <br/>            свойство дает представление о текущем состоянии кэширования, оптимизируя получение данных <br/>            и процессы обработки для повышения производительности и эффективности. |
...
| **Name** | **Description** |
| :- | :- |
| cache_data() | Кешировать данные и гарантировать, что дальнейшая загрузка данных из <br/>            базового [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/) не будет происходить. Эта <br/>            оптимизация повышает производительность, устраняя избыточные операции получения данных, <br/>            что особенно полезно в сценариях, требующих частого доступа к <br/>            данным изображения. |
...
| [create_from_stream(stream)](#create_from_stream_stream_20) | Инициализирует новый экземпляр класса [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/). |
...
| [load(file_path)](#load_file_path_34) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(file_path, load_options)](#load_file_path_load_options_35) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(stream)](#load_stream_36) | Загружает раздел SVG. |
| [load(stream, load_options)](#load_stream_load_options_37) | Загружает новое изображение из указанного потока. |
| [load_stream(stream)](#load_stream_stream_38) | Загружает новое изображение из указанного потока. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_39) | Загружает новое изображение из указанного потока. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_40) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| remove_background() | Удаляет фон. |
| [remove_background(settings)](#remove_background_settings_41) | Удаляет фон. |
| remove_metadata() | Удаляет метаданные. |
| [resize(new_width, new_height)](#resize_new_width_new_height_42) | Изменяет размер изображения. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_43) | Измените размер изображения, чтобы он соответствовал указанным размерам, сохраняя его соотношение <br/>            сторон. Этот метод предоставляет удобный способ корректировать размер изображения <br/>            без искажения его пропорций, обеспечивая оптимальное отображение или хранение <br/>            в соответствии с желаемыми размерами. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_44) | Изменяет размер изображения с расширенными параметрами. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_45) | Изменяет размер изображения. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_46) | Изменяет размер изображения. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_47) | Пропорционально изменяет высоту. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_48) | Пропорционально изменяет высоту. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_49) | Пропорционально изменяет высоту. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_50) | Пропорционально изменяет высоту. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_51) | Пропорционально изменяет ширину. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_52) | Пропорционально изменяет ширину. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_53) | Пропорционально изменяет ширину. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_54) | Пропорционально изменяет ширину. |
| [rotate(angle)](#rotate_angle_55) | Повернуть изображение вокруг центра. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_56) | Вращает, отражает или вращает и отражает изображение. |
| save() | Сохраняет данные изображения в базовый поток. |
| [save(file_path)](#save_file_path_57) | Сохраняет изображение в указанное расположение файла. |
| [save(file_path, options)](#save_file_path_options_58) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_59) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, over_write)](#save_file_path_over_write_60) | Сохраняет данные объекта в указанное расположение файла. |
| [save(stream)](#save_stream_61) | Сохраняет данные. |
| [save(stream, options_base)](#save_stream_options_base_62) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_63) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_to_stream(stream)](#save_to_stream_stream_64) | Сохраняет данные объекта в указанный поток. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_65) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_66) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_67) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_68) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_69) | Применяет указанную палитру к изображению, позволяя настраивать цветовые <br/>            схемы для эстетических или функциональных целей. Этот метод обеспечивает гибкость <br/>            в управлении цветовыми палитрами, чтобы соответствовать различным требованиям дизайна или применения. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_70) | Пытается установить экземпляр _metadata_, если этот экземпляр [Image](/imaging/python-net/aspose.imaging/image/) поддерживает и реализует экземпляр [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
...
Создает новый экземпляр класса [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/), загружая изображение <br/>            из предоставленного потока. Этот конструктор позволяет напрямую загружать изображения SVG <br/>            из потоков, повышая гибкость и эффективность при работе с ресурсами изображений в <br/>            программных приложениях.
...
Создает новый экземпляр класса [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) с указанными параметрами SVG <br/>            опций, ширины и высоты изображения. Этот конструктор позволяет <br/>            разработчикам инициализировать изображения SVG с пользовательскими опциями и размерами, <br/>            обеспечивая гибкость при управлении содержимым и макетом SVG.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| svg_options | [SvgOptions](/imaging/python-net/aspose.imaging.imageoptions/svgoptions/) | Параметры SVG. |
...
Создает новый объект [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/) с указанными шириной и <br/>            высотой. Этот конструктор позволяет разработчикам создавать изображения SVG с предопределенными <br/>            размерами, облегчая точный контроль над размером изображения во время <br/>            инициализации.
...
Инициализирует новый экземпляр класса [SvgImage](/imaging/python-net/aspose.imaging.fileformats.svg/svgimage/).
...
Измените размер изображения, чтобы он соответствовал указанным размерам, сохраняя его соотношение <br/>            сторон. Этот метод предоставляет удобный способ корректировать размер изображения <br/>            без искажения его пропорций, обеспечивая оптимальное отображение или хранение <br/>            в соответствии с желаемыми размерами.
...
Применяет указанную палитру к изображению, позволяя настраивать цветовые <br/>            схемы для эстетических или функциональных целей. Этот метод обеспечивает гибкость <br/>            в управлении цветовыми палитрами, чтобы соответствовать различным требованиям дизайна или применения.
