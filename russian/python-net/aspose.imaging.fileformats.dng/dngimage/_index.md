---
title: "DngImage Класс"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.fileformats.dng/dngimage/
---
...
| bits_per_pixel | int | r | Узнайте количество бит на пиксель в изображении без усилий с помощью этого <br/>            свойства. Идеально подходит для быстрого и точного понимания глубины пикселей изображения. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Определите формат файла вашего изображения с помощью этого свойства. Идеально подходит для <br/>            понимания формата — просто и понятно. |
...
| height | int | r | Получите высоту изображения с помощью этого свойства. Идеально подходит для определения <br/>            вертикального размера изображения без проблем. |
...
| img_data | [RawData](/imaging/python-net/aspose.imaging.fileformats.dng.decoder/rawdata/) | r/w | Управляйте данными изображения с помощью этого свойства. Независимо от того, получаете вы их или обновляете, <br/>            это свойство обеспечивает беспрепятственный доступ к данным изображения для эффективного <br/>            манипулирования. |
...
| width | int | r | Получите доступ к ширине изображения с помощью этого свойства. Идеально подходит для быстрого и эффективного получения <br/>            горизонтального размера изображения. |
...
| [save(stream)](#save_stream_100) | Сохраняет данные. |
