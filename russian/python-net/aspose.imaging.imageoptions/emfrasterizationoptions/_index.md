---
title: "Класс EmfRasterizationOptions"
type: docs
weight: 100
url: /ru/python-net/aspose.imaging.imageoptions/emfrasterizationoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfRasterizationOptions()](#EmfRasterizationOptions__1) | Создаёт новый экземпляр класса EmfRasterizationOptions. |
## **Properties**
...
| render_mode | [EmfRenderMode](/imaging/python-net/aspose.imaging.fileformats.emf/emfrendermode/) | r/w | Получает или задаёт режим рендеринга. |
...
Создаёт новый экземпляр класса EmfRasterizationOptions.
