---
title: "Класс EpsRasterizationOptions"
type: docs
weight: 110
url: /ru/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [EpsRasterizationOptions()](#EpsRasterizationOptions__1) | Инициализирует новый экземпляр класса [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/). |
## **Properties**
...
| preview_to_export | [EpsPreviewFormat](/imaging/python-net/aspose.imaging.fileformats.eps/epspreviewformat/) | r/w | Используйте [EpsImage.get_preview_image(format)](/imaging/python-net/aspose.imaging.fileformats.eps/epsimage/) для экспорта предварительного просмотра. |
...
Инициализирует новый экземпляр класса [EpsRasterizationOptions](/imaging/python-net/aspose.imaging.imageoptions/epsrasterizationoptions/).
