---
title: "Класс PdfOptions"
type: docs
weight: 240
url: /ru/python-net/aspose.imaging.imageoptions/pdfoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [PdfOptions()](#PdfOptions__1) | Инициализирует новый экземпляр класса [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/) |
## **Properties**
...
| page_size | [SizeF](/imaging/python-net/aspose.imaging/sizef/) | r/w | Получает или задает размер страницы. |
| palette | [IColorPalette](/imaging/python-net/aspose.imaging/icolorpalette/) | r/w | Получает или задает цветовую палитру. |
| pdf_core_options | [PdfCoreOptions](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfcoreoptions/) | r/w | Основные параметры PDF |
| pdf_document_info | [PdfDocumentInfo](/imaging/python-net/aspose.imaging.fileformats.pdf/pdfdocumentinfo/) | r/w | Получает или задает метаданные документа. |
...
| use_original_image_resolution | bool | r/w | Получает или задает значение, указывающее использовать оригинальное разрешение DPI изображения. |
...
Инициализирует новый экземпляр класса [PdfOptions](/imaging/python-net/aspose.imaging.imageoptions/pdfoptions/)
