---
title: "Класс OdRasterizationOptions"
type: docs
weight: 210
url: /ru/python-net/aspose.imaging.imageoptions/odrasterizationoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [OdRasterizationOptions()](#OdRasterizationOptions__1) | Создаёт новый экземпляр класса OdRasterizationOptions. |
## **Properties**
...
Создаёт новый экземпляр класса OdRasterizationOptions.
