---
title: "Класс WmfRecorderGraphics2D"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/
---
...
| **Name** | **Description** |
| :- | :- |
| [WmfRecorderGraphics2D(frame, inch)](#WmfRecorderGraphics2D_frame_inch_1) | Инициализирует новый экземпляр класса [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Получает или задает цвет фона. |
| background_mode | [WmfMixMode](/imaging/python-net/aspose.imaging.fileformats.wmf.consts/wmfmixmode/) | r/w | Получает или задает режим фона. |
...
| [from_wmf_image(wmf_image)](#from_wmf_image_wmf_image_32) | Получает экземпляр рекордера Wmf для существующего изображения Wmf. |
...
Инициализирует новый экземпляр класса [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/).

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| frame | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Прямоугольник назначения, измеренный в твипах, для отображения метафайла. |
...
| Тип | Описание |
| :- | :- |
| [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Полученное изображение. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| wmf_image | [WmfImage](/imaging/python-net/aspose.imaging.fileformats.wmf/wmfimage/) | Изображение Wmf, для которого нужно получить рекордер. |

**Returns**

| Тип | Описание |
| :- | :- |
| [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/) | Экземпляр класса [WmfRecorderGraphics2D](/imaging/python-net/aspose.imaging.fileformats.wmf.graphics/wmfrecordergraphics2d/). |
