---
title: "Класс TiffDoubleType"
type: docs
weight: 40
url: /ru/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffDoubleType(tag_id)](#TiffDoubleType_tag_id_1) | Инициализирует новый экземпляр класса [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
| [TiffDoubleType(tag_id)](#TiffDoubleType_tag_id_2) | Инициализирует новый экземпляр класса [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
## **Properties**
...
| values | float[] | r/w | Получает или задает значения. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Инициализирует новый экземпляр класса [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Инициализирует новый экземпляр класса [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/). |
...
Инициализирует новый экземпляр класса [TiffDoubleType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffdoubletype/).
