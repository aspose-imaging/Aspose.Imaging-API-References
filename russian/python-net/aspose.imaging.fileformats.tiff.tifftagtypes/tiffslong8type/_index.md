---
title: "Класс TiffSLong8Type"
type: docs
weight: 120
url: /ru/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_1) | Инициализирует новый экземпляр [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) класса. |
| [TiffSLong8Type(tag_id)](#TiffSLong8Type_tag_id_2) | Инициализирует новый экземпляр [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) класса. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| count | int | r | Получает количество элементов. |
| data_size | int | r | Получает размер значения тега. |
| element_size | System.Byte | r | Получает размер элемента. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Инициализирует новый экземпляр [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) класса. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Инициализирует новый экземпляр [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) класса. |
...
Инициализирует новый экземпляр [TiffSLong8Type](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffslong8type/) класса.
