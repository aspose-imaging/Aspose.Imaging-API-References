---
title: "Класс TiffUnknownType"
type: docs
weight: 180
url: /ru/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffUnknownType(stream, tag_type, tag_id, count, offset_or_value)](#TiffUnknownType_stream_tag_type_tag_id_count_offset_or_value_1) | Инициализирует новый экземпляр класса [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/). |
## **Properties**
...
| offset_or_value | int | r | Получает значение смещения для дополнительных данных или самого значения, если количество равно 1. |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | r | Получает поток для чтения дополнительных данных. |
...
| [get_additional_data_size(size_of_tag_value)](#get_additional_data_size_size_of_tag_value_3) | Получает размер дополнительного значения тега в байтах (в случае, если тег не может вместить всё значение тега). |
| [get_aligned_data_size(size_of_tag_value)](#get_aligned_data_size_size_of_tag_value_4) | Получает размер данных, выровненный по границе 4‑байтов (int) или 8‑байтов (long). |
| [read_tag(data_stream, position)](#read_tag_data_stream_position_5) | Читает данные тега. |
| [write_additional_data(data_stream)](#write_additional_data_data_stream_6) | Записывает дополнительные данные тега. |
| [write_tag(data_stream, additional_data_offset)](#write_tag_data_stream_additional_data_offset_7) | Записывает значение тега или дополнительное смещение. |
...
Инициализирует новый экземпляр класса [TiffUnknownType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffunknowntype/).

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| stream | [TiffStreamReader](/imaging/python-net/aspose.imaging.fileformats.tiff.filemanagement/tiffstreamreader/) | Поток для чтения. |
| tag_type | int | Тип тега. |
| tag_id | int | Идентификатор тега. |
| count | int | Значение счётчика. |
| offset_or_value | int | Смещение или значение. |
