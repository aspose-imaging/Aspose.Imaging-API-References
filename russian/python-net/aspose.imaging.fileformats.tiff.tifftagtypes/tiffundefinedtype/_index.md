---
title: "Класс TiffUndefinedType"
type: docs
weight: 170
url: /ru/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/
---
...
| **Name** | **Description** |
| :- | :- |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_1) | Инициализирует новый экземпляр [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) класса. |
| [TiffUndefinedType(tag_id)](#TiffUndefinedType_tag_id_2) | Инициализирует новый экземпляр [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) класса. |
## **Properties**
| **Name** | **Type** | **Access** | **Description** |
| :- | :- | :- | :- |
| count | int | r | Получает количество элементов. |
| данные | System.Byte | r/w | Получает или задает данные. |
...
| [create_with_tag(tag_id)](#create_with_tag_tag_id_2) | Инициализирует новый экземпляр [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) класса. |
| [create_with_tag_id(tag_id)](#create_with_tag_id_tag_id_3) | Инициализирует новый экземпляр [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) класса. |
...
Инициализирует новый экземпляр [TiffUndefinedType](/imaging/python-net/aspose.imaging.fileformats.tiff.tifftagtypes/tiffundefinedtype/) класса.
