---
title: "CdrUserPalette Класс"
type: docs
weight: 350
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdruserpalette/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrUserPalette()](#CdrUserPalette__1) | Инициализирует новый экземпляр класса CdrUserPalette |
## **Properties**
...
Инициализирует новый экземпляр класса CdrUserPalette
