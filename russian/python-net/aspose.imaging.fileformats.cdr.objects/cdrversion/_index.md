---
title: "Класс CdrVersion"
type: docs
weight: 370
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdrversion/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrVersion()](#CdrVersion__1) | Инициализирует новый экземпляр класса CdrVersion. |
## **Properties**
...
Инициализирует новый экземпляр класса CdrVersion.
