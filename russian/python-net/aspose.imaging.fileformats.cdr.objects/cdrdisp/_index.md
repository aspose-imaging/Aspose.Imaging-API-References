...
type: docs
weight: 70
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdrdisp/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrDisp()](#CdrDisp__1) | Инициализирует новый экземпляр класса CdrDisp |
## **Properties**
...
Инициализирует новый экземпляр класса CdrDisp
