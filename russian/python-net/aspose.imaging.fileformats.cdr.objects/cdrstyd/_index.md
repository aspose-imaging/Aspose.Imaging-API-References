...
type: docs
weight: 300
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdrstyd/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrStyd()](#CdrStyd__1) | Инициализирует новый экземпляр класса CdrStyd |
## **Properties**
...
Инициализирует новый экземпляр класса CdrStyd
