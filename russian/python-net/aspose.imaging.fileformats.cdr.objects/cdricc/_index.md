...
type: docs
weight: 150
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdricc/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrIcc()](#CdrIcc__1) | Инициализирует новый экземпляр класса CdrIcc |
## **Properties**
...
Инициализирует новый экземпляр класса CdrIcc
