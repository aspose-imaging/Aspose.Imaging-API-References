---
title: "CdrFillTransform Класс"
type: docs
weight: 110
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdrfilltransform/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrFillTransform()](#CdrFillTransform__1) | Инициализирует новый экземпляр класса CdrFillTransform |
## **Properties**
...
| transform | [Matrix](/imaging/python-net/aspose.imaging/matrix/) | r/w | Получает или задает преобразование. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Инициализирует новый экземпляр класса CdrFillTransform
