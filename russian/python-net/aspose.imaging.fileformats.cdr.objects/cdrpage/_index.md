...
type: docs
weight: 210
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdrpage/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrPage()](#CdrPage__1) | Инициализирует новый экземпляр класса CdrPage |
## **Properties**
...
| id | int | r/w | Получает или задает идентификатор. |
...
Инициализирует новый экземпляр класса CdrPage
