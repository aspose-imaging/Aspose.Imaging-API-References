...
type: docs
weight: 340
url: /ru/python-net/aspose.imaging.fileformats.cdr.objects/cdrudta/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrUdta()](#CdrUdta__1) | Инициализирует новый экземпляр класса CdrUdta |
## **Properties**
...
Инициализирует новый экземпляр класса CdrUdta
