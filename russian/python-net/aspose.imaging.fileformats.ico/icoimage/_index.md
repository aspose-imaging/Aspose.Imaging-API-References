---
title: "Класс IcoImage"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.fileformats.ico/icoimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [IcoImage(image, ico_options)](#IcoImage_image_ico_options_1) | Созданный для простоты и эффективности, класс [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) позволяет вам легко создавать ICO‑изображения. Этот конструктор инициализирует новый экземпляр класса, обеспечивая надёжную основу для ваших задач по обработке изображений. Независимо от того, разрабатываете ли вы приложения или улучшаете пользовательские интерфейсы, класс [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) упрощает управление ICO‑изображениями, позволяя сосредоточиться на предоставлении исключительного опыта. |
| [IcoImage(width, height, options)](#IcoImage_width_height_options_2) | Начните создание ICO‑изображений без усилий, используя класс [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/). Этот конструктор позволяет инициализировать новые экземпляры ICO‑изображений, указывая параметры ширины, высоты и опций создания. С помощью этого простого конструктора вы можете адаптировать ICO‑изображения к точным требованиям, обеспечивая бесшовную совместимость и визуальную привлекательность на разных платформах и устройствах. |
## **Properties**
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Получайте формат файла без усилий с помощью этого свойства, обеспечивая бесшовную интеграцию в ваш рабочий процесс. Используя это свойство, вы получаете доступ к важной информации о формате вашего файла, гарантируя совместимость и эффективную обработку. |
| has_alpha | bool | r | Определите, присутствует ли альфа‑канал в данном экземпляре, с помощью этого свойства. Оно предоставляет быстрый способ проверить, содержит ли изображение или документ альфа‑канал, что имеет решающее значение для различных задач обработки и рендеринга изображений. Идеально подходит для обеспечения совместимости и управления эффектами прозрачности в изображениях или документах. |
...
| page_count | int | r | Получите мгновенное представление о структуре документа с помощью этого простого свойства. При вызове этого свойства вы без труда получаете общее количество страниц, содержащихся в файле. |
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Получайте полную информацию о страницах документа без усилий через <br/>            это свойство. При доступе к этому свойству вы получаете коллекцию или массив <br/>            , содержащий все страницы, присутствующие в документе. |
...
| **Name** | **Description** |
| :- | :- |
| [add_page(page)](#add_page_page_1) | Расширьте ваше ICO‑изображение, добавив запись страницы изображения, используя <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Этот метод без проблем встраивает растровые изображения в <br/>            ваш ICO‑файл, преобразуя их в высококачественный 32‑битный PNG‑формат. Идеально подходит для <br/>            улучшения ваших ICO‑файлов растровыми изображениями при обеспечении оптимальной совместимости <br/>            и качества рендеринга. |
| [add_page(page)](#add_page_page_2) | Расширьте ваше ICO‑изображение, добавив запись страницы изображения, используя <br/>            [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Этот метод без проблем встраивает растровые изображения в <br/>            ваш ICO‑файл, преобразуя их в высококачественный 32‑битный PNG‑формат. Идеально подходит для <br/>            улучшения ваших ICO‑файлов растровыми изображениями при обеспечении оптимальной совместимости <br/>            и качества рендеринга. |
| [add_page(page, ico_options)](#add_page_page_ico_options_3) | Разнообразьте ваше ICO‑изображение без усилий, интегрировав запись изображения, адаптированную к <br/>            вашим потребностям с указанными [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Этот метод без проблем <br/>            встраивает изображение согласно вашим пользовательским настройкам, обеспечивая гибкость <br/>            и точность в вашем ICO‑файле. |
| [add_raster_page(page)](#add_raster_page_page_4) | Добавляет запись изображения в ICO‑изображение согласно параметрам по умолчанию [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) в виде 32‑битного PNG. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_5) | Регулировка _яркости_ изображения. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_6) | [Image](/imaging/python-net/aspose.imaging/image/) контрастирование |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_7) | Гамма‑коррекция изображения. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_8) | Гамма‑коррекция изображения. |
...
| [binarize_fixed(threshold)](#binarize_fixed_threshold_12) | Бинаризация изображения с предопределённым порогом |
...
| [can_load(stream)](#can_load_stream_17) | Определяет, содержит ли указанный поток ICO‑изображение. |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_34) | Обрезать изображение со смещениями. |
...
| [remove_page(index)](#remove_page_index_79) | Точно настройте ваше ICO‑изображение, удалив конкретную запись изображения, расположенную по <br/>            указанному ***index*** в файле. Этот метод обеспечивает точный <br/>            контроль над композицией изображения, позволяя легко доработать ваш ICO‑файл. |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_83) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное альфа‑значение для сохранения плавных краёв.<br/>                Примечание: если использовать его для изображений без прозрачности, все цвета будут заменены одним. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_84) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное альфа‑значение для сохранения плавных краёв.<br/>                Примечание: если использовать его для изображений без прозрачности, все цвета будут заменены одним. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | [RasterCachedMultipageImage.rotate(angle, resize_proportionally, background_color)](/imaging/python-net/aspose.imaging/rastercachedmultipageimage/) изображение вокруг центра. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | Поворачивает, отражает или одновременно поворачивает и отражает все страницы. |
...
| [save(file_path, options)](#save_file_path_options_103) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
...
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_108) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_109) | Сохраняет 32-битные ARGB‑пиксели. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_110) | Сохраняет пиксели. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_111) | Сохраняет пиксели.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_112) | Сохраняет основные внутренние пиксели. |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_113) | Сохраняет необработанные данные. |
| [save_to_stream(stream)](#save_to_stream_stream_114) | Сохраняет данные объекта в указанный поток. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_115) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_116) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_117) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_118) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_119) | Устанавливает 32‑битный ARGB‑пиксель изображения для указанной позиции. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_120) | Устанавливает палитру изображения. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_121) | Устанавливает пиксель изображения для указанной позиции. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_122) | Устанавливает разрешение для этого [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_123) | Пытается установить экземпляр _metadata_, если этот экземпляр [Image](/imaging/python-net/aspose.imaging/image/) поддерживает и реализует экземпляр [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_124) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_125) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
...
Созданный для простоты и эффективности, класс [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) позволяет вам легко создавать ICO‑изображения. Этот конструктор инициализирует новый экземпляр класса, обеспечивая надёжную основу для ваших задач по обработке изображений. Независимо от того, разрабатываете ли вы приложения или улучшаете пользовательские интерфейсы, класс [IcoImage](/imaging/python-net/aspose.imaging.fileformats.ico/icoimage/) упрощает управление ICO‑изображениями, позволяя сосредоточиться на предоставлении исключительного опыта.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| image | [Image](/imaging/python-net/aspose.imaging/image/) | Изображение. |
| ico_options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | Параметры ICO. |
...
| width | int | Ширина. |
| height | int | Высота. |
| options | [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) | Параметры создания ICO. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| page | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Изображение. |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| page | [Image](/imaging/python-net/aspose.imaging/image/) | Изображение. |
...
Разнообразьте ваше ICO‑изображение без усилий, интегрировав запись изображения, адаптированную к <br/>            вашим потребностям с указанными [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/). Этот метод без проблем <br/>            встраивает изображение согласно вашим пользовательским настройкам, обеспечивая гибкость <br/>            и точность в вашем ICO‑файле.
...
Добавляет запись изображения в ICO‑изображение согласно параметрам по умолчанию [IcoOptions](/imaging/python-net/aspose.imaging.imageoptions/icooptions/) в виде 32‑битного PNG.
...
Определяет, содержит ли указанный поток ICO‑изображение.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| поток | _io.BufferedRandom | Поток изображения. |

**Returns**

| Тип | Описание |
| :- | :- |
| bool | **True**, если поток содержит ICO‑изображение; иначе **False** |
...
Точно настройте ваше ICO‑изображение, удалив конкретную запись изображения, расположенную по <br/>            указанному ***index*** в файле. Этот метод обеспечивает точный <br/>            контроль над композицией изображения, позволяя легко доработать ваш ICO‑файл.
