---
title: "AvifImage Класс"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.fileformats.avif/avifimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [AvifImage()](#AvifImage__1) | Инициализирует новый экземпляр класса AvifImage |
## **Properties**
...
| bits_per_pixel | int | r | Получает значение бит на пиксель. |
...
| height | int | r | Получает высоту изображения AVIF. |
...
| width | int | r | Получает ширину изображения AVIF. |
...
Инициализирует новый экземпляр класса AvifImage
