---
title: "Класс DjvuPage"
type: docs
weight: 20
url: /ru/python-net/aspose.imaging.fileformats.djvu/djvupage/
---
...
| height | int | r | Получает высоту страницы |
...
| image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r | Получает изображение. |
...
| is_color | bool | r | Получает значение, указывающее, является ли этот экземпляр цветным. |
...
| page_number | int | r | Получает номер страницы. |
...
| parent_image | [DjvuImage](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuimage/) | r | Получает родительское изображение, к которому относится страница |
...
| thumbnail_image | [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | r/w | Получает или задает миниатюрное изображение для страницы |
...
| width | int | r | Получает ширину страницы |
...
| [embed_digital_signature(password)](#embed_digital_signature_password_34) | Встроить цифровую подпись, основанную на предоставленном пароле, в изображение с помощью стеганографии. |
| [extract_thumbnail_image()](#extract_thumbnail_image__35) | Извлекает миниатюрное изображение из страницы Djvu. |
| [filter(rectangle, options)](#filter_rectangle_options_36) | Фильтрует указанный прямоугольник. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_37) | Получает 32-битный ARGB‑пиксель изображения. |
| [get_background_image()](#get_background_image__38) | Получает фоновое изображение. |
...
| [get_foreground_image(subsample)](#get_foreground_image_subsample_49) | Получает изображение переднего плана для страницы |
| [get_modify_date(use_default)](#get_modify_date_use_default_50) | Получает дату и время последнего изменения ресурса изображения. |
...
| [get_pixel(x, y)](#get_pixel_x_y_52) | Получает пиксель изображения. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_53) | Получает пропорциональную высоту. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_54) | Получает пропорциональную ширину. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_55) | Преобразует в aps. |
| [get_skew_angle()](#get_skew_angle__56) | Получает угол наклона.<br/>            Этот метод применим к отсканированным текстовым документам для определения угла наклона при сканировании. |
| [get_text_for_location(rect)](#get_text_for_location_rect_57) | Получает текст для расположения прямоугольника |
| [get_text_image(subsample)](#get_text_image_subsample_58) | Получает изображение текста. |
...
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | Изменяет размер изображения страницы до новых размеров |
...
| [save(stream)](#save_stream_105) | Сохраняет данные. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_121) | Устанавливает разрешение для этого [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| Тип | Описание |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Растровое изображение Djvu. |
...
| Тип | Описание |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Битмап |
...
| Тип | Описание |
| :- | :- |
| [DjvuRaster](/imaging/python-net/aspose.imaging.fileformats.djvu/djvuraster/) | Битовое изображение |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| rect | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Прямоугольник местоположения. |

**Returns**

| Тип | Описание |
| :- | :- |
| string | Текст, найденный в месте |
...
Изменяет размер изображения страницы до новых размеров
