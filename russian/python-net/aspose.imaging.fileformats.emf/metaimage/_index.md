---
title: "Класс MetaImage"
type: docs
weight: 3140
url: /ru/python-net/aspose.imaging.fileformats.emf/metaimage/
---
...
| [get_used_fonts()](#get_used_fonts__34) | Возвращает список шрифтов, используемых внутри метафайла. |
...
| [resize_canvas(new_rectangle)](#resize_canvas_new_rectangle_48) | Изменяет размер холста. |
