---
title: "Класс EmfHeaderExtension2"
type: docs
weight: 100
url: /ru/python-net/aspose.imaging.fileformats.emf.emf.objects/emfheaderextension2/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmfHeaderExtension2()](#EmfHeaderExtension2__1) | Инициализирует новый экземпляр класса EmfHeaderExtension2. |
## **Properties**
...
| micrometers_x | int | r/w | Получает или задает 32-битный горизонтальный размер дисплейного устройства, для которого было сгенерировано изображение метафайла, в микрометрах. |
| micrometers_y | int | r/w | Получает или задает 32-битный вертикальный размер дисплейного устройства, для которого было сгенерировано изображение метафайла, в микрометрах. |
