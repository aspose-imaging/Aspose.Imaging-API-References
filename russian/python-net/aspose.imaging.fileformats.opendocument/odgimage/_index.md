---
title: "Класс OdgImage"
type: docs
weight: 490
url: /ru/python-net/aspose.imaging.fileformats.opendocument/odgimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [OdgImage(stream_container)](#OdgImage_stream_container_1) | Создан для бесшовной интеграции в программные решения, конструктор [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) инициализирует новый экземпляр, используя потоковый контейнер. Этот метод <br/>            обеспечивает эффективную работу с данными ODG‑изображений в программных средах, оптимизируя <br/>            использование ресурсов и облегчая упрощённые рабочие процессы обработки изображений. |
| [OdgImage(stream_container, options)](#OdgImage_stream_container_options_2) | Начните новое создание объекта класса [OdgImage](/imaging/python-net/aspose.imaging.fileformats.opendocument/odgimage/) с <br/>            инициацией нового экземпляра. Используйте потенциал потокового контейнера в сочетании <br/>            с параметрами опций загрузки, поддерживая универсальный конструктор для беспрепятственной загрузки <br/>            изображений. Этот конструктор обеспечивает эффективную работу с изображениями, предлагая настраиваемые <br/>            конфигурации загрузки для повышения адаптивности и производительности в различных сценариях. |
## **Properties**
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Получая коллекцию страниц, это свойство позволяет получить доступ ко всей <br/>            совокупности страниц, связанных с изображением. При доступе к этому свойству разработчики могут <br/>            проходить по отдельным страницам, извлекать конкретные страницы по их индексу или <br/>            выполнять пакетные операции над всей коллекцией. |
...
| options | [LoadOptions](/imaging/python-net/aspose.imaging/loadoptions/) | Параметры загрузки |
