---
title: "Класс RectangleMask"
type: docs
weight: 80
url: /ru/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/
---
...
| **Name** | **Description** |
| :- | :- |
| [RectangleMask(selected_area)](#RectangleMask_selected_area_1) | Инициализирует новый экземпляр класса [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) с указанным прямоугольником. |
| [RectangleMask(x, y, width, height)](#RectangleMask_x_y_width_height_2) | Инициализирует новый экземпляр класса [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) с указанной левой верхней точкой, шириной и высотой. |
## **Properties**
...
Инициализирует новый экземпляр класса [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) с указанным прямоугольником.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| selected_area | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | Выбранная область, указана как прямоугольник. |
...
Инициализирует новый экземпляр класса [RectangleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/rectanglemask/) с указанной левой верхней точкой, шириной и высотой.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| x | int | Координата x левой верхней точки выбранной области. |
| y | int | Координата y левой верхней точки выбранной области. |
...
| Тип | Описание |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Обрезанный RectangleMask в виде ImageMask. |
...
| Тип | Описание |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Надутый RectangleMask в виде ImageMask. |
