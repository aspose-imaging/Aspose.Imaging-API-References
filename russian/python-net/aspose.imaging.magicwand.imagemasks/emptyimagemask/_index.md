---
title: "Класс EmptyImageMask"
type: docs
weight: 20
url: /ru/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/
---
...
| **Name** | **Description** |
| :- | :- |
| [EmptyImageMask(width, height)](#EmptyImageMask_width_height_1) | Инициализирует новый экземпляр класса [EmptyImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/) с указанными шириной и высотой. |
## **Properties**
...
Инициализирует новый экземпляр класса [EmptyImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/emptyimagemask/) с указанными шириной и высотой.
...
| Тип | Описание |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Обрезанный EmptyImageMask как ImageMask. |
...
| Тип | Описание |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Раздутый EmptyImageMask как ImageMask. |
