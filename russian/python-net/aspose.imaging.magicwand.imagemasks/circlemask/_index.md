---
title: "Класс CircleMask"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.magicwand.imagemasks/circlemask/
---
...
| **Name** | **Description** |
| :- | :- |
| [CircleMask(center, radius)](#CircleMask_center_radius_1) | Инициализирует новый экземпляр класса [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) с указанными точкой центра и радиусом. |
| [CircleMask(x, y, radius)](#CircleMask_x_y_radius_2) | Инициализирует новый экземпляр класса [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) с указанными точкой центра и радиусом. |
## **Properties**
...
| selection_bounds | [Rectangle](/imaging/python-net/aspose.imaging/rectangle/) | r | Получает границы, в пикселях, этой маски. |
...
Инициализирует новый экземпляр класса [CircleMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/circlemask/) с указанными точкой центра и радиусом.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| center | [Point](/imaging/python-net/aspose.imaging/point/) | Центральная точка выбранной области. |
| радиус | int | Радиус выбранной области. |
...
| Тип | Описание |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Обрезанная CircleMask или ImageBitMask в виде ImageMask.<br/>            Поскольку может быть возвращён ImageBitMask, рекомендуется использовать fluent‑вызов. |
...
| Тип | Описание |
| :- | :- |
| [ImageMask](/imaging/python-net/aspose.imaging.magicwand.imagemasks/imagemask/) | Надутый CircleMask в виде ImageMask. |
