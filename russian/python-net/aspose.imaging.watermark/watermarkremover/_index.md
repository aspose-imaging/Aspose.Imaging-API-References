---
title: "WatermarkRemover Класс"
type: docs
weight: 40
url: /ru/python-net/aspose.imaging.watermark/watermarkremover/
---
...
| **Name** | **Description** |
| :- | :- |
| [paint_over(source, options)](#paint_over_source_options_1) | Удалить водяной знак с растрового изображения. |
...
Удалить водяной знак с растрового изображения.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| source | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Исходное растровое изображение. |
| options | [WatermarkOptions](/imaging/python-net/aspose.imaging.watermark.options/watermarkoptions/) | Параметры водяного знака. |

**Returns**

| Тип | Описание |
| :- | :- |
| [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Полученное изображение. |
