---
title: "Класс EpsOptions"
type: docs
weight: 30
url: /ru/python-net/aspose.imaging.fileformats.eps/epsoptions/
---
...
| **Name** | **Description** |
| :- | :- |
| [EpsOptions()](#EpsOptions__1) | Инициализирует новый экземпляр класса EpsOptions |
## **Properties**
...
| sub_type | [EpsType](/imaging/python-net/aspose.imaging.fileformats.eps.consts/epstype/) | r/w | Получает или задает подтип формата EPS. |
...
Инициализирует новый экземпляр класса EpsOptions
