...
type: docs
weight: 7880
url: /ru/python-net/aspose.imaging/vectorimage/
---
...
| [save(stream)](#save_stream_60) | Сохраняет данные объекта в указанный поток. |
...
| [try_set_metadata(metadata)](#try_set_metadata_metadata_69) | Пытается установить экземпляр _metadata_, если данный экземпляр [Image](/imaging/python-net/aspose.imaging/image/) поддерживает и реализует тип [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
