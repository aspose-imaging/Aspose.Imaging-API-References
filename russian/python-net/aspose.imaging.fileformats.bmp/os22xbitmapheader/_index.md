---
title: "Класс Os22XBitmapHeader"
type: docs
weight: 80
url: /ru/python-net/aspose.imaging.fileformats.bmp/os22xbitmapheader/
---
...
| color_encoding | int | r | Получает кодировку цвета. |
...
| идентификатор | int | r | Получает идентификатор. |
| recording | int | r | Получает запись. |
| rendering | int | r | Получает рендеринг. |
| зарезервировано | int | r | Получает зарезервированное. |
| size1 | int | r | Получает size1. |
| size2 | int | r | Получает size2. |
| units | int | r | Получает единицы измерения. |
