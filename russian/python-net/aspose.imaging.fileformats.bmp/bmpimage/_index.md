---
title: "Класс BmpImage"
type: docs
weight: 50
url: /ru/python-net/aspose.imaging.fileformats.bmp/bmpimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [BmpImage(path)](#BmpImage_path_1) | Начните использовать класс BmpImage без усилий с этим конструктором, который<br/>            инициализирует новый экземпляр. Идеально подходит для разработчиков, желающих быстро и эффективно работать с объектами [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/). |
| [BmpImage(path, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)](#BmpImage_path_bits_per_pixel_compression_horizontal_resolution_vertical_resolution_2) | Без усилий создайте новый экземпляр класса [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) с помощью этого конструктора,<br/>            используя указанные параметры, такие как путь, bitsPerPixel и сжатие. Идеально подходит для разработчиков,<br/>            желающих быстро и эффективно инициализировать объекты BmpImage с точным контролем<br/>            над характеристиками изображения. |
| [BmpImage(raster_image)](#BmpImage_raster_image_3) | Без усилий создайте новый экземпляр класса [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/)<br/>            путем инициализации его объектом RasterImage. Идеально подходит для разработчиков, желающих<br/>            бесшовно преобразовать существующие растровые изображения в формат BmpImage, обеспечивая<br/>            совместимость и простоту интеграции в их проекты. |
| [BmpImage(raster_image, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)](#BmpImage_raster_image_bits_per_pixel_compression_horizontal_resolution_vertical_resolution_4) | Начните работать с классом [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) без проблем, создавая новый экземпляр<br/>            с использованием rasterImage и указанных параметров, таких как bitsPerPixel и сжатие.<br/>            Идеально подходит для разработчиков, ищущих простой способ работы с объектами BmpImage,<br/>            обеспечивая гибкость и эффективность в их проектах. |
| [BmpImage(stream)](#BmpImage_stream_5) | Начните использовать класс [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) без усилий, инициализируя новый экземпляр<br/>            с помощью этого конструктора, используя поток в качестве входных данных. Идеально подходит для разработчиков, ищущих<br/>            удобный способ работы с объектами BmpImage из различных источников данных,<br/>            обеспечивая гибкость и простоту интеграции. |
| [BmpImage(stream, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)](#BmpImage_stream_bits_per_pixel_compression_horizontal_resolution_vertical_resolution_6) | Начните работать с классом [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) без проблем, создавая<br/>            новый экземпляр с использованием потока и указанных параметров, таких как bitsPerPixel<br/>            и сжатие. Идеально подходит для разработчиков, ищущих простой способ работы с<br/>            объектами BmpImage, обеспечивая гибкость и эффективность в их проектах. |
| [BmpImage(width, height)](#BmpImage_width_height_7) | Начните использовать класс [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) без усилий, создавая новый экземпляр<br/>            с указанными параметрами ширины и высоты. Идеально подходит для разработчиков, ищущих<br/>            удобный способ создания объектов BmpImage с пользовательскими размерами, обеспечивая<br/>            гибкость и простоту интеграции в их проекты. |
| [BmpImage(width, height, bits_per_pixel, palette)](#BmpImage_width_height_bits_per_pixel_palette_8) | Начните использовать класс [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) без проблем, инициализируя новый экземпляр<br/>            с параметрами, такими как ширина, высота, глубина цвета и палитра. Идеально подходит для<br/>            разработчиков, ищущих простой способ создания объектов BmpImage с<br/>            пользовательскими размерами и цветовыми конфигурациями, обеспечивая гибкость и эффективность в их проектах. |
| [BmpImage(width, height, bits_per_pixel, palette, compression, horizontal_resolution, vertical_resolution)](#BmpImage_width_height_bits_per_pixel_palette_compression_horizontal_resolution_vertical_resolution_9) | Без усилий создайте новый экземпляр класса [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) с этим конструктором,<br/>            указывая параметры, такие как ширина, высота, bitsPerPixel и палитра. Идеально подходит для разработчиков,<br/>            ищущих удобный способ создания объектов BmpImage с пользовательскими размерами<br/>            и цветовыми конфигурациями, обеспечивая гибкость и простоту интеграции в их проекты. |
## **Properties**
...
| [bitmap_info_header](#bitmap_info_header1) | [BitmapInfoHeader](/imaging/python-net/aspose.imaging.fileformats.bmp/bitmapinfoheader/) | r | Быстро получите основные сведения о вашем битовом изображении с помощью этой простой функции.<br/>            Идеально подходит для разработчиков, которым необходимо извлечь информацию заголовка их изображений. |
| [bits_per_pixel](#bits_per_pixel2) | int | r | Легко получите количество бит на пиксель изображения, используя это свойство.<br/>            Идеально подходит для разработчиков, ищущих быструю информацию о качестве и глубине изображения. |
...
| [compression](#compression3) | [BitmapCompression](/imaging/python-net/aspose.imaging.fileformats.bmp/bitmapcompression/) | r | Получите тип сжатия, используемый для изображения, без усилий с помощью этого свойства.<br/>            Идеально для разработчиков, которым необходимо быстро получать информацию о сжатии изображения. |
...
| [file_format](#file_format4) | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Легко получите значение формата файла с помощью этого удобного свойства.<br/>            Идеально для разработчиков, ищущих быстрый доступ к информации о формате файла. |
...
| has_transparent_color | bool | r/w | Получает или задаёт значение, указывающее, имеет ли этот экземпляр [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) прозрачный цвет. |
| [height](#height5) | int | r | Получите высоту изображения без усилий с помощью этого свойства. Идеально для разработчиков<br/>            которым нужен быстрый доступ к информации о размерах изображения. |
| [horizontal_resolution](#horizontal_resolution6) | float | r/w | Это свойство позволяет вам легко получить или установить горизонтальное разрешение,<br/>            измеряемое в пикселях на дюйм, объекта [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). Идеально для<br/>            разработчиков, которым нужен точный контроль над разрешением изображения в их приложениях. |
...
| [raw_data_format](#raw_data_format7) | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Легко получите формат ваших необработанных данных с помощью этой удобной функции.<br/>            Идеально для разработчиков, желающих быстро получить важную информацию о формате их данных. |
...
| [raw_line_size](#raw_line_size8) | int | r | Быстро получите размер каждой необработанной строки в байтах с помощью этого простого свойства.<br/>            Идеально для разработчиков, которым необходимо эффективно работать с необработанными данными изображения. |
...
| [vertical_resolution](#vertical_resolution9) | float | r/w | Легко получите или задайте вертикальное разрешение, измеряемое в пикселях на дюйм,<br/>            этого объекта [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) с помощью этого свойства. Идеально для разработчиков, требующих<br/>            точный контроль над разрешением изображения в их приложениях. |
| [width](#width10) | int | r | Получите ширину изображения легко с помощью этого свойства. Идеально для разработчиков<br/>            ищущих быструю информацию о размерах изображения. |
...
| [create_from_file_with_params(path, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)](#create_from_file_with_params_path_bits_per_pixel_compression_horizontal_resolution_vertical_resolution_26) | Легко начните использовать класс BmpImage с этим конструктором, упрощая<br/>            процесс инициализации нового экземпляра. Идеально для разработчиков, ищущих<br/>            быстрый и эффективный способ включить объекты [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) в свои проекты. |
| [create_from_files(files)](#create_from_files_files_27) | Создает многостраничное изображение, содержащее указанные файлы в виде страниц с отложенной загрузкой. |
| [create_from_files(files, throw_exception_on_load_error)](#create_from_files_files_throw_exception_on_load_error_28) | Создает многостраничное изображение, содержащее указанные файлы в виде страниц с отложенной загрузкой. |
| [create_from_image(raster_image)](#create_from_image_raster_image_29) | Инициализирует новый экземпляр класса [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/). |
| [create_from_image_with_params(raster_image, bits_per_pixel, compression, horizontal_resolution, vertical_resolution)](#create_from_image_with_params_raster_image_bits_per_pixel_compression_horizontal_resolution_vertical_resolution_30) | Инициализирует новый экземпляр класса [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | Инициализирует новый экземпляр класса [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/). |
...
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_35) | Обрезать изображение со смещениями. |
| [crop(rectangle)](#crop_rectangle_36) | Обрезка изображения. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_37) | Выполняет дизеринг текущего изображения. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_38) | Выполняет дизеринг текущего изображения. |
| [embed_digital_signature(password)](#embed_digital_signature_password_39) | Встроить цифровую подпись, основанную на предоставленном пароле, в изображение с помощью стеганографии. |
| [filter(rectangle, options)](#filter_rectangle_options_40) | Фильтрует указанный прямоугольник. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_41) | Получает 32-битный ARGB‑пиксель изображения. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_42) | Получает массив пикселей по умолчанию в формате 32‑бит ARGB. |
| [get_default_options(args)](#get_default_options_args_43) | Получите параметры по умолчанию без усилий с помощью этого простого метода.<br/>            Идеально для разработчиков, ищущих быстрый доступ к настройкам или конфигурациям изображения по умолчанию. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_44) | Получает массив пикселей по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_45) | Получает массив необработанных данных по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_46) | Получает массив необработанных данных по умолчанию. |
| [get_file_format(file_path)](#get_file_format_file_path_47) | Получает формат файла. |
| [get_file_format(stream)](#get_file_format_stream_48) | Получает формат файла. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_49) | Получает формат файла. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_50) | Получает прямоугольник, соответствующий текущему изображению. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_51) | Получает прямоугольник, соответствующий текущему изображению. |
| [get_modify_date(use_default)](#get_modify_date_use_default_52) | Получает дату и время последнего изменения ресурса изображения. |
| [get_original_options()](#get_original_options__53) | Получает параметры на основе настроек оригинального файла.<br/>            Это может быть полезно для сохранения глубины цвета и других параметров оригинального изображения без изменений.<br/>            Например, если мы загружаем черно‑белое PNG‑изображение с 1 битом на пиксель и затем сохраняем его с помощью<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/) метода, будет получено PNG‑изображение с 8‑битами на пиксель.<br/>            Чтобы избежать этого и сохранить PNG‑изображение с 1‑битом на пиксель, используйте этот метод для получения соответствующих параметров сохранения и передайте их<br/>            в метод [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) в качестве второго параметра. |
| [get_pixel(x, y)](#get_pixel_x_y_54) | Получает пиксель изображения. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_55) | Получает пропорциональную высоту. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_56) | Получает пропорциональную ширину. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_57) | Преобразует в aps. |
| [get_skew_angle()](#get_skew_angle__58) | Получает угол наклона.<br/>            Этот метод применим к отсканированным текстовым документам для определения угла наклона при сканировании. |
| grayscale() | Преобразование изображения в его градации серого |
| [is_digital_signed(password, percentage_threshold)](#is_digital_signed_password_percentage_threshold_59) | Выполняет быструю проверку, чтобы определить, подписано ли изображение цифровой подписью, используя предоставленный пароль и пороговое значение. |
| [load(file_path)](#load_file_path_60) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(file_path, load_options)](#load_file_path_load_options_61) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(stream)](#load_stream_62) | Загружает новое изображение из указанного потока. |
| [load(stream, load_options)](#load_stream_load_options_63) | Загружает новое изображение из указанного потока. |
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_64) | Загружает 32‑битные ARGB‑пиксели. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_65) | Загружает 64‑битные ARGB‑пиксели. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_66) | Загружает пиксели в формате CMYK. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_67) | Загружает пиксели в формате CMYK.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.load_cmyk_32_pixels(rectangle)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_68) | Частично загружает 32‑битные ARGB‑пиксели (по блокам). |
| [load_partial_argb_64_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_69) | Частично загружает 64‑битные ARGB‑пиксели пакетами. |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_70) | Частично загружает пиксели пакетами. |
| [load_pixels(rectangle)](#load_pixels_rectangle_71) | Загружает пиксели. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_72) | Загружает необработанные данные. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_73) | Загружает необработанные данные. |
| [load_stream(stream)](#load_stream_stream_74) | Загружает новое изображение из указанного потока. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_75) | Загружает новое изображение из указанного потока. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_76) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
...
| [read_argb_32_scan_line(scan_line_index)](#read_argb_32_scan_line_scan_line_index_78) | Считывает всю строку сканирования по указанному индексу строки сканирования. |
| [read_scan_line(scan_line_index)](#read_scan_line_scan_line_index_79) | Считывает всю строку сканирования по указанному индексу строки сканирования. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_80) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_81) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_82) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_83) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_84) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
| [resize(new_width, new_height)](#resize_new_width_new_height_85) | Изменяет размер изображения. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_86) | Изменяет размер изображения. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_87) | Изменяет размер изображения. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_88) | Изменяет размер изображения. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_89) | Изменяет размер изображения. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_91) | Пропорционально изменяет высоту. |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_95) | Пропорционально изменяет ширину. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_99) | Повернуть изображение вокруг центра. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_100) | Вращает, отражает или вращает и отражает изображение. |
| save() | Сохраняет данные изображения в базовый поток. |
| [save(file_path)](#save_file_path_101) | Сохраняет изображение в указанное расположение файла. |
| [save(file_path, options)](#save_file_path_options_102) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_103) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, over_write)](#save_file_path_over_write_104) | Сохраняет данные объекта в указанное расположение файла. |
| [save(stream)](#save_stream_105) | Сохраняет данные объекта в указанный поток. |
| [save(stream, options_base)](#save_stream_options_base_106) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_107) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_108) | Сохраняет 32-битные ARGB‑пиксели. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_109) | Сохраняет пиксели. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_110) | Сохраняет пиксели.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_111) | Сохраняет пиксели (метод, специфичный для формата). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_112) | Сохраняет необработанные данные. |
| [save_to_stream(stream)](#save_to_stream_stream_113) | Сохраняет данные объекта в указанный поток. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_114) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_115) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_116) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_117) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_118) | Устанавливает 32‑битный ARGB‑пиксель изображения для указанной позиции. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_119) | Устанавливает палитру изображения. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_120) | Устанавливает пиксель изображения для указанной позиции. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_121) | Отрегулируйте разрешение вашего [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) без усилий с помощью этого<br/>            удобного метода. Идеально для разработчиков, ищущих точный контроль над<br/>            разрешением изображения в их приложениях. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_122) | Пытается установить экземпляр _metadata_, если этот экземпляр [Image](/imaging/python-net/aspose.imaging/image/) поддерживает и реализует экземпляр [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_123) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_124) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
...
Начните использовать класс BmpImage без усилий с этим конструктором, который<br/>            инициализирует новый экземпляр. Идеально подходит для разработчиков, желающих быстро и эффективно работать с объектами [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/).

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| путь | string | Путь, из которого загружается изображение и инициализируются данные пикселей и палитры. |
...
| :- | :- | :- |
| путь | string | Путь, из которого загружается изображение и инициализируются данные пикселей и палитры. |
| bits_per_pixel | int | Биты на пиксель. |
| compression | [BitmapCompression](/imaging/python-net/aspose.imaging.fileformats.bmp/bitmapcompression/) | Сжатие для использования. |
| horizontal_resolution | float | Горизонтальное разрешение. Обратите внимание, что из‑за округления полученное разрешение может немного отличаться от переданного. |
| vertical_resolution | float | Вертикальное разрешение. Обратите внимание, что из‑за округления полученное разрешение может немного отличаться от переданного. |
...
Без усилий создайте новый экземпляр класса [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/)<br/>            путем инициализации его объектом RasterImage. Идеально подходит для разработчиков, желающих<br/>            бесшовно преобразовать существующие растровые изображения в формат BmpImage, обеспечивая<br/>            совместимость и простоту интеграции в их проекты.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| raster_image | [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) | Изображение, с которым инициализируются данные пикселей и палитры. |
...
Начните использовать класс [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) без усилий, инициализируя новый экземпляр<br/>            с помощью этого конструктора, используя поток в качестве входных данных. Идеально подходит для разработчиков, ищущих<br/>            удобный способ работы с объектами BmpImage из различных источников данных,<br/>            обеспечивая гибкость и простоту интеграции.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| поток | _io.BufferedRandom | Поток, из которого загружается изображение и инициализируются данные пикселей и палитры. |
...
Начните использовать класс [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) без усилий, создавая новый экземпляр<br/>            с указанными параметрами ширины и высоты. Идеально подходит для разработчиков, ищущих<br/>            удобный способ создания объектов BmpImage с пользовательскими размерами, обеспечивая<br/>            гибкость и простоту интеграции в их проекты.
...
| height | int | Высота изображения. |
| bits_per_pixel | int | Биты на пиксель. |
| palette | [IColorPalette](/imaging/python-net/aspose.imaging/icolorpalette/) | Цветовая палитра. |
...
Быстро получите основные сведения о вашем битовом изображении с помощью этой простой функции.<br/>            Идеально подходит для разработчиков, которым необходимо извлечь информацию заголовка их изображений.
...
Легко получите количество бит на пиксель изображения, используя это свойство.<br/>            Идеально подходит для разработчиков, ищущих быструю информацию о качестве и глубине изображения.
...
Получите тип сжатия, используемый для изображения, без усилий с помощью этого свойства.<br/>            Идеально для разработчиков, которым необходимо быстро получать информацию о сжатии изображения.
...
Легко получите значение формата файла с помощью этого удобного свойства.<br/>            Идеально для разработчиков, ищущих быстрый доступ к информации о формате файла.
...
Получите высоту изображения без усилий с помощью этого свойства. Идеально для разработчиков<br/>            которым нужен быстрый доступ к информации о размерах изображения.
...
Это свойство позволяет вам легко получить или установить горизонтальное разрешение,<br/>            измеряемое в пикселях на дюйм, объекта [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). Идеально для<br/>            разработчиков, которым нужен точный контроль над разрешением изображения в их приложениях.
...
Легко получите формат ваших необработанных данных с помощью этой удобной функции.<br/>            Идеально для разработчиков, желающих быстро получить важную информацию о формате их данных.
...
Быстро получите размер каждой необработанной строки в байтах с помощью этого простого свойства.<br/>            Идеально для разработчиков, которым необходимо эффективно работать с необработанными данными изображения.
...
Легко получите или задайте вертикальное разрешение, измеряемое в пикселях на дюйм,<br/>            этого объекта [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) с помощью этого свойства. Идеально для разработчиков, требующих<br/>            точный контроль над разрешением изображения в их приложениях.
...
Получите ширину изображения легко с помощью этого свойства. Идеально для разработчиков<br/>            ищущих быструю информацию о размерах изображения.
...
Легко начните использовать класс BmpImage с этим конструктором, упрощая<br/>            процесс инициализации нового экземпляра. Идеально для разработчиков, ищущих<br/>            быстрый и эффективный способ включить объекты [BmpImage](/imaging/python-net/aspose.imaging.fileformats.bmp/bmpimage/) в свои проекты.
...
Получите параметры по умолчанию без усилий с помощью этого простого метода.<br/>            Идеально для разработчиков, ищущих быстрый доступ к настройкам или конфигурациям изображения по умолчанию.
...
Отрегулируйте разрешение вашего [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/) без усилий с помощью этого<br/>            удобного метода. Идеально для разработчиков, ищущих точный контроль над<br/>            разрешением изображения в их приложениях.
...
with Image.load(r"c:\temp\sample.bmp") as image:
	...
	#Формат пикселя: Rgb24Bpp, используемые каналы: 8,8,8
	...
	#Установите значения разрешения в 96 dpi
...
# Исходные пиксели будут преобразованы в формат 32‑bpp при необходимости.
with BmpImage(os.path.join(directory, "sample.bmp")) as bmp_image:
	# Выполнить обработку изображения.
	# Сохраните в другой BMP‑файл.
...
# Загрузите BMP‑изображение из файла.
# Исходные пиксели будут преобразованы в формат 24‑bpp при необходимости.
# Разрешение будет установлено в 96 dpi.
...
# Загрузите BMP‑изображение из файлового потока.
# Исходные пиксели будут преобразованы в формат 32‑bpp при необходимости.
...
# Создайте новое PNG‑изображение.
with PngOptions() as create_options:
	...
	with aspycore.as_of(Image.create(create_options, 100, 100), RasterImage) as raster_image:
		# Заполните всё изображение PNG красным цветом.
		gr = Graphics(raster_image)
		brush = SolidBrush(Color.red)
		gr.fill_rectangle(brush, raster_image.bounds)

		# Создайте BMP‑изображение на основе PNG‑изображения.
		# Исходные пиксели будут преобразованы в формат 32‑bpp при необходимости.
		with BmpImage(raster_image) as bmp_image:
			# Сохраните в BMP‑файл
...
# Создать BMP‑изображение с глубиной 32 бита на пиксель размером 100 × 100 пикселей.
...
# Создать BMP‑изображение с глубиной 24 бита на пиксель размером 100 × 100 пикселей.
with BmpImage(100, 100, 24, None) as bmp_image:
	print("FileFormat={0}, RawDataFormat={1}, HasAlpha={2}".format(bmp_image.file_format.name, bmp_image.raw_data_format, bmp_image.has_alpha))

# Как правило, BMP не поддерживает альфа‑канал, поэтому результат будет выглядеть так:
...
for compression in compressions:
	# Создайте BMP‑изображение 8‑bpp размером 100 × 100 px.
	with BmpImage(100, 100, 8, palette, compression, 0.0, 0.0) as bmp_image:
		...
		# Сохраните изображение в поток памяти, чтобы получить размер выходного изображения.
...
with Image.load(os.path.join(directory, "sample.bmp")) as image:
	...
	{
		# Используйте метод set_resolution для обновления обоих значений разрешения одним вызовом.
		print("Set resolution values to 96 dpi")
...
#Вывод может выглядеть так:
#Количество цветов палитры, необходимых для отображения битмапа: 0
#Количество цветов палитры, используемых в битмапе: 0
#Сжатие битмапа: 0
#Высота битмапа: 375
#Ширина битмапа: 500
#Размер необработанных данных битмапа в байтах: 562500
#Количество плоскостей: 1
#Горизонтальное разрешение битмапа, в пикселях на метр: 0
#Вертикальное разрешение битмапа, в пикселях на метр: 0
#Количество бит на пиксель: 24
#Дополнительные маски битов: 
