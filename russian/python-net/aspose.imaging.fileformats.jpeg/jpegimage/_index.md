---
title: "Класс JpegImage"
type: docs
weight: 20
url: /ru/python-net/aspose.imaging.fileformats.jpeg/jpegimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [JpegImage(jpeg_options, width, height)](#JpegImage_jpeg_options_width_height_1) | Инициализируйте новый объект [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) с предоставленными параметрами JPEG. <br/>            Этот конструктор позволяет настроить различные параметры JPEG‑изображения, такие <br/>            как уровень сжатия, качество и дополнительные параметры, обеспечивая точный контроль <br/>            над получаемым форматом изображения. |
| [JpegImage(path)](#JpegImage_path_2) | Класс [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) инициализируется без усилий при вызове его <br/>            конструктора с указанным параметром пути. Этот конструктор обеспечивает бесшовное <br/>            создание JPEG‑изображений, гарантируя быструю интеграцию в ваши проекты с легкостью. |
| [JpegImage(raster_image)](#JpegImage_raster_image_3) | Инициализируйте новый экземпляр класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) с параметром растрового изображения <br/>            . Этот конструктор предоставляет удобный способ создания JPEG‑изображений <br/>            непосредственно из растровых изображений, упрощая рабочий процесс работы с JPEG‑изображениями <br/>            в ваших приложениях. |
| [JpegImage(stream)](#JpegImage_stream_4) | Инициализируйте объект JPEG‑изображения с помощью класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) используя параметр <br/>            потока. Этот конструктор упрощает процесс работы с JPEG‑изображениями, предлагая простой подход для их интеграции в ваши проекты <br/>            без усилий. |
| [JpegImage(width, height)](#JpegImage_width_height_5) | Создайте новый экземпляр класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) с указанными параметрами ширины <br/>            и высоты. Этот конструктор позволяет создавать JPEG‑изображения с <br/>            пользовательскими размерами, предоставляя гибкость в управлении размерами изображений в вашем приложении. |
## **Properties**
...
| bits_per_pixel | int | r | Получайте глубину цвета изображения без усилий с помощью этого свойства, предоставляя <br/>            сведения о насыщенности цветового или градационного представления. Будь то <br/>            яркая фотография или монохромная иллюстрация, это свойство предоставляет важную <br/>            информацию о визуальной сложности изображения. |
...
| cmyk_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | Цветовой профиль CMYK, связанный с JPEG‑изображениями CMYK и YCCK, обеспечивает точное <br/>            преобразование цветов и достоверность. Он работает совместно с RGBColorProfile, чтобы <br/>            гарантировать точное воспроизведение цветов на различных устройствах и в приложениях. <br/>            Такое сочетание критически важно для поддержания согласованности цветопередачи и <br/>            достижения оптимального качества изображения. |
| comment | string | r/w | Управляйте комментариями JPEG‑файлов с помощью этого свойства, позволяющего добавлять или получать <br/>            описательные аннотации, связанные с изображением. Будь то пометка изображений <br/>            метаданными или добавление дополнительного контекста, это свойство обеспечивает гибкость в <br/>            организации и классификации ваших JPEG‑файлов. |
...
| destination_cmyk_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | Цветовой профиль CMYK имеет решающее значение для точного преобразования цветов JPEG‑изображений CMYK и YCCK <br/>            при сохранении. Он работает в паре с RGBColorProfile <br/>            чтобы обеспечить правильное воспроизведение цветов, поддерживая согласованность и качество на разных <br/>            устройствах и программном обеспечении. Эта синхронизация критически важна для достижения <br/>            точной и надёжной цветопередачи в окончательно сохранённых изображениях. |
| destination_rgb_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | RGBColorProfile необходим для точного преобразования цветов JPEG‑изображений CMYK и YCCK <br/>            при сохранении. В сочетании с CMYKColorProfile он <br/>            гарантирует корректное отображение цветов и поддерживает согласованность на разных <br/>            устройствах и в приложениях. Такое сочетание критически важно для сохранения <br/>            задуманного цветового представления и получения изображений высокого качества. |
| disposed | bool | r | Получает значение, указывающее, удалён ли этот экземпляр. |
| exif_data | [JpegExifData](/imaging/python-net/aspose.imaging.exif/jpegexifdata/) | r/w | Управляйте данными EXIF с помощью этого свойства, позволяющего добавлять или получать метаданные <br/>            , связанные с изображением. Будь то извлечение информации о настройках камеры <br/>            или изменение существующих метаданных, это свойство обеспечивает гибкость в <br/>            управлении контейнером данных EXIF. |
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Получайте формат изображения без усилий с помощью этого свойства. Оно предоставляет <br/>            ценную информацию о файловом формате, способствуя бесшовной интеграции и <br/>            проверкам совместимости на различных платформах и в приложениях. |
...
| height | int | r | Получайте высоту изображения без усилий с помощью этого свойства. Оно обеспечивает быстрый <br/>            доступ к вертикальному измерению изображения, позволяя эффективно <br/>            определить его размер и соотношение сторон без необходимости в сложных вычислениях или <br/>            дополнительных методах. |
| horizontal_resolution | float | r/w | Это свойство предоставляет вам доступ к горизонтальному разрешению <br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), измеряемому в пикселях на дюйм. Устанавливая или получая <br/>            это значение, вы можете точно контролировать разрешение изображения, гарантируя, что оно <br/>            соответствует вашим конкретным требованиям к качеству и чёткости. |
| ignore_embedded_color_profile | bool | r/w | Получает или изменяет флаг, указывающий, игнорируется ли встроенный цветовой профиль <br/>            . Устанавливая этот флаг, пользователи могут указать, следует ли использовать профиль цвета по умолчанию вместо встроенного. Эта опция обеспечивает более высокий <br/>            контроль над управлением цветом, облегчая настройку для согласованности и <br/>            совместимости на различных платформах и в приложениях. |
...
| jfif | [JFIFData](/imaging/python-net/aspose.imaging.fileformats.jpeg/jfifdata/) | r/w | Это свойство позволяет вам получить доступ к данным JFIF (JPEG File Interchange <br/>            Format), связанным с JPEG‑изображением, или изменить их. JFIF — это стандартный формат для <br/>            обмена JPEG‑сжатыми изображениями между компьютерами и другими устройствами. Получая <br/>            или устанавливая это свойство, вы можете работать с данными JFIF, которые могут включать <br/>            информацию, такую как разрешение изображения, соотношение сторон и миниатюру. |
| jpeg_options | [JpegOptions](/imaging/python-net/aspose.imaging.imageoptions/jpegoptions/) | r | Легко получите доступ к параметрам JPEG, используемым при создании или загрузке этого<br/>            [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) экземпляра. Это свойство предоставляет ценные детали <br/>            о конкретных применённых настройках, позволяя пользователям понять и воспроизвести <br/>            процессы обработки изображений эффективно. Будь то уровни сжатия, настройки качества <br/>            или другие параметры, это свойство предоставляет необходимую информацию для <br/>            беспроблемного манипулирования изображениями. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Это свойство получает формат необработанных данных изображения, который указывает, как <br/>            данные изображения структурированы и закодированы. Понимание формата необработанных данных <br/>            необходимо для эффективной обработки или манипулирования данными изображения. Оно предоставляет <br/>            сведения о внутреннем представлении изображения, например, сжато ли оно, закодировано в определённом цветовом пространстве или сохранено в конкретном файловом <br/>            формате. Доступ к этому свойству позволяет получить ценную информацию о <br/>            структуре данных изображения, позволяя выполнять различные операции или оптимизации <br/>            , адаптированные к его конкретному формату. |
...
| rgb_color_profile | [StreamSource](/imaging/python-net/aspose.imaging.sources/streamsource/) | r/w | RGB‑цветовой профиль для JPEG‑изображений CMYK и YCCK обеспечивает точное преобразование и представление цветов <br/>            . Он должен использоваться вместе с CMYKColorProfile для <br/>            поддержания согласованности и точности цветовой визуализации. Такое сочетание необходимо для <br/>            приложений, требующих точного управления цветом и воспроизведения изображений, <br/>            гарантируя правильную интерпретацию и отображение RGB‑данных. |
...
| vertical_resolution | float | r/w | Это свойство управляет вертикальным разрешением, выраженным в пикселях на дюйм, для <br/>            связанного  [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). Регулировка этого разрешения влияет на <br/>            размер и качество изображения при печати или отображении в фиксированном физическом размере. <br/>            Устанавливая это свойство, вы контролируете плотность вертикального размещения пикселей изображения, <br/>            что сказывается на общей чёткости и ясности. |
| width | int | r | Это свойство получает ширину изображения, выраженную в пикселях. Оно предоставляет <br/>            важную информацию о размерах изображения, позволяя точно отображать, <br/>            манипулировать или показывать данные изображения. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_28) | Инициализирует новый экземпляр класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/). |
| [create_from_images(images)](#create_from_images_images_29) | Создаёт новое изображение, используя указанные изображения в качестве страниц |
| [create_from_images(images, dispose_images)](#create_from_images_images_dispose_images_30) | Создает новое изображение из указанных изображений в виде страниц. |
| [create_from_stream(stream)](#create_from_stream_stream_31) | Инициализирует новый экземпляр класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/). |
...
| [crop(rectangle)](#crop_rectangle_33) | Обрезка изображения. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_34) | Выполняет дизеринг текущего изображения. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_35) | Выполняет дизеринг текущего изображения. |
| [embed_digital_signature(password)](#embed_digital_signature_password_36) | Встроить цифровую подпись, основанную на предоставленном пароле, в изображение с помощью стеганографии. |
| [filter(rectangle, options)](#filter_rectangle_options_37) | Фильтрует указанный прямоугольник. |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_49) | Получает дату и время последнего <br/>            изменения ресурса‑изображения. Этот метод предоставляет ценные метаданные, позволяя пользователям отслеживать и <br/>            эффективно управлять обновлениями файла изображения. Получая эту информацию, пользователи <br/>            могут обеспечить целостность и актуальность своих графических ресурсов, способствуя обоснованному <br/>            принятию решений относительно использования и обслуживания изображений. |
| [get_original_options()](#get_original_options__50) | Получает исходные параметры изображения данного экземпляра [Image](/imaging/python-net/aspose.imaging/image/). |
...
| [is_digital_signed(password, percentage_threshold)](#is_digital_signed_password_percentage_threshold_56) | Выполняет быструю проверку, чтобы определить, подписано ли изображение цифровой подписью, используя предоставленный пароль и пороговое значение. |
| [load(file_path)](#load_file_path_57) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(file_path, load_options)](#load_file_path_load_options_58) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(stream)](#load_stream_59) | Загружает новое изображение из указанного потока. |
| [load(stream, load_options)](#load_stream_load_options_60) | Загружает новое изображение из указанного потока. |
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_61) | Загружает 32‑битные ARGB‑пиксели. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_62) | Загружает 64‑битные ARGB‑пиксели. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_63) | Загружает пиксели в формате CMYK. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_64) | Загружает пиксели в формате CMYK.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.load_cmyk_32_pixels(rectangle)](/imaging/python-net/aspose.imaging/rasterimage/). |
...
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_80) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_81) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_83) | Изменяет размер изображения. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_84) | Изменяет размер изображения. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_88) | Пропорционально изменяет высоту. |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_92) | Пропорционально изменяет ширину. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_96) | Повернуть изображение вокруг центра. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_97) | Вращает, отражает или вращает и отражает изображение. |
| save() | Сохраняет данные изображения в базовый поток. |
| [save(file_path)](#save_file_path_98) | Сохраняет изображение в указанное расположение файла. |
| [save(file_path, options)](#save_file_path_options_99) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_100) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, over_write)](#save_file_path_over_write_101) | Сохраняет данные объекта в указанное расположение файла. |
| [save(stream)](#save_stream_102) | Сохраняет данные объекта в указанный поток. |
| [save(stream, options_base)](#save_stream_options_base_103) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_104) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_105) | Сохраняет 32-битные ARGB‑пиксели. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_106) | Сохраняет пиксели. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_107) | Сохраняет пиксели.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_108) | Сохраняет пиксели (метод, специфичный для формата). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_109) | Сохраняет необработанные данные. |
| [save_to_stream(stream)](#save_to_stream_stream_110) | Сохраняет данные объекта в указанный поток. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_111) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_112) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_113) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_114) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_115) | Устанавливает 32‑битный ARGB‑пиксель изображения для указанной позиции. |
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_116) | Устанавливает палитру изображения. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_117) | Устанавливает пиксель изображения для указанной позиции. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_118) | Устанавливает разрешение для указанного [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), обеспечивая <br/>            точное масштабирование и возможности печати. Этот метод позволяет пользователям адаптировать <br/>            разрешение изображения под их конкретные требования, будь то цифровой <br/>            вывод или физическое воспроизведение. Устанавливая разрешение, пользователи могут оптимизировать <br/>            качество изображения и обеспечить совместимость с различными устройствами вывода и носителями, <br/>            улучшая общее визуальное восприятие и удобство использования изображения. |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_119) | Пытается установить экземпляр _metadata_, если этот экземпляр [Image](/imaging/python-net/aspose.imaging/image/) поддерживает и реализует экземпляр [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_120) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_121) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
...
Класс [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) инициализируется без усилий при вызове его <br/>            конструктора с указанным параметром пути. Этот конструктор обеспечивает бесшовное <br/>            создание JPEG‑изображений, гарантируя быструю интеграцию в ваши проекты с легкостью.
...
Инициализируйте новый экземпляр класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) с параметром растрового изображения <br/>            . Этот конструктор предоставляет удобный способ создания JPEG‑изображений <br/>            непосредственно из растровых изображений, упрощая рабочий процесс работы с JPEG‑изображениями <br/>            в ваших приложениях.
...
Инициализируйте объект JPEG‑изображения с помощью класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/) используя параметр <br/>            потока. Этот конструктор упрощает процесс работы с JPEG‑изображениями, предлагая простой подход для их интеграции в ваши проекты <br/>            без усилий.
...
Инициализирует новый экземпляр класса [JpegImage](/imaging/python-net/aspose.imaging.fileformats.jpeg/jpegimage/).
...
Получает исходные параметры изображения данного экземпляра [Image](/imaging/python-net/aspose.imaging/image/).

**Returns**

| Тип | Описание |
| :- | :- |
| [ImageOptionsBase](/imaging/python-net/aspose.imaging/imageoptionsbase/) | Клон исходных параметров изображения. |
...
Устанавливает разрешение для указанного [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), обеспечивая <br/>            точное масштабирование и возможности печати. Этот метод позволяет пользователям адаптировать <br/>            разрешение изображения под их конкретные требования, будь то цифровой <br/>            вывод или физическое воспроизведение. Устанавливая разрешение, пользователи могут оптимизировать <br/>            качество изображения и обеспечить совместимость с различными устройствами вывода и носителями, <br/>            улучшая общее визуальное восприятие и удобство использования изображения.
...
# Сначала создайте временное изображение PNG, которое будет основой для создания изображения JPEG.
...
with PngOptions() as create_options:
	with aspycore.as_of(Image.create(create_options, 100, 100), RasterImage) as raster_image:
		...
		# Создайте изображение JPEG на основе изображения PNG.
		with JpegImage(raster_image) as jpeg_image:
			# Сохранить в файл JPEG
...
# Создайте изображение JPEG размером 100×100 пикселей.
