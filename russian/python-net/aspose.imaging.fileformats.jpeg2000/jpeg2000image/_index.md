---
title: "Класс Jpeg2000Image"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/
---
...
| **Name** | **Description** |
| :- | :- |
| [Jpeg2000Image(image)](#Jpeg2000Image_image_1) | Создайте новый класс [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) с растровым изображением. Этот <br/>            конструктор облегчает создание изображения JPEG2000 из существующего растрового <br/>            изображения, обеспечивая бесшовную интеграцию и конвертацию между различными форматами изображений. |
| [Jpeg2000Image(path)](#Jpeg2000Image_path_2) | Начните работу с классом [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/), инициализируя новый <br/>            экземпляр путем указания пути к изображению, которое вы хотите загрузить. Этот конструктор обеспечивает простой <br/>            доступ к изображениям JPEG2000, упрощая процесс загрузки и обработки файлов изображений. Указав путь к файлу, вы можете быстро приступить к обработке и <br/>            манипулированию изображениями JPEG2000 в вашем приложении. |
| [Jpeg2000Image(path, bits_per_pixel)](#Jpeg2000Image_path_bits_per_pixel_3) | Легко начните работу с классом [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) создав новый <br/>            экземпляр, указав как путь к файлу, так и желаемый параметр битов на пиксель. Этот <br/>            конструктор позволяет точно настраивать процесс загрузки изображения, обеспечивая <br/>            совместимость с различными форматами изображений и настройками качества. Благодаря этой <br/>            гибкости вы можете эффективно управлять и обрабатывать изображения JPEG2000 в соответствии с <br/>            вашими конкретными требованиями. |
| [Jpeg2000Image(raster_image, bits_per_pixel)](#Jpeg2000Image_raster_image_bits_per_pixel_4) | Инициализируйте новый экземпляр [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) с растровым изображением и параметрами битов на пиксель. Этот конструктор обеспечивает точный контроль над <br/>            качеством и размером получаемого изображения JPEG2000, что делает его идеальным для сценариев, <br/>            где настройка имеет решающее значение. |
| [Jpeg2000Image(stream)](#Jpeg2000Image_stream_5) | Легко инициализируйте новый экземпляр [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) предоставив объект потока. Этот конструктор упрощает процесс загрузки <br/>            изображений JPEG2000 напрямую из потоков, предоставляя гибкость и удобство для <br/>            обработки данных изображений из различных источников. |
| [Jpeg2000Image(stream, bits_per_pixel)](#Jpeg2000Image_stream_bits_per_pixel_6) | Инициализируйте новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) с потоком для <br/>            загрузки изображения, а также параметрами битов на пиксель. Этот конструктор предоставляет <br/>            гибкость, позволяя указать как источник данных изображения, так и желаемое количество битов на пиксель, обеспечивая более точный контроль над процессом загрузки изображения. |
| [Jpeg2000Image(width, height)](#Jpeg2000Image_width_height_7) | Создайте новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/), указав параметры ширины и высоты. Этот конструктор позволяет инициализировать изображение JPEG2000 с конкретными размерами, что полезно в сценариях, когда необходимо <br/>            программно создать изображение определённого размера. |
| [Jpeg2000Image(width, height, bits_count)](#Jpeg2000Image_width_height_bits_count_8) | Создайте новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) с параметрами ширины, высоты и количества бит. Этот конструктор позволяет создавать изображения JPEG2000 с определёнными размерами и глубиной цвета, обеспечивая гибкость для различных <br/>            задач обработки изображений. |
| [Jpeg2000Image(width, height, options)](#Jpeg2000Image_width_height_options_9) | Создайте новый объект [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/), указав параметры ширины, высоты и параметров изображения. Этот конструктор позволяет создавать изображения JPEG2000 с конкретными размерами и дополнительными опциями, предоставляя гибкость при <br/>            генерации изображений. |
## **Properties**
...
| bits_per_pixel | int | r | Это свойство возвращает глубину изображения, измеряемую в битах на пиксель (bpp). Оно <br/>            указывает количество цветовой информации, хранящейся в каждом пикселе изображения. <br/>            Понимание глубины изображения имеет решающее значение для определения точности цветов и <br/>            качества изображения. Имея эту информацию, пользователи могут оценить уровень детализации <br/>            и насыщенность цветов, присутствующих в изображении. |
...
| codec | [Jpeg2000Codec](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000codec/) | r | Это свойство получает кодек JPEG2000, связанный с изображением. Кодек JPEG2000 <br/>            отвечает за кодирование и декодирование данных изображения в формате JPEG2000, обеспечивая эффективное сжатие при сохранении высокого качества изображения. <br/>            Доступ к этому кодеку может быть полезен для выполнения продвинутых операций обработки изображений <br/>            или оптимизации настроек сжатия изображения, адаптированных к конкретным требованиям. |
| комментарии | string[] | r/w | Это свойство позволяет получать или обновлять комментарии, связанные с <br/>            изображением. Комментарии предоставляют дополнительную информацию о содержимом изображения, такую как <br/>            аннотации, описания или метаданные. Изменение этих комментариев может быть полезным для <br/>            организации и классификации изображений, а также передачи важной информации <br/>            зрителям или пользователям. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Получите формат файла изображения. Это свойство предоставляет информацию о <br/>            формате файла изображения. Используйте это свойство для программного определения формата <br/>            файла изображения, облегчая соответствующую обработку и работу с ним в зависимости от формата файла. |
...
| height | int | r | Это свойство получает высоту изображения в пикселях. Оно служит важной <br/>            информацией для понимания вертикальных размеров изображения, помогая в различных <br/>            задачах обработки изображений, таких как изменение размера, обрезка и рендеринг. Доступ к этому <br/>            свойству позволяет пользователям определить вертикальный размер изображения, обеспечивая точную <br/>            компоновку и отображение в приложениях. |
| horizontal_resolution | float | r/w | Это свойство позволяет получать или изменять горизонтальное разрешение <br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), измеряемое в пикселях на дюйм (PPI). Регулировка этого <br/>            разрешения может влиять на размер и качество изображения при печати или отображении. <br/>            Устанавливая горизонтальное разрешение, пользователи могут оптимизировать изображение для конкретных <br/>            устройств вывода или приложений, обеспечивая наилучший визуальный результат. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Это свойство получает формат необработанных данных изображения. Оно предоставляет информацию <br/>            о том, как пиксельные данные хранятся в памяти. Используйте это свойство, чтобы понять <br/>            базовый формат данных изображения, что может быть критически важно для различных операций обработки изображений, таких как преобразование цветов, сжатие или распаковка. |
...
| raw_line_size | int | r | Это свойство получает размер одной строки необработанных данных изображения в байтах. Оно <br/>            указывает объём памяти, занимаемый одной строкой пикселей в формате необработанных данных изображения. Понимание размера строки данных имеет важное значение для задач, таких как <br/>            выделение памяти, манипуляция данными и алгоритмы обработки изображений, работающие <br/>            с отдельными строками изображения. |
...
| vertical_resolution | float | r/w | Это свойство предоставляет доступ к вертикальному разрешению <br/>            [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/), измеряемому в пикселях на дюйм (PPI). Изменение этого <br/>            разрешения может влиять на качество и размер изображения при печати или отображении. <br/>            Регулируя вертикальное разрешение, пользователи могут оптимизировать изображение для различных <br/>            устройств вывода или приложений, обеспечивая оптимальное визуальное отображение. |
| width | int | r | Это свойство возвращает ширину изображения в пикселях. Оно предоставляет фундаментальную <br/>            информацию о размерах изображения, важную для различных задач обработки изображений, включая изменение размера, обрезку и рендеринг. |
...
| [create_from_file_with_bpp(path, bits_per_pixel)](#create_from_file_with_bpp_path_bits_per_pixel_26) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
...
| [create_from_image(image)](#create_from_image_image_29) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_from_image_with_bpp(raster_image, bits_per_pixel)](#create_from_image_with_bpp_raster_image_bits_per_pixel_30) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_from_stream_with_bpp(stream, bits_per_pixel)](#create_from_stream_with_bpp_stream_bits_per_pixel_34) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_35) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_with_width_height_bitscount(width, height, bits_count)](#create_with_width_height_bitscount_width_height_bits_count_36) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [create_with_width_height_options(width, height, options)](#create_with_width_height_options_width_height_options_37) | Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/). |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_38) | Обрезать изображение со смещениями. |
| [crop(rectangle)](#crop_rectangle_39) | Обрезка изображения. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_40) | Выполняет дизеринг текущего изображения. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_41) | Выполняет дизеринг текущего изображения. |
| [embed_digital_signature(password)](#embed_digital_signature_password_42) | Встроить цифровую подпись, основанную на предоставленном пароле, в изображение с помощью стеганографии. |
| [filter(rectangle, options)](#filter_rectangle_options_43) | Фильтрует указанный прямоугольник. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_44) | Получает 32-битный ARGB‑пиксель изображения. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_45) | Получает массив пикселей по умолчанию в формате 32‑бит ARGB. |
| [get_default_options(args)](#get_default_options_args_46) | Получает параметры по умолчанию. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_47) | Получает массив пикселей по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_48) | Получает массив необработанных данных по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_49) | Получает массив необработанных данных по умолчанию. |
| [get_file_format(file_path)](#get_file_format_file_path_50) | Получает формат файла. |
| [get_file_format(stream)](#get_file_format_stream_51) | Получает формат файла. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_52) | Получает формат файла. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_53) | Получает прямоугольник, соответствующий текущему изображению. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_54) | Получает прямоугольник, соответствующий текущему изображению. |
| [get_modify_date(use_default)](#get_modify_date_use_default_55) | Получает дату и время последнего изменения ресурса изображения. |
| [get_original_options()](#get_original_options__56) | Получите параметры изображения на основе настроек оригинального файла. Этот метод <br/>            полезен для сохранения глубины цвета и других параметров оригинального <br/>            изображения, обеспечивая согласованность и сохранность целостности данных изображения. <br/>            Доступ к этим параметрам упрощает беспрепятственную работу и обработку изображения <br/>            с сохранением его исходных характеристик.<br/>            Например, если мы загружаем черно‑белое PNG‑изображение с 1 битом на пиксель и затем сохраняем его с помощью метода<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/), будет получено PNG‑изображение с 8 битами на пиксель.<br/>            Чтобы избежать этого и сохранить PNG‑изображение с 1 битом на пиксель, используйте этот метод для получения соответствующих параметров сохранения и передайте их<br/>            в метод [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) в качестве второго параметра. |
| [get_pixel(x, y)](#get_pixel_x_y_57) | Получает пиксель изображения. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_58) | Получает пропорциональную высоту. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_59) | Получает пропорциональную ширину. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_60) | Преобразует в aps. |
| [get_skew_angle()](#get_skew_angle__61) | Получает угол наклона.<br/>            Этот метод применим к отсканированным текстовым документам для определения угла наклона при сканировании. |
| grayscale() | Преобразование изображения в его градации серого |
| [is_digital_signed(password, percentage_threshold)](#is_digital_signed_password_percentage_threshold_62) | Выполняет быструю проверку, чтобы определить, подписано ли изображение цифровой подписью, используя предоставленный пароль и пороговое значение. |
| [load(file_path)](#load_file_path_63) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(file_path, load_options)](#load_file_path_load_options_64) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
| [load(stream)](#load_stream_65) | Загружает новое изображение из указанного потока. |
| [load(stream, load_options)](#load_stream_load_options_66) | Загружает новое изображение из указанного потока. |
| [load_argb_32_pixels(rectangle)](#load_argb_32_pixels_rectangle_67) | Загружает 32‑битные ARGB‑пиксели. |
| [load_argb_64_pixels(rectangle)](#load_argb_64_pixels_rectangle_68) | Загружает 64‑битные ARGB‑пиксели. |
| [load_cmyk_32_pixels(rectangle)](#load_cmyk_32_pixels_rectangle_69) | Загружает пиксели в формате CMYK. |
| [load_cmyk_pixels(rectangle)](#load_cmyk_pixels_rectangle_70) | Загружает пиксели в формате CMYK.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.load_cmyk_32_pixels(rectangle)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [load_partial_argb_32_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_32_pixels_rectangle_partial_pixel_loader_71) | Частично загружает 32‑битные ARGB‑пиксели (по блокам). |
| [load_partial_argb_64_pixels(rectangle, partial_pixel_loader)](#load_partial_argb_64_pixels_rectangle_partial_pixel_loader_72) | Частично загружает 64‑битные ARGB‑пиксели пакетами. |
| [load_partial_pixels(desired_rectangle, pixel_loader)](#load_partial_pixels_desired_rectangle_pixel_loader_73) | Частично загружает пиксели пакетами. |
| [load_pixels(rectangle)](#load_pixels_rectangle_74) | Загружает пиксели. |
| [load_raw_data(rectangle, dest_image_bounds, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_dest_image_bounds_raw_data_settings_raw_data_loader_75) | Загружает необработанные данные. |
| [load_raw_data(rectangle, raw_data_settings, raw_data_loader)](#load_raw_data_rectangle_raw_data_settings_raw_data_loader_76) | Загружает необработанные данные. |
| [load_stream(stream)](#load_stream_stream_77) | Загружает новое изображение из указанного потока. |
| [load_stream_with_options(stream, load_options)](#load_stream_with_options_stream_load_options_78) | Загружает новое изображение из указанного потока. |
| [load_with_options(file_path, load_options)](#load_with_options_file_path_load_options_79) | Загружает новое изображение из указанного пути к файлу или URL.<br/>            Если _filePath_ — путь к файлу, метод просто открывает файл.<br/>            Если _filePath_ — URL, метод загружает файл, сохраняет его как временный и открывает. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_83) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_84) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_85) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_86) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_87) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
| [resize(new_width, new_height)](#resize_new_width_new_height_88) | Изменяет размер изображения. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_89) | Изменяет размер изображения. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_90) | Изменяет размер изображения. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_91) | Изменяет размер изображения. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_92) | Изменяет размер изображения. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_93) | Пропорционально изменяет высоту. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_94) | Пропорционально изменяет высоту. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_95) | Пропорционально изменяет высоту. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_96) | Пропорционально изменяет высоту. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_97) | Пропорционально изменяет ширину. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_98) | Пропорционально изменяет ширину. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_99) | Пропорционально изменяет ширину. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_100) | Пропорционально изменяет ширину. |
| [rotate(angle)](#rotate_angle_101) | Повернуть изображение вокруг центра. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_102) | Повернуть изображение вокруг центра. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_103) | Вращает, отражает или вращает и отражает изображение. |
| save() | Сохраняет данные изображения в базовый поток. |
| [save(file_path)](#save_file_path_104) | Сохраняет изображение в указанное расположение файла. |
| [save(file_path, options)](#save_file_path_options_105) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, options, bounds_rectangle)](#save_file_path_options_bounds_rectangle_106) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save(file_path, over_write)](#save_file_path_over_write_107) | Сохраняет данные объекта в указанное расположение файла. |
| [save(stream)](#save_stream_108) | Сохраняет данные объекта в указанный поток |
| [save(stream, options_base)](#save_stream_options_base_109) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save(stream, options_base, bounds_rectangle)](#save_stream_options_base_bounds_rectangle_110) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_argb_32_pixels(rectangle, pixels)](#save_argb_32_pixels_rectangle_pixels_111) | Сохраняет 32-битные ARGB‑пиксели. |
| [save_cmyk_32_pixels(rectangle, pixels)](#save_cmyk_32_pixels_rectangle_pixels_112) | Сохраняет пиксели. |
| [save_cmyk_pixels(rectangle, pixels)](#save_cmyk_pixels_rectangle_pixels_113) | Сохраняет пиксели.<br/>            Этот метод устарел. Пожалуйста, используйте более эффективный метод [RasterImage.save_cmyk_32_pixels(rectangle, pixels)](/imaging/python-net/aspose.imaging/rasterimage/). |
| [save_pixels(rectangle, pixels)](#save_pixels_rectangle_pixels_114) | Сохраняет пиксели (метод, специфичный для формата). |
| [save_raw_data(data, data_offset, rectangle, raw_data_settings)](#save_raw_data_data_data_offset_rectangle_raw_data_settings_115) | Сохраняет необработанные данные. |
| [save_to_stream(stream)](#save_to_stream_stream_116) | Сохраняет данные объекта в указанный поток. |
| [save_to_stream_with_options(stream, options_base)](#save_to_stream_with_options_stream_options_base_117) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_to_stream_with_options_rect(stream, options_base, bounds_rectangle)](#save_to_stream_with_options_rect_stream_options_base_bounds_rectangle_118) | Сохраняет данные изображения в указанный поток в заданном формате файла согласно параметрам сохранения. |
| [save_with_options(file_path, options)](#save_with_options_file_path_options_119) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [save_with_options_rect(file_path, options, bounds_rectangle)](#save_with_options_rect_file_path_options_bounds_rectangle_120) | Сохраняет данные объекта в указанное расположение файла в заданном формате файла согласно параметрам сохранения. |
| [set_argb_32_pixel(x, y, argb_32_color)](#set_argb_32_pixel_x_y_argb_32_color_121) | Устанавливает 32‑битный ARGB‑пиксель изображения для указанной позиции. |
...
Легко начните работу с классом [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) создав новый <br/>            экземпляр, указав как путь к файлу, так и желаемый параметр битов на пиксель. Этот <br/>            конструктор позволяет точно настраивать процесс загрузки изображения, обеспечивая <br/>            совместимость с различными форматами изображений и настройками качества. Благодаря этой <br/>            гибкости вы можете эффективно управлять и обрабатывать изображения JPEG2000 в соответствии с <br/>            вашими конкретными требованиями.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| путь | string | Путь для загрузки изображения и инициализации данных пикселей и палитры |
...
Инициализируйте новый экземпляр [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) с растровым изображением и параметрами битов на пиксель. Этот конструктор обеспечивает точный контроль над <br/>            качеством и размером получаемого изображения JPEG2000, что делает его идеальным для сценариев, <br/>            где настройка имеет решающее значение.
...
Легко инициализируйте новый экземпляр [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) предоставив объект потока. Этот конструктор упрощает процесс загрузки <br/>            изображений JPEG2000 напрямую из потоков, предоставляя гибкость и удобство для <br/>            обработки данных изображений из различных источников.
...
Инициализируйте новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/) с потоком для <br/>            загрузки изображения, а также параметрами битов на пиксель. Этот конструктор предоставляет <br/>            гибкость, позволяя указать как источник данных изображения, так и желаемое количество битов на пиксель, обеспечивая более точный контроль над процессом загрузки изображения.
...
Создайте новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/), указав параметры ширины и высоты. Этот конструктор позволяет инициализировать изображение JPEG2000 с конкретными размерами, что полезно в сценариях, когда необходимо <br/>            программно создать изображение определённого размера.
...
| width | int | Ширина изображения |
| height | int | Высота изображения |
| bits_count | int | Количество битов. |
...
| width | int | Ширина изображения |
| height | int | Высота изображения |
| options | [Jpeg2000Options](/imaging/python-net/aspose.imaging.imageoptions/jpeg2000options/) | Параметры. |
...
Инициализирует новый экземпляр класса [Jpeg2000Image](/imaging/python-net/aspose.imaging.fileformats.jpeg2000/jpeg2000image/).
...
Получите параметры изображения на основе настроек оригинального файла. Этот метод <br/>            полезен для сохранения глубины цвета и других параметров оригинального <br/>            изображения, обеспечивая согласованность и сохранность целостности данных изображения. <br/>            Доступ к этим параметрам упрощает беспрепятственную работу и обработку изображения <br/>            с сохранением его исходных характеристик.<br/>            Например, если мы загружаем черно‑белое PNG‑изображение с 1 битом на пиксель и затем сохраняем его с помощью метода<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/), будет получено PNG‑изображение с 8 битами на пиксель.<br/>            Чтобы избежать этого и сохранить PNG‑изображение с 1 битом на пиксель, используйте этот метод для получения соответствующих параметров сохранения и передайте их<br/>            в метод [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) в качестве второго параметра.
