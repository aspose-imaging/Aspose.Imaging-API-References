---
title: "Класс CdrImagePage"
type: docs
weight: 210
url: /ru/python-net/aspose.imaging.fileformats.cdr/cdrimagepage/
---
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Получает или задает документ CDR. |
...
| is_cached | bool | r | Получает значение, указывающее, кэшированы ли данные объекта в данный момент и чтение данных не требуется. |
...
| parent_image | [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) | r | Получает родительское изображение. |
