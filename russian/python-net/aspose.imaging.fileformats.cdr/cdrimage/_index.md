---
title: "Класс CdrImage"
type: docs
weight: 190
url: /ru/python-net/aspose.imaging.fileformats.cdr/cdrimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [CdrImage(stream, load_options)](#CdrImage_stream_load_options_1) | Начните работать с классом [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) без усилий, <br/>            инициализируя новый экземпляр с параметрами stream и loadOptions.<br/>            Идеально подходит для разработчиков, ищущих удобный способ загрузки CDR‑изображений из<br/>            различных источников данных с возможностью настройки процесса загрузки по мере необходимости. |
## **Properties**
...
| bits_per_pixel | int | r | Получите глубину цвета изображения без усилий с помощью этого удобного свойства.<br/>            Идеально подходит для разработчиков, желающих определить уровень детализации или глубину цвета в своих изображениях, обеспечивая точную обработку и манипуляцию. |
...
| cdr_document | [CdrDocument](/imaging/python-net/aspose.imaging.fileformats.cdr.objects/cdrdocument/) | r | Без усилий получайте или обновляйте документ CDR с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, желающих получить доступ к документу CDR или изменить его, обеспечивая гибкость и эффективность в их приложениях. |
...
| default_page | [Image](/imaging/python-net/aspose.imaging/image/) | r | Легко получайте страницу по умолчанию изображения с помощью этого удобного свойства.<br/>            Идеально для разработчиков, которым нужен быстрый доступ к основной странице их изображения,<br/>            обеспечивая эффективную навигацию и управление. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Без усилий получайте формат файла изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, желающих динамически определить формат своих изображений,<br/>            обеспечивая совместимость и точную обработку в их приложениях. |
...
| is_cached | bool | r | Без усилий определяйте, кэшированы ли данные объекта в данный момент,<br/>            устраняя необходимость чтения данных. Идеально подходит для разработчиков, стремящихся<br/>            оптимизировать производительность, эффективно используя кэшированные данные, обеспечивая<br/>            более быстрый доступ к информации об объекте. |
| metadata | [ImageMetadata](/imaging/python-net/aspose.imaging.metadata/imagemetadata/) | r | Получает метаданные изображения. |
| page_count | int | r | Без усилий получайте или обновляйте общее количество страниц изображения с помощью этого<br/>            интуитивного свойства. Идеально подходит для разработчиков, желающих управлять многостраничными изображениями<br/>            динамически, обеспечивая эффективную навигацию и манипуляцию содержимым изображения. |
| [pages](#pages1) | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Бесшовно получайте страницы изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, желающих получить доступ и манипулировать отдельными страницами в<br/>            многостраничных изображениях, обеспечивая эффективную навигацию и обработку. |
...
| **Name** | **Description** |
| :- | :- |
| cache_data() | Без усилий кэшируйте данные, чтобы предотвратить дополнительную загрузку из базового источника<br/>            с помощью этого удобного метода. Идеально подходит для разработчиков, стремящихся оптимизировать производительность<br/>            предварительной загрузкой данных, обеспечивая более быстрый доступ и более плавную работу их приложений.<br/>            [DataStreamSupporter.data_stream_container](/imaging/python-net/aspose.imaging/datastreamsupporter/). |
...
Начните работать с классом [CdrImage](/imaging/python-net/aspose.imaging.fileformats.cdr/cdrimage/) без усилий, <br/>            инициализируя новый экземпляр с параметрами stream и loadOptions.<br/>            Идеально подходит для разработчиков, ищущих удобный способ загрузки CDR‑изображений из<br/>            различных источников данных с возможностью настройки процесса загрузки по мере необходимости.
...
Бесшовно получайте страницы изображения с помощью этого интуитивного свойства.<br/>            Идеально подходит для разработчиков, желающих получить доступ и манипулировать отдельными страницами в<br/>            многостраничных изображениях, обеспечивая эффективную навигацию и обработку.
...
| update_colors | bool | если установить значение <c>true</c>, цвета будут обновлены в соответствии с новой палитрой; в противном случае индексы цветов останутся неизменными.<br/>            Обратите внимание, что неизменённые индексы могут привести к сбою загрузки изображения, если для некоторых индексов нет<br/>            соответствующих записей в палитре. |
