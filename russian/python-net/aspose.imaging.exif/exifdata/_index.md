...
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.exif/exifdata/
---
...
| **Name** | **Description** |
| :- | :- |
| [ExifData()](#ExifData__1) | Инициализирует новый экземпляр класса [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/). |
| [ExifData(common_tags, exif_tags, gps_tags)](#ExifData_common_tags_exif_tags_gps_tags_2) | Инициализирует новый экземпляр класса [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) с данными из массива. |
| [ExifData(exifdata)](#ExifData_exifdata_3) | Инициализирует новый экземпляр класса [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) с данными из массива. |
| [ExifData(exifdata)](#ExifData_exifdata_4) | Инициализирует новый экземпляр класса [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) с данными из массива. |
## **Properties**
...
| [maker_notes](#maker_notes1) | [MakerNote[]](/imaging/python-net/aspose.imaging.exif/makernote/) | r | Получает примечания производителя. |
...
| x_resolution | int | r/w | Получает или задает разрешение по оси X. |
| y_resolution | int | r/w | Получает или задает разрешение по оси y. |
## **Methods**
| **Name** | **Description** |
| :- | :- |
...
Инициализирует новый экземпляр класса [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/).
...
Инициализирует новый экземпляр класса [ExifData](/imaging/python-net/aspose.imaging.exif/exifdata/) с данными из массива.
