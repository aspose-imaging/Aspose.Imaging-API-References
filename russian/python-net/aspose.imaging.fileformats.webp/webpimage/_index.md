---
title: "Класс WebPImage"
type: docs
weight: 30
url: /ru/python-net/aspose.imaging.fileformats.webp/webpimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [WebPImage(path)](#WebPImage_path_1) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) , инициализированный <br/>            из предоставленного файлового источника. Используйте этот конструктор для бесшовного создания объектов WebP <br/>            изображений напрямую из файлов, упрощая процесс загрузки и <br/>            манипулирования данными изображений WebP в вашем приложении. |
| [WebPImage(path, load_options)](#WebPImage_path_load_options_2) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) используя файл и <br/>            указанные параметры загрузки, облегчая гибкую работу с данными изображений WebP. Используйте <br/>            этот конструктор для бесшовной инициализации объектов WebP изображений из файлов, одновременно <br/>            настраивая параметры загрузки в соответствии с требованиями вашего приложения. |
| [WebPImage(raster_image)](#WebPImage_raster_image_3) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) , инициализированный <br/>            из предоставленного объекта rasterImage. Этот конструктор позволяет бесшовно <br/>            преобразовывать растровые изображения в формат WebP, обеспечивая эффективную работу и <br/>            манипулирование данными изображений в вашем приложении. |
| [WebPImage(raster_image, load_options)](#WebPImage_raster_image_load_options_4) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) используя объект rasterImage и <br/>            указанные параметры загрузки, обеспечивая гибкую работу с данными изображений. Используйте <br/>            этот конструктор для бесшовной инициализации объектов WebP изображений из растровых изображений, одновременно <br/>            настраивая параметры загрузки в соответствии с требованиями вашего приложения. |
| [WebPImage(stream)](#WebPImage_stream_5) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) , инициализированный <br/> из предоставленного источника потока. Используйте этот конструктор для бесшовного создания объектов WebP <br/> непосредственно из потоков, обеспечивая эффективную обработку и манипуляцию <br/> данными изображений WebP в вашем приложении. |
| [WebPImage(stream, load_options)](#WebPImage_stream_load_options_6) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из потока, <br/> включая указанные параметры загрузки и настройки управления памятью. Этот <br/> конструктор предоставляет гибкость при загрузке изображений WebP из потоков, одновременно <br/> эффективно управляя ресурсами памяти, обеспечивая оптимальную производительность и использование ресурсов в вашем приложении. |
| [WebPImage(width, height, options)](#WebPImage_width_height_options_7) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) с пустым <br/> изображением заданных ширины и высоты. Этот конструктор позволяет <br/> создавать пустые изображения WebP, предоставляя основу для последующей манипуляции изображениями и генерации контента в вашем приложении. |
| [WebPImage(width, height, options, load_options)](#WebPImage_width_height_options_load_options_8) | Создайте новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) с пустым изображением и указанными <br/> параметрами загрузки. Этот конструктор позволяет инициализировать изображения WebP с <br/> настраиваемыми параметрами загрузки, обеспечивая гибкость при создании и <br/> манипуляции изображениями в вашем приложении. |
## **Properties**
...
| [has_alpha](#has_alpha1) | bool | r | Определите, содержит ли изображение альфа-канал, указывающий наличие <br/> информации о прозрачности. Используйте это свойство, чтобы узнать, включает ли изображение <br/> прозрачность, позволяя корректно обрабатывать и выполнять операции, связанные с альфа-каналом, в вашем приложении. |
...
| options | [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/) | r | Получайте или изменяйте параметры, связанные с указанным свойством, позволяя <br/> тонкую настройку поведения и настроек. Используйте это свойство для <br/> беспрепятственного доступа и изменения настраиваемых параметров, обеспечивая гибкое <br/> управление и оптимизацию функциональности вашего приложения. |
...
| pages | [Image[]](/imaging/python-net/aspose.imaging/image/) | r | Получите доступ к блокам WebP в изображении, позволяя детальный анализ или <br/> манипуляцию базовой блоковой структурой. Используйте это свойство для анализа <br/> или изменения отдельных блоков данных изображения WebP, облегчая продвинутые <br/> методы обработки изображений в вашем приложении. |
...
| **Name** | **Description** |
| :- | :- |
| [add_block(block)](#add_block_block_1) | Внедрите новый блок WebP в изображение, обогащая его содержимое и <br/> облегчая продвинутую манипуляцию изображениями. Интегрируйте этот метод для динамического <br/> улучшения структуры и сложности данных изображения WebP в вашем <br/> приложении, обеспечивая точный контроль и оптимизацию рендеринга изображений. |
| [add_page(page)](#add_page_page_2) | Добавьте новую страницу к изображению, расширяя его содержимое и добавляя дополнительные <br/> визуальные элементы. Интегрируйте этот метод для облегчения динамического управления страницами <br/> в вашем приложении, обеспечивая бесшовное создание и расширение многостраничных <br/> документов или изображений. |
| [adjust_brightness(brightness)](#adjust_brightness_brightness_3) | Реализуйте регулировку _яркости_ изображения, позволяя <br/> изменение общего уровня светимости. Внедрите этот метод в ваш процесс обработки изображений, чтобы повысить видимость и улучшить визуальное качество изображений <br/> в вашем приложении. |
| [adjust_contrast(contrast)](#adjust_contrast_contrast_4) | Увеличьте контраст [Image](/imaging/python-net/aspose.imaging/image/), усиливая <br/> различия между светлыми и темными областями. Интегрируйте этот метод в ваш процесс обработки изображений, чтобы улучшить визуальную четкость и общее качество изображения в <br/> вашем приложении. |
| [adjust_gamma(gamma)](#adjust_gamma_gamma_5) | Примените гамма‑коррекцию к изображению, регулируя интенсивность пикселей для достижения <br/> желаемой яркости и цветового баланса. Внедрите этот метод в ваш процесс обработки изображений, чтобы улучшить визуальное качество и повысить точность <br/> последующего анализа или отображения в вашем приложении. |
| [adjust_gamma(gamma_red, gamma_green, gamma_blue)](#adjust_gamma_gamma_red_gamma_green_gamma_blue_6) | Выполните гамма‑коррекцию изображения, используя отдельные коэффициенты для красного, <br/> зеленого и синего каналов, позволяя тонко настраивать цветовой баланс и <br/> контраст. Интегрируйте этот метод в ваш конвейер обработки изображений, чтобы достичь <br/> точного контроля над цветопередачей и повысить визуальную достоверность в вашем <br/> приложении. |
...
| [binarize_bradley(brightness_difference, window_size)](#binarize_bradley_brightness_difference_window_size_9) | Примените бинаризацию к изображению, используя адаптивный алгоритм пороговой обработки Брэдли <br/> с интегральным порогом изображения. Этот метод динамически вычисляет локальные <br/> пороги на основе соседства пикселей, повышая адаптивность к различным <br/> условиям освещения и обеспечивая надежную сегментацию для последующей обработки <br/> задач в вашем приложении. |
| [binarize_fixed(threshold)](#binarize_fixed_threshold_10) | Выполните бинаризацию изображения, используя заранее заданное значение порога, преобразуя <br/> его в бинарное изображение, где пиксели классифицируются как передний план или фон <br/> в зависимости от их интенсивности относительно порога. Интегрируйте этот метод в <br/> ваш процесс обработки изображений, чтобы облегчить сегментацию и извлечение признаков <br/> задач, повышая точность и эффективность последующего анализа в вашем <br/> приложении. |
| binarize_otsu() | Выполните бинаризацию изображения, используя метод пороговой обработки Оцу, автоматически <br/> определяя оптимальное значение порога на основе гистограммы изображения. Интегрируйте <br/> этот метод в ваш процесс обработки изображений, чтобы достичь эффективной сегментации <br/> и извлечения признаков, повышая точность и надежность задач анализа изображений <br/> в вашем приложении. |
...
| clear_blocks() | Очистите все существующие блоки WebP из изображения, создавая чистую основу для <br/> последующих изменений или добавлений. Используйте этот метод для эффективного сброса <br/> блоковой структуры данных изображения WebP, обеспечивая оптимальное управление и <br/> организацию содержимого изображения в вашем приложении. |
...
| [create_from_file_with_options(path, load_options)](#create_from_file_with_options_path_load_options_28) | Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из файла. |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_31) | Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из rasterImage. |
| [create_from_image_with_options(raster_image, load_options)](#create_from_image_with_options_raster_image_load_options_32) | Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из rasterImage. |
| [create_from_images(images)](#create_from_images_images_33) | Создаёт новое изображение, используя указанные изображения в качестве страниц |
| [create_from_images(images, dispose_images)](#create_from_images_images_dispose_images_34) | Создает новое изображение из указанных изображений в виде страниц. |
| [create_from_stream(stream)](#create_from_stream_stream_35) | Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) <br/>                из потока. |
| [create_from_stream_with_options(stream, load_options)](#create_from_stream_with_options_stream_load_options_36) | Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из потока. |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_37) | Обрежьте изображение, применяя сдвиги слева, справа, сверху и снизу, эффективно <br/>            выбирая область интереса внутри изображения. Используйте этот метод для <br/>            динамического извлечения нужных частей изображения, одновременно корректируя его композицию <br/>            и фокус в соответствии с требованиями вашего приложения. |
| [crop(rectangle)](#crop_rectangle_38) | Обрежьте изображение, используя заданный прямоугольный регион, удаляя нежелательные части <br/>            при сохранении нужного содержимого. Интегрируйте этот метод в ваш процесс обработки изображений, чтобы точно извлекать и фокусироваться на конкретных областях интереса <br/>            внутри изображения, улучшая чёткость и композицию для различных приложений. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_39) | Выполняет дизеринг текущего изображения. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_40) | Выполните дизеринг текущего изображения, чтобы уменьшить полосы цвета и улучшить визуальное <br/> качество. Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы достичь более плавных переходов между цветами и улучшить общий вид <br/> изображения в вашем приложении. |
| [embed_digital_signature(password)](#embed_digital_signature_password_41) | Вставьте цифровую подпись, основанную на предоставленном пароле, в каждую страницу изображения. |
| [filter(rectangle, options)](#filter_rectangle_options_42) | Отфильтруйте содержимое в указанном прямоугольнике, применяя заданный фильтр обработки изображений <br/> для улучшения или изменения выбранной области. Интегрируйте этот метод <br/> в ваш рабочий процесс манипуляции изображениями, чтобы достичь целевых улучшений или <br/> трансформаций в вашем приложении. |
| [get_argb_32_pixel(x, y)](#get_argb_32_pixel_x_y_43) | Получает 32-битный ARGB‑пиксель изображения. |
| [get_default_argb_32_pixels(rectangle)](#get_default_argb_32_pixels_rectangle_44) | Получает массив пикселей по умолчанию в формате 32‑бит ARGB. |
| [get_default_options(args)](#get_default_options_args_45) | Получает параметры по умолчанию. |
| [get_default_pixels(rectangle, partial_pixel_loader)](#get_default_pixels_rectangle_partial_pixel_loader_46) | Получает массив пикселей по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, partial_raw_data_loader, raw_data_settings)](#get_default_raw_data_rectangle_partial_raw_data_loader_raw_data_settings_47) | Получает массив необработанных данных по умолчанию с использованием частичного загрузчика пикселей. |
| [get_default_raw_data(rectangle, raw_data_settings)](#get_default_raw_data_rectangle_raw_data_settings_48) | Получает массив необработанных данных по умолчанию. |
| [get_file_format(file_path)](#get_file_format_file_path_49) | Получает формат файла. |
| [get_file_format(stream)](#get_file_format_stream_50) | Получает формат файла. |
| [get_file_format_of_stream(stream)](#get_file_format_of_stream_stream_51) | Получает формат файла. |
| [get_fitting_rectangle(rectangle, pixels, width, height)](#get_fitting_rectangle_rectangle_pixels_width_height_52) | Получает прямоугольник, соответствующий текущему изображению. |
| [get_fitting_rectangle(rectangle, width, height)](#get_fitting_rectangle_rectangle_width_height_53) | Получает прямоугольник, соответствующий текущему изображению. |
| [get_modify_date(use_default)](#get_modify_date_use_default_54) | Получает дату и время последнего изменения ресурса изображения. |
| [get_original_options()](#get_original_options__55) | Получает параметры на основе настроек оригинального файла.<br/>            Это может быть полезно для сохранения глубины цвета и других параметров оригинального изображения без изменений.<br/>            Например, если мы загружаем черно‑белое PNG‑изображение с 1 битом на пиксель и затем сохраняем его с помощью<br/>            [DataStreamSupporter.save(file_path)](/imaging/python-net/aspose.imaging/datastreamsupporter/) метода, будет получено PNG‑изображение с 8‑битами на пиксель.<br/>            Чтобы избежать этого и сохранить PNG‑изображение с 1‑битом на пиксель, используйте этот метод для получения соответствующих параметров сохранения и передайте их<br/>            в метод [Image.save(file_path, options)](/imaging/python-net/aspose.imaging/image/) в качестве второго параметра. |
| [get_pixel(x, y)](#get_pixel_x_y_56) | Получает пиксель изображения. |
| [get_proportional_height(width, height, new_width)](#get_proportional_height_width_height_new_width_57) | Получает пропорциональную высоту. |
| [get_proportional_width(width, height, new_height)](#get_proportional_width_width_height_new_height_58) | Получает пропорциональную ширину. |
| [get_serialized_stream(image_options, clipping_rectangle, page_number)](#get_serialized_stream_image_options_clipping_rectangle_page_number_59) | Преобразует в aps. |
| [get_skew_angle()](#get_skew_angle__60) | Получает угол наклона.<br/>            Этот метод применим к отсканированным текстовым документам для определения угла наклона при сканировании. |
| grayscale() | Преобразуйте изображение в его градации серого, превратив его в <br/> одноканальное изображение, где каждый пиксель представляет интенсивность или яркость. Интегрируйте <br/> этот метод в ваш конвейер обработки изображений, чтобы упростить анализ и повысить <br/> совместимость с алгоритмами, основанными на градациях серого, облегчая различные задачи компьютерного <br/> зрения и анализа изображений в вашем приложении. |
| [insert_block(index, block)](#insert_block_index_block_61) | Вставьте новый блок WebP в указанный индекс внутри изображения, обеспечивая точный <br/> контроль над последовательностью блоков. Интегрируйте этот метод, чтобы бесшовно добавить <br/> дополнительные блоки WebP в структуру данных изображения, способствуя продвинутой обработке и оптимизации изображений в вашем приложении. |
...
| [load(stream, load_options)](#load_stream_load_options_66) | Загружает данные из потока. |
...
| [remove_block(block)](#remove_block_block_83) | Удалите указанный блок WebP из изображения, облегчая эффективное управление <br/> структурой данных изображения. Используйте этот метод, чтобы упростить рабочие процессы обработки изображений, удаляя ненужные блоки или компоненты в вашем приложении. |
...
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_90) | Измените размер изображения, корректируя его размеры при сохранении соотношения сторон. <br/> Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы динамически масштабировать <br/> изображения под различные требования к отображению или хранению в вашем приложении. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_91) | Измените размер изображения согласно указанным настройкам, обеспечивая точный контроль над <br/> размерами, соотношением сторон и поведением масштабирования. Интегрируйте этот метод в ваш <br/> рабочий процесс обработки изображений, чтобы выполнить индивидуальные операции изменения размера, адаптированные к <br/> конкретным требованиям вашего приложения. |
...
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_95) | Регулируйте высоту изображения пропорционально, сохраняя его соотношение сторон <br/> для согласованного изменения размера. Интегрируйте этот метод в ваш рабочий процесс обработки изображений <br/> для динамического изменения размеров изображений с одинаковыми пропорциями, обеспечивая оптимальное отображение или <br/> хранение в вашем приложении. |
...
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_99) | Пропорционально регулируйте ширину изображения, сохраняя его соотношение сторон. <br/> Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы динамически изменять размер <br/> изображений с согласованными пропорциями, обеспечивая оптимальное отображение или хранение в <br/> вашем приложении. |
...
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_103) | Поверните изображение вокруг его центра на заданный угол, одновременно пропорционально <br/> изменяя его размер и применяя указанные параметры цвета фона. Включите этот <br/> метод в ваш рабочий процесс обработки изображений, чтобы достичь точных трансформаций с <br/> настраиваемыми цветами фона, обеспечивая оптимальное визуальное представление в вашем <br/> приложении. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_104) | Применяйте вращение, отражение или оба действия исключительно к активному кадру <br/> внутри изображения. Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы <br/> достичь точного управления отдельными кадрами, повышая гибкость и <br/> контроль над трансформациями кадров в вашем приложении. |
...
| [set_palette(palette, update_colors)](#set_palette_palette_update_colors_124) | Устанавливает палитру изображения. |
| [set_pixel(x, y, color)](#set_pixel_x_y_color_125) | Устанавливает пиксель изображения для указанной позиции. |
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_126) | Устанавливает разрешение для этого [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
| [try_set_metadata(metadata)](#try_set_metadata_metadata_127) | Пытается установить экземпляр _metadata_, если этот экземпляр [Image](/imaging/python-net/aspose.imaging/image/) поддерживает и реализует экземпляр [IImageMetadataFormat](/imaging/python-net/aspose.imaging.metadata/iimagemetadataformat/). |
| [write_argb_32_scan_line(scan_line_index, argb_32_pixels)](#write_argb_32_scan_line_scan_line_index_argb_32_pixels_128) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
| [write_scan_line(scan_line_index, pixels)](#write_scan_line_scan_line_index_pixels_129) | Записывает всю строку сканирования в указанный индекс строки сканирования. |
...
| :- | :- | :- |
| путь | string | Путь к файлу изображения WebP |
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| поток | _io.BufferedRandom | Поток изображения WebP. |
...
| options | [WebPOptions](/imaging/python-net/aspose.imaging.imageoptions/webpoptions/) | Параметры. |
...
Определите, содержит ли изображение альфа-канал, указывающий наличие <br/> информации о прозрачности. Используйте это свойство, чтобы узнать, включает ли изображение <br/> прозрачность, позволяя корректно обрабатывать и выполнять операции, связанные с альфа-каналом, в вашем приложении.
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| block | [IFrame](/imaging/python-net/aspose.imaging.fileformats.webp/iframe/) | Блок WebP для добавления. |
...
Добавьте новую страницу к изображению, расширяя его содержимое и добавляя дополнительные <br/> визуальные элементы. Интегрируйте этот метод для облегчения динамического управления страницами <br/> в вашем приложении, обеспечивая бесшовное создание и расширение многостраничных <br/> документов или изображений.
...
Реализуйте регулировку _яркости_ изображения, позволяя <br/> изменение общего уровня светимости. Внедрите этот метод в ваш процесс обработки изображений, чтобы повысить видимость и улучшить визуальное качество изображений <br/> в вашем приложении.
...
Увеличьте контраст [Image](/imaging/python-net/aspose.imaging/image/), усиливая <br/> различия между светлыми и темными областями. Интегрируйте этот метод в ваш процесс обработки изображений, чтобы улучшить визуальную четкость и общее качество изображения в <br/> вашем приложении.
...
Примените гамма‑коррекцию к изображению, регулируя интенсивность пикселей для достижения <br/> желаемой яркости и цветового баланса. Внедрите этот метод в ваш процесс обработки изображений, чтобы улучшить визуальное качество и повысить точность <br/> последующего анализа или отображения в вашем приложении.
...
Примените бинаризацию к изображению, используя адаптивный алгоритм пороговой обработки Брэдли <br/> с интегральным порогом изображения. Этот метод динамически вычисляет локальные <br/> пороги на основе соседства пикселей, повышая адаптивность к различным <br/> условиям освещения и обеспечивая надежную сегментацию для последующей обработки <br/> задач в вашем приложении.
...
Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из файла.
...
Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из rasterImage.
...
Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) <br/>                из потока.
...
Инициализирует новый экземпляр класса [WebPImage](/imaging/python-net/aspose.imaging.fileformats.webp/webpimage/) из потока.
...
Обрежьте изображение, применяя сдвиги слева, справа, сверху и снизу, эффективно <br/>            выбирая область интереса внутри изображения. Используйте этот метод для <br/>            динамического извлечения нужных частей изображения, одновременно корректируя его композицию <br/>            и фокус в соответствии с требованиями вашего приложения.
...
Обрежьте изображение, используя заданный прямоугольный регион, удаляя нежелательные части <br/>            при сохранении нужного содержимого. Интегрируйте этот метод в ваш процесс обработки изображений, чтобы точно извлекать и фокусироваться на конкретных областях интереса <br/>            внутри изображения, улучшая чёткость и композицию для различных приложений.
...
Выполните дизеринг текущего изображения, чтобы уменьшить полосы цвета и улучшить визуальное <br/> качество. Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы достичь более плавных переходов между цветами и улучшить общий вид <br/> изображения в вашем приложении.
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| index | int | Элемент с нулевой индексацией, в который будет <br/> вставлен _block_. |
| block | [IFrame](/imaging/python-net/aspose.imaging.fileformats.webp/iframe/) | Блок WebP для добавления. |
...
| :- | :- | :- |
| поток | _io.BufferedRandom | Поток изображения WebP. |
| load_options | [LoadOptions](/imaging/python-net/aspose.imaging/loadoptions/) | Параметры загрузки |
...
Удалите указанный блок WebP из изображения, облегчая эффективное управление <br/> структурой данных изображения. Используйте этот метод, чтобы упростить рабочие процессы обработки изображений, удаляя ненужные блоки или компоненты в вашем приложении.

**Parameters:**

| Параметр | Тип | Описание |
| :- | :- | :- |
| block | [IFrame](/imaging/python-net/aspose.imaging.fileformats.webp/iframe/) | Блок для удаления. |
...
Измените размер изображения, корректируя его размеры при сохранении соотношения сторон. <br/> Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы динамически масштабировать <br/> изображения под различные требования к отображению или хранению в вашем приложении.
...
Измените размер изображения согласно указанным настройкам, обеспечивая точный контроль над <br/> размерами, соотношением сторон и поведением масштабирования. Интегрируйте этот метод в ваш <br/> рабочий процесс обработки изображений, чтобы выполнить индивидуальные операции изменения размера, адаптированные к <br/> конкретным требованиям вашего приложения.
...
Пропорционально регулируйте ширину изображения, сохраняя его соотношение сторон. <br/> Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы динамически изменять размер <br/> изображений с согласованными пропорциями, обеспечивая оптимальное отображение или хранение в <br/> вашем приложении.
...
Применяйте вращение, отражение или оба действия исключительно к активному кадру <br/> внутри изображения. Интегрируйте этот метод в ваш рабочий процесс обработки изображений, чтобы <br/> достичь точного управления отдельными кадрами, повышая гибкость и <br/> контроль над трансформациями кадров в вашем приложении.
...
with WebPImage(join(dir_, "test.webp")) as web_pimage:
	# Сохранить в PNG
	# Обратите внимание, что только активный кадр будет сохранён в PNG, поскольку PNG не поддерживает многокадровый формат.
...
dir_: str = "c:\\temp"
# Загрузить PNG‑изображение размером 100×100 пикселей.
with PngImage(100, 100) as png_image:
	...
	# Создать изображение WebP на основе PNG‑изображения.
...
# Создать изображение WebP размером 100×100 пикселей.
