---
title: "Класс PngImage"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.fileformats.png/pngimage/
---
...
| **Name** | **Description** |
| :- | :- |
| [PngImage(path)](#PngImage_path_1) | Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) с использованием параметра path <br/>            для указания расположения файла изображения, которое нужно загрузить. Этот конструктор <br/>            позволяет разработчикам удобно создавать PNG‑изображения, загружая их из файла, <br/>            упрощая процесс работы с PNG‑изображениями в их приложениях. |
| [PngImage(path, color_type)](#PngImage_path_color_type_2) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путем указания <br/>            пути к файлу изображения и типа цвета. Этот конструктор обеспечивает удобное <br/>            создание PNG‑изображений из файлов с различными типами цвета, предоставляя <br/>            гибкость при работе с различными форматами изображений. |
| [PngImage(png_options, width, height)](#PngImage_png_options_width_height_3) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/), включая <br/>            параметры PNG вместе с шириной и высотой. Этот конструктор даёт разработчикам возможность создавать PNG‑изображения с настраиваемыми параметрами и размерами, <br/>            обеспечивая гибкость при генерации изображений для различных сценариев использования. |
| [PngImage(raster_image)](#PngImage_raster_image_4) | Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путём предоставления растрового <br/>            изображения в качестве параметра. Этот конструктор позволяет разработчикам напрямую инициализировать <br/>            объект PNG‑изображения, используя существующее растровое изображение, упрощая процесс <br/>            работы с PNG‑изображениями в их приложениях. |
| [PngImage(raster_image, color_type)](#PngImage_raster_image_color_type_5) | Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путём указания <br/>            растрового изображения и типа цвета. Этот конструктор позволяет разработчикам напрямую <br/>            преобразовывать растровые изображения в формат PNG, указывая желаемый тип цвета, <br/>            обеспечивая гибкость в представлении цветов. |
| [PngImage(stream)](#PngImage_stream_6) | Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путём инициализации его <br/>            потоком. Этот конструктор позволяет разработчикам загружать PNG‑изображения напрямую <br/>            из потока, обеспечивая гибкость получения изображений из различных источников. |
| [PngImage(width, height)](#PngImage_width_height_7) | Инициализирует новый объект класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путём предоставления параметров <br/>            ширины и высоты. Этот конструктор упрощает создание PNG‑изображений, позволяя разработчикам напрямую указывать размеры, способствуя <br/>            эффективному управлению данными PNG‑изображений в их приложениях. |
| [PngImage(width, height, color_type)](#PngImage_width_height_color_type_8) | Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/), указывая <br/>            желаемые параметры ширины, высоты и типа цвета. Этот конструктор обеспечивает <br/>            быстрое создание PNG‑изображений с индивидуальными размерами и цветовыми настройками, <br/>            способствуя упрощённой генерации изображений для различных приложений и рабочих процессов. |
## **Properties**
...
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Возвращает цвет фона изображения, если он указан. Это свойство <br/>            полезно для приложений, которым необходимо определить и при необходимости изменить <br/>            цвет фона изображения. |
| bits_per_pixel | int | r | Получает значение бит на пиксель для изображения. Это свойство предоставляет важную <br/>            информацию о глубине цвета изображения, позволяя разработчикам <br/>            понять уровень детализации и точности цветов, присутствующих в данных изображения. |
...
| file_format | [FileFormat](/imaging/python-net/aspose.imaging/fileformat/) | r | Возвращает формат файла, связанного с экземпляром изображения. Это <br/>            свойство предоставляет важную информацию о типе файла, позволяя <br/>            эффективно обрабатывать и управлять им в соответствии с требованиями конкретного формата. |
| [has_alpha](#has_alpha1) | bool | r | Возвращает логическое значение, указывающее, имеет ли изображение альфа‑канал, <br/>            определяющий его прозрачность. Это свойство полезно для приложений, <br/>            которым необходимо работать с прозрачностью, позволяя разработчикам определить, требуется ли <br/>            дополнительная обработка для управления прозрачными областями изображения. |
| has_background_color | bool | r/w | Возвращает логическое значение, указывающее, имеет ли изображение цвет фона. <br/>            Это свойство полезно для приложений, которым необходимо определить, содержит ли изображение <br/>            цвет фона, что может быть важно для различных задач обработки, <br/>            таких как композитинг, рендеринг или экспорт. |
| has_transparent_color | bool | r/w | Предоставляет логическое значение, указывающее, содержит ли изображение прозрачный <br/>            цвет. Это свойство критически важно для приложений, которым необходимо работать с <br/>            прозрачностью, позволяя разработчикам определить, требуется ли дополнительная обработка <br/>            для управления прозрачными областями изображения. |
| height | int | r | Получить высоту изображения. Это свойство возвращает вертикальный размер <br/>            изображения, позволяя разработчикам определить его размер в пикселях по <br/>            вертикальной оси. |
| horizontal_resolution | float | r/w | Получить или изменить горизонтальное разрешение изображения. Это свойство <br/>            представляет количество пикселей на дюйм по горизонтальной оси <br/>            изображения. Регулировка этого разрешения может влиять на физический размер изображения при <br/>            печати или отображении. |
| image_opacity | float | r | Получает непрозрачность этого изображения. |
| interlaced | bool | r | Возвращает логическое значение, указывающее, является ли [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) <br/>            чересстрочным, что определяет, хранится ли данные изображения прогрессивно <br/>            для более быстрой загрузки или передачи. |
...
| is_interlaced | bool | r | Возвращает логическое значение, указывающее, является ли экземпляр изображения чересстрочным. Это <br/>            свойство имеет решающее значение для оптимизации стратегий загрузки и обеспечения эффективной <br/>            производительности при обработке или отображении изображений. |
...
| raw_data_format | [PixelDataFormat](/imaging/python-net/aspose.imaging/pixeldataformat/) | r | Получает доступ к формату необработанных данных изображения. Это свойство дает представление о <br/>            том, как данные изображения структурированы внутри, что может быть полезно для сложных <br/>            задач обработки изображений или конвертации форматов. |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Получает прозрачный цвет изображения, если он существует. Это свойство <br/>            ценно для приложений, требующих точной работы с прозрачными областями <br/>            в изображениях, позволяя разработчикам получать доступ и управлять конкретным <br/>            используемым прозрачным цветом. |
...
| vertical_resolution | float | r/w | Обеспечивает доступ к вертикальному разрешению изображения. Разработчики могут использовать <br/>            это свойство для получения или изменения настройки разрешения, которое указывает <br/>            количество пикселей на дюйм (PPI) по вертикальной оси изображения. |
| width | int | r | Позволяет получить ширину изображения, предоставляя важную информацию <br/>            о его размерах. Это свойство часто используется разработчиками для <br/>            определения ширины изображения, позволяя выполнять различные операции, основанные <br/>            на его размере. |
...
| [create_from_file_with_color_type(path, color_type)](#create_from_file_with_color_type_path_color_type_26) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_image(raster_image)](#create_from_image_raster_image_29) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_from_image_with_color_type(raster_image, color_type)](#create_from_image_with_color_type_raster_image_color_type_30) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
...
| [create_from_stream(stream)](#create_from_stream_stream_33) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height(width, height)](#create_with_width_height_width_height_34) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_color_type(width, height, color_type)](#create_with_width_height_color_type_width_height_color_type_35) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [create_with_width_height_options(png_options, width, height)](#create_with_width_height_options_png_options_width_height_36) | Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/). |
| [crop(left_shift, right_shift, top_shift, bottom_shift)](#crop_left_shift_right_shift_top_shift_bottom_shift_37) | Обрезать изображение со смещениями. |
| [crop(rectangle)](#crop_rectangle_38) | Обрезка изображения. |
| [dither(dithering_method, bits_count)](#dither_dithering_method_bits_count_39) | Выполняет дизеринг текущего изображения. |
| [dither(dithering_method, bits_count, custom_palette)](#dither_dithering_method_bits_count_custom_palette_40) | Выполняет дизеринг текущего изображения. |
| [embed_digital_signature(password)](#embed_digital_signature_password_41) | Встроить цифровую подпись, основанную на предоставленном пароле, в изображение с помощью стеганографии. |
| [filter(rectangle, options)](#filter_rectangle_options_42) | Фильтрует указанный прямоугольник. |
...
| [get_modify_date(use_default)](#get_modify_date_use_default_54) | Получает метку времени, указывающую на последнее изменение ресурса <br/>            изображения. Этот метод предоставляет доступ к важным метаданным, позволяя приложениям <br/>            определить, когда изображение было изменено в последний раз, облегчая отслеживание версий и <br/>            управление контентом. |
...
| [replace_argb(old_color_argb, old_color_diff, new_color_argb)](#replace_argb_old_color_argb_old_color_diff_new_color_argb_82) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_color(old_color, old_color_diff, new_color)](#replace_color_old_color_old_color_diff_new_color_83) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_color(old_color_argb, old_color_diff, new_color_argb)](#replace_color_old_color_argb_old_color_diff_new_color_argb_84) | Заменяет один цвет другим с допустимой разницей и сохраняет исходное альфа‑значение для сохранения плавных краёв. |
| [replace_non_transparent_colors(new_color)](#replace_non_transparent_colors_new_color_85) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
| [replace_non_transparent_colors(new_color_argb)](#replace_non_transparent_colors_new_color_argb_86) | Заменяет все непрозрачные цвета новым цветом и сохраняет исходное значение альфа‑канала, чтобы сохранить плавные края.<br/>            Примечание: если использовать его на изображениях без прозрачности, все цвета будут заменены одним цветом. |
| [resize(new_width, new_height)](#resize_new_width_new_height_87) | Изменяет размер изображения. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize(new_width, new_height, resize_type)](#resize_new_width_new_height_resize_type_88) | Изменяет размер изображения. |
| [resize(new_width, new_height, settings)](#resize_new_width_new_height_settings_89) | Изменяет размер изображения. |
| [resize_by_settings(new_width, new_height, settings)](#resize_by_settings_new_width_new_height_settings_90) | Изменяет размер изображения. |
| [resize_by_type(new_width, new_height, resize_type)](#resize_by_type_new_width_new_height_resize_type_91) | Изменяет размер изображения. |
| [resize_height_proportionally(new_height)](#resize_height_proportionally_new_height_92) | Пропорционально изменяет высоту. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_height_proportionally(new_height, resize_type)](#resize_height_proportionally_new_height_resize_type_93) | Пропорционально изменяет высоту. |
| [resize_height_proportionally(new_height, settings)](#resize_height_proportionally_new_height_settings_94) | Пропорционально изменяет высоту. |
| [resize_height_proportionally_settings(new_height, settings)](#resize_height_proportionally_settings_new_height_settings_95) | Пропорционально изменяет высоту. |
| [resize_width_proportionally(new_width)](#resize_width_proportionally_new_width_96) | Пропорционально изменяет ширину. По умолчанию используется [ResizeType.NEAREST_NEIGHBOUR_RESAMPLE](/imaging/python-net/aspose.imaging/resizetype/). |
| [resize_width_proportionally(new_width, resize_type)](#resize_width_proportionally_new_width_resize_type_97) | Пропорционально изменяет ширину. |
| [resize_width_proportionally(new_width, settings)](#resize_width_proportionally_new_width_settings_98) | Пропорционально изменяет ширину. |
| [resize_width_proportionally_settings(new_width, settings)](#resize_width_proportionally_settings_new_width_settings_99) | Пропорционально изменяет ширину. |
| [rotate(angle)](#rotate_angle_100) | Повернуть изображение вокруг центра. |
| [rotate(angle, resize_proportionally, background_color)](#rotate_angle_resize_proportionally_background_color_101) | Повернуть изображение вокруг центра. |
| [rotate_flip(rotate_flip_type)](#rotate_flip_rotate_flip_type_102) | Вращает, отражает или вращает и отражает изображение. |
...
| [save(stream)](#save_stream_107) | Данные сохранения. |
...
| [set_resolution(dpi_x, dpi_y)](#set_resolution_dpi_x_dpi_y_123) | Устанавливает разрешение для этого [RasterImage](/imaging/python-net/aspose.imaging/rasterimage/). |
...
Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) с использованием параметра path <br/>            для указания расположения файла изображения, которое нужно загрузить. Этот конструктор <br/>            позволяет разработчикам удобно создавать PNG‑изображения, загружая их из файла, <br/>            упрощая процесс работы с PNG‑изображениями в их приложениях.
...
Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путем указания <br/>            пути к файлу изображения и типа цвета. Этот конструктор обеспечивает удобное <br/>            создание PNG‑изображений из файлов с различными типами цвета, предоставляя <br/>            гибкость при работе с различными форматами изображений.
...
| :- | :- | :- |
| путь | string | Путь для загрузки изображения. |
| color_type | [PngColorType](/imaging/python-net/aspose.imaging.fileformats.png/pngcolortype/) | Тип цвета. |
...
Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/), включая <br/>            параметры PNG вместе с шириной и высотой. Этот конструктор даёт разработчикам возможность создавать PNG‑изображения с настраиваемыми параметрами и размерами, <br/>            обеспечивая гибкость при генерации изображений для различных сценариев использования.
...
Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путём указания <br/>            растрового изображения и типа цвета. Этот конструктор позволяет разработчикам напрямую <br/>            преобразовывать растровые изображения в формат PNG, указывая желаемый тип цвета, <br/>            обеспечивая гибкость в представлении цветов.
...
Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/) путём инициализации его <br/>            потоком. Этот конструктор позволяет разработчикам загружать PNG‑изображения напрямую <br/>            из потока, обеспечивая гибкость получения изображений из различных источников.
...
Создаёт новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/), указывая <br/>            желаемые параметры ширины, высоты и типа цвета. Этот конструктор обеспечивает <br/>            быстрое создание PNG‑изображений с индивидуальными размерами и цветовыми настройками, <br/>            способствуя упрощённой генерации изображений для различных приложений и рабочих процессов.
...
Возвращает логическое значение, указывающее, имеет ли изображение альфа‑канал, <br/>            определяющий его прозрачность. Это свойство полезно для приложений, <br/>            которым необходимо работать с прозрачностью, позволяя разработчикам определить, требуется ли <br/>            дополнительная обработка для управления прозрачными областями изображения.
...
Инициализирует новый экземпляр класса [PngImage](/imaging/python-net/aspose.imaging.fileformats.png/pngimage/).
...
Получает метку времени, указывающую на последнее изменение ресурса <br/>            изображения. Этот метод предоставляет доступ к важным метаданным, позволяя приложениям <br/>            определить, когда изображение было изменено в последний раз, облегчая отслеживание версий и <br/>            управление контентом.
...
dir_ = "c:\\temp"
# Загрузить PNG‑изображение из файла.
# Обратите внимание, что цветное изображение будет автоматически преобразовано в градации серого.
...
dir_: str = "c:\\temp"
# Загрузить PNG‑изображение из потока файла.
...
dir_: str = "c:\\temp"
# Загрузить TrueColor PNG‑изображение из BMP‑изображения.
# Сначала создайте временное BMP‑изображение, которое будет основой для создания PNG‑изображения.
# Вы также можете загрузить BMP‑изображение из файла или использовать изображение любого другого растрового формата.
with BmpImage(100, 100) as bmp_image:
	# Заполните всё BMP‑изображение красным цветом.
...
dir_ = "c:\\temp"
# Загрузить PNG‑изображение в градациях серого из цветного BMP‑изображения.
# Сначала создайте временное BMP‑изображение, которое будет основой для создания PNG‑изображения.
# Вы также можете загрузить BMP‑изображение из файла или использовать изображение любого другого растрового формата.
with BmpImage(100, 100) as bmp_image:
	# Заполните всё BMP‑изображение красным цветом.
	...
	brush = SolidBrush(Color.red)
	gr.fill_rectangle(brush, bmp_image.bounds)
	# Цвета пикселей изображения будут преобразованы в их аналоги в градациях серого.
...
dir_: str = "c:\\temp"
# Создать PNG‑изображение в градациях серого размером 100×100 пикселей.
# Все цвета будут автоматически преобразованы в формат градаций серого.
...
# Вывод выглядит так:
# PNG‑изображение в градациях серого не поддерживает альфа‑канал
# PNG‑изображение TrueColor не поддерживает альфа‑канал
# PNG‑изображение IndexedColor не поддерживает альфа‑канал
