---
title: "Класс ApngFrame"
type: docs
weight: 10
url: /ru/python-net/aspose.imaging.fileformats.apng/apngframe/
---
...
| background_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Получает цвет фона. |
...
| frame_time | int | r/w | Получает или задает длительность кадра. |
| frame_top | int | r | Получает смещение кадра сверху. |
| has_alpha | bool | r | Получить значение, указывающее, имеет ли этот экземпляр альфа-канал. |
| has_background_color | bool | r/w | Получает значение, указывающее, имеет ли фон цвет. |
...
| transparent_color | [Color](/imaging/python-net/aspose.imaging/color/) | r/w | Получает прозрачный цвет. |
...
| [create(files)](#create_files_19) | Создаёт экземпляр [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/). |
...
Создаёт экземпляр [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/).
...
| Тип | Описание |
| :- | :- |
| [Image](/imaging/python-net/aspose.imaging/image/) | Недавно созданный [ApngFrame](/imaging/python-net/aspose.imaging.fileformats.apng/apngframe/) |
