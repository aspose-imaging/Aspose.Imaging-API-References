...
description: "Опции EMF."
type: docs
weight: 19
url: /ru/java/com.aspose.imaging.imageoptions/emfoptions/
---
**Inheritance:**
...
| [EmfOptions(float dpiX, float dpiY)](#EmfOptions-float-float-) | Инициализирует новый экземпляр класса `EmfOptions`. |
| [EmfOptions(float dpi)](#EmfOptions-float-) |  |
| [EmfOptions(EmfOptions emfOptions)](#EmfOptions-com.aspose.imaging.imageoptions.EmfOptions-) | Инициализирует новый экземпляр класса `EmfOptions`. |
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Экспортировать только первые две страницы. На самом деле будет преобразована только одна страница, потому что EMF не является многостраничным форматом.
...
Инициализирует новый экземпляр класса `EmfOptions`.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| emfOptions | [EmfOptions](../../com.aspose.imaging.imageoptions/emfoptions) | Параметры EMF. |
