...
type: docs
weight: 54
url: /ru/java/com.aspose.imaging.imageoptions/wmfoptions/
---
**Inheritance:**
...
try (com.aspose.imaging.Image image = com.aspose.imaging.Image.load(inputFilePath))
{
    ...
    // Экспортировать только первые две страницы. На самом деле будет конвертирована только одна страница, поскольку WMF не является многостраничным форматом.
