...
description: "Тип tiff long."
type: docs
weight: 18
url: /ru/java/com.aspose.imaging.fileformats.tiff.tifftagtypes/tifflongtype/
---
**Inheritance:**
...
| --- | --- |
| [TiffLongType(int tagId)](#TiffLongType-int-) | Создаёт новый экземпляр класса `TiffLongType`. |
## Методы
...
Создаёт новый экземпляр класса `TiffLongType`.
