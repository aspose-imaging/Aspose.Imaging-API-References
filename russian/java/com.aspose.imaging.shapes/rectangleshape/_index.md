...
type: docs
weight: 17
url: /ru/java/com.aspose.imaging.shapes/rectangleshape/
---
**Inheritance:**
...
| --- | --- |
| [RectangleShape()](#RectangleShape--) | Инициализирует новый экземпляр класса `RectangleShape`. |
| [RectangleShape(RectangleF rectangle)](#RectangleShape-com.aspose.imaging.RectangleF-) | Инициализирует новый экземпляр класса `RectangleShape`. |
## Методы
