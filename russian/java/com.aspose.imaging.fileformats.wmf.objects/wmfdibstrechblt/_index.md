...
description: "Запись META_DIBSTRETCHBLT указывает передачу блока пикселей в независимом от устройства формате в соответствии с растровой операцией с возможным расширением или сжатием."
type: docs
weight: 30
url: /ru/java/com.aspose.imaging.fileformats.wmf.objects/wmfdibstrechblt/
---
**Inheritance:**
...
Запись META\_DIBSTRETCHBLT задает передачу блока пикселей в независимом от устройства формате согласно растровой операции, с возможным расширением или сжатием.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [WmfDibStrechBlt()](#WmfDibStrechBlt--) | WMFs запись. |
## Методы
